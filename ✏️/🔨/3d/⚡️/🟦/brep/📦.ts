...
export async function ensureBrepWasmLoaded(): Promise<BrepWasmModule> {
  ...
  const [{ default: initFlow, tessellate, dispose }, { default: wasmUrl }] = await Promise.all([import("../../../../../../🧰/🛍️/💻/🔨/flow/⚡️/🦀/core/pkg/flow_core.js"), import("../../../../../../🧰/🛍️/💻/🔨/flow/⚡️/🦀/core/pkg/flow_core_bg.wasm?url")]);
