//! 🖥️ EN 1999 app — `DocumentApp` facade (constitutional: ui).
//!
...
//! concurrently). There is therefore no UI-layer source in `s/plugin/norm/en/1999/rs/lib.rs` to
...
pub use en1999::Document;
pub use en1999_engine::evaluate;
pub use en1999_op::{En1999Family, Host, Operation};
