//! 📦 VDI 3805 app — binary document surface + laws (constitutional: pack).
...
mod tests {
    ...
    fn document_dsl_pack_equivalence_the_reference_fixture() {
        store::test_support::assert_dsl_pack_equivalence(&vdi3805::reference_fixture());
    }

    #[test]
    fn pack_round_trips_the_reference_fixture() {
        let document = vdi3805::reference_fixture();
