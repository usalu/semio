...
pub const PUZZLE2D_CONCRETE_FOREST_EXAMPLE_TEXT: &str = include_str!("../../../../⚡️/🦀/example/concrete-forest.puzzle2d");
/// 📄 The `nakagin-capsule-tower` example fixture, handcrafted in the `.puzzle2d` DSL.
pub const PUZZLE2D_NAKAGIN_EXAMPLE_TEXT: &str = include_str!("../../../../⚡️/🦀/example/nakagin-capsule-tower.puzzle2d");
