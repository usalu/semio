...
pub const BLOCK5D_CONCRETE_FOREST_LEFT_EXAMPLE_TEXT: &str = include_str!("../../../../⚡️/🦀/example/hexagonal-cut-concrete-forest-left.block5d");
/// 📄 The `nakagin-capsule` example fixture, handcrafted in the `.block5d` DSL.
pub const BLOCK5D_NAKAGIN_CAPSULE_EXAMPLE_TEXT: &str = include_str!("../../../../⚡️/🦀/example/nakagin-capsule.block5d");
