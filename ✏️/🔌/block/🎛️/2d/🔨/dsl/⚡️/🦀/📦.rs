//! 📜 Block 2D app — textual document grammar surface + laws (constitutional: dsl).
...
pub const BLOCK2D_CONCRETE_FOREST_LEFT_EXAMPLE_TEXT: &str = include_str!("../../../../⚡️/🦀/example/hexagonal-cut-concrete-forest-left.block2d");
/// 📄 The `hexagonal-cut-concrete-forest-right` example fixture, handcrafted in the `.block2d` DSL.
pub const BLOCK2D_CONCRETE_FOREST_RIGHT_EXAMPLE_TEXT: &str = include_str!("../../../../⚡️/🦀/example/hexagonal-cut-concrete-forest-right.block2d");
...
mod tests {
    ...
    /// 🌱 Builds the `Hexagonal Cut Concrete Forest Left` node kind — the representative fixture also
