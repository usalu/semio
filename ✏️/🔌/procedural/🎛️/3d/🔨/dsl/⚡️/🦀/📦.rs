...
pub const PROCEDURAL3D_EXAMPLE_HEX_COLUMN_TEXT: &str = include_str!("../../../../⚡️/🦀/example/hexagonal-mushroom-column.procedural3d");
/// 📦 The `procedural3d-play` "rectangle extrude volume" example.
pub const PROCEDURAL3D_EXAMPLE_RECT_EXTRUDE_TEXT: &str = include_str!("../../../../⚡️/🦀/example/rectangle-extrude-volume.procedural3d");
/// 📦 The `procedural3d-play` "sphere cut with torus" example.
pub const PROCEDURAL3D_EXAMPLE_SPHERE_TORUS_TEXT: &str = include_str!("../../../../⚡️/🦀/example/sphere-cut-with-torus.procedural3d");
