...
mod tests {
    ...
    // 🔬️ The postgres DDL (now `SCHEMA`, see this module's header) matches this crate's own
    // queries: archive/atelier membership laws round-trip against a real Postgres, same as the
    // sqlite backend's law test.
    #[tokio::test]
