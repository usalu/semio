...
export const FORMS_PLAY_SURFACE_ID_EDIT = "forms.play.edit";
export const FORMS_PLAY_SURFACE_ID_TRY = "forms.play.try";
...
export class FormsPlayController extends Controller implements PlaygroundExampleHost {
	...
	private readonly docStore = new DocumentVcsStore<FormSpec, FormEditOp>({
		envelope: createDocumentVcsEnvelope("forms.form", "forms-play", defaultFormSpec()),
