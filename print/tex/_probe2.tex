...
\node[font=\SemioMono\fontsize{5.2pt}{5.4pt}\selectfont, text=semio-chrome-text-normal, inner sep=0] at (10.00,10) {M07};
...
\node[font=\SemioMono\fontsize{5.2pt}{5.4pt}\selectfont, text=semio-chrome-text-normal, inner sep=0] at (25.00,10) {U46};
...
\node[font=\SemioMono\fontsize{5.2pt}{5.4pt}\selectfont, text=semio-chrome-text-normal, inner sep=0] at (40.00,10) {F03};
...
\node[font=\SemioMono\fontsize{5.2pt}{5.4pt}\selectfont, text=semio-chrome-text-normal, inner sep=0] at (85.00,10) {U01};
...
\draw[fill=semio-chrome-canvas, draw=semio-chrome-border-normal, line width=0.75pt] (100.00,10) circle (1.75mm);
\node[font=\SemioMono\fontsize{5.2pt}{5.4pt}\selectfont, text=semio-chrome-text-normal, inner sep=0] at (100.00,10) {M7};
\draw[draw=semio-chrome-border-emphasized, line width=0.2pt, dash pattern=on 0.5pt off 0.5pt] (98.25,8.25) rectangle (101.75,11.75);
\draw[fill=semio-chrome-canvas, draw=semio-chrome-border-normal, line width=0.75pt] (115.00,10) circle (1.75mm);
\node[font=\SemioMono\fontsize{5.2pt}{5.4pt}\selectfont, text=semio-chrome-text-normal, inner sep=0] at (115.00,10) {23};
\draw[draw=semio-chrome-border-emphasized, line width=0.2pt, dash pattern=on 0.5pt off 0.5pt] (113.25,8.25) rectangle (116.75,11.75);
\end{tikzpicture}
