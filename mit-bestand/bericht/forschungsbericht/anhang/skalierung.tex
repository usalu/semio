...
\SemioVizText{label}[width=143]{0,-1}{%
...
\SemioVizText{label}[width=25]{0,-7.5}{Prozess-Rückgrat}
...
\SemioVizText{label}[width=72]{0,-1}{19 Antworten, 10 Länder; n\,=\,18 abgeleitet}
...
\SemioVizText{label}[width=66]{0,-1}{C-Index (Jaccard), sign. Paare, Rakhshan 2020}
\SemioVizLayout{heat}[data=sk-h2, row=zeile, col=spalte, value=value, header=true, boxheight=8]
\SemioVizText{label}[width=66]{0,-38}{Zusammenhang, keine Kausalität (eigene Einordnung).}
\end{VizColumn}
\end{VizSection}
...
\SemioVizText{label}[width=64]{0,-1}{Online-Zahlung: 13,4\,\% aller erfassten Lösungen. \enskip „Marktplatz“ ist nur eine von neun Kategorien (5,9\,\%); die Momentaufnahme 2022 ist kein aktueller Marktanteil.}
\end{VizColumn}
\end{VizSection}
