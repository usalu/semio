...
\node[anchor=north west, align=left, text width=72mm, font=\SemioSans\fontsize{6.6pt}{7.6pt}\selectfont] at (0,-1) {19 Antworten, 10 Länder; n\,=\,18 abgeleitet};
...
\end{VizColumn}
\begin{VizColumn}[width=70, title={H2 \ HEMMNIS-KOPPLUNG}]
\node[anchor=north west, align=left, text width=66mm, font=\SemioSans\fontsize{6.6pt}{7.6pt}\selectfont] at (0,-1) {C-Index (Jaccard), sign. Paare, Rakhshan 2020};
\SemioVizLayout{heat}[data=sk-h2, row=zeile, col=spalte, value=value, header=true, boxheight=8]
\node[anchor=north west, align=left, text width=66mm, font=\SemioSans\fontsize{6.6pt}{7.6pt}\selectfont] at (0,-38) {Zusammenhang, keine Kausalität (eigene Einordnung).};
\end{VizColumn}
\end{VizSection}
...
\end{VizColumn}
\begin{VizColumn}[width=68]
\node[anchor=north west, align=left, text width=64mm, font=\SemioSans\fontsize{6.6pt}{7.6pt}\selectfont] at (0,-1) {Online-Zahlung: 13,4\,\% aller erfassten Lösungen. \enskip „Marktplatz“ ist nur eine von neun Kategorien (5,9\,\%); die Momentaufnahme 2022 ist kein aktueller Marktanteil.};
\end{VizColumn}
\end{VizSection}
