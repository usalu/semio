...
% Zeichenvokabel für Systemkarte, Prüftabellen und Bäume der Anlagen. tikz wird
...
\tikzset{
  ...
  semio bar/.style={draw=semio-chrome-border-normal,
    line width=\semio@stroke@hairline, fill=semio-chrome-panel},
  semio tree root/.style={draw=semio-chrome-border-emphasized,
    line width=\semio@stroke@focus, fill=semio-chrome-panel,
    text=semio-chrome-foreground, align=left},
  semio tree group/.style={draw=semio-chrome-border-normal,
    line width=\semio@stroke@default, fill=semio-chrome-window,
    text=semio-chrome-foreground, align=left},
  semio tree branch/.style={draw=semio-chrome-border-normal,
...
% Die Anlagen werden am Ende der Setzung aus dem Zwischenbericht migriert und
% hier über \appendixinput eingehängt.
