...
% Keine Diagramm-Vokabel lebt im Dokument-Preamble: die Systemkarte
% (Anlage SK) verwendet semio-viz.sty (VizFigure/VizSection/VizColumn,
% \SemioVizLayout, \SemioVizText, \SemioVizScale), der Hürden-Baum (Anlage HW)
% semio-tree.sty (\SemioTreeRoot/Group/Leaf). Beide von semio.cls geladen wie
% semio-graph.sty.
