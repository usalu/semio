...
In dem Sekundärbefunde haben wir für uns drei fehlende Fachperspektiven identifiziert und durch Fachgespräche ergänzt, um zentrale Anforderungen aus unterschiedlichen disziplinären Perspektiven zu überprüfen und zu vertiefen.
...
\paragraph{Bereiche}
\begin{SemioNest}
  \paragraph{Erfassung und Qualifizierung}
  Dieses Aufgabenfeld umfasst die Erfassung und Qualifizierung von Baukomponentendaten. Im Vordergrund stehen dabei die Nachvollziehbarkeit der Informationen und der sichtbare Umgang mit Unsicherheiten.

  \paragraph{Suche, Auswahl und Verwendung}
  Dieses Aufgabenfeld beinhaltet die Suche, Auswahl und Verwendung von Komponenten im Entwurf. Eine verlässliche Vergleichbarkeit der Komponenten unterstützt dabei fundierte Entscheidungen.

  \paragraph{Fachliche Bewertung, Abstimmung und Dokumentation}
  Dieses Aufgabenfeld umfasst die fachliche Bewertung, Abstimmung und Dokumentation von Varianten. Entscheidend sind dabei deren Vergleichbarkeit sowie ein nachvollziehbarer und transparenter Umgang mit Unsicherheiten.
\end{SemioNest}
