...
Die User Stories betreffen drei zentrale Bereiche: die Erfassung und \Gls{Qualifizierung} von Baukomponentendaten, die Suche und Verwendung verfügbarer Komponenten im Entwurf sowie die fachliche Bewertung und Abstimmung von Varianten. Übergreifend sind die Nachvollziehbarkeit von Informationen, die Vergleichbarkeit von Komponenten und Varianten sowie der transparente Umgang mit Unsicherheiten von Bedeutung.

Auf dieser Grundlage wurden die Funktionen der \Gls{Einspeiseplattform} und des \Gls{Entwurfswerkzeug}s konkretisiert. Die Einspeiseplattform dient als \Gls{Bauteilportal} zur Erfassung, Qualifizierung und Bereitstellung von Baukomponentendaten. Das Entwurfswerkzeug gliedert sich in \Gls{Bauteilkatalog}, \Gls{Entwurfsumgebung} und \Gls{Konfigurator}.
