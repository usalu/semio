...
\foreach \i/\n in {0/Öffentliche Beschaffung, 1/Normen, 2/Finan\-zierung, 3/Geneh\-migung, 4/Fläche und Raum,
  ...
  \pgfmathsetmacro\xx{\col*29.4}\pgfmathsetmacro\yy{89.5-\rw*8}
  \node[proc, text width=26mm, minimum height=7mm] at (\xx,\yy) {\n};
}

%% ===== INSETS =====
%% H1 (left) + H2 (right)
\node[T] at (0,72) {H1 \ UNTERSTÜTZUNG (EU26)};
\node[Lm, text width=72mm] at (0,67.5) {19 Antworten, 10 Länder; n\,=\,18 abgeleitet};
\foreach \r/\v/\n in {0/83/Öffentliche Beschaffung, 1/72/Finanzielle Anreize, 2/56/Technische Normen,
  ...
  \pgfmathsetmacro\yy{62-\r*2.7}
  \node[Lm] at (0,\yy) {\n};
  \draw[span] (37,\yy-0.85) rectangle (37+\v*0.19,\yy+0.85);
  \node[val] at (71,\yy) {\v\,\%};
}

\node[T] at (77,72) {H2 \ HEMMNIS-KOPPLUNG};
\node[Lm, text width=66mm] at (77,67.5) {C-Index (Jaccard), sign. Paare, Rakhshan 2020};
\foreach \c/\n in {0/Kos, 1/Mkt, 2/Reg, 3/Wah}{\node[val, anchor=south] at (99+\c*8,61) {\n};}
\foreach \r/\n in {0/Markt, 1/Regulierung, 2/Wahrnehmung, 3/Risiko, 4/Gesundheit}{
  \pgfmathsetmacro\yy{58-\r*2.9}\node[Lm] at (77,\yy) {\n};}
\foreach \r/\c/\v in {0/0/.44, 1/0/.49, 1/1/.45, 2/0/.36, 2/1/.35, 2/2/.40,
                      3/0/.34, 3/1/.38, 3/2/.38, 3/3/.63, 4/0/.35}{
  \pgfmathsetmacro\yy{58-\r*2.9}\pgfmathsetmacro\xx{99+\c*8}
  \draw[span] (\xx-3.6,\yy-1.15) rectangle (\xx+3.6,\yy+1.15);
  \node[val, anchor=center] at (\xx,\yy) {\v};}
\node[Lm, text width=66mm] at (77,42) {Zusammenhang, keine Kausalität (eigene Einordnung).};

%% H3 full width
\node[T] at (0,38) {H3 \ MARKTSNAPSHOT 2022 \ \textperiodcentered\ \ n\,=\,746 Digital Reuse Market Solutions, Europa};
\foreach \r/\v/\n in {0/46.4/RBC-Händler, 1/17.2/BC-Händler, 2/15.6/Abbruchunternehmen,
  ...
  \pgfmathsetmacro\yy{32-\r*2.7}
  \node[Lm] at (0,\yy) {\n};
  \draw[span] (40,\yy-0.85) rectangle (40+\v*0.55,\yy+0.85);
  \node[val] at (73,\yy) {\v};
}
\node[Lm, text width=64mm, anchor=north west] at (79,33) {Online-Zahlung: 13,4\,\% aller erfassten Lösungen. \enskip „Marktplatz“ ist nur eine von neun Kategorien (5,9\,\%); die Momentaufnahme 2022 ist kein aktueller Marktanteil.};
