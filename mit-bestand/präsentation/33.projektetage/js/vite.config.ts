...
import { uiAssetsVitePlugin, playgroundStaticSiteBuildOptions } from "../../../../ui/styling/vite-elements-assets.ts";
// #endregion 🔌Adapters
...
const uiReact = resolve(repoRoot, "ui/js/react/index.tsx");
