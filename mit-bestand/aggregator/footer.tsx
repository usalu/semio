...
import type { NavbarItem, UiLocale } from "../../framework/module/ui/js/react/index.tsx";
import { cn } from "../../framework/module/ui/js/react/index.tsx";
...
export const LUH_LOGO_URL = "/mit-bestand/aggregator/asset/logo/luh.png";
/** @emoji 🏛️ Dark-appearance LUH wordmark. */
export const LUH_LOGO_DARK_URL = "/mit-bestand/aggregator/asset/logo/luh-dark.png";
/** @emoji 🏛️ LUH NGS team page. */
export const LUH_URL = "https://www.iek.uni-hannover.de/ngs/team";

/** @emoji 🏛️ Leibniz Universität Hannover logo with light/dark variants served from `mit-bestand/aggregator/asset`. */
...
export const UDK_LOGO_URL = "/mit-bestand/aggregator/asset/logo/udk.png";
/** @emoji 🏛️ Dark-appearance UdK wordmark. */
export const UDK_LOGO_DARK_URL = "/mit-bestand/aggregator/asset/logo/udk-dark.png";
...
/** @emoji 🏛️ Universität der Künste Berlin logo with light/dark variants served from `mit-bestand/aggregator/asset`. */
