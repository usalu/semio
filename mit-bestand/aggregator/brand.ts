  ...
  introduction: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Hier entsteht Ihr Entwurf aus Bestandskomponenten — probieren Sie alle drei Navigationsgesten aus, um sich umzusehen.",
        introduce: windowElementId("puzzle3d-main"),
        show: [],
        placement: "auto",
        interactions: [
          { on: { kind: "zoom", id: "puzzle3d-main" }, label: "Zoomen (Scrollen)" },
          { on: { kind: "pan", id: "puzzle3d-main" }, label: "Verschieben (Ziehen)" },
          { on: { kind: "orbit", id: "puzzle3d-main" }, label: "Orbitieren (Ziehen)" },
        ],
        ordered: false,
        logos: [],
        demonstrations: [
      ...
      },
      {
        id: "panels",
        title: "Paneele",
        body: "Über die Reiter in der Leiste öffnen und schließen Sie Paneele — zum Beispiel Katalog, Dokument oder Einstellungen. Öffnen Sie jetzt das Katalog-Paneel über den Katalog-Reiter.",
        introduce: FRAMEWORK_PANEL_TAB_CATALOGUE_ID,
        show: [],
        placement: "auto",
        interactions: [{ on: { kind: "panel", id: FRAMEWORK_PANEL_TAB_CATALOGUE_ID }, label: "Katalog öffnen" }],
        ordered: false,
        logos: [],
      ...
      },
      {
        ...
        placement: "right",
        interactions: [{ on: { kind: "expand", id: "puzzle3d-play-kinds.objects" }, label: "Baukomponenten aufklappen" }],
        ordered: false,
        logos: [],
      ...
      },
      {
        ...
        placement: "right",
        interactions: [{ on: { kind: "action", id: "addObjectKind" }, label: "Baukomponente hinzufügen" }],
        ordered: false,
        logos: [],
        demonstrations: [
          {
      ...
      },
      {
        ...
        placement: "auto",
        interactions: [{ on: { kind: "utility", id: "transform" }, label: "Transformieren aktivieren" }],
        ordered: false,
        logos: [],
      ...
      },
      {
        ...
        show: [windowElementId("puzzle3d-main")],
        placement: "auto",
        interactions: [{ on: { kind: "action", id: "setVortexShow" }, label: "Verbindungspunkte anzeigen" }],
        ordered: false,
        logos: [],
      ...
      },
      {
        ...
        show: [],
        placement: "top",
        interactions: [{ on: { kind: "tool", id: "fill" }, label: "Füllen aktivieren" }],
        ordered: false,
        logos: [],
