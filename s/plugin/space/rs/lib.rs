...
//!
//! 🪶 Thin bundle after the constitutional split: the Home launcher (`home_ui::HomeApp`) and Studio
...
fn bundle() -> semio_framework_plugin::PluginBundle {
    ...
    semio_framework_plugin::PluginBundle::new("s", "S Studio", "0.1.0")
        ...
        .register_document_app(space_ui::create_space_app(), space_ui::SpaceApp::new)
}
