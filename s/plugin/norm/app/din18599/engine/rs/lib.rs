...
// 📌 Deviation from the original monolith: this was `impl BalancingInputs { pub fn
...
// so it moved here as a free function. See `din18599::Document`'s `Default` impl for the
