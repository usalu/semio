//! 🖥️ EN 1996 app — `DocumentApp` facade (constitutional: ui).
//!
...
//! concurrently). There is therefore no UI-layer source in `s/plugin/norm/en/1996/rs/lib.rs` to
...
pub use en1996::Document;
pub use en1996_engine::evaluate;
pub use en1996_op::{En1996Family, Host, Operation};
