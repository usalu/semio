//! 📜 EN 1991 actions on structures — textual document grammar surface + laws (constitutional: dsl).
//!
//! 📄 No handcrafted `.en1991` DSL fixture exists for this app — the original monolith's own DSL law
//! test exercised only `Document::default()`, so that is the representative document here too.

use en1991::Document;

/// 📖 Parses `.en1991` DSL text into a `Document`.
