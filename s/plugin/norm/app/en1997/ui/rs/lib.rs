//! 🖥️ EN 1997 app — `DocumentApp` facade (constitutional: ui).
//!
...
//! concurrently). There is therefore no UI-layer source in `s/plugin/norm/en/1997/rs/lib.rs` to
...
pub use en1997::Document;
pub use en1997_engine::evaluate;
pub use en1997_op::{En1997Family, Host, Operation};
