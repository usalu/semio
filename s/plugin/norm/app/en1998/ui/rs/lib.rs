//! 🖥️ EN 1998 app — `DocumentApp` facade (constitutional: ui).
//!
...
//! concurrently). There is therefore no UI-layer source in `s/plugin/norm/en/1998/rs/lib.rs` to
...
pub use en1998::Document;
pub use en1998_engine::evaluate;
pub use en1998_op::{En1998Family, Host, Operation};
