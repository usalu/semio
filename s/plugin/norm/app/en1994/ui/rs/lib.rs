//! 🖥️ EN 1994 design of composite steel and concrete structures — `DocumentApp` impl, render, manifest (constitutional: ui).
//!
//! 🏗️ Unlike most constitutional apps, this slot is intentionally empty: the original
//! `s/plugin/norm/en/1994/rs/lib.rs` monolith never defined an `En1994PlayApp`/`DocumentApp`/`create_app`
