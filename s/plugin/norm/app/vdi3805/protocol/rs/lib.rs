...
mod tests {
    use super::*;
    use vdi3805_op::Vdi3805Store;

    #[test]
    fn op_binary_round_trips_and_agrees_with_text() {
        let operation = Operation::SetDocument { document: vdi3805::reference_fixture() };
    ...
    fn document_text_round_trips_through_a_vcs_store() {
        let envelope = store::create_document_envelope(vdi3805::VDI3805_EXTENSION, "vdi3805.demo", vdi3805::reference_fixture(), None);
