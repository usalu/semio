...
pub mod render {
    use animate_core::{compile_animations, interpolate_at, AnimateConfig, Animation, Camera, Scene, SectionList, Sobject, Wait};
    use std::collections::HashMap;
    use std::fs;
...
pub mod scenes {
    ...
    use animate_core::{AnimateConfig, BasicScene, Camera, Scene, Section, SectionList, Sobject, VSobject};
    use std::collections::HashMap;
