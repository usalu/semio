...
pub mod app_space {
    ...
    use semio_framework_os::{
        ...
        create_empty_os_document, create_os_document_id, create_os_id, default_os_projection, list_os_workflow_vfs_children, list_os_workflows,
    ...
    struct SpacePanelState {
        ...
        #[serde(default)]
        workflows: Vec<SpaceProgramEntry>,
        #[serde(default)]
...
fn register_s_exports() {
    ...
    semio_framework_plugin::plugin_runtime::register_document_codec_for_app::<app_space::SpaceApp>(OS_SPACE_SCHEMA);
}
