...
/// tests parse via `include_str!("../../../../../../../framework/product/os/module/infinite/board/port/directed/dag/example/demo.dag")`.
pub const DAG_EXAMPLE_TEXT: &str = include_str!("../../../../../../../framework/product/os/module/infinite/board/port/directed/dag/example/demo.dag");
