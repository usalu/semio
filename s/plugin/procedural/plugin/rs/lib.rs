//! 🔧 Procedural plugin — 2D and 3D flow apps in one hot-swappable WASM plugin.

pub mod app_2d {
    //! 🎲 Procedural 2D plugin — procedural flow play app bundled as a hot-swappable WASM plugin.
    ...
    use semio_framework_plugin::{SurfaceKind, PanelGroup,
        ...
        NodeGraphScene, MediaClass, MediaForm, MediaType, OsMediaCapability, PanelTreeBuilder, ArtifactKindSpec, UiInspectorFieldGroup, UiNode, UiPresence, UiTreeItemNode,
        ViewState,
...
pub mod app_3d {
    //! 🧱 Procedural 3D plugin — flow-based procedural brep editor bundled as a hot-swappable WASM plugin.
    ...
    use semio_framework_plugin::{PanelGroup,
        ...
        ActionDescriptor, MeasureSelectItem, MediaClass, MediaForm, MediaType, NodeGraphScene, OsMediaCapability, PanelTreeBuilder, ArtifactKindSpec, UtilityDefinition,
