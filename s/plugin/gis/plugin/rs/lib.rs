//! 🌐 GIS plugin — 2D map app in a hot-swappable WASM plugin.
...
pub mod app_2d {
    //! 🗺️ GIS 2D plugin — GIS map play app bundled as a hot-swappable WASM plugin.
...
pub mod app_3d {
    //! ⛰️ GIS 3D plugin — terrain viewer app bundled as a hot-swappable WASM plugin. Reuses the
