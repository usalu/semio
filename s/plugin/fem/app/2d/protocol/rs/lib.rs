...
mod tests {
    use super::*;
    use fem2d::{FemAnalysisSettings, FemCamera, FemDof, FemElement, FemLoad, FemLoadCase, FemMaterial, FemNode, FemSection, FemSupport};
    ...
    fn op_binary_round_trips_and_agrees_with_text() {
        let operation = Fem2dOperation::SetCamera { camera: FemCamera { x: 1.0, y: 2.0, zoom: 1.5 } };
