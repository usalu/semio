...
/// 🔁 Re-exported for `sourcing-module-{beams,windows,slabs}`, which depend on this crate (aliased
...
//#region 🔖Fixtures
/// 📄 The demo-stock example, parsed once from `sourcing_dsl::DEMO_STOCK_TEXT` — the source of truth
...
/// 📄 The empty-curation example, parsed once from `sourcing_dsl::EMPTY_CURATION_TEXT`.
