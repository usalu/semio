...
/// 🌐 Resolves the active representation's mesh url — the first representation whose `tags` all
...
/// 🌉 Maps this `ObjectKind` definition into the `s/plugin/puzzle` 3d catalog shape (`objectKinds`/
