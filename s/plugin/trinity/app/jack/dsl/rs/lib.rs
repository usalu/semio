//! 📜 Trinity Jack app — textual document grammar surface + laws (constitutional: dsl).

use trinity_ram::GraphFixture;

/// 📄 The Nakagin Capsule Tower example fixture, handcrafted in the `.trinity` DSL.
pub const NAKAGIN_EXAMPLE_TEXT: &str = include_str!("../../../../example/nakagin-capsule-tower.trinity");
