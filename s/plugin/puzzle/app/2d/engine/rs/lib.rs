...
mod host_tests {
    ...
    fn board_host_fill_base_core_rectangular_excludes_cylindric_tambour() {
        ...
        h.set_brush_node_size(40.0);
        use store::DocumentDsl;
        let fixture: serde_json::Value = serde_json::to_value(<puzzle_2d::Puzzle2dProjection as store::DocumentDsl>::parse_dsl(include_str!("../../example/nakagin-capsule-tower.puzzle2d")).unwrap()).unwrap();
