//! 🔺 Lowpoly program — mesh + paint editor as a typed {@link DocumentApp}. Mesh/object structure and
...
fn inspector_utility_param_field(id: &str, label: &str, key: &str, value: &Value) -> UiNode {
    UiNode::Field(UiFieldNode {presence: UiPresence::default(), 
        ...
        label: label.into(),
        child: Box::new(UiNode::Input(semio_framework_program::UiInputNode {presence: UiPresence::default(), 
...
impl LowpolyPlayApp {
    ...
    ///
    /// 🚧 Deliberately unwired beyond this accessor — same gap as `draw-program`'s
...
fn register_lowpoly_exports() {
    semio_framework_program::program_runtime::register_document_codec_for_app::<LowpolyPlayApp>(LOWPOLY_DOCUMENT_SCHEMA);
    semio_framework_os::register_mesh_exporter("3d.lowpoly", "lowpoly", lowpoly_mesh_from_document, Box::new(semio_framework_program::ObjExporter));
    semio_framework_os::register_mesh_exporter("3d.lowpoly", "lowpoly", lowpoly_mesh_from_document, Box::new(semio_framework_program::GlbExporter));
    semio_framework_os::register_mesh_exporter("3d.lowpoly", "lowpoly", lowpoly_mesh_from_document, Box::new(semio_framework_program::StlExporter));
    semio_framework_os::register_mesh_dwg_export_handler("3d.lowpoly", "lowpoly", lowpoly_mesh_from_document);
    semio_framework_os::register_mesh_importer("3d.lowpoly", lowpoly_document_from_mesh, Box::new(semio_framework_program::ObjImporter));
    semio_framework_os::register_mesh_importer("3d.lowpoly", lowpoly_document_from_mesh, Box::new(semio_framework_program::GlbImporter));
    semio_framework_os::register_mesh_importer("3d.lowpoly", lowpoly_document_from_mesh, Box::new(semio_framework_program::StlImporter));
    semio_framework_os::register_mesh_dwg_import_handler("3d.lowpoly", lowpoly_document_from_mesh);
    semio_framework_os::register_mesh_exporter("3d.mesh", "mesh", mesh_from_mesh_document, Box::new(semio_framework_program::ObjExporter));
    semio_framework_os::register_mesh_exporter("3d.mesh", "mesh", mesh_from_mesh_document, Box::new(semio_framework_program::GlbExporter));
    semio_framework_os::register_mesh_exporter("3d.mesh", "mesh", mesh_from_mesh_document, Box::new(semio_framework_program::StlExporter));
    semio_framework_os::register_mesh_dwg_export_handler("3d.mesh", "mesh", mesh_from_mesh_document);
    semio_framework_os::register_mesh_importer("3d.mesh", mesh_document_from_mesh, Box::new(semio_framework_program::ObjImporter));
    semio_framework_os::register_mesh_importer("3d.mesh", mesh_document_from_mesh, Box::new(semio_framework_program::GlbImporter));
    semio_framework_os::register_mesh_importer("3d.mesh", mesh_document_from_mesh, Box::new(semio_framework_program::StlImporter));
...
mod tests {
    ...
    fn window_kind_actions_scope_mesh_ops_to_main_only() {
        ...
        let resolve = |window_id: &str| -> Vec<String> {
            ...
            semio_framework_program::resolve_window_actions(&definition, window)
                .into_iter()
