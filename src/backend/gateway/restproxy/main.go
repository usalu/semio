...
import (
	...
	gw "github.com/usalu/semio/src/packages/go/gateway/v1"
)
...
var (
	...
	grpcServerEndpoint = flag.String("grpc-server-endpoint", "gateway:2000", "gRPC server endpoint")
...
func run() error {
	...
	return http.ListenAndServe(":2999", mux)
}
