...
export interface AttractionPointRequest {
     ...
     *
     * @generated from protobuf field: semio.model.v1.AttractionParameters attraction_parameters = 3;
     */
    attractionParameters?: AttractionParameters;
}
/**
...
class AttractionPointRequest$Type extends MessageType<AttractionPointRequest> {
    constructor() {
        super("semio.extension.adapter.v1.AttractionPointRequest", [
            ...
            { no: 3, name: "attraction_parameters", kind: "message", T: () => AttractionParameters }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* map<string, string> parameters */ 2:
                    ...
                    break;
                case /* semio.model.v1.AttractionParameters attraction_parameters */ 3:
                    message.attractionParameters = AttractionParameters.internalBinaryRead(reader, reader.uint32(), options, message.attractionParameters);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: AttractionPointRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* semio.model.v1.AttractionParameters attraction_parameters = 3; */
        if (message.attractionParameters)
            AttractionParameters.internalBinaryWrite(message.attractionParameters, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
