...
// tslint:disable
import { RepresentationsResponse } from "./adapter";
...
export interface IAdapterService extends grpc.UntypedServiceImplementation {
     ...
     */
    requestRepresentations: grpc.handleUnaryCall<RepresentationsRequest, RepresentationsResponse>;
}
/**
...
export const adapterServiceDefinition: grpc.ServiceDefinition<IAdapterService> = {
    ...
    requestRepresentations: {
        ...
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => RepresentationsResponse.fromBinary(bytes),
        requestDeserialize: bytes => RepresentationsRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(RepresentationsResponse.toBinary(value)),
