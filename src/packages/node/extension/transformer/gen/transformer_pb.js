...
goog.exportSymbol('proto.semio.extension.transformer.v1.RewriteLayoutRequest', null, global);
/**
...
proto.semio.extension.transformer.v1.RewriteLayoutRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    model_pb.Decision.toObject, includeInstance),
    initialLayout: (f = msg.getInitialLayout()) && model_pb.Layout.toObject(includeInstance, f)
  };
...
proto.semio.extension.transformer.v1.RewriteLayoutRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new model_pb.Decision;
      reader.readMessage(value,model_pb.Decision.deserializeBinaryFromReader);
      msg.addDecisions(value);
      break;
    case 2:
      var value = new model_pb.Layout;
      reader.readMessage(value,model_pb.Layout.deserializeBinaryFromReader);
...
proto.semio.extension.transformer.v1.RewriteLayoutRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      model_pb.Decision.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      model_pb.Layout.serializeBinaryToWriter
    );
  }
};
...
proto.semio.extension.transformer.v1.RewriteLayoutRequest.prototype.getDecisionsList = function() {
  return /** @type{!Array<!proto.semio.model.v1.Decision>} */ (
    jspb.Message.getRepeatedWrapperField(this, model_pb.Decision, 1));
};
...
proto.semio.extension.transformer.v1.RewriteLayoutRequest.prototype.getInitialLayout = function() {
  return /** @type{?proto.semio.model.v1.Layout} */ (
    jspb.Message.getWrapperField(this, model_pb.Layout, 2));
};
...
goog.object.extend(exports, proto.semio.extension.transformer.v1);
