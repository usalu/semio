...
class JSONSchema$Type extends MessageType<JSONSchema> {
    ...
    create(value?: PartialMessage<JSONSchema>): JSONSchema {
        const message = { ref: "", title: "", description: "", default: "", readOnly: false, example: "", multipleOf: 0, maximum: 0, exclusiveMaximum: false, minimum: 0, exclusiveMinimum: false, maxLength: 0n, minLength: 0n, pattern: "", maxItems: 0n, minItems: 0n, uniqueItems: false, maxProperties: 0n, minProperties: 0n, required: [], array: [], type: [], format: "", enum: [], extensions: {} };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
