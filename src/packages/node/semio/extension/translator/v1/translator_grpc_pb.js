...
var extension_translator_v1_translator_pb = require('../../../extension/translator/v1/translator_pb.js');
var model_v1_model_pb = require('../../../model/v1/model_pb.js');

function serialize_semio_server_v1_TranslateRepresentationRequest(arg) {
  if (!(arg instanceof extension_translator_v1_translator_pb.TranslateRepresentationRequest)) {
...
function deserialize_semio_server_v1_TranslateRepresentationRequest(buffer_arg) {
  return extension_translator_v1_translator_pb.TranslateRepresentationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_semio_server_v1_TranslateRepresentationResponse(arg) {
  if (!(arg instanceof extension_translator_v1_translator_pb.TranslateRepresentationResponse)) {
...
function deserialize_semio_server_v1_TranslateRepresentationResponse(buffer_arg) {
  return extension_translator_v1_translator_pb.TranslateRepresentationResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
translateRepresentation: {
    ...
    requestType: extension_translator_v1_translator_pb.TranslateRepresentationRequest,
    responseType: extension_translator_v1_translator_pb.TranslateRepresentationResponse,
