...
/**
 * @generated from protobuf message semio.assembler.v1.LayoutDesignRequest
 */
...
class LayoutDesignRequest$Type extends MessageType<LayoutDesignRequest> {
    constructor() {
        super("semio.assembler.v1.LayoutDesignRequest", [
...
/**
 * @generated MessageType for protobuf message semio.assembler.v1.LayoutDesignRequest
 */
