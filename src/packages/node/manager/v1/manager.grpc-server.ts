...
// tslint:disable
import { Extendings } from "./manager";
...
export interface IManagerService extends grpc.UntypedServiceImplementation {
     ...
     */
    getRegisteredExtensions: grpc.handleUnaryCall<GetRegisteredExtensionsRequest, Extendings>;
}
/**
...
export const managerServiceDefinition: grpc.ServiceDefinition<IManagerService> = {
    ...
    getRegisteredExtensions: {
        ...
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => Extendings.fromBinary(bytes),
        requestDeserialize: bytes => GetRegisteredExtensionsRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(Extendings.toBinary(value)),
