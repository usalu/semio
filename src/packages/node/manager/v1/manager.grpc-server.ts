...
// tslint:disable
import { ExtendingServices } from "./manager";
...
export interface IManagerService extends grpc.UntypedServiceImplementation {
     ...
     */
    getRegisteredExtensions: grpc.handleUnaryCall<GetRegisteredExtensionsRequest, ExtendingServices>;
}
/**
...
export const managerServiceDefinition: grpc.ServiceDefinition<IManagerService> = {
    ...
    getRegisteredExtensions: {
        ...
        requestStream: false,
        responseStream: false,
        responseDeserialize: bytes => ExtendingServices.fromBinary(bytes),
        requestDeserialize: bytes => GetRegisteredExtensionsRequest.fromBinary(bytes),
        responseSerialize: value => Buffer.from(ExtendingServices.toBinary(value)),
