...
export interface ElementRequest {
     ...
     *
     * @generated from protobuf field: string target_representation_concepts = 3;
     */
...
export interface ConnectElementResponse {
    /**
     * @generated from protobuf field: semio.model.v1.Element connected_element = 1;
     */
...
class ElementRequest$Type extends MessageType<ElementRequest> {
    constructor() {
        super("semio.manager.v1.ElementRequest", [
            ...
            { no: 3, name: "target_representation_concepts", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
    ...
    create(value?: PartialMessage<ElementRequest>): ElementRequest {
        const message = { targetRepresentationPlatform: 0, targetRepresentationConcepts: "", targetRepresentationLod: 0n, targetsRequired: false };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* semio.model.v1.Platform target_representation_platform */ 2:
                    ...
                    break;
                case /* string target_representation_concepts */ 3:
                    message.targetRepresentationConcepts = reader.string();
                    break;
    ...
    internalBinaryWrite(message: ElementRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* string target_representation_concepts = 3; */
        if (message.targetRepresentationConcepts !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.targetRepresentationConcepts);
...
class ConnectElementResponse$Type extends MessageType<ConnectElementResponse> {
    constructor() {
        super("semio.manager.v1.ConnectElementResponse", [
            { no: 1, name: "connected_element", kind: "message", T: () => Element },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ConnectElementResponse): ConnectElementResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* semio.model.v1.Element connected_element */ 1:
                    message.connectedElement = Element.internalBinaryRead(reader, reader.uint32(), options, message.connectedElement);
                    break;
    ...
    internalBinaryWrite(message: ConnectElementResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* semio.model.v1.Element connected_element = 1; */
        if (message.connectedElement)
            Element.internalBinaryWrite(message.connectedElement, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
