...
export interface ITranslatorServiceClient {
     ...
     */
    translateRepresentation(input: Layout, options?: RpcOptions): UnaryCall<Layout, Representation>;
}
/**
 * The server service is the gateway for all other apis of semio.
 *
...
export class TranslatorServiceClient implements ITranslatorServiceClient, ServiceInfo {
    ...
    translateRepresentation(input: Layout, options?: RpcOptions): UnaryCall<Layout, Representation> {
        ...
        return stackIntercept<Layout, Representation>("unary", this._transport, method, opt, input);
    }
}
