...
namespace Semio.Extension.Transformer.V1 {
  ...
  /// </summary>
  public static partial class TransformerService
  {
    static readonly string __ServiceName = "semio.extension.transformer.v1.TransformerService";
    ...
    /// <summary>Base class for server-side implementations of TransformerService</summary>
    [grpc::BindServiceMethod(typeof(TransformerService), "BindService")]
    public abstract partial class TransformerServiceBase
    {
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    ...
    /// <summary>Client for TransformerService</summary>
    public partial class TransformerServiceClient : grpc::ClientBase<TransformerServiceClient>
    {
      /// <summary>Creates a new client for TransformerService</summary>
      /// <param name="channel">The channel to use to make remote calls.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public TransformerServiceClient(grpc::ChannelBase channel) : base(channel)
      {
      }
      /// <summary>Creates a new client for TransformerService that uses a custom <c>CallInvoker</c>.</summary>
      /// <param name="callInvoker">The callInvoker to use to make remote calls.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public TransformerServiceClient(grpc::CallInvoker callInvoker) : base(callInvoker)
      {
      }
      /// <summary>Protected parameterless constructor to allow creation of test doubles.</summary>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected TransformerServiceClient() : base()
      {
      }
      /// <summary>Protected constructor to allow creation of configured clients.</summary>
      /// <param name="configuration">The client configuration.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected TransformerServiceClient(ClientBaseConfiguration configuration) : base(configuration)
      {
      }
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected override TransformerServiceClient NewInstance(ClientBaseConfiguration configuration)
      {
        return new TransformerServiceClient(configuration);
      }
    }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static grpc::ServerServiceDefinition BindService(TransformerServiceBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    public static void BindService(grpc::ServiceBinderBase serviceBinder, TransformerServiceBase serviceImpl)
    {
