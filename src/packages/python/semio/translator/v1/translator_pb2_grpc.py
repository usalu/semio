...
from translator.v1 import translator_pb2 as translator_dot_v1_dot_translator__pb2
...
class TranslatorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.TranslateRepresentation = channel.unary_unary(
                ...
                request_serializer=translator_dot_v1_dot_translator__pb2.TranslateRepresentationRequest.SerializeToString,
                response_deserializer=translator_dot_v1_dot_translator__pb2.TranslateRepresentationResponse.FromString,
                )
...
def add_TranslatorServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'TranslateRepresentation': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=translator_dot_v1_dot_translator__pb2.TranslateRepresentationRequest.FromString,
                    response_serializer=translator_dot_v1_dot_translator__pb2.TranslateRepresentationResponse.SerializeToString,
            ),
    }
...
class TranslatorService(object):
    ...
    def TranslateRepresentation(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/semio.server.v1.TranslatorService/TranslateRepresentation',
            translator_dot_v1_dot_translator__pb2.TranslateRepresentationRequest.SerializeToString,
            translator_dot_v1_dot_translator__pb2.TranslateRepresentationResponse.FromString,
