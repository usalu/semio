...
def add_TransformerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RewriteLayout': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=extension_dot_transformer_dot_v1_dot_transformer__pb2.RewriteLayoutRequest.FromString,
                    response_serializer=model_dot_v1_dot_model__pb2.Layout.SerializeToString,
            ),
    }
