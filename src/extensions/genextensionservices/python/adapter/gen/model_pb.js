...
goog.exportSymbol('proto.semio.model.v1.DecisionStrategy', null, global);
 ...
 * @constructor
 */
proto.semio.model.v1.DecisionStrategy = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.semio.model.v1.DecisionStrategy, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.semio.model.v1.DecisionStrategy.displayName = 'proto.semio.model.v1.DecisionStrategy';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.semio.model.v1.DecisionStrategy.prototype.toObject = function(opt_includeInstance) {
  return proto.semio.model.v1.DecisionStrategy.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.semio.model.v1.DecisionStrategy} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.semio.model.v1.DecisionStrategy.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.semio.model.v1.DecisionStrategy}
 */
proto.semio.model.v1.DecisionStrategy.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.semio.model.v1.DecisionStrategy;
  return proto.semio.model.v1.DecisionStrategy.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.semio.model.v1.DecisionStrategy} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.semio.model.v1.DecisionStrategy}
 */
proto.semio.model.v1.DecisionStrategy.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.semio.model.v1.DecisionStrategy.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.semio.model.v1.DecisionStrategy.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.semio.model.v1.DecisionStrategy} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.semio.model.v1.DecisionStrategy.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {number}
 */
proto.semio.model.v1.DecisionStrategy.prototype.getMatchCount = function() {
...
/**
 * @param {number} value
 * @return {!proto.semio.model.v1.DecisionStrategy} returns this
 */
proto.semio.model.v1.DecisionStrategy.prototype.setMatchCount = function(value) {
...
proto.semio.model.v1.Decision.toObject = function(includeInstance, msg) {
  var f, obj = {
    layoutModification: (f = msg.getLayoutModification()) && proto.semio.model.v1.LayoutModification.toObject(includeInstance, f),
    strategy: (f = msg.getStrategy()) && proto.semio.model.v1.DecisionStrategy.toObject(includeInstance, f)
  };
...
proto.semio.model.v1.Decision.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      msg.setLayoutModification(value);
      break;
    case 2:
      var value = new proto.semio.model.v1.DecisionStrategy;
      reader.readMessage(value,proto.semio.model.v1.DecisionStrategy.deserializeBinaryFromReader);
      msg.setStrategy(value);
      break;
    default:
      reader.skipField();
...
proto.semio.model.v1.Decision.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getLayoutModification();
  if (f != null) {
    writer.writeMessage(
      1,
      f,
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.semio.model.v1.DecisionStrategy.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional LayoutModification layout_modification = 1;
 * @return {?proto.semio.model.v1.LayoutModification}
 */
proto.semio.model.v1.Decision.prototype.getLayoutModification = function() {
...
*/
proto.semio.model.v1.Decision.prototype.setLayoutModification = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.semio.model.v1.Decision} returns this
 */
proto.semio.model.v1.Decision.prototype.clearLayoutModification = function() {
  return this.setLayoutModification(undefined);
};
 ...
 * @return {boolean}
 */
proto.semio.model.v1.Decision.prototype.hasLayoutModification = function() {
  return jspb.Message.getField(this, 1) != null;
};


/**
 * optional DecisionStrategy strategy = 2;
 * @return {?proto.semio.model.v1.DecisionStrategy}
 */
proto.semio.model.v1.Decision.prototype.getStrategy = function() {
  return /** @type{?proto.semio.model.v1.DecisionStrategy} */ (
    jspb.Message.getWrapperField(this, proto.semio.model.v1.DecisionStrategy, 2));
};


/**
 * @param {?proto.semio.model.v1.DecisionStrategy|undefined} value
 * @return {!proto.semio.model.v1.Decision} returns this
*/
