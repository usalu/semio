...
export class DecisionStrategy extends jspb.Message { 
    getMatchCount(): number;
    setMatchCount(value: number): DecisionStrategy;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): DecisionStrategy.AsObject;
    static toObject(includeInstance: boolean, msg: DecisionStrategy): DecisionStrategy.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: DecisionStrategy, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): DecisionStrategy;
    static deserializeBinaryFromReader(message: DecisionStrategy, reader: jspb.BinaryReader): DecisionStrategy;
}

export namespace DecisionStrategy {
    export type AsObject = {
        matchCount: number,
    }
}
...
export class Decision extends jspb.Message { 
    ...
    hasLayoutModification(): boolean;
    clearLayoutModification(): void;
    getLayoutModification(): LayoutModification | undefined;
    setLayoutModification(value?: LayoutModification): Decision;

    hasStrategy(): boolean;
    clearStrategy(): void;
    getStrategy(): DecisionStrategy | undefined;
    setStrategy(value?: DecisionStrategy): Decision;
...
export namespace Decision {
    export type AsObject = {
        layoutModification?: LayoutModification.AsObject,
        strategy?: DecisionStrategy.AsObject,
    }
}
