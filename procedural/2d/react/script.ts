#!/usr/bin/env bun
/** 🧭 `@semio-tech/procedural-2d-react` task router. */
import { join } from "node:path";
import { BundleScript, ScriptRouter, playPollingEnv, runBun, runBundleScriptMain, runVitest } from "../../../repo/lib/js/src/index.js";

const flowWasmScript = join(import.meta.dir, "../../../flow/core/script.ts");
const moduleWasmScripts = ["math", "text", "logic", "dictionary", "list", "draw"].map((name) =>
