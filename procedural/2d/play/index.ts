// #region 🧲Header
/** @emoji 🔧 Procedural 2D play harness on `@semio-tech/framework-playground-core`. */
// #endregion 🧲Header
...
export { resolveProcedural2dPlayFixtureSlug };

const proceduralFixtureModules = import.meta.glob("../fixture/*.procedural2d.json", { eager: true }) as Record<
	string,
	{ default: unknown }
>;
...
const PROCEDURAL_2D_PLAY_STORE_KEY = "procedural2d.fixture/v1";
...
if (typeof document !== "undefined" && document.getElementById("root") != null && !import.meta.vitest && import.meta.env.PUZZLE_PLAY_ENTRY === "procedural-2d") {
	...
	void (async () => {
		...
		bootProcedural2dPlay(new PlaygroundProcedural2d());
	})();
}
// #endregion 🔖Boot
