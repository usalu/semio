...
export default defineConfig({
	...
	resolve: {
		alias: {
			...
			"@flow/module-bim": resolve(root, "../../flow/module/bim/pkg/flow_module_bim.js"),
			"@flow/module-core": resolve(root, "../../flow/module/core/pkg/flow_module_core.js"),
			"@flow/module-math": resolve(root, "../../flow/module/math/pkg/flow_module_math.js"),
