// #region 🧲Header
/** @emoji 🔧 Procedural 3D play app — flow editor with 3d preview. */
// #endregion 🧲Header
...
export const PROCEDURAL_PLAY_SURFACE_ID = "procedural.play";
...
export const PROCEDURAL_PLAY_SURFACE_ID_PREVIEW = "procedural.play.preview";
export const PROCEDURAL_PLAY_SURFACE_ID_GENERATE = "procedural.play.generate";

export const PROCEDURAL_PLAY_DEFAULT_FIXTURE: FlowFixture = PROCEDURAL_DEFAULT_FIXTURE;
...
const PROCEDURAL_PLAY_STORE_KEY = "procedural.fixture";

type ProceduralPlayStorage = {
	getItem(key: string): string | null;
	setItem(key: string, value: string): void;
	removeItem(key: string): void;
};

export type ProceduralPlayFixtureStore = {
	load(): string | null;
	save(fixtureJson: string): void;
	clear(): void;
};

/** @emoji 💾 Creates local storage for procedural play fixture persistence. */
export function createProceduralPlayFixtureStore(storage?: ProceduralPlayStorage): ProceduralPlayFixtureStore {
	const resolved =
		storage ??
...
export const PROCEDURAL_PLAY_EMPTY_FIXTURE: FlowFixture = {
	schema: "flow.fixture",
...
if (import.meta.vitest) {
	...
	describe("@semio-tech/procedural-3d-play", () => {
		it("exports default fixture json", () => {
			expect(PROCEDURAL_PLAY_DEFAULT_FIXTURE_JSON).toContain("flow.fixture");
		});
...
async function evaluateProcedural3dMesh(doc: unknown): Promise<MeshTransfer> {
	const fixture = doc as FlowFixture;
