// #region 🧲Header
// 💻 puzzle/5d/play/play.ts — Topology play on `@framework/playground/core`: unified topology fixture, LOD measures, relocate tools (no React).
// #endregion 🧲Header
...
import { buildBoardPlayHierarchySections } from "../../2d/play/play.ts";
...
import { buildPuzzle3dPlayHierarchyTree, PUZZLE_3D_PLAY_EMPTY_SELECTION } from "../../3d/play/play.ts";
import {
  DEFAULT_MANUAL_LOD,
