...
/** @emoji 🧪 Vitest for `@puzzle/topology` (react + play sources with `import.meta.vitest`). */
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{ find: "@puzzle/board", replacement: resolve(root, "../2d/index.tsx") },
			{ find: "@puzzle/scene", replacement: resolve(root, "../3d/index.tsx") },
		],
	},
	test: {
		mode: "test",
