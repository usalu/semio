//! 🧩 Puzzle plugin — 2D, 3D, and 5D play apps in one hot-swappable WASM plugin.

pub mod d2 {
    //! 🧩 Puzzle 2D plugin — declarative puzzle 2d play app bundled as a hot-swappable WASM plugin.
...
pub mod d3 {
    //! 🧊 Puzzle 3D plugin — 3D puzzle assembly play app bundled as a hot-swappable WASM plugin.
...
pub mod d5 {
    //! 👯 Puzzle 5D plugin — paired 2D board + 3D world puzzle play app bundled as a hot-swappable WASM plugin.
