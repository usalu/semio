...
if (import.meta.vitest) {
  ...
  describe("brush", () => {
    ...
    it("brushCompatibleCandidates ranks cross-stack core mates on bottom targets", () => {
      ...
      expect(list.every((entry) => entry.objectKindId === "UpperA" || entry.objectKindId === "UpperB")).toBe(true);
    });
