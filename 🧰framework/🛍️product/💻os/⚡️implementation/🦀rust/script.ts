...
import { BundleScript, ScriptRouter, runBundleScriptMain, runVitest, runWasmPackWebBuild, resolveTestLevel } from "../../../../../🧰framework/🛍️product/🦑repo/🔨module/📚lib/⚡️implementation/🟦typescript/📦index.ts";
...
/** 🌉 Builds the wasm bindings the TS twin decodes `WorkflowFixture` `.dsl`/`.spk` fixtures through — see `rs/lib.rs`'s `wasm_exports` module. */
