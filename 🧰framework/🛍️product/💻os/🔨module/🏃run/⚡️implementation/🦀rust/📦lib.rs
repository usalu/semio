...
//#region 🔖SpaceBundle
/// 📁 The on-disk shape of a studio: `space.os.pack`+`space.os.spr` (the `OsDocument` VCS envelope's
...
impl SpaceBundle {
    ...
    /// @emoji 📦 Reads the studio's pack+spr bytes, matching the per-instance `document_pack_path`/
