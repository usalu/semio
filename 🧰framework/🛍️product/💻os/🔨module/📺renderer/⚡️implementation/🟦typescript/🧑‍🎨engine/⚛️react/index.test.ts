...
import { ENTWERFEN_MIT_BESTAND_BRAND } from "../../../../../../../../../🧰framework/🛍️product/💻os/🔨module/🧑‍💻dev/⚡️implementation/🟦typescript/🏷️brand/📦index.ts";
...
} from "../../../../../../../../../♻️mit-bestand/🧺aggregator/footer.tsx";
import {
  Canvas2dHost,
...
} from "../../../../../../../../../🧰framework/🛍️product/💻os/🔨module/📺renderer/⚡️implementation/🟦typescript/🧑‍🎨engine/⚛️react/📦index.tsx";
...
describe("declarative forms parity", () => {
  ...
  it("dispatches the tree drop action with payload, target and position", async () => {
    const { declarativeTreeDragController } = await import("../../../../../../../../../🧰framework/🛍️product/💻os/🔨module/📺renderer/⚡️implementation/🟦typescript/🧑‍🎨engine/⚛️react/📦index.tsx");
