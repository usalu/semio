...
//#region 🔖Lww
/// @emoji 🏆 HLC-arbitrated register: the diff whose `OperationMeta.timestamp` is greater (via
...
//#region 🔖OrderedSequence
/// @emoji 📍 Dense order key for stable-anchor sequence positions (fractional-index style):
...
/// @emoji 🧵 Stable-anchor sequence merge: concurrent inserts are ordered deterministically by
...
//#endregion 🔖TextSequence

//#region 🔖TombstonedGraphSet
/// @emoji 🪦 Node/edge add-wins-by-default set: a concurrent remove leaves a tombstone that
...
//#endregion 🔖TombstonedGraphSet

//#region 🔖ContentAddressedBlob
...
//#endregion 🔖ContentAddressedBlob
