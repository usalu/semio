...
_trampoline7.fnName = 'wasi:cli/exit@0.2.9#exit';
...
_trampoline8.fnName = 'wasi:io/poll@0.2.9#block';
...
_trampoline9.fnName = 'wasi:io/streams@0.2.9#subscribe';
...
_trampoline11.fnName = 'wasi:cli/stdin@0.2.9#getStdin';
...
_trampoline12.fnName = 'wasi:cli/stdout@0.2.9#getStdout';
...
_trampoline13.fnName = 'wasi:cli/stderr@0.2.9#getStderr';
...
_trampoline14.fnName = 'wasi:clocks/monotonic-clock@0.2.9#now';
...
_trampoline15.fnName = 'wasi:clocks/monotonic-clock@0.2.9#subscribeDuration';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
switch (variant4.tag) {
  case 'ok': {
    ...
    for (let i = 0; i < vec2.length; i++) {
      const e = vec2[i];
      const base = result2 + i * 8;var val1 = e;
...
_trampoline16.fnName = 'semio:framework/host#backbonePoll';

const _trampoline17 = function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
  var result0 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  var ptr1 = arg2;
...
_trampoline17.fnName = 'semio:framework/host#backboneSend';
...
_trampoline18.fnName = 'wasi:random/insecure-seed@0.2.9#insecureSeed';
...
_trampoline19.fnName = 'wasi:io/poll@0.2.9#poll';
...
_trampoline20.fnName = 'wasi:io/streams@0.2.9#read';
...
_trampoline21.fnName = 'wasi:io/streams@0.2.9#checkWrite';
...
_trampoline22.fnName = 'wasi:io/streams@0.2.9#write';
...
_trampoline23.fnName = 'wasi:io/streams@0.2.9#blockingFlush';
...
_trampoline24.fnName = 'wasi:filesystem/types@0.2.9#readViaStream';
...
_trampoline25.fnName = 'wasi:filesystem/types@0.2.9#writeViaStream';
...
_trampoline26.fnName = 'wasi:filesystem/types@0.2.9#appendViaStream';
...
_trampoline27.fnName = 'wasi:filesystem/types@0.2.9#getFlags';
...
_trampoline28.fnName = 'wasi:filesystem/types@0.2.9#stat';
...
_trampoline29.fnName = 'wasi:filesystem/types@0.2.9#statAt';

const _trampoline30 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
...
_trampoline30.fnName = 'wasi:filesystem/types@0.2.9#openAt';
...
_trampoline31.fnName = 'wasi:filesystem/types@0.2.9#metadataHash';
...
_trampoline32.fnName = 'wasi:filesystem/types@0.2.9#metadataHashAt';
...
_trampoline38.fnName = 'wasi:filesystem/preopens@0.2.9#getDirectories';
let exports2;
let postReturn0;
...
let postReturn14;
let postReturn14Async;
let postReturn15;
let postReturn15Async;
let postReturn16;
let postReturn16Async;
let pluginManifest;
...
let pluginApplyOperationsText;

function applyOperationsText(arg0, arg1) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginApplyOperationsText',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginApplyOperationsText(toUint32(arg0), ptr0, len0),
    });
  } catch (err) {
...
function readAppDocumentText(arg0) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginReadAppDocumentText',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginReadAppDocumentText(toUint32(arg0)),
    });
  } catch (err) {
...
let pluginLoadAppDocumentText;

function loadAppDocumentText(arg0, arg1) {
  var {dsl: v0_0, ops: v0_1 } = arg1;
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginLoadAppDocumentText',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginLoadAppDocumentText(toUint32(arg0), ptr1, len1, ptr2, len2),
    });
  } catch (err) {
...
function readAppDocumentPack(arg0) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginReadAppDocumentPack',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginReadAppDocumentPack(toUint32(arg0)),
    });
  } catch (err) {
...
let pluginLoadAppDocumentPack;

function loadAppDocumentPack(arg0, arg1) {
  var {pack: v0_0, spr: v0_1, ops: v0_2 } = arg1;
  var val1 = v0_0;
  var len1 = Array.isArray(val1) ? val1.length : val1.byteLength;
  var ptr1 = realloc0(0, 0, 1, len1 * 1);
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginLoadAppDocumentPack',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginLoadAppDocumentPack(toUint32(arg0), ptr1, len1, ptr2, len2, ptr3, len3),
    });
  } catch (err) {
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./puzzle_plugin_component.core.wasm', import.meta.url));
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      ...
      'wasi:clocks/monotonic-clock@0.2.0': {
        now: trampoline14,
        'subscribe-duration': trampoline15,
      },
      ...
      'wasi:filesystem/types@0.2.0': {
        ...
        '[method]descriptor.stat-at': exports0['13'],
    ...
    postReturn8 = exports1['cabi_post_semio:framework/plugin#apply-operations-text'];
    
    try {
      postReturn8Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#apply-operations-text']);
    } catch(err) {
      postReturn8Async = exports1['cabi_post_semio:framework/plugin#apply-operations-text'];
    }
    
    postReturn9 = exports1['cabi_post_semio:framework/plugin#read-app-document-text'];
    
    try {
      postReturn9Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#read-app-document-text']);
    } catch(err) {
      postReturn9Async = exports1['cabi_post_semio:framework/plugin#read-app-document-text'];
    }
    
    postReturn10 = exports1['cabi_post_semio:framework/plugin#load-app-document-text'];
    
    try {
      postReturn10Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#load-app-document-text']);
    } catch(err) {
      postReturn10Async = exports1['cabi_post_semio:framework/plugin#load-app-document-text'];
    }
    
    postReturn11 = exports1['cabi_post_semio:framework/plugin#read-app-document-pack'];
    
    try {
      postReturn11Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#read-app-document-pack']);
    } catch(err) {
      postReturn11Async = exports1['cabi_post_semio:framework/plugin#read-app-document-pack'];
    }
    
    postReturn12 = exports1['cabi_post_semio:framework/plugin#load-app-document-pack'];
    
    try {
      postReturn12Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#load-app-document-pack']);
    } catch(err) {
      postReturn12Async = exports1['cabi_post_semio:framework/plugin#load-app-document-pack'];
    }
    
    postReturn13 = exports1['cabi_post_semio:framework/plugin#attach-backbone'];
    
    try {
      postReturn13Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#attach-backbone']);
    } catch(err) {
      postReturn13Async = exports1['cabi_post_semio:framework/plugin#attach-backbone'];
    }
    
    postReturn14 = exports1['cabi_post_semio:framework/plugin#detach-backbone'];
    
    try {
      postReturn14Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#detach-backbone']);
    } catch(err) {
      postReturn14Async = exports1['cabi_post_semio:framework/plugin#detach-backbone'];
    }
    
    postReturn15 = exports1['cabi_post_semio:framework/plugin#consume-media'];
    
    try {
      postReturn15Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#consume-media']);
    } catch(err) {
      postReturn15Async = exports1['cabi_post_semio:framework/plugin#consume-media'];
    }
    
    postReturn16 = exports1['cabi_post_semio:framework/plugin#produce-media'];
    
    try {
      postReturn16Async = WebAssembly.promising(exports1['cabi_post_semio:framework/plugin#produce-media']);
    } catch(err) {
      postReturn16Async = exports1['cabi_post_semio:framework/plugin#produce-media'];
    }
...
const plugin = {
  ...
  applyOperationsText: applyOperationsText,
  ...
  loadAppDocumentPack: loadAppDocumentPack,
  loadAppDocumentText: loadAppDocumentText,
  manifest: manifest,
  migrateDocument: migrateDocument,
  produceMedia: produceMedia,
  readAppDocumentPack: readAppDocumentPack,
  readAppDocumentText: readAppDocumentText,
  refreshUi: refreshUi,
  updateWindow: updateWindow,
  
};

export { plugin, plugin as 'semio:framework/plugin',  }