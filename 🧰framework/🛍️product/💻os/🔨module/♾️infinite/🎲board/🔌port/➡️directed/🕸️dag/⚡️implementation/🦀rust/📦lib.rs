...
impl Default for DagFixture {
    fn default() -> Self {
        ...
        let document = <DagDocument as store::DocumentDsl>::parse_dsl(include_str!("../../../../../../🎲board/🔌port/➡️directed/🕸️dag/⚡️implementation/🦀rust/📚example/🕸️demo.dag")).expect("bundled example/🕸️demo.dag is valid DagDocument DSL text");
