...
const tokensOut = join(texDir, "🖋️🖋️semio-tokens.sty");
...
const TEMPLATES: readonly { readonly id: string; readonly tex: string }[] = [
  { id: "report", tex: "template/report/🖋️🖋️report.tex" },
  { id: "paper", tex: "template/paper/🖋️🖋️paper.tex" },
  { id: "flyer", tex: "template/flyer/🖋️🖋️flyer.tex" },
  { id: "forschungsbericht", tex: "template/zukunftbau/🖋️🖋️forschungsbericht.tex" },
  { id: "zwischenbericht", tex: "template/zukunftbau/🖋️🖋️zwischenbericht.tex" },
  { id: "kompaktbericht", tex: "template/zukunftbau/🖋️🖋️kompaktbericht.tex" },
];
...
/** @emoji 🎨 Writes `tex/🖋️🖋️semio-tokens.sty` from {@link framework/ui/styling/🔣tokens.json}. */
...
class GenerateScript extends BundleScript {
  run(): void {
    emitSemioTokensSty();
    console.log("print: wrote tex/🖋️🖋️semio-tokens.sty");
  }
}
...
class TestScript extends BundleScript {
  ...
  private runUnitTests(): void {
    ...
    assert.deepEqual(templatePdfNames("template/report/🖋️🖋️report.tex"), { light: "report.pdf", dark: "report-dark.pdf" });
    ...
    const windowSource = readFileSync(join(texDir, "🖋️🖋️semio-window.sty"), "utf8");
    const tableSource = readFileSync(join(texDir, "🖋️🖋️semio-table.sty"), "utf8");
