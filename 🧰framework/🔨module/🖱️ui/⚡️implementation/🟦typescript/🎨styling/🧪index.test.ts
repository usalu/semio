...
import {
  ...
  resolveElementState,
} from "../../../../../../🧰framework/🔨module/🖱️ui/⚡️implementation/🟦typescript/🎨styling/📦index.ts";
import { meshCollectionVitePlugin, type PlaygroundAssetSpec } from "../../../../../../🧰framework/🔨module/🖱️ui/⚡️implementation/🦀rust/🎨styling/🟦vite-elements-assets.ts";
...
describe("puzzle3d mesh-collection asset spec", () => {
  const puzzle3dMeshSpec: Extract<PlaygroundAssetSpec, { kind: "mesh-collection" }> = {
    ...
    route: "/mesh",
    roots: ["framework/module/asset/metabolism/representation", "mit-bestand/asset/abbau-aufbau"],
    placeholder: "framework/module/asset/mesh/🧊placeholder.glb",
  ...
  it("includes 🧊base.glb for shooting's default fixture", () => {
    expect(existsSync(resolve(repoRoot, puzzle3dMeshSpec.roots[0]!, "🧊base.glb"))).toBe(true);
  });
});
