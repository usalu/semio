// #region 🧲Header
/** @emoji 🌐 Vite plugin: serve and copy `framework/ui/asset` at `/asset/*` (fonts, cursors, …). */
// #endregion 🧲Header
  ...
  return {
    ...
    resolveId(id, importer) {
      ...
      if (workspacePkg) {
        ...
        if (subpath.startsWith("pkg/")) candidates.push(resolve(pkgRoot, "rs", subpath));
        try {
...
export function semioFaviconSources(repoRoot: string): { readonly svg: string; readonly ico: string } {
  const logoRoot = resolve(repoRoot, "./🧰framework/🔨module/🖼️asset/⚡️implementation/🟦typescript/🪧logo");
  return {
...
/** @emoji 🌐 Vite: serve and copy `framework/ui/asset` at `/asset/*` for palette fonts and cursors. */
...
export const PLAYGROUND_PLAY_STATIC_ASSETS: readonly Extract<PlaygroundAssetSpec, { kind: "static-dir" }>[] = [
  ...
  { kind: "static-dir", route: "/infinite-fixture", root: "./🧰framework/🛍️product/💻os/🔨module/♾️infinite/🧫fixture" },
];
...
if (import.meta.vitest) {
  ...
  describe("semioFaviconVitePlugin", () => {
    it("points at round dark emblem svg and ico under asset/logo", () => {
      ...
      expect(svg).toBe(resolve(repoRoot, "./🧰framework/🔨module/🖼️asset/⚡️implementation/🟦typescript/🪧logo/emblem_dark_round.svg"));
      expect(ico).toBe(resolve(repoRoot, "./🧰framework/🔨module/🖼️asset/⚡️implementation/🟦typescript/🪧logo/favicon_dark_round_32x32.ico"));
  ...
  describe("meshCollectionVitePlugin", () => {
    const puzzle3dMeshSpec: Extract<PlaygroundAssetSpec, { kind: "mesh-collection" }> = {
      ...
      route: "/mesh",
      roots: ["./🧰framework/🔨module/🖼️asset/⚡️implementation/🟦typescript/🌱metabolism/🎨representation", "./♻️mit-bestand/🖼️asset/🏚️abbau-aufbau"],
      placeholder: "./🧰framework/🔨module/🖼️asset/⚡️implementation/🟦typescript/🥽mesh/placeholder.glb",
