...
/** @emoji 🔖 Vite: serve and copy the given favicon content at `/favicon.svg` and `/🖼️favicon.ico`. */
...
if (import.meta.vitest) {
  ...
  describe("semioFaviconVitePlugin", () => {
    it("points at round dark emblem svg and ico under asset/logo", () => {
      ...
      expect(ico).toBe(resolve(repoRoot, "./🧰framework/🔨module/🖼️asset/⚡️implementation/🟦typescript/🪧logo/🖼️favicon_dark_round_32x32.ico"));
