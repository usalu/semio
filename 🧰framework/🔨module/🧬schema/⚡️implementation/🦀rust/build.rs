//! 🔧 Runs entity-catalog codegen when `🤖generated.rs` is missing.
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let generated = manifest_dir.join("🤖generated.rs");
    println!("cargo:rerun-if-changed={}", generated.display());
    println!("cargo:rerun-if-changed={}", manifest_dir.join("🔣entity-kinds.json").display());
