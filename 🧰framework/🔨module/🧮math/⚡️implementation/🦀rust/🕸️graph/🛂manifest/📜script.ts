...
function findManifestFiles(root: string): string[] {
  ...
  function walk(dir: string) {
    for (const name of readdirSync(dir)) {
      ...
      if (name === "node_modules" || name === "generated" || name === "🤖generated" || name === "target" || name.startsWith(".")) continue;
      ...
      if (st.isDirectory()) {
        walk(path);
      } else if (name.endsWith(".manifest.json") && (path.includes("/🛂manifest/") || path.includes("/manifest/"))) {
        out.push(path);
      }
    }
  }
