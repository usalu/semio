#!/usr/bin/env bun
/** 🎰 `@semio-tech/math-sampling` — Model-agnostic LLM token-sampling engine: logits in, processor pipeline, constrained distributions, deterministic seeded selection, plus a diffusion/continuous-noise solver module. */
