//! 🧬 Evolutionary outer loop over seeds: maintains a population of seeds across generations,
...
pub struct EvolveConfig {
    ...
    /// 🧬 How many top-scoring seeds survive each generation, both kept as-is and used as parents
...
pub struct EvolveResult {
    ...
    /// 🧬 Total successful solves across every generation (population_size * generations, minus
...
/// 🧬 Runs the evolutionary loop. `solve_one(seed)` should attempt one solve at that seed and
...
mod tests {
    ...
    fn evolve_prefers_higher_scores_across_generations() {
        ...
        // path — see the identical checkerboard fixture in 🦀search.rs's own tests) lets us assert
