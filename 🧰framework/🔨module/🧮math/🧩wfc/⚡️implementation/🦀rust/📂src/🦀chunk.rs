//! 🧩 Chunk-local solving: deterministically seeds and solves *one* grid chunk given fixed seam
...
// #region 🔖Seed
/// 🧩 Combines a world seed with a chunk's integer coordinates and the model's fingerprint into
...
// #region 🔖Chunk
/// 🧩 Solves one chunk: `init_domains` carries the chunk's own baked-in restrictions (e.g. a
