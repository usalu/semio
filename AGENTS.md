...
2. Under `# Software Requirements Specification` in AGENTS.md which indexes distributed spec files. Specs are placed at their most specific location: `.bundle.md` at the bundle root, `.folder.md` in folders, Header Specs region in files, comments after section start markers, and language-native docstrings for definitions. Spec text uses RFC 2119 keywords and MUST NOT contain implementation-specific syntax.
...
- **Bundle-level**: .bundle.md at the bundle root
- **Folder-level**: .folder.md in the folder
...
- semio/.bundle.md - Domain model (Kit, Design, Type, Connection, Piece, Connector, Model, Attribute, Tag, Concept, Plane, Url, Quality, Benchmark, Port, Author, Layer, Group, Prop, Stat)
- semio-repo/cli/.bundle.md - Repo CLI (Code Hygiene, Sections, Move/Integrate/Extract, Tree, Tooling, Ticket, Goal, Repo Dev Server, Repo Tooling, Artifact Kind Derivation, MCP Tools, Contributor, CLI, Ticket UX)
- semio-repo/vscode/.bundle.md - VS Code Extension (Sidebar, Tickets, Commands, Diagnostics, Contributors, Sections View)
- semio/engine/.bundle.md - Engine
- .devcontainer/.folder.md - Devcontainer
- semio/js/sketchpad/.folder.md - Sketchpad UI (State Management, Toolbar, Interaction State, Borders, Windows)
