// #region 🔖Header
// [👤semio📚js⚙️tailwindconfig](semiorepo://p/u/semio/b/l/js/f/tailwind.config.ts)
...
// [👤semio📚js⚙️tailwindconfig🔖configuration](semiorepo://p/u/semio/b/l/js/f/tailwind.config.ts/s/Configuration)
