...
const treppenraumReport: ValidationReport = {
  ...
  expression:
    "not (verbindet exactly 2 (Geschoss and (verbundenZu some Rettungsweg) and (in exactly 1 (Nutzungseinheit and (bruttoGrundfläche some xsd:float[<= 200.0f])))))",
  truth: "false",
  tree: {
    id: "n0",
    kind: "Not",
            ...
            children: [
              {
                ...
                label: "AND",
                fragment:
                  "Geschoss and (verbundenZu some Rettungsweg) and (in exactly 1 (...))",
                truth: "true",
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    summary:
                      "true because at least one related instance is a Rettungsweg",
                    children: [
                      {
                        id: "n6",
                        kind: "Witness",
                  ...
                  },
                  {
                    ...
                    matchingCount: 1,
                    summary:
                      "true because exactly 1 filler satisfies the restriction",
                    children: [
                      {
                        id: "n9",
                        kind: "Witness",
                        ...
                        children: [
                          {
                            ...
                            label: "AND",
                            fragment:
                              "Nutzungseinheit and (bruttoGrundfläche some xsd:float[<= 200.0f])",
                            truth: "true",
                            summary: "true because all children are true",
                            children: [
                              {
                                ...
                                truth: "true",
                                summary:
                                  "NE_01 is an instance of Nutzungseinheit",
                                children: [],
                              },
                              {
                                id: "n12",
                                ...
                                label:
                                  "SOME bruttoGrundfläche xsd:float[<= 200.0f]",
                                fragment:
                                  "bruttoGrundfläche some xsd:float[<= 200.0f]",
                                truth: "true",
                                property: "bruttoGrundfläche",
                                summary:
                                  "true because at least one value satisfies the datatype restriction",
                                children: [
                                  {
                                    id: "n13",
                                    kind: "DataValue",
                        ...
                        children: [
                          {
                            ...
                            truth: "true",
                            summary:
                              "Rettungsweg_2 is an instance of Rettungsweg",
                            children: [],
                          },
                        ],
                      },
                            ...
                            children: [
                              {
                                ...
                                truth: "true",
                                summary:
                                  "NE_02 is an instance of Nutzungseinheit",
                                children: [],
                              },
                              {
                                id: "n24",
