...
prompt: Migration from 2025-11-21_KIT-IMPORT-EXPORT.md
status: finished
...
- `jszip` - For zip/unzip operations ✓ (already installed)
- `sql.js` - For SQLite in-memory operations ✓ (already installed)
