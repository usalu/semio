...
prompt: >-
  Fix Smell 5: Non-reactive snapshot reads in Tutorials.tsx -
  RecordingControlsContent now uses reactive hooks instead of store.snapshot()
status: finished
...
summary: >-
  RecordingControlsContent now uses useRecordingState and useActiveRecording
