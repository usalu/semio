...
prompt: >-
  ...
  (createMachine). There should be only one global sketchpad machine. All app
  specific logic should be part of the APP.tsx files. There should be no design,
  type, etc logic part of Sketchpad.tsx file. All should follow open/closed
  principle.
status: finished
author: Ueli Saluz <ueli.saluz@iek.uni-hannover.de>
date:
  created: '2025-12-16T17:06:07.961Z'
...
iterations:
  - prompt: >-
    ...
    date:
      started: '2025-12-15T12:45:50.535Z'
