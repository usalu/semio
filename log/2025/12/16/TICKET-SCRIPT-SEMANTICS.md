...
iterations:
  - prompt: >-
      ...
      ticket create. Then a new command is ticket iteration start Then there
      should be ticket iteration finish finish becomes ticket finish Throw an
      error if an iteration is unifinished for a ticket (e.g. when another
