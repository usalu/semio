...
const Kit = z
    .object({
        uri: z
            .string()
            .max(2048)
            .describe("🆔 The uri of the kit."),
        name: z
            .string()
            .max(64)
            .describe("📛 The name of the kit."),
        description: z
            .string()
            .max(2560)
            .describe("💬 The optional human-readable description of the kit.")
            .optional(),
        icon: z
            .string()
            .max(1024)
        ...
        homepage: z
            .string()
            .max(1024)
            .describe("🏠 The optional url of the homepage of the kit.")
            .optional(),
        license: z
            .string()
            .max(1024)
            .describe("⚖️ The optional license [ spdx id | url ] of the kit.")
            .optional(),
        created: z
            .string()
            .describe("🕒 The creation date of the kit.")
            .optional(),
        updated: z
            .string()
            .describe("🕒 The last update date of the kit.")
            .optional(),
        types: z
            .array(z.any())
            .describe("🧩 The types of the kit.")
            .optional(),
        designs: z
            .array(z.any())
            .describe("🏙️ The designs of the kit.")
            .optional(),
        qualities: z
            .array(z.any())
            .describe("📏 The qualities of the kit.")
            .optional()
    })
