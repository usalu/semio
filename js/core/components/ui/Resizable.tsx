  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      ...
      className={cn(
        ...
        "border-r border-border hover:border-primary",
    ...
    >
      {withHandle && (
        <div className="z-10 flex h-4 w-3 items-center justify-center border border-border bg-background transition-colors group-hover:border-primary hover:border-primary hover:bg-primary">
