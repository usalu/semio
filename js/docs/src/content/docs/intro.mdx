...
They have built a closed-source core technology with open-source extensions to lock you into their platform 🔒

That's why semio is built the other way around 🔄️

The core technology is open-source and the extensions are closed-source 🔓

This way the industry can grow together by sharing the effort of building the core technology and companies that offer cloud solutions and special features can still be profitable 📈
