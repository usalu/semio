---
title: 🥽 What is semio?
description: 📖 An introduction to semio and when to use it 👀
---
...
semio was built on top of the following principles:

- Open over closed 🔓
- Manual over automated 🖱️
- Team over individual 👥
- Reusbale over unique ♻️
- Implementation over specification 🛠️
- Integration over generality 🔀
- Simple over complex 🧩
- Example over theory 📖
- Architecture over modelling 🏛️
- Prefab over custom 🏗️
