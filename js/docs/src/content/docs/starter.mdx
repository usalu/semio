...
import { File, Sketchpad } from "@semio/js";
...
{/* prettier-ignore */}
{/* <File client:load src="../../../../../examples/geometry/representations/colorful-sphere.glb"/> */}

{/*## 🦗 Grasshoper */}

## 👋 Your First Semio Sketch

This is your “Hello World” moment in Semio — but with geometry 🔧✨

You’ll load a small modular system and see how it comes together using **Ports** and **Connections** 🧩  
No need to understand everything yet 
just explore, adjust, and play around with it 🎮  

We’ll explore the example using the **Semio Grasshopper plugin** 🦗  
So make sure you’ve got **Semio already installed** before jumping in ✅


<Aside type="caution">
  You need the latest version `5.3.0-beta` of semio Grasshopper to run this
  example ▶️
</Aside>
