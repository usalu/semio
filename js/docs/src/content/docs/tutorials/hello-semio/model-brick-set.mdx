...
{/* TODO: insert Geometry Generation image */}
...
The modeling happens in this example inside a **Cluster** at the very left of your definition, we’ll focus here mainly on the **export logic**:
...
![📁 Cluster](/type-cluster-file-reference.png)
...
![📁 Cluster](/type-cluster-direct-reference.png)
