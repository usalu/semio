...
![📤 sketch drawing](/sketch-drawing-set.png)
...
Same shape logic — just stretched or scaled.
  ...
  - In **step 1**, you’ll see the base shape: a rectangle cut at an angle. That’s the blueprint of your custom building block.  
...
![📤 sketch drawing](/sketch-drawing-design.png)
