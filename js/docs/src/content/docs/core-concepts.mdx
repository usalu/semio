...
## [🔓 Open over closed](#manual-over-automated)
...
☁️ Cloud platforms and integrations

⚙️ Productivity-enhancing features
...
Semio does the opposite:

🔓 The core is open-source

💼 The extensions can be commercial
