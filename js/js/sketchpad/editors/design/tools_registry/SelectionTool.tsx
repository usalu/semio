...
export const SelectionNormalTool: Tool<DesignEditorState> = {
  id: ToolType.SELECTION_NORMAL,
  label: "tools.selection.normal",
  icon: <MousePointer2 className="h-4 w-4" />,
  tooltip: "tools.selection.selectPieces",
  hotkey: "Click",
  render: (context: ToolRenderContext<DesignEditorState>) => ({}),
};

export const SelectionAdditiveTool: Tool<DesignEditorState> = {
...
export const SelectionSubtractiveTool: Tool<DesignEditorState> = {
