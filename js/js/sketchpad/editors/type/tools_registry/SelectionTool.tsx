...
export const SelectionNormalTool: Tool<TypeEditorState> = {
...
export const SelectionAdditiveTool: Tool<TypeEditorState> = {
...
export const SelectionSubtractiveTool: Tool<TypeEditorState> = {
