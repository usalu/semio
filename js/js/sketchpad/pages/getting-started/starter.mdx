...
{/* - Minimum amount of components: (Model Model), Model Port, Model Type, (Model Piece), (Model Connection), (Model Design), Show Design */}

import { Aside, FileTree } from "@semio/js";
...
{/* prettier-ignore */}
{/* <Model client:load src="../../../../../examples/geometry/models/colorful-sphere.glb"/> */}
