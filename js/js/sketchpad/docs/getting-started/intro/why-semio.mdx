...
<div className="border rounded p-4 bg-panel my-4">
  <h3 className="font-semibold text-base mb-2">🧩 Design-Information-Modeling for Kit-of-Parts</h3>
  <p className="text-sm text-muted-foreground">semio is the toolchain for designing **modular** architecture ✏️</p>
</div>
