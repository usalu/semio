...
export const WithForm: Story = {
  render: () => {
    const [isOpen, setIsOpen] = useState(false);
    return (
      <Collapsible open={isOpen} onOpenChange={setIsOpen} className="w-96 space-y-2 border p-4">
        ...
        <CollapsibleContent className="space-y-4 pt-2">
          <div>
            ...
            <input className="w-full border px-3 py-2 text-sm mt-1" placeholder="10" />
          </div>
          <div>
            <label className="text-sm font-medium">Rotation (degrees)</label>
            <input type="number" className="w-full border px-3 py-2 text-sm mt-1" placeholder="45" />
          </div>
        </CollapsibleContent>
      </Collapsible>
    );
...
export const NestedCollapsibles: Story = {
  render: () => {
    ...
    return (
      <Collapsible open={isParentOpen} onOpenChange={setIsParentOpen} className="w-96 space-y-2 border p-4">
        <div className="flex items-center justify-between">
