...
\newcommand{\initialSchemeContent}{
  \scriptCall{\kaginSchemeIcon}{10,1}{\begin{bmatrix}3\\6\\9\end{bmatrix}}}
...
\begin{tikzpicture}[rounded corners]
    ...
    \node[semioTermText,left=\horizontalSpacing of iS,align=right] (iSD) {INITIAL \\ SCHEME};
    ...
    \node[semioTermText,right=\horizontalSpacing of bNRC, align=center] (sD) {A\\R\\R\\A\\N\\G\\E\\M\\E\\N\\T};
    ...
    \node[semioTermText,below=\verticalSpacing*2+1 of iSB.south west,anchor= north west,align=left] (iLIT) {I\\N\\I\\T\\I\\T\\A\\L};
    \node[semioTermText,right=0 of iLIT.south east,anchor= south west,align=left] (iLLT) {L\\A\\Y\\O\\U\\T};
    ...
    \node[semioTermText,right=\horizontalSpacing+0.35 of bNDbB.east,anchor=east,align=center] (DD) {D\\E\\S\\I\\G\\N};
\end{tikzpicture}   
