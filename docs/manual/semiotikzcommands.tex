...
\tikzset{
    ...
    definitionDrawingPointAnnotation/.style={draw,cross out,semioSenaryColor,font=\tiny,minimum size=0,inner sep=1pt},
    definitionDrawingLinearAnnotation/.style={semioSenaryColor,|<->|,font=\tiny,minimum size=0,inner sep=1pt},
    % curly brace doesn't work as style somehow
	definitionDrawingCountAnnotation/.style={decorate,decoration={brace,mirror},semioSenaryColor,font=\tiny},
	definitionDrawingCurveAnnotation/.style={semioSenaryColor,font=\tiny,minimum size=0,inner sep=1pt},
    definitionDrawingTextAnnotation/.style={semioSenaryColor,font=\tiny,minimum size=0,inner sep=1pt},
