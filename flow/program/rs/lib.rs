//! 🌊 Flow program — declarative flow play app bundled as a hot-swappable WASM program.
...
fn register_flow_exports() {
    semio_framework_program::program_runtime::register_document_codec_for_app::<FlowPlayApp>(FLOW_DOCUMENT_SCHEMA);
}
//#endregion 🔖PackCodec
