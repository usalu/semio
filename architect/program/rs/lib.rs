//! 🏛️ Architect program — architectural program DocumentApp bundled as a hot-swappable WASM program.
...
fn register_architect_exports() {
    semio_framework_program::program_runtime::register_document_codec_for_app::<ArchitectApp>(ARCHITECT_PROGRAM_SCHEMA);
}
...
mod tests {
    use super::*;
    use semio_framework_program::HistoryView;
