...
def main():
    ...
    # Region format: // #region 🔖️ComponentName_stories_tsx
    ...
    for i, line in enumerate(result_lines):
        ...
        region_start = re.match(r"^// #region 🔖️(\w+_stories_tsx)$", stripped)
        if region_start:
        ...
        region_end = re.match(r"^// #endregion 🔖️(\w+_stories_tsx)$", stripped)
        if region_end:
