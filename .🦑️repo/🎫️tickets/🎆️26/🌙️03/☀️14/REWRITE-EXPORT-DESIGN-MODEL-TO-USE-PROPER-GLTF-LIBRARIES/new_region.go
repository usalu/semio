// #region 🔖️ExportDesignModel/Helpers

// exportPlaneToGltfMatrix converts a Plane to a column-major 4x4 matrix for gltf.Node.Matrix.
// [🏘️compose📚️go💻️compose🔖️exportdesignmodel🛠️exportplanetogltfmatrix](repo://p/u/compose/b/l/go/f/compose.go/s/Export%20Design%20Model/d/i/exportPlaneToGltfMatrix)
...
// [🏘️compose📚️go💻️compose🔖️exportdesignmodel🛠️exportdensetogltfmatrix](repo://p/u/compose/b/l/go/f/compose.go/s/Export%20Design%20Model/d/i/exportDenseToGltfMatrix)
...
// [🏘️compose📚️go💻️compose🔖️exportdesignmodel🛠️exportdecodeblobtobytes](repo://p/u/compose/b/l/go/f/compose.go/s/Export%20Design%20Model/d/i/exportDecodeBlobToBytes)
...
// [🏘️compose📚️go💻️compose🔖️exportdesignmodel🛠️exportcreatebox](repo://p/u/compose/b/l/go/f/compose.go/s/Export%20Design%20Model/d/i/exportCreateBox)
...
// [🏘️compose📚️go💻️compose🔖️exportdesignmodel🛠️exportcopymeshfromglb](repo://p/u/compose/b/l/go/f/compose.go/s/Export%20Design%20Model/d/i/exportCopyMeshFromGLB)
...
// [🏘️compose📚️go💻️compose🔖️exportdesignmodel🛠️exportfindmodelforkind](repo://p/u/compose/b/l/go/f/compose.go/s/Export%20Design%20Model/d/i/exportFindModelForKind)
...
// #endregion 🔖️ExportDesignModel/Helpers

// ExportDesignModel exports the 3D model of a design to GLB or glTF format.
// [🏘️compose📚️go💻️compose🔖️exportdesignmodel🛠️exportdesignmodel](repo://p/u/compose/b/l/go/f/compose.go/s/Export%20Design%20Model/d/i/ExportDesignModel)
func ExportDesignModel(kit *Kit, designGuid string, format string, tags []string, options map[string]interface{}) ([]byte, error) {
	...
	// #region 🔖️ExportDesignModel/BuildGLTF
	...
	// #endregion 🔖️ExportDesignModel/BuildGLTF
}

// #endregion 🔖️ExportDesignModel
