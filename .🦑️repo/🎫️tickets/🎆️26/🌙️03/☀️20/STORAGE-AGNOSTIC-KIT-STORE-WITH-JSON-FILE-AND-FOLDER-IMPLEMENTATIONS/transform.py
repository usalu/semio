...
for i in range(6356, min(7800, total)):
    line = lines[i]
    if '// #endregion 🔖️KitStore Interface Implementation' in line:
...
output.append("\n")
output.append("// [🏘️compose📚️js🗃️sketchpad💻️sketchpad🔖️kit](composerepo://p/u/compose/b/l/js/fd/org/sketchpad/f/Sketchpad.tsx/s/Kit)\n")
