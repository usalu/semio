...
- `semio-s-plugin-norm`: **32 → 0 warnings, 0 errors** (`lib`; had already dropped from the
  ...
  deleted.
- stdio, trinity+remodel, block+forms+framework-plugin, fem+gis+cad+surface still running as of
  this note (fem+gis+cad+surface and trinity+remodel were resumed once after stalling — see below).
