"use components";
import { backbonePoll, backboneSend } from './🟨️host-shim.js';
...
const _trampoline13 = function(arg0, arg1, arg2, arg3, arg4) {
  var ptr0 = arg0;
  var len0 = arg1;
...
_trampoline13.fnName = 'semio:framework/host#backboneSend';
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./semio_s_plugin_flow_extension_bim_component.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABHwVgBX9/f39/AGADf39/AGABfwBgAn9/AGAEf39/fwACSAwAATAAAAABMQABAAEyAAIAATMAAQABNAADAAE1AAQAATYAAwABNwACAAE4AAIAATkAAgACMTAAAgAIJGltcG9ydHMBcAELCwkRAQBBAAsLAAECAwQFBgcICQoALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI1Mi4w');
