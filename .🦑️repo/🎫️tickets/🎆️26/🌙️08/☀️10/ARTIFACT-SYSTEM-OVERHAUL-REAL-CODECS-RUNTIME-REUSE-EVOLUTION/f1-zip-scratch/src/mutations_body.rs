use super::diff::{self, ZipDiff};
use super::{ZipCompressionMethod, ZipEntry, ZipExtraField, ZipSnapshot};
use super::Mutation;
...
pub fn apply_zip_mutation(snapshot: &mut ZipSnapshot, mutation: &ZipMutation) -> ZipDiff {
    let __diff = <ZipMutation as Mutation<ZipSnapshot>>::diff(mutation, snapshot);
...
mod tests {
    use super::*;
    use super::super::diff::ZipEntriesDiff;
    use super::super::{MutationDiff, DiffAlgebra};
