//! 📥️ @LABEL@ play app — the inputs window: the raw compliance document, rendered as JSON.

use crate::artifacts::@MOD@::Document;
use semio_framework_plugin::{LocalizedLabel, UiNode, WindowKindDefinition};

//#region 🔖️Constants
pub const WINDOW_INPUTS: &str = "norm-@VARIANT@-inputs";
pub const BODY_INPUTS: &str = "norm.@VARIANT@.play.inputs";
