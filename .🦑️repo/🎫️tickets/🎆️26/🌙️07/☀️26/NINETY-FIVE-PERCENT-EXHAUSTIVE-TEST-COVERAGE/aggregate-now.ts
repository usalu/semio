#!/usr/bin/env bun
/** 📊️Runs the same aggregation TestScript.enforceCoverageGate uses, against whatever .repo/coverage/ currently
...
writeFileSync(join(".repo/🎫️/26/07/26/NINETY-FIVE-PERCENT-EXHAUSTIVE-TEST-COVERAGE", "phase-a-partial-summary.json"), JSON.stringify(summary, null, 2));
