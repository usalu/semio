...
ROOTS = ["🧰️framework", "✏️s", "🌎️hub", "♻️mit-bestand"]
...
EXCLUDE_PATH_PREFIXES = [
    ...
    "♻️mit-bestand/präsentation/33.projektetage/⚡️/🟦️/slide/",
    "🧰️framework/🛍️product/🦑️repo/🔨️module/🖥️server/🎛️coordinator/⚡️implementation/🟦️typescript/app",
    "🧰️framework/🔨️module/🖱️ui/⚡️implementation/🔷️dotnet/🎨️styling/Elements.Styling",
]
...
FILE_VOCAB = {
    "build.rs": "📦️build.rs",
    "vitest.config.ts": "🧪️vitest.config.ts",
    "vite.config.ts": "⚙️vite.config.ts",
    "postcss.config.ts": "🎨️postcss.config.ts",
    "tailwind.config.ts": "🎨️tailwind.config.ts",
    "index.html": "🌐️index.html",
    "index.test.ts": "🧪️index.test.ts",
    "generated.rs": "🤖️generated.rs",
    "generated.py": "🤖️generated.py",
    "schema.graphql": "🔗️schema.graphql",
    "schema.sql": "🛢️schema.sql",
    "go.work.sum": "🐹️go.work.sum",
    "CNAME": "🌐️CNAME",
    "Dockerfile": "🐳️Dockerfile",
    "Caddyfile": "🌐️Caddyfile",
    "__init__.py": "🐍️__init__.py",
}
...
def proposed_new_name(relpath: str, name: str):
    ...
    if ext:
        ...
        if name.endswith(".manifest.json"):
            return "🛂️manifest.json" if name == "manifest.json" else "🛂️" + name
    if "." in name:
        return "📎️" + name
    return "📎️" + name
