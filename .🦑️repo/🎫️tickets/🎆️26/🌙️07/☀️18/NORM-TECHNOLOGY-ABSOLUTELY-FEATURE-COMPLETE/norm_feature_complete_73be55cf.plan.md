...
- **Ticket:** Reopen `26/07/18/NORM-TECHNOLOGY-FULL-FAMILY-CRATES` (or open a follow-up under goal `🎯️norm`) with this plan_id; keep scratch/logs only in the ticket folder.
