/** @emoji 🧪️ Playground window/mode completeness audit helpers. */
...
/** @emoji ✅️ Returns human-readable failures for incomplete playground shells. */
...
/** @emoji 🔎️ Audits every known playground controller shell. */
