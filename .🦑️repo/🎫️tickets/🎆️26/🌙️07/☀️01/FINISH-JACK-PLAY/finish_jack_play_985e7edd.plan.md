...
- Runtime verify: launch `🛠️dev🔺️trinity🃏️jack` (port 6054) — zoom changes LOD label in window chrome, wheel zoom works, table fixture fills Results, graph fixture shows graph in Results, CREATE query updates main graph.
