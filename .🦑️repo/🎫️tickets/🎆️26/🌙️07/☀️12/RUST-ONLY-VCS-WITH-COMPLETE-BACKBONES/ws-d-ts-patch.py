...
/** @emoji 🎁️ The undo group binding an action invocation to its operations + inverses. */
...
/**
 * @emoji 📤️ Typed result of a plugin `handle-action` call — mirrors the Rust `ActionResult`. Replaces
...
/** @emoji 📥️ Parses a raw plugin `handle-action` response string into a typed {@link ActionResponse}. */
...
/** @emoji 🔧️ Normalizes plugin action responses into legacy JSON patch op strings. */
