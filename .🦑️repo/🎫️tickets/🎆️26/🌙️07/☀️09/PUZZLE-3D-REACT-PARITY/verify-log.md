...
- `.repo/🎫️/26/07/09/PUZZLE-3D-REACT-PARITY/wasm-verify.ts` — fill round-trip value 4
...
- Puzzle wasm rebuilt clean: `SEMIO_PLUGIN=puzzle bun ./📜️script.ts plugin` → `puzzle_plugin_component.core.wasm` produced.
