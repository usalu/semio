#!/usr/bin/env bun
/** 🔍️ Debug brush candidates in wasm runtime. */
...
const pickOps = await handle.handleCommand(instanceId, JSON.stringify({ controllerId: "puzzle3d-play", command: "worldPick", args: { granularity: "mesh", id: 0, merge: "replace" } }), viewState);
...
await handle.handleCommand(instanceId, JSON.stringify({ controllerId: "puzzle3d-play", command: "worldVortexHover", args: { fullId } }), viewState);
