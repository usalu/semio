...
- `framework/product/os/hub/project.json` — `test` target calls `bun ./📜️script.ts test`.
...
file was created:
- `.repo/🎫️/26/07/17/OVERHAUL-TEST-SUITES-TO-30S-BUDGET-PER-APP/report-os-hub.md`
