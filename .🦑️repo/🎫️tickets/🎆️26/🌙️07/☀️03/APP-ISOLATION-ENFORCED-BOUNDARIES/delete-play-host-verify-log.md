...
- [x] All 23 `play-host.tsx` deleted; content merged into `react/index.tsx` `//#region 🔖️PlayHost`
...
All now export `*AppRenderer` from main `index.tsx` `//#region 🔖️PlayHost` with async factory + lazy core import where core↔react cycles exist.
