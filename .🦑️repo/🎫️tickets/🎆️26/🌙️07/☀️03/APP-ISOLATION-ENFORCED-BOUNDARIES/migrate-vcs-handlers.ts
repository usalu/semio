...
const handlers: Record<string, string> = {
  createFlowDagAppVcsHandler: `/** @emoji 🌳️ S app VCS handler for DAG documents. */
export function createFlowDagAppVcsHandler() {
  ...
  createProcedural2dAppVcsHandler: `/** @emoji 📏️ S app VCS handler for procedural 2d documents. */
export function createProcedural2dAppVcsHandler() {
  ...
  createProcedural3dAppVcsHandler: `/** @emoji 📐️ S app VCS handler for procedural 3d documents. */
export function createProcedural3dAppVcsHandler() {
  ...
  createTrinityGraphAppVcsHandler: `/** @emoji 🔺️ S app VCS handler for trinity graph documents. */
...
export function createGisMapAppVcsHandler() {
  ...
  createPuzzle2dAppVcsHandler: `/** @emoji 🩻️ S app VCS handler for puzzle 2d documents. */
...
export function createVcsDemoAppVcsHandler() {
  ...
  createCadSceneAppVcsHandler: `/** @emoji 📐️ S app VCS handler for cad scene documents. */
