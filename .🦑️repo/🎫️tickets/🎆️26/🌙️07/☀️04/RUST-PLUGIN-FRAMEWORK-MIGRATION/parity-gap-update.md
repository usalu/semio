...
cd framework/product/os/dev && SEMIO_PLUGIN=s SEMIO_RENDERER=react S_OS_PORT=6070 bun ./📜️script.ts dev

# E2E:
S_STUDIO_URL=http://127.0.0.1:6070/ node .repo/🎫️/26/07/04/RUST-PLUGIN-FRAMEWORK-MIGRATION/s-studio-e2e-verify.mjs
