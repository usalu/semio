#!/usr/bin/env node
/** @emoji 🌊️ Flow wgpu node-graph parity smoke: build, serve, fetch boot. */
...
const port = process.env.S_OS_PORT ?? "6321";
const host = "127.0.0.1";
const baseUrl = `http://${host}:${port}/?plugin=flow`;
...
run(["framework/product/os/dev/📜️script.ts", "plugin", "flow"], {
...
const pluginJs = join(dist, "plugin-modules/flow/flow_plugin.js");
