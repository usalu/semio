...
- `bun ./📜️script.ts build forschungsbericht` — OK
- `bun ./📜️script.ts build report report-dark` — OK (prior run)
...
- `bun ./📜️script.ts build zwischenbericht forschungsbericht kompaktbericht` — OK
