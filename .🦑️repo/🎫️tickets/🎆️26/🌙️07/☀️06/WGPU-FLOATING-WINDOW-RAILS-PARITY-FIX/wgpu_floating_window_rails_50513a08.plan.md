...
Reopen `.repo/🎫️/26/07/06/WGPU-GLASS-PANEL-CRISPNESS-FIX` (closed today, directly covers "window measures/engagement rails" glass migration) rather than opening a new ticket, per repo convention for continuing directly-related work.
