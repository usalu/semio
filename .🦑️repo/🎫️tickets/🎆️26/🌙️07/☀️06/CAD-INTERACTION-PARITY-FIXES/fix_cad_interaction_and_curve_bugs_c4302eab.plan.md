...
- Work happens inside the existing (closed) ticket `.repo/🎫️/26/07/06/CAD-WGPU-PREMIGRATION-PARITY` — reopen it via `ticket_reopen` before implementing, per repo convention.
