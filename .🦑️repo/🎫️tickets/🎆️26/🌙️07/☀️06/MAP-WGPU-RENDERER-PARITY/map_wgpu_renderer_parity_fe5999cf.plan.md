...
- Open a repo-MCP ticket under the `🎯️gis🎯️map` goal (same goal as the closed `MAP-HOVER-SELECTION-CONTEXT-MENU-PANNING` ticket), keep all temp scripts/logs in its folder.
