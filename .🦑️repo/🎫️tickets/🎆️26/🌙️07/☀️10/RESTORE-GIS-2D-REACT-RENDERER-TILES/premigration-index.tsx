...
/** @emoji 📶️ GIS map LOD band from WASM {@link MapSession.lodScaleJson}. */
...
/** @emoji 📶️ Window LOD select value (`automatic` or a pinned band id). */
...
/** @emoji 📶️ Fixed LOD table declared in GIS map WASM (single source of truth). */
...
/** @emoji 📶️ Automatic LOD select row label showing the live zoom-derived band. */
...
/** @emoji 🔭️ Wheel/pan zoom bounds from GIS map WASM (cover min depends on viewport size). */
...
/** @emoji 🎨️ Serializes UI semantic CSS (`--canvas`, `--foreground`, accents) for WASM map Vello paints. */
...
/** @emoji 🛝️ Map app renderer contribution for playground and OS shells. */
