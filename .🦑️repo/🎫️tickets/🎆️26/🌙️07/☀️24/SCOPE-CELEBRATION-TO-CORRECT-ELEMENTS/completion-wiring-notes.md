...
Shared path lives next to `celebrateElements` in `ui/js/react/index.tsx` 🧭️ElementState; controls call it from their click handlers after applying the interaction.
