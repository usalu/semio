...
| #   | Line | URI                               | Code                                                                                                                                                                               |
| --- | ---- | --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 6   | 4495 | `composerepo://file/test/file.ts` | `header := lang.FormatHeader("💻️test/file.ts", "composerepo://file/test/file.ts", "A test file", "2025 Test User <test@test.com>", "AGPL license text here", "Some requirements")` |
...
| #   | Line | URI                               | Code                                                                                                                              |
| --- | ---- | --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| 7   | 4521 | `composerepo://file/test/file.go` | `header := lang.FormatHeader("💻️test/file.go", "composerepo://file/test/file.go", "", "2025 Dev <dev@dev.com>", "AGPL text", "")` |
...
| #   | Line | URI                            | Code                                                                                                               |
| --- | ---- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| 8   | 4543 | `composerepo://file/test/file` | `header := lang.FormatHeader("💻️test/file", "composerepo://file/test/file", "", "2025 Dev <d@d.com>", "AGPL", "")` |
| 9   | 4557 | `composerepo://file/test/file` | `header := lang.FormatHeader("💻️test/file", "composerepo://file/test/file", "", "2025 Dev <d@d.com>", "AGPL", "")` |
...
| 139 | 11993 | `composerepo://goals`    | `{Kind: TreeNodeCategory, ID: "goals", Label: "🎯️Goals", URI: "composerepo://goals"},`                                |
...
| 141 | 12065 | `composerepo://goals`    | `{Kind: TreeNodeCategory, ID: "goals", Label: "🎯️Goals", URI: "composerepo://goals", Children: []*TreeNode{`          |
