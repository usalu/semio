...
2. Updated emoji constants (added EmojiInteractions, EmojiInteractionStarted, EmojiInteractionFinished, EmojiInteractionRestarted, EmojiInteractionDeleted, changed EmojiFolderRequired to 🛅️)
...
- project: 🏗️🏘️compose (entity=🏗️, kind=👤️, value=compose)
- bundle: 📦️📚️compose/js (entity=📦️, kind=📚️, value=compose/js)
- folder: 📁️🛅️compose/js/src (entity=📁️, kind=🛅️, value=compose/js/src)
- file: 📄️💻️main.go (entity=📄️, kind=💻️, value=main.go)
- definition: 🏷️🛠️file.ts#Section§myFunc (entity=🏷️, kind=🛠️, value=file.ts#Section§myFunc)
- ticket: 🎫️20250204test-ticket (entity=🎫️, YYYYMMDD+slug, no separators)
- policy: 🛡️code-hygiene (entity=🛡️, no leading /)
- interaction: ⚡️🌱️🎫️20260214TICKET (entity=⚡️, kind=🌱️, inner entity ID)
