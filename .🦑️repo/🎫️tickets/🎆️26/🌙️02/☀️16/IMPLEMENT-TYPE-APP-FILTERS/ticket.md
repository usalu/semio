...
- ✓️ Added useSearchParams import from react-router
- ✓️ Created TypeKindToggles component with connector/model filters using Toggle components
- ✓️ Registered toolbar filter section with proper order and specificity
- ✓️ Added translations to en.json
- ✓️ Added translations to de.json
- ✓️ Verified no TypeScript errors in Type.tsx
...
1. ✓️ Study Design app toolbar filter section registration pattern
2. ✓️ Study Kit app KitKindToggles component
