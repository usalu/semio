...
- Pieces with null/undefined center (never dragged): use computedChildCenter (auto-layout) ✓️
- Pieces with stored center (dragged): use stored center (preserves drag position) ✓️
- Root pieces: unaffected (not in BFS child processing) ✓️
