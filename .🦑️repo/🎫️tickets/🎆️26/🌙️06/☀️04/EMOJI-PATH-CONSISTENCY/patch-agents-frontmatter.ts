...
const areaPath: Record<string, string> = {
  ...
  "mathematical/graph/port/directed": "🧮️mathematical⭕️graphs",
  "mathematical/graph/port/undirected": "🧮️mathematical⭕️graphs",
  "mathematical/graph/normal/directed": "🧮️mathematical⭕️graphs",
  "mathematical/graph/normal/undirected": "🧮️mathematical⭕️graphs",
};
