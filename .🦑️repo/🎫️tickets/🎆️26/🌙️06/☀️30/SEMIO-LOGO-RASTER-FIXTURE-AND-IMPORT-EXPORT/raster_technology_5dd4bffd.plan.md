...
- `[framework/core/index.ts](framework/core/index.ts)`: add `#region 🔖️RasterPlayHover` with `RasterKindHoverDomain` (`layer`|`group`|`mask`|`adjustment`) + `RasterKindHover` (parallel to `Puzzle2dKindHover` at lines ~851-890).
