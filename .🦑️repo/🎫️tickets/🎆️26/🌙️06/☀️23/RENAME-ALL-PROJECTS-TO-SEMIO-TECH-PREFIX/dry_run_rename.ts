...
const mappings = JSON.parse(readFileSync(".repo/🎫️/26/06/23/RENAME-ALL-PROJECTS-TO-SEMIO-TECH-PREFIX/mappings.json", "utf8"));
...
writeFileSync(".repo/🎫️/26/06/23/RENAME-ALL-PROJECTS-TO-SEMIO-TECH-PREFIX/dry_run_diff_summary.txt", diffOutput);
...
`;
writeFileSync(".repo/🎫️/26/06/23/RENAME-ALL-PROJECTS-TO-SEMIO-TECH-PREFIX/apply_changes.ts", applyScript);
