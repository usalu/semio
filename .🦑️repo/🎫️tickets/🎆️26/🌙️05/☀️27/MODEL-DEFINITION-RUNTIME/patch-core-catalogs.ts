...
s = s.replace(
  `/** @emoji 📚️ Built-in extension manifest (\`spatial/assets/extension/builtin/extension.json\`). */
...
/** @emoji 📚️ Lists typology assets shipped under \`spatial/assets/extension/builtin/typology/**\`. */
export function listBuiltinTypologies(): readonly TypologySpec[] {
  return builtinTypologyCatalog();
}`,
  `/** @emoji 📚️ Geometry model-definition manifest (\`spatial/assets/modelDefinition/geometry/extension.json\`). */
...
/** @emoji 📚️ Lists typologies from shipped \`spatial/assets/modelDefinition/**\` assets. */
export function listModelDefinitionTypologies(): readonly TypologySpec[] {
  return shippedTypologyCatalog();
}

/** @emoji 📚️ Lists typology assets shipped under geometry model definition (alias). */
export function listBuiltinTypologies(): readonly TypologySpec[] {
...
/** @emoji 📚️ Lists declarative actions from model-definition assets (alias). */
export function listBuiltinActionSpecs(): readonly ActionSpec[] {
...
s = s.replace(`/** @emoji 📚️ Host-facing built-in interaction row (\`spatial/assets/extension/builtin/interaction/<group>/*.json\`). */`, `/** @emoji 📚️ Host-facing interaction row (\`spatial/assets/modelDefinition/**/interaction/*.json\`). */`);

s = s.replace(`/** @emoji 📚️ Built-in interaction ids for host interaction surfaces (\`spatial/assets/extension/builtin/interaction/<group>/*.json\`). */`, `/** @emoji 📚️ Interaction ids from shipped model-definition assets. */`);
