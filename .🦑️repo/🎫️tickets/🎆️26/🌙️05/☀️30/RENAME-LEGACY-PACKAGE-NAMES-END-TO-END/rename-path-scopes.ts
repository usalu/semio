...
const roots = ["ui", "framework", "puzzle", "cad", "compose", "coda", "repo", ".storybook", ".vscode", "package.json", "script.ts", "project.json", "nx.json", "eslint.config.mjs", "Monorepo.sln", "tsconfig.json"];
