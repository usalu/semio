...
const shellChrome = `//#region 📦️shell-chrome-types.tsx

/** @emoji 👣️ Footer row rendered by the workbench shell. */
...
/** @emoji 🌲️ Minimal tree panel payload for declarative side tabs. */
...
/** @emoji 📑️ Side panel tab registration consumed by {@link WorkbenchView}. */
...
//#endregion 📦️shell-chrome-types.tsx

//#region 📦️shell-canvas.tsx
/** @emoji 🖼️ Golden-layout shell: layouts, canvas portals, toolbar, search, and find. */
${domBinding}
${shell}
