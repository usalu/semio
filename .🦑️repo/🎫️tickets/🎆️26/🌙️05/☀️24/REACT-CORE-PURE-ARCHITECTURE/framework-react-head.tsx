...
/** @emoji ­ƒî▓️ Minimal tree panel payload for declarative side tabs. */
...
/** @emoji ­ƒº░️ Toolbar item for a single category slot. */
...
/** @emoji ­ƒº░️ Toolbar category ids shared by framework shell tool maps. */
...
/** @emoji ­ƒº╣️ Drops a surface binding (tests). */
...
/** @emoji ­ƒº╣️ Drops a board surface binding (tests). */
...
/** @emoji ­ƒº╣️ Drops a table surface binding (tests). */
...
/** @emoji ­ƒº╣️ Drops a panel surface binding (tests). */
...
/** @emoji ­ƒû╝️ Registers a static icon node resolved by `iconId` for toolbars, footers, and tabs. */
...
/** @emoji ­ƒû╝️ Registers a Lucide icon constructor for side-panel tab headers keyed by `iconId`. */
...
/** @emoji ­ƒº░️ Converts framework toolbar maps into React toolbar items. */
