...
//#region ­ƒÄÆKit
/**
 * @emoji ­ƒÄÆ Stateless kit fa├️ºade: owns {@link GqlTransport} + {@link EventBus}; every read is a fresh GraphQL round-trip.
 */
export class Kit {
...
//#endregion ­ƒîìPlace
//#region ­ƒù║️´©ÅLocation
export interface LocationWire {
  readonly latitude: number;
  readonly longitude: number;
}
//#endregion ­ƒù║️´©ÅLocation
//#region ­ƒôÀCamera
