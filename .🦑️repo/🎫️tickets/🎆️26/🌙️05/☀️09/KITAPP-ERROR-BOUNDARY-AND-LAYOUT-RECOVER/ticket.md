...
**Files:** `compose/sketchpad/index.tsx`, `.repo/🎫️/26/05/09/KITAPP-ERROR-BOUNDARY-AND-LAYOUT-RECOVER/ticket.md`

**Tests:** Extended Playwright `sketchpad › Kit` to assert zero `data-testid="compose.sketchpad.kit-app.error-boundary-fallback"` after metabolism label is visible. Full `npm test` in this workspace still reports unrelated failures (fixture Zod, Home selection, folder kit tests); not attributed to this change.
