/** @emoji 🔄️ Wrap brep refs/records in export namespace kernelGeometry in core/index.ts. */
...
if (!s.includes("export namespace kernelGeometry")) {
  s = s.replace(
    "// #region 🪪️Refs\n/** @emoji 🪪️ Opaque branded string ids for editable topology entities. */\nexport type AnchorRef",
  ...
  s = s.replace("/** @emoji 🧱️ Editable topology kinds from `spatial/AGENTS.md`. */\nexport type EditableEntityKind =", "/** @emoji 🧱️ Kernel-private geometry entity kinds for selection and query adapters. */\nexport type EditableEntityKind =");
}
...
if (!s.includes("export namespace kernelGeometry") || s.indexOf("export namespace kernelGeometry") === s.lastIndexOf("export namespace kernelGeometry")) {
  s = s.replace("// #region 🧱️ModelGeometry\n/** @emoji 🧱️ Kernel-private vertex payload", "export namespace kernelGeometry {\n// #region 🧱️ModelGeometry\n/** @emoji 🧱️ Kernel-private vertex payload");
  s = s.replace(
