...
const path = "c:/git/compose/puzzle/2d/react/index.tsx";
let c = readFileSync(path, "utf8");
const start = c.indexOf("/** @emoji 🛝️ Board play React host");
...
import {
	...
	BOARD_PLAY_DOCUMENT_TAB_ID,
	BoardPlayShellController,
	buildBoardPlayDocumentSections,
