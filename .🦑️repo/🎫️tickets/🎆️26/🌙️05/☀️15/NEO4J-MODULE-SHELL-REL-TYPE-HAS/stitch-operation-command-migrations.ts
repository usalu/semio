#!/usr/bin/env bun
/**
 * @emoji 🧷️ Inlines generated Neo4j fragments into `migrations.cypher` (operation `Command` relabel/merge/dedupe/reparent + imperative renames + `Data` argument kit from golden `*Input`).
 */
