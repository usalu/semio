...
### 1. Layer and Group GUID Generation ✅️ FIXED
...
### 2. Port Compatible Property Name Mismatch ✅️ FIXED
...
### 3. Missing Prop.key in Connector Props ✅️ FIXED
...
### 4. Design Props Missing GUID ✅️ FIXED
...
1. ✅️ Fix layer GUID preservation in `kitToSqlite`
2. ✅️ Fix group GUID preservation in `kitToSqlite`
3. ✅️ Fix port compatible ports naming
4. ✅️ Fix prop key handling for connector props
5. ✅️ Add design_prop table GUID column
6. ⏳️ Fix date serialization (keep as strings in SQL, return as strings or Date objects consistently)
7. ⏳️ Fix empty string vs undefined (preserve original format or normalize consistently)
8. ⏳️ Fix optional properties (don't add undefined properties that weren't in original)
