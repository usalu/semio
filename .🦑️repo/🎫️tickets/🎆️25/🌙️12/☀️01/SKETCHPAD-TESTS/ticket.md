...
1. ✅️ Fix Settings Panel Document tests - reorder panels so SETTINGS is first
2. ✅️ Add data-panel attribute to Panel component
3. ✅️ Fix ToolGroup to use tool ID instead of mode ID
4. ⏳️ Investigate remaining Settings Panel failures (Kit, Design, Type)
5. ⏳️ Fix toolbar tests for Type app
6. ⏳️ Address performance issues in Kit Import test
