...
- Refactored `README.md` monorepo docs: moved Sketchpad implementation details into `compose/js`, expanded Ecosystems with workspace + preflight examples, fixed repo path links (`net/`, `py/`, `js/compose`, `js/desktop`, `js/play`).
