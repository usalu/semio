...
- `#region 🔖️File Collection` - Shared file collection logic
- `#region 🔖️Regenerate Zip` - Zip generation and copying
- `#region 🔖️Generate Diff` - Diff file generation
- `#region 🔖️Generate Validation` - Validation JSON generation
- `#region 🔖️App` - React UI component
