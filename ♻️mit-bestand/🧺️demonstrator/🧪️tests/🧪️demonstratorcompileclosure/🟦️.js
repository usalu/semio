...
function registerTests1(vitest) {
    return __awaiter(this, void 0, void 0, function () {
        var describe, expect, it, repoRoot, cargoPath, cargo;
        return __generator(this, function (_a) {
            describe = vitest.describe, expect = vitest.expect, it = vitest.it;
            repoRoot = (0, node_path_1.join)((0, node_path_1.dirname)((0, node_url_1.fileURLToPath)(import.meta.url)), "../../../..");
            cargoPath = (0, node_path_1.join)(repoRoot, "✏️s/🔌️plugins/🎪️demonstrator/📦️packages/🦀️rust/Cargo.toml");
            cargo = (0, node_fs_1.readFileSync)(cargoPath, "utf8");
            describe("demonstratorCompileClosure", function () {
                it("does not link whole puzzle, procedural, or gis plugin composition crates", function () {
                ...
                it("links only the artifact crates used by the eight demonstrator panes", function () {
