...
Der Anhang überführt die im Haupttext entwickelte Unterscheidung von Typologie und Entwurfsrolle in eine Arbeitsstruktur für tragende und tragwerksnahe Bauteile. Maßgeblich sind die nach Ausbau oder Zuschnitt erhaltene Form und der konstruktive Zusammenhang. Die Zuordnung ist in \tableref{tab:typologien-lineare}, \tableref{tab:typologien-flaechige}, \tableref{tab:typologien-knoten} und \tableref{tab:typologien-rahmen} dokumentiert; sie stellt weder eine bestätigte Eignung noch einen fachlichen Nachweis dar. Der abschließende Leseschlüssel erläutert Begriffe und Abgrenzungen.
