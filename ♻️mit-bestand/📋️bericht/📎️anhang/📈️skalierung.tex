...
\SemioVizCellGrid{sk-dimension}[label=label, columns=6, boxHeight=7.5]
\end{VizSection}

\begin{VizSection}[title={G \ EVIDENZPFADE \ \textperiodcentered\ \ durchgezogen belegt, gestrichelt analytisch (E3)}]
\SemioVizStageChain{sk-evidenz}[chip=chip, stages={s1,s2,s3,s4}, boxHeight=4.7]
\end{VizSection}
...
\SemioVizCellGrid{sk-prozess}[label=label, key=key, scale=d2r, boxHeight=14.5]
\end{VizSection}
...
\SemioVizSpanRows{sk-funktion}[label=label, from=von, to=bis, scale=d2r, boxHeight=2.4, labelWidth=25]
\end{VizSection}
...
\SemioVizSpanRows{sk-dienst}[label=label, from=von, to=bis, scale=d2r, boxHeight=2.4, labelWidth=25]
\end{VizSection}
...
\SemioVizCellGrid{sk-rahmen}[label=label, columns=5, boxHeight=6.6]
\end{VizSection}

\begin{VizSection}[title={H1 \ UNTERSTÜTZUNG (EU26)}]
\begin{VizColumn}[width=72, note={19 Antworten, 10 Länder; n\,=\,18 abgeleitet}]
\SemioVizChart{horizontal-bar-chart}[data=sk-h1, x=label, y=value, yMin=0, yMax=100, labels=value, grid=none, padLeft=38]
\end{VizColumn}
\begin{VizColumn}[width=70, title={H2 \ HEMMNIS-KOPPLUNG}, note={C-Index (Jaccard), sign. Paare, Rakhshan 2020}]
\SemioVizRunFamily{heatmap}[data=sk-h2, rowcol=zeile, colcol=spalte, valuecol=value, sparse=true, annotate=true, labels=true]
\coordinate (sk-h2-end) at (0, -26);
...
\SemioVizChart{horizontal-bar-chart}[data=sk-h3, x=label, y=value, labels=value, grid=none, padLeft=38]
\end{VizColumn}
