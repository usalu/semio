...
Für ein Reuse-Werkzeug ist zwischen werkstofflichem Recycling und der Wiederverwendung eines konkreten Bauteils zu unterscheiden. Bei der Bauteilwiederverwendung kommt es darauf an, welche Materialkennwerte und Angaben zur Tragfähigkeit verfügbar und belastbar sind.
...
Für die Entwurfsbewertung sind neben der Leistungsfähigkeit auch der Nachweisaufwand und die Anschlussfähigkeit an übliche Planungsprozesse relevant.
...
Die Aussage skizziert eine mögliche konfigurierbare Anschlusslogik. Ein digitales Reuse-Werkzeug könnte die Auswahl eines Anschlussprinzips unterstützen und die dafür benötigten Angaben benennen.
