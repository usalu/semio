/*! For license information please see 🟨️vendors~scripts~projectsMap.js.LICENSE.txt */
      ...
      !(function (t, n) {
        ...
        var k = (function (e) {
          var t,
            ...
            ie = function (e, t) {
              return t ? ("\0" === e ? "�️" : e.slice(0, -1) + "\\" + e.charCodeAt(e.length - 1).toString(16) + " ") : "\\" + e;
            },
            oe = function () {
              p();
            },
            ...
            (a = se.tokenize =
              function (e, t) {
                ...
                for (s = e, u = [], l = r.preFilter; s; ) {
                  for (a in ((n && !(i = _.exec(s))) || (i && (s = s.slice(i[0].length) || s), u.push((o = []))), (n = !1), (i = z.exec(s)) && ((n = i.shift()), o.push({ value: n, type: i[0].replace(B, " ") }), (s = s.slice(n.length))), r.filter))
                          ...
                          l = function () {
                            ...
                            if (!(e < o)) {
                              ...
                              ((l = r && ("object" == typeof r || "function" == typeof r) && r.then),
                                y(l) ? (i ? l.call(r, a(o, t, W, i), a(o, t, F, i)) : (o++, l.call(r, a(o, t, W, i), a(o, t, F, i), a(o, t, W, t.notifyWith)))) : (n !== W && ((s = void 0), (u = [r])), (i || t.resolveWith)(s, u)));
                            }
                          },
                          c = i
                            ? l
        ...
        ((E.fn.ready = function (e) {
          ...
          (E.ready.then = _.then),
          "complete" === x.readyState || ("loading" !== x.readyState && !x.documentElement.doScroll) ? r.setTimeout(E.ready) : (x.addEventListener("DOMContentLoaded", z), r.addEventListener("load", z)));
        ...
        function de(e, t) {
          for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
            (r = e[o]).style &&
              ((n = r.style.display), t ? ("none" === n && ((i[o] = K.get(r, "display") || null), i[o] || (r.style.display = "")), "" === r.style.display && le(r) && (i[o] = pe(r))) : "none" !== n && ((i[o] = "none"), K.set(r, "display", n)));
              ...
              for (c = a[a.length - 1].ownerDocument, E.map(a, Pe), f = 0; f < s; f++)
                ((l = a[f]),
                  me.test(l.type || "") &&
                    ...
                    E.contains(c, l) &&
                    (l.src && "module" !== (l.type || "").toLowerCase() ? E._evalUrl && !l.noModule && E._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c) : w(l.textContent.replace(Le, ""), l, c)));
          }
          return e;
        }
        function We(e, t, n) {
        ...
        function Ve(e, t, n) {
          ...
          return (
            (n = n || Be(e)) &&
              ...
              !v.pixelBoxStyles() && Fe.test(a) && ze.test(t) && ((r = u.width), (i = u.minWidth), (o = u.maxWidth), (u.minWidth = u.maxWidth = u.width = a), (a = n.width), (u.width = r), (u.minWidth = i), (u.maxWidth = o))),
            void 0 !== a ? a + "" : a
          );
        }
        function Ge(e, t) {
          ...
          for (; a < 4; a += 2)
            ("margin" === n && (u += E.css(e, n + oe[a], !0, i)),
              r
                ...
                : ((u += E.css(e, "padding" + oe[a], !0, i)), "padding" !== n ? (u += E.css(e, "border" + oe[a] + "Width", !0, i)) : (s += E.css(e, "border" + oe[a] + "Width", !0, i))));
        ...
        function it(e, t, n) {
          ...
          return (
            ((!v.boxSizingReliable() && i) || (!v.reliableTrDimensions() && j(e, "tr")) || "auto" === a || (!parseFloat(a) && "inline" === E.css(e, "display", !1, r))) &&
        ...
        var at,
          ...
          lt = /queueHooks$/;
        function ct() {
          st && (!1 === x.hidden && r.requestAnimationFrame ? r.requestAnimationFrame(ct) : r.setTimeout(ct, E.fx.interval), E.fx.tick());
        }
        function ft() {
          return (
            r.setTimeout(function () {
        ...
        ((E.Animation = E.extend(ht, {
          ...
          E.each({ slideDown: pt("show"), slideUp: pt("hide"), slideToggle: pt("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
            ...
            attr: function (e, t, n) {
              ...
              if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute
                  ? E.prop(e, t, n)
                  : ((1 === o && E.isXMLDoc(e)) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? gt : void 0)),
                    void 0 !== n
                      ? null === n
              ...
              return (
                ...
                i ||
                  ...
                  (l &&
                    y(n[g]) &&
                    !m(n) &&
                    ((s = n[l]) && (n[l] = null), (E.event.triggered = g), e.isPropagationStopped() && p.addEventListener(g, Et), n[g](), e.isPropagationStopped() && p.removeEventListener(g, Et), (E.event.triggered = void 0), s && (n[l] = s))),
                e.result
              );
            }
          },
        ...
        ((Bt.href = St.href),
          E.extend({
            ...
            ajax: function (e, t) {
              ...
              if (
                (v.promise(C), (d.url = ((e || d.url || St.href) + "").replace(It, St.protocol + "//")), (d.type = t.method || t.type || d.method || d.type), (d.dataTypes = (d.dataType || "*").toLowerCase().match(I) || [""]), null == d.crossDomain)
              ) {
                u = x.createElement("a");
                try {
              ...
              (i = d.url.replace(Ot, "")),
              d.hasContent
                ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Ht, "+"))
                : ((p = d.url.slice(i.length)),
                  d.data && (d.processData || "string" == typeof d.data) && ((i += (At.test(i) ? "&" : "?") + d.data), delete d.data),
                  !1 === d.cache && ((i = i.replace(Pt, "$1")), (p = (At.test(i) ? "&" : "?") + "_=" + kt.guid++ + p)),
                  (d.url = i + p)),
          ...
          E.ajaxPrefilter("json jsonp", function (e, t, n) {
            ...
            if (s || "jsonp" === e.dataTypes[0])
              return (
                ...
                n.always(function () {
                  (void 0 === o ? E(r).removeProp(i) : (r[i] = o), e[i] && ((e.jsonpCallback = t.jsonpCallback), Yt.push(i)), a && y(o) && o(a[0]), (a = o = void 0));
                }),
                "script"
              );
          }),
