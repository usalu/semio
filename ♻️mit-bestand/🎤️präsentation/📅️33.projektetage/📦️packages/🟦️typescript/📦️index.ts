...
if (typeof document !== "undefined" && !import.meta.vitest) {
  const { registerTests1 } = await import("../../🧪️tests/🧪️projektetage-deck/🟦️.ts");
  await registerTests1(import.meta.vitest, { mount }, { directory: import.meta.dir, url: import.meta.url });
}
//#endregion 🔖️Deck
