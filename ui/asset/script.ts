...
function generateJs(icons: Record<string, string>, generatedDir: string): void {
  const entries = Object.keys(icons)
    ...
    .join("\n");
  const body = `// Generated by ui/asset/script.ts — do not edit.
export const ICONS = {
${entries}
} as const;
...
async function generateShortcodes(icons: Record<string, string>): Promise<void> {
  ...
  try {
    ...
    console.warn("[ui/asset] gemoji fetch failed; keeping existing emoji shortcodes if present", err);
  ...
  const tsBody = `// Generated by ui/asset/script.ts — do not edit.
...
`;
  ...
  console.log(`[ui/asset] generated ${Object.keys(emoji).length} emoji + ${catalog.length} catalog shortcodes`);
}
//#endregion 🧬Codegen
...
function runGenerate(target: string): void {
  ...
  console.log(`[ui/asset] generated ${Object.keys(icons).length} icons → ${target}`);
}
...
async function runGenerateAll(): Promise<void> {
  ...
  console.log(`[ui/asset] generated ${Object.keys(icons).length} icons + shortcodes → all`);
}
