...
async function generateShortcodes(icons: Record<string, string>): Promise<void> {
  const generatedDir = join(import.meta.dir, "icons", "generated");
  ...
  try {
    ...
    console.warn("[ui/assets] gemoji fetch failed; keeping existing emoji shortcodes if present", err);
  ...
  const tsBody = `// Generated by ui/assets/script.ts — do not edit.
...
`;
  ...
  console.log(`[ui/assets] generated ${Object.keys(emoji).length} emoji + ${catalog.length} catalog shortcodes`);
}
//#endregion 🧬Codegen
...
async function runGenerateAll(): Promise<void> {
  ...
  console.log(`[ui/assets] generated ${Object.keys(icons).length} icons + shortcodes → all`);
}
