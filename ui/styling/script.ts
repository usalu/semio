...
function emitTypeScriptTokens(tokens: Tokens): string {
	const lines: string[] = [
...
export function generateStylingArtifacts(): void {
	...
	writeFileSync(join(jsGeneratedDir, "tokens.generated.ts"), emitTypeScriptTokens(tokens), "utf8");
...
class GenerateScript extends BundleScript {
	run(): void {
		...
		console.log("elements/lib/styling: wrote generated/*.css, js/palette.css, js/tokens.generated.ts, Palette.g.cs");
	}
}
