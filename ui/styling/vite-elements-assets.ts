...
export function playgroundRendererResolveAliases(repoRoot: string): ReadonlyArray<{ readonly find: string | RegExp; readonly replacement: string }> {
  ...
  return [
    ...
    { find: "@semio-tech/imperative-play", replacement: resolve(repoRoot, "imperative/play/index.ts") },
    ...
    { find: "@semio-tech/sequence-play", replacement: resolve(repoRoot, "sequence/play/index.ts") },
    ...
    { find: "@semio-tech/layout-play", replacement: resolve(repoRoot, "layout/play/index.ts") },
