...
export const STYLING_METRICS = {
  ...
  dag: {
    ...
    lodZoomShift: 0.25,
    lodBandFloorZoom: [0.05, 0.15, 0.35, 0.55, 1.25, 2.5],
    componentWidth: 40,
  },
  map: {
    labelPxBands: [26, 26, 20, 14, 12.5, 12, 10.5, 10.5],
    labelMaxMin: 48,
    labelMaxMax: 140,
    layerWeightMin: 0.25,
    layerWeightMax: 3,
...
export const STYLING_BOARD_PALETTES = {
  light: {
    ...
    edgeStroke: [123, 130, 125, 255],
    edgeStrokeHovered: [0, 17, 23, 255],
    edgeStrokeSelected: [255, 52, 79, 255],
    edgeStrokeSelectionExit: [52, 209, 191, 255],
    edgeStrokeDisabled: [47, 49, 48, 97],
    nodeFill: [238, 234, 219, 255],
    nodeStroke: [123, 130, 125, 255],
    nodeFillHovered: [123, 130, 125, 255],
    nodeStrokeHovered: [0, 17, 23, 255],
    nodeFillSelected: [255, 52, 79, 255],
    nodeStrokeSelected: [255, 52, 79, 255],
    nodeFillSelectionExit: [165, 202, 189, 255],
    nodeStrokeSelectionExit: [52, 209, 191, 255],
    nodeFillDisabled: [101, 100, 95, 128],
    nodeStrokeDisabled: [47, 49, 48, 97],
    indirectHandleFill: [196, 228, 213, 255],
    indirectHandleStroke: [52, 209, 191, 255],
    handleFill: [247, 243, 227, 0],
    handleStroke: [123, 130, 125, 255],
    handleFillHovered: [123, 130, 125, 255],
    handleStrokeHovered: [123, 130, 125, 255],
    handleFillSelected: [255, 52, 79, 255],
    handleStrokeSelected: [255, 52, 79, 255],
    handleFillSelectionExit: [165, 202, 189, 255],
    handleStrokeSelectionExit: [52, 209, 191, 255],
    handleFillDisabled: [101, 100, 95, 128],
    handleStrokeDisabled: [47, 49, 48, 97],
    wireStroke: [123, 130, 125, 255],
    wireStrokeHovered: [0, 17, 23, 255],
    wireStrokeSelected: [255, 52, 79, 255],
    wireStrokeHighlighted: [52, 209, 191, 255],
    wireStrokeDisabled: [47, 49, 48, 97],
    selectionPreviewFill: [31, 6, 9, 31],
    selectionPreviewStroke: [255, 52, 79, 179],
    labelFill: [123, 130, 125, 255],
    labelFillHovered: [0, 17, 23, 255],
    labelHalo: [240, 236, 221, 199],
  },
  dark: {
    rasterClear: [12, 28, 33, 255],
    gridMinorStroke: [85, 95, 93, 56],
    edgeStroke: [162, 165, 157, 255],
    edgeStrokeHovered: [247, 243, 227, 255],
    edgeStrokeSelected: [255, 52, 79, 255],
    edgeStrokeSelectionExit: [52, 209, 191, 255],
    edgeStrokeDisabled: [32, 36, 35, 97],
    nodeFill: [46, 60, 61, 255],
    nodeStroke: [162, 165, 157, 255],
    nodeFillHovered: [85, 95, 93, 255],
    nodeStrokeHovered: [247, 243, 227, 255],
    nodeFillSelected: [255, 52, 79, 255],
    nodeStrokeSelected: [255, 52, 79, 255],
    nodeFillSelectionExit: [47, 96, 92, 255],
    nodeStrokeSelectionExit: [52, 209, 191, 255],
    nodeFillDisabled: [23, 30, 31, 128],
    nodeStrokeDisabled: [32, 36, 35, 97],
    indirectHandleFill: [47, 96, 92, 255],
    indirectHandleStroke: [52, 209, 191, 255],
    handleFill: [12, 28, 33, 0],
    handleStroke: [162, 165, 157, 255],
    handleFillHovered: [85, 95, 93, 255],
    handleStrokeHovered: [162, 165, 157, 255],
    handleFillSelected: [255, 52, 79, 255],
    handleStrokeSelected: [255, 52, 79, 255],
    handleFillSelectionExit: [47, 96, 92, 255],
    handleStrokeSelectionExit: [52, 209, 191, 255],
    handleFillDisabled: [23, 30, 31, 128],
    handleStrokeDisabled: [32, 36, 35, 97],
    wireStroke: [162, 165, 157, 255],
    wireStrokeHovered: [247, 243, 227, 255],
    wireStrokeSelected: [255, 52, 79, 255],
    wireStrokeHighlighted: [52, 209, 191, 255],
    wireStrokeDisabled: [32, 36, 35, 97],
    selectionPreviewFill: [31, 6, 9, 31],
    selectionPreviewStroke: [255, 52, 79, 179],
    labelFill: [211, 210, 197, 255],
    labelFillHovered: [247, 243, 227, 255],
    labelHalo: [12, 28, 33, 199],
  },
} as const;
...
export const STYLING_CANVAS_PALETTES = {
  light: {
    rasterClear: [240, 236, 221, 255],
    iconFg: [0, 0, 0, 255],
    iconBg: [255, 255, 255, 255],
    labelFill: [0, 17, 23, 255],
    labelHalo: [247, 243, 227, 255],
  },
  dark: {
    rasterClear: [12, 28, 33, 255],
    iconFg: [247, 243, 227, 255],
    iconBg: [0, 17, 23, 255],
    labelFill: [247, 243, 227, 255],
    labelHalo: [12, 28, 33, 255],
  },
} as const;
...
export const STYLING_CHROME_PALETTES = {
  light: {
    ...
    window: [235, 232, 217, 255],
    panel: [201, 200, 189, 255],
    foreground: [0, 17, 23, 255],
    mutedForeground: [123, 130, 125, 255],
    accent: [255, 52, 79, 255],
    accentForeground: [0, 17, 23, 255],
    activeBase: [255, 52, 79, 255],
    activeForeground: [0, 17, 23, 255],
    activeHover: [230, 47, 71, 255],
    hoverInteractiveFill: [123, 130, 125, 255],
    hoverWindow: [211, 210, 197, 255],
    hoverPanel: [162, 165, 157, 255],
    borderNormal: [123, 130, 125, 255],
    borderEmphasized: [0, 17, 23, 255],
    borderElement: [123, 130, 125, 255],
    temporary: [151, 155, 148, 255],
    overlayBg: [151, 155, 148, 250],
  },
  dark: {
    base: [0, 17, 23, 255],
    canvas: [12, 28, 33, 255],
    window: [7, 24, 29, 255],
    panel: [29, 43, 47, 255],
    foreground: [247, 243, 227, 255],
    mutedForeground: [123, 130, 125, 255],
    accent: [255, 52, 79, 255],
    accentForeground: [247, 243, 227, 255],
    activeBase: [255, 52, 79, 255],
    activeForeground: [247, 243, 227, 255],
    activeHover: [230, 47, 71, 255],
    hoverInteractiveFill: [123, 130, 125, 255],
    hoverWindow: [36, 50, 53, 255],
    hoverPanel: [85, 95, 93, 255],
    borderNormal: [123, 130, 125, 255],
    borderEmphasized: [247, 243, 227, 255],
    borderElement: [123, 130, 125, 255],
    temporary: [36, 50, 53, 255],
    overlayBg: [36, 50, 53, 250],
  },
} as const;
...
export const STYLING_MAP_PALETTES = {
  light: {
    ...
    landStroke: [51, 64, 65, 107],
    labelFill: [247, 243, 227, 255],
    labelHalo: [12, 28, 33, 235],
    regionFill: [52, 209, 191, 56],
    regionStroke: [52, 209, 191, 230],
    routeStroke: [250, 149, 0, 235],
    positionFill: [255, 52, 79, 255],
    positionStroke: [247, 243, 227, 255],
  },
  dark: {
    surfaceClear: [6, 23, 28, 255],
    landFill: [12, 28, 33, 255],
    landStroke: [51, 64, 65, 107],
    labelFill: [247, 243, 227, 255],
    labelHalo: [6, 23, 28, 235],
    regionFill: [52, 209, 191, 56],
    regionStroke: [52, 209, 191, 230],
    routeStroke: [250, 149, 0, 235],
    positionFill: [255, 52, 79, 255],
...
export const STYLING_SEMIO_THEME = {
  ...
  fontStacks: {
    ...
    serif:
      '"Kelly Slab", "Kelly Slab Extended", "Kelly Slab Cyrillic", "Noto Emoji", "Noto Emoji 0", "Noto Emoji 1", "Noto Emoji 2", "Noto Emoji 3", "Noto Emoji 4", "Noto Emoji 5", "Noto Emoji 6", "Noto Emoji 7", "Noto Emoji 8", "Noto Emoji 9", "Noto Emoji 10", "Noto Emoji 11"',
  ...
  appearances: {
    light: {
      board: {
        ...
        nodeFillSelectionExit: {
          mix: ["secondary", "light-5-7", 0.24],
        },
        nodeStrokeSelectionExit: {
          token: "secondary",
        },
        nodeFillDisabled: {
          mix: ["light-5-7", "transparent", 0.5],
          alpha: 0.5,
        },
        nodeStrokeDisabled: {
          mix: ["gray", "transparent", 0.38],
    ...
    dark: {
      board: {
        ...
        nodeFillSelectionExit: {
          mix: ["secondary", "dark-5-7", 0.24],
        },
        nodeStrokeSelectionExit: {
          token: "secondary",
        },
        nodeFillDisabled: {
          mix: ["dark-5-7", "transparent", 0.5],
          alpha: 0.5,
        },
        nodeStrokeDisabled: {
          mix: ["gray-400", "transparent", 0.38],
