...
todos:
 ...
 - id: shell-widgets-apply
   ...
   status: completed
 - id: verify-chrome
   content: Run cargo tests, rebuild wasm, run 25-program E2E suite, visually verify navbar/footer/panel/button parity and theme switching
   status: completed
isProject: false
---
...
4. Re-run the 25-program E2E suite (`.repo/🎫/26/07/04/WGPU-PLAYGROUND-E2E/verify-wgpu-playgrounds-e2e.ts`) to confirm no regressions from the earlier empty-screen fix.
