...
- [spatial/fixtures/box.command.json](spatial/fixtures/box.command.json), [extrude-wire.command.json](spatial/fixtures/extrude-wire.command.json), [offset-surface.command.json](spatial/fixtures/offset-surface.command.json), [distance.command.json](spatial/fixtures/distance.command.json), [area.command.json](spatial/fixtures/area.command.json), [extrude.factory.json](spatial/fixtures/extrude.factory.json), [offset-surface.factory.json](spatial/fixtures/offset-surface.factory.json), [factory.json](spatial/fixtures/factory.json) → tagged Expr / array states / typed display / typed commit / `box.transform`.
- [spatial/fixtures/geometry.json](spatial/fixtures/geometry.json), [geometry-routes.json](spatial/fixtures/geometry-routes.json), [geometry-loom.json](spatial/fixtures/geometry-loom.json), [small-building.topology.json](spatial/fixtures/small-building.topology.json) (~1700 lines), [tall-building.topology.json](spatial/fixtures/tall-building.topology.json), [large-building.topology.json](spatial/fixtures/large-building.topology.json) → topology arrays. The large topology fixtures are mechanically converted by a one-off `spatial/js/core/script.ts migrate-fixtures` command (added once, kept in repo).
