...
- Extend `@ui/react` tests for the new `Icon` primitive and add inline tests in `ui/asset/script.ts` for SVG normalization + generated-name stability.
