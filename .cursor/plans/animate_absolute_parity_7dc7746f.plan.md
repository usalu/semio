...
Goal `[ANIMATE](.repo/🎯/ANIMATE/goal.json)` already exists. **Reopen** ticket `26/07/18/ANIMATE-TECHNOLOGY-FULL-MANIM-PARITY` (same task). Rewrite the ticket feature checklist from code truth (mark stubs as open).
...
```bash
CARGO_TARGET_DIR=.repo/🎫/26/07/18/ANIMATE-TECHNOLOGY-FULL-MANIM-PARITY/target \
