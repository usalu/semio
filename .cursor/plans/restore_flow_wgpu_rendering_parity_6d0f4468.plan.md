...
5. Work inside a ticket per repo convention (reopen `.repo/🎫/26/07/05/FLOW-WGPU-RICH-PARITY` since it covers the identical regression, or open a new ticket if reopening doesn't fit) and close it with a summary and full file list once verified.
