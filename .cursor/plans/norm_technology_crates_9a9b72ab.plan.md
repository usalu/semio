...
- **Goal:** Approving this plan authorizes opening goal `norm` (title “Norm”, due `2026-12-31`). Ticket binds to `🎯norm`.
...
2. `ticket_open` with emoji `📏`, title “Norm Technology Full Family Crates”, goal `🎯norm`, `plan_id` from this plan; write a part-by-part checklist under the ticket folder.
