...
todos:
 ...
 - id: rust-window-measures
   ...
   status: completed
 - id: validate
   content: cargo test -p gis-plugin, rebuild gis program wasm + gis-2d-rs pkg, browser smoke test tiles/interactions/window options
   status: completed
isProject: false
---
