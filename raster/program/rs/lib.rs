//! 🖼️ Raster program — declarative raster board bundled as a hot-swappable WASM program.
...
pub(crate) mod domain {
    ...
    /// compositor bridge and the `raster-program` `DocumentApp`. Ephemeral tool/brush/selection state
...
/// since it is defined in `framework/program`.
...
fn register_raster_exports() {
    ...
    semio_framework_program::program_runtime::register_document_codec_for_app::<RasterPlayApp>(RASTER_DOCUMENT_SCHEMA);
}
