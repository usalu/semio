...
3. Repo binary (`go/repo/main.go:5787-5788`) skips directories starting with `.` and uses .gitignore patterns
4. Added `isInIgnoredDirectory()` function that:
   - Checks against explicit ignore list (node_modules, __pycache__, site-packages, etc.)
