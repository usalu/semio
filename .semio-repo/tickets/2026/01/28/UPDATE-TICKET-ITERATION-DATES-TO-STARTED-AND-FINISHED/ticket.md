...
Renamed 'date' to 'dates' in Ticket GraphQL object and schema to align with the new naming convention where interactions and tickets have started/finished dates. Updated VS Code extension to use the renamed field. Go structs already supported started/finished dates for both tickets and interactions.
