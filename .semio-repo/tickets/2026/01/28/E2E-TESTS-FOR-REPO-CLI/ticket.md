...
- [x] Analyze ./semio-repo/cli/main.go for commands and flags
- [x] Extend ./semio-repo/cli/main_test.go with helper functions for CLI testing
...
- `go test ./...` (./semio-repo/cli): PASS

## Summary

E2E CLI E2E tests stabilized; node(id:) accepts canonical IDs; ticket close file filtering handled; all ./semio-repo/cli tests pass.
