...
- Identified gaps: missing collection IDs, incorrect section/definition URI encoding, missing project/draft/todo MCP resources, no IdToUri/UriToId, no navigate command, violationKind handler uses wrong prefix
...
- Updated MCP resource handlers: section/definition use ParseSectionUriPath, violationKind prefix fixed, goal/commit implemented, added project/draft/todo handlers
...
- [x] Update MCP resource handlers (section no #, definition no #, violationKind prefix, implement goal/commit)
