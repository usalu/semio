...
Checks every file with a language that SupportsHeaders(). Produces these violation kinds:
...
**Zero-violation header format (TypeScript example for path `some/folder/file.tsx`):**
```
// #region 🔖Header
//
