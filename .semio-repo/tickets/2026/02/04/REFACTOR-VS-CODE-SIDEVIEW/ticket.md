...
- 2026-02-04: Fixed repo binary resolution for the VS Code extension to use `@semio-repo/cli/cli` when `go/repo/repo` is missing, unblocking GraphQL-backed tree expansion.
