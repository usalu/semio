...
- 2026-02-04: Fixed repo binary resolution for the VS Code extension to use `@semio-repo/go/go` when `go/repo/repo` is missing, unblocking GraphQL-backed tree expansion.
