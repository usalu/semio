...
Fixed all 299 policy violations in semio/go/semio.go to 0. Added Imports section for orphan definitions, MUST-keyword summaries for 34 sections, summary comments for 186 exported definitions, RFC2119 spec comments for 77 exported functions.
## Changes
- semio/go/semio.go: Added ~299 comment lines fixing all violations (4985→5284 lines)

## Log
- Analyzed violations: 34 SECTION-MISSING-SUMMARY, 186 DEFINITION-MISSING-SUMMARY, 77 DEFINITION-MISSING-SPECS, 2 SECTION-ORPHAN-DEFINITION
...
## Plan
1. Analyze violations by type and line number
2. Create systematic fix script
3. Apply all fixes at once
4. Verify 0 violations remain
