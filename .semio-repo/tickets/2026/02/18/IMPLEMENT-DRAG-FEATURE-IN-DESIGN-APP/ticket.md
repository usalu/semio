...
Fixed three bugs preventing drag feature: (1) createPathObserver stale Y.js ref comparison in shared.ts, (2) DerivedNode Map serialization via jsonReplacer in shared.ts, (3) useDerived getSnapshot Map serialization in Sketchpad.tsx. Cleaned up debug logs. Refactored test assertions. Fixed Kit test intersect/lasso. All 7 tests pass.
