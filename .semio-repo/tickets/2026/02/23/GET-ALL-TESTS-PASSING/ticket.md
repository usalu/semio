...
- semio-repo/cli/main.go: Added "edited" case to interactionKindEmoji function
- semio-repo/cli/main_test.go: Fixed hardcoded minute emoji (⌛→⏳) in TestAllSpecIDExamples
