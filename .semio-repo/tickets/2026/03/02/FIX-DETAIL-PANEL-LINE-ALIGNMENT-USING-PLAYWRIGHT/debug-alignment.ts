...
async function main() {
  ...
  await sbPage.screenshot({ path: "/workspaces/semio/.semio-repo/tickets/2026/03/02/FIX-DETAIL-PANEL-LINE-ALIGNMENT-USING-PLAYWRIGHT/storybook-tree.png" });
  await sbPage.close();
  ...
  await skPage.screenshot({ path: "/workspaces/semio/.semio-repo/tickets/2026/03/02/FIX-DETAIL-PANEL-LINE-ALIGNMENT-USING-PLAYWRIGHT/sketchpad-home.png" });
  await skPage.close();
