...
async function measure() {
  ...
  await page.screenshot({ path: "/workspaces/semio/.semio-repo/tickets/2026/03/02/FIX-DETAIL-PANEL-LINE-ALIGNMENT-USING-PLAYWRIGHT/sketchpad-tree.png", fullPage: true });
