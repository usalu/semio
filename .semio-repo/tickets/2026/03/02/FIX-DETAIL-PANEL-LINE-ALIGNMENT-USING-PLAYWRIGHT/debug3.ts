...
async function main() {
  ...
  await skPage.screenshot({ path: "/workspaces/semio/.semio-repo/tickets/2026/03/02/FIX-DETAIL-PANEL-LINE-ALIGNMENT-USING-PLAYWRIGHT/sketchpad.png", fullPage: true });
  ...
  await playPage.screenshot({ path: "/workspaces/semio/.semio-repo/tickets/2026/03/02/FIX-DETAIL-PANEL-LINE-ALIGNMENT-USING-PLAYWRIGHT/play.png", fullPage: true });
