...
- Audited all clipboard-related tickets via `./semio-repo/cli/cli tree "copy to clipboard"` and `./semio-repo/cli/cli tree clipboard`; confirmed single relevant ticket.
...
- Gathered repo + ticket context via `./semio-repo/cli/cli tree sketchpad`.
