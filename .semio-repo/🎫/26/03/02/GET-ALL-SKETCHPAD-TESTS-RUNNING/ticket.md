...
- `./semio-repo/cli/cli tree sketchpad` timed out without returning output.
- `./semio-repo/cli/cli ticket reopen 26/01/28/FIX-SKETCHPAD-APP-TESTS ...` failed because the historical ticket has no `ticket.json`.
- `./semio-repo/cli/cli ticket open ...` returned `🎫0000/00/00/GET-ALL-SKETCHPAD-TESTS-RUNNING` after GitHub issue creation failed and did not create a local ticket folder.
