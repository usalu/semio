...
- [ ] Implement `semio repo clial` commands:
  - [ ] `list`
...
- [ ] When syncing to GitHub, handle sub-issue relationship (if possible via API) or just linking.
  - _Note: GitHub Sub-issues are part of Projects/new Issues. Need to verify how to set them via API. Usually it's a "Tracks" / "Tracked By" relationship or nested tasklists._
