...
**Root Cause**: In `./semio-repo/cli/main.go`, the `repoContext.GetPolicies()` function at line 11315 creates `Policy` objects but does NOT populate the `Statutes` field:
