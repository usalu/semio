...
- Ran `npx tsc --noEmit`:
  - Result: failed due pre-existing repository-wide TypeScript parse errors outside this change scope (e.g. `semio-repo/vscode/codegen/*`, `semio/assets/logo/logo.ts`, `vitest.config.ts`).
