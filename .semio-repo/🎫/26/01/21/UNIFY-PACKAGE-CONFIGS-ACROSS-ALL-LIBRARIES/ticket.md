...
13. `./semio-repo/cli/package.json` - semio-repo/go
...
- `./semio-repo/cli/package.json` - semio-repo/go
...
3. `./semio-repo/cli/package.json` had incomplete build script - fixed
...
1. `./semio-repo/cli/package.json` - fixed build script, added dev script
...
- `./semio-repo/cli/package.json` - Fixed incomplete build script, added dev script
