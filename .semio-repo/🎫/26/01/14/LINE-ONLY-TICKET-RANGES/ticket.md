...
User request: Change ticket ranges to line-only ints (start/end lines) instead of line/character objects. Update repo, cli, mcp, and VS Code extension. Files: go/cli/main.go, go/mcp/main.go, ./semio-repo/cli/cli.go, js/vscode/extension.ts.
