...
6. Add `generateCodexNativeConfig`, `generateDroidNativeConfig`, `generateAntigravityNativeConfig` for hooks.json (semio-repo event names as keys)
...
- `semio-repo/cli/main.go`: Fixed all 5 generators, added 3 native generators, updated mappings
- `semio-repo/cli/main_test.go`: Updated all generator tests
- `.github/hooks/semio-repo.json`: Regenerated with all events
