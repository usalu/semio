...
- Ran `go test ./semio-repo/cli -run 'TestNormalizeTicketFileInput|TestCliE2E_TicketLifecycle_Syntaxes_NoGithub'`.

## Todos

- [x] Run semio-repo/cli tests for ticket close file resolution.
