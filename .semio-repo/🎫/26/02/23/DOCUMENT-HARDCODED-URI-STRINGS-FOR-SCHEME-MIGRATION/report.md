...
This report documents all hardcoded URI strings in `semio-repo/cli/main.go` that use the OLD scheme and need updating to the NEW scheme. It is organized by functional area.
