...
| # | Line | URI | Code |
|---|------|-----|------|
| 6 | 4495 | `semiorepo://file/test/file.ts` | `header := lang.FormatHeader("💻test/file.ts", "semiorepo://file/test/file.ts", "A test file", "2025 Test User <test@test.com>", "AGPL license text here", "Some specs")` |

---

## 7. `TestFormatHeaderEmptySpecs` (line 4519)
...
| 16 | 9622 | `semiorepo://project/semio-repo` | `wantURI: "semiorepo://project/semio-repo",` |
...
| 40 | 9790 | `semiorepo://definition/semio-repo/cli/main.go/GraphQL%20Types/GraphQL%20Input%20Types/TicketCloseInput` | `wantURI: "semiorepo://definition/semio-repo/cli/main.go/GraphQL%20Types/GraphQL%20Input%20Types/TicketCloseInput",` |
...
| 91 | 10025 | `semiorepo://project/semio-repo` | `{"project infra", "semiorepo://project/semio-repo", emojiText(EmojiProjectInfra) + "semiorepo"},` |
