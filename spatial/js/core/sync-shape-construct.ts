#!/usr/bin/env bun
/** @emoji 🧩 Writes `surface.construct` and `curve.construct` interactions for spatial.shape. */
...
console.log("[sync] surface.construct + curve.construct → spatial.shape/interaction");
