...
- **compose-js**: embedded `⚡FastUnit`/`🐘WasmE2e` regions now gated by an inline rank check (`long`+) instead of a second env var. Verified: fundamental = 7 tests/351ms, long = 19 tests/66s.
