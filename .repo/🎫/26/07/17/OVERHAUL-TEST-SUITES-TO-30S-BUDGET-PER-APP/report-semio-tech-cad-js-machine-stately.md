...
- After (with the two in-scope fixes): vitest starts, resolves all aliases,
  ...
  `bun ./script.ts test` invocation is well under 1s (blocked before it ever
