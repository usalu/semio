#!/usr/bin/env bun
/** 📊One-off codemod: adds `coverage: { include: [...] }` (mirroring each config's own `include`/`includeSource`
...
// Run from the repo root: `bun .repo/🎫/26/07/26/NINETY-FIVE-PERCENT-EXHAUSTIVE-TEST-COVERAGE/add-vitest-coverage-include.ts`
