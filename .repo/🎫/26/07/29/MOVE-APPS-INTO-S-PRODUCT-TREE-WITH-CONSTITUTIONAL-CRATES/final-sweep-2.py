...
merge_move('s/plugin/architect/spine/script.ts', 's/plugin/architect/module/spine/script.ts')
...
merge_move('s/plugin/reasoning/script.ts', 's/module/mindmap/script.ts')
