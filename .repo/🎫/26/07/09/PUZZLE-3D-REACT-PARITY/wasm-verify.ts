#!/usr/bin/env bun
/** 🔍 Wasm command round-trip verification for puzzle 3d fill/brush. */
...
await handle.handleCommand(
	instanceId,
	JSON.stringify({ controllerId: "puzzle3d-play", command: "setFillCount", args: { value: 4 } }),
	viewState,
);
...
await handle.handleCommand(
	instanceId,
	JSON.stringify({ controllerId: "puzzle3d-play", command: "setHover", args: { objectId: "seed-left-001", mode: "mesh", id: 0 } }),
	viewState,
);
await handle.handleCommand(
	instanceId,
	JSON.stringify({ controllerId: "puzzle3d-play", command: "worldVortexHover", args: { fullId: "seed-left-001:v0" } }),
	viewState,
);
