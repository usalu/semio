...
const files = findReactIndexFiles("/Users/ueli/Documents/semio").filter(
	(path) => !path.includes("/framework/product/platform/") && !path.includes("/framework/product/playground/") && !path.includes("/ui/react/"),
);
