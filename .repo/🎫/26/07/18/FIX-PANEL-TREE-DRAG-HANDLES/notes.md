...
## Tests
`bun ./script.ts test --testNamePattern="PanelTreeUnitsPane|Tree section reorder|mergeTreeSectionOrder|sortable TreeItem always|Tree's controlled|Panel wires bottom|renders sortable drag"` — 8 passed.
