...
const pdfPath = join(ticketDir, "dist/verify-uniform.pdf");
...
writeFileSync(join(ticketDir, `uniform-p${pageNum}.png`), canvas.toBuffer("image/png"));
...
console.log(`[DEBUG] page ${pageNum} bands`, bands.length, "gaps", summary);
