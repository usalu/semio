...
const APPS = [
	"2d", "3d", "5d", "gis-2d", "wires", "draw", "note", "writer", "raster", "forms",
	"flow", "dag", "imperative", "sequence", "layout", "lowpoly", "procedural-2d",
	"procedural-3d", "shooting", "vcs", "trinity-jack", "trinity-rewrite", "presentation", "cad",
] as const;

const PORT_BY_APP: Readonly<Record<string, number>> = {
	"2d": 6012, "3d": 6013, "5d": 6014, "gis-2d": 6040, wires: 6015, draw: 6064, note: 6080,
	writer: 6062, raster: 6060, forms: 6058, flow: 6016, dag: 6017, imperative: 6076,
	sequence: 6077, layout: 6079, lowpoly: 6078, "procedural-2d": 6021, "procedural-3d": 6018,
	shooting: 6019, vcs: 6075, "trinity-jack": 6054, "trinity-rewrite": 6056, presentation: 6051, cad: 6020,
};

const PACKAGE_ROOT_BY_ENTRY: Readonly<Record<string, string>> = {
	draw: "draw", note: "note", writer: "writer", raster: "raster", forms: "forms", flow: "flow",
	dag: "mathematical/graph/port/directed/dag", imperative: "imperative", sequence: "sequence",
	layout: "layout", lowpoly: "lowpoly", "procedural-2d": "procedural/2d", "procedural-3d": "procedural/3d",
	shooting: "shooting", vcs: "vcs", "gis-2d": "gis/2d", wires: "reasoning/mindmap/wires",
	"trinity-jack": "trinity/jack/host-core", "trinity-rewrite": "trinity/rewrite",
	presentation: "framework/product/presentation", cad: "cad/renderer",
	"2d": "puzzle/2d", "3d": "puzzle/3d", "5d": "puzzle/5d",
};
