#!/usr/bin/env bun
/** 🎬 Wgpu↔React interaction-delta parity harness. Boots BOTH renderers of the same OS dev host
 ...
 * `.repo/🎫/26/07/04/WGPU-PLAYGROUND-E2E/verify-wgpu-playgrounds-e2e.ts`):
...
/** 🧮 Rough magnitude class on a log10 scale — used to compare "did both renderers change by a
...
/** 📋 Two scripted clicks into the forms playground body; expects a body-region stat change in both
...
/** 🌀 Clicks the generate-mode toggle (same relative viewport coordinate used by
