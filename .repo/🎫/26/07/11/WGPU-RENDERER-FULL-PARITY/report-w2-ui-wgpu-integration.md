...
- `.repo/🎫/26/07/11/WGPU-RENDERER-FULL-PARITY/region-claims.json` (recorded the narrow additive `events` touches, mirroring w1a/w1d's own exception-recording precedent)
