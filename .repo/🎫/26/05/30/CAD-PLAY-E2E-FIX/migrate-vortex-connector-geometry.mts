#!/usr/bin/env bun
/** @emoji 🧾 One-off: bake nakagin vortex position + direction from metabolism kit type connector point/direction (port match via handle catalog). */
import { readFileSync, writeFileSync } from "node:fs";
import { join } from "node:path";

const repoRoot = join(import.meta.dir, "..", "..", "..", "..", "..", "..");
const kitPath = join(repoRoot, "semio/assets/semio/metabolism/wip/initialKit/kit.semio.json");
