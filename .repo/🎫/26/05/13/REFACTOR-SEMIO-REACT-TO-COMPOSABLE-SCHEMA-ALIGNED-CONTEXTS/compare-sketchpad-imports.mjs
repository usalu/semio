...
const react = fs.readFileSync("semio/client/lib/react/index.tsx", "utf8");
const sketch = fs.readFileSync("semio/client/lib/sketchpad/index.tsx", "utf8");
...
const m1 = block.match(/import type\s*\{([\s\S]*?)\}\s*from\s*["']@semio\/react["']/);
if (m1) grab(m1[1]);
const m2 = block.match(/import\s*\{([\s\S]*?)\}\s*from\s*["']@semio\/react["']/);
if (m2) grab(m2[1]);
