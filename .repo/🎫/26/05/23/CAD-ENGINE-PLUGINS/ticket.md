...
**Files:** `elements/client/lib/geometry/cad/index.tsx` (created), `elements/client/lib/geometry/react/index.tsx`, `elements/client/lib/geometry/vitest.config.ts`, `.repo/🎫/26/05/23/CAD-ENGINE-PLUGINS/ticket.md`.
