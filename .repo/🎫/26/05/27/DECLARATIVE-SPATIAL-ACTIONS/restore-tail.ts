...
const head = readFileSync("c:/git/semio/.repo/🎫/26/05/27/DECLARATIVE-SPATIAL-ACTIONS/index-head.tsx", "utf8");
...
const current = readFileSync("c:/git/semio/spatial/js/renderer-r3f/index.tsx", "utf8");
writeFileSync("c:/git/semio/spatial/js/renderer-r3f/index.tsx", `${current}\n${tail}`);
