...
- Scripts live **only in the bundle (or workspace) they affect** — e.g. `build.3dm.script.ts` under `compose/client/ui/3dm/ui/`, `dev.desktop.script.ts` under `compose/client/ui/desktop/`.
...
- Repo MCP tooling: `repo/client/dev.mcp*.script.ts`, `repo/lint.repo.script.ts`; engine MCP: `compose/client/bin/engine/dev.mcp.engine.script.ts`.
...
- Bundles: `compose/**/**.script.ts`, `elements/ui/*.script.ts`, `coda/client/ui/desktop/*.script.ts`, `repo/**/*.script.ts`
