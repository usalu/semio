# Semio Rs Clean Refactor — Gap Surfaces
...
```powershell
$env:CARGO_TARGET_DIR='E:\cargo-target-semio'
$env:TEMP='E:\cargo-tmp-semio'
$env:TMP='E:\cargo-tmp-semio'
```

Golden fingerprint: `semio/assets/semio/kit-store.golden.expected.semio.json` → `1a9a217ca1ac63d89883abe5bc13e36268becf6cb4ef743105af0a11fcf3653a`.
