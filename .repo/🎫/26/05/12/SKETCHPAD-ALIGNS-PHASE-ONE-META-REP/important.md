...
- **Open:** Monorepo packages importing removed `@compose/js` symbols (`compose/react`, `compose/sketchpad`, `compose/algorithms`, …) — **ticket stays open** per coordinator instruction (no `ticket_close` until full repo completion).
