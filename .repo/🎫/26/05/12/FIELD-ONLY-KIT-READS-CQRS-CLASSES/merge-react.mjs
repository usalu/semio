...
const idx = fs.readFileSync("semio/react/index.tsx", "utf8");
const sp = fs.readFileSync("semio/react/sketchpad-runtime.tsx", "utf8");
...
fs.writeFileSync("semio/react/index.tsx", idxOut, "utf8");
