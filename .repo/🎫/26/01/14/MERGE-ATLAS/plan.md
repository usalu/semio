...
- [x] 1.4 Electricity, Bits, and Binary - Already well merged
- [x] 1.5 Storage: Permanent Memory - Already well merged
...
- [x] 2.4 Variables - Already well merged
- [x] 2.5 Types - Already well merged
- [x] 2.6 Functions - Already well merged
- [x] 2.7 Control Flow - Already well merged
