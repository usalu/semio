...
- Updated SQLite schema with ticket ui column, repo label derivation to include repo fallback, and metrics comment formatting to use icon + path + spaced line deltas.
