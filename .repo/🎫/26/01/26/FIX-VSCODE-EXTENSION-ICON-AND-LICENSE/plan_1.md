...
**Solution**: Copy the icon file to `js/vscode/icons/semio_codeicon.svg` and update the path in package.json to `./icons/semio_codeicon.svg`.
...
2. Copy `assets/icons/semio_codeicon.svg` to `js/vscode/icons/semio_codeicon.svg`
3. Update `js/vscode/package.json` line 37 to use `./icons/semio_codeicon.svg`
...
- `js/vscode/icons/semio_codeicon.svg` - new file (copy from assets)
