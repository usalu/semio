...
- Modified `./repo/cli/main.go` to implement `handle*Resource` functions using internal GraphQL queries.
- Updated `./repo/cli/main.go` to register resources and resource templates in the MCP server.
