...
1. ./repo/cli/main.go - Added BundleKind, FolderKind, and semantic DefinitionKind enums with classification functions
2. ./repo/cli/main.go - Updated Bundle, Folder structs with Kind field
3. ./repo/cli/main.go - Added filter flags and streaming options for all new dimensions
4. ./repo/cli/main.go - Added IsGeneratedFolder function for detecting generated folders
