...
func TestProjectListIDs(t *testing.T) {
	...
	expectedIDs := map[string]string{
		...
		"repo": emojiText(EmojiProjectInfra) + "semiorepo",
...
func TestBundleListIDs(t *testing.T) {
	...
	expectedIDs := map[string]string{
		...
		"repo/cli":     emojiText(EmojiProjectInfra) + "semiorepo" + emojiText(EmojiBundleBinary) + "cli",
		"repo/server":  emojiText(EmojiProjectInfra) + "semiorepo" + emojiText(EmojiBundleBinary) + "server",
		"repo/go":      emojiText(EmojiProjectInfra) + "semiorepo" + emojiText(EmojiBundleLibrary) + "go",
		"repo/vscode":  emojiText(EmojiProjectInfra) + "semiorepo" + emojiText(EmojiBundleUI) + "vscode",
		"repo/graphql": emojiText(EmojiProjectInfra) + "semiorepo" + emojiText(EmojiBundleSchema) + "graphql",
	}
...
func TestAllSpecIDExamples(t *testing.T) {
	cases := []struct {
		...
		{"infra project repo", "project", map[string]interface{}{"name": "repo", "kind": "infrastructure"}, emojiText(EmojiProjectInfra) + "semiorepo"},
		...
		{"binary bundle repo/cli", "bundle", map[string]interface{}{"name": "repo/cli", "kind": "binary"}, emojiText(EmojiProjectInfra) + "semiorepo" + emojiText(EmojiBundleBinary) + "cli"},
