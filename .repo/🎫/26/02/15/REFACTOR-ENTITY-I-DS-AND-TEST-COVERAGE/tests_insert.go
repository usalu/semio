...
{"schema bundle compose/graphql", "bundle", map[string]interface{}{"name": "compose/graphql", "kind": "schema"}, emojiText(EmojiProjectUser) + "compose" + emojiText(EmojiBundleSchema) + "graphql"},
...
{"ui bundle repo/vscode", "bundle", map[string]interface{}{"name": "repo/vscode", "kind": "ui"}, emojiText(EmojiProjectInfra) + "composerepo" + emojiText(EmojiBundleUI) + "vscode"},
...
{"assets bundle compose/assets", "bundle", map[string]interface{}{"name": "compose/assets", "kind": "assets"}, emojiText(EmojiProjectUser) + "compose" + emojiText(EmojiBundleAssets) + "assets"},
...
{"range 3872-3875", "range", map[string]interface{}{"parentId": emojiText(EmojiProjectUser) + "compose" + emojiText(EmojiBundleLibrary) + "js" + emojiText(EmojiFolderOrg) + "sketchpad" + emojiText(EmojiFileCode) + "designstorets", "startLine": float64(3872), "endLine": float64(3875)}, emojiText(EmojiProjectUser) + "compose" + emojiText(EmojiBundleLibrary) + "js" + emojiText(EmojiFolderOrg) + "sketchpad" + emojiText(EmojiFileCode) + "designstorets" + emojiText(EmojiLine) + "3872" + emojiText(EmojiLine) + "3875"},
