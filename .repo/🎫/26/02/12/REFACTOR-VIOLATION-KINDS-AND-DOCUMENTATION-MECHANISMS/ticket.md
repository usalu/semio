...
- **assets/repo/some/folder/file_invalid.tsx**: Rewritten with no identification, AGPL+MIT (wrong license), no contributors, unnamed region, orphan definition.
- **assets/repo/some/folder/file_fixable.tsx**: Rewritten with missing endregion name and name mismatch breachs (autofixable).
- **assets/repo/some/folder/file_fixable_expected.tsx**: Rewritten with corrected endregion names.
- **assets/repo/some/folder/file_fixed.{tsx,py,cs,go}**: Valid headers with [ID](URI), flat license, summary.
- **assets/repo/some/folder/file_invalid.{py,cs,go}**: Old-format plain IDs.
- **assets/repo/some/folder/file_empty_region.tsx**: Valid header with [ID](URI).
