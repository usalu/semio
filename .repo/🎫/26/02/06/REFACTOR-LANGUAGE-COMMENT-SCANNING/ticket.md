...
- `assets/repo/some/folder/file_fixed.tsx`: Fixed header ID format.
- `assets/repo/some/folder/file_fixed.py`: Fixed header ID format, removed bare # comment.
- `assets/repo/some/folder/file_fixed.go`: Fixed header ID format.
- `assets/repo/some/folder/file_fixed.cs`: Fixed header ID format.
- `assets/repo/some/folder/file_fixable.tsx`: Restored original fixture with breachs.
- `assets/repo/some/folder/file_fixable_expected.tsx`: Fixed header ID format.
