...
- Added compose.navigate VS Code command handling all resource types
- Extended Go tests: 43 cases in TestArtifactIDAndURI, 21 in TestIdToUri, 30 in TestUriToId, plus helper tests
- Added compose.navigate to VS Code expected commands
...
- [x] VS Code: add composerepo URI handler + compose.navigate command
