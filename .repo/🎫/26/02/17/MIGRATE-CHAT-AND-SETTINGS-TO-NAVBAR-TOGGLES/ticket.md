...
- [x] Run `npx tsc -p compose/js/tsconfig.json --noEmit`
...
- Validation:
  ...
  - `npx playwright test compose/js/sketchpad.test.ts --grep "Design Navbar Settings Is Available" --reporter=line` passed with local `vite` server on `127.0.0.1:5173`.
