...
// L18448:   ticketPath = fmt.Sprintf(".repo/🎫/%02d/%02d/%02d/%s/ticket.md", ticket.Year, ticket.Month, ticket.Day, ticket.Slug)
// L18449: }
```
...
```go
// L567: files := []string{
// L568:   ".repo/🎫/26/01/20/SAMPLE/plan.md",
// L569:   "./.repo/🎫/26/01/20/SAMPLE/ticket.md",
// L570:   filepath.Join(rootDir, ".repo", "🎫", "26", "01", "20", "SAMPLE", "extra.txt"),
```
...
// L814: ticketPath = path.join(wsRoot, ".repo", "🎫", year, month, day, slug, "ticket.md");
```
...
// L818:   ticketPath = path.join(wsRoot, ".repo", "🎫", parsed.path, "ticket.md");
```
...
// L1066:   return path.join(root, ".repo", "🎫", relPath);
// L1067: }
```
