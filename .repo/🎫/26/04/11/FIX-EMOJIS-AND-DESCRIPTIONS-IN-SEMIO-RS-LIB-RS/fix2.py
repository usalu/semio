"""Fix all doc comment emojis and descriptions in semio/rs/lib.rs."""
...
FUNC_DESC = {
    "SemioError": (
        "\u274c",
        "SemioError represents a domain error with context message",
    ),
    "Result": ("\u2705", "Result represents a success or SemioError outcome"),
    ...
    "wasm": ("\U0001f310", "WebAssembly bindings for the semio library"),
    "tests": ("\U0001f9ea", "unit and integration tests for the semio library"),
    "flatten_design": (
        "\U0001f4d0",
...
# Pattern for the specific broken lines: "/// <summary>🔧xyz.</summary>"
...
for i, line in enumerate(lines):
    ...
    if m:
        ...
        # These are lines like: "/// <summary>🔧ror.</summary>" where the first script ate the name
                ...
                # Handle Default impl
                    ...
                    if desc:
                        ...
                        if entity_name.startswith("find_"):
                            ...
                            new_line = f"{bm.group(1)}<summary>\u2705Result represents a success or SemioError outcome.</summary>"
                        else:
                            new_line = (
