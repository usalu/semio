...
const indexPath = "c:/git/semio/semio/js/index.ts";
const regionPath = "c:/git/semio/.repo/🎫/26/04/25/SEMIO-JS-THIN-CLIENT-REFACTOR/kit_local_mirror_region.txt";

const index = fs.readFileSync(indexPath, "utf8");
const region = fs.readFileSync(regionPath, "utf8");

const start = index.indexOf("/** 🧱Normalizes plain kit DTOs into the JS [`Kit`] entity wrapper. */");
