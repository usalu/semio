...
try {
  const response = await page.goto('http://127.0.0.1:6007/iframe.html?id=compose-algorithms-drag--default&viewMode=story', { waitUntil: 'domcontentloaded', timeout: 30000 });
