...
tests.push(["kit-scalars", (b, a) => {
  a.name = "Modified"; a.version = "r25.08-1"; a.description = "Mod";
  a.icon = "ic"; a.image = "im"; a.remote = "https://x"; a.homepage = "https://h";
  a.license = "MIT"; a.preview = "p";
}]);

tests.push(["types-remove", (b, a) => {
  const types = a.types!;
  const idx = types.findIndex((t: any) => t.guid === "71749140-9db9-43f6-bd81-d89011667b80");
  if (idx >= 0) types.splice(idx, 1);
}]);

tests.push(["types-update-scalars", (b, a) => {
...
tests.push(["types-update-location", (b, a) => {
  const t = a.types!.find((t: any) => t.guid === "277768b5-9220-4312-bf0d-ab82d9fb6a73") as any;
  if (t) t.location = { guid: newGuid() };
}]);

tests.push(["types-update-parent", (b, a) => {
  const t = a.types!.find((t: any) => t.guid === "277768b5-9220-4312-bf0d-ab82d9fb6a73") as any;
  if (t) t.parent = { guid: a.types![2].guid };
}]);

tests.push(["types-update-authors", (b, a) => {
  const t = a.types!.find((t: any) => t.guid === "277768b5-9220-4312-bf0d-ab82d9fb6a73") as any;
  if (t) t.authors = [{ guid: b.authors![0].guid }];
}]);

tests.push(["types-update-concepts", (b, a) => {
  const t = a.types!.find((t: any) => t.guid === "277768b5-9220-4312-bf0d-ab82d9fb6a73") as any;
  if (t) t.concepts = [{ guid: b.concepts![0].guid }];
}]);

tests.push(["types-update-connectors", (b, a) => {
  const t = a.types!.find((t: any) => t.guid === "277768b5-9220-4312-bf0d-ab82d9fb6a73") as any;
  if (t) {
...
tests.push(["types-update-models", (b, a) => {
  const t = a.types!.find((t: any) => t.guid === "277768b5-9220-4312-bf0d-ab82d9fb6a73") as any;
  if (t) {
    t.models.splice(0, 1);
    t.models[0].name = "mod";
...
tests.push(["designs-update-pieces", (b, a) => {
  ...
  if (d) {
    ...
    if (pieces.length >= 2) {
      ...
      d.connections = (d.connections ?? []).filter((c:any) =>
        c.connected?.piece?.guid !== removed.guid && c.connecting?.piece?.guid !== removed.guid
      );
    }
