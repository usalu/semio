...
async function main() {
  ...
  await page.evaluate((kitGuid) => {
    window.__SEMIO_NAVIGATE__(`/kits/${kitGuid}`);
  }, importedKitGuid);
  ...
  await page.evaluate(
    ({ designGuid, kitGuid }) => {
      window.__SEMIO_NAVIGATE__(`/kits/${kitGuid}/designs/${designGuid}`);
    },
  ...
  await page.screenshot({
    path: "/workspaces/semio/.repo/🎫/26/03/31/ALIGN-TREE-ACTION-BUTTONS-TO-VALUE-COLUMN-RIGHT-EDGE/design-page.png",
  });
