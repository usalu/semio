...

{
  ...
  extract 2157 2383
  echo ''
  echo '// #region 🔖CanvasExtension'
  echo '/// 🧩 Extension hook for domain-specific canvas behavior (hit-test, paint, kinds).'
  ...
  echo '    }'
  echo '}'
  echo '// #endregion 🔖CanvasExtension'
} > "$CAVAS"

{
  ...
  echo '}'
  echo ''
  echo '// #region 🔖GraphExtension'
  echo 'pub trait GraphExtension: cavas::CanvasExtension {}'
  echo '// #endregion 🔖GraphExtension'
  echo ''
