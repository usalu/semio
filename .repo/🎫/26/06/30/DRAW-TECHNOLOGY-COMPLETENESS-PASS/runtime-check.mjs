...
const { parseDrawDocument, flattenDrawDocumentToSceneNodes, drawPlayLayersTreeRowId, drawPlayLayerIdFromTreeRowId, findDrawLayer, applyDrawEditOp, createDrawShapeLayer, createDrawTextLayer, createDrawImageLayer, defaultDrawDocument } = await import(
  coreUrl
);
...
console.log(
  "[DEBUG] runtime-check emblem nodes",
...
const richDoc = applyDrawEditOp(applyDrawEditOp(applyDrawEditOp(defaultDrawDocument("rich"), { op: "addShapeLayer", layer: shape }), { op: "addTextLayer", layer: text }), { op: "addImageLayer", layer: image });
