...
## Changes
- `semio/js/sketchpad.test.ts`: Extended all 5 app test blocks with comprehensive toolbar tests
...
- Kit/Design use namespaced IDs (`semio.sketchpad.app.kit.tools.select.mode.additive`)
