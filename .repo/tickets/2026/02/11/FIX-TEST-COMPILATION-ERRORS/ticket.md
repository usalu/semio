...
- Changed inline camera type to Camera import from semio.ts
...
- Fixed @semio/assets module resolution by adding path mappings to tsconfig.json
...
- Fixed semio.test.ts validation result type mismatch
- Fixed semio.test.ts Design type casting issue
