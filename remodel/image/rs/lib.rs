...
// #region 🔖Codec
/// ⚠️ Error type for PNG codec operations; `Dimensions` signals a size/buffer mismatch before any encoding is attempted.
#[derive(Clone, Debug, PartialEq)]
pub enum ImageError {
    Decode(String),
    Encode(String),
...
impl std::fmt::Display for ImageError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Self::Decode(msg) => write!(f, "png decode failed: {msg}"),
