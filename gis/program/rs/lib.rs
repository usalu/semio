//! 🌐 GIS program — 2D map app in a hot-swappable WASM program.
...
pub(crate) mod domain {
    ...
    /// render mode, vector style, LOD, selection, layer visibility, stroke weights) is program runtime, not
...
pub mod app_2d {
    //! 🗺️ GIS 2D program — GIS map play app bundled as a hot-swappable WASM program.
    ...
    use semio_framework_program::{SurfaceKind, PanelGroup,
        ...
        DocumentApp, DocumentView, DwgDrawing, DwgGeometry, MediaClass, MediaForm, MediaType, OsMediaCapability, OsMediaFormat, PanelTreeBuilder, ArtifactKindSpec, TiledMapScene,
    ...
    pub fn register_gis2d_exports() {
        ...
        // 🗂️ Sole native setup hook for the whole `gis` program bundle (`semio_program!`'s single
        ...
        semio_framework_program::program_runtime::register_document_codec_for_app::<Gis2dPlayApp>(GIS_MAP_SCHEMA);
        semio_framework_program::program_runtime::register_document_codec_for_app::<crate::app_3d::Gis3dPlayApp>(crate::domain::GIS_3D_TERRAIN_SCHEMA);
    }
    //#endregion 🔖Manifest
    ...
    mod tests {
        use super::*;
        use semio_framework_program::{testkit, ActionKind, ProgramApp, VcsDocumentApp};
...
pub mod app_3d {
    //! ⛰️ GIS 3D program — terrain viewer app bundled as a hot-swappable WASM program. Reuses the
