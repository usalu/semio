...
| ----------------- | -------------------------------------------------------------------------------------- |
| Digital platforms | Which metadata exists? Which is missing? Can data be exported via APIs?                |
| Urban mining      | How are elements identified before demolition? Which data is captured at source?       |
| Material supply   | How is stock described and updated? What would designers need beyond current listings? |
| Engineering       | Which data is needed for structural plausibility? How are components checked today?    |
| Design            | How do reused components enter early design? When do stock constraints shape concept?  |
