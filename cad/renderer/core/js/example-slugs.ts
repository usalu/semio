...
export function resolveCadPlayExampleSlug(slug: string): string | undefined {
...
if (import.meta.vitest) {
  ...
  describe("resolveCadPlayExampleSlug", () => {
    it("maps concrete shorthand to concrete-forest-left", () => {
      expect(resolveCadPlayExampleSlug("concrete")).toBe("concrete-forest-left");
      expect(resolveCadPlayExampleSlug("concrete-forest-right")).toBe("concrete-forest-right");
    });
  });
}
