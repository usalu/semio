...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@puzzle/2d/play", replacement: resolve(repoRoot, "puzzle/2d/play/play.ts") },
      { find: "@puzzle/3d/play", replacement: resolve(repoRoot, "puzzle/3d/play/play.ts") },
      { find: "@puzzle/5d/play", replacement: resolve(repoRoot, "puzzle/5d/play/play.ts") },
