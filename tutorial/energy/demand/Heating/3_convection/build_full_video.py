"""Render, mux, and compose Heating Module 3 (Konvektion) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_GebaeudeKonvektion", base_dir / "beat_1_audio.mp3"),
        ("Beat2_Innenvolumen", base_dir / "beat_2_audio.mp3"),
        ("Beat3_Luftwechselrate", base_dir / "beat_3_audio.mp3"),
    ...
    final_output = base_dir / "Full_Modul3_Konvektion.mp4"
