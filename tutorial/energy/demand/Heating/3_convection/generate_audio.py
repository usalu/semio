"""Generate TTS audio for Heating Module 3 (Konvektion).

Narration text is imported from each Beat's NARRATION in scene_3.py.
"""
...
from scene_3 import (  # noqa: E402
    Beat1_GebaeudeKonvektion,
    Beat2_Innenvolumen,
    Beat3_Luftwechselrate,
...
def main():
    print("=== Modul 3 (Konvektion) TTS Audio Generation ===\n")
