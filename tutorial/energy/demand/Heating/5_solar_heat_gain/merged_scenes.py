"""⚠️ LEGACY — do not edit or render this file.

The Heating Modul 5 template lives in ``scene_5.py``:

- Top title: ``Modul 5: Solarer Wärmegewinn`` (same pattern as Modul 2–4)
- Teal beat subtitle under the title (``beat_subtitle``)
- German bottom subtitle bar (``caption_bar`` / ``swap_caption``)

Open ``scene_5.py`` in Sideview and pick a ``Beat*`` class.
"""
