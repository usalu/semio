"""Render, mux, and compose Heating Module 5 (Solarer Wärmegewinn) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_VerlustZuGewinn", base_dir / "beat_1_audio.mp3"),
        ("Beat2_BestrahlungUndFlaeche", base_dir / "beat_2_audio.mp3"),
        ("Beat3_GWert", base_dir / "beat_3_audio.mp3"),
        ("Beat4_SaisonaleWinkel", base_dir / "beat_4_audio.mp3"),
        ("Beat5_Verschattung", base_dir / "beat_5_audio.mp3"),
        ("Beat6_Waermespeicherung", base_dir / "beat_6_audio.mp3"),
        ("Beat7_SpeichermasseFormel", base_dir / "beat_7_audio.mp3"),
        ("Beat8_Hauptgleichung", base_dir / "beat_8_audio.mp3"),
    ]
    ...
    final_output = base_dir / "Full_Modul5_SolarerWaermegewinn.mp4"
