"""Render, mux, and compose Heating Module 1 (Einführung: Drei Wege der Wärme) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_DreiWegeDerWaerme", base_dir / "beat_1_audio.mp3"),
        ("Beat2_Waermeleitung",     base_dir / "beat_2_audio.mp3"),
        ("Beat3_Konvektion",        base_dir / "beat_3_audio.mp3"),
        ("Beat4_Strahlung",         base_dir / "beat_4_audio.mp3"),
        ("Beat5_Zusammenfassung",   base_dir / "beat_5_audio.mp3"),
        ("Beat6_VonWegenZuZahlen",  base_dir / "beat_6_audio.mp3"),
        ("Beat7_Waermedurchlasswiderstand", base_dir / "beat_7_audio.mp3"),
        ("Beat8_UWert",             base_dir / "beat_8_audio.mp3"),
        ("Beat9_WaermestromFormel", base_dir / "beat_9_audio.mp3"),
    ]
    ...
    final_output = base_dir / "Full_Modul1_Einfuehrung.mp4"
