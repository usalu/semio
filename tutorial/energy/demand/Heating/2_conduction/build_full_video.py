...
def main():
    ...
    script_path = base_dir / "scene_2.py"
    ...
    for idx, (scene_name, audio_path) in enumerate(scenes, start=1):
        ...
        rendered_mp4 = output_dir / "media" / "videos" / "scene_2" / "1080p60" / f"{scene_name}.mp4"
    ...
    final_output = base_dir / "Full_Modul2_Waermeleitung.mp4"
