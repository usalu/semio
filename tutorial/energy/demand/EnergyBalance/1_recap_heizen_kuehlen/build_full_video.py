"""Render, mux, and compose Chapter 1 (Rückblick: Heizen & Kühlen) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_Bilanzgrenze",             base_dir / "beat_1_audio.mp3"),
        ("Beat2_Verlustseite",     base_dir / "beat_2_audio.mp3"),
        ("Beat3_Gewinnseite",            base_dir / "beat_3_audio.mp3"),
        ("Beat4_WinterUndSommer", base_dir / "beat_4_audio.mp3"),
    ]
    ...
    final_output = base_dir / "Full_Chapter1_Recap_Heizen_Kuehlen.mp4"
