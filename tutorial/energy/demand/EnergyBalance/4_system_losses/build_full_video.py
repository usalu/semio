"""Render, mux, and compose Chapter 4 (Von der Nutzenergie zur Endenergie) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_Verlustkette",         base_dir / "beat_1_audio.mp3"),
        ("Beat2_UebergabeVerteilungSpeicherung",              base_dir / "beat_2_audio.mp3"),
        ("Beat3_Erzeugung",        base_dir / "beat_3_audio.mp3"),
        ("Beat4_Anlagenaufwandszahl", base_dir / "beat_4_audio.mp3"),
    ]
    ...
    final_output = base_dir / "Full_Chapter4_System_Losses.mp4"
