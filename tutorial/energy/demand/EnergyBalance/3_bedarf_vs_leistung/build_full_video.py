"""Render, mux, and compose Chapter 3 (Bedarf vs. Leistung) into a single video."""
...
def main():
    ...
    script_path = base_dir / "scene_3.py"
    output_dir = base_dir / "rendered"
    output_dir.mkdir(exist_ok=True)

    # Each tuple: (SceneClassName, audio_file_stem)
    scenes = [
        ("Beat1_LeistungUndEnergie", base_dir / "beat_1_audio.mp3"),
        ("Beat2_Normheizlast",       base_dir / "beat_2_audio.mp3"),
        ("Beat3_Jahresdauerlinie",          base_dir / "beat_3_audio.mp3"),
        ("Beat4_RichtigAuslegen",       base_dir / "beat_4_audio.mp3"),
    ]
    ...
    for idx, (scene_name, audio_path) in enumerate(scenes, start=1):
        ...
        rendered_mp4 = output_dir / "media" / "videos" / "scene_3" / "1080p60" / f"{scene_name}.mp4"
    ...
    final_output = base_dir / "Full_Chapter3_Bedarf_vs_Leistung.mp4"
