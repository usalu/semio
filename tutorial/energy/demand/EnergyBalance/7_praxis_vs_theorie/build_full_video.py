"""Render, mux, and compose Chapter 7 (Theorie vs. Praxis) into a single video."""
...
def main():
    ...
    script_path = base_dir / "scene_7.py"
    output_dir = base_dir / "rendered"
    output_dir.mkdir(exist_ok=True)

    # Each tuple: (SceneClassName, audio_file_stem)
    scenes = [
        ("Beat1_BerechnungVsAbrechnung", base_dir / "beat_1_audio.mp3"),
        ("Beat2_HydraulischerAbgleich",       base_dir / "beat_2_audio.mp3"),
        ("Beat3_SerienAbschluss",       base_dir / "beat_3_audio.mp3"),
    ]
    ...
    for idx, (scene_name, audio_path) in enumerate(scenes, start=1):
        ...
        rendered_mp4 = output_dir / "media" / "videos" / "scene_7" / "1080p60" / f"{scene_name}.mp4"
    ...
    final_output = base_dir / "Full_Chapter7_Praxis_vs_Theorie.mp4"
