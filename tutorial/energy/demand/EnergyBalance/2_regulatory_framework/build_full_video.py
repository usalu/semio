"""Render, mux, and compose Chapter 2 (Regulatorischer Rahmen & Klima) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_GEGundNormen",          base_dir / "beat_1_audio.mp3"),
        ("Beat2_Monatsbilanz",        base_dir / "beat_2_audio.mp3"),
        ("Beat3_Klimadaten", base_dir / "beat_3_audio.mp3"),
        ("Beat4_Gradtagszahl",       base_dir / "beat_4_audio.mp3"),
    ]
    ...
    final_output = base_dir / "Full_Chapter2_Regulatory_Framework.mp4"
