"""Render, mux, and compose Scene 4 (Solare Strahlung & Verglasung) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_SolarIrradiance",    base_dir / "beat_1_audio.mp3"),
        ("Beat2_FrameFactor",        base_dir / "beat_2_audio.mp3"),
        ("Beat3_ShadingFactor",      base_dir / "beat_3_audio.mp3"),
        ("Beat4_GlassTransmittance", base_dir / "beat_4_audio.mp3"),
        ("Beat5_SolarCoolingLoad",   base_dir / "beat_5_audio.mp3"),
    ]
    ...
    final_output = base_dir / "Full_Scene4_Solar_Radiation.mp4"
