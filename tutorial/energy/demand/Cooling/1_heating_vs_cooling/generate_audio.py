...
Voice model is chosen by env (see repo README audio notes):

    export TUTORIAL_TTS_BASE_URL=https://api.openai.com/v1
    export TUTORIAL_TTS_MODEL=gpt-4o-mini-tts
    export TTS_API_KEY=sk-...
    export TTS_VOICE=ash
    export TTS_INSTRUCTIONS="Sprich Hochdeutsch als ruhige, kompetente Dozentin. \
Gleichmäßiges Tempo, klare Betonung am Satzende, natürliche Atempausen an Kommas \
und Gedankenstrichen. Sachlich, nicht werblich, kein Singsang."
"""
