"""Render, mux, and compose Scene 2 (Internal Gains) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_OfficeRoom", base_dir / "beat_1_audio.mp3"),
    ...
    final_output = base_dir / "Full_Scene2_Internal_Gains.mp4"
