"""Render, mux, and compose Scene 3 (Transmission & Feuchtigkeit) into a single video."""
...
def main():
    ...
    scenes = [
        ("Beat1_TransmissionOpaque", base_dir / "beat_1_audio.mp3"),
        ("Beat2_TimeLag",            base_dir / "beat_2_audio.mp3"),
        ("Beat3_VentilationHeat",    base_dir / "beat_3_audio.mp3"),
        ("Beat4_SensibleVsLatent",   base_dir / "beat_4_audio.mp3"),
    ]
    ...
    final_output = base_dir / "Full_Scene3_Transmission_Humidity.mp4"
