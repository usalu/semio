...
1. ✅️ Update `PanelSection` interface in `elements.tsx`
2. ✅️ Update `PanelSectionProvider` to sort by specificity (descending), then order (ascending)
3. ✅️ Add `SectionSpecificity` enum to `elements.tsx`
4. ✅️ Export `SectionSpecificity` from `App.tsx`
5. ✅️ Update Home App sections (SKETCHPAD = 0)
6. ✅️ Update Kit App sections (KIT = 10, SELECTION = 30 for artifacts)
7. ✅️ Update Design App sections (DESIGN = 20, SELECTION = 30)
8. ✅️ Update Type App sections (TYPE = 20, SELECTION = 30 for connectors)
9. ✅️ Update Quality App sections (QUALITY = 20)
10. ✅️ Update Docs App sections (DOCS = 20)
