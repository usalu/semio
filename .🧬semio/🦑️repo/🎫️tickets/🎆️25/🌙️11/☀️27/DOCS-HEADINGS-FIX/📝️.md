...
Additionally, the MDX heading components were registering headings using `children.toString()` which produced broken text like `[object Object],🦗️ Grasshopper (Rhino 8)` for complex React children.
