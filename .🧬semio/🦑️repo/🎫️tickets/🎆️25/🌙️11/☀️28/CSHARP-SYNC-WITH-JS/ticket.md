...
1. ✅️ Analyze JS test structure in `js/compose/compose.test.ts`
2. ✅️ Identify JSON fixtures in `assets/compose/`
3. ✅️ Fix C# schema: Parent fields → TypeId?/DesignId?
4. ✅️ Fix Connection/ConnectionDiff: X/Y → U/V (float?)
5. ✅️ Remove obsolete CompatiblePorts from Connector/ConnectorDiff
6. ✅️ Add HashCode polyfill for .NET Framework 4.8 compatibility
7. ✅️ Rewrite C# Tests.cs matching JS test structure
8. ✅️ Verify all tests pass on net7.0
9. ✅️ Verify both net7.0 and net48 build successfully
