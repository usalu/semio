...
1. ✅️ Analyze the handleDragEnd function in Design.tsx
2. ✅️ Fix the coordinate calculation to properly account for viewport transform
3. ✅️ Update test to drop pieces in visible diagram area (not under workbench panel)
4. ✅️ Verify hover ring works when cursor is over placed piece
5. ✅️ Extend test to drop pieces at all four corners
6. ✅️ Add pan/zoom verification to test
