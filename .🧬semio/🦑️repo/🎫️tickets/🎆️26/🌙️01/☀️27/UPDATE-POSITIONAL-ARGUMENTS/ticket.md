...
- [x] Update ./repo/cli/main.go goal open command signature and extraction logic.
...
- Updated `./repo/cli/main.go` `goalCommand` to swap `extractUIFromArgs` and `extractLLMFromArgs` call order and make LLM optional.
- Rebuilt `repo` binary.
