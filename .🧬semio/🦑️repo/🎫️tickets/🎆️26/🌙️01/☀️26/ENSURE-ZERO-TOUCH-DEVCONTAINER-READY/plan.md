...
- [ ] Verify that Nx module resolution works for `@semio-tech/compose-sketchpad-play` and other apps.
- [ ] Verify that all repositories (compose and metabolism) are in a ready state.
