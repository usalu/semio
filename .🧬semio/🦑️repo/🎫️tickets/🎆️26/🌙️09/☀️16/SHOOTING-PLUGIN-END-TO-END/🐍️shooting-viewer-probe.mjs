/** 👁️ Shooting viewer probe: boots the editor playground, switches the navbar role to Viewer and checks the
 * viewer's scene window host renders without faults. Usage: cd <ticket> && bun 🐍️shooting-viewer-probe.mjs */
import { chromium } from "playwright";
import { mkdirSync, writeFileSync } from "node:fs";
import { join } from "node:path";
const outDir = join(import.meta.dir, "🗑️generated", process.env.SEMIO_PROBE_OUT ?? "shooting-viewer");
...
await page.goto("http://127.0.0.1:6019/?plugin=shooting", { waitUntil: "domcontentloaded" });
let s = null;
