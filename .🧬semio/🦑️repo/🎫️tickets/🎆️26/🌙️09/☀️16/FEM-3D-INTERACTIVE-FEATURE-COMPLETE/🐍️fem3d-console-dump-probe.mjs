/** 🩺️ Fem boot probe: loads a fem react dev playground headless, captures console + page errors,
 * the shell's readiness beacon, every rendered window host and a screenshot.
 * Usage: cd <ticket> && SEMIO_PROBE_URL=http://127.0.0.1:6087/?plugin=fem3d SEMIO_PROBE_OUT=fem3d-boot bun 🐍️fem3d-console-dump-probe.mjs
 */
...
const outDir = join(import.meta.dir, "🗑️generated", process.env.SEMIO_PROBE_OUT ?? "fem-boot");
