/** 🩺️ (semio-91 copy: full error stacks, first intake rejection context) Mid-run Abort and Finalize of a puzzle 3d fill in the React shell (:6013, Metal). For each action: start a long fill,
...
writeFileSync(`${out}/abort-finalize-midrun-stacks-${Date.now()}.txt`, report.join("\n"));
