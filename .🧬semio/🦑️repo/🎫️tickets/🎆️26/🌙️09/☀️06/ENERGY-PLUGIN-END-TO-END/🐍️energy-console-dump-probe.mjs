/** 🩺️ Energy boot probe: loads a energy react dev playground headless, captures console + page errors,
 * the shell's readiness beacon, every rendered window host and a screenshot.
 * Usage: cd <ticket> && SEMIO_PROBE_URL=http://127.0.0.1:6106/?plugin=energy SEMIO_PROBE_OUT=energy-boot bun 🐍️energy-console-dump-probe.mjs
 */
...
const outDir = join(import.meta.dir, "🗑️generated", process.env.SEMIO_PROBE_OUT ?? "energy-boot");
