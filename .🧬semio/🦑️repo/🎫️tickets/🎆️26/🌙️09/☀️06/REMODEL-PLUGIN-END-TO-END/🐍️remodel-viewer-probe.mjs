/** 👁️ Remodel viewer probe: boots the editor playground, switches the navbar role to Viewer and checks the
 * viewer's scene window host renders without faults. Usage: cd <ticket> && bun 🐍️remodel-viewer-probe.mjs */
import { chromium } from "playwright";
import { mkdirSync, writeFileSync } from "node:fs";
import { join } from "node:path";
const outDir = join(import.meta.dir, "🗑️generated", process.env.SEMIO_PROBE_OUT ?? "remodel-viewer");
...
await page.goto("http://127.0.0.1:6063/?plugin=remodel", { waitUntil: "domcontentloaded" });
let s = null;
