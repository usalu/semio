#!/bin/zsh
# 🔒 One react-dev activation for slice B3f, serialized through the fleet wasm mutex (preamble
...
#
# Usage: 📜️b3f-activate.sh <variant>
cd /Users/ueli/Documents/semio || exit 1
TICKET=".🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️09/☀️18/OS-HUB-COLLABORATION-AI-END-TO-END"
VARIANT="$1"
LOG="$TICKET/🗑️generated/b3f-${VARIANT}-activate.txt"
CHAIN="$TICKET/🗑️generated/b3f-activate-chain.txt"
...
zsh "$TICKET/📜️wasm-build-mutex.sh" b3f -- bun nx run "@semio-tech/framework-os-dev:activate-${VARIANT}-react-dev" >> "$LOG" 2>&1
CODE=$?
