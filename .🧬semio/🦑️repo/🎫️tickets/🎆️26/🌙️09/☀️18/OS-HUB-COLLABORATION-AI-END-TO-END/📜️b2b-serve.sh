#!/bin/zsh
# 🛰️ Detached react dev serve for a batch-B dormant plugin (slice B2b).
# Usage: 📜️b2b-serve.sh <variant> <port>
VARIANT="$1"; PORT="$2"
LOG="/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️09/☀️18/OS-HUB-COLLABORATION-AI-END-TO-END/🗑️generated/b2b-${VARIANT}-serve.txt"
exec > "$LOG" 2>&1
