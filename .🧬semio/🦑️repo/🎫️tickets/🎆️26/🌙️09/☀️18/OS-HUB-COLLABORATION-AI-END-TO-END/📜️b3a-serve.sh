#!/bin/zsh
# 🛰️ Detached react dev serve for a batch-B dormant plugin (slice B3a).
# Usage: 📜️b3a-serve.sh <variant> <port>
VARIANT="$1"; PORT="$2"
LOG="/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️09/☀️18/OS-HUB-COLLABORATION-AI-END-TO-END/🗑️generated/b3a-${VARIANT}-serve.txt"
exec > "$LOG" 2>&1
