/** 🩺️ Wfc boot probe: loads a wfc react dev playground headless, captures console + page errors,
 * the shell's readiness beacon, every rendered window host and a screenshot.
 * Usage: cd <ticket> && SEMIO_PROBE_URL=http://127.0.0.1:6063/?plugin=wfc SEMIO_PROBE_OUT=wfc-boot bun 🐍️wfc-console-dump-probe.mjs
 */
...
const outDir = join(import.meta.dir, "🗑️generated", process.env.SEMIO_PROBE_OUT ?? "wfc-boot");
