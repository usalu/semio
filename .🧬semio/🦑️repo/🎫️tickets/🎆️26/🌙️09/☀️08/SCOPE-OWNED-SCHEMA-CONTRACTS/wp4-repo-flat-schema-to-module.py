...
jobs = [
    ...
    ("🧰️framework/🛍️products/📓️print/🔨️modules/🔤print-font-catalog/🧬️schema.json",
     ...
     "https://json.schemas.assets.semio-tech.com/print/print-font-catalog/schema.json",
    ...
    ("🧰️framework/🛍️products/📓️print/🔨️modules/🖨️tectonic-template-compilation/📇️catalog/🧬️schema.json",
     ...
     "https://json.schemas.assets.semio-tech.com/print/tectonic-template-compilation/catalog/schema.json",
    ...
    ("🧰️framework/🛍️products/📓️print/🔨️modules/🖨️tectonic-template-compilation/📚️bundle/🧬️schema.json",
     ...
     "https://json.schemas.assets.semio-tech.com/print/tectonic-template-compilation/bundle/schema.json",
    ...
    ("🧰️framework/🛍️products/📓️print/🔨️modules/🖨️tectonic-template-compilation/🔧️toolchain/🧬️schema.json",
     ...
     "https://json.schemas.assets.semio-tech.com/print/tectonic-template-compilation/toolchain/schema.json",
    ...
    ("♻️mit-bestand/📋️bericht/🔨️modules/📄️documents/🧬️schema.json",
     ...
     "https://json.schemas.assets.semio-tech.com/mit-bestand/bericht/documents/schema.json",
    ...
    ("♻️mit-bestand/🧺️demonstrator/🔨️modules/🧩️runtime/🧬️schema.json",
     ...
     "https://json.schemas.assets.semio-tech.com/mit-bestand/demonstrator/runtime/schema.json",
