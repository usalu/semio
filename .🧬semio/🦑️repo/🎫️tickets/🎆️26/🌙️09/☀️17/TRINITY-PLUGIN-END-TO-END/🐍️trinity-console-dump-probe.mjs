/** 🩺️ Trinity boot probe: loads a trinity (jack/rewriting) react dev playground headless, captures console + page errors,
 * the shell's readiness beacon, every rendered window host and a screenshot.
 * Usage: cd <ticket> && SEMIO_PROBE_URL=http://127.0.0.1:6054/?plugin=trinity-jack SEMIO_PROBE_OUT=jack-boot bun 🐍️trinity-console-dump-probe.mjs
 */
...
const outDir = join(import.meta.dir, "🗑️generated", process.env.SEMIO_PROBE_OUT ?? "jack-boot");
