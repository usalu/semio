...
date
bun /Users/ueli/Documents/semio/node_modules/vite/bin/vite.js --configLoader bundle --config "/Users/ueli/Documents/semio/🧰️framework/🛍️products/💻️os/🔨️modules/🧑‍💻dev/🏗️builder/🌐️vite/🟦️.ts" --host 127.0.0.1 --port 6028 --strictPort
echo "EXIT=$?"
date
