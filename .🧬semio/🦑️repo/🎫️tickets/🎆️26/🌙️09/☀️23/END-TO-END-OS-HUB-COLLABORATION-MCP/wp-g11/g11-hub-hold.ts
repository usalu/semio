#!/usr/bin/env bun
/** 🌎️ G11 hub hold (copy of W2's w2-hub-hold.ts): owns the local-bootstrap pipe for one hub and never exits while it runs.
...
const PROFILE = { profileId: "developer", subject: "local-developer-g11", displayName: "Local Developer", allowedClientClasses: ["native", "mcp", "react-relay", "admin-relay"] };
