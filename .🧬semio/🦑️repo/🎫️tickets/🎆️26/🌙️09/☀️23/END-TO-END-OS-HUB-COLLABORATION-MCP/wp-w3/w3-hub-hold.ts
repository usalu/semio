#!/usr/bin/env bun
/** 🌎️ W3 canonical hub hold (from W2): owns the local-bootstrap pipe for one hub and SUPERVISES it on its existing data root.
 * Usage (detached): python3 w3-detach.py <stateDir>/hold.txt bun w3-hub-hold.ts <port> <dataDir> <binary> <stateDir>
...
const PROFILE = { profileId: "developer", subject: "local-developer-w3", displayName: "Local Developer", allowedClientClasses: ["native", "mcp", "react-relay", "admin-relay"] };
const RESTART_MAX = 5;
