...
const result = await build({ entryPoints: [entry], bundle: true, write: false, metafile: true, platform: "node", format: "esm", logLevel: "info", absWorkingDir: repoRoot, plugins: [externalizeDeps as any] });
