#!/usr/bin/env python3
"""🔁️ WG9 session 13 (from WG7's session-12 set) — late joiners see no history: the hub half (coordinator decision 17:1x).

Both hub catch-up tails — the hello tail AND the mid-session `FrontierAdvertise` catch-up — carry a DECLARED hub origin (`HUB_CATCH_UP_ORIGIN`, pinned to the fixture's `hubCatchUpOrigin`),
