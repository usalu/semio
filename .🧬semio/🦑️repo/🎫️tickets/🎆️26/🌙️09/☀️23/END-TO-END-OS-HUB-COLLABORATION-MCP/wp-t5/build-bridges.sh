...
for manifest in $(find "✏️s/🔌️plugins" "🧰️framework/🛍️products/💻️os/🎚️config" -path "*/🏭️bridge/Cargo.toml" -not -path "*/🪆️subsets/*" | sort); do
  ...
  ( cd "$dir" && CARGO_INCREMENTAL=0 CARGO_BUILD_BUILD_DIR=/Users/ueli/Documents/semio/.tmp-ticket/wp-t5/build-bridge CARGO_TARGET_DIR=/Users/ueli/Documents/semio/.tmp-ticket/wp-t5/target-bridge cargo build --offline > "/Users/ueli/Documents/semio/$out/$name.txt" 2>&1; echo "exit $?" >> "/Users/ueli/Documents/semio/$out/$name.txt" )
