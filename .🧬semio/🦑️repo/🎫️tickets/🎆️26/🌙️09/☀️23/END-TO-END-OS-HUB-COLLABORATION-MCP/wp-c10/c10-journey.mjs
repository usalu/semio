...
import { activate, clickRowAction, dialog, read, rowIds, submitDialog, waitNewRow, waitRow } from "./c10-lib.mjs";
...
export async function edit(session, plugin, args = undefined) {
  ...
  return { verb, clicked, before, after: typeof after === "string" ? after : after.missed, applied: typeof after === "string" };
}
