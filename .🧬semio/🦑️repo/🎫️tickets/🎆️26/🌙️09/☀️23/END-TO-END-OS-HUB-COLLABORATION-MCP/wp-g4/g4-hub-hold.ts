#!/usr/bin/env bun
/** 🌎️ G4 hub hold — detached-safe. Usage:
...
const run = await startLocalHub(repoRoot, hubRust, [{ profileId: "developer", subject: "local-developer-g4", displayName: "Local Developer", allowedClientClasses: ["native", "mcp"] }], {
  port,
  dataDir: dataRoot,
  binaryPath,
  capture: true,
