#!/usr/bin/env python3
"""🔍️ E1 standalone runner for `mutate-remodeling-1/🐍️.py` — per-kind (before, mutation, after)
triads, VECTORS[kind] = (dir, fixture, wire_tag), 34 kinds (commit-reconstruction excluded)."""
