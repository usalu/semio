...
const TARGET_CAPABILITIES = new Set([
  "binary-raw-mutate", "block-2d-1-mutate", "block-3d-1-mutate", "block-5d-1-mutate", "cad-1-mutate",
  "curate-1-mutate", "din16798-1-mutate", "din18599-1-mutate", "din4108-1-mutate",
  "docx-ecma-376-strict-mutate", "docx-ecma-376-transitional-mutate", "dwg-ac1024-mutate",
  "en1990-1-mutate", "en1991-1-mutate", "en1992-1-mutate", "en1993-1-mutate", "en1994-1-mutate",
  "en1995-1-mutate", "en1996-1-mutate", "en1997-1-mutate", "en1998-1-mutate", "en1999-1-mutate",
  "energy-model-1-mutate", "flow-1-mutate", "gismap-1-mutate", "gisterrain-1-mutate", "html-5-mutate",
  "ifc-2x3-cobie-mutate", "ifc-2x3-cv20-mutate", "ifc-2x3-sav-mutate", "imperative-1-mutate",
  "jack-1-mutate", "jpg-jfif-1-01-baseline-mutate", "layout-1-mutate", "lowpoly-1-mutate",
  "playbook-1-mutate", "playground-1-mutate", "pptx-ecma-376-mutate", "pptx-ecma-376-strict-mutate",
  "pptx-ecma-376-transitional-mutate", "present-1-mutate", "procedural-2d-1-mutate",
  "procedural-3d-1-mutate", "process3d-1-mutate", "puzzle-2d-1-mutate", "puzzle-3d-1-mutate",
  "puzzle-5d-1-mutate", "raster-1-mutate", "remodel-1-mutate", "rewrite-1-mutate", "s-home-1-mutate",
  "s-space-1-mutate", "semio-v1-animation-mutate", "semio-v1-any-mutate", "semio-v1-audio-mutate",
  "semio-v1-flow-mutate", "semio-v1-graph-mutate", "semio-v1-image-mutate", "semio-v1-kit-mutate",
  "semio-v1-model-mutate", "semio-v1-object-mutate", "semio-v1-presentation-mutate",
  "semio-v1-table-mutate", "semio-v1-text-mutate", "semio-v1-value-mutate", "semio-v1-video-mutate",
  "shooting-1-mutate", "step-ap214-any-mutate", "svg-1-1-basic-mutate", "svg-1-1-tiny-mutate",
  "tiff-6-0-baseline-mutate", "txt-utf-8-mutate", "vcs-1-mutate", "vdi3805-1-mutate",
  "wav-riff-pcm-mutate", "wires-1-mutate", "writer-1-mutate", "xlsx-ecma-376-mutate",
  "xlsx-ecma-376-strict-mutate", "xlsx-ecma-376-transitional-mutate", "xml-1-0-valid-mutate",
  "zip-2-0-iso21320-mutate", "zip-2-0-mutate",
]);
