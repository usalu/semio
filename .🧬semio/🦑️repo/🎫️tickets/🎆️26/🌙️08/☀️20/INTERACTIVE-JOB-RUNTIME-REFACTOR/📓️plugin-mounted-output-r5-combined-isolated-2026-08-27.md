# Live Output R5 Combined and Isolated Native Evidence

Combined actual result: **2 passed,4 failed**,515 filtered,0.05s,exit1. Saturation's actual admission assertion passes (accepted=false), and child-step unwind passes. Four other tests fail at their initial reserve_mounted unwrap, before their intended ownership assertions. Preserve this combined RED; do not relabel it a full-six PASS.

All six unchanged tests then passed individually in fresh processes using the exact same compiled binary. Those six isolated native results establish their individual behavior, not concurrent-cohort timing or a same-process concurrency law. The binary SHA-256 before and after all eight isolated executions was `6a35395a803de7e10d13695a560123d1234e056411de0e96cbe85728409c926d`.

Separate Dag dropped-Future probes remain RED: checkpoint fails at existing assertion left1/right0 at36019, before its new parked assertion; registration observes zero rather than one installed dialect at37609. These are not live output tests.

The actual roster contains521 tests. Selected eight exact names and every command/full output follow. The canonical Plugin test script currently runs plain cargo test; its process-global pool saturation fixture shares capacity with concurrent tests. Isolated diagnosis is consistent with that interference, but a dedicated same-process concurrent admission law and canonical process-isolated cohort remain pending.

R4 selected input census plus the only own R5 field-borrow correction applies: current PatchTracker SHA `bbc7c5bfde84b5cce6b0b915d78061b4e7c34f49da460c5b479093fdfee45bff`. No budget, stack, pool capacity, or production serialization changed.

## Combined Command and Full Output

```sh
set -o pipefail
SEMIO_COVERAGE=0 NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx run @semio-tech/framework-plugin:test --skip-nx-cache --args='mounted_output_admission_ -- --nocapture' 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-mounted-output-admission-r5-2026-08-27.txt'
```
...
warning: unnecessary qualification
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1240:21
     |
1240 |         let bytes = std::mem::size_of::<PatchTrackerState>();
     |                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
     |
help: remove the unnecessary path segments
     |
1240 -         let bytes = std::mem::size_of::<PatchTrackerState>();
1240 +         let bytes = size_of::<PatchTrackerState>();
     |

warning: unnecessary qualification
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1656:19
     |
1656 |         let key = super::super::instance_lifetime::NativeCloseKey::fixture(instance, 1);
     |                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
     |
help: remove the unnecessary path segments
     |
1656 -         let key = super::super::instance_lifetime::NativeCloseKey::fixture(instance, 1);
1656 +         let key = NativeCloseKey::fixture(instance, 1);
     |
...
warning: type `ArtifactToolRegistration` is more private than the item `component::app::AppActionRegistry::tool_job_registration`
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:11950:9
      |
11950 | /         pub(crate) fn tool_job_registration<A: ArtifactApp>(
11951 | |             &self,
11952 | |             runtime_controller_id: &str,
11953 | |             document_schema: &str,
...     |
11956 | |             registrations: &BTreeMap<String, ArtifactToolRegistration>,
11957 | |         ) -> Result<(String, Vec<QualifiedBoundedFirstStepProof>), Fault> {
...
note: but type `ArtifactToolRegistration` is only usable at visibility `pub(self)`
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:12576:5
      |
12576 |     struct ArtifactToolRegistration {
      |     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

warning: type `ToolCancellationLease` is more private than the item `component::app::ToolCancellationHandle::begin`
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:14638:9
      |
14638 |         pub(crate) fn begin(&self, key: ToolOperationKey) -> Result<ToolCancellationLease, Fault> {
...
note: but type `ToolCancellationLease` is only usable at visibility `pub(self)`
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:14807:5
      |
14807 |     struct ToolCancellationLease {
      |     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:37597:5
      |
37597 | /     subset! {
37598 | |         pub derived dialect "s.test.subset-macro" / "1" / "derived" {
37599 | |             validator: MacroDerivedValidator,
37600 | |         }
37601 | |     }
      | |_____^
      |
...
warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:37606:9
      |
37606 |         register_subset();
      |         ^^^^^^^^^^^^^^^^^
      |
      = note: futures do nothing unless you `.await` or poll them
...
warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:37607:9
      |
37607 |         register_subset();
      |         ^^^^^^^^^^^^^^^^^
      |
      = note: futures do nothing unless you `.await` or poll them
...
warning: associated function `from_operation` is never used
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:8028:12
     |
8027 |     impl AppOperationContext {
     |     ------------------------ associated function in this implementation
8028 |         fn from_operation(app_instance_id: u32, parent_document_id: String, operation: semio_framework_job::Operation, canonical_b...
     |            ^^^^^^^^^^^^^^

warning: associated function `with_dispatch_context` is never used
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:8062:18
     |
8044 |     impl<'a, P> ArtifactView<'a, P> {
     |     ------------------------------- associated function in this implementation
...
8062 |         async fn with_dispatch_context(snapshot: &'a P, history: &'a HistoryView, children: ChildContentView, operation: AppOperat...
     |                  ^^^^^^^^^^^^^^^^^^^^^

warning: field `seq` is never read
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:9078:9
     |
9077 |     struct ValidatedPeerRosterCommit {
     |            ------------------------- field in this struct
9078 |         seq: u64,
     |         ^^^

warning: associated function `new` is never used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:14001:31
      |
14000 |             impl $job {
      |             --------- associated function in this implementation
14001 |                 pub(crate) fn new(raw: Vec<u8>, total_items: usize) -> Self {
      |                               ^^^
...
14170 |     framework_reserved_job!(FrameworkImportMediaJob, FrameworkImportMediaJobFactory, "import-media", 10, 8_388_608, 8_192, 4_096, 8_388_608);
      |     ---------------------------------------------------------------------------------------------------------------------------------------- in this macro invocation
      |
...
warning: associated function `new` is never used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:14120:20
      |
14119 |             impl<A: ArtifactApp> $factory<A> {
      |             -------------------------------- associated function in this implementation
14120 |                 fn new(controller_id: &str) -> Self {
      |                    ^^^
...
14170 |     framework_reserved_job!(FrameworkImportMediaJob, FrameworkImportMediaJobFactory, "import-media", 10, 8_388_608, 8_192, 4_096, 8_388_608);
      |     ---------------------------------------------------------------------------------------------------------------------------------------- in this macro invocation
...
warning: fields `verb` and `contract` are never read
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:15885:9
      |
15884 |     struct MountedTypedCommandFullOperation<A: ArtifactApp> {
      |            -------------------------------- fields in this struct
15885 |         verb: String,
      |         ^^^^
...
15894 |         contract: semio_framework::ToolExecutionContract,
      |         ^^^^^^^^

warning: variant `OutputValidation` is never constructed
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:16232:9
      |
16229 |     enum TypedCommandFullOperationPhase {
      |          ------------------------------ variant in this enum
...
16232 |         OutputValidation,
      |         ^^^^^^^^^^^^^^^^
      |
...
warning: fields `app_instance_id` and `canonical_base_revision` are never read
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:16242:9
      |
16240 |     pub(crate) struct TypedCommandFullOperationJob<A: ArtifactApp> {
      |                       ---------------------------- fields in this struct
16241 |         operation: Option<semio_framework_job::Operation>,
16242 |         app_instance_id: u32,
      |         ^^^^^^^^^^^^^^^
16243 |         parent_document_id: Option<String>,
16244 |         canonical_base_revision: [u8; 32],
      |         ^^^^^^^^^^^^^^^^^^^^^^^

warning: method `admit_exposure_freshness` is never used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:16306:12
      |
16278 |     impl<A: ArtifactApp> TypedCommandFullOperationJob<A> {
      |     ---------------------------------------------------- method in this implementation
...
16306 |         fn admit_exposure_freshness(&mut self, revision: semio_framework_job::RevisionId, generation: semio_framework_job::Genera...
      |            ^^^^^^^^^^^^^^^^^^^^^^^^

warning: field `preview_sequence` is never read
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:27804:9
      |
27797 |     struct RuntimeCloseWorkerState<PA: PluginApp> {
      |            ----------------------- field in this struct
...
27804 |         preview_sequence: AtomicU64,
      |         ^^^^^^^^^^^^^^^^

warning: associated function `new` is never used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:27835:12
      |
27834 |     impl RuntimeActorAuthority {
      |     -------------------------- associated function in this implementation
27835 |         fn new(actor: String) -> Result<Self, Fault> {
      |            ^^^

warning: methods `entry_mut` and `get_mut` are never used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:27893:12
      |
27855 |     impl<T> RuntimeInstanceRegistry<T> {
      |     ---------------------------------- methods in this implementation
...
27893 |         fn entry_mut(&mut self, index: usize) -> Option<&mut (u32, T)> {
      |            ^^^^^^^^^
...
27927 |         fn get_mut(&mut self, instance_id: u32) -> Option<&mut T> {
      |            ^^^^^^^

warning: field `instance_id` is never read
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:28800:9
      |
28799 |     struct RuntimeCloseCleanupJob<PA: PluginApp> {
      |            ---------------------- field in this struct
28800 |         instance_id: u32,
      |         ^^^^^^^^^^^
...
warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:36009:13
      |
36009 |             crate::reactor::test_support::run_until_idle(8); // parks — still in flight when checkpointed
      |             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      |
      = note: futures do nothing unless you `.await` or poll them

warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:36018:13
      |
36018 |             crate::reactor::test_support::cancel_instance_registry_requests(instance);
      |             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      |
      = note: futures do nothing unless you `.await` or poll them

warning: calls to `std::mem::drop` with a value that implements `Copy` does nothing
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:18102:17
      |
18102 |                 drop(page);
      |                 ^^^^^----^
      |                      |
...
warning: unused `Result` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:24451:13
      |
24451 |             self.store.detach_backbone();
      |             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      |
      = note: this `Result` may be an `Err` variant, which should be handled
help: use `let _ = ...` to ignore the resulting value
      |
24451 |             let _ = self.store.detach_backbone();
      |             +++++++

warning: `semio-framework-plugin` (lib test) generated 600 warnings (run `cargo fix --lib -p semio-framework-plugin --tests` to apply 547 suggestions)
    Finished `test` profile [unoptimized] target(s) in 42.56s
...
note: to see what the problems were, use the option `--future-incompat-report`, or run `cargo report future-incompatibilities --id 27`
...
thread 'component::reactor::patches::tests::mounted_output_admission_close_waits_for_the_original_uncommitted_grant' (8422171) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1226:105:
called `Result::unwrap()` on an `Err` value: SurfaceId("76:grant")
stack backtrace:
...
test component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full ... ok
   ...
   3: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_close_waits_for_the_original_uncommitted_grant
   4: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_close_waits_for_the_original_uncommitted_grant::{closure#0}
   5: <semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_close_waits_for_the_original_uncommitted_grant::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.

thread 'component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners' (8422173) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1146:92:
called `Result::unwrap()` on an `Err` value: SurfaceId("73:producer-source")
stack backtrace:
   0: __rustc::rust_begin_unwind
   1: core::panicking::panic_fmt
   2: core::result::unwrap_failed
   3: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners
   4: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners::{closure#0}
   5: <semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
test component::reactor::patches::tests::mounted_output_admission_close_waits_for_the_original_uncommitted_grant ... FAILED

thread 'component::reactor::patches::tests::mounted_output_admission_cancel_and_drop_keep_the_original_close_generation' (8422170) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1083:60:
called `Result::unwrap()` on an `Err` value: SurfaceId("74:cancelled-admission")
test component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners ... FAILED
stack backtrace:
   0: __rustc::rust_begin_unwind
   1: core::panicking::panic_fmt
   2: core::result::unwrap_failed
   3: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_cancel_and_drop_keep_the_original_close_generation
   4: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_cancel_and_drop_keep_the_original_close_generation::{closure#0}
   5: <semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_cancel_and_drop_keep_the_original_close_generation::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.

thread 'component::reactor::patches::tests::mounted_output_admission_direct_receiver_preserves_captured_lifetime_generation_and_callback_roots' (8422172) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1184:123:
called `Result::unwrap()` on an `Err` value: SurfaceId("75:direct")
stack backtrace:
   0: __rustc::rust_begin_unwind
   1: core::panicking::panic_fmt
   2: core::result::unwrap_failed
   3: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_direct_receiver_preserves_captured_lifetime_generation_and_callback_roots
   4: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_direct_receiver_preserves_captured_lifetime_generation_and_callback_roots::{closure#0}
   5: <semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_direct_receiver_preserves_captured_lifetime_generation_and_callback_roots::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
test component::reactor::patches::tests::mounted_output_admission_cancel_and_drop_keep_the_original_close_generation ... FAILED

thread 'component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box' (8422174) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:964:79:
[DEBUG] actual mounted producer partial-step unwind
stack backtrace:
test component::reactor::patches::tests::mounted_output_admission_direct_receiver_preserves_captured_lifetime_generation_and_callback_roots ... FAILED
   0: __rustc::rust_begin_unwind
   1: core::panicking::panic_fmt
...
failures:
    component::reactor::patches::tests::mounted_output_admission_cancel_and_drop_keep_the_original_close_generation
    component::reactor::patches::tests::mounted_output_admission_close_waits_for_the_original_uncommitted_grant
    ...
    component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners

test result: FAILED. 2 passed; 4 failed; 0 ignored; 0 measured; 515 filtered out; finished in 0.05s
...
```sh
set -o pipefail
NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx exec --projects=@semio-tech/framework-plugin --skip-nx-cache -- '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8' --exact 'component::reactor::patches::tests::mounted_output_admission_cancel_and_drop_keep_the_original_close_generation' --nocapture 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-live-isolated-r5-01-2026-08-27.txt'
```
...
test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 520 filtered out; finished in 0.02s
...
```sh
set -o pipefail
NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx exec --projects=@semio-tech/framework-plugin --skip-nx-cache -- '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8' --exact 'component::reactor::patches::tests::mounted_output_admission_close_waits_for_the_original_uncommitted_grant' --nocapture 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-live-isolated-r5-02-2026-08-27.txt'
```
...
test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 520 filtered out; finished in 0.00s
...
```sh
set -o pipefail
NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx exec --projects=@semio-tech/framework-plugin --skip-nx-cache -- '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8' --exact 'component::reactor::patches::tests::mounted_output_admission_direct_receiver_preserves_captured_lifetime_generation_and_callback_roots' --nocapture 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-live-isolated-r5-03-2026-08-27.txt'
```
...
thread 'component::reactor::patches::tests::mounted_output_admission_direct_receiver_preserves_captured_lifetime_generation_and_callback_roots' (8439195) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:960:82:
...
thread 'component::reactor::patches::tests::mounted_output_admission_direct_receiver_preserves_captured_lifetime_generation_and_callback_roots' (8439195) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1211:13:
...
test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 520 filtered out; finished in 0.21s
...
```sh
set -o pipefail
NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx exec --projects=@semio-tech/framework-plugin --skip-nx-cache -- '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8' --exact 'component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners' --nocapture 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-live-isolated-r5-04-2026-08-27.txt'
```
...
## component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box

Process exit: 0.

```sh
set -o pipefail
NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx exec --projects=@semio-tech/framework-plugin --skip-nx-cache -- '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8' --exact 'component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box' --nocapture 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-live-isolated-r5-05-2026-08-27.txt'
```
...
thread 'component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box' (8440527) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:964:79:
[DEBUG] actual mounted producer partial-step unwind
stack backtrace:
   0: __rustc::rust_begin_unwind
   1: core::panicking::panic_fmt
...
## component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full

Process exit: 0.

```sh
set -o pipefail
NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx exec --projects=@semio-tech/framework-plugin --skip-nx-cache -- '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8' --exact 'component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full' --nocapture 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-live-isolated-r5-06-2026-08-27.txt'
```
...
test result: ok. 1 passed; 0 failed; 0 ignored; 0 measured; 520 filtered out; finished in 0.01s
...
```sh
set -o pipefail
NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx exec --projects=@semio-tech/framework-plugin --skip-nx-cache -- '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8' --exact 'component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume' --nocapture 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-live-isolated-r5-07-2026-08-27.txt'
```
...
thread 'component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume' (8442289) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:36019:13:
...
stack backtrace:
   ...
   4: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume::{closure#0}
   5: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume::__semio_async_test_block_on::<semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume::{closure#0}>
   6: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume
   ...
   8: <semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
test component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume ... FAILED
...
test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 520 filtered out; finished in 0.04s

Error: Command failed: "/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8" "--exact" "component::plugin_runtime::plugin_builder_contract_tests::checkpoint_then_restore_requeues_a_restartable_tasks_command_as_a_resume" "--nocapture"
...
## component::subset_macro_tests::subset_macro_derived_register_is_idempotent

Process exit: 1.

```sh
set -o pipefail
NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx exec --projects=@semio-tech/framework-plugin --skip-nx-cache -- '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8' --exact 'component::subset_macro_tests::subset_macro_derived_register_is_idempotent' --nocapture 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-live-isolated-r5-08-2026-08-27.txt'
```
...
thread 'component::subset_macro_tests::subset_macro_derived_register_is_idempotent' (8443612) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:37609:9:
assertion `left == right` failed: two completed registrations must install exactly one actual registry entry
  left: 0
 right: 1
stack backtrace:
   0: __rustc::rust_begin_unwind
   ...
   4: semio_framework_plugin::component::subset_macro_tests::subset_macro_derived_register_is_idempotent::{closure#0}
   5: semio_framework_plugin::component::subset_macro_tests::subset_macro_derived_register_is_idempotent::__semio_async_test_block_on::<semio_framework_plugin::component::subset_macro_tests::subset_macro_derived_register_is_idempotent::{closure#0}>
   6: semio_framework_plugin::component::subset_macro_tests::subset_macro_derived_register_is_idempotent
   7: semio_framework_plugin::component::subset_macro_tests::subset_macro_derived_register_is_idempotent::{closure#0}
   8: <semio_framework_plugin::component::subset_macro_tests::subset_macro_derived_register_is_idempotent::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
test component::subset_macro_tests::subset_macro_derived_register_is_idempotent ... FAILED
...
test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 520 filtered out; finished in 0.02s

Error: Command failed: "/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad/debug/deps/semio_framework_plugin-d81b8cb7f98afff8" "--exact" "component::subset_macro_tests::subset_macro_derived_register_is_idempotent" "--nocapture"
    at genericNodeError (node:internal/errors:985:15)
    at wrappedFn (node:internal/errors:539:14)
    at checkExecSyncError (node:child_process:925:11)
    at execSync (node:child_process:997:15)
