# Independent Renderer Full R15 and Strict R20

## Results

The coordinator actually ran the current canonical renderer long-test target on2026-08-27 at16:15:34. Exit0:542tests passed across5files,26.37s. This supersedes full R14's532-test checkpoint. The separate concrete OwnedSurface target passed5/5; its source review and full output are in `📓️coordinator-owned-surface-r1-2026-08-27.md`.

The immediately following strict React project typecheck exited1 with exactly7diagnostics. They are the existing real tutorial/interactionSelection joins in the demonstrator brand fixture, renderer test fixture and ShellHelpers. No extra OwnedSurface type diagnostic appeared in this actual run. Do not hide these errors with an empty selection or resurrect the deleted PluginViewState.selectionJson field.

These checks do not establish live flat UiNodeView adoption, prepared scene decoding, native or component-Wasm parity, all-app accessibility or the strict8ms ceiling. Those gates remain open; GIS's fresh component continuation stall is separately under investigation.
...
Warning: The 'NO_COLOR' env is ignored due to the 'FORCE_COLOR' env being set.
 ...
 Test Files  5 passed (5)
   ...
   Start at  16:15:34
   Duration  26.37s (transform 14.39s, setup 0ms, import 17.24s, tests 27.95s, environment 1.47s)
