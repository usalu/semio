...
warning: unnecessary qualification
   --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:896:30
    |
896 |         let receiver_bytes = std::mem::size_of::<ReadySlot>();
    |                              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    |
help: remove the unnecessary path segments
    |
896 -         let receiver_bytes = std::mem::size_of::<ReadySlot>();
896 +         let receiver_bytes = size_of::<ReadySlot>();
    |

warning: unnecessary qualification
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1061:19
     |
1061 |         let key = super::super::instance_lifetime::NativeCloseKey::fixture(instance, 1);
     |                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
     |
help: remove the unnecessary path segments
     |
1061 -         let key = super::super::instance_lifetime::NativeCloseKey::fixture(instance, 1);
1061 +         let key = NativeCloseKey::fixture(instance, 1);
     |

warning: unnecessary qualification
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1098:27
     |
1098 |         let mut outputs = semio_framework_ui_runtime::SurfaceReconcileOutputs::default();
     |                           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
     |
help: remove the unnecessary path segments
     |
1098 -         let mut outputs = semio_framework_ui_runtime::SurfaceReconcileOutputs::default();
1098 +         let mut outputs = SurfaceReconcileOutputs::default();
     |

warning: unnecessary qualification
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1239:21
     |
1239 |         let bytes = std::mem::size_of::<PatchTrackerState>();
     |                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
     |
help: remove the unnecessary path segments
     |
1239 -         let bytes = std::mem::size_of::<PatchTrackerState>();
1239 +         let bytes = size_of::<PatchTrackerState>();
     |

warning: unnecessary qualification
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1655:19
     |
1655 |         let key = super::super::instance_lifetime::NativeCloseKey::fixture(instance, 1);
     |                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
     |
help: remove the unnecessary path segments
     |
1655 -         let key = super::super::instance_lifetime::NativeCloseKey::fixture(instance, 1);
1655 +         let key = NativeCloseKey::fixture(instance, 1);
     |
...
error[E0499]: cannot borrow `state` as mutable more than once at a time
   --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:740:21
    |
739 | ...   let surface = state.slots[surface_index].as_mut().expect("transferred job and canonical root retained");
    |                     ----- first mutable borrow occurs here
740 | ...   state.terminals[target] = Some(TerminalSlot { key: surface.key, instance: Some(closing.instance), authority: surface.job.take...
    |       ^^^^^ second mutable borrow occurs here
741 | ...   surface.output_index = None;
    |       --------------------------- first borrow later used here

For more information about this error, try `rustc --explain E0499`.
warning: `semio-framework-plugin` (lib test) generated 555 warnings
error: could not compile `semio-framework-plugin` (lib test) due to 1 previous error; 558 warnings emitted
