# Plugin PatchTracker Full R8

Actual canonical exhaustive/no-fail-fast module run: **30 tests executed, 30 passed, 0 failed, 492 skipped**, 0.933s; Nx exit 0. No test in the PatchTracker module was excluded. The source hold was released immediately after completion; no Rust process remains active in this lane.

The corrected existing capacity test reports actual fixed backing 534,368 bytes, three 8,388,608-byte reservations, full ledger 25,700,192 bytes, unchanged exact cap-plus-one refusal, and final credit restored to 534,368 bytes. All seven live-output laws also passed, including a real two-thread shared-pool contention/saturation law and controlled child/receiver callback unwinds. No quota, timing ceiling, thread setting, production serialization, or central runner configuration was changed.

R6 29/1 remains the actual preceding RED; R5 combined same-process 2/4 and isolated-six diagnostics are retained separately. Nx's final historical “flaky task” notice is included below; the actual nextest run had no failing test. This is not a full Plugin suite, guest/WIT execution, external publication timing, or eager-constructor resident admission proof. Those remaining joins are listed in the [receiver handoff](./📓️live-patchtracker-output-receiver-handoff-2026-08-28.md).

Selected nested source hashes were captured after both source owners confirmed their holds: [R7 held inputs](./📓️plugin-patchtracker-r7-held-source-inputs-2026-08-28.md). This is a selected non-atomic roster, not a claimed full dependency closure. All output below is copied directly from untruncated stored tool result chunks, avoiding the later-read loss seen in older .txt artifacts.

## Command

```sh
set -o pipefail
SEMIO_COVERAGE=0 NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx run @semio-tech/framework-plugin:test --skip-nx-cache --args='exhaustive component::reactor::patches::tests:: --no-fail-fast -- --nocapture' 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-patchtracker-full-r8-2026-08-28.md'
```
