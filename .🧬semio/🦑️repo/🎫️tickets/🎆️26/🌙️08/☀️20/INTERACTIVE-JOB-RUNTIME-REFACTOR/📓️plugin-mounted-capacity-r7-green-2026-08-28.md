# Plugin Mounted Capacity R7 GREEN

Actual corrected existing law: 1 passed, 521 skipped, 0.018s, Nx exit 0. Native DEBUG reports actual fixed backing 534,368 bytes, unchanged per-surface reservation 8,388,608 bytes, capacity 3, full dynamic-plus-fixed ledger 25,700,192 bytes, exact cap-plus-one refusal, and final restored credit 534,368 bytes. The capacity is derived with checked subtraction from the actual ledger, not hard-coded to three.

The fixture still asserts pre-producer reservation, exact overflow tree pointer, unchanged snapshot after refusal, every admitted byte/item/slot count, bounded exact-key close and final all-owner credit restoration. Production quotas and production code did not change for this correction. The original R6 29/1 RED remains evidence; full module regression is a separate R8 run.

Schema-first neutral boundary cases (zero/one/exact-boundary/plus-one/full fixed bytes) passed the existing Node Buffer/Ajv independent oracle, which reports 40 checks. This count is that existing function's declared count, not a newly counted assertion total.

Output copied directly from untruncated tool chunks.

```sh
set -o pipefail
SEMIO_COVERAGE=0 NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx run @semio-tech/framework-plugin:test --skip-nx-cache --args='exhaustive mounted_reservation_precedes_tree_and_cap_plus_one_returns_exact_owner --no-fail-fast -- --nocapture' 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-capacity-green-r7-2026-08-28.md'
```
