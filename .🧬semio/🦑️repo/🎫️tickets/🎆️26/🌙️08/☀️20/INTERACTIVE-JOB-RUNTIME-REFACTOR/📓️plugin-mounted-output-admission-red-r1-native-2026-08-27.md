# Mounted Output Admission R1 Native RED

Actual result: 0 passed, 3 failed, 514 filtered out, 0.17s; Nx exit1/Cargo101. Two tests reached intended ownership assertions. The saturation test failed cleanup before its admission assertion and is not yet a clean admission-semantic RED.

- Partial producer-step unwind: the real child step ran, injected panic was caught, then the exact structural Slot/Box/reservation preservation assertion was false instead of true (patches line1059).
- Incomplete producer sources: the retained reconciler was deliberately held outside the driver; the tuple extraction lost remaining reservation/tree owners, producing false instead of true at line1092 after cleanup.
- Shared pool saturation: `close_instance_to_empty` failed at line1014 (`instance 71 did not reach terminal empty`) before the final `admitted == false` assertion. The source has no output reservation, but that source observation is distinct from the unexecuted final assertion; cleanup needs diagnosis before the exact RED can be credited.

No production changes occurred between R8 compile, construction2 and this run. Native source holds were released immediately after the test process exited. Dag's subsequent construction-order repair is not part of this binary or evidence.

## Command

```sh
set -o pipefail
SEMIO_COVERAGE=0 NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx run @semio-tech/framework-plugin:test --skip-nx-cache --args='mounted_output_admission_ -- --nocapture' 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-mounted-output-admission-red-r1-2026-08-27.txt'
```

## Exact Output

[Raw retained output](./🧪️member-plugin-mounted-output-admission-red-r1-2026-08-27.txt), copied directly below:
...
warning: `semio-framework-plugin` (lib test) generated 590 warnings (run `cargo fix --lib -p semio-framework-plugin --tests` to apply 536 suggestions)
    Finished `test` profile [unoptimized] target(s) in 18.97s
...
thread 'component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box' (7987874) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:911:79:
...
thread 'component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners' (7987873) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1092:9:
assertion `left == right` failed: one missing source must not consume other completed owners
  left: false
 right: true
stack backtrace:
   0: __rustc::rust_begin_unwind
   ...
   4: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners
   5: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners::{closure#0}
   6: <semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_incomplete_producer_sources_preserve_remaining_owners::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.

thread 'component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box' (7987874) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1059:9:
assertion `left == right` failed: actual producer step must not remove the structural slot before invoking the child
  left: false
 right: true
stack backtrace:
   0: __rustc::rust_begin_unwind
   ...
   2: core::panicking::assert_failed_inner
   3: core::panicking::assert_failed::<bool, bool>
   4: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box
   5: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box::{closure#0}
   6: <semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
...
test component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box ... FAILED

thread 'component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full' (7987875) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1014:9:
instance 71 did not reach terminal empty
stack backtrace:
   0: __rustc::rust_begin_unwind
   1: core::panicking::panic_fmt
   2: semio_framework_plugin::component::reactor::patches::tests::close_instance_to_empty
   3: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full
   4: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full::{closure#0}
   5: <semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
test component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full ... FAILED
...
test result: FAILED. 0 passed; 3 failed; 0 ignored; 0 measured; 514 filtered out; finished in 0.17s
