# Native Close Construction R1 Semantic RED

Actual result: 0 passed, 2 failed, 515 filtered out, 0.23s; Nx exit1/Cargo101. Both laws reached their intended ownership assertions after cleanup. There was no SIGABRT or close-driver overrun in this run.

- `instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment`: observed `Some(false)`, required `Some(true)`, dispatch fixture line203.
- `instance_lifetime_close_construction_failure_preserves_original_live_root`: the explicitly injected pre-worker-allocation panic was caught; the later original-live-root assertion observed false, required true, line252. This is a deterministic construction-boundary failure injection, not an actual allocator failure.

The existing native Plugin target and unmodified R8 source snapshot were used. The producer/lifetime/runtime key files still matched R8 hashes; no tests were serialized or budgets raised. The next live-output3 run was dispatched without an intervening production change, and the source owner was notified to preserve the snapshot until it completed.

## Command

```sh
set -o pipefail
SEMIO_COVERAGE=0 NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx run @semio-tech/framework-plugin:test --skip-nx-cache --args='instance_lifetime_close_construct -- --nocapture' 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-close-construction-red-r1-2026-08-27.txt'
```

## Exact Output

[Raw retained output](./🧪️member-plugin-close-construction-red-r1-2026-08-27.txt), copied directly below:
...
warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:37505:5
      |
37505 | /     subset! {
37506 | |         pub derived dialect "s.test.subset-macro" / "1" / "derived" {
37507 | |             validator: MacroDerivedValidator,
37508 | |         }
37509 | |     }
      | |_____^
      |
...
warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:37513:9
      |
37513 |         register_subset();
      |         ^^^^^^^^^^^^^^^^^
      |
      = note: futures do nothing unless you `.await` or poll them
...
warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:35920:13
      |
35920 |             crate::reactor::test_support::run_until_idle(8); // parks — still in flight when checkpointed
      |             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      |
      = note: futures do nothing unless you `.await` or poll them

warning: unused implementer of `std::future::Future` that must be used
     --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:35928:13
      |
35928 |             crate::reactor::test_support::cancel_instance_registry_requests(instance);
      |             ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
      |
      = note: futures do nothing unless you `.await` or poll them
...
warning: unused implementer of `std::future::Future` that must be used
   --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../.././🧪️tests/🧬️mutation-fixtures/🪟️surface/🦀️.rs:195:5
    |
195 |     assert_viewer_never_mutates::<SurfaceViewerFixture>();
    |     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    |
    = note: futures do nothing unless you `.await` or poll them
...
warning: `semio-framework-plugin` (lib test) generated 590 warnings (run `cargo fix --lib -p semio-framework-plugin --tests` to apply 536 suggestions)
    Finished `test` profile [unoptimized] target(s) in 12.70s
...
note: to see what the problems were, use the option `--future-incompat-report`, or run `cargo report future-incompatibilities --id 24`
...
thread 'component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root' (7979601) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🦀️component.rs:29186:80:
...
thread 'component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment' (7979602) panicked at /Users/ueli/Documents/semio/🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🕹️interaction/📡️live/🧪️dispatch/🧪️component.rs:203:5:
...
stack backtrace:
   ...
   3: core::panicking::assert_failed::<core::option::Option<bool>, core::option::Option<bool>>
   4: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment::{closure#0}
   5: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment::__semio_async_test_block_on::<semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment::{closure#0}>
   6: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment
   7: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment::{closure#0}
   8: <semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
test component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment ... FAILED

thread 'component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root' (7979601) panicked at /Users/ueli/Documents/semio/🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../🕹️interaction/📡️live/🧪️dispatch/🧪️component.rs:252:5:
assertion `left == right` failed
  left: false
 right: true
stack backtrace:
   ...
   4: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root::{closure#0}
   5: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root::__semio_async_test_block_on::<semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root::{closure#0}>
   6: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root
   7: semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root::{closure#0}
   8: <semio_framework_plugin::component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
test component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root ... FAILED

failures:

failures:
    component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_construction_failure_preserves_original_live_root
    component::plugin_runtime::plugin_builder_contract_tests::local_interaction_dispatch::instance_lifetime_close_constructs_worker_shell_before_exact_live_detachment

test result: FAILED. 0 passed; 2 failed; 0 ignored; 0 measured; 515 filtered out; finished in 0.23s
...
[0m[1m1746 |[0m   [0m[35mif[0m (status !== [0m[33m0[0m) [0m[35mthrow[0m [0m[35mnew[0m [0m[1mError[0m([0m[32m`[0m${cmd}[0m[32m [0m${args[0m[3m[1m.join[0m([0m[32m" "[0m)}[0m[32m exited with status [0m${status}[0m[32m`[0m)[0m[2m;[0m
                                     [31m[1m^[0m
[0m[31merror[0m[2m:[0m [1mcargo test --manifest-path Cargo.toml --lib instance_lifetime_close_construct -- --nocapture exited with status 101[0m
...
Warning: command "bun 📜️script.ts test instance_lifetime_close_construct -- --nocapture" exited with non-zero status code
