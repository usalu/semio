# Mounted Output Admission R2

Actual native result: **3 passed, 1 failed, 515 filtered out**, 0.05s; Cargo 101 / Nx 1. Cancellation/Drop preserves admitted generation and reaches terminal; the actual child-step unwind retains the structural slot/producer; incomplete completion retains remaining owners. Shared-output saturation now reaches its intended assertion: admission was true, required false, after successful cleanup.

This does not prove consuming producer-to-job construction, its allocation/unwind handling, shared output preadmission, captured lifetime propagation, or full Plugin/guest timing. Those remain open.

The independent permanent cancellation fixture oracle ran 40 checks successfully; raw output: `🧪️member-runtime-output-cancel-oracle-r1-2026-08-27.txt`.

## Exact Command

```sh
set -o pipefail
SEMIO_COVERAGE=0 NX_DAEMON=false NX_CACHE_PROJECT_GRAPH=false NX_ISOLATE_PLUGINS=false CARGO_BUILD_JOBS=2 CARGO_TARGET_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧱️cargo-target-cad' SEMIO_TEST_ARTIFACT_DIR='/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️native-artifacts' SEMIO_BUILD_BUDGET_MS=3600000 RUST_BACKTRACE=1 bun x nx run @semio-tech/framework-plugin:test --skip-nx-cache --args='mounted_output_admission_ -- --nocapture' 2>&1 | tee '/Users/ueli/Documents/semio/.🧬semio/🦑️repo/🎫️tickets/🎆️26/🌙️08/☀️20/INTERACTIVE-JOB-RUNTIME-REFACTOR/🧪️member-plugin-mounted-output-admission-r2-2026-08-27.txt'
```
...
warning: unnecessary qualification
   --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:848:30
    |
848 | ...   let receiver_bytes = std::mem::size_of::<ReadySlot>() + std::mem::size_of::<TerminalSlot>() + 2 * std::mem::size_of::<Option<...
    |                            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    |
help: remove the unnecessary path segments
    |
848 -         let receiver_bytes = std::mem::size_of::<ReadySlot>() + std::mem::size_of::<TerminalSlot>() + 2 * std::mem::size_of::<Option<SurfaceReconcileJob>>();
848 +         let receiver_bytes = size_of::<ReadySlot>() + std::mem::size_of::<TerminalSlot>() + 2 * std::mem::size_of::<Option<SurfaceReconcileJob>>();
    |

warning: unnecessary qualification
   --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:848:65
    |
848 | ...   let receiver_bytes = std::mem::size_of::<ReadySlot>() + std::mem::size_of::<TerminalSlot>() + 2 * std::mem::size_of::<Option<...
    |                                                               ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    |
help: remove the unnecessary path segments
    |
848 -         let receiver_bytes = std::mem::size_of::<ReadySlot>() + std::mem::size_of::<TerminalSlot>() + 2 * std::mem::size_of::<Option<SurfaceReconcileJob>>();
848 +         let receiver_bytes = std::mem::size_of::<ReadySlot>() + size_of::<TerminalSlot>() + 2 * std::mem::size_of::<Option<SurfaceReconcileJob>>();
    |

warning: unnecessary qualification
   --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:848:107
    |
848 | ...d::mem::size_of::<TerminalSlot>() + 2 * std::mem::size_of::<Option<SurfaceReconcileJob>>();
    |                                            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    |
help: remove the unnecessary path segments
    |
848 -         let receiver_bytes = std::mem::size_of::<ReadySlot>() + std::mem::size_of::<TerminalSlot>() + 2 * std::mem::size_of::<Option<SurfaceReconcileJob>>();
848 +         let receiver_bytes = std::mem::size_of::<ReadySlot>() + std::mem::size_of::<TerminalSlot>() + 2 * size_of::<Option<SurfaceReconcileJob>>();
    |

warning: unnecessary qualification
    --> 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1122:21
     |
1122 |         let bytes = std::mem::size_of::<PatchTrackerState>();
     |                     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
     |
help: remove the unnecessary path segments
     |
1122 -         let bytes = std::mem::size_of::<PatchTrackerState>();
1122 +         let bytes = size_of::<PatchTrackerState>();
     |
...
warning: `semio-framework-plugin` (lib test) generated 591 warnings (run `cargo fix --lib -p semio-framework-plugin --tests` to apply 538 suggestions)
    Finished `test` profile [unoptimized] target(s) in 16.17s
...
thread 'component::reactor::patches::tests::mounted_output_admission_partial_producer_step_unwind_retains_original_slot_and_box' (8156959) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:914:79:
...
thread 'component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full' (8156960) panicked at 🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/📦️packages/🦀️rust/../../⚛️reactor/🩹️patches/🦀️component.rs:1056:9:
...
stack backtrace:
   ...
   4: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full
   5: semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full::{closure#0}
 ...
 6: <semio_framework_plugin::component::reactor::patches::tests::mounted_output_admission_refuses_before_tree_when_shared_output_pool_is_full::{closure#0} as core::ops::function::FnOnce<()>>::call_once
note: Some details are omitted, run with `RUST_BACKTRACE=full` for a verbose backtrace.
...
test result: FAILED. 3 passed; 1 failed; 0 ignored; 0 measured; 515 filtered out; finished in 0.05s
