# UI Conformance Relocation Input

```json
{
  "oldRoot": "🧰️framework/🔨️modules/🖱️ui/🧬️contract/📚️examples/🧪️conformance",
  "newRoot": "🧰️framework/🔨️modules/🖱️ui/🧬️contract/🧫️fixtures/🧪️conformance",
  "ledger": [
    {
