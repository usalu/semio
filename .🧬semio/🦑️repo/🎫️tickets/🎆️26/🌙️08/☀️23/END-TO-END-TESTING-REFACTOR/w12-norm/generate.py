...
for art, info in survey.items():
    ...
    parts = [
        ...
        f"`../../{SUB}/🧪️oracle/🔣️.json`, and it means the runner executes NO oracle role "
...
"""
    ...
    header = doc(
        ...
        f"(`../../{SUB}/🧪️oracle/🔣️.json`): `s.norm.{slug}` is a semio-native artifact with "
        ...
        "declares in `✏️s/🔌️plugins/📕️norm/🧪️oracle/🔣️.json`. The oracle handlers still "
