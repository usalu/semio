"""🐍️ Independent Python implementation of the EN 1998 mutation vocabulary — the second producer
this case's differential comparison needs.

`s.norm.en1998` is a semio-NATIVE artifact and no third-party library, in any ecosystem, reads or
writes it. That was checked rather than assumed: PyPI serves no `en1998`, `eurocode`, `vdi3805` or
...
judge this subset's `En1998Mutation` vocabulary. The reference is therefore a second IMPLEMENTATION,
...
DSL_ASSET = "asset://🏅️standards/🔖️1/🪆️subsets/✳️any/📚️examples/📕️seismic-rc-frame/🖼️assets/🗣️seismic-rc-frame.dsl.semio"
...
def identity_handler(ctx):
    """🔁️ The real committed EN 1998 document through the carrier it is committed in. That carrier
