"""🐍️ Independent Python implementation of the EN 1990 mutation vocabulary — the second producer
this case's differential comparison needs.

`s.norm.en1990` is a semio-NATIVE artifact and no third-party library, in any ecosystem, reads or
writes it. That was checked rather than assumed: PyPI serves no `en1990`, `eurocode`, `vdi3805` or
...
judge this subset's `En1990Mutation` vocabulary. The reference is therefore a second IMPLEMENTATION,
...
def identity_handler(ctx):
    """🔁️ The real committed EN 1990 document through the carrier it is committed in. That carrier
