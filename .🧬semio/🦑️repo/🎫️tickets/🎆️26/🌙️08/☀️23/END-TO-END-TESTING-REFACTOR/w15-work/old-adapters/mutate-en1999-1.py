"""🐍️ Independent Python implementation of the EN 1999 mutation vocabulary — the second producer
this case's differential comparison needs.

`s.norm.en1999` is a semio-NATIVE artifact and no third-party library, in any ecosystem, reads or
writes it. That was checked rather than assumed: PyPI serves no `en1999`, `eurocode`, `vdi3805` or
...
judge this subset's `En1999Mutation` vocabulary. The reference is therefore a second IMPLEMENTATION,
...
DSL_ASSET = "asset://🏅️standards/🔖️1/🪆️subsets/✳️any/📚️examples/📕️aluminium-roof-purlin/🖼️assets/🗣️aluminium-roof-purlin.dsl.semio"
...
def identity_handler(ctx):
    """🔁️ The real committed EN 1999 document through the carrier it is committed in. That carrier
