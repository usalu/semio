//! 📄️ @LABEL@ play app panel — the document headline: family, check count, worst utilization, verdict.
...
//#region 🔖️Constants
pub const BODY_DOCUMENT: &str = "norm.@VARIANT@.play.document";
...
//#region 🔖️Render
pub fn render(host: &NormHost<@FAMILY@>) -> UiNode {
