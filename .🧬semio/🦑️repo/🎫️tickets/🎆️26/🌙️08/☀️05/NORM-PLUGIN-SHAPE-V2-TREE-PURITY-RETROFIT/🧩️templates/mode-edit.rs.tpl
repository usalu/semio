//! ✏️ @LABEL@ play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::@MOD@::create_@MOD@_app`. Every norm app declares
