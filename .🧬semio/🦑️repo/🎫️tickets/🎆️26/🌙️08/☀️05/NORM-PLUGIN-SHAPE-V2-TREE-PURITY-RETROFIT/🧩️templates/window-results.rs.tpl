//! 📊️ @LABEL@ play app — the results window: every computed compliance check, one line each.
...
//#region 🔖️Constants
pub const WINDOW_RESULTS: &str = "norm-@VARIANT@-results";
pub const BODY_RESULTS: &str = "norm.@VARIANT@.play.results";
//#endregion 🔖️Constants

//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::@MOD@::create_@MOD@_app`.
