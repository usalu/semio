"use components";
import { nowMs } from './🟨️host-shim.js';
import { environment, exit as exit$1, stderr, stdin, stdout, terminalInput, terminalOutput, terminalStderr, terminalStdin, terminalStdout } from '../_vendor/cli.js';
import { monotonicClock } from '../_vendor/clocks.js';
import { error, poll as poll$2, streams } from '../_vendor/io.js';
import { insecureSeed as insecureSeed$1 } from '../_vendor/random.js';
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./scalefixture2.core.wasm', import.meta.url));
