...
export type Event = EventInstanceOpen | EventInstanceClose | EventActivate | EventSuspendRequest | EventCapabilityChanged | EventQuotaChanged | EventUiIntent | EventSurfaceVisible | EventSurfaceHidden | EventSurfaceResized | EventPatchAck | EventPatchRejected | EventCompleted | EventHttpChunk | EventJobProgress | EventJobCompleted | EventMessage | EventTimer | EventWake | EventRequest;
