...
- [x] Read all 20 files
- [x] PostCSS configs (5 files): desktop, docs, play, sketchpad, js
- [x] Tailwind configs (4 files): desktop, docs, play, sketchpad
- [x] Other small files (6 files): forge, preload, play/index, sketchpad/index, codegen, test-search
- [x] Vite configs (5 files): js, play, vscode, vscode-test, sketchpad
