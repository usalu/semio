...
- Fixed Contributor.GetID() to use emoji prefix `👤️` + Github handle
- Fixed Contributor.GetURI() to uppercase without Slugify
- Fixed Commit.GetID() to use emoji prefix `🔀️` + SHA
...
- Contributor.GetID() returned "contributor:Name" instead of "👤️github"
- Commit.GetID() returned "commit:sha" instead of "🔀️sha"
