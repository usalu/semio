...
- Updated `README.md` (`# 📦️ Bundles`) with the canonical Sketchpad toolbar tooltree mechanism and cross-app mapping.
...
- Updated `README.md` (`# 📦️ Bundles`) and `AGENTS.md` (`Business Logic -> Diagrams`, `UI/UX -> Sketchpad -> Kit Editor`, `# Codebase`) with strategy registry and snap-point routing ownership.
...
9. Updated docs:
   - `README.md` (`# 📦️ Bundles`) with shape strategy and snap-point routing mechanism,
