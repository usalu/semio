...
- `repo/go/main.go`: Added `Markdown` bool to `Config` struct. Added `MarkdownRenderer` struct and implementation. Added logic to switch to Markdown renderer when `--md` flag is present.
