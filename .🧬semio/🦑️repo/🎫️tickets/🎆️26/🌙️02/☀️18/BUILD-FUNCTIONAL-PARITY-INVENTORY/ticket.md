...
1. `assets/logo` → `@semio-tech/logo`
2. `assets/icons` → `@semio-tech/icons`
3. `assets` → `@semio-tech/assets`
...
**Dev deps:** `@semio-tech/logo` (internal)

#### `@semio-tech/assets` (assets)
...
**Dev deps:** `@semio-tech/assets`, `storybook`, `vite`, `vitest`, `@playwright/test`, `tailwindcss`, `postcss`, `eslint`, `prettier`, `tsx`, `typescript`
...
**Dev deps (npm):** `@semio-tech/assets`
...
```
@semio-tech/logo ← @semio-tech/icons
@semio-tech/logo, @semio-tech/icons ← @semio-tech/assets
@semio-tech/assets ← @semio-tech/compose-js
@semio-tech/assets ← @semio-tech/compose-engine (devDep)
@semio-tech/assets ← @semio-tech/compose-net (devDep)
@semio-tech/assets ← @coda/engine (devDep)
...
1. `@semio-tech/logo` → 2. `@semio-tech/icons` → 3. `@semio-tech/assets` → 4. `@semio-tech/compose-js` → 5. `@semio-tech/compose-sketchpad-docs`, `@semio-tech/compose-sketchpad-play`, `@semio-tech/compose-sketchpad`, `@semio-tech/compose-desktop`, `repo`
