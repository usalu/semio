...
FILE = "/workspaces/semio/repo/cli/main.go"
MAX_LINE = 15000

with open(FILE, "r") as f:
    lines = f.readlines()

section_start_re = re.compile(r"^// #region 🔖️(.+)$")
section_end_re = re.compile(r"^// #endregion 🔖️(.+)$")
...
def gen_spec(name, line, section_name):
    ...
    if name == "GetURI":
        return "GetURI MUST return a valid URI in the composerepo scheme."
