...
Fix data loading for Goals, Tickets, and Contributors in the "Monorepo" tree view of the repo VS Code extension.
...
### [js/vscode/extension.ts](repo/vscode/extension.ts)
...
- Add `.toPromise()` to all `client.query` calls in `repo/vscode/extension.ts`.
