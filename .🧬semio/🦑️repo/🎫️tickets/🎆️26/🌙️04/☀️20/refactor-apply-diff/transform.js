...
const newModule = `mod apply_diff {
    ...
    /// <summary>🔖️apply_collection_diff holds the data fields for a apply_collection_diff record.</summary>
    /// <remarks>
    /// </remarks>
    use super::*;
    ...
    impl Attribute {
        /// 🔖️Applies an AttributeDiff to this Attribute in-place.
    ...
    impl Prop {
        /// 🔖️Applies a PropDiff to this Prop in-place.
    ...
    impl Connector {
        /// 🔖️Applies a ConnectorDiff to this Connector in-place.
        pub fn apply_diff(
            &mut self,
            diff: &ConnectorDiff,
    ...
    impl Model {
        /// 🔖️Applies a ModelDiff to this Model in-place.
    ...
    impl Type {
        /// 🔖️Applies a TypeDiff to this Type in-place.
        pub fn apply_diff(
            &mut self,
            diff: &TypeDiff,
            types: &HashMap<String, Arc<Type>>,
    ...
    impl Layer {
        /// 🔖️Applies a LayerDiff to this Layer in-place.
    ...
    impl Group {
        /// 🔖️Applies a GroupDiff to this Group in-place.
    ...
    impl Stat {
        /// 🔖️Applies a StatDiff to this Stat in-place.
    ...
    impl Piece {
        /// 🔖️Applies a PieceDiff to this Piece in-place.
        pub fn apply_diff(
            &mut self,
            diff: &PieceDiff,
            types: &HashMap<String, Arc<Type>>,
    ...
    impl Connection {
        /// 🔖️Applies a ConnectionDiff to this Connection in-place.
        pub fn apply_diff(
            &mut self,
            diff: &ConnectionDiff,
    ...
    impl Design {
        /// 🔖️Applies a DesignDiff to this Design in-place.
        pub fn apply_diff(
            &mut self,
            diff: &DesignDiff,
            types: &HashMap<String, Arc<Type>>,
        ...
        /// 📌️Creates a mixed design keeping old entities with diff status annotations.
    ...
    impl Tag {
        /// 🔖️Applies a TagDiff to this Tag in-place.
    ...
    impl Concept {
        /// 🔖️Applies a ConceptDiff to this Concept in-place.
    ...
    impl Port {
        /// 🔖️Applies a PortDiff to this Port in-place.
    ...
    impl Quality {
        /// 🔖️Applies a QualityDiff to this Quality in-place.
    ...
    impl File {
        /// 🔖️Applies a FileDiff to this File in-place.
    ...
    impl Folder {
        /// 🔖️Applies a FolderDiff to this Folder in-place.
    ...
    impl Author {
        /// 🔖️Applies an AuthorDiff to this Author in-place.
    ...
    impl Kit {
        /// 🔖️Applies a KitDiff to this Kit in-place.
