...
SEMANTIC_MAP = {
    # Types/Concepts
    'event': '📡️', 'payload': '📦️', 'emit': '📤️', 'config': '⚙️', 'error': '❌️',
    'request': '📨️', 'response': '📩️', 'handler': '🎯️', 'middleware': '🔗️',
    'server': '🖥️', 'client': '💻️', 'connection': '🔌️', 'socket': '🔌️',
    'auth': '🔐️', 'token': '🎟️', 'session': '🪪️', 'cookie': '🍪️',
    'user': '👤️', 'contributor': '🤝️', 'author': '✍️', 'owner': '👑️',
    'ticket': '🎫️', 'goal': '⛳️', 'todo': '✅️', 'task': '📋️', 'draft': '📝️',
    'file': '📄️', 'folder': '📁️', 'directory': '📂️', 'path': '🛤️',
    'section': '📑️', 'definition': '📖️', 'scope': '🔭️',
    'tree': '🌳️', 'node': '🌿️', 'leaf': '🍃️', 'branch': '🌿️', 'root': '🌱️',
    'cache': '💾️', 'store': '🏪️', 'database': '🗄️', 'table': '📊️',
    'query': '🔍️', 'search': '🔎️', 'filter': '🧹️', 'sort': '📶️',
    'parse': '🔬️', 'scan': '📡️', 'extract': '🧲️', 'transform': '🔄️',
    'render': '🎨️', 'display': '📺️', 'view': '👁️', 'template': '📋️',
    'test': '🧪️', 'mock': '🎭️', 'fixture': '🔧️', 'assert': '✔️',
    'build': '🏗️', 'compile': '⚒️', 'deploy': '🚀️', 'install': '📥️',
    'log': '📜️', 'debug': '🐛️', 'trace': '🔬️', 'monitor': '📊️',
    'type': '🏷️', 'kind': '🏷️', 'enum': '📇️', 'interface': '🔌️',
    'struct': '🧱️', 'class': '🏛️', 'record': '💿️',
    'func': '⚡️', 'method': '🔧️', 'procedure': '📐️',
    'const': '🔒️', 'var': '📦️', 'param': '🎛️', 'arg': '🎛️',
    'string': '🔤️', 'number': '🔢️', 'bool': '🔘️', 'array': '📚️', 'map': '🗺️',
    'json': '📋️', 'xml': '📃️', 'yaml': '📃️', 'csv': '📊️',
    'url': '🌐️', 'uri': '🔗️', 'link': '🔗️', 'href': '🔗️',
    'regex': '🧩️', 'pattern': '🧩️', 'match': '🎯️',
    'color': '🎨️', 'theme': '🎨️', 'style': '💄️', 'icon': '🖼️',
    'button': '🔘️', 'input': '📝️', 'form': '📋️', 'dialog': '💬️',
    'list': '📋️', 'queue': '📋️', 'stack': '📚️', 'set': '🗃️',
    'work': '💼️', 'item': '🔖️', 'entry': '📍️', 'record': '💿️',
    'provider': '🔌️', 'factory': '🏭️', 'builder': '👷️', 'adapter': '🔄️',
    'open': '📬️', 'close': '📪️', 'create': '🆕️', 'delete': '🗑️',
    'change': '♻️', 'update': '🔁️', 'move': '🚚️', 'copy': '📋️',
    'read': '📖️', 'write': '✏️', 'send': '📤️', 'receive': '📥️',
    'start': '▶️', 'stop': '⏹️', 'pause': '⏸️', 'resume': '▶️',
    'add': '➕️', 'remove': '➖️', 'insert': '📌️', 'append': '➡️',
    'integrate': '🧬️', 'export': '📤️', 'import': '📥️',
    'analyze': '🔬️', 'fix': '🔧️', 'policy': '📜️', 'check': '✔️',
    'git': '🐙️', 'github': '🐙️', 'commit': '💾️', 'push': '⬆️', 'pull': '⬇️',
    'editor': '📝️', 'ide': '💻️', 'vscode': '💻️',
    'graphql': '🕸️', 'rest': '🌐️', 'grpc': '📡️', 'websocket': '🔌️',
    'emoji': '😀️', 'unicode': '🔤️', 'text': '📝️', 'font': '🔤️',
    'comment': '💬️', 'annotation': '📌️', 'label': '🏷️', 'tag': '🏷️',
    'heading': '📰️', 'title': '📌️', 'summary': '📋️', 'description': '📝️',
    'technology': '🛠️', 'bundle': '📦️', 'monorepo': '🏢️',
    'language': '🗣️', 'syntax': '📐️', 'grammar': '📐️',
    'ansi': '🎨️', 'mermaid': '🧜️', 'markdown': '📰️',
    'artifact': '🏺️', 'resource': '🎁️', 'asset': '🖼️',
    'sandbox': '🏖️', 'container': '📦️', 'devcontainer': '🐳️',
    'checkpoint': '💾️', 'snapshot': '📸️', 'version': '📌️',
    'milestone': '🎯️', 'release': '🚀️', 'publish': '📢️',
    'subscriber': '📬️', 'notification': '🔔️', 'alert': '⚠️', 'warn': '⚠️',
    'reopen': '🔓️', 'flag': '🚩️',
}
...
def get_semantic_emoji(name, doc, used_emojis):
    ...
    compounds = [
        ('ticket_open', '📬️'), ('ticket_close', '📪️'), ('ticket_reopen', '🔓️'),
        ('ticket_change', '♻️'), ('ticket_read', '📖️'),
        ('goal_open', '🎯️'), ('goal_close', '🏁️'), ('goal_reopen', '🔄️'), ('goal_change', '📐️'),
        ('todo_create', '🆕️'), ('todo_change', '✏️'), ('todo_delete', '🗑️'),
        ('draft_create', '📝️'), ('draft_delete', '🗑️'),
        ('file_create', '📄️'), ('file_move', '🚚️'), ('file_delete', '🗑️'),
        ('folder_create', '📁️'), ('folder_move', '🚚️'), ('folder_delete', '🗑️'),
        ('section_create', '📑️'), ('section_move', '🚚️'), ('section_delete', '🗑️'),
        ('contributor_add', '➕️'), ('contributor_remove', '➖️'),
        ('parsed_section', '📑️'), ('parsed_definition', '📖️'),
        ('section_frame', '🖼️'), ('scope_entry', '📍️'),
        ('work_item', '💼️'), ('contributor_work', '🤝️'),
        ('event_kind', '📡️'), ('checkpoint', '💾️'),
        ('integrate', '🧬️'), ('extract', '🧲️'), ('export', '📤️'),
        ('analyze', '🔬️'), ('fix', '🔧️'), ('policy', '📜️'),
        ('graphql', '🕸️'), ('move', '🚚️'), ('tree', '🌳️'),
    ]
