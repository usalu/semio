...
const randomWasm = await import("../../../../../../flow/modules/math/pkg/flow_extension_math.js");
...
const range = (await import("../../../../../../flow/modules/list/pkg/flow_extension_list.js")).evaluate("list.range", JSON.stringify({ start: 0, step: 2, count: 3 }));
