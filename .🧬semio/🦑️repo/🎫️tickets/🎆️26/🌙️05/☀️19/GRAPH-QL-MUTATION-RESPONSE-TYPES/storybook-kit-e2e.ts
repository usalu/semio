/**
 * @emoji 📚️ Same contract as Storybook `createStorybookKitGraphqlHandle` via `@semio-tech/compose-js`.
 * Run: `bun .repo/🎫️/26/05/19/GRAPH-QL-MUTATION-RESPONSE-TYPES/storybook-kit-e2e.ts`
 */
