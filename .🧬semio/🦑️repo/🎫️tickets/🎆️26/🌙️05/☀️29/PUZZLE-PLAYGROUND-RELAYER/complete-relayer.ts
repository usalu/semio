...
function extract2d(): void {
  ...
  const hostHeader = `// #region 🧲️Header
/** @emoji 🛝️ Board play React host — entry-only; imported from play/main.ts. */
// #endregion 🧲️Header
...
function extract3d(): void {
  ...
  let c = readFileSync(indexPath, "utf8");
  const marker = "\n// #region";
  const markers = ["\nfunction useScenePlayController():", "\n// #region 🧲️Header\n// 💻️ elements/client/lib/system/renderer/react/scene/scene-play-host"];
  let pos = -1;
  ...
  const hostHeader = `// #region 🧲️Header
/** @emoji 🛝️ Scene play React host — entry-only; imported from play/main.ts. */
// #endregion 🧲️Header
...
function extract5d(): void {
  ...
  const hostHeader = `// #region 🧲️Header
/** @emoji 🛝️ Topology play React host — entry-only; imported from play/main.ts. */
// #endregion 🧲️Header
