...
- **Extra Bolt graphs (env):** `NEO4J_EXTRA_GRAPH_DATABASES=comma,separated,names` — included in `bun run generate`, native `CREATE DATABASE`, `.repo/🛂️/<name>.cypher` stubs, and devcontainer post-start reload.
