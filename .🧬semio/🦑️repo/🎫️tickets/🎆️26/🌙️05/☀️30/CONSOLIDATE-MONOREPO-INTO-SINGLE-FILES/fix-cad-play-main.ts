...
const headlessEnd = lines.findIndex((l) => l === "//#endregion 🔖️Runtime");
const firstTestsStart = lines.findIndex((l) => l === "//#region 🧪️Tests");
const reactStart = lines.findIndex((l) => l.startsWith('import "./globals.css"'));
const secondTestsStart = lines.findIndex((l, i) => i > reactStart && l === "//#region 🧪️Tests");
const playgroundHostStart = lines.findIndex((l) => l === "//#region 🔖️PlaygroundHost");
