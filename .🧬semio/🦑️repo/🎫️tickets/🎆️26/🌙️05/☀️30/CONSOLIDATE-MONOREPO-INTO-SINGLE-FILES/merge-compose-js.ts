...
wasm = wasm.replace(/\/\/#region 🔌️Adapters\r?\nimport \{ RS_WASM_EMPTY_STORE_URI \} from "\.\/graphql-contract";\r?\n\/\/#endregion 🔌️Adapters\r?\n\r?\n/m, "");

const block = `//#region 🌐️GraphqlContract\n${contract}//#endregion 🌐️GraphqlContract\n\n//#region 🌐️GraphqlKitSelection\n${kitSel}//#endregion 🌐️GraphqlKitSelection\n\n//#region 🌐️RsWasmTransport\n${wasm}//#endregion 🌐️RsWasmTransport\n\n`;

index = index.replace(/^(#\/\/endregion 🧲️Header\r?\n)/m, `$1\n${block}`);
if (!index.includes("//#region 🌐️GraphqlContract")) {
