...
const idxHead = idx.split("//#region 🧩️WasmGraphNamespace")[0] ?? idx;
...
const block = `//#region 🧷️KitWasmHost
/** @emoji 🧷️ Wasm kit graph + KitStore (nested under {@linkcode WasmGraph}). */
export namespace WasmGraph {
${body}
}

//#endregion 🧷️KitWasmHost

//#region 🧷️WasmGraphFlatReexports
${lines.join("\n")}
//#endregion 🧷️WasmGraphFlatReexports
`;

fs.writeFileSync(".repo/🎫️/26/05/12/FIELD-ONLY-KIT-READS-CQRS-CLASSES/merged-wasm-chunk.txt", block, "utf8");
