...
const b = idx.indexOf("//#endregion 🧷️KitWasmHost");
...
const ins = `//#region 🧷️WasmGraphTypeAliases\n${lines.join("\n")}\n//#endregion 🧷️WasmGraphTypeAliases\n`;
const marker = "//#endregion 🧷️WasmGraphFlatReexports";
