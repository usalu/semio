...
s = s.replace(
  `/** @emoji 📦️ Parses canonical box asset (\`spatial/assets/interaction/primitive/box.json\`). */
export function buildBoxInteractionSpec(): InteractionSpec {
  ...
  `/** @emoji 📦️ Parses primitive.box interaction from model-definition assets. */
export function buildBoxInteractionSpec(): InteractionSpec {
...
s = s.replace(
  `/** @emoji 📦️ Parses extrude-wire asset (\`spatial/assets/interaction/feature/extrude-wire.json\`). */
export function buildExtrudeInteractionSpec(): InteractionSpec {
  ...
  `/** @emoji 📦️ Parses feature.extrude-wire interaction from model-definition assets. */
export function buildExtrudeInteractionSpec(): InteractionSpec {
...
s = s.replace(
  `/** @emoji 📦️ Parses offset-surface asset (\`spatial/assets/interaction/feature/offset-surface.json\`). */
export function buildOffsetSurfaceInteractionSpec(): InteractionSpec {
  ...
  `/** @emoji 📦️ Parses feature.offset-surface interaction from model-definition assets. */
export function buildOffsetSurfaceInteractionSpec(): InteractionSpec {
...
s = s.replace(
  `/** @emoji 📦️ Parses distance asset (\`spatial/assets/interaction/measure/length.json\`). */
export function buildDistanceInteractionSpec(): InteractionSpec {
  ...
  `/** @emoji 📦️ Parses measure.length interaction from model-definition assets. */
export function buildDistanceInteractionSpec(): InteractionSpec {
...
s = s.replace(
  `/** @emoji 📦️ Parses area asset (\`spatial/assets/interaction/measure/area.json\`). */
export function buildAreaInteractionSpec(): InteractionSpec {
  ...
  `/** @emoji 📦️ Parses measure.area interaction from model-definition assets. */
export function buildAreaInteractionSpec(): InteractionSpec {
