...
/** @emoji 🧾️ Parses \`spatial.extension/v1\` JSON or returns \`null\`. */
...
/** @emoji 📚️ Lists model-definition manifests under \`spatial/assets/modelDefinition/**\`. */
...
const viewBlockEnd = `// #endregion 🧱️Model`;
...
s = s.replace(
  `/** @emoji 🪪️ True when a selection command needs \`ExtensionViewService\` (\`object\` rows). */
