/** @emoji 🧹️ Strip cellComplex/cluster/shell picks; fix cell→solid rename damage in spatial packages. */
...
text = text.replace(
  ...
  /** @emoji 🪪️ Kernel-private brepjs sub-element kind for parametric picks. */
