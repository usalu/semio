#!/usr/bin/env bun
/**
 * 🧩️ Runs ticket migrations.cypher via cypher-shell; copies batch to .repo/cache for Windows -f paths. NEO4J_DATABASE defaults to compose; live schema export is `bun ./📜️script.ts generate`, not this ticket.
 */
...
//#region 🧭️ResolveRepoRoot
/**
 * 📁️ Finds workspace root (directory containing root `script.ts`) for Neo4j tool cache paths.
 */
