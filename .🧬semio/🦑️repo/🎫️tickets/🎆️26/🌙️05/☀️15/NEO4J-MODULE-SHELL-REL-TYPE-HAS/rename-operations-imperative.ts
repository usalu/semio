...
/** @emoji 🧭️ Past-participle operation stem → imperative stem (PascalCase prefix swap). */
...
/** @emoji 🧭️ Build (from,to) pairs longest-first so `XInput` replaces before bare `X`. */
...
/** @emoji 🧭️ Adds `Gap…` schema-gap Rust identifiers mirroring each concrete operation rename. */
...
/** @emoji 🧭️ Identifier-safe replace so `FixedPiece` does not corrupt `CreateFixedPiece`. */
