...
const startMarker = "// #region 🎊️UI";
const endMarker = "// #endregion 🎊️UI";
...
const importBlockEnd = fr.indexOf("//#region 📦️shell-chrome-types.tsx");
