...
// Topology: react/index.tsx + topology-play-host → topology/index.tsx
{
  ...
  const merged = `// #region 🧲️Header\n/** @emoji 🔗️ \`@elements/topology\` — paired board + scene surfaces + play harness (monolith). */\n// #endregion 🧲️Header\n\n${fixedReact}\n\n// #region 🛝️PlayHost\n${host.replace(/^[\s\S]*?#endregion 🧲️Header\n\n?/, "")}\n// #endregion 🛝️PlayHost\n`;
...
// Spatial
{
  ...
  if (existsSync(join(root, reactPath)) && existsSync(join(root, hostPath))) {
    ...
    const merged = `// #region 🧲️Header\n/** @emoji 📐️ \`@elements/spatial\` — spatial play + react surfaces (monolith). */\n// #endregion 🧲️Header\n\n${react}\n\n// #region 🛝️PlayHost\n${host.replace(/^[\s\S]*?#endregion 🧲️Header\n\n?/, "")}\n// #endregion 🛝️PlayHost\n`;
