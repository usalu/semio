#!/usr/bin/env python3
"""Catch-all: fix ANY quoted string ending in bare 📦️.rs/📦️.ts/📦️.tsx (regardless of
...
RENAME = {"📦️.rs": "📦️lib.rs", "📦️.ts": "📦️index.ts", "📦️.tsx": "📦️index.tsx"}
EXCLUDE_DIRS = {"node_modules", "target", ".git", ".repo", ".nx", "pkg"}
PATTERN = re.compile(r'"([^"]*(?:📦️\.rs|📦️\.ts|📦️\.tsx))"')
