...
```bash
cd infinite/world/r3f && bun ./📜️script.ts test -t "lodGridGeometrySpec|cameraLodGridLayout"
bun .repo/🎫️/26/07/21/FIX-AGGREGATOR-ABBAU-AUFBAU-EXAMPLE-CRASH/verify-runtime.ts
```
