...
- `bun ./📜️script.ts test` in `print/` — all 12 template PDFs (6 light + 6 dark) built successfully
- `bun ./📜️script.ts build` in `mit-bestand/bericht/` — `zwischenbericht.pdf` and `zwischenbericht-dark.pdf` built successfully
