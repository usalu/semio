...
- `bun ./📜️script.ts plugin din4108` (from `framework/product/os/dev`): **SUCCESS**. Build scope
...
A background loop (`SEMIO_PLUGIN=<variant> HEADED=0 bun ./📜️script.ts parity triage <variant>` for
