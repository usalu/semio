#!/usr/bin/env python3
"""🔧️ Fix broken include_bytes!/include_str!/#[path] after compound-emoji layout."""
...
EMOJI_PREFIXES = ["🔤️", "🔣️", "🧊️", "🌊️", "📦️", "🦀️", "🟦️", "🖼️", "🌱️", "🎨️", "😀️", "♾️"]
...
def try_resolve(from_dir: Path, rel: str):
    ...
    for marker in ("🧰️framework", "✏️s", "♻️mit-bestand", "compose", "puzzle"):
