...
1. dsl/core/rs/lib.rs
   ...
   - Extended 🧪️Tests: back-arrow lexing, placeholder vs `_foo`/`foo_bar`, `is_bare_ident` unit tests.
...
2. dsl/schema/rs/lib.rs (biggest step)
   ...
   - Extended 🧪️Tests: bare-string printing, glue spacing (List/Value/Map/Record/Wire), wire `<-`
...
4. dsl/rs/lib.rs (facade)
   ...
   - Extended 🧪️Tests: `wire_field_dsl_field_impl_round_trips`, `derived_table_field_prints_compact_soa_and_round_trips`.
