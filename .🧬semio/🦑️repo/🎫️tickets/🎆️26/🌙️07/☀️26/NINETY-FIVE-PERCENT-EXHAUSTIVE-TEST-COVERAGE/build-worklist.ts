#!/usr/bin/env bun
/** 📊️Phase B work-list builder: walks the raw per-tool coverage output directly (not the flat merged
...
const outPath = join(repoRoot, ".repo/🎫️/26/07/26/NINETY-FIVE-PERCENT-EXHAUSTIVE-TEST-COVERAGE/worklist.json");
