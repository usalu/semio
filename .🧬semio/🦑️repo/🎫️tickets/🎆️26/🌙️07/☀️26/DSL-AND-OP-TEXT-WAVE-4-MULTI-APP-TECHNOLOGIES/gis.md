...
## Design
- `gis/plugin/rs/lib.rs` domain module: added `//#region 🔖️Dsl` + `//#region 🔖️OpText` right after each
  app's existing `//#region 🔖️DocumentVcs` (map's around old line ~327, terrain's around old line ~870).
