...
const coreIndex = `// #region 🧲️Header
/** @emoji 📐️ CAD play app core — controller, document, inspector, runtime. */
// #endregion 🧲️Header
...
/** @emoji 🧩️ S program definition for cad. */
...
const reactIndex = `// #region 🧲️Header
/** @emoji 📐️ CAD play React host — viewport chrome, model space, playground root. */
// #endregion 🧲️Header
...
const playgroundTs = `// #region 🧲️Header
/** @emoji 🛝️ CAD playground harness — fixtures and dev-host wiring only. */
// #endregion 🧲️Header
...
/** @emoji 🧩️ Shape fixture assets for CAD play navbar. */
...
/** @emoji 🛝️ CAD playground app definition. */
