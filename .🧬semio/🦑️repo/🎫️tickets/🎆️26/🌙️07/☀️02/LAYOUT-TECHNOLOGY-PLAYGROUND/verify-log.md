...
- `layout/play` direct `bun ./📜️script.ts build` — success, includes `layout_rs_bg.wasm` (~2.9 MiB)

## Dev server

- `LAYOUT_PLAY_PORT=6079 bun ./📜️script.ts dev` — Vite ready on http://127.0.0.1:6079/
