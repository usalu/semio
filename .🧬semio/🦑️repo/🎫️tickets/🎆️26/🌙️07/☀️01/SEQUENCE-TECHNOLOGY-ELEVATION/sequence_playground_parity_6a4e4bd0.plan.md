...
## 7. Framework renderer wiring (`framework/product/playground/renderer/react/index.tsx`, `🔖️SequencePlayHost` region)

Mirror `🔖️DagPlayHost` exactly:
