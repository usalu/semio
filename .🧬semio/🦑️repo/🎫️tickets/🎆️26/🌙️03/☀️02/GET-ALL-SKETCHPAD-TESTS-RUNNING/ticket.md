...
- `./repo/cli/cli ticket open ...` returned `🎫️0000/00/00/GET-ALL-SKETCHPAD-TESTS-RUNNING` after GitHub issue creation failed and did not create a local ticket folder.
