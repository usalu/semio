...
- `// #region 🔖️Design` starts at **line 5822**
- `// #endregion 🔖️Design` ends at **line 7099**
...
**Before `// #endregion 🔖️Design` at line 7099**, after `findStaleConnectionsInDesign`. The function should:
