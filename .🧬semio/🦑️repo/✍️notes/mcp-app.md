...
if __name__ == "__main__":
    ...
    if args.http:
        print("🚀️ Starting MCP server on HTTP (SSE transport)")
        mcp.settings.port = args.port
        mcp.run(transport="sse")
    else:
        print("🚀️ Starting MCP server with stdio transport")
        mcp.run()
```
...
if __name__ == "__main__":
    ...
    if args.http:
        print("🚀️ Starting MCP server on HTTP (SSE transport)")
        print("📡️ Server will use SSE transport settings")
        mcp.settings.port = args.port
        mcp.run(transport="sse")
    else:
        print("🚀️ Starting MCP server with stdio transport")
