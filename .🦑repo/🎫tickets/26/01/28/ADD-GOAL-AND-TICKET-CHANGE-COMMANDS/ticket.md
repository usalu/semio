...
- Modified `./repo/cli/main.go` to add `GoalDates`, `GoalUpdateInput`, `TicketChangeInput`, `TicketChange` logic.
...
- Refactored `./repo/cli/main.go` to support new functionality.
