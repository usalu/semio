...
New sub-region: `//#region 🔖ChromeOverlaysAndTour` (types, thread-locals, free functions) plus a new `#[cfg(test)] mod chrome_overlays_tour_tests` — both purely additive.
