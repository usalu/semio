...
Goal association on implement: `🎯r2602🎯runningsketchpad` (same as related panel chrome tickets). Open a new ticket (no existing ticket covers this).
...
- Ticket folder under `.repo/🎫/…` for any temp notes (on implement)
