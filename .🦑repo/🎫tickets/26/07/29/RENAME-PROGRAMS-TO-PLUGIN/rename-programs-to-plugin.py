...
REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("//#region 🔖ProgramRegistryEntry", "//#region 🔖PluginRegistryEntry"),
    ("//#endregion 🔖ProgramRegistryEntry", "//#endregion 🔖PluginRegistryEntry"),
    ("// #region 🔖ProgramRegistryCommand", "// #region 🔖PluginRegistryCommand"),
    ("// #endregion 🔖ProgramRegistryCommand", "// #endregion 🔖PluginRegistryCommand"),
    ("programId", "pluginId"),
