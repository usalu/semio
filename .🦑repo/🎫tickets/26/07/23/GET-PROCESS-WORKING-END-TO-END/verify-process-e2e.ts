#!/usr/bin/env bun
/** 🧪 Process 3D react e2e: playground boots, Process chrome visible, canvas present, no render error. */

import { chromium } from "playwright";
import { writeFileSync } from "node:fs";

const baseUrl = process.env.PROCESS_URL ?? "http://127.0.0.1:6022/";
const outDir = "/Users/ueli/Documents/semio/.repo/🎫/26/07/23/GET-PROCESS-WORKING-END-TO-END";
