...
const rendererRoot = resolve(repoRoot, "🧰framework/🛍️product/💻os/🔨module/📺renderer/🧑‍🎨engine/⚛️react/⚡️implementation/🟦typescript");

export default defineConfig({
  root: rendererRoot,
  resolve: {
    alias: [
      { find: /^@semio-tech\/.*\/pkg\/.*\.js$/, replacement: resolve(ticketRoot, "🟦wasm-stub.ts") },
      ...
      { find: "@semio-tech/framework-core", replacement: resolve(repoRoot, "🧰framework/⚡️implementation/🟦typescript/📦index.ts") },
      {
        ...
        replacement: resolve(repoRoot, "🧰framework/🛍️product/💻os/🔨module/♾️infinite/🖼️canvas/🎨react-renderer/⚡️implementation/🟦typescript/📦index.tsx"),
      },
      {
        find: "@semio-tech/infinite-world-r3f",
        replacement: resolve(repoRoot, "🧰framework/🛍️product/💻os/🔨module/♾️infinite/🌍world/🎨r3f/⚡️implementation/🟦typescript/📦index.tsx"),
      },
    ],
  },
