...
const TYPE_STUB_KEYS = new Set(["id", "name", "hash", "isAbstract", "createdAt", "updatedAt", "typology", "families", "parent"]);

const DESIGN_STUB_KEYS = new Set(["id", "name", "hash", "parent", "createdAt", "updatedAt", "typology", "families", "isAbstract"]);
