...
const start = lines.findIndex((line) => line === "// #region 📍Scene" && lines[lines.indexOf(line) + 1]?.includes("Scene MUST render"));
...
const replacement = ["// #region 📍Scene", "/** 🎬 Design scene is {@link DesignTopologySceneWindow} on @elements/scene via {@link TopologyScenePane}. */", "// #endregion 📍Scene", ""];
