...
- Command strings: `compose.{design,kit,quality}App.{startNewChange,saveChange,discardChange}`; hooks `useKitAppChange`, `useTypeAppChange`, `useDesignAppChange`, `DesignAppChangeProvider`.
