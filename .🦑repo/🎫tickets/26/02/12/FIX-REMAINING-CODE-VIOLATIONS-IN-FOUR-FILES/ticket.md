...
- **assets/grasshopper/build.py**: Removed shebang; wrapped all code after header in `# region 🔖Build` section with MUST summary; removed 4 comment lines before non-definition variable assignments; fixed file ID emoji (📜→💻)
