...
<details>
<summary><strong>🔮 If you don't need an port because something is not likely to be extended soon, don't create it ❌</strong></summary>
...
- Each code report problem includes a reason and a solution to document rule intent and remediation steps.
