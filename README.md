...
- Validation reports live in `reports/` and are generated by pre-commit hooks and CI/CD; all reports are gitignored except `reports/README.md`.

## Pre-commit Hooks

The repository uses pre-commit hooks to ensure code quality. Install with:
...
- **Prettier** - Formats JavaScript/TypeScript/JSON/YAML/Markdown
- **Ruff** - Lints and formats Python code
- **i18n Validation** - Validates translation keys (generates `reports/i18n.md`)
- **TypeScript Check** - Type checking (generates `reports/typescript.md`)
- **ESLint** - JavaScript/TypeScript linting (generates `reports/eslint.md`)
- **File Checks** - Trailing whitespace, line endings, merge conflicts, etc.
