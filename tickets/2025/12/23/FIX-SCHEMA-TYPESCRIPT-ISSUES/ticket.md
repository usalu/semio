---
slug: FIX-SCHEMA-TYPESCRIPT-ISSUES
prompt: >-
  FIX all schema issues until the schema.json has no more mismatches. Rerun the
  script and check for issues. Then fix all typescript issues and rerun
  typescript.tsx
status: open
author: Ueli Saluz <ueli.saluz@iek.uni-hannover.de>
date:
  created: "2025-12-23T14:27:10.321Z"
iterations:
  - prompt: Fix schema and TypeScript issues
    model: claude-sonnet-4-20250514
    date: "2025-12-23T14:27:10.321Z"
    files:
      updated:
        - scripts/schema.tsx
        - hooks/code.tsx
        ...
        - js/js/.storybook/stories/elements/aggregation/Tree.stories.tsx
        ...
        - js/js/.storybook/stories/elements/input/Combobox.stories.tsx
        ...
        - js/js/.storybook/stories/elements/navigation/Breadcrumb.stories.tsx
---
...
- `js/js/sketchpad/Sketchpad.tsx`: Changed return type from `React.ReactElement` to `JSX.Element`
- `js/js/sketchpad/Design.tsx`:
