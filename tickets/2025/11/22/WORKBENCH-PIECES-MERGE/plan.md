...
1. Review the existing workbench section setup in js/js/sketchpad/apps/design/App.tsx to understand how types and designs are rendered and interacted with (hover, navigation, creation).
