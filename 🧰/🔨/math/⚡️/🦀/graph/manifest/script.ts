...
import { BundleScript, getWorkspaceRoot, ScriptRouter, runBundleScriptMain, runCargoLint, runCargoTestBudgeted, resolveTestLevel } from "../../../../../../🛍️/🦑/🔨/lib/⚡️/🟦/📦.ts";
...
function emitTsManifest(doc: ManifestDocument): string {
  const prefix = pascalCase(doc.id);
  let out = `// Generated from ${doc.id}.manifest.json\n\nimport type { GraphManifestDocument, KindCatalogBundle } from "./generated/types.ts";\n\n`;
