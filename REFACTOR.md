...
export function initializeKitAppStore() {
  registerKitAppStoreFactory((parent, yMap, transact, id, state) => 
    new KitAppStore(parent, yMap, transact, id, state));
}
...
registerHomeStoreFactory((parent, yMap, transact) => 
  new HomeStore(parent, yMap, transact));
...
```typescript
export class DocsAppStore extends AppStore<
  DocsState,
  DocsDiff,
  DocsSelectionDiff,
  DocsEdit,
...
| **type** | ✅ Yes | Port placement, representation selection |
