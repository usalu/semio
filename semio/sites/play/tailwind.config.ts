// #region 🔖Header
// [👤semio🌐play⚙️tailwindconfig](repo://p/u/semio/b/w/play/f/tailwind.config.ts)
...
// [👤semio🌐play⚙️tailwindconfig🔖configuration](repo://p/u/semio/b/w/play/f/tailwind.config.ts/s/Configuration)
...
// [👤semio🌐play⚙️tailwindconfig🔖configuration🪨config](repo://p/u/semio/b/w/play/f/tailwind.config.ts/s/Configuration/d/i/config)
