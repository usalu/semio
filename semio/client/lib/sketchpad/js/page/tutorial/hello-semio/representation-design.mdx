...
To representation a Piece, semio needs to know **which mold it’s made from** 🔗  
...
When two Pieces are connected through Connectors, semio gives you control over **how the attached geometry is positioned** —  
...
A **Design** in semio is your full representation — created by snapping together specific **Pieces** 🧱 using their **Connections** 🔗
...
To build your Design in semio (e.g. in Grasshopper), you’ll use the `Representation Design` component.  
...
In Semio, **Representation components** like `Representation Type`, `Representation Piece`, `Representation Connection`, and `Representation Design` follow a shared logic:  
...
Each Representation component can **create** a structured semio object from your inputs:
...
In Semio, you can update any representationed object — like a Type, Piece, Connection, or Design —  
