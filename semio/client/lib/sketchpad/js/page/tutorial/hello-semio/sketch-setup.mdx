...
We'll representation the semio logo as a custom brick set and use it to explore the basic semio tools, concepts, terminologies, and workflows 🖼️
...
You’ll **always start in Grasshopper**, using the **semio plugin** to representation your **Brick Set** 🧱  
