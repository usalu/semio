...
- **[Grasshopper](/manual/grasshopper)**: Battery-included plugin for creating, editing and sharing semio kits 🦗
- **[Wasp](/integration/wasp)**: A Grasshopper-based integration between semio and Wasp 🐝
- **[Remote](/integration/cloud)**: Use any file-hosting platform as a shared Common-Data-Environment ☁️

### 🚀 In the making

- **[sketchpad](/manual/grasshopper):** A drag-and-drop interface to create semio designs ✏️
- **[Ladybug](/integration/speckle):** A Grasshopper-based converter from semio to Ladybug 🐞
- **[Speckle](/integration/speckle):** A Grasshopper-based integration between semio and Speckle 🟦
