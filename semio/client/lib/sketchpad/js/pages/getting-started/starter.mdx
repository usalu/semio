...
{/* prettier-ignore */}
{/* <Representation client:load src="../../../../../examples/geometry/representations/colorful-sphere.glb"/> */}
...
3. Change the connectors from 1:`red` to `white` and 2:`cyan` to `black` 🎨
   ...
   In Grasshoper you should see:
   ![Connectors](../../../../../assets/images/starter-grasshopper-ports.png)

   In Rhino you should see:
   ![Connectors Preview](../../../../../assets/images/starter-grasshopper-ports-preview.png)
...
4. Change the connection parameters (1:`Gap`, 2:`Shift`, 3;`Rise`, 4:`Rotation`, 5:`Turn`, 6:`Tilt`) 🎛️
   ...
   In Grasshoper you should see:
   ![Connectors](../../../../../assets/images/starter-grasshopper-connection.png)

   In Rhino you should see:
   ![Connectors Preview](../../../../../assets/images/starter-grasshopper-connection-preview.png)
