...
export async function runTests(options: {
  ...
  const env: NodeJS.ProcessEnv = {
    ...
    SEMIO_E2E_KIT_FOLDER: process.env.SEMIO_E2E_KIT_FOLDER ?? path.resolve(extensionDevelopmentPath, "../../fixture/kit/dev/metabolism"),
    SEMIO_E2E_KIT_FILE: process.env.SEMIO_E2E_KIT_FILE ?? path.resolve(extensionDevelopmentPath, "../../fixture/kit/dev/metabolism/wip/initialKit/kit.semio.json"),
