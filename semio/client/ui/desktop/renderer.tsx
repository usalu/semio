  ...
  return (
    <div className="h-screen w-screen">
      <Suspense fallback={<div className="flex h-full w-full items-center justify-center bg-neutral-950 text-white">Loading sketchpad...</div>}>
        ...
        <LazySketchpad desktop={desktop} id={userId} folderKitStoreFactory={folderKitStoreFactory} fileKitStoreFactory={fileKitStoreFactory} temporaryKitStoreFactory={temporaryKitStoreFactory} remoteKitStoreFactory={remoteKitStoreFactory} />
      </Suspense>
    </div>
  );
}
