...
import { Aside, Card, Tabs, TabsContent, TabsList, TabsTrigger } from "@semio/ui";
...
- Rhino, SketchUp, 3ds Max, Spline, Blender, ...
  ...
  > In semio you **link** 3d-representations 🎋
...
- OpenSCAD, CadQuery, Fornjot, …
  ...
  > In semio you **link** connectors visually 🖱️
...
- EnergyPlus, TRYNSIS, Representationlica, …

  A _simulation_ tool ☀️

  > In semio you **link** representations and results 🔢
...
<Card title="🧩 Design-Information-Representationing for Kit-of-Parts">semio is the toolchain for designing **modular** architecture ✏️</Card>
...
- **[🏛️ Architecture over representationing](#architecture-over-representationing):** We need more architecture-focused toolchains ✏️
- **[🏗️ Prefab over custom](#prefab-over-custom):** For economic and ecologic solutions 📉

### 🔓 Open over closed

<Aside type="note" title="Did you know?">
  semio stands on the shoulder of giants 🏙️ It is built with cutting-edge open-source technology 🌍 | Tool | Users | Followers | Contributors | |------|-------|-----------|--------------| | [User Interface](https://github.com/facebook/react) |
  27,800,000 | 234,000 | 1,698 | | [3D Engine](https://github.com/mrdoob/three.js/) | 465,000 | 105,000 | 1,977 |
</Aside>
...
<Aside type="tip" title="Are you curious what the world runs on?">
  <Tabs defaultValue="os">
    <TabsList>
      ...
      <TabsTrigger value="ui">User Interfaces</TabsTrigger>
      <TabsTrigger value="db">Databases</TabsTrigger>
      <TabsTrigger value="pl">Programming Languages</TabsTrigger>
    </TabsList>
...
### 🏛️ Architecture over representationing
