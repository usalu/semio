...
![📤 sketch drawing](/assets/images/sketch-drawing-piece.png)
...
- **Geometry (Model)** — the shape defined by the Variant’s geometry file 🧱
...
![Model Piece Component](/assets/images/model-piece-10Alpha.png)

Once all five Pieces are created, your model will look like this:

![Model Piece Component](/assets/images/model-5pieces-10Alpha-V2.png)
...
![📤 sketch drawing](/assets/images/sketch-drawing-connections.png)
...
![Connection Example](/assets/images/mode-connection-grasshopper.png)

This tells Semio:  
**Snap the west Connector of `Yel` to the west Connector of `Red-T`**

![Set Connection](/assets/images/set-connection-2pcs-alpha.png)

Once this first connection is in place, you can continue snapping all remaining bricks together using similar logic 🧩

![Set Connection](/assets/images/mode-connection-5pcs-grasshopper.png)
...
![Set Connection](/assets/images/set-connection-all-pcs-alpha.png)
...
- **Rise** ⬆️⬇️ → Lifts or lowers the Piece vertically, perpendicular to the face it connects to  
  ...
  ![Connection Adjustment](/assets/images/translation-parameter.gif)
...
- **Tilt** 🤸 → Tilts the Piece forward or backward, around a vertical axis
  ...
  ![Connection Adjustment](/assets/images/Rotation-parameter.gif)
...
<br />
![Set Connection](/assets/images/set-connection-2pcs.gif)
...
![Set Connection](/assets/images/set-connection-3pcs.gif)

![Set Connection](/assets/images/set-connection-5pcs.gif)
...
![Model Design Example](/assets/images/model-design.png)
...
![Reconstruct Piece](/assets/images/reconruct-piece-2.png)

![Reconstruct Piece](/assets/images/reconruct-piece.png)
...
![Reconstruct Con](/assets/images/reconstruct-connection.png)
![Reconstruct Con](/assets/images/reconstruct-connection-2.png)
![Reconstruct Con](/assets/images/reconstruct-connection-3.png)

#### 🧱 Update a Type

You can update a **Type** by feeding its `Ty` output back into the same `Model Type` component 🔁  
This lets you modify its **Model**, **Connectors**, or **metadata** — without changing anything else.
