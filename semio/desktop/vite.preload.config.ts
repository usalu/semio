// #region 🔖Header
// [👤semio🖱️desktop⚙️vitepreloadconfig](repo://p/u/semio/b/u/desktop/f/vite.preload.config.ts)
...
// [👤semio🖱️desktop⚙️vitepreloadconfig🔖configuration](repo://p/u/semio/b/u/desktop/f/vite.preload.config.ts/s/Configuration)
