// #region 🔖Header
// [👤semio📚js⚙️postcssconfig](semiorepo://p/u/semio/b/l/js/f/postcss.config.ts)
...
// [👤semio📚js⚙️postcssconfig🔖configuration](semiorepo://p/u/semio/b/l/js/f/postcss.config.ts/s/Configuration)
