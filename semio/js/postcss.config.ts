...
// [⚙️semio/js/postcss.config.ts](semiorepo://file/semio/js/postcss.config.ts)
...
// [🔖semio/js/postcss.config.ts#Configuration](semiorepo://section/semio/js/postcss.config.ts/CONFIGURATION)
