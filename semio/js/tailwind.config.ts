// #region 🔖Header
// [👤semio📚js⚙️tailwindconfigts](semiorepo://p/u/semio/b/l/js/f/tailwind.config.ts)
...
// [👤semio📚js⚙️tailwindconfigts🔖configuration](semiorepo://p/u/semio/b/l/js/f/tailwind.config.ts/s/Configuration)
