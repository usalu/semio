...
- OpenSCAD, CadQuery, Fornjot, …
  ...
  > In semio you **link** connectors visually 🖱️️
...
- A _razor-sharp_ interface for integrating manual and automated design workflows 🏗️️
...
- **[🖱️️Manual over automated](#manual-over-automated):** Design supported and not derived by technology 🪛
...
- **[🏗️️Prefab over custom](#prefab-over-custom):** For economic and ecologic solutions 📉
...
### 🖱️️Manual over automated

### 👥 Team over individual

### ♻️ Composable over disposable

### 🛠️Implementation over specification
