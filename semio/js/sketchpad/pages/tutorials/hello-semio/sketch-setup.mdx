...
Before we jump in, we’ll take a quick look at the semio workflow and the platforms you can use to do this 🛠️️

---

## 🛠️️Designing with Semio: Your Platform Options
...
Ideal for early design studies, collaboration, and fast interaction
...
- In **Step 1** 🔧 you’ll see the base shape and instructions to reach the desired outcome  
  A rectangle cut at an angle ✂️️with four docking points on each side ⚓  
...
- In **Steps 4 & 5** 📐 you’ll see the final assembly of your bricks into a design  
  This is where you snap them together to form your structure 🏗️️️
