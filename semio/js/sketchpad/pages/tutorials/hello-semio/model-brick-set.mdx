...
<Aside type="note">⚙️️This method combines the **parametric power of Grasshopper** with the **modular logic of Semio** 📤 Every time a parameter changes, the file can be **re-exported automatically** — ready to be referenced in the next step</Aside>
...
- ⚙️️If your geometry is dynamic or parametric, it still needs to be **exported to a file**
...
- ⚙️️Quick interactions and high-speed previews
