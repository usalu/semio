...
- 🏷️️**Name** → A unique name to identify your Type and reuse it in different designs
...
Now let's take a closer look at how these elements come together — and start modeling our first **brick mold** 🛠️️

<ol>

<li>

### 🏷️️Name Your Mold ([Type](/think-in-semio/#type) Name - Na)
...
In Semio, the process of adding geometry to a Type is called **modeling its Model** 🛠️️
...
- You can add or update it later 🛠️️
...
A **rectangle that’s cut at an angle** ✂️️️— just repeated in different lengths 📏
...
> 🛠️️You've already modeled the geometry earlier in your Grasshopper definition.  
...
<Aside type="note">⚙️️️This method combines the **parametric power of Grasshopper** with the **modular logic of Semio** 📤 Every time a parameter changes, the file can be **re-exported automatically** — ready to be referenced in the next step</Aside>
...
- ⚙️️️If your geometry is dynamic or parametric, it still needs to be **exported to a file**
...
- ⚙️️️Quick interactions and high-speed previews
...
- 🎯**Don’t worry about perfect alignment**  
  ...
  semio lets you adjust each Piece’s **position and rotation** _after_ snapping 🛠️️
...
A **Connector ID** is the name you give to each Connector 🏷️️
...
- 🏷️️**Name** — the shared identity of the mold (e.g. `"Profile"`)
...
- 🏷️️**Type name** — you’re still using the same underlying mold
...
1. 🏷️️Set the **Type name** (same as the original mold)
