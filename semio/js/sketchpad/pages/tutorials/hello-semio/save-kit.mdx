...
Together, these elements define a fully functional modular system — ready to assemble, remix, or expand in any future design. 🧱🛠️️

---

## 🛠️️Build Your Kit in Grasshopper

To assemble your Kit in Grasshopper, plug your modular setup into the `~Kit` component.

### You'll need to connect:

- 🏷️️**Name** – the name of your Kit (e.g. `"hello semio"`)
