...
// [👤semio🏪assets🗃️repo🗃️some🗃️folder💻filefixedgo🔖functions🛠️fixedvalue](semiorepo://definition/SEMIO/ASSETS/REPO/SOME/FOLDER/FILE_FIXED.GO/FUNCTIONS/FIXED-VALUE)
func FixedValue() int {
return 2
}
