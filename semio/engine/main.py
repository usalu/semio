...
class Store(abc.ABC):
    ...
    def initialize(self: "Store") -> None:
        """Initialize the store and perform nothing if was already initialized."""
...
def _mcp_app_html_resource_meta() -> dict[str, typing.Any]:
    """Resource _meta for MCP App HTML: hosts apply _meta.ui.csp to the sandbox (see .repo//mcp-app.md)."""
