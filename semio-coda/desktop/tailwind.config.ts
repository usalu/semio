// #region 🔖Header
// [🔬coda🖱️desktop⚙️tailwindconfig](semiorepo://p/r/coda/b/u/desktop/f/tailwind.config.ts)
...
// [🔬coda🖱️desktop⚙️tailwindconfig🔖configuration](semiorepo://p/r/coda/b/u/desktop/f/tailwind.config.ts/s/Configuration)
