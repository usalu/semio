...
import { BundleScript, ScriptRouter, fixtureItemsOf, runBundleScriptMain } from "../../🧰️framework/🛍️products/🦑️repo/🔨️modules/📚️library/📦️packages/🟦️typescript/📦️index.ts";

//#region 🔖️AssembleSplitInitialKit
/** @emoji 📎️ Reads `{ hash, items }` collection blocks from kit snapshot JSON. */
export { fixtureItemsOf } from "../../🧰️framework/🛍️products/🦑️repo/🔨️modules/📚️library/📦️packages/🟦️typescript/📦️index.ts";
...
/** @emoji 📦️ Reads split or monolithic `kit.compose.json` (assembles sidecars when `types/` exists). */
...
//#endregion 🔖️AssembleSplitInitialKit
