...
function shouldEsbuildTransform(url) {
  ...
  return filePath.includes("/compose/") || filePath.includes("/framework/") || filePath.includes("/puzzle/") || filePath.includes("/ui/") || filePath.includes("/cad/") || filePath.includes("/elements/");
}
