...
![📤 sketch drawing](/asset/image/🖼️sketch-drawing-mold.png)
...
![📁 Geometry Generation](/asset/image/🖼️attach-geometry-crop.gif)
...
![📤 Export Geometry](/asset/image/🖼️export-geometry.png)
...
![📤 Exported file](/asset/image/🖼️file-export-Profile-2-.png)

---

<Aside type="note">
  ⚙️ This method combines the **parametric power of Grasshopper** with the **modular logic of Compose** 📤 Every time a parameter changes, the file can be **re-exported automatically** — ready to be referenced in the next step
</Aside>
...
![📁 Reference Geometry](/asset/image/🖼️reference-geometry.png)
...
![📁 Switch Representation](/asset/image/🖼️Switch-Representation.png)  
![📁 Filename](/asset/image/🖼️Profile-2-detailed.png)
...
![📁 Switch Representation](/asset/image/🖼️switch-representation-sheet.png)  
![📁 Filename](/asset/image/🖼️Profile-2-simplified.png)
...
![📁 Switch Representation](/asset/image/🖼️switch-representation-Block.png)  
![📁 Filename](/asset/image/🖼️Profile-2-simplified.png)
...
![📁 Connectors](/asset/image/🖼️representation-port-alpha.png)
...
![📁 Representation Type](/asset/image/🖼️representation-type.png)  
![📁 Representation Type](/asset/image/🖼️representation-type-geo.png)
...
![📤 sketch drawing](/asset/image/🖼️sketch-drawing-variant.png)
...
![📁 Variant GIF](/asset/image/🖼️Type-1-to-5-crop.gif)
...
![📁 Cluster](/asset/image/🖼️cluster-type-inside-ALpha.png)
...
![📁 Cluster](/asset/image/🖼️type-cluster-file-reference-Alpha.png)  
![📁 Cluster](/asset/image/🖼️file-export.png)
...
![📁 Cluster](/asset/image/🖼️cluster-type-inside-direct.rfrc.png)
...
![📁 Cluster](/asset/image/🖼️type-cluster-direct-reference-Alpha.png)
