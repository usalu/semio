...
In your very first step into the compose workflow, we’ll start with a simple, hands-on example 🧱
...
From sketch to final design, you'll learn how to break down your sketch into modular parts and lay them out — then snap everything together, just like building a LEGO representation 📐
...
You’ll **always start in Grasshopper**, using the **compose plugin** to representation your **Brick Set** 🧱  
...
compose is designed to be **platform-flexible** 🔄
...
![📤 sketch drawing](/asset/image/sketch-drawing.png)
...
![📤 sketch drawing](/asset/image/sketch-drawing-123.png)
...
![📤 sketch drawing](/asset/image/sketch-drawing-45.png)
