...
- **[Grasshopper](/manual/grasshopper)**: Battery-included plugin for creating, editing and sharing compose kits 🦗
- **[Wasp](/integration/wasp)**: A Grasshopper-based integration between compose and Wasp 🐝
...
- **[Ladybug](/integration/speckle):** A Grasshopper-based converter from compose to Ladybug 🐞
- **[Speckle](/integration/speckle):** A Grasshopper-based integration between compose and Speckle 🟦
...
## ❌ What compose is _not_:

- Rhino, SketchUp, 3ds Max, Spline, Blender, ...

  A _3d_ tool 🐚

  > In compose you **link** 3d-representations 🎋

- AutoCAD, DraftSight, LibreCAD, ...

  A _CAD_ tool 📐

  > In compose you **link** dynamic blocks 📦

- Revit, ArchiCAD, Vectorworks, BricksCAD, Bonsai, …

  A _BIM_ tool 🧱

  > In compose you **link** instances of your own types 🗿

- Grasshopper, Dynamo, GenerativeComponents, Sverchok, …

  A _node_ tool 🦗

  > In compose you **link** the input with the output ⛓️‍💥

- IFC, Speckle, BHoM, …

  A _data_ tool 📄

  > In compose you **link** design knowledge 📚

- Hypar, Viktor, Fusion, …

  A _parametric_ tool 🎛️

  > In compose you **link** static designs 🩻

- Wasp, Assembler, Monoceros, ComputerGeneratedArchitecture …

  A _solver_ tool 🎰

  > In compose you **link** precise pieces 🪡
...
- Illustrator, AffinityDesigner, InkScape, …
  ...
  > In compose you **link** drawings 🪙

- EnergyPlus, TRYNSIS, Representationlica, …

  A _simulation_ tool ☀️

  > In compose you **link** representations and results 🔢

- Autodesk Construction Cloud, Bimcloud, Bentley Infrastructure Cloud, Git, Nextcloud, …

  A _CDE_ tool ☁️

  > In compose you **link** urls 🔗

## 📖 So, what _is_ compose?

<Card title="🧩 Design-Information-Representationing for Kit-of-Parts">compose is the toolchain for designing **modular** architecture ✏️</Card>
...
<Aside type="note" title="Did you know?">
  compose stands on the shoulder of giants 🏙️ It is built with cutting-edge open-source technology 🌍 | Tool | Users | Followers | Contributors | |------|-------|-----------|--------------| | [User Interface](https://github.com/facebook/react) |
...
## 🤨 When should I design with compose?
