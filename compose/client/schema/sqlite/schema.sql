...
-- Normalized SQLite schema for compose kit persistence aligned with the current Rust kit DTO graph.
-- #endregion 🧲️Header

PRAGMA foreign_keys = ON;

CREATE TABLE IF NOT EXISTS compose_schema (
...
CREATE TABLE IF NOT EXISTS piece (
	...
	name TEXT,
	description TEXT,
	pose_plane_origin_x REAL,
	pose_plane_origin_y REAL,
	pose_plane_origin_z REAL,
	pose_plane_x_axis_x REAL,
	pose_plane_x_axis_y REAL,
	pose_plane_x_axis_z REAL,
	pose_plane_y_axis_x REAL,
	pose_plane_y_axis_y REAL,
	pose_plane_y_axis_z REAL,
	pose_center_x REAL,
	pose_center_y REAL,
	pose_center_z REAL,
	scale REAL,
...
CREATE TABLE IF NOT EXISTS connection (
	id TEXT NOT NULL,
	ordinal INTEGER NOT NULL,
	parent_side_id TEXT NOT NULL,
	parent_piece_id TEXT NOT NULL,
	parent_port_id TEXT,
	parent_design_piece_id TEXT,
	child_side_id TEXT NOT NULL,
	child_piece_id TEXT NOT NULL,
	child_port_id TEXT,
	child_design_piece_id TEXT,
	gap REAL,
	shift REAL,
	rise REAL,
	rotation REAL,
	...
	design_id TEXT NOT NULL,
	PRIMARY KEY (id),
	FOREIGN KEY (parent_piece_id) REFERENCES piece (id),
	FOREIGN KEY (parent_port_id) REFERENCES port (id),
	FOREIGN KEY (parent_design_piece_id) REFERENCES piece (id),
	FOREIGN KEY (child_piece_id) REFERENCES piece (id),
	FOREIGN KEY (child_port_id) REFERENCES port (id),
	FOREIGN KEY (child_design_piece_id) REFERENCES piece (id),
	FOREIGN KEY (design_id) REFERENCES design (id) ON DELETE CASCADE
);
