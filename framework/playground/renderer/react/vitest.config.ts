...
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{ find: "@framework/playground/renderer/react/puzzle/2d", replacement: resolve(root, "puzzle/2d-play-host.tsx") },
			{ find: "@framework/playground/renderer/react/puzzle/3d", replacement: resolve(root, "puzzle/3d-play-host.tsx") },
			{ find: "@framework/playground/renderer/react/puzzle/5d", replacement: resolve(root, "puzzle/5d-play-host.tsx") },
