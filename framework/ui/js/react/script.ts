...
export const UI_PRIMITIVES_ALLOWLIST: readonly string[] = [
  ...
  "s/plugin/animate/present/renderer/react/index.tsx",
  "s/plugin/cad/renderer/js/index.tsx",
  ...
  "framework/os/kernel/infinite/world/r3f/index.tsx",
] as const;
...
function collectUiPrimitivesHits(repoRootPath: string): Map<string, UiPrimitiveHit[]> {
  ...
  const walk = (dir: string): void => {
    for (const entry of readdirSync(dir, { withFileTypes: true })) {
      ...
      const svgExempt = rel.startsWith("framework/") && !rel.startsWith("framework/os/core/") && !rel.startsWith("framework/os/dev/");
...
const CHROME_I18N_SCANNED_FILES = ["framework/ui/js/react/index.tsx", "framework/os/renderer/js/react/index.tsx"] as const;
