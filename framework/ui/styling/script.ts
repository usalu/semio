...
const PX_SCAN_ROOTS = ["framework/ui/js/react", "framework/ui/styling/js", "framework/os/core", "framework/os/dev", "compose/client/ui", "s/plugin/flow", "s/plugin/cad/renderer", "s/plugin/puzzle", "framework/os/kernel/infinite/world", "s/plugin/gis/2d"] as const;
...
const COLOR_SCAN_ROOTS = [...PX_SCAN_ROOTS.filter((root) => !root.startsWith("framework/ui/styling") && root !== "compose/client/ui"), ".storybook", "compose/client"] as const;
...
const COLOR_SCAN_LEGACY_ALLOWLIST = [
  ...
  "framework/os/kernel/infinite/world/rs/lib.rs",
  "puzzle/2d/rs/lib.rs",
