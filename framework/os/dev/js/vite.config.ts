...
const uiAssetsRoot = path.join(repoRoot, "framework/ui/asset");
...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@semio-tech/ui-react", replacement: path.resolve(repoRoot, "framework/ui/js/react/index.tsx") },
      { find: "@semio-tech/ui-asset", replacement: path.resolve(repoRoot, "framework/ui/asset") },
      { find: "@semio-tech/ui-styling", replacement: path.resolve(repoRoot, "framework/ui/styling/js") },
      { find: "@semio-tech/infinite-cavas-react-renderer", replacement: path.resolve(repoRoot, "framework/os/kernel/infinite/canvas/react-renderer/index.tsx") },
      { find: "@semio-tech/infinite-world-r3f", replacement: path.resolve(repoRoot, "framework/os/kernel/infinite/world/r3f/index.tsx") },
      { find: "@semio-tech/framework-renderer-react", replacement: path.resolve(repoRoot, "framework/os/renderer/js/react/index.tsx") },
      { find: "@semio-tech/framework-renderer-wgpu", replacement: path.resolve(repoRoot, "framework/os/renderer/wgpu/index.ts") },
      { find: "@semio-tech/framework-core", replacement: path.resolve(repoRoot, "framework/core/js/index.ts") },
      { find: "@semio-tech/framework-os-core", replacement: path.resolve(repoRoot, "framework/os/core/js/index.ts") },
