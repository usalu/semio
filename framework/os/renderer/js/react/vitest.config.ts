...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@semio-tech/ui-asset", replacement: resolve(repoRoot, "framework/ui/asset/js/index.ts") },
      { find: "@semio-tech/ui-styling", replacement: resolve(repoRoot, "framework/ui/styling/js/index.ts") },
      { find: "@semio-tech/framework-core", replacement: resolve(repoRoot, "framework/core/js/index.ts") },
      { find: "@semio-tech/infinite-cavas-react-renderer", replacement: resolve(repoRoot, "framework/os/kernel/infinite/canvas/react-renderer/index.tsx") },
