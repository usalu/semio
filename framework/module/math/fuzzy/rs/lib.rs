...
#![allow(clippy::needless_range_loop, reason = "index-based numerics loops mirror the mathematical_algebra style for matrix and rule iteration")]
...
/// 📐 Parametric membership function with eval, parameter access, and gradient hooks for adaptation.
...
// #region 🔖TNormTConorm
/// 🔗 T-norm for fuzzy AND aggregation.
...
/// 🔗 T-conorm for fuzzy OR aggregation.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub enum TConorm {
    Max,
    ProbSum,
...
// #endregion 🔖TNormTConorm

// #region 🔖FuzzyArithmetic
/// 🔢 Triangular fuzzy number for α-cut arithmetic.
#[derive(Clone, Copy, Debug, PartialEq, Serialize, Deserialize)]
...
// #endregion 🔖FuzzyArithmetic

// #region 🔖FuzzyRelation
/// 🔗 Graded fuzzy relation R: X → Y stored as a matrix.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
// #endregion 🔖FuzzyRelation

// #region 🔖PossibilityTheory
/// 🎭 Possibility measure Π(A) = sup_{x∈A} μ(x) on a discrete universe.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
// #endregion 🔖PossibilityTheory

// #region 🔖Universe
/// 📏 Discrete universe of discourse for numerical integration and defuzzification.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Universe {
    pub min: f64,
    pub max: f64,
...
// #endregion 🔖LinguisticVariable

// #region 🔖Rule
/// 📜 Antecedent clause: input variable index and term index.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
/// 📜 Rule consequent variants for Mamdani, Sugeno, and Tsukamoto engines.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub enum Consequent {
...
/// 📜 Weighted fuzzy rule with optional confidence.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Rule {
    pub id: usize,
...
/// 🎯 Defuzzification method applied to a discrete aggregated membership vector.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Serialize, Deserialize)]
...
/// 🔥 Single rule firing trace for explainability.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
/// 🧾 Explanation of an inference step.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
// #endregion 🔖InferenceEngine

// #region 🔖AdaptiveMembership
/// 🎯 Adaptive membership-function fitting from labeled (x, μ) samples via gradient descent.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
// #endregion 🔖AdaptiveMembership

// #region 🔖Anfis
/// 🧠 ANFIS: adaptive neuro-fuzzy inference system with hybrid least-squares + gradient learning.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct Anfis {
...
// #region 🔖RuleLearning
/// 🌱 Wang–Mendel rule induction from input-output samples.
...
/// 🧹 Prune rules with activation support or weight below thresholds.
...
/// 🎯 Re-weight rules by empirical fit quality on a dataset.
...
/// 🌱 Subtractive clustering seed centers for rule generation.
...
// #endregion 🔖RuleLearning

// #region 🔖Optimizers
/// 🧬 Genetic algorithm optimizer for fuzzy parameter vectors.
...
/// 🐝 Particle swarm optimizer for fuzzy parameter tuning.
...
// #region 🔖EvolvingFuzzySystem
/// 🔄 Evolving fuzzy system that adds, prunes, and adapts rules from streaming samples.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
/// 🎯 Gustafson–Kessel fuzzy clustering with adaptive covariance per cluster.
...
// #endregion 🔖FuzzyCMeans

// #region 🔖MulticriteriaDecision
...
/// 📊 Fuzzy TOPSIS decision over alternatives.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
/// 📊 Fuzzy VIKOR compromise ranking.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
// #endregion 🔖MulticriteriaDecision

// #region 🔖TemporalSpatial
...
/// 📍 Spatial fuzzy evaluator for proximity concepts.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
// #endregion 🔖TemporalSpatial

// #region 🔖HybridUncertainty
/// 🔀 Map probabilistic scores to fuzzy membership without external Bayesian engines.
pub fn probabilistic_to_membership(probability: f64, certainty: f64) -> f64 {
    clamp01(probability * certainty + 0.5 * (1.0 - certainty))
}

/// 🔀 Bridge possibility and fuzzy membership on a shared universe.
pub fn possibility_to_membership(possibility: &PossibilityMeasure) -> Vec<f64> {
    possibility.membership.clone()
}

/// 🔀 Combine fuzzy and possibility evidence via weighted fusion.
...
// #endregion 🔖HybridUncertainty

// #region 🔖FanController
/// 🌀 Fan-speed controller builder demonstrating the full advanced fuzzy pipeline.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
...
mod tests {
    ...
    fn defuzzifier_bisector_mom_som_lom() {
        ...
        // 🔍 argmax breaks ties on the *last* max (std max_by semantics), so Som and Lom
