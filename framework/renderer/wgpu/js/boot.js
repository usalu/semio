...
var PLAYGROUND_BUILD_TARGETS = [
  { variant: "aggregator", pluginId: "puzzle", cratePath: "s/plugin/puzzle/rs", app: "puzzle3d-play", brand: "entwerfen-mit-bestand", aliases: ["mit-bestand", "entwerfen-mit-bestand"], ports: { react: 6023, wgpu: 6123 }, examples: [], engines: [], assets: [{ kind: "mesh-collection", route: "/mesh", roots: ["asset/metabolism/representation", "asset/abbau-aufbau"], placeholder: "asset/mesh/placeholder.glb", filterFromExamples: true }, { kind: "static-dir", route: "/infinite-fixture", root: "infinite/fixture" }] },
  { variant: "animate", pluginId: "animate", cratePath: "s/plugin/animate/rs", aliases: [], ports: { react: 6051, wgpu: 6151 }, examples: [], engines: [], assets: [] },
  ...
  { variant: "cad", pluginId: "cad", cratePath: "s/plugin/cad/rs", aliases: [], ports: { react: 6020, wgpu: 6120 }, examples: [], engines: [], assets: [{ kind: "static-dir", route: "/cad-fixture", root: "cad/fixture" }] },
  { variant: "dag", pluginId: "dag", cratePath: "s/plugin/dag/rs", aliases: [], ports: { react: 6017, wgpu: 6117 }, examples: [], engines: [], assets: [] },
  { variant: "din16798", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-din-en-16798-play", aliases: [], ports: { react: 6092, wgpu: 6192 }, examples: [], engines: [], assets: [] },
  { variant: "din18599", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-din-v-18599-play", aliases: [], ports: { react: 6093, wgpu: 6193 }, examples: [], engines: [], assets: [] },
  { variant: "din4108", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-din-4108-play", aliases: [], ports: { react: 6091, wgpu: 6191 }, examples: [], engines: [], assets: [] },
  { variant: "draw", pluginId: "draw", cratePath: "s/plugin/draw/rs", aliases: [], ports: { react: 6064, wgpu: 6164 }, examples: [], engines: [], assets: [] },
  { variant: "en1990", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1990-play", aliases: [], ports: { react: 6094, wgpu: 6194 }, examples: [], engines: [], assets: [] },
  { variant: "en1991", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1991-play", aliases: [], ports: { react: 6095, wgpu: 6195 }, examples: [], engines: [], assets: [] },
  { variant: "en1992", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1992-play", aliases: [], ports: { react: 6096, wgpu: 6196 }, examples: [], engines: [], assets: [] },
  { variant: "en1993", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1993-play", aliases: [], ports: { react: 6097, wgpu: 6197 }, examples: [], engines: [], assets: [] },
  { variant: "en1994", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1994-play", aliases: [], ports: { react: 6098, wgpu: 6198 }, examples: [], engines: [], assets: [] },
  { variant: "en1995", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1995-play", aliases: [], ports: { react: 6099, wgpu: 6199 }, examples: [], engines: [], assets: [] },
  { variant: "en1996", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1996-play", aliases: [], ports: { react: 6100, wgpu: 6200 }, examples: [], engines: [], assets: [] },
  { variant: "en1997", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1997-play", aliases: [], ports: { react: 6101, wgpu: 6201 }, examples: [], engines: [], assets: [] },
  { variant: "en1998", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1998-play", aliases: [], ports: { react: 6102, wgpu: 6202 }, examples: [], engines: [], assets: [] },
  { variant: "en1999", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-en-1999-play", aliases: [], ports: { react: 6103, wgpu: 6203 }, examples: [], engines: [], assets: [] },
  { variant: "fem2d", pluginId: "fem", cratePath: "s/plugin/fem/rs", app: "fem2d-play", aliases: ["fem 2d"], ports: { react: 6086, wgpu: 6186 }, examples: [], engines: [], assets: [] },
  { variant: "fem3d", pluginId: "fem", cratePath: "s/plugin/fem/rs", app: "fem3d-play", aliases: ["fem 3d"], ports: { react: 6087, wgpu: 6187 }, examples: [], engines: [], assets: [] },
  { variant: "flow", pluginId: "flow", cratePath: "s/plugin/flow/rs", aliases: [], ports: { react: 6016, wgpu: 6116 }, examples: [], engines: ["s/kernel/flow/core/rs"], assets: [] },
  { variant: "forms", pluginId: "forms", cratePath: "s/plugin/forms/rs", aliases: [], ports: { react: 6058, wgpu: 6158 }, examples: [], engines: [], assets: [] },
  { variant: "gis2d", pluginId: "gis", cratePath: "s/plugin/gis/rs", app: "gis2d-play", aliases: ["gis 2d"], ports: { react: 6040, wgpu: 6140 }, examples: [], engines: ["framework/surface/tiled-map/rs"], assets: [{ kind: "tile-proxy", route: "/osm", upstream: "https://tile.openstreetmap.org/{z}/{x}/{y}.png", cache: "osm-tiles" }, { kind: "tile-proxy", route: "/vt", upstream: "https://tiles.openfreemap.org/planet", cache: "openfreemap-vt" }] },
  { variant: "gis3d", pluginId: "gis", cratePath: "s/plugin/gis/rs", app: "gis3d-play", aliases: ["gis 3d"], ports: { react: 6083, wgpu: 6183 }, examples: [], engines: ["framework/surface/terrain/rs"], assets: [{ kind: "tile-proxy", route: "/dem", upstream: "https://s3.amazonaws.com/elevation-tiles-prod/terrarium/{z}/{x}/{y}.png", cache: "terrarium-dem" }] },
  { variant: "imperative", pluginId: "imperative", cratePath: "s/plugin/imperative/rs", aliases: [], ports: { react: 6076, wgpu: 6176 }, examples: [], engines: [], assets: [] },
  { variant: "iso16757", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-iso-16757-play", aliases: [], ports: { react: 6104, wgpu: 6204 }, examples: [], engines: [], assets: [] },
  { variant: "layout", pluginId: "layout", cratePath: "s/plugin/layout/rs", aliases: [], ports: { react: 6079, wgpu: 6179 }, examples: [], engines: [], assets: [] },
  { variant: "lowpoly", pluginId: "lowpoly", cratePath: "s/plugin/lowpoly/rs", aliases: [], ports: { react: 6078, wgpu: 6178 }, examples: [], engines: [], assets: [] },
  { variant: "mathematical", pluginId: "mathematical", cratePath: "s/plugin/mathematical/rs", app: "mathematical-play", aliases: ["mathematical", "math"], ports: { react: 6084, wgpu: 6184 }, examples: [], engines: [], assets: [] },
  ...
  { variant: "procedural2d", pluginId: "procedural", cratePath: "s/plugin/procedural/rs", app: "procedural2d-play", aliases: ["procedural 2d"], ports: { react: 6021, wgpu: 6121 }, examples: [], engines: [], assets: [] },
  { variant: "procedural3d", pluginId: "procedural", cratePath: "s/plugin/procedural/rs", app: "procedural3d-play", aliases: ["procedural 3d"], ports: { react: 6018, wgpu: 6118 }, examples: [], engines: [], assets: [] },
  { variant: "process3d", pluginId: "process", cratePath: "s/plugin/process/rs", app: "process3d-play", aliases: ["process 3d"], ports: { react: 6022, wgpu: 6122 }, examples: [], engines: [], assets: [] },
  { variant: "puzzle2d", pluginId: "puzzle", cratePath: "s/plugin/puzzle/rs", app: "puzzle2d-play", aliases: ["2d"], ports: { react: 6012, wgpu: 6112 }, examples: [], engines: ["s/plugin/puzzle/app/2d/engine/rs"], assets: [] },
  { variant: "puzzle3d", pluginId: "puzzle", cratePath: "s/plugin/puzzle/rs", app: "puzzle3d-play", aliases: ["3d"], ports: { react: 6013, wgpu: 6113 }, examples: [], engines: [], assets: [{ kind: "mesh-collection", route: "/mesh", roots: ["asset/metabolism/representation", "asset/abbau-aufbau"], placeholder: "asset/mesh/placeholder.glb", filterFromExamples: true }, { kind: "static-dir", route: "/infinite-fixture", root: "infinite/fixture" }] },
  { variant: "puzzle5d", pluginId: "puzzle", cratePath: "s/plugin/puzzle/rs", app: "puzzle5d-play", aliases: ["5d"], ports: { react: 6014, wgpu: 6114 }, examples: [], engines: [], assets: [] },
  { variant: "raster", pluginId: "raster", cratePath: "s/plugin/raster/rs", aliases: [], ports: { react: 6060, wgpu: 6160 }, examples: [], engines: ["framework/surface/paint/rs"], assets: [] },
  { variant: "reasoning-wires", pluginId: "reasoning-mindmap", cratePath: "s/plugin/reasoning/rs", aliases: ["wires"], ports: { react: 6015, wgpu: 6115 }, examples: [], engines: [], assets: [] },
  { variant: "remodel", pluginId: "remodel", cratePath: "s/plugin/remodel/rs", aliases: [], ports: { react: 6063, wgpu: 6163 }, examples: [], engines: [], assets: [] },
  { variant: "s", pluginId: "s", cratePath: "s/plugin/space/rs", aliases: [], ports: { react: 6070, wgpu: 6066 }, examples: [], engines: [], assets: [] },
  { variant: "sequence", pluginId: "sequence", cratePath: "s/plugin/sequence/rs", aliases: [], ports: { react: 6077, wgpu: 6177 }, examples: [], engines: [], assets: [] },
  { variant: "shooting", pluginId: "shooting", cratePath: "s/plugin/shooting/rs", aliases: [], ports: { react: 6019, wgpu: 6119 }, examples: [], engines: [], assets: [{ kind: "mesh-collection", route: "/mesh", roots: ["asset/metabolism/representation", "asset/abbau-aufbau"], placeholder: "asset/mesh/placeholder.glb", filterFromExamples: true }] },
  { variant: "sourcing", pluginId: "sourcing", cratePath: "s/plugin/sourcing/rs", app: "sourcing-curate", aliases: ["curate"], ports: { react: 6081, wgpu: 6181 }, examples: [], engines: [], assets: [] },
  { variant: "trinity-jack", pluginId: "trinity", cratePath: "s/plugin/trinity/rs", app: "trinity-jack-play", aliases: ["trinity jack"], ports: { react: 6054, wgpu: 6154 }, examples: [], engines: [], assets: [] },
  { variant: "trinity-rewrite", pluginId: "trinity", cratePath: "s/plugin/trinity/rs", app: "trinity-rewrite-play", aliases: ["trinity rewrite"], ports: { react: 6056, wgpu: 6156 }, examples: [], engines: [], assets: [] },
  { variant: "vcs", pluginId: "vcs", cratePath: "s/plugin/vcs/rs", aliases: [], ports: { react: 6075, wgpu: 6175 }, examples: [], engines: [], assets: [] },
  { variant: "vdi3805", pluginId: "norm", cratePath: "s/plugin/norm/rs", app: "norm-vdi-3805-play", aliases: [], ports: { react: 6105, wgpu: 6205 }, examples: [], engines: [], assets: [] },
  { variant: "writer", pluginId: "writer", cratePath: "s/plugin/writer/rs", aliases: [], ports: { react: 6062, wgpu: 6162 }, examples: [], engines: [], assets: [] }
];
...
var PLUGIN_BUILD_TARGETS = [
  { pluginId: "animate", cratePath: "s/plugin/animate/rs", wasmOut: "animate_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "architect", cratePath: "architect/plugin/rs", wasmOut: "architect_spine.wasm", contributes: [], consumes: [] },
  { pluginId: "cad", cratePath: "s/plugin/cad/rs", wasmOut: "cad_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "dag", cratePath: "s/plugin/dag/rs", wasmOut: "dag_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "draw", cratePath: "s/plugin/draw/rs", wasmOut: "draw_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "fem", cratePath: "s/plugin/fem/rs", wasmOut: "semio_s_plugin_fem.wasm", contributes: [], consumes: [] },
  { pluginId: "flow", cratePath: "s/plugin/flow/rs", wasmOut: "flow_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "forms", cratePath: "s/plugin/forms/rs", wasmOut: "forms_plugin.wasm", contributes: [], consumes: ["forms.questionKind"] },
  { pluginId: "gis", cratePath: "s/plugin/gis/rs", wasmOut: "semio_s_plugin_gis.wasm", contributes: [], consumes: [] },
  { pluginId: "imperative", cratePath: "s/plugin/imperative/rs", wasmOut: "imperative_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "layout", cratePath: "s/plugin/layout/rs", wasmOut: "semio_s_plugin_layout.wasm", contributes: [], consumes: [] },
  { pluginId: "lowpoly", cratePath: "s/plugin/lowpoly/rs", wasmOut: "lowpoly_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "mathematical", cratePath: "s/plugin/mathematical/rs", wasmOut: "mathematical_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "norm", cratePath: "s/plugin/norm/rs", wasmOut: "norm_plugin.wasm", contributes: [], consumes: [] },
  ...
  { pluginId: "procedural", cratePath: "s/plugin/procedural/rs", wasmOut: "procedural_plugin.wasm", contributes: [], consumes: ["forms.questionKind"] },
  { pluginId: "process", cratePath: "s/plugin/process/rs", wasmOut: "process_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "puzzle", cratePath: "s/plugin/puzzle/rs", wasmOut: "puzzle_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "raster", cratePath: "s/plugin/raster/rs", wasmOut: "raster_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "reasoning-mindmap", cratePath: "s/plugin/reasoning/rs", wasmOut: "reasoning_mindmap_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "remodel", cratePath: "s/plugin/remodel/rs", wasmOut: "remodel_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "s", cratePath: "s/plugin/space/rs", wasmOut: "s_plugin.wasm", contributes: [], consumes: [], host: { landingAppId: "home", hostAppId: "studio" } },
  { pluginId: "sequence", cratePath: "s/plugin/sequence/rs", wasmOut: "sequence_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "shooting", cratePath: "s/plugin/shooting/rs", wasmOut: "shooting_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "sourcing", cratePath: "s/plugin/sourcing/rs", wasmOut: "sourcing_plugin.wasm", contributes: [], consumes: [] },
  ...
  { pluginId: "trinity", cratePath: "s/plugin/trinity/rs", wasmOut: "trinity_plugin.wasm", contributes: [], consumes: [] },
  { pluginId: "vcs", cratePath: "s/plugin/vcs/rs", wasmOut: "semio_s_plugin_vcs.wasm", contributes: [], consumes: [] },
  { pluginId: "writer", cratePath: "s/plugin/writer/rs", wasmOut: "writer_plugin.wasm", contributes: [], consumes: [] }
];
