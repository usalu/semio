...
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{ find: "@semio-tech/flow-react", replacement: resolve(repoRoot, ".repo/🎫/26/07/04/RUST-PLUGIN-FRAMEWORK-MIGRATION/flow-react-stub.tsx") },
			{ find: "@semio-tech/writer-react", replacement: resolve(repoRoot, ".repo/🎫/26/07/04/RUST-PLUGIN-FRAMEWORK-MIGRATION/writer-react-stub.tsx") },
			{ find: "@semio-tech/writer-core", replacement: resolve(repoRoot, ".repo/🎫/26/07/04/RUST-PLUGIN-FRAMEWORK-MIGRATION/writer-core-stub.ts") },
