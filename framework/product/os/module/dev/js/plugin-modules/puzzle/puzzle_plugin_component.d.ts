...
export type * as SemioFrameworkHost from './interfaces/semio-framework-host.js'; // import semio:framework/host
export type * as SemioFrameworkTypes from './interfaces/semio-framework-types.js'; // import semio:framework/types
...
export * as plugin from './interfaces/semio-framework-plugin.js'; // export semio:framework/plugin
