"use components";
import { backbonePoll, backboneSend, nowMs } from './host-shim.js';
...
import { insecureSeed as insecureSeed$1, random } from '../_vendor/@bytecodealliance/preview2-shim/random.js';
...
const _trampoline0 = function() {
  _debugLog('[iface="semio:framework/host", function="now-ms"] [Instruction::CallInterface] (sync, @ enter)');
  ...
  _debugLog('[iface="semio:framework/host", function="now-ms"][Instruction::Return]', {
    funcName: 'now-ms',
    paramCount: 1,
    async: false,
    postReturn: false
...
_trampoline0.fnName = 'semio:framework/host#nowMs';
...
_trampoline1.fnName = 'wasi:random/random@0.2.9#getRandomU64';
...
_trampoline20.fnName = 'wasi:io/streams@0.2.9#checkWrite';
...
_trampoline21.fnName = 'wasi:io/streams@0.2.9#write';
...
_trampoline22.fnName = 'wasi:io/streams@0.2.9#blockingFlush';
...
_trampoline23.fnName = 'wasi:cli/environment@0.2.9#getEnvironment';
...
_trampoline24.fnName = 'wasi:cli/terminal-stdin@0.2.9#getTerminalStdin';
...
_trampoline25.fnName = 'wasi:cli/terminal-stdout@0.2.9#getTerminalStdout';
...
_trampoline26.fnName = 'wasi:cli/terminal-stderr@0.2.9#getTerminalStderr';
...
_trampoline27.fnName = 'wasi:clocks/wall-clock@0.2.9#now$1';
let exports2;
let postReturn0;
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./s_program_component.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABHwVgA39/fwBgBX9/f39/AGABfwBgAn9/AGAEf39/fwACTg0AATAAAAABMQABAAEyAAIAATMAAAABNAADAAE1AAQAATYAAwABNwACAAE4AAIAATkAAgACMTAAAgACMTEAAgAIJGltcG9ydHMBcAEMDAkSAQBBAAsMAAECAwQFBgcICQoLAC8JcHJvZHVjZXJzAQxwcm9jZXNzZWQtYnkBDXdpdC1jb21wb25lbnQHMC4yNTIuMA');
