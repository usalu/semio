"use components";
import { backbonePoll, backboneSend } from './host-shim.js';
import { environment, exit as exit$1, stderr, stdin, stdout, terminalInput, terminalOutput, terminalStderr, terminalStdin, terminalStdout } from '../_vendor/@bytecodealliance/preview2-shim/cli.js';
import { monotonicClock, wallClock } from '../_vendor/@bytecodealliance/preview2-shim/clocks.js';
import { preopens, types } from '../_vendor/@bytecodealliance/preview2-shim/filesystem.js';
import { error, poll as poll$1, streams } from '../_vendor/@bytecodealliance/preview2-shim/io.js';
import { insecureSeed as insecureSeed$1 } from '../_vendor/@bytecodealliance/preview2-shim/random.js';
...
_trampoline9.fnName = 'wasi:io/poll@0.2.9#block';
...
const _trampoline10 = function(arg0) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="wasi:io/streams@0.2.9", function="[method]input-stream.subscribe"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_trampoline10.fnName = 'wasi:io/streams@0.2.9#subscribe';
...
_trampoline11.fnName = 'wasi:io/streams@0.2.9#subscribe';
...
_trampoline12.fnName = 'wasi:cli/stdin@0.2.9#getStdin';
...
_trampoline13.fnName = 'wasi:cli/stdout@0.2.9#getStdout';
...
_trampoline14.fnName = 'wasi:cli/stderr@0.2.9#getStderr';
...
_trampoline15.fnName = 'wasi:clocks/monotonic-clock@0.2.9#now';
...
_trampoline16.fnName = 'wasi:clocks/monotonic-clock@0.2.9#subscribeDuration';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
const _trampoline17 = function(arg0, arg1, arg2) {
  ...
  _debugLog('[iface="semio:framework/host", function="backbone-poll"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="semio:framework/host", function="backbone-poll"][Instruction::Return]', {
  funcName: 'backbone-poll',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline17.fnName = 'semio:framework/host#backbonePoll';
...
const _trampoline18 = function(arg0, arg1, arg2, arg3, arg4) {
  ...
  _debugLog('[iface="semio:framework/host", function="backbone-send"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => backboneSend(result0, result1),
    })
  };
} catch (e) {
  ret = { tag: 'err', val: getErrorPayload(e) };
...
_debugLog('[iface="semio:framework/host", function="backbone-send"][Instruction::Return]', {
  funcName: 'backbone-send',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline18.fnName = 'semio:framework/host#backboneSend';
...
_trampoline19.fnName = 'wasi:random/insecure-seed@0.2.9#insecureSeed';
...
_trampoline20.fnName = 'wasi:io/poll@0.2.9#poll';
...
const _trampoline21 = function(arg0, arg1, arg2) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="wasi:io/streams@0.2.9", function="[method]input-stream.read"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_trampoline21.fnName = 'wasi:io/streams@0.2.9#read';
...
_trampoline22.fnName = 'wasi:io/streams@0.2.9#checkWrite';
...
_trampoline23.fnName = 'wasi:io/streams@0.2.9#write';
...
_trampoline24.fnName = 'wasi:io/streams@0.2.9#blockingFlush';
...
_trampoline25.fnName = 'wasi:filesystem/types@0.2.9#readViaStream';
...
_trampoline26.fnName = 'wasi:filesystem/types@0.2.9#writeViaStream';
...
_trampoline27.fnName = 'wasi:filesystem/types@0.2.9#appendViaStream';
...
_trampoline28.fnName = 'wasi:filesystem/types@0.2.9#getFlags';
...
const _trampoline29 = function(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.read-directory"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_trampoline29.fnName = 'wasi:filesystem/types@0.2.9#readDirectory';
...
const _trampoline30 = function(arg0, arg1, arg2, arg3) {
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.create-directory-at"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_trampoline30.fnName = 'wasi:filesystem/types@0.2.9#createDirectoryAt';
...
_trampoline31.fnName = 'wasi:filesystem/types@0.2.9#stat';
...
const _trampoline32 = function(arg0, arg1, arg2, arg3, arg4) {
  ...
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.stat-at"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_trampoline32.fnName = 'wasi:filesystem/types@0.2.9#statAt';

const _trampoline33 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
...
_trampoline33.fnName = 'wasi:filesystem/types@0.2.9#openAt';
...
const _trampoline34 = function(arg0, arg1, arg2, arg3) {
  ...
  var len3 = arg2;
  var result3 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr3, len3));
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.remove-directory-at"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_trampoline34.fnName = 'wasi:filesystem/types@0.2.9#removeDirectoryAt';
...
const _trampoline35 = function(arg0, arg1, arg2, arg3) {
  ...
  var len3 = arg2;
  var result3 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr3, len3));
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.unlink-file-at"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_trampoline35.fnName = 'wasi:filesystem/types@0.2.9#unlinkFileAt';
...
_trampoline36.fnName = 'wasi:filesystem/types@0.2.9#metadataHash';

const _trampoline37 = function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
  ...
  var len4 = arg3;
  var result4 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr4, len4));
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.metadata-hash-at"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]descriptor.metadata-hash-at"][Instruction::Return]', {
...
_trampoline37.fnName = 'wasi:filesystem/types@0.2.9#metadataHashAt';
...
const _trampoline38 = function(arg0, arg1) {
  ...
  curResourceBorrows.push(rsc0);
  _debugLog('[iface="wasi:filesystem/types@0.2.9", function="[method]directory-entry-stream.read-directory-entry"] [Instruction::CallInterface] (sync, @ enter)');
  const hostProvided = true;
...
_trampoline38.fnName = 'wasi:filesystem/types@0.2.9#readDirectoryEntry';
...
_trampoline39.fnName = 'wasi:cli/environment@0.2.9#getEnvironment';
...
_trampoline40.fnName = 'wasi:cli/terminal-stdin@0.2.9#getTerminalStdin';
...
_trampoline41.fnName = 'wasi:cli/terminal-stdout@0.2.9#getTerminalStdout';

const _trampoline42 = function(arg0) {
...
_trampoline42.fnName = 'wasi:cli/terminal-stderr@0.2.9#getTerminalStderr';
...
_trampoline43.fnName = 'wasi:clocks/wall-clock@0.2.9#now$1';
...
_trampoline44.fnName = 'wasi:filesystem/preopens@0.2.9#getDirectories';
let exports2;
let postReturn0;
...
let postReturn12;
let postReturn12Async;
let postReturn13;
let postReturn13Async;
let pluginManifest;
...
let pluginInstantiateApp;

function instantiateApp(arg0, arg1) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginInstantiateApp',
    getCallbackFn: () => null,
    callbackFnName: null,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginInstantiateApp(ptr0, len0, ptr1, len1),
    });
  } catch (err) {
...
let pluginHandleAction;

function handleAction(arg0, arg1, arg2) {
  var {json: v0_0 } = arg1;
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginHandleAction',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginHandleAction(toUint32(arg0), ptr1, len1, ptr3, len3),
    });
  } catch (err) {
...
let pluginHandleCommand;

function handleCommand(arg0, arg1, arg2) {
  var {json: v0_0 } = arg1;
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginHandleCommand',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginHandleCommand(toUint32(arg0), ptr1, len1, ptr3, len3),
    });
  } catch (err) {
...
let pluginUpdateWindow;

function updateWindow(arg0, arg1) {
  var {json: v0_0 } = arg1;
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginUpdateWindow',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginUpdateWindow(toUint32(arg0), ptr1, len1),
    });
  } catch (err) {
...
function refreshUi(arg0, arg1) {
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginRefreshUi(toUint32(arg0), ptr1, len1),
    });
  } catch (err) {
...
let pluginMigrateDocument;

function migrateDocument(arg0) {
  var {fromVersion: v0_0, toVersion: v0_1, data: v0_2 } = arg0;
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginMigrateDocument',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginMigrateDocument(ptr1, len1, ptr2, len2, ptr3, len3),
    });
  } catch (err) {
...
let pluginApplyOperations;

function applyOperations(arg0, arg1) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginApplyOperations',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginApplyOperations(toUint32(arg0), ptr0, len0),
    });
  } catch (err) {
...
function readAppDocument(arg0) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginReadAppDocument',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginReadAppDocument(toUint32(arg0)),
    });
  } catch (err) {
...
let pluginLoadAppDocument;

function loadAppDocument(arg0, arg1) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginLoadAppDocument',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginLoadAppDocument(toUint32(arg0), ptr0, len0),
    });
  } catch (err) {
...
let pluginAttachBackbone;

function attachBackbone(arg0, arg1) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginAttachBackbone',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginAttachBackbone(toUint32(arg0), ptr0, len0),
    });
  } catch (err) {
...
function detachBackbone(arg0) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginDetachBackbone',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginDetachBackbone(toUint32(arg0)),
    });
  } catch (err) {
...
let pluginConsumeMedia;

function consumeMedia(arg0, arg1, arg2) {
  
  var encodeRes = _utf8AllocateAndEncode(arg1, realloc0, memory0);
  var ptr0= encodeRes.ptr;
  var len0 = encodeRes.len;
  
  var {descriptorJson: v1_0, data: v1_1 } = arg2;
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginConsumeMedia',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginConsumeMedia(toUint32(arg0), ptr0, len0, ptr2, len2, ptr3, len3),
    });
  } catch (err) {
...
let pluginProduceMedia;

function produceMedia(arg0, arg1, arg2) {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginProduceMedia',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginProduceMedia(toUint32(arg0), ptr0, len0, ptr1, len1),
    });
  } catch (err) {
...
function clearInstanceGuard() {
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginClearInstanceGuard',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'none',
    callingWasmExport: true,
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./animate_program_component.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module1));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'semio:framework/host': {
        'backbone-poll': exports0['0'],
        'backbone-send': exports0['1'],
      },
      ...
      'wasi:filesystem/types@0.2.0': {
        ...
        '[method]descriptor.create-directory-at': exports0['13'],
        '[method]descriptor.get-flags': exports0['11'],
        '[method]descriptor.metadata-hash': exports0['19'],
        '[method]descriptor.metadata-hash-at': exports0['20'],
        '[method]descriptor.open-at': exports0['16'],
        '[method]descriptor.read-directory': exports0['12'],
        '[method]descriptor.read-via-stream': exports0['8'],
        '[method]descriptor.remove-directory-at': exports0['17'],
        '[method]descriptor.stat': exports0['14'],
        '[method]descriptor.stat-at': exports0['15'],
        '[method]descriptor.unlink-file-at': exports0['18'],
        '[method]descriptor.write-via-stream': exports0['9'],
        '[method]directory-entry-stream.read-directory-entry': exports0['21'],
      ...
      'wasi:io/streams@0.2.0': {
        ...
        '[method]output-stream.blocking-flush': exports0['7'],
    ...
    postReturn10 = exports1['cabi_post_semio:framework/program#attach-backbone'];
    
    try {
      postReturn10Async = WebAssembly.promising(exports1['cabi_post_semio:framework/program#attach-backbone']);
    } catch(err) {
      postReturn10Async = exports1['cabi_post_semio:framework/program#attach-backbone'];
    }
    
    postReturn11 = exports1['cabi_post_semio:framework/program#detach-backbone'];
    
    try {
      postReturn11Async = WebAssembly.promising(exports1['cabi_post_semio:framework/program#detach-backbone']);
    } catch(err) {
      postReturn11Async = exports1['cabi_post_semio:framework/program#detach-backbone'];
    }
    
    postReturn12 = exports1['cabi_post_semio:framework/program#consume-media'];
    
    try {
      postReturn12Async = WebAssembly.promising(exports1['cabi_post_semio:framework/program#consume-media']);
    } catch(err) {
      postReturn12Async = exports1['cabi_post_semio:framework/program#consume-media'];
    }
    
    postReturn13 = exports1['cabi_post_semio:framework/program#produce-media'];
    
    try {
      postReturn13Async = WebAssembly.promising(exports1['cabi_post_semio:framework/program#produce-media']);
    } catch(err) {
      postReturn13Async = exports1['cabi_post_semio:framework/program#produce-media'];
    }
...
const program = {
  ...
  attachBackbone: attachBackbone,
  clearInstanceGuard: clearInstanceGuard,
  consumeMedia: consumeMedia,
  detachBackbone: detachBackbone,
  handleAction: handleAction,
  handleCommand: handleCommand,
  instantiateApp: instantiateApp,
  loadAppDocument: loadAppDocument,
  manifest: manifest,
  migrateDocument: migrateDocument,
  produceMedia: produceMedia,
  readAppDocument: readAppDocument,
  refreshUi: refreshUi,
