...
_trampoline17.fnName = 'wasi:random/insecure-seed@0.2.9#insecureSeed';
...
_trampoline18.fnName = 'wasi:io/poll@0.2.9#poll';
...
_trampoline19.fnName = 'wasi:io/streams@0.2.9#read';
...
_trampoline23.fnName = 'wasi:filesystem/types@0.2.9#readViaStream';
...
_trampoline24.fnName = 'wasi:filesystem/types@0.2.9#writeViaStream';
...
_trampoline25.fnName = 'wasi:filesystem/types@0.2.9#appendViaStream';
...
_trampoline26.fnName = 'wasi:filesystem/types@0.2.9#getFlags';
...
_trampoline27.fnName = 'wasi:filesystem/types@0.2.9#stat';

const _trampoline28 = function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
...
_trampoline28.fnName = 'wasi:filesystem/types@0.2.9#statAt';

const _trampoline29 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  var handle1 = arg0;
...
_trampoline29.fnName = 'wasi:filesystem/types@0.2.9#openAt';
...
_trampoline30.fnName = 'wasi:filesystem/types@0.2.9#metadataHash';

const _trampoline31 = function(arg0, arg1, arg2, arg3, arg4) {
  var handle1 = arg0;
...
_trampoline31.fnName = 'wasi:filesystem/types@0.2.9#metadataHashAt';
...
_trampoline32.fnName = 'wasi:cli/environment@0.2.9#getEnvironment';
...
_trampoline33.fnName = 'wasi:cli/terminal-stdin@0.2.9#getTerminalStdin';
...
_trampoline34.fnName = 'wasi:cli/terminal-stdout@0.2.9#getTerminalStdout';
...
_trampoline35.fnName = 'wasi:cli/terminal-stderr@0.2.9#getTerminalStderr';
...
_trampoline36.fnName = 'wasi:filesystem/preopens@0.2.9#getDirectories';
let exports2;
let postReturn0;
...
function listTools(arg0, arg1) {
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginListTools(toUint32(arg0), ptr1, len1),
    });
  } catch (err) {
...
let pluginWindowEngagements;

function windowEngagements(arg0, arg1) {
  var {json: v0_0 } = arg1;
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginWindowEngagements',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginWindowEngagements(toUint32(arg0), ptr1, len1),
    });
  } catch (err) {
...
let pluginWindowMeasures;

function windowMeasures(arg0, arg1) {
  var {json: v0_0 } = arg1;
  ...
  const [task, _wasm_call_currentTaskID] = createNewCurrentTask({
    ...
    isAsync: false,
    isManualAsync: false,
    entryFnName: 'pluginWindowMeasures',
    getCallbackFn: () => null,
    callbackFnName: null,
    errHandling: 'throw-result-err',
    callingWasmExport: true,
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginWindowMeasures(toUint32(arg0), ptr1, len1),
    });
  } catch (err) {
...
function appLabels(arg0, arg1) {
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => pluginAppLabels(toUint32(arg0), ptr1, len1),
    });
  } catch (err) {
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./presentation_program_component.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module1));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'semio:framework/host': {
        'backbone-poll': exports0['1'],
        'backbone-send': exports0['0'],
      },
...
const program = {
  ...
  windowEngagements: windowEngagements,
