...
_trampoline12.fnName = 'wasi:clocks/monotonic-clock@0.2.9#now';
...
_trampoline13.fnName = 'wasi:clocks/monotonic-clock@0.2.9#subscribeDuration';
let exports1;
let memory0;
let realloc0;
let realloc0Async;
...
_trampoline14.fnName = 'semio:framework/host#backbonePoll';
...
_trampoline15.fnName = 'semio:framework/host#backboneSend';
...
_trampoline16.fnName = 'wasi:random/insecure-seed@0.2.9#insecureSeed';
...
_trampoline17.fnName = 'wasi:io/poll@0.2.9#poll';
...
_trampoline18.fnName = 'wasi:io/streams@0.2.9#checkWrite';
...
_trampoline19.fnName = 'wasi:io/streams@0.2.9#write';
...
_trampoline20.fnName = 'wasi:io/streams@0.2.9#blockingFlush';
...
_trampoline21.fnName = 'wasi:cli/environment@0.2.9#getEnvironment';
...
_trampoline22.fnName = 'wasi:cli/terminal-stdin@0.2.9#getTerminalStdin';
...
_trampoline23.fnName = 'wasi:cli/terminal-stdout@0.2.9#getTerminalStdout';
...
_trampoline24.fnName = 'wasi:cli/terminal-stderr@0.2.9#getTerminalStderr';
...
_trampoline25.fnName = 'wasi:clocks/wall-clock@0.2.9#now$1';
let exports2;
let postReturn0;
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./imperative_program_component.core.wasm', import.meta.url));
