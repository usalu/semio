...
_trampoline13.fnName = 'semio:framework/host#backbonePoll';
...
_trampoline14.fnName = 'semio:framework/host#backboneSend';
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./sourcing_module_windows_component.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABHwVgA39/fwBgBX9/f39/AGABfwBgAn9/AGAEf39/fwACSAwAATAAAAABMQABAAEyAAIAATMAAAABNAADAAE1AAQAATYAAwABNwACAAE4AAIAATkAAgACMTAAAgAIJGltcG9ydHMBcAELCwkRAQBBAAsLAAECAwQFBgcICQoALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI1Mi4w');
