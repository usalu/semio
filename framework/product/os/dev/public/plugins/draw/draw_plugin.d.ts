...
export class DrawDocumentVcs {
    free(): void;
    [Symbol.dispose](): void;
    dispatchJson(command_json: string): void;
    envelopeJson(): string;
    generation(): number;
    constructor(envelope_json?: string | null);
...
export interface InitOutput {
    ...
    readonly __wbg_drawdocumentvcs_free: (a: number, b: number) => void;
    readonly drawdocumentvcs_dispatchJson: (a: number, b: number, c: number) => [number, number];
    readonly drawdocumentvcs_envelopeJson: (a: number) => [number, number, number, number];
    readonly drawdocumentvcs_generation: (a: number) => number;
    readonly drawdocumentvcs_new: (a: number, b: number) => [number, number, number];
    readonly drawdocumentvcs_projectionJson: (a: number) => [number, number, number, number];
