/* @ts-self-types="./reasoning_wires_plugin.d.ts" */
...
export function semio_plugin_render(instance_id, body_key, view_state_json) {
    ...
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(body_key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(view_state_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./reasoning_wires_plugin_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('reasoning_wires_plugin_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
