//! 🧮 Combined mathematical framework playground — graph algorithms and computational geometry as one hot-swappable WASM program.
...
fn register_mathematical_exports() {
    semio_framework_program::program_runtime::register_document_codec_for_app::<MathematicalPlayApp>("semio.mathematical/v1");
}
...
mod tests {
    ...
    fn renders_node_graph_scene() {
        ...
        let history = semio_framework_program::HistoryView { columns: Vec::new(), can_undo: false, can_redo: false, active_alternative_id: None, current_checkpoint_id: None, recent_ops: Vec::new() };
