...
use crate::nogood::{NogoodConfig, NogoodStore};
...
pub struct SearchConfig {
    ...
    /// 🧠 Opt-in nogood learning (see [`crate::nogood`]); disabled by default.
...
mod tests {
    ...
    mod quick {
        ...
        fn random_instances_with_nogoods_enabled_still_match_oracle() {
            ...
            // layer (see nogood.rs's module doc), so this must reach the exact same
