...
/** 🧹️Zero-warning clippy gate: `cargo clippy -p semio-framework-core --all-targets -- -D warnings`. */
class LintScript extends BundleScript {
  run(segments: string[]): void {
    runCargoLint(["semio-framework-core"], this.root, segments);
  }
}

//#region 🔖️Typegen
/** 🧬️ Name of the `#[cfg(test, feature = "typegen")]` test in `📦️lib.rs` that calls `TS::export()` for every mirrored type. */
...
function consolidateBindings(dir: string): string {
  ...
  return `/** @generated by \`bun nx run @semio-tech/framework-core:generate\` from framework/📦️packages/🦀️rust/📦️lib.rs via ts-rs. Do not edit. */\n\n${blocks.join("\n\n")}\n`;
}
