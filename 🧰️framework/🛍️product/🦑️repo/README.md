...
Repo-wide settings live in [`.🦑️repo/config.toml`](../.🦑️repo/config.toml) at the monorepo root.

| Key                  | Default    | Description                                                                 |
| -------------------- | ---------- | --------------------------------------------------------------------------- |
| `logging.session`    | `false`    | Write per-session `session.json` under `.🦑️repo/⚡️/🤖️/…` on agent hooks       |
