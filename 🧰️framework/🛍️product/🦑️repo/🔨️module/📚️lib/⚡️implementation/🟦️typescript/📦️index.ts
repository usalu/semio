...
import type { PlaygroundBuildTarget as PlaygroundVariant } from "../../../../../../../🧰️framework/🛍️product/💻️os/🔨️module/🔌️plugin/⚡️implementation/🟦️typescript/📇️registry/🤖️generated/🟦️playgrounds.ts";
...
function defaultCliBin(root: string): string {
  ...
  return join(root, "🧰️framework/🛍️product/🦑️repo/🔨️module/💻️client", win ? "client.exe" : "client");
}
...
export function loadFrameworkOsPlaygroundCatalog(): readonly PlaygroundVariant[] {
  const catalogPath = join(getWorkspaceRoot(), "./🧰️framework/🛍️product/💻️os/🔨️module/🔌️plugin/⚡️implementation/🟦️typescript/📇️registry/🤖️generated/🔣️playgrounds.json");
...
const MICRO_COMMIT_RESOLVE_REPO_CLI_SH = `compose_resolve_repo_cli() {
  ...
  if [ -x "$ROOT/🧰️framework/🛍️product/🦑️repo/🔨️module/💻️client/client" ]; then
    echo "$ROOT/🧰️framework/🛍️product/🦑️repo/🔨️module/💻️client/client"
    return
  fi
  if [ -x "$ROOT/🧰️framework/🛍️product/🦑️repo/🔨️module/💻️client/client.exe" ]; then
    echo "$ROOT/🧰️framework/🛍️product/🦑️repo/🔨️module/💻️client/client.exe"
    return
  fi
}`;
