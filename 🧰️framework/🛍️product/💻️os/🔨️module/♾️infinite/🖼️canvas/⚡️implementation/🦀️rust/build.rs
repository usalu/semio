...
fn repo_ui_assets(manifest_dir: &Path) -> PathBuf {
    manifest_dir.join("../../../../../../../🔨️module/🖱️ui/🖼️asset/⚡️implementation/🟦️typescript")
}

fn metabolism_icons_dir(manifest_dir: &Path) -> PathBuf {
    manifest_dir.join("../../../../../../../🔨️module/🖼️asset/⚡️implementation/🟦️typescript/🌱️metabolism/🔣️icon")
}
...
fn main() {
    ...
    let shortcodes_path = ui_assets.join("🔣️icon/🤖️generated/🔣️shortcodes.json");
    let icons_dir = ui_assets.join("🔣️icon");
