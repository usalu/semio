...
pub mod icon_assets {
    ...
    pub static NOTO_COLOR_EMOJI_SUBSET_TTF: &[u8] = include_bytes!("../../../🖼️canvas/⚡️implementation/🦀️rust/🖼️asset/🔤️NotoColorEmoji-subset.ttf");

    pub static MAP_LABEL_SANS_TTF: &[u8] = include_bytes!("../../../🖼️canvas/⚡️implementation/🦀️rust/🖼️asset/🔤️MapLabelSans.ttf");
}
