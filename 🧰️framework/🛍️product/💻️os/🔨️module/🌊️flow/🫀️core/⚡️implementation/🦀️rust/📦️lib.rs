...
mod flow_vcs_tests {
    ...
    fn default_flow_example_dsl_round_trips() {
        let text = include_str!("../../../📚️example/🌊️default.flow");
...
mod tests {
    ...
    fn flow_fixture_with_synapses_builds_dag_edges_and_ports() {
        ...
        host.replace_fixture(<FlowFixture as store::DocumentDsl>::parse_dsl(include_str!("../../../📚️example/🌊️default.flow")).expect("fixture"));
