...
fn operator(id: &str, name: &str, summary: &str, outputs: Vec<ChannelSpec>, operation: Box<dyn Operation>) -> (OperatorInfo, Vec<OperatorImpl>) {
    (
        OperatorInfo { id: id.into(), module: "core".into(), name: name.into(), abbreviation: name.into(), icon: "emoji:🧱️".into(), summary: summary.into(), inputs: vec![], outputs, ..Default::default() },
