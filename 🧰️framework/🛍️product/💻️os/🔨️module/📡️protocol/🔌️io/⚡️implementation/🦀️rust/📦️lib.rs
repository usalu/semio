...
mod native {
    ...
    impl HistoryFile {
        ...
        ///
        /// 🎯️ Design choice (forced by the crate boundary): `protocol_format::SprWriter::begin` and
    ...
    /// @emoji 💾️ Writes a complete `.spk` pack file as a sidecar, atomically (`pack_io::write_atomic`
    ...
    impl TailFollower {
        ...
        ///
        /// 🎯️ Design choice: `protocol_history::HistoryReader::edits()` always begins its own fresh
    ...
    /// @emoji 🧹️ Atomic rewrite via `pack_io::write_atomic` (temp file + fsync + rename — a reader
