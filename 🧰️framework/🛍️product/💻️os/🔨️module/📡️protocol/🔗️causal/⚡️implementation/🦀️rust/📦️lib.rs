...
/// `protocol_core::🔖️WireCodec`'s primitives — the storage/wire form `protocol_wire`'s frames
...
mod tests {
    ...
    /// @emoji 🎯️ Hand-written (no `dsl::DslOps` derive in this dependency-free fixture): `format
    /// u8 (=1) | delta i64 LE`.
