...
fn main() {
    ...
    let icons_dir = manifest_dir.join("../../../../../../../../🔨️module/🖱️ui/🖼️asset/⚡️implementation/🟦️typescript/🔣️icon");
    ...
    fs::copy(manifest_dir.join("🔣️semio_logo.svg"), out_dir.join("🔣️semio_logo.svg")).expect("copy semio logo");
    ...
    out.push_str("];\n");
    fs::write(out_dir.join("icons_🤖️generated.rs"), out).expect("write icons_🤖️generated.rs");
}
