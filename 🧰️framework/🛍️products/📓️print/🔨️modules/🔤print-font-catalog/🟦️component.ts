...
const PRINT_FONT_DESCRIPTORS: readonly PrintFontDescriptor[] = [
  ...
  { family: "Noto Emoji", directory: "noto-emoji", filename: "NotoEmoji-Regular.ttf", sourceUrl: "https://raw.githubusercontent.com/google/fonts/main/ofl/notoemoji/NotoEmoji%5Bwght%5D.ttf" },
];
...
export function printFontSearchPaths(): readonly string[] {
  return PRINT_FONT_DESCRIPTORS.map((font) => join(fontRoot, font.directory));
}
