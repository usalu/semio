...
//!
//! See the pack testing section of the wave-0 contract at
...
//#region 🔖️Corrupt
/// 🧪️ Container-level corruption sweeps live with the container itself.
...
pub async fn golden_hash_hex(bytes: &[u8]) -> String {
    semio_framework_hash::hash(bytes).to_hex()
}
//#endregion 🔖️Golden

//#region 🧪️Tests
#[cfg(test)]
#[path = "../🧬️record-codec-laws-unit/🦀️.rs"]
mod tests;
//#endregion 🧪️Tests
