...
export default defineConfig({
  ...
  test: {
    ...
    environment: "node",
    include: ["🧪️tests/📨️browser-frame-transport/🟦️.ts", "🧪️tests/🎮️browser-interactive-job-port/🟦️.ts", "🧪️tests/⏱️wgpu-ui-turn-budget/🟦️.ts", "🧪️tests/⏱️wgpu-worker-step-budget/🟦️.ts", "🧪️tests/🧩️package-integration/🟦️.ts", "🧪️tests/🔬️wgpu-extension-dispatch/🟦️.ts", "🧪️tests/🧩️wgpu-module-routes/🟦️.ts", "🧪️tests/🔢️wgpu-u64-seam/🟦️.ts", "🧪️tests/🖌️wgpu-document-owner-move/🟦️.ts", "🧪️tests/🌳️wgpu-document-reconcile/🟦️.ts", "🧪️tests/🌳️tree-row-rects/🟦️.ts", "🧪️tests/🎯️retained-hit-targets/🟦️.ts", "🧪️tests/🛍️app-catalogue-attempt/🟦️.ts", "🧪️tests/🪟️action-window-scope/🟦️.ts","🧪️tests/🖼️wgpu-raster-witness/🟦️.ts", "🧪️tests/🗞️wgpu-typed-operation-reply/🟦️.ts", "🧪️tests/🎮️wgpu-browser-input-wire/🟦️.ts", "🧪️tests/🎮️wgpu-runtime-mailbox-admission/🟦️.ts", "🧪️tests/🧾️frame-action-ledger/🟦️.ts"],
