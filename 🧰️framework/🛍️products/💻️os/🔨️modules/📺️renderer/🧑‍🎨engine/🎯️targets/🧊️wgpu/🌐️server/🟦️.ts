...
function bootAxisMetaTags(variant: string | undefined): { tag: string; attrs: Record<string, string>; injectTo: "head" }[] {
  const axes: [string, string | undefined][] = [
    ...
    ["semio-brand-window-title", process.env.SEMIO_BRAND_WINDOW_TITLE],
    ["semio-brand-ephemeral", process.env.SEMIO_BRAND_EPHEMERAL],
    ["semio-brand-replay-introduction", process.env.SEMIO_BRAND_REPLAY_INTRODUCTION],
