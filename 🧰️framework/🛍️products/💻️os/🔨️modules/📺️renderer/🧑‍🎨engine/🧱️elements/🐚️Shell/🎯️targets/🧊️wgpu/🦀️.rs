...
mod command_registry_tests {
    ...
    #[cfg(not(target_arch = "wasm32"))]
    use semio_framework_os_kernel::os_directory::schema::{GisMapInferenceApprovalReceiptV1, GisMapInferenceEventPageV1, GisMapInferenceJobReceiptV1, GisMapInferenceJobStateV1, GisMapInferencePreviewV1, GisMapInferenceProgressV1, GisMapInferenceProposalStateV1};
