...
if (import.meta.vitest) {
  ...
  describe("TypedWire", () => {
    ...
    it("OwnedResidentPool reserves shared pages before allocation and returns credit only after final alias retirement", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/💾️resident/🔣️.json"); const { default: retainedRootSchemaModule } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧬️schema/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedRootSchemaModule, "ResidentFixture"); const { default: residentSchemaModule } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧬️schema/🔣️.json"); const domain = exactSchemaDefinitionV1(residentSchemaModule, "Resident"); const { default: neutralSchemaModule } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🧬️schema/🔣️.json"); const neutral = exactSchemaDefinitionV1(neutralSchemaModule, "Resident"); const { default: contract } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🤝️contract.json"); const { default: metadata } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧪️fixture/🔣️.json"); const { default: binding } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: readers } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { Buffer } = await import("node:buffer");
...
it("OwnedResidentReaderRevocation preserves the original read alias and parent close after operations revoke", async () => {
    ...
    it("OwnedResidentMetadata charges each schema-defined UI record envelope separately from neutral registration and backing", async () => {
      ...
      const schema = exactSchemaDefinitionV1(metadataSchemaModule, "MetadataFixture");
      const domain = exactSchemaDefinitionV1(metadataSchemaModule, "Metadata");
      ...
      const capacitySchema = exactSchemaDefinitionV1(capacitySchemaModule, "Resident");
    ...
    it("OwnedInstanceMaintenance preserves child refusal and callback failure without losing the queued owner", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🛠️instance-maintenance/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🛠️instance-maintenance/🧬️.schema.json");
    ...
    it("OwnedInstanceCloseAccounting preserves full-grant surface completion before separate wrapper release", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🚪️instance-close/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🚪️instance-close/🧬️.schema.json"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedSurfaceChild preserves private lookup and retirement refusal without losing retry ownership", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🪆️surface-child/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🪆️surface-child/🧬️.schema.json"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("normalizes all native component variants and defaults with strict neutral and Immer oracles", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🧾️typed/🧬️.schema.json");
    ...
    it("TypedNodeFields retains seven direct fields without ancestor chains across repeated replacement", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🏷️fields/🧬️.schema.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedNodeIndex captures exact readers across removal and closes final surface owners in bounded steps", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🌳️owned-nodes/🧬️.schema.json");
    ...
    it("OwnedOperation applies typed field owners and removes subtrees while preserving concurrent source snapshots", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/⚙️owned-operations/🧬️.schema.json");
      const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedValidation preserves graph violation order, captured byte lifetimes and every cancellation frontier", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🛡️owned-validation/🧬️.schema.json");
      const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
      let prefixes = 0;
    ...
    it("OwnedHash streams exact insertion-ordered JSON bytes while retaining old surface owners through cancellation", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔏️owned-hash/🧬️.schema.json");
      const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("ReadLease binds exact consumer commits, keeps stable snapshots and backpressures until retired roots are empty", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🎟️read-lease/🧬️.schema.json");
      const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("ReadPublication exposes all staged reads at one epoch and retains cancelled captures until bounded close", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📤️read-publication/🧬️.schema.json");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedScene prepares native tag vectors and long Unicode slices with strict neutral and Node oracles", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🎬️owned-scene/🧬️.schema.json");
    ...
    it("TypedScene validates all fifteen native schema roots and nested records without reconstructing source strings", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🧾️typed-scene/🧬️.schema.json");
    ...
    it("SceneTextBytes reads exact owned UTF-8 ranges without whole-text conversion and retires cancelled readers", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔤️scene-text-bytes/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔤️scene-text-bytes/🧬️.schema.json"); expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true); expect(Buffer.from(fixture.text).toString("hex")).toBe(fixture.utf8Hex);
    ...
    it("OwnedSceneJson streams exact syntax from captured prepared UTF-8 with JSON.parse and Node Buffer oracles", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️scene-json/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️scene-json/🧬️.schema.json"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedSceneJsonDocument publishes flat validated tokens with independent exact span and reader ownership", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📃️scene-json-document/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📃️scene-json-document/🧬️.schema.json"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
      function create(text: string) {
        const bytes = Buffer.from(text); const prefix = [13, 1, 6, 6, ...Buffer.from("buffer"), 6]; let remaining = bytes.length; do { const digit = remaining % 128; remaining = Math.floor(remaining / 128); prefix.push(digit | (remaining ? 128 : 0)); } while (remaining);
    ...
    it("OwnedSceneJsonString projects selected exact string tokens into bounded UTF-16 pages", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🧵️scene-json-string/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🧵️scene-json-string/🧬️.schema.json"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedScenePackedField decodes captured base64 into independently retired pages with atob and Node Buffer oracles", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🧳️scene-pack-field/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🧳️scene-pack-field/🧬️.schema.json"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedSceneGenericPack retains original symbols, map pairs and exact scalar spans with native-wire and Node oracles", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📦️scene-generic-pack/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📦️scene-generic-pack/🧬️.schema.json"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("SceneBinding atomically owns the exact node and prepared scene or a surfaced diagnostic", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔗️scene-binding/🧬️.schema.json");
    ...
    it("TypedScene separates exact numeric wire bits from finite geometry and owning-host usize width", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔢️scene-numeric/🧬️.schema.json");
    ...
    it("OwnedNativeChild preserves decode refusal and raw over-grant work through both operation layers", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/👶️native-child/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/👶️native-child/🧬️.schema.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); const deepStrictEqual: typeof import("node:assert").deepStrictEqual = (await import("node:assert")).deepStrictEqual;
    ...
    it("OwnedWireOperation consumes all eleven native tags into paired publication before its exact ACK", async () => {
      ...
      const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📨️wire-operations/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📨️wire-operations/🧬️.schema.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedInstance binds the exact activation and guest lifetime while closing old readers independently", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🪪️instance-owner/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🪪️instance-owner/🧬️.schema.json");
    ...
    it("OwnedRootSource renders exact native roots through independent consumers and retains close until unmount", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🌱️root-source/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🌱️root-source/🧬️.schema.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📨️wire-operations/🔣️.json");
    ...
    it("OwnedIntake retains one lookup and exact native source until successful publication receipt", async () => {
      const { OwnedUiPatchIntake } = await import("./📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📥️intake/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📥️intake/🧬️.schema.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedIntake preserves an injected committed close rejection and its exact retained owner", async () => {
      const { OwnedUiPatchIntake } = await import("./📥️intake/🟦️.ts"); const { OwnedUiInstance, OwnedUiInstancePatch } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🚨️intake-close-fault/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🚨️intake-close-fault/🧬️.schema.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedIntake preserves failed notification ownership and permits exact consumer retry before later publication", async () => {
      const { OwnedUiPatchIntake } = await import("./📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔔️intake-notification/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔔️intake-notification/🧬️.schema.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedSurface publishes a validated hashed flat root before ACK and retires exact subscription owners", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🗺️owned-surface/🧬️.schema.json");
      const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
  ...
  describe("SurfaceBytePages", () => {
    it("matches Node Buffer at every native page boundary and preserves exact captured owners", async () => {
      ...
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🗺️surface-bytes/🧬️.schema.json");
      expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
      for (const length of fixture.lengths) {
