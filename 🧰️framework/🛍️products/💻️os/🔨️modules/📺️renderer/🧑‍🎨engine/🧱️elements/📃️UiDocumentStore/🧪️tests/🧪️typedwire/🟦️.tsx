...
export async function registerTests1(vitest: NonNullable<ImportMeta["vitest"]>, dependencies: any, source: TestSource): Promise<void> {
  ...
  const exactSchemaDefinitionV1 = (source: unknown, name: string): object => {
    if (source === null || typeof source !== "object") throw new Error(`Missing schema module for ${name}`);
    const definitions = Reflect.get(source, "definitions");
    const defs = Reflect.get(source, "$defs");
    if (defs === null || typeof defs !== "object") throw new Error(`Missing schema definitions for ${name}`);
    const definition = Reflect.get(defs, name);
    if (definition === null || typeof definition !== "object") throw new Error(`Missing schema definition ${name}`);
    return { ...(definitions === null || typeof definitions !== "object" ? {} : { definitions }), $defs: defs, ...definition };
  };
  const { default: retainedFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🩹️patch/🔣️.json");
  const { default: retainedSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧬️schema/🔣️.json");
  const retainedSchema = exactSchemaDefinitionV1(retainedSchemaModule, "PatchFixture");
  const { default: Ajv } = await import("ajv");
  const { produce } = await import("immer");
  const { RetainedUiWireValueCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🟦️.ts");
  const { default: wireFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/📤️decode/🔣️.json");
  const { default: wireSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧬️schema/🔣️.json");
  const wireSchema = exactSchemaDefinitionV1(wireSchemaModule, "DecodeFixture");
  ...
  const { default: scalarSchemaModuleJson } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🔢️scalar/🧬️schema/🔣️.json");
  const scalarDeclarationSchemaJson = exactSchemaDefinitionV1(scalarSchemaModuleJson, "ScalarDeclaration");
  const { default: scalarTestsJson } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🔢️scalar/🧫️fixtures/🔣️.json");
  const scalarTestsSchemaJson = exactSchemaDefinitionV1(scalarSchemaModuleJson, "ScalarTestsFixture");
  const { default: actorWordSchemaJson } = await import("../../../../../../../../../🔨️modules/🎭️actor/📃️page/🧬️schema/🔣️.json");
  const { default: scalarReaderFixtureRaw } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json?raw");
  const { default: scalarPageFixtureRaw } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json?raw");
  ...
  describe("TypedWire", () => {
    //#region 🔢️ScalarSourceOracles
    {
      ...
      //#endregion
      const importedLeb: unknown = createRequire(source.url)("@webassemblyjs/leb128/lib/leb.js");
      ...
      const scalarChildSources: Readonly<Record<string, Uint8Array>> = {
       "🧰️framework/🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json": new TextEncoder().encode(scalarReaderFixtureRaw),
       "🧰️framework/🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json": new TextEncoder().encode(scalarPageFixtureRaw),
      };
      //#endregion
    ...
    async function nativeInstanceFixture(sharedLedger?: import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      ...
      const { OwnedResidentLedger } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: residentFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧫️fixtures/🔣️.json");
    ...
    async function nativePagedFieldFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🧫️fixtures/🔣️.json"); const row = fixture.valid[fixtureIndex]!; const payload = Buffer.from(Array.from({ length: Number(row.declaredBytes) }, (_, i) => (73 * i + 19) & 255));
    ...
    it("OwnedPagedPayloadSchema admits only exact canonical u64 field lengths", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🧫️fixtures/🔣️.json"); const { default: pagesSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🧬️schema/🔣️.json"); const fixtureSchema = exactSchemaDefinitionV1(pagesSchemaModule, "PagesFixture"); const domain = exactSchemaDefinitionV1(pagesSchemaModule, "Pages"); const { default: words } = await import("../../../../../../../../../🔨️modules/🎭️actor/📃️page/🧬️schema/🔣️.json"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedPagedAdmission roots the actual field builder before exposure and cancels abandoned input under the shared owner grant", async () => {
      const { OwnedUiOperationPayloadBuilder, OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { default: evidence } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json"); const { default: cancellation } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧫️fixtures/🔣️.json"); const { default: scopes } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json");
    ...
    it("OwnedPagedAdmission keeps rejected binding and source release failures owned and separates terminal child work from parent release", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { native, pool, scope, payload, builder, evidenceFixture: evidence } = await residentEvidenceFixture(); const foreign = await residentBuilderFixture(); const before = pool.usage;
    ...
    async function residentAuthoredWindowFixture() {
      const base = await residentBuilderFixture(); const { default: binding } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); expect(base.builder.advance({ maxItems: 1, maxBytes: binding.producer.fragmentCapture })).toMatchObject({ kind: "pending", bytes: binding.producer.fragmentCapture });
    ...
    it("OwnedPagedCopy copies the genuine first fragment into admitted fixed pages and strongly owns the sequential reader", async () => {
      const { Buffer } = await import("node:buffer"); const { default: copied } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧫️fixtures/🔣️.json"); const { default: cancellation } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧫️fixtures/🔣️.json"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { native, payload, builder, reader, actual, pool, evidenceFixture: evidence, readerFixture: readers, fixture: payloadFixture, pageFixture: pages } = await residentCopiedRangeFixture(); const baseline = pool.usage;
    ...
    it("OwnedPagedFault preserves child refusal and raw over-grant accounting without advancing the producer", async () => {
      const { OwnedUiResidentPage } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🧫️fixtures/🔣️.json");
    ...
    it("OwnedPagedFault retains a registered reader after an exact page read throws without skipping the failed byte", async () => {
      const { OwnedResidentReader, OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: readers } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { native, pool, payload, builder, binding } = await residentAuthoredWindowFixture(); let reader: import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayloadReader | null = null;
    ...
    it("OwnedPagedPartialFault cannot resume after a page write throws before or after mutation", async () => {
      const { OwnedUiResidentPage } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🧫️fixtures/🔣️.json");
    ...
    async function residentAuthoredClosePayload(base: Awaited<ReturnType<typeof residentBuilderFixture>>) {
      const { default: readers } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: binding } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { default: cancellation } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧫️fixtures/🔣️.json"); const maximum = readers.admissionGrants.length + readers.closing.grants.length + readers.aliasCloseGrants.length + binding.admissionGrants.length + binding.closeGrants.length + base.evidenceFixture.grants.length + base.evidenceFixture.retirement.grants.length + base.evidenceFixture.retirement.registrationGrants.length + builders.bindingGrants.length + base.fixture.sourceReleaseTurns.length + cancellation.closeBound.payloadRegistrationGrants.length + cancellation.closeBound.storageGrants.length + cancellation.closeBound.inputDetachGrants.length;
    ...
    it("OwnedPagedCancel retains every first-fragment cancellation prefix and distinguishes copied from detached input", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🧫️fixtures/🔣️.json"); const { default: readers } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: binding } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: evidence } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json"); const { default: copied } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧫️fixtures/🔣️.json"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedPagedContinuation completes only after the original field consumes its released range", async () => {
      const { default: copied } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧫️fixtures/🔣️.json"); const { builder, reader, native, evidenceFixture: evidence } = await residentAuthoredSourceFixture(); let consumed = 0;
    ...
    it("OwnedPagedContinuation preserves source child faults and separates terminal work from readiness", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🧫️fixtures/🔣️.json"); const { default: copied } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentReaderConstructor keeps the preinstalled reader and exact finalization fault charged", async () => {
      const { OwnedUiResidentPayloadReader } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { payload, builder, pool } = await residentBuilderFixture();
    ...
    it("OwnedPagedBoundary defers exact source completion metadata until after a full-grant child turn", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: copied } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧫️fixtures/🔣️.json"); const { builder, native } = await residentAuthoredSourceFixture(); for (let index = 0; index < native.payload.length - 1; index++) { builder.advance({ maxItems: 1, maxBytes: copied.sourceStepBytes }); builder.advance({ maxItems: 1, maxBytes: copied.sourceObservationBytes }); }
    ...
    it("OwnedResidentPool reserves shared pages before allocation and returns credit only after final alias retirement", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/💾️resident/🔣️.json"); const { default: retainedRootSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧬️schema/🔣️.json"); const { default: residentSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧬️schema/🔣️.json"); const { default: neutralSchemaModule } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🧬️schema/🔣️.json"); const { default: contract } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🤝️contract.json"); const { default: metadata } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: binding } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: readers } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { Buffer } = await import("node:buffer");
      const ajv = new Ajv({ strict: true, allErrors: true }).addSchema(neutralSchemaModule).addSchema(residentSchemaModule).addSchema(retainedRootSchemaModule); const residentFixtureSchema = ajv.getSchema(`${retainedRootSchemaModule.$id}#/$defs/ResidentFixture`)!; expect(residentFixtureSchema(fixture), JSON.stringify(residentFixtureSchema.errors)).toBe(true); const capacity = ajv.getSchema(`${residentSchemaModule.$id}#/$defs/Resident`)!; expect(capacity(metadata.compositionCapacity)).toBe(true); for (const invalid of fixture.invalidCapacities) expect(capacity(invalid)).toBe(false); expect(capacity({ bytes: 0, slots: 0, owners: 0, control: { bytes: 0, slots: 0, owners: 0 } })).toBe(true); expect(contract.composition.defaultCapacity).toBeNull(); expect(contract.finalInstanceWitness.counterOnlyAuthorityAccepted).toBe(false); expect(contract.composition.parallelUiCapacity).toBe(false);
    ...
    it("OwnedResidentPool preserves ownership on saturation, cancellation, forged handles and revoked operations", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentPage, OwnedUiResidentPayload, OwnedUiResidentInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedResidentLedger } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: neutral } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🧫️fixtures/🔣️.json"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/💾️resident/🔣️.json"); const { default: metadata } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); for (const invalid of fixture.invalidCapacities) expect(() => new OwnedResidentLedger(invalid)).toThrow(); for (const Type of [OwnedUiResidentPool, OwnedUiResidentPage, OwnedUiResidentPayload, OwnedUiResidentInstance]) expect(() => Reflect.construct(Type, [{}, {}])).toThrow();
    ...
    it("OwnedResidentPool roots abandoned reservations and delays the exact instance witness for live read aliases", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/💾️resident/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: readers } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: scopes } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json"); const base = await residentBuilderFixture(); const { native, payload, builder, scope } = base; let page: import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentSlotContract declares the funded parent handoff and immutable concurrent roster oracle", async () => {
      const { default: contract } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🤝️contract.json"); const { default: slotSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧬️schema/🔣️.json"); const domain = exactSchemaDefinitionV1(slotSchemaModule, "Slot");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json"); const schema = exactSchemaDefinitionV1(slotSchemaModule, "SlotFixture");
    ...
    it("OwnedResidentConstruction installs the original pool before fallible field construction and retains exact faults", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧫️fixtures/🔣️.json"); const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentScope admits its original native lifetime through the parent-funded slot and retires exact registrations", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json");
      const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json"); const native = await nativeInstanceFixture(); for (const bytes of composition.poolPreparation.prepareBytes) expect(native.client.prepareUiResidentPool(native.residentLedger, { maxItems: 1, maxBytes: bytes }).kind).toBe("pending");
    ...
    it("OwnedResidentScope cancels every admitted prefix through its original parent slot", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json"); const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentScope retains exact installed shells and first faults across constructor and handoff failures", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json"); const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentScope serializes transitions without conflating independent native lifetimes", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { encodeActorInstanceLifecycle } = await import("../../../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json"); const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentScope retains before-and-after canonical admission wrapper faults without a false pending close", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedResidentLedger, OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json"); const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentComposition retains the exact prepared pool and separates metadata admission from construction and final refund", async () => {
      ...
      const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json"); const native = await nativeInstanceFixture(); const before = native.residentLedger.usage.data;
    ...
    async function residentPayloadFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const { OwnedUiResidentPool } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧫️fixtures/🔣️.json"); const { default: scopes } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json"); const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json");
    ...
    async function residentBuilderFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const base = await residentPayloadFixture(fixtureIndex, sharedLedger); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { default: builderFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { default: evidenceFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentPayloadAdmission admits an exact captured field in separate grants and waits for two-way source retirement", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentPayload } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧫️fixtures/🔣️.json"); const { default: scopes } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧫️fixtures/🔣️.json"); const { default: composition } = await import("../../../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧫️fixtures/🔣️.json");
...
it("OwnedResidentPageBinding keeps the original page in its builder until parent-authorized detachment", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: bindingSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧬️schema/🔣️.json"); const schema = exactSchemaDefinitionV1(bindingSchemaModule, "BindingFixture"); const { default: contract } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🤝️contract.json"); const domain = exactSchemaDefinitionV1(bindingSchemaModule, "Binding"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(ajv.validate(domain, contract)).toBe(true);
...
it("OwnedResidentPageProducer admits its original page through the shared parent before allocation", async () => {
      const { builder, payload, pool, reader } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: binding } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const before = pool.usage; expect(builder.advance(grant)).toMatchObject({ kind: "pending", bytes: 128 });
...
it("OwnedResidentPageProducerWindow copies two original windows with separate scalar grants before source EOF", async () => {
      const { payload, builder, reader, pool, native, readerFixture: readers } = await residentReaderFixture(); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { Buffer } = await import("node:buffer"); const before = pool.usage; const actual: number[] = []; const work = fixture.producer;
...
it("OwnedResidentPageBindingFault retains original install and detach wrapper failures without refund", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json");
...
it("OwnedResidentPageBindingChild preserves refusal and separates terminal child work from observation", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json");
...
it("OwnedResidentPageProducerFault retains the exact read or write fault without replaying an offset", async () => {
      const { OwnedKernelReturnInputFragment } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedUiResidentPage } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentPageAdmission charges the original storage owner and complete fixed page before allocation", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: pageSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧬️schema/🔣️.json"); const schema = exactSchemaDefinitionV1(pageSchemaModule, "PageFixture"); const { default: Ajv } = await import("ajv"); const { Buffer } = await import("node:buffer"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(48n + 8n * BigInt(fixture.stateFields.length + fixture.facadeFields.length + fixture.witnessFields.length)).toBe(BigInt(fixture.domain.bytes));
    ...
    it("OwnedResidentPageRetirement preserves zero-grant authority and refunds each original alias separately", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: pageSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧬️schema/🔣️.json"); const schema = exactSchemaDefinitionV1(pageSchemaModule, "PageFixture"); const { default: Ajv } = await import("ajv"); expect(new Ajv({ strict: true }).validate(schema, fixture)).toBe(true);
    ...
    it("OwnedResidentPageCancellation closes every original owner and page admission prefix through its payload", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: builderFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json");
    ...
    async function residentPageFixture() {
      const base = await residentBuilderFixture(); const { default: pageFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); let page: import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentPageChild preserves exact child refusal and terminal grant before parent observation", async () => {
      const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentPageFault retains exact constructor and admission wrapper failures in the original parent cell", async () => {
      const { OwnedResidentLedger, OwnedResidentOwner, OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { OwnedUiResidentPage } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json");
      for (const row of fixture.faults) {
    ...
    it("OwnedResidentPageBodyFault never retries past a before or after mutation failure", async () => {
      const { OwnedResidentPage, OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentPageInventory matches actual fixed fields and the shared metadata envelope", async () => {
      const ts = await import("typescript"); const { readFileSync } = await import("node:fs"); const { resolve } = await import("node:path"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: payloadFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧫️fixtures/🔣️.json"); const { uiResidentMetadataEnvelope } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🟦️.ts");
...
it("OwnedResidentReaderPageFence invalidates the exact sealed page when the reader captures retirement", async () => {
      const { payload, builder, reader, readerFixture: fixture } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); let page: import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
...
it("OwnedResidentReaderInventory matches the exact state facade witness and existing parent words", async () => {
      const ts = await import("typescript"); const { readFileSync } = await import("node:fs"); const { resolve } = await import("node:path"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: payloadFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧫️fixtures/🔣️.json"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { uiResidentMetadataEnvelope } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🟦️.ts");
    ...
    it("OwnedResidentReaderBindingFault keeps exact before and after detachment failures charged", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentReaderBindingGrant forwards child refusal and terminal work before separate observation", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json");
...
it("OwnedResidentReaderRevocation preserves the original read alias and parent close after operations revoke", async () => {
      const { payload, builder, reader, pool, native, readerFixture: fixture } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); let page: import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentReaderAdmission installs the exact reader before EOF without charging another page or owner", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: readerSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧬️schema/🔣️.json"); const schema = exactSchemaDefinitionV1(readerSchemaModule, "ReaderFixture"); const { default: Ajv } = await import("ajv"); expect(new Ajv({ strict: true }).validate(schema, fixture)).toBe(true);
    ...
    async function residentReaderFixture(fixtureIndex = 2) {
      const base = await residentBuilderFixture(fixtureIndex); const { default: readerFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); let reader: import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayloadReader | null = null;
    ...
    it("OwnedResidentReaderWindow consumes two original byte pages before source EOF without retaining the whole extent", async () => {
      const { payload, builder, reader, pool, native, readerFixture: fixture } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { Buffer } = await import("node:buffer"); const expected = Buffer.from(native.payload); const actual: number[] = []; const baseline = pool.usage;
    ...
    it("OwnedResidentReaderHeld preserves original handle identity throughout its admitted read phases", async () => {
      const { payload, builder, reader, pageFixture: pages, page } = await (async () => { const base = await residentReaderFixture(); const { default: pageFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); let page: import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null; for (const bytes of [...pageFixture.storageOwnerGrants, ...pageFixture.admissionGrants]) page = base.payload.beginPage(base.builder, 1, { maxItems: 1, maxBytes: bytes }).page; if (!page) throw new Error("Missing held-reader page"); return { ...base, page, pageFixture }; })();
    ...
    it("OwnedResidentReaderCancellation retires every admitted prefix under the exact original parent", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentReaderBodyFault preserves original alias and byte offset after read or detach wrapper failure", async () => {
      const { OwnedResidentReader, OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json");
      for (const row of fixture.bodyFaults) {
    ...
    it("OwnedResidentBuilderAdmission charges and registers the original builder before source binding and publication", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { default: builderSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧬️schema/🔣️.json"); const schema = exactSchemaDefinitionV1(builderSchemaModule, "BuilderFixture"); const { default: contract } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🤝️contract.json"); const contractSchema = exactSchemaDefinitionV1(builderSchemaModule, "Builder"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true, allErrors: true }); expect(ajv.validate(schema, fixture), ajv.errorsText()).toBe(true); expect(ajv.validate(contractSchema, contract), ajv.errorsText()).toBe(true);
    ...
    it("OwnedResidentBuilderGrant preserves every phase when one byte short", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { native, pool, scope, fixture: payloadFixture } = await residentPayloadFixture(); let payload: import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null;
    ...
    it("OwnedResidentBuilderCancellation retires every prefix through the exact source binding", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts");
      for (const prefix of fixture.prefixes) {
    ...
    it("OwnedResidentBuilderInventory matches actual compiler-parsed fields and the neutral metadata oracle", async () => {
      const ts = await import("typescript"); const { readFileSync } = await import("node:fs"); const { resolve } = await import("node:path"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { default: evidence } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json"); const root = resolve(process.cwd(), "../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained");
    ...
    async function residentCopiedRangeFixture() {
      const base = await residentReaderFixture(); const { default: binding } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { builder, reader, readerFixture: readers } = base; const actual: number[] = []; builder.advance({ maxItems: 1, maxBytes: binding.producer.fragmentCapture });
    ...
    it("OwnedResidentCopiedCancellation preserves the same copied token without advancing source progress during close", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧫️fixtures/🔣️.json"); const { default: cancellation } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧫️fixtures/🔣️.json"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts");
    ...
    it("OwnedResidentCopiedChild preserves source refusal and full-grant results before independent observation", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧫️fixtures/🔣️.json"); const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts");
    ...
    it("OwnedResidentCopiedFault retains exact source-advance wrapper exceptions before or after the original byte", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧫️fixtures/🔣️.json"); const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts");
    ...
    it("OwnedResidentActiveInputCancellation detaches the captured input before admitting its exact cancelled evidence", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧫️fixtures/🔣️.json"); const { default: cancellationSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧬️schema/🔣️.json"); const schema = exactSchemaDefinitionV1(cancellationSchemaModule, "CancellationFixture"); const { default: contract } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🤝️contract.json"); const domain = exactSchemaDefinitionV1(cancellationSchemaModule, "Cancellation"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(ajv.validate(domain, contract)).toBe(true);
      const { OwnedUiOperationInputCancelled } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentActiveInputWindows closes latched and written bytes behind the exact reader and page aliases", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧫️fixtures/🔣️.json"); const { default: binding } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🔗️binding/🧫️fixtures/🔣️.json"); const { default: pages } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📃️page/🧫️fixtures/🔣️.json"); const { default: readers } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧫️fixtures/🔣️.json"); const { default: builders } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { OwnedUiOperationInputCancelled } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts");
    ...
    it("OwnedResidentEvidenceBrands exposes only exact private release predicates", async () => {
      const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json"); const { default: evidenceSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧬️schema/🔣️.json"); const schema = exactSchemaDefinitionV1(evidenceSchemaModule, "EvidenceFixture"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(fixture.records.reduce((sum, row) => sum + 16n + 8n * BigInt(row.fields), 0n)).toBe(BigInt(fixture.domain.bytes)); let reads = 0; const hostile = new Proxy({}, { get() { reads++; throw new Error("Untrusted evidence read"); } });
    ...
    it("OwnedResidentEvidenceAdmission registers original cancellation evidence before source release", async () => {
      const { OwnedUiOperationPayloadBuilder, OwnedUiOperationInputCancelled } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { default: builderFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const { default: evidenceFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentEvidenceCancellation retires every admitted prefix without replacing the original token", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts");
    ...
    it("OwnedResidentEvidenceChild forwards exact source refusal and full-grant work before its own observation", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentEvidenceSourceFault keeps exact before and after mutation faults under the original cell", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentEvidenceFault retains the installed token shell, capsule and exact original fault", async () => {
      const { OwnedUiOperationInputCancelled, OwnedUiOperationInputCopied } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📃️pages/🟦️.ts"); const { OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧫️fixtures/🔣️.json");
      for (const frontier of fixture.faults) {
    ...
    it("OwnedResidentBuilderBindingChild forwards source refusal and terminal full-grant work without a same-turn observation", async () => {
      const { OwnedUiResidentBuilderRetirement } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentBuilderBindingFault retains exact before and after source-mutation faults without refund", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json");
    ...
    it("OwnedResidentBuilderBindingBrands requires the original privately phased body and source witness", async () => {
      const resident = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧫️fixtures/🔣️.json"); const witness: unknown = Reflect.get(resident, "OwnedUiResidentBuilderRetirement"); expect(typeof witness).toBe("function"); if (typeof witness !== "function") throw new Error("Missing original builder witness"); let reads = 0; const hostile = new Proxy({}, { get() { reads++; throw new Error("Forged builder binding read"); } });
    ...
    it("OwnedResidentPayloadCancellation closes all admitted prefixes through the original parent slot", async () => {
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧫️fixtures/🔣️.json");
      for (const prefix of fixture.cancellationPrefixes) {
    ...
    it("OwnedResidentPayloadFault retains exact source-install and finalizer faults under the original charged cell", async () => {
      const { OwnedUiResidentPayload, OwnedUiResidentPayloadSourceRelease } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputField } = await import("../../../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧫️fixtures/🔣️.json");
      for (const frontier of fixture.constructionFaults) {
    ...
    it("OwnedResidentPayloadContract accounts each future parent slot and field-owned payload record before construction", async () => {
      const { default: payloadSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧬️schema/🔣️.json"); const domain = exactSchemaDefinitionV1(payloadSchemaModule, "Payload"); const { default: contract } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🤝️contract.json"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧫️fixtures/🔣️.json"); const schema = exactSchemaDefinitionV1(payloadSchemaModule, "PayloadFixture");
    ...
    it("OwnedResidentMetadata charges each schema-defined UI record envelope separately from neutral registration and backing", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧫️fixtures/🔣️.json");
      const { default: metadataSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧬️schema/🔣️.json");
      const { OwnedResidentLedger } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts");
      const { default: capacitySchemaModule } = await import("../../../../../../../../../🔨️modules/🌱️value/💾️resident/🧬️schema/🔣️.json");
      ...
      const metadataAjv = new Ajv({ strict: true, allErrors: true }).addSchema(capacitySchemaModule).addSchema(metadataSchemaModule); const metadataFixtureSchema = metadataAjv.getSchema(`${metadataSchemaModule.$id}#/$defs/MetadataFixture`)!; expect(metadataFixtureSchema(fixture), JSON.stringify(metadataFixtureSchema.errors)).toBe(true);
    ...
    it("OwnedInstanceMaintenance preserves child refusal and callback failure without losing the queued owner", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🛠️instance-maintenance/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "InstanceMaintenanceFixture");
    ...
    it("OwnedInstanceCloseAccounting preserves full-grant surface completion before separate wrapper release", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🚪️instance-close/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "InstanceCloseFixture"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedInstanceCloseAccounting issues input retirement separately from full-grant wire completion", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedUiWirePatchCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🚪️instance-close/🔣️.json");
    ...
    it("OwnedInstanceCloseAccounting retains lookup refusal diagnostics and its exact child for retry", async () => {
      const { OwnedUiInstance, OwnedUiSurfaceLookup } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🚪️instance-close/🔣️.json");
    ...
    it("OwnedSurfaceChild preserves private lookup and retirement refusal without losing retry ownership", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🪆️surface-child/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "SurfaceChildFixture"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedSurfaceChild keeps a full-grant reader completion separate from queue work and lease minting", async () => {
      const { OwnedUiSurface } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { OwnedUiSceneBindingIndexReader } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🔗️binding/🗂️index/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🪆️surface-child/🔣️.json");
    ...
    it("normalizes all native component variants and defaults with strict neutral and Immer oracles", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🧾️typed/🔣️.json");
      const schema = exactSchemaDefinitionV1(wireSchemaModule, "TypedFixture");
    ...
    it("TypedNodeFields retains seven direct fields without ancestor chains across repeated replacement", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json");
      const schema = exactSchemaDefinitionV1(wireSchemaModule, "FieldsFixture");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedNodeIndex captures exact readers across removal and closes final surface owners in bounded steps", async () => {
      ...
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🌳️owned-nodes/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "OwnedNodesFixture");
      const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedOperation applies typed field owners and removes subtrees while preserving concurrent source snapshots", async () => {
      ...
      const { OwnedUiNodeIndex } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🗂️nodes/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/⚙️owned-operations/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "OwnedOperationsFixture");
      const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedValidation preserves graph violation order, captured byte lifetimes and every cancellation frontier", async () => {
      ...
      const { OwnedUiNodeIndex } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🗂️nodes/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🛡️owned-validation/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "OwnedValidationFixture");
      const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
      let prefixes = 0;
      for (const vector of fixture.cases) {
        ...
        const expected = validateUiDocumentCore(vector.root, new Map(produce(Array.from(reference), () => {})), limits); expect(expected.map((value: { type: string }) => value.type)).toEqual(vector.expected);
    ...
    it("OwnedHash streams exact insertion-ordered JSON bytes while retaining old surface owners through cancellation", async () => {
      ...
      const { OwnedUiNodeIndex } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🗂️nodes/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🔏️owned-hash/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "OwnedHashFixture");
      const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("ReadLease binds exact consumer commits, keeps stable snapshots and backpressures until retired roots are empty", async () => {
      ...
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🎟️read-lease/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "ReadLeaseFixture");
      const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("ReadPublication exposes all staged reads at one epoch and retains cancelled captures until bounded close", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📤️read-publication/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "ReadPublicationFixture");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedScene prepares native tag vectors and long Unicode slices with strict neutral and Node oracles", async () => {
      ...
      const { RetainedUiTypedCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🎬️owned-scene/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "OwnedSceneFixture");
      const { default: rawFixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🎬️owned-scene/🔣️.json?raw");
    ...
    it("TypedScene validates all fifteen native schema roots and nested records without reconstructing source strings", async () => {
      ...
      const { OwnedUiSceneCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🧾️typed-scene/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "TypedSceneFixture");
      const { default: catalog } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/📇️catalog.json");
      const { default: typedSceneSchemaModule } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🧬️schema/🔣️.json"); const catalogSchema = exactSchemaDefinitionV1(typedSceneSchemaModule, "TypedScene");
      const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("SceneTextBytes reads exact owned UTF-8 ranges without whole-text conversion and retires cancelled readers", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🔤️scene-text-bytes/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "SceneTextBytesFixture"); expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true); expect(Buffer.from(fixture.text).toString("hex")).toBe(fixture.utf8Hex);
    ...
    it("OwnedSceneJson streams exact syntax from captured prepared UTF-8 with JSON.parse and Node Buffer oracles", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🔣️scene-json/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "SceneJsonFixture"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedSceneJsonDocument publishes flat validated tokens with independent exact span and reader ownership", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📃️scene-json-document/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "SceneJsonDocumentFixture"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
      function create(text: string) {
        const bytes = Buffer.from(text); const prefix = [13, 1, 6, 6, ...Buffer.from("buffer"), 6]; let remaining = bytes.length; do { const digit = remaining % 128; remaining = Math.floor(remaining / 128); prefix.push(digit | (remaining ? 128 : 0)); } while (remaining);
    ...
    it("OwnedSceneJsonString projects selected exact string tokens into bounded UTF-16 pages", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🧵️scene-json-string/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "SceneJsonStringFixture"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedScenePackedField decodes captured base64 into independently retired pages with atob and Node Buffer oracles", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🧳️scene-pack-field/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "ScenePackFieldFixture"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedSceneGenericPack retains original symbols, map pairs and exact scalar spans with native-wire and Node oracles", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📦️scene-generic-pack/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "SceneGenericPackFixture"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
      ...
      for (const vector of fixture.integers) { const bytes = Buffer.from(vector.hex, "hex"); const cursor = create(bytes); expect(drive(cursor, bytes.length), cursor.failure ?? vector.name).toBe("ready"); const document = cursor.takeResult()!; close(cursor); const source = document.captureSource(); const reader = document.beginRead(); retire(document.beginClose()); const observed: { kind: string; value: string }[] = [];
        for (;;) { const current = reader.advance(grant); if (current.kind === "value" && (current.value.kind === "int" || current.value.kind === "uint")) { expect(typeof current.value.value).toBe("bigint"); expect(current.value.length).toBeGreaterThan(0); expect(source.byteAt(current.value.start - 1)).toBe(current.value.kind === "int" ? 3 : 4); observed.push({ kind: current.value.kind, value: current.value.value.toString() }); } if (current.kind === "complete") break; }
        expect(observed, vector.name).toEqual(vector.tokens); retire(reader.beginClose()); retire(source.beginClose()); }
    ...
    it("SceneBinding atomically owns the exact node and prepared scene or a surfaced diagnostic", async () => {
      ...
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🔗️scene-binding/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "SceneBindingFixture");
      const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
      for (const vector of fixture.cases) {
    ...
    it("TypedScene separates exact numeric wire bits from finite geometry and owning-host usize width", async () => {
      ...
      const { OwnedUiSceneCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🔢️scene-numeric/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "SceneNumericFixture");
    ...
    it("OwnedSurfaceScene publishes node and prepared scene atomically and waits for issued scene children on close", async () => {
      ...
      const { RetainedUiTypedCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🔗️scene-binding/🔣️.json"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedNativeChild preserves decode refusal and raw over-grant work through both operation layers", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/👶️native-child/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "NativeChildFixture"); const { encodePackValue } = await import("@semio-tech/framework-os"); const deepStrictEqual: typeof import("node:assert").deepStrictEqual = (await import("node:assert")).deepStrictEqual;
    ...
    it("OwnedNativeChild preserves exact close refusal without unlinking real payload and decoder owners", async () => {
      ...
      const { OwnedUiOperationRetirement } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/👶️native-child/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); const deepStrictEqual: typeof import("node:assert").deepStrictEqual = (await import("node:assert")).deepStrictEqual;
    ...
    it("OwnedNativeChild separates terminal full-grant work and retains thrown close ownership", async () => {
      const { OwnedUiWireOperationCursor, OwnedUiWirePatchCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { RetainedUiTypedCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/👶️native-child/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedWireOperation consumes all eleven native tags into paired publication before its exact ACK", async () => {
      ...
      const { OwnedUiSurface } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "WireOperationsFixture"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedWireOperation rejects hostile transport inputs before transfer and closes every admitted prefix", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedWireOperation native retirement closes known fields without claiming unknown wrapper ownership", async () => {
      const { OwnedUiWireOperationCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedInstance binds the exact activation and guest lifetime while closing old readers independently", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🪪️instance-owner/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "InstanceOwnerFixture");
    ...
    it("OwnedRootSource renders exact native roots through independent consumers and retains close until unmount", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🌱️root-source/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "RootSourceFixture"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json");
    ...
    it("OwnedIntake retains one lookup and exact native source until successful publication receipt", async () => {
      const { OwnedUiPatchIntake } = await import("../../📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📥️intake/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "IntakeFixture"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedIntake late cancellation preserves committed notification and ACK under the shared close driver", async () => {
      const { OwnedUiPatchIntake } = await import("../../📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedIntake preserves an injected committed close rejection and its exact retained owner", async () => {
      const { OwnedUiPatchIntake } = await import("../../📥️intake/🟦️.ts"); const { OwnedUiInstance, OwnedUiInstancePatch } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🚨️intake-close-fault/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "IntakeCloseFaultFixture"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedIntake preserves failed notification ownership and permits exact consumer retry before later publication", async () => {
      const { OwnedUiPatchIntake } = await import("../../📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🔔️intake-notification/🔣️.json"); const schema = exactSchemaDefinitionV1(retainedSchemaModule, "IntakeNotificationFixture"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedInstance old patch facades cannot read or release a successor input receipt", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedInstance input-retirement token rejects forged ordinals and preserves cancelled exact source ownership", async () => {
      const { OwnedUiInstance, OwnedUiPatchInputRetirement } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json");
    ...
    it("OwnedInstance retirement witness requires exact terminal descendants and transfers once after revocation", async () => {
      const { OwnedUiInstance, OwnedUiInstanceRetirement } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🪪️instance-owner/🔣️.json");
    ...
    it("OwnedInstance cancels one-cell lookups and rejects forged facades at the native name boundary", async () => {
      const { OwnedUiInstance, OwnedUiInstanceSurface, OwnedUiSurfaceLookup } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🪪️instance-owner/🔣️.json");
    ...
    it("OwnedInstance binds native patch source to issued ACK and retries the exact pair after revocation", async () => {
      const { OwnedUiInstance, OwnedUiPatchAcknowledgement, OwnedUiInstanceRetirement } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/📨️wire-operations/🔣️.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedSurface publishes a validated hashed flat root before ACK and retires exact subscription owners", async () => {
      ...
      const { OwnedUiOperation } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧫️fixtures/🗺️owned-surface/🔣️.json");
      const schema = exactSchemaDefinitionV1(retainedSchemaModule, "OwnedSurfaceFixture");
      const { default: fields } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🏷️fields/🔣️.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
      expect(new Ajv({ strict: true, allErrors: true }).compile(schema)(fixture)).toBe(true);
  ...
  describe("SurfaceBytePages", () => {
    it("matches Node Buffer at every native page boundary and preserves exact captured owners", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧫️fixtures/🗺️surface-bytes/🔣️.json");
      const schema = exactSchemaDefinitionV1(wireSchemaModule, "SurfaceBytesFixture");
      expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
      for (const length of fixture.lengths) {
  ...
  function retainedClose(cursor: RetainedUiPatchCursorRef, bytes: number): void {
    cursor.beginClose();
    for (let n = 0; n < 2_000_000; n++) {
      ...
      it(`${vector.name} at one item/${bytes} bytes matches the reference rejection order and Immer value oracle`, () => {
        ...
        for (let n = 0; n < 4_000_000; n++) {
          ...
          if (result.ok && reference.ok) {
            ...
            const oracle = produce(initial.nodes, (draft: any) => {
  ...
  describe("Retained UI atomic publication", () => {
    ...
    function closeOwner(owner: RetainedUiSurfaceOwnerRef): void {
  ...
  describe("emitIntent", () => {
    it("hands the displayed store intent to its exact browser actor mailbox without a descriptor projection", async () => {
      ...
      const fixture = JSON.parse(readFileSync(new URL("../../../../🔌️plugin/🌐️browser-bundle/🎯️action-handoff/🧫️fixtures/🔣️.json", source.url), "utf8"));
