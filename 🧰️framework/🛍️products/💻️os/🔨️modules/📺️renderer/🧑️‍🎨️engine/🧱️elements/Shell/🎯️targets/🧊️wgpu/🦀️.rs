...
//! `#[path = "../../../../🧱️elements/Shell/🎯️targets/🧊️wgpu/🦀️.rs"] pub mod shell;` in lib.rs in place of
...
impl ShellState {
    ...
    /// `handleCommand` response, per `ProgramBridge/🎯️targets/🧊️wgpu/🦀️.rs`'s `AppFrame::Invocation` decode)
