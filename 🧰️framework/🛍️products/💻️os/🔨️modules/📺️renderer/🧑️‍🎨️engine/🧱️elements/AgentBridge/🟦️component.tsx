...
import { reduce, type ReduceResult, type ShellCommand, type ShellState } from "../../../../🖥️shell/🟦️component.ts";
import {
  NO_BRIDGE_FLAGS,
  ...
  type ShellKind,
  type ShellToGateway,
} from "../../../../🌉️mcp/🧵️bridge/🟦️component.ts";
// #endregion 🔌️Adapters
 ...
 * has no filesystem access to read it. Verified by reading `🌉️mcp/🦀️component.rs` and
 ...
 * inject at build/launch time, mirroring `ShellHost/🟦️component.tsx`'s `readViteSEnv` idiom
 ...
 * identical to `🖥️shell/🟦️component.ts`'s own in-source `defaultState()` test fixture (that
