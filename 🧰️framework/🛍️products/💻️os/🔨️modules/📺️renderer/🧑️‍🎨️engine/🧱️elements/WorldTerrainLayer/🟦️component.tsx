// #region 🧲️Header
// 🎨️ framework/products/os/modules/renderer/engine/elements/WorldTerrainLayer/component.tsx
/** @emoji ⛰️ `WorldTerrainLayer` — chunked-DEM-tile GIS terrain mesh mounted alongside `WorldInstancesLayer` inside the shared `World3d` viewport, driven by a wasm `TerrainSession`. */
// #endregion 🧲️Header
...
/** 🎨️ A vertical hypsometric ramp (low -> green/tan, high -> grey rock, peak -> white) sampled by
...
/** 🧵️ Owns a `TerrainSession`, fetches/uploads/evicts DEM tiles as the camera moves, and reports
