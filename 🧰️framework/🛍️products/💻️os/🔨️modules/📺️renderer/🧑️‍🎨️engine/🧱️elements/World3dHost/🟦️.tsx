...
import { CAMERA_SYNC_DEBOUNCE_MS } from "../Canvas2dHost/🟦️.tsx";
import { openSurfaceContextMenu, useShellContextMenuFallback, wireLabel, type SurfaceContextMenuResult } from "../Interpreter/🟦️.tsx";
import { WorldTerrainLayer } from "../WorldTerrainLayer/🟦️.tsx";
import { base64ToBytes } from "../Paint2dHost/🟦️.tsx";
import { createCoalescingActionDispatcher, createInFlightSkippingInterval, isRevealCutoffHidden, registeredPuzzle3dBrushMeshes, NOTE_WORLD_NAVIGATION_ACTION_ID, PUZZLE3D_FILL_REVEAL_GROUP_ID, reconcileCommittedRevealCutoffs, worldRevealCutoffStore, shellLabel } from "../ShellHelpers/🟦️.tsx";
import { SetWindowIconContext, SetWindowTitleContext, useMapContextMenuSpecs } from "../ShellHost/🟦️.tsx";
// #endregion 🔌️Adapters
