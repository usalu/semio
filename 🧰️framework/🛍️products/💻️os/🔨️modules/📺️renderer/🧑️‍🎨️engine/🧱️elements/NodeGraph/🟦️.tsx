...
import { openSurfaceContextMenu, parseSceneJsonField, useShellContextMenuFallback, type SurfaceContextMenuResult } from "../Interpreter/🟦️.tsx";
import { mapContextMenuSpecs, parseJsonArray, parseSelectionDomainsFromSession, selectionGroupsFromDomains, WindowInstanceIdContext } from "../World3dHost/🟦️.tsx";
import { createDemandFrameScheduler, createFlowSession, createGraphSession, isFlowGraphScene, type FlowTask, type FlowWasmSession } from "../WasmSessionLoader/🟦️.tsx";
import { useAppKeybindingsByActionId, useMapContextMenuSpecs } from "../ShellHost/🟦️.tsx";
import { useUIFindSafe } from "../ShellSearch/🟦️.tsx";
// #endregion 🔌️Adapters
