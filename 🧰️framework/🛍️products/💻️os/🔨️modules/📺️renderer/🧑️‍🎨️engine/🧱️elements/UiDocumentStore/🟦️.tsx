...
if (import.meta.vitest) {
  ...
  const { default: scalarTestsJson } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🔢️scalar/🧪️test/🔣️s.json");
  ...
  describe("TypedWire", () => {
    ...
    async function nativeInstanceFixture(sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const { ShardClient } = await import("../../../../../../../🔨️modules/🎭️actor/📦️packages/🟦️typescript/🧵️shard-client.ts"); const { encodeActorInstanceLifecycle } = await import("../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🟦️.ts");
      ...
      const { OwnedResidentLedger } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: residentFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧪️fixture.json");
    ...
    it("OwnedPagedAdmission roots the actual field builder before exposure and cancels abandoned input under the shared owner grant", async () => {
      const { OwnedUiOperationPayloadBuilder, OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json"); const { default: evidence } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture.json"); const { default: cancellation } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture.json"); const { default: scopes } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture.json");
    ...
    it("OwnedPagedAdmission keeps rejected binding and source release failures owned and separates terminal child work from parent release", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json"); const { native, pool, scope, payload, builder, evidenceFixture: evidence } = await residentEvidenceFixture(); const foreign = await residentBuilderFixture(); const before = pool.usage;
    ...
    it("OwnedPagedCopy copies the genuine first fragment into admitted fixed pages and strongly owns the sequential reader", async () => {
      const { Buffer } = await import("node:buffer"); const { default: copied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture.json"); const { default: cancellation } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json"); const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { native, payload, builder, reader, actual, pool, evidenceFixture: evidence, readerFixture: readers, fixture: payloadFixture, pageFixture: pages } = await residentCopiedRangeFixture(); const baseline = pool.usage;
    ...
    it("OwnedPagedFault preserves child refusal and raw over-grant accounting without advancing the producer", async () => {
      const { OwnedUiResidentPage } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️fixture.json");
    ...
    it("OwnedPagedFault retains a registered reader after an exact page read throws without skipping the failed byte", async () => {
      const { OwnedResidentReader, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: readers } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture.json"); const { native, pool, payload, builder, binding } = await residentAuthoredWindowFixture(); let reader: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayloadReader | null = null;
    ...
    it("OwnedPagedPartialFault cannot resume after a page write throws before or after mutation", async () => {
      const { OwnedUiResidentPage } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️fixture.json");
    ...
    it("OwnedPagedCancel retains every first-fragment cancellation prefix and distinguishes copied from detached input", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️fixture.json"); const { default: readers } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture.json"); const { default: binding } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json"); const { default: evidence } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture.json"); const { default: copied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json"); const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedPagedContinuation preserves source child faults and separates terminal work from readiness", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️fixture.json"); const { default: copied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture.json");
    ...
    it("OwnedResidentReaderConstructor keeps the preinstalled reader and exact finalization fault charged", async () => {
      const { OwnedUiResidentPayloadReader } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture.json"); const { payload, builder, pool } = await residentBuilderFixture();
    ...
    it("OwnedResidentScope admits its original native lifetime through the parent-funded slot and retires exact registrations", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture.json");
    ...
    it("OwnedResidentScope cancels every admitted prefix through its original parent slot", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture.json");
    ...
    it("OwnedResidentScope retains exact installed shells and first faults across constructor and handoff failures", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture.json");
    ...
    it("OwnedResidentScope serializes transitions without conflating independent native lifetimes", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { encodeActorInstanceLifecycle } = await import("../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture.json");
    ...
    it("OwnedResidentScope retains before-and-after canonical admission wrapper faults without a false pending close", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedResidentLedger, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture.json");
    ...
    async function residentPayloadFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture.json"); const { default: scopes } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture.json");
    ...
    async function residentBuilderFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const base = await residentPayloadFixture(fixtureIndex, sharedLedger); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: builderFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json"); const { default: evidenceFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture.json");
    ...
    it("OwnedResidentPayloadAdmission admits an exact captured field in separate grants and waits for two-way source retirement", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentPayload } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture.json"); const { default: scopes } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture.json");
...
it("OwnedResidentPageBinding keeps the original page in its builder until parent-authorized detachment", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️schema.json"); const { default: contract } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧬️contract.json"); const { default: domain } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧬️schema.json"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(ajv.validate(domain, contract)).toBe(true);
...
it("OwnedResidentPageBindingFault retains original install and detach wrapper failures without refund", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json");
...
it("OwnedResidentPageBindingChild preserves refusal and separates terminal child work from observation", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json");
...
it("OwnedResidentPageProducerFault retains the exact read or write fault without replaying an offset", async () => {
      const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedUiResidentPage } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json");
    ...
    async function residentPageFixture() {
      const base = await residentBuilderFixture(); const { default: pageFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json"); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentPageChild preserves exact child refusal and terminal grant before parent observation", async () => {
      const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json");
    ...
    it("OwnedResidentPageFault retains exact constructor and admission wrapper failures in the original parent cell", async () => {
      const { OwnedResidentLedger, OwnedResidentOwner, OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { OwnedUiResidentPage } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json");
      for (const row of fixture.faults) {
    ...
    it("OwnedResidentPageBodyFault never retries past a before or after mutation failure", async () => {
      const { OwnedResidentPage, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json");
...
it("OwnedResidentReaderPageFence invalidates the exact sealed page when the reader captures retirement", async () => {
      const { payload, builder, reader, readerFixture: fixture } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json"); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
...
it("OwnedResidentReaderInventory matches the exact state facade witness and existing parent words", async () => {
    ...
    it("OwnedResidentReaderBindingFault keeps exact before and after detachment failures charged", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture.json");
    ...
    it("OwnedResidentReaderBindingGrant forwards child refusal and terminal work before separate observation", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture.json");
...
it("OwnedResidentReaderRevocation preserves the original read alias and parent close after operations revoke", async () => {
      const { payload, builder, reader, pool, native, readerFixture: fixture } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json"); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    async function residentReaderFixture(fixtureIndex = 2) {
      const base = await residentBuilderFixture(fixtureIndex); const { default: readerFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture.json"); let reader: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayloadReader | null = null;
    ...
    it("OwnedResidentReaderHeld preserves original handle identity throughout its admitted read phases", async () => {
      const { payload, builder, reader, pageFixture: pages, page } = await (async () => { const base = await residentReaderFixture(); const { default: pageFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json"); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null; for (const bytes of [...pageFixture.storageOwnerGrants, ...pageFixture.admissionGrants]) page = base.payload.beginPage(base.builder, 1, { maxItems: 1, maxBytes: bytes }).page; if (!page) throw new Error("Missing held-reader page"); return { ...base, page, pageFixture }; })();
    ...
    it("OwnedResidentReaderBodyFault preserves original alias and byte offset after read or detach wrapper failure", async () => {
      const { OwnedResidentReader, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture.json");
      for (const row of fixture.bodyFaults) {
    ...
    it("OwnedResidentBuilderCancellation retires every prefix through the exact source binding", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts");
      for (const prefix of fixture.prefixes) {
    ...
    it("OwnedResidentCopiedFault retains exact source-advance wrapper exceptions before or after the original byte", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture.json"); const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts");
    ...
    it("OwnedResidentActiveInputCancellation detaches the captured input before admitting its exact cancelled evidence", async () => {
      ...
      const { OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json");
    ...
    it("OwnedResidentEvidenceBrands exposes only exact private release predicates", async () => {
      const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️schema.json"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(fixture.records.reduce((sum, row) => sum + 16n + 8n * BigInt(row.fields), 0n)).toBe(BigInt(fixture.domain.bytes)); let reads = 0; const hostile = new Proxy({}, { get() { reads++; throw new Error("Untrusted evidence read"); } });
    ...
    it("OwnedResidentEvidenceAdmission registers original cancellation evidence before source release", async () => {
      const { OwnedUiOperationPayloadBuilder, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: builderFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json"); const { default: evidenceFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture.json");
    ...
    it("OwnedResidentEvidenceCancellation retires every admitted prefix without replacing the original token", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts");
    ...
    it("OwnedResidentEvidenceSourceFault keeps exact before and after mutation faults under the original cell", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture.json");
    ...
    it("OwnedResidentEvidenceFault retains the installed token shell, capsule and exact original fault", async () => {
      const { OwnedUiOperationInputCancelled, OwnedUiOperationInputCopied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture.json");
      for (const frontier of fixture.faults) {
    ...
    it("OwnedResidentBuilderBindingChild forwards source refusal and terminal full-grant work without a same-turn observation", async () => {
      const { OwnedUiResidentBuilderRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json");
    ...
    it("OwnedResidentBuilderBindingFault retains exact before and after source-mutation faults without refund", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json");
    ...
    it("OwnedResidentBuilderBindingBrands requires the original privately phased body and source witness", async () => {
      const resident = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture.json"); const witness: unknown = Reflect.get(resident, "OwnedUiResidentBuilderRetirement"); expect(typeof witness).toBe("function"); if (typeof witness !== "function") throw new Error("Missing original builder witness"); let reads = 0; const hostile = new Proxy({}, { get() { reads++; throw new Error("Forged builder binding read"); } });
    ...
    it("OwnedResidentPayloadFault retains exact source-install and finalizer faults under the original charged cell", async () => {
      const { OwnedUiResidentPayload, OwnedUiResidentPayloadSourceRelease } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture.json");
      for (const frontier of fixture.constructionFaults) {
