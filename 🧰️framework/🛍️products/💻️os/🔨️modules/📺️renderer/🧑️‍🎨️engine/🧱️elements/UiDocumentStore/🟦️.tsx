...
if (import.meta.vitest) {
  ...
  const { RetainedUiWireValueCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🟦️.ts");
  ...
  const { default: scalarReaderFixtureRaw } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json?raw");
  const { default: scalarPageFixtureRaw } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json?raw");
  ...
  describe("TypedWire", () => {
    //#region 🔢️ScalarSourceOracles
    {
      ...
      const scalarChildSources: Readonly<Record<string, Uint8Array>> = {
       "🧰️framework/🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json": new TextEncoder().encode(scalarReaderFixtureRaw),
       "🧰️framework/🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json": new TextEncoder().encode(scalarPageFixtureRaw),
      };
      //#endregion
    ...
    async function nativeInstanceFixture(sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const { ShardClient } = await import("../../../../../../../🔨️modules/🎭️actor/📦️packages/🟦️typescript/🟦️"); const { encodeActorInstanceLifecycle } = await import("../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🟦️.ts");
      const { encodeActorUiPatchReceipt } = await import("../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🩹️patch/🟦️.ts"); let nativePatchSequence = 50n;
      class Worker {
      ...
      const { OwnedResidentLedger } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: residentFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧪️fixture/🔣️.json");
    ...
    async function nativePagedFieldFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const native = await nativeInstanceFixture(sharedLedger); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedKernelReturnContent } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { encodeActorReturnResult } = await import("../../../../../../../🔨️modules/🎭️actor/📤️return/🟦️.ts"); const { createActorBytePage } = await import("../../../../../../../🔨️modules/🎭️actor/📄️page/🟦️.ts"); const { encodeActorUiPatchReceipt } = await import("../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🩹️patch/🟦️.ts"); const { Buffer } = await import("node:buffer");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️fixture/🔣️.json"); const row = fixture.valid[fixtureIndex]!; const payload = Buffer.from(Array.from({ length: Number(row.declaredBytes) }, (_, i) => (73 * i + 19) & 255));
    ...
    it("OwnedPagedPayloadSchema admits only exact canonical u64 field lengths", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️fixture/🔣️.json"); const { default: fixtureSchema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️schema/🔣️.json"); const { default: domain } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧬️schema.json"); const { default: words } = await import("../../../../../../../🔨️modules/🎭️actor/📄️page/🧬️schema.json"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedPagedInputBrands rejects structural builders and forged copied or cancelled evidence", async () => {
      const { OwnedUiOperationPayloadBuilder, OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts");
    ...
    it("OwnedPagedAdmission roots the actual field builder before exposure and cancels abandoned input under the shared owner grant", async () => {
      const { OwnedUiOperationPayloadBuilder, OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { default: evidence } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture/🔣️.json"); const { default: cancellation } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture/🔣️.json"); const { default: scopes } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json");
      const { native, pool, scope, fixture, baseline } = await residentPayloadFixture(); let payload: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null; for (const bytes of fixture.admissionBytes) payload = scope.beginPayload(native.field, { maxItems: 1, maxBytes: bytes }).payload; if (!payload) throw new Error("Missing admitted payload"); const before = pool.usage;
      ...
      let builder: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationPayloadBuilder | null = null;
    ...
    it("OwnedPagedAdmission keeps rejected binding and source release failures owned and separates terminal child work from parent release", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { native, pool, scope, payload, builder, evidenceFixture: evidence } = await residentEvidenceFixture(); const foreign = await residentBuilderFixture(); const before = pool.usage;
    ...
    async function residentAuthoredWindowFixture() {
      const base = await residentBuilderFixture(); const { default: binding } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); expect(base.builder.advance({ maxItems: 1, maxBytes: binding.producer.fragmentCapture })).toMatchObject({ kind: "pending", bytes: binding.producer.fragmentCapture });
    ...
    it("OwnedPagedCopy copies the genuine first fragment into admitted fixed pages and strongly owns the sequential reader", async () => {
      const { Buffer } = await import("node:buffer"); const { default: copied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json"); const { default: cancellation } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture/🔣️.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { native, payload, builder, reader, actual, pool, evidenceFixture: evidence, readerFixture: readers, fixture: payloadFixture, pageFixture: pages } = await residentCopiedRangeFixture(); const baseline = pool.usage;
    ...
    it("OwnedPagedFault retains a registered reader after an exact page read throws without skipping the failed byte", async () => {
      const { OwnedResidentReader, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: readers } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { native, pool, payload, builder, binding } = await residentAuthoredWindowFixture(); let reader: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayloadReader | null = null;
    ...
    async function residentAuthoredClosePayload(base: Awaited<ReturnType<typeof residentBuilderFixture>>) {
      const { default: readers } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: binding } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { default: cancellation } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture/🔣️.json"); const maximum = readers.admissionGrants.length + readers.closing.grants.length + readers.aliasCloseGrants.length + binding.admissionGrants.length + binding.closeGrants.length + base.evidenceFixture.grants.length + base.evidenceFixture.retirement.grants.length + base.evidenceFixture.retirement.registrationGrants.length + builders.bindingGrants.length + base.fixture.sourceReleaseTurns.length + cancellation.closeBound.payloadRegistrationGrants.length + cancellation.closeBound.storageGrants.length + cancellation.closeBound.inputDetachGrants.length;
    ...
    it("OwnedPagedCancel retains every first-fragment cancellation prefix and distinguishes copied from detached input", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️fixture/🔣️.json"); const { default: readers } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: binding } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { default: evidence } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture/🔣️.json"); const { default: copied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedPagedContinuation completes only after the original field consumes its released range", async () => {
      const { default: copied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json"); const { builder, reader, native, evidenceFixture: evidence } = await residentAuthoredSourceFixture(); let consumed = 0;
    ...
    it("OwnedPagedContinuation preserves source child faults and separates terminal work from readiness", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🧪️fixture/🔣️.json"); const { default: copied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentReaderConstructor keeps the preinstalled reader and exact finalization fault charged", async () => {
      ...
      expect(builder.beginRead(grant).step.kind).toBe("rejected"); const retained: unknown[] = []; const retain = OwnedResidentAdmission.prototype.retainFailure; const observe = vi.spyOn(OwnedResidentAdmission.prototype, "retainFailure").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentAdmission, error, budget) { retained.push(error); return retain.call(this, error, budget); }); try { payload.beginClose(); expect(payload.closeStep(grant).kind).toBe("pending"); expect(payload.closeStep(grant).kind).toBe("rejected"); } finally { observe.mockRestore(); }
    ...
    it("OwnedPagedBoundary defers exact source completion metadata until after a full-grant child turn", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: copied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json"); const { builder, native } = await residentAuthoredSourceFixture(); for (let index = 0; index < native.payload.length - 1; index++) { builder.advance({ maxItems: 1, maxBytes: copied.sourceStepBytes }); builder.advance({ maxItems: 1, maxBytes: copied.sourceObservationBytes }); }
    ...
    it("OwnedResidentPool reserves shared pages before allocation and returns credit only after final alias retirement", async () => {
      ...
      let x: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null; let y: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentPool preserves ownership on saturation, cancellation, forged handles and revoked operations", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentPage, OwnedUiResidentPayload, OwnedUiResidentInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedResidentLedger } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: neutral } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🧪️fixture/🔣️.json"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️resident.json"); const { default: metadata } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); for (const invalid of fixture.invalidCapacities) expect(() => new OwnedResidentLedger(invalid)).toThrow(); for (const Type of [OwnedUiResidentPool, OwnedUiResidentPage, OwnedUiResidentPayload, OwnedUiResidentInstance]) expect(() => Reflect.construct(Type, [{}, {}])).toThrow();
    ...
    it("OwnedResidentPool roots abandoned reservations and delays the exact instance witness for live read aliases", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️resident.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { default: readers } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: scopes } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json"); const base = await residentBuilderFixture(); const { native, payload, builder, scope } = base; let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentSlotContract declares the funded parent handoff and immutable concurrent roster oracle", async () => {
      ...
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️schema/🔣️.json");
    ...
    it("OwnedResidentConstruction installs the original pool before fallible field construction and retains exact faults", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentPoolRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧪️fixture/🔣️.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json");
      for (const frontier of fixture.poolConstructionFaults) {
        ...
        type OwnedPool = import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPool;
    ...
    it("OwnedResidentScope admits its original native lifetime through the parent-funded slot and retires exact registrations", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json");
      const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json"); const native = await nativeInstanceFixture(); for (const bytes of composition.poolPreparation.prepareBytes) expect(native.client.prepareUiResidentPool(native.residentLedger, { maxItems: 1, maxBytes: bytes }).kind).toBe("pending");
      ...
      let scope: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentInstance | null = null;
    ...
    it("OwnedResidentScope cancels every admitted prefix through its original parent slot", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentScope retains exact installed shells and first faults across constructor and handoff failures", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json");
      for (const frontier of fixture.constructionFaults) {
        ...
        const prefix = frontier.startsWith("owner") ? 7 : frontier.startsWith("binding") ? 8 : 6; for (const bytes of fixture.firstChild.prepareBytes.slice(0, prefix)) pool.bindInstance(owner, native.activation, native.lifetime, { maxItems: 1, maxBytes: bytes }); const before = native.residentLedger.usage; const fault = { frontier, bytes: Uint8Array.of(73) }; const originalInstall = OwnedResidentRecord.prototype.install; const originalAttach = OwnedUiInstance.prototype.attachResidentScope; const originalSet = WeakMap.prototype.set; const originalFreeze = Object.freeze; let originalScope: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentInstance | null = null;
        ...
        const retained: unknown[] = []; const retain = OwnedResidentAdmission.prototype.retainFailure; const probe = vi.spyOn(OwnedResidentAdmission.prototype, "retainFailure").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentAdmission, error, budget) { retained.push(error); return retain.call(this, error, budget); });
    ...
    it("OwnedResidentScope serializes transitions without conflating independent native lifetimes", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { encodeActorInstanceLifecycle } = await import("../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentScope retains before-and-after canonical admission wrapper faults without a false pending close", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedResidentLedger, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentComposition retains the exact prepared pool and separates metadata admission from construction and final refund", async () => {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { uiResidentMetadataEnvelope } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🟦️.ts");
      const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json"); const native = await nativeInstanceFixture(); const before = native.residentLedger.usage.data;
    ...
    async function residentPayloadFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const { OwnedUiResidentPool } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture/🔣️.json"); const { default: scopes } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json");
      ...
      let scope: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentInstance | null = null; for (const bytes of scopes.firstChild.prepareBytes) scope = pool.bindInstance(native.owner, native.activation, native.lifetime, { maxItems: 1, maxBytes: bytes }).scope; if (!scope) throw new Error("Missing original scope");
      return { native, pool, scope, fixture, baseline };
    }
    async function residentBuilderFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const base = await residentPayloadFixture(fixtureIndex, sharedLedger); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: builderFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { default: evidenceFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture/🔣️.json");
      let payload: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null; for (const bytes of base.fixture.admissionBytes) payload = base.scope.beginPayload(base.native.field, { maxItems: 1, maxBytes: bytes }).payload; if (!payload) throw new Error("Missing original payload"); let builder: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationPayloadBuilder | null = null; for (const bytes of builderFixture.grants) builder = OwnedUiOperationPayloadBuilder.begin(base.native.owner, base.native.activation, base.native.lifetime, base.native.field, payload, { maxItems: 1, maxBytes: bytes }).builder; if (!builder) throw new Error("Missing original builder"); return { ...base, payload, builder, evidenceFixture };
    }
    ...
    it("OwnedResidentPayloadAdmission admits an exact captured field in separate grants and waits for two-way source retirement", async () => {
      const { OwnedUiResidentPool, OwnedUiResidentPayload } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture/🔣️.json"); const { default: scopes } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📨️slot/🧪️fixture/🔣️.json"); const { default: composition } = await import("../../../../../../../🔨️modules/🎭️actor/🏘️composition/🧪️fixture/🔣️.json");
      ...
      let payload: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null;
    ...
    it("OwnedResidentPayloadSettledField rejects the original settled field before another admission", async () => {
      const { native, pool, scope, fixture } = await residentPayloadFixture(); let payload: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null;
...
it("OwnedResidentPageBinding keeps the original page in its builder until parent-authorized detachment", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️schema/🔣️.json"); const { default: contract } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧬️contract.json"); const { default: domain } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧬️schema.json"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(ajv.validate(domain, contract)).toBe(true);
...
it("OwnedResidentPageProducer admits its original page through the shared parent before allocation", async () => {
      const { builder, payload, pool, reader } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { default: binding } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const before = pool.usage; expect(builder.advance(grant)).toMatchObject({ kind: "pending", bytes: 128 });
...
it("OwnedResidentPageProducerWindow copies two original windows with separate scalar grants before source EOF", async () => {
      const { payload, builder, reader, pool, native, readerFixture: readers } = await residentReaderFixture(); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { Buffer } = await import("node:buffer"); const before = pool.usage; const actual: number[] = []; const work = fixture.producer;
...
it("OwnedResidentPageBindingFault retains original install and detach wrapper failures without refund", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json");
      for (const row of fixture.faults) {
        const { payload, builder, pool } = await residentBuilderFixture(); const count = row.method === "install" ? fixture.admissionPhases.indexOf("builder-install") : fixture.admissionGrants.length; let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null; for (const bytes of [...pages.storageOwnerGrants, ...fixture.admissionGrants.slice(0, count)]) page = payload.beginPage(builder, 1, { maxItems: 1, maxBytes: bytes }).page; const held = pool.usage; if (row.method === "detach") { if (!page) throw new Error("Missing original binding page"); expect(payload.closePage(page, grant).kind).toBe("pending"); }
...
it("OwnedResidentPageBindingChild preserves refusal and separates terminal child work from observation", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json");
      for (const method of ["install", "detach"] as const) for (const row of fixture.childResults) {
        const { payload, builder, pool } = await residentBuilderFixture(); const count = method === "install" ? fixture.admissionPhases.indexOf("builder-install") : fixture.admissionGrants.length; let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null; for (const bytes of [...pages.storageOwnerGrants, ...fixture.admissionGrants.slice(0, count)]) page = payload.beginPage(builder, 1, { maxItems: 1, maxBytes: bytes }).page; if (method === "detach") { if (!page) throw new Error("Missing child page"); payload.closePage(page, grant); } const held = pool.usage; const install = OwnedUiOperationPayloadBuilder.installPage; const detach = OwnedUiOperationPayloadBuilder.detachPage; const current = () => method === "install" ? payload.beginPage(builder, 1, grant).step : payload.closePage(page!, grant);
...
it("OwnedResidentPageProducerFault retains the exact read or write fault without replaying an offset", async () => {
      const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedUiResidentPage } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentPageAdmission charges the original storage owner and complete fixed page before allocation", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️schema/🔣️.json"); const { default: Ajv } = await import("ajv"); const { Buffer } = await import("node:buffer"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(48n + 8n * BigInt(fixture.stateFields.length + fixture.facadeFields.length + fixture.witnessFields.length)).toBe(BigInt(fixture.domain.bytes));
      for (const length of fixture.lengths) {
        ...
        let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentPageRetirement preserves zero-grant authority and refunds each original alias separately", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️schema/🔣️.json"); const { default: Ajv } = await import("ajv"); expect(new Ajv({ strict: true }).validate(schema, fixture)).toBe(true);
      for (const length of fixture.lengths) for (const allocated of [false, true]) {
        ...
        let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null; for (const bytes of [...fixture.storageOwnerGrants, ...fixture.admissionGrants]) page = payload.beginPage(builder, length, { maxItems: 1, maxBytes: bytes }).page; if (!page) throw new Error("Missing admitted page");
    ...
    it("OwnedResidentPageCancellation closes every original owner and page admission prefix through its payload", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { default: builderFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json");
    ...
    async function residentPageFixture() {
      const base = await residentBuilderFixture(); const { default: pageFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentPageQuarantine retains parent faults across direct page calls and exact close", async () => {
      const { OwnedResidentPage, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { payload, page, pool, pageFixture } = await residentPageFixture(); const held = pool.usage; const fault = Object.freeze({ backing: Uint8Array.of(73) });
    ...
    it("OwnedResidentPageChild preserves exact child refusal and terminal grant before parent observation", async () => {
      const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json");
      for (const row of fixture.childResults) {
        ...
        const original = OwnedResidentAdmission.prototype.closeStep; const probe = vi.spyOn(OwnedResidentAdmission.prototype, "closeStep").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentAdmission, budget) { if (row.actual) expect(original.call(this, budget).kind).toBe("complete"); return { kind: row.kind === "complete" ? "complete" : row.kind === "blocked" ? "blocked" : "rejected", phase: "private-page-child", items: row.bytes ? 1 : 0, bytes: row.bytes }; });
    ...
    it("OwnedResidentPageFault retains exact constructor and admission wrapper failures in the original parent cell", async () => {
      const { OwnedResidentLedger, OwnedResidentOwner, OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { OwnedUiResidentPage } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json");
      for (const row of fixture.faults) {
        ...
        const probe = row.method === "record-install" ? vi.spyOn(OwnedResidentRecord.prototype, "install").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentRecord, shell, budget) { if (row.after) install.call(this, shell, budget); throw fault; }) : row.method === "storage-prepare" ? vi.spyOn(OwnedResidentLedger.prototype, "prepareAdmission").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger, consumer, partition, budget) { if (row.after) prepare.call(this, consumer, partition, budget); throw fault; }) : row.method === "storage-claim" ? vi.spyOn(OwnedResidentLedger.prototype, "claimAdmission").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger, consumer, cell, budget) { if (row.after) claim.call(this, consumer, cell, budget); throw fault; }) : row.method === "storage-reserve" ? vi.spyOn(OwnedResidentOwner.prototype, "reservePage").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentOwner, length, cell, budget) { if (row.after) reserve.call(this, length, cell, budget); throw fault; }) : null;
    ...
    it("OwnedResidentPageBodyFault never retries past a before or after mutation failure", async () => {
      const { OwnedResidentPage, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json");
      for (const row of fixture.bodyFaults) {
        ...
        const probe = row.method === "allocate" ? vi.spyOn(OwnedResidentPage.prototype, "allocate").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentPage, budget) { if (row.after) expect(allocate.call(this, budget).kind).toBe("ready"); throw fault; }) : vi.spyOn(OwnedResidentPage.prototype, "writeByte").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentPage, value, budget) { if (row.after) expect(write.call(this, value, budget).kind).toBe("pending"); throw fault; });
    ...
    it("OwnedResidentPageInventory matches actual fixed fields and the shared metadata envelope", async () => {
      const ts = await import("typescript"); const { readFileSync } = await import("node:fs"); const { resolve } = await import("node:path"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { default: payloadFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture/🔣️.json"); const { uiResidentMetadataEnvelope } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🟦️.ts");
      const source = ts.createSourceFile("resident.ts", readFileSync(resolve(process.cwd(), "../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"), "utf8"), ts.ScriptTarget.Latest, true);
...
it("OwnedResidentReaderPageFence invalidates the exact sealed page when the reader captures retirement", async () => {
      const { payload, builder, reader, readerFixture: fixture } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
...
it("OwnedResidentReaderInventory matches the exact state facade witness and existing parent words", async () => {
      const ts = await import("typescript"); const { readFileSync } = await import("node:fs"); const { resolve } = await import("node:path"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: payloadFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture/🔣️.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { uiResidentMetadataEnvelope } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🟦️.ts");
      const root = "../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/"; const source = ts.createSourceFile("resident.ts", readFileSync(resolve(process.cwd(), root + "💾️resident/🟦️.ts"), "utf8"), ts.ScriptTarget.Latest, true); const builderSource = ts.createSourceFile("builder.ts", readFileSync(resolve(process.cwd(), root + "🩹️operations/📥️wire/📄️pages/🟦️.ts"), "utf8"), ts.ScriptTarget.Latest, true);
    ...
    it("OwnedResidentReaderBindingFault keeps exact before and after detachment failures charged", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json");
      for (const row of fixture.bindingFaults) {
        ...
        const retained: unknown[] = []; const retain = OwnedResidentAdmission.prototype.retainFailure; const capture = vi.spyOn(OwnedResidentAdmission.prototype, "retainFailure").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentAdmission, error, budget) { retained.push(error); return retain.call(this, error, budget); }); try { expect(payload.closeReader(reader, grant).kind).toBe("pending"); expect(payload.closeReader(reader, grant).kind).toBe("rejected"); } finally { capture.mockRestore(); } expect(retained).toEqual([fault]); expect(pool.usage).toEqual(held); expect(reader.terminalIsEmpty()).toBe(false); expect(reader.advance(grant).kind).toBe("rejected");
      }
    });
    it("OwnedResidentReaderBindingGrant forwards child refusal and terminal work before separate observation", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json");
...
it("OwnedResidentReaderRevocation preserves the original read alias and parent close after operations revoke", async () => {
      const { payload, builder, reader, pool, native, readerFixture: fixture } = await residentReaderFixture(); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null;
    ...
    it("OwnedResidentReaderQuarantine preserves the original parent failure across reads and binding close", async () => {
      const { OwnedResidentAdmission, OwnedResidentReader } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { payload, reader, pool, readerFixture: fixture } = await residentReaderFixture(); const held = pool.usage; const fault = Object.freeze({ backing: Uint8Array.of(73) });
    ...
    it("OwnedResidentReaderAdmission installs the exact reader before EOF without charging another page or owner", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️schema/🔣️.json"); const { default: Ajv } = await import("ajv"); expect(new Ajv({ strict: true }).validate(schema, fixture)).toBe(true);
      ...
      let reader: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayloadReader | null = null;
    ...
    async function residentReaderFixture(fixtureIndex = 2) {
      const base = await residentBuilderFixture(fixtureIndex); const { default: readerFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); let reader: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayloadReader | null = null;
    ...
    it("OwnedResidentReaderHeld preserves original handle identity throughout its admitted read phases", async () => {
      const { payload, builder, reader, pageFixture: pages, page } = await (async () => { const base = await residentReaderFixture(); const { default: pageFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null; for (const bytes of [...pageFixture.storageOwnerGrants, ...pageFixture.admissionGrants]) page = base.payload.beginPage(base.builder, 1, { maxItems: 1, maxBytes: bytes }).page; if (!page) throw new Error("Missing held-reader page"); return { ...base, page, pageFixture }; })();
    ...
    it("OwnedResidentReaderCancellation retires every admitted prefix under the exact original parent", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentReaderFault retains exact shell and binding failures without replacing the original admission", async () => {
      const { OwnedResidentRecord, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { OwnedUiResidentPayloadReader } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json");
      for (const row of fixture.faults) {
        ...
        const probe = row.method === "record-install" ? vi.spyOn(OwnedResidentRecord.prototype, "install").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentRecord, shell, budget) { if (row.after) install.call(this, shell, budget); throw fault; }) : row.method === "builder-install" ? vi.spyOn(OwnedUiOperationPayloadBuilder, "installReader").mockImplementation((builder, reader, resident, budget) => { if (row.after) expect(bind(builder, reader, resident, budget).kind).toBe("pending"); throw fault; }) : null;
    ...
    it("OwnedResidentReaderBodyFault preserves original alias and byte offset after read or detach wrapper failure", async () => {
      const { OwnedResidentReader, OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json");
      for (const row of fixture.bodyFaults) {
        const { payload, builder, reader, pool } = await residentReaderFixture(); let page: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPage | null = null; for (const bytes of [...pages.storageOwnerGrants, ...pages.admissionGrants]) page = payload.beginPage(builder, 1, { maxItems: 1, maxBytes: bytes }).page; if (!page) throw new Error("Missing fault page"); page.allocate(grant); page.writeByte(73, grant); page.seal(grant); reader.advance({ maxItems: 1, maxBytes: 64 }); for (const bytes of fixture.aliasGrants) reader.advance({ maxItems: 1, maxBytes: bytes });
        ...
        const probe = row.method === "read" ? vi.spyOn(OwnedResidentReader.prototype, "byteAt").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentReader, index) { offsets.push(index); if (row.after) expect(read.call(this, index)).toBe(73); throw fault; }) : vi.spyOn(OwnedResidentAdmission.prototype, "closeStep").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentAdmission, budget) { if (row.after) expect(close.call(this, budget)).toMatchObject({ kind: "pending", bytes: 136 }); throw fault; });
    ...
    it("OwnedResidentBuilderAdmission charges and registers the original builder before source binding and publication", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️schema/🔣️.json"); const { default: contract } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧬️contract.json"); const { default: contractSchema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧬️schema.json"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true, allErrors: true }); expect(ajv.validate(schema, fixture), ajv.errorsText()).toBe(true); expect(ajv.validate(contractSchema, contract), ajv.errorsText()).toBe(true);
      ...
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { native, pool, scope, fixture: payloadFixture } = await residentPayloadFixture(); let payload: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null; for (const bytes of payloadFixture.admissionBytes) payload = scope.beginPayload(native.field, { maxItems: 1, maxBytes: bytes }).payload; if (!payload) throw new Error("Missing original payload");
      const before = pool.usage; const begin = (maxBytes: number) => OwnedUiOperationPayloadBuilder.begin(native.owner, native.activation, native.lifetime, native.field, payload, { maxItems: 1, maxBytes }); expect(begin(0)).toMatchObject({ step: { kind: "blocked", bytes: 0 }, builder: null }); expect(pool.usage).toEqual(before); let builder: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationPayloadBuilder | null = null;
    ...
    it("OwnedResidentBuilderGrant preserves every phase when one byte short", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { native, pool, scope, fixture: payloadFixture } = await residentPayloadFixture(); let payload: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null;
    ...
    it("OwnedResidentBuilderCancellation retires every prefix through the exact source binding", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts");
      for (const prefix of fixture.prefixes) {
        const { native, pool, scope, fixture: payloadFixture } = await residentPayloadFixture(); const original = pool.usage; let payload: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null; for (const bytes of payloadFixture.admissionBytes) payload = scope.beginPayload(native.field, { maxItems: 1, maxBytes: bytes }).payload; if (!payload) throw new Error("Missing original payload");
    ...
    it("OwnedResidentBuilderFault retains original entry, install, source and finalizer failures", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission, OwnedResidentRecord } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts");
    ...
    it("OwnedResidentBuilderInventory matches actual compiler-parsed fields and the neutral metadata oracle", async () => {
      const ts = await import("typescript"); const { readFileSync } = await import("node:fs"); const { resolve } = await import("node:path"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { default: evidence } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture/🔣️.json"); const root = resolve(process.cwd(), "../../../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained");
      const pages = ts.createSourceFile("pages.ts", readFileSync(resolve(root, "🩹️operations/📥️wire/📄️pages/🟦️.ts"), "utf8"), ts.ScriptTarget.Latest, true); const resident = ts.createSourceFile("resident.ts", readFileSync(resolve(root, "💾️resident/🟦️.ts"), "utf8"), ts.ScriptTarget.Latest, true);
    ...
    async function residentCopiedRangeFixture() {
      const base = await residentReaderFixture(); const { default: binding } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { builder, reader, readerFixture: readers } = base; const actual: number[] = []; builder.advance({ maxItems: 1, maxBytes: binding.producer.fragmentCapture });
    ...
    it("OwnedResidentCopiedRange admits one original copied token and observes every real source byte before EOF", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️schema/🔣️.json"); const { default: contract } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧬️contract.json"); const { default: domain } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧬️schema.json"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(ajv.validate(domain, contract)).toBe(true); const { Buffer } = await import("node:buffer"); const { OwnedUiOperationInputCopied } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { builder, reader, native, payload, pool, actual, evidenceFixture: evidence } = await residentCopiedRangeFixture(); const baseline = pool.usage; expect(Buffer.from(actual)).toEqual(native.payload); expect(actual.length).toBe(fixture.length); expect(native.field.consumed).toBe(0n); expect(reader.advance(grant).kind).toBe("blocked");
    ...
    it("OwnedResidentCopiedCancellation preserves the same copied token without advancing source progress during close", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json"); const { default: cancellation } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture/🔣️.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts");
    ...
    it("OwnedResidentCopiedChild preserves source refusal and full-grant results before independent observation", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json"); const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts");
    ...
    it("OwnedResidentCopiedFault retains exact source-advance wrapper exceptions before or after the original byte", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/📋️copied/🧪️fixture/🔣️.json"); const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts");
    ...
    it("OwnedResidentActiveInputCancellation detaches the captured input before admitting its exact cancelled evidence", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️schema/🔣️.json"); const { default: contract } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧬️contract.json"); const { default: domain } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧬️schema.json"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(ajv.validate(domain, contract)).toBe(true);
      const { OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json");
      for (const revoked of fixture.revoked) {
        ...
        let token: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationInputCopied | import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationInputCancelled | null = null; for (const bytes of evidence.grants) { expect(payload.closeStep({ maxItems: 1, maxBytes: bytes })).toMatchObject({ kind: "pending", bytes }); } token = payload.beginEvidence(builder, grant).evidence; expect(OwnedUiOperationInputCancelled.matches(token, fragment, native.field, builder, fragment.offset, fragment.length)).toBe(true);
    ...
    it("OwnedResidentActiveInputWindows closes latched and written bytes behind the exact reader and page aliases", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture/🔣️.json"); const { default: binding } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🔗️binding/🧪️fixture/🔣️.json"); const { default: pages } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📄️page/🧪️fixture/🔣️.json"); const { default: readers } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📖️reader/🧪️fixture/🔣️.json"); const { default: builders } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts");
      for (const row of fixture.cases.filter(row => row.page)) for (const revoked of fixture.revoked) {
        const { payload, builder, native, pool, evidenceFixture: evidence, fixture: payloadFixture } = await residentBuilderFixture(); const baseline = pool.usage; let reader: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayloadReader | null = null; for (const bytes of readers.admissionGrants) reader = builder.beginRead({ maxItems: 1, maxBytes: bytes }).reader; if (!reader) throw new Error("Missing original reader"); builder.advance({ maxItems: 1, maxBytes: binding.producer.fragmentCapture }); for (const bytes of [...pages.storageOwnerGrants, ...binding.admissionGrants, binding.producer.pageObservation, binding.producer.allocation, binding.producer.allocationObservation]) expect(builder.advance({ maxItems: 1, maxBytes: bytes })).toMatchObject({ kind: "pending", bytes });
    ...
    it("OwnedResidentActiveInputFault preserves the original before and after detachment exception without source release", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🚫️cancellation/🧪️fixture/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts");
    ...
    it("OwnedResidentEvidenceBrands exposes only exact private release predicates", async () => {
      const { OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️schema/🔣️.json"); const { default: Ajv } = await import("ajv"); const ajv = new Ajv({ strict: true }); expect(ajv.validate(schema, fixture)).toBe(true); expect(fixture.records.reduce((sum, row) => sum + 16n + 8n * BigInt(row.fields), 0n)).toBe(BigInt(fixture.domain.bytes)); let reads = 0; const hostile = new Proxy({}, { get() { reads++; throw new Error("Untrusted evidence read"); } });
    ...
    it("OwnedResidentEvidenceAdmission registers original cancellation evidence before source release", async () => {
      const { OwnedUiOperationPayloadBuilder, OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { default: builderFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const { default: evidenceFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture/🔣️.json");
      const { native, pool, scope, fixture } = await residentPayloadFixture(); let payload: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts").OwnedUiResidentPayload | null = null; for (const bytes of fixture.admissionBytes) payload = scope.beginPayload(native.field, { maxItems: 1, maxBytes: bytes }).payload; if (!payload) throw new Error("Missing original payload"); let builder: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationPayloadBuilder | null = null; for (const bytes of builderFixture.grants) builder = OwnedUiOperationPayloadBuilder.begin(native.owner, native.activation, native.lifetime, native.field, payload, { maxItems: 1, maxBytes: bytes }).builder; if (!builder) throw new Error("Missing original builder");
      const baseline = pool.usage; const fragment = native.field.fragment; if (!fragment) throw new Error("Missing actual fragment"); builder.beginClose(); let evidence: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationInputCancelled | import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationInputCopied | null = null;
    ...
    it("OwnedResidentEvidenceRetirement separates original source settlement from exact registration refund", async () => {
      const { OwnedUiOperationInputCancelled } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputRelease, OwnedKernelReturnInputFragment, OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { payload, builder, pool, native, evidenceFixture: fixture } = await residentEvidenceFixture(); const baseline = pool.usage; let token: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationInputCancelled | import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationInputCopied | null = null;
    ...
    it("OwnedResidentEvidenceCancellation retires every admitted prefix without replacing the original token", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture/🔣️.json"); const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts");
      const { default: builderFixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentEvidenceQuarantine rejects direct child drive after the original payload holds a fault", async () => {
      const { OwnedUiOperationPayloadBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts"); const { OwnedKernelReturnInputFragment } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { payload, builder, pool, evidenceFixture: fixture } = await residentEvidenceFixture(); let token: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationInputCopied | import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/📄️pages/🟦️.ts").OwnedUiOperationInputCancelled | null = null; for (const bytes of fixture.grants) token = payload.beginEvidence(builder, { maxItems: 1, maxBytes: bytes }).evidence; if (!token) throw new Error("Missing original evidence"); for (let index = 0; index < fixture.parentQuarantine.prefix; index++) payload.advanceEvidence(builder, grant); const held = pool.usage; const fault = Object.freeze({ bytes: Uint8Array.of(73) }); payload.beginClose(); expect(payload.closeStep({ get maxItems(): number { throw fault; }, maxBytes: 4096 }).kind).toBe("rejected"); const probe = vi.spyOn(OwnedKernelReturnInputFragment.prototype, "release"); try { expect(OwnedUiOperationPayloadBuilder.advanceEvidence(token, builder, payload, grant).kind).toBe(fixture.parentQuarantine.kind); expect(probe).toHaveBeenCalledTimes(fixture.parentQuarantine.sourceReleaseCalls); } finally { probe.mockRestore(); } const retained: unknown[] = []; const retain = OwnedResidentAdmission.prototype.retainFailure; const capture = vi.spyOn(OwnedResidentAdmission.prototype, "retainFailure").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentAdmission, error, budget) { retained.push(error); return retain.call(this, error, budget); }); try { expect(payload.closeStep(grant).kind).toBe("pending"); expect(payload.closeStep(grant).kind).toBe("rejected"); } finally { capture.mockRestore(); } expect(retained).toEqual([fault]); expect(pool.usage).toEqual(produce(held, () => {}));
    });

    it("OwnedResidentEvidenceChild forwards exact source refusal and full-grant work before its own observation", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🧾️evidence/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentEvidenceFault retains the installed token shell, capsule and exact original fault", async () => {
      ...
      for (const frontier of fixture.faults) {
        ...
        const probe = frontier.name.startsWith("token-install") ? vi.spyOn(OwnedResidentRecord.prototype, "install").mockImplementation(function(this: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentRecord, shell, budget) { token = shell; for (const type of [OwnedUiOperationInputCopied, OwnedUiOperationInputCancelled]) { expect(type.matchesRelease(shell, hostile)).toBe(false); expect(type.matchesSourceDetached(shell, hostile)).toBe(false); expect(type.matches(shell, native.fragment, native.field, builder, native.fragment.offset, native.fragment.length)).toBe(false); } if (frontier.name.endsWith("after")) install.call(this, shell, budget); throw fault; }) : null;
    ...
    it("OwnedResidentBuilderBindingChild forwards source refusal and terminal full-grant work without a same-turn observation", async () => {
      const { OwnedUiResidentBuilderRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentBuilderBindingFault retains exact before and after source-mutation faults without refund", async () => {
      const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json");
    ...
    it("OwnedResidentBuilderBindingBrands requires the original privately phased body and source witness", async () => {
      const resident = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🏗️builder/🧪️fixture/🔣️.json"); const witness: unknown = Reflect.get(resident, "OwnedUiResidentBuilderRetirement"); expect(typeof witness).toBe("function"); if (typeof witness !== "function") throw new Error("Missing original builder witness"); let reads = 0; const hostile = new Proxy({}, { get() { reads++; throw new Error("Forged builder binding read"); } });
    ...
    it("OwnedResidentPayloadCancellation closes all admitted prefixes through the original parent slot", async () => {
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture/🔣️.json");
      for (const prefix of fixture.cancellationPrefixes) {
    ...
    it("OwnedResidentPayloadFault retains exact source-install and finalizer faults under the original charged cell", async () => {
      const { OwnedUiResidentPayload, OwnedUiResidentPayloadSourceRelease } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts"); const { OwnedKernelReturnInputField } = await import("../../../../../../../🔨️modules/🎠️kernel/📤️return/📦️content/📥️input/🟦️.ts"); const { OwnedResidentAdmission } = await import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture/🔣️.json");
      for (const frontier of fixture.constructionFaults) {
    ...
    it("OwnedResidentPayloadBrands rejects forged field, scope and two-way source release authority", async () => {
      const { OwnedUiResidentPayload, OwnedUiResidentPayloadSourceRelease } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🟦️.ts");
    ...
    it("OwnedResidentPayloadContract accounts each future parent slot and field-owned payload record before construction", async () => {
      const { default: domain } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧬️schema.json"); const { default: contract } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧬️contract.json"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️fixture/🔣️.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/📦️payload/🧪️schema/🔣️.json");
    ...
    it("OwnedResidentMetadata charges each schema-defined UI record envelope separately from neutral registration and backing", async () => {
      const { uiResidentMetadataEnvelope } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧪️fixture/🔣️.json");
      const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/💾️resident/🪪️metadata/🧪️schema/🔣️.json");
    ...
    it("OwnedInstanceMaintenance preserves child refusal and callback failure without losing the queued owner", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️instance-maintenance.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️instance-maintenance.schema.json");
    ...
    it("OwnedInstanceCloseAccounting preserves full-grant surface completion before separate wrapper release", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️instance-close.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️instance-close.schema.json"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedInstanceCloseAccounting issues input retirement separately from full-grant wire completion", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { OwnedUiWirePatchCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️instance-close.json");
    ...
    it("OwnedInstanceCloseAccounting retains lookup refusal diagnostics and its exact child for retry", async () => {
      const { OwnedUiInstance, OwnedUiSurfaceLookup } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️instance-close.json");
    ...
    it("OwnedSurfaceChild preserves private lookup and retirement refusal without losing retry ownership", async () => {
      const { OwnedUiSurface, OwnedUiSurfacePatch } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { OwnedUiSceneBindingIndexReader, OwnedUiSceneBindingIndexRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🔗️binding/🗂️index/🟦️.ts"); const { OwnedUiNodeIndexRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🗂️nodes/🟦️.ts");
      ...
      for (const layer of fixture.layers) for (const kind of fixture.refusals) {
        ...
        const refusal = (): import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🟦️.ts").RetainedUiWireStep => { hit = true; return { kind, phase: layer, items: 0, bytes: 0 }; };
    ...
    it("OwnedSurfaceChild keeps a full-grant reader completion separate from queue work and lease minting", async () => {
      const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { OwnedUiSceneBindingIndexReader } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🔗️binding/🗂️index/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️surface-child.json");
    ...
    it("OwnedSurfaceChild retains a throwing or over-grant private reader for cancellation", async () => {
      const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { OwnedUiSceneBindingIndexReader } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🔗️binding/🗂️index/🟦️.ts");
    ...
    it("normalizes all native component variants and defaults with strict neutral and Immer oracles", async () => {
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("TypedNodeFields retains seven direct fields without ancestor chains across repeated replacement", async () => {
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("OwnedNodeIndex captures exact readers across removal and closes final surface owners in bounded steps", async () => {
      const { OwnedUiNodeIndex } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🗂️nodes/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("OwnedOperation applies typed field owners and removes subtrees while preserving concurrent source snapshots", async () => {
      const { OwnedUiOperation, OwnedUiOperationCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/🟦️.ts");
      const { OwnedUiNodeIndex } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🗂️nodes/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("OwnedValidation preserves graph violation order, captured byte lifetimes and every cancellation frontier", async () => {
      const { OwnedUiValidationCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🛡️validation/🟦️.ts");
      const { OwnedUiNodeIndex } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🗂️nodes/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("OwnedHash streams exact insertion-ordered JSON bytes while retaining old surface owners through cancellation", async () => {
      const { OwnedUiSnapshotHashCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🔢️hash/🟦️.ts");
      const { OwnedUiNodeIndex } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🗂️nodes/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("ReadLease binds exact consumer commits, keeps stable snapshots and backpressures until retired roots are empty", async () => {
      const { OwnedUiNodeReadLease } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📖️read-lease/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("ReadLease React subscriptions own StrictMode remounts and independently acknowledge exact committed snapshots", async () => {
      const { useOwnedUiNode } = await import("./📖️owned/🟦️.tsx");
      const { OwnedUiNodeReadLease } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📖️read-lease/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🔣️fields.json");
      ...
      type Subscription = import("./📖️owned/🟦️.tsx").OwnedUiReadSubscription & { readonly lease: InstanceType<typeof OwnedUiNodeReadLease>; readonly notify: () => void };
      const active = new Set<Subscription>(); const closing: Subscription[] = []; const acknowledgements: number[] = [];
      const source: import("./📖️owned/🟦️.tsx").OwnedUiReadSource = {
    ...
    it("ReadLease source and node replacement reject stale layout acknowledgements while retaining detached owners", async () => {
      ...
      type Source = import("./📖️owned/🟦️.tsx").OwnedUiReadSource;
      type Subscription = import("./📖️owned/🟦️.tsx").OwnedUiReadSubscription & { readonly lease: InstanceType<typeof OwnedUiNodeReadLease> };
      const owners = () => {
    ...
    it("ReadPublication exposes all staged reads at one epoch and retains cancelled captures until bounded close", async () => {
      const { OwnedUiNodeReadLease, OwnedUiReadPublication, OwnedUiReadCommit } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📖️read-lease/🟦️.ts");
    ...
    it("OwnedScene prepares native tag vectors and long Unicode slices with strict neutral and Node oracles", async () => {
      const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("OwnedScene rejects malformed native packets and forged or rebound scene ownership without retiring the source", async () => {
      const { OwnedUiSceneCursor, OwnedUiSceneDocument, OwnedUiSceneReader, OwnedUiSceneRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️owned-scene.json");
    ...
    it("TypedScene validates all fifteen native schema roots and nested records without reconstructing source strings", async () => {
      const { OwnedUiSceneProjectionCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🟦️.ts");
      const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      ...
      const { default: catalogSchema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🔣️.schema.json");
      const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("TypedScene cancels every observed projection prefix while retaining the exact source and rejecting forged owners", async () => {
      const typedScene = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🟦️.ts");
      const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️typed-scene.json");
      const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("SceneTextBytes reads exact owned UTF-8 ranges without whole-text conversion and retires cancelled readers", async () => {
      const { OwnedUiSceneProjectionCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🟦️.ts"); const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts"); const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedSceneJson streams exact syntax from captured prepared UTF-8 with JSON.parse and Node Buffer oracles", async () => {
      const { OwnedUiSceneJsonCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🧩️json/🟦️.ts"); const { OwnedUiSceneProjectionCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🟦️.ts"); const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts"); const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedSceneJsonDocument publishes flat validated tokens with independent exact span and reader ownership", async () => {
      const { OwnedUiSceneJsonDocumentCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🧩️json/🧾️value/🟦️.ts"); const { OwnedUiSceneProjectionCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🟦️.ts"); const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts"); const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
      ...
      const { NumericIndexRetirement } = await import("../../../../../../../🔨️modules/🌱️value/🗂️ordered/🔢️numeric/🟦️.ts"); const terminal = create("0"); const originalAdvance = NumericIndexRetirement.prototype.advance; let injected = false;
    ...
    it("OwnedSceneJsonString projects selected exact string tokens into bounded UTF-16 pages", async () => {
      const { OwnedUiSceneJsonStringCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🧩️json/🔤️string/🟦️.ts"); const { OwnedUiSceneJsonDocumentCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🧩️json/🧾️value/🟦️.ts"); const { OwnedUiSceneProjectionCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🟦️.ts"); const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts"); const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedScenePackedField decodes captured base64 into independently retired pages with atob and Node Buffer oracles", async () => {
      const { OwnedUiSceneBase64Cursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🧩️pack/🔤️base64/🟦️.ts"); const { OwnedUiSceneProjectionCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🟦️.ts"); const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts"); const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedSceneGenericPack retains original symbols, map pairs and exact scalar spans with native-wire and Node oracles", async () => {
      const { OwnedUiGenericPackCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🧩️pack/🧾️value/🟦️.ts"); const { OwnedUiSceneBase64Cursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🧩️pack/🔤️base64/🟦️.ts"); const { OwnedUiSceneProjectionCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🧾️typed/🟦️.ts"); const { OwnedUiSceneCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🟦️.ts"); const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { encodePackValue, decodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
      ...
      const { NumericIndexRetirement, NumericIndexReader } = await import("../../../../../../../🔨️modules/🌱️value/🗂️ordered/🔢️numeric/🟦️.ts"); const terminal = create(Buffer.from("0001011112", "hex")); terminal.beginClose(); expect(terminal.closeStep(grant).phase).toBe("generic-pack-symbol-close");
    ...
    it("SceneBinding atomically owns the exact node and prepared scene or a surfaced diagnostic", async () => {
      const { OwnedUiSceneBindingCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🔗️binding/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("SceneBinding refuses forged typed source constructors before reading caller-owned roots", async () => {
      const { OwnedUiNode, OwnedUiPayload } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("SceneBindingIndex keeps paired roots through concurrent edit cancellation and insertion-order snapshots", async () => {
      const { OwnedUiNodeReadLease } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📖️read-lease/🟦️.ts");
      const { OwnedUiSceneBindingCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🔗️binding/🟦️.ts");
      const { OwnedUiSceneBindingIndex } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🎬️scene/🔗️binding/🗂️index/🟦️.ts");
      const { RetainedUiTypedCursor, OwnedUiNode } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️scene-binding.json");
      const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🔣️fields.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedSurfaceScene publishes node and prepared scene atomically and waits for issued scene children on close", async () => {
      const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts");
      const { OwnedUiOperation } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("OwnedSurfaceScene React effect cleanup queues exact children across source replacement and unmount", async () => {
      ...
      const { OwnedUiOperation } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { useOwnedUiScene } = await import("./📖️owned/🟦️.tsx");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️scene-binding.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🔣️fields.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
      ...
      const first = create(); const second = create(); const views: import("./📖️owned/🟦️.tsx").OwnedUiSceneEffectView[] = []; const readers: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📖️read-lease/🟦️.ts").OwnedUiSceneRecordView[] = []; let cleanups = 0;
      const consume = (view: import("./📖️owned/🟦️.tsx").OwnedUiSceneEffectView) => { views.push(view); const a = view.openRecord(); const b = view.openRecord(); expect(a).not.toBeNull(); expect(b).not.toBeNull(); expect(view.openRecord()).toBeNull(); readers.push(a!, b!); return () => { cleanups++; }; };
    ...
    it("OwnedNativeChild preserves decode refusal and raw over-grant work through both operation layers", async () => {
      const { OwnedUiWireOperationCursor, OwnedUiWirePatchCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts");
      const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts");
      ...
      for (const layer of ["operation-decode", "stream-decode"]) for (const kind of fixture.refusals) for (const bytes of [0, fixture.overGrantBytes]) {
        const current: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🟦️.ts").RetainedUiWireStep = { kind: kind === "blocked" ? "blocked" : "rejected", phase: layer, items: bytes ? 1 : 0, bytes };
    ...
    it("OwnedNativeChild preserves exact close refusal without unlinking real payload and decoder owners", async () => {
      const { OwnedUiWireOperationCursor, OwnedUiWirePatchCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { RetainedUiTypedCursor, UiPayloadRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
      const { OwnedUiOperationRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️native-child.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); const deepStrictEqual: typeof import("node:assert").deepStrictEqual = (await import("node:assert")).deepStrictEqual;
      for (const layer of fixture.layers.filter(value => !value.endsWith("decode"))) for (const kind of fixture.refusals) {
        const current: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🟦️.ts").RetainedUiWireStep = { kind: kind === "blocked" ? "blocked" : "rejected", phase: layer, items: 0, bytes: 0 };
    ...
    it("OwnedNativeChild separates terminal full-grant work and retains thrown close ownership", async () => {
      const { OwnedUiWireOperationCursor, OwnedUiWirePatchCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { RetainedUiTypedCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️native-child.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
      for (const layer of fixture.terminalLayers) {
        ...
        const spy = layer === "decoder-close" ? vi.spyOn(RetainedUiTypedCursor.prototype, "closeStep").mockImplementation(function (this: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts").RetainedUiTypedCursor<"component">, budget) { const result = typed.call(this, budget); if (this.terminalIsEmpty()) { terminal = true; return { ...result, kind: "complete", items: 1, bytes: fixture.childBytes }; } return result; }) : vi.spyOn(OwnedUiWireOperationCursor.prototype, "closeStep").mockImplementation(function (this: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts").OwnedUiWireOperationCursor, budget) { const result = native.call(this, budget); if (this.terminalIsEmpty()) { terminal = true; return { ...result, kind: "complete", items: 1, bytes: fixture.childBytes }; } return result; });
    ...
    it("OwnedWireOperation consumes all eleven native tags into paired publication before its exact ACK", async () => {
      const { OwnedUiWireOperationCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts");
      const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts");
    ...
    it("OwnedWireOperation rejects hostile transport inputs before transfer and closes every admitted prefix", async () => {
      const { OwnedUiWireOperationCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts");
      const { RetainedUiChildIdsCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts");
    ...
    it("OwnedWireOperation transfers intrinsic buffer ownership without reading shadowed view metadata", async () => {
      const { OwnedUiWireOperationCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedWireOperation accepts intrinsic native fields from another realm at the public entry", async () => {
      const { OwnedUiWireOperationCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { runInNewContext } = await import("node:vm"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedWireOperation mint refuses arbitrary normalized roots before touching source getters", async () => {
      const { OwnedUiOperation, OwnedUiOperationRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/🟦️.ts");
    ...
    it("OwnedWireOperation stream retains one exact ordinal through close and preserves committed late-cancel ACK", async () => {
      const { OwnedUiWirePatchCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { OwnedUiSurface } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedWireOperation native retirement closes known fields without claiming unknown wrapper ownership", async () => {
      const { OwnedUiWireOperationCursor } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🩹️operations/📥️wire/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { Buffer } = await import("node:buffer");
    ...
    it("OwnedRootSource renders exact native roots through independent consumers and retains close until unmount", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { useOwnedUiView, useOwnedUiNode } = await import("./📖️owned/🟦️.tsx");
    ...
    it("OwnedIntake retains one lookup and exact native source until successful publication receipt", async () => {
      const { OwnedUiPatchIntake } = await import("./📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️intake.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️intake.schema.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedIntake cancellation retires each accepted prefix without closing the whole instance", async () => {
      const { OwnedUiPatchIntake } = await import("./📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️intake.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedIntake late cancellation preserves committed notification and ACK under the shared close driver", async () => {
      const { OwnedUiPatchIntake } = await import("./📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedIntake preserves an injected committed close rejection and its exact retained owner", async () => {
      const { OwnedUiPatchIntake } = await import("./📥️intake/🟦️.ts"); const { OwnedUiInstance, OwnedUiInstancePatch } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️intake-close-fault.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️intake-close-fault.schema.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
    ...
    it("OwnedIntake preserves failed notification ownership and permits exact consumer retry before later publication", async () => {
      const { OwnedUiPatchIntake } = await import("./📥️intake/🟦️.ts"); const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️intake-notification.json"); const { default: schema } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️intake-notification.schema.json"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os"); expect(new Ajv({ strict: true }).compile(schema)(fixture)).toBe(true);
      const native = await nativeInstanceFixture(); const { activation, lifetime } = native; const owner = new OwnedUiInstance(activation, lifetime, DEFAULT_UI_DOCUMENT_LIMITS, { usizeBits: 64 }); native.lease.bindHostRetirement(owner); const lookup = owner.beginSurfaceLookup(activation, lifetime, "window")!; expect(finish(lookup)).toBe("ready"); const surface = lookup.takeResult()!; close(lookup); const events: string[] = []; let fail = true;
      const subscription: import("./📖️owned/🟦️.tsx").OwnedUiReadSubscription = surface.subscribeNode(fields.root, () => { const snapshot = subscription.snapshot!; if (snapshot.version === 1 && fail) { fail = false; events.push("rejected"); throw new Error("Temporary consumer failure"); } events.push(String(snapshot.version)); surface.acknowledgeRead(subscription, snapshot); }); while (owner.maintenancePending) owner.advanceMaintenance(grant);
    ...
    it("OwnedInstance old patch facades cannot read or release a successor input receipt", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
    ...
    it("OwnedInstance acknowledgement token rejects forged roots without consulting public properties", async () => {
      const { OwnedUiPatchAcknowledgement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); let reads = 0; const source = Object.freeze({}); const forged = { get value() { reads++; throw new Error("Forged value access"); }, matches() { reads++; return true; } };
    ...
    it("OwnedInstance input-retirement token rejects forged ordinals and preserves cancelled exact source ownership", async () => {
      const { OwnedUiInstance, OwnedUiPatchInputRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { encodePackValue } = await import("@semio-tech/framework-os"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json");
    ...
    it("OwnedInstance retirement witness requires exact terminal descendants and transfers once after revocation", async () => {
      const { OwnedUiInstance, OwnedUiInstanceRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️instance-owner.json");
    ...
    it("OwnedInstance cancels one-cell lookups and rejects forged facades at the native name boundary", async () => {
      const { OwnedUiInstance, OwnedUiInstanceSurface, OwnedUiSurfaceLookup } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️instance-owner.json");
      ...
      const surfaces: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts").OwnedUiInstanceSurface[] = [];
    ...
    it("OwnedInstance binds native patch source to issued ACK and retries the exact pair after revocation", async () => {
      const { OwnedUiInstance, OwnedUiPatchAcknowledgement, OwnedUiInstanceRetirement } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const { default: fields } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🧪️fixtures/🔣️wire-operations.json"); const { encodePackValue } = await import("@semio-tech/framework-os");
      ...
      const { encodeActorInstanceLifecycle } = await import("../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🟦️.ts"); const accepted = { kind: "accepted" as const, lifetime, requestSequence: closeRequest.requestSequence, closeGeneration: 17n }; const retired = { ...accepted, kind: "retired" as const };
    ...
    it("OwnedInstance refuses the same native source on an independently owned same-lifetime surface", async () => {
      const { OwnedUiInstance } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🏘️instance/🟦️.ts"); const native = await nativeInstanceFixture(); const { activation, lifetime } = native;
    ...
    it("OwnedSurfaceMint refuses forged subscription detachment and private patch source access", async () => {
      const { OwnedUiSurface, OwnedUiSurfacePatch } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/🖼️surface/🟦️.ts");
    ...
    it("OwnedSurface React reads initialize incrementally and exact unmount releases the final published byte owner", async () => {
      ...
      let last: import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧾️typed/🟦️.ts").RetainedUiNodeRecord | undefined;
    ...
    it("OwnedSurface notifications use an exact cutoff across unsubscribe, reentrant subscribe and thrown callbacks", async () => {
      ...
      let late: import("./📖️owned/🟦️.tsx").OwnedUiReadSubscription | null = null;
    ...
    it("ReadLease aborted speculative rendering never creates a subscription owner", async () => {
      const { useOwnedUiNode } = await import("./📖️owned/🟦️.tsx"); const { render, cleanup } = await import("@testing-library/react"); const { Suspense, createElement } = await import("react");
      const subscribe = vi.fn(() => { throw new Error("Aborted render must not acquire a read lease"); });
      const source: import("./📖️owned/🟦️.tsx").OwnedUiReadSource = { subscribeNode: subscribe, acknowledgeRead: vi.fn(), unsubscribeNode: vi.fn() };
  ...
  describe("SurfaceBytePages", () => {
    it("matches Node Buffer at every native page boundary and preserves exact captured owners", async () => {
      const { UiSurfaceByteBuilder } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🔢️bytes/🟦️.ts");
    ...
    it("decodes the full native SurfaceDoc numeric-list wire into pages without changing ordinary UiValue bounds", async () => {
      const { UiSurfaceBytes } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🔢️bytes/🟦️.ts");
      const { default: fixture } = await import("../../../../../../../🔨️modules/🖱️ui/🧬️contract/🧵️retained/📦️wire/🧪️fixtures/🔣️surface-bytes.json");
      const { encodePackValue } = await import("@semio-tech/framework-os");
