...
if (import.meta.vitest) {
  ...
  describe("TypedWire", () => {
    ...
    async function nativeInstanceFixture(sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      const { ShardClient } = await import("../../../../../../../🔨️modules/🎭️actor/🧵️shard-client/🟦️.ts"); const { encodeActorInstanceLifecycle } = await import("../../../../../../../🔨️modules/🎭️actor/🚪️lifetime/🟦️.ts");
    ...
    async function nativePagedFieldFixture(fixtureIndex = 2, sharedLedger?: import("../../../../../../../🔨️modules/🌱️value/💾️resident/🟦️.ts").OwnedResidentLedger) {
      ...
      const owner = new OwnedUiInstance(native.activation, native.lifetime, DEFAULT_UI_DOCUMENT_LIMITS, { usizeBits: 64 }); native.lease.bindHostRetirement(owner); const { default: returnAdmission } = await import("../../../../../../../🔨️modules/🎭️actor/🪪️activation/📤️return/🏘️admission/🧪️fixture/🔣️.json"); let source: import("../../../../../../../🔨️modules/🎭️actor/🧵️shard-client/🟦️.ts").OwnedShardReturn | null = null;
