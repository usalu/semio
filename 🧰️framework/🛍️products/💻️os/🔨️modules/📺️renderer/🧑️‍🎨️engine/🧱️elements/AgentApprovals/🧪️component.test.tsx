// #region 🧲️Header
// 🎨️ framework/products/os/modules/renderer/engine/elements/AgentApprovals/component.test.tsx
/** @emoji 🧪️ `AgentApprovals` tests: the pure `parseApprovalSummary` fallback parser plus a
