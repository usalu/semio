// #region 🧲️Header
// 🎨️ framework/products/os/modules/renderer/engine/elements/AgentApprovals/component.tsx
/** @emoji ✅️ `AgentApprovals` — the `os.agent.approvals` human-in-the-loop dialog: lists parked
...
import { agentUiLabel, type PendingAgentApproval } from "../AgentBridge/🟦️.tsx";
