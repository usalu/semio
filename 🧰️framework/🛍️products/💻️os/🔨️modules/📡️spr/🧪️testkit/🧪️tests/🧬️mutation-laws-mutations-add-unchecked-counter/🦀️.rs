...
mod tests {
    ...
    fn direct_fixture_contract() {
        super::super::super::tests::assert_leaf::<AddUncheckedCounter>(2, CounterMutation::AddUncheckedCounter, include_str!("../🧬️mutation-laws/🧬️mutations/🐛️add-unchecked-counter/🔣️.json"));
    }
}
//#endregion 🧪️Contract
