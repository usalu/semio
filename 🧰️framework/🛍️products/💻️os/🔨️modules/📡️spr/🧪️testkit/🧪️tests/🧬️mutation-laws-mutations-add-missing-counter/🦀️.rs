...
mod tests {
    ...
    fn direct_fixture_contract() {
        super::super::super::tests::assert_leaf::<AddMissingCounter>(1, CounterMutation::AddMissingCounter, include_str!("../🧬️mutation-laws/🧬️mutations/🚫️add-missing-counter/🔣️.json"));
    }
}
//#endregion 🧪️Contract
