...
mod tests {
    ...
    fn direct_fixture_contract() {
        super::super::super::tests::assert_leaf::<AddRejectedCounter>(4, CounterMutation::AddRejectedCounter, include_str!("../🧬️mutation-laws/🧬️mutations/⛔️add-rejected-counter/🔣️.json"));
    }
}
//#endregion 🧪️Contract
