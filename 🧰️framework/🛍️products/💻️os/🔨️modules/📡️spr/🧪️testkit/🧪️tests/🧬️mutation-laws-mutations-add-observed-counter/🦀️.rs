...
mod tests {
    ...
    fn direct_fixture_contract() {
        super::super::super::tests::assert_leaf::<AddObservedCounter>(3, CounterMutation::AddObservedCounter, include_str!("../🧬️mutation-laws/🧬️mutations/👁️add-observed-counter/🔣️.json"));
    }
}
//#endregion 🧪️Contract
