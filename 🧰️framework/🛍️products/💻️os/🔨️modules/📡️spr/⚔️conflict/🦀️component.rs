...
impl ConflictId {
    ...
    pub fn new(kind: &ConflictKind, artifact_id: &crate::os_spr::ids::ArtifactId, mutation_ids: &[crate::os_spr::ids::MutationId], hlc: &crate::os_spr::ids::HybridLogicalTimestamp) -> Self {
...
pub enum ConflictKind {
    Quarantined { envelopes: Vec<crate::os_spr::MutationEnvelope> },
...
pub struct Conflict {
    ...
    pub actors: Vec<crate::os_spr::ids::ActorId>,
...
pub struct DispatchReport {
    pub policy: crate::os_spr::MergePolicy,
...
mod tests {
    ...
    fn hlc(actor: u64, physical_ms: u64) -> crate::os_spr::ids::HybridLogicalTimestamp {
        crate::os_spr::ids::HybridLogicalTimestamp::new(actor, physical_ms)
    }

    //#region 🔖️ConflictId
    #[test]
    fn conflict_id_is_deterministic_and_content_sensitive() {
        let artifact = crate::os_spr::ids::ArtifactId("doc-1".into());
        let ids = vec![crate::os_spr::ids::MutationId("op-2".into()), crate::os_spr::ids::MutationId("op-1".into())];
        let ids_reordered = vec![crate::os_spr::ids::MutationId("op-1".into()), crate::os_spr::ids::MutationId("op-2".into())];
        ...
        let different_artifact = ConflictId::new(&kind, &crate::os_spr::ids::ArtifactId("doc-2".into()), &ids, &stamp);
    ...
    fn dispatch_report_carries_worst_and_messages() {
        let report = DispatchReport {
            policy: crate::os_spr::MergePolicy::Vigilant,
            worst: Some(crate::os_dsl::Severity::Warning),
            messages: vec![crate::os_spr::MutationMessage::warn("mutation.clamped", "value clamped to range")],
        };
        assert_eq!(report.worst, Some(crate::os_dsl::Severity::Warning));
    ...
    fn merge_report_round_trips_through_serde() {
        let report = MergeReport {
            policy: crate::os_spr::MergePolicy::Normal,
            accepted: true,
            insertion_index: 3,
            replayed: vec![EditMessages { edit_id: "e1".into(), messages: vec![crate::os_spr::MutationMessage::info("mutation.cascade", "cascaded")] }],
            worst: Some(crate::os_dsl::Severity::Info),
            conflict: None,
        };
    ...
    fn conflict_kind_status_resolution_are_distinct() {
        ...
        let conflict = Conflict {
            ...
            messages: vec![crate::os_spr::MutationMessage::error("mutation.target-missing", "target missing")],
            actors: vec![crate::os_spr::ids::ActorId("actor-1".into())],
            timestamp: stamp,
        };
