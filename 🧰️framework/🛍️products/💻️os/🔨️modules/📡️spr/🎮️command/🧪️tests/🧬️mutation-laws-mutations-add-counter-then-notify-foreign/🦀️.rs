...
fn direct_counter_leaf_contract() {
    super::super::super::assert_counter_leaf_descriptor::<AddCounterThenNotifyForeign>(include_str!("../../🧫️fixtures/🧬️mutation-laws/🧬️mutations/🌐️add-counter-then-notify-foreign/🔣️.json"));
}
#[test]
