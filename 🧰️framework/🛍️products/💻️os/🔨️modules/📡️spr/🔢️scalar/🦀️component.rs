...
/// payload codecs. `out`/`input` follow `crate::os_pack::codec::ByteWriter`/`ByteReader` conventions exactly
/// (they take `&mut crate::os_pack::codec::ByteWriter` / `&mut crate::os_pack::codec::ByteReader<'_>` directly — no
/// reimplementation of the varint/byte primitives).
pub mod scalar {
    use crate::os_pack::codec::{ByteReader, ByteWriter, PackError};
    ...
    // Minimal-varint enforcement reuses crate::os_pack::codec::is_minimal_varint at Full verification.
}
//#endregion 🔖️Scalars
