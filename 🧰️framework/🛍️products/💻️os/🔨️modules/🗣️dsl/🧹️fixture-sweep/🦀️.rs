...
#[cfg(test)]
#[path = "🧪️tests/🔬️example-asset-discovery/🦀️.rs"]
...
#[cfg(test)]
#[path = "🧪️tests/🔬️pilot-resolve/🦀️.rs"]
mod pilot_resolve;
...
#[cfg(test)]
#[path = "🧪️tests/🔬️m5-auto-discovery/🦀️.rs"]
...
#[cfg(test)]
#[path = "🧪️tests/🔬️m5-soft-skip/🦀️.rs"]
mod m5_soft_skip;
...
#[cfg(test)]
#[path = "🧪️tests/🔬️m5-handcrafted-grammar-conformance/🦀️.rs"]
...
#[cfg(test)]
#[path = "🧪️tests/🔬️m5-handcrafted-protocol-conformance/🦀️.rs"]
...
#[cfg(test)]
#[path = "🧪️tests/🔬️m5-cross-artifact-rejection/🦀️.rs"]
...
#[cfg(test)]
#[path = "🧪️tests/🔬️m5-production-coverage/🦀️.rs"]
...
#[cfg(test)]
#[path = "🧪️tests/🔬️m5-semio-envelope-protocol/🦀️.rs"]
