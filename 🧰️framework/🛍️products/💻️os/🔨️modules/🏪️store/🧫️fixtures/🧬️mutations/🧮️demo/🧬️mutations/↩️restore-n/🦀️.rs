use super::{DemoDiff, DemoMutation, DemoSnapshot};
...
impl crate::os_spr::MutationKind<DemoSnapshot, DemoMutation> for RestoreN {
...
#[cfg(test)]
#[path = "../../../../../🧪️tests/🧪️fixture-demo-restore-n/🦀️.rs"]
mod tests;
