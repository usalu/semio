...
//#region ⚠️ Errors
/// 🚨️ Failure modes when adapting a DAG fixture into neural wire rows.
#[derive(Debug, thiserror::Error)]
pub enum NeuralDagError {
    /// 🧩️ The fixture document is not valid JSON.
...
/// 🌳️ Build a neural execution tree from compiled DAG wire rows.
...
/// 🌳️ Build wire rows from a DAG fixture JSON document.
