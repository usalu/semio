...
/// @emoji 📣️ One commit's live-query-relevant summary — `DocumentEngine::commit_log` accumulates
...
//#region 🔖️Hooks
/// @emoji 🛂️ The authorization seam `DocumentEngine::submit` calls once per envelope, before
...
impl DocumentEngine {
    ...
    // 🔒️ Mirrors `submit`'s ownership rationale above: `DocumentMessage::RunQuery` already owns
...
/// @emoji 📋️ What `DocumentEngine::open` did to materialize state — "initial ⊕ snapshot ⊕ WAL
