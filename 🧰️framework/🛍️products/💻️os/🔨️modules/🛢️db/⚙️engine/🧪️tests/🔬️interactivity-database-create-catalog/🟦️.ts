...
//#endregion 🔖️CreateDocumentCatalogCas`;
  ...
  const mutations: readonly [string, string][] = [
    ...
    ["finite-saturation-law-manual-fire", good.replace("release_held_create_catalog_worker; spent_submission_attempts", "pool.timer_wheel().fire_due(u64::MAX); spent_submission_attempts")],
    ["finite-saturation-law-adds-caller-fire", good.replace("release_held_create_catalog_worker; spent_submission_attempts", "release_held_create_catalog_worker; pool.timer_wheel().fire_due(u64::MAX); spent_submission_attempts")],
