use super::super::{ChangedNodeAbbreviation, DagDelta, DagDiff, DagMutation, DagSnapshot};
...
impl protocol::MutationKind<DagSnapshot, DagMutation> for ChangeNodeAbbreviation {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change node abbreviation {}", self.id), &format!("Knotenabkürzung {} ändern", self.id))
    }
