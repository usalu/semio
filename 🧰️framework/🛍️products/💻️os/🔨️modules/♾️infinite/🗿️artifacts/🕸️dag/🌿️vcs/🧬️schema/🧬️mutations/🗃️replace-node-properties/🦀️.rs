use super::super::{DagDelta, DagDiff, DagMutation, DagSnapshot, PropertyBag, ReplacedNodeProperties};
...
impl protocol::MutationKind<DagSnapshot, DagMutation> for ReplaceNodeProperties {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Replace node properties {}", self.id), &format!("Knoteneigenschaften {} ersetzen", self.id))
    }
