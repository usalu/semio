...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: "@semio-tech/framework-core", replacement: path.resolve(repoRoot, "./🧰️framework/📦️packages/🟦️typescript/📦️index.ts") },
      { find: "@semio-tech/framework-os-core", replacement: path.resolve(repoRoot, "./🧰️framework/🛍️products/💻️os/📦️packages/🟦️typescript/📦️index.ts") },
