...
_trampoline15.fnName = 'wasi:io/poll@0.2.9#poll';
...
_trampoline16.fnName = 'wasi:io/streams@0.2.9#checkWrite';
...
_trampoline17.fnName = 'wasi:io/streams@0.2.9#write';
...
_trampoline18.fnName = 'wasi:io/streams@0.2.9#blockingFlush';
...
_trampoline19.fnName = 'wasi:cli/environment@0.2.9#getEnvironment';
...
_trampoline20.fnName = 'wasi:cli/terminal-stdin@0.2.9#getTerminalStdin';
...
_trampoline21.fnName = 'wasi:cli/terminal-stdout@0.2.9#getTerminalStdout';
...
_trampoline22.fnName = 'wasi:cli/terminal-stderr@0.2.9#getTerminalStderr';
...
_trampoline23.fnName = 'wasi:clocks/wall-clock@0.2.9#now$1';
let exports2;
let postReturn0;
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./semio_s_plugin_flow_extension_math_component.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABFwRgAX8AYAN/f38AYAJ/fwBgBH9/f38AAkILAAEwAAAAATEAAQABMgACAAEzAAMAATQAAgABNQAAAAE2AAAAATcAAAABOAAAAAE5AAAACCRpbXBvcnRzAXABCgoJEAEAQQALCgABAgMEBQYHCAkALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI1Mi4w');
