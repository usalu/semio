...
// import keeps that ergonomics without re-exposing `crate::os_spr::Operation` on `vcs`'s own public API
// (dependents import `crate::os_spr::Operation` directly). `OperationDiff` is imported for its `apply`
