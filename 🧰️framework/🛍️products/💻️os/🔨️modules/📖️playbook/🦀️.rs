...
mod tests {
    ...
    fn fully_populated_block() -> PlaybookBlock {
        PlaybookBlock {
            ...
            params: Some(DslValue::Object(vec![("height".into(), DslValue::float(6.0)), ("nested".into(), DslValue::Object(vec![("a".into(), DslValue::Array(vec![DslValue::float(1.0), DslValue::float(2.0), DslValue::String("three\"quoted".into())]))]))])),
