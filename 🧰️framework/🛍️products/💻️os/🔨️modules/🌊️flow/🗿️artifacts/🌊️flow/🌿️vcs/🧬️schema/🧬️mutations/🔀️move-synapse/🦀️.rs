...
//#region 🎮️Behavior
impl MutationKind<FlowHostSnapshot, FlowMutation> for MoveSynapse {
    ...
    fn label(&self) -> crate::LocalizedLabel {
        crate::LocalizedLabel::native(&format!("Move synapse {}", self.id), &format!("Synapse {} verschieben", self.id))
    }
