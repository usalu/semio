...
fn flow_host_snapshot_to_dsl(host_snapshot: &FlowHostSnapshot) -> FlowHostSnapshotDsl {
    FlowHostSnapshotDsl {
...
fn flow_host_snapshot_dsl_to_host_snapshot(dsl: FlowHostSnapshotDsl) -> Result<FlowHostSnapshot, String> {
    Ok(FlowHostSnapshot {
        schema: dsl.schema,
        camera: dsl.camera,
