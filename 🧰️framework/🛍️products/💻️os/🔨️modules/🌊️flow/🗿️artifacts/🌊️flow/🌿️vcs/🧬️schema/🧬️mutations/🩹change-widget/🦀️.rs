...
use super::super::{FlowHostDocument, FlowDiff, FlowDelta, FlowCollectionDelta, FlowMutation, Widget};
...
//#region 🎮️Behavior
impl MutationKind<FlowHostDocument, FlowMutation> for ChangeWidget {
