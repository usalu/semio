...
//#region 🎮️Behavior
impl MutationKind<FlowHostSnapshot, FlowMutation> for RemoveSynapse {
    ...
    fn label(&self) -> crate::LocalizedLabel {
        crate::LocalizedLabel::native(&format!("Remove synapse {}", self.id), &format!("Synapse {} entfernen", self.id))
    }
