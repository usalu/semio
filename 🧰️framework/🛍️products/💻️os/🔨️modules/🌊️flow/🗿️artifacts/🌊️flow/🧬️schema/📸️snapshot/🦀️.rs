...
pub fn tree_from_fixture(fixture: &FlowFixture, kind_infos: &HashMap<String, OperatorInfo>) -> Tree {
    let neurons = fixture
        .widgets
        .iter()
...
pub fn variable_io_ports(name: &str, schema: &str) -> (Vec<IoPortSpec>, Vec<IoPortSpec>) {
...
pub fn parse_port_endpoint(endpoint: &str, default_port: &str) -> (String, String) {
...
pub const FLOW_SLIDER_MIN: f64 = 0.0;
pub const FLOW_SLIDER_MAX: f64 = 10.0;
pub const FLOW_SLIDER_STEP: f64 = 0.1;
...
pub fn sensible_slider_range(value: f64) -> (f64, f64, f64) {
...
pub fn dag_preview_content_from_dict(dict: &Dictionary) -> DagPreviewContent {
...
pub fn descriptor_explicit_id(descriptor: &WidgetDescriptor) -> Option<String> {
