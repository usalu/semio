...
//! (`📡️spr/🧵️channel/🦀️.rs` is their exclusive, mid-rewrite territory per
...
/// `encode`/`decode` — private to this file; the TS twin (`🟦️.ts`) mirrors the exact same
