...
//! `async func`, called through `Store::run_concurrent` + `Accessor` — `../⏳️runtime/🦀️.rs`'s
...
//! `.semio_framework_jobs()`, unsuffixed, exactly as `../⏳️runtime/🦀️.rs` already calls them). It is
