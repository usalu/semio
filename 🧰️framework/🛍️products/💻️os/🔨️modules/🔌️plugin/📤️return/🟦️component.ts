...
import { encodeActorReturnDrive, encodeActorReturnResult, type ActorReturnControl, type ActorReturnDrive, type ActorReturnFault, type ActorReturnIdentity, type ActorReturnOrigin, type ActorReturnPageReceipt, type ActorReturnResult } from "../../../../../🔨️modules/🎭️actor/📤️return/🟦️component.ts";
import type { ActorBytePage } from "../../../../../🔨️modules/🎭️actor/📄️page/🟦️component.ts";
...
if (import.meta.vitest) {
  ...
  it("PluginReturnWit maps every canonical drive to the exact WIT nesting and u64 request", async () => {
    ...
    const { decodeActorReturnDrive } = await import("../../../../../🔨️modules/🎭️actor/📤️return/🟦️component.ts");
  ...
  it("PluginReturnWit matches the shared fixed result vectors and exact enum subset", async () => {
    ...
    const { decodeActorReturnResult } = await import("../../../../../🔨️modules/🎭️actor/📤️return/🟦️component.ts");
  ...
  it("PluginReturnWit preserves all neutral page words without interpreting semantic bytes", async () => {
    const api = await import("./🟦️component.ts");
    const { default: fixture } = await import("../../../../../🔨️modules/🎭️actor/📤️return/🧪️fixture.json");
    const { createActorBytePage } = await import("../../../../../🔨️modules/🎭️actor/📄️page/🟦️component.ts");
