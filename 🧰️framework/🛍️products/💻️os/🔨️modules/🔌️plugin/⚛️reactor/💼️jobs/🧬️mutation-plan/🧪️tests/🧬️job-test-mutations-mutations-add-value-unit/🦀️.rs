...
fn vectors() -> serde_json::Value {
    serde_json::from_str(include_str!("../🧬️job-test-mutations/🧪️tests/🔣️.json")).expect("neutral job vectors")
}
...
fn leaf_descriptor_matches_actual_authored_file() {
    let authored: serde_json::Value = serde_json::from_str(include_str!("../🧬️job-test-mutations/🧬️mutations/➕️add-value/🔣️.json")).expect("descriptor");
