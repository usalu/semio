...
if (import.meta.vitest) {
  ...
  it("PluginPollCompositionWit preserves the canonical six scalars and exact nested field names", async () => {
    const api = await import("./🟦️component.ts"); const { default: fixture } = await import("../../../../../../🔨️modules/🎠️kernel/📥️poll/🏘️composition/🧪️fixture.json"); const { default: contract } = await import("../../../../../../🔨️modules/🎠️kernel/📥️poll/🏘️composition/🧬️contract.json");
    const { default: schema } = await import("../../../../../../🔨️modules/🎠️kernel/📥️poll/🏘️composition/🧬️schema.json"); const { default: fixtureSchema } = await import("../../../../../../🔨️modules/🎠️kernel/📥️poll/🏘️composition/🧪️schema.json"); const { default: capacitySchema } = await import("../../../../../../🔨️modules/🌱️value/💾️resident/🧬️schema.json");
  ...
  it("PluginPollCompositionWit checks every WIT u64 before conversion and keeps number and bigint dialects distinct", async () => {
    const api = await import("./🟦️component.ts"); const { default: fixture } = await import("../../../../../../🔨️modules/🎠️kernel/📥️poll/🏘️composition/🧪️fixture.json"); const { default: contract } = await import("../../../../../../🔨️modules/🎠️kernel/📥️poll/🏘️composition/🧬️contract.json"); const library = "lodash"; const { default: _ } = await import(library);
  ...
  it("PluginPollCompositionWit reads only own data fields without claiming unknown-root retirement or private owner authority", async () => {
    const api = await import("./🟦️component.ts"); const { default: fixture } = await import("../../../../../../🔨️modules/🎠️kernel/📥️poll/🏘️composition/🧪️fixture.json"); const original = fixture.valid[1]!.input.composition; let reads = 0;
