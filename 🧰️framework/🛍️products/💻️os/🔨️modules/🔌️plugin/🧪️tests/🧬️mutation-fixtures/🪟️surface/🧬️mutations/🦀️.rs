...
#[derive(Clone,Debug,PartialEq,serde::Serialize,serde::Deserialize,ToValue, FromValue, dsl::Mutations)] #[serde(tag="operation",content="payload",rename_all="camelCase",deny_unknown_fields)] #[mutations(snapshot=super::SurfaceSnapshot,diff=super::SurfaceDiff,schema="plugin.testkit.surface")] pub(crate) enum SurfaceMutation { SetSurfaceCount(SetSurfaceCount) }
