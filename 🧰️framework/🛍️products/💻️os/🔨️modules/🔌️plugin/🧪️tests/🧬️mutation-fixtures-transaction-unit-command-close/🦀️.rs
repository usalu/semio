...
fn check(id: &str) {
    let document: Cases = serde_json::from_str(include_str!("../../🧫️fixtures/🧬️mutation-fixtures/🔀️transaction/🧪️tests/🧪️command-close/🔣️.json")).expect("command-close neutral vectors");
