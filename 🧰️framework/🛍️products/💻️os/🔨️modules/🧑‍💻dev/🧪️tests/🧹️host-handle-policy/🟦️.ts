...
export { HOST_ENGINE_HANDLE_TYPES, HOST_ENGINE_HANDLE_TYPE_ALTERNATION, HOST_ENGINE_HANDLE_TYPE_NAMES, HOST_HANDLE_CONSTRUCT_PATTERN, HOST_HANDLE_FIELD_PATTERN, HOST_HANDLE_STATIC_PATTERN, type HostHandleBreach, HostHandleReachLintScript, lineNumberAtIndex, scanHostHandleReach };
