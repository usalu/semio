...
pub mod host {
    ...
    /// docstring in `🧩️extension/🦀️.rs` gives for ITS wire-shape duplication) — so the two
...
pub mod instance {
    ...
    //#region 🧪️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️instance-unit/🦀️.rs");
    //#endregion 🧪️Tests
    // #endregion instance
}
...
pub mod media_export_raster {
    ...
    // `import_obj_object`/`import_stl_object`, `🗿️artifacts/📐️cad/…/🚪️io/🦀️.rs`) already
...
pub mod workflow {
    ...
    //#region 🧪️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️workflow-unit/🦀️.rs");
    //#endregion 🧪️Tests
    // #endregion workflow
}
...
pub mod codec_abi {
    ...
    //#region 🧪️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️codec-abi-unit/🦀️.rs");
    //#endregion 🧪️Tests
}
...
pub mod registry {
    ...
    //#region 🧪️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️registry-unit/🦀️.rs");
    //#endregion 🧪️Tests
    // #endregion registry
}
