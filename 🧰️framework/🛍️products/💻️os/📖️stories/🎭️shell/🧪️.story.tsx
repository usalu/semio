// #region 🧲️Header
// 💻️ 🧰️framework/🛍️products/💻️os/📖️stories/🎭️shell/🧪️.story.tsx
...
// Summary: Args-driven `program` select (populated from `PLUGIN_BUILD_TARGETS`) + `appId` text control via `OsBootHost` (`🧰️framework/🛍️products/💻️os/📖️stories/🧭️coordination/🟦️.tsx`). Serves prebuilt WASM from `/plugin-modules`; a missing artifact renders an instruction panel instead of blocking on cargo.
// 2026 Ueli Saluz <ueli@semio-tech.com>
// #endregion 🧲️Header

import type { Meta, StoryObj } from "@storybook/react-vite";

import { OsBootHost, PLUGIN_BUILD_TARGETS, type OsBootHostProps } from "../🧭️coordination/🟦️.tsx";
