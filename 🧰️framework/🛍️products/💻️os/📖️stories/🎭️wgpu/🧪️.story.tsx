// #region 🧲️Header
// 💻️ 🧰️framework/🛍️products/💻️os/📖️stories/🎭️wgpu/🧪️.story.tsx
...
// Summary: Args-driven `plugin` select via `WgpuBootHost` (`🧰️framework/🛍️products/💻️os/📖️stories/🧭️coordination/🟦️.tsx`), which dynamically imports the wgpu package, resolves its Trunk-hashed bundle filename from the served `index.html`, and boots into a `#root` container. Falls back to a "WebGPU unavailable" message when `navigator.gpu` is undefined (e.g. headless Chromium without `--enable-unsafe-webgpu`, Safari, Firefox) and to an artifact-missing panel when the plugin has no prebuilt WASM — never triggers a cargo build.
// 2026 Ueli Saluz <ueli@semio-tech.com>
// #endregion 🧲️Header

import type { Meta, StoryObj } from "@storybook/react-vite";

import { WgpuBootHost, PLUGIN_BUILD_TARGETS, type WgpuBootHostProps } from "../🧭️coordination/🟦️.tsx";
