//! 🧪️ `sign-in` fixture — `replaces-the-active-session-with-a-second-account`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "sign-in/replaces-the-active-session-with-a-second-account: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
