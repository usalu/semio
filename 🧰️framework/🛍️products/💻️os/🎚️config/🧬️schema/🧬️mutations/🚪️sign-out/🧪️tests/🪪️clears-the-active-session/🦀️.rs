...
const AFTER: &str = include_str!("../../🧫️fixtures/🪪️clears-the-active-session/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../🧫️fixtures/🪪️clears-the-active-session/🦠️mutation/🔣️.json");
