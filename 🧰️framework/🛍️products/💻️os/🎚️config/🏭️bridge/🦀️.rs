...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_framework_os_config::opening_config::mutations::sign_in::IdentitySetting, semio_framework_os_config::opening_config::mutations::IdentityConfigMutation>,
    descriptors::<semio_framework_os_config::opening_config::mutations::change_merge_policy::MergePolicySetting, semio_framework_os_config::opening_config::mutations::MergePolicyConfigMutation>,
    descriptors::<semio_framework_os_config::opening_config::OpeningPreferences, semio_framework_os_config::opening_config::mutations::OpeningConfigMutation>,
    descriptors::<semio_framework_os_config::opening_config::UiPreferences, semio_framework_os_config::opening_config::mutations::UiPreferencesConfigMutation>,
];

/// 🗺️ Manifest coordinate → the owner directory whose leaves it measures.
const COORDINATES: &[(&str, &str, &str, &str)] = &[
    ("os.config", "1", "identity", "🧰️framework/🛍️products/💻️os/🎚️config"),
    ("os.config", "1", "merge-policy", "🧰️framework/🛍️products/💻️os/🎚️config"),
    ("os.config", "1", "opening", "🧰️framework/🛍️products/💻️os/🎚️config"),
];
