...
export default defineConfig({
  ...
  test: {
    ...
    include: [],
    coverage: { include: ["../../🟦️.ts", "../../🧵️backbone-worker.ts", "../../⚡️effect-backbone.ts", "../../🔨️modules/🔌️plugin/🌐️browser-bundle/🩹️patch-handoff/🟦️.ts"] },
    includeSource: ["../../🟦️.ts", "../../🧵️backbone-worker.ts", "../../⚡️effect-backbone.ts", "../../🔨️modules/🔌️plugin/🌐️browser-bundle/🩹️patch-handoff/🟦️.ts"],
