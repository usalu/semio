...
/**
 * 📡️ TS twin of `protocol_channel::CHANNEL_VERSION` (`🔨️modules/📡️protocol/🧵️channel/⚡️implementations/🦀️rust/📦️lib.rs`)
...
if (import.meta.vitest) {
  ...
  describe("@semio-tech/framework-os-core AppChannelCodec", () => {
     ...
     * `protocol_channel`'s own `🔖️Corpus` region (`🔨️modules/📡️protocol/🧵️channel/⚡️implementations/🦀️rust/📦️lib.rs`,
