...
import type { FileLinter } from "../../../../📚️lib/⚡️implementations/🟦️typescript/📦️index.ts";
import { BundleScript, ScriptRouter, buildBudgetMs, defineLint, resolveCliBin, runBundleScriptMain, runCmd, runTestBudgeted } from "../../../../📚️lib/⚡️implementations/🟦️typescript/📦️index.ts";
...
const REPO_CLI_GO = join(REPO_CLIENT_DIR, "⌨️cli", "⚡️implementations", "🐹️go");
