...
func TestContributorDiscovery(t *testing.T) {
	...
	contributorsDir := filepath.Join(tmpDir, ".🦑️repo", "🧑️‍💻️devs")
...
// #endregion 🔑️Compose Repo ID Conversion
...
func TestExhaustiveFilterTicketWorkspaceFiles(t *testing.T) {
	...
	ticket := &Ticket{
		...
		Day:        20,
		Slug:       "SAMPLE",
		FolderPath: filepath.Join(rootDir, ".🦑️repo", "🎫️tickets", "26", "01", "20", "SAMPLE"),
	}
	files := []string{
		".🦑️repo/🎫️tickets/26/01/20/SAMPLE/plan.md",
		"./.🦑️repo/🎫️tickets/26/01/20/SAMPLE/ticket.json",
		filepath.Join(rootDir, ".🦑️repo", "🎫️tickets", "26", "01", "20", "SAMPLE", "extra.txt"),
		absMain,
	}
...
func TestAnalyzeReadsBreachCacheJSON(t *testing.T) {
	tmp := t.TempDir()
	cacheDir := filepath.Join(tmp, ".🦑️repo", "⚡️cache", "breaches")
...
func TestFileHeaderId(t *testing.T) {
	tests := []struct {
		...
		{"code ts", "compose/js/src/index.ts", "🏘️compose📜️js" + emojiText(EmojiFolderOrg) + "src" + emojiText(EmojiFileCode) + "index"},
		{"code tsx", "compose/js/src/App.tsx", "🏘️compose📜️js" + emojiText(EmojiFolderOrg) + "src" + emojiText(EmojiFileCode) + "app"},
		{"code go", "repo/client/client.go", "🧰️repo⌨️client" + emojiText(EmojiFileCode) + "client"},
		{"code cs", "compose/gh/Compose.cs", "🏘️compose🐙️gh" + emojiText(EmojiFileCode) + "compose"},
		{"code py", "compose/engine/main.py", "🏘️compose⚙️engine" + emojiText(EmojiFileCode) + "main"},
		{"test ts", "compose/js/src/🧪️index.test.ts", "🏘️compose📜️js" + emojiText(EmojiFolderOrg) + "src" + emojiText(EmojiFileLab) + "indextest"},
		{"test go", "repo/client/client_test.go", "🧰️repo⌨️client" + emojiText(EmojiFileLab) + "clienttest"},
...
func TestDocsBreach(t *testing.T) {
	...
	t.Run("docsPolicy detects missing Summary section", func(t *testing.T) {
		...
		if err := WriteTextFile(readmePath, "# 💯️Requirements\n\nSome requirements here.\n"); err != nil {
			t.Fatalf("failed to write: %v", err)
		}
		bundles := []Bundle{{Name: "test-bundle", Root: bundleRoot}}
		scope := Scope{Kind: ScopeRepo}
...
func TestExhaustiveGoalDocument(t *testing.T) {
	...
	childPath := filepath.Join(GetRepoGoalsDir(), filepath.FromSlash(child.ID), "🎯️goal.json")
	...
	newChildPath := filepath.Join(GetRepoGoalsDir(), filepath.FromSlash(newChildID), "🎯️goal.json")
	...
	rootChildPath := filepath.Join(GetRepoGoalsDir(), "TEST-CHILD-GOAL", "🎯️goal.json")
...
func TestSpecExactIDs(t *testing.T) {
	cases := []struct {
		...
		{"years", "years", map[string]interface{}{"parentId": ""}, "🎆️"},
		{"year 26", "year", map[string]interface{}{"parentId": "", "yy": "26"}, "🎆️26"},
		{"months", "months", map[string]interface{}{"parentId": "🎆️26"}, "🎆️26🌙️"},
		{"month 02", "month", map[string]interface{}{"parentId": "🎆️26", "mm": "02"}, "🎆️26🌙️02"},
		{"days", "days", map[string]interface{}{"parentId": "🎆️26🌙️02"}, "🎆️26🌙️02☀️"},
		{"day 15", "day", map[string]interface{}{"parentId": "🎆️26🌙️02", "dd": "15"}, "🎆️26🌙️02☀️15"},
		{"hours", "hours", map[string]interface{}{"parentId": "🎆️26🌙️02☀️15"}, "🎆️26🌙️02☀️15⏰️"},
		{"hour 14", "hour", map[string]interface{}{"parentId": "🎆️26🌙️02☀️15", "hh": "14"}, "🎆️26🌙️02☀️15⏰️14"},
		{"minutes", "minutes", map[string]interface{}{"parentId": "🎆️26🌙️02☀️15⏰️14"}, "🎆️26🌙️02☀️15⏰️14⌚️"},
		{"minute 33", "minute", map[string]interface{}{"parentId": "🎆️26🌙️02☀️15⏰️14", "mm": "33"}, "🎆️26🌙️02☀️15⏰️14⌚️33"},
		{"seconds", "seconds", map[string]interface{}{"parentId": "🎆️26🌙️02☀️15⏰️14⌚️33"}, "🎆️26🌙️02☀️15⏰️14⌚️33⏱️"},
		{"second 38", "second", map[string]interface{}{"parentId": "🎆️26🌙️02☀️15⏰️14⌚️33", "ss": "38"}, "🎆️26🌙️02☀️15⏰️14⌚️33⏱️38"},
		{"technologies", "technologies", map[string]interface{}{"parentId": ""}, "🏗️"},
		{"technology repo", "technology", map[string]interface{}{"name": "repo", "kind": "infrastructure"}, "🧰️repo"},
		{"bundles", "bundles", map[string]interface{}{"parentId": "🏘️compose"}, "🏘️compose📦️"},
		{"bundle compose/js", "bundle", map[string]interface{}{"name": "compose/js", "kind": "library"}, "🏘️compose📚️js"},
		{"root folders", "folders", map[string]interface{}{"parentId": ""}, "📁️"},
		{"bundle folders", "folders", map[string]interface{}{"parentId": "🏘️compose📚️js🗃️sketchpad"}, "🏘️compose📚️js🗃️sketchpad📁️"},
		{"required folder folders", "folders", map[string]interface{}{"parentId": "🛅️github"}, "🛅️github📁️"},
		{"folder compose/js/sketchpad", "folder", map[string]interface{}{"path": "compose/js/sketchpad", "kind": "organization", "parentId": "🏘️compose📚️js"}, "🏘️compose📚️js🗃️sketchpad"},
		{"folder .devcontainer", "folder", map[string]interface{}{"path": ".devcontainer", "kind": "required", "parentId": ""}, "🛅️devcontainer"},
		{"root files", "files", map[string]interface{}{"parentId": ""}, "📄️"},
		{"folder files", "files", map[string]interface{}{"parentId": "🏘️compose📚️js🗃️sketchpad"}, "🏘️compose📚️js🗃️sketchpad📄️"},
		{"required folder files", "files", map[string]interface{}{"parentId": "🛅️github"}, "🛅️github📄️"},
		{"code file Design.tsx", "file", map[string]interface{}{"path": "compose/js/sketchpad/Design.tsx", "kind": "code", "parentId": "🏘️compose📚️js🗃️sketchpad"}, "🏘️compose📚️js🗃️sketchpad💻️design"},
		{"config file devcontainer.json", "file", map[string]interface{}{"path": ".devcontainer/devcontainer.json", "kind": "config", "parentId": "🛅️devcontainer"}, "🛅️devcontainer⚙️devcontainer"},
		{"line 3872", "line", map[string]interface{}{"parentId": "🏘️compose📚️js🗃️sketchpad💻️design", "line": float64(3872)}, "🏘️compose📚️js🗃️sketchpad💻️design📌️3872"},
		{"sections in file", "sections", map[string]interface{}{"parentId": "🏘️compose📚️js🗃️sketchpad💻️design"}, "🏘️compose📚️js🗃️sketchpad💻️design🔖️"},
		{"section State Managment", "section", map[string]interface{}{"name": "State Managment", "parentId": "🏘️compose📚️js🗃️sketchpad💻️design"}, "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment"},
		{"section Store nested", "section", map[string]interface{}{"name": "Store", "parentId": "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment"}, "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store"},
		{"definitions in section", "definitions", map[string]interface{}{"parentId": "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store"}, "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store🏷️"},
		{"definition createSketchpadStore", "definition", map[string]interface{}{"name": "createSketchpadStore", "kind": "implementation", "parentId": "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store"}, "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store🛠️createsketchpadstore"},
		{"root goals", "goals", map[string]interface{}{"parentId": ""}, "🎯️"},
		{"nested goals", "goals", map[string]interface{}{"parentId": "🎯️r26021🎯️runningsketchpad"}, "🎯️r26021🎯️runningsketchpad🎯️"},
		{"goal Running Sketchpad", "goal", map[string]interface{}{"id": "R26-02-1/RUNNING-SKETCHPAD", "parentId": "🎯️r26021"}, "🎯️r26021🎯️runningsketchpad"},
		{"root tickets", "tickets", map[string]interface{}{"parentId": ""}, "🎫️"},
		{"goal tickets", "tickets", map[string]interface{}{"parentId": "🎯️r26021🎯️runningsketchpad"}, "🎯️r26021🎯️runningsketchpad🎫️"},
		{"section tickets", "tickets", map[string]interface{}{"parentId": "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store"}, "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store🎫️"},
		{"ticket", "ticket", map[string]interface{}{"slug": "INTRODUCE-KEY-GUID-URI-MECHANISM", "parentId": "🎯️r26021🎯️runningsketchpad"}, "🎯️r26021🎯️runningsketchpad🎫️introducekeyguidurimechanism"},
		{"draft", "draft", map[string]interface{}{"slug": "NEW-ARCHITECTURE", "parentId": "🧰️repo⌨️client"}, "🧰️repo⌨️client📝️newarchitecture"},
		{"todo", "todo", map[string]interface{}{"id": "INTRODUCE-PROPER-SYNC-MECHANISM", "parentId": "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store🛠️createsketchpadstore"}, "🏘️compose📚️js🗃️sketchpad💻️design🔖️statemanagment🔖️store🛠️createsketchpadstore📝️introducepropersyncmechanism"},
		...
		{"breach", "breach", map[string]interface{}{
			"parentId": "💻️👮️godfiles",
			"affected": "🏘️compose📚️js🗃️sketchpad💻️designstore",
			"lineId":   "📌️3872📌️3875",
			"secondId": "🎆️26🌙️02☀️14⏰️19⌚️07⏱️12",
		}, "💻️👮️godfiles🚫️🏘️compose📚️js🗃️sketchpad💻️designstore🔍️📌️3872📌️3875🎆️26🌙️02☀️14⏰️19⌚️07⏱️12"},
		{"contributor", "contributor", map[string]interface{}{"alias": "ueli", "github": "usalu"}, "🧑️‍💻️ueli"},
		{"checkpoint", "checkpoint", map[string]interface{}{"sha": "cfb3b6084ff3fe883d5f39b08810a0b90997907a", "contributorId": "🧑️‍💻️ueli"}, "🧑️‍💻️ueli🔀️cfb3b6084ff3fe883d5f39b08810a0b90997907a"},
		{"interaction started", "interaction", map[string]interface{}{
			"secondId":      "🎆️26🌙️02☀️14⏰️19⌚️07⏱️12",
			"contributorId": "🧑️‍💻️ueli",
			"entityId":      "🎯️r26021🎯️runningsketchpad🎫️introducekeyguidurimechanism",
			"kind":          "started",
		}, "🎆️26🌙️02☀️14⏰️19⌚️07⏱️12🧑️‍💻️ueli🎯️r26021🎯️runningsketchpad🎫️introducekeyguidurimechanism🌱️"},
		...
		{"sessions", "sessions", map[string]interface{}{"parentId": "🎆️26🌙️02☀️15"}, "🎆️26🌙️02☀️15⚪️"},
		{"session", "session", map[string]interface{}{"uuid": "e753ed61-e8cc-49b7-88f7-dda53b8d5a15", "parentId": "🎆️26🌙️02☀️15"}, "🎆️26🌙️02☀️15⚪️e753ed61e8cc49b788f7dda53b8d5a15"},
	}
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
...
func TestExhaustiveMonorepoTreeEntityIDs(t *testing.T) {
	...
	for _, c := range composeTechnology.Children {
		if c.Kind == TreeNodeBundle {
			...
			if strings.HasSuffix(bId, emojiText("🔤️")+"antlr") {
				antlrBundle = c
				break
			}
		}
	...
	expectedBundleId := emojiText(EmojiTechnologyUser) + "compose" + emojiText("🔤️") + "antlr"
...
func TestBundleListIDs(t *testing.T) {
	...
	expectedIDs := map[string]string{
		...
		"compose/rs":         emojiText(EmojiTechnologyUser) + "compose" + emojiText("🦀️") + "rs",
		"compose/py":         emojiText(EmojiTechnologyUser) + "compose" + emojiText("🐍️") + "py",
		"compose/net":        emojiText(EmojiTechnologyUser) + "compose" + emojiText("🔷️") + "net",
		"compose/graphql":    emojiText(EmojiTechnologyUser) + "compose" + emojiText("🔗️") + "graphql",
		"compose/jsonschema": emojiText(EmojiTechnologyUser) + "compose" + emojiText("📋️") + "jsonschema",
		"compose/openapi":    emojiText(EmojiTechnologyUser) + "compose" + emojiText("📡️") + "openapi",
...
func TestTicketLifecycle_NoManagement(t *testing.T) {
	...
	goalPath := filepath.Join(tmpDir, ".🦑️repo", "🎯️goals", "GOAL-TITLE", "🎯️goal.json")
	...
	closedGoalPath := filepath.Join(tmpDir, ".🦑️repo", "🎯️goals", goal2.ID, "🎯️goal.json")
...
func TestSearchMonorepoTreeWithCache(t *testing.T) {
	...
	if err := os.MkdirAll(filepath.Join(tmpDir, ".🦑️repo"), 0755); err != nil {
...
func TestRenderMonorepoTree(t *testing.T) {
	...
	t.Run("text tree shows only own ID segment not full parent chain", func(t *testing.T) {
		...
		for _, line := range lines {
			if strings.Contains(line, "🎯️parentgoal🎯️childgoal") {
				t.Errorf("tree text should not contain full hierarchical ID, got line: %s", line)
			}
			if strings.Contains(line, "🎯️parentgoal🎯️") {
		...
		for _, line := range lines {
			if strings.Contains(line, "🎯️childgoal") && !strings.Contains(line, "🎯️parentgoal🎯️childgoal") {
				childFound = true
			}
			if strings.Contains(line, "🎯️grandchildgoal") && !strings.Contains(line, "🎯️childgoal🎯️grandchildgoal") {
...
func TestUnifiedRenderingGoalIdentity(t *testing.T) {
	...
	t.Run("human has artifact ID", func(t *testing.T) {
		if !strings.Contains(humanItem, "🎯️") {
...
// #endregion 📋️Unified Rendering Identity
...
func TestFolderPolicySkipsExcludedDirs(t *testing.T) {
	...
	for _, v := range breachs {
		if v.Kind == BreachFolderIllegalEmpty {
			if strings.HasPrefix(v.Excerpt, ".git") || strings.HasPrefix(v.Excerpt, ".🦑️repo") || strings.HasPrefix(v.Excerpt, "node_modules") {
...
func TestFilePolicyGodfile(t *testing.T) {
	...
	rootDir = tmpDir
	defer func() { rootDir = oldRoot }()
	metaDir := filepath.Join(tmpDir, ".🦑️repo")
...
func TestFilePolicyGodfileSkipsComposeRepo(t *testing.T) {
	...
	breachs := filePolicy(ctx)
	for _, v := range breachs {
		if v.Kind == BreachFileIllegalUseGodfile && strings.HasPrefix(v.Excerpt, ".🦑️repo") {
...
func TestSetRootDirCanonicalizesToRepoRoot(t *testing.T) {
	...
	if got := GetRepoMetaDir(); got != filepath.Join(repoRoot, ".🦑️repo") {
...
func TestRenderPromptTemplateUsesRepoMetaRoot(t *testing.T) {
	...
	templateDir := filepath.Join(repoRoot, ".🦑️repo", "💬️prompts")
...
func TestGetCacheDirUsesMonorepoRoot(t *testing.T) {
	...
	wantPrefix := filepath.Join(monoRoot, ".🦑️repo", "⚡️cache") + string(os.PathSeparator)
...
func writeRepoLoggingConfig(t *testing.T, root string, lg LoggingConfig) {
	t.Helper()
	repoDir := filepath.Join(root, ".🦑️repo")
...
func TestRepoConfig(t *testing.T) {
	...
	t.Run("detail levels", func(t *testing.T) {
		tmpDir := t.TempDir()
		logDir := filepath.Join(tmpDir, ".🦑️repo", "⚡️cache", "🤖️generated", "26", "05", "30", "detail-sess")
...
func TestHookLogging(t *testing.T) {
	...
	now := time.Now().UTC()
	logDir := filepath.Join(tmpDir, ".🦑️repo", "⚡️cache", "🤖️generated",
...
func setupTicketDir(t *testing.T) (string, string) {
	...
	tmpDir := t.TempDir()
	now := time.Now().UTC()
	ticketDir := filepath.Join(tmpDir, ".🦑️repo", "🎫️tickets",
		fmt.Sprintf("%02d", now.Year()%100),
...
func getLogFiles(t *testing.T, tmpDir string) []string {
	t.Helper()
	outBase := filepath.Join(tmpDir, ".🦑️repo", "⚡️cache")
	var logFiles []string
...
`
	...
	t.Run("go_full_suite_returns_labs", func(t *testing.T) {
		...
		if !strings.Contains(labs[0], "🥼️") || !strings.Contains(labs[0], "mypackage") {
...
func TestNativeHookEventMappingFromRealLogFiles(t *testing.T) {
	...
	logDir := filepath.Join(repoRoot, ".🦑️repo", "📜️")
...
func TestCheckpointInLoggedEventJSON(t *testing.T) {
	...
	agentEventsDir := filepath.Join(tmpDir, ".🦑️repo", "⚡️cache", "🤖️generated")
...
func TestEventIDsUseComposeRepoFormat(t *testing.T) {
	...
	if !strings.Contains(rangeRef, "📌️") {
		t.Errorf("expected 📌️ in range ref, got: %s", rangeRef)
	}
	...
	if !strings.Contains(rangeRefFull, "📌️10📌️20") {
		t.Errorf("expected 📌️10📌️20 in full range ref, got: %s", rangeRefFull)
	}
}
...
func TestGoalIDForFilesystem(t *testing.T) {
	...
	tests := []struct {
		...
		{"🎯️aioptimizedrepo🎯️repoclient", "AI-OPTIMIZED-REPO/REPO-CLIENT"},
	}
	for _, tt := range tests {
...
func TestGenerateTechnologyRequirements(t *testing.T) {
	...
	if !strings.HasPrefix(content, "# 💯️ Requirements") {
		t.Error("SPECS.md should start with '# 💯️ Requirements'")
	}
...
func TestGenerateTechnologyDocs(t *testing.T) {
	...
	if !strings.HasPrefix(content, "# 📚️ Docs") {
		t.Error("DOCS.md should start with '# 📚️ Docs'")
	}
...
func TestGenerateTechnologyTodos(t *testing.T) {
	...
	if !strings.HasPrefix(content, "# 🔳️ TODOs") {
		t.Error("TODOS.md should start with '# 🔳️ TODOs'")
	}
}
