module github.com/usalu/semio/repo/hooks

go 1.25

require (
	github.com/usalu/semio/repo/codebase v0.0.0
	github.com/usalu/semio/repo/contributors v0.0.0
	...
	github.com/usalu/semio/repo/testrunner v0.0.0
...
replace github.com/usalu/semio/repo/contributors => ../../../🧑️contributors/📦️packages/🐹️go
...
replace github.com/usalu/semio/repo/testrunner => ../../../🏃️test-runner/📦️packages/🐹️go
