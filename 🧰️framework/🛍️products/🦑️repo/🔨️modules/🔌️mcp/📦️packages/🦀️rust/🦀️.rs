...
const DESCRIPTIONS_JSON: &str = include_str!("../../🧬️schema/🔣️descriptions.json");

static DESCRIPTIONS: OnceLock<BTreeMap<String, BTreeMap<String, String>>> = OnceLock::new();

/// 🗣️ The per-profile description table, authored once at `🔌️mcp/🧬️schema/🔣️descriptions.json`.
