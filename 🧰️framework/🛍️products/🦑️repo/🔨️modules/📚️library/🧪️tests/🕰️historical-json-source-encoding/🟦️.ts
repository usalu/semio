...
const vector = JSON.parse(readFileSync(join(import.meta.dir, "../🕰️historical-json-source-encoding/🔣️.json"), "utf8"));
const historical = JSON.parse(readFileSync(join(import.meta.dir, "../🕰️historical-json-source-encoding/🧬️energy-source-coordinates/🔣️.json"), "utf8"));
