...
const inventorySchemaPath = resolve(import.meta.dir, "../../📋️mutation-inventory/🛂️schema/🔣️.json");
const vectorsPath = resolve(import.meta.dir, "../../📋️mutation-inventory/🎭️source-roster-roles/🔣️.json");
const vectorsSchemaPath = resolve(import.meta.dir, "../../📋️mutation-inventory/🎭️source-roster-roles/🧬️schema/🔣️.json");
