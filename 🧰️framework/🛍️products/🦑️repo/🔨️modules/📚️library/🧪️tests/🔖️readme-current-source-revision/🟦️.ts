...
test("current source revision neutral grammar agrees with Ajv and independent JSON parsing", () => {
  ...
  expect(parseJson(readFileSync(join(import.meta.dir, "../🔖️readme-current-source-revision/🔣️.json"), "utf8"), errors, { disallowComments: true, allowTrailingComma: false })).toEqual(vector);
