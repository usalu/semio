...
import { semanticPackageProjectionAuthority, type SemanticPackageProjectionCatalog, type Taxonomy } from "../../🔍️discovery/🟦️component.ts";
...
function productionExpressions() {
  ...
  const discovery = source("🔍️discovery/🟦️component.ts", "semanticPackageProjectionAuthority");
