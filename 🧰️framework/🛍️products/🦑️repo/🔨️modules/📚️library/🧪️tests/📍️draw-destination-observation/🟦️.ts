...
const vectorText = readFileSync(join(import.meta.dir, "../../🧫️fixtures/📍️draw-destination-observation/🔣️.json"), "utf8"), vector = JSON.parse(vectorText) as ObservationVector;
const schemaText = readFileSync(join(import.meta.dir, "../../🧬️schema/📍️draw-destination-observation/🔣️.json"), "utf8"), schema = JSON.parse(schemaText);
...
const authoredSchemaPath = join(dirname(authoredPath), "../../🧬️schema/📍️draw-destination-observation/🔣️.json"), authoredSchema = JSON.parse(readFileSync(authoredSchemaPath, "utf8"));
...
const inputPaths = [import.meta.filename, join(import.meta.dir, "../../🧫️fixtures/📍️draw-destination-observation/🔣️.json"), join(import.meta.dir, "../../🧬️schema/📍️draw-destination-observation/🔣️.json"), catalogPath, authoredPath, authoredSchemaPath, join(libraryRoot, "🔣️taxonomy.json"), join(libraryRoot, "🔍️discovery/🟦️.ts"), join(import.meta.dir, "../../🧫️fixtures/📍️draw-destination-observation/🧪️registration/🔣️.json"), join(import.meta.dir, "../../🧬️schema/📍️draw-destination-observation/🧪️registration/🔣️.json")];
