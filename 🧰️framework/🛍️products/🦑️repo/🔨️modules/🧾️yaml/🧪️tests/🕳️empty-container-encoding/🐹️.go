...
type codecVectorFile struct {
	...
	EdgeVectors []codecVector `json:"edgeVectors"`
}
...
func loadVectors(ctx *host.Context) ([]codecVector, error) {
	...
	return append(append([]codecVector{}, file.Vectors...), file.EdgeVectors...), nil
}
...
func theOwnedEncoderLosesAnEmptyContainer(ctx *host.Context) (host.Outcome, error) {
...
func Adapter() *host.Adapter {
	return host.NewAdapter("go").
		Subject("the-owned-encoder-loses-an-empty-container", theOwnedEncoderLosesAnEmptyContainer)
}
