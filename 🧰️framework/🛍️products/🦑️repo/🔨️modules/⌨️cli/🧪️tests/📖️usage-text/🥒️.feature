...
Feature: Every command states its own usage text
  ...
  shared://📖️usage-text/📖️usage-goldens.json states that text verbatim for representative commands, states
  ...
  Scenario: Every golden command produces its stated usage text byte for byte
    Given the goldens shared://📖️usage-text/📖️usage-goldens.json
