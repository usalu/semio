...
HTMLCanvasElement.prototype.getContext = function getContext(this: HTMLCanvasElement, type: string, options?: CanvasRenderingContext2DSettings): RenderingContext | null {
  if (type === "2d") {
    return {
      fillRect: () => undefined,
      clearRect: () => undefined,
  ...
  return (originalGetContext as unknown as (this: HTMLCanvasElement, type: string, options?: CanvasRenderingContext2DSettings) => RenderingContext | null).call(this, type, options);
...
if (typeof Range !== "undefined" && typeof Range.prototype.getClientRects !== "function") {
  Range.prototype.getClientRects = function getClientRectsPolyfill(this: Range): DOMRectList {
    const element = this.commonAncestorContainer.nodeType === Node.ELEMENT_NODE ? (this.commonAncestorContainer as HTMLElement) : this.commonAncestorContainer.parentElement;
    if (!element) {
