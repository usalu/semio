...
import { compileMarkdownToHtml } from "../../📦️packages/🟦️typescript/🎯️targets/⚛️react/🟦️.tsx";
...
describe("owned markdown html compiler", () => {
  it("renders GFM tables through the active compiler of the React target", async () => {
