...
export async function registerTests1(vitest: NonNullable<ImportMeta["vitest"]>, dependencies: Pick<typeof import("../../🟦️.ts"), "artifactKindChoices" | "decodeArtifactKindChoice" | "decodeSurfaceAppChoice" | "encodeArtifactKindChoice" | "encodeSurfaceAppChoice">, source: TestSource): Promise<void> {
