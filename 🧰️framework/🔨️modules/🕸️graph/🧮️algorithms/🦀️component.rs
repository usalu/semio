...
mod tests {
    ...
    #[test]
    async fn bfs_order_visits_reachable_nodes_breadth_first() {
    ...
    #[test]
    async fn bfs_distances_unreachable_is_none() {
    ...
    #[test]
    async fn topo_sort_orders_dependencies_before_dependents() {
    ...
    #[test]
    async fn topo_sort_detects_cycle() {
    ...
    #[test]
    async fn topo_levels_groups_independent_nodes() {
    ...
    #[test]
    async fn would_create_cycle_detects_back_edge() {
    ...
    #[test]
    async fn would_create_cycle_ids_matches_index_version() {
    ...
    #[test]
    async fn connected_components_groups_weak_components() {
    ...
    #[test]
    async fn strongly_connected_components_finds_cycle_as_one_component() {
    ...
    #[test]
    async fn union_find_unions_and_queries_sets() {
    ...
    #[test]
    async fn dijkstra_prefers_cheaper_longer_path() {
    ...
    #[test]
    async fn id_index_is_deterministic_and_sorted() {
    ...
    #[test]
    async fn id_index_from_ids_dedupes_and_reports_len() {
    ...
    #[test]
    async fn adjacency_accessors_expose_node_count_and_neighbor_lists() {
    ...
    #[test]
    async fn bfs_order_ignores_out_of_range_seeds() {
        let adj = adj_from(2, &[(0, 1)], true);
        assert_eq!(bfs_order(&adj, &[5]), Vec::<usize>::new());
    }

    #[test]
    async fn topo_levels_detects_cycle() {
        let adj = adj_from(3, &[(0, 1), (1, 2), (2, 0)], true);
    ...
    #[test]
    async fn would_create_cycle_self_loop_is_always_a_cycle() {
        let adj = adj_from(2, &[(0, 1)], true);
        assert!(would_create_cycle(&adj, 1, 1));
    }

    #[test]
    async fn is_reachable_from_equals_to_is_trivially_true() {
        let adj = adj_from(2, &[], true);
        assert!(is_reachable(&adj, 1, 1));
    }

    #[test]
    async fn dijkstra_unreachable_node_stays_none() {
        let adj = adj_from(3, &[(0, 1)], true);
    ...
    #[test]
    async fn dijkstra_out_of_range_from_returns_empty() {
        let adj = adj_from(2, &[(0, 1)], true);
