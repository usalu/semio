...
Feature: Web-Mercator projection and slippy-tile selection agree with a third-party reference
  ...
  `local://🔣️.json`, generated once from `mercantile` and frozen. Both the `../../🧪️tests/🕸️web-mercator-tile-oracle/🐍️.py` oracle
  ...
  those vectors are specification vectors pinning `🦀️.rs`, not an oracle claim.
