...
export async function registerTests1(vitest: NonNullable<ImportMeta["vitest"]>, dependencies: Pick<typeof import("../../🧵️turn-scheduler/🟦️.ts"), "TurnScheduler">, source: TestSource): Promise<void> {
