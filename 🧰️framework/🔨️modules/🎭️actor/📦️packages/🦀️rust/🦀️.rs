//! 📦️ Package glue — wiring only. Domain lives at owner `🦀️.rs`. The `wasm_bindgen`
...
//! `🦀️.rs` for the crate's one canonical implementation slot. It passes only byte buffers
