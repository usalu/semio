...
use crate::brep::arena::{ArenaId, Curve3Id, EdgeId, FaceId, SolidId, SurfaceId, VertexId};
use crate::brep::bspline::KnotVector;
use crate::brep::curve::Curve3;
use crate::brep::error::StepError;
...
impl StepWriteContext {
    ...
    fn write_edge_loop(&mut self, body: &Body, loop_id: crate::brep::arena::LoopId) -> Result<u64, StepError> {
    ...
    fn write_shell(&mut self, body: &Body, shell_id: crate::brep::arena::ShellId) -> Result<u64, StepError> {
...
impl<'a> StepBuilder<'a> {
    ...
    fn build_shell(&mut self, shell_ref: u64) -> Result<crate::brep::arena::ShellId, StepError> {
