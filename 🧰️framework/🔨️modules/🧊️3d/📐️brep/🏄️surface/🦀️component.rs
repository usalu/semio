...
use crate::brep::bspline::{basis_function_derivatives, KnotVector};
...
/// [`crate::brep::curve::Curve3`], a face's *used* trim domain is stored by the topology layer, not here.
...
impl Surface {
    ...
    /// NURBS surfaces use central finite differences (see [`crate::brep::curve`]'s equivalent note —
