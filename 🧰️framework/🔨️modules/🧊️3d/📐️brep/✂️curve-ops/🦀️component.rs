//! 📏️ Curve algorithms that operate *on* a [`crate::brep::curve::Curve3`] rather than being part of its
...
use crate::brep::bspline::{basis_functions, insert_knot, KnotVector};
use crate::brep::curve::{Curve3, NurbsCurve3};
...
mod tests {
    use super::*;
    use crate::brep::bspline::de_boor;
