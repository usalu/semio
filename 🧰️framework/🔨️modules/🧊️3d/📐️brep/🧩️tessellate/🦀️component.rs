//! 🧩 Crack-free edge-first tessellation producing [`crate::brep::engine::MeshTransfer`].
//!
...
use crate::brep::engine::{FaceGroup, MeshTransfer};
...
fn collect_loop_polyline(body: &Body, loop_id: crate::brep::arena::LoopId, edge_cache: &HashMap<EdgeId, Vec<Pnt3>>) -> Result<Vec<Pnt3>, KernelError> {
