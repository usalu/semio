//! 🧭️ Surface algorithms that operate *on* a [`crate::brep::surface::Surface`]: closest-point
...
//! same reason as [`crate::brep::curve_ops`] versus [`crate::brep::curve`].
...
/// 🧭️ Wraps into a periodic domain (mirrors [`crate::brep::curve_ops`]'s identical fix for closed
