...
//! falls through to a NURBS representation that is either clipped with [`crate::brep::bezier`]
...
use crate::brep::bezier::RationalBezier3;
use crate::brep::bspline::insert_knot;
