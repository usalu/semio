...
import { borderNormalClass } from "../📏️border-presentation/🟦️component.ts";
import { formControlFocusBorderClass } from "../📝️form-control-presentation/🟦️component.ts";
import { hoverExcludingHandleBgFillClass, hoverExcludingHandleTextEmphasizedClass, interactiveHoverClass, interactiveOnClass } from "../🖱️interaction-presentation/🟦️component.ts";
import { glassClass } from "../🌈️surface-presentation/🟦️component.ts";
// #endregion 🔌️Adapters
