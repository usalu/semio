...
/// (documented D3D11/D3D12 swapchain restriction; not something the `🪟️windows` crate's bindings
...
/// 🪟️ The concrete Windows `GraphicsBackend`. Every D3D12/DXGI/`🪟️windows`-crate type stays behind this
...
fn create_device_and_queue() -> Result<(Device, ID3D12CommandQueue, IDXGIFactory2), BackendError> {
    ...
    // generic pattern this whole crate uses for every `🪟️windows`-crate out-param call.
...
#[path = "../../../../🧪️tests/🔬️d3d12-packages-rust-backend-unit/🦀️.rs"]
mod tests;
