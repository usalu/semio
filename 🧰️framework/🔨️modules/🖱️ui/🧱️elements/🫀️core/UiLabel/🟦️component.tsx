// #region 🧲️Header
// 💻️ framework/ui/elements/core/UiLabel/component.tsx
...
//#region 🎗️UiLabel
/**
 * 🆔️ `UiLabel` + `uiDataLabel`, split out of the ui-react barrel into their own `🧱️elements/🫀️core/` file
 ...
 * `🧱️elements/🫀️core/Ports/🟦️component.tsx`'s header comment for the sibling `reactHostPort` case).
