...
import { interactiveJobPort, reactHostPort } from "../🔌️Ports/🟦️.tsx";
...
import { createDiagramLayoutPublication, diagramLayoutCredits, DIAGRAM_LAYOUT_CODEC_KIND, DIAGRAM_UNIT, type DiagramLayoutOptions, type DiagramLayoutPublicationResult } from "./🟦️.ts";
export { DIAGRAM_UNIT, DIAGRAM_LAYOUT_CODEC_KIND, DIAGRAM_LAYOUT_INGRESS_BYTES, DIAGRAM_LAYOUT_INGRESS_ITEMS, DIAGRAM_LAYOUT_MAX_EDGE_BYTES, DIAGRAM_LAYOUT_MAX_ID_CHARACTERS, DIAGRAM_LAYOUT_MAX_INPUT_ITEMS, DIAGRAM_LAYOUT_MAX_NODE_BYTES, DIAGRAM_LAYOUT_MAX_RESERVED_BYTES, DIAGRAM_LAYOUT_OUTPUT_ITEMS } from "./🟦️.ts";
export type { DiagramLayoutDescriptor, DiagramLayoutDirection, DiagramLayoutEdgeWire, DiagramLayoutIngressPage, DiagramLayoutNodeWire, DiagramLayoutOptions, DiagramLayoutPosition, DiagramLayoutPositionPage, DiagramLayoutTerminal } from "./🟦️.ts";
// #endregion 🔌️Adapters
