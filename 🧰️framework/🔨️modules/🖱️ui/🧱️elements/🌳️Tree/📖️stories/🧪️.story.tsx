...
// 🥼️ 🧰️framework/🔨️modules/🖱️ui/🧱️elements/🌳️Tree/📖️stories/🧪️.story.tsx
...
const windowedSections = [
  {
    ...
    defaultOpen: true,
    windowKey: "entries",
    window: { rowExtent: "standard" as const, total: 400, offset: 40 },
  ...
  },
  {
    ...
    defaultOpen: true,
    windowKey: "pending",
    window: { rowExtent: "standard" as const, total: 24, offset: 0 },
    items: [],
  },
];
