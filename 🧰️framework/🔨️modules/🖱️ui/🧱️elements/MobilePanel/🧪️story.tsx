...
// 🥼️ .storybook/stories/ui/MobilePanel.stories.tsx
...
export const Default: Story = {
  ...
  render: (args) => {
    ...
    return (
      <div className="flex flex-col h-[420px] w-[375px] border ui-surface mx-auto" data-level="base">
