...
// 🥼️ .storybook/stories/ui/Command.stories.tsx
...
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList, CommandShortcut } from "@semio-tech/ui-react";
        ...
        <CommandList>
          ...
          <CommandGroup heading="Settings">
            <CommandItem value="profile">
              <User />
              <span>Profile</span>
              <CommandShortcut>⌘️P</CommandShortcut>
            </CommandItem>
            <CommandItem value="settings">
              <Settings />
              <span>Settings</span>
              <CommandShortcut>⌘️S</CommandShortcut>
            </CommandItem>
          </CommandGroup>
        </CommandList>
      </Command>
