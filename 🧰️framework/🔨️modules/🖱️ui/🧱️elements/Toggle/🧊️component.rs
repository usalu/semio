...
//! `crate::widgets` (declared `#[cfg(feature = "engine")] #[path = "..."] mod toggle;` right before
...
//! `use crate::toggle::render_toggle;` so its own unqualified call sites keep working.
...
pub(crate) fn render_toggle<E: Clone>(id: &str, icon_id: IconName, pressed: bool, text: Option<&str>, bounds: crate::geometry::Rect, ctx: &mut WidgetContext<'_, E>) {
