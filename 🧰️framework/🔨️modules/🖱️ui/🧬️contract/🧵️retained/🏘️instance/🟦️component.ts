...
import { OwnedUiSurface, type OwnedUiSurfaceAcknowledgement, type OwnedUiSurfaceView } from "../🖼️surface/🟦️component.ts";
import { OwnedUiWirePatchCursor } from "../🩹️operations/📥️wire/🟦️component.ts";
...
import { OwnedUiResidentInstance } from "../💾️resident/🟦️component.ts";
import type { OwnedUiSceneReadSource, OwnedUiReadSubscription, OwnedUiNodeReadSnapshot, OwnedUiIssuedSceneReader, OwnedUiSceneRecordView, OwnedUiSceneTextView } from "../📖️read-lease/🟦️component.ts";
