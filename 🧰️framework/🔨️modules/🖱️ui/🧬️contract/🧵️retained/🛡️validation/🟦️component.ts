...
import type { UiContractViolation, UiDocumentLimits } from "../../../../🛂️manifest/🟦️component.ts";
import { RetainedUiNumericTable, RetainedUiSiblingKeys } from "../🟦️component.ts";
...
import { retainedUiGraphValidation, closeRetainedUiGraphFrame, type RetainedUiGraphFrontier } from "./🔬️graph/🟦️component.ts";
