...
import type { AccessibilitySpec, ActionBinding, Component, PatchRejection, UiContractViolation, UiDocumentLimits, UiNodeRecord, UiPatch, UiPatchOp, UiSnapshot } from "../../../🛂️manifest/🟦️component.ts";
import { retainedUiGraphValidation, closeRetainedUiGraphFrame, type RetainedUiGraphFrontier } from "./🛡️validation/🔬️graph/🟦️component.ts";
...
function* componentStrings(component: Component | import("./📦️wire/🧾️typed/🟦️component.ts").RetainedUiComponent): Generator<string> {
