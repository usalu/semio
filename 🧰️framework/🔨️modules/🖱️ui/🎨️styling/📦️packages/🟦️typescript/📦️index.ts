...
/** @emoji 📏️ Derives dag component width as twice the IO channel column width (mirrors the 🔣️tokens.json authoring shortcut). */
...
/** @emoji 📐️ DOM layout multipliers (multiples of `--ui-spacing`) from 🔣️tokens.json. */
...
//#region 🔖️theme
//#region 🔑️Premades
/** @emoji 🎨️ The default "semio" theme, built from 🔣️tokens.json at generate time. */
