/** 🎗️ The real UI vocabulary these extracted suites annotate against. The import is type-only, so the
 * runtime cycle with `🎯️targets/⚛️react/🟦️.tsx` (which dynamically imports this file inside its own
 * `import.meta.vitest` block) is erased at compile time. */
      ...
      const { container } = render(
        <div>
          <UIIntroduction
            introduction={{
              title: "Welcome",
              steps: [{ id: "welcome", title: "Willkommen", body: "A quick tour.", introduce: null, show: [], placement: "center", interactions: [], ordered: false, logos: [], demonstrations: [] }],
            }}
            stepIndex={0}
            onStepIndexChange={vi.fn()}
            onDismiss={onDismiss}
    ...
    it("Window keeps engagement options reachable while the Actions pane is folded", () => {
      ...
      const { container } = render(
        <Window
          ...
          active
          engagement={{
            options: [{ id: "shell-menu.action.openAddObjectDialog", label: uiDataLabel("Add Object…"), icon: { kind: "text", text: "+" }, onPress: () => pressed.push("open") }],
          }}
        >
          <div>Body</div>
        </Window>,
...
export async function registerTests2(vitest: Pick<typeof import("vitest"), "describe" | "expect" | "it" | "vi">, dependencies: Pick<typeof import("../../🎯️targets/⚛️react/🟦️.tsx"), "Button" | "ButtonGroup" | "ButtonGroupItem" | "COLLAPSED_FIELD_ELLIPSIS" | "COMPACT_UI_DRIVER" | "CheckIcon" | "ChevronDownIcon" | "ChevronLeftIcon" | "ChevronRightIcon" | "ChevronUpIcon" | "Command" | "CommandItem" | "CommandList" | "ControlTree" | "DEFAULT_UI_DRIVER" | "DragHandle" | "FindInViewIcon" | "FlowProvider" | "Footer" | "GhostProvider" | "GhostRegionShell" | "HistoryTable" | "Icon" | "Input" | "Label" | "LevelProvider" | "Mode" | "Navbar" | "NavbarExampleSelect" | "Pane" | "PaneHost" | "Panel" | "PanelChromeTabBar" | "PanelDockContext" | "PanelRightIcon" | "PresenceBar" | "Ribbon" | "RibbonItem" | "RibbonZone" | "Ring" | "SCENE_GIZMO_LABELS" | "Search" | "SearchIcon" | "Select" | "SelectContent" | "SelectItem" | "SelectTrigger" | "SelectValue" | "Slider" | "Stepper" | "Table" | "Textarea" | "Toggle" | "ToggleGroup" | "Tree" | "TreeAlignedRow" | "TreeCheckbox" | "TreeContent" | "TreeContext" | "TreeItem" | "TreeRow" | "TreeRowAlignmentContext" | "TreeSection" | "TreeStateProvider" | "TutorialBar" | "UIIntroduction" | "UI_CHROME_LAYOUT_STORAGE_KEY" | "UiDriverProvider" | "UiKeybindingsProvider" | "VIRTUAL_FILE_SYSTEM_DEMO_FILE_NODE_KINDS" | "VIRTUAL_FILE_SYSTEM_DEMO_SCHEMA" | "VirtualFileSystem" | "WINDOW_PANE_MEASURES_ICON" | "Window" | "WindowChrome" | "WindowMeasureTreeGroup" | "WindowMeasureTreeLeaf" | "WindowMeasuresTree" | "WindowPaneChromeToggle" | "applyChromeRevealAtPoint" | "applyDockSkeleton" | "applyElementsSurfaceChrome" | "bootstrapElementsSurfaceChromeDocument" | "borderNormalBottomClass" | "borderNormalClass" | "borderNormalTopClass" | "buildVirtualFileSystemDescriptorColumns" | "buildVirtualFileSystemVisibleRows" | "catalogueTreeDragController" | "cn" | "composeControlKeybindings" | "composeTutorialUi" | "computeTabDockDropZone" | "createTreeHighlightStore" | "createTreeSelectionStore" | "createTutorialClock" | "defaultControlRenderer" | "deriveTreeDragRoles" | "dockSkeletonOf" | "dockSkeletonsEqual" | "fitCollapsedFieldText" | "flowChevronIconName" | "formatControlTooltipText" | "formatKeybindingShortcut" | "formatTutorialTime" | "formatVirtualFileSystemTime" | "getElementById" | "getTreeItemOrderedIds" | "getTreeNextSelectionState" | "getTreeSiblingGapPx" | "getVirtualFileSystemNextSelectionState" | "humanizeControlId" | "humanizeControlSegment" | "interactionMergeFromModifiers" | "interpolateTutorialCamera" | "isInternalChromeControlId" | "isPanelTabInSubtree" | "isTreeReorderDragEvent" | "loadingBorderActiveClass" | "loadingBorderClass" | "loadingBorderStateClass" | "markGhostTreeInteraction" | "measureWindowSilhouetteMetrics" | "modeDockTabClassName" | "moveTabInDock" | "moveTreeUnitInDock" | "navbarFillItem" | "normalizeTreeSelectedIds" | "panelKindFromPanelToggleControlId" | "panelTabButtonDividerClass" | "parseUiDriver" | "presenceColor" | "presenceCssVar" | "pruneEmptyPanelBranches" | "readStoredUiChromeLayout" | "reconcileActivePath" | "resetElementsSurfaceChromeForTests" | "resolveCollapsedFieldDisplayState" | "resolveControlLabelId" | "resolveSceneGizmoSnapTarget" | "resolveSceneGizmoViewportPlacement" | "resolveTranslationLabel" | "resolveTreeDropPosition" | "resolveUiDriver" | "resolveVirtualFileSystemSchemaIcon" | "resolveWindowSilhouetteBorderKind" | "serializeUiDriver" | "shellChromeBorderClass" | "shellChromeFrameLayerClass" | "shouldBeginAutomaticGhostInteraction" | "shouldDispatchTreeRowPointerLeave" | "singleTreeLeaf" | "syncTreeSelectionPath" | "treeCompactSiblingGapPx" | "treeFoldChevronIcon" | "treeItemSecondaryTextClassName" | "treeRowChromeClasses" | "treeRowChromeContentFillClasses" | "treeRowChromeShellClasses" | "treeRowDragPayloadAttributes" | "tutorialCameraAt" | "tutorialCuesBetween" | "tutorialSlice" | "uiDataLabel" | "uiI18n" | "useCanvasAppearanceSync" | "validateTutorial" | "waitingBorderActiveClass" | "waitingBorderClass" | "waitingBorderStateClass" | "windowMeasureToggleClass" | "windowMeasureToggleCompactClass" | "windowSilhouettePath" | "writeStoredUiChromeLayout"> & Pick<typeof import("@semio-tech/framework"), "createBrowserStoragePort"> & Pick<typeof import("react-dom/server"), "renderToStaticMarkup"> & { readonly React: typeof import("react") } & { readonly THREE: typeof import("three") }, testSource: { directory: string; url: string }): Promise<void> {
