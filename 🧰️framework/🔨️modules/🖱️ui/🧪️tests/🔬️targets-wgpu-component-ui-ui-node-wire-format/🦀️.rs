        ...
        UiNode::Stack(UiStackNode {
            ...
            children: vec![
                ...
                UiNode::Input(UiInputNode {
                    ...
                    accessibility_label: Some(Label::data("Message")),
                    commit: None,
                    min: None,
                    max: None,
                    step: None,
