...
export async function registerTests1(vitest: NonNullable<ImportMeta["vitest"]>, dependencies: Pick<typeof import("../../🔣️icons/🏗️builder/📽️projection/🟦️.ts"), "iconIdToRustVariant">, source: TestSource): Promise<void> {
