#!/usr/bin/env bun
/** 📜️ `@semio-tech/graph-manifest` — codegen from manifest JSON sources to Rust + TypeScript. */
import { existsSync, mkdirSync, readdirSync, readFileSync, statSync, writeFileSync } from "node:fs";
import { basename, dirname, join, relative, resolve } from "node:path";
import { BundleScript, getWorkspaceRoot, ScriptRouter, runBundleScriptMain, runCargoLint, runCargoTestBudgeted, resolveTestLevel } from "../../../../../../../🧰️framework/🛍️products/🦑️repo/🔨️modules/📚️lib/⚡️implementations/🟦️typescript/📦️index.ts";
...
/** 🧹️Zero-warning clippy gate: `cargo clippy -p mathematical_graph_manifest --all-targets -- -D warnings`. */
