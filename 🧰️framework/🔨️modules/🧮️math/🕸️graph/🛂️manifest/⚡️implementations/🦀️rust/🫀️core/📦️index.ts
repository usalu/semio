/** @emoji 📜️ `@semio-tech/graph-manifest` — compile-time graph manifest types and catalog projection. */
export * from "../../../../../🕸️graph/🛂️manifest/⚡️implementations/🦀️rust/🤖️generated/📦️index.ts";
//#region 🔖️validate
/** @emoji 🛡️ Runtime validation helpers for graph manifest documents. */
import type { GraphManifestDocument } from "../../../../../🕸️graph/🛂️manifest/⚡️implementations/🦀️rust/🤖️generated/🟦️types.ts";
import manifestSchema from "../../../../../🕸️graph/🛂️manifest/⚡️implementations/🦀️rust/🤖️generated/🔣️manifest.schema.json";
