#!/usr/bin/env bun
/** 🌲️ `@semio-tech/math-graph-trees` — Tree recognition, spanning tree algorithms, arborescences/branchings, and Prüfer encoding. */
...
class TestScript extends BundleScript {
  run(segments: string[]): void {
    ...
    runCargoTestBudgeted(["mathematical_graph_trees"], join(this.root, "rs"), rest);
  }
}

class LintScript extends BundleScript {
  run(): void {
    runCargoLint(["mathematical_graph_trees"], join(this.root, "rs"));
  }
}
