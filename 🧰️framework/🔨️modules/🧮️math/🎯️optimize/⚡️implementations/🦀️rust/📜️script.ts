#!/usr/bin/env bun
/** 🎯️ `@semio-tech/math-optimize` — Nonlinear least squares and robust estimation: Gauss-Newton, Levenberg-Marquardt, Schur-complement bundle solvers, robust losses and RANSAC consensus. */
