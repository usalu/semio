...
//! [`crate::wfc::outcome::SolveOutcome`] variants, never errors: a search finding no solution is not a
//! bug, a malformed model or an internal invariant violation is.

// #region 🔖️ModelError
/// 🚨️ Everything that can go wrong while building or compiling a [`crate::wfc::model::CompiledModel`].
...
pub enum ModelError {
    ...
    UnknownPattern(crate::wfc::ids::PatternId),
    UnknownTile(crate::wfc::ids::TileId),
    UnknownRelation(crate::wfc::ids::RelationId),
    UnknownPort(crate::wfc::ids::PortId),
    /// 🚨️ The same relation name/id was registered twice.
    DuplicateRelation(crate::wfc::ids::RelationId),
    ...
    AsymmetricInverse {
        relation: crate::wfc::ids::RelationId,
    },
    ...
    /// 🚨️ A [`crate::wfc::serial::SourceModelDoc`]'s schema version does not match this build's. No
...
pub enum TopologyError {
    ...
    /// 🚨️ A node count exceeded `u32::MAX`, the limit `crate::wfc::ids::NodeId` can address.
...
pub enum ConstraintError {
    ...
    UnknownRegion(crate::wfc::ids::RegionId),
    UnknownTag(u32),
...
/// itself finding no solution, which is a [`crate::wfc::outcome::SolveOutcome`]).
#[derive(Clone, PartialEq, Debug)]
pub enum SolveError {
