...
//!
//! Unlike [`crate::wfc::search`]'s kernel, a dropped beam is never revisited: this is **not** a
...
use crate::wfc::outcome::{ContradictionReport, RunReport, Solution, SolveOutcome};
...
/// `crate::wfc::soft::SoftConstraint` scoring on top once there's a concrete consumer).
...
mod tests {
    ...
    use crate::wfc::oracle;
    use crate::wfc::topology::GraphTopologyBuilder;

    fn checkerboard(n: usize) -> (CompiledModel, crate::wfc::topology::GraphTopology, Vec<oracle::ArcSpec>) {
    ...
    fn k_graph(n: usize, k: usize) -> (CompiledModel, crate::wfc::topology::GraphTopology, Vec<oracle::ArcSpec>) {
        let mut b = ModelBuilder::new();
