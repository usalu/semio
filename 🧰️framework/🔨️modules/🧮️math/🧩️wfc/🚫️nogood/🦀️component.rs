...
//! `crate::wfc::search::decide_and_propagate`), never to ordinary propagation-caused domain reductions.
...
use crate::wfc::domain::{DomainStore, RestrictResult};
...
impl NogoodIndex {
    ...
    pub fn rewatch_for_new_attempt<T: Topology>(&mut self, model: &CompiledModel, topo: &T, domains: &mut DomainStore, queue: &mut PropQueue, trail: &mut Trail, metrics: &mut crate::wfc::diag::Metrics) -> Option<NodeId> {
    ...
    pub fn on_decision<T: Topology>(&mut self, model: &CompiledModel, topo: &T, node: NodeId, pattern: PatternId, domains: &mut DomainStore, queue: &mut PropQueue, trail: &mut Trail, metrics: &mut crate::wfc::diag::Metrics) -> Option<NodeId> {
        if !self.config.enabled {
            return None;
        }
...
fn force_exclude_and_propagate<T: Topology>(
    ...
    queue: &mut PropQueue,
    trail: &mut Trail,
    metrics: &mut crate::wfc::diag::Metrics,
    node: NodeId,
    pattern: PatternId,
    w: &WeightTable,
) -> Option<NodeId> {
...
mod tests {
    use super::*;
    use crate::wfc::diag::Metrics;
    use crate::wfc::model::ModelBuilder;
    use crate::wfc::topology::GraphTopologyBuilder;
    use crate::wfc::weights::WeightTable;
    ...
    fn no_arcs_topology(node_count: usize) -> crate::wfc::topology::GraphTopology {
    ...
    fn on_decision_detects_conflict_when_the_other_watch_was_already_resolved_true() {
        ...
        let mut singleton_p1 = crate::wfc::bitset::PatternSet::new_empty(3);
