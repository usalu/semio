...
//! [`crate::wfc::prop_ac3`] for identical results from identical starting domains (this crate's P6
//! gate). Wiring this engine into [`crate::wfc::search`]'s backtracking loop is deliberately deferred:
...
//! subtly wrong is exactly the class of bug this crate's own [`crate::wfc::search`] history already hit
...
#[allow(dead_code)] // exercised by this module's own differential tests today; wired into
                    // crate::wfc::search's runtime engine selection once trail-integrated rollback lands (see module docs)
...
mod tests {
    ...
    fn checkerboard(n: usize) -> (CompiledModel, crate::wfc::topology::GraphTopology, RelationId) {
    ...
    /// passes). [`crate::wfc::oracle::testgen::random_model`] does *not* guarantee this — it independently
    ...
    mod quick {
        ...
        fn ac3_and_ac4_reach_identical_fixed_points_on_random_instances() {
            ...
            for trial in 0..300 {
                ...
                // full-graph seeding crate::wfc::search performs at solve start, and necessary so both
