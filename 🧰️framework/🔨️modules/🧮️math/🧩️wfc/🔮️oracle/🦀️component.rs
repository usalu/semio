//! 🔮️ Brute-force reference solver. Deliberately shares no code with [`crate::wfc::propagate`]/
//! [`crate::wfc::search`] — a naive, obviously-correct DFS enumerator (with only per-step consistency
...
use crate::wfc::ids::{NodeId, PatternId, RelationId};
...
/// module's `#[cfg(test)] mod tests` can `use crate::wfc::oracle::testgen::*` once `cargo test` enables
/// `cfg(test)` crate-wide.
#[cfg(test)]
