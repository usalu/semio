...
//! `width × height × depth` bounding box, unlike `crate::wfc::grid3d::Grid3dTopology`) into a
//! [`crate::wfc::topology::GraphTopology`], emitting an arc between two occupied voxels only where
...
use crate::wfc::ids::{NodeId, RelationId};
use crate::wfc::topology::{GraphTopology, GraphTopologyBuilder};
...
impl SparseVolume {
    ...
    /// (e.g. from [`crate::wfc::grid3d::declare_stencil_relations_3d`]) — an arc is emitted from a
...
mod tests {
    use super::*;
    use crate::wfc::grid3d::{declare_stencil_relations_3d, Stencil3d};
