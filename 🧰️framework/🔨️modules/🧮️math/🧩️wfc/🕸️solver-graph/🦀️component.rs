...
//! wiring — every real behavior lives in [`crate::wfc::search`], [`crate::wfc::prop_ac3`], and friends;
//! this module only validates a model/topology pairing and forwards to the generic kernel.

use crate::wfc::beam::{self, BeamConfig};
...
use crate::wfc::parallel;
use crate::wfc::repair;
use crate::wfc::search::{self, CancelToken, SearchConfig};
use crate::wfc::topology::GraphTopology;
use crate::wfc::trail::Checkpoint;
...
impl GraphSolver {
    ...
    /// assignment). See [`crate::wfc::repair`]'s module docs for the exact contract — a returned
    ...
    /// [`crate::wfc::beam`]'s module docs for the (intentionally incomplete) guarantees. Ignores
    ...
    /// [`crate::wfc::parallel::multi_start`]'s docs for the exact reduction rule. Ignores constraints
...
mod tests {
    ...
    // End-to-end constraint wiring: unlike `crate::wfc::constraints_card`'s own tests (which exercise
    ...
    fn cardinality_constraint_forces_the_unique_matching_checkerboard_coloring() {
        use crate::wfc::constraint::PatternSelector;
        use crate::wfc::constraints_card::{CardinalityConstraint, Scope};
    ...
    fn flow_constraint_end_to_end_forces_a_connected_path_through_a_real_solve() {
        use crate::wfc::constraint::PatternSelector;
        use crate::wfc::flow::FlowConstraint;
        use crate::wfc::model::ModelBuilder;
        use crate::wfc::topology::GraphTopologyBuilder;
