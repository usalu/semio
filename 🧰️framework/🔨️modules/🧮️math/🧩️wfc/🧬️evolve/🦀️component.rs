...
//! scoring each via a caller-supplied [`crate::wfc::soft::SoftConstraint`] over the assignment
...
//! which it's "evolutionary" rather than just [`crate::wfc::soft::best_of_n`] repeated per
...
use crate::wfc::soft::{Attempt, SoftConstraint};
...
mod tests {
    ...
    use crate::wfc::soft::ScoreFn;
    use crate::wfc::topology::GraphTopologyBuilder;

    fn checkerboard(n: usize) -> (crate::wfc::model::CompiledModel, crate::wfc::topology::GraphTopology) {
        ...
        for i in 0..n.saturating_sub(1) {
            tb.arc(crate::wfc::ids::NodeId::from_index(i), crate::wfc::ids::NodeId::from_index(i + 1), adj);
            tb.arc(crate::wfc::ids::NodeId::from_index(i + 1), crate::wfc::ids::NodeId::from_index(i), adj);
        }
