...
use crate::wfc::constraint::ConstraintSet;
use crate::wfc::diag::{DiagLevel, Event, EventSink, Metrics};
...
/// 🌳️ Everything [`crate::wfc::solver_graph::GraphSolver`] (and later grid solvers) needs to configure
/// one solve.
...
pub struct SearchConfig {
    ...
    /// 🧠️ Opt-in nogood learning (see [`crate::wfc::nogood`]); disabled by default.
...
mod tests {
    ...
    fn checkerboard_topology(n: usize) -> (CompiledModel, crate::wfc::topology::GraphTopology, Vec<oracle::ArcSpec>) {
    ...
    fn golden_replay_same_seed_reproduces_the_identical_decision_trace() {
        ...
        use crate::wfc::diag::TraceReplay;
    ...
    fn nogood_learning_still_proves_unsat_on_pigeonhole_instance() {
        use crate::wfc::nogood::NogoodConfig;
