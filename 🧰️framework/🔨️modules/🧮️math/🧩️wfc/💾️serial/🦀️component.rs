...
//! [`SourceModelDoc`] always recompiles through [`crate::wfc::model::ModelBuilder`] (the exact same
...
//! [`crate::wfc::trail::Checkpoint`]. This is one of the few places outside `🦀️ids.rs` this crate derives
...
use crate::wfc::error::{ModelError, SolveError};
...
/// 💾️ A versioned, human-editable model schema — the input shape [`crate::wfc::model::ModelBuilder`]
/// consumes, not [`CompiledModel`]'s compiled bitset tables. Deliberately does not capture
/// [`crate::wfc::tiled::TiledModelBuilder`]'s higher-level socket/symmetry authoring (deferred; a tiled
...
mod tests {
    ...
    fn checkerboard() -> (CompiledModel, crate::wfc::topology::GraphTopology) {
        let mut b = ModelBuilder::new();
        ...
        tb.arc(crate::wfc::ids::NodeId(0), crate::wfc::ids::NodeId(1), adj);
        tb.arc(crate::wfc::ids::NodeId(1), crate::wfc::ids::NodeId(0), adj);
        tb.arc(crate::wfc::ids::NodeId(1), crate::wfc::ids::NodeId(2), adj);
        tb.arc(crate::wfc::ids::NodeId(2), crate::wfc::ids::NodeId(1), adj);
