...
use crate::wfc::outcome::SolveOutcome;
use crate::wfc::search::{self, SearchConfig};
use crate::wfc::topology::Topology;

// #region 🔖️Seed
/// 🧵️ Deterministically derives attempt `i`'s seed from `base_seed` — a single splitmix64-style
/// mixing step, not a call into `crate::random::Rng` (this only needs to be a fast,
...
mod tests {
    ...
    fn k_graph(n: usize, k: usize) -> (CompiledModel, crate::wfc::topology::GraphTopology) {
        let mut b = ModelBuilder::new();
