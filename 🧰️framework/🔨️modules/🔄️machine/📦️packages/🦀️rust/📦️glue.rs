...
// 🧬️ Crate declares async-fn-in-trait families (`Host`, `Inspector`, `Migration`, `ActorLogic`,
// `Configuration`, `StatechartEvent`, `Machine`, …). The lint's Send-erasure concern is answered
// structurally, not by bound — R3/R7.
