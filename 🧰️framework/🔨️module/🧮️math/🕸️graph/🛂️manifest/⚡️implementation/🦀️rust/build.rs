...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let generated = manifest_dir.join("../../../../🕸️graph/🛂️manifest/⚡️implementation/🦀️rust/🤖️generated/🦀️registry.rs");
    println!("cargo:rerun-if-changed={}", generated.display());
    println!("cargo:rerun-if-changed={}", manifest_dir.join("../../../../🕸️graph/🛂️manifest/⚡️implementation/🦀️rust/📜️script.ts").display());
