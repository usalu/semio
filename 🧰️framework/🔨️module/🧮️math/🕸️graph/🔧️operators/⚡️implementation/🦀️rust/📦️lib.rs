//! ➕️ Graph combination and transformation operators: union, products, complement, contractions, line graphs — NetworkX `operators` module parity, built generically over `mathematical_graph::Storage<P, D>`.
