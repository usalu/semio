#!/usr/bin/env bun
/** ⭐️ `@semio-tech/math-graph-centrality` — Node and edge centrality measures: betweenness, closeness, eigenvector, Katz, PageRank, HITS, and more. */
...
class TestScript extends BundleScript {
  run(segments: string[]): void {
    ...
    runCargoTestBudgeted(["mathematical_graph_centrality"], join(this.root, "rs"), rest);
  }
}

class LintScript extends BundleScript {
  run(): void {
    runCargoLint(["mathematical_graph_centrality"], join(this.root, "rs"));
  }
}
