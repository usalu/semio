#!/usr/bin/env bun
/** 🌊️ `@semio-tech/math-wfc` — Wave Function Collapse as a finite-domain constraint solver: one propagation/search kernel under three solvers (arbitrary graphs, dense 2D grids, dense 3D grids). */
