...
//! scoring each via a caller-supplied [`crate::soft::SoftConstraint`] over the assignment
...
//! which it's "evolutionary" rather than just [`crate::soft::best_of_n`] repeated per
...
use crate::soft::{Attempt, SoftConstraint};
