#!/usr/bin/env bun
/** 🌀️ `@semio-tech/math-entropy` — zero-dependency entropy and information-theory library: entropies, estimators, divergences, mutual information, information dynamics, streaming. */
