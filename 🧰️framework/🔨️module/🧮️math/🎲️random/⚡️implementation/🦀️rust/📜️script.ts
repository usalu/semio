#!/usr/bin/env bun
/** 🎲️ `@semio-tech/math-random` — Seeded, reproducible pseudo-random generation: xoshiro256** core, distributions, and sequence samplers shared by every randomized graph algorithm. */
