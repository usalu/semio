//! 📈️ Generic univariate and multivariate polynomials over the `mathematical_number` algebraic trait
...
// #region 🔖️Univariate
pub mod univariate {
//! 📈️ Dense univariate polynomials, generic over the `mathematical_number` ring hierarchy: arithmetic,
