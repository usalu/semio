...
export const UI_PRIMITIVES_ALLOWLIST: readonly string[] = [
  "✏️s/🔌️plugin/📐️cad/🔨️module/📺️renderer/⚡️implementation/🟦️typescript/📦️index.tsx",
...
const CHROME_I18N_SCANNED_ROOTS = [
  "🧰️framework/🔨️module/🖱️ui/⚛️react/⚡️implementation/🟦️typescript",
  "🧰️framework/🛍️product/💻️os/🔨️module/📺️renderer/🧑️‍🎨️engine/⚛️react/⚡️implementation/🟦️typescript",
