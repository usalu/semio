...
import type { BundleLinter } from "../../../../../../🧰️framework/🛍️product/🦑️repo/🔨️module/📚️lib/⚡️implementation/🟦️typescript/📦️index.ts";
import { dependencyBoundaryBreachesForBundleDir } from "../../../../../../🧰️framework/🛍️product/🦑️repo/🔨️module/📚️lib/⚡️implementation/🟦️typescript/📦️index.ts";
import { getWorkspaceRoot } from "../../../../../../🧰️framework/🛍️product/🦑️repo/🔨️module/📚️lib/⚡️implementation/🟦️typescript/📦️index.ts";
import { BundleScript, ScriptRouter, devToolingEnv, resolveTestLevel, runBundleScriptMain, runBunx, runCmd, runVitest } from "../../../../../../🧰️framework/🛍️product/🦑️repo/🔨️module/📚️lib/⚡️implementation/🟦️typescript/📦️index.ts";
...
export const UI_PRIMITIVES_ALLOWLIST: readonly string[] = [
  ...
  "compose/client/lib/sketchpad/js/🟦️boot.tsx",
...
/** 🔍️ Walks the repo tree for `.tsx`/`.jsx` raw-DOM-primitive and `component:` escape-hatch hits, keyed by file. */
...
/** 🔍️ Scans the fixed chrome-bearing file list for label-prop/label-field/fallback-literal/bare-JSX-text
