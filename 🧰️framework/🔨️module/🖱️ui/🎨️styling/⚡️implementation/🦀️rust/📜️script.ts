...
import { BundleScript, ScriptRouter, runBundleScriptMain, runVitest, getWorkspaceRoot } from "../../../../../../🧰️framework/🛍️product/🦑️repo/🔨️module/📚️lib/⚡️implementation/🟦️typescript/📦️index.ts";
import { parseUiTheme, resolveThemeMetrics, resolveThemePaint, type ThemePaintRef, type UiTheme } from "../../../🎨️styling/⚡️implementation/🟦️typescript/📦️index.ts";
...
function emitCSharp(tokens: Tokens): string {
  const lines: string[] = ["// <auto-generated />", "// Generated from framework/ui/styling/🔣️tokens.json — run `bun ./📜️script.ts generate`.", "using System;", "", "namespace Elements.Styling;", "", "public static class Palette", "{"];
  for (const [k, v] of Object.entries(tokens.colors)) {
