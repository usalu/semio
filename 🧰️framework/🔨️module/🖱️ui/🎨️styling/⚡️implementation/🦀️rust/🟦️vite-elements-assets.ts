...
export function semioFaviconSources(repoRoot: string): { readonly svg: string; readonly ico: string } {
  const logoRoot = resolve(repoRoot, "./🧰️framework/🔨️module/🖼️asset/⚡️implementation/🟦️typescript/🪧️logo");
  return {
...
export const PLAYGROUND_PLAY_STATIC_ASSETS: readonly Extract<PlaygroundAssetSpec, { kind: "static-dir" }>[] = [
  { kind: "static-dir", route: "/cad-fixture", root: "✏️s/🔌️plugin/📐️cad/🧫️fixture" },
  { kind: "static-dir", route: "/infinite-fixture", root: "./🧰️framework/🛍️product/💻️os/🔨️module/♾️infinite/🧫️fixture" },
];
...
if (import.meta.vitest) {
  ...
  describe("semioFaviconVitePlugin", () => {
    it("points at round dark emblem svg and ico under asset/logo", () => {
      ...
      expect(svg).toBe(resolve(repoRoot, "./🧰️framework/🔨️module/🖼️asset/⚡️implementation/🟦️typescript/🪧️logo/🔣️emblem_dark_round.svg"));
      expect(ico).toBe(resolve(repoRoot, "./🧰️framework/🔨️module/🖼️asset/⚡️implementation/🟦️typescript/🪧️logo/🖼️favicon_dark_round_32x32.ico"));
  ...
  describe("meshCollectionVitePlugin", () => {
    const puzzle3dMeshSpec: Extract<PlaygroundAssetSpec, { kind: "mesh-collection" }> = {
      ...
      route: "/mesh",
      roots: ["./🧰️framework/🔨️module/🖼️asset/⚡️implementation/🟦️typescript/🌱️metabolism/🎨️representation", "./♻️mit-bestand/🖼️asset/🏚️abbau-aufbau"],
