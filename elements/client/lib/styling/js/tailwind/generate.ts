#!/usr/bin/env bun
/** @emoji ⚙️ Reads `elements/core/styling/tokens.json` and writes Tailwind palette fragments + .NET `Palette.g.cs`. */
import { mkdirSync, readFileSync, writeFileSync } from "node:fs";
import { dirname, join } from "node:path";

const here = import.meta.dir;
const repoElements = join(here, "..", "..", "..", "..", "..");
const tokensPath = join(repoElements, "core", "styling", "tokens.json");
const stylingRoot = join(repoElements, "client", "lib", "styling");
const generatedDir = join(stylingRoot, "generated");
const netPaletteDir = join(repoElements, "..", "semio", "client", "lib", "net", "Elements.Styling", "Generated");
...
function emitPaletteFonts(tokens: Tokens): string {
  ...
  const lines: string[] = ["/* Generated from elements/core/styling/tokens.json — run `bun ./script.ts generate`. */"];
...
function emitPaletteTheme(tokens: Tokens): string {
  const lines: string[] = [
    "/* Generated from elements/core/styling/tokens.json — run `bun ./script.ts generate`. */",
    "@theme {",
...
function emitCSharpPalette(tokens: Tokens): string {
  const lines: string[] = [
    "// <auto-generated />",
    "// Generated from elements/core/styling/tokens.json — run `bun ./elements/client/lib/styling/script.ts generate`.",
...
if (import.meta.main) {
  ...
  console.log("elements styling: wrote generated CSS + Elements.Styling/Generated/Palette.g.cs");
}
