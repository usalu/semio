 ...
 **/
export type WindowLayout = WindowLayout;
...
//#endregion 📦workbench-mount.tsximport {
	CommandBus,
	Controller,
	Workbench,
	WorkbenchApp,
...
/** @emoji 🖼 Golden-layout shell: window layout, canvas portals, toolbar, search, and find palettes. */
