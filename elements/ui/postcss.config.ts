// #region 🔖Header
// [👤semio📚js⚙️postcssconfig](repo://p/u/semio/b/l/js/f/postcss.config.ts)
...
// [👤semio📚js⚙️postcssconfig🔖configuration](repo://p/u/semio/b/l/js/f/postcss.config.ts/s/Configuration)
...
// [👤semio📚js⚙️postcssconfig🔖configuration🪨config](repo://p/u/semio/b/l/js/f/postcss.config.ts/s/Configuration/d/i/config)
