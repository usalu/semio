// @emoji 🎨 Emits `OUT_DIR/elements_styling_board.rs` from `elements/core/styling/tokens.json` for Vello `Color` constants (included from `elements/client/lib/board/rs/build.rs`).
