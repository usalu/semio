//! 📜️ Shooting app — textual document grammar surface + laws (constitutional: dsl).

use shooting::ShootingFixture;

/// 🗄️ The base-icon example fixture, handcrafted in `shooting`'s DSL (`store::DocumentDsl`).
pub const SHOOTING_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🎥️shooting/📚️example/🎥️base-icon.shooting");
