//! 📜️ Mathematical app — textual document grammar surface + laws (constitutional: dsl).
//!
//! 🧭️ No external `.mathematical` fixture file has ever shipped for this app, so these laws stay
//! proven purely against inline-constructed fixtures (mirrors the original flattened `🔖️DslTests`).
