...
//#region 🔖️AppInstances
/// @emoji ✨️ Builds the `SpawnAppInstance` operation (minting a deterministic instance id + app-document id
...
//#endregion 🔖️AppInstances

//#region 🔖️MediaContractConnect
/// @emoji 🤝️ Resolves the source/target `OsMediaPort`s for a proposed connect from the live projection
