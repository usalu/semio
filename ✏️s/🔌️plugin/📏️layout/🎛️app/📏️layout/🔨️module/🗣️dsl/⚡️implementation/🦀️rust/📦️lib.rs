//! 📜️ Layout app — textual document grammar surface + laws (constitutional: dsl).

use layout::LayoutDocument;

/// 📄️ The bundled sample fixture, handcrafted in the `.layout` DSL.
pub const LAYOUT_SAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/📏️layout/📚️example/📏️sample.layout");
