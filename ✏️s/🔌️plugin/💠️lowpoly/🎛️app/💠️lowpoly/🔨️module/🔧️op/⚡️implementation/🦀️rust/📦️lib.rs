//! ⚡️ Lowpoly app — operation enum + laws (constitutional: op).
...
/// @emoji 📦️ A lowpoly diff is just the ordered list of operations it applies — replaying them over a cloned
