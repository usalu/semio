//! 📜️ Sourcing curate app — textual document grammar surface + laws (constitutional: dsl).

use sourcing::CurateDocument;

/// 📄️ The demo-stock example, handcrafted in the `.curate` DSL.
pub const DEMO_STOCK_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🪵️sourcing/📚️example/🗂️demo-stock.curate");

/// 📄️ The empty-curation example, handcrafted in the `.curate` DSL.
pub const EMPTY_CURATION_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🪵️sourcing/📚️example/🗂️empty-curation.curate");
