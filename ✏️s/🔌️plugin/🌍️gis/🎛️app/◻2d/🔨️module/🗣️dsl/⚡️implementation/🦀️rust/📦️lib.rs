//! 📜️ GIS 2D app — textual document grammar surface + laws (constitutional: dsl).

use gis2d::GisMapDocument;

/// 🗺️ The bundled "reuse map" example document, handcrafted in the `.gismap` DSL.
pub const REUSE_MAP_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🌍️gis/🎛️app/◻2d/⚡️implementation/🦀️rust/📚️example/🌍️reuse.map.gismap");
