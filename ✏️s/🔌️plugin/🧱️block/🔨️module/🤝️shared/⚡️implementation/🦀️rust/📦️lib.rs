//! 🤝️ Block plugin — record types shared by all three apps' entity (`rs`) crates (non-constitutional;
//! see the constitutional-split recipe's "shared code used by ≥2 apps" rule). Dimension-specific
//! nouns (handle/vortex/grip kinds and their placement templates) stay per-app — only the identity/
//! metadata/compatibility/representation shapes common to every dimension live here.
