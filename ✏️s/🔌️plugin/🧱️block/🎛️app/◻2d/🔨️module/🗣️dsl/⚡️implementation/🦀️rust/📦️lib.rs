...
pub const BLOCK2D_CONCRETE_FOREST_LEFT_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🧱️block/🎛️app/◻2d/⚡️implementation/🦀️rust/📚️example/🧱️hexagonal-cut-concrete-forest-left.block2d");
/// 📄️ The `hexagonal-cut-concrete-forest-right` example fixture, handcrafted in the `.block2d` DSL.
pub const BLOCK2D_CONCRETE_FOREST_RIGHT_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🧱️block/🎛️app/◻2d/⚡️implementation/🦀️rust/📚️example/🧱️hexagonal-cut-concrete-forest-right.block2d");
