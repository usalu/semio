...
pub const PROCESS_3D_TIMBER_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🏭️process/🎛️app/🧊️3d/⚡️implementation/🦀️rust/📚️example/🏭️timber-beam-joinery.process3d");

/// 🗄️ The drilled-plate example fixture, handcrafted in `process_3d`'s DSL (`store::DocumentDsl`).
pub const PROCESS_3D_PLATE_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🏭️process/🎛️app/🧊️3d/⚡️implementation/🦀️rust/📚️example/🏭️drilled-plate.process3d");
