...
//#region 🔖️Bundle
const MODULE_PLUGIN_ID: &str = "process-module-wood";
const HOST_APP_ID: &str = "process3d-play";

fn bundle() -> PluginBundle {
    let catalog = WoodCatalog;
    PluginBundle::new(MODULE_PLUGIN_ID, "Process Module Wood", "0.1.0").contributes(Contribution::ProcessMachines {
...
mod tests {
    ...
    #[test]
    fn bundle_contributes_wood_machines_for_process3d() {
