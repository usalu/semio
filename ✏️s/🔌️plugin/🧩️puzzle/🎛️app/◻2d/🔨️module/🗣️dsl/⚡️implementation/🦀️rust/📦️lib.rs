//! 📜️ Puzzle 2d app — textual document grammar surface + laws (constitutional: dsl).

use puzzle_2d::Puzzle2dProjection;

/// 📄️ The `concrete-forest` example fixture, handcrafted in the `.puzzle2d` DSL.
pub const PUZZLE2D_CONCRETE_FOREST_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🧩️puzzle/🎛️app/◻2d/⚡️implementation/🦀️rust/📚️example/🧩️concrete-forest.puzzle2d");
/// 📄️ The `nakagin-capsule-tower` example fixture, handcrafted in the `.puzzle2d` DSL.
pub const PUZZLE2D_NAKAGIN_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugin/🧩️puzzle/🎛️app/◻2d/⚡️implementation/🦀️rust/📚️example/🧩️nakagin-capsule-tower.puzzle2d");
