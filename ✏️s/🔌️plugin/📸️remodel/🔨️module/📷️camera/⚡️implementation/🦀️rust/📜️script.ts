#!/usr/bin/env bun
/** 📷️ `@semio-tech/remodel-camera` — Camera models and calibration: pinhole, Brown-Conrady and fisheye distortion, rolling shutter, rigs, planar and self-calibration. */
