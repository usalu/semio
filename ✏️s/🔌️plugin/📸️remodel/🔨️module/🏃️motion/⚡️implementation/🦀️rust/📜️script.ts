#!/usr/bin/env bun
/** 🏃️ `@semio-tech/remodel-motion` — Videogrammetry: multi-frame tracking, 3D trajectories, kinematics, vibration and modal analysis, camera sync, stabilization and non-rigid capture. */
