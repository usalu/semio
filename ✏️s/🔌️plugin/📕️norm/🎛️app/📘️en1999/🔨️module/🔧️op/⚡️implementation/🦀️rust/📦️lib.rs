//! ⚡️ EN 1999 app — operation type + family + laws (constitutional: op).
//!
...
//! impls are blanket ones bounded on `D: DocumentDsl`/`DocumentPack`, satisfied for free by `en1999`'s
...
impl NormFamily for En1999Family {
    ...
    fn evaluate(document: &Document) -> CheckReport {
        en1999_engine::evaluate(document)
    }
}
