...
function shippedModelDefinitionAssets(): ModelDefinitionAssetModules {
  ...
  shippedModelDefinitionAssetsCache = {
    typologies: import.meta.glob(["../../asset/modelDefinition/**/🔣️typology.json", "../../asset/modelDefinition/**/typology/*.json"], {
      eager: true,
      import: "default",
    ...
    manifests: import.meta.glob("../../asset/modelDefinition/**/🔣️modelDefinition.json", { eager: true, import: "default" }) as Record<string, unknown>,
    extensions: import.meta.glob("../../asset/modelDefinition/**/🔣️extension.json", { eager: true, import: "default" }) as Record<string, unknown>,
