//! 📐️ CAD scene document + typed VCS on `vcs`.
...
mod tests {
    ...
    fn interaction_spec_parses_box_asset() {
        let raw = include_str!("../../../../../../../✏️s/🔌️plugin/📐️cad/🖼️asset/🏗️modelDefinition/📐️spatial.shape/🎬️interaction/🔣️box.json");
    ...
    fn interaction_spec_parses_sphere_asset_with_command_finish() {
        let raw = include_str!("../../../../../../../✏️s/🔌️plugin/📐️cad/🖼️asset/🏗️modelDefinition/📐️spatial.shape/🎬️interaction/🔣️sphere.json");
    ...
    fn interaction_spec_parses_all_energy_and_structure_classic_assets() {
        let sources = [
            include_str!("../../../../../../../✏️s/🔌️plugin/📐️cad/🖼️asset/🏗️modelDefinition/🔥️aec.building.energy/🎬️interaction/🔣️constructBasePlate.json"),
            include_str!("../../../../../../../✏️s/🔌️plugin/📐️cad/🖼️asset/🏗️modelDefinition/🔥️aec.building.energy/🎬️interaction/🔣️constructExternalWall.json"),
            include_str!("../../../../../../../✏️s/🔌️plugin/📐️cad/🖼️asset/🏗️modelDefinition/🔥️aec.building.energy/🎬️interaction/🔣️constructHull.json"),
            include_str!("../../../../../../../✏️s/🔌️plugin/📐️cad/🖼️asset/🏗️modelDefinition/🔥️aec.building.energy/🎬️interaction/🔣️constructRoof.json"),
            include_str!("../../../../../../../✏️s/🔌️plugin/📐️cad/🖼️asset/🏗️modelDefinition/🔥️aec.building.energy/🎬️interaction/🔣️constructWindows.json"),
    ...
    fn every_interaction_asset_on_disk_parses_as_interaction_spec() {
        ...
        fn walk(dir: &std::path::Path, out: &mut Vec<std::path::PathBuf>) {
            ...
            for entry in entries.flatten() {
                ...
                if path.is_dir() {
                    walk(&path, out);
                } else if path.file_name().and_then(|n| n.to_str()).map(|n| n.ends_with(".json")).unwrap_or(false) && path.parent().and_then(|p| p.file_name()).and_then(|n| n.to_str()) == Some("🎬️interaction") {
                    out.push(path);
                }
            }
        }
    ...
    fn interaction_spec_guard_evaluates_against_context() {
        let raw = include_str!("../../../../../../../✏️s/🔌️plugin/📐️cad/🖼️asset/🏗️modelDefinition/🔥️aec.building.energy/🎬️interaction/🔣️constructExternalWall.json");
