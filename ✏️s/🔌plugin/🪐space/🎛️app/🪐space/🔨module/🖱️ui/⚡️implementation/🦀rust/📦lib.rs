        ...
        match action {
            ...
            "exportStudioPack" => {
                ...
                if let Some(document) = home_ui::resolve_studio_document(&space_id) {
                    // 📦 Whole-document pack<->dsl codec (`register_document_codec_for_app::<SpaceApp>`
...
mod tests {
    ...
    ///
    /// 🩹 Renamed from the pre-split monolith's mismatched pair: the harness fn was defined as
