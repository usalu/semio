//! 📜 EN 1994 design of composite steel and concrete structures — textual document grammar surface + laws (constitutional: dsl).
//!
//! 📄 No handcrafted `.en1994` DSL fixture exists for this app — the original monolith's own DSL law
//! test exercised only `Document::default()`, so that is the representative document here too.

use en1994::Document;

/// 📖 Parses `.en1994` DSL text into a `Document`.
