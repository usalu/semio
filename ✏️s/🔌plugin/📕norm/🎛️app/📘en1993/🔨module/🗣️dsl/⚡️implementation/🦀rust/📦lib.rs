//! 📜 EN 1993 design of steel structures — textual document grammar surface + laws (constitutional: dsl).
//!
//! 📄 No handcrafted `.en1993` DSL fixture exists for this app — the original monolith's own DSL law
//! test exercised only `Document::default()`, so that is the representative document here too.

use en1993::Document;

/// 📖 Parses `.en1993` DSL text into a `Document`.
