...
//#region 🔖Constants
/// 📄 The `semio` example document, handcrafted in the `.draw` DSL — {@link semio_draw_example_document}/
/// {@link semio_draw_example_json} are the only ways it should be consumed.
const SEMIO_DRAW_EXAMPLE_TEXT: &str = draw_dsl::SEMIO_DRAW_EXAMPLE_TEXT;
