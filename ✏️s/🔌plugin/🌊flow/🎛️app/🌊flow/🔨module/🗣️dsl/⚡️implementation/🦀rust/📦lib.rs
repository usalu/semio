...
/// tests parse via `include_str!("../../../../../../../../../🧰framework/🛍️product/💻os/🔨module/🌊flow/📚example/default.flow")`.
pub const FLOW_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../🧰framework/🛍️product/💻os/🔨module/🌊flow/📚example/default.flow");
