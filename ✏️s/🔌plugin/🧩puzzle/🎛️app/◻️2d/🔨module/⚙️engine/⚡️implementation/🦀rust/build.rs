//! @emoji 📎 Build script: metabolism SVG icon table for `include_str!`.
...
fn main() {
    ...
    let icons_src = manifest_dir.join("../../../../../../../../../🧰framework/🔨module/🖼️asset/⚡️implementation/🟦typescript/🌱metabolism/🔣icon");
