//! 📜 Block 3D app — textual document grammar surface + laws (constitutional: dsl).

use block_3d::Block3dDefinition;

/// 📄 The `nakagin-capsule` example fixture, handcrafted in the `.block3d` DSL — the `ObjectKind` half
/// of compose's metabolism-kit `Capsule` type.
pub const BLOCK3D_NAKAGIN_CAPSULE_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌plugin/🧱block/🎛️app/🧊3d/⚡️implementation/🦀rust/📚example/🧱nakagin-capsule.block3d");
/// 📄 The `hexagonal-cut-concrete-forest-left` example fixture, handcrafted in the `.block3d` DSL.
pub const BLOCK3D_CONCRETE_FOREST_LEFT_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌plugin/🧱block/🎛️app/🧊3d/⚡️implementation/🦀rust/📚example/🧱hexagonal-cut-concrete-forest-left.block3d");

/// 📖 Parses `.block3d` DSL text into a `Block3dDefinition`.
...
mod tests {
    ...
    pub fn nakagin_capsule() -> Block3dDefinition {
        ...
        definition.representations.push(BlockRepresentation { id: "r0".into(), name: "Full Detail".into(), mesh_url: Some("/mesh/🧊capsule_J.glb".into()), tags: vec!["full".into()], lod: Some("full".into()), description: String::new(), attributes: Vec::new() });
