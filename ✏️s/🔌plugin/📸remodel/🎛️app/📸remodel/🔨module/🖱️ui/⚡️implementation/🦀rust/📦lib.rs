//! 🏺 Remodel app — DocumentApp impl, render, manifest (constitutional: ui). Wires `remodel`'s
...
//! terminal one — uses `ActionEmit::amend` with the same key; see `🔖StagedReconstruction` for why
