// #region 🧲Header
/** @emoji 🎞 `@semio-tech/animate-present-core` — render-independent declarative presentation model. */
// #endregion 🧲Header
...
//#region 🔖Play
/** @emoji 🛝 Minimal play-app registration stub for presentation hosts. */
