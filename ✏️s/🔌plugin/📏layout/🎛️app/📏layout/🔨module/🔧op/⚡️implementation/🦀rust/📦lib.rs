...
//#region 🔖OpText
// 🔤 `LayoutOperation`'s `store::OpText`/`protocol::OpBinary` would normally come for free from
...
/// ⚡ DSL-only mirror of `LayoutOperation` — see this region's opening doc comment.
