...
export async function exportModelSpaceToDwg(space: ModelSpace, deflection = 0.1): Promise<Uint8Array> {
  ...
  const flowCore = (await import("../../../../../../../🧰framework/🛍️product/💻os/🔨module/🌊flow/🫀core/pkg/⚡️implementation/🦀rust/flow_core.js")) as { dwg_encode_mesh_json?: (meshJson: string) => string };
