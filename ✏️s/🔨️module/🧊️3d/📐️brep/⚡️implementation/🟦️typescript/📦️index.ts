...
export async function ensureBrepWasmLoaded(): Promise<BrepWasmModule> {
  ...
  const [{ default: initFlow, tessellate, dispose }, { default: wasmUrl }] = await Promise.all([import("../../../../../../🧰️framework/🛍️product/💻️os/🔨️module/🌊️flow/🫀️core/pkg/⚡️implementation/🦀️rust/flow_core.js"), import("../../../../../../🧰️framework/🛍️product/💻️os/🔨️module/🌊️flow/🫀️core/pkg/⚡️implementation/🦀️rust/flow_core_bg.wasm?url")]);
