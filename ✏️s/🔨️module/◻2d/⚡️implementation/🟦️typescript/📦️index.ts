...
/** @emoji 🌉️ Flow-core WASM bridge for drawing scene IO. */
...
/** @emoji 📐️ DWG serialization port for {@link DrawingScene}. */
export interface DrawingDwgExportPort {
  exportDwg(scene: DrawingScene): string;
}

/** @emoji 📄️ Default SVG export via WASM when a handle is provided, otherwise client scene walk. */
export interface DrawingExportBridge extends DrawingWasmBridge {
  exportPng(handle: DrawingRef | string): string;
}
// #endregion 📤️ExportPorts

// #region 🎨️CanvasRaster
...
/** @emoji 🔀️ Client-side boolean fallback when WASM is unavailable. */
...
export async function ensureDrawingWasmLoaded(): Promise<DrawingWasmModule> {
  ...
  if (import.meta.env.VITEST) {
    ...
    const mod = (await import("../../../../../🧰️framework/🛍️product/💻️os/🔨️module/🌊️flow/🫀️core/pkg/⚡️implementation/🦀️rust/flow_core.js")) as DrawingWasmModule;
  ...
  const [{ default: initFlow, render_drawing_scene, export_drawing_svg, export_drawing_pdf, dispose_drawing, trace_drawing_bitmap, boolean_drawing_segments, export_drawing_dwg, import_drawing_dwg }, { default: wasmUrl }] = await Promise.all([
    import("../../../../../🧰️framework/🛍️product/💻️os/🔨️module/🌊️flow/🫀️core/pkg/⚡️implementation/🦀️rust/flow_core.js"),
    import("../../../../../🧰️framework/🛍️product/💻️os/🔨️module/🌊️flow/🫀️core/pkg/⚡️implementation/🦀️rust/flow_core_bg.wasm?url"),
  ]);
...
/** @emoji 🔌️ Default drawing bridge via flow-core WASM + canvas PNG raster. */
