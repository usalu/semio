//! 📜️ Imperative app — textual document grammar surface + laws (constitutional: dsl).

use imperative::ImperativeDocument;

/// 📄️ The default `imperative` document, handcrafted in the `.imperative` DSL.
pub const IMPERATIVE_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/📜️imperative/📚️examples/📜️default.imperative");
