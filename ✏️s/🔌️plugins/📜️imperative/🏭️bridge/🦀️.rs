...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_imperative_procedure::standards::v1::subsets::any::schema::snapshot::ProcedureSnapshot, semio_s_artifact_imperative_procedure::standards::v1::subsets::any::schema::mutations::ProcedureMutation>,
];
