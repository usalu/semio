//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/📜️imperative`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("ImperativeConfigMutation", descriptors::<semio_s_artifact_imperative_procedure::editor::procedure::config::ImperativeConfig, semio_s_artifact_imperative_procedure::editor::procedure::config::ImperativeConfigMutation>),
    ("ProcedureMutation", descriptors::<semio_s_artifact_imperative_procedure::standards::v1::subsets::any::schema::snapshot::ProcedureSnapshot, semio_s_artifact_imperative_procedure::standards::v1::subsets::any::schema::mutations::ProcedureMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.imperative.procedure", "1", "any", "", "✏️s/🔌️plugins/📜️imperative/🗿️artifacts/📜️procedure/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.imperative.procedure", "1", "any", "✏️editor/🎚️config", "✏️s/🔌️plugins/📜️imperative/🗿️artifacts/📜️procedure/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎚️config", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-imperative-mutation-bridge")),
