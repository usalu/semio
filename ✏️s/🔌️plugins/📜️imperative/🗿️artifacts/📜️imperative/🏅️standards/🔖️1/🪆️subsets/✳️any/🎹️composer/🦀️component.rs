//! 🎹️ ImperativeComposer (1/✳️any) — analyzer + builder glued. Reads native `s.imperative` sources
//! plus any of: stdio.csv, stdio.json, stdio.md, stdio.txt. Writes one `s.imperative` (1/✳️any) snapshot.
...
use crate::artifacts::imperative::standards::v1::subsets::any::analyzer::ImperativeAnalyzer;
...
pub struct ImperativeComposer;

impl ArtifactComposer for ImperativeComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        ...
        Err(ComposeError { message: "ImperativeComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
