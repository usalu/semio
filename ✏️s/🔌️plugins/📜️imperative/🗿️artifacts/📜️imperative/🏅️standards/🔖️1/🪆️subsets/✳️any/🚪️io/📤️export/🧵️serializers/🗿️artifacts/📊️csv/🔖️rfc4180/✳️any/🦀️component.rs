...
pub async fn serialize(snapshot: &ImperativeSnapshot) -> Result<CsvSnapshot, store::TextError> {
    Ok(CsvSnapshot {
...
pub async fn serialize_bytes(snapshot: &ImperativeSnapshot) -> Result<Vec<u8>, store::TextError> {
