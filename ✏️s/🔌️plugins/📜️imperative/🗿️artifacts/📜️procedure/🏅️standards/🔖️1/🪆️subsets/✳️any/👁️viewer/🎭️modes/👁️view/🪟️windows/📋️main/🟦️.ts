/** 📋️ Imperative viewer — main (steps) window: typed twin of `🦀️.rs`'s `TableWindowKit`
 ...
 * (a bare `ProcedureSnapshot`, no runtime/config/utility state: a viewer has none of those). */
