//! 🧪️ `reorder-steps` fixture — `🚪️warns-that-an-over-clamped-index-leaves-the-tail-step-in-place`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-steps/🧪️warns-that-an-over-clamped-index-leaves-the-tail-step-in-place/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-steps/🧪️warns-that-an-over-clamped-index-leaves-the-tail-step-in-place/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-steps/🧪️warns-that-an-over-clamped-index-leaves-the-tail-step-in-place/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-steps/🧪️warns-that-an-over-clamped-index-leaves-the-tail-step-in-place/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-steps/🧪️warns-that-an-over-clamped-index-leaves-the-tail-step-in-place/🎯️outcome/🔣️.json");
