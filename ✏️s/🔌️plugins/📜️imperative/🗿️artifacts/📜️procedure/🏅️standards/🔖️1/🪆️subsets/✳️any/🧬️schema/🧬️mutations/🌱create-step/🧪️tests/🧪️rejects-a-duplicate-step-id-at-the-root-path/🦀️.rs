...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-step/🧪️rejects-a-duplicate-step-id-at-the-root-path/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-step/🧪️rejects-a-duplicate-step-id-at-the-root-path/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-step/🧪️rejects-a-duplicate-step-id-at-the-root-path/🦠️mutation/🔣️.json");
const ABSENT_DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-step/🧪️rejects-a-duplicate-step-id-at-the-root-path/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-step/🧪️rejects-a-duplicate-step-id-at-the-root-path/🎯️outcome/🔣️.json");
