 ...
 * binding, mirroring `🦀️.rs`'s `create_sequence_viewer()` stitching the mode/window module
 * together. Genuinely independent of the editor's own surface-root twin (`✏️editor/🟦️.ts`)
