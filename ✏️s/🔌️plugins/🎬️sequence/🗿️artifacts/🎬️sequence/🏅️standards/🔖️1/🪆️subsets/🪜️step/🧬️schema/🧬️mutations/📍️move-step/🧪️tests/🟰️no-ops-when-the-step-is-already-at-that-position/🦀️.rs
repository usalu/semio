...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️move-step/🟰️no-ops-when-the-step-is-already-at-that-position/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️move-step/🟰️no-ops-when-the-step-is-already-at-that-position/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️move-step/🟰️no-ops-when-the-step-is-already-at-that-position/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️move-step/🟰️no-ops-when-the-step-is-already-at-that-position/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️move-step/🟰️no-ops-when-the-step-is-already-at-that-position/🎯️outcome/🔣️.json");
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(outcome.get("status").and_then(serde_json::Value::as_str), Some("no-op"), "move-step/no-ops-when-the-step-is-already-at-that-position declares a no-op outcome");
