...
use crate::{SequenceEdge, SequenceHostSnapshot, SequenceSnapshot, SequenceStep};
...
pub struct SequenceDetectionContext<'a> {
    pub before: &'a SequenceHostSnapshot,
    pub after: &'a SequenceHostSnapshot,
...
pub fn sequence_snapshot_mutations(before: &SequenceHostSnapshot, after: &SequenceHostSnapshot) -> Vec<SequenceMutation> {
