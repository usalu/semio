//! 🧪️ `connect-steps` fixture — `🚫️rejects-connecting-a-step-to-itself`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-steps/🚫️rejects-connecting-a-step-to-itself/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-steps/🚫️rejects-connecting-a-step-to-itself/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-steps/🚫️rejects-connecting-a-step-to-itself/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-steps/🚫️rejects-connecting-a-step-to-itself/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-steps/🚫️rejects-connecting-a-step-to-itself/🎯️outcome/🔣️.json");
