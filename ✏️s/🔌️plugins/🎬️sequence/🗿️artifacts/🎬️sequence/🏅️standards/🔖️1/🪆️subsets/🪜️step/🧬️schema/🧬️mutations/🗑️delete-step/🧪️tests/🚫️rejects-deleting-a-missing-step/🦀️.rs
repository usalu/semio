...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-step/🚫️rejects-deleting-a-missing-step/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-step/🚫️rejects-deleting-a-missing-step/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-step/🚫️rejects-deleting-a-missing-step/🎯️outcome/🔣️.json");
