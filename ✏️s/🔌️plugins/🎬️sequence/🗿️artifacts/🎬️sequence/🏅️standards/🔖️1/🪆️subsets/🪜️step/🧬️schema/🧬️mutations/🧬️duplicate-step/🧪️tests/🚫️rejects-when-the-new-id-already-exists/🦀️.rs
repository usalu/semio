...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧬️duplicate-step/🚫️rejects-when-the-new-id-already-exists/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧬️duplicate-step/🚫️rejects-when-the-new-id-already-exists/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧬️duplicate-step/🚫️rejects-when-the-new-id-already-exists/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧬️duplicate-step/🚫️rejects-when-the-new-id-already-exists/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧬️duplicate-step/🚫️rejects-when-the-new-id-already-exists/🎯️outcome/🔣️.json");
