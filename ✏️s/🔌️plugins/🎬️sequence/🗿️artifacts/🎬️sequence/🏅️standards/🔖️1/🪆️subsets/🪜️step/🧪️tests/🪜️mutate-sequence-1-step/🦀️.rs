//! 🦀️ SEQUENCE step-vocabulary exhaustive mutation case — Rust adapter. Relocated out of the
...
//! `steps`' own kinds have a subset-owned test.
//!
...
//! shared `✏️s/🔌️plugins/🗄️stdio/🔮️oracles/⚖️law/🦀️.rs` module before it returns.
//!
...
/// build never links the subject crate. The contract's mutation-coverage gate keeps this list honest
/// against the catalog, and `kinds_match_the_enum_and_the_catalog` in the production module keeps it
