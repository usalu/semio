...
use crate::artifacts::sequence::{cache_sequence_content, SequenceSnapshot, SequenceStep};
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "edit-step-params/no-ops-when-the-params-are-already-identical: produced diff differs from the committed 🔺️diff/🔣️component.json");
