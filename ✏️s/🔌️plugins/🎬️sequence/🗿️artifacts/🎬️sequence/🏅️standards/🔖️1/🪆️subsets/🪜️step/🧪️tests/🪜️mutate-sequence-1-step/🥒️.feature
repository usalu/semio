...
Feature: Apply every typed SEQUENCE step mutation to the real committed step graph
  ...
  ⚠️ THIS NO-ORACLE DECISION IS A DEBT, NOT A VERDICT, and is recorded as one. `🐧️mutate-puzzle-2d-1` and
  `💎️mutate-puzzle-3d-1` took Python second implementations over this same `.dsl.semio` carrier in this
