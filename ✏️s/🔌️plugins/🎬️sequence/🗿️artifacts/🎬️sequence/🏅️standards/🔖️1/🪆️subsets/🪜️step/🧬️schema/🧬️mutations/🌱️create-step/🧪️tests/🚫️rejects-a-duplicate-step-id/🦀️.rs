//! 🧪️ `create-step` fixture — `🚫️rejects-a-duplicate-step-id`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱️create-step/🚫️rejects-a-duplicate-step-id/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱️create-step/🚫️rejects-a-duplicate-step-id/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱️create-step/🚫️rejects-a-duplicate-step-id/🦠️mutation/🔣️.json");
