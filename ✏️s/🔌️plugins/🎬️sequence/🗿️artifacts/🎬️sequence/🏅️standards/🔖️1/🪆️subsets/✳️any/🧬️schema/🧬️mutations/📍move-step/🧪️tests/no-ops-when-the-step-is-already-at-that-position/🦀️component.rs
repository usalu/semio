...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-step/no-ops-when-the-step-is-already-at-that-position: produced diff differs from the committed 🔺️diff/🔣️component.json");
