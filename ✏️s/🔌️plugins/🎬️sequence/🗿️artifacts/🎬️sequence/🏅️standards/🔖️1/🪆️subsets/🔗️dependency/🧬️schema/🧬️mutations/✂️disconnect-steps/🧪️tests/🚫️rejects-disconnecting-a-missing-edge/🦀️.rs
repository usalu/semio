//! 🧪️ `disconnect-steps` fixture — `🚫️rejects-disconnecting-a-missing-edge`.
//!
...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-steps/🚫️rejects-disconnecting-a-missing-edge/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-steps/🚫️rejects-disconnecting-a-missing-edge/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-steps/🚫️rejects-disconnecting-a-missing-edge/🎯️outcome/🔣️.json");
