//! 🔧 sequence artifact — OpText/OpBinary codecs + grammar for serializing `SequenceMutation`.
...
/// `SequenceMutation`'s own `#[derive(dsl::DslEnum)]`-generated `DslVariants` impl — every variant
