...
//! (`../../🏅️standards/🔖️1/🪆️subsets/✳️any/🔣️oracle.json`): `s.sequence.sequence` is a
...
const SEQUENCE_ASSET: &str = "asset://🏅️standards/🔖️1/🪆️subsets/✳️any/📚️examples/🎬️demo/🖼️assets/🗣️.dsl.semio";
...
mod subject {
    ...
    /// which is this subset's own convention — `🧬️mutations/🦀️.rs`'s `round_trip` test
