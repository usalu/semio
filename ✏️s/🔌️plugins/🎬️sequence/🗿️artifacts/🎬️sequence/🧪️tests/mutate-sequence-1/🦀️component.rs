//! 🦀️ SEQUENCE exhaustive mutation case — Rust adapter. Ticket
...
//! (`../../🏅️standards/🔖️1/🪆️subsets/✳️any/🧪️oracle/🔣️component.json`): `s.sequence.sequence` is a
...
//#region 🔖️Vocabulary
/// 🏷️ Mirrors `SequenceMutation::KINDS`
...
const KINDS: &[&str] = &["create-step", "delete-step", "move-step", "edit-step-params", "change-step-collapsed", "connect-steps", "disconnect-steps", "duplicate-step"];

/// 📄️ The plugin's own committed real sequence artifact, read where the domain already keeps it.
const SEQUENCE_ASSET: &str = "asset://🏅️standards/🔖️1/🪆️subsets/✳️any/📚️examples/🎬️demo/🖼️assets/🗣️example.dsl.semio";
...
mod subject {
    ...
    /// which is this subset's own convention — `🧬️mutations/🦀️component.rs`'s `round_trip` test
    /// helper reverses before replaying.
