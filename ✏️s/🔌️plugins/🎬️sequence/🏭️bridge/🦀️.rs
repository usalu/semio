...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_sequence_sequence::standards::v1::subsets::any::schema::snapshot::SequenceSnapshot, semio_s_artifact_sequence_sequence::standards::v1::subsets::any::schema::mutations::SequenceMutation>,
];
