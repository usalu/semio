//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🎬️sequence`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("SequenceMutation", descriptors::<semio_s_artifact_sequence_sequence::standards::v1::subsets::any::schema::snapshot::SequenceSnapshot, semio_s_artifact_sequence_sequence::standards::v1::subsets::any::schema::mutations::SequenceMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.sequence.sequence", "1", "dependency", "", "✏️s/🔌️plugins/🎬️sequence/🗿️artifacts/🎬️sequence/🏅️standards/🔖️1/🪆️subsets/🔗️dependency", ""),
    ("s.sequence.sequence", "1", "step", "", "✏️s/🔌️plugins/🎬️sequence/🗿️artifacts/🎬️sequence/🏅️standards/🔖️1/🪆️subsets/🪜️step", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-sequence-mutation-bridge")),
