    ...
    pub mod sequence {
        ...
        pub mod io {
            ...
            pub mod csv {
                #[path = "."]
                pub mod export {
                    #[path = "../../🗿️artifacts/🎬️sequence/🚪️io/📊️csv/📤️export/🦀️component.rs"]
                    mod component;
                    pub use component::*;
                }
                #[path = "."]
                pub mod import {
                    #[path = "../../🗿️artifacts/🎬️sequence/🚪️io/📊️csv/📥️import/🦀️component.rs"]
                    mod component;
                    pub use component::*;
                }
            }
            ...
            pub mod json {
                #[path = "."]
                pub mod export {
                    #[path = "../../🗿️artifacts/🎬️sequence/🚪️io/🔣️json/📤️export/🦀️component.rs"]
                    mod component;
                    pub use component::*;
                }
                #[path = "."]
                pub mod import {
                    #[path = "../../🗿️artifacts/🎬️sequence/🚪️io/🔣️json/📥️import/🦀️component.rs"]
                    mod component;
                    pub use component::*;
                }
            }
            ...
            pub mod md {
                #[path = "."]
                pub mod export {
                    #[path = "../../🗿️artifacts/🎬️sequence/🚪️io/📝️md/📤️export/🦀️component.rs"]
                    mod component;
                    pub use component::*;
                }
                #[path = "."]
                pub mod import {
                    #[path = "../../🗿️artifacts/🎬️sequence/🚪️io/📝️md/📥️import/🦀️component.rs"]
                    mod component;
                    pub use component::*;
                }
            }
