...
/// `mutate-curation-1`'s exhaustive case measures itself against. Three kinds and no more: `stock` is
...
mod tests {
    ...
    /// `KINDS` could drift from the enum and the catalog could keep measuring `mutate-curation-1`
