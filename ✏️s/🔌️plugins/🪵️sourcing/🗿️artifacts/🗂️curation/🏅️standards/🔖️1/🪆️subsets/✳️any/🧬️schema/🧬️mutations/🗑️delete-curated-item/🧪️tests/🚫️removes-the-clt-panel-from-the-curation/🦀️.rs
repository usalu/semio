...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-curated-item/🚫️removes-the-clt-panel-from-the-curation/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-curated-item/🚫️removes-the-clt-panel-from-the-curation/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-curated-item/🚫️removes-the-clt-panel-from-the-curation/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-curated-item/🚫️removes-the-clt-panel-from-the-curation/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-curated-item/🚫️removes-the-clt-panel-from-the-curation/🎯️outcome/🔣️.json");
