...
fn empty_view() -> (CurationSnapshot, HistoryView) {
    (CurationSnapshot::default(), HistoryView::empty())
}
...
fn load_document_pack(emit: &Emit<SourcingMutation, SourcingCurationConfigMutation>) -> CurationSnapshot {
