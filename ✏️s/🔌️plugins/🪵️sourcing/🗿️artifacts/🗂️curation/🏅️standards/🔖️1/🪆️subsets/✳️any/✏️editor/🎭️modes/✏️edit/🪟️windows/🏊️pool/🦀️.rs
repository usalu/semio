...
use crate::artifacts::curation::schema::{curated_count, filtered_stock};
use crate::artifacts::curation::{CurationSnapshot, Filters, SortDirection};
...
mod tests {
    ...
    async fn pool_render_respects_query_filter() {
        ...
        let view = pool_view(&document, &cfg, crate::editor::sourcing::terminology::sourcing_curation_labels(&SourcingCurationConfig::default()));
