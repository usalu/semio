//! 🪆️ Subset root for `s.sourcing.curate@1/*` (ticket 26/08/17/CLEAN-ARTIFACT-STANDARD-SUBSET-
...
use crate::artifacts::curate::standards::v1::subsets::any::{io, schema};
use crate::artifacts::curate::SOURCING_DIALECT;
