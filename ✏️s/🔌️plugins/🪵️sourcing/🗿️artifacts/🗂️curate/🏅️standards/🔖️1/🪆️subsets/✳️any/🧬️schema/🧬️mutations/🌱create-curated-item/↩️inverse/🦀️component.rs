...
//#region 🔖️Inverse
pub fn inverse(payload: &super::CreateCuratedItem, _base: &CurateSnapshot) -> Vec<SourcingMutation> {
    vec![crate::artifacts::curate::mutations::delete_curated_item::delete_curated_item(payload.item.object_id.clone())]
}
//#endregion 🔖️Inverse
