...
//!
//! The three semantic payloads are mounted from their direct mutation leaves in `📦️glue.rs`.
...
/// vocabulary the `curate-1-any` mutation catalog (`../../🧪️oracle/🔣️.json`) declares and
