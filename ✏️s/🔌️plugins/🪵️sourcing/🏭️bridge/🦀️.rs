...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_sourcing_curation::standards::v1::subsets::any::schema::snapshot::CurationSnapshot, semio_s_artifact_sourcing_curation::standards::v1::subsets::any::schema::mutations::SourcingMutation>,
];
