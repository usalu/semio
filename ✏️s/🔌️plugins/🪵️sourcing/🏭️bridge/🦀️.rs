//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🪵️sourcing`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("SourcingMutation", descriptors::<semio_s_artifact_sourcing_curation::standards::v1::subsets::any::schema::snapshot::CurationSnapshot, semio_s_artifact_sourcing_curation::standards::v1::subsets::any::schema::mutations::SourcingMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.sourcing.curation", "1", "any", "", "✏️s/🔌️plugins/🪵️sourcing/🗿️artifacts/🗂️curation/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-sourcing-mutation-bridge")),
