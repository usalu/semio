...
fn bundle() -> ExtensionBundle {
    ...
    let bundle = ExtensionBundle::new(EXTENSION_ID, "Sourcing Module Windows", env!("CARGO_PKG_VERSION")).extends("sourcing").depends_on("sourcing", semio_framework::tree_pin!());
