...
use sourcing_curation::artifacts::curation::schema::{beams::BeamsModule, SourcingModule};
...
fn bundle() -> ExtensionBundle {
    ...
    let bundle = ExtensionBundle::new(EXTENSION_ID, "Sourcing Module Beams", "0.1.0").extends("sourcing");
