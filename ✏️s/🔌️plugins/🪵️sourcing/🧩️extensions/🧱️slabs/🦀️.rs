...
use semio_s_artifact_sourcing_curation::schema::{slabs::SlabsModule, SourcingModule};
...
fn bundle() -> ExtensionBundle {
    ...
    let bundle = ExtensionBundle::new(EXTENSION_ID, "Sourcing Module Slabs", env!("CARGO_PKG_VERSION")).extends("sourcing").depends_on("sourcing", semio_framework::tree_pin!());
