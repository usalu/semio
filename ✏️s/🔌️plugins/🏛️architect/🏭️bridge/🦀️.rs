//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🏛️architect`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("ArchitectConfigMutation", descriptors::<semio_s_artifact_architect_program::editor::architect::config::ArchitectConfig, semio_s_artifact_architect_program::editor::architect::config::ArchitectConfigMutation>),
    ("ArchitectPresenceMutation", descriptors::<semio_s_artifact_architect_program::editor::architect::presence::ArchitectPresence, semio_s_artifact_architect_program::editor::architect::presence::ArchitectPresenceMutation>),
    ("ProgramMutation", descriptors::<semio_s_artifact_architect_program::standards::v1::subsets::any::schema::snapshot::ProgramSnapshot, semio_s_artifact_architect_program::standards::v1::subsets::any::schema::mutations::ProgramMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.architect.program", "1", "any", "", "✏️s/🔌️plugins/🏛️architect/🗿️artifacts/🏛️program/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.architect.program", "1", "any", "✏️editor/🎚️config", "✏️s/🔌️plugins/🏛️architect/🗿️artifacts/🏛️program/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎚️config", ""),
    ("s.architect.program", "1", "any", "✏️editor/👥️presence", "✏️s/🔌️plugins/🏛️architect/🗿️artifacts/🏛️program/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/👥️presence", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-architect-mutation-bridge")),
