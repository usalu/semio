...
pub mod artifacts {
    ...
    pub mod program {
        ...
        #[path = "🗿️artifacts/🏛️program/🦀️kernel.rs"]
        pub mod kernel;
        #[path = "🗿️artifacts/🏛️program/🦀️registers.rs"]
        pub mod registers;
        ...
        pub mod engine {
            ...
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️adjacency.rs"]
            pub mod adjacency;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️analyze.rs"]
            pub mod analyze;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️exchange.rs"]
            pub mod exchange;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️outputs.rs"]
            pub mod outputs;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️report.rs"]
            pub mod report;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️search.rs"]
            pub mod search;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️status_summary.rs"]
            pub mod status_summary;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️template.rs"]
            pub mod template;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️trace.rs"]
            pub mod trace;
            #[path = "🗿️artifacts/🏛️program/⚙️engine/🦀️validate.rs"]
            pub mod validate;
        }
    }
}
...
pub mod apps {
    ...
    pub mod architect {
        ...
        #[path = "🎛️apps/🏛️architect/🦀️config.rs"]
        pub mod config;
        #[path = "🎛️apps/🏛️architect/🦀️chrome.rs"]
        pub mod chrome;
        #[path = "🎛️apps/🏛️architect/🦀️catalog.rs"]
        pub mod catalog;
