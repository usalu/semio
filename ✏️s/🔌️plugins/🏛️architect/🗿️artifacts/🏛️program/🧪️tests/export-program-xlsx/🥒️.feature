...
Feature: Export every architect program table to a real XLSX workbook
  ...
  Scenario: A populated program remains visible to an independent spreadsheet reader
    Given the committed program snapshot asset://🏅️standards/🔖️1/🪆️subsets/✳️any/🧬️schema/🧬️mutations/🌱🧱create-program-element/🧪️tests/creates-program-element-a/📸️snapshot/➡️after/🔣️.json
