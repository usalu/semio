...
#[cfg(feature = "sut")]
const PROGRAM: &str = "asset://🏅️standards/🔖️1/🪆️subsets/✳️any/🧬️schema/🧬️mutations/🌱🧱create-program-element/🧪️tests/creates-program-element-a/📸️snapshot/➡️after/🔣️.json";
