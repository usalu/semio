...
extern crate self as semio_s_artifact_architect_program;
...
pub fn sample_plugin() -> ProgramSnapshot {
    ...
    let (a, b) = crate::standards::v1::subsets::any::schema::normalize_pair(&reception_id, &waiting_id);
...
mod tests {
    ...
    async fn architect_example_text_parses_to_sample_plugin_and_round_trips() {
        let parsed = ProgramSnapshot::parse_dsl(crate::document_dsl::ARCHITECT_EXAMPLE_TEXT).expect("parse bundled .architect example");
...
pub fn declaration() -> Result<semio_framework_plugin::ArtifactDeclaration, semio_framework_plugin::ArtifactDefinitionError> {
    semio_framework_plugin::ArtifactDeclaration::builder(definition()?)
        .schema(crate::schema::program_artifact_schema_descriptor())
        .inferences([crate::standards::v1::subsets::any::schema::inferences::program_artifact_inference_descriptor()])
