//! 🔺️ Diff fragment for `ComplianceRecords`.
...
pub struct ComplianceRecordsDiff { pub mutation: Option<ProgramMutation> }
impl ComplianceRecordsDiff {
    pub fn from_mutation(mutation: ProgramMutation) -> Self { Self { mutation: Some(mutation) } }
}
impl MutationDiff<Program> for ComplianceRecordsDiff {
