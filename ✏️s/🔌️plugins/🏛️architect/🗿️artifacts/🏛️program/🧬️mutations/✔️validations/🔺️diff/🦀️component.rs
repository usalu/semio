//! 🔺️ Diff fragment for `Validations`.
...
pub struct ValidationsDiff { pub mutation: Option<ProgramMutation> }
impl ValidationsDiff {
    pub fn from_mutation(mutation: ProgramMutation) -> Self { Self { mutation: Some(mutation) } }
}
impl MutationDiff<Program> for ValidationsDiff {
