//! 🔺️ Diff fragment for `UpdateGovernance`.
...
pub struct UpdateGovernanceDiff { pub mutation: Option<ProgramMutation> }
impl UpdateGovernanceDiff {
    pub fn from_mutation(mutation: ProgramMutation) -> Self { Self { mutation: Some(mutation) } }
}
impl MutationDiff<Program> for UpdateGovernanceDiff {
