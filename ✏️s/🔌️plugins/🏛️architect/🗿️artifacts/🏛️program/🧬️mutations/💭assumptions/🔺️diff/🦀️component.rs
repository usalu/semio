//! 🔺️ Diff fragment for `Assumptions`.
...
pub struct AssumptionsDiff { pub mutation: Option<ProgramMutation> }
impl AssumptionsDiff {
    pub fn from_mutation(mutation: ProgramMutation) -> Self { Self { mutation: Some(mutation) } }
}
impl MutationDiff<Program> for AssumptionsDiff {
