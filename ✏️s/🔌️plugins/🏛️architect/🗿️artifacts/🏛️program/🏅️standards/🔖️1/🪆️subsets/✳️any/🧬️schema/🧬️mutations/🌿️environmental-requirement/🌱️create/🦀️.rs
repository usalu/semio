...
impl MutationKind<ProgramSnapshot, ProgramMutation> for CreateEnvironmentalRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create environmental requirement \"{}\"", self.environmental_requirement.header.name), &format!("Umweltanforderung \"{}\" erstellen", self.environmental_requirement.header.name))
    }
