//! 🦠️ ProgramSnapshot mutation — `rename-benchmark-record` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameBenchmarkRecord {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename benchmark record to \"{}\"", self.new_name), &format!("Vergleichswertdatensatz in \"{}\" umbenennen", self.new_name))
    }
