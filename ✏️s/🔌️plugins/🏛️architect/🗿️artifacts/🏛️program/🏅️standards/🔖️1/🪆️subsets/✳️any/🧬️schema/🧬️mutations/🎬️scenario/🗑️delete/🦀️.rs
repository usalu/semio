//! 🦠️ ProgramSnapshot mutation — `delete-scenario` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteScenario {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete scenario \"{}\"", self.id.0), &format!("Szenario \"{}\" löschen", self.id.0))
    }
