//! 🦠️ ProgramSnapshot mutation — `delete-user-profile` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteUserProfile {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete user profile \"{}\"", self.id.0), &format!("Benutzerprofil \"{}\" löschen", self.id.0))
    }
