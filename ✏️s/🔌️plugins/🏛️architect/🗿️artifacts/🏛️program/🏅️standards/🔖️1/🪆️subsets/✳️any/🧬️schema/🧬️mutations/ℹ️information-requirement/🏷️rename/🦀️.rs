//! 🦠️ ProgramSnapshot mutation — `rename-information-requirement` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameInformationRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename information requirement to \"{}\"", self.new_name), &format!("Informationsanforderung in \"{}\" umbenennen", self.new_name))
    }
