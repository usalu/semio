//! 🦠️ ProgramSnapshot mutation — `rename-equipment` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameEquipment {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename equipment to \"{}\"", self.new_name), &format!("Ausstattung in \"{}\" umbenennen", self.new_name))
    }
