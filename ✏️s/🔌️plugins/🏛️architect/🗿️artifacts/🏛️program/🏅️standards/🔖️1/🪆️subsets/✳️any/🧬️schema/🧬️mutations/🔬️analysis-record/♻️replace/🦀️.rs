...
impl MutationKind<ProgramSnapshot, ProgramMutation> for ReplaceAnalysisRecord {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Replace analysis record \"{}\"", self.analysis_record.header.name), &format!("Analysedatensatz \"{}\" ersetzen", self.analysis_record.header.name))
    }
