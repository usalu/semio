//! 🧪️ `delete-benchmark-record` fixture — `🚫️absent-a`.
//!
...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/🗑️delete/🚫️absent-a/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/🗑️delete/🚫️absent-a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/🗑️delete/🚫️absent-a/🦠️mutation/🔣️.json");
const ABSENT: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/🗑️delete/🚫️absent-a/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/🗑️delete/🚫️absent-a/🎯️outcome/🔣️.json");

fn before() -> ProgramSnapshot {
    dsl::json::from_json_str(BEFORE).expect("delete-benchmark-record/rejects-deleting-absent-benchmark-record-a: before snapshot decodes")
}

fn expected_after() -> ProgramSnapshot {
    dsl::json::from_json_str(AFTER).expect("delete-benchmark-record/rejects-deleting-absent-benchmark-record-a: after snapshot decodes")
}
...
async fn delete_benchmark_record_committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: ProgramSnapshot = dsl::json::from_json_str(text).expect("delete-benchmark-record/rejects-deleting-absent-benchmark-record-a: snapshot decodes");
        let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&decoded)).expect("delete-benchmark-record/rejects-deleting-absent-benchmark-record-a: snapshot re-encodes");
