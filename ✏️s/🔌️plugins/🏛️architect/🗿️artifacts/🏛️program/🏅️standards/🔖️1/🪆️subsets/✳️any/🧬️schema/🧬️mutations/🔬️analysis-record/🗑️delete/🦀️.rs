//! 🦠️ ProgramSnapshot mutation — `delete-analysis-record` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteAnalysisRecord {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete analysis record \"{}\"", self.id.0), &format!("Analysendatensatz \"{}\" löschen", self.id.0))
    }
