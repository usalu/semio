...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameAccessibilityRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename accessibility requirement to \"{}\"", self.new_name), &format!("Barrierefreiheitsanforderung in \"{}\" umbenennen", self.new_name))
    }
