//! 🦠️ ProgramSnapshot mutation — `delete-operational-requirement` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteOperationalRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete operational requirement \"{}\"", self.id.0), &format!("Betriebsanforderung \"{}\" löschen", self.id.0))
    }
