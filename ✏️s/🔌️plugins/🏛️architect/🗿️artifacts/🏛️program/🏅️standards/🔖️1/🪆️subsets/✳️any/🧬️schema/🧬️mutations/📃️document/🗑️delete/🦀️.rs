//! 🦠️ ProgramSnapshot mutation — `delete-document` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteDocument {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete document \"{}\"", self.id.0), &format!("Dokument \"{}\" löschen", self.id.0))
    }
