//! 🦠️ ProgramSnapshot mutation — `rename-issue` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameIssue {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename issue to \"{}\"", self.new_name), &format!("Vorgang in \"{}\" umbenennen", self.new_name))
    }
