...
impl MutationKind<ProgramSnapshot, ProgramMutation> for CreateAnalysisRecord {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create analysis record \"{}\"", self.analysis_record.header.name), &format!("Analysedatensatz \"{}\" erstellen", self.analysis_record.header.name))
    }
