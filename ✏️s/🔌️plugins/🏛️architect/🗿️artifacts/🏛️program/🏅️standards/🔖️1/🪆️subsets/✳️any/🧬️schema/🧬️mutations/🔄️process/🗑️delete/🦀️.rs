//! 🦠️ ProgramSnapshot mutation — `delete-process` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteProcess {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete process \"{}\"", self.id.0), &format!("Prozess \"{}\" löschen", self.id.0))
    }
