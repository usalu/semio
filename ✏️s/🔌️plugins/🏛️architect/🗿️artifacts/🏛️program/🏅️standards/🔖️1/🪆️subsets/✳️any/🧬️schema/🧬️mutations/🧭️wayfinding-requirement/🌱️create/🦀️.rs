...
impl MutationKind<ProgramSnapshot, ProgramMutation> for CreateWayfindingRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create wayfinding requirement \"{}\"", self.wayfinding_requirement.header.name), &format!("Wegeführungsanforderung \"{}\" erstellen", self.wayfinding_requirement.header.name))
    }
