//! 🦠️ ProgramSnapshot mutation — `delete-conflict` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteConflict {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete conflict \"{}\"", self.id.0), &format!("Konflikt \"{}\" löschen", self.id.0))
    }
