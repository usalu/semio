...
impl MutationKind<ProgramSnapshot, ProgramMutation> for CreateStorageRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create storage requirement \"{}\"", self.storage_requirement.header.name), &format!("Speicheranforderung \"{}\" erstellen", self.storage_requirement.header.name))
    }
