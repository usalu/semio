...
use super::mutation::ReplaceFlowRequirement;
...
pub fn diff(payload: &ReplaceFlowRequirement, base: &ProgramSnapshot) -> ProgramDiff {
    ...
    ProgramDiff { flows: Some(ProgramFlowsDelta { patched: vec![ProgramFlowsPatchEntry { id: payload.flow_requirement.header.id.0.clone(), patch }], ..Default::default() }), ..Default::default() }
}
