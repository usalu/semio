//! 🦠️ ProgramSnapshot mutation — `rename-environmental-requirement` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameEnvironmentalRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename environmental requirement to \"{}\"", self.new_name), &format!("Umweltanforderung in \"{}\" umbenennen", self.new_name))
    }
