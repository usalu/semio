...
/// `🧱️block/◻2d` exemplar's own `🚪️io/🦀️component.rs`). The artifact root's OWN `io_registry`
/// shim (`✏️s/🔌️plugins/🏛️architect/🗿️artifacts/🏛️program/🦀️component.rs`) wraps this one behind a
