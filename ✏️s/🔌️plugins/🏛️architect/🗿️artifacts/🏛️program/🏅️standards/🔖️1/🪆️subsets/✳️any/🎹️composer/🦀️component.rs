//! 🎹️ ProgramComposer (1/✳️any) — analyzer + builder glued. Reads native `s.program` sources
//! plus any of: stdio.csv, stdio.json, stdio.txt, stdio.xlsx, stdio.zip. Writes one `s.program` (1/✳️any) snapshot.
...
use crate::artifacts::program::standards::v1::subsets::any::analyzer::ProgramAnalyzer;
...
impl ArtifactComposer for ProgramComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        ...
        Err(ComposeError { message: "ProgramComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
