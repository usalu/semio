...
use crate::registers::Relationship;
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for CreateRelationship {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create relationship \"{}\"", self.relationship.header.name), &format!("Beziehung \"{}\" erstellen", self.relationship.header.name))
    }
