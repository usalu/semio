//! 🧪️ `delete-site-context` fixture — `deletes-site-context-a`.
//!
//! Hand-authored source of truth is the JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below is transcribed from THIS
//! leaf's own `🔺️diff/🦀️component.rs`, which drops `site-context-a` from `program.site_context` as `removed = ["site-context-a"]`, after a target-missing guard.
//!
...
async fn delete_site_context_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-site-context/deletes-site-context-a: the diff delete-site-context builds differs from the committed 🔺️diff/🔣️component.json");
}
