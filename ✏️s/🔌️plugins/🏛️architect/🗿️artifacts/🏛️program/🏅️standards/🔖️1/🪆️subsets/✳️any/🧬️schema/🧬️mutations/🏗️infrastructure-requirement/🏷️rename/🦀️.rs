//! 🦠️ ProgramSnapshot mutation — `rename-infrastructure-requirement` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameInfrastructureRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename infrastructure requirement to \"{}\"", self.new_name), &format!("Infrastrukturanforderung in \"{}\" umbenennen", self.new_name))
    }
