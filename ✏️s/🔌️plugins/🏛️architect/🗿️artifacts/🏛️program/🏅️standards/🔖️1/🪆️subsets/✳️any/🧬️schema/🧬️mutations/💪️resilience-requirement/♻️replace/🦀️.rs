...
impl MutationKind<ProgramSnapshot, ProgramMutation> for ReplaceResilienceRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Replace resilience requirement \"{}\"", self.resilience_requirement.header.name), &format!("Resilienzanforderung \"{}\" ersetzen", self.resilience_requirement.header.name))
    }
