//! 🦠️ ProgramSnapshot mutation — `delete-constraint-record` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteConstraintRecord {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete constraint record \"{}\"", self.id.0), &format!("Randbedingungsdatensatz \"{}\" löschen", self.id.0))
    }
