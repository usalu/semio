//! 🦠️ ProgramSnapshot mutation — `delete-survey` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteSurvey {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete survey \"{}\"", self.id.0), &format!("Erhebung \"{}\" löschen", self.id.0))
    }
