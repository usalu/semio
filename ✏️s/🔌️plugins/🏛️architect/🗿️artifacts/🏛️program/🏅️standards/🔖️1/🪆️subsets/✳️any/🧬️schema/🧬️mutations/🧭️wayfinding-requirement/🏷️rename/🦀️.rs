//! 🦠️ ProgramSnapshot mutation — `rename-wayfinding-requirement` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameWayfindingRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename wayfinding requirement to \"{}\"", self.new_name), &format!("Wegeführungsanforderung in \"{}\" umbenennen", self.new_name))
    }
