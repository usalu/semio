//! 🧪️ `replace-benchmark-record` fixture — `🚫️absent-a`.
//!
...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/♻️replace/🚫️absent-a/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/♻️replace/🚫️absent-a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/♻️replace/🚫️absent-a/🦠️mutation/🔣️.json");
const ABSENT: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏁️benchmark-record/♻️replace/🚫️absent-a/🔺️diff/🚫️.absent");
...
async fn replace_benchmark_record_carries_the_absent_diff_marker() {
    assert!(ABSENT.is_empty(), "replace-benchmark-record/rejects-replacing-absent-benchmark-record-a: 🔺️diff/🚫️.absent must be an empty marker file");
}
