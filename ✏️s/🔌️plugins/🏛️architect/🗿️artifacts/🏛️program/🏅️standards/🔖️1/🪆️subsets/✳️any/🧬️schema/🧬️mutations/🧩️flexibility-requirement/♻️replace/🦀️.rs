...
use crate::registers::FlexibilityRequirement;
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for ReplaceFlexibilityRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Replace flexibility requirement \"{}\"", self.flexibility_requirement.header.name), &format!("Flexibilitätsanforderung \"{}\" ersetzen", self.flexibility_requirement.header.name))
    }
