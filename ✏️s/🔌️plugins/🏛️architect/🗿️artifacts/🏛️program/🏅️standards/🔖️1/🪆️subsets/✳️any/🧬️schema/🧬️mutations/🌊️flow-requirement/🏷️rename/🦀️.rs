//! 🦠️ ProgramSnapshot mutation — `rename-flow-requirement` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameFlowRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename flow requirement to \"{}\"", self.new_name), &format!("Flussanforderung in \"{}\" umbenennen", self.new_name))
    }
