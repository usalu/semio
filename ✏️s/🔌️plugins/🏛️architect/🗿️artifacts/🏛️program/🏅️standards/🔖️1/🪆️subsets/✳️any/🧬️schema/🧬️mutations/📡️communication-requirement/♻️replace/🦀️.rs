...
impl MutationKind<ProgramSnapshot, ProgramMutation> for ReplaceCommunicationRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Replace communication requirement \"{}\"", self.communication_requirement.header.name), &format!("Kommunikationsanforderung \"{}\" ersetzen", self.communication_requirement.header.name))
    }
