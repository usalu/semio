//! 🦠️ ProgramSnapshot mutation — `delete-option-evaluation` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteOptionEvaluation {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete option evaluation \"{}\"", self.id.0), &format!("Optionsbewertung \"{}\" löschen", self.id.0))
    }
