//! 🦠️ ProgramSnapshot mutation — `delete-infrastructure-requirement` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteInfrastructureRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete infrastructure requirement \"{}\"", self.id.0), &format!("Infrastrukturanforderung \"{}\" löschen", self.id.0))
    }
