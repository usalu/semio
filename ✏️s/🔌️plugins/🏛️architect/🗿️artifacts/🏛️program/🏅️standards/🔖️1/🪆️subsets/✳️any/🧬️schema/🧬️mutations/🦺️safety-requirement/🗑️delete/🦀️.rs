//! 🦠️ ProgramSnapshot mutation — `delete-safety-requirement` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteSafetyRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete safety requirement \"{}\"", self.id.0), &format!("Sicherheitsanforderung \"{}\" löschen", self.id.0))
    }
