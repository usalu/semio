...
impl MutationKind<ProgramSnapshot, ProgramMutation> for CreateValidationRecord {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create validation record \"{}\"", self.validation_record.header.name), &format!("Validierungsdatensatz \"{}\" erstellen", self.validation_record.header.name))
    }
