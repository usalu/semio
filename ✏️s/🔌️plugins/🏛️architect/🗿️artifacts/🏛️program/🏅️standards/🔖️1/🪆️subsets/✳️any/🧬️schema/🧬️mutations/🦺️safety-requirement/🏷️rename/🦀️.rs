//! 🦠️ ProgramSnapshot mutation — `rename-safety-requirement` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameSafetyRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename safety requirement to \"{}\"", self.new_name), &format!("Sicherheitsanforderung in \"{}\" umbenennen", self.new_name))
    }
