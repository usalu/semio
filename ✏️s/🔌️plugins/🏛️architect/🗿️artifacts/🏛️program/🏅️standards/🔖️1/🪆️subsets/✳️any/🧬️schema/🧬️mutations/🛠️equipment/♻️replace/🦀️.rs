...
impl MutationKind<ProgramSnapshot, ProgramMutation> for ReplaceEquipment {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Replace equipment \"{}\"", self.equipment.header.name), &format!("Ausstattung \"{}\" ersetzen", self.equipment.header.name))
    }
