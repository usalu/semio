//! 🦠️ ProgramSnapshot mutation — `rename-report-record` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameReportRecord {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename report record to \"{}\"", self.new_name), &format!("Berichtsdatensatz in \"{}\" umbenennen", self.new_name))
    }
