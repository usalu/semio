...
use crate::registers::ArtifactRecord;
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for CreateDocument {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create document \"{}\"", self.document.header.name), &format!("Dokument \"{}\" erstellen", self.document.header.name))
    }
