//! 🦠️ ProgramSnapshot mutation — `delete-program-element` leaf (delete). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for DeleteProgramElement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Delete program element \"{}\"", self.id.0), &format!("Programmelement \"{}\" löschen", self.id.0))
    }
