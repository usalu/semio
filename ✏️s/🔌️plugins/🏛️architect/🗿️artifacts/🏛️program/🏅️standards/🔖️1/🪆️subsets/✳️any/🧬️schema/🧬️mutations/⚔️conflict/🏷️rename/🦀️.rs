//! 🦠️ ProgramSnapshot mutation — `rename-conflict` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameConflict {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename conflict to \"{}\"", self.new_name), &format!("Konflikt in \"{}\" umbenennen", self.new_name))
    }
