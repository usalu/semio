//! 🦠️ ProgramSnapshot mutation — `rename-quantity-requirement` leaf (rename). Split from the
...
impl MutationKind<ProgramSnapshot, ProgramMutation> for RenameQuantityRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Rename quantity requirement to \"{}\"", self.new_name), &format!("Mengenanforderung in \"{}\" umbenennen", self.new_name))
    }
