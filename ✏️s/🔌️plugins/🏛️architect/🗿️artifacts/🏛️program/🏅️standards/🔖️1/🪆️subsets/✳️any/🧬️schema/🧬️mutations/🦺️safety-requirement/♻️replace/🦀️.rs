...
impl MutationKind<ProgramSnapshot, ProgramMutation> for ReplaceSafetyRequirement {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Replace safety requirement \"{}\"", self.safety_requirement.header.name), &format!("Sicherheitsanforderung \"{}\" ersetzen", self.safety_requirement.header.name))
    }
