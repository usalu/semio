...
use crate::apps::architect::modes::edit::windows::{adjacency, graph, register, report};
...
mod tests {
    ...
    #[test]
    fn the_default_layout_lists_the_four_edit_windows() {
    ...
    #[test]
    fn the_mode_is_the_pencil_edit_mode() {
