...
pub mod export_registers_csv {
    ...
    pub fn handle(_payload: &ExportRegistersCsv, doc: &DocumentView<'_, Program>, _cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
...
pub mod import_registers_csv {
    ...
    pub fn handle(payload: &ImportRegistersCsv, doc: &DocumentView<'_, Program>, _cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
...
pub mod export_program {
    ...
    pub fn handle(_payload: &ExportProgram, doc: &DocumentView<'_, Program>, _cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
        let program = doc.projection;
...
pub mod import_program_request {
    ...
    pub fn handle(_payload: &ImportProgramRequest, _doc: &DocumentView<'_, Program>, _cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
...
pub mod import_program {
    ...
    pub fn handle(payload: &ImportProgram, _doc: &DocumentView<'_, Program>, cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
        ...
        Ok(Emit { document_operations: vec![ProgramOperation::SetProgram { program: Box::new(next_program) }], config_operations: snapshot(next), ..Default::default() })
    }
}
