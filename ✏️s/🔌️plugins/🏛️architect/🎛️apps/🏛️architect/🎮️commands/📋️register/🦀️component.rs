...
pub mod select_register {
    ...
    pub fn handle(payload: &SelectRegister, _doc: &DocumentView<'_, Program>, cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
...
pub mod add_register_item {
    ...
    pub fn handle(payload: &AddRegisterItem, doc: &DocumentView<'_, Program>, cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
        ...
        Ok(Emit { document_operations: vec![operation], config_operations: snapshot(next), ..Default::default() })
    }
}
...
pub mod remove_register_item {
    ...
    pub fn handle(payload: &RemoveRegisterItem, doc: &DocumentView<'_, Program>, cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
        let program = doc.projection;
...
pub mod patch_register_item {
    ...
    pub fn handle(payload: &PatchRegisterItem, _doc: &DocumentView<'_, Program>, _cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramOperation, ArchitectConfigOperation>, Fault> {
