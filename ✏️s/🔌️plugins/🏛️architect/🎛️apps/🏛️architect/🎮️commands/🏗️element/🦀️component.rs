...
pub mod add_element {
    ...
    pub fn handle(payload: &AddElement, doc: &ArtifactView<'_, ProgramSnapshot>, cfg: &ConfigView<'_, ArchitectConfig>) -> Result<Emit<ProgramMutation, ArchitectConfigMutation>, Fault> {
        ...
        Ok(Emit {
            artifact_mutations: vec![ProgramMutation::Elements(CollectionMutation::Add { index: program.elements.len(), item: element })],
