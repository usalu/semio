/** ↩️ generation2d delete-widget inverse — mirrors `inverse()` (…/🗑️delete-widget/↩️inverse/🦀️.rs): recreates the removed widget at its captured BASE index, or a no-op when the id was already absent. */
