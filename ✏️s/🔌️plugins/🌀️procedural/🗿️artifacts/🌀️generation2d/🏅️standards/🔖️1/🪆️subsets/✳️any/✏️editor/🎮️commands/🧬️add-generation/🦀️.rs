...
pub fn handle(_payload: &AddGeneration, doc: &ArtifactView<'_, Generation2dSnapshot>, cfg: &ConfigView<'_, Generation2dConfig>, session: &mut FlowEvalSession) -> Result<Emit<Generation2dMutation, Generation2dConfigMutation>, Fault> {
...
mod tests {
    ...
    fn add_generation_records_an_undoable_generation_operation() {
        ...
        dispatch(&mut app, Generation2dCommand::AddGeneration(AddGeneration {}));
    ...
    fn generate_is_a_view_action_with_no_artifact_mutations() {
        ...
        dispatch(&mut app, Generation2dCommand::Generate(enter_generate::Generate {}));
