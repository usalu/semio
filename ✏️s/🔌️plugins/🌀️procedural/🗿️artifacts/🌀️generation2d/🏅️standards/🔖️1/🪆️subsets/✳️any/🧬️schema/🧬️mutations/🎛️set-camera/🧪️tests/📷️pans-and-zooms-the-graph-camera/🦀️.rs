//! 🧪️ `set-camera` fixture — `📷️pans-and-zooms-the-graph-camera`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️set-camera/📷️pans-and-zooms-the-graph-camera/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️set-camera/📷️pans-and-zooms-the-graph-camera/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️set-camera/📷️pans-and-zooms-the-graph-camera/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️set-camera/📷️pans-and-zooms-the-graph-camera/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️set-camera/📷️pans-and-zooms-the-graph-camera/🎯️outcome/🔣️.json");
...
fn applies_to_committed_after() {
    ...
    apply_generation2d_mutation(&mut snapshot, &mutation()).expect("set-camera applies to its committed before-snapshot");
...
fn declared_outcome_holds() {
    ...
    match status {
        "applied" => {
            ...
            assert_ne!(snapshot, base, "set-camera/pans-and-zooms-the-graph-camera: declared applied but the snapshot came back unchanged");
        }
        "rejected" => {
            assert_eq!(snapshot, base, "set-camera/pans-and-zooms-the-graph-camera: a rejected mutation must leave the snapshot untouched");
        }
