//! 👁️ Generation2d viewer — the `view` mode: a single full-pane Preview window, the read-only
...
pub const GENERATION2D_VIEW_MODE_VIEW: &str = "view";

//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::generation2d::create_generation2d_viewer`.
pub fn definition() -> ModeDefinition {
    ModeDefinition { id: GENERATION2D_VIEW_MODE_VIEW.into(), label: LocalizedLabel::native("View", "Ansicht"), icon_id: "eye".into(), tools: Vec::new(), layout_id: None, commands: Vec::new() }
}
