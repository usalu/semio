//! 🧪️ `connect-synapse` fixture — `🔗️joins-note-b-to-note-c-at-index-1`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-synapse/🔗️joins-note-b-to-note-c-at-index-1/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-synapse/🔗️joins-note-b-to-note-c-at-index-1/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-synapse/🔗️joins-note-b-to-note-c-at-index-1/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-synapse/🔗️joins-note-b-to-note-c-at-index-1/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-synapse/🔗️joins-note-b-to-note-c-at-index-1/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    match status {
        "applied" => {
            ...
            assert_ne!(snapshot, base, "connect-synapse/joins-note-b-to-note-c-at-index-1: declared applied but the snapshot came back unchanged");
        }
        "rejected" => {
            assert_eq!(snapshot, base, "connect-synapse/joins-note-b-to-note-c-at-index-1: a rejected mutation must leave the snapshot untouched");
        }
