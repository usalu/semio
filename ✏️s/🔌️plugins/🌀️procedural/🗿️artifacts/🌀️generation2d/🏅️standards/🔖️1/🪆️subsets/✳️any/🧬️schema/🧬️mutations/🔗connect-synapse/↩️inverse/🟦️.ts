/** ↩️ generation2d connect-synapse inverse — mirrors `inverse()` (…/🔗connect-synapse/↩️inverse/🦀️.rs): always one `disconnect-synapse` for the created edge's id (no BASE lookup needed). */
