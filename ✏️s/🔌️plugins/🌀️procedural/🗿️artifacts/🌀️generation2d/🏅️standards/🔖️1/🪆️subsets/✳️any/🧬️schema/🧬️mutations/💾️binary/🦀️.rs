...
impl Generation2dRetainedMutationOwner {
    ...
    fn finish_widget(owner: Generation2dMutationWidgetOwner) -> Result<semio_framework_artifact_flow_flow::Widget, &'static str> {
    ...
    fn begin_record(&mut self) -> Result<(), &'static str> {
        ...
        let frame = match self.stack.last_mut() {
            ...
            _ => match (self.ordinal, root) {
                ...
                (6, Some(1)) => Generation2dMutationFrame::Layout { field: None, value: semio_framework_artifact_flow_flow::WidgetLayout { x: 0.0, y: 0.0 } },
                (8, Some(0)) => Generation2dMutationFrame::Camera { field: None, value: semio_framework_artifact_flow_flow::CameraJson::default() },
...
struct Generation2dPackSnapshotAuthority {
    ...
    relative: usize,
    high: Option<u8>,
    session: std::mem::ManuallyDrop<Option<crate::standards::v1::subsets::any::schema::snapshot::binary::Generation2dMountedPackSession>>,
    value: std::mem::ManuallyDrop<Option<Generation2dSnapshot>>,
...
fn generation2d_copy_neural_value(source: &semio_framework_artifact_flow_flow::neural::Value, depth: usize) -> Result<semio_framework_artifact_flow_flow::neural::Value, &'static str> {
    if depth >= GENERATION2D_RETAINED_STACK_CAPACITY {
...
fn generation2d_copy_dictionary(source: &semio_framework_artifact_flow_flow::neural::Dictionary, depth: usize) -> Result<semio_framework_artifact_flow_flow::neural::Dictionary, &'static str> {
...
fn generation2d_copy_tree(source: &semio_framework_artifact_flow_flow::neural::Tree, depth: usize) -> Result<semio_framework_artifact_flow_flow::neural::Tree, &'static str> {
    if depth >= GENERATION2D_RETAINED_STACK_CAPACITY {
...
fn generation2d_copy_flow_ui(source: &semio_framework_artifact_flow_flow::FlowGui) -> Result<semio_framework_artifact_flow_flow::FlowGui, &'static str> {
...
fn generation2d_copy_widget(source: &semio_framework_artifact_flow_flow::Widget) -> Result<semio_framework_artifact_flow_flow::Widget, &'static str> {
    Ok(match source {
...
fn generation2d_copy_synapse(source: &semio_framework_artifact_flow_flow::SynapseSpec) -> Result<semio_framework_artifact_flow_flow::SynapseSpec, &'static str> {
    ...
    fn step(&mut self, source: &Generation2dSnapshot, digest: &mut store::ArtifactStoreInitializationDigest) -> Result<bool, &'static str> {
        ...
        match self.phase {
            ...
            6 if self.index < source.fixture.layout.len() => {
                ...
                target.fixture.layout.insert(generation2d_copy_string(id)?, semio_framework_artifact_flow_flow::WidgetLayout { x: layout.x, y: layout.y });
