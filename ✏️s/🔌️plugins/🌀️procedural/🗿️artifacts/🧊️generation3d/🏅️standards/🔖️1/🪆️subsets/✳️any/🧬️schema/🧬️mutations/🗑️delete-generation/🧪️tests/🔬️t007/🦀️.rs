//! 🧪️ `delete-generation` fixture — `🚫️removes-the-selected-generation-2-and-falls-back`.
//!
...
fn applies_to_committed_after() {
    ...
    apply_generation3d_mutation(&mut snapshot, &mutation()).expect("delete-generation applies to its committed before-snapshot");
