...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-widget-position/🧹️unpins-the-node-a-position/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-widget-position/🧹️unpins-the-node-a-position/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-widget-position/🧹️unpins-the-node-a-position/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-widget-position/🧹️unpins-the-node-a-position/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-widget-position/🧹️unpins-the-node-a-position/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    match status {
        "applied" => {
            ...
            assert_ne!(snapshot, base, "delete-widget-position/unpins-the-node-a-position: declared applied but the snapshot came back unchanged");
        }
        "rejected" => {
            assert_eq!(snapshot, base, "delete-widget-position/unpins-the-node-a-position: a rejected mutation must leave the snapshot untouched");
        }
