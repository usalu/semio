...
pub fn diff(payload: &ConnectSynapse, base: &Generation3dSnapshot) -> protocol::MutationOutcome<Generation3dDiff> {
    ...
    if widget_index(&base.host_document, &payload.synapse.to).is_none() {
