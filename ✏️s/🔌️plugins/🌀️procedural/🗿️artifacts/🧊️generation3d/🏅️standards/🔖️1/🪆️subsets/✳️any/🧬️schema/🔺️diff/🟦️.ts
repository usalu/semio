/** 🧬️ Generation3d diff schema — sparse field delta. */

export interface Generation3dDiff {
  /** @state artifact */
  artifact?: Generation3dArtifact;
  /** @state artifact */
  fixture?: FlowFixture;
  /** @state artifact */
...
export interface Generation3dArtifact { /* see artifact facet */ }
