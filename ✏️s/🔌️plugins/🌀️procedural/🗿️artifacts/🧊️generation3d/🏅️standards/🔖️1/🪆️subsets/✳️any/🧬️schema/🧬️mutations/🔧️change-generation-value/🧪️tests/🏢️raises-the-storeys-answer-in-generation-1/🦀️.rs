...
fn declared_outcome_holds() {
    ...
    match status {
        "applied" => {
            ...
            assert_ne!(snapshot, base, "change-generation-value/raises-the-storeys-answer-in-generation-1: declared applied but the snapshot came back unchanged");
        }
        "rejected" => {
            assert_eq!(snapshot, base, "change-generation-value/raises-the-storeys-answer-in-generation-1: a rejected mutation must leave the snapshot untouched");
        }
