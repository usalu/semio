...
fn vector(kind: &str) -> Result<Vector, String> {
    Ok(match kind {
        "set-show-mode" => Vector {
            before: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/👁️set-show-mode/✅️set-show-mode-applied/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/👁️set-show-mode/✅️set-show-mode-applied/🦠️mutation/🔣️.json"),
            after: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/👁️set-show-mode/✅️set-show-mode-applied/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/👁️set-show-mode/✅️set-show-mode-applied/🔺️diff/🔣️.json"),
            outcome: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/👁️set-show-mode/✅️set-show-mode-applied/🎯️outcome/🔣️.json"),
            observable: true,
        },
        "set-preview-camera" => Vector {
            before: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/📷️set-preview-camera/✅️set-preview-camera-applied/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/📷️set-preview-camera/✅️set-preview-camera-applied/🦠️mutation/🔣️.json"),
            after: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/📷️set-preview-camera/✅️set-preview-camera-applied/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/📷️set-preview-camera/✅️set-preview-camera-applied/🔺️diff/🔣️.json"),
            outcome: include_str!("../../👁️viewer/👥️presence/🧫️fixtures/📷️set-preview-camera/✅️set-preview-camera-applied/🎯️outcome/🔣️.json"),
            observable: true,
        },
...
mod subject {
    ...
    fn report(committed: &Vector) -> Result<String, String> {
        generation3d_view_presence_mutation_report_json(committed.before, committed.mutation, committed.after)
    }
