...
fn declared_outcome_holds() {
    ...
    match status {
        "applied" => {
            ...
            assert_ne!(snapshot, base, "delete-generation/removes-the-selected-generation-2-and-falls-back: declared applied but the snapshot came back unchanged");
        }
        "rejected" => {
            assert_eq!(snapshot, base, "delete-generation/removes-the-selected-generation-2-and-falls-back: a rejected mutation must leave the snapshot untouched");
        }
