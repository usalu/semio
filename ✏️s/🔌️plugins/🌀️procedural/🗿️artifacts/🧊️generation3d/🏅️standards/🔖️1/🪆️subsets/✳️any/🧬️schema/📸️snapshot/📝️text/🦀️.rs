...
fn generation3d_document_from_dsl(parsed: Generation3dSnapshotDsl) -> Result<Generation3dSnapshot, store::TextError> {
...
pub fn parse_dsl(text: &str) -> Result<Generation3dSnapshot, store::TextError> {
