...
//#region 🔖️Render
pub fn render(fixture: &FlowHostDocument, generation: &GenerationPlayState, selected_id: Option<&str>, labels: &Generation3dLabels) -> semio_framework_plugin::UiAssemblyResult<BuiltNode> {
