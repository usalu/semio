/** ↩️ procedural2d move-widget inverse — mirrors `inverse()` (…/📍move-widget/↩️inverse/🦀️.rs): moves back to the captured BASE layout when the widget already had one, or clears the layout entry entirely when this move is what created it. */
