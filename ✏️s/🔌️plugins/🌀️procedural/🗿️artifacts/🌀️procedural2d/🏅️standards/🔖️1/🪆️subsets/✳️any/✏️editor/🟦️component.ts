 ...
 * `🦀️component.rs`'s `create_procedural2d_app()` stitching every window/mode module together. */
...
export * as editPreviewWindow from "./🎭️modes/✏️edit/🪟️windows/👁️preview/🟦️component";
