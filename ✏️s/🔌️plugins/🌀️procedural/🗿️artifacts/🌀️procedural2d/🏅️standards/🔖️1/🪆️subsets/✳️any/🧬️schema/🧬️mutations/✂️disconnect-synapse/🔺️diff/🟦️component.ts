/** 🔺️ procedural2d disconnect-synapse diff — mirrors `diff()` (…/✂️disconnect-synapse/🔺️diff/🦀️component.rs), a sparse id-keyed removal from the fixture's synapse collection. */
