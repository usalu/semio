/** 🔺️ procedural2d clear-widget-layout diff — mirrors `diff()` (…/🧹clear-widget-layout/🔺️diff/🦀️component.rs), a sparse id-keyed removal from the fixture's layout collection. */
