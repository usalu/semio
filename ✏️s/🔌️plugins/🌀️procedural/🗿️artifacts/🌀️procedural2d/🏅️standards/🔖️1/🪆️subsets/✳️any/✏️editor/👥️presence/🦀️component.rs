...
impl protocol::MutationDiff<Procedural2dPresence> for Procedural2dPresence {
    fn apply(&self, _base: &Procedural2dPresence) -> protocol::MutationApplyResult<Procedural2dPresence> {
        Ok(self.clone())
    }
...
impl Mutation<Procedural2dPresence> for Procedural2dPresenceMutation {
    ...
    const DESCRIPTORS: &'static [protocol::MutationLeafDescriptor] = &[
        protocol::MutationLeafDescriptor { schema_version: 1, owner: "✏️s/🔌️plugins/🌀️procedural/🗿️artifacts/🌀️procedural2d/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/👥️presence/👥️set-snapshot", semantic_kind: "set-snapshot", display_name: "Set Snapshot", emoji: "👥️", aggregate_variant: "Snapshot", payload_schema: "🔣️payload.schema.json", text_opcode: None, binary_tag: None, invertibility: protocol::MutationInvertibility::ExplicitMutation, diff_participation: protocol::MutationDiffParticipation::Detect, outcome_classes: &[protocol::MutationOutcomeClass::Applied], composition: protocol::MutationComposition::Atomic, required_language_surfaces: &[protocol::MutationLanguageSurface::Rust, protocol::MutationLanguageSurface::JsonSchema] },
    ];

    fn descriptor(&self) -> &'static protocol::MutationLeafDescriptor {
        match self {
            Procedural2dPresenceMutation::Snapshot { .. } => &Self::DESCRIPTORS[0],
        }
    }

    type Diff = Procedural2dPresence;

    fn diff(&self, _base: &Procedural2dPresence) -> protocol::MutationOutcome<Procedural2dPresence> {
        match self {
