/** ↩️ procedural2d clear-widget-layout inverse — mirrors `inverse()` (…/🧹clear-widget-layout/↩️inverse/🦀️.rs): restores the captured BASE layout entry, or a no-op when the widget already had none. */
