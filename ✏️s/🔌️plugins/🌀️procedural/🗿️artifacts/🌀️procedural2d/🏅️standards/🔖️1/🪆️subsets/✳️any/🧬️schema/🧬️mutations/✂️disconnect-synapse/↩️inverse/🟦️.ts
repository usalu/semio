/** ↩️ procedural2d disconnect-synapse inverse — mirrors `inverse()` (…/✂️disconnect-synapse/↩️inverse/🦀️.rs): reconnects the removed edge at its captured BASE index, or a no-op when the id was already absent. */
