...
pub fn generation_mutation_to_procedural2d(operation: GenerationMutation) -> Procedural2dMutation {
    match operation {
        GenerationMutation::Add { generation } => Procedural2dMutation::CreateGeneration(super::create_generation::CreateGeneration { generation }),
        GenerationMutation::Remove { id } => Procedural2dMutation::DeleteGeneration(super::delete_generation::DeleteGeneration { id }),
        GenerationMutation::Rename { id, name } => Procedural2dMutation::RenameGeneration(super::rename_generation::RenameGeneration { id, name }),
        GenerationMutation::UpdateValues { id, question_id, value } => Procedural2dMutation::ChangeGenerationValue(super::change_generation_value::ChangeGenerationValue { id, question_id, value }),
    }
}
