/** ↩️ procedural2d create-widget inverse — mirrors `inverse()` (…/🌱create-widget/↩️inverse/🦀️.rs): always one `delete-widget` for the created widget's id, read off the payload's own JSON-blob widget (no BASE lookup needed). */
