/** ↩️ procedural2d update-camera inverse — mirrors `inverse()` (…/🎛set-camera/↩️inverse/🦀️.rs): unconditionally restores the captured BASE camera (the camera field always exists). */
