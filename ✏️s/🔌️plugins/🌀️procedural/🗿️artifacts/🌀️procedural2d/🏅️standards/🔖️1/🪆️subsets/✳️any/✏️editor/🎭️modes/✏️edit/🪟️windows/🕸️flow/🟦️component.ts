/** 🕸️ Procedural2d editor — Flow window: typed twin of `🦀️component.rs`'s view-model. Mirrors the
 ...
 * carries (absent from the viewer's read-only twin, see `👁️viewer/…/🟦️component.ts`). */
