/** 🌳️ Assembly viewer — `structure` window: typed twin of `🦀️component.rs`'s `TreeWindowKit`
 * view-model. Read-only counterpart of `✏️editor/…/🌳️structure/🟦️component.ts`: no command payload
