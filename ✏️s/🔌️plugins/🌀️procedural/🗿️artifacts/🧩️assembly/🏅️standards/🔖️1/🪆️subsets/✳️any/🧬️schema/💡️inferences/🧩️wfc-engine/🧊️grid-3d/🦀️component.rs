//! 🧊️ Dense 3D grid topology: the exact 2D design of [`crate::wfc_engine::grid2d`] extended to a third axis
//! (same arithmetic-neighbor, zero-adjacency-storage approach, same [`crate::wfc_engine::grid2d::Boundary`]
...
use crate::wfc_engine::grid2d::{resolve_coord, Boundary};
