...
//! never [`crate::wfc_engine::error`] variants — a search finding no solution is not a bug.

use crate::wfc_engine::bitset::PatternSet;
use crate::wfc_engine::diag::{Event, Metrics};
...
pub enum SolveOutcome {
    ...
    /// 🏁️ A caller-supplied [`crate::wfc_engine::search::CancelToken`] was set before the attempt concluded.
    Cancelled {
        partial: PartialState,
        report: RunReport,
    },
