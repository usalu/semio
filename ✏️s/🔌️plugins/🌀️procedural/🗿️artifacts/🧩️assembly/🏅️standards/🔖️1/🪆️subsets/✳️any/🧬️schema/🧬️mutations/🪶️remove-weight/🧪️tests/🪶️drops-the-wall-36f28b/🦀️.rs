//! 🧪️ `remove-weight` fixture — `🪶️drops-the-wall-module-weight-override`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-weight/drops-the-wall-module-weight-override: produced diff differs from the committed 🔺️diff/🔣️.json");
}
