//! 🧪️ `connect-slots` fixture — `🔗️joins-slot-b-to-slot-c-at-index-1`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-slots/🔗️joins-slot-b-to-slot-c-at-index-1/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-slots/🔗️joins-slot-b-to-slot-c-at-index-1/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-slots/🔗️joins-slot-b-to-slot-c-at-index-1/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-slots/🔗️joins-slot-b-to-slot-c-at-index-1/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️connect-slots/🔗️joins-slot-b-to-slot-c-at-index-1/🎯️outcome/🔣️.json");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "connect-slots/joins-slot-b-to-slot-c-at-index-1: produced diff differs from the committed 🔺️diff/🔣️.json");
}
