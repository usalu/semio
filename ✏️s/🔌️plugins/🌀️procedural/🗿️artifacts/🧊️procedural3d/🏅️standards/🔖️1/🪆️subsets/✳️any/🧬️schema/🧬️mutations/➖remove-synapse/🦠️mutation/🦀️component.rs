...
impl protocol::MutationKind<Procedural3dSnapshot, Procedural3dMutation> for DisconnectSynapse {
    ...
    fn diff(&self, base: &Procedural3dSnapshot) -> Procedural3dDiff {
        crate::artifacts::procedural3d::mutations::remove_synapse::diff::diff(self, base)
    }

    fn inverse(&self, base: &Procedural3dSnapshot) -> Vec<Procedural3dMutation> {
        crate::artifacts::procedural3d::mutations::remove_synapse::inverse::inverse(self, base)
    }
