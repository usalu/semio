/** 🗂️ Procedural3d editor — Generations window (generate mode): typed twin of `🦀️.rs`'s
...
export interface Procedural3dGenerationsViewModel {
  windowKindId: "procedural3d-generations";
...
export const PROCEDURAL3D_PLAY_GENERATIONS_WINDOW_KIND_ID = "procedural3d-generations" as const;
export const PROCEDURAL3D_PLAY_GENERATIONS_BODY_KEY = "procedural.play.generations" as const;
