//! 🧪️ `create-generation` fixture — `appends-generation-2-and-moves-the-selection`.
//!
...
fn applies_to_committed_after() {
    ...
    apply_procedural3d_mutation(&mut snapshot, &mutation()).expect("create-generation applies to its committed before-snapshot");
