...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-generation/appends-generation-2-and-moves-the-selection: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
