...
impl protocol::MutationKind<Procedural3dSnapshot, Procedural3dMutation> for DeleteWidget {
    ...
    fn diff(&self, base: &Procedural3dSnapshot) -> Procedural3dDiff {
        crate::artifacts::procedural3d::mutations::remove_widget::diff::diff(self, base)
    }

    fn inverse(&self, base: &Procedural3dSnapshot) -> Vec<Procedural3dMutation> {
        crate::artifacts::procedural3d::mutations::remove_widget::inverse::inverse(self, base)
    }
