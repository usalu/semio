//! 🧪️ `delete-widget-position` fixture — `unpins-the-node-a-position`.
//!
...
async fn applies_to_committed_after() {
    ...
    apply_procedural3d_mutation(&mut snapshot, &mutation()).expect("delete-widget-position applies to its committed before-snapshot");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-widget-position/unpins-the-node-a-position: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
