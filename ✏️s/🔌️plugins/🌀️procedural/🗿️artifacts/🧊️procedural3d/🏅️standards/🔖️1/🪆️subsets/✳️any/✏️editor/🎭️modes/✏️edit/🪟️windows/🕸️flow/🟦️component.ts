/** 🕸️ Procedural3d editor — Flow window (edit mode): typed twin of `🦀️component.rs`'s view-model.
 ...
 * ships a single mesh-preview window instead (see `👁️viewer/…/🟦️component.ts`). */
