#!/usr/bin/env python3
"""🧊️ An INDEPENDENT second implementation of the `s.procedural.procedural3d` document and its fourteen typed
mutations, in Python, serving as this case's differential oracle.

**Why a second implementation and not a third-party library.** A `procedural3d` document is a COMPOSITION
...
`✏️s/🔌️plugins/🌀️procedural/🗿️artifacts/🌀️procedural2d/🧪️tests/mutate-procedural-2d-1/🐍️.py` are
