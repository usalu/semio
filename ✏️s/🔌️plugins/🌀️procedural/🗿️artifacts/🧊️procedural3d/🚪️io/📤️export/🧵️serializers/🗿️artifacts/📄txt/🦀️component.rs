...
pub fn register() {}
pub fn serialize(_from: &Procedural3dSnapshot) -> Result<crate::artifacts::txt::TxtSnapshot, String> {
    Err("txt export not yet implemented".into())
}
pub fn deserialize_bytes(_bytes: &[u8]) -> Result<Procedural3dSnapshot, String> {
