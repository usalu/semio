...
pub fn diff_for(mutation: &Procedural3dMutation, base: &Procedural3dDocument) -> Procedural3dDiff {
    <Procedural3dMutation as protocol::Mutation<Procedural3dDocument>>::diff(mutation, base)
}
