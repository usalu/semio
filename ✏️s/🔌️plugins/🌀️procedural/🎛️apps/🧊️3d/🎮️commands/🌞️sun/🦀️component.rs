...
pub mod toggle_sun {
    ...
    pub fn handle(_payload: &ToggleSun, _doc: &DocumentView<'_, Procedural3dDocument>, cfg: &ConfigView<'_, Procedural3dConfig>, _session: &mut FlowEvalSession) -> Result<Emit<Procedural3dMutation, Procedural3dConfigMutation>, Fault> {
...
pub mod set_sun_azimuth {
    ...
    pub fn handle(payload: &SetSunAzimuth, _doc: &DocumentView<'_, Procedural3dDocument>, cfg: &ConfigView<'_, Procedural3dConfig>, _session: &mut FlowEvalSession) -> Result<Emit<Procedural3dMutation, Procedural3dConfigMutation>, Fault> {
        let mut sun = cfg.projection.sun();
...
pub mod set_sun_elevation {
    ...
    pub fn handle(payload: &SetSunElevation, _doc: &DocumentView<'_, Procedural3dDocument>, cfg: &ConfigView<'_, Procedural3dConfig>, _session: &mut FlowEvalSession) -> Result<Emit<Procedural3dMutation, Procedural3dConfigMutation>, Fault> {
        let mut sun = cfg.projection.sun();
...
pub mod set_sun_intensity {
    ...
    pub fn handle(payload: &SetSunIntensity, _doc: &DocumentView<'_, Procedural3dDocument>, cfg: &ConfigView<'_, Procedural3dConfig>, _session: &mut FlowEvalSession) -> Result<Emit<Procedural3dMutation, Procedural3dConfigMutation>, Fault> {
        let mut sun = cfg.projection.sun();
