//! 🧱️ Procedural3d play app — the `ArtifactApp` impl (dispatch-only), the aggregated command enum and
//! the manifest stitch.
//!
...
impl ArtifactApp for Procedural3dPlayApp {
...
pub fn create_procedural3d_app() -> App {
    ...
    .example(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_HEX_COLUMN, LocalizedLabel::native("Hexagonal Mushroom Column", "Sechseckige Pilzsäule"), crate::artifacts::procedural3d::schema::example_document_json(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_HEX_COLUMN), "hexagon")
    .example(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_RECT_EXTRUDE, LocalizedLabel::native("Rectangle Extrude Volume", "Rechteck-Extrusionsvolumen"), crate::artifacts::procedural3d::schema::example_document_json(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_RECT_EXTRUDE), "box")
    .example(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_SPHERE_TORUS, LocalizedLabel::native("Sphere Cut With Torus", "Kugel mit Torus geschnitten"), crate::artifacts::procedural3d::schema::example_document_json(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_SPHERE_TORUS), "circle")
    .example(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_BOX_FILLET, LocalizedLabel::native("Box Fillet Preview", "Kantenrundung Vorschau"), crate::artifacts::procedural3d::schema::example_document_json(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_BOX_FILLET), "box")
    .example(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_SPHERE_BOX_FUSE, LocalizedLabel::native("Sphere Box Fuse", "Kugel und Quader vereinen"), crate::artifacts::procedural3d::schema::example_document_json(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_SPHERE_BOX_FUSE), "combine")
    .example(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_FACE_SWEEP_EXTRUDE, LocalizedLabel::native("Face Sweep Extrude", "Fläche extrudieren"), crate::artifacts::procedural3d::schema::example_document_json(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_FACE_SWEEP_EXTRUDE), "layers")
    .example(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_RECTANGLE_WIRE, LocalizedLabel::native("Rectangle Wire Preview", "Rechteck-Draht Vorschau"), crate::artifacts::procedural3d::schema::example_document_json(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_RECTANGLE_WIRE), "square")
    .example(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_BOX_SHELL, LocalizedLabel::native("Box Shell Preview", "Hohlkörper Vorschau"), crate::artifacts::procedural3d::schema::example_document_json(crate::artifacts::procedural3d::schema::PROCEDURAL_EXAMPLE_BOX_SHELL), "box")
