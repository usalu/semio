...
impl protocol::MutationDiff<Procedural2dPresence> for Procedural2dPresence {
    fn apply(&self, _base: &Procedural2dPresence) -> Procedural2dPresence {
        self.clone()
    }
...
impl store::DocumentDsl for Procedural2dPresence {
...
impl DocumentPack for Procedural2dPresence {
...
pub enum Procedural2dPresenceMutation {
    ...
    Snapshot {
        #[dsl(block)]
        presence: Procedural2dPresence,
    },
}

impl Mutation<Procedural2dPresence> for Procedural2dPresenceMutation {
    type Diff = Procedural2dPresence;

    fn diff(&self, _base: &Procedural2dPresence) -> Procedural2dPresence {
        match self {
            Self::Snapshot { presence } => presence.clone(),
        }
    }

    fn inverse(&self, base: &Procedural2dPresence) -> Vec<Self> {
        vec![Self::Snapshot { presence: base.clone() }]
    }
}

impl protocol::OpText for Procedural2dPresenceMutation {
...
impl protocol::OpBinary for Procedural2dPresenceMutation {
