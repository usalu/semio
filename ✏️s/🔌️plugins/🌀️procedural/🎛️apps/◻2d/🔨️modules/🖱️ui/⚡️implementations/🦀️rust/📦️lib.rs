...
use semio_framework_plugin::{
    ...
    ActionDefinition, ActionDescriptor, ActionKind, App, AppLabels, ArtifactKindSpec, Canvas2dScene, ConfigView, DocumentApp, DocumentView, Emit, Fault, Label, Locale, LocalizedLabel, Media, MediaClass, MediaError, MediaForm, MediaPayload, MediaType,
...
mod tests {
    ...
    fn main_graph_scene_exports_flow_backed_node_graph_fields() {
        ...
        // see `🧰️framework/🔨️modules/🖱️ui/🧊️wgpu`'s `NodeGraphScene`) — assert the new shape instead.
