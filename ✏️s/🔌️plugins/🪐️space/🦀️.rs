...
pub fn plugin() -> Result<Plugin<SpaceApps>, PluginAssemblyError> {
    Plugin::<SpaceApps>::builder("space")
        ...
        .editor_with_examples::<semio_s_artifact_space_home::editor::home::HomeApp>(resolve_ready(semio_s_artifact_space_home::editor::home::create_home_app()), vec![semio_s_artifact_space_home::examples::demo::source()])
        ...
        .editor_with_examples::<semio_s_artifact_space_space::editor::space_index::SpaceIndexEditor>(semio_s_artifact_space_space::editor::space_index::create_space_index_editor(), vec![semio_s_artifact_space_space::examples::demo::source()])
        ...
        .requests(CapabilityRequest { id: CapabilityId("artifacts.write".into()), scope: "plugin".into(), reason: "persist home/space-index edits to the open document".into(), optional: false })
        .try_build()
}
