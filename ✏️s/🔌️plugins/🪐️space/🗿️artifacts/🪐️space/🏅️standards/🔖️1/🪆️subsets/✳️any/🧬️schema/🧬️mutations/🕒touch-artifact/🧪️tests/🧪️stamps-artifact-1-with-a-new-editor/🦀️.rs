//! 🧪️ `touch-artifact` fixture — `🗿️stamps-artifact-1-with-a-new-editor`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕒touch-artifact/🧪️stamps-artifact-1-with-a-new-editor/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕒touch-artifact/🧪️stamps-artifact-1-with-a-new-editor/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕒touch-artifact/🧪️stamps-artifact-1-with-a-new-editor/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕒touch-artifact/🧪️stamps-artifact-1-with-a-new-editor/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕒touch-artifact/🧪️stamps-artifact-1-with-a-new-editor/🎯️outcome/🔣️.json");
