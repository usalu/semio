//! 🧪️ `rename-artifact` fixture — `🗿️renames-artifact-1`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-artifact/🧪️renames-artifact-1/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-artifact/🧪️renames-artifact-1/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-artifact/🧪️renames-artifact-1/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-artifact/🧪️renames-artifact-1/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-artifact/🧪️renames-artifact-1/🎯️outcome/🔣️.json");
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(declared.get("status").and_then(pack::JsonValue::as_str), Some("applied"), "rename-artifact/renames-artifact-1: this fixture declares an applied outcome");
