...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-artifact/🧪️appends-artifact-3-to-the-index/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-artifact/🧪️appends-artifact-3-to-the-index/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-artifact/🧪️appends-artifact-3-to-the-index/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-artifact/🧪️appends-artifact-3-to-the-index/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-artifact/🧪️appends-artifact-3-to-the-index/🎯️outcome/🔣️.json");
