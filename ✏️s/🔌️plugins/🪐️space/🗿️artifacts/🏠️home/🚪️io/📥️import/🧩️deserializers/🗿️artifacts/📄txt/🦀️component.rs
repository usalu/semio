...
use crate::artifacts::sHome::SHomeSnapshot;
pub fn register() {}
pub fn deserialize(_from: &crate::artifacts::txt::TxtSnapshot) -> Result<SHomeSnapshot, String> {
    Err("txt import not yet implemented".into())
}
pub fn deserialize_bytes(_bytes: &[u8]) -> Result<SHomeSnapshot, String> {
    Err("txt import not yet implemented".into())
}
