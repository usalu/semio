...
/// `🦀️component.rs`, both the `.composers(…)` call and the root's own shadowing `io_registry` shim
...
pub mod io_registry {
    ...
    async fn rebuild_native_snapshot(sources: &[ErasedComposeSource]) -> Result<crate::artifacts::home::SHomeSnapshot, ComposeError> {
