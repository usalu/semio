/** 👁️ S Home viewer — subset-level typed twin. Read-only counterpart of `✏️editor/🟦️component.ts`:
...
export const HOME_VIEWER_DIALECT = { artifactKind: "s.space.home", standard: "1", subset: "*" } as const;
