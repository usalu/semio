...
pub fn layout() -> WindowLayout {
    WindowLayout {
        root: WindowLayoutRoot::Stack(WindowLayoutStackNode {
            ...
            children: vec![WindowLayoutWindowNode { kind: "window".into(), window_kind_id: main::S_HOME_VIEW_WINDOW.into(), title: Some("Studios".into()), instance_id: None, template_id: None }],
        }),
    }
}
