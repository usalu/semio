...
pub fn render(directory: &store::os_directory::DirectoryReadModel, view_state: &semio_framework_plugin::ViewModel, client_id: &str) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
