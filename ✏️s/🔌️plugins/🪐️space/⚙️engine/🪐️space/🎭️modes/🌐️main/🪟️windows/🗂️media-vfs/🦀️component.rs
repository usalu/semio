...
pub fn render(projection: &WorkflowSnapshot, locale: &str) -> UiNode {
    ...
    crate::engine::space::engine::flatten_media_vfs_rows(OS_WORKFLOW_VFS_ROOT_ID, &projection.graph, &projection.parameter_bindings, &projection.parameters, &mut rows);
