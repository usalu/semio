...
mod tests {
    ...
    fn open_and_close_focused_instance() {
        ...
        let close_emit = studio_emit(&projection, &config_after_open, &SpaceCommand::CloseFocusedInstance(crate::engine::space::commands::close_focused_instance::CloseFocusedInstance {})).expect("handle");
