...
pub mod set_active_panel_tab {
    ...
    pub fn handle(payload: &SetActivePanelTab, _doc: &DocumentView<'_, SHomeSnapshot>, _cfg: &ConfigView<'_, HomeConfig>) -> Result<Emit<SHomeMutation, HomeConfigMutation>, Fault> {
...
mod tests {
    ...
    fn home_command_op_text_round_trips_every_variant() {
        ...
        store::os_store::test_support::assert_op_line_round_trip(&HomeCommand::SetActivePanelTab(set_active_panel_tab::SetActivePanelTab { tab_id: "tab-1".into() }));
    }
