...
//! operation is `semio_framework_os::WorkflowOperation`, owned entirely outside this plugin (see this crate's
...
//! there is no `WorkflowOperation` twin for config, config is genuinely local to this app.
