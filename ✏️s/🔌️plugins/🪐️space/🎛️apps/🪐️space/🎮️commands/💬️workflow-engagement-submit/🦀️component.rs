...
mod tests {
    ...
    fn space_command_op_text_round_trips_every_variant() {
        ...
        store::os_store::test_support::assert_op_line_round_trip(&SpaceCommand::CompiledDagEngagementSubmit(crate::apps::space::commands::compiled_dag_engagement_submit::CompiledDagEngagementSubmit {}));
        store::os_store::test_support::assert_op_line_round_trip(&SpaceCommand::WorkflowEngagementInput(crate::apps::space::commands::workflow_engagement_input::WorkflowEngagementInput { value: "draw draw".into() }));
        store::os_store::test_support::assert_op_line_round_trip(&SpaceCommand::CompiledDagEngagementInput(crate::apps::space::commands::compiled_dag_engagement_input::CompiledDagEngagementInput { value: "".into() }));
    }
}
//#endregion 🧪️Tests
