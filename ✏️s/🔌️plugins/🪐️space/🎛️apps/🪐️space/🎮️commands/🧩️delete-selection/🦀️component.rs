...
mod tests {
    use super::*;
    use crate::apps::space::testkit::{app_with_registry, dispatch, seed_draw_plugin};
    ...
    fn delete_selection_removes_the_live_selected_node() {
        ...
        dispatch(&mut app, SpaceCommand::SpawnApp(spawn_app::SpawnApp { plugin_id: "draw".into(), app_id: "draw".into(), x: 10.0, y: 10.0 }));
