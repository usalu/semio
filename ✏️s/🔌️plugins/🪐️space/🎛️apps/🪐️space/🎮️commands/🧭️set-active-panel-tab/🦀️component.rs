...
mod tests {
    ...
    fn space_command_op_text_round_trips_every_variant() {
        ...
        store::os_store::test_support::assert_op_line_round_trip(&SpaceCommand::GoHome(crate::apps::space::commands::go_home::GoHome {}));
        store::os_store::test_support::assert_op_line_round_trip(&SpaceCommand::NavigateVirtualFileSystemNode(crate::apps::space::commands::navigate_virtual_file_system_node::NavigateVirtualFileSystemNode { space_id: "demo".into() }));
        store::os_store::test_support::assert_op_line_round_trip(&SpaceCommand::SetAppRegistrations(crate::apps::space::commands::set_app_registrations::SetAppRegistrations { json: "[]".into() }));
    }
    ...
    fn set_app_registrations_command_registers_app_and_surfaces_empty_document_apps_in_catalogue() {
        ...
        studio_emit(&projection, &config, &SpaceCommand::SetAppRegistrations(crate::apps::space::commands::set_app_registrations::SetAppRegistrations { json: wire })).expect("handle");
