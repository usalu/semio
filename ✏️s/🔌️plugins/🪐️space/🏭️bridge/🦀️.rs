...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_space_home::standards::v1::subsets::any::schema::snapshot::SHomeSnapshot, semio_s_artifact_space_home::standards::v1::subsets::any::schema::mutations::SHomeMutation>,
    descriptors::<semio_s_artifact_space_space::standards::v1::subsets::any::schema::snapshot::SSpaceSnapshot, semio_s_artifact_space_space::standards::v1::subsets::any::schema::mutations::SSpaceMutation>,
];
