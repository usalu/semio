//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🪐️space`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("SHomeMutation", descriptors::<semio_s_artifact_space_home::standards::v1::subsets::any::schema::snapshot::SHomeSnapshot, semio_s_artifact_space_home::standards::v1::subsets::any::schema::mutations::SHomeMutation>),
    ("SSpaceMutation", descriptors::<semio_s_artifact_space_space::standards::v1::subsets::any::schema::snapshot::SSpaceSnapshot, semio_s_artifact_space_space::standards::v1::subsets::any::schema::mutations::SSpaceMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.space.home", "1", "any", "", "✏️s/🔌️plugins/🪐️space/🗿️artifacts/🏠️home/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.space.space", "1", "any", "", "✏️s/🔌️plugins/🪐️space/🗿️artifacts/🪐️space/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-space-mutation-bridge")),
