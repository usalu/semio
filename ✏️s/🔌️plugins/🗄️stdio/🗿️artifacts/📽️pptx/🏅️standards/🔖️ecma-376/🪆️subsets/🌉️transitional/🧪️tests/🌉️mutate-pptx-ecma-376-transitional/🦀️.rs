...
mod subject {
    ...
    use semio_s_artifact_stdio_pptx::standards::v_ecma_376::subsets::transitional::schema::mutations::{apply_pptx_transitional_mutation, stamp_conformance_class, PptxTransitionalMutation};
