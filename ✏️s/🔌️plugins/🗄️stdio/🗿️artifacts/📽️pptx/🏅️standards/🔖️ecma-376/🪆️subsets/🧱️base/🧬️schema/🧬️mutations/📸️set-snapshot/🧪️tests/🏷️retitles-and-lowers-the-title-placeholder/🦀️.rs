//! 🧪️ `set-snapshot` fixture — `🏷️retitles-and-lowers-the-title-placeholder`.
//!
...
use crate::standards::v_ecma_376::subsets::base::schema::mutations::{apply_pptx_mutation, PptxMutation};
use crate::standards::v_ecma_376::subsets::base::schema::snapshot::PptxSnapshot;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🏷️retitles-and-lowers-the-title-placeholder/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🏷️retitles-and-lowers-the-title-placeholder/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🏷️retitles-and-lowers-the-title-placeholder/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🏷️retitles-and-lowers-the-title-placeholder/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🏷️retitles-and-lowers-the-title-placeholder/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    match &snapshot.presentation.slides[0].shapes[0] {
        crate::standards::v_ecma_376::subsets::base::schema::snapshot::PptxShape::Placeholder { kind, text_frame, position } => {
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: PptxSnapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-snapshot/retitles-and-lowers-the-title-placeholder: produced diff differs from the committed 🔺️diff/🔣️.json");
    ...
    match &shapes.modified[0].diff {
        crate::standards::v_ecma_376::subsets::base::schema::diff::PptxShapeDiff::Placeholder(placeholder) => {
...
async fn committed_diff_is_canonical() {
    let decoded: PptxDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
