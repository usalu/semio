...
mod subject {
    ...
    use semio_s_artifact_stdio_pptx::standards::v_ecma_376::subsets::strict::schema::mutations::{apply_pptx_strict_mutation, stamp_conformance_class, vml_markup, PptxStrictMutation};
