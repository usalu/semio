...
/// other by design).
async fn entity_count(document: &StlSnapshot) -> usize {
...
async fn world_instances_json(document: &StlSnapshot) -> String {
...
pub async fn render(document: &StlSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(STL_ANY_EDIT_DEFAULT_CAMERA_POSITION, STL_ANY_EDIT_DEFAULT_CAMERA_TARGET, STL_ANY_EDIT_DEFAULT_CAMERA_FOV).await,
        meshes_json,
