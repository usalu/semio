//! 📄️ Docx viewer — `main` window: a real, READ-ONLY page view of `DocxDocument.body`, built from
//! the framework `DocumentWindowKit` (contract §2.6). Independent render from the sibling
//! mutation-capable surface — the same block-to-page mapping, no edit affordances
