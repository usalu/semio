...
impl protocol::OpBinary for DocxTransitionalEditorCommand {
    ...
    async fn decode_op(bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        ...
        <Self as protocol::OpText>::parse_op(&line).await.map_err(|error| protocol::ProtocolError::Malformed { what: "docx transitional editor command", offset: 0, detail: error.to_string() })
    }
}
//#endregion 🔖️Command
...
//#region 🔖️Manifest
pub async fn create_docx_transitional_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(DOCX_TRANSITIONAL_EDITOR_DIALECT)
        ...
        .await.default_mode_id(edit::DOCX_TRANSITIONAL_EDIT_MODE_ID)
