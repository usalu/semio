...
impl Mutation<DocxSnapshot> for DocxStrictMutation {
    type Diff = DocxDiff;
    ...
    fn diff(&self, base: &DocxSnapshot) -> protocol::MutationOutcome<Self::Diff> {
        protocol::MutationOutcome::new(match self {
            ...
            Self::InsertAlternateContent { path } => diff_append_alternate_content(base, path),
            Self::RemoveAlternateContent { path } => diff_strip_alternate_content(base, path),
        })
    }
...
mod tests {
    ...
    fn kinds_match_enum_and_catalog() {
        fn kind_of(mutation: &DocxStrictMutation) -> &'static str {
            match mutation {
                DocxStrictMutation::NoMutation => "no-mutation",
                DocxStrictMutation::SetSnapshot { .. } => "set-snapshot",
                DocxStrictMutation::SetMainNamespace { .. } => "set-main-namespace",
                DocxStrictMutation::SetRelationshipBase { .. } => "set-relationship-base",
                DocxStrictMutation::SetConformanceAttribute { .. } => "set-conformance-attribute",
                DocxStrictMutation::RemoveConformanceAttribute => "remove-conformance-attribute",
                DocxStrictMutation::InsertVmlPart { .. } => "insert-vml-part",
                DocxStrictMutation::RemoveVmlPart { .. } => "remove-vml-part",
                DocxStrictMutation::InsertAlternateContent { .. } => "insert-alternate-content",
                DocxStrictMutation::RemoveAlternateContent { .. } => "remove-alternate-content",
            }
        }
        let samples = [
            DocxStrictMutation::NoMutation,
            DocxStrictMutation::SetSnapshot { snapshot: DocxSnapshot::default() },
            DocxStrictMutation::SetMainNamespace { namespace: String::new() },
            DocxStrictMutation::SetRelationshipBase { base: String::new() },
            DocxStrictMutation::SetConformanceAttribute { value: String::new() },
            DocxStrictMutation::RemoveConformanceAttribute,
            DocxStrictMutation::InsertVmlPart { path: String::new(), markup: String::new() },
            DocxStrictMutation::RemoveVmlPart { path: String::new() },
            DocxStrictMutation::InsertAlternateContent { path: String::new() },
            DocxStrictMutation::RemoveAlternateContent { path: String::new() },
        ];
