/** 👁️ Docx transitional viewer — subset-level typed twin. Read-only counterpart re-exporting the
...
export const DOCX_TRANSITIONAL_VIEWER_DIALECT = { artifactKind: "s.stdio.docx", standard: "ecma-376", subset: "transitional" } as const;
