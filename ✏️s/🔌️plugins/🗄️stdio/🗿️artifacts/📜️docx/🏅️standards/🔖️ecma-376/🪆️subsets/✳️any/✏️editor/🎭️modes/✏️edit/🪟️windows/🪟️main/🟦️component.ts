/** 📄️ Docx editor — `main` window: typed twin of `🦀️component.rs`'s `DocumentWindowKit`
...
export const DOCX_MAIN_WINDOW_KIND_ID = "framework.window.document" as const;
export const DOCX_MAIN_BODY_KEY = "framework.window.document" as const;
