...
mod subject {
    ...
    use semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::{apply_docx_strict_mutation, stamp_conformance_class, vml_markup, DocxStrictMutation};
    ...
    fn mutation_from_spec(ctx: &Context, spec: &Json) -> Result<DocxStrictMutation, String> {
        ...
        Ok(match spec.str("kind").as_str() {
            "set-snapshot" => DocxStrictMutation::SetSnapshot(semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::set_snapshot::SetSnapshot { snapshot: stamped(&decode(&mutable_input(ctx)?)?, params.str("conformanceClass") == "strict")? }),
            "set-main-namespace" => DocxStrictMutation::SetMainNamespace(semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::set_main_namespace::SetMainNamespace { namespace: params.str("namespace") }),
            "set-relationship-base" => DocxStrictMutation::SetRelationshipBase(semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::set_relationship_base::SetRelationshipBase { base: params.str("base") }),
            "set-conformance-attribute" => DocxStrictMutation::SetConformanceAttribute(semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::set_conformance_attribute::SetConformanceAttribute { value: params.str("value") }),
            ...
            "insert-vml-part" => DocxStrictMutation::InsertVmlPart(semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::insert_vml_part::InsertVmlPart { path: params.str("path"), markup: vml_markup() }),
            "remove-vml-part" => DocxStrictMutation::RemoveVmlPart(semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::remove_vml_part::RemoveVmlPart { path: params.str("path") }),
            "insert-alternate-content" => DocxStrictMutation::InsertAlternateContent(semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::insert_alternate_content::InsertAlternateContent { path: params.str("path") }),
            "remove-alternate-content" => DocxStrictMutation::RemoveAlternateContent(semio_s_artifact_stdio_docx::standards::v_ecma_376::subsets::strict::schema::mutations::remove_alternate_content::RemoveAlternateContent { path: params.str("path") }),
