...
//! `semantic-ooxml-docx-transitional-v1` profile compares them. The subject half is gated behind the
...
//#region 🔖️Kinds
/// 🧾️ Test-case-local mirror of the `docx-ecma-376-transitional` catalog. Duplicated, not imported,
...
/// outright.
const KINDS: &[&str] = &["no-mutation", "set-snapshot", "set-main-namespace", "set-relationship-base", "set-conformance-attribute", "remove-conformance-attribute"];
//#endregion 🔖️Kinds
