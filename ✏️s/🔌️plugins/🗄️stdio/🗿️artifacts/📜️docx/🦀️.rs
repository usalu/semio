...
pub fn contribution() -> semio_s_artifact_stdio_contract::ArtifactContribution {
    semio_s_artifact_stdio_contract::ArtifactContribution { identity: "docx", schema: ARTIFACT_DEFINITION_SCHEMA, definition, assembly, formats, native_codecs }
}
...
fn docx_subset_validators() -> &'static [semio_framework_plugin::SubsetValidatorEntry] {
    ...
    ENTRIES
        .get_or_init(|| {
            vec![
                semio_framework_plugin::subset_validator_entry_of::<standards::v_ecma_376::subsets::strict::io::DocxStrictValidator>(),
                semio_framework_plugin::subset_validator_entry_of::<standards::v_ecma_376::subsets::transitional::io::DocxTransitionalValidator>(),
            ]
        })
        .as_slice()
}
