...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔑️promotes-the-second-sample-to-a-sync-frame/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔑️promotes-the-second-sample-to-a-sync-frame/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔑️promotes-the-second-sample-to-a-sync-frame/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔑️promotes-the-second-sample-to-a-sync-frame/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔑️promotes-the-second-sample-to-a-sync-frame/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: Mp4Snapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn committed_diff_is_canonical() {
    let decoded: Mp4Diff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
