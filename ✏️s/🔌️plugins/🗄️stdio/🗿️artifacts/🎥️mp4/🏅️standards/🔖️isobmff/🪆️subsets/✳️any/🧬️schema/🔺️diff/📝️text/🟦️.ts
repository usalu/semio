// stdio.mp4 diff 📝️text facet — same shape as ../🟦️.ts.
...
export interface Mp4TrackDiff {
  trackId?: number; timescale?: number; codec?: import("./🟦️").Mp4Codec;
  width?: number; height?: number; chunkSampleCounts?: number[]; samples?: IndexedDiff<import("./🟦️").Mp4Sample, Mp4SampleDiff>;
}
export interface Mp4Diff {
  ftyp?: import("./🟦️").Mp4Ftyp;
  tracks?: IndexedDiff<import("./🟦️").Mp4Track, Mp4TrackDiff>;
}
