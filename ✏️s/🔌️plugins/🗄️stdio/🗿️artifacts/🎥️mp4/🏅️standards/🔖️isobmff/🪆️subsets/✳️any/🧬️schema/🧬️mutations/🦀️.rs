...
mod tests {
    ...
    async fn mutation_diff_law_and_inverse_law_hold_for_every_variant() {
        ...
        let variants = vec![
            ...
            Mp4Mutation::InsertTrack(insert_track::InsertTrack { index: 1, track: Mp4Track { track_id: 2, timescale: 500, codec: Mp4Codec::default(), width: 32, height: 32, metadata: Mp4TrackMetadata::default(), chunk_sample_counts: vec![0], samples: vec![] } }),
...
#[path = "."]
mod fixture_tests {
    #[path = "📸️set-snapshot/🧪️tests/🔑️promotes-the-f2b6ba/🦀️.rs"]
