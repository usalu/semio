//! 🧪️ `set-snapshot` fixture — `promotes-the-second-sample-to-a-sync-frame`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-snapshot/promotes-the-second-sample-to-a-sync-frame: produced diff differs from the committed 🔺️diff/🔣️component.json");
