//! 🧪️ `change-gamma` fixture — `direct-behavior`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-gamma/direct-behavior: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
