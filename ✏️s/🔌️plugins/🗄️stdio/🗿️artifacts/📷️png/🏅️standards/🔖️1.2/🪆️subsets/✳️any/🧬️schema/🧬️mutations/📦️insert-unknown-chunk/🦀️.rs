...
pub(crate) fn test_case() -> PngMutation {
    dsl::json::from_json_str(include_str!("../../../🧫️fixtures/🧬️mutations/📦️insert-unknown-chunk/🎯️direct-behavior/🦠️mutation/🔣️.json")).expect("committed insert-unknown-chunk payload")
}
#[cfg(test)]
