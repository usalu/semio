//! 🧪️ `change-srgb-intent` fixture — `direct-behavior`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-srgb-intent/direct-behavior: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
