//! 🧪️ `change-background` fixture — `🟣️direct-behavior`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-background/direct-behavior: produced diff differs from the committed 🔺️diff/🔣️.json");
}
