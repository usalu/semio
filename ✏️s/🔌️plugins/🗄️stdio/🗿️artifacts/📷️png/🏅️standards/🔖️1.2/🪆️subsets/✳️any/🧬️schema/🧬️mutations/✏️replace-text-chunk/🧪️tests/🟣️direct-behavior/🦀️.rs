//! 🧪️ `replace-text-chunk` fixture — `🟣️direct-behavior`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-text-chunk/direct-behavior: produced diff differs from the committed 🔺️diff/🔣️.json");
}
