...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️set-snapshot/🤝️closes-the-clash-topic-and-answers-its-comment/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️set-snapshot/🤝️closes-the-clash-topic-and-answers-its-comment/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️set-snapshot/🤝️closes-the-clash-topic-and-answers-its-comment/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️set-snapshot/🤝️closes-the-clash-topic-and-answers-its-comment/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️set-snapshot/🤝️closes-the-clash-topic-and-answers-its-comment/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: BcfSnapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn committed_diff_is_canonical() {
    let decoded: BcfDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
