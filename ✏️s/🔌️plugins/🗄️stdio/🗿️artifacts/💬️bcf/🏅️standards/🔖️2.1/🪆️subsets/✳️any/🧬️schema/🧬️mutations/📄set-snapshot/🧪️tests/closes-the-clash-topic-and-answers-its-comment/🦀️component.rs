...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-snapshot/closes-the-clash-topic-and-answers-its-comment: produced diff differs from the committed 🔺️diff/🔣️component.json");
