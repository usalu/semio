...
Feature: Apply every typed BCF 2.1 mutation to a real-world coordination review
  See ../mutate-bcf-2-1/🥒️.feature for the full fixture/provenance narrative -- this subset's own scenarios exercise only the mutation kinds `../../🏅️standards` places under this subset.
