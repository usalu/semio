//! 🚪️ IO stdio.bcf (2.1/✳️any) — flat ZIP container of parts, reusing the real `stdio.zip`
...
mod tests {
    use super::*;
    use crate::artifacts::bcf::standards::v2_1::subsets::any::schema::snapshot::{empty_bcf_snapshot, demo_bcf_snapshot};
