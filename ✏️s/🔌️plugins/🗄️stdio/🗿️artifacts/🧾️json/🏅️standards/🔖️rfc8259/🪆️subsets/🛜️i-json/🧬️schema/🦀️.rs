...
pub mod derived_construction {
    ...
    mod tests {
        ...
        async fn unsafe_integer_injected_via_raw_mutate_still_fails_build() {
            ...
            let (mutated, _diff) = JsonIJsonBuilderConstruction::from_snapshot(JsonSnapshot::default()).mutate(JsonIJsonMutation::SetSnapshot(crate::standards::v_rfc8259::subsets::i_json::schema::mutations::set_snapshot::SetSnapshot { snapshot: violating }));
