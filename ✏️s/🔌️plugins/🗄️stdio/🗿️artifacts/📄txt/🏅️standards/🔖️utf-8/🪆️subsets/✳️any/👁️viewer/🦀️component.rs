...
pub fn create_txt_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(TXT_VIEWER_DIALECT).document(["semio", "stdio", "txt"]).icon_id("type").mode_def(view::definition()).default_mode_id(view::TXT_VIEW_MODE_ID).window_kind_def(main::definition()).default_layout(view::layout()).build_definition()
}
//#endregion 🔖️Manifest
