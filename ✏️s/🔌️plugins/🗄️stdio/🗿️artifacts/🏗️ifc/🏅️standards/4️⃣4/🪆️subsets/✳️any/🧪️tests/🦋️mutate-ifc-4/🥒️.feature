...
Feature: Apply every typed IFC4 mutation to a real-world exchange structure
  ...
  `shared://🏢️nakagin-capsule-tower/🏢️nakagin-capsule-tower.ifc`, a real IfcOpenShell 0.8.4.post1 export of the Nakagin
  ...
  one. This wave's `🟠️mutate-step-ap214` case already registered `ruststep` 0.4 as a real Part-21
