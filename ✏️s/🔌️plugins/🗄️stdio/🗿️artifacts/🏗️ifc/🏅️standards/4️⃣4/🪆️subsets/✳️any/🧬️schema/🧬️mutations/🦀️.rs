...
mod tests {
    ...
    fn absorb_law() {
        ...
        assert_absorb_law(
            &base,
            IfcMutation::InsertEntityArg(insert_entity_arg::InsertEntityArg { id: 6, index: 0, value: IfcValue::Unset }),
            IfcMutation::SetEntityArg(set_entity_arg::SetEntityArg { id: 6, index: 0, value: IfcValue::Derived }),
        );
