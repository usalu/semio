...
//#region 🔖️Manifest
pub async fn create_ifc4_any_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(IFC4_ANY_DIALECT)
        .await.document(["stdio", "ifc4"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::IFC4_ANY_EDIT_MODE_ID)
