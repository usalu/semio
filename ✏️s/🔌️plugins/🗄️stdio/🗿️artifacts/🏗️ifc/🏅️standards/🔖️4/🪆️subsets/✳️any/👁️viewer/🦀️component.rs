...
impl ArtifactViewer for Ifc4AnyViewer {
    ...
    async fn initial_snapshot() -> IfcSnapshot {
        IfcSnapshot::default()
    }
...
//#region 🔖️Manifest
pub async fn create_ifc4_any_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(IFC4_ANY_DIALECT)
        .await.document(["stdio", "ifc4"])
        .await.icon_id("box")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::IFC4_ANY_VIEW_MODE_ID)
