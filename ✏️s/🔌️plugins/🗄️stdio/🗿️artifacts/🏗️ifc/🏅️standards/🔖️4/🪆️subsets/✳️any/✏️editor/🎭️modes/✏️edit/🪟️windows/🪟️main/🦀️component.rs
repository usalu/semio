...
pub fn render(document: &IfcSnapshot) -> semio_framework_plugin::UiAssemblyResult<BuiltNode> {
    let meshes_json = pack::json_to_string(&pack::json_array([pack::json!({ "id": IFC4_ANY_EDIT_FALLBACK_MESH_KIND, "data": mesh_from_kind(IFC4_ANY_EDIT_FALLBACK_MESH_KIND) })]));
    let view = MeshView {
