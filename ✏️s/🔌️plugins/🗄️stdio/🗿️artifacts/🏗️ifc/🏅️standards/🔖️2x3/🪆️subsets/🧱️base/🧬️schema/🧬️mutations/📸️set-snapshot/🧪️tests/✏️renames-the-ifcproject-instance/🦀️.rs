...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-ifcproject-instance/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-ifcproject-instance/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-ifcproject-instance/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-ifcproject-instance/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-ifcproject-instance/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: Ifc2x3Snapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn committed_diff_is_canonical() {
    let decoded: Ifc2x3Diff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
