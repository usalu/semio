...
`../🔺️differential-ifc-4/🐍️component.py`'s reader rather than a shared module: a case adapter in this
...
`shared://🏥️wellness-center-sama-street-level/🏥️wellness-center-sama-street-level.ifc` — a real self-consistent 3 464-entity slice of a
