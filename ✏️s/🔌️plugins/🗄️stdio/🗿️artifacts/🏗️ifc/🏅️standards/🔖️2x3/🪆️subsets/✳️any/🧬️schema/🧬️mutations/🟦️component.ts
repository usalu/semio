import type { Ifc2x3Snapshot, Part21Header, Part21Instance } from "../📸️snapshot/🟦️component.ts";

/** 🧬️ Ifc2x3Mutation schema. Mirrors the Rust `Ifc2x3Mutation` enum field-for-field — `snapshot`,
 * `instance`, and `header` were drifted to `unknown`; `../📸️snapshot/🟦️component.ts` already
