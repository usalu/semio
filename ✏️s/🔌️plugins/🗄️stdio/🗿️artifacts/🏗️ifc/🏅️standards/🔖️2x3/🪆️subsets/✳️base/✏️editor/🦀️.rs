...
pub fn create_ifc2x3_any_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(IFC2X3_ANY_DIALECT).document(["stdio", "ifc2x3"]).icon_id("box").mode_def(edit::definition()).default_mode_id(edit::IFC2X3_ANY_EDIT_MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
