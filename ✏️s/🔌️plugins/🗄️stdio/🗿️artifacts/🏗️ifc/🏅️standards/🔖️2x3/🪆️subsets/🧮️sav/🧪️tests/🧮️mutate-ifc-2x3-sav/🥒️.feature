...
Feature: Apply every typed Structural Analysis View mutation to an IFC2X3 building model
  The input is `shared://🏗️wellness-center-sama-structural-seed/🏗️wellness-center-sama-structural-seed.ifc`.
  ...
  Scenario Outline: Apply <id> to the structural analysis document
    Given the real input document shared://🏗️wellness-center-sama-structural-seed/🏗️wellness-center-sama-structural-seed.ifc
  ...
  @level-exhaustive
  @mode-property
  Scenario: Apply no-mutation to the structural analysis document
    Given the real input document shared://🏗️wellness-center-sama-structural-seed/🏗️wellness-center-sama-structural-seed.ifc
  ...
  @level-exhaustive
  @mode-property
  Scenario: Undoing no-mutation restores the structural analysis document
    Given the real input document shared://🏗️wellness-center-sama-structural-seed/🏗️wellness-center-sama-structural-seed.ifc
    When the no-mutation mutation is applied with its parameters
      """
      {"kind": "no-mutation", "params": {}}
