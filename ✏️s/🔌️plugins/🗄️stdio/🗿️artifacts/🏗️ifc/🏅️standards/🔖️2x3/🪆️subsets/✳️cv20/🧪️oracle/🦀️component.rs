...
//!
//! @see 🔣️component.json — the oracle registration and the `ifc-2x3-cv20` mutation catalog.
//! @see ../🧬️schema/🧬️mutations/🦀️component.rs — the vocabulary itself (`Ifc2x3Cv20Mutation::KINDS`).
