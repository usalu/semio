...
impl protocol::MutationKind<Ifc2x3Snapshot, Ifc2x3CobieMutation> for SetViewDefinition {
    ...
    fn diff(&self, base: &Ifc2x3Snapshot) -> protocol::MutationOutcome<<Ifc2x3CobieMutation as protocol::Mutation<Ifc2x3Snapshot>>::Diff> {
        agg_diff(&Ifc2x3CobieMutation::SetViewDefinition(self.clone()), base)
    }
    fn inverse(&self, base: &Ifc2x3Snapshot) -> Vec<Ifc2x3CobieMutation> {
        agg_inverse(&Ifc2x3CobieMutation::SetViewDefinition(self.clone()), base)
    }
