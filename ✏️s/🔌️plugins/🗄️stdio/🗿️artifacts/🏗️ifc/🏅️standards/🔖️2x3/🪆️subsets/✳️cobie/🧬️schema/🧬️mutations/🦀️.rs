...
#[path = "⚙set-facility-name/🦀️.rs"]
pub mod set_facility_name;
#[path = "🧩set-floor-elevation/🦀️.rs"]
pub mod set_floor_elevation;
#[path = "🔖set-space/🦀️.rs"]
pub mod set_space;
#[path = "🏷set-type-assignment/🦀️.rs"]
...
mod tests {
    ...
    fn the_cobie_guards_reject_rather_than_silently_edit() {
        ...
        assert!(
            !apply_ifc2x3_cobie_mutation(&mut snapshot, &Ifc2x3CobieMutation::SetTypeAssignment(set_type_assignment::SetTypeAssignment { id: 98, assignment: Some(CobieTypeAssignment { global_id: "x".into(), owner_history: None, related_objects: vec![3], relating_type: 3 }) }))
                .messages()
                .is_empty(),
