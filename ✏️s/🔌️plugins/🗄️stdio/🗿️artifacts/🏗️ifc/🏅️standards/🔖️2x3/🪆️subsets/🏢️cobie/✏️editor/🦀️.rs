...
impl protocol::OpBinary for Ifc2x3CobieEditCommand {
    const TOOL_JOB_IDS: &'static [&'static str] = IFC2X3_COBIE_DOCUMENT_SCHEMA_EXAMPLE_TOOL_IDS;
...
impl ArtifactOwnedToolJobFactory for Ifc2x3CobieEditorExampleFactory {
    ...
    fn build_document_store_initialization_job(
        ...
        Ok(semio_framework_plugin::bounded_document_store_initialization_job(envelope, IFC2X3_COBIE_DOCUMENT_SCHEMA, operation, generation))
    }
...
pub fn create_ifc2x3_cobie_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(IFC2X3_COBIE_DIALECT).document(["stdio", "ifc2x3"]).icon_id("box").mode_def(edit::definition()).default_mode_id(edit::IFC2X3_COBIE_EDIT_MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).action_with(semio_s_artifact_stdio_contract::set_active_example_action())
