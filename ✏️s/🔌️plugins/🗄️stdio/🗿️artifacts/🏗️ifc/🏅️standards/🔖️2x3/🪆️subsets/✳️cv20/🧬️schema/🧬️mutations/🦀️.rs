...
#[path = "⚙set-structural-entity/🦀️.rs"]
pub mod set_structural_entity;
#[path = "🧩set-project-units/🦀️.rs"]
pub mod set_project_units;
#[path = "🔖set-product-placement/🦀️.rs"]
...
pub(crate) fn agg_diff(this: &Ifc2x3Cv20Mutation, base: &Ifc2x3Snapshot) -> protocol::MutationOutcome<Ifc2x3Diff> {
        match this {
            Ifc2x3Cv20Mutation::SetSnapshot(set_snapshot::SetSnapshot { snapshot }) => match crate::artifacts::ifc::standards::v2x3::subsets::any::schema::snapshot::validate_ifc2x3_snapshot(snapshot) {
...
mod tests {
    ...
    fn the_mvd_guards_reject_rather_than_silently_edit() {
        ...
        assert!(
            !apply_ifc2x3_cv20_mutation(&mut snapshot, &Ifc2x3Cv20Mutation::SetStructuralEntity(set_structural_entity::SetStructuralEntity { id: 99, entity: Some(Cv20StructuralEntity { type_name: "IFCWALL".into(), global_id: "x".into(), name: "x".into() }) })).messages().is_empty(),
