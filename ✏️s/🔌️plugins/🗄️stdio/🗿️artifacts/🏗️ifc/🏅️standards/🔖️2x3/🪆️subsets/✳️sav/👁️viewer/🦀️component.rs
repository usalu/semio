//! 👁️ IFC 2x3 Sav viewer — the read-only counterpart of `✏️editor` for this subset (ticket
//! 26/08/16/ARTIFACT-VIEWERS-AND-EDITORS-PER-SUBSET contract §2.2). `Ifc2x3SavViewer`
//! implements `ArtifactViewer`, never `ArtifactEditor`/`ArtifactApp` — `ViewerApp<Ifc2x3SavViewer>`
...
use crate::artifacts::ifc::standards::v2x3::subsets::sav::schema::mutations::Ifc2x3Mutation;
use crate::artifacts::ifc::standards::v2x3::subsets::sav::schema::snapshot::Ifc2x3Snapshot;
use crate::viewer::ifc2x3_sav::modes::view;
use crate::viewer::ifc2x3_sav::modes::view::windows::main;
...
pub const IFC2X3_SAV_DIALECT: Dialect = Dialect { artifact_kind: "s.stdio.ifc", standard: StandardId("2x3"), subset: SubsetId("sav") };
pub const IFC2X3_SAV_DOCUMENT_SCHEMA: &str = "stdio.ifc.2x3";
//#endregion 🔖️Dialect

//#region 🔖️Command
/// 👁️ The viewer declares no actions, so its typed command channel has exactly one inert variant.
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub enum Ifc2x3SavViewCommand {
    #[default]
    Noop,
}

impl protocol::OpBinary for Ifc2x3SavViewCommand {
    fn encode_op(&self) -> Result<Vec<u8>, protocol::ProtocolError> {
        Ok(Vec::new())
    }
    fn decode_op(_bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        Ok(Ifc2x3SavViewCommand::Noop)
    }
}
//#endregion 🔖️Command
...
pub struct Ifc2x3SavViewer;

impl ArtifactViewer for Ifc2x3SavViewer {
    ...
    type Command = Ifc2x3SavViewCommand;
...
pub fn create_ifc2x3_sav_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(IFC2X3_SAV_DIALECT).document(["stdio", "ifc2x3"]).icon_id("box").mode_def(view::definition()).default_mode_id(view::IFC2X3_SAV_VIEW_MODE_ID).window_kind_def(main::definition()).default_layout(view::layout()).build_definition()
}
//#endregion 🔖️Manifest
...
mod tests {
    ...
    async fn viewer_never_mutates_the_document_or_draft_store() {
        semio_framework_plugin::testkit::assert_viewer_never_mutates::<Ifc2x3SavViewer>();
    }
}
//#endregion 🧪️Tests
