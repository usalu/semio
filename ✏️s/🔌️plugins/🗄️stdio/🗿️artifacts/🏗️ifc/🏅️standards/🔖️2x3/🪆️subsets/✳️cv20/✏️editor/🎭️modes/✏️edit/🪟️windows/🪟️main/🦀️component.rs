...
/// other by design).
async fn entity_count(document: &Ifc2x3Snapshot) -> usize {
...
pub async fn render(document: &Ifc2x3Snapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(IFC2X3_CV20_EDIT_DEFAULT_CAMERA_POSITION, IFC2X3_CV20_EDIT_DEFAULT_CAMERA_TARGET, IFC2X3_CV20_EDIT_DEFAULT_CAMERA_FOV).await,
        meshes_json,
