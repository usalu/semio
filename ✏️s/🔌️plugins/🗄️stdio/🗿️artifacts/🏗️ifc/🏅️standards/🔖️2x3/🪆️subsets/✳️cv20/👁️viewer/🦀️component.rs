...
//#region 🔖️Manifest
pub async fn create_ifc2x3_cv20_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(IFC2X3_CV20_DIALECT)
        .await.document(["stdio", "ifc2x3"])
        .await.icon_id("box")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::IFC2X3_CV20_VIEW_MODE_ID)
