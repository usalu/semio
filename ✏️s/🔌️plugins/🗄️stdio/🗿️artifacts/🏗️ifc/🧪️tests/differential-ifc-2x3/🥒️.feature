@capability-ifc-2x3-any-mutate
@oracle-ifcopenshell-ifc-2x3-any-differential
...
Feature: Produce every schema-expressible IFC2X3 mutation twice, in two independent implementations
  This case exists for one reason: the sibling `../mutate-ifc-2x3` cannot make a differential claim.
  ...
  claimed as one; `remove-instance` keeps its `ruststep`-backed scenarios in `../mutate-ifc-2x3`,
  ...
  `../mutate-ifc-2x3`, unchanged — nothing is lost, and nothing false is claimed here.
