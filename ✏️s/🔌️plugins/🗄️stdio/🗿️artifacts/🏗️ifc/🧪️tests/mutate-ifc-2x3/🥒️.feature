...
@oracle-ruststep-ifc-2x3-any-mutate
@comparison-semantic-ifc-v1
@mutations-ifc-2x3-any
Feature: Apply every typed IFC2X3 mutation to a real-world building model
  ...
  This subset's own vocabulary (`Ifc2x3Mutation`, `../../🏅️standards/🔖️2x3/🪆️subsets/✳️any/🧬️schema/
  ...
  the same pattern the sibling `step/🔖️ap214/✳️any` subset's `insert-entity`/`remove-entity` pair
  ...
  `ruststep` 0.4, already linked and registered for the sibling `step/🔖️ap214/✳️any` subset this
  ...
  this subset's own from-scratch Part-21 writer, in `../../🏅️standards/🔖️2x3/🪆️subsets/✳️any/
