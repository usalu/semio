...
impl protocol::OpBinary for PptxTransitionalEditorCommand {
    ...
    async fn decode_op(bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        ...
        <Self as protocol::OpText>::parse_op(&line).await.map_err(|error| protocol::ProtocolError::Malformed { what: "pptx transitional editor command", offset: 0, detail: error.to_string() })
    }
}
//#endregion 🔖️Command
...
pub async fn create_pptx_transitional_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(PPTX_TRANSITIONAL_EDITOR_DIALECT)
        ...
        .await.default_mode_id(edit::PPTX_TRANSITIONAL_EDIT_MODE_ID)
