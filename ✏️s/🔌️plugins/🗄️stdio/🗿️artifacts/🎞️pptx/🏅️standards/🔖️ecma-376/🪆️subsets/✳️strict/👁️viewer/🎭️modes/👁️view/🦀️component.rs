//! 👁️ Pptx strict viewer — the `view` mode: the read-only twin of the mutation-capable surface's
//! single full-pane Document window, same page-per-slide content, no edit affordances.

use crate::viewer::pptx::standards::v_ecma_376::subsets::strict::modes::view::windows::main;
use semio_framework_plugin::{LocalizedLabel, ModeDefinition, WindowLayout, WindowLayoutRoot, WindowLayoutStackNode, WindowLayoutWindowNode};

pub const PPTX_STRICT_VIEW_MODE_ID: &str = "view";

//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `create_pptx_strict_viewer` (this subset's surface
/// root).
pub async fn definition() -> ModeDefinition {
    ModeDefinition { id: PPTX_STRICT_VIEW_MODE_ID.into(), label: LocalizedLabel::native("View", "Ansicht"), icon_id: "eye".into(), tools: Vec::new(), layout_id: None, commands: Vec::new() }
}
