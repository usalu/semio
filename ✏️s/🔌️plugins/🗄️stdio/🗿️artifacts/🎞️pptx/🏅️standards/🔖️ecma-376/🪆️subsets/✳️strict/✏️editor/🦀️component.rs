...
impl protocol::OpBinary for PptxStrictEditorCommand {
    ...
    async fn decode_op(bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        ...
        <Self as protocol::OpText>::parse_op(&line).await.map_err(|error| protocol::ProtocolError::Malformed { what: "pptx strict editor command", offset: 0, detail: error.to_string() })
    }
}
//#endregion 🔖️Command
...
//#region 🔖️Manifest
pub async fn create_pptx_strict_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(PPTX_STRICT_EDITOR_DIALECT)
        ...
        .await.default_mode_id(edit::PPTX_STRICT_EDIT_MODE_ID)
