//! ✏️ Pptx transitional editor — the `edit` mode: a single full-pane Document window over the
//! slide list, one page per slide.

use crate::editor::pptx::standards::v_ecma_376::subsets::transitional::modes::edit::windows::main;
use semio_framework_plugin::{LocalizedLabel, ModeDefinition, WindowLayout, WindowLayoutRoot, WindowLayoutStackNode, WindowLayoutWindowNode};

pub const PPTX_TRANSITIONAL_EDIT_MODE_ID: &str = "edit";
...
pub fn definition() -> ModeDefinition {
    ModeDefinition { id: PPTX_TRANSITIONAL_EDIT_MODE_ID.into(), label: LocalizedLabel::native("Edit", "Bearbeiten"), icon_id: "pencil".into(), tools: Vec::new(), layout_id: None, commands: Vec::new() }
}
