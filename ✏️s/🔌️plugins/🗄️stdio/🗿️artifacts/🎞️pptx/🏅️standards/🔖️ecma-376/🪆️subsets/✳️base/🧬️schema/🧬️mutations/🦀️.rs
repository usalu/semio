...
mod tests {
    ...
    async fn op_text_binary_roundtrip_law() {
        ...
        let mutations = vec![
            ...
            PptxMutation::RemoveShape(remove_shape::RemoveShape { slide_index: 0, shape_index: 0 }),
            PptxMutation::SetShapeText(set_shape_text::SetShapeText { slide_index: 0, shape_index: 0, text_frame: vec![PptxParagraph { runs: vec![PptxRun { text: "bold".into(), bold: true, italic: false, font_size: Some(24) }] }, PptxParagraph::text("second")] }),
            PptxMutation::SetShapePosition(set_shape_position::SetShapePosition { slide_index: 0, shape_index: 0, position: PptxTransform { x: 5, y: 6, cx: 7, cy: 8 } }),
        ];
