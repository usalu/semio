...
pub async fn assembly(definition: semio_framework_plugin::ArtifactDefinition) -> Result<crate::registry::ArtifactAssembly, semio_framework_plugin::PluginAssemblyError> {
    crate::registry::runtime_assembly("pptx", definition, declaration).await
}
...
pub async fn declaration(definition: semio_framework_plugin::ArtifactDefinition) -> Result<semio_framework_plugin::ArtifactDeclaration, semio_framework_plugin::ArtifactDefinitionError> {
    let formats = crate::registry::format_descriptors_for("pptx").await?;
    semio_framework_plugin::ArtifactDeclaration::builder(definition)
        .await.schema(crate::artifacts::pptx::schema::pptx_artifact_schema_descriptor().await)
        .await.formats(formats)
        .await.inferences([crate::artifacts::pptx::standards::v_ecma_376::subsets::any::schema::inferences::pptx_artifact_inference_descriptor()])
        .await.composers(crate::artifacts::pptx::standards::v_ecma_376::subsets::any::io::io_registry::entries())
        .await.subset_validators(pptx_subset_validators().await)
...
async fn pptx_subset_validators() -> &'static [semio_framework_plugin::SubsetValidatorEntry] {
