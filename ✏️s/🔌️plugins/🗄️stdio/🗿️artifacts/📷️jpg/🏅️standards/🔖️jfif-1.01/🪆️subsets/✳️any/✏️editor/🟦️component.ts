/** ✏️ `jpg` editor (any) — subset-level typed twin. Mirrors the editor
...
export const JPG_ANY_EDITOR_DIALECT = { artifactKind: "s.stdio.jpg", standard: "jfif-1.01", subset: "*" } as const;

export const JPG_ANY_EDIT_MODE_ID = "edit" as const;
