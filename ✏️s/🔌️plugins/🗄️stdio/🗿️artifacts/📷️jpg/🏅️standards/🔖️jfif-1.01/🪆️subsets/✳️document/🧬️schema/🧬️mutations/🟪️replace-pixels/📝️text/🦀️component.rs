...
pub fn print(value: &JpgMutation) -> Option<String> {
    ...
    Some(format!("replace-pixels pixels={}", diff::hex_encode(pixels)))
}
pub fn parse(line: &str) -> Result<JpgMutation, String> {
    ...
    Ok(JpgMutation::ReplacePixels(crate::artifacts::jpg::schema::mutations::ReplacePixelsMutation { pixels: diff::hex_decode(arg("pixels")?)? }))
}
