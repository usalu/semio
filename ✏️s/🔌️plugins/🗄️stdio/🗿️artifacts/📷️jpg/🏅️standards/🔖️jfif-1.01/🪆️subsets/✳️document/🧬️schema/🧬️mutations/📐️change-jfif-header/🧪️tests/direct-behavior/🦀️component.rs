//! 🧪️ `change-jfif-header` fixture — `direct-behavior`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-jfif-header/direct-behavior: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
