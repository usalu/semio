...
pub fn print(value: &JpgMutation) -> Option<String> {
    ...
    Some(format!("replace-quant-table table={}", diff::enc_quant_table(table)))
}
pub fn parse(line: &str) -> Result<JpgMutation, String> {
    ...
    Ok(JpgMutation::ReplaceQuantTable(crate::artifacts::jpg::schema::mutations::ReplaceQuantTableMutation { table: diff::dec_quant_table(arg("table")?)? }))
}
