//! 🧪️ `📸️set-snapshot` fixture — `📈️raises-the-flevel-hint-and-extends-the-payload`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️raises-the-flevel-hint-and-extends-the-payload/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️raises-the-flevel-hint-and-extends-the-payload/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️raises-the-flevel-hint-and-extends-the-payload/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️raises-the-flevel-hint-and-extends-the-payload/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️raises-the-flevel-hint-and-extends-the-payload/🎯️outcome/🔣️.json");
