//! 👁️ Deflate viewer — the `view` mode: a single read-only window over the RFC1950 header metadata
...
pub fn definition() -> ModeDefinition {
    ModeDefinition { id: DEFLATE_VIEW_MODE_ID.into(), label: LocalizedLabel::native("View", "Ansicht"), icon_id: "eye".into(), tools: Vec::new(), layout_id: None, commands: Vec::new() }
}
