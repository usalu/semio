//! 🧪️ `set-snapshot` fixture — `✏️corrects-the-area-cell-and-quotes-it`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️corrects-the-area-cell-and-quotes-it/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️corrects-the-area-cell-and-quotes-it/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️corrects-the-area-cell-and-quotes-it/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️corrects-the-area-cell-and-quotes-it/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️corrects-the-area-cell-and-quotes-it/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: CsvSnapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn committed_diff_is_canonical() {
    let decoded: CsvDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
