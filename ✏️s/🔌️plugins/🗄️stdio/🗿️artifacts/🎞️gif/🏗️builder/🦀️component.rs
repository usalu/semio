//! 🏗️ GifBuilder (final, artifact-level) — delegates to the 89a standard (canonical per S-6:
//! `.claude/plans/the-current-schemas-are-scalable-journal.md`; 87a stays reachable at
//! `standards::v87a::builder`).

use semio_framework_plugin::ArtifactBuilder;
use crate::artifacts::gif::{GifDiff, GifMutation, GifSnapshot};
use crate::artifacts::gif::standards::v89a::builder::GifBuilder as GifRawBuilder;
