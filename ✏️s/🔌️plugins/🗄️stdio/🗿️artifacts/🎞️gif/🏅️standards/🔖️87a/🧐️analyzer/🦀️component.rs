//! 🧐️ GifAnalyzer (87a standard) — delegates to its ✳️any subset.

use semio_framework_plugin::{ArtifactAnalyzer, Dialect, StandardId, SubsetId, IoConfidence, Analysis, AnalyzeSource};
use crate::artifacts::gif::standards::v87a::subsets::any::analyzer::GifAnalyzer as GifRawAnyAnalyzer;
pub use crate::artifacts::gif::standards::v87a::subsets::any::analyzer::GifParts;
