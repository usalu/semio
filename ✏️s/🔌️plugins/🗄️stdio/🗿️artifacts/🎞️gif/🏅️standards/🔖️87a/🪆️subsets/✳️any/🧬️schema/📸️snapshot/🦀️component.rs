//! 🧬️ GifSnapshot schema — persistent fields + real codecs.
...
impl Default for GifSnapshot {
    fn default() -> Self {
        Self { schema: STDIO_GIF_DOCUMENT_SCHEMA.into(), image: RasterImage::default() }
    }
}
//#endregion Snapshot

//#region HandcraftedDocumentCodecs
impl store::DocumentDsl for GifSnapshot {
    const EXTENSION: &'static str = "gif";
    fn envelope_id() -> &'static str { "stdio.gif" }
...
impl store::DocumentPack for GifSnapshot {
