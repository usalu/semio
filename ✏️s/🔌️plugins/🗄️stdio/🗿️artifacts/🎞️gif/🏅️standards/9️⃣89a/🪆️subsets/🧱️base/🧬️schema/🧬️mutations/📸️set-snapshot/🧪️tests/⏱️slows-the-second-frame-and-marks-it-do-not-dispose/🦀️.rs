...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⏱️slows-the-second-frame-and-marks-it-do-not-dispose/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⏱️slows-the-second-frame-and-marks-it-do-not-dispose/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⏱️slows-the-second-frame-and-marks-it-do-not-dispose/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⏱️slows-the-second-frame-and-marks-it-do-not-dispose/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⏱️slows-the-second-frame-and-marks-it-do-not-dispose/🎯️outcome/🔣️.json");
