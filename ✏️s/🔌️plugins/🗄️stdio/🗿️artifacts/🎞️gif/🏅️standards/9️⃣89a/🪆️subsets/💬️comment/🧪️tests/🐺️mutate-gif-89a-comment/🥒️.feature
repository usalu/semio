...
Feature: Apply every typed GIF 89a mutation to a real-world animation
  See ../🪁️mutate-gif-89a/🥒️.feature for the full fixture/provenance narrative -- this subset's own scenarios exercise only the mutation kinds `../../🏅️standards` places under this subset.
