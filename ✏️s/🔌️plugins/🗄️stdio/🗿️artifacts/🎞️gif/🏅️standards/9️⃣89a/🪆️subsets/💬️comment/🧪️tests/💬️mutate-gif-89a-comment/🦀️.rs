...
mod subject {
    ...
    use semio_s_artifact_stdio_gif::standards::v89a::subsets::any::schema::snapshot::{GifAppExtension, GifColorTable, GifDisposal, GifFrame, GifRgb, GifSnapshot, STDIO_GIF89A_DOCUMENT_SCHEMA};
