 ...
 * — `../📸️snapshot/🟦️component.ts`'s `GifSnapshot` is still the pre-rewrite raw-`entries` stub
 * (the Rust snapshot moved to a structured screen/GCT/frame model per `📸️snapshot/🦀️component.rs`),
