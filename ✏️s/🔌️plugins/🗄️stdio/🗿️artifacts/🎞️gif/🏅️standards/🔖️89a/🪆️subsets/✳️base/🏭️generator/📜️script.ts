...
function readerManifestEntry(recipe: ReaderRecipe, outDir: string): Record<string, unknown> {
  ...
  return {
    ...
    generator: {
      ...
      command: `bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/🎞️gif/🏅️standards/🔖️89a/🪆️subsets/✳️base/🏭️generator/📜️script.ts build --only ${recipe.id}`,
      platform: platformId(),
    },
...
`;
    ...
    for (const kind of KINDS) {
      ...
      entries.push({
        ...
        generator: { oracle: "gif-89a-extension-reader", packageVersion: "11.3.0", engineFamily: "pillow", engineVersion: "11.3.0", command: "bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/🎞️gif/🏅️standards/🔖️89a/🪆️subsets/✳️base/🏭️generator/📜️script.ts extensions", platform: process.platform },
