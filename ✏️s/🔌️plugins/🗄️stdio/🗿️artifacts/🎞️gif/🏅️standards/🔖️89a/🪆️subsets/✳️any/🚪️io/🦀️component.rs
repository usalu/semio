//! 🚪️ IO stdio.gif (89a/✳️any) — registration now flows through 🎹️composer::register
...
/// `GifFrameDiff`'s own three nested tri-states block it, see `🔺️diff/🦀️component.rs`'s own
