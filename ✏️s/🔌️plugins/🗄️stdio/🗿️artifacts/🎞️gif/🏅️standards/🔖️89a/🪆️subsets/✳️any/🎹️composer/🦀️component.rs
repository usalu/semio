//! 🎹️ GifComposer (raw/✳️any at 89a) — analyzer + builder glued. Reads native
//! `stdio.gif` sources (plus its DAG dependencies: binary), writes one `stdio.gif` (89a/✳️any) snapshot.
