...
/// 🧪️ P2-FG2: real, deterministic demo `GifSnapshot` for `conformance_laws` (below) and the
/// shipped `.dsl.semio`/`.pack.semio` fixtures (`../📚️examples/🎬️demo/🖼️assets/`) — per the
/// ticket's own instruction, this reuses the REAL `dancing.gif` fixture
