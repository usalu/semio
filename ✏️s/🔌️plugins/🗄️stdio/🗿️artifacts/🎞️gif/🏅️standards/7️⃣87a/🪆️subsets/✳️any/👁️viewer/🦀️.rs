...
use crate::standards::v87a::subsets::any::schema::mutations::GifMutation;
...
pub fn create_gif_87a_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(GIF_87A_DIALECT).document(["semio", "gif"]).icon_id("image").mode_def(view::definition()).default_mode_id(view::MODE_ID).window_kind_def(main::definition()).default_layout(view::layout()).build_definition()
}
//#endregion 🔖️Manifest
