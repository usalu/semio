//! 💡️ Gif (87a) inference schema — the fourth schema family alongside snapshot/diff/mutations
...
//! SEPARATE inference schema id from) `9️⃣89a`'s own `GifInference` — same shape as those two
...
impl protocol::InferenceSpec<GifSnapshot> for GifInference {
    fn inference_schema_id() -> &'static str {
        "s.stdio.gif.inference"
    }
    fn schema_version() -> u32 {
        1
    }
    fn fields() -> &'static [protocol::InferenceFieldSpec] {
        &[protocol::InferenceFieldSpec { id: "s.stdio.gif.inference.dimensions", reads: &["width", "height", "gct"] }]
    }
}
//#endregion 🔖️Inference

//#region 🔖️ArtifactInferrer
/// 💡️ No `InferredField`s here (a screen-descriptor/GCT read is already O(1)) — the default
/// `infer_cached` passthrough (`ArtifactInferrer::infer_cached`) is exact.
impl semio_framework_plugin::ArtifactInferrer for crate::artifacts::gif::standards::v87a::subsets::any::schema::GifBuilder {
