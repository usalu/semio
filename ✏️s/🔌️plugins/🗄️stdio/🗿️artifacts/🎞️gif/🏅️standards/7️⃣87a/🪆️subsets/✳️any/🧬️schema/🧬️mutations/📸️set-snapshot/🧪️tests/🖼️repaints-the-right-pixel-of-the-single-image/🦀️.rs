...
use crate::standards::v87a::subsets::any::schema::mutations::{apply_gif_mutation, GifMutation};
use crate::standards::v87a::subsets::any::schema::snapshot::GifSnapshot;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🖼️repaints-the-right-pixel-of-the-single-image/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🖼️repaints-the-right-pixel-of-the-single-image/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🖼️repaints-the-right-pixel-of-the-single-image/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🖼️repaints-the-right-pixel-of-the-single-image/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🖼️repaints-the-right-pixel-of-the-single-image/🎯️outcome/🔣️.json");
