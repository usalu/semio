...
mod tests {
    ...
    fn pdf_snapshot_and_facets_forbid_native_shadow_state() {
        let rust = include_str!("../🧬️schema/📸️snapshot/🦀️.rs");
        ...
        for (relative, text) in [
            ...
            ("diff.proto", include_str!("../🧬️schema/🔺️diff/🛰️.proto")),
            ("diff.graphql", include_str!("../🧬️schema/🔺️diff/🔗️.graphql")),
            ("diff.ts", include_str!("../🧬️schema/🔺️diff/🟦️.ts")),
            ("diff.ebnf", include_str!("../🧬️schema/🔺️diff/📝️text/🔤️.ebnf")),
            ("diff.g4", include_str!("../🧬️schema/🔺️diff/📝️text/🅰️.g4")),
            ("diff-binary.abnf", include_str!("../🧬️schema/🔺️diff/💾️binary/🔠️.abnf")),
            ("diff-binary.spicy", include_str!("../🧬️schema/🔺️diff/💾️binary/🌶️.spicy")),
            ("diff-binary.ksy", include_str!("../🧬️schema/🔺️diff/💾️binary/🥋️.ksy")),
        ] {
