...
fn missing_optional_fields_keep_the_derived_defaults() {
    ...
    assert_eq!(PdfSnapshot::from_value(value), Ok(PdfSnapshot { schema: "stdio.pdf.1.7".to_string(), declared_version: String::new(), pages: Vec::new(), info: PdfInfo::default(), objects: Vec::new(), trailer: Vec::new() }));
}
