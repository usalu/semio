...
//! `../../🏅️standards/7️⃣1.7/🪆️subsets/🧾️vt/🔮️oracles/🦀️.rs`, `subject` handlers drive this
...
//!
//! @see ../../🏅️standards/7️⃣1.7/🪆️subsets/🧾️vt/🧬️schema/🦀️.rs — `check_vt_conformance`, the one
...
/// `../../🏅️standards/7️⃣1.7/🪆️subsets/🧾️vt/🧬️schema/🧬️mutations/🦀️.rs::KINDS` — that module
