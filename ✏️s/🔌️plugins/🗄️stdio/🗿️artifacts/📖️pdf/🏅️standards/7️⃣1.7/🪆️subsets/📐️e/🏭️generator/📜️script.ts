...
// `../../../../../../🧪️tests/📐️mutate-pdf-1-7-e` drives — never this repository's own production PDF
  ...
  for (const kind of KINDS) {
    ...
    entries.push({
      ...
      generator: {
        ...
        engineFamily: "lopdf",
        engineVersion: "0.44",
        command: "bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/📖️pdf/🏅️standards/7️⃣1.7/🪆️subsets/📐️e/🏭️generator/📜️script.ts generate",
        platform: process.platform,
      },
      comparisonPipeline: "pdf-1-7-e-lopdf-compare-v1",
