...
//! `../../🏅️standards/7️⃣1.7/🪆️subsets/📐️e/🔮️oracles/🦀️.rs`, `subject` handlers drive this
...
//!
//! @see ../../🏅️standards/7️⃣1.7/🪆️subsets/📐️e/🧬️schema/🦀️.rs — `check_e_conformance`, the one
...
/// `../../🏅️standards/7️⃣1.7/🪆️subsets/📐️e/🧬️schema/🧬️mutations/🦀️.rs::KINDS` — that module
...
mod subject {
    ...
    use crate::standards::v1_7::subsets::e::schema::mutations::*;
