...
use crate::standards::v1_7::subsets::base::schema::snapshot::{PdfSnapshot, STDIO_PDF17_DOCUMENT_SCHEMA};
...
pub fn deserialize(from: &DeflateSnapshot) -> Result<PdfSnapshot, store::PackError> {
    let mut snap = crate::standards::v1_7::subsets::base::io::decode_pdf(&from.payload).map_err(|e| store::PackError::Schema(e.to_string()))?;
