...
//! `../../🏅️standards/7️⃣1.7/🪆️subsets/🖨️x/🔮️oracles/🦀️.rs`, `subject` handlers drive this
...
//!
//! @see ../../🏅️standards/7️⃣1.7/🪆️subsets/🖨️x/🧬️schema/🦀️.rs — `check_x_conformance`, the one
...
mod subject {
    ...
    use semio_s_artifact_stdio_pdf::standards::v1_7::subsets::x::schema::mutations::{apply_x_conformance_mutation, PdfXMutation, InsertEncryptionDictionary, RemoveEncryptionDictionary, SetOutputIntent, RemoveOutputIntent, SetTrimBox, RemoveTrimBox, EmbedFontFile, RemoveFontFile, InsertJavascriptAction, RemoveJavascriptAction, InsertLaunchAction, RemoveLaunchAction, InsertMediaAnnotation, RemoveMediaAnnotation};
