...
pub mod derived_analysis {
    ...
    // 🚫️async: E1 pure inherent-impl helper (file verified I/O-free, consumed via opaque-type-hostile call site) — see R9
    fn dict_name<'a>(dict: &'a [crate::standards::v1_7::subsets::base::schema::snapshot::PdfDictEntry], key: &str) -> Option<&'a str> {
    ...
    //#region 🔖️Analyzer
    /// 🧐️ Analyzes `stdio.pdf` (1.7/🗄️a): delegates the real parse to the 🧱️base subset's analyzer
