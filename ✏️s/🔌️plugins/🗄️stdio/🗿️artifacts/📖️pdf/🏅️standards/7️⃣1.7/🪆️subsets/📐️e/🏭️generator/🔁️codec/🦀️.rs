//! 📄️ The `pdf@1.7/e` mutation vocabulary and conformance projection, expressed ENTIRELY through
...
pub fn build_seed() -> Vec<u8> {
    ...
    let content_id = document.add_object(Stream::new(dictionary! {}, b"BT /F1 12 Tf 72 720 Td (pdf-1-7-e fixture seed) Tj ET".to_vec()));
    ...
    let info = document.add_object(dictionary! {
        "Title" => Object::string_literal("pdf-1-7-e fixture seed"),
        "Author" => Object::string_literal("pdf-1-7-e-lopdf-engine"),
    });
...
pub fn project(bytes: &[u8]) -> Result<String, String> {
    ...
    let mut out = String::from("{\"subset\":\"e\"");
