//! 🔒️ Authoritative PDF/A mutation for inserting a Standard Security Handler dictionary.
...
impl MutationKind<PdfSnapshot, PdfAMutation> for InsertEncryptionDictionary {
