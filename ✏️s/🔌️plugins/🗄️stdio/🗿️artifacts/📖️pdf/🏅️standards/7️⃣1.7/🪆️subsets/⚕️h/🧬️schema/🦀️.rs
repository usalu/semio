//! 🧬️ PdfSnapshot schema (1.7/⚕️h) — reuses the 🧱️base subset's `PdfSnapshot` verbatim (the
...
pub mod derived_analysis {
    ...
    mod tests {
        use super::*;
        use crate::artifacts::pdf::standards::v1_7::subsets::base::schema::snapshot::PdfInfo;
