//! 📄️ The `pdf@1.4/a` mutation vocabulary and structural projection, expressed ENTIRELY through
...
pub fn build_seed() -> Vec<u8> {
    ...
    let first = make(&mut document, "pdf-1-4-a fixture seed page one");
    let second = make(&mut document, "pdf-1-4-a fixture seed page two");
    ...
    let info = document.add_object(dictionary! {
        "Title" => Object::string_literal("pdf-1-4-a fixture seed"),
        "Author" => Object::string_literal("pdf-1-4-a-lopdf-engine"),
    });
