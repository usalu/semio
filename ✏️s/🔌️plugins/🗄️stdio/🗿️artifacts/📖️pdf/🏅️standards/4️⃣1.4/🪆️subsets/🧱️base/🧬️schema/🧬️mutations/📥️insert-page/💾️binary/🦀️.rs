...
//#region 🔖️Codec
pub const TAG: u8 = dsl::protocol_record::tag_u8(include_str!("../../💾️binary/📡️.protocol.semio"), "insert-page");
...
pub fn decode(bytes: &[u8]) -> Result<PdfMutation, String> {
    ...
    let payload = InsertPage { index: reader.index()?, page: crate::standards::v1_4::subsets::base::schema::snapshot::PageDoc { width: reader.number()?, height: reader.number()?, text: reader.text()? } };
    reader.finish()?;
