//! 🏭️ Writes the `pdf@1.4/base` fixture corpus with semantic directories and before/after carriers.
//!
...
fn fixture_directory(kind: &str) -> &'static str {
    match kind {
        ...
        "resize-page" => "📐️resize-page",
        "replace-page-text" => "♻️replace-page-text",
