//! 🧪️ `resize-page` fixture — `🔄️round-trips-the-concrete-inverse`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-page/🔄️round-trips-the-concrete-inverse/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-page/🔄️round-trips-the-concrete-inverse/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-page/🔄️round-trips-the-concrete-inverse/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-page/🔄️round-trips-the-concrete-inverse/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-page/🔄️round-trips-the-concrete-inverse/🎯️outcome/🔣️.json");
...
fn mutation() -> PdfMutation {
    dsl::json::from_json_str(MUTATION).expect("committed resize-page payload decodes")
}
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "resize-page/round-trips-the-concrete-inverse: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
fn op_codecs_round_trip() {
    ...
    for step in std::iter::once(payload.clone()).chain(payload.inverse(&before())) {
        ...
        assert_eq!(
            ...
            step,
            "resize-page/round-trips-the-concrete-inverse: the JSON form does not round-trip"
        );
    }
}
