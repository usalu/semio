//! 🧪️ `insert-page` fixture — `🔄️round-trips-the-concrete-inverse`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️insert-page/🔄️round-trips-the-concrete-inverse/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️insert-page/🔄️round-trips-the-concrete-inverse/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️insert-page/🔄️round-trips-the-concrete-inverse/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️insert-page/🔄️round-trips-the-concrete-inverse/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️insert-page/🔄️round-trips-the-concrete-inverse/🎯️outcome/🔣️.json");
