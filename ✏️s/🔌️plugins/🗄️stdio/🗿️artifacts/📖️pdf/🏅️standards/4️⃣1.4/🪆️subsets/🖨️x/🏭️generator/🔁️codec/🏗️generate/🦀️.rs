//! 🏭️ Writes the `pdf@1.4/x` fixture corpus with semantic directories and before/after carriers.
//!
...
use pdf_14_x_lopdf::{apply, arrange, build_seed, project, KINDS};

fn fixture_directory(kind: &str) -> &'static str {
    match kind {
        "set-page-size" => "📐️set-page-size",
        "collapse-page-size" => "📉️collapse-page-size",
