...
mod tests {
    ...
    fn language_neutral_direct_vectors_match_independent_lopdf() {
        use crate::standards::v1_4::subsets::base::{build_document, independent_pages, OraclePage};
        use semio_repo_test_host::parse_json;
        let vectors =
            [include_str!("../🧬️schema/🧬️mutations/📝️set-page-text/🧪️tests/🔄️round-trips-the-concrete-inverse/🔣️.json"), include_str!("../🧬️schema/🧬️mutations/🧹️clear-page-text/🧪️tests/🔄️round-trips-the-concrete-inverse/🔣️.json")];
        for text in vectors {
