...
//! `../../🏅️standards/4️⃣1.4/🪆️subsets/🗄️a/🔮️oracles/🦀️.rs`, `subject` handlers drive this
...
//!
//! @see ../../🏅️standards/4️⃣1.4/🪆️subsets/🗄️a/🧬️schema/🦀️.rs — `check_pdf_a_conformance`, the one
...
/// `../../🏅️standards/4️⃣1.4/🪆️subsets/🗄️a/🧬️schema/🧬️mutations/🦀️.rs::KINDS` — that module
...
mod subject {
    ...
    use crate::standards::v1_4::subsets::a::schema::mutations::{apply_a_conformance_mutation, inverse_a_conformance_mutation, ClearPageText, PdfA1Mutation, SetPageText};
