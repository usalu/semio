...
fn missing_page_refuses_without_inverse_or_state_change() {
    let mutation: PdfMutation = pack::from_json_str(include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️insert-page/🔄️round-trips-the-concrete-inverse/🦠️mutation/🔣️.json")).expect("committed insert-page payload decodes");
