//! 🧪️ `move-page` fixture — `🔄️round-trips-the-concrete-inverse`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-page/🔄️round-trips-the-concrete-inverse/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-page/🔄️round-trips-the-concrete-inverse/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-page/🔄️round-trips-the-concrete-inverse/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-page/🔄️round-trips-the-concrete-inverse/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-page/🔄️round-trips-the-concrete-inverse/🎯️outcome/🔣️.json");
...
fn mutation() -> PdfMutation {
    dsl::json::from_json_str(MUTATION).expect("committed move-page payload decodes")
}
