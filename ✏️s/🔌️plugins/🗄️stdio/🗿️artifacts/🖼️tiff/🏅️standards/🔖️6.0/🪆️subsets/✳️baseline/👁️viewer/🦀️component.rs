...
use crate::artifacts::tiff::{TIFF_BASELINE_DIALECT, STDIO_TIFF_DOCUMENT_SCHEMA};
...
//#region 🔖️Manifest
pub async fn create_tiff_baseline_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(TIFF_BASELINE_DIALECT)
        .document(["semio", "tiff"])
        .icon_id("image")
