//! 🧪️ `remove-ifd` fixture — `direct-behavior`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-ifd/direct-behavior: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
