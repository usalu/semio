/** ✏️ `tiff` editor (any) — subset-level typed twin. Mirrors the editor
...
export const TIFF_ANY_EDITOR_DIALECT = { artifactKind: "s.stdio.tiff", standard: "6.0", subset: "*" } as const;

export const TIFF_ANY_EDIT_MODE_ID = "edit" as const;
