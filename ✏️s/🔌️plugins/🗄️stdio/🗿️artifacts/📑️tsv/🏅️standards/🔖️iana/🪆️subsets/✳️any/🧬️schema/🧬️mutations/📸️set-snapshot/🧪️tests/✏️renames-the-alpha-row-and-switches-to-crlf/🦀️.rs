//! 🧪️ `set-snapshot` fixture — `✏️renames-the-alpha-row-and-switches-to-crlf`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-alpha-row-and-switches-to-crlf/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-alpha-row-and-switches-to-crlf/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-alpha-row-and-switches-to-crlf/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-alpha-row-and-switches-to-crlf/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️renames-the-alpha-row-and-switches-to-crlf/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: TsvSnapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-snapshot/renames-the-alpha-row-and-switches-to-crlf: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: TsvDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
