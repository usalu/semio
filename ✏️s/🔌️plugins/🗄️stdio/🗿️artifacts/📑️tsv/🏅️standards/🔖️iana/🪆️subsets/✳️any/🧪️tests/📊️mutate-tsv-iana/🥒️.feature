...
Feature: Apply every typed IANA TSV mutation to a real-world table
  The input is shared://♻️reuse-marketplaces.tsv, a 51-record, 12-column real research table derived
  ONCE through a real provenance chain: a genuine systematic survey of European building-component
  reuse marketplaces (♻️mit-bestand/📋️bericht/📋️zwischenbericht/📎️anhang/♻️bauteilboersen.tex) was
