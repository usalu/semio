//! 👁️ Zip viewer (2.0/✳️iso21320) — the `view` mode: a single read-only window over the archive
//! tree, the read-only counterpart of the editor's `edit` mode.
...
pub const ZIP_ISO21320_VIEW_MODE_ID: &str = "view";
