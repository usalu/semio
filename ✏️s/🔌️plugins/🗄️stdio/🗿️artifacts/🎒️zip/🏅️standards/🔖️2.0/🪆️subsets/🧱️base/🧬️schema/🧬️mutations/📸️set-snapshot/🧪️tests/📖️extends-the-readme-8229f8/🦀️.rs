//! 🧪️ `set-snapshot` fixture — `📖️extends-the-readme-and-adds-a-version-member`.
//!
...
use crate::artifacts::zip::standards::v2_0::subsets::base::schema::mutations::{apply_zip_mutation, ZipMutation};
