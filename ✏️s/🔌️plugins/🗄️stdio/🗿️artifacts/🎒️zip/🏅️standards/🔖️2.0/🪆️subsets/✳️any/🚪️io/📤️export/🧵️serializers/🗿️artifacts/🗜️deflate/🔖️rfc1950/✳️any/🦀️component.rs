...
pub async fn serialize(from: &ZipSnapshot) -> Result<DeflateSnapshot, store::PackError> {
    let zip_bytes = crate::artifacts::zip::standards::v2_0::subsets::any::io::encode_zip(from).await.map_err(|e| store::PackError::Schema(e.to_string()))?;
