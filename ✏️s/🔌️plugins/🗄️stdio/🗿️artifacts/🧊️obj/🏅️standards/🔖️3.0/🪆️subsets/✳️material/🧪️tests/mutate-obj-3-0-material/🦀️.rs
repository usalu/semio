...
//! direct OBJ-grammar manipulation (`../../../✳️any/🧪️oracle/🦀️.rs`,
...
//! level into this subset), this file was a copy-pasted duplicate of `✳️any/🧪️tests/mutate-obj-3-0/
...
/// usemtl range this ticket's own fixtures (`../../🧫️fixtures/set-usemtl/before.obj`) carry.
