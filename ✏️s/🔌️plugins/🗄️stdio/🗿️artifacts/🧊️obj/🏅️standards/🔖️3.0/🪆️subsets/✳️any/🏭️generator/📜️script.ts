...
// 🏭️ Third-party fixture generator for `s.stdio.obj@3.0/✳️any`.
//
...
async function manifestForLegacy(): Promise<Record<string, unknown>> {
  ...
  return {
    ...
    generator: { oracle: "tobj-obj-3-0-mutate", packageVersion: "4", engineFamily: "tobj", engineVersion: "4", command: `bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/🧊️obj/🏅️standards/🔖️3.0/🪆️subsets/✳️any/🏭️generator/📜️script.ts generate`, platform: `${process.platform}-${process.arch}` },
...
async function manifestForReaderRecipe(recipe: { id: string; hasAfter: boolean }): Promise<Record<string, unknown>> {
  ...
  return {
    ...
    units: { length: "unitless", angle: "degree" },
    files,
    generator: { oracle: "tobj-obj-3-0-mutate-reader", packageVersion: "4", engineFamily: "tobj", engineVersion: "4", command: `bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/🧊️obj/🏅️standards/🔖️3.0/🪆️subsets/✳️any/🏭️generator/📜️script.ts generate --only ${recipe.id}`, platform: `${process.platform}-${process.arch}` },
    provenance: { source: "generated", license: "public-domain (synthetic, no third-party content embedded)" },
    comparisonProfile: "semantic-obj-3-0-v1",
    reproducible: true,
    family: "structural",
  ...
  if (command === "document" || command === "document-manifests") {
    ...
    for (const kind of Object.keys(PAIRS)) {
      ...
      entries.push({
        ...
        generator: { oracle: "three-obj-3-0-document-reader", packageVersion: "0.182.0", engineFamily: "threejs", engineVersion: "0.182.0", command: "bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/🧊️obj/🏅️standards/🔖️3.0/🪆️subsets/✳️any/🏭️generator/📜️script.ts document", platform: process.platform },
