...
Feature: Apply every typed OBJ 3.0 mutation to a real-world mesh
  See ../mutate-obj-3-0/🥒️.feature for the full fixture/provenance narrative -- this subset's own scenarios exercise only the mutation kinds `../../🏅️standards` places under this subset.
