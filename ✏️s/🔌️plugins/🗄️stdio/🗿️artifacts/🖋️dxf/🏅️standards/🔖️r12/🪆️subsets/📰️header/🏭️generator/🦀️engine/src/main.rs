...
//!                                   `../../../🔮️oracle/🦀️.rs`'s own `project_dxf_r12` shape,
...
/// collection rebuilt — same small pattern `../../../🔮️oracle/🦀️.rs`'s own `imp` module uses
...
fn recipe(id: &str) -> Option<RecipeOutput> {
    ...
    match id {
        ...
        // persists unconditionally on an R12 save (../../../🔮️oracle/🦀️.rs's own
...
/// 📄️ Semantic projection of one entity — the exact field set `../../../🔮️oracle/🦀️.rs`'s
...
/// independently re-derived from `../../../🔮️oracle/🦀️.rs`'s own `project_dxf_r12` (same
...
//#region 🔖️Tests
#[cfg(test)]
#[path = "../../🧪️tests/🔬️engine-src-unit/🦀️.rs"]
mod tests;
//#endregion 🔖️Tests
