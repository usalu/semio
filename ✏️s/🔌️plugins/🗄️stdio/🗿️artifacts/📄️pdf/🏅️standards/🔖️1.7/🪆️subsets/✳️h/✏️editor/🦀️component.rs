...
impl ArtifactEditor for Pdf17HEditor {
    ...
    type Command = Pdf17HEditorCommand;
    ...
    async fn handle(
        ...
        match command {
            Pdf17HEditorCommand::SetPage { index, text } => {
...
//#region 🔖️Manifest
pub async fn create_pdf17_h_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(PDF17H_DIALECT)
        .document(["stdio", "pdf", "1.7", "h"])
        .icon_id("file-text")
        .mode_def(edit::definition())
        .default_mode_id(edit::PDF17H_EDIT_MODE_ID)
