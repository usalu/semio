...
// 0.44 reference implementation named `lopdf-pdf-1-7-x-mutate` in `../🔣️oracle.json` —
...
// `../🔣️oracle.json`'s `pdf-1-7-x` catalog) — `manifests` walks whichever recipe directories the
