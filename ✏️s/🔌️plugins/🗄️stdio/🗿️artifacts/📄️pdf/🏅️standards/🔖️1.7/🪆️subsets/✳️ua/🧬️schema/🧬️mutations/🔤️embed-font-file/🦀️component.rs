//! 🔤️ Authoritative PDF/UA mutation for attaching a font program to a font descriptor.

use super::remove_font_file::RemoveFontFile;
use super::PdfUaMutation;
use crate::artifacts::pdf::standards::v1_7::subsets::any::schema::{conformance_support as support, diff::PdfDiff, snapshot::{ObjRef, PdfObject, PdfSnapshot}};
...
impl MutationKind<PdfSnapshot, PdfUaMutation> for EmbedFontFile {
...
mod tests {
    ...
    fn attaches_the_program_to_the_selected_descriptor() {
        ...
        let outcome = <EmbedFontFile as MutationKind<PdfSnapshot, PdfUaMutation>>::diff(&mutation, &base);
