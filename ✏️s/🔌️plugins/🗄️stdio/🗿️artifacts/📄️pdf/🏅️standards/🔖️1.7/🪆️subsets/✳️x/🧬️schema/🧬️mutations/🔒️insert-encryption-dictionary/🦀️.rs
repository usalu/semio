//! 🔒️ Authoritative PDF/X mutation for inserting a Standard Security Handler dictionary.
...
impl MutationKind<PdfSnapshot, PdfXMutation> for InsertEncryptionDictionary {
    ...
    fn inverse(&self, _base: &PdfSnapshot) -> Vec<PdfXMutation> {
        vec![PdfXMutation::RemoveEncryptionDictionary(RemoveEncryptionDictionary { version: self.version, revision: self.revision })]
    }
