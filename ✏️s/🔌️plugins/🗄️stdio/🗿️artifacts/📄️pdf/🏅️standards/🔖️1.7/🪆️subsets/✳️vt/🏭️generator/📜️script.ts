...
// 🏭️ Third-party fixture generator for `s.stdio.pdf@1.7/✳️vt` — the 18-kind ISO 16612-2 (PDF/VT-1)
  ...
  for (const kind of KINDS) {
    ...
    entries.push({
      ...
      generator: {
        ...
        engineFamily: "lopdf",
        engineVersion: "0.44",
        command: "bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/📄️pdf/🏅️standards/🔖️1.7/🪆️subsets/✳️vt/🏭️generator/📜️script.ts generate",
...
async function encryptionMode(emitManifests: boolean, root: string): Promise<number> {
  ...
  for (const kind of KINDS) {
    ...
    entries.push({
      ...
      id: `encryption-${kind}`,
      class: "third-party-generated",
      target: { artifact: "s.stdio.pdf", standard: "1.7", subset: "vt" },
      mutation: kind,
      outcome: "applied",
      units: { length: "unitless", angle: "degree" },
      files,
