//! 🚀️ Authoritative PDF/E mutation for inserting a launch action.
...
impl MutationKind<PdfSnapshot, PdfEMutation> for InsertLaunchAction {
...
mod tests {
    ...
    fn inserts_the_launch_target() {
        ...
        let outcome = <InsertLaunchAction as MutationKind<PdfSnapshot, PdfEMutation>>::diff(&mutation, &base);
