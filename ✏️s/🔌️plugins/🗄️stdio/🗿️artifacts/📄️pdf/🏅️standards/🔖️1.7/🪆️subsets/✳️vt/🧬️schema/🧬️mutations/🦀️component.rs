...
#[path = "📐️set-trim-box/🦀️component.rs"]
pub mod set_trim_box;
#[path = "🧽️remove-trim-box/🦀️component.rs"]
...
#[path = "🗂️set-dpart-root/🦀️component.rs"]
pub mod set_dpart_root;
#[path = "🧹️remove-dpart-root/🦀️component.rs"]
pub mod remove_dpart_root;
#[path = "🏷️set-dpart-metadata/🦀️component.rs"]
pub mod set_dpart_metadata;
#[path = "🗑️remove-dpart-metadata/🦀️component.rs"]
