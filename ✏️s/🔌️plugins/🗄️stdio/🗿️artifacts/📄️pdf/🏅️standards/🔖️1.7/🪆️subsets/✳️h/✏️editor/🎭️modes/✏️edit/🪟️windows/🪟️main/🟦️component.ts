/** 🪟️ PDF/H Document (1.7) editor -- `main` window: typed twin of `component.rs`'s `DocumentWindowKit`
...
/** ✏️ `set-page` payload shape -- mirrors `Pdf17HEditorCommand::SetPage`. APPENDS to the page's
...
export interface Pdf17HSetPage {
  index: number;
  text: string;
}
