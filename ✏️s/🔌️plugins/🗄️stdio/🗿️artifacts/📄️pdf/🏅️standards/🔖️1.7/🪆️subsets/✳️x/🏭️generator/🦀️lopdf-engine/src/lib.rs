//! 📄️ The `pdf@1.7/x` mutation vocabulary and conformance projection, expressed ENTIRELY through
...
pub fn build_seed() -> Vec<u8> {
    ...
    let content_id = document.add_object(Stream::new(dictionary! {}, b"BT /F1 12 Tf 72 720 Td (pdf-1-7-x fixture seed) Tj ET".to_vec()));
    ...
    let info = document.add_object(dictionary! {
        "Title" => Object::string_literal("pdf-1-7-x fixture seed"),
        "Author" => Object::string_literal("pdf-1-7-x-lopdf-engine"),
    });
