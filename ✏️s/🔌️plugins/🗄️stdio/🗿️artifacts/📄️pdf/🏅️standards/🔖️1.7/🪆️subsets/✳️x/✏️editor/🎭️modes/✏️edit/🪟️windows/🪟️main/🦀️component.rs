//! 🪟️ PDF/X Document (1.7) editor -- `main` window: a real per-page overview + authoring surface over the shared `PdfSnapshot`
...
//#region 🔖️Definition
/// 🧱️ Stitched into the editor manifest by `crate::editor::pdf17x::create_pdf17_x_editor`.
