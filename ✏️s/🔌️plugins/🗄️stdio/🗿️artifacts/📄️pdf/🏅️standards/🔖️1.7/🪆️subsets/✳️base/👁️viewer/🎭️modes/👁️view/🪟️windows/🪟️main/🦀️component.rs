//! 🪟️ PDF Document (1.7) viewer -- `main` window: a real, READ-ONLY per-page overview over the shared `PdfSnapshot`
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::pdf17::create_pdf17_viewer`.
