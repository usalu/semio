...
//#region 🔖️Manifest
pub async fn create_pdf17_x_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(PDF17X_DIALECT)
        .await.document(["stdio", "pdf", "1.7", "x"])
        .await.icon_id("file-text")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::PDF17X_VIEW_MODE_ID)
