//! 🧐️ PdfAnalyzer (1.4 standard) — delegates to its ✳️any subset.

use semio_framework_plugin::{ArtifactAnalyzer, Dialect, StandardId, SubsetId, IoConfidence, Analysis, AnalyzeSource};
use crate::artifacts::pdf::standards::v1_4::subsets::any::analyzer::PdfAnalyzer as PdfRawAnyAnalyzer;
pub use crate::artifacts::pdf::standards::v1_4::subsets::any::analyzer::PdfParts;
