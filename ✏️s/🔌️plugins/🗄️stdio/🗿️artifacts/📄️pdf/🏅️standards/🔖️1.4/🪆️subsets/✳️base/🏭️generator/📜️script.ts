...
// 🏭️ Third-party fixture generator for `s.stdio.pdf@1.7/✳️base` — the 18-kind ISO 16612-2 (PDF/VT-1)
...
// 0.44 reference implementation named `lopdf-pdf-1-4-base-mutate` in `../🧪️oracle/🔣️.json` —
...
// `../../../../../../🧪️tests/mutate-pdf-1-4-base` drives — never this repository's own production PDF
...
// `../🧪️oracle/🔣️.json`'s `pdf-1-4-base` catalog) — `manifests` walks whichever recipe directories the
...
const KINDS: readonly string[] = ["insert-page", "remove-page", "move-page", "resize-page", "replace-page-text"];
//#endregion 🧬️Contract
  ...
  for (const kind of KINDS) {
    ...
    entries.push({
      ...
      generator: {
        ...
        engineFamily: "lopdf",
        engineVersion: "0.44",
        command: "bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/📄️pdf/🏅️standards/🔖️1.4/🪆️subsets/✳️base/🏭️generator/📜️script.ts generate",
