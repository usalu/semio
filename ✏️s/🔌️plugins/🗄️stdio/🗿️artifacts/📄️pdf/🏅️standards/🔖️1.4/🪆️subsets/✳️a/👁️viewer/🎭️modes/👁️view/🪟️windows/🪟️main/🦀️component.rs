//! 🪟️ PDF/A Document (1.4) viewer -- `main` window: a real, READ-ONLY per-page overview over the shared `PdfSnapshot`
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::pdf14a::create_pdf14_a_viewer`.
