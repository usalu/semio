...
mod tests {
    ...
    fn language_neutral_direct_vectors_match_independent_lopdf() {
        ...
        let vectors =
            [include_str!("../🧬️schema/🧬️mutations/📝️set-page-text/🧪️tests/round-trips-the-concrete-inverse/🔣️.json"), include_str!("../🧬️schema/🧬️mutations/🧹️clear-page-text/🧪️tests/round-trips-the-concrete-inverse/🔣️.json")];
        for text in vectors {
