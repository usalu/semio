...
// 🏭️ Third-party fixture generator for `s.stdio.pdf@1.7/✳️x` — the 18-kind ISO 16612-2 (PDF/VT-1)
...
// 0.44 reference implementation named `lopdf-pdf-1-4-x-mutate` in `../🧪️oracle/🔣️.json` —
...
// `../../../../../../🧪️tests/mutate-pdf-1-4-x` drives — never this repository's own production PDF
...
// `../🧪️oracle/🔣️.json`'s `pdf-1-4-x` catalog) — `manifests` walks whichever recipe directories the
  ...
  for (const kind of KINDS) {
    ...
    entries.push({
      ...
      generator: {
        ...
        engineFamily: "lopdf",
        engineVersion: "0.44",
        command: "bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/📄️pdf/🏅️standards/🔖️1.4/🪆️subsets/✳️x/🏭️generator/📜️script.ts generate",
