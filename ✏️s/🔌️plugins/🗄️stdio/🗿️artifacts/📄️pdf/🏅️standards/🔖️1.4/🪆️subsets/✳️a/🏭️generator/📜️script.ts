...
// 0.44 reference implementation named `lopdf-pdf-1-4-a-mutate` in `../🧪️oracle/🔣️.json` —
...
// `../../../../../../🧪️tests/mutate-pdf-1-4-a` drives — never this repository's own production PDF
...
// `../🧪️oracle/🔣️.json`'s `pdf-1-4-a` catalog) — `manifests` walks whichever recipe directories the
  ...
  for (const kind of KINDS) {
    ...
    entries.push({
      ...
      generator: {
        ...
        engineFamily: "lopdf",
        engineVersion: "0.44",
        command: "bun ✏️s/🔌️plugins/🗄️stdio/🗿️artifacts/📄️pdf/🏅️standards/🔖️1.4/🪆️subsets/✳️a/🏭️generator/📜️script.ts generate",
