...
//! `../📸️snapshot/🦀️component.rs`), so its diff is the recipe's INDEX-KEYED triple:
...
//! it (`📝️text/📖️component.grammar.semio`, `💾️binary/📡️component.protocol.semio`) have to state that
