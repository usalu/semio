//! 🦀️ PDF 1.7 ✳️x exhaustive conformance-class mutation case — Rust adapter.
//!
...
//! `../../🏅️standards/🔖️1.7/🪆️subsets/✳️x/🧪️oracle/🦀️component.rs`, `subject` handlers drive this
//! repository's own decode/mutate/encode round trip, and both results are read back by the SAME
//! independent `project_conformance` before the `semantic-pdf-conformance-x-v1` profile compares
...
//!
//! @see ../../🏅️standards/🔖️1.7/🪆️subsets/✳️x/🧬️schema/🦀️component.rs — `check_x_conformance`, the one
...
/// `../../🏅️standards/🔖️1.7/🪆️subsets/✳️x/🧬️schema/🧬️mutations/🦀️component.rs::KINDS` — that module
...
mod subject {
    ...
    /// `PdfXMutation` — the only channel between the feature's parameters and the subject's codec.
