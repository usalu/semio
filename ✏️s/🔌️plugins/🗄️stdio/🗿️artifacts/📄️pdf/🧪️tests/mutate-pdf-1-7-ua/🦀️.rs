...
//! `../../🏅️standards/🔖️1.7/🪆️subsets/✳️ua/🧪️oracle/🦀️component.rs`, `subject` handlers drive this
...
/// `../../🏅️standards/🔖️1.7/🪆️subsets/✳️ua/🧬️schema/🧬️mutations/🦀️component.rs::KINDS` — that module
