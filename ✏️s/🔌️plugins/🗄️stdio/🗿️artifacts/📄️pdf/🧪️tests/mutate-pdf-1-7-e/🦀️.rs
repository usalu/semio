//! 🦀️ PDF 1.7 ✳️e exhaustive conformance-class mutation case — Rust adapter.
//!
...
//! `../../🏅️standards/🔖️1.7/🪆️subsets/✳️e/🧪️oracle/🦀️component.rs`, `subject` handlers drive this
//! repository's own decode/mutate/encode round trip, and both results are read back by the SAME
//! independent `project_conformance` before the `semantic-pdf-conformance-e-v1` profile compares
...
//!
//! @see ../../🏅️standards/🔖️1.7/🪆️subsets/✳️e/🧬️schema/🦀️component.rs — `check_e_conformance`, the one
...
//#region 🔖️Kinds
/// 🧾️ Test-case-local mirror of the `pdf-1-7-e` catalog. Duplicated, not imported, from
/// `../../🏅️standards/🔖️1.7/🪆️subsets/✳️e/🧬️schema/🧬️mutations/🦀️component.rs::KINDS` — that module
