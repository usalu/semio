//! 🧐️ PdfAnalyzer (final, artifact-level) — delegates to the 1.4 standard.

use semio_framework_plugin::{ArtifactAnalyzer, Dialect, StandardId, SubsetId, IoConfidence, Analysis, AnalyzeSource};
use crate::artifacts::pdf::standards::v1_4::analyzer::PdfAnalyzer as PdfRawAnalyzer;
pub use crate::artifacts::pdf::standards::v1_4::analyzer::PdfParts;
