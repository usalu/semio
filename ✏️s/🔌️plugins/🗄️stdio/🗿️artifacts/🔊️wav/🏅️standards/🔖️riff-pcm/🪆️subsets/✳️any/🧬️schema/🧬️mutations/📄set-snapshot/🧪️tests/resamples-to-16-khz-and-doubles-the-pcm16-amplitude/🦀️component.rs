//! 🧪️ `📄set-snapshot` fixture — `resamples-to-16-khz-and-doubles-the-pcm16-amplitude`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "wav/set-snapshot: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
