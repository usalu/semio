...
pub async fn definition() -> WindowKindDefinition {
    MediaWindowKit::window_kind().await
}
...
pub async fn render(_snapshot: &WavSnapshot) -> UiNode {
    MediaWindowKit::render(&MediaView { duration_ms: 0, position_ms: 0, kind: MediaKind::Audio }).await
}
