...
//! `snapshot::demo_mesh_snapshot()` (`🏅️standards/🔖️v1/🪆️subsets/✳️mesh/🧬️schema/📸️snapshot/
...
pub fn label() -> LocalizedLabel { LocalizedLabel::native("Cube", "Cube") }
