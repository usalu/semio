...
mod subject {
    ...
    pub fn round_trip(ctx: &Context) -> Result<Outcome, String> {
        ...
        let reparsed = parse_semio_document_dsl(&print_semio_document_dsl(&parsed))?;
        ...
        let unpacked = decode_semio_document_pack(&ctx.fixture_bytes(PACK_ASSET)?)?;
        ...
        let repacked = decode_semio_document_pack(&encode_semio_document_pack(&parsed))?;
