...
//! `../../🏅️standards/🔖️v1/🪆️subsets/✳️kit/🧪️oracle/🔣️.json`. Registering oracle handlers
...
const FURNITURE_DSL: &str = "asset://🏅️standards/🔖️v1/🪆️subsets/✳️kit/📚️examples/🪑️furniture/🖼️assets/🗣️example.dsl.semio";
