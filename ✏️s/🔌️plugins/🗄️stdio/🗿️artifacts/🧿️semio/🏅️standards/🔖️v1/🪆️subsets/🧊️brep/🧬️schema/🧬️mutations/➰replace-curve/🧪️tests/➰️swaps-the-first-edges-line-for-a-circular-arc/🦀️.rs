...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➰replace-curve/➰️swaps-the-first-edges-line-for-a-circular-arc/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➰replace-curve/➰️swaps-the-first-edges-line-for-a-circular-arc/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➰replace-curve/➰️swaps-the-first-edges-line-for-a-circular-arc/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➰replace-curve/➰️swaps-the-first-edges-line-for-a-circular-arc/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➰replace-curve/➰️swaps-the-first-edges-line-for-a-circular-arc/🎯️outcome/🔣️.json");
