//! 🧪️ `🏷️create-properties` fixture — `🟢️attaches-a-properties-child-to-an-object-that-has-none`.
//!
...
async fn the_undo_delete_properties_detaches_the_handle_again() {
    ...
    assert_eq!(
        undo,
        vec![SemioObjectMutation::DeleteProperties(crate::artifacts::semio::standards::v1::subsets::object::schema::mutations::delete_properties::DeleteProperties {})],
