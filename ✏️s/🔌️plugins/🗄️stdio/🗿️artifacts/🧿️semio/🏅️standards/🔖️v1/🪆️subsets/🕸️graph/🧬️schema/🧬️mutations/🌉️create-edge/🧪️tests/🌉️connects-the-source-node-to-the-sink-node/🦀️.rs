...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🌉️connects-the-source-node-to-the-sink-node/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🌉️connects-the-source-node-to-the-sink-node/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🌉️connects-the-source-node-to-the-sink-node/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🌉️connects-the-source-node-to-the-sink-node/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🌉️connects-the-source-node-to-the-sink-node/🎯️outcome/🔣️.json");
