//! 🧬️ SemioAnimationSnapshot — timelines -> channels{target, keyframes{t, AnimValue}} — from gltf animations.
...
/// 🎬️ Owned by the `animation` subset: `AnimTimeline`, `AnimChannel`, `AnimKeyframe`, `AnimValue`.
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct AnimTimeline { #[serde(default)] pub channels: Vec<AnimChannel> }

#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct AnimChannel { pub target: String, #[serde(default)] pub keyframes: Vec<AnimKeyframe> }

#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct AnimKeyframe { pub t: f64, pub value: AnimValue }

#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(tag = "kind", rename_all = "camelCase")]
pub enum AnimValue { Scalar { value: f64 }, Vector { value: SemioPoint3 } }

use schema::ArtifactSchema;
use serde::{Deserialize, Serialize};

//#region 🔖️Ids
pub const STDIO_SEMIOANIMATION_DOCUMENT_SCHEMA: &str = "stdio.semio.animation";
//#endregion 🔖️Ids
...
mod tests {
    ...
    fn dsl_text_round_trips() {
        ...
        let back = <SemioAnimationSnapshot as store::ArtifactDsl>::parse_dsl(&text).expect("parse");
        assert_eq!(snap, back);
    }
}
//#endregion 🔖️Tests
