...
pub mod derived_composition {
    ...
    impl ArtifactComposition for SemioTextComposerComposition {
        ...
        fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
            ...
            let snapshot = analysis.parts.snapshot.ok_or_else(|| ComposeError {
                message: "SemioTextComposerComposition: analysis produced no snapshot".into(),
        ...
        fn validate(payload: &IoPayload) -> Vec<dsl::Diagnostic> {
            ...
            match decoded {
                ...
                None => vec![dsl::Diagnostic::error(
                    "stdio.semio_text.validate-decode-failed",
                    dsl::TextSpan::at(1, 1),
                    "SemioTextValidator: payload did not decode as a SemioTextSnapshot".to_string(),
                )],
            }
        }
    }
    ...
    fn validator_entry() -> &'static SubsetValidatorEntry { VALIDATOR_ENTRY.get_or_init(subset_validator_entry_of::<SemioTextValidator>) }
    ...
    pub fn register() {
        ...
        store::register_document_codec(store::ArtifactCodec::of::<SemioTextSnapshot, crate::artifacts::semio::standards::v1::subsets::text::schema::mutations::SemioTextMutation>(crate::artifacts::semio::standards::v1::subsets::text::schema::snapshot::STDIO_SEMIOTEXT_DOCUMENT_SCHEMA));
