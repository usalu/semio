...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: the index is CLAMPED to `frames.len()` and a
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "insert-frame/appends-a-second-frame-at-the-end: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
