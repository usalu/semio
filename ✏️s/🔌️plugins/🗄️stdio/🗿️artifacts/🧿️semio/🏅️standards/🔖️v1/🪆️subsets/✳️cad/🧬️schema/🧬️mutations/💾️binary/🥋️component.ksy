...
doc: |
  ...
  ordinal, `🧬️mutations/🦀️component.rs`'s `OP_KEYWORDS`/`variant_ordinal`), then one opaque
  ...
  `📡️component.protocol.semio`'s own comment on the `protocol-array-of-records`/
