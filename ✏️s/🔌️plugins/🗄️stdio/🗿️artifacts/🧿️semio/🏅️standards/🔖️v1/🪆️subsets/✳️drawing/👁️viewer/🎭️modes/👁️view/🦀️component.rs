...
pub fn definition() -> ModeDefinition {
    ModeDefinition { id: SEMIO_DRAWING_VIEW_MODE_ID.into(), label: LocalizedLabel::native("View", "Ansicht"), icon_id: "eye".into(), tools: Vec::new(), layout_id: None, commands: Vec::new() }
}
