...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs` and `diff_add_texture`: a duplicate texture id
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-texture/adds-a-second-texture-at-the-end: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
