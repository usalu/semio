...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-node-port/detaches-the-trailing-out-port-from-the-source-node: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
