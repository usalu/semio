...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`, guards in order: an unknown style name ⇒ Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-fill/repaints-the-primary-styles-fill-from-red-to-blue: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
