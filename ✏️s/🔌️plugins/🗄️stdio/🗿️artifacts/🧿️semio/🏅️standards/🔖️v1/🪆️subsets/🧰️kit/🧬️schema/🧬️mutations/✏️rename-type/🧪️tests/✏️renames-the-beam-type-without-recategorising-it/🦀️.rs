...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-type/✏️renames-the-beam-type-without-recategorising-it/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-type/✏️renames-the-beam-type-without-recategorising-it/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-type/✏️renames-the-beam-type-without-recategorising-it/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-type/✏️renames-the-beam-type-without-recategorising-it/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-type/✏️renames-the-beam-type-without-recategorising-it/🎯️outcome/🔣️.json");
