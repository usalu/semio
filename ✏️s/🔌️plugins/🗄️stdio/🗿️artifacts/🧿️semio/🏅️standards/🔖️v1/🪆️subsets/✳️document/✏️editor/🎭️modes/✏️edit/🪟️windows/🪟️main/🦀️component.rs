...
pub async fn render(document: &SemioDocumentSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(SEMIO_DOCUMENT_EDIT_DEFAULT_CAMERA_POSITION, SEMIO_DOCUMENT_EDIT_DEFAULT_CAMERA_TARGET, SEMIO_DOCUMENT_EDIT_DEFAULT_CAMERA_FOV),
        meshes_json,
