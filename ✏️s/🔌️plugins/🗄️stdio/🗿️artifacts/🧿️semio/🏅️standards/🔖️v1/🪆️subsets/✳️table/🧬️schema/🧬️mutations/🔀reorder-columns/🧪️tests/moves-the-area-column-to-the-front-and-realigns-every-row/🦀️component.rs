...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown name is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-columns/moves-the-area-column-to-the-front-and-realigns-every-row: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
