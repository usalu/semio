...
pub fn create_semio_graph_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(SEMIO_GRAPH_DIALECT).document(["stdio", "semio"]).icon_id("box").mode_def(view::definition()).default_mode_id(view::SEMIO_GRAPH_VIEW_MODE_ID).window_kind_def(main::definition()).default_layout(view::layout()).build_definition()
}
//#endregion 🔖️Manifest
