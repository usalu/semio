//! 🧬️ SemioCadSnapshot — layers/blocks/entities (Line/Circle to start) — from dxf/dwg + the cad plugin.
...
/// 📐️ Owned by the `cad` subset: `CadEntity` (layers/blocks land in W2).
