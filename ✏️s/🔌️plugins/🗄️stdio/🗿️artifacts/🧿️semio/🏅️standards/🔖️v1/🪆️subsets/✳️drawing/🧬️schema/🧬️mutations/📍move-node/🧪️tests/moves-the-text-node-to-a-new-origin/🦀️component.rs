...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`, guards in order: an unresolvable path ⇒ Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-node/moves-the-text-node-to-a-new-origin: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
