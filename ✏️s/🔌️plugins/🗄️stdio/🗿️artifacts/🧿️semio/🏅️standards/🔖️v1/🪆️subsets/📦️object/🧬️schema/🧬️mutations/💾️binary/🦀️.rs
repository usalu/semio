...
fn variant_ordinal(m: &SemioObjectMutation) -> u8 {
    match m {
        ...
        SemioObjectMutation::ScaleObject(_) => 2,
        SemioObjectMutation::CreateBrep(_) => 3,
        SemioObjectMutation::DeleteBrep(_) => 4,
        SemioObjectMutation::CreateMesh(_) => 5,
        SemioObjectMutation::DeleteMesh(_) => 6,
        SemioObjectMutation::CreateProperties(_) => 7,
        SemioObjectMutation::DeleteProperties(_) => 8,
    }
}
