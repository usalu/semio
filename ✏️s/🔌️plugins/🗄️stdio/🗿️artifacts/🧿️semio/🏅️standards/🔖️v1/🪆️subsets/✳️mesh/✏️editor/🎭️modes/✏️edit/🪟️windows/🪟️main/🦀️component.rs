...
/// other by design).
async fn entity_count(document: &SemioMeshSnapshot) -> usize {
...
async fn world_instances_json(document: &SemioMeshSnapshot) -> String {
...
pub async fn render(document: &SemioMeshSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(SEMIO_MESH_EDIT_DEFAULT_CAMERA_POSITION, SEMIO_MESH_EDIT_DEFAULT_CAMERA_TARGET, SEMIO_MESH_EDIT_DEFAULT_CAMERA_FOV).await,
        meshes_json,
