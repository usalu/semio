//! 🧪️ `edit-run` fixture — `rewrites-the-marked-runs-content`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: `edit-run` rejects an out-of-range BASE index
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "edit-run/rewrites-the-marked-runs-content: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
