...
//! 🪆️subsets/📽️presentation/🔮️oracles/🔣️.json`) — an independent Python implementation of the
...
mod subject {
    ...
    /// `law::reparsed_not_copied` would be exactly backwards — the same reading `🌳️mutate-dag-1`
