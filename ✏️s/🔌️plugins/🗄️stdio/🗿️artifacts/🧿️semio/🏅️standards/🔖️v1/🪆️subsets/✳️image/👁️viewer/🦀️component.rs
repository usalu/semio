...
//#region 🔖️Manifest
pub async fn create_semio_image_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(SEMIO_IMAGE_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::SEMIO_IMAGE_VIEW_MODE_ID)
