#[path = "../../➕add-mark/🧪️tests/🔗️adds-a-link-mark-ahead-580746/🦀️.rs"]
mod tests_add_mark_adds_a_link_mark_ahead_of_the_bold_mark;
#[path = "../../🌐change-run-language/🧪️tests/🔬️retags-the-2cfe07/🦀️.rs"]
mod tests_change_run_language_retags_the_second_run_as_german;
#[path = "../../✏️edit-run/🧪️tests/✍️rewrites-the-marked-b3d483/🦀️.rs"]
mod tests_edit_run_rewrites_the_marked_runs_content;
#[path = "../../📥insert-run/🧪️tests/📥️inserts-a-german-run-96eb04/🦀️.rs"]
mod tests_insert_run_inserts_a_german_run_between_two_english_runs;
#[path = "../../➖remove-mark/🧪️tests/➖️detaches-the-italic-19c064/🦀️.rs"]
...
#[path = "../../🔀reorder-runs/🧪️tests/🧭️moves-the-first-2f0e97/🦀️.rs"]
