...
async fn editor_and_viewer_share_one_dialect() {
    semio_framework_plugin::artifact_app_laws::assert_editor_and_viewer_share_dialect::<SemioAnimationEditor, crate::viewer::semio_animation::SemioAnimationViewer>().await;
}
