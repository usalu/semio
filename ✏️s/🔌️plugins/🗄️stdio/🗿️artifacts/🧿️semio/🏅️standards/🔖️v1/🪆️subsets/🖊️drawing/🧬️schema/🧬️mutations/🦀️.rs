...
#[path = "."]
mod fixture_tests {
    #[path = "🖌️change-stroke-color/🧪️tests/🎨️recolours-the-primary-styles-stroke-to-translucent-white/🦀️.rs"]
    mod tests_change_stroke_color_recolours_the_primary_styles_stroke_to_translucent_white;
    #[path = "📐change-stroke-width/🧪️tests/📐️thickens-the-primary-styles-stroke/🦀️.rs"]
    mod tests_change_stroke_width_thickens_the_primary_styles_stroke;
    #[path = "🌱create-layer/🧪️tests/🪜️inserts-a-second-layer-above-the-base-layer/🦀️.rs"]
    mod tests_create_layer_inserts_a_second_layer_above_the_base_layer;
    #[path = "➕create-node/🧪️tests/🔤️appends-a-caption-text-node-to-the-layer-root/🦀️.rs"]
    mod tests_create_node_appends_a_caption_text_node_to_the_layer_root;
    #[path = "🗑️delete-layer/🧪️tests/🚫️removes-the-leading-layer-and-keeps-the-overlay/🦀️.rs"]
    mod tests_delete_layer_removes_the_leading_layer_and_keeps_the_overlay;
    #[path = "➖delete-node/🧪️tests/🚫️removes-the-text-node-from-the-layer-root/🦀️.rs"]
    mod tests_delete_node_removes_the_text_node_from_the_layer_root;
    #[path = "🖐️drag-nodes/🧪️tests/🖐️drags-the-text-node-and-the-nested-group-by-the-same-offset/🦀️.rs"]
    mod tests_drag_nodes_drags_the_text_node_and_the_nested_group_by_the_same_offset;
    #[path = "🫓flatten-node/🧪️tests/🫓️flattens-an-identity-nested-group-into-its-leaves/🦀️.rs"]
    mod tests_flatten_flattens_an_identity_nested_group_into_its_leaves;
    #[path = "🧷group-nodes/🧪️tests/🧷️groups-the-two-leading-children-into-a-new-group/🦀️.rs"]
    mod tests_group_groups_the_two_leading_children_into_a_new_group;
    #[path = "📍move-node/🧪️tests/📍️moves-the-text-node-to-a-new-origin/🦀️.rs"]
    mod tests_move_node_moves_the_text_node_to_a_new_origin;
    #[path = "🔀reorder-nodes/🧪️tests/🔀️moves-the-leading-path-node-to-the-end-of-the-layer-root/🦀️.rs"]
    mod tests_reorder_nodes_moves_the_leading_path_node_to_the_end_of_the_layer_root;
    #[path = "🪣replace-fill/🧪️tests/🎨️repaints-the-primary-styles-fill-from-red-to-blue/🦀️.rs"]
    mod tests_replace_fill_repaints_the_primary_styles_fill_from_red_to_blue;
    #[path = "🛤️replace-path/🧪️tests/🔺️swaps-the-open-path-for-a-closed-triangle/🦀️.rs"]
    mod tests_replace_path_swaps_the_open_path_for_a_closed_triangle;
    #[path = "🔄rotate-node/🧪️tests/🔄️rotates-the-nested-group-a-half-turn-about-z/🦀️.rs"]
    mod tests_rotate_rotates_the_nested_group_a_half_turn_about_z;
    #[path = "📏scale-node/🧪️tests/📏️scales-the-nested-group-non-uniformly/🦀️.rs"]
    mod tests_scale_scales_the_nested_group_non_uniformly;
    #[path = "🎈unflatten-node/🧪️tests/🎈️restores-the-captured-hierarchy-over-the-flat-group/🦀️.rs"]
    mod tests_unflatten_restores_the_captured_hierarchy_over_the_flat_group;
    #[path = "💫ungroup-node/🧪️tests/💫️dissolves-the-nested-group-into-its-parent/🦀️.rs"]
