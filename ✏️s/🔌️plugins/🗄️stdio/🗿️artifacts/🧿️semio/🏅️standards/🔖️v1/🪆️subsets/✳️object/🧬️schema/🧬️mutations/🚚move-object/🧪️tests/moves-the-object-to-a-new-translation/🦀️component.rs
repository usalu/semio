//! 🧪️ `move-object` fixture — `moves-the-object-to-a-new-translation`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a non-finite component is FATAL
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-object/moves-the-object-to-a-new-translation: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
