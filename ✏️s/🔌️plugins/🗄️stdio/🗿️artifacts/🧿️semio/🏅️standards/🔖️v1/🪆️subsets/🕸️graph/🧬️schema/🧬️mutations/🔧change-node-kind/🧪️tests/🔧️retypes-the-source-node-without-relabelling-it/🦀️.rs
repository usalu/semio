...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧change-node-kind/🔧️retypes-the-source-node-without-relabelling-it/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧change-node-kind/🔧️retypes-the-source-node-without-relabelling-it/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧change-node-kind/🔧️retypes-the-source-node-without-relabelling-it/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧change-node-kind/🔧️retypes-the-source-node-without-relabelling-it/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧change-node-kind/🔧️retypes-the-source-node-without-relabelling-it/🎯️outcome/🔣️.json");
