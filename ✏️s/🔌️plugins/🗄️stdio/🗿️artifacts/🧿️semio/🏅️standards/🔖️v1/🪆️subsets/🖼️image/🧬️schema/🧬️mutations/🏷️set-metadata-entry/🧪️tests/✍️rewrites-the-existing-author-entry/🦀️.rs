...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️set-metadata-entry/✍️rewrites-the-existing-author-entry/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️set-metadata-entry/✍️rewrites-the-existing-author-entry/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️set-metadata-entry/✍️rewrites-the-existing-author-entry/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️set-metadata-entry/✍️rewrites-the-existing-author-entry/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️set-metadata-entry/✍️rewrites-the-existing-author-entry/🎯️outcome/🔣️.json");
