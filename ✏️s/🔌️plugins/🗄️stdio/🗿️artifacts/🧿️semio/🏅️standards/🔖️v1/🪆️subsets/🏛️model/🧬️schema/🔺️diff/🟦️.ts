 ...
 * over spatial/elements/relations. Real interfaces matching the Rust `🦀️.rs` sibling. */

import type { SemioTransform, SpatialKind, ElementClass, GeometryRef, PropertySet, RelationKind } from "../📸️snapshot/🟦️.ts";
