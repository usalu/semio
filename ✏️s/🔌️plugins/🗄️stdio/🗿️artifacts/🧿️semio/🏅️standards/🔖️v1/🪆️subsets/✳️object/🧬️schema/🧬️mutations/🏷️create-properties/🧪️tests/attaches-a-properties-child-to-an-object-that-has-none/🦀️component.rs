...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an object that ALREADY has a properties child is
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "🏷️create-properties/attaches-a-properties-child-to-an-object-that-has-none: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
