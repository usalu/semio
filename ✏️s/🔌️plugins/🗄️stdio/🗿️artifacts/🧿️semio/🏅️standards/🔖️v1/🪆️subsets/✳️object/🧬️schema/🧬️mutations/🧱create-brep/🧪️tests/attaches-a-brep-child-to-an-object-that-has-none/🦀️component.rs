//! 🧪️ `🧱create-brep` fixture — `attaches-a-brep-child-to-an-object-that-has-none`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an object that ALREADY has a brep child is
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "🧱create-brep/attaches-a-brep-child-to-an-object-that-has-none: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
