//! 🔢 `set-list-ordered` — authored as its own mutation leaf. The aggregate's original `diff`/`inverse` bodies
...
impl protocol::MutationKind<SemioDocumentSnapshot, SemioDocumentMutation> for SetListOrdered {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native("Set list ordered", "Nummerierung der Liste setzen")
    }
