    ...
    pub mod triples;
                    ...
                    pub mod mesh {
                        ...
                        pub mod schema {
                            #[path = "."]
                            pub mod snapshot {
                                #[path = "../../✳️mesh/🧬️schema/📸️snapshot/🦀️component.rs"]
                                mod component;
                                pub use component::*;
                                #[path = "../../✳️mesh/🧬️schema/📸️snapshot/💾️binary/🦀️component.rs"]
                                pub mod binary;
                                #[path = "../../✳️mesh/🧬️schema/📸️snapshot/📝️text/🦀️component.rs"]
                                pub mod text;
                            }
                            #[path = "."]
                            pub mod diff {
                                #[path = "../../✳️mesh/🧬️schema/🔺️diff/🦀️component.rs"]
                                mod component;
                                pub use component::*;
                                #[path = "../../✳️mesh/🧬️schema/🔺️diff/💾️binary/🦀️component.rs"]
                                pub mod binary;
                                #[path = "../../✳️mesh/🧬️schema/🔺️diff/📝️text/🦀️component.rs"]
                                pub mod text;
                            }
                            #[path = "."]
                            pub mod mutations {
                                ...
                                mod component;
                                pub use component::*;
                                #[path = "../../✳️mesh/🧬️schema/🧬️mutations/💾️binary/🦀️component.rs"]
                                pub mod binary;
                                ...
                                pub mod move_vertex;
                                #[path = "../../✳️mesh/🧬️schema/🧬️mutations/📝️text/🦀️component.rs"]
                                pub mod text;
                            }
                        }
                    }
