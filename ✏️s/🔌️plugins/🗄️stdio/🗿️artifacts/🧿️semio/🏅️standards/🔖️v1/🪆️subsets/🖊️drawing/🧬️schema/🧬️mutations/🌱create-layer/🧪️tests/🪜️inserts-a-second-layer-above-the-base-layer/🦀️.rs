...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-layer/🪜️inserts-a-second-layer-above-the-base-layer/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-layer/🪜️inserts-a-second-layer-above-the-base-layer/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-layer/🪜️inserts-a-second-layer-above-the-base-layer/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-layer/🪜️inserts-a-second-layer-above-the-base-layer/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-layer/🪜️inserts-a-second-layer-above-the-base-layer/🎯️outcome/🔣️.json");

fn before() -> SemioDrawingSnapshot {
    dsl::json::from_json_str(BEFORE).expect("create-layer before snapshot decodes")
}
fn expected_after() -> SemioDrawingSnapshot {
    dsl::json::from_json_str(AFTER).expect("create-layer after snapshot decodes")
}
fn mutation() -> SemioDrawingMutation {
    dsl::json::from_json_str(MUTATION).expect("create-layer mutation decodes")
}
...
async fn committed_json_is_canonical() {
    ...
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&(mutation()))).expect("create-layer mutation encodes");
...
async fn committed_diff_is_canonical_and_narrowly_scoped() {
    let decoded: SemioDrawingDiff = dsl::json::from_json_str(DIFF).expect("committed create-layer diff decodes");
