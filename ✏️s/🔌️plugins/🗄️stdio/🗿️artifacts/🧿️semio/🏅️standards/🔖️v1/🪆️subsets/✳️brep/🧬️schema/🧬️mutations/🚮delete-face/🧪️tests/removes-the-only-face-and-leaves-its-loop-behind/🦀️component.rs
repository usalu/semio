...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown face id is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-face/removes-the-only-face-and-leaves-its-loop-behind: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
