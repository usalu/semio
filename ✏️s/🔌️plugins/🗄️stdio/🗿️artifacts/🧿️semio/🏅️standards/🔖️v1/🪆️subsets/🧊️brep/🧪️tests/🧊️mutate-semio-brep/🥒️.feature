...
Feature: Apply every typed semio BREP mutation to the real concrete-forest structure, against an independent Python implementation
  ...
  `semio-brep-python-independent` in `…/🧊️brep/🔮️oracles/🔣️.json`; the recorded no-oracle
  ...
  Scenario Outline: Apply <id> to the real concrete-forest structure
    Given the real concrete-forest solid shared://🧊️mutate-semio-brep/🌲️hexagonal-cut-concrete-forest-left/🗣️.dsl.semio
  ...
  Scenario: Re-emit both encodings of the committed solid and of the real concrete-forest structure
    Given the real committed brep artifact asset://🧊️solid/🗣️.dsl.semio
    And its committed binary twin asset://🧊️solid/🎒️.pack.semio
    And the real concrete-forest solid shared://🧊️mutate-semio-brep/🌲️hexagonal-cut-concrete-forest-left/🗣️.dsl.semio
    And its binary twin shared://🧊️mutate-semio-brep/🎒️.pack.semio
