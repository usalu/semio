...
impl ArtifactViewer for SemioValueViewer {
    ...
    async fn initial_snapshot() -> SemioValueSnapshot {
...
//#region 🔖️Manifest
pub async fn create_semio_value_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(SEMIO_VALUE_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::SEMIO_VALUE_VIEW_MODE_ID)
