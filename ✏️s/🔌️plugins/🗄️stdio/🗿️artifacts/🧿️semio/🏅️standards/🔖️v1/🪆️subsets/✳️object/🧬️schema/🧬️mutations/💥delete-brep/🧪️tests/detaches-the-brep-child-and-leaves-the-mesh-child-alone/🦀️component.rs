...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an object with no brep child is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-brep/detaches-the-brep-child-and-leaves-the-mesh-child-alone: produced diff differs from the committed 🔺️diff/🔣️component.json");
