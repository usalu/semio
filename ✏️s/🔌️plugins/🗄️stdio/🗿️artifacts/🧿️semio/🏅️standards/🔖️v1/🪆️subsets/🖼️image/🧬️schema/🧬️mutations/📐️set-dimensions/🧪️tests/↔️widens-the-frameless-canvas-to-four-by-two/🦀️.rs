...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️set-dimensions/↔️widens-the-frameless-canvas-to-four-by-two/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️set-dimensions/↔️widens-the-frameless-canvas-to-four-by-two/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️set-dimensions/↔️widens-the-frameless-canvas-to-four-by-two/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️set-dimensions/↔️widens-the-frameless-canvas-to-four-by-two/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️set-dimensions/↔️widens-the-frameless-canvas-to-four-by-two/🎯️outcome/🔣️.json");
