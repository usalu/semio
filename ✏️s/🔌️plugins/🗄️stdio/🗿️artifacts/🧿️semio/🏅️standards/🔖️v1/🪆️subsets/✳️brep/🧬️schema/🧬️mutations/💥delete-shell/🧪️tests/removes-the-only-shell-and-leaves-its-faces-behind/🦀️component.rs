...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown shell id is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-shell/removes-the-only-shell-and-leaves-its-faces-behind: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
