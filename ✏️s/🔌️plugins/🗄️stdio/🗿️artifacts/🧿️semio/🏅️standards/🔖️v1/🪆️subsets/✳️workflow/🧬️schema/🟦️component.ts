/** 🧬️ SemioWorkflowArtifact schema — real facet mirror of `🧬️schema/🦀️component.rs`; that Rust
 * file is the source of truth (mirrors `SemioWorkflowSnapshot` field for field). */
