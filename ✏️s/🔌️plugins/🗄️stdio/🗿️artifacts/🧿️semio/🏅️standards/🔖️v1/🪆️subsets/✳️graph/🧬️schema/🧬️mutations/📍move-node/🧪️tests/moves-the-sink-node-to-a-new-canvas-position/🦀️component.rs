...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`, whose guards run in this exact order: unknown
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-node/moves-the-sink-node-to-a-new-canvas-position: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
