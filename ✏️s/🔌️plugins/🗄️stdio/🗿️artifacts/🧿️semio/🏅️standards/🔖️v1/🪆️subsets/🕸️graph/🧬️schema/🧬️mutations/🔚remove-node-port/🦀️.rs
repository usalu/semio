...
impl protocol::MutationKind<SemioGraphSnapshot, SemioGraphMutation> for RemoveNodePort {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Remove port #{} from node \"{}\"", self.index, self.node_id.value), &format!("Anschluss #{} aus Knoten \"{}\" entfernen", self.index, self.node_id.value))
    }
