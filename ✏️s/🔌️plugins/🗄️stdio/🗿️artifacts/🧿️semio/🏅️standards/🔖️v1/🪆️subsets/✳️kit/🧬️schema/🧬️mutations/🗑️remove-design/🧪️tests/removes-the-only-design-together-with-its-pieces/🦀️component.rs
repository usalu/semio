...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown design id is Error
...
//! That is why `↩️inverse/🦀️component.rs` needs TWO steps: `add-design` only restores the empty
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-design/removes-the-only-design-together-with-its-pieces: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
