...
#[path = "."]
mod fixture_tests {
    #[path = "🌈change-material-base-color/🧪️tests/🐨️repaints-the-material-from-red-to-blue/🦀️.rs"]
    mod tests_change_material_base_color_repaints_the_material_from_red_to_blue;
    #[path = "⚙️change-material-metallic/🧪️tests/🏔️raises-the-metallic-factor-to-fully-metallic/🦀️.rs"]
    mod tests_change_material_metallic_raises_the_metallic_factor_to_fully_metallic;
    #[path = "🧱change-material-roughness/🧪️tests/🟨️lowers-the-roughness-factor-to-a-quarter/🦀️.rs"]
    mod tests_change_material_roughness_lowers_the_roughness_factor_to_a_quarter;
    #[path = "🏷️change-texture-mime/🧪️tests/📅️retags-the-texture-as-jpeg-without-touching-its-bytes/🦀️.rs"]
    mod tests_change_texture_mime_retags_the_texture_as_jpeg_without_touching_its_bytes;
    #[path = "🎨create-material/🧪️tests/🍎️adds-a-second-material-at-the-end/🦀️.rs"]
    mod tests_create_material_adds_a_second_material_at_the_end;
    #[path = "🕸️create-mesh/🧪️tests/🐼️adds-an-empty-second-mesh-at-the-end/🦀️.rs"]
    mod tests_create_mesh_adds_an_empty_second_mesh_at_the_end;
    #[path = "🔺create-primitive/🧪️tests/🚀️adds-a-second-primitive-inside-the-existing-mesh/🦀️.rs"]
    mod tests_create_primitive_adds_a_second_primitive_inside_the_existing_mesh;
    #[path = "🖼️create-texture/🧪️tests/🔤️adds-a-second-texture-at-the-end/🦀️.rs"]
    mod tests_create_texture_adds_a_second_texture_at_the_end;
    #[path = "🚮delete-material/🧪️tests/🚫️removes-the-leading-material-and-keeps-the-trailing-one/🦀️.rs"]
    mod tests_delete_material_removes_the_leading_material_and_keeps_the_trailing_one;
    #[path = "🗑️delete-mesh/🧪️tests/🚫️removes-the-leading-mesh-and-keeps-the-trailing-one/🦀️.rs"]
    mod tests_delete_mesh_removes_the_leading_mesh_and_keeps_the_trailing_one;
    #[path = "✂️delete-primitive/🧪️tests/🚫️removes-the-leading-primitive-and-keeps-the-trailing-one/🦀️.rs"]
    mod tests_delete_primitive_removes_the_leading_primitive_and_keeps_the_trailing_one;
    #[path = "🕳️delete-texture/🧪️tests/🚫️removes-the-leading-texture-and-keeps-the-trailing-one/🦀️.rs"]
    mod tests_delete_texture_removes_the_leading_texture_and_keeps_the_trailing_one;
    #[path = "📍move-vertex/🧪️tests/🎯️lifts-the-third-vertex-of-the-triangle/🦀️.rs"]
    mod tests_move_vertex_lifts_the_third_vertex_of_the_triangle;
    #[path = "📐replace-primitive-geometry/🧪️tests/🔤️swaps-the-triangle-for-a-textured-quad/🦀️.rs"]
    mod tests_replace_primitive_geometry_swaps_the_triangle_for_a_textured_quad;
    #[path = "📀replace-texture-bytes/🧪️tests/📅️swaps-the-texture-payload-without-retagging-its-mime/🦀️.rs"]
    mod tests_replace_texture_bytes_swaps_the_texture_payload_without_retagging_its_mime;
    #[path = "🧲️set-primitive-material/🧪️tests/🔗️binds-the-primitive-to-the-existing-material/🦀️.rs"]
    mod tests_set_primitive_material_binds_the_primitive_to_the_existing_material;
    #[path = "🔀set-primitive-topology/🧪️tests/🌾️switches-the-primitive-to-a-triangle-strip/🦀️.rs"]
