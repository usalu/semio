...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an out-of-range BASE index is
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-run-language/retags-the-second-run-as-german: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
