...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a duplicate solid id is FATAL
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-solid/adds-a-second-solid-that-treats-the-shell-as-a-void: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
