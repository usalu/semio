//! 🧊 Semio Presentation editor — the Main window: the SAME world-3d mesh scene shape as the sibling
...
//! artifact-level `SemioPresentationSnapshot` — this window itself never mutates; mutation is the surface
...
const SEMIO_PRESENTATION_EDIT_FALLBACK_MESH_KIND: &str = "box";
const SEMIO_PRESENTATION_EDIT_DEFAULT_CAMERA_POSITION: [f64; 3] = [8.0, -8.0, 6.0];
const SEMIO_PRESENTATION_EDIT_DEFAULT_CAMERA_TARGET: [f64; 3] = [0.0, 0.0, 0.0];
const SEMIO_PRESENTATION_EDIT_DEFAULT_CAMERA_FOV: f64 = 45.0;
