...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-node/🚫️removes-the-text-node-from-the-layer-root/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-node/🚫️removes-the-text-node-from-the-layer-root/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-node/🚫️removes-the-text-node-from-the-layer-root/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-node/🚫️removes-the-text-node-from-the-layer-root/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-node/🚫️removes-the-text-node-from-the-layer-root/🎯️outcome/🔣️.json");
