...
use crate::viewer::semio_base::modes::view;
use crate::viewer::semio_base::modes::view::windows::main;
...
pub fn create_semio_base_viewer() -> semio_framework_plugin::AppDefinition {
...
mod tests {
    ...
    async fn create_viewer_builds_a_definition_for_the_viewer_role() {
        let def = create_semio_base_viewer();
    ...
    async fn viewer_never_mutates_the_document_or_draft_store() {
        semio_framework_plugin::testkit::assert_viewer_never_mutates::<SemioAnyViewer>().await;
    }
}
//#endregion 🧪️Tests
