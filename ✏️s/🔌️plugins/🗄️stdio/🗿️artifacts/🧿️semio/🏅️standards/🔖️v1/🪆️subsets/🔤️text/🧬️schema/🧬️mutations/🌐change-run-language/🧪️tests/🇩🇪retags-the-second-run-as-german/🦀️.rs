...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐change-run-language/🇩🇪retags-the-second-run-as-german/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐change-run-language/🇩🇪retags-the-second-run-as-german/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐change-run-language/🇩🇪retags-the-second-run-as-german/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐change-run-language/🇩🇪retags-the-second-run-as-german/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐change-run-language/🇩🇪retags-the-second-run-as-german/🎯️outcome/🔣️.json");
