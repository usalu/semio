//! 🧬️ SemioModelSnapshot — spatial elements with placement + a typed geometry reference — from ifc/4.
...
/// 🏛️ Owned by the `model` subset: `SemioModelElement`, `GeometryRef`.
#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SemioModelElement { pub id: String, pub class: String, pub placement: SemioTransform, pub geometry: GeometryRef }

#[derive(Clone, Debug, PartialEq, serde::Serialize, serde::Deserialize)]
#[serde(tag = "kind", rename_all = "camelCase")]
pub enum GeometryRef { None, Brep { brep_id: String }, Mesh { mesh_id: String } }
