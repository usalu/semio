...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: unknown edge id ⇒ Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-curve/swaps-the-first-edges-line-for-a-circular-arc: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
