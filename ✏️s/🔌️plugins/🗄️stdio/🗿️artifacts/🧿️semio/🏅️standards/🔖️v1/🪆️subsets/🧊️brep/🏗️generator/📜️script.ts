...
const FIXTURE_DIRECTORY_BY_ID: Readonly<Record<string, string>> = {
  "booleans-coincident-face-stack-fuse-large": "🏢️booleans-coincident-face-stack-fuse-large",
  "booleans-coincident-face-stack-fuse-small": "🧱️booleans-coincident-face-stack-fuse-small",
  "booleans-cut-fully-engulfed-empty": "🫥️booleans-cut-fully-engulfed-empty",
  "booleans-cut-fuse-chain-large": "⛓️booleans-cut-fuse-chain-large",
  "booleans-cut-fuse-chain-small": "🔗️booleans-cut-fuse-chain-small",
  "booleans-cut-no-overlap-noop": "↔️booleans-cut-no-overlap-noop",
  "booleans-disjoint-compound-mixed-scale": "⚖️booleans-disjoint-compound-mixed-scale",
  "booleans-fuse-cut-intersect-three-step": "3️⃣booleans-fuse-cut-intersect-three-step",
  "booleans-intersect-non-overlap-empty": "🕳️booleans-intersect-non-overlap-empty",
  "booleans-multistep-complex-scaled-1e4": "🔭️booleans-multistep-complex-scaled-1e4",
  "booleans-nested-void-double-large": "🪆️booleans-nested-void-double-large",
  "booleans-nested-void-double-small": "🫧️booleans-nested-void-double-small",
  "booleans-nested-void-single-large": "🌑️booleans-nested-void-single-large",
  "booleans-nested-void-single-small": "⚫️booleans-nested-void-single-small",
  "booleans-non-manifold-corner-touch-boxes": "📐️booleans-non-manifold-corner-touch-boxes",
  "booleans-tangent-cylinders-line-contact": "🛢️booleans-tangent-cylinders-line-contact",
  "booleans-tangent-spheres-point-contact": "🎱️booleans-tangent-spheres-point-contact",
  "booleans-tangent-spheres-point-contact-large": "🪐️booleans-tangent-spheres-point-contact-large",
  "geometry-replace-curve-arc-to-spline-square": "〰️geometry-replace-curve-arc-to-spline-square",
  "geometry-replace-curve-line-to-arc-square-large": "🌈️geometry-replace-curve-line-to-arc-square-large",
  "geometry-replace-curve-line-to-arc-square-small": "🪃️geometry-replace-curve-line-to-arc-square-small",
  "geometry-replace-curve-line-to-spline-rectangle": "➰️geometry-replace-curve-line-to-spline-rectangle",
  "geometry-replace-curve-prism-line-to-arc-large": "🏛️geometry-replace-curve-prism-line-to-arc-large",
  "geometry-replace-curve-prism-line-to-arc-small": "🧊️geometry-replace-curve-prism-line-to-arc-small",
  "geometry-replace-curve-tangent-arc-fillet-like": "🪝️geometry-replace-curve-tangent-arc-fillet-like",
  "geometry-replace-surface-cylindrical-strip-to-bspline-large": "🧻️geometry-replace-surface-cylindrical-strip-to-bspline-large",
  "geometry-replace-surface-cylindrical-strip-to-bspline-small": "🎗️geometry-replace-surface-cylindrical-strip-to-bspline-small",
  "geometry-replace-surface-disk-plane-to-general": "💿️geometry-replace-surface-disk-plane-to-general",
  "geometry-replace-surface-plane-to-bspline-pentagon": "5️⃣geometry-replace-surface-plane-to-bspline-pentagon",
  "geometry-replace-surface-plane-to-bspline-square-large": "🔳️geometry-replace-surface-plane-to-bspline-square-large",
  "geometry-replace-surface-plane-to-bspline-square-small": "◼️geometry-replace-surface-plane-to-bspline-square-small",
  "geometry-replace-surface-plane-to-bspline-triangle": "🔺️geometry-replace-surface-plane-to-bspline-triangle",
  "move-vertex-inplane-shift-prism-solid-large": "🏗️move-vertex-inplane-shift-prism-solid-large",
  "move-vertex-inplane-shift-prism-solid-small": "📦️move-vertex-inplane-shift-prism-solid-small",
  "move-vertex-inplane-shift-quad-large": "◻️move-vertex-inplane-shift-quad-large",
  "move-vertex-inplane-shift-quad-small": "▫️move-vertex-inplane-shift-quad-small",
  "move-vertex-lifts-third-corner-off-base-plane": "🛫️move-vertex-lifts-third-corner-off-base-plane",
  "move-vertex-lifts-third-corner-off-base-plane-large": "🚀️move-vertex-lifts-third-corner-off-base-plane-large",
  "move-vertex-makes-pentagon-nonplanar-rejected": "🛑️move-vertex-makes-pentagon-nonplanar-rejected",
  "move-vertex-makes-quad-nonplanar-rejected": "🚫️move-vertex-makes-quad-nonplanar-rejected",
  "move-vertex-self-intersect-bowtie-rejected": "🎀️move-vertex-self-intersect-bowtie-rejected",
  "move-vertex-self-intersect-bowtie-rejected-large": "🦋️move-vertex-self-intersect-bowtie-rejected-large",
  "topology-build-create-edge-chord-across-disk": "🎸️topology-build-create-edge-chord-across-disk",
  "topology-build-create-edge-diagonal-across-square-large": "📏️topology-build-create-edge-diagonal-across-square-large",
  "topology-build-create-edge-diagonal-across-square-small": "✏️topology-build-create-edge-diagonal-across-square-small",
  "topology-build-create-face-caps-open-cylinder": "🧢️topology-build-create-face-caps-open-cylinder",
  "topology-build-create-face-closes-open-box-large": "🎁️topology-build-create-face-closes-open-box-large",
  "topology-build-create-face-closes-open-box-small": "🗃️topology-build-create-face-closes-open-box-small",
  "topology-build-create-shell-from-cylinder-faces": "🐚️topology-build-create-shell-from-cylinder-faces",
  "topology-build-create-shell-second-shell-flipped-sense": "🔄️topology-build-create-shell-second-shell-flipped-sense",
  "topology-build-create-shell-second-shell-flipped-sense-large": "🔃️topology-build-create-shell-second-shell-flipped-sense-large",
  "topology-build-create-solid-second-disjoint-solid-large": "🏘️topology-build-create-solid-second-disjoint-solid-large",
  "topology-build-create-solid-second-disjoint-solid-small": "🏠️topology-build-create-solid-second-disjoint-solid-small",
  "topology-build-create-solid-void-boundary-as-solid": "⭕️topology-build-create-solid-void-boundary-as-solid",
  "topology-build-create-vertex-apex-above-box-large": "🏔️topology-build-create-vertex-apex-above-box-large",
  "topology-build-create-vertex-apex-above-box-small": "⛰️topology-build-create-vertex-apex-above-box-small",
  "topology-build-create-vertex-three-loose-points": "🎳️topology-build-create-vertex-three-loose-points",
  "topology-remove-delete-edge-boundary-edge-rejected": "🛡️topology-remove-delete-edge-boundary-edge-rejected",
  "topology-remove-delete-edge-loose-diagonal-large": "✂️topology-remove-delete-edge-loose-diagonal-large",
  "topology-remove-delete-edge-loose-diagonal-small": "🪓️topology-remove-delete-edge-loose-diagonal-small",
  "topology-remove-delete-face-from-redundant-shell-large": "🎭️topology-remove-delete-face-from-redundant-shell-large",
  "topology-remove-delete-face-from-redundant-shell-small": "🎟️topology-remove-delete-face-from-redundant-shell-small",
  "topology-remove-delete-face-still-bounding-closed-shell-rejected": "🔒️topology-remove-delete-face-still-bounding-closed-shell-rejected",
  "topology-remove-delete-shell-only-shell-of-solid-rejected": "🥚️topology-remove-delete-shell-only-shell-of-solid-rejected",
  "topology-remove-delete-shell-redundant-shell-large": "🦪️topology-remove-delete-shell-redundant-shell-large",
  "topology-remove-delete-shell-redundant-shell-small": "🐌️topology-remove-delete-shell-redundant-shell-small",
  "topology-remove-delete-solid-one-of-three": "1️⃣topology-remove-delete-solid-one-of-three",
  "topology-remove-delete-solid-second-disjoint-solid-large": "2️⃣topology-remove-delete-solid-second-disjoint-solid-large",
  "topology-remove-delete-solid-second-disjoint-solid-small": "✌️topology-remove-delete-solid-second-disjoint-solid-small",
  "topology-remove-delete-vertex-corner-cascade-rejected": "💥️topology-remove-delete-vertex-corner-cascade-rejected",
  "topology-remove-delete-vertex-loose-apex-large": "📍️topology-remove-delete-vertex-loose-apex-large",
  "topology-remove-delete-vertex-loose-apex-small": "📌️topology-remove-delete-vertex-loose-apex-small",
};
...
const EXPECTED_STEP_FILENAME = "📐️expected.step";
const EXPECTED_MESH_FILENAME = "🔺️expected.mesh.json";
const EXPECTED_METRICS_FILENAME = "📊️expected.metrics.json";
...
/** 🔮️ Keeps the oracle's independent tolerance declarations while refreshing generated file coordinates. */
function synchronizeOracleFixtureCoordinates(manifests: readonly Record<string, unknown>[]): void {
  ...
  oracle.fixtureManifests = existing.map((manifest) => {
    ...
    return {
      ...
      generator: { ...(manifest.generator as Record<string, unknown>), command: generator.command },
    };
  });
  write(oraclePath, `${JSON.stringify(oracle, null, 2)}\n`);
}
...
async function generateOne(b: Kernel, recipe: Recipe, outDir: string): Promise<Record<string, unknown>> {
  ...
  const emitStep = async (role: string, shape: unknown, filename: string): Promise<void> => {
    ...
    files.push({ role, path: `../🧫️fixtures/${fixtureDirectory}/${filename}`, mediaType: "model/step", sha256: await contentDigest(text), bytes: Buffer.byteLength(text) });
  };

  const { operands, result, rejectionReason } = recipe.build(b);
  for (const operand of operands) {
    const filename = OPERAND_FILENAME_BY_ROLE[operand.role];
    if (filename === undefined) throw new Error(`No reviewed operand filename is registered for ${operand.role}`);
  ...
  if (result !== null) {
    ...
    if (trulyEmpty) {
      ...
      try {
        ...
        write(join(dir, EXPECTED_STEP_FILENAME), exportedText);
        files.push({ role: "expected-step", path: `../🧫️fixtures/${fixtureDirectory}/${EXPECTED_STEP_FILENAME}`, mediaType: "model/step", sha256: await contentDigest(exportedText), bytes: Buffer.byteLength(exportedText) });
        ...
        if (hasExtent && measurements.boundingBoxDiagonal !== null) {
          ...
          if (meshed !== null) {
            ...
            write(join(dir, EXPECTED_MESH_FILENAME), meshBody);
            files.push({ role: "expected-mesh", path: `../🧫️fixtures/${fixtureDirectory}/${EXPECTED_MESH_FILENAME}`, mediaType: "application/json", sha256: await contentDigest(meshBody), bytes: Buffer.byteLength(meshBody) });
  ...
  write(join(dir, EXPECTED_METRICS_FILENAME), metricsBody);
...
async function verifyReproducibility(b: Kernel, recipe: Recipe, primaryDir: string, scratchDir: string): Promise<{ reproducible: boolean; diffs: string[] }> {
  ...
  const fixtureDirectory = FIXTURE_DIRECTORY_BY_ID[recipe.id];
  if (fixtureDirectory === undefined) throw new Error(`No reviewed fixture directory is registered for ${recipe.id}`);
  const primary = join(primaryDir, fixtureDirectory);
  const scratch = join(scratchDir, fixtureDirectory);
...
async function main(argv: readonly string[]): Promise<number> {
  ...
  const registeredDirectories = RECIPES.map((recipe) => FIXTURE_DIRECTORY_BY_ID[recipe.id]);
  if (registeredDirectories.some((directory) => directory === undefined) || new Set(registeredDirectories).size !== RECIPES.length || Object.keys(FIXTURE_DIRECTORY_BY_ID).length !== RECIPES.length) {
