//! 🧪️ `move-node` fixture — `📍️moves-the-sink-node-to-a-new-canvas-position`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-node/📍️moves-the-sink-node-to-a-new-canvas-position/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-node/📍️moves-the-sink-node-to-a-new-canvas-position/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-node/📍️moves-the-sink-node-to-a-new-canvas-position/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-node/📍️moves-the-sink-node-to-a-new-canvas-position/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-node/📍️moves-the-sink-node-to-a-new-canvas-position/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical_and_omits_edges_entirely() {
    let decoded: SemioGraphDiff = dsl::json::from_json_str(DIFF).expect("committed move-node diff decodes");
