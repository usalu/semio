...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-design/🚫️removes-the-only-design-together-with-its-pieces/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-design/🚫️removes-the-only-design-together-with-its-pieces/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-design/🚫️removes-the-only-design-together-with-its-pieces/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-design/🚫️removes-the-only-design-together-with-its-pieces/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-design/🚫️removes-the-only-design-together-with-its-pieces/🎯️outcome/🔣️.json");
