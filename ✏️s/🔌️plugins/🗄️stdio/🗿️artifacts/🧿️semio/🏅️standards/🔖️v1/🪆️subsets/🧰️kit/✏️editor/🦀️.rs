...
pub fn create_semio_kit_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_KIT_DIALECT).document(["stdio", "semio"]).icon_id("box").mode_def(edit::definition()).default_mode_id(edit::SEMIO_KIT_EDIT_MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
...
mod tests {
    ...
    async fn editor_and_viewer_share_one_dialect() {
        semio_framework_plugin::testkit::assert_editor_and_viewer_share_dialect::<SemioKitEditor, crate::viewer::semio_kit::SemioKitViewer>().await;
    }
}
//#endregion 🧪️Tests
