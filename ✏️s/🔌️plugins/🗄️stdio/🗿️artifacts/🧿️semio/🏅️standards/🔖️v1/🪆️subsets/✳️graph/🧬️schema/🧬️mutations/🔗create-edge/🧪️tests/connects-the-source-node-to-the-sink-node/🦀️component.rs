//! 🧪️ `create-edge` fixture — `connects-the-source-node-to-the-sink-node`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`, which has THREE rejection branches, all FATAL:
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-edge/connects-the-source-node-to-the-sink-node: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
