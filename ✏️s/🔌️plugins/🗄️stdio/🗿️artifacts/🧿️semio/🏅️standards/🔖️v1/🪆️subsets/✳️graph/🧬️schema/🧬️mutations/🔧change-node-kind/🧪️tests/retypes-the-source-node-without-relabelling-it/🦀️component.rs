//! 🧪️ `change-node-kind` fixture — `retypes-the-source-node-without-relabelling-it`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-node-kind/retypes-the-source-node-without-relabelling-it: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
