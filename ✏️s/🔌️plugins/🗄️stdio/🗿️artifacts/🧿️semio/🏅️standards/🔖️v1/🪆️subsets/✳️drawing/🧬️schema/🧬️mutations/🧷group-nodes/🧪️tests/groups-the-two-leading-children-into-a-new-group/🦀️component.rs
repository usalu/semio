//! 🧪️ `group` fixture — `groups-the-two-leading-children-into-a-new-group`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: the indices must be a NON-EMPTY, CONTIGUOUS,
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "group/groups-the-two-leading-children-into-a-new-group: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
