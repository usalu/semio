...
fn expected_after() -> SemioObjectSnapshot {
    dsl::json::from_json_str(AFTER).expect("delete-brep after snapshot decodes")
}
fn mutation() -> SemioObjectMutation {
    dsl::json::from_json_str(MUTATION).expect("delete-brep mutation decodes")
}
...
async fn committed_json_is_canonical() {
    ...
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&(mutation()))).expect("delete-brep mutation encodes");
