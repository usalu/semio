...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-object/🏗️attaches-a-second-object-child/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-object/🏗️attaches-a-second-object-child/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-object/🏗️attaches-a-second-object-child/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-object/🏗️attaches-a-second-object-child/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-object/🏗️attaches-a-second-object-child/🎯️outcome/🔣️.json");
