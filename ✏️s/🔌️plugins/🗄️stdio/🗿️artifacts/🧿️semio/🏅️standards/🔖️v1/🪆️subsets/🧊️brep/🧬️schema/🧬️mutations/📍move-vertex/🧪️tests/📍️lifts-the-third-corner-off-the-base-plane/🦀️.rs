//! 🧪️ `move-vertex` fixture — `📍️lifts-the-third-corner-off-the-base-plane`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/📍️lifts-the-third-corner-off-the-base-plane/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/📍️lifts-the-third-corner-off-the-base-plane/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/📍️lifts-the-third-corner-off-the-base-plane/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/📍️lifts-the-third-corner-off-the-base-plane/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/📍️lifts-the-third-corner-off-the-base-plane/🎯️outcome/🔣️.json");
