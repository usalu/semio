...
use crate::standards::v1::subsets::brep::schema::snapshot::{BrepShellFace, SemioBrepSnapshot};
...
impl protocol::MutationKind<SemioBrepSnapshot, SemioBrepMutation> for CreateShell {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create shell \"{}\"", self.id), &format!("Schale \"{}\" erstellen", self.id))
    }
