//! 📊️ Statistical inference: descriptive moments, correlation structure, OLS/logistic regression, hypothesis tests, and discrete information measures.
//!
