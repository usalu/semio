//! 🧪️ `move-frame` fixture — `moves-the-last-frame-to-the-front`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an out-of-range `from` OR `to` is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-frame/moves-the-last-frame-to-the-front: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
