    ...
    mod tests {
        ...
        mod conformance_laws {
            ...
            async fn fixture_honesty_law() {
                ...
                let parsed = <snapshot::SemioObjectSnapshot as store::ArtifactDsl>::parse_dsl(FIXTURE_DSL).await.expect("parse shipped .dsl.semio fixture");
                ...
                let decoded = <snapshot::SemioObjectSnapshot as store::ArtifactPack>::decode_pack(FIXTURE_PACK).await.expect("decode shipped .pack.semio fixture");
