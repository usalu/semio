...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: this leaf has TWO distinct
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-mark/detaches-the-italic-mark-from-the-run: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
