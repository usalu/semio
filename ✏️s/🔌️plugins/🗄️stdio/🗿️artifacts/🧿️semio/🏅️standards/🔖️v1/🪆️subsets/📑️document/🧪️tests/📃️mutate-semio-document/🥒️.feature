...
Feature: Apply every typed semio DOCUMENT mutation to the real committed memo, against an independent Python implementation
  ...
  `semio-document-python-independent` in `.../📑️document/🔮️oracles/🔣️.json`; the recorded
  ...
  Scenario Outline: Apply <id> to its committed specification vector
    Given the committed specification vector shared://📃️mutate-semio-document/<fixture>/🦠️mutation/🔣️.json for the <id> kind
