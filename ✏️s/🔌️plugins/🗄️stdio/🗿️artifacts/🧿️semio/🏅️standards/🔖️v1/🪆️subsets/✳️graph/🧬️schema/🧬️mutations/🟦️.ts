/** 🧬️ SemioGraphMutation — real facet mirror of the Rust `🦀️.rs` sibling. Closed,
 ...
 * `🔚remove-node-port/🧪️tests/*​/🦠️mutation/🔣️.json` fixture (`{"RemoveNodePort":
 ...
 * `../<leaf>/🦠️mutation/🟦️.ts` files that don't exist (no leaf has a nested `🦠️mutation`
