                ...
                pub mod subsets {
                    ...
                    pub mod brep {
                        ...
                        pub mod schema {
                            #[path = "."]
                            pub mod snapshot {
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/🦀️.rs"]
                                mod component;
                                pub use component::*;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/🏟️arena/🦀️.rs"]
                                pub mod arena;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/💾️binary/🦀️.rs"]
                                pub mod binary;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/➰️curve/🦀️.rs"]
                                pub mod curve;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/🚨️error/🦀️.rs"]
                                pub mod error;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/〰️polynomial/🦀️.rs"]
                                pub mod polynomial;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/🏄️surface/🦀️.rs"]
                                pub mod surface;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/📝️text/🦀️.rs"]
                                pub mod text;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/📏️tolerance/🦀️.rs"]
                                pub mod tolerance;
                                #[path = "../../🧊️brep/🧬️schema/📸️snapshot/➡️vector/🦀️.rs"]
                                pub mod vector;
                            }
                            #[path = "."]
                            pub mod diff {
                                #[path = "../../🧊️brep/🧬️schema/🔺️diff/🦀️.rs"]
                                mod component;
                                pub use component::*;
                                #[path = "../../🧊️brep/🧬️schema/🔺️diff/💾️binary/🦀️.rs"]
                                pub mod binary;
                                #[path = "../../🧊️brep/🧬️schema/🔺️diff/✂️intersect/🦀️.rs"]
                                pub mod intersect;
                                #[path = "../../🧊️brep/🧬️schema/🔺️diff/📝️text/🦀️.rs"]
                                pub mod text;
                            }
                            #[path = "."]
                            pub mod mutations {
                                ...
                                mod component;
                                pub use component::*;
                                #[path = "../../🧊️brep/🧬️schema/🧬️mutations/💾️binary/🦀️.rs"]
                                pub mod binary;
                                ...
                                pub mod move_vertex;
                                #[path = "../../🧊️brep/🧬️schema/🧬️mutations/🖇️create-edge/🦀️.rs"]
                                pub mod create_edge;
                                ...
                                #[path = "../../🧊️brep/🧬️schema/🧬️mutations/📝️text/🦀️.rs"]
                                pub mod text;
                            }
                        }
                    }
