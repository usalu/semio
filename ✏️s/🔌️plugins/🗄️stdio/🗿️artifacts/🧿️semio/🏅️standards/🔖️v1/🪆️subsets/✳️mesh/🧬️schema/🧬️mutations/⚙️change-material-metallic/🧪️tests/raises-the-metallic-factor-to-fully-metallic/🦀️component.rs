//! 🧪️ `change-material-metallic` fixture — `raises-the-metallic-factor-to-fully-metallic`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-material-metallic/raises-the-metallic-factor-to-fully-metallic: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
