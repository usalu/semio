...
/** 🧭️ Physical fixture directories are reviewed identities, independent of stable recipe IDs. */
const FIXTURE_DIRECTORY_BY_ID: Readonly<Record<string, string>> = {
  "boolean-difference-cube-blind-bore": "🙈️boolean-difference-cube-blind-bore",
  "boolean-difference-cube-countersink": "🔩️boolean-difference-cube-countersink",
  "boolean-difference-cube-groove": "🛤️boolean-difference-cube-groove",
  "boolean-difference-cube-single-bore": "1️⃣boolean-difference-cube-single-bore",
  "boolean-difference-cube-slot-through": "🪟️boolean-difference-cube-slot-through",
  "boolean-difference-cube-three-bores": "3️⃣boolean-difference-cube-three-bores",
  "boolean-difference-cube-two-crossing-bores": "✖️boolean-difference-cube-two-crossing-bores",
  "boolean-difference-nested-cavity-box": "📦️boolean-difference-nested-cavity-box",
  "boolean-difference-nested-cavity-sphere": "🫧️boolean-difference-nested-cavity-sphere",
  "boolean-difference-sphere-crescent": "🌙️boolean-difference-sphere-crescent",
  "boolean-difference-torus-minus-cube": "➖️boolean-difference-torus-minus-cube",
  "boolean-intersection-cube-sphere": "🤝️boolean-intersection-cube-sphere",
  "boolean-intersection-cylinder-cylinder": "🛢️boolean-intersection-cylinder-cylinder",
  "boolean-intersection-sphere-sphere-lens": "🔍️boolean-intersection-sphere-sphere-lens",
  "boolean-union-cube-cylinder-boss": "🎛️boolean-union-cube-cylinder-boss",
  "boolean-union-cube-sphere-tangent-contact": "👆️boolean-union-cube-sphere-tangent-contact",
  "boolean-union-disjoint-spheres": "↔️boolean-union-disjoint-spheres",
  "boolean-union-overlapping-spheres": "🫂️boolean-union-overlapping-spheres",
  "boolean-union-tangent-spheres": "🎱️boolean-union-tangent-spheres",
  "boolean-union-three-spheres-chain": "⛓️boolean-union-three-spheres-chain",
  "create-material-applied": "🎨️create-material-applied",
  "degenerate-coplanar-faces-union": "🗺️degenerate-coplanar-faces-union",
  "degenerate-hairline-groove": "🧵️degenerate-hairline-groove",
  "degenerate-high-tessellation-sphere": "🕸️degenerate-high-tessellation-sphere",
  "degenerate-microscopic-cube": "🔬️degenerate-microscopic-cube",
  "degenerate-near-coincident-union": "🧲️degenerate-near-coincident-union",
  "degenerate-needle-cone": "🪡️degenerate-needle-cone",
  "degenerate-sliver-thin-slab": "🪶️degenerate-sliver-thin-slab",
  "degenerate-thin-fin": "🦈️degenerate-thin-fin",
  "degenerate-tiny-bore-below-tolerance": "🤏️degenerate-tiny-bore-below-tolerance",
  "degenerate-tiny-boss-on-large-plate": "🔘️degenerate-tiny-boss-on-large-plate",
  "primitives-cone-16": "📣️primitives-cone-16",
  "primitives-cone-32": "🌋️primitives-cone-32",
  "primitives-cone-8": "🚧️primitives-cone-8",
  "primitives-cube-rectangular": "🧱️primitives-cube-rectangular",
  "primitives-cube-unit": "🎲️primitives-cube-unit",
  "primitives-cylinder-16": "🥫️primitives-cylinder-16",
  "primitives-cylinder-32": "🧻️primitives-cylinder-32",
  "primitives-cylinder-64": "🧯️primitives-cylinder-64",
  "primitives-cylinder-8": "🥁️primitives-cylinder-8",
  "primitives-sphere-16": "🌐️primitives-sphere-16",
  "primitives-sphere-32": "🌍️primitives-sphere-32",
  "primitives-sphere-64": "🪐️primitives-sphere-64",
  "primitives-sphere-8": "⚽️primitives-sphere-8",
  "primitives-torus-16": "💍️primitives-torus-16",
  "primitives-torus-32": "🍩️primitives-torus-32",
  "primitives-torus-64": "🛟️primitives-torus-64",
  "scale-bore-boss-1": "📏️scale-bore-boss-1",
  "scale-bore-boss-1e-3": "🦠️scale-bore-boss-1e-3",
  "scale-bore-boss-1e3": "🏢️scale-bore-boss-1e3",
  "scale-bore-boss-1e6": "🌌️scale-bore-boss-1e6",
  "scale-torus-1": "🛞️scale-torus-1",
  "scale-torus-1e-3": "🦟️scale-torus-1e-3",
  "scale-torus-1e3": "🎡️scale-torus-1e3",
  "scale-torus-1e6": "🛰️scale-torus-1e6",
  "topology-disconnected-mixed-sizes": "⚖️topology-disconnected-mixed-sizes",
  "topology-disconnected-three-components": "🍡️topology-disconnected-three-components",
  "topology-disconnected-two-components": "🕶️topology-disconnected-two-components",
  "topology-genus0-sphere": "0️⃣topology-genus0-sphere",
  "topology-genus1-single-bore": "🥯️topology-genus1-single-bore",
  "topology-genus2-two-bores": "🥽️topology-genus2-two-bores",
  "topology-genus3-three-bores": "🥨️topology-genus3-three-bores",
  "topology-high-aspect-ratio-plate": "📋️topology-high-aspect-ratio-plate",
  "topology-high-aspect-ratio-rod": "🪄️topology-high-aspect-ratio-rod",
  "topology-thin-shell-box": "🎁️topology-thin-shell-box",
  "topology-thin-shell-sphere": "🥚️topology-thin-shell-sphere",
  "topology-thin-wall-partition": "🚪️topology-thin-wall-partition",
};

const OPERAND_FILENAME_BY_ROLE: Readonly<Record<string, string>> = {
  "operand-a": "🅰️operand-a.stl",
  "operand-b": "🅱️operand-b.stl",
};

const EXPECTED_FILENAME_BY_FORMAT: Readonly<Record<string, string>> = {
  stl: "🔺️expected.stl",
  obj: "🧊️expected.obj",
  ply: "🧱️expected.ply",
  gltf: "🎬️expected.gltf",
...
async function generateOne(t: NonNullable<typeof toolkit>, recipe: Recipe, outDir: string): Promise<Record<string, unknown>> {
  ...
  if (fixtureDirectory === undefined) throw new Error(`Unregistered fixture directory for ${recipe.id}`);
  ...
  const emitStl = async (role: string, shape: Manifold, filename: string): Promise<void> => {
    ...
    files.push({ role, path: `${FIXTURE_PATH_PREFIX}${fixtureDirectory}/${filename}`, mediaType: "model/stl", sha256: await contentDigest(text), bytes: Buffer.byteLength(text) });
  };

  const { operands, result } = recipe.build({ Manifold: t.Manifold, CrossSection: t.CrossSection });
  for (const operand of operands ?? []) {
    const filename = OPERAND_FILENAME_BY_ROLE[operand.role];
    if (filename === undefined) throw new Error(`Unregistered operand role ${operand.role}`);
    await emitStl(operand.role, operand.shape, filename);
  }
  ...
  if (!empty) {
    ...
    for (const [format, text] of Object.entries(exported)) {
      const filename = EXPECTED_FILENAME_BY_FORMAT[format];
      if (filename === undefined) throw new Error(`Unregistered expected format ${format}`);
      write(join(dir, filename), text);
      files.push({ role: `expected-${format}`, path: `${FIXTURE_PATH_PREFIX}${fixtureDirectory}/${filename}`, mediaType: format === "gltf" ? "model/gltf+json" : `model/${format}`, sha256: await contentDigest(text), bytes: Buffer.byteLength(text) });
    }
  ...
  files.push({ role: "expected-measurements", path: `${FIXTURE_PATH_PREFIX}${fixtureDirectory}/📊️expected.metrics.json`, mediaType: "application/json", sha256: await contentDigest(metricsBody), bytes: Buffer.byteLength(metricsBody) });
