...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-column/drops-the-middle-column-and-cascades-into-every-row: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
