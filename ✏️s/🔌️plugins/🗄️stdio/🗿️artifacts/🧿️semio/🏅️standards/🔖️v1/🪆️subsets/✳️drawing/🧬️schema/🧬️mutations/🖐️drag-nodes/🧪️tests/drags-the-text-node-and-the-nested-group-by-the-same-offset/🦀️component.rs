...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a non-finite offset is FATAL
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "drag-nodes/drags-the-text-node-and-the-nested-group-by-the-same-offset: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
