...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-cell/👥️rewrites-the-population-cell-of-the-second-row/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-cell/👥️rewrites-the-population-cell-of-the-second-row/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-cell/👥️rewrites-the-population-cell-of-the-second-row/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-cell/👥️rewrites-the-population-cell-of-the-second-row/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-cell/👥️rewrites-the-population-cell-of-the-second-row/🎯️outcome/🔣️.json");
