...
/// 👁️ Pure `SemioModelSnapshot -> UiNode` read: default camera (a viewer has no persisted
...
pub async fn render(document: &SemioModelSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(SEMIO_MODEL_VIEW_DEFAULT_CAMERA_POSITION, SEMIO_MODEL_VIEW_DEFAULT_CAMERA_TARGET, SEMIO_MODEL_VIEW_DEFAULT_CAMERA_FOV).await,
        meshes_json,
