//! 🧪️ `delete-layer` fixture — `🚫️removes-the-leading-layer-and-keeps-the-overlay`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️removes-the-leading-layer-and-keeps-the-overlay/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️removes-the-leading-layer-and-keeps-the-overlay/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️removes-the-leading-layer-and-keeps-the-overlay/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️removes-the-leading-layer-and-keeps-the-overlay/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️removes-the-leading-layer-and-keeps-the-overlay/🎯️outcome/🔣️.json");

fn before() -> SemioDrawingSnapshot {
    dsl::json::from_json_str(BEFORE).expect("delete-layer before snapshot decodes")
}
fn expected_after() -> SemioDrawingSnapshot {
    dsl::json::from_json_str(AFTER).expect("delete-layer after snapshot decodes")
}
fn mutation() -> SemioDrawingMutation {
    dsl::json::from_json_str(MUTATION).expect("delete-layer mutation decodes")
}
...
async fn committed_json_is_canonical() {
    ...
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&(mutation()))).expect("delete-layer mutation encodes");
...
async fn committed_diff_is_canonical_and_narrowly_scoped() {
    let decoded: SemioDrawingDiff = dsl::json::from_json_str(DIFF).expect("committed delete-layer diff decodes");
