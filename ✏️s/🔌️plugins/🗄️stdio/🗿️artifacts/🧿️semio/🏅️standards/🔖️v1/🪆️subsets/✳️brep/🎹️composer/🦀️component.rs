...
mod tests {
    ...
    /// workflow pilot's proven template (`ws-codec-workflow-report.md`). Lives in this composer's
    /// own test region: brep has no per-standard `⚙️engine` dir the way json/csv/zip/png do, and
    /// v1's SHARED `🏅️standards/🔖️v1/⚙️engine/🦀️component.rs` only aggregates all 14 subsets'
    ...
    mod conformance_laws {
        ...
        fn fixture_honesty_law() {
            const FIXTURE_DSL: &str = include_str!("../../../../../📚️examples/🧊️solid/🖼️assets/🗣️example.dsl.semio");
            const FIXTURE_PACK: &[u8] = include_bytes!("../../../../../📚️examples/🧊️solid/🖼️assets/🎒️example.pack.semio");
