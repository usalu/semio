...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-vertex/🏔️adds-an-apex-vertex-above-the-square/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-vertex/🏔️adds-an-apex-vertex-above-the-square/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-vertex/🏔️adds-an-apex-vertex-above-the-square/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-vertex/🏔️adds-an-apex-vertex-above-the-square/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-vertex/🏔️adds-an-apex-vertex-above-the-square/🎯️outcome/🔣️.json");
...
async fn adds_the_apex_vertex_without_touching_any_other_collection() {
    ...
    assert_eq!(created.tol, 2e-7, "the vertex carries the payload's nonzero tolerance");
