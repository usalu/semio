...
use crate::artifacts::semio::standards::v1::subsets::base::schema::mutations::SemioMutation;
...
pub fn create_semio_base_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_ANY_DIALECT).document(["stdio", "semio"]).icon_id("box").mode_def(edit::definition()).default_mode_id(edit::SEMIO_ANY_EDIT_MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
...
mod tests {
    ...
    async fn editor_and_viewer_share_one_dialect() {
        semio_framework_plugin::testkit::assert_editor_and_viewer_share_dialect::<SemioAnyEditor, crate::viewer::semio_base::SemioAnyViewer>().await;
    }
}
//#endregion 🧪️Tests
