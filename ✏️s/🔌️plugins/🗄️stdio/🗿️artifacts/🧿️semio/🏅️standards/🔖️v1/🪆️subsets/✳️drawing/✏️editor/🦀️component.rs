...
impl protocol::OpBinary for SemioDrawingEditCommand {
    ...
    async fn decode_op(_bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        Ok(SemioDrawingEditCommand::SetVertex)
    }
}
//#endregion 🔖️Command
...
impl ArtifactEditor for SemioDrawingEditor {
    ...
    async fn initial_snapshot() -> SemioDrawingSnapshot {
...
//#region 🔖️Manifest
pub async fn create_semio_drawing_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_DRAWING_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::SEMIO_DRAWING_EDIT_MODE_ID)
...
mod tests {
    ...
    async fn editor_and_viewer_share_one_dialect() {
        semio_framework_plugin::testkit::assert_editor_and_viewer_share_dialect::<SemioDrawingEditor, crate::viewer::semio_drawing::SemioDrawingViewer>();
    }
}
//#endregion 🧪️Tests
