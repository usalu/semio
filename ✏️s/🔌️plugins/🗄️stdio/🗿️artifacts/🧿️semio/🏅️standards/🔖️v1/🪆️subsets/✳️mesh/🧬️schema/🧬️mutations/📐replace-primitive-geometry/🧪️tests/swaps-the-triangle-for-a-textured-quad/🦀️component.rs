...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-primitive-geometry/swaps-the-triangle-for-a-textured-quad: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
