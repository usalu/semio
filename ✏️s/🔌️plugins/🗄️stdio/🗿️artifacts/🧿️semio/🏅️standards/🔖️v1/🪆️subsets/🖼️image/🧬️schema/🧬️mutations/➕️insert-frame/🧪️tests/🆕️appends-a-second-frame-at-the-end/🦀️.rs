...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-frame/🆕️appends-a-second-frame-at-the-end/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-frame/🆕️appends-a-second-frame-at-the-end/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-frame/🆕️appends-a-second-frame-at-the-end/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-frame/🆕️appends-a-second-frame-at-the-end/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-frame/🆕️appends-a-second-frame-at-the-end/🎯️outcome/🔣️.json");
