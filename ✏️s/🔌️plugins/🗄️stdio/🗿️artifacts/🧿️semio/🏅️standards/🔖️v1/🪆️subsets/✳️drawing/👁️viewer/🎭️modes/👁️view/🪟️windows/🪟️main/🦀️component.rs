...
pub async fn render(document: &SemioDrawingSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(SEMIO_DRAWING_VIEW_DEFAULT_CAMERA_POSITION, SEMIO_DRAWING_VIEW_DEFAULT_CAMERA_TARGET, SEMIO_DRAWING_VIEW_DEFAULT_CAMERA_FOV).await,
        meshes_json,
