...
pub mod derived_composition {
    ...
    impl ArtifactComposition for SemioGraphComposerComposition {
        ...
        fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
            ...
            let snapshot = analysis.parts.snapshot.ok_or_else(|| ComposeError {
                message: "SemioGraphComposerComposition: analysis produced no snapshot".into(),
        ...
        fn validate(payload: &IoPayload) -> Vec<dsl::Diagnostic> {
            ...
            match decoded {
                ...
                None => vec![dsl::Diagnostic::error(
                    "stdio.semio_graph.validate-decode-failed",
                    dsl::TextSpan::at(1, 1),
                    "SemioGraphValidator: payload did not decode as a SemioGraphSnapshot".to_string(),
                )],
            }
        }
    }
    ...
    fn validator_entry() -> &'static SubsetValidatorEntry { VALIDATOR_ENTRY.get_or_init(subset_validator_entry_of::<SemioGraphValidator>) }
    ...
    pub fn register() {
        ...
        store::register_document_codec(store::ArtifactCodec::of::<SemioGraphSnapshot, crate::artifacts::semio::standards::v1::subsets::graph::schema::mutations::SemioGraphMutation>(crate::artifacts::semio::standards::v1::subsets::graph::schema::snapshot::STDIO_SEMIOGRAPH_DOCUMENT_SCHEMA));
    ...
    mod tests {
        ...
        mod conformance_laws {
            ...
            fn fixture_honesty_law() {
                const FIXTURE_DSL: &str = include_str!("../📚️examples/🕸️wires/🖼️assets/🗣️example.dsl.semio");
