...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "add-node-property/inserts-a-weight-property-ahead-of-the-colour-property: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
