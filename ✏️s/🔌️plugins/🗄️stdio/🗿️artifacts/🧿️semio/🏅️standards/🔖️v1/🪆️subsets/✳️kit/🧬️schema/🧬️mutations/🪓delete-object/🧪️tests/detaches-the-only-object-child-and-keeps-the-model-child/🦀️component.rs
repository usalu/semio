//! 🧪️ `delete-object` fixture — `detaches-the-only-object-child-and-keeps-the-model-child`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown `child_id` is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-object/detaches-the-only-object-child-and-keeps-the-model-child: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
