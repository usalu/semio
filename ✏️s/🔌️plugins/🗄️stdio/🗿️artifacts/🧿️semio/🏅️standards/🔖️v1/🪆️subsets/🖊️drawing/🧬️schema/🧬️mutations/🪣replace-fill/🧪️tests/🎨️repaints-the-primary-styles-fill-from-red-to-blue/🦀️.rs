//! 🧪️ `replace-fill` fixture — `🎨️repaints-the-primary-styles-fill-from-red-to-blue`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪣replace-fill/🎨️repaints-the-primary-styles-fill-from-red-to-blue/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪣replace-fill/🎨️repaints-the-primary-styles-fill-from-red-to-blue/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪣replace-fill/🎨️repaints-the-primary-styles-fill-from-red-to-blue/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪣replace-fill/🎨️repaints-the-primary-styles-fill-from-red-to-blue/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪣replace-fill/🎨️repaints-the-primary-styles-fill-from-red-to-blue/🎯️outcome/🔣️.json");

fn before() -> SemioDrawingSnapshot {
    dsl::json::from_json_str(BEFORE).expect("replace-fill before snapshot decodes")
}
fn expected_after() -> SemioDrawingSnapshot {
    dsl::json::from_json_str(AFTER).expect("replace-fill after snapshot decodes")
}
fn mutation() -> SemioDrawingMutation {
    dsl::json::from_json_str(MUTATION).expect("replace-fill mutation decodes")
}
...
async fn committed_json_is_canonical() {
    ...
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&(mutation()))).expect("replace-fill mutation encodes");
...
async fn committed_diff_is_canonical_and_narrowly_scoped() {
    let decoded: SemioDrawingDiff = dsl::json::from_json_str(DIFF).expect("committed replace-fill diff decodes");
