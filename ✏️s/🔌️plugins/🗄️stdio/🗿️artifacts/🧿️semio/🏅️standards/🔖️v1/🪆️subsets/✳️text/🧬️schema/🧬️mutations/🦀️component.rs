...
/// vocabulary the `semio-v1-text` mutation catalog (`../../🧪️oracle/🔣️.json`) declares and
...
/// (consumed by `../🦀️component.rs`'s `SemioTextBuilderConstruction::mutate`).
