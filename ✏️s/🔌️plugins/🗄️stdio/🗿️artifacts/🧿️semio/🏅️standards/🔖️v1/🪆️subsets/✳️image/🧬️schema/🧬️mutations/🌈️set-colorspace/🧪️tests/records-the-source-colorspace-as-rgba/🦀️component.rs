...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a colorspace already equal to `base`'s is
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-colorspace/records-the-source-colorspace-as-rgba: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
