...
use crate::standards::v1::subsets::mesh::schema::snapshot::{SemioMaterial, SemioMesh, SemioMeshSnapshot, SemioTexture};
...
pub fn semio_mesh_artifact_schema_descriptor() -> framework_schema::ArtifactSchemaDescriptor {
