...
//#region 🔖️Manifest
pub async fn create_semio_flow_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(SEMIO_FLOW_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::SEMIO_FLOW_VIEW_MODE_ID)
