...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫓flatten-node/🫓️flattens-an-identity-nested-group-into-its-leaves/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫓flatten-node/🫓️flattens-an-identity-nested-group-into-its-leaves/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫓flatten-node/🫓️flattens-an-identity-nested-group-into-its-leaves/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫓flatten-node/🫓️flattens-an-identity-nested-group-into-its-leaves/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫓flatten-node/🫓️flattens-an-identity-nested-group-into-its-leaves/🎯️outcome/🔣️.json");
