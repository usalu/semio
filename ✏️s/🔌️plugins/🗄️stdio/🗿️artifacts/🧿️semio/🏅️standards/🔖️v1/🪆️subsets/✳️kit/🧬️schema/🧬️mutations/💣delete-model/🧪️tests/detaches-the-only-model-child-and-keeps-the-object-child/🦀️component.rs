...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-model/detaches-the-only-model-child-and-keeps-the-object-child: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
