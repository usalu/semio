...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-frame/⏮️moves-the-last-frame-to-the-front/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-frame/⏮️moves-the-last-frame-to-the-front/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-frame/⏮️moves-the-last-frame-to-the-front/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-frame/⏮️moves-the-last-frame-to-the-front/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️move-frame/⏮️moves-the-last-frame-to-the-front/🎯️outcome/🔣️.json");
