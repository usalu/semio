...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "edit-design/replaces-the-designs-pieces-and-connections-in-one-step: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
