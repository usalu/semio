...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-material-base-color/repaints-the-material-from-red-to-blue: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
