//! 🧪️ `create-model` fixture — `attaches-a-second-model-child`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a duplicate `child_id` is FATAL
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-model/attaches-a-second-model-child: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
