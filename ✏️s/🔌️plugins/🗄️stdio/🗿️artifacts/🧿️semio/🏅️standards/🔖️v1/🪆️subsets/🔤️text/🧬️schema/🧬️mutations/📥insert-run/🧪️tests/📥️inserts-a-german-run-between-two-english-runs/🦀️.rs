...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-run/📥️inserts-a-german-run-between-two-english-runs/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-run/📥️inserts-a-german-run-between-two-english-runs/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-run/📥️inserts-a-german-run-between-two-english-runs/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-run/📥️inserts-a-german-run-between-two-english-runs/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-run/📥️inserts-a-german-run-between-two-english-runs/🎯️outcome/🔣️.json");
