/** ✏️ Semio Animation editor — subset-level typed twin. Mirrors the editor manifest's mode/window
...
export const SEMIO_ANIMATION_EDITOR_DIALECT = { artifactKind: "s.stdio.semio", standard: "v1", subset: "animation" } as const;
