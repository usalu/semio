...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an object with no mesh child is Error
...
//! `None`, i.e. "untouched". The committed `🔺️diff/🔣️component.json` is therefore the correct
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-mesh/detaches-the-mesh-child-and-leaves-the-brep-child-alone: produced diff differs from the committed 🔺️diff/🔣️component.json");
