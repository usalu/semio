...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a duplicate id is FATAL
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-vertex/adds-an-apex-vertex-above-the-square: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
