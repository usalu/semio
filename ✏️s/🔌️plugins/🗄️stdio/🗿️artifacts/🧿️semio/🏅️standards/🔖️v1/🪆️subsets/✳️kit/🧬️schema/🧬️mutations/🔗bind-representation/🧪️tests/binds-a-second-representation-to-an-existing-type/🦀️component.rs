//! 🧪️ `bind-representation` fixture — `binds-a-second-representation-to-an-existing-type`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: `role` must name an EXISTING type or the
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "bind-representation/binds-a-second-representation-to-an-existing-type: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
