...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⭕️dims-the-walls-layer-and-widens-the-circle/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⭕️dims-the-walls-layer-and-widens-the-circle/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⭕️dims-the-walls-layer-and-widens-the-circle/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⭕️dims-the-walls-layer-and-widens-the-circle/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/⭕️dims-the-walls-layer-and-widens-the-circle/🎯️outcome/🔣️.json");
