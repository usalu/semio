...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💫ungroup-node/💫️dissolves-the-nested-group-into-its-parent/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💫ungroup-node/💫️dissolves-the-nested-group-into-its-parent/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💫ungroup-node/💫️dissolves-the-nested-group-into-its-parent/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💫ungroup-node/💫️dissolves-the-nested-group-into-its-parent/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💫ungroup-node/💫️dissolves-the-nested-group-into-its-parent/🎯️outcome/🔣️.json");

fn before() -> SemioDrawingSnapshot {
    dsl::json::from_json_str(BEFORE).expect("ungroup before snapshot decodes")
}
fn expected_after() -> SemioDrawingSnapshot {
    dsl::json::from_json_str(AFTER).expect("ungroup after snapshot decodes")
}
fn mutation() -> SemioDrawingMutation {
    dsl::json::from_json_str(MUTATION).expect("ungroup mutation decodes")
}
...
async fn committed_json_is_canonical() {
    ...
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&(mutation()))).expect("ungroup mutation encodes");
...
async fn committed_diff_is_canonical_and_narrowly_scoped() {
    let decoded: SemioDrawingDiff = dsl::json::from_json_str(DIFF).expect("committed ungroup diff decodes");
