...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a kit that ALREADY has a properties child is
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-properties/attaches-a-properties-child-to-a-kit-that-has-none: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
