...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`, whose invariant guard is STRICTER than
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "scale-object/scales-the-object-non-uniformly: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
