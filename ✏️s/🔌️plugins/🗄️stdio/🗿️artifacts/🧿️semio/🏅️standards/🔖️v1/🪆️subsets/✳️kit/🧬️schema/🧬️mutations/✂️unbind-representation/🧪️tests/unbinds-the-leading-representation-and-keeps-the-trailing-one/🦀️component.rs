...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: `representations` is addressed BY INDEX (links
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "unbind-representation/unbinds-the-leading-representation-and-keeps-the-trailing-one: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
