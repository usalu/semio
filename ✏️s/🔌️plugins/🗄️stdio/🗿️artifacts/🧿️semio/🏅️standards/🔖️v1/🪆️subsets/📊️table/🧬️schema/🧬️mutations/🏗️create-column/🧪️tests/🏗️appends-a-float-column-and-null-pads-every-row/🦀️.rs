...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-column/🏗️appends-a-float-column-and-null-pads-every-row/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-column/🏗️appends-a-float-column-and-null-pads-every-row/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-column/🏗️appends-a-float-column-and-null-pads-every-row/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-column/🏗️appends-a-float-column-and-null-pads-every-row/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️create-column/🏗️appends-a-float-column-and-null-pads-every-row/🎯️outcome/🔣️.json");
