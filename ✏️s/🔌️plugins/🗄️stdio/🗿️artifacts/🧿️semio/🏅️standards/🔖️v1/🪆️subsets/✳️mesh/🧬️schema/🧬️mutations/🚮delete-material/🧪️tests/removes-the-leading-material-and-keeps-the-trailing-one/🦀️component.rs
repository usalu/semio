...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown material id is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-material/removes-the-leading-material-and-keeps-the-trailing-one: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
