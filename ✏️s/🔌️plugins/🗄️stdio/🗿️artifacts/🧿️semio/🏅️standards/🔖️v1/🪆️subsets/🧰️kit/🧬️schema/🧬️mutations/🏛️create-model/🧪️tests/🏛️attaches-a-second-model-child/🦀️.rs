...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-model/🏛️attaches-a-second-model-child/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-model/🏛️attaches-a-second-model-child/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-model/🏛️attaches-a-second-model-child/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-model/🏛️attaches-a-second-model-child/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-model/🏛️attaches-a-second-model-child/🎯️outcome/🔣️.json");
