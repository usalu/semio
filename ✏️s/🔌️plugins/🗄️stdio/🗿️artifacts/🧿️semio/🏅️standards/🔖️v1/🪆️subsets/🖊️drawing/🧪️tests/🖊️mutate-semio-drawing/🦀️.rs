...
//! 🖊️drawing/🔮️oracles/🔣️.json`) — an independent Python implementation of the semio drawing
...
mod subject {
    ...
    use crate::standards::v1::subsets::drawing::schema::mutations::{apply_semio_drawing_mutation, decode_semio_drawing_mutation_json, inverse_semio_drawing_mutation, SemioDrawingMutation};
