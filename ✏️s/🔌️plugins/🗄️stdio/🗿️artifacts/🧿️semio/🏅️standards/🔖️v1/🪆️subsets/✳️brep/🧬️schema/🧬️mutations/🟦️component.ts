/** 🧬️ SemioBrepMutation — real facet mirror of the Rust `🦀️component.rs` sibling. Closed,
 ...
 * }`, confirmed by the committed `🐚create-shell/🧪️tests/*​/🦠️mutation/🔣️component.json` fixture
 ...
 * `import(...)` payload references pointed at `../<leaf>/🦠️mutation/🟦️component.ts` files that
 * don't exist (no leaf has a nested `🦠️mutation` TS mirror here — only
 * `../📸️snapshot/🟦️component.ts`'s types are real). None of the 13 leaf structs carry
...
import type { SemioPoint3, BrepCurve, BrepSurface, BrepShellFace, BrepSolidShell } from "../📸️snapshot/🟦️component.ts";
