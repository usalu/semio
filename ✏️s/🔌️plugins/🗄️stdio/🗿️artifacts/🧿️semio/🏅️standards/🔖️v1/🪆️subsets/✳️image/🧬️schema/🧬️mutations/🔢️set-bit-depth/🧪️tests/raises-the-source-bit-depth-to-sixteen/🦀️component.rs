//! 🧪️ `set-bit-depth` fixture — `raises-the-source-bit-depth-to-sixteen`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a bit depth already equal to `base`'s is
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-bit-depth/raises-the-source-bit-depth-to-sixteen: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
