//! 🧪️ `delete-solid` fixture — `🚫️removes-the-only-solid-and-leaves-its-shell-behind`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-solid/🚫️removes-the-only-solid-and-leaves-its-shell-behind/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-solid/🚫️removes-the-only-solid-and-leaves-its-shell-behind/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-solid/🚫️removes-the-only-solid-and-leaves-its-shell-behind/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-solid/🚫️removes-the-only-solid-and-leaves-its-shell-behind/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-solid/🚫️removes-the-only-solid-and-leaves-its-shell-behind/🎯️outcome/🔣️.json");
