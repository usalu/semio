...
//!
//! ARTIFACT-SYSTEM-OVERHAUL-REAL-CODECS-RUNTIME-REUSE-EVOLUTION's image wave adds the 6
//! conformance-law tests below (`#[cfg(test)] mod tests { mod conformance_laws }`), mirroring
//! `✳️workflow`'s/`✳️mesh`'s own proven, fully-verified template.
...
mod tests {
    ...
    /// REUSE-EVOLUTION's image wave), mirroring `✳️workflow`'s/`✳️mesh`'s own proven, fully-verified
    ...
    mod conformance_laws {
        ...
        fn fixture_honesty_law() {
            const FIXTURE_DSL: &str = include_str!("../../../../../📚️examples/🖼️swatch/🖼️assets/🗣️example.dsl.semio");
            const FIXTURE_PACK: &[u8] = include_bytes!("../../../../../📚️examples/🖼️swatch/🖼️assets/🎒️example.pack.semio");
