...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮delete-face/🚫️removes-the-only-face-and-leaves-its-loop-behind/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮delete-face/🚫️removes-the-only-face-and-leaves-its-loop-behind/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮delete-face/🚫️removes-the-only-face-and-leaves-its-loop-behind/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮delete-face/🚫️removes-the-only-face-and-leaves-its-loop-behind/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮delete-face/🚫️removes-the-only-face-and-leaves-its-loop-behind/🎯️outcome/🔣️.json");
