...
async fn editor_and_viewer_share_one_dialect() {
    semio_framework_plugin::artifact_app_laws::assert_editor_and_viewer_share_dialect::<SemioDrawingEditor, crate::viewer::semio_drawing::SemioDrawingViewer>().await;
}
