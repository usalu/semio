...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-representation-pin/repins-the-representation-from-head-to-a-checkpoint: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
