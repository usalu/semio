//! 🧪️ `scale-object` fixture — `📏️scales-the-object-non-uniformly`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-object/📏️scales-the-object-non-uniformly/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-object/📏️scales-the-object-non-uniformly/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-object/📏️scales-the-object-non-uniformly/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-object/📏️scales-the-object-non-uniformly/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-object/📏️scales-the-object-non-uniformly/🎯️outcome/🔣️.json");
