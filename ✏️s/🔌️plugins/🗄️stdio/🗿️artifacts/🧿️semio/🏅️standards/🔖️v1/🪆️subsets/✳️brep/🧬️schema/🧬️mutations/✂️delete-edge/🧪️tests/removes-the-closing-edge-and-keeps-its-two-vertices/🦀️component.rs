...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-edge/removes-the-closing-edge-and-keeps-its-two-vertices: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
