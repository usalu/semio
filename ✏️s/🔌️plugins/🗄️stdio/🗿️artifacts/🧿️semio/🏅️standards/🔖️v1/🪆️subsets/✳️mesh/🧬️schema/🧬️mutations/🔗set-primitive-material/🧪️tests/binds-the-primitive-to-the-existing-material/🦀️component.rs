...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-primitive-material/binds-the-primitive-to-the-existing-material: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
