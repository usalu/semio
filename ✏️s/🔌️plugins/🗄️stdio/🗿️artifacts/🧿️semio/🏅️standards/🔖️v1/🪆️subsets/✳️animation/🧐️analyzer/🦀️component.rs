//! 🧐️ SemioAnimationAnalyzer — 🚧 scaffolded by W1b: JSON-pack decode only. `sniff()` genuinely
...
pub struct SemioAnimationAnalyzer;

impl ArtifactAnalyzer for SemioAnimationAnalyzer {
