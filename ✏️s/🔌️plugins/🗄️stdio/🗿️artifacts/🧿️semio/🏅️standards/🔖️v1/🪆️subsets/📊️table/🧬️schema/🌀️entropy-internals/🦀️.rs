...
//!
//! Moved verbatim from `🧰️framework/🔨️modules/🧮️math/🎲️entropy` in ticket 26/08/12/
//! DISSOLVE-KERNELS-AND-MODULES-INTO-EVENT-SOURCED-ARTIFACTS wave M3e: Rust-only compute internals
//! backing `📊️table`'s inferences (no TS twin — this is algorithm, not boundary vocabulary), mirroring
//! `📊️statistics-internals`'s shape. Fully self-contained (zero external crate deps, zero coupling to
//! any other math sibling) — the internal `spatial`/`graph` submodules below are this module's OWN
//! entropy-over-pixels / entropy-over-edge-lists measures, not references to a sibling `spatial` or
//! `graph` math module. See `💡️inferences/🎲entropy` for the one genuine `InferredField` wiring.
...
pub mod numeric {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️numeric-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Numeric
...
pub mod counts {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️counts-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Counts
...
pub mod discrete {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️discrete-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Discrete
...
pub mod estimators {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️estimators-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod continuous {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️continuous-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod divergence {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️divergence-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod mutual {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️mutual-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Mutual
...
pub mod fisher {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️fisher-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Fisher
...
pub mod symbolic {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️symbolic-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Symbolic
...
pub mod regularity {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️regularity-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod ordinal {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️ordinal-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Ordinal
...
pub mod markov {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️markov-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Markov
...
pub mod multiscale {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️multiscale-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod spectral {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️spectral-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Spectral
...
pub mod wavelet {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️wavelet-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Wavelet
...
pub mod inference {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️inference-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod transfer {
    ...
    pub fn active_information_storage(x: &[f64], k_history: usize, backend: TeBackend, base: LogBase) -> Result<Estimate, EntropyError> {
        ...
        let nats = match backend {
            TeBackend::Discrete { bins } => {
                ...
                crate::standards::v1::subsets::table::schema::entropy_internals::mutual::mutual_information(&past, &future, crate::standards::v1::subsets::table::schema::entropy_internals::estimators::DiscreteMethod::Plugin, LogBase::Nats)?.value
            }
            TeBackend::Knn { k } => {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️transfer-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Transfer
    ...
    pub fn bald_mutual_information(ensemble_probs: &[f64], n_members: usize, n_classes: usize, base: LogBase) -> Result<Vec<Estimate>, EntropyError> {
        ...
        for s in 0..n_samples {
            ...
            for m in 0..n_members {
                ...
                let p = crate::standards::v1::subsets::table::schema::entropy_internals::counts::validate_probabilities(member, crate::standards::v1::subsets::table::schema::entropy_internals::Tolerances::default())?;
                for c in 0..n_classes {
                    mean_probs[c] += p[c] / n_members as f64;
                }
                mean_member_entropy_nats += -p.iter().map(|&v| x_ln_x(v)).sum::<f64>() / n_members as f64;
            }
            let mean_probs = crate::standards::v1::subsets::table::schema::entropy_internals::counts::validate_probabilities(&mean_probs, crate::standards::v1::subsets::table::schema::entropy_internals::Tolerances::default())?;
...
pub mod streaming {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️streaming-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod features {
    ...
    fn feature_histogram_entropy(x: &[f64]) -> Result<Estimate, EntropyError> {
        crate::standards::v1::subsets::table::schema::entropy_internals::continuous::entropy_continuous(x, &crate::standards::v1::subsets::table::schema::entropy_internals::continuous::ContinuousMethod::Histogram(BinsSpec::Sturges), LogBase::Nats)
    }
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️features-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Features
