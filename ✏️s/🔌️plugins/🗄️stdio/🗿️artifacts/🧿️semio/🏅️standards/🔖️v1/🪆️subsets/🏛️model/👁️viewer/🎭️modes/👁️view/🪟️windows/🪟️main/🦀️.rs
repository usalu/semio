//! 🧊 Semio Model viewer — the Main window: a read-only world-3d mesh scene built with the shared
//! `MeshWindowKit` (ticket 26/08/16/ARTIFACT-VIEWERS-AND-EDITORS-PER-SUBSET contract §2.6), from the
//! artifact-level `SemioModelSnapshot` — this file imports nothing from the sibling editor module
...
const SEMIO_MODEL_VIEW_FALLBACK_MESH_KIND: &str = "box";
const SEMIO_MODEL_VIEW_DEFAULT_CAMERA_POSITION: [f64; 3] = [8.0, -8.0, 6.0];
const SEMIO_MODEL_VIEW_DEFAULT_CAMERA_TARGET: [f64; 3] = [0.0, 0.0, 0.0];
const SEMIO_MODEL_VIEW_DEFAULT_CAMERA_FOV: f64 = 45.0;
