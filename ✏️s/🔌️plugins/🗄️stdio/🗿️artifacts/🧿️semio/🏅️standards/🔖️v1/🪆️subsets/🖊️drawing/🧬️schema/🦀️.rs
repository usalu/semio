...
use crate::standards::v1::subsets::drawing::schema::snapshot::{DrawCanvas, DrawLayer, DrawStyle, SemioDrawingSnapshot};
...
pub fn semio_drawing_artifact_schema_descriptor() -> framework_schema::ArtifactSchemaDescriptor {
