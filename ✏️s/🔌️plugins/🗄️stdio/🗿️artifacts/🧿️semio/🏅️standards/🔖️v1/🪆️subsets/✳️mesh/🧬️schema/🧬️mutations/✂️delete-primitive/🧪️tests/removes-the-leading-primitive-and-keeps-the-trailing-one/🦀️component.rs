...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-primitive/removes-the-leading-primitive-and-keeps-the-trailing-one: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
