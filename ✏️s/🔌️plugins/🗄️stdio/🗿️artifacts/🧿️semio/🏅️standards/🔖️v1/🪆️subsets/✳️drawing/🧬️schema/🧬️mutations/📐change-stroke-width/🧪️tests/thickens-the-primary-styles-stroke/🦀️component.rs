//! 🧪️ `change-stroke-width` fixture — `thickens-the-primary-styles-stroke`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: unknown name ⇒ Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-stroke-width/thickens-the-primary-styles-stroke: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
