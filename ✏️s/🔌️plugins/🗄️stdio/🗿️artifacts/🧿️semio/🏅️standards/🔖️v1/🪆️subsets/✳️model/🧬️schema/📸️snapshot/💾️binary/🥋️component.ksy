...
doc: |
  ...
  sibling `📡️component.protocol.semio`'s own comment). Not a JSON blob — see
  `📸️snapshot/🦀️component.rs`'s `encode_model_snapshot_binary` for the payload's real internal
