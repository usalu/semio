...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: unknown `node_id` ⇒ Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "add-node-port/inserts-an-in-port-ahead-of-the-existing-out-port: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
