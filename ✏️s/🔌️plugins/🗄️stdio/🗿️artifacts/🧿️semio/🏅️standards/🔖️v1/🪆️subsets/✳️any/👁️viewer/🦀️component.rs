...
//#region 🔖️Manifest
pub async fn create_semio_any_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(SEMIO_ANY_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::SEMIO_ANY_VIEW_MODE_ID)
