        ...
        let streams = from
            ...
            .filter_map(|s| {
                ...
                let samples = s
                    ...
                    .iter()
                    .enumerate()
                    .map(|(i, chunk)| SemioVideoSample { pts: (i as i64 * scale).max(0) as u64, key: chunk.keyframe, data: chunk.data.clone() })
                    .collect();
        ...
        AviSnapshot {
            ...
            streams: vec![AviStream {
                ...
                chunks: vec![
                    ...
                    AviChunk { fourcc: "00dc".into(), data: vec![5, 6, 7, 8], keyframe: false },
                ],
            }],
            idx1_present: true,
            unknown_chunks: vec![],
