...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an out-of-range BASE `from` is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-rows/moves-the-last-row-to-the-front: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
