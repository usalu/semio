//! 🧪️ `📸️set-snapshot` fixture — `🪞️reasserts-the-value-envelope-unchanged`: reasserts the committed value envelope through set-snapshot — the envelope's identity.
//!
//! The envelope vocabulary has no separate no-mutation verb: reasserting the snapshot it already holds is its identity, and the routed envelope equals the one it started from. Source of truth is the committed JSON bundle under
//! `../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🪞️reasserts-the-value-envelope-unchanged/`, read through this subset's
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🪞️reasserts-the-value-envelope-unchanged/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🪞️reasserts-the-value-envelope-unchanged/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🪞️reasserts-the-value-envelope-unchanged/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🪞️reasserts-the-value-envelope-unchanged/🔺️diff/🔣️.json");
