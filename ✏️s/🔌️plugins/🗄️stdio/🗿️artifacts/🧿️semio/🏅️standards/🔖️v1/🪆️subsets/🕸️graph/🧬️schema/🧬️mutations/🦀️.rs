...
#[path = "."]
mod fixture_tests {
    #[path = "🔌add-node-port/🧪️tests/🔌️inserts-an-in-port-ahead-of-the-existing-out-port/🦀️.rs"]
    mod tests_add_node_port_inserts_an_in_port_ahead_of_the_existing_out_port;
    #[path = "➕add-node-property/🧪️tests/⚖️inserts-a-weight-property-ahead-of-the-colour-property/🦀️.rs"]
    mod tests_add_node_property_inserts_a_weight_property_ahead_of_the_colour_property;
    #[path = "🔧change-node-kind/🧪️tests/🔧️retypes-the-source-node-without-relabelling-it/🦀️.rs"]
    mod tests_change_node_kind_retypes_the_source_node_without_relabelling_it;
    #[path = "🖍️change-node-label/🧪️tests/🔤️relabels-the-source-node-without-retyping-it/🦀️.rs"]
    mod tests_change_node_label_relabels_the_source_node_without_retyping_it;
    #[path = "🌉️create-edge/🧪️tests/🌉️connects-the-source-node-to-the-sink-node/🦀️.rs"]
    mod tests_create_edge_connects_the_source_node_to_the_sink_node;
    #[path = "🏗️create-node/🧪️tests/🔎️appends-a-filter-node-to-the-end-of-the-node-set/🦀️.rs"]
    mod tests_create_node_appends_a_filter_node_to_the_end_of_the_node_set;
    #[path = "✂️delete-edge/🧪️tests/✂️removes-the-feedback-edge-and-keeps-both-endpoints/🦀️.rs"]
    mod tests_delete_edge_removes_the_feedback_edge_and_keeps_both_endpoints;
    #[path = "🗑️delete-node/🧪️tests/🚫️removes-the-sink-node-and-severs-the-edge-into-it/🦀️.rs"]
    mod tests_delete_node_removes_the_sink_node_and_severs_the_edge_into_it;
    #[path = "📍move-node/🧪️tests/📍️moves-the-sink-node-to-a-new-canvas-position/🦀️.rs"]
    mod tests_move_node_moves_the_sink_node_to_a_new_canvas_position;
    #[path = "🔚remove-node-port/🧪️tests/🔚️detaches-the-trailing-out-port-from-the-source-node/🦀️.rs"]
    mod tests_remove_node_port_detaches_the_trailing_out_port_from_the_source_node;
    #[path = "➖remove-node-property/🧪️tests/➖️detaches-the-trailing-weight-property-from-the-source-node/🦀️.rs"]
