//! 🧪️ `📄set-snapshot` fixture — `bolds-the-body-paragraph-and-finalizes-its-copy`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "semio-document/set-snapshot: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
