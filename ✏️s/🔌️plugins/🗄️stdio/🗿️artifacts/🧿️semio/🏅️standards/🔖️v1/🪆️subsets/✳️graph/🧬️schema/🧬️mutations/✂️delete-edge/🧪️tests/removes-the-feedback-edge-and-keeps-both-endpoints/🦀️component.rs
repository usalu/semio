...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown edge id is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-edge/removes-the-feedback-edge-and-keeps-both-endpoints: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
