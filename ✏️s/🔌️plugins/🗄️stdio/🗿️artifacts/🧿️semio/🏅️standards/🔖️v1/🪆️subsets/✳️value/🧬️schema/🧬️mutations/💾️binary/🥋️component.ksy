...
doc: |
  ...
  `SemioValueMutation` variant ordinal, 0-8, same order as the text facet's keyword list) fixed
...
seq:
  ...
  - id: tag
    ...
    doc: >
      ...
      5=insert-list-item 6=remove-list-item 7=set-node 8=remove-node
  - id: payload
    size-eos: true
