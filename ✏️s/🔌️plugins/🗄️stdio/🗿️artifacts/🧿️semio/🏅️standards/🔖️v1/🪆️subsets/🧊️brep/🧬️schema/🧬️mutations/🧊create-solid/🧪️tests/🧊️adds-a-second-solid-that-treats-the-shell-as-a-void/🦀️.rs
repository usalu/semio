//! 🧪️ `create-solid` fixture — `🧊️adds-a-second-solid-that-treats-the-shell-as-a-void`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊create-solid/🧊️adds-a-second-solid-that-treats-the-shell-as-a-void/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊create-solid/🧊️adds-a-second-solid-that-treats-the-shell-as-a-void/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊create-solid/🧊️adds-a-second-solid-that-treats-the-shell-as-a-void/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊create-solid/🧊️adds-a-second-solid-that-treats-the-shell-as-a-void/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊create-solid/🧊️adds-a-second-solid-that-treats-the-shell-as-a-void/🎯️outcome/🔣️.json");

fn before() -> SemioBrepSnapshot {
    decode_semio_brep_snapshot_json(BEFORE).expect("create-solid before snapshot decodes")
}
fn expected_after() -> SemioBrepSnapshot {
    decode_semio_brep_snapshot_json(AFTER).expect("create-solid after snapshot decodes")
}
fn mutation() -> SemioBrepMutation {
    decode_semio_brep_mutation_json(MUTATION).expect("create-solid mutation decodes")
}
...
async fn committed_json_is_canonical() {
    ...
    let original = pack::json::parse(MUTATION).expect("create-solid mutation reparses");
...
async fn declared_outcome_holds_as_committed() {
    ...
    assert_eq!(outcome.get("status").and_then(pack::json::Value::as_str), Some("applied"), "create-solid/adds-a-second-solid-that-treats-the-shell-as-a-void: this case is declared applied");
