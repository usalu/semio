//! 🧪️ `delete-properties` fixture — `detaches-the-properties-child-and-leaves-every-other-collection-alone`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a kit with no properties child is Error
...
//! OUTER `None`, i.e. "untouched". The committed `🔺️diff/🔣️component.json` is therefore the correct
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-properties/detaches-the-properties-child-and-leaves-every-other-collection-alone: produced diff differs from the committed 🔺️diff/🔣️component.json");
