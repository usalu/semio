...
//#region 🔖️Manifest
pub async fn create_semio_flow_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_FLOW_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::SEMIO_FLOW_EDIT_MODE_ID)
