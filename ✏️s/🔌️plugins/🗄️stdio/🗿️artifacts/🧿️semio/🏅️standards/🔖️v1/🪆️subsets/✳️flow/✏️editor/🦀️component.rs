...
impl protocol::OpBinary for SemioFlowEditCommand {
    ...
    fn decode_op(_bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        Ok(SemioFlowEditCommand::SetVertex)
    }
}
//#endregion 🔖️Command
...
impl ArtifactEditor for SemioFlowEditor {
    ...
    async fn initial_snapshot() -> SemioFlowSnapshot {
...
pub fn create_semio_flow_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_FLOW_DIALECT).document(["stdio", "semio"]).icon_id("box").mode_def(edit::definition()).default_mode_id(edit::SEMIO_FLOW_EDIT_MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
...
mod tests {
    ...
    async fn editor_and_viewer_share_one_dialect() {
        semio_framework_plugin::testkit::assert_editor_and_viewer_share_dialect::<SemioFlowEditor, crate::viewer::semio_flow::SemioFlowViewer>();
    }
}
//#endregion 🧪️Tests
