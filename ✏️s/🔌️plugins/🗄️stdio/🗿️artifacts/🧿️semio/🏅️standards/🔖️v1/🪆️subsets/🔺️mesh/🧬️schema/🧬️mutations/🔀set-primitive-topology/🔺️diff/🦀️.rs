...
pub fn diff(payload: &super::SetPrimitiveTopology, base: &SemioMeshSnapshot) -> protocol::MutationOutcome<SemioMeshDiff> {
    ...
    protocol::MutationOutcome::new(crate::standards::v1::subsets::mesh::schema::diff::diff_set_primitive_topology(base, &payload.mesh_id, &payload.primitive_id, payload.topology))
}
//#endregion 🔖️Diff
