//! 🧪️ `change-texture-mime` fixture — `retags-the-texture-as-jpeg-without-touching-its-bytes`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-texture-mime/retags-the-texture-as-jpeg-without-touching-its-bytes: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
