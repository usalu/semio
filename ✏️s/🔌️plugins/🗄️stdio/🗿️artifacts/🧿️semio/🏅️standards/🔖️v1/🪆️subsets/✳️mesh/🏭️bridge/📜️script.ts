...
// 🏭️ Language-neutral production mutation bridge for `s.stdio.semio@v1/✳️mesh`.
//
...
//
//   bun 📜️script.ts list-mutations s.stdio.semio v1 mesh
//
...
function main(argv: readonly string[]): number {
  const [command = "", artifact = "s.stdio.semio", standard = "v1", subset = "mesh"] = argv;
  ...
  const built = spawnSync("cargo", ["run", "--quiet", "--offline", "--bin", "semio-semio-v1-mesh-bridge", "--", command, artifact, standard, subset], {
    cwd: import.meta.dir,
    encoding: "utf8",
