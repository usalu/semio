...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an object with no properties child is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-properties/detaches-the-properties-child-and-leaves-the-mesh-child-alone: produced diff differs from the committed 🔺️diff/🔣️component.json");
