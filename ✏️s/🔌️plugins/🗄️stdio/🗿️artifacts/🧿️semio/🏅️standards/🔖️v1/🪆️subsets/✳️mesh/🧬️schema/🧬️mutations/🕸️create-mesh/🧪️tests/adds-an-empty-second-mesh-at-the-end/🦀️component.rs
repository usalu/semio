...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs` and the `diff_add_mesh` helper it delegates to:
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-mesh/adds-an-empty-second-mesh-at-the-end: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
