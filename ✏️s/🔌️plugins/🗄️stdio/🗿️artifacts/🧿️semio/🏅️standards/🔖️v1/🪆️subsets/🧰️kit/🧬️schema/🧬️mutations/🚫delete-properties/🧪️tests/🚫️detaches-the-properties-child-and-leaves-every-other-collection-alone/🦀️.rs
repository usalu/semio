...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-properties/🚫️detaches-the-properties-child-and-leaves-every-other-collection-alone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-properties/🚫️detaches-the-properties-child-and-leaves-every-other-collection-alone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-properties/🚫️detaches-the-properties-child-and-leaves-every-other-collection-alone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-properties/🚫️detaches-the-properties-child-and-leaves-every-other-collection-alone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-properties/🚫️detaches-the-properties-child-and-leaves-every-other-collection-alone/🎯️outcome/🔣️.json");
