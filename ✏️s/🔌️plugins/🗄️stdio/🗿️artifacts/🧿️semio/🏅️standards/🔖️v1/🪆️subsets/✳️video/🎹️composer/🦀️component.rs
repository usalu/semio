...
mod tests {
    ...
    mod conformance_laws {
        ...
        fn fixture_honesty_law() {
            const FIXTURE_DSL: &str = include_str!("../../../../../📚️examples/🎥️clip/🖼️assets/🗣️example.dsl.semio");
            const FIXTURE_PACK: &[u8] = include_bytes!("../../../../../📚️examples/🎥️clip/🖼️assets/🎒️example.pack.semio");
