...
mod subject {
    ...
    use crate::standards::v1::subsets::text::schema::mutations::{apply_semio_text_mutation, decode_semio_text_mutation_json, inverse_semio_text_mutation, SemioTextMutation};
    use crate::standards::v1::subsets::text::schema::snapshot::{decode_semio_text_pack, decode_semio_text_snapshot_json, encode_semio_text_pack, encode_semio_text_snapshot_json, parse_semio_text_dsl, print_semio_text_dsl, SemioTextSnapshot};
    ...
    const ARTICLE_DSL: &str = "shared://🔤️mutate-semio-text/🏚️zukunft-bau-entwerfen-mit-bestand/🗣️.dsl.semio";
    ...
    const ARTICLE_PACK: &str = "shared://🔤️mutate-semio-text/🎒️.pack.semio";
    ...
    const DSL_ASSET: &str = "asset://📃️note/🗣️.dsl.semio";
    /// 🎒️ The same note in its binary envelope, written by a separate codec from the DSL text.
    const PACK_ASSET: &str = "asset://📃️note/🎒️.pack.semio";
