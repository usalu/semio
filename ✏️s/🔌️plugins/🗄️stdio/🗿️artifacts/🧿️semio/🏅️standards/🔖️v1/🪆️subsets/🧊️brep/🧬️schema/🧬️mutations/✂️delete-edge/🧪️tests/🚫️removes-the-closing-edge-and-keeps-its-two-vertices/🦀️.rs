...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/🚫️removes-the-closing-edge-and-keeps-its-two-vertices/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/🚫️removes-the-closing-edge-and-keeps-its-two-vertices/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/🚫️removes-the-closing-edge-and-keeps-its-two-vertices/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/🚫️removes-the-closing-edge-and-keeps-its-two-vertices/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/🚫️removes-the-closing-edge-and-keeps-its-two-vertices/🎯️outcome/🔣️.json");
