...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a `parent` that does not resolve to a `Group`
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-node/appends-a-caption-text-node-to-the-layer-root: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
