...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-type/renames-the-beam-type-without-recategorising-it: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
