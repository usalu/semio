...
pub mod derived_construction {
    ...
    pub struct SemioBuilderConstruction { snapshot: SemioSnapshot }
...
semio_framework_plugin::derive_artifact_facets!(
    pub spec SemioBuilderFacets {
        construction: derived_construction::SemioBuilderConstruction,
        analysis: derived_analysis::SemioAnalyzerAnalysis,
