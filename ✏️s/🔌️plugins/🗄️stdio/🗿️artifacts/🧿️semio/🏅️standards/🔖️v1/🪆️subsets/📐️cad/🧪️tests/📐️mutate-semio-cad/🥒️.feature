...
Feature: Apply every typed semio CAD mutation to the real committed drawing, against an independent Python implementation
  ...
  `semio-cad-python-independent` in `…/📐️cad/🔮️oracles/🔣️.json`; the recorded no-oracle
  ...
  Scenario Outline: Apply <id> to its committed specification vector
    Given the committed specification vector shared://📐️mutate-semio-cad/<fixture>/🦠️mutation/🔣️.json for the <id> kind
    ...
    Examples:
      ...
      | add-block | 🧱️add-block |
      | remove-block | 🚫️remove-block |
      | set-block-base-point | 📍️set-block-base-point |
      | add-entity | 🔷️add-entity |
      | remove-entity | 🗑️remove-entity |
      | set-entity-layer | 🏳️set-entity-layer |
      | set-entity-geometry | 📐️set-entity-geometry |
      | add-block-entity | 🧩️add-block-entity |
      | remove-block-entity | ✂️remove-block-entity |
      | set-block-entity-layer | 🧷️set-block-entity-layer |
      | set-block-entity-geometry | 🔺️set-block-entity-geometry |
