...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️set-frame-delay/⏳️slows-the-second-frame-down/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️set-frame-delay/⏳️slows-the-second-frame-down/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️set-frame-delay/⏳️slows-the-second-frame-down/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️set-frame-delay/⏳️slows-the-second-frame-down/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️set-frame-delay/⏳️slows-the-second-frame-down/🎯️outcome/🔣️.json");
