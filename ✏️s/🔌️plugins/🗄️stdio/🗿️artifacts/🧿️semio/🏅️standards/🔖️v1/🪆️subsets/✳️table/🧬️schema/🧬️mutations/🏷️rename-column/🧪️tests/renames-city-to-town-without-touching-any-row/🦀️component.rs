...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`, which has THREE guard branches — Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-column/renames-city-to-town-without-touching-any-row: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
