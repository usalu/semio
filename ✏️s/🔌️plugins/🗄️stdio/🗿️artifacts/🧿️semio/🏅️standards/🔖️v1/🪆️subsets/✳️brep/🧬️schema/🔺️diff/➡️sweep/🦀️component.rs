...
fn attach_face(
    body: &mut Body,
    surface_id: crate::artifacts::semio::standards::v1::subsets::brep::schema::snapshot::arena::SurfaceId,
    members: &[(EdgeId, bool)],
    flipped: bool,
    tol: Tol,
    rec: &mut OpRecorder,
...
mod tests {
    ...
    fn extrude_uses_rectangle_wire_helper() {
        ...
        let face = crate::artifacts::semio::standards::v1::subsets::brep::schema::diff::primitives::make_planar_face_from_wire(&mut body, &wire, Pnt3::new(0.0, 0.0, 0.0), Vec3::Z, &mut rec)
            .unwrap();
