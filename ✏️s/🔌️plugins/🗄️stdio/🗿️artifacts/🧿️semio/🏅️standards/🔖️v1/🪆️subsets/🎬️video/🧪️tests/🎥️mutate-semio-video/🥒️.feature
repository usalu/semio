...
Feature: Apply every typed semio VIDEO mutation to a real recording, against an independent Python implementation
  ...
  `semio-video-python-independent` in `…/🎬️video/🔮️oracles/🔣️.json`; the recorded no-oracle
  ...
  Scenario Outline: Apply <id> to its committed specification vector
    Given the committed specification vector shared://🎥️mutate-semio-video/<fixture>/🦠️mutation/🔣️.json for the <id> kind
