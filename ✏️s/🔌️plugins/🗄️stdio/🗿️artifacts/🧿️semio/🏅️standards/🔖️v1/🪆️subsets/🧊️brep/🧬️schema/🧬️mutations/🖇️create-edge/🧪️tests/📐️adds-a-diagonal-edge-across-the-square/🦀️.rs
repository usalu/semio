...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️create-edge/📐️adds-a-diagonal-edge-across-the-square/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️create-edge/📐️adds-a-diagonal-edge-across-the-square/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️create-edge/📐️adds-a-diagonal-edge-across-the-square/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️create-edge/📐️adds-a-diagonal-edge-across-the-square/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️create-edge/📐️adds-a-diagonal-edge-across-the-square/🎯️outcome/🔣️.json");
...
async fn adds_the_diagonal_between_two_existing_vertices() {
    ...
    assert_eq!(created.tol, 3e-7, "the edge carries the payload's nonzero tolerance");
