...
//#region 🔖️Manifest
pub async fn create_semio_video_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_VIDEO_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::SEMIO_VIDEO_EDIT_MODE_ID)
