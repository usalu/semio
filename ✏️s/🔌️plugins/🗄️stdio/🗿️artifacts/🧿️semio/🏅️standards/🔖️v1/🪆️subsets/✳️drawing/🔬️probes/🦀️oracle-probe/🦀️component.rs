...
//! colour field for a path at all (`…🖊️dxf/🔖️r12/✳️any/🦀️component.rs:140` binds `style` and never
...
/// (`…🎨️svg/🔖️1.1/✳️any/🦀️component.rs:27–38`). Two encodings may differ in number FORMATTING
