//! 🧪️ `create-layer` fixture — `inserts-a-second-layer-above-the-base-layer`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a duplicate layer id is FATAL
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-layer/inserts-a-second-layer-above-the-base-layer: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
