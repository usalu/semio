//! 🏭️ Writes the `semio@v1/mesh` JSON-carrier fixture corpus. Every pair is checked for OBSERVABILITY
//! before it is written — a mutation whose projection does not move is refused, not committed.
use std::fs;
use std::path::PathBuf;
use std::process::exit;

use semio_mesh_json::{apply, build_seed, project, render, FIXTURE_DIRECTORY_BY_KIND, KINDS};
