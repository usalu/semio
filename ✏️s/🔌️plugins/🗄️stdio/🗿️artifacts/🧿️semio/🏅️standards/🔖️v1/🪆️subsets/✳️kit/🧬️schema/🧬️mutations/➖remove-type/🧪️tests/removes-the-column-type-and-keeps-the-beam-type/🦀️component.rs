//! 🧪️ `remove-type` fixture — `removes-the-column-type-and-keeps-the-beam-type`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown type id is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-type/removes-the-column-type-and-keeps-the-beam-type: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
