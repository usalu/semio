...
//#region 🔖️Manifest
pub async fn create_semio_cad_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_CAD_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::SEMIO_CAD_EDIT_MODE_ID)
