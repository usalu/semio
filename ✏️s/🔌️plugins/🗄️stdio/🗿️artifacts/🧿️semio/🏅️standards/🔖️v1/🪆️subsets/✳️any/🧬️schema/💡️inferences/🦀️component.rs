...
//! same `subset_tag`/`subset_ordinal` pair `📸️snapshot/🦀️component.rs`'s own DSL header/binary-pack
...
pub async fn semio_artifact_inference_descriptor() -> schema::ArtifactInferenceDescriptor {
