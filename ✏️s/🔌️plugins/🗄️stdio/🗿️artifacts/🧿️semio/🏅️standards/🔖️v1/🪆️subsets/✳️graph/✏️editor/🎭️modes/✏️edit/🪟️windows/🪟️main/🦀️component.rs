...
/// other by design).
async fn entity_count(document: &SemioGraphSnapshot) -> usize {
...
async fn world_instances_json(document: &SemioGraphSnapshot) -> String {
...
pub async fn render(document: &SemioGraphSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(SEMIO_GRAPH_EDIT_DEFAULT_CAMERA_POSITION, SEMIO_GRAPH_EDIT_DEFAULT_CAMERA_TARGET, SEMIO_GRAPH_EDIT_DEFAULT_CAMERA_FOV).await,
        meshes_json,
