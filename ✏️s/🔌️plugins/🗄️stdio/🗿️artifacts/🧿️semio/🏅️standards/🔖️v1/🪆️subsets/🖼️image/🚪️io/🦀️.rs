    ...
    mod tests {
        ...
        mod conformance_laws {
            ...
            async fn fixture_honesty_law() {
                const FIXTURE_DSL: &str = include_str!("../../✉️base/📚️examples/🖼️swatch/🖼️assets/🗣️.dsl.semio");
                const FIXTURE_PACK: &[u8] = include_bytes!("../../✉️base/📚️examples/🖼️swatch/🖼️assets/🎒️.pack.semio");
