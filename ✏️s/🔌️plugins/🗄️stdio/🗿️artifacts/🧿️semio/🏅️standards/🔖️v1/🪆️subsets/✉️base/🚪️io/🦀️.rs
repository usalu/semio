...
pub mod derived_composition {
    ...
    mod tests {
        ...
        /// `✉️base` envelope union) three facets — following `flow`'s/`value`'s own established
        ...
        mod conformance_laws {
            ...
            async fn fixture_honesty_law() {
                const FIXTURE_DSL: &str = include_str!("../../✉️base/📚️examples/🌐️envelope/🖼️assets/🗣️.dsl.semio");
                const FIXTURE_PACK: &[u8] = include_bytes!("../../✉️base/📚️examples/🌐️envelope/🖼️assets/🎒️.pack.semio");
