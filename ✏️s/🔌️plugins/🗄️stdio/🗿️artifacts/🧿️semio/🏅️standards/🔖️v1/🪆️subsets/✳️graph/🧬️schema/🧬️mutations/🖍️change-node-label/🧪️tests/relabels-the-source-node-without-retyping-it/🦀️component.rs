...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-node-label/relabels-the-source-node-without-retyping-it: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
