...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a duplicate design id is FATAL
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "add-design/adds-an-empty-roof-design: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
