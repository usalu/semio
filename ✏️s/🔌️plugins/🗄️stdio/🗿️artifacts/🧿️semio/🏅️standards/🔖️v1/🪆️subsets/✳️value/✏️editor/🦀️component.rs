...
//#region 🔖️Manifest
pub async fn create_semio_value_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_VALUE_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::SEMIO_VALUE_EDIT_MODE_ID)
