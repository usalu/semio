...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-row/📥️inserts-a-row-between-the-two-existing-rows/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-row/📥️inserts-a-row-between-the-two-existing-rows/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-row/📥️inserts-a-row-between-the-two-existing-rows/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-row/📥️inserts-a-row-between-the-two-existing-rows/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥insert-row/📥️inserts-a-row-between-the-two-existing-rows/🎯️outcome/🔣️.json");
