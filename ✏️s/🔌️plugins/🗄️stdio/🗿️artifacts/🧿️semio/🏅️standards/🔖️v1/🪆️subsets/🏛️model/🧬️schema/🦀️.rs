...
use crate::standards::v1::subsets::model::schema::snapshot::{ModelRelation, SemioModelElement, SemioModelSnapshot, SpatialNode};
...
pub fn semio_model_artifact_schema_descriptor() -> framework_schema::ArtifactSchemaDescriptor {
