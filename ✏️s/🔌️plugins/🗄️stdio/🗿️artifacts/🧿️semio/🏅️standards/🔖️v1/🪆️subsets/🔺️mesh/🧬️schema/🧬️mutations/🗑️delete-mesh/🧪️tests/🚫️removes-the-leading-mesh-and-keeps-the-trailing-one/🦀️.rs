//! 🧪️ `delete-mesh` fixture — `🚫️removes-the-leading-mesh-and-keeps-the-trailing-one`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-mesh/🚫️removes-the-leading-mesh-and-keeps-the-trailing-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-mesh/🚫️removes-the-leading-mesh-and-keeps-the-trailing-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-mesh/🚫️removes-the-leading-mesh-and-keeps-the-trailing-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-mesh/🚫️removes-the-leading-mesh-and-keeps-the-trailing-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-mesh/🚫️removes-the-leading-mesh-and-keeps-the-trailing-one/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-mesh/removes-the-leading-mesh-and-keeps-the-trailing-one: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn committed_diff_is_canonical_and_narrowly_scoped() {
    let decoded: SemioMeshDiff = dsl::json::from_json_str(DIFF).expect("committed delete-mesh diff decodes");
