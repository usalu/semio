...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: an unknown texture id is Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-texture/removes-the-leading-texture-and-keeps-the-trailing-one: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
