...
//#region 🔖️Manifest
pub async fn create_semio_audio_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_AUDIO_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::SEMIO_AUDIO_EDIT_MODE_ID)
...
mod tests {
    ...
    async fn editor_and_viewer_share_one_dialect() {
        semio_framework_plugin::testkit::assert_editor_and_viewer_share_dialect::<SemioAudioEditor, crate::viewer::semio_audio::SemioAudioViewer>();
    }
}
//#endregion 🧪️Tests
