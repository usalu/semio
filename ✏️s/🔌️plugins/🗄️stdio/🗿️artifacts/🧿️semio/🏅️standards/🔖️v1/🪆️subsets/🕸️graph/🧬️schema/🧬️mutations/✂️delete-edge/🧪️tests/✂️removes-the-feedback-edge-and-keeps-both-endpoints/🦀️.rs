...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/✂️removes-the-feedback-edge-and-keeps-both-endpoints/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/✂️removes-the-feedback-edge-and-keeps-both-endpoints/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/✂️removes-the-feedback-edge-and-keeps-both-endpoints/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/✂️removes-the-feedback-edge-and-keeps-both-endpoints/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-edge/✂️removes-the-feedback-edge-and-keeps-both-endpoints/🎯️outcome/🔣️.json");
