//! 🧊 Semio Model editor — the Main window: the SAME world-3d mesh scene shape as the sibling
...
const SEMIO_MODEL_EDIT_FALLBACK_MESH_KIND: &str = "box";
const SEMIO_MODEL_EDIT_DEFAULT_CAMERA_POSITION: [f64; 3] = [8.0, -8.0, 6.0];
const SEMIO_MODEL_EDIT_DEFAULT_CAMERA_TARGET: [f64; 3] = [0.0, 0.0, 0.0];
const SEMIO_MODEL_EDIT_DEFAULT_CAMERA_FOV: f64 = 45.0;
...
/// other by design).
async fn entity_count(document: &SemioModelSnapshot) -> usize {
...
pub async fn render(document: &SemioModelSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(SEMIO_MODEL_EDIT_DEFAULT_CAMERA_POSITION, SEMIO_MODEL_EDIT_DEFAULT_CAMERA_TARGET, SEMIO_MODEL_EDIT_DEFAULT_CAMERA_FOV).await,
        meshes_json,
...
mod tests {
    ...
    async fn render_produces_a_scene_node_for_the_default_document() {
        let document = SemioModelSnapshot::default();
