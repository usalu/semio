...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥delete-shell/🚫️removes-the-only-shell-and-leaves-its-faces-behind/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥delete-shell/🚫️removes-the-only-shell-and-leaves-its-faces-behind/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥delete-shell/🚫️removes-the-only-shell-and-leaves-its-faces-behind/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥delete-shell/🚫️removes-the-only-shell-and-leaves-its-faces-behind/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥delete-shell/🚫️removes-the-only-shell-and-leaves-its-faces-behind/🎯️outcome/🔣️.json");
