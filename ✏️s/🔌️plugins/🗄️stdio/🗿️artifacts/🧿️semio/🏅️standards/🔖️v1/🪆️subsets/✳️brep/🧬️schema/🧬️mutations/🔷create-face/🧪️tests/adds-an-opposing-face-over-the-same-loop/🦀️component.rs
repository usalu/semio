...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a duplicate face id is FATAL
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-face/adds-an-opposing-face-over-the-same-loop: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
