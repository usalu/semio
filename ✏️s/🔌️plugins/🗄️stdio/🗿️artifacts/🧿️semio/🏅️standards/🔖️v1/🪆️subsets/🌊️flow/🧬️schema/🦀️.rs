...
use crate::standards::v1::subsets::flow::schema::snapshot::{FlowEdge, FlowNode, SemioFlowSnapshot};
...
pub fn semio_flow_artifact_schema_descriptor() -> framework_schema::ArtifactSchemaDescriptor {
