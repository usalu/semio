//! 🧪️ `remove-frame` fixture — `🚫️removes-the-leading-frame`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️remove-frame/🚫️removes-the-leading-frame/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️remove-frame/🚫️removes-the-leading-frame/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️remove-frame/🚫️removes-the-leading-frame/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️remove-frame/🚫️removes-the-leading-frame/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️remove-frame/🚫️removes-the-leading-frame/🎯️outcome/🔣️.json");
