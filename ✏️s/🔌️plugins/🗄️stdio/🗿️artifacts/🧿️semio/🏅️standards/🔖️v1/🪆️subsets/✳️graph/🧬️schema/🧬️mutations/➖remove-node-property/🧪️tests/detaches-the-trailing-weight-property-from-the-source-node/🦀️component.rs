//! 🧪️ `remove-node-property` fixture — `detaches-the-trailing-weight-property-from-the-source-node`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`, which has TWO distinct Error
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-node-property/detaches-the-trailing-weight-property-from-the-source-node: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
