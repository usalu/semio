...
pub mod derived_composition {
    ...
    mod tests {
        ...
        async fn subset_validator_recheck_matches_the_composer_side_invariants() {
            ...
            assert!(diagnostics.await.iter().any(|d| d.code.0 == "stdio.semio_audio.zero-sample-rate"), "got {diagnostics:?}");
        }
        ...
        mod conformance_laws {
            ...
            async fn fixture_honesty_law() {
                ...
                let parsed = <snapshot::SemioAudioSnapshot as store::ArtifactDsl>::parse_dsl(FIXTURE_DSL).await.expect("parse shipped .dsl.semio fixture");
                ...
                let decoded = <snapshot::SemioAudioSnapshot as store::ArtifactPack>::decode_pack(FIXTURE_PACK).await.expect("decode shipped .pack.semio fixture");
