    ...
    mod tests {
        ...
        mod conformance_laws {
            ...
            async fn fixture_honesty_law() {
                const FIXTURE_DSL: &str = include_str!("../../✳️any/📚️examples/🕸️graph/🖼️assets/🗣️.dsl.semio");
                const FIXTURE_PACK: &[u8] = include_bytes!("../../✳️any/📚️examples/🕸️graph/🖼️assets/🎒️.pack.semio");
