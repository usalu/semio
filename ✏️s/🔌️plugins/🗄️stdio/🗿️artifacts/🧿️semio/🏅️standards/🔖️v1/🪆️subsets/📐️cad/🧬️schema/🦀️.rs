...
use crate::standards::v1::subsets::cad::schema::snapshot::{CadBlock, CadEntityRecord, CadLayer, SemioCadSnapshot};
...
pub fn semio_cad_artifact_schema_descriptor() -> framework_schema::ArtifactSchemaDescriptor {
