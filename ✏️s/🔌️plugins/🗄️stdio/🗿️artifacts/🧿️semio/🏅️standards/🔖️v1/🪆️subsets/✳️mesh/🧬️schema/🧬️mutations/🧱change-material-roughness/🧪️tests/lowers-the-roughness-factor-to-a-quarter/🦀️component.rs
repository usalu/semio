...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: the exact mirror of
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-material-roughness/lowers-the-roughness-factor-to-a-quarter: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
