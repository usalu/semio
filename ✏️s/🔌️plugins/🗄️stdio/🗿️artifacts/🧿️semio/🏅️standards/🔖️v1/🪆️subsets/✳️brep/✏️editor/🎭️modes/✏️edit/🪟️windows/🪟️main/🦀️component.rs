...
pub async fn render(document: &SemioBrepSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(SEMIO_BREP_EDIT_DEFAULT_CAMERA_POSITION, SEMIO_BREP_EDIT_DEFAULT_CAMERA_TARGET, SEMIO_BREP_EDIT_DEFAULT_CAMERA_FOV).await,
        meshes_json,
