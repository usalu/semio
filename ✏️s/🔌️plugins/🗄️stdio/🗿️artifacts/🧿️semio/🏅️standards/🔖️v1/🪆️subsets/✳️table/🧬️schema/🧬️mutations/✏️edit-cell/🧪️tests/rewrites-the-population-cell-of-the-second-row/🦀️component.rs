//! 🧪️ `edit-cell` fixture — `rewrites-the-population-cell-of-the-second-row`.
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`, which has THREE Error `mutation.target-missing`
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "edit-cell/rewrites-the-population-cell-of-the-second-row: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
