...
impl protocol::OpBinary for SemioDocumentEditCommand {
    ...
    fn decode_op(_bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        Ok(SemioDocumentEditCommand::SetVertex)
    }
}
//#endregion 🔖️Command
...
mod tests {
    ...
    async fn create_editor_builds_a_definition_for_the_editor_role() {
        let def = create_semio_document_editor();
    ...
    async fn editor_dialect_matches_the_artifact_coordinate() {
        assert_eq!(<SemioDocumentEditor as ArtifactEditor>::DIALECT, SEMIO_DOCUMENT_DIALECT);
    }

    #[semio_framework_async_macros::async_test]
    async fn editor_and_viewer_share_one_dialect() {
        semio_framework_plugin::testkit::assert_editor_and_viewer_share_dialect::<SemioDocumentEditor, crate::viewer::semio_document::SemioDocumentViewer>().await;
    }
}
//#endregion 🧪️Tests
