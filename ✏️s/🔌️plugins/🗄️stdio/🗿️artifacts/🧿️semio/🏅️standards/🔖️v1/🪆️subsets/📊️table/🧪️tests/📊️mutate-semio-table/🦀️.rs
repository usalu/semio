...
mod subject {
    ...
    use crate::standards::v1::subsets::table::schema::mutations::{apply_semio_table_mutation, decode_semio_table_mutation_json, inverse_semio_table_mutation, SemioTableMutation};
    ...
    /// would be exactly backwards — the same reading `🌳️mutate-dag-1` records for `.dag.dsl.semio`. It
