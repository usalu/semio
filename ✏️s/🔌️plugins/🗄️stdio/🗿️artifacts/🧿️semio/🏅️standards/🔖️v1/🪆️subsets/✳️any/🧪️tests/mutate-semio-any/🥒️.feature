...
Feature: Route every typed semio ENVELOPE mutation into the subset arm it names
  ...
  Scenario: no-mutation leaves the committed value-subset envelope exactly as it stands
    Given the committed before-envelope asset://🧬️schema/🧬️mutations/📄set-snapshot/🧪️tests/replaces-the-envelope-wrapping-a-value-subset/📸️snapshot/⬅️before/🔣️.json
  ...
  Scenario: set-snapshot replaces the committed value-subset envelope wholesale
    Given the committed before-envelope asset://🧬️schema/🧬️mutations/📄set-snapshot/🧪️tests/replaces-the-envelope-wrapping-a-value-subset/📸️snapshot/⬅️before/🔣️.json
    And the committed mutation fixture asset://🧬️schema/🧬️mutations/📄set-snapshot/🧪️tests/replaces-the-envelope-wrapping-a-value-subset/🦠️mutation/🔣️.json
    And the committed after-envelope asset://🧬️schema/🧬️mutations/📄set-snapshot/🧪️tests/replaces-the-envelope-wrapping-a-value-subset/📸️snapshot/➡️after/🔣️.json
