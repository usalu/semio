/** 🧬️ SemioWorkflowMutation schema (TEXT representation facet mirror) — real, matches the facet
 * root's shape; the wire ENCODING is `keyword arg=value ...` (see 📝️text/📖️component.grammar.semio). */
