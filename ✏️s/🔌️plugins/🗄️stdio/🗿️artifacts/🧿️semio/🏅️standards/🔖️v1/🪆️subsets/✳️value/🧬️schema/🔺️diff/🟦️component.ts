/** 🔺️ SemioValueTreeDiff facet mirror — the `🦀️component.rs` sibling is the real source of truth;
 ...
 * `NamedTripleDiff<K,D,T>.added: T[]` alone carries no position — see the `🦀️component.rs`
