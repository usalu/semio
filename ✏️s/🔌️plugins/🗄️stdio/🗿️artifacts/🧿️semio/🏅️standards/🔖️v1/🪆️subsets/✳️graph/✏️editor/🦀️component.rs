...
impl protocol::OpBinary for SemioGraphEditCommand {
    ...
    fn decode_op(_bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        Ok(SemioGraphEditCommand::SetVertex)
    }
}
//#endregion 🔖️Command
...
pub fn create_semio_graph_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_GRAPH_DIALECT).document(["stdio", "semio"]).icon_id("box").mode_def(edit::definition()).default_mode_id(edit::SEMIO_GRAPH_EDIT_MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
...
mod tests {
    ...
    async fn editor_and_viewer_share_one_dialect() {
        semio_framework_plugin::testkit::assert_editor_and_viewer_share_dialect::<SemioGraphEditor, crate::viewer::semio_graph::SemioGraphViewer>();
    }
}
//#endregion 🧪️Tests
