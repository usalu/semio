...
//#region 🔖️Manifest
pub async fn create_semio_graph_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_GRAPH_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::SEMIO_GRAPH_EDIT_MODE_ID)
