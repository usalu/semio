...
impl ArtifactEditor for SemioObjectEditor {
    ...
    async fn initial_snapshot() -> SemioObjectSnapshot {
...
//#region 🔖️Manifest
pub async fn create_semio_object_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SEMIO_OBJECT_DIALECT)
        .await.document(["stdio", "semio"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::SEMIO_OBJECT_EDIT_MODE_ID)
