//! 🧪️ `📸️set-snapshot` fixture — `🔤️relabels-and-repositions-the-transform-node`.
//!
...
use crate::standards::v1::subsets::flow::schema::mutations::{apply_semio_flow_mutation, SemioFlowMutation};
use crate::standards::v1::subsets::flow::schema::snapshot::SemioFlowSnapshot;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔤️relabels-and-repositions-the-transform-node/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔤️relabels-and-repositions-the-transform-node/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔤️relabels-and-repositions-the-transform-node/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔤️relabels-and-repositions-the-transform-node/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔤️relabels-and-repositions-the-transform-node/🎯️outcome/🔣️.json");
