...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-texture/🖼️adds-a-second-texture-at-the-end/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-texture/🖼️adds-a-second-texture-at-the-end/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-texture/🖼️adds-a-second-texture-at-the-end/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-texture/🖼️adds-a-second-texture-at-the-end/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-texture/🖼️adds-a-second-texture-at-the-end/🎯️outcome/🔣️.json");
