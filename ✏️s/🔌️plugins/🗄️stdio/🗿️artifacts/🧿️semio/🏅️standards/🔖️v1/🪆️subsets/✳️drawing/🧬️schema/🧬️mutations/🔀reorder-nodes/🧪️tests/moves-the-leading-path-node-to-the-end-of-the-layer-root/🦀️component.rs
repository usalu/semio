...
//!
//! Transcribed from `../../🔺️diff/🦀️component.rs`: a parent that is not a group, or a `from` past
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-nodes/moves-the-leading-path-node-to-the-end-of-the-layer-root: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
