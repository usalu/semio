//! 🧪️ `move-vertex` fixture — `🎯️lifts-the-third-vertex-of-the-triangle`.
//!
//! Transcribed from `../../🔺️diff/🦀️.rs`, guards in order: absent mesh/primitive ⇒ Error
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/🎯️lifts-the-third-vertex-of-the-triangle/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/🎯️lifts-the-third-vertex-of-the-triangle/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/🎯️lifts-the-third-vertex-of-the-triangle/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/🎯️lifts-the-third-vertex-of-the-triangle/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍move-vertex/🎯️lifts-the-third-vertex-of-the-triangle/🎯️outcome/🔣️.json");

fn before() -> SemioMeshSnapshot {
    dsl::json::from_json_str(BEFORE).expect("move-vertex before snapshot decodes")
}
fn expected_after() -> SemioMeshSnapshot {
    dsl::json::from_json_str(AFTER).expect("move-vertex after snapshot decodes")
}
fn mutation() -> SemioMeshMutation {
    dsl::json::from_json_str(MUTATION).expect("move-vertex mutation decodes")
}
...
async fn committed_json_is_canonical() {
    ...
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&(mutation()))).expect("move-vertex mutation encodes");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-vertex/lifts-the-third-vertex-of-the-triangle: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn committed_diff_is_canonical_and_narrowly_scoped() {
    let decoded: SemioMeshDiff = dsl::json::from_json_str(DIFF).expect("committed move-vertex diff decodes");
