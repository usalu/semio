...
//! `../../🏅️standards/4️⃣ac1018/🪆️subsets/✳️any/🧬️schema/🧬️mutations/🦀️.rs` re-exports the
...
mod subject {
    ...
    use crate::standards::v_ac1018::subsets::any::schema::mutations::{apply_dwg_mutation_checked, inverse_dwg_mutation, set_snapshot, set_version_info, DwgMutation};
    use crate::standards::v_ac1018::subsets::any::schema::snapshot::{decode_dwg, encode_dwg, DwgSnapshot};
