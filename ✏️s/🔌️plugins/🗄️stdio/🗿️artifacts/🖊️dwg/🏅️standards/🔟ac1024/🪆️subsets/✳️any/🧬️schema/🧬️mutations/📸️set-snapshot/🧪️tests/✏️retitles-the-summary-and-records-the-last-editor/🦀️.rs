//! 🧪️ `📸️set-snapshot` fixture — `✏️retitles-the-summary-and-records-the-last-editor` (AC1024).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️retitles-the-summary-and-records-the-last-editor/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️retitles-the-summary-and-records-the-last-editor/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️retitles-the-summary-and-records-the-last-editor/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️retitles-the-summary-and-records-the-last-editor/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/✏️retitles-the-summary-and-records-the-last-editor/🎯️outcome/🔣️.json");

fn before() -> DwgSnapshot {
    dsl::json::from_json_str(BEFORE).expect("before AC1024 snapshot decodes")
}
fn expected_after() -> DwgSnapshot {
    dsl::json::from_json_str(AFTER).expect("after AC1024 snapshot decodes")
}
...
async fn committed_json_is_canonical() {
    for (label, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: DwgSnapshot = dsl::json::from_json_str(text).expect("AC1024 snapshot decodes");
        let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&decoded)).expect("AC1024 snapshot encodes");
