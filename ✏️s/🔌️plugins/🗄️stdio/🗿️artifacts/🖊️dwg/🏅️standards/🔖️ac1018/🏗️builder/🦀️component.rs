//! 🏗️ DwgBuilder (ac1018 standard) — delegates to its ✳️any subset.

use semio_framework_plugin::ArtifactBuilder;
use crate::artifacts::dwg::{DwgDiff, DwgMutation, DwgSnapshot};
use crate::artifacts::dwg::standards::v_ac1018::subsets::any::builder::DwgBuilder as DwgRawAnyBuilder;
