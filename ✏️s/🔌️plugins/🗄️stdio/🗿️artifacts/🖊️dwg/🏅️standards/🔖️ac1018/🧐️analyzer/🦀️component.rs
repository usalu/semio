//! 🧐️ DwgAnalyzer (ac1018 standard) — delegates to its ✳️any subset.

use semio_framework_plugin::{ArtifactAnalyzer, Dialect, StandardId, SubsetId, IoConfidence, Analysis, AnalyzeSource};
use crate::artifacts::dwg::standards::v_ac1018::subsets::any::analyzer::DwgAnalyzer as DwgRawAnyAnalyzer;
pub use crate::artifacts::dwg::standards::v_ac1018::subsets::any::analyzer::DwgParts;
