...
/// mutations root so `📦️glue.rs` stays untouched (`#[path]` on a non-inline module resolves
/// against this file's own directory).
#[cfg(test)]
#[path = "📄set-snapshot/🧪️tests/bumps-the-auxiliary-save-counter/🦀️component.rs"]
