//! 🧪️ `📄set-snapshot` fixture — `bumps-the-auxiliary-save-counter` (AC1018).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "dwg-ac1018/set-snapshot: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
