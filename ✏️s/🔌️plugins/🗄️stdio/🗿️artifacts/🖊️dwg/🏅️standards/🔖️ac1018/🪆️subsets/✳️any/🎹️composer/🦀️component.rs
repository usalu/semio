//! 🎹️ DwgComposer (raw/✳️any at ac1018) — analyzer + builder glued. Reads native
//! `stdio.dwg` sources (plus its DAG dependencies: binary), writes one `stdio.dwg` (ac1018/✳️any) snapshot.
...
use crate::artifacts::dwg::standards::v_ac1018::subsets::any::analyzer::DwgAnalyzer;
