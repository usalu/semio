...
//#region 🔖️Manifest
pub async fn create_dwg_ac1018_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(DWG_AC1018_DIALECT)
        .await.document(["stdio", "dwgac1018"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::DWG_AC1018_EDIT_MODE_ID)
