...
pub fn create_dwg_ac1018_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(DWG_AC1018_DIALECT).document(["stdio", "dwgac1018"]).icon_id("box").mode_def(edit::definition()).default_mode_id(edit::DWG_AC1018_EDIT_MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
