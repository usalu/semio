...
pub async fn render(document: &DwgSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(DWG_AC1024_VIEW_DEFAULT_CAMERA_POSITION, DWG_AC1024_VIEW_DEFAULT_CAMERA_TARGET, DWG_AC1024_VIEW_DEFAULT_CAMERA_FOV).await,
        meshes_json,
