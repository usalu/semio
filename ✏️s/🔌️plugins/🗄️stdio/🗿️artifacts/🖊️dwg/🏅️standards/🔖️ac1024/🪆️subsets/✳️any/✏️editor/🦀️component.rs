...
//#region 🔖️Manifest
pub async fn create_dwg_ac1024_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(DWG_AC1024_DIALECT)
        .await.document(["stdio", "dwgac1024"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::DWG_AC1024_EDIT_MODE_ID)
