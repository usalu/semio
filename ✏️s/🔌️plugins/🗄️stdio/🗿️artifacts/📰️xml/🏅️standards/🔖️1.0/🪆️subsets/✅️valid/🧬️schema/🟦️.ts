...
if (import.meta.vitest) {
  const { registerTests1 } = await import("./🧪️tests/🧪️stdio-xml-valid-conformance-mirror/🟦️.ts");
  await registerTests1(import.meta.vitest, { CODE_DOCTYPE_MISSING, CODE_ROOT_NAME_MISMATCH, CODE_STANDALONE_EXTERNAL_SUBSET, CODE_VALIDITY_NOT_VERIFIED, checkValidConformance, meta, snapshotWith }, { directory: import.meta.dir, url: import.meta.url });
}
