...
//! `../../../🔮️oracles/🦀️.rs` (which is registered `cross-semio-implementation` and computes what a
...
//! `../../../🔮️oracles/🦀️.rs::resolve_general_ref` documents — and the shared base document's own
