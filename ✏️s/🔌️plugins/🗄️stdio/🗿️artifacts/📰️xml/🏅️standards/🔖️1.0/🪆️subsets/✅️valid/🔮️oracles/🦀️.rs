...
//! of failing, where `📸️snapshot/🦀️.rs` rejects them outright ("only typed ENTITY
...
//! @see ../🧬️schema/🧬️mutations/🦀️.rs — the vocabulary itself (`XmlValidMutation::KINDS`).
...
mod live {
    ...
    /// before the forward mutation ran. Mirrors the algebra `../🧬️schema/🧬️mutations/🦀️.rs`
