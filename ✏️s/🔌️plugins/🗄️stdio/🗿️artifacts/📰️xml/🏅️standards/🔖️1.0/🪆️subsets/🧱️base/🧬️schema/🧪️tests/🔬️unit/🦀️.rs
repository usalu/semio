...
async fn schema_facets_reject_raw_doctype_and_source_shadow_state() {
    let facets = [
        include_str!("../../📸️snapshot/🦀️.rs"),
        include_str!("../../📸️snapshot/🟦️.ts"),
        include_str!("../../📸️snapshot/🔣️.json"),
        include_str!("../../📸️snapshot/📝️text/🔗️.graphql"),
        include_str!("../../📸️snapshot/📝️text/🛰️.proto"),
...
mod conformance_laws {
    ...
    /// `m5_handcrafted_grammar_conformance`'s own `dsl_body_from_host_document` uses, so this is a
