...
pub fn declaration(definition: semio_framework_plugin::ArtifactDefinition) -> Result<semio_framework_plugin::ArtifactDeclaration, semio_framework_plugin::ArtifactDefinitionError> {
    ...
    semio_framework_plugin::ArtifactDeclaration::builder(definition)
        .schema(crate::schema::xml_artifact_schema_descriptor())
        .formats(formats)
        .inferences([crate::standards::v1_0::subsets::base::schema::inferences::xml_artifact_inference_descriptor()])
        .composers(crate::standards::v1_0::subsets::base::io::io_registry::entries())
...
fn pilot_subset_validators() -> &'static [semio_framework_plugin::SubsetValidatorEntry] {
    ...
    ENTRIES.get_or_init(|| vec![semio_framework_plugin::subset_validator_entry_of::<crate::standards::v1_0::subsets::valid::io::XmlValidValidator>()]).as_slice()
}
