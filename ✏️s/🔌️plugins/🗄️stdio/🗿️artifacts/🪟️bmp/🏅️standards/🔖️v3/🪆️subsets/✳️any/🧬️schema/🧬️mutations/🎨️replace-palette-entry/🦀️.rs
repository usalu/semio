...
pub(crate) fn test_case() -> BmpMutation {
    dsl::json::from_json_str(include_str!("../../../🧫️fixtures/🧬️mutations/🎨️replace-palette-entry/🎯️direct-behavior/🦠️mutation/🔣️.json")).expect("committed replace-palette-entry payload")
}
#[cfg(test)]
