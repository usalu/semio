//! 🧪️ `remove-palette-entry` fixture — `🎯️direct-behavior`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📤️remove-palette-entry/🎯️direct-behavior/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📤️remove-palette-entry/🎯️direct-behavior/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📤️remove-palette-entry/🎯️direct-behavior/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📤️remove-palette-entry/🎯️direct-behavior/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📤️remove-palette-entry/🎯️direct-behavior/🎯️outcome/🔣️.json");
...
fn mutation() -> BmpMutation {
    dsl::json::from_json_str(MUTATION).expect("committed remove-palette-entry payload decodes")
}
...
fn op_codecs_round_trip() {
    ...
    assert_eq!(bytes[1], binary::BINARY_TAG, "remove-palette-entry/direct-behavior: the binary frame must carry this schema's tag");
