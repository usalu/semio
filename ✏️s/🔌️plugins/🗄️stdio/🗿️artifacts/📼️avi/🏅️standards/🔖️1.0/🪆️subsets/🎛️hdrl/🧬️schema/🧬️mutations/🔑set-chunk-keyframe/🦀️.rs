//! 🔑️ `set-chunk-keyframe` — authored as its own mutation leaf. The aggregate's original `diff`/`inverse`
...
impl protocol::MutationKind<AviSnapshot, AviMutation> for SetChunkKeyframe {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native("Set chunk keyframe", "Keyframe-Kennung des Chunks setzen")
    }
