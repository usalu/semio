...
mod oracles {
    ...
    /// `🚪️io/🦀️.rs`). <https://learn.microsoft.com/🪟️windows/win32/directshow/avimainheader>
    /// <https://learn.microsoft.com/🪟️windows/win32/api/wingdi/ns-wingdi-bitmapinfoheader>
