//! 🧪️ `📄set-snapshot` fixture — `promotes-the-second-movi-chunk-to-a-keyframe`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "avi/set-snapshot: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
