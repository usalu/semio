//! 🧐️ AviAnalyzer — 🚧 scaffolded by W1b: JSON-pack decode for the internal snapshot
...
use crate::artifacts::avi::standards::v1_0::engine as engine;
    ...
    fn sniff(source: &AnalyzeSource<'_>) -> IoConfidence {
        match source {
            ...
            AnalyzeSource::Text(text) => {
                if engine::sniff_real_bytes(text.as_bytes()) || text.contains(STDIO_AVI_DOCUMENT_SCHEMA) {
                    IoConfidence::High
                } else {
                    IoConfidence::Low
                }
