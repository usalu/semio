...
//! production `decode_avi` in `../../🚪️io/🦀️component.rs` requires exactly 64 bytes and returns
...
//! handlers in the case's own `🦀️component.rs` will fail at `decode_avi` the moment the subject
...
mod oracles {
    ...
    /// `🚪️io/🦀️component.rs`). <https://learn.microsoft.com/windows/win32/directshow/avimainheader>
