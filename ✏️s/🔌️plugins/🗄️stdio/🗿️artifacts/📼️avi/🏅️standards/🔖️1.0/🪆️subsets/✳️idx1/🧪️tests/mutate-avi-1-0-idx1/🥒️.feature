...
Feature: Apply every typed AVI 1.0 mutation to a real-world video container
  See ../mutate-avi-1-0/🥒️.feature for the full fixture/provenance narrative -- this subset's own scenarios exercise only the mutation kinds `../../🏅️standards` places under this subset.
