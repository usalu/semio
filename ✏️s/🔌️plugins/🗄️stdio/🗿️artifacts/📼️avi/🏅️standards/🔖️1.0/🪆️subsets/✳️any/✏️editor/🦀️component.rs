...
pub fn create_avi_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(AVI_DIALECT).document(["semio", "avi"]).icon_id("play").mode_def(edit::definition()).default_mode_id(edit::MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
