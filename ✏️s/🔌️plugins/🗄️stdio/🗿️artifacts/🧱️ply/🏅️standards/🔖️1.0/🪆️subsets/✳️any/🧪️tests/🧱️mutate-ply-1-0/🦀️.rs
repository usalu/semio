...
mod subject {
    ...
    use semio_s_artifact_stdio_ply::standards::v1_0::subsets::any::schema::mutations::{add_element, apply_ply_mutation, insert_comment, insert_row, remove_comment, remove_element, remove_row, set_format, set_row_property, set_snapshot, PlyMutation};
    use semio_s_artifact_stdio_ply::standards::v1_0::subsets::any::schema::snapshot::{PlyElement, PlyFormat, PlyProperty, PlyRow, PlyScalarType, PlySnapshot, PlyValue};
    ...
    fn mutation_from_spec(spec: &Json, snapshot: &PlySnapshot) -> Result<PlyMutation, String> {
        ...
        Ok(match kind.as_str() {
            ...
            "set-snapshot" => {
                ...
                let mut next = semio_s_artifact_stdio_ply::standards::v1_0::subsets::any::schema::snapshot::PlySnapshot::default();
