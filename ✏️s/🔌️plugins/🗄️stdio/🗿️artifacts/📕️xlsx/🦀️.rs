...
pub fn declaration(definition: semio_framework_plugin::ArtifactDefinition) -> Result<semio_framework_plugin::ArtifactDeclaration, semio_framework_plugin::ArtifactDefinitionError> {
    ...
    semio_framework_plugin::ArtifactDeclaration::builder(definition)
        .schema(crate::schema::xlsx_artifact_schema_descriptor())
        .formats(formats)
        .inferences([crate::standards::v_ecma_376::subsets::base::schema::inferences::xlsx_artifact_inference_descriptor()])
...
fn xlsx_subset_validators() -> &'static [semio_framework_plugin::SubsetValidatorEntry] {
    ...
    ENTRIES
        .get_or_init(|| {
            vec![
                semio_framework_plugin::subset_validator_entry_of::<crate::standards::v_ecma_376::subsets::strict::io::XlsxStrictValidator>(),
                semio_framework_plugin::subset_validator_entry_of::<crate::standards::v_ecma_376::subsets::transitional::io::XlsxTransitionalValidator>(),
            ]
        })
        .as_slice()
}
