//! 👁️ Xlsx viewer (ecma-376/🧱️base) — read-only counterpart of the sibling mutation-capable surface
...
/// surface, and `🧱️base`'s own schema module (a different, live peer ticket) exposes no standalone
