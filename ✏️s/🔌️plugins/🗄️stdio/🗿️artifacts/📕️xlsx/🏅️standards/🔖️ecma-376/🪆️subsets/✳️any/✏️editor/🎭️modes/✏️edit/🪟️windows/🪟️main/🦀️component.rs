//! 📊️ Xlsx editor (ecma-376/✳️any) — `main` window: a real, directly editable flat table of every
...
use crate::editor::xlsx::standards::v_ecma_376::subsets::any::{render_xlsx_cell_value, xlsx_flat_cells};
...
pub async fn definition() -> WindowKindDefinition {
    WindowKindDefinition { label: LocalizedLabel::native("Cells", "Zellen"), icon_id: "table-2".into(), ..TableWindowKit::editable_window_kind().await }
}
