...
mod subject {
    ...
    use crate::standards::v_ecma_376::subsets::base::schema::mutations::apply_xlsx_mutation;
    ...
    fn mutation_from_spec(spec: &Json, base: &XlsxSnapshot) -> Result<XlsxMutation, String> {
        ...
        Ok(match spec.str("kind").as_str() {
            "no-mutation" => XlsxMutation::SetSnapshot(crate::standards::v_ecma_376::subsets::base::schema::mutations::set_snapshot::SetSnapshot { snapshot: base.clone() }),
            "set-snapshot" => {
                ...
                XlsxMutation::SetSnapshot(crate::standards::v_ecma_376::subsets::base::schema::mutations::set_snapshot::SetSnapshot { snapshot: build_minimal_xlsx(XlsxWorkbook { sheets, shared_strings: vec![] }) })
            }
            "insert-sheet" => XlsxMutation::InsertSheet(crate::standards::v_ecma_376::subsets::base::schema::mutations::insert_sheet::InsertSheet { sheet: XlsxSheet { name: params.str("name"), cells: xlsx_cells_from_json(&params, "cells")? } }),
            "remove-sheet" => XlsxMutation::RemoveSheet(crate::standards::v_ecma_376::subsets::base::schema::mutations::remove_sheet::RemoveSheet { name: params.str("name") }),
            "rename-sheet" => XlsxMutation::RenameSheet(crate::standards::v_ecma_376::subsets::base::schema::mutations::rename_sheet::RenameSheet { name: params.str("name"), new_name: params.str("newName") }),
            "set-cell" => XlsxMutation::SetCell(crate::standards::v_ecma_376::subsets::base::schema::mutations::set_cell::SetCell { sheet_name: params.str("sheetName"), row: number("row").ok_or("set-cell: missing `row`")? as u32, col: number("col").ok_or("set-cell: missing `col`")? as u32, value: xlsx_cell_value_from_json(params.get("value").ok_or("set-cell: missing `value`")?)? }),
            "remove-cell" => XlsxMutation::RemoveCell(crate::standards::v_ecma_376::subsets::base::schema::mutations::remove_cell::RemoveCell { sheet_name: params.str("sheetName"), row: number("row").ok_or("remove-cell: missing `row`")? as u32, col: number("col").ok_or("remove-cell: missing `col`")? as u32 }),
            "insert-shared-string" => XlsxMutation::InsertSharedString(crate::standards::v_ecma_376::subsets::base::schema::mutations::insert_shared_string::InsertSharedString { value: params.str("value") }),
            "remove-shared-string" => XlsxMutation::RemoveSharedString(crate::standards::v_ecma_376::subsets::base::schema::mutations::remove_shared_string::RemoveSharedString { index: number("index").ok_or("remove-shared-string: missing `index`")? as usize }),
            "set-shared-string" => XlsxMutation::SetSharedString(crate::standards::v_ecma_376::subsets::base::schema::mutations::set_shared_string::SetSharedString { index: number("index").ok_or("set-shared-string: missing `index`")? as usize, value: params.str("value") }),
