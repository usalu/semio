...
mod subject {
    ...
    use semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::{apply_xlsx_strict_mutation, stamp_conformance_class, vml_markup, XlsxStrictMutation};
