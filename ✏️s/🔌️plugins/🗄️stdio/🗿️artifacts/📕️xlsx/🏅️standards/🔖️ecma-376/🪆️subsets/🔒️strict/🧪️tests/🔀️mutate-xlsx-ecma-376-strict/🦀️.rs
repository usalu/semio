...
use semio_s_plugin_stdio_test_oracle::artifacts::xlsx::standards::v_ecma_376::subsets::strict::{oracle_apply_mutation, oracle_arrange, oracle_inverse_spec, oracle_round_trip, project_package};
...
mod subject {
    ...
    use semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::{apply_xlsx_strict_mutation, remove_conformance_attribute, stamp_conformance_class, vml_markup, XlsxStrictMutation};
    ...
    fn mutation_from_spec(ctx: &Context, spec: &Json) -> Result<XlsxStrictMutation, String> {
        ...
        Ok(match spec.str("kind").as_str() {
            "set-snapshot" => XlsxStrictMutation::SetSnapshot(semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::set_snapshot::SetSnapshot { snapshot: stamped(&decode(&mutable_input(ctx)?)?, params.str("conformanceClass") == "strict")? }),
            "set-main-namespace" => XlsxStrictMutation::SetMainNamespace(semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::set_main_namespace::SetMainNamespace { namespace: params.str("namespace") }),
            "set-relationships-namespace" => XlsxStrictMutation::SetRelationshipsNamespace(semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::set_relationships_namespace::SetRelationshipsNamespace { namespace: params.str("namespace") }),
            "set-conformance-attribute" => XlsxStrictMutation::SetConformanceAttribute(semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::set_conformance_attribute::SetConformanceAttribute { value: params.str("value") }),
            ...
            "insert-vml-part" => XlsxStrictMutation::InsertVmlPart(semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::insert_vml_part::InsertVmlPart { path: params.str("path"), markup: vml_markup() }),
            "remove-vml-part" => XlsxStrictMutation::RemoveVmlPart(semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::remove_vml_part::RemoveVmlPart { path: params.str("path") }),
            "set-worksheet-content-type" => XlsxStrictMutation::SetWorksheetContentType(semio_s_artifact_stdio_xlsx::standards::v_ecma_376::subsets::strict::schema::mutations::set_worksheet_content_type::SetWorksheetContentType { path: params.str("path"), content_type: params.str("contentType") }),
