...
/// mutation catalog `xlsx-ecma-376-transitional` (`../../🧪️oracle/🔣️component.json`) is measured against
...
impl Mutation<XlsxSnapshot> for XlsxTransitionalMutation {
    type Diff = XlsxDiff;
...
mod tests {
    ...
    fn kinds_match_enum_and_catalog() {
        fn kind_of(mutation: &XlsxTransitionalMutation) -> &'static str {
            match mutation {
                XlsxTransitionalMutation::NoMutation => "no-mutation",
                XlsxTransitionalMutation::SetSnapshot { .. } => "set-snapshot",
                XlsxTransitionalMutation::SetMainNamespace { .. } => "set-main-namespace",
                XlsxTransitionalMutation::SetRelationshipsNamespace { .. } => "set-relationships-namespace",
                XlsxTransitionalMutation::SetConformanceAttribute { .. } => "set-conformance-attribute",
                XlsxTransitionalMutation::RemoveConformanceAttribute => "remove-conformance-attribute",
                XlsxTransitionalMutation::SetWorksheetContentType { .. } => "set-worksheet-content-type",
            }
        }
        let samples = [
            XlsxTransitionalMutation::NoMutation,
            XlsxTransitionalMutation::SetSnapshot { snapshot: XlsxSnapshot::default() },
            XlsxTransitionalMutation::SetMainNamespace { namespace: String::new() },
            XlsxTransitionalMutation::SetRelationshipsNamespace { namespace: String::new() },
            XlsxTransitionalMutation::SetConformanceAttribute { value: String::new() },
            XlsxTransitionalMutation::RemoveConformanceAttribute,
            XlsxTransitionalMutation::SetWorksheetContentType { path: String::new(), content_type: String::new() },
        ];
