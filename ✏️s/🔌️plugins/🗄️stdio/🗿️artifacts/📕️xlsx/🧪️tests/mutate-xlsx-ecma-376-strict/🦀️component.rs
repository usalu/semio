...
//! `semantic-ooxml-xlsx-strict-v1` profile compares them. The subject half is gated behind the
...
//#region 🔖️Kinds
/// 🧾️ Test-case-local mirror of the `xlsx-ecma-376-strict` catalog. Duplicated, not imported,
...
/// outright.
const KINDS: &[&str] = &["no-mutation", "set-snapshot", "set-main-namespace", "set-relationships-namespace", "set-conformance-attribute", "remove-conformance-attribute", "insert-vml-part", "remove-vml-part", "set-worksheet-content-type"];
//#endregion 🔖️Kinds
