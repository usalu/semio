...
//! `semantic-ooxml-xlsx-transitional-v1` profile compares them. The subject half is gated behind the
...
//#region 🔖️Kinds
/// 🧾️ Test-case-local mirror of the `xlsx-ecma-376-transitional` catalog. Duplicated, not imported,
/// from `../../🏅️standards/🔖️ecma-376/🪆️subsets/✳️transitional/🧬️schema/🧬️mutations/🦀️component.rs::KINDS`
...
/// outright.
const KINDS: &[&str] = &["no-mutation", "set-snapshot", "set-main-namespace", "set-relationships-namespace", "set-conformance-attribute", "remove-conformance-attribute", "set-worksheet-content-type"];
//#endregion 🔖️Kinds
