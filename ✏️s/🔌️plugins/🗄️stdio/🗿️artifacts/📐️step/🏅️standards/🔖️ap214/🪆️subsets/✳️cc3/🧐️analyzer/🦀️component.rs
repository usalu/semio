//! 🧐️ StepCc3Analyzer (ap214/✳️cc3) — real ISO 10303-214 CC3 (wireframe with topology) conformance checks against the
...
//! - HARD: any `*_SHAPE_REPRESENTATION` instance whose ladder rung exceeds 3 (see
//!   `⚙️engine::ladder::ladder_rung_of` for the classification and rationale; cc3 allows rungs
//!   up to 3).
...
pub struct StepCc3Analyzer;

impl ArtifactAnalyzer for StepCc3Analyzer {
