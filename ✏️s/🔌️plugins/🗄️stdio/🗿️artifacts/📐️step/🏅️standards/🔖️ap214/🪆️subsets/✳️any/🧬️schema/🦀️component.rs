...
mod tests {
    ...
    async fn codec_round_trip() {
        ...
        let parsed = <StepSnapshot as store::ArtifactDsl>::parse_dsl(&text).await.expect("parse");
    ...
    mod conformance_laws {
        ...
        async fn fixture_honesty_law() {
            ...
            let parsed = <StepSnapshot as store::ArtifactDsl>::parse_dsl(FIXTURE_DSL).await.expect("parse shipped .dsl.semio fixture");
            ...
            let decoded = <StepSnapshot as store::ArtifactPack>::decode_pack(FIXTURE_PACK).await.expect("decode shipped .pack.semio fixture");
