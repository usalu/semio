//! 🔮️ Mutation oracle for `ap214/6️⃣cc6` — ISO 10303-214 CC6 (advanced B-Rep, top of the ladder).
//!
...
//!
//! * There is no `demote-shape-representation` arm. `2️⃣cc2`..`5️⃣cc5` have instances above their
...
//! @see 🔣️.json — the `step-ap214-cc6` catalog and the `ruststep` registration it carries.
