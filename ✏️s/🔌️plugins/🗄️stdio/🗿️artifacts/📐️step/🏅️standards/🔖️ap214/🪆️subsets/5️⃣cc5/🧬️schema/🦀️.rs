//! 🧬️ StepSnapshot schema (ap214/5️⃣cc5) — reuses the 🧱️base subset's `StepSnapshot` verbatim
...
//! `🪆️subsets/5️⃣cc5/🧬️schema/` is present per `🔣️taxonomy.json`'s `subsetChildDirs`, without
