//! 🧬️ StepSnapshot schema (ap214/1️⃣cc1) — reuses the 🧱️base subset's `StepSnapshot` verbatim
...
//! `🪆️subsets/1️⃣cc1/🧬️schema/` is present per `🔣️taxonomy.json`'s `subsetChildDirs`, without
...
pub mod derived_analysis {
    ...
    //#region 🔖️Analyzer
    /// 🧐️ Analyzes `stdio.step` (ap214/1️⃣cc1): delegates the real parse to the 🧱️base subset's
