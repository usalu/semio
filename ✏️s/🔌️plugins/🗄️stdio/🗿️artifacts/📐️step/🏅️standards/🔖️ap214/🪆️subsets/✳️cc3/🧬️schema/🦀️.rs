//! 🧬️ StepSnapshot schema (ap214/✳️cc3) — reuses the ✳️base subset's `StepSnapshot` verbatim
...
pub mod derived_construction {
    ...
    mod tests {
        ...
        async fn hard_violation_injected_via_raw_mutate_still_fails_build() {
            ...
            let (mutated, _diff) = StepCc3BuilderConstruction::from_snapshot(StepSnapshot::default()).mutate(StepMutation::SetSnapshot(crate::artifacts::step::standards::v_ap214::subsets::any::schema::mutations::set_snapshot::SetSnapshot { snapshot }));
...
pub mod derived_analysis {
    ...
    //#region 🔖️Analyzer
    /// 🧐️ Analyzes `stdio.step` (ap214/✳️cc3): delegates the real parse to the ✳️base subset's
