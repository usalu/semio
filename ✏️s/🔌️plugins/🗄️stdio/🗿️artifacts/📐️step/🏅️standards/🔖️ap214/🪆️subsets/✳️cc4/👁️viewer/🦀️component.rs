...
//#region 🔖️Manifest
pub async fn create_step_cc4_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(STEP_CC4_DIALECT)
        .await.document(["stdio", "step"])
        .await.icon_id("box")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::STEP_CC4_VIEW_MODE_ID)
