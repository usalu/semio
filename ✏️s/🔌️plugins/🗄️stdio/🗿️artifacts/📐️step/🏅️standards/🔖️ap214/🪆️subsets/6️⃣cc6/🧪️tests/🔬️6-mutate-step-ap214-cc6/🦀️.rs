...
mod subject {
    ...
    use semio_s_artifact_stdio_step::standards::v_ap214::subsets::cc6::schema::mutations::{apply_step_cc6_mutation_checked, inverse_step_cc6_mutation, StepCc6Mutation};
    ...
    fn mutation_from_spec(spec: &Json, base: &StepSnapshot) -> Result<StepCc6Mutation, String> {
        ...
        Ok(match spec.str("kind").as_str() {
            "set-snapshot" => {
                ...
                let _ = base;
                StepCc6Mutation::SetSnapshot(semio_s_artifact_stdio_step::standards::v_ap214::subsets::cc6::schema::mutations::set_snapshot::SetSnapshot { snapshot })
            }
            "set-file-schema" => {
                ...
                StepCc6Mutation::SetFileSchema(semio_s_artifact_stdio_step::standards::v_ap214::subsets::cc6::schema::mutations::set_file_schema::SetFileSchema { schemas })
            }
            "set-product-identity" => StepCc6Mutation::SetProductIdentity(semio_s_artifact_stdio_step::standards::v_ap214::subsets::cc6::schema::mutations::set_product_identity::SetProductIdentity {
                identity: match params.get("identity").filter(|value| !matches!(value, Json::Null)) {
                    Some(value) => Some(identity_from(value)?),
                    None => None,
                },
            }),
            "set-shape-representation" => StepCc6Mutation::SetShapeRepresentation(semio_s_artifact_stdio_step::standards::v_ap214::subsets::cc6::schema::mutations::set_shape_representation::SetShapeRepresentation {
