//! 🧐️ StepCc6Analyzer (ap214/✳️cc6) — real ISO 10303-214 CC6 (advanced B-Rep, top of the ladder) conformance checks against the
...
//! - HARD: any `*_SHAPE_REPRESENTATION` instance whose ladder rung exceeds 6 (see
//!   `⚙️engine::ladder::ladder_rung_of` for the classification and rationale; cc6 allows rungs
//!   up to 6).
...
pub struct StepCc6Analyzer;

impl ArtifactAnalyzer for StepCc6Analyzer {
