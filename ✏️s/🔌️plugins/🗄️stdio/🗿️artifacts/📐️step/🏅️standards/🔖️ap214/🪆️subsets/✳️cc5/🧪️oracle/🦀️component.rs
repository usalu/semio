...
//! @see 🔣️component.json — the `step-ap214-cc5` catalog and the `ruststep` registration it carries.
...
mod tests {
    ...
    fn kinds_match_the_catalog_and_the_vocabulary() {
        ...
        let feature = include_str!("../../../../../🧪️tests/mutate-step-ap214-cc5/component.feature");
        for kind in KINDS {
