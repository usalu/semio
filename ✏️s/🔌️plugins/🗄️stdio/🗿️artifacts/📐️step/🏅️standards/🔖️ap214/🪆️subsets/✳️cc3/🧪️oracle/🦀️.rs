//! 🔮️ Mutation oracle for `ap214/✳️cc3` — ISO 10303-214 CC3 (wireframe with topology).
//!
...
mod tests {
    ...
    fn the_real_export_reads_the_way_this_class_predicts() {
        ...
        assert_eq!(before.get("aboveCeiling"), Some(&Json::Number(1.0)), "the rung-6 #13 is above CC3; #836 is rung 2 and well inside it");
            ...
            spec(
                ...
                object(vec![
                    ...
                    (
                        "representation",
                        object(vec![
                            ("typeName", Json::String("GEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION".to_string())),
