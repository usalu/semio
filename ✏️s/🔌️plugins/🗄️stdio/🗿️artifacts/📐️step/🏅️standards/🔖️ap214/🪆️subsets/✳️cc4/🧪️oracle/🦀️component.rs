//! 🔮️ Mutation oracle for `ap214/✳️cc4` — ISO 10303-214 CC4 (manifold surfaces with topology).
//!
...
//!
//! 🧬️ **This catalog declares exactly the same six kinds as `✳️cc2`, `✳️cc3`, `✳️cc5`, and that is a
...
//! @see 🔣️component.json — the `step-ap214-cc4` catalog and the `ruststep` registration it carries.
...
mod tests {
    ...
    fn kinds_match_the_catalog_and_the_vocabulary() {
        ...
        let feature = include_str!("../../../../../🧪️tests/mutate-step-ap214-cc4/component.feature");
        for kind in KINDS {
