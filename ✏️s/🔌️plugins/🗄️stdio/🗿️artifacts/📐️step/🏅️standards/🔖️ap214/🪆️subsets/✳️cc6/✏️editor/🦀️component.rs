...
impl protocol::OpBinary for StepCc6EditCommand {
    ...
    fn decode_op(_bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        Ok(StepCc6EditCommand::SetVertex)
    }
}
//#endregion 🔖️Command
...
pub fn create_step_cc6_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(STEP_CC6_DIALECT).document(["stdio", "step"]).icon_id("box").mode_def(edit::definition()).default_mode_id(edit::STEP_CC6_EDIT_MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
