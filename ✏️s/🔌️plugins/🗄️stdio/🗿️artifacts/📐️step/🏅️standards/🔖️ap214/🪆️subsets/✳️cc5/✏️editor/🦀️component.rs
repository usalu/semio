...
//#region 🔖️Manifest
pub async fn create_step_cc5_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(STEP_CC5_DIALECT)
        .await.document(["stdio", "step"])
        .await.icon_id("box")
        .await.mode_def(edit::definition().await)
        .await.default_mode_id(edit::STEP_CC5_EDIT_MODE_ID)
