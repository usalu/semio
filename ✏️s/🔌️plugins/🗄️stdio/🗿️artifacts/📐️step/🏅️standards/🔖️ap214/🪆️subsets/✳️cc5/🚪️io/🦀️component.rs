...
pub mod derived_composition {
        ...
        fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
            ...
            if !hard.is_empty() {
                ...
                return Err(ComposeError {
                    message: format!("ISO 10303-214 CC5 (faceted B-Rep) conformance violated: {} hard issue(s) -- not stamping the cc5 dialect", hard.len()),
                    diagnostics: all,
                });
            }
    ...
    mod tests {
        ...
        fn subset_validator_recheck_flags_missing_file_schema_on_the_raw_wire_payload() {
            ...
            assert!(diagnostics.iter().any(|d| d.code.0 == crate::artifacts::step::standards::v_ap214::subsets::cc5::schema::CODE_FILE_SCHEMA), "got {diagnostics:?}");
        }
    }
}
