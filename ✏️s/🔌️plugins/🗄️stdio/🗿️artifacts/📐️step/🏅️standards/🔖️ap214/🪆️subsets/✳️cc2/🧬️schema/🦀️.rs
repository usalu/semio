//! 🧬️ StepSnapshot schema (ap214/✳️cc2) — reuses the ✳️base subset's `StepSnapshot` verbatim
...
pub mod derived_analysis {
    ...
    //#region 🔖️Analyzer
    /// 🧐️ Analyzes `stdio.step` (ap214/✳️cc2): delegates the real parse to the ✳️base subset's
