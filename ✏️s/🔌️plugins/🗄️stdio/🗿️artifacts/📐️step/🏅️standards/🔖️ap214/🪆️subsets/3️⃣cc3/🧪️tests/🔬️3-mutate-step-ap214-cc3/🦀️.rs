...
mod subject {
    ...
    use crate::standards::v_ap214::subsets::cc3::schema::mutations::{apply_step_cc3_mutation_checked, inverse_step_cc3_mutation, StepCc3Mutation};
    ...
    fn mutation_from_spec(spec: &Json, base: &StepSnapshot) -> Result<StepCc3Mutation, String> {
        ...
        Ok(match spec.str("kind").as_str() {
            "set-snapshot" => {
                ...
                let _ = base;
                StepCc3Mutation::SetSnapshot(crate::standards::v_ap214::subsets::cc3::schema::mutations::set_snapshot::SetSnapshot { snapshot })
            }
            "set-file-schema" => {
                ...
                StepCc3Mutation::SetFileSchema(crate::standards::v_ap214::subsets::cc3::schema::mutations::set_file_schema::SetFileSchema { schemas })
            }
            "set-product-identity" => StepCc3Mutation::SetProductIdentity(crate::standards::v_ap214::subsets::cc3::schema::mutations::set_product_identity::SetProductIdentity {
                identity: match params.get("identity").filter(|value| !matches!(value, Json::Null)) {
                    Some(value) => Some(identity_from(value)?),
                    None => None,
                },
            }),
            "set-shape-representation" => StepCc3Mutation::SetShapeRepresentation(crate::standards::v_ap214::subsets::cc3::schema::mutations::set_shape_representation::SetShapeRepresentation {
            ...
            "demote-shape-representation" => StepCc3Mutation::DemoteShapeRepresentation(crate::standards::v_ap214::subsets::cc3::schema::mutations::demote_shape_representation::DemoteShapeRepresentation { id: u64_field(&params, "id")? }),
