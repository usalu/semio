//! 🔮️ Mutation oracle for `ap214/5️⃣cc5` — ISO 10303-214 CC5 (faceted B-Rep).
//!
...
//!
//! 🧬️ **This catalog declares exactly the same six kinds as `2️⃣cc2`, `3️⃣cc3`, `4️⃣cc4`, and that is a
...
mod tests {
    ...
    fn kinds_match_the_catalog_and_the_vocabulary() {
        ...
        let feature = include_str!("../🧪️tests/5️⃣mutate-step-ap214-cc5/🥒️.feature");
        for kind in KINDS {
