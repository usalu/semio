...
//#region 🔖️Manifest
pub async fn create_step_cc2_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(STEP_CC2_DIALECT)
        .await.document(["stdio", "step"])
        .await.icon_id("box")
        .await.mode_def(view::definition().await)
        .await.default_mode_id(view::STEP_CC2_VIEW_MODE_ID)
