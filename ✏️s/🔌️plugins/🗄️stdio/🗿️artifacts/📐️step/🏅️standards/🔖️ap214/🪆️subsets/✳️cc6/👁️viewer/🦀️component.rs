...
pub fn create_step_cc6_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(STEP_CC6_DIALECT).document(["stdio", "step"]).icon_id("box").mode_def(view::definition()).default_mode_id(view::STEP_CC6_VIEW_MODE_ID).window_kind_def(main::definition()).default_layout(view::layout()).build_definition()
}
//#endregion 🔖️Manifest
