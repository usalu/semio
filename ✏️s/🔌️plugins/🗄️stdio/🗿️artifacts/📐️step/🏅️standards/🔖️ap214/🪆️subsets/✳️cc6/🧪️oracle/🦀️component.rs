...
//! @see 🔣️component.json — the `step-ap214-cc6` catalog and the `ruststep` registration it carries.
            ...
            spec(
                ...
                object(vec![
                    ...
                    (
                        "representation",
                        object(vec![
                            ("typeName", Json::String("ADVANCED_BREP_SHAPE_REPRESENTATION".to_string())),
