...
pub mod derived_construction {
    ...
    mod tests {
        ...
        use crate::standards::v_ap214::subsets::cc4::schema::CODE_LADDER;
        ...
        async fn hard_violation_injected_via_raw_mutate_still_fails_build() {
            ...
            let (mutated, _diff) = StepCc4BuilderConstruction::from_snapshot(StepSnapshot::default()).mutate(StepMutation::SetSnapshot(crate::standards::v_ap214::subsets::base::schema::mutations::set_snapshot::SetSnapshot { snapshot }));
