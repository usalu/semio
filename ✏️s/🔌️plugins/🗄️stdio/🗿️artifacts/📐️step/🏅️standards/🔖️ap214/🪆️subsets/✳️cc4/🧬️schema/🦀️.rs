//! 🧬️ StepSnapshot schema (ap214/✳️cc4) — reuses the ✳️base subset's `StepSnapshot` verbatim
...
//! `🪆️subsets/✳️cc4/🧬️schema/` is present per `🔣️taxonomy.json`'s `subsetChildDirs`, without
...
pub mod derived_analysis {
    ...
    //#region 🔖️Analyzer
    /// 🧐️ Analyzes `stdio.step` (ap214/✳️cc4): delegates the real parse to the ✳️base subset's
