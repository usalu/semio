//! 🦀️ STEP AP214 `✳️cc2` mutation case — Rust adapter. ISO 10303-214 CC2 (bounded wireframe/basic surfaces).
//!
...
mod subject {
    ...
    use semio_s_plugin_stdio::artifacts::step::standards::v_ap214::subsets::cc2::schema::mutations::{apply_step_cc2_mutation_checked, inverse_step_cc2_mutation, StepCc2Mutation};
