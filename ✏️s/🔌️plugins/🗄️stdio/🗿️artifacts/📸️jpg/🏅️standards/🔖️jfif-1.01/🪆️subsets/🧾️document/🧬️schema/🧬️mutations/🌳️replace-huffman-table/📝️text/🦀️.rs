...
pub fn print(value: &JpgMutation) -> Option<String> {
    ...
    Some(format!("replace-huffman-table table={}", diff::enc_huffman_table(table)))
}
pub fn parse(line: &str) -> Result<JpgMutation, String> {
    ...
    Ok(JpgMutation::ReplaceHuffmanTable(crate::artifacts::jpg::schema::mutations::ReplaceHuffmanTableMutation { table: diff::dec_huffman_table(arg("table")?)? }))
}
