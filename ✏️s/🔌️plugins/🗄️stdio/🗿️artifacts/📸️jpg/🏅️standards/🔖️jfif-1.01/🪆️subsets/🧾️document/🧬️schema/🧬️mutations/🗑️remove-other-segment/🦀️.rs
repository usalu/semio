...
pub(crate) fn test_case() -> JpgMutation {
    dsl::json::from_json_str(include_str!("../../../🧫️fixtures/🧬️mutations/🗑️remove-other-segment/🎯️direct-behavior/🦠️mutation/🔣️.json")).expect("committed remove-other-segment payload")
}
#[cfg(test)]
