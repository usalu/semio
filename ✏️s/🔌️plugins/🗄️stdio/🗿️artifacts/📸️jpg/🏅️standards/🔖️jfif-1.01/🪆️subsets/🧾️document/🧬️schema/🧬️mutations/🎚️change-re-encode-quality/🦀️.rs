...
pub(crate) fn test_case() -> JpgMutation {
    dsl::json::from_json_str(include_str!("../../../🧫️fixtures/🧬️mutations/🎚️change-re-encode-quality/🎯️direct-behavior/🦠️mutation/🔣️.json")).expect("committed change-re-encode-quality payload")
}
#[cfg(test)]
