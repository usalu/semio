//! 🧪️ `replace-quant-table` fixture — `🎯️direct-behavior`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-quant-table/direct-behavior: produced diff differs from the committed 🔺️diff/🔣️.json");
}
