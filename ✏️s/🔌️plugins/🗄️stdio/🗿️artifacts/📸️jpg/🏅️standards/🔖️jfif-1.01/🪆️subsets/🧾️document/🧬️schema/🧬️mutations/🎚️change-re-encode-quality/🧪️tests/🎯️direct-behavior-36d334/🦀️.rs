//! 🧪️ `change-re-encode-quality` fixture — `🎯️direct-behavior`.
//!
...
fn op_codecs_round_trip() {
    ...
    assert_eq!(bytes[1], binary::BINARY_TAG, "change-re-encode-quality/direct-behavior: the binary frame must carry this schema's tag");
