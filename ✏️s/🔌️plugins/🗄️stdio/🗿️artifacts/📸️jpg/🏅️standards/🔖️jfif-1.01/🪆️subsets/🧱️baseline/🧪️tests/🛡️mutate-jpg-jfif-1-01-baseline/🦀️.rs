...
//! (`../../🏅️standards/🔖️jfif-1.01/🪆️subsets/🧱️baseline/🔮️oracles/🔣️.json`).
//!
//! **Why there is no oracle here when the sibling subset has one.** `image` 0.25 is registered by
//! `🧾️document` and is the right reference for a JPEG raster, but its public surface is pixels,
...
//! `🧾️document` oracle module's independent `image`-backed reader — so the geometry claim is made by a
...
mod subject {
    ...
    use crate::schema::snapshot::{JpgFrameComponent, JpgHuffmanClass, JpgHuffmanTable};
    use crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::{apply_jpg_baseline_mutation, encode_jpg_baseline_projection_json, inverse_jpg_baseline_mutation, jpg_baseline_conformance_codes, JpgBaselineMutation};
    ...
    fn mutation_from_spec(kind: &str, params: &Json, base: &JpgSnapshot) -> Result<JpgBaselineMutation, String> {
        match kind {
            "set-snapshot" => {
                ...
                Ok(JpgBaselineMutation::SetSnapshot(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::set_snapshot::SetSnapshot { snapshot }))
            }
            "set-sof-marker" => Ok(JpgBaselineMutation::SetSofMarker(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::set_sof_marker::SetSofMarker { marker: number(params, "marker", 194.0) as u8 })),
            "set-sample-precision" => Ok(JpgBaselineMutation::SetSamplePrecision(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::set_sample_precision::SetSamplePrecision { precision: number(params, "precision", 12.0) as u8 })),
            "set-arithmetic" => Ok(JpgBaselineMutation::SetArithmetic(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::set_arithmetic::SetArithmetic { arithmetic: matches!(params.get("arithmetic"), Some(Json::Bool(true))) })),
            "insert-huffman-table" => Ok(JpgBaselineMutation::InsertHuffmanTable(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::insert_huffman_table::InsertHuffmanTable { index: number(params, "index", 0.0) as usize, table: inert_table(class_of(params), number(params, "id", 2.0) as u8) })),
            "remove-huffman-table" => Ok(JpgBaselineMutation::RemoveHuffmanTable(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::remove_huffman_table::RemoveHuffmanTable { key: JpgHuffmanTableKey { class: class_of(params), id: number(params, "id", 0.0) as u8 } })),
            "insert-frame-component" => Ok(JpgBaselineMutation::InsertFrameComponent(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::insert_frame_component::InsertFrameComponent {
            ...
            "remove-frame-component" => Ok(JpgBaselineMutation::RemoveFrameComponent(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::remove_frame_component::RemoveFrameComponent { id: number(params, "id", 3.0) as u8 })),
            "set-component-sampling" => Ok(JpgBaselineMutation::SetComponentSampling(crate::standards::v_jfif_1_01::subsets::baseline::schema::mutations::set_component_sampling::SetComponentSampling { id: number(params, "id", 1.0) as u8, h_sampling: number(params, "hSampling", 5.0) as u8, v_sampling: number(params, "vSampling", 1.0) as u8 })),
