/** 👁️ DXF viewer — subset-level typed twin. Read-only counterpart of
 * `✏️editor/🟦️.ts`: mirrors the viewer manifest's mode/window vocabulary, no
 * mutation-shaped exports. */

export const DXF_ANY_VIEWER_DIALECT = { artifactKind: "s.stdio.dxf", standard: "r12", subset: "*" } as const;
