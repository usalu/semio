...
//! @see ../🧬️schema/🧬️mutations/🦀️.rs — the mutation vocabulary itself (`MdMutation`).
//! @see ../🧬️schema/📸️snapshot/🦀️.rs — the `MdBlock`/`MdInline` shape this module's JSON
...
mod live {
    ...
    //#region 🔖️Navigate
    /// 🧭️ Mirrors `MdPathStep`'s two variants (`../../🧬️schema/🔺️diff/🦀️.rs`) without
