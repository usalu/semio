//! 🧪️ `set-snapshot` fixture — `🔽️demotes-the-tower-heading-to-level-3`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔽️demotes-the-tower-heading-to-level-3/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔽️demotes-the-tower-heading-to-level-3/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔽️demotes-the-tower-heading-to-level-3/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔽️demotes-the-tower-heading-to-level-3/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🔽️demotes-the-tower-heading-to-level-3/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: MdSnapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-snapshot/demotes-the-tower-heading-to-level-3: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: MdDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
