...
export const gltfPrincipalAxesInference = {
  id: 's.stdio.gltf.inference.principal-axes.v1',
  algorithmVersion: 1,
  cacheKey: 's.stdio.gltf.inference.principal-axes.v1:geometry-v2',
...
export type GltfPrincipalAxesInference = typeof gltfPrincipalAxesInference;
