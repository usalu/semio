//! 🧪️ `move-camera` fixture — `swaps-the-perspective-and-orthographic-cameras`.
//!
...
use crate::artifacts::gltf::schema::mutations::move_camera::mutation::GltfMoveCameraPayload;
