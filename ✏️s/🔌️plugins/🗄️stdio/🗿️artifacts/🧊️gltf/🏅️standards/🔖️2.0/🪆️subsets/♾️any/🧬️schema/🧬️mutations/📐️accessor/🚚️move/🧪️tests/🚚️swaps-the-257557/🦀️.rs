...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🚚️move/🚚️swaps-the-257557/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🚚️move/🚚️swaps-the-257557/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🚚️move/🚚️swaps-the-257557/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🚚️move/🚚️swaps-the-257557/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🚚️move/🚚️swaps-the-257557/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfMoveAccessorDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
