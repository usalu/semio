//! 🧪️ `create-buffer` fixture — `inserts-a-two-byte-buffer-ahead-of-the-four-byte-buffer`.
//!
...
use crate::artifacts::gltf::schema::mutations::create_buffer::mutation::GltfCreateBufferPayload;
