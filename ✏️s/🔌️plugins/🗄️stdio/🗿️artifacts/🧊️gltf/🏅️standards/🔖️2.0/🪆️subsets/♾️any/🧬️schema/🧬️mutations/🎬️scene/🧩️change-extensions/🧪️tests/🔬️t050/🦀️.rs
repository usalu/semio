...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🧩️change-extensions/🔬️t050/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🧩️change-extensions/🔬️t050/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🧩️change-extensions/🔬️t050/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🧩️change-extensions/🔬️t050/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🧩️change-extensions/🔬️t050/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfChangeSceneExtensionDataDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
