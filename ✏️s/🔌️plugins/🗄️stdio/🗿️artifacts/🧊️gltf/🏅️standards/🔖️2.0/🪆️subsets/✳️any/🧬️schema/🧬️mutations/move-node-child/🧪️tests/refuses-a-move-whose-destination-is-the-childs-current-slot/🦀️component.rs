...
//!
//! This leaf ships NO `🔺️diff` and NO `↩️inverse` module at all — `🦠️mutation` is its entire
...
use crate::artifacts::gltf::schema::mutations::move_node_child::mutation::GltfMoveNodeChildPayload;
use crate::artifacts::gltf::schema::mutations::move_node_child::mutation;
