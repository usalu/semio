//! 🧪️ `reorder-node-children` fixture — `refuses-an-order-that-repeats-the-same-child-twice`.
//!
//! No `🔺️diff` and no `↩️inverse` module, hence `🔺️diff/🚫️component.absent`. `validate()` builds a
...
use crate::artifacts::gltf::schema::mutations::reorder_node_children::mutation::GltfReorderNodeChildrenPayload;
use crate::artifacts::gltf::schema::mutations::reorder_node_children::mutation;
