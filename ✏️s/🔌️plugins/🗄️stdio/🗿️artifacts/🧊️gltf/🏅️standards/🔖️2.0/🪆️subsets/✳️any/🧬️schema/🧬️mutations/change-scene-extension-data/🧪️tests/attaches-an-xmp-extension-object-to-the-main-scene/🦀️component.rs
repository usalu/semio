//! 🧪️ `change-scene-extension-data` fixture — `attaches-an-xmp-extension-object-to-the-main-scene`.
//!
...
use crate::artifacts::gltf::schema::mutations::change_scene_extension_data::mutation::GltfChangeSceneExtensionDataPayload;
