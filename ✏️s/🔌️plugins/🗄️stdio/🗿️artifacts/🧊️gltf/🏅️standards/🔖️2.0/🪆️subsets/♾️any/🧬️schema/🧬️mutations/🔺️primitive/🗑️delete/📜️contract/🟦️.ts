...
import { applyGltfDeletePrimitive, type GltfDeletePrimitivePayload } from './🟦️';
import { deriveGltfDeletePrimitiveDiff } from './🟦️';
import { deriveGltfDeletePrimitiveInverse } from './🟦️';
