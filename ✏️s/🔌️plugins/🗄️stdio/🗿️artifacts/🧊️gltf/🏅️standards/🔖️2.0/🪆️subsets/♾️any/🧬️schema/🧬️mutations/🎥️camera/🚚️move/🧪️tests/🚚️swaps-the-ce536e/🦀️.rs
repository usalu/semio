...
use crate::schema::mutations::move_camera::diff::GltfMoveCameraDiff;
use crate::schema::mutations::move_camera::GltfMoveCameraPayload;
use crate::schema::mutations::move_camera::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "move-camera/swaps-the-perspective-and-orthographic-cameras";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎥️camera/🚚️move/🚚️swaps-the-ce536e/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎥️camera/🚚️move/🚚️swaps-the-ce536e/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎥️camera/🚚️move/🚚️swaps-the-ce536e/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎥️camera/🚚️move/🚚️swaps-the-ce536e/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎥️camera/🚚️move/🚚️swaps-the-ce536e/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    assert!(matches!(snapshot.document.cameras[0].projection, crate::schema::snapshot::GltfCameraProjection::Orthographic(_)), "{CASE}: the orthographic camera must end up first");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfMoveCameraDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
