//! 🧪️ `create-texture` fixture — `inserts-an-empty-texture-ahead-of-the-albedo-texture`.
//!
...
use crate::artifacts::gltf::schema::mutations::create_texture::mutation::GltfCreateTexturePayload;
