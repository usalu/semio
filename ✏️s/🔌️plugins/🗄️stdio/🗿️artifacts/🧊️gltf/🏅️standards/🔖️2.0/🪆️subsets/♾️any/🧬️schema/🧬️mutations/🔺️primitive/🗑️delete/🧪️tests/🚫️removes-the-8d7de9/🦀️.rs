...
use crate::artifacts::gltf::schema::mutations::delete_primitive::GltfDeletePrimitivePayload;
use crate::artifacts::gltf::schema::mutations::delete_primitive::{diff, inverse, mutation};
