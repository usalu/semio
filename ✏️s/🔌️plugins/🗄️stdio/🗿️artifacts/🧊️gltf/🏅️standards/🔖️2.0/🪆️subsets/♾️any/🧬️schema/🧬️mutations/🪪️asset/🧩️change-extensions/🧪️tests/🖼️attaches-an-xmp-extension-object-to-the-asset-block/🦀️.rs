//! 🧪️ `change-asset-extension-data` fixture — `🖼️attaches-an-xmp-extension-object-to-the-asset-block`.
//!
...
use crate::artifacts::gltf::schema::mutations::change_asset_extension_data::GltfChangeAssetExtensionDataPayload;
