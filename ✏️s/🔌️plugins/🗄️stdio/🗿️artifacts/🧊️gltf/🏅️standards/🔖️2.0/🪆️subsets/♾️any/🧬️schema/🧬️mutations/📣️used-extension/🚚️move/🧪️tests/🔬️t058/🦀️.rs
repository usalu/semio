...
use crate::schema::mutations::move_used_extension::GltfMoveUsedExtensionPayload;
use crate::schema::mutations::move_used_extension::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "move-used-extension/demotes-the-unlit-declaration-behind-the-transform-declaration";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/🚚️move/🔬️t058/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/🚚️move/🔬️t058/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/🚚️move/🔬️t058/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/🚚️move/🔬️t058/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/🚚️move/🔬️t058/🎯️outcome/🔣️.json");
