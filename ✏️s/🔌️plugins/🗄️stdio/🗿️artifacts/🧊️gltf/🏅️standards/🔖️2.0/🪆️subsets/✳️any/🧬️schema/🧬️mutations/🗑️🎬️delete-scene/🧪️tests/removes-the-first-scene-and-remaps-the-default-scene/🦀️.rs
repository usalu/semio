//! 🧪️ `delete-scene` fixture — `removes-the-first-scene-and-remaps-the-default-scene`.
//!
...
async fn committed_diff_is_canonical() {
    let decoded: GltfDeleteSceneDiff = serde_json::from_str(DIFF).expect("committed diff decodes");
