...
use crate::schema::mutations::reorder_morph_targets::GltfReorderMorphTargetsPayload;
use crate::schema::mutations::reorder_morph_targets::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "reorder-morph-targets/flips-the-two-morph-targets";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🧬️morph-target/🔀️reorder/🔀️flips-the-two-14d32f/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🧬️morph-target/🔀️reorder/🔀️flips-the-two-14d32f/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🧬️morph-target/🔀️reorder/🔀️flips-the-two-14d32f/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🧬️morph-target/🔀️reorder/🔀️flips-the-two-14d32f/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🧬️morph-target/🔀️reorder/🔀️flips-the-two-14d32f/🎯️outcome/🔣️.json");
