//! 🧪️ `change-asset-extra-data` fixture — `attaches-a-pipeline-extras-object-to-the-asset-block`.
//!
...
use crate::artifacts::gltf::schema::mutations::change_asset_extra_data::mutation::GltfChangeAssetExtraDataPayload;
