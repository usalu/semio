//! 🧪️ `reorder-scene-root-nodes` fixture — `🚫️refuses-a-scene-index-past-the-end-of-the-scene-list`.
//!
...
use crate::schema::mutations::reorder_scene_root_nodes::GltfReorderSceneRootNodesPayload;
use crate::schema::mutations::reorder_scene_root_nodes;
