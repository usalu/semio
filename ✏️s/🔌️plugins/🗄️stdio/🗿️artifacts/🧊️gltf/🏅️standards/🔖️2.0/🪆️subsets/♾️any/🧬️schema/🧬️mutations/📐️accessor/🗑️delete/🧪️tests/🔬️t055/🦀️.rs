//! 🧪️ `delete-accessor` fixture — `🗑️removes-the-index-accessor-and-renumbers-the-position-attribute`.
//!
...
use crate::schema::mutations::delete_accessor::diff::GltfDeleteAccessorDiff;
use crate::schema::mutations::delete_accessor::GltfDeleteAccessorPayload;
use crate::schema::mutations::delete_accessor::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "delete-accessor/removes-the-index-accessor-and-renumbers-the-position-attribute";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🗑️delete/🔬️t055/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🗑️delete/🔬️t055/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🗑️delete/🔬️t055/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🗑️delete/🔬️t055/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📐️accessor/🗑️delete/🔬️t055/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfDeleteAccessorDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&decoded)).expect("diff re-encodes");
    let original: serde_json::Value = serde_json::from_str(DIFF).expect("committed diff reparses");
    assert_eq!(reencoded, original, "{CASE}: committed diff JSON is not canonical");
    assert!(matches!(decoded.operation, crate::schema::mutations::delete_accessor::diff::GltfDeleteAccessorOperation::Delete { index: 0, .. }), "{CASE}: the committed operation must be a delete at index 0");
}
