/** 🦠️ unrequire-extension executable glTF command. */
...
export const GltfUnrequireExtensionDescriptor = { id: 's.stdio.gltf.mutation.unrequire-extension.v1', version: 1, touchedPaths: ["document/extensionsRequired"], referencePolicy: 'removes only an existing requirement' } as const;
