...
use crate::schema::mutations::bind_node_mesh::diff::GltfBindNodeMeshDiff;
use crate::schema::mutations::bind_node_mesh::GltfBindNodeMeshPayload;
use crate::schema::mutations::bind_node_mesh::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "bind-node-mesh/binds-the-hull-mesh-to-the-body-node";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏗️node-mesh/🔗️bind/🔗️binds-the-hull-fe46fd/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏗️node-mesh/🔗️bind/🔗️binds-the-hull-fe46fd/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏗️node-mesh/🔗️bind/🔗️binds-the-hull-fe46fd/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏗️node-mesh/🔗️bind/🔗️binds-the-hull-fe46fd/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏗️node-mesh/🔗️bind/🔗️binds-the-hull-fe46fd/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfBindNodeMeshDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
