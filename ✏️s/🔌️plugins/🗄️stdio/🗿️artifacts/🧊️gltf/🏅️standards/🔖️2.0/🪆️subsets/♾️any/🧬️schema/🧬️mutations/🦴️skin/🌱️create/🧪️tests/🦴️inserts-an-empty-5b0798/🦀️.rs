...
use crate::schema::mutations::create_skin::diff::GltfCreateSkinDiff;
use crate::schema::mutations::create_skin::GltfCreateSkinPayload;
use crate::schema::mutations::create_skin::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "create-skin/inserts-an-empty-skin-ahead-of-the-jointed-skin";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🌱️create/🦴️inserts-an-empty-5b0798/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🌱️create/🦴️inserts-an-empty-5b0798/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🌱️create/🦴️inserts-an-empty-5b0798/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🌱️create/🦴️inserts-an-empty-5b0798/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🌱️create/🦴️inserts-an-empty-5b0798/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfCreateSkinDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
