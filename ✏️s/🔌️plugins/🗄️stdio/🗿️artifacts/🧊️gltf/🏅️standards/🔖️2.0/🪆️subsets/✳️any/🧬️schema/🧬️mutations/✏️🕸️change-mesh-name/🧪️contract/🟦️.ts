...
import { applyGltfChangeMeshName, type GltfChangeMeshNamePayload } from '../../change-mesh-name/🟦️.ts';
import { deriveGltfChangeMeshNameDiff } from '../../change-mesh-name/🔺️diff/🟦️.ts';
import { deriveGltfChangeMeshNameInverse } from '../../change-mesh-name/↩️inverse/🟦️.ts';
