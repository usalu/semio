//! 🧪️ `unbind-scene-root-node` fixture — `demotes-the-root-node-out-of-the-main-scene`.
//!
...
use crate::artifacts::gltf::schema::mutations::unbind_scene_root_node::mutation::GltfUnbindSceneRootNodePayload;
