//! 🧪️ `change-material-double-sided` fixture — `makes-the-default-material-double-sided`.
//!
...
use crate::artifacts::gltf::schema::mutations::change_material_double_sided::mutation::GltfChangeMaterialDoubleSidedPayload;
