...
use crate::schema::mutations::change_asset_extension_data::GltfChangeAssetExtensionDataPayload;
use crate::schema::mutations::change_asset_extension_data::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "change-asset-extension-data/attaches-an-xmp-extension-object-to-the-asset-block";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧩️change-extensions/🔬️t069/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧩️change-extensions/🔬️t069/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧩️change-extensions/🔬️t069/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧩️change-extensions/🔬️t069/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧩️change-extensions/🔬️t069/🎯️outcome/🔣️.json");
