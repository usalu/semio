...
use crate::schema::mutations::delete_buffer_view::diff::GltfDeleteBufferViewDiff;
use crate::schema::mutations::delete_buffer_view::GltfDeleteBufferViewPayload;
use crate::schema::mutations::delete_buffer_view::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "delete-buffer-view/removes-the-two-byte-window-and-renumbers-the-accessor";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🗑️delete/🔬️t067/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🗑️delete/🔬️t067/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🗑️delete/🔬️t067/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🗑️delete/🔬️t067/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🗑️delete/🔬️t067/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfDeleteBufferViewDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
