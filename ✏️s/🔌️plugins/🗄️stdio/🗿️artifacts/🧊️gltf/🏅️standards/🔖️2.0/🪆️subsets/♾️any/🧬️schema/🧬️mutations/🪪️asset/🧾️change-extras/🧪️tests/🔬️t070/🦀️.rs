...
use crate::schema::mutations::change_asset_extra_data::GltfChangeAssetExtraDataPayload;
use crate::schema::mutations::change_asset_extra_data::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "change-asset-extra-data/attaches-a-pipeline-extras-object-to-the-asset-block";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧾️change-extras/🔬️t070/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧾️change-extras/🔬️t070/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧾️change-extras/🔬️t070/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧾️change-extras/🔬️t070/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🧾️change-extras/🔬️t070/🎯️outcome/🔣️.json");
