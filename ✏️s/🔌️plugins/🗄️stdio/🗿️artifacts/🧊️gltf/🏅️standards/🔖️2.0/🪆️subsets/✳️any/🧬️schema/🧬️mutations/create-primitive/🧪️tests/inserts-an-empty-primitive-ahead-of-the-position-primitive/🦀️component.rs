//! 🧪️ `create-primitive` fixture — `inserts-an-empty-primitive-ahead-of-the-position-primitive`.
//!
...
use crate::artifacts::gltf::schema::mutations::create_primitive::mutation::GltfCreatePrimitivePayload;
