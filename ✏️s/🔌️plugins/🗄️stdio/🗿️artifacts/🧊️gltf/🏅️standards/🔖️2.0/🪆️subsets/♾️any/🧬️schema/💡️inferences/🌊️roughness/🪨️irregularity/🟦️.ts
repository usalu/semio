...
export const gltfIrregularityInference = {
  id: 's.stdio.gltf.inference.irregularity.v1',
  algorithmVersion: 1,
  cacheKey: 's.stdio.gltf.inference.irregularity.v1:geometry-v2',
...
export type GltfIrregularityInference = typeof gltfIrregularityInference;
