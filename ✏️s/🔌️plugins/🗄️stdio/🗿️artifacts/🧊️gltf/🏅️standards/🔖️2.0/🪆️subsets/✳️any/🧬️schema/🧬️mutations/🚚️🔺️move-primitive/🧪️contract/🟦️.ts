...
import { applyGltfMovePrimitive, type GltfMovePrimitivePayload } from '../../move-primitive/🟦️.ts';
import { deriveGltfMovePrimitiveDiff } from '../../move-primitive/🔺️diff/🟦️.ts';
import { deriveGltfMovePrimitiveInverse } from '../../move-primitive/↩️inverse/🟦️.ts';
