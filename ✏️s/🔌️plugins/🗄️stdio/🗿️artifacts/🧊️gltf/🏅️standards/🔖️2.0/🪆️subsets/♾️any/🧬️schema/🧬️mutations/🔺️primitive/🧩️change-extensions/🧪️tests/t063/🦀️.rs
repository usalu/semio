//! 🧪️ `change-primitive-extension-data` fixture — `🔌️attaches-a-draco-extension-object-to-the-primitive`.
//!
...
use crate::schema::mutations::change_primitive_extension_data::GltfChangePrimitiveExtensionDataPayload;
use crate::schema::mutations::change_primitive_extension_data::{diff, inverse, mutation};
