...
use crate::schema::mutations::unbind_node_child::diff::GltfUnbindNodeChildDiff;
use crate::schema::mutations::unbind_node_child::GltfUnbindNodeChildPayload;
...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌿️node-child/✂️unbind/✂️releases-the-8ba322/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌿️node-child/✂️unbind/✂️releases-the-8ba322/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌿️node-child/✂️unbind/✂️releases-the-8ba322/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌿️node-child/✂️unbind/✂️releases-the-8ba322/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌿️node-child/✂️unbind/✂️releases-the-8ba322/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfUnbindNodeChildDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
