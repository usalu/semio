//! 🧪️ `create-animation` fixture — `inserts-an-empty-clip-ahead-of-the-spin-clip`.
//!
...
use crate::artifacts::gltf::schema::mutations::create_animation::mutation::GltfCreateAnimationPayload;
