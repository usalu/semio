...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🌫️change-alpha/🎭️switches-the-79b834/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🌫️change-alpha/🎭️switches-the-79b834/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🌫️change-alpha/🎭️switches-the-79b834/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🌫️change-alpha/🎭️switches-the-79b834/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🌫️change-alpha/🎭️switches-the-79b834/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfChangeMaterialAlphaModeDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
