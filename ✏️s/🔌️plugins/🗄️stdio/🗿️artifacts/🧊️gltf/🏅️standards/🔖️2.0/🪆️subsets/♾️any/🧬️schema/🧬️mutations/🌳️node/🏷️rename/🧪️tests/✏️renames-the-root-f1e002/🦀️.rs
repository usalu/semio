...
use crate::schema::mutations::change_node_name::diff::GltfChangeNodeNameDiff;
use crate::schema::mutations::change_node_name::GltfChangeNodeNamePayload;
...
async fn committed_diff_is_canonical() {
    let decoded: GltfChangeNodeNameDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
