...
use crate::schema::mutations::change_primitive_extra_data::GltfChangePrimitiveExtraDataPayload;
use crate::schema::mutations::change_primitive_extra_data::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "change-primitive-extra-data/attaches-a-lod-extras-object-to-the-primitive";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📝️change-extras/📝️attaches-a-lod-698164/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📝️change-extras/📝️attaches-a-lod-698164/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📝️change-extras/📝️attaches-a-lod-698164/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📝️change-extras/📝️attaches-a-lod-698164/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📝️change-extras/📝️attaches-a-lod-698164/🎯️outcome/🔣️.json");
