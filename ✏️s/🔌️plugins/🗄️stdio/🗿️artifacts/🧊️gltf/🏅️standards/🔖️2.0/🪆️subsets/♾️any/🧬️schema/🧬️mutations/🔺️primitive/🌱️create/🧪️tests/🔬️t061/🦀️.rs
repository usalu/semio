...
use crate::schema::mutations::create_primitive::GltfCreatePrimitivePayload;
use crate::schema::mutations::create_primitive::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "create-primitive/inserts-an-empty-primitive-ahead-of-the-position-primitive";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/🌱️create/🔬️t061/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/🌱️create/🔬️t061/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/🌱️create/🔬️t061/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/🌱️create/🔬️t061/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/🌱️create/🔬️t061/🎯️outcome/🔣️.json");
