//! 🧪️ `reorder-primitives` fixture — `flips-the-strip-primitive-ahead-of-the-position-primitive`.
//!
...
use crate::artifacts::gltf::schema::mutations::reorder_primitives::mutation::GltfReorderPrimitivesPayload;
