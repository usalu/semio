...
use crate::schema::mutations::bind_default_scene::GltfBindDefaultScenePayload;
use crate::schema::mutations::bind_default_scene::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "bind-default-scene/moves-the-default-scene-pointer-to-the-second-scene";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/🔗️bind/🎞️moves-the-0e42fe/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/🔗️bind/🎞️moves-the-0e42fe/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/🔗️bind/🎞️moves-the-0e42fe/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/🔗️bind/🎞️moves-the-0e42fe/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/🔗️bind/🎞️moves-the-0e42fe/🎯️outcome/🔣️.json");
