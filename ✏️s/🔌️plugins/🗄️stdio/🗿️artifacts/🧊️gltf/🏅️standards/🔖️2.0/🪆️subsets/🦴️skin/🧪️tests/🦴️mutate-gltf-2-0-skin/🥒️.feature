...
Feature: Apply every registered glTF 2.0 skin mutation to a real-world document
  ...
  directory (`../../../♾️any/🧬️schema/🧬️mutations/🦴️skin/
  ...
  Scenario Outline: Apply <id> to the real document
    ...
    Examples:
      | id             | fixture                     | params                       |
      | create-skin    | 🌱️create-skin-applied       | {"position":1}               |
      | delete-skin    | 🗑️delete-skin-applied       | {"index":0}                  |
      | move-skin      | 🚚️move-skin-applied         | {"index":1,"position":0}     |
      | reorder-skins  | 🔀️reorder-skins-applied     | {"order":[1,0]}              |
