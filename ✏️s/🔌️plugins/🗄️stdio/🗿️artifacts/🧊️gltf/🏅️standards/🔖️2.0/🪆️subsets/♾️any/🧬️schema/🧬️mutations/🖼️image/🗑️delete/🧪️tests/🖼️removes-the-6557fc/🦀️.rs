//! 🧪️ `delete-image` fixture — `🖼️removes-the-albedo-image-and-renumbers-the-texture-source`.
//!
...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🖼️image/🗑️delete/🖼️removes-the-6557fc/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🖼️image/🗑️delete/🖼️removes-the-6557fc/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🖼️image/🗑️delete/🖼️removes-the-6557fc/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🖼️image/🗑️delete/🖼️removes-the-6557fc/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🖼️image/🗑️delete/🖼️removes-the-6557fc/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfDeleteImageDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
