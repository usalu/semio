//! 🧪️ `create-skin` fixture — `inserts-an-empty-skin-ahead-of-the-jointed-skin`.
//!
...
use crate::artifacts::gltf::schema::mutations::create_skin::mutation::GltfCreateSkinPayload;
