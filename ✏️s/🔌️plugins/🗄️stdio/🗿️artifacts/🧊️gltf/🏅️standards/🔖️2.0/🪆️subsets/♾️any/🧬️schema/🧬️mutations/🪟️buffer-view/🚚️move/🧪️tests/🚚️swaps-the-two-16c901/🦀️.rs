//! 🧪️ `move-buffer-view` fixture — `🚚️swaps-the-two-windows-and-renumbers-both-accessors`.
//!
...
use crate::schema::mutations::move_buffer_view::diff::GltfMoveBufferViewDiff;
use crate::schema::mutations::move_buffer_view::GltfMoveBufferViewPayload;
use crate::schema::mutations::move_buffer_view::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "move-buffer-view/swaps-the-two-windows-and-renumbers-both-accessors";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🚚️move/🚚️swaps-the-two-16c901/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🚚️move/🚚️swaps-the-two-16c901/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🚚️move/🚚️swaps-the-two-16c901/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🚚️move/🚚️swaps-the-two-16c901/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪟️buffer-view/🚚️move/🚚️swaps-the-two-16c901/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfMoveBufferViewDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
