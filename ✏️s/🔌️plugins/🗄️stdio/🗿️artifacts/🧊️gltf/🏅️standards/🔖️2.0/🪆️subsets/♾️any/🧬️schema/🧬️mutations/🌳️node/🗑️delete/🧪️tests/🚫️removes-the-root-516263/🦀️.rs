//! 🧪️ `delete-node` fixture — `🚫️removes-the-root-node-and-drops-it-from-the-scene`.
//!
...
use crate::schema::mutations::delete_node::diff::GltfDeleteNodeDiff;
use crate::schema::mutations::delete_node::GltfDeleteNodePayload;
use crate::schema::mutations::delete_node::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "delete-node/removes-the-root-node-and-drops-it-from-the-scene";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌳️node/🗑️delete/🚫️removes-the-root-516263/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌳️node/🗑️delete/🚫️removes-the-root-516263/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌳️node/🗑️delete/🚫️removes-the-root-516263/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌳️node/🗑️delete/🚫️removes-the-root-516263/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌳️node/🗑️delete/🚫️removes-the-root-516263/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfDeleteNodeDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
