//! 🧪️ Rust executor for the shared unbind-scene-root-node vector.
//!
#[cfg(test)]
mod tests {
    ...
    struct Vector {
        ...
        after: GltfSnapshot,
        stale: GltfSnapshot,
        rejected_payload: mutation::GltfUnbindSceneRootNodePayload,
    }
    ...
    #[test]
    fn canonical_vector_plans_removes_replays_rejects_stale_and_undoes_the_exact_root() {
