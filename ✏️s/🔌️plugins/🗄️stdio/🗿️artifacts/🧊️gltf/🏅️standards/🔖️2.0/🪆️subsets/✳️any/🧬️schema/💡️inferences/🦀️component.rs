...
pub const GLTF_INFERENCE_LEAF_SERVICE_DESCRIPTORS: &[GltfInferenceLeafServiceDescriptor] = &[
    ...
    GltfInferenceLeafServiceDescriptor {
        ...
        encode: clearance::minimum_distance_to_neighbors::encode_result,
    },
    GltfInferenceLeafServiceDescriptor {
    ...
    GltfInferenceLeafServiceDescriptor {
        ...
        encode: orientation::face_normal_distribution::encode_result,
    },
    GltfInferenceLeafServiceDescriptor {
        ...
        encode: orientation::orientation_consistency::encode_result,
    },
    GltfInferenceLeafServiceDescriptor {
        ...
        encode: symmetry::reflection_symmetry_score::encode_result,
    },
    GltfInferenceLeafServiceDescriptor {
...
mod tests {
    ...
    #[test]
    fn manifest_requires_exactly_one_fully_faceted_service_per_leaf() {
