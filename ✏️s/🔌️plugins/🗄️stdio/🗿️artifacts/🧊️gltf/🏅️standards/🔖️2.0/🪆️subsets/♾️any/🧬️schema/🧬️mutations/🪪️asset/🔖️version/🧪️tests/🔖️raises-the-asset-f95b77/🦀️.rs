//! 🧪️ `change-asset-version` fixture — `🔖️raises-the-asset-version-to-2-point-1`.
//!
...
use crate::schema::mutations::change_asset_version::GltfChangeAssetVersionPayload;
use crate::schema::mutations::change_asset_version::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "change-asset-version/raises-the-asset-version-to-2-point-1";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🔖️version/🔖️raises-the-asset-f95b77/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🔖️version/🔖️raises-the-asset-f95b77/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🔖️version/🔖️raises-the-asset-f95b77/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🔖️version/🔖️raises-the-asset-f95b77/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/🔖️version/🔖️raises-the-asset-f95b77/🎯️outcome/🔣️.json");
