...
use crate::schema::mutations::move_scene::diff::GltfMoveSceneDiff;
use crate::schema::mutations::move_scene::GltfMoveScenePayload;
use crate::schema::mutations::move_scene::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "move-scene/demotes-the-first-scene-and-slides-the-default-pointer";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🚚️move/⬇️demotes-the-first-f41a10/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🚚️move/⬇️demotes-the-first-f41a10/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🚚️move/⬇️demotes-the-first-f41a10/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🚚️move/⬇️demotes-the-first-f41a10/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/🚚️move/⬇️demotes-the-first-f41a10/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfMoveSceneDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
