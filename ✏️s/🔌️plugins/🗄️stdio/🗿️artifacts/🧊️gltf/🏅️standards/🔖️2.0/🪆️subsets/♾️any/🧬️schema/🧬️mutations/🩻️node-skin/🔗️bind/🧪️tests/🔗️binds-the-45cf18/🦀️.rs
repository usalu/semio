//! 🧪️ `bind-node-skin` fixture — `🔗️binds-the-jointed-skin-to-the-rig-node`.
//!
...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🩻️node-skin/🔗️bind/🔗️binds-the-45cf18/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🩻️node-skin/🔗️bind/🔗️binds-the-45cf18/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🩻️node-skin/🔗️bind/🔗️binds-the-45cf18/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🩻️node-skin/🔗️bind/🔗️binds-the-45cf18/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🩻️node-skin/🔗️bind/🔗️binds-the-45cf18/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfBindNodeSkinDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
