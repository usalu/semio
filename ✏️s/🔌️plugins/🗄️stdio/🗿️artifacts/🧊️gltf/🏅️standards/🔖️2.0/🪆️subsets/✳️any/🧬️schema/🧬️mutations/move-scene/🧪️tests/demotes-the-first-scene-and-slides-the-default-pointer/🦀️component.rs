//! 🧪️ `move-scene` fixture — `demotes-the-first-scene-and-slides-the-default-pointer`.
//!
...
use crate::artifacts::gltf::schema::mutations::move_scene::mutation::GltfMoveScenePayload;
