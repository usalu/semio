...
//! {🌱️🧥️create-skin,🗑️🧥️delete-skin,🚚️🧥️move-skin,🔀️🧥️reorder-skins}/🦀️.rs`) stays physically
...
/// each kind's own committed fixture (`../../🧫️fixtures/<kind>-applied/before.gltf`) — computed
