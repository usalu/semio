...
#[path = "modularity-ratio/🦀️.rs"]
pub mod modularity_ratio;
#[path = "reflection-symmetries/🦀️.rs"]
pub mod reflection_symmetries;
#[path = "reflection-symmetry-score/🦀️.rs"]
pub mod reflection_symmetry_score;
#[path = "repetition-ratio/🦀️.rs"]
pub mod repetition_ratio;
#[path = "rotational-symmetries/🦀️.rs"]
pub mod rotational_symmetries;
#[path = "rotational-symmetry-score/🦀️.rs"]
