...
use crate::schema::mutations::create_texture::diff::GltfCreateTextureDiff;
use crate::schema::mutations::create_texture::GltfCreateTexturePayload;
use crate::schema::mutations::create_texture::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "create-texture/inserts-an-empty-texture-ahead-of-the-albedo-texture";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎨️texture/🌱️create/🎨️inserts-an-empty-736467/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎨️texture/🌱️create/🎨️inserts-an-empty-736467/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎨️texture/🌱️create/🎨️inserts-an-empty-736467/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎨️texture/🌱️create/🎨️inserts-an-empty-736467/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎨️texture/🌱️create/🎨️inserts-an-empty-736467/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfCreateTextureDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
