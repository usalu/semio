//! 🧪️ `change-asset-descriptive-metadata` fixture — `🏗️restamps-generator-copyright-and-min-version-together`.
//!
...
use crate::schema::mutations::change_asset_descriptive_metadata::GltfChangeAssetDescriptiveMetadataPayload;
use crate::schema::mutations::change_asset_descriptive_metadata::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "change-asset-descriptive-metadata/restamps-generator-copyright-and-min-version-together";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/📝️change-description/🔬️t068/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/📝️change-description/🔬️t068/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/📝️change-description/🔬️t068/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/📝️change-description/🔬️t068/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🪪️asset/📝️change-description/🔬️t068/🎯️outcome/🔣️.json");
