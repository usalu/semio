...
export const gltfConcavityIndexInference = {
  id: 's.stdio.gltf.inference.concavity-index.v1',
  algorithmVersion: 1,
  cacheKey: 's.stdio.gltf.inference.concavity-index.v1:geometry-v2',
...
export type GltfConcavityIndexInference = typeof gltfConcavityIndexInference;
