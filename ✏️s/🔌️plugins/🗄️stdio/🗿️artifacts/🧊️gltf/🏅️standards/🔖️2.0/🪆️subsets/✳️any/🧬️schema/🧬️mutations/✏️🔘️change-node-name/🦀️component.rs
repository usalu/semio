//! 🧬️ Direct change-node-name mutation owner: payload, validation, typed diff, inverse, and outcomes.
...
impl protocol::MutationKind<GltfSnapshot, super::GltfMutation> for ChangeNodeNameMutation {
    ...
    fn inverse(&self, base: &GltfSnapshot) -> Vec<super::GltfMutation> {
        ...
        vec![super::GltfMutation::ChangeNodeName(Self::Restore(inverse))]
    }
    ...
    fn target(&self) -> Vec<String> {
        vec!["change-node-name".to_string()]
    }
}
...
mod direct_leaf_tests {
    ...
    fn semantic_identity_matches_the_language_neutral_descriptor() {
        assert_eq!(<ChangeNodeNameMutation as protocol::MutationKind<GltfSnapshot, super::super::GltfMutation>>::SEMANTICS.kind, "change-node-name");
    }
}
//#endregion 🧪️Tests
