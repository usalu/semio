//! 🧪️ `create-mesh` fixture — `inserts-an-empty-mesh-ahead-of-the-hull-mesh`.
//!
...
use crate::artifacts::gltf::schema::mutations::create_mesh::mutation::GltfCreateMeshPayload;
