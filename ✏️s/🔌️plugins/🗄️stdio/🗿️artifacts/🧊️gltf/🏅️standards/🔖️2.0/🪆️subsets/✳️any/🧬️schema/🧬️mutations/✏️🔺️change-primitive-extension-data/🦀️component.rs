//! 🧬️ Direct change-primitive-extension-data mutation owner: payload, validation, typed diff, inverse, and outcomes.
...
pub enum ChangePrimitiveExtensionDataMutation {
    Apply(GltfChangePrimitiveExtensionDataPayload),
...
impl protocol::MutationKind<GltfSnapshot, super::GltfMutation> for ChangePrimitiveExtensionDataMutation {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "change", entity: "primitive-extension-data", kind: "change-primitive-extension-data", record: "ChangedPrimitiveExtensionData" };
    ...
    fn inverse(&self, base: &GltfSnapshot) -> Vec<super::GltfMutation> {
        ...
        vec![super::GltfMutation::ChangePrimitiveExtensionData(Self::Restore(inverse))]
    }

    fn label(&self) -> String {
        "Change Primitive Extension Data".to_string()
    }

    fn target(&self) -> Vec<String> {
        vec!["change-primitive-extension-data".to_string()]
    }
}
...
mod direct_leaf_tests {
    ...
    fn semantic_identity_matches_the_language_neutral_descriptor() {
        assert_eq!(<ChangePrimitiveExtensionDataMutation as protocol::MutationKind<GltfSnapshot, super::super::GltfMutation>>::SEMANTICS.kind, "change-primitive-extension-data");
    }
}
//#endregion 🧪️Tests
