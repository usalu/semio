...
use crate::schema::mutations::bind_scene_root_node::diff::GltfBindSceneRootNodeDiff;
use crate::schema::mutations::bind_scene_root_node::GltfBindSceneRootNodePayload;
...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌲️scene-root/🔗️bind/📥️promotes-the-b86f40/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌲️scene-root/🔗️bind/📥️promotes-the-b86f40/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌲️scene-root/🔗️bind/📥️promotes-the-b86f40/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌲️scene-root/🔗️bind/📥️promotes-the-b86f40/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🌲️scene-root/🔗️bind/📥️promotes-the-b86f40/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfBindSceneRootNodeDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
