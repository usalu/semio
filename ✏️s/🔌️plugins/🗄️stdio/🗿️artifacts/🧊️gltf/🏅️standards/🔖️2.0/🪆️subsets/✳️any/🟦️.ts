...
/** 🫙️ Deliberately empty. `🦀️.rs` builds the `subsets::any` barrel inline
 * (`#[path = "."] pub mod any { … }`) and only `#[path]`s into the real leaves —
 * `🚪️io/🟦️.ts` and `🧬️schema/🟦️.ts` — never into this level. No stdio
 ...
 * re-exported by `📦️packages/🟦️typescript/🟦️.ts`. */
export {};
