...
use crate::schema::mutations::change_scene_extra_data::diff::GltfChangeSceneExtraDataDiff;
use crate::schema::mutations::change_scene_extra_data::GltfChangeSceneExtraDataPayload;
use crate::schema::mutations::change_scene_extra_data::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "change-scene-extra-data/attaches-a-units-extras-object-to-the-main-scene";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/📝️change-extras/📏️attaches-a-units-e2653c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/📝️change-extras/📏️attaches-a-units-e2653c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/📝️change-extras/📏️attaches-a-units-e2653c/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/📝️change-extras/📏️attaches-a-units-e2653c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎬️scene/📝️change-extras/📏️attaches-a-units-e2653c/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfChangeSceneExtraDataDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
