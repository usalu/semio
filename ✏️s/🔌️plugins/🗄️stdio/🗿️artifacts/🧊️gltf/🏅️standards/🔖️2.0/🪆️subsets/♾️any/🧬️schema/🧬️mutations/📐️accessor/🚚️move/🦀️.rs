...
impl protocol::MutationKind<GltfSnapshot, super::GltfMutation> for MoveAccessorMutation {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native("Move Accessor", "Accessor verschieben")
    }
