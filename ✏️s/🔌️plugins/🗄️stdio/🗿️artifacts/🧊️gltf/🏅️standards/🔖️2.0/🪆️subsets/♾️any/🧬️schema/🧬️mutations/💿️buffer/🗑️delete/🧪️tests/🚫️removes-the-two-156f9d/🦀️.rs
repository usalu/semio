//! 🧪️ `delete-buffer` fixture — `🚫️removes-the-two-byte-buffer-and-retargets-the-buffer-view`.
//!
...
async fn committed_diff_is_canonical() {
    let decoded: GltfDeleteBufferDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
