...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🪞️change-sides/🪞️makes-the-6261b2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🪞️change-sides/🪞️makes-the-6261b2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🪞️change-sides/🪞️makes-the-6261b2/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🪞️change-sides/🪞️makes-the-6261b2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💎️material/🪞️change-sides/🪞️makes-the-6261b2/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfChangeMaterialDoubleSidedDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
