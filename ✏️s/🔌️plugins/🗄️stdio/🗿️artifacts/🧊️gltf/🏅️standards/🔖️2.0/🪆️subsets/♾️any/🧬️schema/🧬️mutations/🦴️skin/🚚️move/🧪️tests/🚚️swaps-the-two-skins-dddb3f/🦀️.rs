...
use crate::schema::mutations::move_skin::diff::GltfMoveSkinDiff;
use crate::schema::mutations::move_skin::GltfMoveSkinPayload;
use crate::schema::mutations::move_skin::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "move-skin/swaps-the-two-skins-and-rewrites-both-node-bindings";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🚚️move/🚚️swaps-the-two-skins-dddb3f/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🚚️move/🚚️swaps-the-two-skins-dddb3f/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🚚️move/🚚️swaps-the-two-skins-dddb3f/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🚚️move/🚚️swaps-the-two-skins-dddb3f/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🦴️skin/🚚️move/🚚️swaps-the-two-skins-dddb3f/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfMoveSkinDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
