//! 🧪️ `delete-texture` fixture — `🔗️removes-the-albedo-texture-and-renumbers-the-base-colour-binding`.
//!
...
use crate::schema::mutations::delete_texture::diff::GltfDeleteTextureDiff;
use crate::schema::mutations::delete_texture::GltfDeleteTexturePayload;
use crate::schema::mutations::delete_texture::{diff, inverse, mutation};
...
async fn committed_diff_is_canonical() {
    let decoded: GltfDeleteTextureDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
