...
export const gltfInterferenceVolumeInference = {
  id: 's.stdio.gltf.inference.interference-volume.v1',
  algorithmVersion: 1,
  cacheKey: 's.stdio.gltf.inference.interference-volume.v1:geometry-v2',
...
export type GltfInterferenceVolumeInference = typeof gltfInterferenceVolumeInference;
