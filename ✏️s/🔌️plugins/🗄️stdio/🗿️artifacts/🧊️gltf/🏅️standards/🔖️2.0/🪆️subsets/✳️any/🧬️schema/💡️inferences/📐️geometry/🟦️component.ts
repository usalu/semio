...
import type { GltfMeasure, GltfScalarMeasure, GltfStatisticsMeasure, GltfAnalysisPolicy, GltfDiagnostic, GltfEntityAddress, GltfValidity, GltfQuality, GltfProvenance } from '../🧾️measure/🟦️component.ts';
