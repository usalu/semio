...
use crate::schema::mutations::change_primitive_topology_mode::GltfChangePrimitiveTopologyModePayload;
use crate::schema::mutations::change_primitive_topology_mode::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "change-primitive-topology-mode/switches-the-primitive-from-implicit-triangles-to-triangle-strip";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📐️change-topology/📐️triangle-81bc44/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📐️change-topology/📐️triangle-81bc44/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📐️change-topology/📐️triangle-81bc44/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📐️change-topology/📐️triangle-81bc44/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🔺️primitive/📐️change-topology/📐️triangle-81bc44/🎯️outcome/🔣️.json");
