...
impl protocol::MutationKind<GltfSnapshot, super::GltfMutation> for MoveSceneRootNodeMutation {
    ...
    fn label(&self) -> String {
        "Move Scene Root Node".to_string()
    }
