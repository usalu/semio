//! 🧪️ `change-node-extension-data` fixture — `🔌️attaches-a-punctual-light-extension-to-the-root-node`.
//!
...
async fn committed_diff_is_canonical() {
    let decoded: GltfChangeNodeExtensionDataDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
