//! 🧪️ `move-buffer` fixture — `🚚️swaps-the-two-buffers-and-their-byte-lanes`.
//!
...
use crate::schema::mutations::move_buffer::diff::GltfMoveBufferDiff;
use crate::schema::mutations::move_buffer::GltfMoveBufferPayload;
use crate::schema::mutations::move_buffer::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "move-buffer/swaps-the-two-buffers-and-their-byte-lanes";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💿️buffer/🚚️move/🚚️swaps-the-two-a9f8e2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💿️buffer/🚚️move/🚚️swaps-the-two-a9f8e2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💿️buffer/🚚️move/🚚️swaps-the-two-a9f8e2/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💿️buffer/🚚️move/🚚️swaps-the-two-a9f8e2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/💿️buffer/🚚️move/🚚️swaps-the-two-a9f8e2/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfMoveBufferDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
