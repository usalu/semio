...
export * from './📦️size/📏️overall-size/🟦️.ts';
export * from './📦️size/🌳️axis-aligned-bounds/🟦️.ts';
export * from './📦️size/🌹️oriented-bounds/🟦️.ts';
export * from './📦️size/📐️bounding-box-dimensions/🟦️.ts';
export * from './📦️size/🐯️characteristic-length/🟦️.ts';
export * from './📦️size/🖨️footprint-area/🟦️.ts';
export * from './📦️size/🎯️projected-area/🟦️.ts';
export * from './🧱️area-volume/🖱️surface-area/🟦️.ts';
export * from './🧱️area-volume/🐨️total-area/🟦️.ts';
export * from './🧱️area-volume/🍐️exposed-area/🟦️.ts';
export * from './🧱️area-volume/🦅️contact-area/🟦️.ts';
export * from './🧱️area-volume/🟫️volume/🟦️.ts';
export * from './🧱️area-volume/🐯️enclosed-volume/🟦️.ts';
export * from './🧱️area-volume/🧊️material-volume/🟦️.ts';
export * from './🧱️area-volume/⚪️void-volume/🟦️.ts';
export * from './⚪️compactness/⚓️compactness/🟦️.ts';
export * from './⚪️compactness/🖱️surface-to-volume-ratio/🟦️.ts';
export * from './⚪️compactness/🪁️sphericity/🟦️.ts';
export * from './⚪️compactness/🚪️compactness-index/🟦️.ts';
export * from './⚪️compactness/🟤️hull-fill-ratio/🟦️.ts';
export * from './📏️proportion/🧪️aspect-ratios/🟦️.ts';
export * from './📏️proportion/🌾️slenderness/🟦️.ts';
export * from './📏️proportion/🔮️flatness/🟦️.ts';
export * from './📏️proportion/🟫️elongation/🟦️.ts';
export * from './⚖️mass-distribution/🐞️centroid/🟦️.ts';
export * from './⚖️mass-distribution/🟥️principal-frame/🟦️.ts';
export * from './⚖️mass-distribution/🧭️principal-axes/🟦️.ts';
export * from './⚖️mass-distribution/🍐️moments-of-inertia/🟦️.ts';
export * from './⚖️mass-distribution/🐧️inertia-tensor/🟦️.ts';
export * from './🌀️curvature/🐝️mean-curvature/🟦️.ts';
export * from './🌀️curvature/🟪️gaussian-curvature/🟦️.ts';
export * from './🌀️curvature/🟥️curvature-histogram/🟦️.ts';
export * from './🌀️curvature/🐨️sharp-feature-proportion/🟦️.ts';
export * from './↕️thickness/🦋️mean-thickness/🟦️.ts';
export * from './↕️thickness/⚪️minimum-thickness/🟦️.ts';
export * from './↕️thickness/🟤️thickness-variability/🟦️.ts';
export * from './↕️thickness/🛰️thickness-distribution/🟦️.ts';
export * from './🕳️concavity/🟨️convex-hull-gap/🟦️.ts';
export * from './🕳️concavity/⚪️reentrant-area/🟦️.ts';
export * from './🕳️concavity/🪻️reentrant-volume/🟦️.ts';
export * from './🕳️concavity/🚪️concavity-index/🟦️.ts';
export * from './↔️clearance/🌾️minimum-distance-to-neighbors/🟦️.ts';
export * from './↔️clearance/🦁️clearance-distribution/🟦️.ts';
export * from './↔️clearance/🟡️interference-volume/🟦️.ts';
export * from './↔️clearance/🌹️overlap-volume/🟦️.ts';
export * from './🤝️adjacency/🔢️number-of-contacts/🟦️.ts';
export * from './🤝️adjacency/🌳️contact-graph-degree/🟦️.ts';
export * from './🤝️adjacency/🧩️connected-components/🟦️.ts';
export * from './🧭️orientation/🚪️main-axis-direction/🟦️.ts';
export * from './🧭️orientation/📊️face-normal-distribution/🟦️.ts';
export * from './🧭️orientation/🌻️orientation-consistency/🟦️.ts';
export * from './🪞️symmetry/🌴️reflection-symmetry-score/🟦️.ts';
export * from './🪞️symmetry/🌻️rotational-symmetry-score/🟦️.ts';
export * from './🪞️symmetry/🐞️reflection-symmetries/🟦️.ts';
export * from './🪞️symmetry/🐯️rotational-symmetries/🟦️.ts';
...
export * from './🕸️topology/🐼️holes/🟦️.ts';
export * from './🕸️topology/🐙️handles/🟦️.ts';
export * from './🕸️topology/🎈️boundary-loops/🟦️.ts';
export * from './🕸️topology/🪄️euler-characteristic/🟦️.ts';
export * from './🕸️topology/🐨️genus/🟦️.ts';
