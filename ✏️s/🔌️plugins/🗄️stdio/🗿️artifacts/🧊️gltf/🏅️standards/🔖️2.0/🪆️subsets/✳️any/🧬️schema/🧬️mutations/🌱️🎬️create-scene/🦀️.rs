...
use crate::artifacts::gltf::schema::modules::mutation_support::create_scene::{insert_empty_scene, insertion_position, GltfCreateSceneRejection};
...
impl protocol::MutationKind<GltfSnapshot, super::GltfMutation> for CreateSceneMutation {
    ...
    fn inverse(&self, base: &GltfSnapshot) -> Vec<super::GltfMutation> {
        ...
        vec![super::GltfMutation::CreateScene(Self::Restore(inverse))]
    }
