...
import { applyGltfDeletePrimitive, type GltfDeletePrimitivePayload } from '../../delete-primitive/🟦️.ts';
import { deriveGltfDeletePrimitiveDiff } from '../../delete-primitive/🔺️diff/🟦️.ts';
import { deriveGltfDeletePrimitiveInverse } from '../../delete-primitive/↩️inverse/🟦️.ts';
