//! 🧪️ `move-used-extension` fixture — `demotes-the-unlit-declaration-behind-the-transform-declaration`.
//!
...
use crate::artifacts::gltf::schema::mutations::move_used_extension::mutation::GltfMoveUsedExtensionPayload;
