...
impl protocol::MutationKind<GltfSnapshot, super::GltfMutation> for UnbindPrimitiveMaterialMutation {
    ...
    fn label(&self) -> String {
        "Unbind Primitive Material".to_string()
    }
