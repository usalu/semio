//! 🧪️ `unbind-default-scene` fixture — `🎞️clears-the-default-scene-pointer`.
//!
...
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/✂️unbind/🎞️clears-the-b236b0/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/✂️unbind/🎞️clears-the-b236b0/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/✂️unbind/🎞️clears-the-b236b0/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/✂️unbind/🎞️clears-the-b236b0/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🏠️default-scene/✂️unbind/🎞️clears-the-b236b0/🎯️outcome/🔣️.json");
