...
use crate::schema::mutations::create_animation::diff::GltfCreateAnimationDiff;
use crate::schema::mutations::create_animation::GltfCreateAnimationPayload;
use crate::schema::mutations::create_animation::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "create-animation/inserts-an-empty-clip-ahead-of-the-spin-clip";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎞️animation/🌱️create/🎞️inserts-an-empty-99ef88/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎞️animation/🌱️create/🎞️inserts-an-empty-99ef88/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎞️animation/🌱️create/🎞️inserts-an-empty-99ef88/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎞️animation/🌱️create/🎞️inserts-an-empty-99ef88/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/🎞️animation/🌱️create/🎞️inserts-an-empty-99ef88/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: GltfCreateAnimationDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::json::to_json_string(&decoded)).expect("diff re-encodes");
    let original: serde_json::Value = serde_json::from_str(DIFF).expect("committed diff reparses");
    assert_eq!(reencoded, original, "{CASE}: committed diff JSON is not canonical");
    assert!(matches!(decoded.operation, crate::schema::mutations::create_animation::diff::GltfCreateAnimationOperation::Insert { position: 0, .. }), "{CASE}: the committed operation must be an insert at position 0");
}
