//! 🧪️ `add-used-extension` fixture — `🔌️declares-the-unlit-extension-ahead-of-the-transform-extension`.
//!
...
use crate::schema::mutations::add_used_extension::GltfDeclareUsedExtensionPayload;
use crate::schema::mutations::add_used_extension::{diff, inverse, mutation};
use crate::GltfSnapshot;

const CASE: &str = "add-used-extension/declares-the-unlit-extension-ahead-of-the-transform-extension";
const BEFORE: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/➕️add/🔬️t056/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/➕️add/🔬️t056/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/➕️add/🔬️t056/🧬️operation/🔣️.json");
const DIFF: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/➕️add/🔬️t056/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../../🧫️fixtures/🧬️mutations/📣️used-extension/➕️add/🔬️t056/🎯️outcome/🔣️.json");
