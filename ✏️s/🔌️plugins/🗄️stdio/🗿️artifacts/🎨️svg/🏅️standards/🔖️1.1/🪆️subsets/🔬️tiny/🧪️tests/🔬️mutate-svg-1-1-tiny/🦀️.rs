...
mod subject {
    ...
    use semio_s_artifact_stdio_svg::standards::v1_1::subsets::tiny::schema::mutations::{apply_svg_tiny_mutation, insert_tiny_element, inverse_svg_tiny_mutation, remove_element, set_snapshot, set_text, set_tiny_attribute, set_transform, set_view_box, stamp_base_profile, strip_non_tiny, SvgTinyMutation};
