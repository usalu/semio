/** ✏️ `svg` editor (any) — subset-level typed twin. Mirrors the editor
...
export const SVG_ANY_EDITOR_DIALECT = { artifactKind: "s.stdio.svg", standard: "1.1", subset: "*" } as const;

export const SVG_ANY_EDIT_MODE_ID = "edit" as const;
