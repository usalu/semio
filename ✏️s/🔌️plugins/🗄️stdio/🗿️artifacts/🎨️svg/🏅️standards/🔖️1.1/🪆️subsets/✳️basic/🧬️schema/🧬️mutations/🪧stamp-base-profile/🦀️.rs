...
impl protocol::MutationKind<SvgSnapshot, SvgBasicMutation> for StampBaseProfile {
    ...
    fn diff(&self, base: &SvgSnapshot) -> protocol::MutationOutcome<<SvgBasicMutation as protocol::Mutation<SvgSnapshot>>::Diff> {
        agg_diff(&SvgBasicMutation::StampBaseProfile(self.clone()), base)
    }
    fn inverse(&self, base: &SvgSnapshot) -> Vec<SvgBasicMutation> {
        agg_inverse(&SvgBasicMutation::StampBaseProfile(self.clone()), base)
    }
