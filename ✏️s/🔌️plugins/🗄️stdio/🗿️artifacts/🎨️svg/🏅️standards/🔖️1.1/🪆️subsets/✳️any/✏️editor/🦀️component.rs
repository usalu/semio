...
use crate::artifacts::svg::{SVG_ANY_DIALECT, STDIO_SVG_DOCUMENT_SCHEMA};
...
impl ArtifactEditor for SvgAnyEditor {
    ...
    async fn handle(
        ...
        match command {
            SvgAnyEditCommand::SetPixelRegion { source } => match <SvgSnapshot as store::ArtifactDsl>::parse_dsl(source).await {
...
//#region 🔖️Manifest
pub async fn create_svg_any_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(SVG_ANY_DIALECT)
