...
mod oracles {
    ...
    /// (`../../🧬️schema/📸️snapshot/🦀️component.rs`), never importing it. Attributes are an ordered
    ...
    /// `NodePath` uses (`node_at`/`node_at_mut`, `../../🧬️schema/📸️snapshot/🦀️component.rs`),
    ...
    /// `parse_view_box`/`view_box_to_string` (`../../🧬️schema/📸️snapshot/🦀️component.rs`).
