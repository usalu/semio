...
mod tests {
    ...
    fn svg_snapshot(attrs: Vec<XmlAttr>) -> SvgSnapshot {
        SvgSnapshot { schema: crate::artifacts::svg::STDIO_SVG_DOCUMENT_SCHEMA.into(), doc: XmlDocument { root: Some(XmlNode::Element { name: "svg".into(), attrs, children: Vec::new() }), doctype: None, declaration: None } }
    }
    ...
    fn empty_document_yields_zero_dimensions() {
        assert_eq!(compute_svg_dimensions(&SvgSnapshot { schema: crate::artifacts::svg::STDIO_SVG_DOCUMENT_SCHEMA.into(), doc: XmlDocument { root: None, doctype: None, declaration: None } }), SvgDimensions::default());
    }
}
//#endregion 🧪️Tests
