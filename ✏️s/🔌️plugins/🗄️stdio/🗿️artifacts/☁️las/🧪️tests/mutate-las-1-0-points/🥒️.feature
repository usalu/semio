...
Feature: Apply every typed LAS 1.0 mutation to a real-world point cloud
  See ../mutate-las-1-0/🥒️.feature for the full fixture/provenance narrative -- this subset's own scenarios exercise only the mutation kinds `../../🏅️standards` places under this subset.
