...
/// other by design).
async fn entity_count(document: &LasSnapshot) -> usize {
...
async fn world_instances_json(document: &LasSnapshot) -> String {
...
pub async fn render(document: &LasSnapshot) -> UiNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(LAS_ANY_EDIT_DEFAULT_CAMERA_POSITION, LAS_ANY_EDIT_DEFAULT_CAMERA_TARGET, LAS_ANY_EDIT_DEFAULT_CAMERA_FOV).await,
        meshes_json,
