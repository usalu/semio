//! 🧪️ `set-snapshot` fixture — `📈️lifts-the-second-point-and-stretches-the-z-bound`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️lifts-the-second-point-and-stretches-the-z-bound/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️lifts-the-second-point-and-stretches-the-z-bound/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️lifts-the-second-point-and-stretches-the-z-bound/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️lifts-the-second-point-and-stretches-the-z-bound/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/📈️lifts-the-second-point-and-stretches-the-z-bound/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: LasSnapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-snapshot/lifts-the-second-point-and-stretches-the-z-bound: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    let decoded: LasDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
