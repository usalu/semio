...
/// 👁️ Pure `LasSnapshot -> BuiltNode` read: default camera (a viewer has no persisted
...
pub fn render(document: &LasSnapshot) -> BuiltNode {
    ...
    let view = MeshView {
        camera_json: world3d_camera_json(LAS_ANY_VIEW_DEFAULT_CAMERA_POSITION, LAS_ANY_VIEW_DEFAULT_CAMERA_TARGET, LAS_ANY_VIEW_DEFAULT_CAMERA_FOV),
        meshes_json,
