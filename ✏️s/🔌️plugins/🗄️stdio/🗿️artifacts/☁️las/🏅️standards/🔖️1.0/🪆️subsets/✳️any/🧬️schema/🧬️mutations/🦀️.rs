...
#[path = "🛠set-software-info/🦀️.rs"]
pub mod set_software_info;
#[path = "🕰set-creation-date/🦀️.rs"]
...
mod tests {
    ...
    fn absorb_law() {
        ...
        assert_absorb_law(&base, LasMutation::SetSystemIdentifier(set_system_identifier::SetSystemIdentifier { system_identifier: "first".into() }), LasMutation::SetSystemIdentifier(set_system_identifier::SetSystemIdentifier { system_identifier: "second".into() }));
    }
