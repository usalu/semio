...
pub fn contribution() -> semio_s_artifact_stdio_contract::ArtifactContribution {
    semio_s_artifact_stdio_contract::ArtifactContribution { identity: "obj", schema: ARTIFACT_DEFINITION_SCHEMA, definition, assembly, formats, native_codecs }
}
...
pub mod editor {
    ...
    pub mod obj {
        ...
        #[path = "."]
        pub mod presence {
            #[path = "🏅️standards/🔖️3.0/🪆️subsets/📐️geometry/✏️editor/👥️presence/🧬️schema/🦀️.rs"]
            pub mod schema;
        }
        #[path = "."]
        pub mod config {
            #[path = "🏅️standards/🔖️3.0/🪆️subsets/📐️geometry/✏️editor/🎚️config/🧬️schema/🦀️.rs"]
            pub mod schema;
        }
        #[path = "."]
        pub mod modes {
...
pub mod viewer {
    ...
    pub mod obj {
        ...
        #[path = "."]
        pub mod presence {
            #[path = "🏅️standards/🔖️3.0/🪆️subsets/📐️geometry/👁️viewer/👥️presence/🧬️schema/🦀️.rs"]
            pub mod schema;
        }
        #[path = "."]
        pub mod config {
            #[path = "🏅️standards/🔖️3.0/🪆️subsets/📐️geometry/👁️viewer/🎚️config/🧬️schema/🦀️.rs"]
            pub mod schema;
        }
        #[path = "."]
        pub mod modes {
