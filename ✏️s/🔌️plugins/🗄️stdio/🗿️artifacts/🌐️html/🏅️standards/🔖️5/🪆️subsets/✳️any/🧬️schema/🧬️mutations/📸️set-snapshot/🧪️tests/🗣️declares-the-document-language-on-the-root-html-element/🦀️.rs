...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🗣️declares-the-document-language-on-the-root-html-element/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🗣️declares-the-document-language-on-the-root-html-element/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🗣️declares-the-document-language-on-the-root-html-element/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🗣️declares-the-document-language-on-the-root-html-element/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📸️set-snapshot/🗣️declares-the-document-language-on-the-root-html-element/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: HtmlSnapshot = dsl::json::from_json_str(text).expect("snapshot decodes");
...
async fn committed_diff_is_canonical() {
    let decoded: HtmlDiff = dsl::json::from_json_str(DIFF).expect("committed diff decodes");
