...
pub fn create_html_editor() -> semio_framework_plugin::AppDefinition {
    Editor::builder(HTML_DIALECT).document(["semio", "html"]).icon_id("file-text").mode_def(edit::definition()).default_mode_id(edit::MODE_ID).window_kind_def(main::definition()).default_layout(edit::layout()).build_definition()
}
//#endregion 🔖️Manifest
