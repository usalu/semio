//! 🧪️ `set-snapshot` fixture — `🧩️declares-the-document-language-on-the-root-html-element`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-snapshot/declares-the-document-language-on-the-root-html-element: produced diff differs from the committed 🔺️diff/🔣️.json");
