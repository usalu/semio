...
//!    tests instead (`schema/🧬️mutations/🦀️component.rs::set_attribute_tristate_apply_and_inverse_round_trip`).
...
//#region 🔖️Kinds
/// 📇️ Mirrors `../../../../../🧬️schema/🧬️mutations/🦀️component.rs::KINDS` -- duplicated, not
...
mod oracles {
    ...
    /// (`schema/🧬️mutations/🦀️component.rs`), computed here independently against this oracle's own
    /// tree instead.
