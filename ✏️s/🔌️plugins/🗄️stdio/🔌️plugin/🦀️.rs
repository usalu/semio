...
fn register_apps(mut builder: PluginBuilder<Ready, StdioApps>) -> PluginBuilder<Ready, StdioApps> {
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_png::editor::png::PngEditor>(semio_s_artifact_stdio_png::editor::png::create_png_editor(), vec![semio_s_artifact_stdio_png::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_jpg::editor::jpg_any::JpgAnyEditor>(semio_s_artifact_stdio_jpg::editor::jpg_any::create_jpg_any_editor(), vec![semio_s_artifact_stdio_jpg::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_jpg::editor::jpg_baseline::JpgBaselineEditor>(semio_s_artifact_stdio_jpg::editor::jpg_baseline::create_jpg_baseline_editor(), vec![semio_s_artifact_stdio_jpg::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_bmp::editor::bmp::BmpEditor>(semio_s_artifact_stdio_bmp::editor::bmp::create_bmp_editor(), vec![semio_s_artifact_stdio_bmp::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_tiff::editor::tiff_any::TiffAnyEditor>(semio_s_artifact_stdio_tiff::editor::tiff_any::create_tiff_any_editor(), vec![semio_s_artifact_stdio_tiff::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_tiff::editor::tiff_baseline::TiffBaselineEditor>(semio_s_artifact_stdio_tiff::editor::tiff_baseline::create_tiff_baseline_editor(), vec![semio_s_artifact_stdio_tiff::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_gif::editor::gif_87a::Gif87aEditor>(semio_s_artifact_stdio_gif::editor::gif_87a::create_gif_87a_editor(), vec![semio_s_artifact_stdio_gif::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_gif::editor::gif_89a::Gif89aEditor>(semio_s_artifact_stdio_gif::editor::gif_89a::create_gif_89a_editor(), vec![semio_s_artifact_stdio_gif::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_svg::editor::svg_any::SvgAnyEditor>(semio_s_artifact_stdio_svg::editor::svg_any::create_svg_any_editor(), vec![semio_s_artifact_stdio_svg::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_svg::editor::svg_basic::SvgBasicEditor>(semio_s_artifact_stdio_svg::editor::svg_basic::create_svg_basic_editor(), vec![semio_s_artifact_stdio_svg::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_svg::editor::svg_tiny::SvgTinyEditor>(semio_s_artifact_stdio_svg::editor::svg_tiny::create_svg_tiny_editor(), vec![semio_s_artifact_stdio_svg::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_mp4::editor::mp4::Mp4Editor>(semio_s_artifact_stdio_mp4::editor::mp4::create_mp4_editor(), vec![semio_s_artifact_stdio_mp4::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_mp3::editor::mp3::Mp3Editor>(semio_s_artifact_stdio_mp3::editor::mp3::create_mp3_editor(), vec![semio_s_artifact_stdio_mp3::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_wav::editor::wav::WavEditor>(semio_s_artifact_stdio_wav::editor::wav::create_wav_editor(), vec![semio_s_artifact_stdio_wav::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_avi::editor::avi::AviEditor>(semio_s_artifact_stdio_avi::editor::avi::create_avi_editor(), vec![semio_s_artifact_stdio_avi::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_drawing::SemioDrawingEditor>(semio_s_artifact_stdio_semio::editor::semio_drawing::create_semio_drawing_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_graph::SemioGraphEditor>(semio_s_artifact_stdio_semio::editor::semio_graph::create_semio_graph_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_kit::SemioKitEditor>(semio_s_artifact_stdio_semio::editor::semio_kit::create_semio_kit_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_object::SemioObjectEditor>(semio_s_artifact_stdio_semio::editor::semio_object::create_semio_object_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_table::SemioTableEditor>(semio_s_artifact_stdio_semio::editor::semio_table::create_semio_table_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_text::SemioTextEditor>(semio_s_artifact_stdio_semio::editor::semio_text::create_semio_text_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_animation::SemioAnimationEditor>(semio_s_artifact_stdio_semio::editor::semio_animation::create_semio_animation_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_base::SemioAnyEditor>(semio_s_artifact_stdio_semio::editor::semio_base::create_semio_base_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_audio::SemioAudioEditor>(semio_s_artifact_stdio_semio::editor::semio_audio::create_semio_audio_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_cad::SemioCadEditor>(semio_s_artifact_stdio_semio::editor::semio_cad::create_semio_cad_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_document::SemioDocumentEditor>(semio_s_artifact_stdio_semio::editor::semio_document::create_semio_document_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_flow::SemioFlowEditor>(semio_s_artifact_stdio_semio::editor::semio_flow::create_semio_flow_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_image::SemioImageEditor>(semio_s_artifact_stdio_semio::editor::semio_image::create_semio_image_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_model::SemioModelEditor>(semio_s_artifact_stdio_semio::editor::semio_model::create_semio_model_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_presentation::SemioPresentationEditor>(semio_s_artifact_stdio_semio::editor::semio_presentation::create_semio_presentation_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_value::SemioValueEditor>(semio_s_artifact_stdio_semio::editor::semio_value::create_semio_value_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_semio::editor::semio_video::SemioVideoEditor>(semio_s_artifact_stdio_semio::editor::semio_video::create_semio_video_editor(), vec![semio_s_artifact_stdio_semio::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_step::editor::step_any::StepAnyEditor>(semio_s_artifact_stdio_step::editor::step_any::create_step_any_editor(), vec![semio_s_artifact_stdio_step::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_step::editor::step_cc1::StepCc1Editor>(semio_s_artifact_stdio_step::editor::step_cc1::create_step_cc1_editor(), vec![semio_s_artifact_stdio_step::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_step::editor::step_cc2::StepCc2Editor>(semio_s_artifact_stdio_step::editor::step_cc2::create_step_cc2_editor(), vec![semio_s_artifact_stdio_step::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_step::editor::step_cc3::StepCc3Editor>(semio_s_artifact_stdio_step::editor::step_cc3::create_step_cc3_editor(), vec![semio_s_artifact_stdio_step::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_step::editor::step_cc4::StepCc4Editor>(semio_s_artifact_stdio_step::editor::step_cc4::create_step_cc4_editor(), vec![semio_s_artifact_stdio_step::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_step::editor::step_cc5::StepCc5Editor>(semio_s_artifact_stdio_step::editor::step_cc5::create_step_cc5_editor(), vec![semio_s_artifact_stdio_step::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_step::editor::step_cc6::StepCc6Editor>(semio_s_artifact_stdio_step::editor::step_cc6::create_step_cc6_editor(), vec![semio_s_artifact_stdio_step::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_ifc::editor::ifc2x3_any::Ifc2x3AnyEditor>(semio_s_artifact_stdio_ifc::editor::ifc2x3_any::create_ifc2x3_any_editor(), vec![semio_s_artifact_stdio_ifc::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_ifc::editor::ifc2x3_cobie::Ifc2x3CobieEditor>(semio_s_artifact_stdio_ifc::editor::ifc2x3_cobie::create_ifc2x3_cobie_editor(), vec![semio_s_artifact_stdio_ifc::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_ifc::editor::ifc2x3_cv20::Ifc2x3Cv20Editor>(semio_s_artifact_stdio_ifc::editor::ifc2x3_cv20::create_ifc2x3_cv20_editor(), vec![semio_s_artifact_stdio_ifc::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_ifc::editor::ifc2x3_sav::Ifc2x3SavEditor>(semio_s_artifact_stdio_ifc::editor::ifc2x3_sav::create_ifc2x3_sav_editor(), vec![semio_s_artifact_stdio_ifc::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_ifc::editor::ifc4_any::Ifc4AnyEditor>(semio_s_artifact_stdio_ifc::editor::ifc4_any::create_ifc4_any_editor(), vec![semio_s_artifact_stdio_ifc::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_dwg::editor::dwg_ac1018::DwgAc1018Editor>(semio_s_artifact_stdio_dwg::editor::dwg_ac1018::create_dwg_ac1018_editor(), vec![semio_s_artifact_stdio_dwg::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_dwg::editor::dwg_ac1024::DwgAc1024Editor>(semio_s_artifact_stdio_dwg::editor::dwg_ac1024::create_dwg_ac1024_editor(), vec![semio_s_artifact_stdio_dwg::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_dxf::editor::dxf::DxfAnyEditor>(semio_s_artifact_stdio_dxf::editor::dxf::create_dxf_any_editor(), vec![semio_s_artifact_stdio_dxf::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_gltf::editor::gltf::GltfAnyEditor>(semio_s_artifact_stdio_gltf::editor::gltf::create_gltf_any_editor(), vec![semio_s_artifact_stdio_gltf::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_obj::editor::obj::ObjAnyEditor>(semio_s_artifact_stdio_obj::editor::obj::create_obj_any_editor(), vec![semio_s_artifact_stdio_obj::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_stl::editor::stl::StlAnyEditor>(semio_s_artifact_stdio_stl::editor::stl::create_stl_any_editor(), vec![semio_s_artifact_stdio_stl::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_ply::editor::ply::PlyAnyEditor>(semio_s_artifact_stdio_ply::editor::ply::create_ply_any_editor(), vec![semio_s_artifact_stdio_ply::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_las::editor::las::LasAnyEditor>(semio_s_artifact_stdio_las::editor::las::create_las_any_editor(), vec![semio_s_artifact_stdio_las::examples::demo::source()]);
    ...
    builder = builder.editor_with_examples::<semio_s_artifact_stdio_bcf::editor::bcf::BcfAnyEditor>(semio_s_artifact_stdio_bcf::editor::bcf::create_bcf_any_editor(), vec![semio_s_artifact_stdio_bcf::examples::demo::source()]);
