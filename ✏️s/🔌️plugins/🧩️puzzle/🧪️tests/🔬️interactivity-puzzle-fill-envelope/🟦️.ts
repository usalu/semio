...
export function interactivityPuzzleFillEnvelopeSelfTests(repoRoot: string): void {
  ...
  const mutations: [string, string, string, string, string][] = [
    ...
    ["standard-map-backing", precompute, fill.replace("placed_lookup: FixedOwnerMap<String, usize, DOCUMENT_OBJECT_SLOTS>", "placed_lookup: BTreeMap<String, usize>"), geometry, action],
    ["fixed-slot-cap-plus-one", precompute, fill, geometry.replace("FIXED_OWNER_SLOTS: usize = 32", "FIXED_OWNER_SLOTS: usize = 33"), action],
    ["document-object-slots-are-the-bookkeeping-batch", precompute, fill, geometry.replace("DOCUMENT_OBJECT_SLOTS: usize = 2048", "DOCUMENT_OBJECT_SLOTS: usize = FIXED_OWNER_SLOTS"), action],
    ["document-page-ceiling-is-one-bookkeeping-page", precompute, fill, geometry.replace("DOCUMENT_OWNER_PAGE_BYTES: usize = 64 * FIXED_OWNER_PAGE_BYTES", "DOCUMENT_OWNER_PAGE_BYTES: usize = FIXED_OWNER_PAGE_BYTES"), action],
    ["document-entries-narrowed-to-bookkeeping", precompute, fill, geometry.replace("entries: FixedOwnerMap<String, CollisionAabb, DOCUMENT_OBJECT_SLOTS>", "entries: FixedOwnerMap<String, CollisionAabb>"), action],
