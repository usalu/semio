...
export function interactivityPuzzleFillP4eSelfTests(repoRoot: string): void {
  ...
  const mutations: [string, string, string, string, string, string, string][] = [
    ...
    ["dynamic-bucket", precompute, fill, geometry.replace("cells: FixedOwnerMap<(i32, i32, i32), FixedOwnerSet<String>, DOCUMENT_CELL_SLOTS>", "cells: FixedOwnerMap<(i32, i32, i32), Vec<String>>"), schema, transport, renderer],
    ...
    ["missing-fixture-object-preflight", precompute, fill.replace("(PreparationCapacityBranch::FixtureObjects, roots.scene.fixture.objects.len(), DOCUMENT_OBJECT_SLOTS)", "(PreparationCapacityBranch::FixtureObjects, 0, DOCUMENT_OBJECT_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-fixture-attraction-preflight", precompute, fill.replace("(PreparationCapacityBranch::FixtureAttractions, roots.scene.fixture.attractions.len(), DOCUMENT_ATTRACTION_SLOTS)", "(PreparationCapacityBranch::FixtureAttractions, 0, DOCUMENT_ATTRACTION_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-fixture-volume-preflight", precompute, fill.replace("(PreparationCapacityBranch::FixtureTargetVolumes, roots.scene.fixture.target_volumes.len(), DOCUMENT_VOLUME_SLOTS)", "(PreparationCapacityBranch::FixtureTargetVolumes, 0, DOCUMENT_VOLUME_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-mesh-preflight", precompute, fill.replace("(PreparationCapacityBranch::Meshes, roots.meshes.len(), DOCUMENT_KIND_SLOTS)", "(PreparationCapacityBranch::Meshes, 0, DOCUMENT_KIND_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-catalog-object-preflight", precompute, fill.replace("(PreparationCapacityBranch::CatalogObjects, catalogs.map_or(0, |value| value.objects.len()), DOCUMENT_KIND_SLOTS)", "(PreparationCapacityBranch::CatalogObjects, 0, DOCUMENT_KIND_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-catalog-vortex-preflight", precompute, fill.replace("(PreparationCapacityBranch::CatalogVortices, catalogs.map_or(0, |value| value.vortices.len()), DOCUMENT_KIND_SLOTS)", "(PreparationCapacityBranch::CatalogVortices, 0, DOCUMENT_KIND_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-catalog-cable-preflight", precompute, fill.replace("(PreparationCapacityBranch::CatalogCables, catalogs.map_or(0, |value| value.cables.len()), DOCUMENT_KIND_SLOTS)", "(PreparationCapacityBranch::CatalogCables, 0, DOCUMENT_KIND_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-compatibility-preflight", precompute, fill.replace("(PreparationCapacityBranch::KindCompatibility, roots.scene.kind_compatibility.len(), DOCUMENT_KIND_SLOTS)", "(PreparationCapacityBranch::KindCompatibility, 0, DOCUMENT_KIND_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-object-weight-preflight", precompute, fill.replace("(PreparationCapacityBranch::ObjectWeights, roots.scene.weights.object_weights.len(), DOCUMENT_KIND_SLOTS)", "(PreparationCapacityBranch::ObjectWeights, 0, DOCUMENT_KIND_SLOTS)"), geometry, schema, transport, renderer],
    ["missing-vortex-weight-preflight", precompute, fill.replace("(PreparationCapacityBranch::VortexWeights, roots.scene.weights.vortex_weights.len(), DOCUMENT_KIND_SLOTS)", "(PreparationCapacityBranch::VortexWeights, 0, DOCUMENT_KIND_SLOTS)"), geometry, schema, transport, renderer],
    ["dynamic-fixture-object-owner", precompute, fill.replace("pub(crate) objects: FixedOwnerVec<FixtureObject, DOCUMENT_OBJECT_SLOTS>", "pub(crate) objects: Vec<FixtureObject>"), geometry, schema, transport, renderer],
    ["dynamic-fixture-attraction-owner", precompute, fill.replace("pub(crate) attractions: FixedOwnerVec<AttractionProps, DOCUMENT_ATTRACTION_SLOTS>", "pub(crate) attractions: Vec<AttractionProps>"), geometry, schema, transport, renderer],
    ["dynamic-fixture-volume-owner", precompute, fill.replace("pub(crate) target_volumes: FixedOwnerVec<WorldVolumeProps, DOCUMENT_VOLUME_SLOTS>", "pub(crate) target_volumes: Vec<WorldVolumeProps>"), geometry, schema, transport, renderer],
    ["dynamic-catalog-object-owner", precompute, fill.replace("objects: FixedOwnerVec<ObjectKind, DOCUMENT_KIND_SLOTS>", "objects: Vec<ObjectKind>"), geometry, schema, transport, renderer],
    ["dynamic-catalog-vortex-owner", precompute, fill.replace("vortices: FixedOwnerVec<VortexKindCatalog, DOCUMENT_KIND_SLOTS>", "vortices: Vec<VortexKindCatalog>"), geometry, schema, transport, renderer],
    ["dynamic-catalog-cable-owner", precompute, fill.replace("cables: FixedOwnerVec<CableKindCatalog, DOCUMENT_KIND_SLOTS>", "cables: Vec<CableKindCatalog>"), geometry, schema, transport, renderer],
    ["dynamic-compatibility-owner", precompute, fill.replace("kind_compatibility: FixedOwnerVec<KindCompatEntry, DOCUMENT_KIND_SLOTS>", "kind_compatibility: Vec<KindCompatEntry>"), geometry, schema, transport, renderer],
    ["dynamic-mesh-owner", precompute, fill.replace("meshes: FixedOwnerMap<String, CollisionBody, DOCUMENT_KIND_SLOTS>", "meshes: HashMap<String, CollisionBody>"), geometry, schema, transport, renderer],
    ["missing-catalog-cap-acceptance", precompute, fill.replace("(HostileRoot::CatalogObjects, \"catalog-objects\", DOCUMENT_KIND_SLOTS)", "(HostileRoot::FixtureObjects, \"catalog-objects\", DOCUMENT_KIND_SLOTS)"), geometry, schema, transport, renderer],
