//! 🧪️ `create-node` fixture — `appends-node-c`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-node/appends-node-c: produced diff differs from the committed 🔺️diff/🔣️component.json");
