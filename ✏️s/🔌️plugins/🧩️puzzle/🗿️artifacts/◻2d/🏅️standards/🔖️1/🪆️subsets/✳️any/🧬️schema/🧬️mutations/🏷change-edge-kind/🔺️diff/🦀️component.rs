...
//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::ChangeEdgeKind, base: &Puzzle2dSnapshot) -> protocol::MutationOutcome<Puzzle2dDiff> {
    ...
    next.edge_kind = payload.new_edge_kind.clone();
    if next == *edge {
