//! 🧪️ `change-node-root` fixture — `promotes-node-a-to-root`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-node-root/promotes-node-a-to-root: produced diff differs from the committed 🔺️diff/🔣️component.json");
