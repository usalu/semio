...
pub async fn board_compute_edge_bezier(source_px: f64, source_py: f64, source_cx: f64, source_cy: f64, target_px: f64, target_py: f64, target_cx: f64, target_cy: f64) -> Vec<f64> {
...
pub async fn board_distance_point_cubic(px: f64, py: f64, p0x: f64, p0y: f64, p1x: f64, p1y: f64, p2x: f64, p2y: f64, p3x: f64, p3y: f64, steps: u32) -> f64 {
...
pub async fn board_ray_rect_edge(hw: f64, hh: f64, ux: f64, uy: f64) -> Vec<f64> {
...
pub async fn board_handle_position_circle(cx: f64, cy: f64, radius: f64, angle: f64) -> Vec<f64> {
...
pub async fn board_handle_position_rectangle(cx: f64, cy: f64, width: f64, height: f64, angle: f64) -> Vec<f64> {
...
pub async fn board_redraw_layout_fixture_json(fixture_json: &str, options_json: &str) -> Result<String, JsValue> {
...
pub async fn board_redraw_handles_fixture_json(fixture_json: &str) -> Result<String, JsValue> {
...
pub async fn puzzle2d_parse_dsl_json(dsl_text: &str) -> Result<String, JsValue> {
...
impl BoardSession {
    ...
    pub async fn is_dragging_area_select(&self) -> bool {
        self.state.borrow().host.is_dragging_area_select()
    }

    #[wasm_bindgen(js_name = defersDescriptorSyncFromJs)]
    pub async fn defers_descriptor_sync_from_js(&self) -> bool {
    ...
    pub async fn set_selection_screen_preview(&mut self, flat_xy: &[f64]) {
        let mut inner = self.state.borrow_mut();
    ...
    pub async fn clear_selection_screen_preview(&mut self) {
        self.state.borrow_mut().host.set_selection_screen_preview(None);
    }

    #[wasm_bindgen(js_name = syncDescriptorJson)]
    pub async fn sync_descriptor_json(&mut self, json: &str) -> Result<(), JsValue> {
    ...
    pub async fn set_node_positions_json_wasm(&mut self, json: &str) -> Result<(), JsValue> {
    ...
    pub async fn set_board_kind_catalogs_json(&mut self, json: &str) -> Result<(), JsValue> {
    ...
    pub async fn clear_icon_vector_cache_wasm(&mut self) {
        self.state.borrow_mut().host.clear_icon_vector_cache();
    }

    #[wasm_bindgen(js_name = parseFixtureJson)]
    pub async fn parse_fixture_json(&mut self, json: &str) -> bool {
    ...
    pub async fn set_camera_wasm(&mut self, x: f64, y: f64, zoom: f64) {
    ...
    pub async fn overlay_paint_state_json_wasm(&self) -> String {
        self.state.borrow().host.overlay_paint_state_json()
    }

    #[wasm_bindgen(js_name = setSelectionOptions)]
    pub async fn set_selection_options_wasm(&mut self, method: &str, mode: &str, select_nodes: bool, select_edges: bool, select_handles: bool) {
    ...
    pub async fn set_handle_link_compat_json(&mut self, json: &str) -> Result<(), JsValue> {
    ...
    pub async fn set_world_raster_tiling_wasm(&mut self, mode: &str) {
    ...
    pub async fn clear_brush_session_json_wasm(&mut self) {
        let _ = self.state.borrow_mut().host.set_brush_session_mirror_json("");
    }

    #[wasm_bindgen(js_name = setFixtureDropPreviewJson)]
    pub async fn set_fixture_drop_preview_json_wasm(&mut self, json: &str) -> Result<(), JsValue> {
    ...
    pub async fn clear_fixture_drop_preview_wasm(&mut self) {
        let _ = self.state.borrow_mut().host.set_fixture_drop_preview_json("");
    }

    #[wasm_bindgen(js_name = setLinkSessionJson)]
    pub async fn set_link_session_json_wasm(&mut self, json: &str) -> Result<(), JsValue> {
    ...
    pub async fn set_selection_ids_json_silent(&mut self, json: &str) -> Result<(), JsValue> {
        let ids: Vec<String> = serde_json::from_str(json).map_err(|err| JsValue::from_str(&err.to_string()))?;
    ...
    pub async fn set_preselect_state_json_silent(&mut self, json: &str) -> Result<(), JsValue> {
    ...
    pub async fn set_hovered_id_silent_wasm(&mut self, id: Option<String>) {
        self.state.borrow_mut().host.set_hovered_id_silent(id);
    }

    #[wasm_bindgen(js_name = setHoveredKindSilent)]
    pub async fn set_hovered_kind_silent_wasm(&mut self, domain: Option<String>, kind_id: Option<String>) {
        self.state.borrow_mut().host.set_hovered_kind_silent(domain, kind_id);
    }

    #[wasm_bindgen(js_name = encodedSceneHint)]
    pub async fn encoded_scene_hint_wasm(&self) -> usize {
