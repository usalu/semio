//! 🧪️ `change-edge-tips` fixture — `swaps-edge-1-tips`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-edge-tips/swaps-edge-1-tips: produced diff differs from the committed 🔺️diff/🔣️component.json");
