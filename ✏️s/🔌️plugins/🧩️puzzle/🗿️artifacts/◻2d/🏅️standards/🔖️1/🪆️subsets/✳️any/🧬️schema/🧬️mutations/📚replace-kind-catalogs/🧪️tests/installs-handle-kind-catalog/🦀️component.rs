//! 🧪️ `replace-kind-catalogs` fixture — `installs-handle-kind-catalog`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-kind-catalogs/installs-handle-kind-catalog: produced diff differs from the committed 🔺️diff/🔣️component.json");
