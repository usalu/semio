//! 🔺️ Sparse diff builder for `ChangeNodeLocked` — patches the one addressed node in place.
use crate::artifacts::puzzle2d::diff::{Puzzle2dDiff, Puzzle2dNodePatch, Puzzle2dNodePatchEntry, Puzzle2dNodesDelta};
use crate::artifacts::puzzle2d::Puzzle2dSnapshot;

//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::ChangeNodeLocked, base: &Puzzle2dSnapshot) -> protocol::MutationOutcome<Puzzle2dDiff> {
