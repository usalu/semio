...
//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::ChangeNodeIcon, base: &Puzzle2dSnapshot) -> protocol::MutationOutcome<Puzzle2dDiff> {
    ...
    next.icon_kind = payload.new_icon_kind.clone();
    if next == *node {
