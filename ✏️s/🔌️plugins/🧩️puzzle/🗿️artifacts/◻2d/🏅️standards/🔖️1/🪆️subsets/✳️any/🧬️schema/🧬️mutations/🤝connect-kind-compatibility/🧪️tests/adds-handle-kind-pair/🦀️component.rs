//! 🧪️ `connect-kind-compatibility` fixture — `adds-handle-kind-pair`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "connect-kind-compatibility/adds-handle-kind-pair: produced diff differs from the committed 🔺️diff/🔣️component.json");
