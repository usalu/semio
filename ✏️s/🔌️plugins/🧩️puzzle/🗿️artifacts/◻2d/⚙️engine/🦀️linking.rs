//! 🔗️ Puzzle 2d artifact engine — the handle-to-handle wiring laws: link-drag snapping, proximity
...
mod tests {
    ...
    use crate::artifacts::puzzle2d::engine::{BoardHost, EdgeDescJson, GraphPortMode, HandleDescJson, NodeDescJson, SceneDescriptorJson, WireDescJson};
    use serde_json::json;
