...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/🪢️rewires-the-capsule-the-subgraph-left-loose/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/🪢️rewires-the-capsule-the-subgraph-left-loose/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/🪢️rewires-the-capsule-the-subgraph-left-loose/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/🪢️rewires-the-capsule-the-subgraph-left-loose/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/🪢️rewires-the-capsule-the-subgraph-left-loose/🎯️outcome/🔣️.json");
