...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-a-tambour-door-and-severs-its-capsule-edge/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-a-tambour-door-and-severs-its-capsule-edge/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-a-tambour-door-and-severs-its-capsule-edge/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-a-tambour-door-and-severs-its-capsule-edge/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-a-tambour-door-and-severs-its-capsule-edge/🎯️outcome/🔣️.json");
