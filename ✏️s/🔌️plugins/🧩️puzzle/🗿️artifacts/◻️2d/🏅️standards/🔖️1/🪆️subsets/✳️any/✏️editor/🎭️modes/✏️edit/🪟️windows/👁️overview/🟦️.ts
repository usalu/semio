/** 👁️ Puzzle 2d editor — Overview window: typed twin of `🦀️.rs`'s view boundary. Mirrors
 ...
 * read-only twin, see `👁️viewer/…/🟦️.ts`). This is the one pane with brush/select utilities
 * (see `🪛️utilities/{🖌️brush,🖱️select}/🟦️.ts` for their own typed twins). */
