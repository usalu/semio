...
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-manifest/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-manifest/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-manifest/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-manifest/🎯️outcome/🔣️.json");
