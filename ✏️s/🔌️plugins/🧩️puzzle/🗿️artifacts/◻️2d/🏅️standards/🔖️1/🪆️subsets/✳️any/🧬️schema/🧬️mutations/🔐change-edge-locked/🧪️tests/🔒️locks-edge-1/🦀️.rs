//! 🧪️ `change-edge-locked` fixture — `🔒️locks-edge-1`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔐change-edge-locked/🔒️locks-edge-1/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔐change-edge-locked/🔒️locks-edge-1/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔐change-edge-locked/🔒️locks-edge-1/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔐change-edge-locked/🔒️locks-edge-1/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔐change-edge-locked/🔒️locks-edge-1/🎯️outcome/🔣️.json");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-edge-locked/locks-edge-1: produced diff differs from the committed 🔺️diff/🔣️.json");
