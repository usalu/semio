//! 🧪️ `delete-node` fixture — `🚫️removes-node-a-and-severs-edge`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️removes-node-a-and-severs-edge/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️removes-node-a-and-severs-edge/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️removes-node-a-and-severs-edge/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️removes-node-a-and-severs-edge/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️removes-node-a-and-severs-edge/🎯️outcome/🔣️.json");
