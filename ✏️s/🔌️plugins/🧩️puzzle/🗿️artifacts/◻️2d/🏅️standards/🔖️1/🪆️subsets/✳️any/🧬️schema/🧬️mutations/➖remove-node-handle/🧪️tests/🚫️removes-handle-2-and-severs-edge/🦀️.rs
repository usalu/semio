//! 🧪️ `remove-node-handle` fixture — `🚫️removes-handle-2-and-severs-edge`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-handle-2-and-severs-edge/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-handle-2-and-severs-edge/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-handle-2-and-severs-edge/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-handle-2-and-severs-edge/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-node-handle/🚫️removes-handle-2-and-severs-edge/🎯️outcome/🔣️.json");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-node-handle/removes-handle-2-and-severs-edge: produced diff differs from the committed 🔺️diff/🔣️.json");
