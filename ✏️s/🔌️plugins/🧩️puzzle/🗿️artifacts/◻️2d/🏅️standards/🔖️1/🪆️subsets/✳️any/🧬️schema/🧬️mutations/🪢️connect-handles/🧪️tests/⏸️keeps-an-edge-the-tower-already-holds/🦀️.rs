...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/⏸️keeps-an-edge-the-tower-already-holds/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/⏸️keeps-an-edge-the-tower-already-holds/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/⏸️keeps-an-edge-the-tower-already-holds/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/⏸️keeps-an-edge-the-tower-already-holds/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-handles/⏸️keeps-an-edge-the-tower-already-holds/🎯️outcome/🔣️.json");
