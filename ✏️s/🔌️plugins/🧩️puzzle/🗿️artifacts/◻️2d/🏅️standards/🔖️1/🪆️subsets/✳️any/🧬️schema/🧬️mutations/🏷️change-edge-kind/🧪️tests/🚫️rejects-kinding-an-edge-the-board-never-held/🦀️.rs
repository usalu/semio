...
fn the_refusal_is_the_declared_one() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::puzzle2d::diff::Puzzle2dDiff::default(), "change-edge-kind/rejects-kinding-an-edge-the-board-never-held: a refusing diff builder answers the default diff, never a half-built delta");
