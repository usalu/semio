//! 🧪️ `replace-node-geometry` fixture — `🔳️circle-to-rectangle`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊replace-node-geometry/🔳️circle-to-rectangle/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊replace-node-geometry/🔳️circle-to-rectangle/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊replace-node-geometry/🔳️circle-to-rectangle/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊replace-node-geometry/🔳️circle-to-rectangle/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊replace-node-geometry/🔳️circle-to-rectangle/🎯️outcome/🔣️.json");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-node-geometry/circle-to-rectangle: produced diff differs from the committed 🔺️diff/🔣️.json");
