...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔disconnect-kind-compatibility/🚫️removes-handle-kind-pair/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔disconnect-kind-compatibility/🚫️removes-handle-kind-pair/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔disconnect-kind-compatibility/🚫️removes-handle-kind-pair/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔disconnect-kind-compatibility/🚫️removes-handle-kind-pair/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔disconnect-kind-compatibility/🚫️removes-handle-kind-pair/🎯️outcome/🔣️.json");
