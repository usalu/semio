...
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-node-text/✏️retitles-node-a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-node-text/✏️retitles-node-a/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-node-text/✏️retitles-node-a/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-node-text/✏️retitles-node-a/🎯️outcome/🔣️.json");
