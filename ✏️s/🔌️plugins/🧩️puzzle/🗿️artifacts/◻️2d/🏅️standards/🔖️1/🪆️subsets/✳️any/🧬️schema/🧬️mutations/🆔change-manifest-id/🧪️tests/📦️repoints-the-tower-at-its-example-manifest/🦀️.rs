...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-the-tower-at-its-example-manifest/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-the-tower-at-its-example-manifest/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-the-tower-at-its-example-manifest/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-the-tower-at-its-example-manifest/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆔change-manifest-id/📦️repoints-the-tower-at-its-example-manifest/🎯️outcome/🔣️.json");
