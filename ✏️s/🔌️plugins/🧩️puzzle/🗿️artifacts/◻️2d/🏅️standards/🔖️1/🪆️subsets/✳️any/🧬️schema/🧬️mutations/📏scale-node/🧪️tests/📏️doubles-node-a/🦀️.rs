...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-node/📏️doubles-node-a/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-node/📏️doubles-node-a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-node/📏️doubles-node-a/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-node/📏️doubles-node-a/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏scale-node/📏️doubles-node-a/🎯️outcome/🔣️.json");
