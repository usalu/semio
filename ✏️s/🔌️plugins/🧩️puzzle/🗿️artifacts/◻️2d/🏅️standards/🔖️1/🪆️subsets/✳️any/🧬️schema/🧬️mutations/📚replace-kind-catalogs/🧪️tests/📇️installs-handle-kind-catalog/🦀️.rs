...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/📇️installs-handle-kind-catalog/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/📇️installs-handle-kind-catalog/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/📇️installs-handle-kind-catalog/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/📇️installs-handle-kind-catalog/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/📇️installs-handle-kind-catalog/🎯️outcome/🔣️.json");
