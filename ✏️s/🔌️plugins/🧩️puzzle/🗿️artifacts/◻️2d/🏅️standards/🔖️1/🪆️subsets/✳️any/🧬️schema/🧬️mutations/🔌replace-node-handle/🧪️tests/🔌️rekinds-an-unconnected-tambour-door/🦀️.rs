...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌replace-node-handle/🔌️rekinds-an-unconnected-tambour-door/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌replace-node-handle/🔌️rekinds-an-unconnected-tambour-door/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌replace-node-handle/🔌️rekinds-an-unconnected-tambour-door/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌replace-node-handle/🔌️rekinds-an-unconnected-tambour-door/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌replace-node-handle/🔌️rekinds-an-unconnected-tambour-door/🎯️outcome/🔣️.json");
