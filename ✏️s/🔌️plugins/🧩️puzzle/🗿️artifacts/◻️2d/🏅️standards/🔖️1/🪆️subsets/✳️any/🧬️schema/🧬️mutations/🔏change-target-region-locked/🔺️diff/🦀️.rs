//! 🔺️ Sparse diff builder for `ChangeTargetRegionLocked` — patches the one addressed target region in place.
...
//#region 🔖️Diff
pub fn diff(payload: &super::ChangeTargetRegionLocked, base: &Puzzle2dSnapshot) -> protocol::MutationOutcome<Puzzle2dDiff> {
