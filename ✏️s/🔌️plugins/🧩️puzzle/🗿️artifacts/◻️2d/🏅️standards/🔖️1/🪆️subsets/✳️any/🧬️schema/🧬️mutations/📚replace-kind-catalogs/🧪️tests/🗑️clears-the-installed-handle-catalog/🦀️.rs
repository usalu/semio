...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/🗑️clears-the-installed-handle-catalog/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/🗑️clears-the-installed-handle-catalog/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/🗑️clears-the-installed-handle-catalog/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/🗑️clears-the-installed-handle-catalog/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📚replace-kind-catalogs/🗑️clears-the-installed-handle-catalog/🎯️outcome/🔣️.json");
