//! 🧪️ `replace-node-handle` fixture — `⏸️rekind-handle-1-is-noop`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-node-handle/rekind-handle-1-is-noop: produced diff differs from the committed 🔺️diff/🔣️.json");
