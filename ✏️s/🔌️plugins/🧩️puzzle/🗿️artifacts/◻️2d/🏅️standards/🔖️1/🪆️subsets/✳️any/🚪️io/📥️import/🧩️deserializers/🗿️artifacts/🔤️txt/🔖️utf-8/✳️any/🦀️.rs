...
pub fn register() {}
pub fn deserialize(_from: &semio_s_artifact_stdio_txt::TxtSnapshot) -> Result<Puzzle2dSnapshot, String> {
    Err("txt import not yet implemented".into())
}
pub fn deserialize_bytes(_bytes: &[u8]) -> Result<Puzzle2dSnapshot, String> {
    Err("txt import not yet implemented".into())
}
