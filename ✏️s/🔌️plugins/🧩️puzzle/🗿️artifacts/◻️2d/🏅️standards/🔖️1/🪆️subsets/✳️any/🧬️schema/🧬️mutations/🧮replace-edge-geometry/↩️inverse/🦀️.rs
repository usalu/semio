...
pub fn inverse(payload: &super::ReplaceEdgeGeometry, base: &Puzzle2dSnapshot) -> Vec<Puzzle2dMutation> {
    ...
    vec![crate::mutations::replace_edge_semio_framework_geometry::replace_edge_geometry(edge.id.clone(), edge.gap, edge.shift, edge.rise, edge.rotation, edge.turn, edge.tilt, edge.x, edge.y)]
}
//#endregion 🔖️Inverse
