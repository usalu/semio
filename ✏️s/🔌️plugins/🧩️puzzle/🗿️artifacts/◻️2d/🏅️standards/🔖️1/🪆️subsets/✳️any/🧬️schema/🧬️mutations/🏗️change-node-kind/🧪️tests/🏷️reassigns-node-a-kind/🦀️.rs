//! 🧪️ `change-node-kind` fixture — `🏷️reassigns-node-a-kind`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-node-kind/🏷️reassigns-node-a-kind/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-node-kind/🏷️reassigns-node-a-kind/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-node-kind/🏷️reassigns-node-a-kind/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-node-kind/🏷️reassigns-node-a-kind/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-node-kind/🏷️reassigns-node-a-kind/🎯️outcome/🔣️.json");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-node-kind/reassigns-node-a-kind: produced diff differs from the committed 🔺️diff/🔣️.json");
