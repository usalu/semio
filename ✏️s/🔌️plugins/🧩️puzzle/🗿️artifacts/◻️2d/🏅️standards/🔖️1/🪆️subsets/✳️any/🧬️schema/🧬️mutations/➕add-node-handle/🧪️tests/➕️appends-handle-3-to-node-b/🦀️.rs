...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-node-handle/➕️appends-handle-3-to-node-b/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-node-handle/➕️appends-handle-3-to-node-b/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-node-handle/➕️appends-handle-3-to-node-b/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-node-handle/➕️appends-handle-3-to-node-b/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-node-handle/➕️appends-handle-3-to-node-b/🎯️outcome/🔣️.json");
