//! 🎛 Puzzle-5d flatten — absolute 3d planes via the 3d attraction solver, plus diagram centers.
//!
//! Maps parts/grips/fasteners onto the 3d object/vortex/attraction graph, runs
//! `puzzle3d::engine::geometry::flatten`, then writes origins/orientations and 2d centers back.

use crate::artifacts::puzzle3d::engine::geometry::flatten::{self, FlattenPose, DIAGRAM_HORIZONTAL_SCALE, DIAGRAM_RADIUS, DIAGRAM_VERTICAL_V_EXTRA};
