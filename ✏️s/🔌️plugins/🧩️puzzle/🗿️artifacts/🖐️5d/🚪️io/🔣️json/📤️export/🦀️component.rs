//! 📤️ Export Puzzle5dSnapshot as .json.

use semio_framework_plugin::{DocumentCodec, IoError, JsonCodec, MediaFormat};

//#region 🔖️Export
pub fn export(snapshot: &crate::artifacts::puzzle5d::Puzzle5dSnapshot) -> Result<Vec<u8>, IoError> {
...
pub fn register() {
    ...
    semio_framework_os::register_os_media_export_handler(kind, format, move |doc| {
        let snapshot: crate::artifacts::puzzle5d::Puzzle5dSnapshot =
