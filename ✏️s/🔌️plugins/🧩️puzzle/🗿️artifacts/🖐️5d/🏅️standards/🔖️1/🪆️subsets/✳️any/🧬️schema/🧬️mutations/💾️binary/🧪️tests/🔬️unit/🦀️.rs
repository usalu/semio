...
fn puzzle5d_document_vcs_replays_granular_operations() {
    ...
    let mut store = semio_framework::io::resolve_ready(puzzle5d_store(create_document_envelope(PUZZLE_5D_SCHEMA, "puzzle5d", empty_puzzle5d_snapshot(), None))).expect("store");
