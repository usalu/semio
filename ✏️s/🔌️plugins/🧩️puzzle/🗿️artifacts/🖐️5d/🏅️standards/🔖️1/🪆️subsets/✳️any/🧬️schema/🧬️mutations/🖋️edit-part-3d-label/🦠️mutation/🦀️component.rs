...
//#region 🔖️Mutation
/// `edit-part-3d-label` payload.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, dsl::DslRecord)]
#[serde(rename_all = "camelCase")]
#[dsl(keyword = "edit-part-3d-label")]
...
impl protocol::MutationKind<Puzzle5dSnapshot, Puzzle5dMutation> for EditPart3dLabel {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "edit", entity: "part", kind: "edit-part-3d-label", record: "EditedPart3dLabel" };
