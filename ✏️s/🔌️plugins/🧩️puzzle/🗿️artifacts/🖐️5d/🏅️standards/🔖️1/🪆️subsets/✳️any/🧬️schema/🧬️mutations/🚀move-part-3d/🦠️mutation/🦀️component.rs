...
//#region 🔖️Mutation
/// `move-part-3d` payload.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, dsl::DslRecord)]
#[serde(rename_all = "camelCase")]
#[dsl(keyword = "move-part-3d")]
...
impl protocol::MutationKind<Puzzle5dSnapshot, Puzzle5dMutation> for MovePart3d {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "move", entity: "part", kind: "move-part-3d", record: "MovedPart3d" };
