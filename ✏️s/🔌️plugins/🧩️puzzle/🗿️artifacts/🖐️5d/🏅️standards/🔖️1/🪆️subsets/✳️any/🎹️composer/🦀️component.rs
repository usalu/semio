//! 🎹️ Puzzle5dComposer (1/✳️any) — analyzer + builder glued. Reads native `s.puzzle5d` sources
//! plus any of: stdio.glb, stdio.json, stdio.obj, stdio.png, stdio.stl, stdio.txt, stdio.zip. Writes one `s.puzzle5d` (1/✳️any) snapshot.
...
use crate::artifacts::puzzle5d::standards::v1::subsets::any::analyzer::Puzzle5dAnalyzer;
...
pub struct Puzzle5dComposer;

impl ArtifactComposer for Puzzle5dComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        for source in sources {
            ...
            if source.dialect == DEP_GLB {
                ...
                if let Ok(snapshot) = crate::artifacts::puzzle5d::io::import::deserializers::artifacts::glb::v2_0::any::deserialize_bytes(&bytes) {
        ...
        Err(ComposeError { message: "Puzzle5dComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
