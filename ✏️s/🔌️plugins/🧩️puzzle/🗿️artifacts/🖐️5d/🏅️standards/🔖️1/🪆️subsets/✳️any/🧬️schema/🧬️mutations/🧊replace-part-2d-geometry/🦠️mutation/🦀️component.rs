...
//#region 🔖️Mutation
/// `replace-part-2d-geometry` payload.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, dsl::DslRecord)]
#[serde(rename_all = "camelCase")]
#[dsl(keyword = "replace-part-2d-geometry")]
...
impl protocol::MutationKind<Puzzle5dSnapshot, Puzzle5dMutation> for ReplacePart2dGeometry {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "replace", entity: "part", kind: "replace-part-2d-geometry", record: "ReplacedPart2dGeometry" };
