//! 🧪️ `connect-grips` fixture — `adds-second-fastener`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "connect-grips/adds-second-fastener: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
