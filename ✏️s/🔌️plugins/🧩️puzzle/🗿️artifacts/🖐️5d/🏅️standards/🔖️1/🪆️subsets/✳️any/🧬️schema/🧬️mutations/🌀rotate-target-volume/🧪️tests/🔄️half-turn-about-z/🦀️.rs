//! 🧪️ `rotate-target-volume` fixture — `🔄️half-turn-about-z`.
//!
//! A half turn about the world up-axis; the quaternion is written, the extent is not.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀rotate-target-volume/🔄️half-turn-about-z/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀rotate-target-volume/🔄️half-turn-about-z/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀rotate-target-volume/🔄️half-turn-about-z/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀rotate-target-volume/🔄️half-turn-about-z/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀rotate-target-volume/🔄️half-turn-about-z/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    assert_eq!(status, "applied", "rotate-target-volume/half-turn-about-z: this vector declares an applied outcome");
    let mut snapshot = before();
    apply_puzzle5d_mutation(&mut snapshot, &mutation()).expect("rotate-target-volume/half-turn-about-z: declared applied but the mutation was rejected");
}
...
fn produces_committed_diff() {
    ...
    assert!(committed["parts"].is_null(), "rotate-target-volume/half-turn-about-z: a target volume is not a part");
    assert!(committed["fasteners"].is_null(), "rotate-target-volume/half-turn-about-z: a target volume is not a fastener");
}
