 ...
 * sibling `🦀️component.rs` union enum and each variant's `<slug>/🦠️mutation/🦀️component.rs`
 * payload struct). */
import type { Puzzle5dCompatSpecificity, Puzzle5dKindCatalogs, Puzzle5dPart, Puzzle5dPartAnchor } from "../📸️snapshot/🟦️component.ts";
