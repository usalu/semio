//! 🧪️ `add-part-grip` fixture — `appends-grip-3`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "add-part-grip/appends-grip-3: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
