...
Feature: Apply every typed puzzle5d assembly mutation twice — once in Rust, once in Python — and require the same answer
  ...
  Scenario Outline: The committed <id> vector declares its own kind and moves the document
    ...
    Examples:
      ...
      | delete-part                   | 🗑️delete-part/🧪️tests/removes-part-a-and-severs-fastener      |
      ...
      | change-part-kind              | 🏗️change-part-kind/🧪️tests/reassigns-kind                     |
      ...
      | connect-grips                 | 🪢️connect-grips/🧪️tests/adds-second-fastener                  |
      ...
      | rename-puzzle5d               | 🏷️rename-puzzle5d/🧪️tests/relabels-document                   |
      | change-domain                 | 🌐change-domain/🧪️tests/architecture-to-engineering           |
      | change-description            | 🗒️change-description/🧪️tests/rewrites-description             |
