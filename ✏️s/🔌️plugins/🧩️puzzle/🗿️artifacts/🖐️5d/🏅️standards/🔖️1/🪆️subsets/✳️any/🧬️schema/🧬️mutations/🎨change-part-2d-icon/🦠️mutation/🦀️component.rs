...
//#region 🔖️Mutation
/// `change-part-2d-icon` payload.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, dsl::DslRecord)]
#[serde(rename_all = "camelCase")]
#[dsl(keyword = "change-part-2d-icon")]
...
impl protocol::MutationKind<Puzzle5dSnapshot, Puzzle5dMutation> for ChangePart2dIcon {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "change", entity: "part", kind: "change-part-2d-icon", record: "ChangedPart2dIcon" };
