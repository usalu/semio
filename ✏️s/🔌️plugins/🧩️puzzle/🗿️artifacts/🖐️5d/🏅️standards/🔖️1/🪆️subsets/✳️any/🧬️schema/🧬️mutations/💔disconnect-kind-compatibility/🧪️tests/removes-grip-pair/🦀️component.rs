//! 🧪️ `disconnect-kind-compatibility` fixture — `removes-grip-pair`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "disconnect-kind-compatibility/removes-grip-pair: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
