...
async fn examples() -> &'static [ExampleSource] {
    ...
    EXAMPLES
        .get_or_init(|| {
            vec![
                crate::examples::puzzle5d::nakagin_capsule_tower::SOURCE.clone(),
                crate::examples::puzzle5d::capsule_dream::SOURCE.clone(),
                crate::examples::puzzle5d::concrete_forest::SOURCE.clone(),
            ]
        })
        .as_slice()
}
