...
//#region 🔖️Mutation
/// `rotate-part-3d` payload.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, dsl::DslRecord)]
#[serde(rename_all = "camelCase")]
#[dsl(keyword = "rotate-part-3d")]
...
impl protocol::MutationKind<Puzzle5dSnapshot, Puzzle5dMutation> for RotatePart3d {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "rotate", entity: "part", kind: "rotate-part-3d", record: "RotatedPart3d" };
