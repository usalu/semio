...
fn applies_to_committed_after() {
    ...
    apply_puzzle5d_mutation(&mut snapshot, &mutation()).expect("change-domain applies to its committed before-snapshot");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-domain/architecture-to-engineering: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
