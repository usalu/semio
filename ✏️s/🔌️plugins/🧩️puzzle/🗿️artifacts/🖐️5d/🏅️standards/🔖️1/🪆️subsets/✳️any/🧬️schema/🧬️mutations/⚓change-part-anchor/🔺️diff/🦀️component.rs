//! 🔺️ Sparse diff builder for `ChangePartAnchor` — patches the one addressed part in place.
use crate::artifacts::puzzle5d::diff::{Puzzle5dDiff, Puzzle5dPartPatch, Puzzle5dPartPatchEntry, Puzzle5dPartsDelta};
use crate::artifacts::puzzle5d::Puzzle5dSnapshot;

//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::ChangePartAnchor, base: &Puzzle5dSnapshot) -> protocol::MutationOutcome<Puzzle5dDiff> {
