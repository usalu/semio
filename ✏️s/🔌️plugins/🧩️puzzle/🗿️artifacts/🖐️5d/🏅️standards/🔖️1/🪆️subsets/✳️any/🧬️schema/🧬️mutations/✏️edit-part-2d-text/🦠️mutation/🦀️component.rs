...
//#region 🔖️Mutation
/// `edit-part-2d-text` payload.
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, dsl::DslRecord)]
#[serde(rename_all = "camelCase")]
#[dsl(keyword = "edit-part-2d-text")]
...
impl protocol::MutationKind<Puzzle5dSnapshot, Puzzle5dMutation> for EditPart2dText {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "edit", entity: "part", kind: "edit-part-2d-text", record: "EditedPart2dText" };
