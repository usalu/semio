//! 🖌️ Puzzle 3d artifact engine — the brush rulebook: which object kind may dock onto which vortex
...
//! candidate becomes a concrete `BrushPreviewState`/placement spliced into a `Fixture`.

use crate::artifacts::puzzle3d::engine::geometry::{compute_brush_placement_pose, normalize_vec3, quat_rotate_vec, vec3_add};
