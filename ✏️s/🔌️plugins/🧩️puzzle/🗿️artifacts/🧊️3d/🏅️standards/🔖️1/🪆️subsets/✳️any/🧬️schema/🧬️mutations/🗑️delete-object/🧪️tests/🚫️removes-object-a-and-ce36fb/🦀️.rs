//! 🧪️ `delete-object` fixture — `🚫️removes-object-a-and-severs-attraction`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-object/removes-object-a-and-severs-attraction: produced diff differs from the committed 🔺️diff/🔣️.json");
