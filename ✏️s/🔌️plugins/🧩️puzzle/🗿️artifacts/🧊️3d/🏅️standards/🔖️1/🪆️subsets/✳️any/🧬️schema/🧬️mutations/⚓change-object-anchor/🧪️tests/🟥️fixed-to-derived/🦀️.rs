//! 🧪️ `change-object-anchor` fixture — `🟥️fixed-to-derived`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-object-anchor/fixed-to-derived: produced diff differs from the committed 🔺️diff/🔣️.json");
