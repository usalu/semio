//! 🔺️ Sparse diff builder for `MoveObject` — patches the one addressed object in place.
...
//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::MoveObject, base: &Puzzle3dSnapshot) -> protocol::MutationOutcome<Puzzle3dDiff> {
