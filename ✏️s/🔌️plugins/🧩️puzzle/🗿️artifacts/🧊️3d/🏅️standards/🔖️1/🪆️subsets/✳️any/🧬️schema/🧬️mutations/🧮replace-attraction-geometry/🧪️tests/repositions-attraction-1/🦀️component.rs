//! 🧪️ `replace-attraction-geometry` fixture — `repositions-attraction-1`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-attraction-geometry/repositions-attraction-1: produced diff differs from the committed 🔺️diff/🔣️component.json");
