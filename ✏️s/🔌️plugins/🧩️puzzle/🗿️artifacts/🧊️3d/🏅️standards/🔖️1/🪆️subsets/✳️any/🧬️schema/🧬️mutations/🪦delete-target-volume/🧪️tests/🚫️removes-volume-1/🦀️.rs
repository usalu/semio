...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪦delete-target-volume/🚫️removes-volume-1/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪦delete-target-volume/🚫️removes-volume-1/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪦delete-target-volume/🚫️removes-volume-1/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪦delete-target-volume/🚫️removes-volume-1/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪦delete-target-volume/🚫️removes-volume-1/🎯️outcome/🔣️.json");
