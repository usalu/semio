...
pub async fn serialize(_from: &Puzzle3dSnapshot) -> Result<semio_s_plugin_stdio::artifacts::txt::TxtSnapshot, String> {
    Err("txt export not yet implemented".into())
}
pub async fn deserialize_bytes(_bytes: &[u8]) -> Result<Puzzle3dSnapshot, String> {
