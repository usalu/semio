//! 🧪️ `scale-target-volume` fixture — `📏️per-axis-to-uniform`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐scale-target-volume/📏️per-axis-to-uniform/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐scale-target-volume/📏️per-axis-to-uniform/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐scale-target-volume/📏️per-axis-to-uniform/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐scale-target-volume/📏️per-axis-to-uniform/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐scale-target-volume/📏️per-axis-to-uniform/🎯️outcome/🔣️.json");
