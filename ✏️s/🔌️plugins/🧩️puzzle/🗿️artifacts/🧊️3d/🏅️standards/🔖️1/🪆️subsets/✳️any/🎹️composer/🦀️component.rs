...
//! plus any of: stdio.dwg, stdio.glb, stdio.gltf, stdio.json, stdio.las, stdio.obj, stdio.ply, stdio.png, stdio.stl, stdio.txt, stdio.zip. Writes one `s.puzzle3d` (1/✳️any) snapshot.
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        for source in sources {
            ...
            if source.dialect == DEP_GLB {
                ...
                if let Ok(snapshot) = crate::artifacts::puzzle3d::io::import::deserializers::artifacts::glb::v2_0::any::deserialize_bytes(&bytes) {
                    return Ok(Composition { snapshot, confidence: semio_framework_plugin::IoConfidence::Medium, diagnostics: Vec::new() });
                }
            }
