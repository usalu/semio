//! 🧪️ `connect-vortices` fixture — `🧲️adds-second-attraction`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-vortices/🧲️adds-second-attraction/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-vortices/🧲️adds-second-attraction/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-vortices/🧲️adds-second-attraction/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-vortices/🧲️adds-second-attraction/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-vortices/🧲️adds-second-attraction/🎯️outcome/🔣️.json");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "connect-vortices/adds-second-attraction: produced diff differs from the committed 🔺️diff/🔣️.json");
