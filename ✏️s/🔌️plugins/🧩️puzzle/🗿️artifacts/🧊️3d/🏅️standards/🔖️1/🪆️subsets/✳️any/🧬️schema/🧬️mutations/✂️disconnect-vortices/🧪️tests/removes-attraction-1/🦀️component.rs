//! 🧪️ `disconnect-vortices` fixture — `removes-attraction-1`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "disconnect-vortices/removes-attraction-1: produced diff differs from the committed 🔺️diff/🔣️component.json");
