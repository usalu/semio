...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-object-vortex/🌀️appends-vortex-3-to-object-b/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-object-vortex/🌀️appends-vortex-3-to-object-b/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-object-vortex/🌀️appends-vortex-3-to-object-b/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-object-vortex/🌀️appends-vortex-3-to-object-b/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕add-object-vortex/🌀️appends-vortex-3-to-object-b/🎯️outcome/🔣️.json");
