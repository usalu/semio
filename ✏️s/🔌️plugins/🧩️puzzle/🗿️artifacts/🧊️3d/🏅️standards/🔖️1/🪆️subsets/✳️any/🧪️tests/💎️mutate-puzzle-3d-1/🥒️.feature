...
Feature: Apply every typed puzzle3d scene mutation twice — once in Rust, once in Python — and require the same answer
  ...
  Scenario Outline: The committed <id> vector declares its own kind and moves the document
    ...
    Examples:
      ...
      | delete-object                 | 🗑️delete-object/🧪️tests/removes-object-a-and-severs-attraction        |
      ...
      | change-object-kind            | 🏗️change-object-kind/🧪️tests/reassigns-object-a-kind                  |
      | change-object-anchor          | ⚓change-object-anchor/🧪️tests/fixed-to-derived                       |
      | change-object-hidden          | 👁️change-object-hidden/🧪️tests/hides-object-a                         |
      ...
      | connect-vortices              | 🪢️connect-vortices/🧪️tests/adds-second-attraction                     |
      ...
      | create-reference              | 🖼️create-reference/🧪️tests/appends-reference-2                        |
      ...
      | replace-reference-source      | 🖇️replace-reference-source/🧪️tests/repoints-reference-1-source        |
      | change-reference-hidden       | 👀change-reference-hidden/🧪️tests/hides-reference-1                   |
      | change-reference-locked       | 🗝️change-reference-locked/🧪️tests/locks-reference-1                   |
