//! 🧪️ `create-reference` fixture — `🖼️appends-reference-2`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-reference/🖼️appends-reference-2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-reference/🖼️appends-reference-2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-reference/🖼️appends-reference-2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-reference/🖼️appends-reference-2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️create-reference/🖼️appends-reference-2/🎯️outcome/🔣️.json");
