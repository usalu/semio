...
use crate::artifacts::puzzle3d::{Puzzle3dTargetVolume, Puzzle3dSnapshot};
...
pub async fn create_target_volume(target_volume: Puzzle3dTargetVolume, index: Option<usize>) -> Puzzle3dMutation {
