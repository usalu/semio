//! 🧪️ `replace-kind-catalogs` fixture — `📇️installs-vortex-kind-catalog`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-kind-catalogs/installs-vortex-kind-catalog: produced diff differs from the committed 🔺️diff/🔣️.json");
