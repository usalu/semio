//! 🔺️ Sparse diff builder for `RotateObject` — patches the one addressed object in place.
...
//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::RotateObject, base: &Puzzle3dSnapshot) -> protocol::MutationOutcome<Puzzle3dDiff> {
