...
/// `Default` is required by `artifact_app_laws::assert_viewer_never_mutates::<V>() where V::Command: Default`.
...
impl ArtifactViewer for Puzzle3dViewer {
    ...
    fn initial_snapshot() -> Puzzle3dSnapshot {
...
//#region 🔖️Manifest
pub fn create_puzzle3d_viewer() -> semio_framework_plugin::AppDefinition {
