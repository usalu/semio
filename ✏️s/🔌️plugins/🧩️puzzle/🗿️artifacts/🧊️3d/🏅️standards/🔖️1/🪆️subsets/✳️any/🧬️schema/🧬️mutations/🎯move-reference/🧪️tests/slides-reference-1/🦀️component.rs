//! 🧪️ `move-reference` fixture — `slides-reference-1`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-reference/slides-reference-1: produced diff differs from the committed 🔺️diff/🔣️component.json");
