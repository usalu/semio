//! 🧪️ `remove-object-vortex` fixture — `🚫️removes-vortex-2-and-severs-attraction`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-object-vortex/🚫️removes-vortex-2-and-severs-attraction/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-object-vortex/🚫️removes-vortex-2-and-severs-attraction/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-object-vortex/🚫️removes-vortex-2-and-severs-attraction/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-object-vortex/🚫️removes-vortex-2-and-severs-attraction/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-object-vortex/🚫️removes-vortex-2-and-severs-attraction/🎯️outcome/🔣️.json");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-object-vortex/removes-vortex-2-and-severs-attraction: produced diff differs from the committed 🔺️diff/🔣️.json");
