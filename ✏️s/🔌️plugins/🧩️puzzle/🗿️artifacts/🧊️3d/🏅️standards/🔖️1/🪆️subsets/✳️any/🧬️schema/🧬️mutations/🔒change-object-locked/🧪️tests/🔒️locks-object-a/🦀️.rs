//! 🧪️ `change-object-locked` fixture — `🔒️locks-object-a`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-object-locked/🔒️locks-object-a/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-object-locked/🔒️locks-object-a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-object-locked/🔒️locks-object-a/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-object-locked/🔒️locks-object-a/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-object-locked/🔒️locks-object-a/🎯️outcome/🔣️.json");
