//! 🧪️ `replace-object-vortex` fixture — `rekind-vortex-1-is-noop`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-object-vortex/rekind-vortex-1-is-noop: produced diff differs from the committed 🔺️diff/🔣️component.json");
