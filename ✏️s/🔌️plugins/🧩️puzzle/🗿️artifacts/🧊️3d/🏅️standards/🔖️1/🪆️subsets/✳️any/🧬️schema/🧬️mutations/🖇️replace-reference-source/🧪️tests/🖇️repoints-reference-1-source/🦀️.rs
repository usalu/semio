//! 🧪️ `replace-reference-source` fixture — `🖇️repoints-reference-1-source`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️replace-reference-source/🖇️repoints-reference-1-source/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️replace-reference-source/🖇️repoints-reference-1-source/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️replace-reference-source/🖇️repoints-reference-1-source/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️replace-reference-source/🖇️repoints-reference-1-source/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️replace-reference-source/🖇️repoints-reference-1-source/🎯️outcome/🔣️.json");
