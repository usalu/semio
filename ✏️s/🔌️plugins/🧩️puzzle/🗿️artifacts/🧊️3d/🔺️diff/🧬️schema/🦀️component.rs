...
pub struct Puzzle3dDiff {
    #[state(persistent)] pub artifact: Option<Box<Puzzle3dArtifact>>,
    #[state(persistent)] pub schema: Option<String>,
    #[state(persistent)] pub domain: Option<String>,
    #[state(persistent)] pub meta: Option<Puzzle3dMeta>,
    #[state(persistent)] pub objects: Option<Puzzle3dObjectsDelta>,
    #[state(persistent)] pub attractions: Option<Puzzle3dAttractionsDelta>,
    #[state(persistent)] pub target_volumes: Option<Puzzle3dTargetVolumesDelta>,
    #[state(persistent)] pub references: Option<Puzzle3dReferencesDelta>,
    #[state(shared_ui)] pub selected_object_ids: Option<Puzzle3dStringList>,
    #[state(shared_ui)] pub selected_vortex_ids: Option<Puzzle3dStringList>,
    #[state(shared_ui)] pub selected_attraction_ids: Option<Puzzle3dStringList>,
    #[state(shared_ui)] pub selected_target_volume_ids: Option<Puzzle3dStringList>,
    #[state(shared_ui)] pub selected_reference_ids: Option<Puzzle3dStringList>,
    ...
    #[state(local_ui)] pub grid_spacing: Option<f64>,
    ...
    #[state(local_ui)] pub lod_automatic: Option<bool>,
    #[state(local_ui)] pub lod_depth_variable: Option<bool>,
    #[state(local_ui)] pub lod_manual: Option<f64>,
    #[state(local_ui)] pub proximity_radius: Option<f64>,
    ...
    #[state(preview)] pub hovered_kind_id: Option<Option<String>>,
