//! 🔗️ Puzzle 3d play app commands — attractions: creating one from a vortex-to-vortex drag (kept
//! non-moving by deriving its six connection parameters from the endpoints' CURRENT poses) and
//! deleting one by id.
