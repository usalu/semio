...
fn default_vortex_show() -> String {
    crate::apps::puzzle3d::PUZZLE3D_VORTEX_SHOW_SELECTED.into()
}

fn default_vortex_direction() -> String {
    crate::apps::puzzle3d::PUZZLE3D_VORTEX_DIRECTION_OUTWARDS.into()
}
...
fn default_window_ids() -> Vec<String> {
    vec![crate::apps::puzzle3d::modes::edit::windows::main::WINDOW_KIND_ID.to_string()]
}
//#endregion 🔖️Defaults
