...
//#region 🔖️Reexports
pub use crate::apps::puzzle3d::precompute::brush::apply_brush_placement_to_fixture;
...
/// `crate::apps::puzzle3d::PUZZLE3D_FILL_COUNT_MAX` slider clamp.
pub(crate) const FILL_COUNT_MAX: usize = 1000;
//#endregion 🔖️Constants

use crate::apps::puzzle3d::precompute::brush::{
...
use crate::apps::puzzle3d::precompute::fill::{FillBuilder, PlacedCollisionEntry};
use crate::apps::puzzle3d::precompute::geometry::{pose_isometry, solid_overlap_volume, world_bounds, world_volumes_contain_aabb, CollisionBody};
...
impl Puzzle3dCollision {
    ...
    fn install_collision_mesh(&mut self, url: String, positions: &[f32], indices: &[u32], is_fallback: bool) {
        let Some(body) = crate::apps::puzzle3d::precompute::geometry::collision_body_from_buffers(positions, indices) else {
            return;
        };
...
mod tests {
    ...
    /// surface under `crate::apps::puzzle3d::precompute::…`. A rename or a visibility narrowing breaks
