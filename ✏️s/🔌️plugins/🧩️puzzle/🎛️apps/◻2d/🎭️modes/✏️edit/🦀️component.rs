...
pub fn render_canvas(document_json: &str, envelope: &Puzzle2dScene, pane: &str) -> UiNode {
    build_board2d_scene(format!("{PUZZLE2D_PLAY_SURFACE_ID}.{pane}"), crate::apps::puzzle2d::PUZZLE2D_PLAY_CONTROLLER_ID, puzzle2d_board_scene(document_json, envelope, pane))
}
//#endregion 🔖️Canvas
