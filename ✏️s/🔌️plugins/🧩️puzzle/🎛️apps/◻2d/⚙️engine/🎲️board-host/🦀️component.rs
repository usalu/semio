...
use crate::apps::puzzle2d::engine::icons::puzzle_themed_icon_lookup;
...
pub(crate) mod testkit {
    ...
    use crate::apps::puzzle2d::engine::{BoardHost, EdgeDescJson, HandleDescJson, NodeDescJson, SceneDescriptorJson};
    use serde_json::json;
...
mod tests {
    use super::testkit::*;
    use crate::apps::puzzle2d::engine::canvas;
    use crate::apps::puzzle2d::engine::canvas::geom_sel::cubic_bezier_point;
    ...
    fn puzzle2d_default_manifest_satisfies_board_host_validation() {
        let manifest: serde_json::Value = serde_json::from_str(include_str!("../../../../🗿️artifacts/◻2d/🛂️manifest.jsondefault.manifest.json")).unwrap();
