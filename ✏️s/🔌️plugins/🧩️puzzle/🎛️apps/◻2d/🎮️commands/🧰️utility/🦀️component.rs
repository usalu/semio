//! 🧰️ Puzzle 2d play app commands — the utility switch. B1: this command IS the switch now (was
//! host-applied ambient `view_state.active_utility_id`), so it must persist the new value itself
//! before clearing any in-progress brush/fill scratch.

use crate::apps::puzzle2d::modes::edit::windows::overview;
use crate::apps::puzzle2d::{Puzzle2dActionCtx, PUZZLE2D_PANES};
