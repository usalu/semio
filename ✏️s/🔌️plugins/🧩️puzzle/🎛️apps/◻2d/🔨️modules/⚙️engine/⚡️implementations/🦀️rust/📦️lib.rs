...
mod host_tests {
    ...
    fn puzzle2d_default_manifest_satisfies_board_host_validation() {
        let manifest: serde_json::Value = serde_json::from_str(include_str!("../../../../../../../../../✏️s/🔌️plugins/🧩️puzzle/🎛️apps/◻2d/⚡️implementations/🦀️rust/🛂️manifest/🛂️manifest.jsondefault.manifest.json")).unwrap();
    ...
    fn board_host_fill_base_core_rectangular_excludes_cylindric_tambour() {
        ...
        let fixture: serde_json::Value = serde_json::to_value(
            <puzzle_2d::Puzzle2dProjection as store::DocumentDsl>::parse_dsl(include_str!("../../../../../../../../../✏️s/🔌️plugins/🧩️puzzle/🎛️apps/◻2d/⚡️implementations/🦀️rust/📚️examples/🧩️nakagin-capsule-tower.puzzle2d")).unwrap(),
        )
        .unwrap();
