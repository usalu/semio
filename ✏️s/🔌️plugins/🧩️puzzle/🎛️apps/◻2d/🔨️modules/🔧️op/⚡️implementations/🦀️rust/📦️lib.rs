...
// `.🦑️repo/🎫️tickets/…/convertpuzzle2d3d5dtotypeddslderiveengine`). Bridging `Puzzle2dOperation`/`Puzzle2dDiff`
...
/// 🌱️ `puzzle-plugin`'s `Puzzle2dPlayApp` predates the typed `Puzzle2dProjection` above and stays on
