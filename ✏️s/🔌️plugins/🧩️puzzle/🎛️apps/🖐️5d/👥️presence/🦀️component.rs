...
impl protocol::MutationDiff<Puzzle5dPresence> for Puzzle5dPresence {
    fn apply(&self, _base: &Puzzle5dPresence) -> Puzzle5dPresence {
        self.clone()
    }
...
impl store::DocumentDsl for Puzzle5dPresence {
...
impl DocumentPack for Puzzle5dPresence {
...
impl Mutation<Puzzle5dPresence> for Puzzle5dPresenceMutation {
    ...
    fn diff(&self, _base: &Puzzle5dPresence) -> Puzzle5dPresence {
        match self {
