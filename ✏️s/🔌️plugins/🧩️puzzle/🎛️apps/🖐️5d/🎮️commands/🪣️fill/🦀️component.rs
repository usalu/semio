//! 🪣️ Puzzle 5d play app commands — the fill generator: `setFillCount` re-drives the engine plan and
//! adopts the resulting fixture (which also switches the active utility to `fill`).

use crate::apps::puzzle5d::{merge_engine_fixture, Puzzle5dActionCtx, PUZZLE5D_FILL_COUNT_MAX};
