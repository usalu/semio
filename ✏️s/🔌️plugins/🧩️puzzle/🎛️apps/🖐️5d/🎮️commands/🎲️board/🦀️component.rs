//! 🎲️ Puzzle 5d play app commands — the Board2d surface's batched event stream (camera, marquee,
//! node drags, brush placements, edge create/delete), replayed onto the scene in order.
