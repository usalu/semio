// #region 🧲️Header
// 💻️ ✏️s/🔌️plugins/🧩️puzzle/📖️stories/🎭️2d-fixtures/🧪️.story.tsx
...
import concreteForestFixtureDsl from "../../🗿️artifacts/◻️2d/🏅️standards/🔖️1/🪆️subsets/✳️any/📚️examples/🌲️concrete-forest/🖼️assets/🌲️forest/🗣️.dsl.semio?raw";
...
function loadPuzzle2dWasm(): Promise<Puzzle2dWasmModule> {
  if (!puzzle2dWasmModulePromise) {
    puzzle2dWasmModulePromise = import("../../📦️packages/🦀️rust/pkg/semio_puzzle.js").then(async (mod) => {
