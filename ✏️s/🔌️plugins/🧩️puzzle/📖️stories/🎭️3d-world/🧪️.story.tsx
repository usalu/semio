// #region 🧲️Header
// 💻️ ✏️s/🔌️plugins/🧩️puzzle/📖️stories/🎭️3d-world/🧪️.story.tsx
...
import concreteForestFixtureDsl from "../../🗿️artifacts/🧊️3d/🏅️standards/🔖️1/🪆️subsets/✳️any/📚️examples/🌲️concrete-forest/🖼️assets/🌲️forest/🗣️.dsl.semio?raw";
import nakaginCapsuleTowerFixtureDsl from "../../🗿️artifacts/🧊️3d/🏅️standards/🔖️1/🪆️subsets/✳️any/📚️examples/🏗️nakagin-capsule-tower/🖼️assets/🏢️tower/🗣️.dsl.semio?raw";

import abbauAufbauReferenceUrl from "../../../../../🧰️framework/🛍️products/💻️os/🔨️modules/♾️infinite/🖼️assets/🏘️abbau-aufbau-masterarbeit-grundriss/🖼️.jpg";
import rathausAhlenReferenceUrl from "../../../../../🧰️framework/🛍️products/💻️os/🔨️modules/♾️infinite/🖼️assets/🏛️rathaus-ahlen-grundriss/🖼️.png";
...
function loadPuzzle3dWasm(): Promise<Puzzle3dWasmModule> {
  if (!puzzle3dWasmModulePromise) {
    puzzle3dWasmModulePromise = import("../../📦️packages/🦀️rust/pkg/semio_puzzle.js").then(async (mod) => {
...
function buildStoryWorld3dSceneNode(state: StoryWorld3dState): UiComponentSceneNode {
  ...
  // 📦️ No `url`/`data` on purpose (see header docstring) — falls back to `World3dHost`'s neutral placeholder box per instance.
...
/** 🌲️ The real Concrete Forest 3D world fixture (`puzzle/3d/example/concrete-forest.puzzle3d`) — 1 object, 2 locked/hidden reference planes. */
...
/** 🏯️ The real Nakagin Capsule Tower 3D world fixture (`puzzle/3d/example/nakagin-capsule-tower.puzzle3d`) — 180 objects. */
