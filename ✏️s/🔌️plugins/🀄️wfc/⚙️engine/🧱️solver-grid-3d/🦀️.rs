//! 🧊️ `Grid3dSolver`: dense 3D grid solving. Exactly [`crate::solver_grid2d`]'s design extended to
...
use crate::constraint::{build_adjacency_view, AdjacencyView, ConstraintSet, Constraints};
