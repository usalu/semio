...
use crate::soft::ScoreFn;
use crate::topology::GraphTopologyBuilder;

fn checkerboard(n: usize) -> (crate::model::CompiledModel, crate::topology::GraphTopology) {
    ...
    for i in 0..n.saturating_sub(1) {
        tb.arc(crate::ids::NodeId::from_index(i), crate::ids::NodeId::from_index(i + 1), adj);
        tb.arc(crate::ids::NodeId::from_index(i + 1), crate::ids::NodeId::from_index(i), adj);
    }
