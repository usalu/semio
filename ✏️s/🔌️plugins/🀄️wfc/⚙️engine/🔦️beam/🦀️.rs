...
pub fn beam_search<T: Topology>(model: &CompiledModel, topo: &T, beam_config: BeamConfig, seed: u64, init_domains: Option<&[PatternSet]>, fixed: &[(NodeId, PatternId)]) -> SolveOutcome {
