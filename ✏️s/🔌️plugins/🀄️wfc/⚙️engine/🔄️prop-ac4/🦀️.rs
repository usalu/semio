...
impl Ac4Engine {
    ...
    pub fn count_at(&self, slot: usize, p: PatternId) -> u32 {
    ...
    pub fn debug_assert_consistent<T: Topology>(&self, model: &CompiledModel, topo: &T, domains: &DomainStore) {
