...
/// solved so far.
pub fn chunk_seed(world_seed: u64, chunk_x: i64, chunk_y: i64, model_fingerprint: u64) -> u64 {
...
pub fn solve_chunk<T: Topology + Clone + Send>(model: &CompiledModel, topo: &T, config: &SearchConfig, world_seed: u64, chunk_x: i64, chunk_y: i64, init_domains: Option<&[PatternSet]>, seam_fixed: &[(NodeId, PatternId)]) -> SolveOutcome {
