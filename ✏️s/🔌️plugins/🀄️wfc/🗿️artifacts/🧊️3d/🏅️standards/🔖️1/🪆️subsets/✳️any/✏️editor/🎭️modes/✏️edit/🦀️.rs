...
pub fn definition() -> ModeDefinition {
    ModeDefinition { id: WFC_3D_EDIT_MODE_ID.into(), label: LocalizedLabel::native("Edit", "Bearbeiten"), icon_id: "pencil".into(), tools: vec![fill::TOOL_ID.into()], layout_id: None, commands: Vec::new() }
}
