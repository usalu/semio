...
/// crate: production dispatch (`Mutation::diff(..).apply_to`) and the mutation's own inverse over `Wfc3dConfig`.
///
/// @see store::os_store::test_support::mutation_report_json
pub fn wfc3d_config_mutation_report_json(base_json: &str, mutation_json: &str, after_json: &str) -> Result<String, String> {
    store::os_store::test_support::mutation_report_json::<Wfc3dConfig, Wfc3dConfigMutation>(base_json, mutation_json, after_json)
}
