//! 🦀️ wfc3d 1 exhaustive mutation case — Rust adapter, the SUBJECT half.
//!
...
//! production codec and `Mutation` implementation (`wfc3d_mutation_report_json`) and asserts, in role, the laws of
