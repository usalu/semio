...
fn inverse_restores_before() {
    ...
    assert_eq!(snapshot, base, "change-tile-weight/⚖️raises-the-wall-tile-bias: inverse did not restore the before-snapshot");
}
...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            assert_eq!(snapshot, before(), "change-tile-weight/⚖️raises-the-wall-tile-bias: a rejected mutation must leave the snapshot untouched");
        }
