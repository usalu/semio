//! 🎚️ `s.wfc.wfc2d` ✏️editor/🎚️config state-lane mutation case — Rust adapter.
//!
//! Recorded no-oracle decision `wfc-wfc2d-1-any-editor-config-state-lane-semantics`: the runner dispatches no oracle role, so every law is asserted inside
//! the subject handlers through `semio_s_plugin_stdio_test_oracle::law::vector` over the report of this crate's
//! production bridge `wfc2d_config_mutation_report_json`. The oracle handlers answer with the committed after- and before-snapshots read
...
fn vector(kind: &str) -> Result<Vector, String> {
    Ok(match kind {
        "change-active-tile" => Vector {
            before: include_str!("../../✏️editor/🎚️config/🧫️fixtures/🀄️change-active-tile/✅️change-active-tile-applied/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../✏️editor/🎚️config/🧫️fixtures/🀄️change-active-tile/✅️change-active-tile-applied/🦠️mutation/🔣️.json"),
            after: include_str!("../../✏️editor/🎚️config/🧫️fixtures/🀄️change-active-tile/✅️change-active-tile-applied/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../✏️editor/🎚️config/🧫️fixtures/🀄️change-active-tile/✅️change-active-tile-applied/🔺️diff/🔣️.json"),
            outcome: include_str!("../../✏️editor/🎚️config/🧫️fixtures/🀄️change-active-tile/✅️change-active-tile-applied/🎯️outcome/🔣️.json"),
            observable: true,
        },
