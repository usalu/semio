//! ✏️ EN 1999 play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::en1999::create_en1999_app`. Every norm app declares
