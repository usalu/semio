...
//! `crate::apps::en1999`, and everything the fifteen norm apps share verbatim (config,
...
impl ArtifactApp for En1999PlayApp {
    ...
    fn render(body_key: &str, doc: &ArtifactView<'_, En1999Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
...
pub(crate) mod testkit {
    ...
    pub type NormApp = VcsArtifactApp<En1999PlayApp>;
