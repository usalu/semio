...
impl DocumentApp for En1999PlayApp {
    ...
    fn command_id(&self, command: &En1999Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1999Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
