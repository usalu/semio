...
semio_framework_plugin::app_commands! {
    ...
    pub enum En1999Command for Document, Operation, NormConfig, NormConfigOperation {
...
impl DocumentApp for En1999PlayApp {
    ...
    fn handle(command: &En1999Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<Operation, NormConfigOperation, Self::DraftOperation>, Fault> {
