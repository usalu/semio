...
impl DocumentApp for En1995PlayApp {
    ...
    fn command_id(&self, command: &En1995Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1995Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
