...
//! `crate::apps::en1995`, and everything the fifteen norm apps share verbatim (config,
...
impl ArtifactApp for En1995PlayApp {
    ...
    fn handle(command: &En1995Command, doc: &ArtifactView<'_, En1995Snapshot>, cfg: &ConfigView<'_, NormConfig>, _interaction: &InteractionView<'_>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1995Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
...
pub(crate) mod testkit {
    ...
    pub type NormApp = VcsArtifactApp<En1995PlayApp>;
