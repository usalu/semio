...
impl ArtifactApp for En1995PlayApp {
    ...
    fn handle(command: &En1995Command, doc: &ArtifactView<'_, En1995Snapshot>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1995Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
