...
use crate::artifacts::en1995::op::Operation;
...
semio_framework_plugin::app_commands! {
    ...
    pub enum En1995Command for Document, Operation, NormConfig, NormConfigOperation {
...
impl DocumentApp for En1995PlayApp {
    ...
    fn handle(command: &En1995Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<Operation, NormConfigOperation, Self::DraftOperation>, Fault> {
