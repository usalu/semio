...
use crate::artifacts::en1995::engine::En1995Family;
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1995Family>, selected_check_index: Option<u32>) -> UiNode {
...
mod tests {
    ...
    fn an_out_of_range_selected_index_falls_back_to_the_first_check() {
        let host = NormHost::<En1995Family>::from_document(crate::artifacts::en1995::Document::default());
