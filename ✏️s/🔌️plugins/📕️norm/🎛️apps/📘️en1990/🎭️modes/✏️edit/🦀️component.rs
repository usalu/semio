//! ✏️ EN 1990 play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::en1990::create_en1990_app`. Every norm app declares
