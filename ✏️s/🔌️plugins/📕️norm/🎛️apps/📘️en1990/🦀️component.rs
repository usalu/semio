...
impl DocumentApp for En1990PlayApp {
    ...
    fn command_id(&self, command: &En1990Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1990Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
