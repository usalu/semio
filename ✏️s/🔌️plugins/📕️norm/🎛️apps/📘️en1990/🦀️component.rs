...
impl ArtifactApp for En1990PlayApp {
    ...
    fn handle(command: &En1990Command, doc: &ArtifactView<'_, En1990Snapshot>, cfg: &ConfigView<'_, NormConfig>, _interaction: &InteractionView<'_>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1990Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
