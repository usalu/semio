...
//! `crate::apps::en1990`, and everything the fifteen norm apps share verbatim (config,
//! media ports, render primitives, manifest constructors) in `crate::document::app` / `crate::document::config`.

use crate::apps::en1990::commands::{evaluate, selected_check, set_snapshot};
use crate::apps::en1990::modes::edit as edit_mode;
use crate::apps::en1990::modes::edit::windows::{inputs, results};
use crate::apps::en1990::panels::{catalogue as catalogue_panel, document as document_panel, inspection as inspection_panel};
use crate::apps::en1990::En1990Family;
...
impl ArtifactApp for En1990PlayApp {
    ...
    const APP_ID: &'static str = "norm-en-1990-play";
    ...
    fn handle(command: &En1990Command, doc: &ArtifactView<'_, En1990Snapshot>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1990Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
        command.dispatch(doc, cfg)
    }

    fn render(body_key: &str, doc: &ArtifactView<'_, En1990Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
...
pub(crate) mod testkit {
    ...
    pub type NormApp = VcsArtifactApp<En1990PlayApp>;
...
mod tests {
    ...
    fn declares_model_in_and_report_out_ports() {
        let ports = create_en1990_app().definition.io.ports;
