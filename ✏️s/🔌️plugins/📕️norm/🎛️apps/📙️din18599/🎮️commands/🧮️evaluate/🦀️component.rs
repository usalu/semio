...
//#region 🔖️Handler
pub fn handle(_payload: &Evaluate, doc: &DocumentView<'_, Din18599Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Din18599Mutation, NormConfigMutation>, Fault> {
...
mod tests {
    ...
    fn handle_recommits_the_current_projection_under_its_action_id() {
        ...
        assert_eq!(emit.document_mutations, vec![Din18599Mutation::SetSnapshot { snapshot: Din18599Snapshot::default() }]);
