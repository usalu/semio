...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::din18599::create_din18599_app`.
...
//#region 🔖️Render
pub fn render(host: &NormHost<DinV18599Family>) -> UiNode {
...
mod tests {
    use super::*;
    use crate::apps::din18599::testkit;
