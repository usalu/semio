//! ✏️ DIN V 18599 play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::din18599::create_din18599_app`. Every norm app declares
