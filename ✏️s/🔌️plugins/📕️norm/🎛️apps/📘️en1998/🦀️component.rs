...
impl DocumentApp for En1998PlayApp {
    ...
    fn command_id(&self, command: &En1998Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1998Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
