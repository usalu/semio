...
semio_framework_plugin::app_commands! {
    ...
    pub enum En1998Command for Document, Operation, NormConfig, NormConfigOperation {
...
impl DocumentApp for En1998PlayApp {
    ...
    fn command_id(command: &En1998Command) -> &str {
        command.command_id()
    }

    fn handle(command: &En1998Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<Operation, NormConfigOperation, Self::DraftOperation>, Fault> {
    ...
    fn export_media(port: &str, doc: &DocumentView<'_, Document>) -> Result<Media, MediaError> {
        crate::core::app::export_media::<En1998Family>(port, VARIANT, DOCUMENT_SCHEMA, doc.projection)
    }
