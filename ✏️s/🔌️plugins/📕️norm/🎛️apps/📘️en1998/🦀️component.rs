...
impl DocumentApp for En1998PlayApp {
    ...
    fn handle(command: &En1998Command, doc: &DocumentView<'_, En1998Snapshot>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1998Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
        command.dispatch(doc, cfg)
    }

    fn render(body_key: &str, doc: &DocumentView<'_, En1998Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
    ...
    fn export_media(port: &str, doc: &DocumentView<'_, En1998Snapshot>) -> Result<Media, MediaError> {
...
mod tests {
    ...
    fn every_command() -> Vec<En1998Command> {
        vec![
            En1998Command::SetSnapshot(set_snapshot::SetSnapshot { snapshot: En1998Snapshot::default() }),
