//! ✏️ EN 1998 play app — the `edit` mode: the inputs/results authoring layout.

use crate::apps::en1998::modes::edit::windows::{inputs, results};
use semio_framework_plugin::{create_default_layout, ModeDefinition, WindowLayout};

//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::en1998::create_en1998_app`. Every norm app declares
