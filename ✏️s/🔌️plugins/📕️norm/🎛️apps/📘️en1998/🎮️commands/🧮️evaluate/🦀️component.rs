//! 🧮️ EN 1998 play app command — recompute the compliance report in place.
//!
...
//#region 🔖️Handler
pub fn handle(_payload: &Evaluate, doc: &ArtifactView<'_, En1998Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1998Mutation, NormConfigMutation>, Fault> {
    crate::app_surface::commit_snapshot(En1998Mutation::SetSnapshot { snapshot: doc.snapshot.clone() }, "evaluate")
}
//#endregion 🔖️Handler
...
mod tests {
    ...
    fn handle_recommits_the_current_projection_under_its_action_id() {
        let projection = En1998Snapshot::default();
        ...
        assert_eq!(emit.artifact_mutations, vec![En1998Mutation::SetSnapshot { snapshot: En1998Snapshot::default() }]);
