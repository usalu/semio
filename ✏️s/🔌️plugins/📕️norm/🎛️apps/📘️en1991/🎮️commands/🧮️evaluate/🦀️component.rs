...
//#region 🔖️Handler
pub fn handle(_payload: &Evaluate, doc: &ArtifactView<'_, En1991Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1991Mutation, NormConfigMutation>, Fault> {
    crate::app_surface::commit_snapshot(En1991Mutation::SetSnapshot { snapshot: doc.snapshot.clone() }, "evaluate")
}
//#endregion 🔖️Handler
