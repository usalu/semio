...
//#region 🔖️Handler
pub fn handle(_payload: &Evaluate, doc: &DocumentView<'_, En1991Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1991Mutation, NormConfigMutation>, Fault> {
...
mod tests {
    ...
    fn handle_recommits_the_current_projection_under_its_action_id() {
        ...
        assert_eq!(emit.document_mutations, vec![SetDocumentMutation::SetDocument { document: En1991Snapshot::default() }]);
