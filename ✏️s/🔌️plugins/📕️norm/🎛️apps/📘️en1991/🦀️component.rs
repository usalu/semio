...
semio_framework_plugin::app_commands! {
    ...
    pub enum En1991Command for Document, Operation, NormConfig, NormConfigOperation {
...
impl DocumentApp for En1991PlayApp {
    ...
    fn command_id(command: &En1991Command) -> &str {
        command.command_id()
    }

    fn handle(command: &En1991Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<Operation, NormConfigOperation, Self::DraftOperation>, Fault> {
