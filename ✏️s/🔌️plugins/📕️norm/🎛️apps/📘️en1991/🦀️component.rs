...
impl DocumentApp for En1991PlayApp {
    ...
    fn command_id(&self, command: &En1991Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1991Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
