...
mod tests {
    ...
    fn every_command() -> Vec<En1991Command> {
        vec![
            En1991Command::SetSnapshot(set_snapshot::ReplaceSnapshot { snapshot: En1991Snapshot::default() }),
    ...
    fn set_snapshot_commits_a_host_backed_report() {
        let mut app = testkit::new_app();
        testkit::dispatch(&mut app, En1991Command::SetSnapshot(set_snapshot::ReplaceSnapshot { snapshot: En1991Snapshot::default() }));
