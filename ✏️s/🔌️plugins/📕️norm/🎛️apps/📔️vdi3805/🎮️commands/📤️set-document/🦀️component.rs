//! 📤️ VDI 3805 play app command — replace the whole compliance document.
//!
...
//#region 🔖️Handler
pub fn handle(payload: &SetDocument, _doc: &DocumentView<'_, Document>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Vdi3805Mutation, NormConfigMutation>, Fault> {
