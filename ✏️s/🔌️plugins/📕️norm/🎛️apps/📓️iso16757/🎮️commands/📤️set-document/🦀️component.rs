//! 📤️ ISO 16757 play app command — replace the whole compliance document.
//!
...
//#region 🔖️Handler
pub fn handle(payload: &SetDocument, _doc: &DocumentView<'_, Document>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Iso16757Mutation, NormConfigMutation>, Fault> {
