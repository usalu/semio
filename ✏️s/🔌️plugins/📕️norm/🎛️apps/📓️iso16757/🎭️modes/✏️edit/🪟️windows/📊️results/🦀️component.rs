...
pub const BODY_RESULTS: &str = "norm.iso16757.play.results";
//#endregion 🔖️Constants

//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::iso16757::create_iso16757_app`.
...
mod tests {
    use super::*;
    use crate::apps::iso16757::testkit;
