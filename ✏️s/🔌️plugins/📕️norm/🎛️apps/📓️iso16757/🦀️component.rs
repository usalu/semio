...
semio_framework_plugin::app_commands! {
    ...
    pub enum Iso16757Command for Document, Operation, NormConfig, NormConfigOperation {
...
impl DocumentApp for Iso16757PlayApp {
    ...
    fn handle(command: &Iso16757Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<Operation, NormConfigOperation, Self::DraftOperation>, Fault> {
