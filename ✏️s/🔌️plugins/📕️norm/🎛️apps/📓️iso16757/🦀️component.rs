...
impl DocumentApp for Iso16757PlayApp {
    ...
    fn command_id(&self, command: &Iso16757Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &Iso16757Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
