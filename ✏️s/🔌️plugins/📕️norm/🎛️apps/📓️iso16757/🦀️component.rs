...
impl ArtifactApp for Iso16757PlayApp {
    ...
    fn handle(command: &Iso16757Command, doc: &ArtifactView<'_, Iso16757Snapshot>, cfg: &ConfigView<'_, NormConfig>, _interaction: &InteractionView<'_>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<Iso16757Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
...
pub(crate) mod testkit {
    ...
    pub type NormApp = VcsArtifactApp<Iso16757PlayApp>;
