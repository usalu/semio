//! 🧲️ EN 1994 play app — the `ArtifactApp` impl (dispatch-only), the aggregated command enum and
//! the manifest stitch.
//!
...
semio_framework_plugin::app_commands! {
    /// 🎯️ `En1994PlayApp::Command` — the SOLE dispatch surface for this app's own behavior, covering every
...
mod tests {
    ...
    /// 🎯️ One value per `En1994Command` row — the whole-command-surface laws below iterate it, so a new row
