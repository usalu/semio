...
impl DocumentApp for En1994PlayApp {
    ...
    fn handle(command: &En1994Command, doc: &DocumentView<'_, En1994Snapshot>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1994Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
