...
mod tests {
    ...
    fn every_command() -> Vec<Din4108Command> {
        vec![
            Din4108Command::SetSnapshot(set_snapshot::ReplaceSnapshot { snapshot: Din4108Snapshot::default() }),
    ...
    fn set_snapshot_commits_a_host_backed_report() {
        let mut app = testkit::new_app();
        testkit::dispatch(&mut app, Din4108Command::SetSnapshot(set_snapshot::ReplaceSnapshot { snapshot: Din4108Snapshot::default() }));
