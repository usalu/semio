...
use din16798::Document;
use norm_core::{AnnexChoice, CheckReport, CheckResult, ClauseId, NormFamily, NormFamilyId, NormHost, OccupancyType, Quantity};
...
impl NormFamily for DinEn16798Family {
    ...
    type Operation = norm_core::SetDocumentOperation<Document>;
