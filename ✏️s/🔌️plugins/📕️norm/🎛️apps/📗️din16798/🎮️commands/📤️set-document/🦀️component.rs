//! 📤️ DIN EN 16798 play app command — replace the whole compliance document.
//!
...
//#region 🔖️Handler
pub fn handle(payload: &SetDocument, _doc: &DocumentView<'_, Document>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Din16798Mutation, NormConfigMutation>, Fault> {
