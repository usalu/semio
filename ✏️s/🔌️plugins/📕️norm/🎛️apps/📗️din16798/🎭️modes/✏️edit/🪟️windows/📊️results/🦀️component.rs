...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::apps::din16798::create_din16798_app`.
...
//#region 🔖️Render
pub fn render(host: &NormHost<DinEn16798Family>) -> UiNode {
...
mod tests {
    use super::*;
    use crate::apps::din16798::testkit;
