...
impl DocumentApp for En1996PlayApp {
    ...
    fn command_id(&self, command: &En1996Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1996Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
