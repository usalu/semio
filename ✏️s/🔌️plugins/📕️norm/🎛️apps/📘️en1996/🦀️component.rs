...
impl ArtifactApp for En1996PlayApp {
    ...
    fn handle(command: &En1996Command, doc: &ArtifactView<'_, En1996Snapshot>, cfg: &ConfigView<'_, NormConfig>, _interaction: &InteractionView<'_>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1996Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
