...
//! `crate::apps::en1996`, and everything the fifteen norm apps share verbatim (config,
//! media ports, render primitives, manifest constructors) in `crate::document::app` / `crate::document::config`.

use crate::apps::en1996::commands::{evaluate, selected_check, set_snapshot};
use crate::apps::en1996::modes::edit as edit_mode;
use crate::apps::en1996::modes::edit::windows::{inputs, results};
use crate::apps::en1996::panels::{catalogue as catalogue_panel, document as document_panel, inspection as inspection_panel};
use crate::apps::en1996::En1996Family;
...
pub const APP_ID: &str = "norm-en-1996-play";
...
impl ArtifactApp for En1996PlayApp {
    ...
    const APP_ID: &'static str = "norm-en-1996-play";
    ...
    fn handle(command: &En1996Command, doc: &ArtifactView<'_, En1996Snapshot>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1996Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
...
pub fn create_en1996_app() -> App {
    ...
    .example("default", LocalizedLabel::native("Default", "Standard"), serde_json::to_string(&En1996Snapshot::default()).expect("default document serializes"), "file")
...
pub(crate) mod testkit {
    ...
    pub type NormApp = VcsArtifactApp<En1996PlayApp>;

    pub fn new_app() -> NormApp {
        sdk_new_app::<En1996PlayApp>()
    }
    ...
    pub fn app_with_registry() -> NormApp {
        new_app_with_registry::<En1996PlayApp>(create_en1996_app)
    }
...
mod tests {
    ...
    fn the_manifest_stitches_every_taxonomy_node() {
        let definition = create_en1996_app().definition;
    ...
    fn declares_model_in_and_report_out_ports() {
        let ports = create_en1996_app().definition.io.ports;
