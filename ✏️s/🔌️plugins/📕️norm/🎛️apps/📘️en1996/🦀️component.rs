...
semio_framework_plugin::app_commands! {
    ...
    pub enum En1996Command for Document, Operation, NormConfig, NormConfigOperation {
...
impl DocumentApp for En1996PlayApp {
    ...
    fn handle(command: &En1996Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<Operation, NormConfigOperation, Self::DraftOperation>, Fault> {
