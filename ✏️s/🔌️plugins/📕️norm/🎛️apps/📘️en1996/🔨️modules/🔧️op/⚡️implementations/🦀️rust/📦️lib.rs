//! ⚡️ EN 1996 app — operation type + family + laws (constitutional: op).
//!
...
//! impls are blanket ones bounded on `D: DocumentDsl`/`DocumentPack`, satisfied for free by `en1996`'s
...
impl NormFamily for En1996Family {
    ...
    fn evaluate(document: &Document) -> CheckReport {
        en1996_engine::evaluate(document)
    }
}
