...
//! those entity enums, re-importing the types from `en1996::part_2`.

use en1996::{Document, MasonryClass};
...
pub mod na_de {
    ...
    pub fn gamma_m() -> f64 {
        super::AnnexParams { annex: norm_core::AnnexChoice::De, masonry_class: en1996::MasonryClass::default(), accidental: false }.gamma_m()
    }
}
...
// #region 🔖️Part2
/// 🧱️ EN 1996-2 selection of materials & execution: exposure-class durability admissibility and bed-joint execution checks. `ExposureClass`/`MortarClass` live in `en1996::part_2` (Document field types); this submodule holds only the compute functions.
pub mod part_2 {
    use super::*;
    use en1996::part_2::{ExposureClass, MortarClass};
...
/// `en1996::Document` type across the crate boundary (Rust's orphan rule).
...
mod tests {
    ...
    fn exposure_mortar_mx1_clay_m1_admissible() {
        let result = part_2::check_exposure_mortar(en1996::part_2::ExposureClass::Mx1, MasonryUnit::Clay, en1996::part_2::MortarClass::M1);
        assert_eq!(result.status, CheckStatus::Pass);
    }

    #[test]
    fn exposure_mortar_mx4_aac_inadmissible() {
        let result = part_2::check_exposure_mortar(en1996::part_2::ExposureClass::Mx4, MasonryUnit::Aac, en1996::part_2::MortarClass::M20);
