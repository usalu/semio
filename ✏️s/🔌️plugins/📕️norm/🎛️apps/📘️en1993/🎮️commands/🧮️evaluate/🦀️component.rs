...
//#region 🔖️Handler
pub fn handle(_payload: &Evaluate, doc: &ArtifactView<'_, En1993Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1993Mutation, NormConfigMutation>, Fault> {
...
mod tests {
    ...
    fn handle_recommits_the_current_projection_under_its_action_id() {
        ...
        assert_eq!(emit.artifact_mutations, vec![En1993Mutation::SetSnapshot { snapshot: En1993Snapshot::default() }]);
