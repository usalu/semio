//! 🖥️ EN 1993 design of steel structures — `DocumentApp` impl, render, manifest (constitutional: ui).
//!
//! 🏗️ Unlike most constitutional apps, this slot is intentionally empty: the original
//! `s/plugin/norm/en/1993/rs/lib.rs` monolith never defined an `En1993PlayApp`/`DocumentApp`/`create_app`
