...
impl DocumentApp for En1993PlayApp {
    ...
    fn command_id(&self, command: &En1993Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1993Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
