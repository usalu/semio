...
//! `crate::apps::en1997`, and everything the fifteen norm apps share verbatim (config,
...
impl ArtifactApp for En1997PlayApp {
    ...
    fn handle(command: &En1997Command, doc: &ArtifactView<'_, En1997Snapshot>, cfg: &ConfigView<'_, NormConfig>, _interaction: &InteractionView<'_>, _draft: &DraftView<'_, Self::Draft>, _engines: &EngineHandles) -> Result<Emit<En1997Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
...
impl crate::document::NormFamily for En1997Family {
    ...
    fn evaluate(document: &En1997Snapshot) -> crate::document::CheckReport {
        crate::artifacts::en1997::standards::v1::subsets::any::schema::inferences::evaluate(document)
    }
}
