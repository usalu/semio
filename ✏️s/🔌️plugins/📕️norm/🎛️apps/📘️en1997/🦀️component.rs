...
mod tests {
    ...
    fn every_command() -> Vec<En1997Command> {
        vec![
            En1997Command::SetSnapshot(set_snapshot::ReplaceSnapshot { snapshot: En1997Snapshot::default() }),
    ...
    fn set_snapshot_commits_a_host_backed_report() {
        let mut app = testkit::new_app();
        testkit::dispatch(&mut app, En1997Command::SetSnapshot(set_snapshot::ReplaceSnapshot { snapshot: En1997Snapshot::default() }));
