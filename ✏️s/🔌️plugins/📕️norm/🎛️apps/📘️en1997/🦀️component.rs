...
impl DocumentApp for En1997PlayApp {
    ...
    fn command_id(&self, command: &En1997Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1997Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
