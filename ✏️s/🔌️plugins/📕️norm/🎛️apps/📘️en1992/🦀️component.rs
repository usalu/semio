...
impl DocumentApp for En1992PlayApp {
    ...
    fn command_id(&self, command: &En1992Command) -> &str {
        command.command_id()
    }

    fn handle(&self, command: &En1992Command, doc: &DocumentView<'_, Document>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Operation, NormConfigOperation>, Fault> {
