...
//#region 🔖️Render
pub fn render(host: &NormHost<DinV18599Family>, windows: &semio_framework_plugin::TreeWindows<'_>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
