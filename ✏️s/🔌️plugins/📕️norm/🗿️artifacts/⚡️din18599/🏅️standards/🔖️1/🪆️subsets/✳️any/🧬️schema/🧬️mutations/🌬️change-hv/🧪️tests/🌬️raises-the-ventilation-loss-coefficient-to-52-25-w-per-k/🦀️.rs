...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-hv/🌬️raises-the-ventilation-loss-coefficient-to-52-25-w-per-k/📸️snapshot/⬅️before/🔣️.json");
...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-hv/🌬️raises-the-ventilation-loss-coefficient-to-52-25-w-per-k/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-hv/🌬️raises-the-ventilation-loss-coefficient-to-52-25-w-per-k/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-hv/🌬️raises-the-ventilation-loss-coefficient-to-52-25-w-per-k/🎯️outcome/🔣️.json");
