//! 🧬️ `update-renewables` mutation leaf.
...
pub struct UpdateRenewables {
    pub new_renewables: crate::Renewables,
}

impl protocol::MutationKind<Din18599Snapshot, Din18599Mutation> for UpdateRenewables {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor {
        verb: "update",
        entity: "renewables",
        kind: "update-renewables",
        record: "UpdatedRenewables",
    };
