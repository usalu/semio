//! 🧬️ `update-cooling` mutation leaf.
...
pub struct UpdateCooling {
    pub new_cooling: crate::CoolingSystem,
}

impl protocol::MutationKind<Din18599Snapshot, Din18599Mutation> for UpdateCooling {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor {
        verb: "update",
        entity: "cooling",
        kind: "update-cooling",
        record: "UpdatedCooling",
    };
