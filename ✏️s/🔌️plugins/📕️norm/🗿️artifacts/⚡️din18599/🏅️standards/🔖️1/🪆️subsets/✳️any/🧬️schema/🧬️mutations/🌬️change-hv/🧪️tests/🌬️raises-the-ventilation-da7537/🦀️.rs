//! 🧪️ `change-h-v` fixture — `🌬️raises-the-ventilation-loss-coefficient-to-52-25-w-per-k`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-h-v/raises-the-ventilation-loss-coefficient-to-52-25-w-per-k: produced diff differs from the committed 🔺️diff/🔣️.json");
}
