//! 🧬️ `replace-elements` mutation leaf.
...
pub struct ReplaceElements {
    pub new_elements: Vec<crate::EnvelopeElement>,
}

impl protocol::MutationKind<Din18599Snapshot, Din18599Mutation> for ReplaceElements {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor {
        verb: "replace",
        entity: "elements",
        kind: "replace-elements",
        record: "ReplacedElements",
    };
