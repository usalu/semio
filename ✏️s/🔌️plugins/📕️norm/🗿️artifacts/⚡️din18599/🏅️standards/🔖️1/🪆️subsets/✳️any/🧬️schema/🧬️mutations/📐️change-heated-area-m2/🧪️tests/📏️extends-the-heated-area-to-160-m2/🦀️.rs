//! 🧪️ `change-heated-area-m2` fixture — `📏️extends-the-heated-area-to-160-m2`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-heated-area-m2/📏️extends-the-heated-area-to-160-m2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-heated-area-m2/📏️extends-the-heated-area-to-160-m2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-heated-area-m2/📏️extends-the-heated-area-to-160-m2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-heated-area-m2/📏️extends-the-heated-area-to-160-m2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-heated-area-m2/📏️extends-the-heated-area-to-160-m2/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-heated-area-m2/extends-the-heated-area-to-160-m2: produced diff differs from the committed 🔺️diff/🔣️.json");
}
