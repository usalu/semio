...
pub struct ChangeMethod {
    pub new_method: crate::CalculationMethod,
}

impl protocol::MutationKind<Din18599Snapshot, Din18599Mutation> for ChangeMethod {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor {
        verb: "change",
        entity: "method",
        kind: "change-method",
        record: "ChangedMethod",
    };
