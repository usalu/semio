//! 🧪️ Fixture `🏷️use-class/🏢️reclassifies-the-building-as-an-office`.
use crate::{Din18599Diff, Din18599Mutation, Din18599Snapshot};

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️use-class/🏢️reclassifies-the-building-as-an-office/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️use-class/🏢️reclassifies-the-building-as-an-office/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️use-class/🏢️reclassifies-the-building-as-an-office/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️use-class/🏢️reclassifies-the-building-as-an-office/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️use-class/🏢️reclassifies-the-building-as-an-office/🎯️outcome/🔣️.json");
