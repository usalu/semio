...
#[path = "."]
mod fixture_tests {
    #[path = "🦡change-annual-limit-kwh/🧪️tests/tightens-the-annual-primary-energy-limit-to-6000-kwh/🦀️.rs"]
    mod tests_change_annual_limit_kwh_tightens_the_annual_primary_energy_limit_to_6000_kwh;
    #[path = "📐change-energy-carrier/🧪️tests/switches-the-energy-carrier-to-an-electric-heat-pump/🦀️.rs"]
    mod tests_change_energy_carrier_switches_the_energy_carrier_to_an_electric_heat_pump;
    #[path = "🐫change-ht/🧪️tests/raises-the-transmission-loss-coefficient-to-118-w-per-k/🦀️.rs"]
    mod tests_change_h_t_raises_the_transmission_loss_coefficient_to_118_w_per_k;
    #[path = "🦒change-hv/🧪️tests/raises-the-ventilation-loss-coefficient-to-52-25-w-per-k/🦀️.rs"]
    mod tests_change_h_v_raises_the_ventilation_loss_coefficient_to_52_25_w_per_k;
    #[path = "🦛change-heated-area-m2/🧪️tests/extends-the-heated-area-to-160-m2/🦀️.rs"]
    mod tests_change_heated_area_m2_extends_the_heated_area_to_160_m2;
    #[path = "🦘change-internal-gains-wm2/🧪️tests/raises-the-internal-gains-to-5-w-per-m2/🦀️.rs"]
    mod tests_change_internal_gains_w_m2_raises_the_internal_gains_to_5_w_per_m2;
    #[path = "🐪change-occupants/🧪️tests/raises-the-occupancy-to-six-people/🦀️.rs"]
    mod tests_change_occupants_raises_the_occupancy_to_six_people;
    #[path = "🔽change-reference-qp-kwh/🧪️tests/lowers-the-reference-building-primary-energy-to-8750-kwh/🦀️.rs"]
    mod tests_change_reference_q_p_kwh_lowers_the_reference_building_primary_energy_to_8750_kwh;
    #[path = "🦨change-renewable-kwh/🧪️tests/raises-the-on-site-renewable-yield-to-2250-kwh/🦀️.rs"]
    mod tests_change_renewable_kwh_raises_the_on_site_renewable_yield_to_2250_kwh;
    #[path = "🦥change-solar-gains-kwh/🧪️tests/raises-the-annual-solar-gains-to-132-kwh/🦀️.rs"]
    mod tests_change_solar_gains_kwh_raises_the_annual_solar_gains_to_132_kwh;
    #[path = "🦦change-system-losses-kwh/🧪️tests/cuts-the-system-losses-to-450-kwh/🦀️.rs"]
    mod tests_change_system_losses_kwh_cuts_the_system_losses_to_450_kwh;
    #[path = "🦏change-use-class/🧪️tests/reclassifies-the-building-as-an-office/🦀️.rs"]
    mod tests_change_use_class_reclassifies_the_building_as_an_office;
    #[path = "🐘update-climate/🧪️tests/refuses-a-negative-january-irradiance/🦀️.rs"]
