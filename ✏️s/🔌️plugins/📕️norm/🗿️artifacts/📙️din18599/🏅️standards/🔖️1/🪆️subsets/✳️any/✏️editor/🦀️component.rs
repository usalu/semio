...
impl ArtifactEditor for Din18599PlayApp {
    ...
    async fn command_id(command: &Din18599Command) -> &'static str {
        command.command_id()
    }
    ...
    async fn render(body_key: &str, doc: &ArtifactView<'_, Din18599Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
    ...
    async fn export_media(port: &str, doc: &ArtifactView<'_, Din18599Snapshot>) -> Result<Media, MediaError> {
    ...
    async fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, Din18599Snapshot>) -> Result<Emit<Din18599Mutation, NormConfigMutation, Self::DraftMutation>, MediaError> {
...
impl crate::document::NormFamily for DinV18599Family {
    ...
    async fn evaluate(document: &Din18599Snapshot) -> crate::document::CheckReport {
...
//#region ðï¸Manifest
pub async fn create_din18599_app() -> semio_framework_plugin::AppDefinition {
...
pub(crate) mod testkit {
    ...
    pub async fn din18599_manifest_for_testkit() -> semio_framework_plugin::App {
...
mod tests {
    ...
    async fn every_command() -> Vec<Din18599Command> {
        vec![
