...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.din18599/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &Din18599Command, _snapshot: &Din18599Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<Din18599Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<Din18599PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<Din18599PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<Din18599PlayApp>;
...
impl ArtifactEditor for Din18599PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📙️din18599/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
