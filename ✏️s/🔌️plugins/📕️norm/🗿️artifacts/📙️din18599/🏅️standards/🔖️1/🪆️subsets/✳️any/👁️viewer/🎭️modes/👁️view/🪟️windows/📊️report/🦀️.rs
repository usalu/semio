//! 📊️ DIN V 18599 viewer — the Report window: a read-only table of every computed compliance
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::din18599::create_din18599_viewer`. Read-only variant
...
//#region 🔖️Render
/// 👁️ Pure `Din18599Snapshot -> UiNode` read: recomputes the compliance report straight off the document
...
pub fn render(document: &Din18599Snapshot) -> UiNode {
    let report = crate::artifacts::din18599::standards::v1::subsets::any::schema::inferences::evaluate(document);
