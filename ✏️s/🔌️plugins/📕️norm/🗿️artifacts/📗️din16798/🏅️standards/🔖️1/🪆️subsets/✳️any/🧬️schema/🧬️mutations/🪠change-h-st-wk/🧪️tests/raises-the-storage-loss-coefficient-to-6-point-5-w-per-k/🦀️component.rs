...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-h-st-wk/raises-the-storage-loss-coefficient-to-6-point-5-w-per-k: produced diff differs from the committed 🔺️diff/🔣️component.json");
