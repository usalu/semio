...
//#region 🔖️Diff
pub fn diff(payload: &ChangeCellarVentilationM3H, _base: &Din16798Snapshot) -> Din16798Diff {
    Din16798Diff { cellar_ventilation_m3_h: Some(payload.new_cellar_ventilation_m3_h.clone()), ..Default::default() }
}
//#endregion 🔖️Diff
