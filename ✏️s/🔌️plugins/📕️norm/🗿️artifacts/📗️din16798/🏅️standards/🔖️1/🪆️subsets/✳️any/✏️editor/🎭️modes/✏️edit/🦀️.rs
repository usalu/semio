//! ✏️ DIN EN 16798 play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::editor::din16798::create_din16798_app`. Every norm app declares
