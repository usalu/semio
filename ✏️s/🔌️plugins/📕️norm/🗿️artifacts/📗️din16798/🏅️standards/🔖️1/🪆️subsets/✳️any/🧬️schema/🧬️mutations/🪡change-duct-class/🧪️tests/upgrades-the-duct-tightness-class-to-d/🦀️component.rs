//! 🧪️ `change-duct-class` fixture — `upgrades-the-duct-tightness-class-to-d`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-duct-class/upgrades-the-duct-tightness-class-to-d: produced diff differs from the committed 🔺️diff/🔣️component.json");
