...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-cooling-reference-kwh/raises-the-cooling-reference-to-25-kwh: produced diff differs from the committed 🔺️diff/🔣️.json");
