//! 📤️ DIN EN 16798-1 play app command — replace the whole compliance document.
//!
...
//#region 🔖️Handler
pub async fn handle(payload: &ReplaceSnapshot, _doc: &ArtifactView<'_, Din16798Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Din16798Mutation, NormConfigMutation>, Fault> {
    crate::app_surface::commit_snapshot_fields(Din16798Mutation::from_snapshot(&payload.snapshot), "setSnapshot")
}
//#endregion 🔖️Handler
