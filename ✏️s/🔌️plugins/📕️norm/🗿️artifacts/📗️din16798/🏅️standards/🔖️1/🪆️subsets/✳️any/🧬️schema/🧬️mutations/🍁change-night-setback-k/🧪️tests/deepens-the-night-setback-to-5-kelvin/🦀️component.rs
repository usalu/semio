...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-night-setback-k/deepens-the-night-setback-to-5-kelvin: produced diff differs from the committed 🔺️diff/🔣️component.json");
