...
//#region 🔖️Inverse
pub async fn inverse(_payload: &ChangeHrDeltaTC, base: &Din16798Snapshot) -> Vec<Din16798Mutation> {
    vec![Din16798Mutation::ChangeHrDeltaTC(ChangeHrDeltaTC { new_hr_delta_t_c: base.hr_delta_t_c.clone() })]
}
//#endregion 🔖️Inverse
