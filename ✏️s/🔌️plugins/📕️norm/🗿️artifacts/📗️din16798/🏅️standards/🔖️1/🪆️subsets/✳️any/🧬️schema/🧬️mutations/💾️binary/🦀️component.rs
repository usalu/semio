...
pub async fn encode_op(mutation: &Din16798Mutation) -> Result<Vec<u8>, protocol::ProtocolError> {
    mutation.encode_op()
}

/// 📖️ Decodes a document mutation from its binary op form.
pub async fn decode_op(bytes: &[u8]) -> Result<Din16798Mutation, protocol::ProtocolError> {
...
mod tests {
    ...
    async fn sample_mutation() -> Din16798Mutation {
