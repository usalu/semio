//! 🔺️ DIN EN 16798 artifact — the operation diff and its `MutationDiff` law.
//!
...
//! names as its `Din16798Mutation::Diff`, with the `MutationDiff` impl (apply = "take the replacement,
