//! 🧪️ `🗑️retire-geometry-object` fixture — `🗑️removes-the-pr600-geometry`.

use crate::{Iso16757Diff, Iso16757Mutation, Iso16757Snapshot};

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️retire-geometry-object/🗑️removes-the-pr600-geometry/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️retire-geometry-object/🗑️removes-the-pr600-geometry/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️retire-geometry-object/🗑️removes-the-pr600-geometry/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️retire-geometry-object/🗑️removes-the-pr600-geometry/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️retire-geometry-object/🗑️removes-the-pr600-geometry/🎯️outcome/🔣️.json");
...
async fn removes_the_pr600_geometry() {
    let applied = protocol::MutationDiff::apply(built_outcome().diff(), &before()).expect("apply");
    assert_eq!(applied, expected_after());
    assert_eq!(applied.geometry.objects.len(), before().geometry.objects.len().saturating_sub(1));
