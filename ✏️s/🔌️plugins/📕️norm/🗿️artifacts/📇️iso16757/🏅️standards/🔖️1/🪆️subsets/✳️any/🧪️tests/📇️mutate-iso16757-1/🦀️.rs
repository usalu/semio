...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str, &'static str) {
    match kind {
        "change-exchange-process" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🔄️change-exchange-process/🔄️advances-the-exchange-stage-to-determine-product/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔄️change-exchange-process/🔄️advances-the-exchange-stage-to-determine-product/🦠️mutation/🔣️.json"),
        ...
        "replace-part-number-rule" => (
            ...
            include_str!("../../🧫️fixtures/🧬️mutations/🧮️replace-part-number-rule/🧮️swaps-the-literal-rule-for-a-height-driven-script/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧮️replace-part-number-rule/🧮️swaps-the-literal-rule-for-a-height-driven-script/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧮️replace-part-number-rule/🧮️swaps-the-literal-rule-for-a-height-driven-script/🎯️outcome/🔣️.json"),
        ),
        "change-part-number-input" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🎛️change-part-number-input/🔢️raises-the-height-part-number-input-to-750/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎛️change-part-number-input/🔢️raises-the-height-part-number-input-to-750/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎛️change-part-number-input/🔢️raises-the-height-part-number-input-to-750/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎛️change-part-number-input/🔢️raises-the-height-part-number-input-to-750/🎯️outcome/🔣️.json"),
        ),
        "remove-part-number-input" => (
        ...
        "change-selection-class" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🎯️change-selection-class/🎯️retargets-the-selection-at-the-towel-radiator-class/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎯️change-selection-class/🎯️retargets-the-selection-at-the-towel-radiator-class/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎯️change-selection-class/🎯️retargets-the-selection-at-the-towel-radiator-class/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎯️change-selection-class/🎯️retargets-the-selection-at-the-towel-radiator-class/🎯️outcome/🔣️.json"),
        ),
        "change-selection-series" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🧵️change-selection-series/🧵️narrows-the-selection-to-the-pr-plus-series/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧵️change-selection-series/🧵️narrows-the-selection-to-the-pr-plus-series/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧵️change-selection-series/🧵️narrows-the-selection-to-the-pr-plus-series/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧵️change-selection-series/🧵️narrows-the-selection-to-the-pr-plus-series/🎯️outcome/🔣️.json"),
        ),
        "add-selection-constraint" => (
