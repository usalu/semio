//! 🧪️ `delete-subject` fixture — `🚫️removes-the-radiator-subject-from-the-dictionary`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-subject/🚫️removes-the-radiator-subject-from-the-dictionary/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-subject/🚫️removes-the-radiator-subject-from-the-dictionary/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-subject/🚫️removes-the-radiator-subject-from-the-dictionary/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-subject/🚫️removes-the-radiator-subject-from-the-dictionary/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-subject/🚫️removes-the-radiator-subject-from-the-dictionary/🎯️outcome/🔣️.json");
