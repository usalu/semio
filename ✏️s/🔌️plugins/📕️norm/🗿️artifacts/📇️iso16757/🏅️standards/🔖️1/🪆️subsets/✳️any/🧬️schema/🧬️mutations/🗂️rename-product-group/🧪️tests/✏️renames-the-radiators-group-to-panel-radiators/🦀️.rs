...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️rename-product-group/✏️renames-the-radiators-group-to-panel-radiators/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️rename-product-group/✏️renames-the-radiators-group-to-panel-radiators/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️rename-product-group/✏️renames-the-radiators-group-to-panel-radiators/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️rename-product-group/✏️renames-the-radiators-group-to-panel-radiators/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️rename-product-group/✏️renames-the-radiators-group-to-panel-radiators/🎯️outcome/🔣️.json");
...
async fn renames_the_radiators_group_to_panel_radiators() {
...
#[semio_framework_async_macros::async_test]
async fn renaming_the_group_back_restores_before() {
    let base = before();
