...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧽️delete-property-definition/🚫️removes-the-height-property-definition/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧽️delete-property-definition/🚫️removes-the-height-property-definition/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧽️delete-property-definition/🚫️removes-the-height-property-definition/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧽️delete-property-definition/🚫️removes-the-height-property-definition/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧽️delete-property-definition/🚫️removes-the-height-property-definition/🎯️outcome/🔣️.json");
