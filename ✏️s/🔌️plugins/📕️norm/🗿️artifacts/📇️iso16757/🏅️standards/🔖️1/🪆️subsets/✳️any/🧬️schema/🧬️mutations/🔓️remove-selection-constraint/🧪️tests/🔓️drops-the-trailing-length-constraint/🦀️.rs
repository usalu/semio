...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-selection-constraint/🔓️drops-the-trailing-length-constraint/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-selection-constraint/🔓️drops-the-trailing-length-constraint/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-selection-constraint/🔓️drops-the-trailing-length-constraint/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-selection-constraint/🔓️drops-the-trailing-length-constraint/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-selection-constraint/🔓️drops-the-trailing-length-constraint/🎯️outcome/🔣️.json");
