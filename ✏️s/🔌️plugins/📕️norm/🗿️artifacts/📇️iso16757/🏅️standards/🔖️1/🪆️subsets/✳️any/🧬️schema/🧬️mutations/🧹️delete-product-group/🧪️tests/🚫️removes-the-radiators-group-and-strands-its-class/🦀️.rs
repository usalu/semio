...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-product-group/🚫️removes-the-radiators-group-and-strands-its-class/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-product-group/🚫️removes-the-radiators-group-and-strands-its-class/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-product-group/🚫️removes-the-radiators-group-and-strands-its-class/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-product-group/🚫️removes-the-radiators-group-and-strands-its-class/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-product-group/🚫️removes-the-radiators-group-and-strands-its-class/🎯️outcome/🔣️.json");
