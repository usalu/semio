...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-selection-constraint/🔒️appends-a-width-under-800-constraint/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-selection-constraint/🔒️appends-a-width-under-800-constraint/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-selection-constraint/🔒️appends-a-width-under-800-constraint/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-selection-constraint/🔒️appends-a-width-under-800-constraint/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-selection-constraint/🔒️appends-a-width-under-800-constraint/🎯️outcome/🔣️.json");
