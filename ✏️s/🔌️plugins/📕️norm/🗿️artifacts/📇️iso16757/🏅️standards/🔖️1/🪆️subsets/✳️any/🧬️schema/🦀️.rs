...
pub struct Iso16757Artifact {
    #[state(artifact)]
    pub catalogue: crate::part_1::Catalogue,
    #[state(artifact)]
    pub dictionary: crate::part_4::Dictionary,
    #[state(artifact)]
    pub geometry: crate::part_2::GeometryCatalogue,
    #[state(artifact)]
    pub selection: crate::part_1::SelectionRequest,
    #[state(artifact)]
    pub part_number_rule: crate::part_5::PartNumberRule,
    #[state(artifact)]
    pub part_number_inputs: BTreeMap<String, CatalogueValue>,
    #[state(artifact)]
    pub script_limits: crate::part_5::ScriptLimits,
    #[state(artifact)]
    pub exchange_process: crate::part_5::ExchangeProcess,
    #[state(presence)]
...
impl Iso16757Artifact {
    /// 📸️ Persisted subset.
    pub fn to_snapshot(&self) -> crate::Iso16757Snapshot {
        crate::Iso16757Snapshot {
    ...
    pub fn from_snapshot(snapshot: crate::Iso16757Snapshot) -> Self {
        Self {
...
pub fn iso16757_artifact_schema_descriptor() -> framework_schema::ArtifactSchemaDescriptor {
...
pub mod part_5 {
    ...
    pub fn build_ifc_catalogue(catalogue: &crate::part_1::Catalogue) -> IfcCatalogue {
...
mod compliance_helpers_tests {
    ...
    async fn select_products_filters_by_series_id() {
        let mut doc = Iso16757Snapshot::default();
        let other_series =
            crate::part_1::ProductSeries { id: "series.other".into(), class_id: "class.valve".into(), names: doc.catalogue.product_series[0].names.clone(), shared_property_values: BTreeMap::new(), geometry_id: None };
    ...
    async fn select_products_records_missing_property_and_constraint_failures() {
        let mut doc = Iso16757Snapshot::default();
        doc.selection.constraints.push(crate::part_1::SelectionConstraint {
            property_id: "prop.missing".into(),
            operator: crate::part_1::ConstraintOperator::Equal,
    ...
    async fn validate_geometry_graph_empty_parameter_binding() {
        let object = crate::part_2::GeometryObject {
            id: "geom.bind".into(),
            shape: None,
            symbolic: None,
            spaces: Vec::new(),
    ...
    async fn subtype_closure_is_transitive() {
        let dictionary = crate::part_4::Dictionary {
            ...
            subjects: Vec::new(),
            relationships: vec![
                crate::part_4::Relationship {
                    id: "r1".into(),
                    kind: crate::part_4::RelationshipKind::IsSubtypeOf,
                    source_id: "a".into(),
                    target_id: "b".into(),
