//! 🧪️ `rename-manufacturer` fixture — `🏭️adds-the-ag-suffix-to-the-manufacturer`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-manufacturer/adds-the-ag-suffix-to-the-manufacturer: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
