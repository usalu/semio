//! 🧪️ `rename-product` fixture — `✏️renames-pr600-to-the-compact-variant-name`.
//!
...
async fn renames_pr600_to_the_compact_variant_name() {
...
#[semio_framework_async_macros::async_test]
async fn renaming_the_product_back_restores_before() {
    let base = before();
