//! 🧪️ `delete-product` fixture — `🚫️removes-the-pr600-product-from-the-catalogue`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️delete-product/🚫️removes-the-pr600-product-from-the-catalogue/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️delete-product/🚫️removes-the-pr600-product-from-the-catalogue/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️delete-product/🚫️removes-the-pr600-product-from-the-catalogue/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️delete-product/🚫️removes-the-pr600-product-from-the-catalogue/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫️delete-product/🚫️removes-the-pr600-product-from-the-catalogue/🎯️outcome/🔣️.json");
...
async fn removes_the_pr600_product_from_the_catalogue() {
...
#[semio_framework_async_macros::async_test]
async fn recreating_the_pr600_product_restores_before() {
    let base = before();
