//! 🧪️ `create-property-definition` fixture — `📏️appends-a-selection-scoped-length-property`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-property-definition/📏️appends-a-selection-scoped-length-property/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-property-definition/📏️appends-a-selection-scoped-length-property/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-property-definition/📏️appends-a-selection-scoped-length-property/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-property-definition/📏️appends-a-selection-scoped-length-property/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-property-definition/📏️appends-a-selection-scoped-length-property/🎯️outcome/🔣️.json");
