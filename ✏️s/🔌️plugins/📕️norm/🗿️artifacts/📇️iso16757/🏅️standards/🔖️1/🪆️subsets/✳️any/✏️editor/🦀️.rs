...
pub const CONFIG_SCHEMA: &str = "config.norm.iso16757";
...
impl ArtifactEditor for Iso16757PlayApp {
    ...
    const DIALECT: Dialect = crate::artifacts::iso16757::ISO16757_DIALECT;
    ...
    ) -> Result<Emit<Iso16757Mutation, NormConfigMutation, Self::DraftMutation>, Fault> {
        command.dispatch(doc, cfg)
    }

    fn render(body_key: &str, doc: &ArtifactView<'_, Iso16757Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::ComponentTree> {
...
impl crate::app_surface::NormRetainedEditor for Iso16757PlayApp {
    fn dispatch_retained(command: &Iso16757Command, doc: &ArtifactView<'_, Iso16757Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Iso16757Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
        command.dispatch(doc, cfg)
    }
}
...
pub fn create_iso16757_app() -> semio_framework_plugin::AppDefinition {
    Editor::builder(crate::artifacts::iso16757::ISO16757_DIALECT)
            .document(["semio", "norm", VARIANT])
            .artifact_kind(crate::artifacts::iso16757::artifact_kind())
...
pub(crate) mod testkit {
    ...
    pub fn iso16757_manifest_for_testkit() -> semio_framework_plugin::App {
