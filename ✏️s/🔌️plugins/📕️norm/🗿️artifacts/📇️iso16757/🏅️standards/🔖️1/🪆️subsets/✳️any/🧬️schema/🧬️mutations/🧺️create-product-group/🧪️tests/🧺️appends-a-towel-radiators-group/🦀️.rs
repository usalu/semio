//! 🧪️ `create-product-group` fixture — `🧺️appends-a-towel-radiators-group`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️create-product-group/🧺️appends-a-towel-radiators-group/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️create-product-group/🧺️appends-a-towel-radiators-group/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️create-product-group/🧺️appends-a-towel-radiators-group/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️create-product-group/🧺️appends-a-towel-radiators-group/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️create-product-group/🧺️appends-a-towel-radiators-group/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-product-group/appends-a-towel-radiators-group: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
