//! 🧪️ `replace-part-number-rule` fixture — `🧮️swaps-the-literal-rule-for-a-height-driven-script`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-part-number-rule/swaps-the-literal-rule-for-a-height-driven-script: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
