...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-a-pr900-product-to-the-existing-series/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-a-pr900-product-to-the-existing-series/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-a-pr900-product-to-the-existing-series/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-a-pr900-product-to-the-existing-series/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-a-pr900-product-to-the-existing-series/🎯️outcome/🔣️.json");
