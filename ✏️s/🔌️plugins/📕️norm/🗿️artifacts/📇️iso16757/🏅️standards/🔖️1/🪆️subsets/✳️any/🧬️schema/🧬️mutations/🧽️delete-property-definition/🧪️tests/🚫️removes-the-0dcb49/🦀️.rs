//! 🧪️ `delete-property-definition` fixture — `🚫️removes-the-height-property-definition`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-property-definition/removes-the-height-property-definition: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
