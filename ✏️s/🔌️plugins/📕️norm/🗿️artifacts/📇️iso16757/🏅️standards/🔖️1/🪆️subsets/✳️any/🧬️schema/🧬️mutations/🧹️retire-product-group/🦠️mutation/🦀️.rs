//! 🗑️ `retire-product-group` — removes an id-keyed catalogue product group.
...
pub struct RetireProductGroup {
    pub id: String,
}

impl protocol::MutationKind<Iso16757Snapshot, Iso16757Mutation> for RetireProductGroup {
    const SEMANTICS: protocol::SemanticDescriptor =

        protocol::SemanticDescriptor { verb: "remove", entity: "productGroup", kind: "retire-product-group", record: "RetiredProductGroup" };
