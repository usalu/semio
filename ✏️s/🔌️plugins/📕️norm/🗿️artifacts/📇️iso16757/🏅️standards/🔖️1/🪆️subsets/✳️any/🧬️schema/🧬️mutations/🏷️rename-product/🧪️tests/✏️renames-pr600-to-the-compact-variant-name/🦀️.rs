...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-product/✏️renames-pr600-to-the-compact-variant-name/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-product/✏️renames-pr600-to-the-compact-variant-name/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-product/✏️renames-pr600-to-the-compact-variant-name/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-product/✏️renames-pr600-to-the-compact-variant-name/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-product/✏️renames-pr600-to-the-compact-variant-name/🎯️outcome/🔣️.json");
