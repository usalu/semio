...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-sheet-w-el-mm3/raises-sheet-section-modulus-to-12800-mm3: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
