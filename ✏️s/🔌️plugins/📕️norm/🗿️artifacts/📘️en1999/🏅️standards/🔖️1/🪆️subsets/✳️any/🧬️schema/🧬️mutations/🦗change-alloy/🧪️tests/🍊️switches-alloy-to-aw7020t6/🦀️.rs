//! 🧪️ `change-alloy` fixture — `🍊️switches-alloy-to-aw7020t6` (EN 1999 aluminium).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-alloy/switches-alloy-to-aw7020t6: produced diff differs from the committed 🔺️diff/🔣️.json");
}
