//! 🧪️ `change-fatigue-m` fixture — `🌲️flattens-sn-slope-to-m-5` (EN 1999 aluminium).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-fatigue-m/flattens-sn-slope-to-m-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
