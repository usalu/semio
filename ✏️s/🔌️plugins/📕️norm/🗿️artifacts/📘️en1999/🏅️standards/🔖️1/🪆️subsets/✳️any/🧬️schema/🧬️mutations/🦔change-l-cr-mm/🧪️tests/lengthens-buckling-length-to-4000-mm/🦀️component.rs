//! 🧪️ `change-l-cr-mm` fixture — `lengthens-buckling-length-to-4000-mm` (EN 1999 aluminium).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-l-cr-mm/lengthens-buckling-length-to-4000-mm: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
