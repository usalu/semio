//! 🧪️ `change-v-weld-ed-kn` fixture — `raises-weld-shear-to-48-kn` (EN 1999 aluminium).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-v-weld-ed-kn/raises-weld-shear-to-48-kn: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
