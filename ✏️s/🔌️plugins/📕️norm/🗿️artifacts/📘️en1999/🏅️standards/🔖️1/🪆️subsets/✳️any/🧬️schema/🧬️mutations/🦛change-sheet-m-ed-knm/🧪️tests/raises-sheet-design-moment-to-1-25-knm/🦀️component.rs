...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-sheet-m-ed-knm/raises-sheet-design-moment-to-1-25-knm: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
