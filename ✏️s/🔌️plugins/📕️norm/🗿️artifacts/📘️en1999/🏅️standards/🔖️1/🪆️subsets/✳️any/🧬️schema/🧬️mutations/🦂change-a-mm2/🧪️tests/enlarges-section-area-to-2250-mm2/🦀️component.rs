//! 🧪️ `change-a-mm2` fixture — `enlarges-section-area-to-2250-mm2` (EN 1999 aluminium).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-a-mm2/enlarges-section-area-to-2250-mm2: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
