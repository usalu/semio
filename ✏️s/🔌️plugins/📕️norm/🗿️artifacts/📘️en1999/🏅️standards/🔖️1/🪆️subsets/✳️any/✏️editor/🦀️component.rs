...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.en1999/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &En1999Command, _snapshot: &En1999Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<En1999Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<En1999PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<En1999PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<En1999PlayApp>;
...
impl ArtifactEditor for En1999PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📘️en1999/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
