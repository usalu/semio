...
impl ArtifactEditor for En1999PlayApp {
    ...
    async fn command_id(command: &En1999Command) -> &'static str {
        command.command_id()
    }
    ...
    async fn render(body_key: &str, doc: &ArtifactView<'_, En1999Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
    ...
    async fn export_media(port: &str, doc: &ArtifactView<'_, En1999Snapshot>) -> Result<Media, MediaError> {
    ...
    async fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, En1999Snapshot>) -> Result<Emit<En1999Mutation, NormConfigMutation, Self::DraftMutation>, MediaError> {
...
impl crate::document::NormFamily for En1999Family {
    ...
    async fn evaluate(document: &En1999Snapshot) -> crate::document::CheckReport {
...
//#region ðï¸Manifest
pub async fn create_en1999_app() -> semio_framework_plugin::AppDefinition {
...
pub(crate) mod testkit {
    ...
    pub async fn en1999_manifest_for_testkit() -> semio_framework_plugin::App {
...
mod tests {
    ...
    async fn every_command() -> Vec<En1999Command> {
        vec![
