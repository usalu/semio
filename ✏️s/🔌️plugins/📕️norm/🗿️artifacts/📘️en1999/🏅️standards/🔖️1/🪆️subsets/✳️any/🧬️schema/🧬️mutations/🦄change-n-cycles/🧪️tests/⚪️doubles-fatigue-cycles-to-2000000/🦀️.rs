//! 🧪️ `change-n-cycles` fixture — `⚪️doubles-fatigue-cycles-to-2000000` (EN 1999 aluminium).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-n-cycles/doubles-fatigue-cycles-to-2000000: produced diff differs from the committed 🔺️diff/🔣️.json");
}
