//! 🧪️ `change-sheet-k-sigma` fixture — `🟧️raises-sheet-plate-buckling-k-sigma-to-6-25` (EN 1999 aluminium).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-sheet-k-sigma/raises-sheet-plate-buckling-k-sigma-to-6-25: produced diff differs from the committed 🔺️diff/🔣️.json");
}
