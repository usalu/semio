//! 🔍️ EN 1999 play app panel — the inspection tab: one computed check in full, chosen by the config's
...
//#region 🔖️Constants
pub const BODY_INSPECTION: &str = "norm.en1999.play.inspection";
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1999Family>, selected_check_index: Option<u32>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
...
mod tests {
    ...
    fn an_out_of_range_selected_index_falls_back_to_the_first_check() {
        let host = NormHost::<En1999Family>::from_document(crate::artifacts::en1999::En1999Snapshot::default());
