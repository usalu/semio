...
pub const EN1999_ALUMINIUM_ROOF_PURLIN_EXAMPLE_TEXT: &str = include_str!("../📚️examples/📕️aluminium-roof-purlin/🗣️dsls/📕️aluminium-roof-purlin/🧬️component.norm.en1999.dsl.semio");
