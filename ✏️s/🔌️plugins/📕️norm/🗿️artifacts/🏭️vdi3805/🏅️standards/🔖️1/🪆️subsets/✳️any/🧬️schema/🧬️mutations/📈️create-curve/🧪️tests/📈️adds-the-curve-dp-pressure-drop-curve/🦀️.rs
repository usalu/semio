//! 🧪️ `create-curve` fixture — `📈️adds-the-curve-dp-pressure-drop-curve`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📈️create-curve/📈️adds-the-curve-dp-pressure-drop-curve/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📈️create-curve/📈️adds-the-curve-dp-pressure-drop-curve/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📈️create-curve/📈️adds-the-curve-dp-pressure-drop-curve/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📈️create-curve/📈️adds-the-curve-dp-pressure-drop-curve/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📈️create-curve/📈️adds-the-curve-dp-pressure-drop-curve/🎯️outcome/🔣️.json");
