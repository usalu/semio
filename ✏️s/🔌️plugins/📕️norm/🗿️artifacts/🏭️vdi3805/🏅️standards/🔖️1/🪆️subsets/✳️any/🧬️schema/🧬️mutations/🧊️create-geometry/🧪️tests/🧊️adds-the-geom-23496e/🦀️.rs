//! 🧪️ `create-geometry` fixture — `🧊️adds-the-geom-valve-80-definition`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-geometry/adds-the-geom-valve-80-definition: produced diff differs from the committed 🔺️diff/🔣️.json");
}
