...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/🎯️outcome/🔣️.json");
