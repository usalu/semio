...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️replace-geometry-parameters/➗️rescales-geom-valve-50-to-half-and-adds-clearance/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️replace-geometry-parameters/➗️rescales-geom-valve-50-to-half-and-adds-clearance/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️replace-geometry-parameters/➗️rescales-geom-valve-50-to-half-and-adds-clearance/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️replace-geometry-parameters/➗️rescales-geom-valve-50-to-half-and-adds-clearance/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️replace-geometry-parameters/➗️rescales-geom-valve-50-to-half-and-adds-clearance/🎯️outcome/🔣️.json");
