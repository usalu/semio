...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-geometry/📐️doubles-the-geom-valve-50-bounding-box/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-geometry/📐️doubles-the-geom-valve-50-bounding-box/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-geometry/📐️doubles-the-geom-valve-50-bounding-box/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-geometry/📐️doubles-the-geom-valve-50-bounding-box/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️resize-geometry/📐️doubles-the-geom-valve-50-bounding-box/🎯️outcome/🔣️.json");
