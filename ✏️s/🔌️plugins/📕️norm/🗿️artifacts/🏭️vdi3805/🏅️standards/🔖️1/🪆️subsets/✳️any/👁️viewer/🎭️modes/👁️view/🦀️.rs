//! 👁️ VDI 3805 viewer — the `view` mode: a single full-pane Report window, the read-only
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::vdi3805::create_vdi3805_viewer`.
