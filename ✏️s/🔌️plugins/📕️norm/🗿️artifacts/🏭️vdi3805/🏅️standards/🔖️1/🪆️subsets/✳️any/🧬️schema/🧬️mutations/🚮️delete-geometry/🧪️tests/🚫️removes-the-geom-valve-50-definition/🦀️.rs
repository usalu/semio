//! 🧪️ `delete-geometry` fixture — `🚫️removes-the-geom-valve-50-definition`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-geometry/🚫️removes-the-geom-valve-50-definition/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-geometry/🚫️removes-the-geom-valve-50-definition/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-geometry/🚫️removes-the-geom-valve-50-definition/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-geometry/🚫️removes-the-geom-valve-50-definition/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-geometry/🚫️removes-the-geom-valve-50-definition/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-geometry/removes-the-geom-valve-50-definition: produced diff differs from the committed 🔺️diff/🔣️.json");
}
