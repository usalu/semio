//! 🧪️ `change-correction-as-of` fixture — `📅️advances-the-correction-cut-off-to-2025-03`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-correction-as-of/advances-the-correction-cut-off-to-2025-03: produced diff differs from the committed 🔺️diff/🔣️.json");
}
