...
#[path = "../../📈️add-curve/🧪️tests/📈️adds-the-curve-dp-pressure-drop-curve/🦀️.rs"]
mod tests_add_curve_adds_the_curve_dp_pressure_drop_curve;
#[path = "../../🧊️add-geometry/🧪️tests/🧊️adds-the-geom-valve-80-definition/🦀️.rs"]
mod tests_add_geometry_adds_the_geom_valve_80_definition;
#[path = "../../📦️add-product/🧪️tests/📦️appends-vlv-80-002-and-its-index-entry/🦀️.rs"]
mod tests_add_product_appends_vlv_80_002_and_its_index_entry;
#[path = "../../📉️remove-curve/🧪️tests/🚫️removes-the-curve-kvs-flow-curve/🦀️.rs"]
mod tests_remove_curve_removes_the_curve_kvs_flow_curve;
#[path = "../../🚮️remove-geometry/🧪️tests/🚫️removes-the-geom-valve-50-definition/🦀️.rs"]
mod tests_remove_geometry_removes_the_geom_valve_50_definition;
#[path = "../../🗑️remove-product/🧪️tests/🚫️removes-vlv-50-001-and-its-index-entry/🦀️.rs"]
mod tests_remove_product_removes_vlv_50_001_and_its_index_entry;
...
#[path = "../../📍️change-curve-points/🧪️tests/📍️resamples-curve-kvs-onto-three-points/🦀️.rs"]
