//! ✏️ VDI 3805 play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::editor::vdi3805::create_vdi3805_app`. Every norm app declares
