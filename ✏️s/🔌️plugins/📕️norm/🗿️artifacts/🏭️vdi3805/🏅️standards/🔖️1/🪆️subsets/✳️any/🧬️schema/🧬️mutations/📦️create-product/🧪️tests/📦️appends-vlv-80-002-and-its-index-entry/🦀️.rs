...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-vlv-80-002-and-its-index-entry/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-vlv-80-002-and-its-index-entry/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-vlv-80-002-and-its-index-entry/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-vlv-80-002-and-its-index-entry/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️create-product/📦️appends-vlv-80-002-and-its-index-entry/🎯️outcome/🔣️.json");
