//! 🧪️ `remove-geometry-connection` fixture — `🔌️detaches-the-out-connection-from-geom-valve-50`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-geometry-connection/detaches-the-out-connection-from-geom-valve-50: produced diff differs from the committed 🔺️diff/🔣️.json");
}
