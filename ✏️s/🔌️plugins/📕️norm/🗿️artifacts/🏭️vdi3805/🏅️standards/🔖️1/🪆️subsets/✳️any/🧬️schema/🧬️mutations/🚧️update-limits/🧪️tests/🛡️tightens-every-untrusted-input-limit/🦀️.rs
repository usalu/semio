...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️update-limits/🛡️tightens-every-untrusted-input-limit/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️update-limits/🛡️tightens-every-untrusted-input-limit/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️update-limits/🛡️tightens-every-untrusted-input-limit/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️update-limits/🛡️tightens-every-untrusted-input-limit/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️update-limits/🛡️tightens-every-untrusted-input-limit/🎯️outcome/🔣️.json");
