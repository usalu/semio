...
//#region 🔖️Render
pub fn render(host: &NormHost<Vdi3805Family>, locale: semio_framework_plugin::Locale) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
