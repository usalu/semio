//! 🧪️ `delete-product` fixture — `🚫️removes-vlv-50-001-and-its-index-entry`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-product/🚫️removes-vlv-50-001-and-its-index-entry/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-product/🚫️removes-vlv-50-001-and-its-index-entry/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-product/🚫️removes-vlv-50-001-and-its-index-entry/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-product/🚫️removes-vlv-50-001-and-its-index-entry/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-product/🚫️removes-vlv-50-001-and-its-index-entry/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-product/removes-vlv-50-001-and-its-index-entry: produced diff differs from the committed 🔺️diff/🔣️.json");
}
