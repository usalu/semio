...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str, &'static str) {
    match kind {
        ...
        "add-geometry-connection" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔌️add-geometry-connection/🚰️attaches-the-drain-connection-to-geom-valve-50/🎯️outcome/🔣️.json"),
        ),
        "remove-geometry-connection" => (
            include_str!("../../🧫️fixtures/🧬️mutations/✂️remove-geometry-connection/🔌️detaches-the-out-connection-from-geom-valve-50/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✂️remove-geometry-connection/🔌️detaches-the-out-connection-from-geom-valve-50/🦠️mutation/🔣️.json"),
