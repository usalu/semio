...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️replace-curve-points/📍️resamples-curve-kvs-onto-three-points/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️replace-curve-points/📍️resamples-curve-kvs-onto-three-points/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️replace-curve-points/📍️resamples-curve-kvs-onto-three-points/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️replace-curve-points/📍️resamples-curve-kvs-onto-three-points/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📍️replace-curve-points/📍️resamples-curve-kvs-onto-three-points/🎯️outcome/🔣️.json");
