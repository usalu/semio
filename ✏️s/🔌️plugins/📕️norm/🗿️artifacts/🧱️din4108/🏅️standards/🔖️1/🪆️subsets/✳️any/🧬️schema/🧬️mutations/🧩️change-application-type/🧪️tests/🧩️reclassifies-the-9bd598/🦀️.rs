//! 🧪️ `change-application-type` fixture — `🧩️reclassifies-the-application-type-as-wab`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-application-type/reclassifies-the-application-type-as-wab: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-application-type/reclassifies-the-application-type-as-wab: change-application-type is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
