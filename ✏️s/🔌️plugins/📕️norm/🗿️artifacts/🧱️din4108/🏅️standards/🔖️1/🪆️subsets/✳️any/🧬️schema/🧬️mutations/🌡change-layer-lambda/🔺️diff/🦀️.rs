//! 🔺️ `change-layer-lambda` diff — whole-list rewrite via Din4108Diff list wrappers.
...
fn apply_in_place(payload: &ChangeLayerLambda, snap: &mut Din4108Snapshot) -> Result<(), String> {
    ...
    layer.lambda = payload.new_lambda;
