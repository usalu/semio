//! 🧪️ `change-solar-absorptance` fixture — `☀️lightens-the-facade-to-absorptance-0-point-25`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-solar-absorptance/lightens-the-facade-to-absorptance-0-point-25: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-solar-absorptance/lightens-the-facade-to-absorptance-0-point-25: change-solar-absorptance is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
