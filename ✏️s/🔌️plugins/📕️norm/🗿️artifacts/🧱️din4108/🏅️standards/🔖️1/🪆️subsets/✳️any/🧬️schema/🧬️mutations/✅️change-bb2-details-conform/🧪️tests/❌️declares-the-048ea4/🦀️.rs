//! 🧪️ `change-bb2-details-conform` fixture — `❌️declares-the-beiblatt-2-details-non-conforming`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-bb2-details-conform/declares-the-beiblatt-2-details-non-conforming: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-bb2-details-conform/declares-the-beiblatt-2-details-non-conforming: change-bb2-details-conform is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
