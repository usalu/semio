//! 🧪️ `reorder-layers` fixture — `🧭️moves-the-insulation-in-front-of-the-masonry`.
//!
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "reorder-layers/moves-the-insulation-in-front-of-the-masonry: reorder-layers is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
