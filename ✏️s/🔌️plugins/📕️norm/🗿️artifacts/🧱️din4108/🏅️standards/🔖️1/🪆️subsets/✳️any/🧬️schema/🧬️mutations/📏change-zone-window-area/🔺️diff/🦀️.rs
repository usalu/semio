//! 🔺️ `change-zone-window-area` diff — whole-list rewrite via Din4108Diff list wrappers.
...
fn apply_in_place(payload: &ChangeZoneWindowArea, snap: &mut Din4108Snapshot) -> Result<(), String> {
