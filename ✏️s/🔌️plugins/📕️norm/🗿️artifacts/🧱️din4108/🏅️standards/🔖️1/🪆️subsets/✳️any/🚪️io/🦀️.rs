//! 🚪️ IO s.norm.din4108 (1/✳️any) — no stdio format bridges. W5a (ticket 26/08/11/SEMIO-ARTIFACT-UNIFIED-IMPORT-EXPORT-AND-MEDIA-FORMAT-RETIREMENT) deleted the five
...
//! ⚙️engine::register) for the native `s.norm.din4108` dialect only.
...
pub mod derived_composition {
    use crate::standards::v1::subsets::any::schema::Din4108Analyzer;
...
pub mod io_registry {
    use crate::standards::v1::subsets::any::schema::Din4108Composer as Din4108AnyComposer;
