...
pub fn handle(_payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, Din4108Snapshot>, _cfg: &ConfigView<'_, NoConfig>) -> Result<Emit<Din4108Mutation, NoConfigMutation>, Fault> {
    Ok(Emit::default())
}
//#endregion 🔖️Handler
