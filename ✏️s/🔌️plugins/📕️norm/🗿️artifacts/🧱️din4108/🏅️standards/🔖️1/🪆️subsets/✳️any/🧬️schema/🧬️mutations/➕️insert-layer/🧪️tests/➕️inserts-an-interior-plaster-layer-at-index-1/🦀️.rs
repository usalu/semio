...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-layer/➕️inserts-an-interior-plaster-layer-at-index-1/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-layer/➕️inserts-an-interior-plaster-layer-at-index-1/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-layer/➕️inserts-an-interior-plaster-layer-at-index-1/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-layer/➕️inserts-an-interior-plaster-layer-at-index-1/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-layer/➕️inserts-an-interior-plaster-layer-at-index-1/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "insert-layer/inserts-an-interior-plaster-layer-at-index-1: insert-layer is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
