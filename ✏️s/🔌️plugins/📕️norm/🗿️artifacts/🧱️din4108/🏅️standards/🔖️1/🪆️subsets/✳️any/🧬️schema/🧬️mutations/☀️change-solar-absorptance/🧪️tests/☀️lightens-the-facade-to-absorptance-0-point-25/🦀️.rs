...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-solar-absorptance/☀️lightens-the-facade-to-absorptance-0-point-25/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-solar-absorptance/☀️lightens-the-facade-to-absorptance-0-point-25/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-solar-absorptance/☀️lightens-the-facade-to-absorptance-0-point-25/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-solar-absorptance/☀️lightens-the-facade-to-absorptance-0-point-25/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-solar-absorptance/☀️lightens-the-facade-to-absorptance-0-point-25/🎯️outcome/🔣️.json");
