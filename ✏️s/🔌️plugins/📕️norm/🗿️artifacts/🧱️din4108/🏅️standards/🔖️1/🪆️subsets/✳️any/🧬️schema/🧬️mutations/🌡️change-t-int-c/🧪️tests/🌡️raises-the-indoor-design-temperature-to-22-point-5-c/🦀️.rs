//! 🧪️ `change-t-int-c` fixture — `🌡️raises-the-indoor-design-temperature-to-22-point-5-c`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-t-int-c/🌡️raises-the-indoor-design-temperature-to-22-point-5-c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-t-int-c/🌡️raises-the-indoor-design-temperature-to-22-point-5-c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-t-int-c/🌡️raises-the-indoor-design-temperature-to-22-point-5-c/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-t-int-c/🌡️raises-the-indoor-design-temperature-to-22-point-5-c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-t-int-c/🌡️raises-the-indoor-design-temperature-to-22-point-5-c/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-t-int-c/raises-the-indoor-design-temperature-to-22-point-5-c: change-t-int-c is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
