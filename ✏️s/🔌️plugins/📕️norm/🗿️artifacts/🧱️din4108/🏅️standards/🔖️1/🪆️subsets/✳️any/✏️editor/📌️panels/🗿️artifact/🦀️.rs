//! 📄️ DIN 4108 play app panel — the document headline: family, check count, worst utilization, verdict.
...
//#region 🔖️Constants
pub const BODY_ARTIFACT: &str = "norm.din4108.play.artifact";
...
//#region 🔖️Render
pub fn render(host: &NormHost<Din4108Family>, locale: semio_framework_plugin::Locale) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
