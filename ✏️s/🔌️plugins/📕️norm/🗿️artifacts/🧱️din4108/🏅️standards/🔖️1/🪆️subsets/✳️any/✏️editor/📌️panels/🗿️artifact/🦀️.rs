...
//#region 🔖️Constants
pub const BODY_DOCUMENT: &str = "norm.din4108.play.document";
...
//#region 🔖️Render
pub fn render(host: &NormHost<Din4108Family>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
