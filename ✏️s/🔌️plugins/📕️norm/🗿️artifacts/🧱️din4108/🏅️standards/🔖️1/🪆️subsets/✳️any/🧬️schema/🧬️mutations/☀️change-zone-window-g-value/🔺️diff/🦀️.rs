//! 🔺️ `change-zone-window-g-value` diff — whole-list rewrite via Din4108Diff list wrappers.
...
fn apply_in_place(payload: &ChangeZoneWindowGValue, snap: &mut Din4108Snapshot) -> Result<(), String> {
