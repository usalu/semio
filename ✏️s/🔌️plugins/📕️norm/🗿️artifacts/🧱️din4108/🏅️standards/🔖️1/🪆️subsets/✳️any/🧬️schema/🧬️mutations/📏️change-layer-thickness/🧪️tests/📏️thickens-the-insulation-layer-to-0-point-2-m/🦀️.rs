//! 🧪️ `change-layer-thickness` fixture — `📏️thickens-the-insulation-layer-to-0-point-2-m`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-layer-thickness/📏️thickens-the-insulation-layer-to-0-point-2-m/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-layer-thickness/📏️thickens-the-insulation-layer-to-0-point-2-m/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-layer-thickness/📏️thickens-the-insulation-layer-to-0-point-2-m/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-layer-thickness/📏️thickens-the-insulation-layer-to-0-point-2-m/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-layer-thickness/📏️thickens-the-insulation-layer-to-0-point-2-m/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-layer-thickness/thickens-the-insulation-layer-to-0-point-2-m: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-layer-thickness/thickens-the-insulation-layer-to-0-point-2-m: change-layer-thickness is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
