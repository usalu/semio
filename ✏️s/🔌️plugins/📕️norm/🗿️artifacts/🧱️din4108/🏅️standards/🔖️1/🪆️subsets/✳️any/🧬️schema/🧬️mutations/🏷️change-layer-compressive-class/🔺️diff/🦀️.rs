//! Diff for `change-layer-compressive-class`.
...
fn apply_in_place(payload: &ChangeLayerCompressiveClass, snap: &mut Din4108Snapshot) -> Result<(), String> {
    ...
    layer.compressive_class = payload.new_compressive_class.clone();
    Ok(())
}
