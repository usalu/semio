//! 🧪️ `change-airtightness-class` fixture — `🔒️upgrades-the-airtightness-class-to-class1`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-airtightness-class/upgrades-the-airtightness-class-to-class1: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-airtightness-class/upgrades-the-airtightness-class-to-class1: change-airtightness-class is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
