...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-layer/🚫️removes-the-load-bearing-masonry-layer/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-layer/🚫️removes-the-load-bearing-masonry-layer/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-layer/🚫️removes-the-load-bearing-masonry-layer/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-layer/🚫️removes-the-load-bearing-masonry-layer/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-layer/🚫️removes-the-load-bearing-masonry-layer/🎯️outcome/🔣️.json");
