/** 🧬️ Din4108Mutation — mirrors `Din4108Mutation` in `🦀️.rs` (22 variants: one
 ...
 * `🧪️tests/*​/🦠️mutation/🔣️.json` fixture (e.g. `{"ChangeMoistureMuInterior":
 ...
 * `📕️norm/⚖️compliance/🦀️.rs`) has no `#[serde(rename_all)]` either, so it serializes as the
