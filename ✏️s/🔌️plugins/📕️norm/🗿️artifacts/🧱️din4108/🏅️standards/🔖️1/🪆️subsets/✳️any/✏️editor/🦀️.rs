...
impl ArtifactEditor for Din4108PlayApp {
    ...
    fn render(body_key: &str, doc: &ArtifactView<'_, Din4108Snapshot>, cfg: &ConfigView<'_, NoConfig>, _view_state: &semio_framework_plugin::ViewModel) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::ComponentTree> {
