//! 🔺️ `change-zone-window-shading-fc` diff — whole-list rewrite via Din4108Diff list wrappers.
...
fn apply_in_place(payload: &ChangeZoneWindowShadingFc, snap: &mut Din4108Snapshot) -> Result<(), String> {
    ...
    w.shading_fc = payload.new_shading_fc;
