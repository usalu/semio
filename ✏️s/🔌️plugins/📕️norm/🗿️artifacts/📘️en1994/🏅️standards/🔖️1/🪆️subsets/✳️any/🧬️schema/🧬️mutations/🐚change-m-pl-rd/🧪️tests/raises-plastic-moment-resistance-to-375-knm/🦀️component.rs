...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-m-pl-rd/raises-plastic-moment-resistance-to-375-knm: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
