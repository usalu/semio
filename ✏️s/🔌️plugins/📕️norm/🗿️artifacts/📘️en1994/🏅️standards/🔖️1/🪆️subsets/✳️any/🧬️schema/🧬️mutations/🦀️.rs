...
#[path = "."]
mod fixture_tests {
    #[path = "🏞️change-annex/🧪️tests/switches-national-annex-to-en/🦀️.rs"]
    mod tests_change_annex_switches_national_annex_to_en;
    #[path = "🌰change-d-mm/🧪️tests/thickens-stud-shank-to-22-mm/🦀️.rs"]
    mod tests_change_d_mm_thickens_stud_shank_to_22_mm;
    #[path = "🐝change-deck-type/🧪️tests/switches-deck-to-re-entrant/🦀️.rs"]
    mod tests_change_deck_type_switches_deck_to_re_entrant;
    #[path = "🌏️change-delta-sigma-mpa/🧪️tests/raises-steel-stress-range-to-96-mpa/🦀️.rs"]
    mod tests_change_delta_sigma_mpa_raises_steel_stress_range_to_96_mpa;
    #[path = "🌎️change-delta-tau-stud-mpa/🧪️tests/raises-stud-shear-stress-range-to-110-mpa/🦀️.rs"]
    mod tests_change_delta_tau_stud_mpa_raises_stud_shear_stress_range_to_110_mpa;
    #[path = "🌍️change-e-cm-mpa/🧪️tests/raises-concrete-modulus-to-35000-mpa/🦀️.rs"]
    mod tests_change_e_cm_mpa_raises_concrete_modulus_to_35000_mpa;
    #[path = "🏕️change-eta/🧪️tests/raises-shear-connection-degree-to-0-875/🦀️.rs"]
    mod tests_change_eta_raises_shear_connection_degree_to_0_875;
    #[path = "🪵change-f-ck-mpa/🧪️tests/upgrades-concrete-cylinder-strength-to-40-mpa/🦀️.rs"]
    mod tests_change_f_ck_mpa_upgrades_concrete_cylinder_strength_to_40_mpa;
    #[path = "⛰️change-fatigue-detail/🧪️tests/switches-fatigue-detail-to-flange-butt-weld/🦀️.rs"]
    mod tests_change_fatigue_detail_switches_fatigue_detail_to_flange_butt_weld;
    #[path = "🏟️change-fire-rating/🧪️tests/upgrades-fire-rating-to-r90/🦀️.rs"]
    mod tests_change_fire_rating_upgrades_fire_rating_to_r90;
    #[path = "🪨change-fu-mpa/🧪️tests/upgrades-stud-ultimate-strength-to-500-mpa/🦀️.rs"]
    mod tests_change_fu_mpa_upgrades_stud_ultimate_strength_to_500_mpa;
    #[path = "🌼change-fy-mpa/🧪️tests/upgrades-steel-yield-to-460-mpa/🦀️.rs"]
    mod tests_change_fy_mpa_upgrades_steel_yield_to_460_mpa;
    #[path = "🌐change-h-sc-mm/🧪️tests/lengthens-stud-to-125-mm/🦀️.rs"]
    mod tests_change_h_sc_mm_lengthens_stud_to_125_mm;
    #[path = "🏖️change-insulation-thickness-mm/🧪️tests/thickens-fire-insulation-to-40-mm/🦀️.rs"]
    mod tests_change_insulation_thickness_mm_thickens_fire_insulation_to_40_mm;
    #[path = "🗻change-m-ed-knm/🧪️tests/raises-design-moment-to-320-knm/🦀️.rs"]
    mod tests_change_m_ed_knm_raises_design_moment_to_320_knm;
    #[path = "🐚change-m-pl-rd/🧪️tests/raises-plastic-moment-resistance-to-375-knm/🦀️.rs"]
    mod tests_change_m_pl_rd_raises_plastic_moment_resistance_to_375_knm;
    #[path = "🏝️change-m-pla/🧪️tests/raises-steel-plastic-moment-to-128-knm/🦀️.rs"]
    mod tests_change_m_pla_raises_steel_plastic_moment_to_128_knm;
    #[path = "🏔️change-n-cycles-stud/🧪️tests/raises-stud-cycle-count-to-5000000/🦀️.rs"]
    mod tests_change_n_cycles_stud_raises_stud_cycle_count_to_5000000;
    #[path = "🌊change-span-m/🧪️tests/lengthens-span-to-12-m/🦀️.rs"]
    mod tests_change_span_m_lengthens_span_to_12_m;
    #[path = "🍄change-v-ed-kn/🧪️tests/raises-design-shear-to-225-kn/🦀️.rs"]
    mod tests_change_v_ed_kn_raises_design_shear_to_225_kn;
    #[path = "🏜️change-v-ed-per-stud-kn/🧪️tests/raises-per-stud-shear-to-62-5-kn/🦀️.rs"]
    mod tests_change_v_ed_per_stud_kn_raises_per_stud_shear_to_62_5_kn;
    #[path = "🐞change-vl-rd/🧪️tests/raises-longitudinal-shear-resistance-to-240-kn/🦀️.rs"]
