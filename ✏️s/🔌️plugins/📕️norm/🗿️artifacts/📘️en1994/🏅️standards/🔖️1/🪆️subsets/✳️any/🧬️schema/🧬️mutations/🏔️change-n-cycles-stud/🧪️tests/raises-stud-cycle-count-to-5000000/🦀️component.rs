//! 🧪️ `change-n-cycles-stud` fixture — `raises-stud-cycle-count-to-5000000` (EN 1994 composite).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-n-cycles-stud/raises-stud-cycle-count-to-5000000: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
