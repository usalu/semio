/** ✏️ EN 1994 editor — subset-level typed twin. Mirrors the editor manifest's mode/
...
export const EN1994_EDITOR_DIALECT = { artifactKind: "s.norm.en1994", standard: "1", subset: "*" } as const;

export const EN1994_EDIT_MODE_ID = "edit" as const;
