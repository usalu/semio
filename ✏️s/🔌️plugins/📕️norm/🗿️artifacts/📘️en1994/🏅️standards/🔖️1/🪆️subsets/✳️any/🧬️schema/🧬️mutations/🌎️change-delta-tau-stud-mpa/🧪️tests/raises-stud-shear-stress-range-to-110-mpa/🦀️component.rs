//! 🧪️ `change-delta-tau-stud-mpa` fixture — `raises-stud-shear-stress-range-to-110-mpa` (EN 1994 composite).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-delta-tau-stud-mpa/raises-stud-shear-stress-range-to-110-mpa: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
