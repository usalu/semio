//! 👁️ EN 1994 viewer — the `view` mode: a single full-pane Report window, the read-only
...
use crate::viewer::en1994::modes::view::windows::report;
use semio_framework_plugin::{ModeDefinition, WindowLayout};

//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::en1994::create_en1994_viewer`.
