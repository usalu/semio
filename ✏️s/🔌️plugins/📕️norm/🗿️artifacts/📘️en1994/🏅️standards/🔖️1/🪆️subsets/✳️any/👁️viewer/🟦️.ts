/** 👁️ EN 1994 viewer — subset-level typed twin. Read-only counterpart of
...
export const EN1994_VIEWER_DIALECT = { artifactKind: "s.norm.en1994", standard: "1", subset: "*" } as const;
