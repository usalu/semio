...
use crate::editor::en1994::commands::{evaluate, selected_check, set_snapshot};
...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.en1994/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &En1994Command, _snapshot: &En1994Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<En1994Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<En1994PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<En1994PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<En1994PlayApp>;
...
impl ArtifactEditor for En1994PlayApp {
    ...
    const DIALECT: Dialect = crate::artifacts::en1994::EN1994_DIALECT;
    const DOCUMENT_SCHEMA: &'static str = "semio.norm.en1994/v1";

    semio_framework_plugin::bounded_first_step_tool_proofs! {
        owner: semio_framework_plugin::EditorApp<En1994PlayApp>,
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📘️en1994/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
        controller: "s.norm.en1994@1/*#editor",
        document_schema: "semio.norm.en1994/v1",
...
//#region ðï¸Manifest
pub fn create_en1994_app() -> semio_framework_plugin::AppDefinition {
    Editor::builder(crate::artifacts::en1994::EN1994_DIALECT)
...
pub(crate) mod testkit {
    ...
    pub fn en1994_manifest_for_testkit() -> semio_framework_plugin::App {
    ...
    pub fn new_app() -> NormApp {
        sdk_new_app::<EditorApp<En1994PlayApp>>()
    }
    ...
    pub fn app_with_registry() -> NormApp {
        new_app_with_registry::<EditorApp<En1994PlayApp>>(en1994_manifest_for_testkit)
    }
