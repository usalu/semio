...
impl ArtifactEditor for En1994PlayApp {
    ...
    async fn command_id(command: &En1994Command) -> &'static str {
        command.command_id()
    }
    ...
    async fn render(body_key: &str, doc: &ArtifactView<'_, En1994Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
    ...
    async fn export_media(port: &str, doc: &ArtifactView<'_, En1994Snapshot>) -> Result<Media, MediaError> {
    ...
    async fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, En1994Snapshot>) -> Result<Emit<En1994Mutation, NormConfigMutation, Self::DraftMutation>, MediaError> {
...
impl crate::document::NormFamily for En1994Family {
    ...
    async fn evaluate(document: &En1994Snapshot) -> crate::document::CheckReport {
...
//#region ðï¸Manifest
pub async fn create_en1994_app() -> semio_framework_plugin::AppDefinition {
...
pub(crate) mod testkit {
    ...
    pub async fn en1994_manifest_for_testkit() -> semio_framework_plugin::App {
...
mod tests {
    ...
    async fn every_command() -> Vec<En1994Command> {
        vec![
