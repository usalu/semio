...
pub fn definition() -> Result<semio_framework_plugin::ArtifactDefinition, semio_framework_plugin::ArtifactDefinitionError> {
    crate::artifacts::definition::schema_owned_definition(
        "s.en1994",
        crate::artifacts::en1994::schema::en1994_artifact_schema_descriptor().id,
        crate::artifacts::en1994::standards::v1::subsets::any::schema::inferences::en1994_artifact_inference_descriptor().id,
        crate::artifacts::en1994::standards::v1::subsets::any::io::io_registry::entries(),
        pilot_languages(),
        crate::apps::en1994::DOCUMENT_SCHEMA,
        <En1994Snapshot as store::ArtifactDsl>::EXTENSION,
