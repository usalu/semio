...
mod tests {
    ...
    use crate::artifacts::iso16757::op::Iso16757Store;
    ...
    fn document_text_round_trips_through_a_vcs_store() {
        let envelope = store::create_document_envelope(crate::artifacts::iso16757::ISO16757_EXTENSION, "iso16757.demo", Document::reference_fixture(), None);
        let mut store = Iso16757Store::new(envelope);
        let mut mutated = Document::reference_fixture();
        mutated.exchange_process = crate::artifacts::iso16757::part_5::ExchangeProcess::ProvideCatalogue;
