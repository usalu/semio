/** 🧬️ Iso16757Mutation — mirrors `Iso16757Mutation` in `🦀️component.rs` (21 variants over
 ...
 * }`, confirmed by every committed `🧪️tests/*​/🦠️mutation/🔣️component.json` fixture (e.g.
