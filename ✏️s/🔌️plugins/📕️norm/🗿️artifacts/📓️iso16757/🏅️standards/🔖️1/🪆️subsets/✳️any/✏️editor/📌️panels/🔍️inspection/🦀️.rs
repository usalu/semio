...
//#region 🔖️Constants
pub const BODY_INSPECTION: &str = "norm.iso16757.play.inspection";
...
//#region 🔖️Render
pub fn render(host: &NormHost<Iso16757Family>, selected_check_index: Option<u32>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
