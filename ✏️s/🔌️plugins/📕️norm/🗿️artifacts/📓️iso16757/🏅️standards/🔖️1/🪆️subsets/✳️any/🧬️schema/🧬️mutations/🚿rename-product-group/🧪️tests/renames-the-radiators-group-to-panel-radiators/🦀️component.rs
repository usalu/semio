//! 🧪️ `rename-product-group` fixture — `renames-the-radiators-group-to-panel-radiators`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-product-group/renames-the-radiators-group-to-panel-radiators: the produced diff differs from the committed 🔺️diff/🔣️component.json");
}
