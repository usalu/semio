//! 🧪️ `change-part-number-input` fixture — `🔢️raises-the-height-part-number-input-to-750`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-part-number-input/raises-the-height-part-number-input-to-750: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
