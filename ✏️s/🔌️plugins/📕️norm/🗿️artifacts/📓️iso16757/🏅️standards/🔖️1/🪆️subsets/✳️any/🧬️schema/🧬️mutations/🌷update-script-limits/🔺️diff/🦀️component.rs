...
pub fn diff(payload: &UpdateScriptLimits, _base: &Iso16757Snapshot) -> Iso16757Diff {
    Iso16757Diff { script_limits: Some(ScriptLimits { max_steps: payload.new_max_steps, max_recursion: payload.new_max_recursion, timeout_ms: payload.new_timeout_ms }), ..Default::default() }
}
//#endregion 🔖️Diff
