...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.iso16757/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &Iso16757Command, _snapshot: &Iso16757Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<Iso16757Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<Iso16757PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<Iso16757PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<Iso16757PlayApp>;
...
impl ArtifactEditor for Iso16757PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📓️iso16757/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
    ...
    fn render(body_key: &str, doc: &ArtifactView<'_, Iso16757Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
