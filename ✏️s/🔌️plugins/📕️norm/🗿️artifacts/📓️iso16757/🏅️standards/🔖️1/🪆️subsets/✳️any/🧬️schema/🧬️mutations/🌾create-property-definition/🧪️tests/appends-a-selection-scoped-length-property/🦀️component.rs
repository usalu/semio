...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-property-definition/appends-a-selection-scoped-length-property: the produced diff differs from the committed 🔺️diff/🔣️component.json");
}
