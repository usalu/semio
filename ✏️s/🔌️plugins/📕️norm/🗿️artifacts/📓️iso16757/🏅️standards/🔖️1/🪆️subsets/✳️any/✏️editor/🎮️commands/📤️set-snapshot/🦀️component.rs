...
//#region 🔖️Handler
pub async fn handle(payload: &ReplaceSnapshot, doc: &ArtifactView<'_, Iso16757Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<Iso16757Mutation, NormConfigMutation>, Fault> {
