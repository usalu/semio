...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-selection-class/retargets-the-selection-at-the-towel-radiator-class: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
