...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-product/renames-pr600-to-the-compact-variant-name: the produced diff differs from the committed 🔺️diff/🔣️component.json");
}
