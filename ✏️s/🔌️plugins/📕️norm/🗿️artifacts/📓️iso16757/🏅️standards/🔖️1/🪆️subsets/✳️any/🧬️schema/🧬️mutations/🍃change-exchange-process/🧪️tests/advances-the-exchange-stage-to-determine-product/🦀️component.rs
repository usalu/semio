...
#[semio_framework_async_macros::async_test]
async fn returning_to_the_provide_catalogue_stage_restores_before() {
    let base = before();
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-exchange-process/advances-the-exchange-stage-to-determine-product: the produced diff differs from the committed 🔺️diff/🔣️component.json");
}
