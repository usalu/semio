//! 🧪️ `add-selection-constraint` fixture — `🍊️appends-a-width-under-800-constraint`.
//!
...
fn appends_a_width_under_800_constraint() {
...
#[semio_framework_async_macros::async_test]
fn removing_the_appended_constraint_restores_before() {
    let base = before();
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "add-selection-constraint/appends-a-width-under-800-constraint: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
