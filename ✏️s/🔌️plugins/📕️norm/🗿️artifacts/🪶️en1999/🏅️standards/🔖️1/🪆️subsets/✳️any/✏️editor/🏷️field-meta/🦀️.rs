...
const TABLE: &[(&str, NormFieldMeta)] = &[
    ...
    ("coldFormed[].actions[].id", m("Sheet action id", "Blech-Einwirkungs-Id", None, None)),
    ("coldFormed[].actions[].kind", m("Sheet action kind", "Blech-Einwirkungsart", None, Some(ACTION_KIND))),
    ("coldFormed[].actions[].category", m("Sheet action category", "Blech-Einwirkungskategorie", None, Some(ACTION_CAT))),
    ("coldFormed[].actions[].source", m("Sheet action source", "Blech-Einwirkungsquelle", None, Some(ACTION_SRC))),
    ("coldFormed[].actions[].gKLine", m("Sheet g_k line load", "Blech g_k Streckenlast", Some("N/m"), None)),
    ("coldFormed[].actions[].qKLine", m("Sheet q_k line load", "Blech q_k Streckenlast", Some("N/m"), None)),
    ("coldFormed[].actions[].nK", m("Sheet characteristic axial N_k", "Blech charakteristische Normalkraft N_k", Some("N"), None)),
    ("coldFormed[].actions[].vYK", m("Sheet characteristic shear V_y,k", "Blech charakteristische Querkraft V_y,k", Some("N"), None)),
    ("coldFormed[].actions[].vZK", m("Sheet characteristic shear V_z,k", "Blech charakteristische Querkraft V_z,k", Some("N"), None)),
    ("coldFormed[].actions[].mYK", m("Sheet characteristic moment M_y,k", "Blech charakteristisches Moment M_y,k", Some("N·m"), None)),
    ("coldFormed[].actions[].mZK", m("Sheet characteristic moment M_z,k", "Blech charakteristisches Moment M_z,k", Some("N·m"), None)),
    ...
    ("shells[].actions[].id", m("Shell action id", "Schalen-Einwirkungs-Id", None, None)),
    ("shells[].actions[].kind", m("Shell action kind", "Schalen-Einwirkungsart", None, Some(ACTION_KIND))),
    ("shells[].actions[].category", m("Shell action category", "Schalen-Einwirkungskategorie", None, Some(ACTION_CAT))),
    ("shells[].actions[].source", m("Shell action source", "Schalen-Einwirkungsquelle", None, Some(ACTION_SRC))),
    ("shells[].actions[].gKLine", m("Shell g_k (unused for membrane)", "Schale g_k (für Membran ungenutzt)", Some("N/m"), None)),
    ("shells[].actions[].qKLine", m("Shell q_k (unused for membrane)", "Schale q_k (für Membran ungenutzt)", Some("N/m"), None)),
    ("shells[].actions[].nK", m("Characteristic meridional stress σ_x,k", "Charakteristische Meridianspannung σ_x,k", Some("Pa"), None)),
    ("shells[].actions[].vYK", m("Shell characteristic V_y,k", "Schale charakteristische V_y,k", Some("N"), None)),
    ("shells[].actions[].vZK", m("Characteristic shear stress τ_k", "Charakteristische Schubspannung τ_k", Some("Pa"), None)),
    ("shells[].actions[].mYK", m("Characteristic circumferential stress σ_θ,k", "Charakteristische Umfangsspannung σ_θ,k", Some("Pa"), None)),
    ("shells[].actions[].mZK", m("Shell characteristic M_z,k", "Schale charakteristisches M_z,k", Some("N·m"), None)),
