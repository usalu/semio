...
impl En1999Artifact {
    pub fn to_snapshot(&self) -> En1999Snapshot {
        En1999Snapshot {
            ...
            a_mm2: self.a_mm2,
            w_el_mm3: self.w_el_mm3,
            alloy: self.alloy.clone(),
            chi: self.chi,
            i_t_mm4: self.i_t_mm4,
            l_cr_mm: self.l_cr_mm,
            theta_c: self.theta_c,
            delta_sigma_ed: self.delta_sigma_ed,
            delta_sigma_c: self.delta_sigma_c,
            fatigue_m: self.fatigue_m,
            n_cycles: self.n_cycles,
            v_weld_ed_kn: self.v_weld_ed_kn,
            weld_throat_mm: self.weld_throat_mm,
            weld_length_mm: self.weld_length_mm,
            beta_w: self.beta_w,
            sheet_b_mm: self.sheet_b_mm,
            sheet_t_mm: self.sheet_t_mm,
            sheet_k_sigma: self.sheet_k_sigma,
            sheet_w_el_mm3: self.sheet_w_el_mm3,
            sheet_m_ed_knm: self.sheet_m_ed_knm,
            shell_t_mm: self.shell_t_mm,
            shell_r_mm: self.shell_r_mm,
            sigma_ed_shell_mpa: self.sigma_ed_shell_mpa,
            annex: self.annex,
        }
    }
