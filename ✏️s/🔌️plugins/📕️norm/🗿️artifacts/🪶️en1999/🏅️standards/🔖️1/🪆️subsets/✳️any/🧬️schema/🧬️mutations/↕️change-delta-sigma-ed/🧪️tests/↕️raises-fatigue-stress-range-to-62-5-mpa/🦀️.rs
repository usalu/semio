//! 🧪️ `change-delta-sigma-ed` fixture — `↕️raises-fatigue-stress-range-to-62-5-mpa` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️change-delta-sigma-ed/↕️raises-fatigue-stress-range-to-62-5-mpa/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️change-delta-sigma-ed/↕️raises-fatigue-stress-range-to-62-5-mpa/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️change-delta-sigma-ed/↕️raises-fatigue-stress-range-to-62-5-mpa/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️change-delta-sigma-ed/↕️raises-fatigue-stress-range-to-62-5-mpa/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️change-delta-sigma-ed/↕️raises-fatigue-stress-range-to-62-5-mpa/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-delta-sigma-ed/raises-fatigue-stress-range-to-62-5-mpa: produced diff differs from the committed 🔺️diff/🔣️.json");
}
