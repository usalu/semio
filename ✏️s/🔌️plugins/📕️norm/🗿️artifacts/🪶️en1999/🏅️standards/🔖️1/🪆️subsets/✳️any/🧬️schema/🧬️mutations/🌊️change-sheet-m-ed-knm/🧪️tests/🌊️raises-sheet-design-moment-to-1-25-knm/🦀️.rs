//! 🧪️ `change-sheet-m-ed-knm` fixture — `🌊️raises-sheet-design-moment-to-1-25-knm` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌊️change-sheet-m-ed-knm/🌊️raises-sheet-design-moment-to-1-25-knm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌊️change-sheet-m-ed-knm/🌊️raises-sheet-design-moment-to-1-25-knm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌊️change-sheet-m-ed-knm/🌊️raises-sheet-design-moment-to-1-25-knm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌊️change-sheet-m-ed-knm/🌊️raises-sheet-design-moment-to-1-25-knm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌊️change-sheet-m-ed-knm/🌊️raises-sheet-design-moment-to-1-25-knm/🎯️outcome/🔣️.json");
