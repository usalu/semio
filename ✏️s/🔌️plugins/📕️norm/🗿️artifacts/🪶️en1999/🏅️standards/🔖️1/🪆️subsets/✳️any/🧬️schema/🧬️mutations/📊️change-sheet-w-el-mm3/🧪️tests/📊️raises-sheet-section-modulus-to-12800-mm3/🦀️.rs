//! 🧪️ `change-sheet-w-el-mm3` fixture — `📊️raises-sheet-section-modulus-to-12800-mm3` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️change-sheet-w-el-mm3/📊️raises-sheet-section-modulus-to-12800-mm3/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️change-sheet-w-el-mm3/📊️raises-sheet-section-modulus-to-12800-mm3/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️change-sheet-w-el-mm3/📊️raises-sheet-section-modulus-to-12800-mm3/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️change-sheet-w-el-mm3/📊️raises-sheet-section-modulus-to-12800-mm3/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️change-sheet-w-el-mm3/📊️raises-sheet-section-modulus-to-12800-mm3/🎯️outcome/🔣️.json");
