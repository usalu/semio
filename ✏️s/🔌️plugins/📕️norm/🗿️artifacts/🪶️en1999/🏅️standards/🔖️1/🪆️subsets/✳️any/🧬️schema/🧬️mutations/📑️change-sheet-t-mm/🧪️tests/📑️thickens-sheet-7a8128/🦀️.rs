//! 🧪️ `change-sheet-t-mm` fixture — `📑️thickens-sheet-to-3-5-mm` (EN 1999 aluminium).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-sheet-t-mm/thickens-sheet-to-3-5-mm: produced diff differs from the committed 🔺️diff/🔣️.json");
}
