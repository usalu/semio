//! 🧪️ `change-w-el-mm3` fixture — `🧊️raises-section-modulus-to-40000-mm3` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️change-w-el-mm3/🧊️raises-section-modulus-to-40000-mm3/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️change-w-el-mm3/🧊️raises-section-modulus-to-40000-mm3/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️change-w-el-mm3/🧊️raises-section-modulus-to-40000-mm3/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️change-w-el-mm3/🧊️raises-section-modulus-to-40000-mm3/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️change-w-el-mm3/🧊️raises-section-modulus-to-40000-mm3/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-w-el-mm3/raises-section-modulus-to-40000-mm3: produced diff differs from the committed 🔺️diff/🔣️.json");
}
