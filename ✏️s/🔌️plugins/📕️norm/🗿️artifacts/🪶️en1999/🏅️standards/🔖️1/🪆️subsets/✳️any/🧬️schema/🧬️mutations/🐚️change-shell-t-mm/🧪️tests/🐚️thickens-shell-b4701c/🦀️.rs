//! 🧪️ `change-shell-t-mm` fixture — `🐚️thickens-shell-to-6-25-mm` (EN 1999 aluminium).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-shell-t-mm/thickens-shell-to-6-25-mm: produced diff differs from the committed 🔺️diff/🔣️.json");
}
