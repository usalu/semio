...
pub fn handle(_payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, En1999Snapshot>, _cfg: &ConfigView<'_, NoConfig>) -> Result<Emit<En1999Mutation, NoConfigMutation>, Fault> {
    Ok(Emit::default())
}
//#endregion 🔖️Handler
