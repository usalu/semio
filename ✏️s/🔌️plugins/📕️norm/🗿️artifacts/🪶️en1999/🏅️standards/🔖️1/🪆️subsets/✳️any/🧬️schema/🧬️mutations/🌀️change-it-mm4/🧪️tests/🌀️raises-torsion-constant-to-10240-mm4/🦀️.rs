//! 🧪️ `change-it-mm4` fixture — `🌀️raises-torsion-constant-to-10240-mm4` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-it-mm4/🌀️raises-torsion-constant-to-10240-mm4/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-it-mm4/🌀️raises-torsion-constant-to-10240-mm4/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-it-mm4/🌀️raises-torsion-constant-to-10240-mm4/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-it-mm4/🌀️raises-torsion-constant-to-10240-mm4/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-it-mm4/🌀️raises-torsion-constant-to-10240-mm4/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-it-mm4/raises-torsion-constant-to-10240-mm4: produced diff differs from the committed 🔺️diff/🔣️.json");
}
