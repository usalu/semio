...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-l-cr-mm/📏️lengthens-buckling-length-to-4000-mm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-l-cr-mm/📏️lengthens-buckling-length-to-4000-mm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-l-cr-mm/📏️lengthens-buckling-length-to-4000-mm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-l-cr-mm/📏️lengthens-buckling-length-to-4000-mm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-l-cr-mm/📏️lengthens-buckling-length-to-4000-mm/🎯️outcome/🔣️.json");
