//! 🧪️ `change-m-ed-knm` fixture — `⤴️raises-design-moment-to-9-5-knm` (EN 1999 aluminium).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-m-ed-knm/raises-design-moment-to-9-5-knm: produced diff differs from the committed 🔺️diff/🔣️.json");
}
