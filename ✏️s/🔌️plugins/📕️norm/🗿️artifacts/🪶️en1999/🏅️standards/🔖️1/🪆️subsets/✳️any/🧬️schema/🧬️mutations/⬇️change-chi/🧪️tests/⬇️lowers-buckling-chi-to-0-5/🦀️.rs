//! 🧪️ `change-chi` fixture — `⬇️lowers-buckling-chi-to-0-5` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-chi/⬇️lowers-buckling-chi-to-0-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-chi/⬇️lowers-buckling-chi-to-0-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-chi/⬇️lowers-buckling-chi-to-0-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-chi/⬇️lowers-buckling-chi-to-0-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-chi/⬇️lowers-buckling-chi-to-0-5/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-chi/lowers-buckling-chi-to-0-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
