...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-design-moment-to-9-5-knm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-design-moment-to-9-5-knm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-design-moment-to-9-5-knm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-design-moment-to-9-5-knm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-design-moment-to-9-5-knm/🎯️outcome/🔣️.json");
