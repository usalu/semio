//! 🧪️ `change-sigma-ed-shell-mpa` fixture — `🐚️raises-shell-design-stress-to-165-mpa` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-sigma-ed-shell-mpa/🐚️raises-shell-design-stress-to-165-mpa/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-sigma-ed-shell-mpa/🐚️raises-shell-design-stress-to-165-mpa/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-sigma-ed-shell-mpa/🐚️raises-shell-design-stress-to-165-mpa/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-sigma-ed-shell-mpa/🐚️raises-shell-design-stress-to-165-mpa/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-sigma-ed-shell-mpa/🐚️raises-shell-design-stress-to-165-mpa/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-sigma-ed-shell-mpa/raises-shell-design-stress-to-165-mpa: produced diff differs from the committed 🔺️diff/🔣️.json");
}
