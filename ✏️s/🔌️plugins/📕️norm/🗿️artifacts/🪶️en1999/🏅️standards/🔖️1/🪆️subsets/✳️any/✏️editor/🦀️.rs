...
impl ArtifactEditor for En1999PlayApp {
    ...
    fn render(body_key: &str, doc: &ArtifactView<'_, En1999Snapshot>, cfg: &ConfigView<'_, NormConfig>, _view_state: &semio_framework_plugin::ViewModel) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::ComponentTree> {
