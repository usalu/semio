...
fn en1999_mutation_to_dsl(mutation: &En1999Mutation) -> En1999MutationDsl {
    match mutation {
        En1999Mutation::ChangeNEdKn(payload) => En1999MutationDsl::ChangeNEdKn { new_n_ed_kn: payload.new_n_ed_kn },
        En1999Mutation::ChangeMEdKnm(payload) => En1999MutationDsl::ChangeMEdKnm { new_m_ed_knm: payload.new_m_ed_knm },
        En1999Mutation::ChangeAMm2(payload) => En1999MutationDsl::ChangeAMm2 { new_a_mm2: payload.new_a_mm2 },
        En1999Mutation::ChangeWElMm3(payload) => En1999MutationDsl::ChangeWElMm3 { new_w_el_mm3: payload.new_w_el_mm3 },
        En1999Mutation::ChangeAlloy(payload) => En1999MutationDsl::ChangeAlloy { new_alloy: payload.new_alloy.clone() },
        En1999Mutation::ChangeChi(payload) => En1999MutationDsl::ChangeChi { new_chi: payload.new_chi },
        En1999Mutation::ChangeITMm4(payload) => En1999MutationDsl::ChangeITMm4 { new_i_t_mm4: payload.new_i_t_mm4 },
        En1999Mutation::ChangeLCrMm(payload) => En1999MutationDsl::ChangeLCrMm { new_l_cr_mm: payload.new_l_cr_mm },
        En1999Mutation::ChangeThetaC(payload) => En1999MutationDsl::ChangeThetaC { new_theta_c: payload.new_theta_c },
        En1999Mutation::ChangeDeltaSigmaEd(payload) => En1999MutationDsl::ChangeDeltaSigmaEd { new_delta_sigma_ed: payload.new_delta_sigma_ed },
        En1999Mutation::ChangeDeltaSigmaC(payload) => En1999MutationDsl::ChangeDeltaSigmaC { new_delta_sigma_c: payload.new_delta_sigma_c },
        En1999Mutation::ChangeFatigueM(payload) => En1999MutationDsl::ChangeFatigueM { new_fatigue_m: payload.new_fatigue_m },
        En1999Mutation::ChangeNCycles(payload) => En1999MutationDsl::ChangeNCycles { new_n_cycles: payload.new_n_cycles },
        En1999Mutation::ChangeVWeldEdKn(payload) => En1999MutationDsl::ChangeVWeldEdKn { new_v_weld_ed_kn: payload.new_v_weld_ed_kn },
        En1999Mutation::ChangeWeldThroatMm(payload) => En1999MutationDsl::ChangeWeldThroatMm { new_weld_throat_mm: payload.new_weld_throat_mm },
        En1999Mutation::ChangeWeldLengthMm(payload) => En1999MutationDsl::ChangeWeldLengthMm { new_weld_length_mm: payload.new_weld_length_mm },
        En1999Mutation::ChangeBetaW(payload) => En1999MutationDsl::ChangeBetaW { new_beta_w: payload.new_beta_w },
        En1999Mutation::ChangeSheetBMm(payload) => En1999MutationDsl::ChangeSheetBMm { new_sheet_b_mm: payload.new_sheet_b_mm },
        En1999Mutation::ChangeSheetTMm(payload) => En1999MutationDsl::ChangeSheetTMm { new_sheet_t_mm: payload.new_sheet_t_mm },
        En1999Mutation::ChangeSheetKSigma(payload) => En1999MutationDsl::ChangeSheetKSigma { new_sheet_k_sigma: payload.new_sheet_k_sigma },
        En1999Mutation::ChangeSheetWElMm3(payload) => En1999MutationDsl::ChangeSheetWElMm3 { new_sheet_w_el_mm3: payload.new_sheet_w_el_mm3 },
        En1999Mutation::ChangeSheetMEdKnm(payload) => En1999MutationDsl::ChangeSheetMEdKnm { new_sheet_m_ed_knm: payload.new_sheet_m_ed_knm },
        En1999Mutation::ChangeShellTMm(payload) => En1999MutationDsl::ChangeShellTMm { new_shell_t_mm: payload.new_shell_t_mm },
        En1999Mutation::ChangeShellRMm(payload) => En1999MutationDsl::ChangeShellRMm { new_shell_r_mm: payload.new_shell_r_mm },
        En1999Mutation::ChangeSigmaEdShellMpa(payload) => En1999MutationDsl::ChangeSigmaEdShellMpa { new_sigma_ed_shell_mpa: payload.new_sigma_ed_shell_mpa },
        En1999Mutation::ChangeAnnex(payload) => En1999MutationDsl::ChangeAnnex { new_annex: payload.new_annex },
    }
}
