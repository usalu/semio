...
//#region 🔖️Constants
pub const BODY_ARTIFACT: &str = "norm.en1999.play.artifact";
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1999Family>, locale: semio_framework_plugin::Locale) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
