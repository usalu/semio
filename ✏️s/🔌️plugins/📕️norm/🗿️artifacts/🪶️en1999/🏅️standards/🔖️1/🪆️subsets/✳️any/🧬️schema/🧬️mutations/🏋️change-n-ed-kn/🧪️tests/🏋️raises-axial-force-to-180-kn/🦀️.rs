//! 🧪️ `change-n-ed-kn` fixture — `🏋️raises-axial-force-to-180-kn` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-n-ed-kn/🏋️raises-axial-force-to-180-kn/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-n-ed-kn/🏋️raises-axial-force-to-180-kn/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-n-ed-kn/🏋️raises-axial-force-to-180-kn/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-n-ed-kn/🏋️raises-axial-force-to-180-kn/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-n-ed-kn/🏋️raises-axial-force-to-180-kn/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-n-ed-kn/raises-axial-force-to-180-kn: produced diff differs from the committed 🔺️diff/🔣️.json");
}
