//! 🧪️ `change-theta-c` fixture — `🌡️raises-temperature-to-225-c` (EN 1999 aluminium).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-theta-c/🌡️raises-temperature-to-225-c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-theta-c/🌡️raises-temperature-to-225-c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-theta-c/🌡️raises-temperature-to-225-c/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-theta-c/🌡️raises-temperature-to-225-c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-theta-c/🌡️raises-temperature-to-225-c/🎯️outcome/🔣️.json");
