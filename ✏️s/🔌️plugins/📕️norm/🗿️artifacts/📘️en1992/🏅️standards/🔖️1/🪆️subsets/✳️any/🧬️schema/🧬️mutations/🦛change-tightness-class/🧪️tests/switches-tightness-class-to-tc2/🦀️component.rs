...
fn change_tightness_class_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
fn change_tightness_class_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
fn change_tightness_class_committed_json_is_canonical() {
...
#[semio_framework_async_macros::async_test]
fn change_tightness_class_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
fn change_tightness_class_produces_committed_diff() {
    let outcome = <En1992Mutation as protocol::Mutation<En1992Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
fn change_tightness_class_committed_diff_is_canonical() {
...
#[semio_framework_async_macros::async_test]
fn change_tightness_class_committed_diff_applies_to_after() {
    let decoded: En1992Diff = serde_json::from_str(DIFF).expect("change-tightness-class committed diff decodes");
