...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1992Diff.liquid_f_ct_eff_mpa` and nothing else,
...
fn change_liquid_f_ct_eff_mpa_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-liquid-f-ct-eff-mpa/raises-liquid-f-ct-eff-mpa-to-3-25: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
