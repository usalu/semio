...
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1992Diff.liquid_sigma_s_mpa` and nothing else,
...
fn change_liquid_sigma_s_mpa_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-liquid-sigma-s-mpa/raises-liquid-sigma-s-mpa-to-235-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
