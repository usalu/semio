...
//#region 🔖️Handler
pub async fn handle(payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, En1992Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1992Mutation, NormConfigMutation>, Fault> {
