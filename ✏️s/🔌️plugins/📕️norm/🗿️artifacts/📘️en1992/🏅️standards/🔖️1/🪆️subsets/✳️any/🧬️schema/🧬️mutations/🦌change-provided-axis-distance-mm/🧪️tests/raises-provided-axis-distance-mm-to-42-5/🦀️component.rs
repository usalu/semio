...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1992Diff.provided_axis_distance_mm` and nothing else,
...
async fn change_provided_axis_distance_mm_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-provided-axis-distance-mm/raises-provided-axis-distance-mm-to-42-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
