//! 🧪️ `change-udl-kn-m` fixture — `raises-udl-kn-m-to-26-25`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1992Diff.udl_kn_m` and nothing else,
...
fn change_udl_kn_m_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-udl-kn-m/raises-udl-kn-m-to-26-25: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
