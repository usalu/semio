...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1992Diff.b_mm` and nothing else,
...
async fn change_b_mm_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-b-mm/raises-b-mm-to-375-0: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
