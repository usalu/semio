...
impl protocol::MutationKind<En1992Snapshot, En1992Mutation> for ChangeAnchorHEfMm {
    ...
    fn diff(&self, base: &En1992Snapshot) -> protocol::MutationOutcome<En1992Diff> {
        crate::artifacts::en1992::mutations::change_anchor_h_ef_mm::diff::diff(self, base)
    }

    fn inverse(&self, base: &En1992Snapshot) -> Vec<En1992Mutation> {
        crate::artifacts::en1992::mutations::change_anchor_h_ef_mm::inverse::inverse(self, base)
    }
