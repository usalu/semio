//! 🧪️ `change-anchor-c1-mm` fixture — `raises-anchor-c1-mm-to-137-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1992Diff.anchor_c1_mm` and nothing else,
...
async fn change_anchor_c1_mm_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-anchor-c1-mm/raises-anchor-c1-mm-to-137-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
