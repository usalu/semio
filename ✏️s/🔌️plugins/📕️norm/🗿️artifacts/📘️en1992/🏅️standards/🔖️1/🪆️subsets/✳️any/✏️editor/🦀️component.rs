...
impl ArtifactEditor for En1992PlayApp {
    ...
    async fn initial_snapshot() -> En1992Snapshot {
    ...
    async fn command_id(command: &En1992Command) -> &'static str {
        command.command_id()
    }
    ...
    async fn render(body_key: &str, doc: &ArtifactView<'_, En1992Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
    ...
    async fn export_media(port: &str, doc: &ArtifactView<'_, En1992Snapshot>) -> Result<Media, MediaError> {
    ...
    async fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, En1992Snapshot>) -> Result<Emit<En1992Mutation, NormConfigMutation, Self::DraftMutation>, MediaError> {
...
impl crate::document::NormFamily for En1992Family {
    ...
    async fn evaluate(document: &En1992Snapshot) -> crate::document::CheckReport {
...
//#region ðï¸Manifest
pub async fn create_en1992_app() -> semio_framework_plugin::AppDefinition {
...
pub(crate) mod testkit {
    ...
    pub async fn en1992_manifest_for_testkit() -> semio_framework_plugin::App {
...
mod tests {
    ...
    async fn every_command() -> Vec<En1992Command> {
        vec![
