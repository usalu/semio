...
//! agent owns `📦️glue.rs`). The one exception is the `🧪️FixtureTests` region at the bottom of
//! this file: the per-mutation fixture cases self-wire from here, because `📦️glue.rs` is shared
...
/// order and spelling — the list `../../🧪️oracle/🔣️component.json` publishes as the `en1992-1-any`
...
impl En1992Mutation {
    ...
    pub async fn from_snapshot(snapshot: &En1992Snapshot) -> Vec<En1992Mutation> {
...
mod tests {
    ...
    async fn every_mutation() -> Vec<En1992Mutation> {
        vec![
    ...
    async fn round_trip(base: &En1992Snapshot, mutation: &En1992Mutation) -> En1992Snapshot {
...
#[path = "."]
mod fixture_tests {
    #[path = "🐞change-ac-mm2/🧪️tests/raises-a-c-mm2-to-168750-0/🦀️component.rs"]
    mod tests_change_a_c_mm2_raises;
    #[path = "🐍change-as-mm2/🧪️tests/raises-a-s-mm2-to-1608-5/🦀️component.rs"]
    mod tests_change_a_s_mm2_raises;
    #[path = "🦋change-anchor-as-mm2/🧪️tests/raises-anchor-a-s-mm2-to-157-0/🦀️component.rs"]
    mod tests_change_anchor_a_s_mm2_raises;
    #[path = "🐌change-anchor-c1-mm/🧪️tests/raises-anchor-c1-mm-to-137-5/🦀️component.rs"]
    mod tests_change_anchor_c1_mm_raises;
    #[path = "🐢change-anchor-cracked/🧪️tests/turns-anchor-cracked-on/🦀️component.rs"]
    mod tests_change_anchor_cracked_turns_on;
    #[path = "🐬change-anchor-d-mm/🧪️tests/raises-anchor-d-mm-to-16-0/🦀️component.rs"]
    mod tests_change_anchor_d_mm_raises;
    #[path = "🐳change-anchor-f-uk-mpa/🧪️tests/raises-anchor-f-uk-mpa-to-900-0/🦀️component.rs"]
    mod tests_change_anchor_f_uk_mpa_raises;
    #[path = "🦈change-anchor-f-yk-mpa/🧪️tests/raises-anchor-f-yk-mpa-to-720-0/🦀️component.rs"]
    mod tests_change_anchor_f_yk_mpa_raises;
    #[path = "🦭change-anchor-h-ef-mm/🧪️tests/raises-anchor-h-ef-mm-to-105-0/🦀️component.rs"]
    mod tests_change_anchor_h_ef_mm_raises;
    #[path = "🐊change-anchor-n-ed-kn/🧪️tests/raises-anchor-n-ed-kn-to-22-5/🦀️component.rs"]
    mod tests_change_anchor_n_ed_kn_raises;
    #[path = "🦎change-anchor-v-ed-kn/🧪️tests/raises-anchor-v-ed-kn-to-11-25/🦀️component.rs"]
    mod tests_change_anchor_v_ed_kn_raises;
    #[path = "🦂change-b-mm/🧪️tests/raises-b-mm-to-375-0/🦀️component.rs"]
    mod tests_change_b_mm_raises;
    #[path = "🦟change-bridge-delta-sigma-s-mpa/🧪️tests/raises-bridge-delta-sigma-s-mpa-to-132-5/🦀️component.rs"]
    mod tests_change_bridge_delta_sigma_s_mpa_raises;
    #[path = "🦗change-bridge-sigma-c-mpa/🧪️tests/raises-bridge-sigma-c-mpa-to-15-75/🦀️component.rs"]
    mod tests_change_bridge_sigma_c_mpa_raises;
    #[path = "🕷️change-d-mm/🧪️tests/raises-d-mm-to-512-5/🦀️component.rs"]
    mod tests_change_d_mm_raises;
    #[path = "🐜change-f-ck/🧪️tests/raises-f-ck-to-45-0/🦀️component.rs"]
    mod tests_change_f_ck_raises;
    #[path = "🦔change-f-yk/🧪️tests/raises-f-yk-to-550-0/🦀️component.rs"]
    mod tests_change_f_yk_raises;
    #[path = "🦇change-fire-rating/🧪️tests/switches-fire-rating-to-r120/🦀️component.rs"]
    mod tests_change_fire_rating_switches;
    #[path = "🦉change-hd-over-h/🧪️tests/raises-hd-over-h-to-12-5/🦀️component.rs"]
    mod tests_change_hd_over_h_raises;
    #[path = "🐴change-liquid-es-mpa/🧪️tests/raises-liquid-e-s-mpa-to-205000-0/🦀️component.rs"]
    mod tests_change_liquid_e_s_mpa_raises;
    #[path = "🐎change-liquid-f-ct-eff-mpa/🧪️tests/raises-liquid-f-ct-eff-mpa-to-3-25/🦀️component.rs"]
    mod tests_change_liquid_f_ct_eff_mpa_raises;
    #[path = "🦄change-liquid-rho-p-eff/🧪️tests/raises-liquid-rho-p-eff-to-0-0078125/🦀️component.rs"]
    mod tests_change_liquid_rho_p_eff_raises;
    #[path = "🐐change-liquid-sr-max-mm/🧪️tests/raises-liquid-s-r-max-mm-to-312-5/🦀️component.rs"]
    mod tests_change_liquid_s_r_max_mm_raises;
    #[path = "🐑change-liquid-sigma-s-mpa/🧪️tests/raises-liquid-sigma-s-mpa-to-235-5/🦀️component.rs"]
    ...
    #[path = "🐷change-n-ed-kn/🧪️tests/raises-n-ed-kn-to-62-5/🦀️component.rs"]
    mod tests_change_n_ed_kn_raises;
    #[path = "🐗change-p-kn/🧪️tests/raises-p-kn-to-45-5/🦀️component.rs"]
    mod tests_change_p_kn_raises;
    #[path = "🦌change-provided-axis-distance-mm/🧪️tests/raises-provided-axis-distance-mm-to-42-5/🦀️component.rs"]
    mod tests_change_provided_axis_distance_mm_raises;
    #[path = "🐘change-rho-l/🧪️tests/raises-rho-l-to-0-015625/🦀️component.rs"]
    mod tests_change_rho_l_raises;
    #[path = "🦏change-span-m/🧪️tests/raises-span-m-to-7-5/🦀️component.rs"]
    mod tests_change_span_m_raises;
    #[path = "🦛change-tightness-class/🧪️tests/switches-tightness-class-to-tc2/🦀️component.rs"]
    mod tests_change_tightness_class_switches;
    #[path = "🐪change-udl-kn-m/🧪️tests/raises-udl-kn-m-to-26-25/🦀️component.rs"]
    mod tests_change_udl_kn_m_raises;
    #[path = "🐫change-use-fem/🧪️tests/turns-use-fem-on/🦀️component.rs"]
    mod tests_change_use_fem_turns_on;
    #[path = "🦒change-v-ed-kn/🧪️tests/raises-v-ed-kn-to-96-5/🦀️component.rs"]
    mod tests_change_v_ed_kn_raises;
    #[path = "🐝set-snapshot/🧪️tests/switches-annex-to-en/🦀️component.rs"]
