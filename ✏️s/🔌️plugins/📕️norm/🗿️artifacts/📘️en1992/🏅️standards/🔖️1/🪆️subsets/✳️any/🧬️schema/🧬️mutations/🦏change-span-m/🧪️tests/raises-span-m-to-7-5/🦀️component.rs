...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1992Diff.span_m` and nothing else,
...
async fn change_span_m_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-span-m/raises-span-m-to-7-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
