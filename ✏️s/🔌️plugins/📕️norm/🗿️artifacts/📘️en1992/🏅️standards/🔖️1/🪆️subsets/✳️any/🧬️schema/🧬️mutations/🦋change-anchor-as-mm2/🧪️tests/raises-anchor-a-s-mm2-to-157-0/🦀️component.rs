...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1992Diff.anchor_a_s_mm2` and nothing else,
...
fn change_anchor_as_mm2_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-anchor-as-mm2/raises-anchor-a-s-mm2-to-157-0: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
