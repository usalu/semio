...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1992Diff.liquid_e_s_mpa` and nothing else,
...
async fn change_liquid_es_mpa_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-liquid-es-mpa/raises-liquid-e-s-mpa-to-205000-0: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
