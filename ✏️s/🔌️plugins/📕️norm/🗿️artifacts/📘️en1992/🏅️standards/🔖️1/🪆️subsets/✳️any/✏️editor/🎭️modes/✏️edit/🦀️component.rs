//! ✏️ EN 1992 play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::editor::en1992::create_en1992_app`. Every norm app declares
