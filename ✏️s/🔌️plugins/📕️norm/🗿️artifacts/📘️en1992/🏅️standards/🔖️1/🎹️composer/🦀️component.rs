//! 🎹️ En1992Composer (1 standard) — aggregates its subsets' composer entries value-level. W5a
...
//! history) — a fabricated shape, not a real codec. Only the native `s.en1992` entry remains.

use std::sync::OnceLock;
use semio_framework_plugin::{ComposerEntry, composer_entry_of};
use crate::artifacts::en1992::standards::v1::subsets::any::composer::En1992Composer as En1992AnyComposer;
