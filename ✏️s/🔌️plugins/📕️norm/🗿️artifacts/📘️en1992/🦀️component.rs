...
pub fn definition() -> Result<semio_framework_plugin::ArtifactDefinition, semio_framework_plugin::ArtifactDefinitionError> {
    crate::artifacts::definition::schema_owned_definition(
        "s.en1992",
        crate::artifacts::en1992::schema::en1992_artifact_schema_descriptor().id,
        crate::artifacts::en1992::standards::v1::subsets::any::schema::inferences::en1992_artifact_inference_descriptor().id,
        crate::artifacts::en1992::standards::v1::subsets::any::io::io_registry::entries(),
        pilot_languages(),
        crate::apps::en1992::DOCUMENT_SCHEMA,
        <En1992Snapshot as store::ArtifactDsl>::EXTENSION,
        "EN 1992 design of concrete structures",
        "EN 1992 Bemessung und Konstruktion von Betontragwerken",
    )
}
