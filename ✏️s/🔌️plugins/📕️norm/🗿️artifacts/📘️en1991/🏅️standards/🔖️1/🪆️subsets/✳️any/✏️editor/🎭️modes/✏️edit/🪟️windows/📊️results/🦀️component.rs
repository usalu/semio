//! 📊️ EN 1991 play app — the results window: every computed compliance check, one line each.
...
//#region 🔖️Constants
pub const WINDOW_RESULTS: &str = "norm-en1991-results";
pub const BODY_RESULTS: &str = "norm.en1991.play.results";
...
//#region 🔖️Render
pub async fn render(host: &NormHost<En1991Family>) -> UiNode {
