//! 🧪️ `change-bridge-moment-resistance-knm` fixture — `raises-bridge-moment-resistance-to-4500-knm` (EN 1991 actions).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-bridge-moment-resistance-knm/raises-bridge-moment-resistance-to-4500-knm: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
