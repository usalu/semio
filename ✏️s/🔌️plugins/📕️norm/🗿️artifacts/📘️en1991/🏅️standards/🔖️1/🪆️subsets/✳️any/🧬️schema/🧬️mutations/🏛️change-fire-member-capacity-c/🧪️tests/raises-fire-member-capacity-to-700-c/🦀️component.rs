//! 🧪️ `change-fire-member-capacity-c` fixture — `raises-fire-member-capacity-to-700-c` (EN 1991 actions).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-fire-member-capacity-c/raises-fire-member-capacity-to-700-c: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
