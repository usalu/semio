//! 🧮️ EN 1991 play app command — recompute the compliance report in place.
//!
...
//#region 🔖️Handler
pub async fn handle(_payload: &Evaluate, _doc: &ArtifactView<'_, En1991Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1991Mutation, NormConfigMutation>, Fault> {
    Ok(Emit::default())
}
//#endregion 🔖️Handler
