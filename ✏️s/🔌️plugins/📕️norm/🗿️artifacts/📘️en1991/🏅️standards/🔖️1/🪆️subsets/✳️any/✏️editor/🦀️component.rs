...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.en1991/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &En1991Command, _snapshot: &En1991Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<En1991Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<En1991PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<En1991PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<En1991PlayApp>;
...
impl ArtifactEditor for En1991PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📘️en1991/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
