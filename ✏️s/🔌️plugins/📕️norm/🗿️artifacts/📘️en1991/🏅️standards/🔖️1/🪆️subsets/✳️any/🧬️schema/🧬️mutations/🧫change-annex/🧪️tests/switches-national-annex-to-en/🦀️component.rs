//! 🧪️ `change-annex` fixture — `switches-national-annex-to-en` (EN 1991 actions).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-annex/switches-national-annex-to-en: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
