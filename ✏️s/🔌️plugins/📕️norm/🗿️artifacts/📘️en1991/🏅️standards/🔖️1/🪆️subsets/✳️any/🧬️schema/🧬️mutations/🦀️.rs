...
#[path = "."]
mod fixture_tests {
    #[path = "🎚️change-accidental-mass-t/🧪️tests/lightens-impact-vehicle-to-12-5-t/🦀️.rs"]
    mod tests_change_accidental_mass_t_lightens_impact_vehicle_to_12_5_t;
    #[path = "🕹️change-accidental-speed-km-h/🧪️tests/lowers-impact-speed-to-50-km-h/🦀️.rs"]
    ...
    #[path = "🧪change-area-m2/🧪️tests/enlarges-loaded-area-to-360-m2/🦀️.rs"]
    mod tests_change_area_m2_enlarges_loaded_area_to_360_m2;
    #[path = "🎢change-assumed-gk-kn-m2/🧪️tests/raises-assumed-gk-to-7-5-kn-m2/🦀️.rs"]
    mod tests_change_assumed_gk_kn_m2_raises_assumed_gk_to_7_5_kn_m2;
    #[path = "❄️change-bridge-lane/🧪️tests/widens-carriageway-to-3-notional-lanes/🦀️.rs"]
    mod tests_change_bridge_lane_widens_carriageway_to_3_notional_lanes;
    #[path = "🗺️change-bridge-lane-width-m/🧪️tests/widens-notional-lane-to-3-5-m/🦀️.rs"]
    mod tests_change_bridge_lane_width_m_widens_notional_lane_to_3_5_m;
    #[path = "📡change-bridge-moment-resistance-knm/🧪️tests/raises-bridge-moment-resistance-to-4500-knm/🦀️.rs"]
    mod tests_change_bridge_moment_resistance_knm_raises_bridge_moment_resistance_to_4500_knm;
    #[path = "🎯change-bridge-span-m/🧪️tests/lengthens-bridge-span-to-36-m/🦀️.rs"]
    mod tests_change_bridge_span_m_lengthens_bridge_span_to_36_m;
    #[path = "🧭change-category/🧪️tests/reclassifies-imposed-load-to-category-d/🦀️.rs"]
    mod tests_change_category_reclassifies_imposed_load_to_category_d;
    #[path = "🔆change-cd/🧪️tests/lowers-dynamic-factor-cd-to-0-875/🦀️.rs"]
    mod tests_change_cd_lowers_dynamic_factor_cd_to_0_875;
    #[path = "🪟change-construction-activity/🧪️tests/switches-construction-activity-to-concreting/🦀️.rs"]
    mod tests_change_construction_activity_switches_construction_activity_to_concreting;
    #[path = "🔀change-crane-class/🧪️tests/upgrades-crane-to-class-hc3/🦀️.rs"]
    mod tests_change_crane_class_upgrades_crane_to_class_hc3;
    #[path = "🔥change-cs/🧪️tests/raises-size-factor-cs-to-1-125/🦀️.rs"]
    mod tests_change_cs_raises_size_factor_cs_to_1_125;
    #[path = "⚡change-delta-tk/🧪️tests/raises-thermal-delta-tk-to-45-k/🦀️.rs"]
    mod tests_change_delta_tk_raises_thermal_delta_tk_to_45_k;
    #[path = "🏗️change-en-sk-kn-m2/🧪️tests/raises-en-characteristic-snow-load-to-1-25-kn-m2/🦀️.rs"]
    mod tests_change_en_sk_kn_m2_raises_en_characteristic_snow_load_to_1_25_kn_m2;
    #[path = "📈change-en-vbms/🧪️tests/raises-en-basic-wind-speed-to-30-m-s/🦀️.rs"]
    mod tests_change_en_vbms_raises_en_basic_wind_speed_to_30_m_s;
    #[path = "🔭change-fire-curve/🧪️tests/switches-fire-curve-to-hydrocarbon/🦀️.rs"]
    mod tests_change_fire_curve_switches_fire_curve_to_hydrocarbon;
    #[path = "🏛️change-fire-member-capacity-c/🧪️tests/raises-fire-member-capacity-to-700-c/🦀️.rs"]
    mod tests_change_fire_member_capacity_c_raises_fire_member_capacity_to_700_c;
    #[path = "🧱change-fire-resistance-min/🧪️tests/extends-fire-resistance-to-120-min/🦀️.rs"]
    mod tests_change_fire_resistance_min_extends_fire_resistance_to_120_min;
    #[path = "🧊change-hoist-class/🧪️tests/upgrades-hoist-to-class-hc4/🦀️.rs"]
    mod tests_change_hoist_class_upgrades_hoist_to_class_hc4;
    #[path = "🌬️change-hoisting-speed-ms/🧪️tests/speeds-hoisting-to-1-25-m-s/🦀️.rs"]
    mod tests_change_hoisting_speed_ms_speeds_hoisting_to_1_25_m_s;
    #[path = "🏷️change-self-weight-material/🧪️tests/switches-self-weight-material-to-structural-steel/🦀️.rs"]
    mod tests_change_self_weight_material_switches_self_weight_material_to_structural_steel;
    #[path = "🧮change-self-weight-thickness-m/🧪️tests/thickens-self-weight-layer-to-0-375-m/🦀️.rs"]
    mod tests_change_self_weight_thickness_m_thickens_self_weight_layer_to_0_375_m;
    #[path = "🌗change-silo-bulk-density-kn-m3/🧪️tests/raises-silo-bulk-density-to-10-5-kn-m3/🦀️.rs"]
    mod tests_change_silo_bulk_density_kn_m3_raises_silo_bulk_density_to_10_5_kn_m3;
    #[path = "🎛️change-silo-height-m/🧪️tests/raises-silo-to-18-m/🦀️.rs"]
    mod tests_change_silo_height_m_raises_silo_to_18_m;
    #[path = "📊change-silo-hydraulic-radius-m/🧪️tests/widens-silo-hydraulic-radius-to-2-25-m/🦀️.rs"]
    mod tests_change_silo_hydraulic_radius_m_widens_silo_hydraulic_radius_to_2_25_m;
    #[path = "🔬change-silo-k/🧪️tests/raises-silo-lateral-pressure-ratio-k-to-0-625/🦀️.rs"]
    mod tests_change_silo_k_raises_silo_lateral_pressure_ratio_k_to_0_625;
    #[path = "📉change-silo-mu/🧪️tests/raises-silo-wall-friction-mu-to-0-625/🦀️.rs"]
    mod tests_change_silo_mu_raises_silo_wall_friction_mu_to_0_625;
    #[path = "🌡️change-snow-altitude-m/🧪️tests/lifts-snow-altitude-to-780-m/🦀️.rs"]
    mod tests_change_snow_altitude_m_lifts_snow_altitude_to_780_m;
    #[path = "💧change-snow-zone/🧪️tests/moves-site-to-snow-zone-3/🦀️.rs"]
    mod tests_change_snow_zone_moves_site_to_snow_zone_3;
    #[path = "🌞change-wind-zone/🧪️tests/moves-site-to-wind-zone-4/🦀️.rs"]
