//! 🧪️ `change-silo-mu` fixture — `raises-silo-wall-friction-mu-to-0-625` (EN 1991 actions).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-silo-mu/raises-silo-wall-friction-mu-to-0-625: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
