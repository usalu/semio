//! 🧪️ `change-fire-resistance-min` fixture — `extends-fire-resistance-to-120-min` (EN 1991 actions).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-fire-resistance-min/extends-fire-resistance-to-120-min: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
