...
export interface FireExposure { id: string; memberId: string; rating: string; protectionThickness: number; sectionFactor: number; mu0: number; designTemperature: number; protectionConductivity: number; protectionDensity: number; protectionSpecificHeat: number; }
