//! 🧪️ `update-cold-formed-inputs` fixture — `↪️thickens-the-cold-formed-flange-and-reverses-its-stress-gradient`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-cold-formed-inputs/thickens-the-cold-formed-flange-and-reverses-its-stress-gradient: produced diff differs from the committed 🔺️diff/🔣️.json");
}
