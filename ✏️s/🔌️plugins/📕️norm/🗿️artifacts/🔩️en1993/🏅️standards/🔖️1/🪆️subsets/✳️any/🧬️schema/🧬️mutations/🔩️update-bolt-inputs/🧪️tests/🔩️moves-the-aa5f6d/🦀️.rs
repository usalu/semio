//! 🧪️ `update-bolt-inputs` fixture — `🔩️moves-the-connection-to-four-m24-grade-10-9-bolts`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-bolt-inputs/moves-the-connection-to-four-m24-grade-10-9-bolts: produced diff differs from the committed 🔺️diff/🔣️.json");
}
