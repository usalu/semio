//! 🧪️ `update-fatigue-inputs` fixture — `🔁️drops-to-detail-category-56-under-a-safe-life-assessment`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-fatigue-inputs/drops-to-detail-category-56-under-a-safe-life-assessment: produced diff differs from the committed 🔺️diff/🔣️.json");
}
