...
//#region 🔖️Render
pub fn render(host: &NormHost<En1993Family>, selected_check_index: Option<u32>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
...
mod tests {
    ...
    async fn an_out_of_range_selected_index_falls_back_to_the_first_check() {
        let host = NormHost::<En1993Family>::from_document(crate::En1993Snapshot::default());
