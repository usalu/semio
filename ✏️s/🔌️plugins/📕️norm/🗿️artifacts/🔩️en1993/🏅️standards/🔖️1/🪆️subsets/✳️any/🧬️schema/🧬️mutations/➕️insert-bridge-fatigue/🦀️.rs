...
impl protocol::MutationKind<En1993Snapshot, En1993Mutation> for InsertBridgeFatigue {
    ...
    fn label(&self) -> protocol::LocalizedLabel { protocol::LocalizedLabel::native(&format!("Insert bridge-fatigue at #{}", self.index), &format!("bridge-fatigue an #{} einfügen", self.index)) }
