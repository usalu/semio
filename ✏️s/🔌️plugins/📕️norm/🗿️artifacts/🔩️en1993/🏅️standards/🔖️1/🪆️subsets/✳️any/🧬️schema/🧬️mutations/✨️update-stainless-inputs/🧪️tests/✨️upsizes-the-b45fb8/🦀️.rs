//! 🧪️ `update-stainless-inputs` fixture — `✨️upsizes-the-stainless-section-to-a-duplex-grade`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-stainless-inputs/upsizes-the-stainless-section-to-a-duplex-grade: produced diff differs from the committed 🔺️diff/🔣️.json");
}
