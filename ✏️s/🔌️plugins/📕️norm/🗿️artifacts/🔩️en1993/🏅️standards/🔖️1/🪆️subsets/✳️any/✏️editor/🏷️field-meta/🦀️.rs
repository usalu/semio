...
const TABLE: &[(&str, NormFieldMeta)] = &[
    ...
    ("fireExposures[].designTemperature", NormFieldMeta { label_en: "Design steel temperature θ_a,d", label_de: "Bemessungsstahltemperatur θ_a,d", unit: Some("°C"), choices: None }),
