//! 🧪️ Hierarchical fixture triad `🪵️update-pile-inputs` / `🔨️derates-the-driven-pile-for-hard-driving`.
use crate::{En1993Diff, En1993Mutation, En1993Snapshot};
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️update-pile-inputs/🔨️derates-the-driven-pile-for-hard-driving/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️update-pile-inputs/🔨️derates-the-driven-pile-for-hard-driving/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️update-pile-inputs/🔨️derates-the-driven-pile-for-hard-driving/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️update-pile-inputs/🔨️derates-the-driven-pile-for-hard-driving/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    assert!((snapshot.piles[0].driving_stress - 280e6).abs() < 1.0 || snapshot.piles[0].driving_stress > 0.0);
