//! 🧪️ `update-through-thickness-inputs` fixture — `🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-through-thickness-inputs/upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c: produced diff differs from the committed 🔺️diff/🔣️.json");
}
