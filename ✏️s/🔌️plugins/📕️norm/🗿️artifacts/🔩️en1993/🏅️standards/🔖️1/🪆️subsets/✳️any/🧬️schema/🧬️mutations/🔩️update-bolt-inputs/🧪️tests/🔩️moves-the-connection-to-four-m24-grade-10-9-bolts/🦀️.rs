//! 🧪️ Hierarchical fixture triad `🔩️update-bolt-inputs` / `🔩️moves-the-connection-to-four-m24-grade-10-9-bolts`.
use crate::{En1993Diff, En1993Mutation, En1993Snapshot};
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️update-bolt-inputs/🔩️moves-the-connection-to-four-m24-grade-10-9-bolts/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️update-bolt-inputs/🔩️moves-the-connection-to-four-m24-grade-10-9-bolts/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️update-bolt-inputs/🔩️moves-the-connection-to-four-m24-grade-10-9-bolts/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️update-bolt-inputs/🔩️moves-the-connection-to-four-m24-grade-10-9-bolts/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    assert_eq!(snapshot.joints[0].bolt_diameter, 0.024);
