...
#[cfg(feature = "cross-fem")]
pub fn check_steel_member_from_fem(span_m: f64, udl_kn_m: f64, a_mm2: f64, w_pl_mm3: f64, a_v_mm2: f64, f_y_mpa: f64, chi: f64) -> Result<CheckReport, FemError> {
    ...
    model.elements.push(Elements::BeamEb2(BeamEb2 { id: "b1".into(), start: "n0".into(), end: "n1".into(), e: 210e9, area: a_mm2 / 1e6, iy: a_mm2 * a_mm2 / 12e12, density: 7850.0 }));
