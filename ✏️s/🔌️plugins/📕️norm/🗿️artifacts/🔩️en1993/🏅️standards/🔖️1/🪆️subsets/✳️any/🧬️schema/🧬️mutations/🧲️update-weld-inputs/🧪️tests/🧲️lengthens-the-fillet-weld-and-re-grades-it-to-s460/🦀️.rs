//! 🧪️ `update-weld-inputs` fixture — `🧲️lengthens-the-fillet-weld-and-re-grades-it-to-s460`.
//!
...
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️update-weld-inputs/🧲️lengthens-the-fillet-weld-and-re-grades-it-to-s460/🔺️diff/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-weld-inputs/lengthens-the-fillet-weld-and-re-grades-it-to-s460: produced diff differs from the committed 🔺️diff/🔣️.json");
}
