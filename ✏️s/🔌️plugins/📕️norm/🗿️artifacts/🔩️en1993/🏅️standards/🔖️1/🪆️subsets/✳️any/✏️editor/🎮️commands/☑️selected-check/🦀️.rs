...
pub fn handle(_payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, En1993Snapshot>, _cfg: &ConfigView<'_, NoConfig>) -> Result<Emit<En1993Mutation, NoConfigMutation>, Fault> {
    Ok(Emit::default())
}
//#endregion 🔖️Handler
