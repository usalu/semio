...
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥶️update-cold-formed-inputs/↪️thickens-the-cold-formed-flange-and-reverses-its-stress-gradient/🔺️diff/🔣️.json");
