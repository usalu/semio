//! 🧪️ Hierarchical fixture triad `🔥️update-fire-inputs` / `🧯️raises-the-fire-protection-to-r90`.
use crate::{En1993Diff, En1993Mutation, En1993Snapshot};
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️update-fire-inputs/🧯️raises-the-fire-protection-to-r90/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️update-fire-inputs/🧯️raises-the-fire-protection-to-r90/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️update-fire-inputs/🧯️raises-the-fire-protection-to-r90/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️update-fire-inputs/🧯️raises-the-fire-protection-to-r90/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    assert_eq!(snapshot.fire_exposures[0].rating, "r90");
