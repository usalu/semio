...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str, &'static str) {
    match kind {
        ...
        "update-member-properties" => (
            include_str!("../../🧫️fixtures/🧬️mutations/📊️update-member-properties/🏋️re-grades-the-base-member-to-s460-under-a-heavier-load/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📊️update-member-properties/🏋️re-grades-the-base-member-to-s460-under-a-heavier-load/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📊️update-member-properties/🏋️re-grades-the-base-member-to-s460-under-a-heavier-load/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📊️update-member-properties/🏋️re-grades-the-base-member-to-s460-under-a-heavier-load/🎯️outcome/🔣️.json"),
        ),
        "update-fire-inputs" => (
        ...
        "update-cold-formed-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🥶️update-cold-formed-inputs/↪️thickens-the-cold-formed-flange-and-reverses-its-stress-gradient/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🥶️update-cold-formed-inputs/↪️thickens-the-cold-formed-flange-and-reverses-its-stress-gradient/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🥶️update-cold-formed-inputs/↪️thickens-the-cold-formed-flange-and-reverses-its-stress-gradient/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🥶️update-cold-formed-inputs/↪️thickens-the-cold-formed-flange-and-reverses-its-stress-gradient/🎯️outcome/🔣️.json"),
        ),
        "update-stainless-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/✨️update-stainless-inputs/✨️upsizes-the-stainless-section-to-a-duplex-grade/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✨️update-stainless-inputs/✨️upsizes-the-stainless-section-to-a-duplex-grade/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✨️update-stainless-inputs/✨️upsizes-the-stainless-section-to-a-duplex-grade/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✨️update-stainless-inputs/✨️upsizes-the-stainless-section-to-a-duplex-grade/🎯️outcome/🔣️.json"),
        ),
        "update-plated-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🧱️update-plated-inputs/📈️makes-the-plate-panel-more-slender-and-more-stressed/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧱️update-plated-inputs/📈️makes-the-plate-panel-more-slender-and-more-stressed/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧱️update-plated-inputs/📈️makes-the-plate-panel-more-slender-and-more-stressed/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧱️update-plated-inputs/📈️makes-the-plate-panel-more-slender-and-more-stressed/🎯️outcome/🔣️.json"),
        ),
        "update-silo-shell-inputs" => (
        ...
        "update-weld-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🧲️update-weld-inputs/🧲️lengthens-the-fillet-weld-and-re-grades-it-to-s460/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧲️update-weld-inputs/🧲️lengthens-the-fillet-weld-and-re-grades-it-to-s460/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧲️update-weld-inputs/🧲️lengthens-the-fillet-weld-and-re-grades-it-to-s460/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧲️update-weld-inputs/🧲️lengthens-the-fillet-weld-and-re-grades-it-to-s460/🎯️outcome/🔣️.json"),
        ),
        "update-fatigue-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🔁️update-fatigue-inputs/🔁️drops-to-detail-category-56-under-a-safe-life-assessment/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔁️update-fatigue-inputs/🔁️drops-to-detail-category-56-under-a-safe-life-assessment/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔁️update-fatigue-inputs/🔁️drops-to-detail-category-56-under-a-safe-life-assessment/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔁️update-fatigue-inputs/🔁️drops-to-detail-category-56-under-a-safe-life-assessment/🎯️outcome/🔣️.json"),
        ),
        "update-through-thickness-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/↕️update-through-thickness-inputs/🥶️upgrades-the-subgrade-to-k2-for-a-thicker-plate-at-minus-20c/🎯️outcome/🔣️.json"),
        ),
        "update-tension-component-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🪢️update-tension-component-inputs/📉️derates-the-tension-rod-to-a-400-kn-characteristic-strength/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🪢️update-tension-component-inputs/📉️derates-the-tension-rod-to-a-400-kn-characteristic-strength/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🪢️update-tension-component-inputs/📉️derates-the-tension-rod-to-a-400-kn-characteristic-strength/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🪢️update-tension-component-inputs/📉️derates-the-tension-rod-to-a-400-kn-characteristic-strength/🎯️outcome/🔣️.json"),
        ),
        "update-hss-inputs" => (
        ...
        "update-bridge-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🌉️update-bridge-inputs/🌉️raises-the-bridge-damage-equivalence-and-dynamic-factors/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🌉️update-bridge-inputs/🌉️raises-the-bridge-damage-equivalence-and-dynamic-factors/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🌉️update-bridge-inputs/🌉️raises-the-bridge-damage-equivalence-and-dynamic-factors/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🌉️update-bridge-inputs/🌉️raises-the-bridge-damage-equivalence-and-dynamic-factors/🎯️outcome/🔣️.json"),
        ),
        "update-tower-inputs" => (
        ...
        "update-crane-inputs" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🏗️update-crane-inputs/🏋️widens-the-crane-wheel-contact-patch-under-a-heavier-wheel/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🏗️update-crane-inputs/🏋️widens-the-crane-wheel-contact-patch-under-a-heavier-wheel/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🏗️update-crane-inputs/🏋️widens-the-crane-wheel-contact-patch-under-a-heavier-wheel/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🏗️update-crane-inputs/🏋️widens-the-crane-wheel-contact-patch-under-a-heavier-wheel/🎯️outcome/🔣️.json"),
        ),
