...
//#region 🔖️Constants
pub const BODY_ARTIFACT: &str = "norm.en1993.play.artifact";
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1993Family>, locale: semio_framework_plugin::Locale) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
