...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-system-type/⚙️switches-to-a-decentral-mechanical-system/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-system-type/⚙️switches-to-a-decentral-mechanical-system/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-system-type/⚙️switches-to-a-decentral-mechanical-system/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-system-type/⚙️switches-to-a-decentral-mechanical-system/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-system-type/⚙️switches-to-a-decentral-mechanical-system/🎯️outcome/🔣️.json");
