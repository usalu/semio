...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-storage-allowance-kwh/tightens-the-storage-loss-allowance-to-4-point-5-kwh: change-storage-allowance-kwh is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
