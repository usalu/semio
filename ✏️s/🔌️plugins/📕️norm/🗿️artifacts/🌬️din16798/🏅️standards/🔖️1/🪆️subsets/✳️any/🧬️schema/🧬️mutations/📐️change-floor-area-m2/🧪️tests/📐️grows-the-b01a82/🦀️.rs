//! 🧪️ `change-floor-area-m2` fixture — `📐️grows-the-conditioned-floor-area-to-120-m2`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-floor-area-m2/grows-the-conditioned-floor-area-to-120-m2: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-floor-area-m2/grows-the-conditioned-floor-area-to-120-m2: change-floor-area-m2 is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
