...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-duct-class/🛡️upgrades-the-duct-tightness-class-to-d/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-duct-class/🛡️upgrades-the-duct-tightness-class-to-d/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-duct-class/🛡️upgrades-the-duct-tightness-class-to-d/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-duct-class/🛡️upgrades-the-duct-tightness-class-to-d/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-duct-class/🛡️upgrades-the-duct-tightness-class-to-d/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-duct-class/upgrades-the-duct-tightness-class-to-d: change-duct-class is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
