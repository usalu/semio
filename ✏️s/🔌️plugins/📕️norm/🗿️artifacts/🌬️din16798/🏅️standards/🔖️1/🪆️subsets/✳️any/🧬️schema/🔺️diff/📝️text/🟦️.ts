...
export const normDin16798DiffTextGuardObject = (value: unknown, at: string): object =>
  value !== null && typeof value === "object" && !Array.isArray(value) ? (value as object) : normDin16798DiffTextGuardReject(at, "value is not an object");
