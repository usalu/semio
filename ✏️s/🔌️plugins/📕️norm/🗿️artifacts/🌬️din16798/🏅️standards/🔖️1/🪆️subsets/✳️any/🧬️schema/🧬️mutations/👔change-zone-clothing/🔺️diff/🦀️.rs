...
pub fn diff(payload: &ChangeZoneClothing, base: &Din16798Snapshot) -> protocol::MutationOutcome<Din16798Diff> {
    ...
    z.clothing_clo = payload.new_clothing_clo;
