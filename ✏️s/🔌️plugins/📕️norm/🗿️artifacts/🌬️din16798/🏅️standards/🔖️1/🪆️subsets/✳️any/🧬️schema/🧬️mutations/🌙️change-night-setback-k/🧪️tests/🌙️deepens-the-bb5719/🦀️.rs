...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-night-setback-k/deepens-the-night-setback-to-5-kelvin: change-night-setback-k is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
