//! 🧪️ `change-hr-m-dot-kg-s` fixture — `⚖️raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-hr-m-dot-kg-s/⚖️raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-hr-m-dot-kg-s/⚖️raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-hr-m-dot-kg-s/⚖️raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-hr-m-dot-kg-s/⚖️raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-hr-m-dot-kg-s/⚖️raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-hr-m-dot-kg-s/raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-hr-m-dot-kg-s/raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second: change-hr-m-dot-kg-s is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
