//! 🧪️ `change-rh-percent` fixture — `💧️drops-indoor-humidity-to-42-point-5-percent`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-rh-percent/drops-indoor-humidity-to-42-point-5-percent: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-rh-percent/drops-indoor-humidity-to-42-point-5-percent: change-rh-percent is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
