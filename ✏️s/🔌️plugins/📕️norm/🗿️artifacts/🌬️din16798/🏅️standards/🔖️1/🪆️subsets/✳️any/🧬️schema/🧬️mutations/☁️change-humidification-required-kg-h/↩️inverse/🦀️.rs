...
pub fn inverse(_payload: &ChangeHumidificationRequiredKgH, base: &Din16798Snapshot) -> Vec<Din16798Mutation> {
    vec![Din16798Mutation::ChangeHumidificationRequiredKgH(ChangeHumidificationRequiredKgH { new_humidification_required_kg_h: base.humidification_required_kg_h })]
}
//#endregion 🔖️Inverse
