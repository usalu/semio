...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️change-persons/👥️raises-the-design-occupancy-to-16-people/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️change-persons/👥️raises-the-design-occupancy-to-16-people/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️change-persons/👥️raises-the-design-occupancy-to-16-people/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️change-persons/👥️raises-the-design-occupancy-to-16-people/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️change-persons/👥️raises-the-design-occupancy-to-16-people/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-persons/raises-the-design-occupancy-to-16-people: change-persons is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
