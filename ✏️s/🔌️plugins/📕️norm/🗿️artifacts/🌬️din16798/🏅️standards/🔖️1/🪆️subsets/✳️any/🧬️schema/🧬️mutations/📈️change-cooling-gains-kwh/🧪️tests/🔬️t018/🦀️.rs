//! 🧪️ `change-cooling-gains-kwh` fixture — `📈️raises-the-internal-cooling-gains-to-7-point-5-kwh`.
//!
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-cooling-gains-kwh/raises-the-internal-cooling-gains-to-7-point-5-kwh: change-cooling-gains-kwh is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
