...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-h-st-wk/🧮️raises-the-storage-loss-coefficient-to-6-point-5-w-per-k/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-h-st-wk/🧮️raises-the-storage-loss-coefficient-to-6-point-5-w-per-k/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-h-st-wk/🧮️raises-the-storage-loss-coefficient-to-6-point-5-w-per-k/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-h-st-wk/🧮️raises-the-storage-loss-coefficient-to-6-point-5-w-per-k/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-h-st-wk/🧮️raises-the-storage-loss-coefficient-to-6-point-5-w-per-k/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-h-st-wk/raises-the-storage-loss-coefficient-to-6-point-5-w-per-k: change-h-st-wk is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
