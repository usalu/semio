//! 🚪️ IO s.norm.din16798 (1/✳️any) — no stdio format bridges. W5a (ticket 26/08/11/SEMIO-ARTIFACT-UNIFIED-IMPORT-EXPORT-AND-MEDIA-FORMAT-RETIREMENT) deleted the five
...
//! ⚙️engine::register) for the native `s.norm.din16798` dialect only.
