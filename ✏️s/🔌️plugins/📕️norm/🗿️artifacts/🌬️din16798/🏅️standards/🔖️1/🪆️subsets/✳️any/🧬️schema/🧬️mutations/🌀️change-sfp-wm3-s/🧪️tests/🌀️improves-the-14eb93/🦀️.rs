//! 🧪️ `change-sfp-wm3-s` fixture — `🌀️improves-the-specific-fan-power-to-1250-w-per-m3-s`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-sfp-wm3-s/improves-the-specific-fan-power-to-1250-w-per-m3-s: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-sfp-wm3-s/improves-the-specific-fan-power-to-1250-w-per-m3-s: change-sfp-wm3-s is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
