...
impl protocol::MutationKind<Din16798Snapshot, Din16798Mutation> for ChangeThetaSetC {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change cooling set-point temperature to {}", self.new_theta_set_c), &format!("Kühlsolltemperatur auf {} ändern", self.new_theta_set_c))
    }
}
