...
#[path = "."]
mod fixture_tests {
    #[path = "🪁️change-air-speed-ms/🧪️tests/🪁️doubles-the-draught-air-speed-to-0-point-25-ms/🦀️.rs"]
    mod tests_change_air_speed_m_s_doubles_the_draught_air_speed_to_0_point_25_ms;
    #[path = "🌍️change-annex/🧪️tests/🌍️switches-the-check-to-the-en-annex/🦀️.rs"]
    ...
    #[path = "🏚️change-cellar-area-m2/🧪️tests/🏚️grows-the-cellar-floor-area-to-62-point-5-m2/🦀️.rs"]
    mod tests_change_cellar_area_m2_grows_the_cellar_floor_area_to_62_point_5_m2;
    #[path = "🪟️change-cellar-ventilation-m3-h/🧪️tests/🪟️raises-the-cellar-airflow-to-22-point-5-m3-per-hour/🦀️.rs"]
    mod tests_change_cellar_ventilation_m3_h_raises_the_cellar_airflow_to_22_point_5_m3_per_hour;
    #[path = "🥶️change-chiller-type/🧪️tests/🥶️switches-to-a-water-cooled-chiller/🦀️.rs"]
    mod tests_change_chiller_type_switches_to_a_water_cooled_chiller;
    #[path = "🌫️change-co2-ppm/🧪️tests/🌫️raises-the-measured-co2-to-950-ppm/🦀️.rs"]
    mod tests_change_co2_ppm_raises_the_measured_co2_to_950_ppm;
    #[path = "🛋️change-comfort-category/🧪️tests/🛋️tightens-the-comfort-category-to-i/🦀️.rs"]
    mod tests_change_comfort_category_tightens_the_comfort_category_to_i;
    #[path = "⌛️change-cooling-delta-th/🧪️tests/⌛️extends-the-cooling-period-to-12-point-5-hours/🦀️.rs"]
    mod tests_change_cooling_delta_t_h_extends_the_cooling_period_to_12_point_5_hours;
    #[path = "📈️change-cooling-gains-kwh/🧪️tests/📈️raises-the-internal-cooling-gains-to-7-point-5-kwh/🦀️.rs"]
    mod tests_change_cooling_gains_kwh_raises_the_internal_cooling_gains_to_7_point_5_kwh;
    #[path = "📊️change-cooling-reference-kwh/🧪️tests/📊️raises-the-cooling-reference-to-25-kwh/🦀️.rs"]
    mod tests_change_cooling_reference_kwh_raises_the_cooling_reference_to_25_kwh;
    #[path = "🎚️change-cooling-utilization-factor/🧪️tests/🎚️raises-the-cooling-utilization-factor-to-0-point-875/🦀️.rs"]
    mod tests_change_cooling_utilization_factor_raises_the_cooling_utilization_factor_to_0_point_875;
    #[path = "🖥️change-data-center-supply-c/🧪️tests/🖥️raises-the-data-centre-supply-air-to-27-c/🦀️.rs"]
    mod tests_change_data_center_supply_c_raises_the_data_centre_supply_air_to_27_c;
    #[path = "☀️change-df-percent/🧪️tests/☀️raises-the-daylight-factor-to-3-point-75-percent/🦀️.rs"]
    mod tests_change_df_percent_raises_the_daylight_factor_to_3_point_75_percent;
    #[path = "🚿️change-dhw-delivery-c/🧪️tests/🚿️raises-the-dhw-delivery-temperature-to-60-c/🦀️.rs"]
    mod tests_change_dhw_delivery_c_raises_the_dhw_delivery_temperature_to_60_c;
    #[path = "🛡️change-duct-class/🧪️tests/🛡️upgrades-the-duct-tightness-class-to-d/🦀️.rs"]
    mod tests_change_duct_class_upgrades_the_duct_tightness_class_to_d;
    #[path = "🕳️change-duct-leakage-m3-sm2/🧪️tests/🕳️halves-the-measured-duct-leakage-to-0-point-0625/🦀️.rs"]
    mod tests_change_duct_leakage_m3_s_m2_halves_the_measured_duct_leakage_to_0_point_0625;
    #[path = "🧭️change-duct-test-pressure-pa/🧪️tests/🧭️raises-the-duct-test-pressure-to-500-pa/🦀️.rs"]
    mod tests_change_duct_test_pressure_pa_raises_the_duct_test_pressure_to_500_pa;
    #[path = "🏡️change-dwelling-ventilation-m3-h/🧪️tests/🏡️raises-the-dwelling-airflow-to-96-m3-per-hour/🦀️.rs"]
    mod tests_change_dwelling_ventilation_m3_h_raises_the_dwelling_airflow_to_96_m3_per_hour;
    #[path = "✅️change-eer-actual/🧪️tests/✅️raises-the-achieved-eer-to-3-point-5/🦀️.rs"]
    mod tests_change_eer_actual_raises_the_achieved_eer_to_3_point_5;
    #[path = "🔌️change-fan-energy-reference-kwh/🧪️tests/🔌️raises-the-fan-energy-reference-to-18-kwh/🦀️.rs"]
    mod tests_change_fan_energy_reference_kwh_raises_the_fan_energy_reference_to_18_kwh;
    #[path = "🪭️change-fan-qvm3-s/🧪️tests/🪭️raises-the-fan-volume-flow-to-1-point-5-m3-per-second/🦀️.rs"]
    mod tests_change_fan_q_v_m3_s_raises_the_fan_volume_flow_to_1_point_5_m3_per_second;
    #[path = "⏰️change-fan-t-run-h/🧪️tests/⏰️extends-the-daily-fan-runtime-to-12-hours/🦀️.rs"]
    mod tests_change_fan_t_run_h_extends_the_daily_fan_runtime_to_12_hours;
    #[path = "📐️change-floor-area-m2/🧪️tests/📐️grows-the-conditioned-floor-area-to-120-m2/🦀️.rs"]
    mod tests_change_floor_area_m2_grows_the_conditioned_floor_area_to_120_m2;
    #[path = "⚡️change-generation-reference-kwh/🧪️tests/⚡️raises-the-generation-reference-to-450-kwh/🦀️.rs"]
    mod tests_change_generation_reference_kwh_raises_the_generation_reference_to_450_kwh;
    #[path = "🧮️change-h-st-wk/🧪️tests/🧮️raises-the-storage-loss-coefficient-to-6-point-5-w-per-k/🦀️.rs"]
    mod tests_change_h_st_w_k_raises_the_storage_loss_coefficient_to_6_point_5_w_per_k;
    #[path = "🧱️change-h-tr-wk/🧪️tests/🧱️improves-the-transmission-heat-transfer-to-175-w-per-k/🦀️.rs"]
    mod tests_change_h_tr_w_k_improves_the_transmission_heat_transfer_to_175_w_per_k;
    #[path = "🔃️change-h-ve-wk/🧪️tests/🔃️raises-the-ventilation-heat-transfer-to-125-w-per-k/🦀️.rs"]
    mod tests_change_h_ve_w_k_raises_the_ventilation_heat_transfer_to_125_w_per_k;
    #[path = "🚧️change-heat-recovery-eta-min/🧪️tests/🚧️raises-the-required-heat-recovery-minimum-to-0-point-625/🦀️.rs"]
    mod tests_change_heat_recovery_eta_min_raises_the_required_heat_recovery_minimum_to_0_point_625;
    #[path = "♻️change-heat-recovery-eta/🧪️tests/♻️raises-the-achieved-heat-recovery-to-0-point-875/🦀️.rs"]
    mod tests_change_heat_recovery_eta_raises_the_achieved_heat_recovery_to_0_point_875;
    #[path = "🥵️change-hr-cp-j-kgk/🧪️tests/🥵️corrects-the-air-specific-heat-to-1010-j-per-kgk/🦀️.rs"]
    mod tests_change_hr_cp_j_kgk_corrects_the_air_specific_heat_to_1010_j_per_kgk;
    #[path = "↕️change-hr-delta-tc/🧪️tests/↕️drops-the-heat-recovery-temperature-lift-to-12-point-5-c/🦀️.rs"]
    mod tests_change_hr_delta_t_c_drops_the_heat_recovery_temperature_lift_to_12_point_5_c;
    #[path = "⚖️change-hr-m-dot-kg-s/🧪️tests/⚖️raises-the-heat-recovery-mass-flow-to-0-point-75-kg-per-second/🦀️.rs"]
    mod tests_change_hr_m_dot_kg_s_raises_the_heat_recovery_mass_flow_to_0_point_75_kg_per_second;
    #[path = "💡️change-hr-savings-reference-kwh/🧪️tests/💡️raises-the-heat-recovery-savings-reference-to-65-kwh/🦀️.rs"]
    mod tests_change_hr_savings_reference_kwh_raises_the_heat_recovery_savings_reference_to_65_kwh;
    #[path = "⏳️change-hr-th/🧪️tests/⏳️extends-the-heat-recovery-operating-hours-to-14/🦀️.rs"]
    mod tests_change_hr_t_h_extends_the_heat_recovery_operating_hours_to_14;
    #[path = "💦️change-humidification-provided-kg-h/🧪️tests/💦️drops-the-provided-humidification-to-1-point-25-kg-per-hour/🦀️.rs"]
    mod tests_change_humidification_provided_kg_h_drops_the_provided_humidification_to_1_point_25_kg_per_hour;
    #[path = "☁️change-humidification-required-kg-h/🧪️tests/☁️raises-the-required-humidification-to-3-point-5-kg-per-hour/🦀️.rs"]
    mod tests_change_humidification_required_kg_h_raises_the_required_humidification_to_3_point_5_kg_per_hour;
    #[path = "🫁️change-ida-class/🧪️tests/🫁️relaxes-the-indoor-air-class-to-ida-3/🦀️.rs"]
    mod tests_change_ida_class_relaxes_the_indoor_air_class_to_ida_3;
    #[path = "🚪️change-infiltration-allowance-m3-h/🧪️tests/🚪️raises-the-infiltration-allowance-to-52-point-5-m3-per-hour/🦀️.rs"]
    mod tests_change_infiltration_allowance_m3_h_raises_the_infiltration_allowance_to_52_point_5_m3_per_hour;
    #[path = "🔊️change-l-aeq-db/🧪️tests/🔊️raises-the-equivalent-sound-level-to-30-db/🦀️.rs"]
    mod tests_change_l_aeq_db_raises_the_equivalent_sound_level_to_30_db;
    #[path = "🏠️change-n50-h-inv/🧪️tests/🏠️loosens-the-blower-door-result-to-2-point-5-per-hour/🦀️.rs"]
    mod tests_change_n50_h_inv_loosens_the_blower_door_result_to_2_point_5_per_hour;
    #[path = "🌙️change-night-setback-k/🧪️tests/🌙️deepens-the-night-setback-to-5-kelvin/🦀️.rs"]
    mod tests_change_night_setback_k_deepens_the_night_setback_to_5_kelvin;
    #[path = "🏢️change-occupancy/🧪️tests/🏢️reclassifies-the-space-as-office/🦀️.rs"]
    mod tests_change_occupancy_reclassifies_the_space_as_office;
    #[path = "👪️change-occupants/🧪️tests/👪️raises-the-household-to-five-occupants/🦀️.rs"]
    mod tests_change_occupants_raises_the_household_to_five_occupants;
    #[path = "👥️change-persons/🧪️tests/👥️raises-the-design-occupancy-to-16-people/🦀️.rs"]
    mod tests_change_persons_raises_the_design_occupancy_to_16_people;
    #[path = "❄️change-qc-kwh/🧪️tests/❄️raises-the-annual-cooling-demand-to-1250-kwh/🦀️.rs"]
    mod tests_change_q_c_kwh_raises_the_annual_cooling_demand_to_1250_kwh;
    #[path = "🏘️change-residential-ventilation-m3-h/🧪️tests/🏘️raises-the-residential-airflow-to-110-m3-per-hour/🦀️.rs"]
    mod tests_change_residential_ventilation_m3_h_raises_the_residential_airflow_to_110_m3_per_hour;
    #[path = "💧️change-rh-percent/🧪️tests/💧️drops-indoor-humidity-to-42-point-5-percent/🦀️.rs"]
    mod tests_change_rh_percent_drops_indoor_humidity_to_42_point_5_percent;
    #[path = "🏷️change-sfp-required-class/🧪️tests/🏷️tightens-the-required-sfp-class-to-3/🦀️.rs"]
    mod tests_change_sfp_required_class_tightens_the_required_sfp_class_to_3;
    #[path = "🌀️change-sfp-wm3-s/🧪️tests/🌀️improves-the-specific-fan-power-to-1250-w-per-m3-s/🦀️.rs"]
    mod tests_change_sfp_w_m3_s_improves_the_specific_fan_power_to_1250_w_per_m3_s;
    #[path = "📉️change-storage-allowance-kwh/🧪️tests/📉️tightens-the-storage-loss-allowance-to-4-point-5-kwh/🦀️.rs"]
    mod tests_change_storage_allowance_kwh_tightens_the_storage_loss_allowance_to_4_point_5_kwh;
    #[path = "🕒️change-storage-th/🧪️tests/🕒️shortens-the-storage-standby-period-to-18-hours/🦀️.rs"]
    mod tests_change_storage_t_h_shortens_the_storage_standby_period_to_18_hours;
    #[path = "⚙️change-system-type/🧪️tests/⚙️switches-to-a-decentral-mechanical-system/🦀️.rs"]
    mod tests_change_system_type_switches_to_a_decentral_mechanical_system;
    #[path = "🌡️change-t-op-c/🧪️tests/🌡️raises-the-operative-temperature-to-24-point-5-c/🦀️.rs"]
    mod tests_change_t_op_c_raises_the_operative_temperature_to_24_point_5_c;
    #[path = "🌬️change-theta-amb-c/🧪️tests/🌬️lowers-the-storage-room-ambient-to-18-c/🦀️.rs"]
    mod tests_change_theta_amb_c_lowers_the_storage_room_ambient_to_18_c;
    #[path = "🌤️change-theta-ec/🧪️tests/🌤️raises-the-external-design-temperature-to-34-point-5-c/🦀️.rs"]
    mod tests_change_theta_e_c_raises_the_external_design_temperature_to_34_point_5_c;
    #[path = "🔄️change-theta-rm-c/🧪️tests/🔄️raises-the-running-mean-outdoor-temperature-to-18-point-5-c/🦀️.rs"]
    mod tests_change_theta_rm_c_raises_the_running_mean_outdoor_temperature_to_18_point_5_c;
    #[path = "🎯️change-theta-set-c/🧪️tests/🎯️lowers-the-cooling-set-point-to-25-c/🦀️.rs"]
    mod tests_change_theta_set_c_lowers_the_cooling_set_point_to_25_c;
    #[path = "🫙️change-theta-st-c/🧪️tests/🫙️lowers-the-storage-temperature-to-55-c/🦀️.rs"]
    mod tests_change_theta_st_c_lowers_the_storage_temperature_to_55_c;
    #[path = "💨️change-ventilation-m3-h/🧪️tests/💨️raises-the-supply-airflow-to-360-m3-per-hour/🦀️.rs"]
    mod tests_change_ventilation_m3_h_raises_the_supply_airflow_to_360_m3_per_hour;
    #[path = "🧊️change-volume-m3/🧪️tests/🧊️grows-the-air-volume-to-640-m3/🦀️.rs"]
    mod tests_change_volume_m3_grows_the_air_volume_to_640_m3;
    #[path = "📅️change-years-since-inspection/🧪️tests/📅️ages-the-last-inspection-to-six-years/🦀️.rs"]
