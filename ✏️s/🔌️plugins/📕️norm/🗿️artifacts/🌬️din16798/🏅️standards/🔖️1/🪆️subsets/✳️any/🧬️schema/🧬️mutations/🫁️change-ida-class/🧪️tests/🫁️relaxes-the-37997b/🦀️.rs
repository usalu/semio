//! 🧪️ `change-ida-class` fixture — `🫁️relaxes-the-indoor-air-class-to-ida-3`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-ida-class/relaxes-the-indoor-air-class-to-ida-3: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-ida-class/relaxes-the-indoor-air-class-to-ida-3: change-ida-class is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
