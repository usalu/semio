//! 🧪️ `change-hr-th` fixture — `⏳️extends-the-heat-recovery-operating-hours-to-14`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-hr-th/⏳️extends-the-heat-recovery-operating-hours-to-14/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-hr-th/⏳️extends-the-heat-recovery-operating-hours-to-14/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-hr-th/⏳️extends-the-heat-recovery-operating-hours-to-14/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-hr-th/⏳️extends-the-heat-recovery-operating-hours-to-14/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-hr-th/⏳️extends-the-heat-recovery-operating-hours-to-14/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-hr-th/extends-the-heat-recovery-operating-hours-to-14: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-hr-th/extends-the-heat-recovery-operating-hours-to-14: change-hr-th is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
