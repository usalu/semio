...
use crate::document_schema::Din16798Artifact;
    ...
    pub fn apply_to_artifact(&self, artifact: &Din16798Artifact) -> protocol::MutationApplyResult<Din16798Artifact> {
        Ok({
            ...
            if let Some(value) = &self.rh_percent {
                next.rh_percent = *value;
            }
            if let Some(value) = &self.air_speed_m_s {
                next.air_speed_m_s = *value;
            }
...
pub type Din16798DiffText = String;
//#endregion 🚚️Carrier
