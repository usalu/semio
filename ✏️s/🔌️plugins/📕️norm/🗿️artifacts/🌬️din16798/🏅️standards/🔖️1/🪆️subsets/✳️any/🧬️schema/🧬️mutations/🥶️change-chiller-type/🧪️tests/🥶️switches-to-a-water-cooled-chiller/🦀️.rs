//! 🧪️ `change-chiller-type` fixture — `🥶️switches-to-a-water-cooled-chiller`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥶️change-chiller-type/🥶️switches-to-a-water-cooled-chiller/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥶️change-chiller-type/🥶️switches-to-a-water-cooled-chiller/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥶️change-chiller-type/🥶️switches-to-a-water-cooled-chiller/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥶️change-chiller-type/🥶️switches-to-a-water-cooled-chiller/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥶️change-chiller-type/🥶️switches-to-a-water-cooled-chiller/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-chiller-type/switches-to-a-water-cooled-chiller: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-chiller-type/switches-to-a-water-cooled-chiller: change-chiller-type is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
