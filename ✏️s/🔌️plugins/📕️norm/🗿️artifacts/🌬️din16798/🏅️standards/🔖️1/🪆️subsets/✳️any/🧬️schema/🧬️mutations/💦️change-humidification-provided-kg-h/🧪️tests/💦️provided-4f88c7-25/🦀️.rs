//! 🧪️ `change-humidification-provided-kg-h` fixture — `💦️drops-the-provided-humidification-to-1-point-25-kg-per-hour`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-humidification-provided-kg-h/drops-the-provided-humidification-to-1-point-25-kg-per-hour: produced diff differs from the committed 🔺️diff/🔣️.json");
