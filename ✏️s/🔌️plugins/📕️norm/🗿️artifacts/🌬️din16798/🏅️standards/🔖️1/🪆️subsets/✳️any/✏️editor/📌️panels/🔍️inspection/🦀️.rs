...
//#region 🔖️Render
pub fn render(host: &NormHost<DinEn16798Family>, selected_check_index: Option<u32>, locale: semio_framework_plugin::Locale, controller_id: Option<&'static str>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
