//! 🧪️ `change-occupants` fixture — `👪️raises-the-household-to-five-occupants`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-occupants/raises-the-household-to-five-occupants: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-occupants/raises-the-household-to-five-occupants: change-occupants is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
