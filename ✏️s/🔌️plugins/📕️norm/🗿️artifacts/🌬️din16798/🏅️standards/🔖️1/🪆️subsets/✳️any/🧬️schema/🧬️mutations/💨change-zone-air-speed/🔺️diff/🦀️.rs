...
pub fn diff(payload: &ChangeZoneAirSpeed, base: &Din16798Snapshot) -> protocol::MutationOutcome<Din16798Diff> {
    ...
    z.air_speed_m_s = payload.new_air_speed_m_s;
