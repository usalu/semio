//! 🔺️ `change-vent-heat-recovery` diff.
...
pub fn diff(payload: &ChangeVentHeatRecovery, base: &Din16798Snapshot) -> protocol::MutationOutcome<Din16798Diff> {
    ...
    v.heat_recovery_eta = payload.new_heat_recovery_eta;
