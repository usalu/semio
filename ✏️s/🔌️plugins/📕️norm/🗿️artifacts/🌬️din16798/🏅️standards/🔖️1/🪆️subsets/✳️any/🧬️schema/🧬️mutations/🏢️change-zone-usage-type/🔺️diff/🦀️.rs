...
pub fn diff(payload: &ChangeZoneUsageType, base: &Din16798Snapshot) -> protocol::MutationOutcome<Din16798Diff> {
    ...
    z.usage_type = payload.new_usage_type.clone();
