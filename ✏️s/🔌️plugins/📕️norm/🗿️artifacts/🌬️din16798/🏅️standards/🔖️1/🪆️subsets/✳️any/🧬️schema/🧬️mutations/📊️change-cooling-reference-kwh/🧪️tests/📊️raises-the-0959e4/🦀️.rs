//! 🧪️ `change-cooling-reference-kwh` fixture — `📊️raises-the-cooling-reference-to-25-kwh`.
//!
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-cooling-reference-kwh/raises-the-cooling-reference-to-25-kwh: change-cooling-reference-kwh is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
