...
use crate::mutations::change_generation_reference_kwh::ChangeGenerationReferenceKwh;
...
pub fn inverse(_payload: &ChangeGenerationReferenceKwh, base: &Din16798Snapshot) -> Vec<Din16798Mutation> {
    vec![Din16798Mutation::ChangeGenerationReferenceKwh(ChangeGenerationReferenceKwh { new_generation_reference_kwh: base.generation_reference_kwh })]
}
//#endregion 🔖️Inverse
