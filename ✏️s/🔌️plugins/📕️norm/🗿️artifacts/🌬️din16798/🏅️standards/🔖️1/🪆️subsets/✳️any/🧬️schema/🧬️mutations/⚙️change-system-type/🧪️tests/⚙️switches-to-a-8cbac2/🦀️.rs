//! 🧪️ `change-system-type` fixture — `⚙️switches-to-a-decentral-mechanical-system`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-system-type/switches-to-a-decentral-mechanical-system: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-system-type/switches-to-a-decentral-mechanical-system: change-system-type is an artifact-lane edit and must never carry the presence-lane selectedCheckIndex"
    );
