...
use crate::editor::din16798::commands::{evaluate, selected_check, set_active_example, set_snapshot};
...
impl ArtifactEditor for Din16798PlayApp {
    ...
    fn render(body_key: &str, doc: &ArtifactView<'_, Din16798Snapshot>, cfg: &ConfigView<'_, NoConfig>, view_state: &semio_framework_plugin::ViewModel) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::ComponentTree> {
        let host = NormHost::<DinEn16798Family>::from_artifact(doc.snapshot.clone());
        match body_key {
    ...
    fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, Din16798Snapshot>) -> Result<Emit<Din16798Mutation, NoConfigMutation, Self::DraftMutation>, MediaError> {
