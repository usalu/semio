//! `remove-accidental` mutation for EN 1990.
use crate::{En1990Mutation, En1990Snapshot};
#[derive(Clone, Debug, PartialEq, dsl::MutationLeaf, value_derive::ToValue, value_derive::FromValue)]
#[cfg_attr(test, derive(serde::Serialize, serde::Deserialize))]
#[mutation_leaf(contract = ::protocol)]
pub struct RemoveAccidental { pub index: usize, }
impl protocol::MutationKind<En1990Snapshot, En1990Mutation> for RemoveAccidental {
    ...
    fn label(&self) -> protocol::LocalizedLabel { protocol::LocalizedLabel::native("Remove accidental", "Entfernen: accidental") }
}
