...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-variable-action-value/⛔️refuses-to-revalue-a-missing-action-0/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-variable-action-value/⛔️refuses-to-revalue-a-missing-action-0/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-variable-action-value/⛔️refuses-to-revalue-a-missing-action-0/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-variable-action-value/⛔️refuses-to-revalue-a-missing-action-0/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-variable-action-value/⛔️refuses-to-revalue-a-missing-action-0/🎯️outcome/🔣️.json");
