//! `change-project-id` mutation for EN 1990.
...
pub struct ChangeProjectId {
    pub new_project_id: String,
}

impl protocol::MutationKind<En1990Snapshot, En1990Mutation> for ChangeProjectId {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor {
        verb: "change",
        entity: "project-id",
        kind: "change-project-id",
        record: "ChangedProjectId",
    };
