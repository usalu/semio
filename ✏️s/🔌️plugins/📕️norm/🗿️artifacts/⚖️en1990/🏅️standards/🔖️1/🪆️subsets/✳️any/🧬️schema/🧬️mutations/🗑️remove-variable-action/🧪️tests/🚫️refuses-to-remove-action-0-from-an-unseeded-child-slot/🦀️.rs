//! 🧪️ `remove-variable-action` fixture — `🚫️refuses-to-remove-action-0-from-an-unseeded-child-slot`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-variable-action/🚫️refuses-to-remove-action-0-from-an-unseeded-child-slot/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-variable-action/🚫️refuses-to-remove-action-0-from-an-unseeded-child-slot/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-variable-action/🚫️refuses-to-remove-action-0-from-an-unseeded-child-slot/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-variable-action/🚫️refuses-to-remove-action-0-from-an-unseeded-child-slot/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-variable-action/🚫️refuses-to-remove-action-0-from-an-unseeded-child-slot/🎯️outcome/🔣️.json");
