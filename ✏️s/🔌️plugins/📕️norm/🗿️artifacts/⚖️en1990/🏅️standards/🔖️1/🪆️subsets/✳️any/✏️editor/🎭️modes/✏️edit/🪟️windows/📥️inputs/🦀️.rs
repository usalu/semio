...
//#region 🔖️Render
pub fn render(document: &En1990Snapshot, locale: semio_framework_plugin::Locale, controller_id: &'static str, windows: &TreeWindows<'_>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
    crate::app_surface::render_document_editor(document, locale, controller_id, Some(crate::field_meta::en1990_field_meta), windows)
}
//#endregion 🔖️Render
