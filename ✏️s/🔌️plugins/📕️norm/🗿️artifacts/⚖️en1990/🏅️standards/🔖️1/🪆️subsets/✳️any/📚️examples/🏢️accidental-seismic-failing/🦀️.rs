...
pub fn label() -> LocalizedLabel {
    LocalizedLabel::native("Accidental Seismic Failing", "Außergewöhnlich/Erdbeben — nicht konform")
}
pub const ICON: &str = "file";
pub const PRIMARY_TEXT: &str = include_str!("../../🖼️assets/🏢️accidental-seismic-failing/🏢️accidental-seismic-failing/🗣️.dsl.semio");
pub fn source() -> ExampleSource {
    ExampleSource::new(ID, label(), PRIMARY_TEXT, ICON)
}

/// 💥🌋️ Non-compliant accidental + seismic design situations (EN 1990 6.11 / 6.12b).
pub fn reference_snapshot() -> crate::En1990Snapshot {
    crate::En1990Snapshot {
        annex: crate::document::AnnexChoice::De,
        project_id: "accidental-seismic-failing".into(),
        ...
        beta_computed: 3.8,
        permanents: vec![
            PermanentAction { id: "G-sup".into(), kind: "g_sup".into(), gk: 100_000.0 },
            PermanentAction { id: "G-inf".into(), kind: "g_inf".into(), gk: 20_000.0 },
        ],
        variables: vec![
            VariableAction { id: "Q-office".into(), category: "office".into(), qk: 50_000.0 },
            VariableAction { id: "Q-wind".into(), category: "wind".into(), qk: 25_000.0 },
        ],
        accidentals: vec![
            AccidentalAction { id: "A-impact".into(), ad: 180_000.0 },
        ],
        seismics: vec![
            SeismicAction { id: "E-1".into(), a_ek: 150_000.0, importance_class: ImportanceClass::III },
        ],
        members: vec![Member {
            id: "beam-B1".into(),
            ...
            rd_str: 150_000.0,
            rd_geo: 150_000.0,
            rd_equ_stab: 120_000.0,
            rd_equ_destab: 100_000.0,
            rd_fat: 0.0,
            span: 6.0,
            deflection_w: 0.03,
