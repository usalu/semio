//! `change-accidentals` mutation for EN 1990.
...
pub struct ChangeAccidentals {
    pub new_accidentals: Vec<crate::AccidentalAction>,
}

impl protocol::MutationKind<En1990Snapshot, En1990Mutation> for ChangeAccidentals {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor {
        verb: "change",
        entity: "accidentals",
        kind: "change-accidentals",
        record: "ChangedAccidentals",
    };
