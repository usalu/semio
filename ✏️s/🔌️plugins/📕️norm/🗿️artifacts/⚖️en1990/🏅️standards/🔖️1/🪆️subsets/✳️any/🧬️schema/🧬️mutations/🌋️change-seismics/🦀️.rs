//! `change-seismics` mutation for EN 1990.
...
pub struct ChangeSeismics {
    pub new_seismics: Vec<crate::SeismicAction>,
}

impl protocol::MutationKind<En1990Snapshot, En1990Mutation> for ChangeSeismics {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor {
        verb: "change",
        entity: "seismics",
        kind: "change-seismics",
        record: "ChangedSeismics",
    };
