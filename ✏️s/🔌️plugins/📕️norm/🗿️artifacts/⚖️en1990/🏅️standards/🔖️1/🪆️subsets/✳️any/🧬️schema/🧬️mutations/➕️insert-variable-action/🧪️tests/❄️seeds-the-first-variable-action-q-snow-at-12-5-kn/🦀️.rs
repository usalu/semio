//! 🧪️ `insert-variable-action` fixture — `❄️seeds-the-first-variable-action-q-snow-at-12-5-kn`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-variable-action/❄️seeds-the-first-variable-action-q-snow-at-12-5-kn/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-variable-action/❄️seeds-the-first-variable-action-q-snow-at-12-5-kn/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-variable-action/❄️seeds-the-first-variable-action-q-snow-at-12-5-kn/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-variable-action/❄️seeds-the-first-variable-action-q-snow-at-12-5-kn/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️insert-variable-action/❄️seeds-the-first-variable-action-q-snow-at-12-5-kn/🎯️outcome/🔣️.json");
