//! `change-effects` mutation for EN 1990.
...
pub struct ChangeEffects {
    pub new_effects: Vec<crate::MemberEffect>,
}

impl protocol::MutationKind<En1990Snapshot, En1990Mutation> for ChangeEffects {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor {
        verb: "change",
        entity: "effects",
        kind: "change-effects",
        record: "ChangedEffects",
    };
