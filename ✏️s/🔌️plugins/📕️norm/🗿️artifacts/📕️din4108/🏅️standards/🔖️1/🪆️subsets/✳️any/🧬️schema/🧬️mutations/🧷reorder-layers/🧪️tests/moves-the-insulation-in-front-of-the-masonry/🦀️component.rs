...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-layers/moves-the-insulation-in-front-of-the-masonry: produced diff differs from the committed 🔺️diff/🔣️component.json");
