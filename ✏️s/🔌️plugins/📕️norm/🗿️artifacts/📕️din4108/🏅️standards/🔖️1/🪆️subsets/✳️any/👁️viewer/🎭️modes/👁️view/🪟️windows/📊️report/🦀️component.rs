//! 📊️ DIN 4108 viewer — the Report window: a read-only table of every computed compliance
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::din4108::create_din4108_viewer`. Read-only variant
...
pub async fn render(document: &Din4108Snapshot) -> UiNode {
