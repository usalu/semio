//! ✏️ DIN 4108 play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::editor::din4108::create_din4108_app`. Every norm app declares
