...
use crate::editor::din4108::Din4108Family;
...
//#region 🔖️Render
pub async fn render(host: &NormHost<Din4108Family>, selected_check_index: Option<u32>) -> UiNode {
...
mod tests {
    ...
    async fn an_out_of_range_selected_index_falls_back_to_the_first_check() {
        let host = NormHost::<Din4108Family>::from_document(crate::artifacts::din4108::Din4108Snapshot::default());
