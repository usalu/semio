...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.din4108/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &Din4108Command, _snapshot: &Din4108Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<Din4108Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<Din4108PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<Din4108PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<Din4108PlayApp>;
...
impl ArtifactEditor for Din4108PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📕️din4108/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
