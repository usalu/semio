...
impl ArtifactEditor for Din4108PlayApp {
    ...
    async fn initial_snapshot() -> Din4108Snapshot {
    ...
    async fn command_id(command: &Din4108Command) -> &'static str {
        command.command_id()
    }
    ...
    async fn render(body_key: &str, doc: &ArtifactView<'_, Din4108Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
    ...
    async fn export_media(port: &str, doc: &ArtifactView<'_, Din4108Snapshot>) -> Result<Media, MediaError> {
    ...
    async fn import_media(port: &str, media: &Media, doc: &ArtifactView<'_, Din4108Snapshot>) -> Result<Emit<Din4108Mutation, NormConfigMutation, Self::DraftMutation>, MediaError> {
...
impl crate::document::NormFamily for Din4108Family {
    ...
    async fn evaluate(document: &Din4108Snapshot) -> crate::document::CheckReport {
...
//#region ðï¸Manifest
pub async fn create_din4108_app() -> semio_framework_plugin::AppDefinition {
...
pub(crate) mod testkit {
    ...
    pub async fn din4108_manifest_for_testkit() -> semio_framework_plugin::App {
...
mod tests {
    ...
    async fn every_command() -> Vec<Din4108Command> {
        vec![
