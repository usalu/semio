...
#[path = "."]
mod fixture_tests {
    #[path = "🪚change-airtightness-class/🧪️tests/upgrades-the-airtightness-class-to-class1/🦀️.rs"]
    mod tests_change_airtightness_class_upgrades_the_airtightness_class_to_class1;
    #[path = "🧰change-airtightness-n50/🧪️tests/tightens-n50-to-1-point-5-per-hour/🦀️.rs"]
    mod tests_change_airtightness_n50_tightens_n50_to_1_point_5_per_hour;
    #[path = "🪤change-application-type/🧪️tests/reclassifies-the-application-type-as-wab/🦀️.rs"]
    mod tests_change_application_type_reclassifies_the_application_type_as_wab;
    #[path = "🔀change-bb2-details-conform/🧪️tests/declares-the-beiblatt-2-details-non-conforming/🦀️.rs"]
    mod tests_change_bb2_details_conform_declares_the_beiblatt_2_details_non_conforming;
    #[path = "🧵change-catalog-id/🧪️tests/repoints-the-catalogue-entry-to-aw-07/🦀️.rs"]
    mod tests_change_catalog_id_repoints_the_catalogue_entry_to_aw_07;
    #[path = "🪜change-category/🧪️tests/retypes-the-assembly-as-office/🦀️.rs"]
    mod tests_change_category_retypes_the_assembly_as_office;
    #[path = "🛠️change-climate/🧪️tests/moves-the-building-to-climate-zone-4/🦀️.rs"]
    mod tests_change_climate_moves_the_building_to_climate_zone_4;
    #[path = "🧶change-declared-application-class/🧪️tests/declares-application-class-kh/🦀️.rs"]
    mod tests_change_declared_application_class_declares_application_class_kh;
    #[path = "🪢change-envelope-area-m2/🧪️tests/grows-the-envelope-to-150-m2/🦀️.rs"]
    mod tests_change_envelope_area_m2_grows_the_envelope_to_150_m2;
    #[path = "🧲change-irradiance-wm2/🧪️tests/raises-design-irradiance-to-750-w-per-m2/🦀️.rs"]
    mod tests_change_irradiance_w_m2_raises_design_irradiance_to_750_w_per_m2;
    #[path = "🪒change-layer-lambda/🧪️tests/degrades-the-masonry-lambda-to-0-point-5/🦀️.rs"]
    mod tests_change_layer_lambda_degrades_the_masonry_lambda_to_0_point_5;
    #[path = "🪡change-layer-thickness/🧪️tests/thickens-the-insulation-layer-to-0-point-2-m/🦀️.rs"]
    mod tests_change_layer_thickness_thickens_the_insulation_layer_to_0_point_2_m;
    #[path = "🪥change-material-id/🧪️tests/swaps-the-insulation-material-to-eps/🦀️.rs"]
    mod tests_change_material_id_swaps_the_insulation_material_to_eps;
    #[path = "🪛change-moisture-mu-exterior/🧪️tests/raises-the-exterior-mu-value-to-20/🦀️.rs"]
    mod tests_change_moisture_mu_exterior_raises_the_exterior_mu_value_to_20;
    #[path = "🪝change-moisture-mu-interior/🧪️tests/raises-the-interior-mu-value-to-2-point-5/🦀️.rs"]
    mod tests_change_moisture_mu_interior_raises_the_interior_mu_value_to_2_point_5;
    #[path = "🧯change-psi-times-l-sum/🧪️tests/raises-the-thermal-bridge-sum-to-0-point-05/🦀️.rs"]
    mod tests_change_psi_times_l_sum_raises_the_thermal_bridge_sum_to_0_point_05;
    #[path = "🪣change-rh-int/🧪️tests/raises-indoor-relative-humidity-to-0-point-65/🦀️.rs"]
    mod tests_change_rh_int_raises_indoor_relative_humidity_to_0_point_65;
    #[path = "🏷️change-solar-absorptance/🧪️tests/lightens-the-facade-to-absorptance-0-point-25/🦀️.rs"]
    mod tests_change_solar_absorptance_lightens_the_facade_to_absorptance_0_point_25;
    #[path = "🚨change-t-int-c/🧪️tests/raises-the-indoor-design-temperature-to-22-point-5-c/🦀️.rs"]
    mod tests_change_t_int_c_raises_the_indoor_design_temperature_to_22_point_5_c;
    #[path = "🔢insert-layer/🧪️tests/inserts-an-interior-plaster-layer-at-index-1/🦀️.rs"]
    mod tests_insert_layer_inserts_an_interior_plaster_layer_at_index_1;
    #[path = "🛡️remove-layer/🧪️tests/removes-the-load-bearing-masonry-layer/🦀️.rs"]
    mod tests_remove_layer_removes_the_load_bearing_masonry_layer;
    #[path = "🧷reorder-layers/🧪️tests/moves-the-insulation-in-front-of-the-masonry/🦀️.rs"]
