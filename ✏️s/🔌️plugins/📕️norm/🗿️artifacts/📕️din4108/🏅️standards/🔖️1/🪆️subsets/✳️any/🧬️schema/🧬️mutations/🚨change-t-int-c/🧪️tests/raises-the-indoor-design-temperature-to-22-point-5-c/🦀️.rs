...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-t-int-c/raises-the-indoor-design-temperature-to-22-point-5-c: produced diff differs from the committed 🔺️diff/🔣️.json");
