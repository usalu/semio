//! 🔺️ DIN 4108 artifact — the operation diff and its `MutationDiff` law.
//!
...
//! names as its `Din4108Mutation::Diff`, with the `MutationDiff` impl (apply = "take the replacement,
