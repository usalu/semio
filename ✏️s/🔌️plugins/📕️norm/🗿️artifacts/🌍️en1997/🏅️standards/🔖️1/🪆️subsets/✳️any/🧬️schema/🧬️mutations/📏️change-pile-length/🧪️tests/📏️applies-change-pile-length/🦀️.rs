...
async fn applies_change_pile_length() {
    ...
    assert_eq!(restored, base, "change-pile-length inverse restores the base snapshot");
}

fn sample_mutation(base: &En1997Snapshot) -> En1997Mutation {
    use crate::mutations::*;
    En1997Mutation::ChangePileLength(change_pile_length::ChangePileLength { id: base.piles[0].id.clone(), new_length: base.piles[0].length + 2.0 })
}
