...
fn en1997_mutation_to_dsl(mutation: &En1997Mutation) -> En1997MutationDsl {
    match mutation {
        En1997Mutation::ChangeVEdKn(payload) => En1997MutationDsl::ChangeVEdKn { new_v_ed_kn: payload.new_v_ed_kn },
        En1997Mutation::ChangeHEdKn(payload) => En1997MutationDsl::ChangeHEdKn { new_h_ed_kn: payload.new_h_ed_kn },
        En1997Mutation::ChangeFootingAreaM2(payload) => En1997MutationDsl::ChangeFootingAreaM2 { new_footing_area_m2: payload.new_footing_area_m2 },
        En1997Mutation::ChangePhiDeg(payload) => En1997MutationDsl::ChangePhiDeg { new_phi_deg: payload.new_phi_deg },
        En1997Mutation::ChangeCKpa(payload) => En1997MutationDsl::ChangeCKpa { new_c_kpa: payload.new_c_kpa },
        En1997Mutation::ChangeGammaKnM3(payload) => En1997MutationDsl::ChangeGammaKnM3 { new_gamma_kn_m3: payload.new_gamma_kn_m3 },
        En1997Mutation::ChangeBM(payload) => En1997MutationDsl::ChangeBM { new_b_m: payload.new_b_m },
        En1997Mutation::ChangeDFM(payload) => En1997MutationDsl::ChangeDFM { new_d_f_m: payload.new_d_f_m },
        En1997Mutation::ChangeESMpa(payload) => En1997MutationDsl::ChangeESMpa { new_e_s_mpa: payload.new_e_s_mpa },
        En1997Mutation::ChangeNu(payload) => En1997MutationDsl::ChangeNu { new_nu: payload.new_nu },
        ...
        En1997Mutation::ChangeSettlementLimitMm(payload) => En1997MutationDsl::ChangeSettlementLimitMm { new_settlement_limit_mm: payload.new_settlement_limit_mm },
        En1997Mutation::ChangeNPileEdKn(payload) => En1997MutationDsl::ChangeNPileEdKn { new_n_pile_ed_kn: payload.new_n_pile_ed_kn },
        En1997Mutation::ChangeAlphaS(payload) => En1997MutationDsl::ChangeAlphaS { new_alpha_s: payload.new_alpha_s },
        En1997Mutation::ChangePileDM(payload) => En1997MutationDsl::ChangePileDM { new_pile_d_m: payload.new_pile_d_m },
        En1997Mutation::ChangeQSKpa(payload) => En1997MutationDsl::ChangeQSKpa { new_q_s_kpa: payload.new_q_s_kpa },
        En1997Mutation::ChangePileLM(payload) => En1997MutationDsl::ChangePileLM { new_pile_l_m: payload.new_pile_l_m },
        En1997Mutation::ChangeQBKpa(payload) => En1997MutationDsl::ChangeQBKpa { new_q_b_kpa: payload.new_q_b_kpa },
        En1997Mutation::ChangePileBaseAreaM2(payload) => En1997MutationDsl::ChangePileBaseAreaM2 { new_pile_base_area_m2: payload.new_pile_base_area_m2 },
        En1997Mutation::ChangePileNProfiles(payload) => En1997MutationDsl::ChangePileNProfiles { new_pile_n_profiles: payload.new_pile_n_profiles },
        En1997Mutation::ChangeZInvestigatedM(payload) => En1997MutationDsl::ChangeZInvestigatedM { new_z_investigated_m: payload.new_z_investigated_m },
    }
}
