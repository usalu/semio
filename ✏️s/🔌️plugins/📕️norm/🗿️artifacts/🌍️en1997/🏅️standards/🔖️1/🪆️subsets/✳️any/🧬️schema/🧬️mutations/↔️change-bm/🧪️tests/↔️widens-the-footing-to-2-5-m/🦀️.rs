//! 🧪️ `change-bm` fixture — `↔️widens-the-footing-to-2-5-m`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bm/↔️widens-the-footing-to-2-5-m/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bm/↔️widens-the-footing-to-2-5-m/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bm/↔️widens-the-footing-to-2-5-m/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bm/↔️widens-the-footing-to-2-5-m/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bm/↔️widens-the-footing-to-2-5-m/🎯️outcome/🔣️.json");
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(
        ...
        None,
        "change-bm/widens-the-footing-to-2-5-m: the payload is finite, so `change-bm`'s `mutation.invariant` fatal cannot fire, and 2.5 differs from the committed 2.0, so its `mutation.no-op` warning cannot either"
    );
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-bm/widens-the-footing-to-2-5-m: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
