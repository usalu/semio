//! 🧪️ `change-dfm` fixture — `⬇️deepens-the-founding-level-to-2-m`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-dfm/deepens-the-founding-level-to-2-m: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
