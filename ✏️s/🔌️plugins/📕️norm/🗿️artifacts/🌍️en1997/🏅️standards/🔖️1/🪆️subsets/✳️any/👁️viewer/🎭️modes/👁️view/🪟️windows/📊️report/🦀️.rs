//! 📊️ EN 1997 viewer — the Report window: a read-only table of every computed compliance
...
pub fn render(document: &En1997Snapshot, locale: semio_framework_plugin::Locale) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
