...
Feature: Apply every typed EN 1997 mutation against an independent Python implementation
  ...
  Scenario Outline: Apply <id> to its committed specification vector
    ...
    Examples:
      | id                         | dir                         | fixture                                                 |
      | change-v-ed-kn             | 🏋️change-v-ed-kn             | 🏋️raises-the-design-vertical-load-to-750-kn               |
      | change-h-ed-kn             | ➡️change-h-ed-kn             | ➡️raises-the-design-horizontal-load-to-120-kn             |
      | change-footing-area-m2     | 🦶️change-footing-area-m2     | 🦶️enlarges-the-footing-area-to-6-25-m2                    |
      | change-phi-deg             | 📐️change-phi-deg             | 📐️raises-the-friction-angle-to-35-degrees                 |
      | change-c-kpa               | 🧲️change-c-kpa               | 🧲️gives-the-drained-sand-12-5-kpa-of-effective-cohesion   |
      | change-gamma-kn-m3         | ⚖️change-gamma-kn-m3         | ⚖️raises-the-soil-unit-weight-to-20-kn-m3                 |
      | change-bm                  | ↔️change-bm                  | ↔️widens-the-footing-to-2-5-m                             |
      | change-dfm                 | ⬇️change-dfm                 | ⬇️deepens-the-founding-level-to-2-m                       |
      | change-es-mpa              | 🌀️change-es-mpa              | 🌀️stiffens-the-soil-modulus-to-45-mpa                     |
      | change-nu                  | 🧮️change-nu                  | 🧮️raises-poissons-ratio-to-0-375                          |
      | change-design-approach     | 🧭️change-design-approach    | 🧭️switches-from-design-approach-1-to-design-approach-2    |
      | change-annex               | 🌍️change-annex              | 🌍️switches-from-the-german-na-to-the-recommended-en-annex |
      | change-settlement-limit-mm | 🚦️change-settlement-limit-mm | 🚦️relaxes-the-settlement-limit-to-40-mm                   |
      | change-n-pile-ed-kn        | 🏗️change-n-pile-ed-kn        | 🏗️raises-the-design-pile-axial-load-to-1200-kn            |
      | change-alpha-s             | 🎚️change-alpha-s             | 🎚️lowers-the-shaft-resistance-factor-to-0-5               |
      | change-pile-dm             | ⭕️change-pile-dm             | ⭕️enlarges-the-pile-diameter-to-0-75-m                    |
      | change-qs-kpa              | 🪵️change-qs-kpa              | 🪵️raises-the-unit-shaft-resistance-to-120-kpa             |
      | change-pile-lm             | 📏️change-pile-lm             | 📏️lengthens-the-pile-to-15-m                              |
      | change-qb-kpa              | 🛡️change-qb-kpa              | 🛡️raises-the-unit-base-resistance-to-3200-kpa             |
      | change-pile-base-area-m2   | 🔘️change-pile-base-area-m2   | 🔘️doubles-the-pile-base-area-to-0-5-m2                    |
      | change-pile-n-profiles     | 🗺️change-pile-n-profiles     | 🗺️adds-a-third-investigated-ground-profile                |
      | change-z-investigated-m    | 🔎️change-z-investigated-m    | 🔎️deepens-the-investigated-depth-to-12-m                  |
