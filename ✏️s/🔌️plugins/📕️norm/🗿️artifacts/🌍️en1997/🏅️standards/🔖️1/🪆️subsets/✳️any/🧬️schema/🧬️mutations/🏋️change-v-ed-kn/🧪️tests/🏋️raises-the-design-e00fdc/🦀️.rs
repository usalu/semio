//! 🧪️ `change-v-ed-kn` fixture — `🏋️raises-the-design-vertical-load-to-750-kn`.
//!
...
async fn raises_the_design_vertical_load_to_750_kn() {
...
/// `v_ed_kn`.
#[semio_framework_async_macros::async_test]
async fn restoring_500_kn_restores_before() {
    let base = before();
