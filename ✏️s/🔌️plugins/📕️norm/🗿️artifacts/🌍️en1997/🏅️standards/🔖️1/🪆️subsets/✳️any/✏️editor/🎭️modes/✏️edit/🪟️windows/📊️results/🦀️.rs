...
//#region 🔖️Constants
pub const WINDOW_RESULTS: &str = "norm-en1997-results";
crate::norm_results_window_config_owner!(ResultsWindowConfigOwner, WINDOW_RESULTS);

pub const BODY_RESULTS: &str = "norm.en1997.play.results";
//#endregion 🔖️Constants

//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::editor::en1997::create_en1997_app`.
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1997Family>, windows: &semio_framework_plugin::TreeWindows<'_>, locale: semio_framework_plugin::Locale, controller_id: Option<&'static str>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
