//! 🔍️ EN 1997 play app panel — the inspection tab: one computed check in full, chosen by the config's
...
//#region 🔖️Constants
pub const BODY_INSPECTION: &str = "norm.en1997.play.inspection";
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1997Family>, selected_check_index: Option<u32>, locale: semio_framework_plugin::Locale, controller_id: Option<&'static str>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
