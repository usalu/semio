...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-phi-deg/📐️raises-the-friction-angle-to-35-degrees/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-phi-deg/📐️raises-the-friction-angle-to-35-degrees/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-phi-deg/📐️raises-the-friction-angle-to-35-degrees/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-phi-deg/📐️raises-the-friction-angle-to-35-degrees/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-phi-deg/📐️raises-the-friction-angle-to-35-degrees/🎯️outcome/🔣️.json");
...
async fn raises_the_friction_angle_to_35_degrees() {
...
/// back on `phi_deg`.
#[semio_framework_async_macros::async_test]
async fn restoring_30_degrees_restores_before() {
    let base = before();
