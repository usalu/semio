...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⭕️change-pile-dm/⭕️enlarges-the-pile-diameter-to-0-75-m/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⭕️change-pile-dm/⭕️enlarges-the-pile-diameter-to-0-75-m/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⭕️change-pile-dm/⭕️enlarges-the-pile-diameter-to-0-75-m/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⭕️change-pile-dm/⭕️enlarges-the-pile-diameter-to-0-75-m/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⭕️change-pile-dm/⭕️enlarges-the-pile-diameter-to-0-75-m/🎯️outcome/🔣️.json");
