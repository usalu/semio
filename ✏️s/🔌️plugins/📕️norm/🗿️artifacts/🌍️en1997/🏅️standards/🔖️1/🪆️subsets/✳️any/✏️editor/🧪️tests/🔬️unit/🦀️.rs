pub(crate) mod context {
    ...
    pub async fn app_with_registry() -> NormApp {
        new_app_with_registry::<EditorApp<En1997PlayApp>>(en1997_manifest_for_tests).await
    }
...
async fn set_snapshot_commits_a_host_backed_report() {
    ...
    let host = NormHost::<En1997Family>::from_document(app.snapshot().expect("projection"));
