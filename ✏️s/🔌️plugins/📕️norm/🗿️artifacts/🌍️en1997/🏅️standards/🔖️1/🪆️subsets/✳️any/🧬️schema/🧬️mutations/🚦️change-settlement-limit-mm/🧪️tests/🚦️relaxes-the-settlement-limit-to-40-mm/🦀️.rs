//! 🧪️ `change-settlement-limit-mm` fixture — `🚦️relaxes-the-settlement-limit-to-40-mm`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-settlement-limit-mm/🚦️relaxes-the-settlement-limit-to-40-mm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-settlement-limit-mm/🚦️relaxes-the-settlement-limit-to-40-mm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-settlement-limit-mm/🚦️relaxes-the-settlement-limit-to-40-mm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-settlement-limit-mm/🚦️relaxes-the-settlement-limit-to-40-mm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-settlement-limit-mm/🚦️relaxes-the-settlement-limit-to-40-mm/🎯️outcome/🔣️.json");
...
async fn relaxes_the_settlement_limit_to_40_mm() {
...
#[semio_framework_async_macros::async_test]
async fn restoring_the_25_mm_limit_restores_before() {
    let base = before();
