...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔎️change-z-investigated-m/🔎️deepens-the-investigated-depth-to-12-m/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔎️change-z-investigated-m/🔎️deepens-the-investigated-depth-to-12-m/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔎️change-z-investigated-m/🔎️deepens-the-investigated-depth-to-12-m/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔎️change-z-investigated-m/🔎️deepens-the-investigated-depth-to-12-m/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔎️change-z-investigated-m/🔎️deepens-the-investigated-depth-to-12-m/🎯️outcome/🔣️.json");
...
async fn deepens_the_investigated_depth_to_12_m() {
...
#[semio_framework_async_macros::async_test]
async fn restoring_the_8_m_investigation_restores_before() {
    let base = before();
