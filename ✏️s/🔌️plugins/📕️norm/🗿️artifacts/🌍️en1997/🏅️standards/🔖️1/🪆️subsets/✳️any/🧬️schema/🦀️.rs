...
//#region 🔖️Artifact
/// 🧬️ EN 1997 document artifact state.
...
impl En1997Artifact {
    pub fn to_snapshot(&self) -> En1997Snapshot {
        En1997Snapshot {
            ...
            footing_area_m2: self.footing_area_m2,
            phi_deg: self.phi_deg,
            c_kpa: self.c_kpa,
            gamma_kn_m3: self.gamma_kn_m3,
            b_m: self.b_m,
            d_f_m: self.d_f_m,
            e_s_mpa: self.e_s_mpa,
            nu: self.nu,
            design_approach: self.design_approach.clone(),
            annex: self.annex,
            settlement_limit_mm: self.settlement_limit_mm,
            n_pile_ed_kn: self.n_pile_ed_kn,
            alpha_s: self.alpha_s,
            pile_d_m: self.pile_d_m,
            q_s_kpa: self.q_s_kpa,
            pile_l_m: self.pile_l_m,
            q_b_kpa: self.q_b_kpa,
            pile_base_area_m2: self.pile_base_area_m2,
            pile_n_profiles: self.pile_n_profiles,
            z_investigated_m: self.z_investigated_m,
        }
    }
...
/// `semio_s_artifact_norm_en1990`'s relocated `NaDe`.
