//! 🧪️ `change-pile-n-profiles` fixture — `🗺️adds-a-third-investigated-ground-profile`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-pile-n-profiles/adds-a-third-investigated-ground-profile: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
