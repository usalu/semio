...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔘️change-pile-base-area-m2/🔘️doubles-the-pile-base-area-to-0-5-m2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔘️change-pile-base-area-m2/🔘️doubles-the-pile-base-area-to-0-5-m2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔘️change-pile-base-area-m2/🔘️doubles-the-pile-base-area-to-0-5-m2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔘️change-pile-base-area-m2/🔘️doubles-the-pile-base-area-to-0-5-m2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔘️change-pile-base-area-m2/🔘️doubles-the-pile-base-area-to-0-5-m2/🎯️outcome/🔣️.json");
...
async fn doubles_the_pile_base_area_to_0_5_m2() {
...
#[semio_framework_async_macros::async_test]
async fn restoring_0_25_m2_restores_before() {
    let base = before();
