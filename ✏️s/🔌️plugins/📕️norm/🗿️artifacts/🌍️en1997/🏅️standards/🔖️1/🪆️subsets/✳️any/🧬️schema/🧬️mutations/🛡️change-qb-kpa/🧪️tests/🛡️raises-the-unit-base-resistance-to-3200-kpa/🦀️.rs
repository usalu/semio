...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-qb-kpa/🛡️raises-the-unit-base-resistance-to-3200-kpa/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-qb-kpa/🛡️raises-the-unit-base-resistance-to-3200-kpa/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-qb-kpa/🛡️raises-the-unit-base-resistance-to-3200-kpa/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-qb-kpa/🛡️raises-the-unit-base-resistance-to-3200-kpa/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-qb-kpa/🛡️raises-the-unit-base-resistance-to-3200-kpa/🎯️outcome/🔣️.json");
