//! 🧪️ `change-wall-thickness-mm` fixture — `🌻️thickens-the-wall-to-300-mm`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-wall-thickness-mm/thickens-the-wall-to-300-mm: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
