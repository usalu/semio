//! 🧪️ `change-z-mm3` fixture — `⚫️raises-the-section-modulus-to-9500000-mm3`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-z-mm3/raises-the-section-modulus-to-9500000-mm3: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
