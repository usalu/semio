/** ✏️ EN 1996 editor — subset-level typed twin. Mirrors the editor manifest's mode/
...
export const EN1996_EDITOR_DIALECT = { artifactKind: "s.norm.en1996", standard: "1", subset: "*" } as const;
