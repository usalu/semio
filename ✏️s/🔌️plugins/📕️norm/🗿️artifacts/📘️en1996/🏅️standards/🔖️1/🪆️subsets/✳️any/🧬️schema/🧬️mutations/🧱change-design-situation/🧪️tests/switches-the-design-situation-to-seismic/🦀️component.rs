...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-design-situation/switches-the-design-situation-to-seismic: the produced diff differs from the committed 🔺️diff/🔣️component.json");
}
