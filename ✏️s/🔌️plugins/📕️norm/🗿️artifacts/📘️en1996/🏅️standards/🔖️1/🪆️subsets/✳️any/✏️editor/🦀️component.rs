...
impl ArtifactEditor for En1996PlayApp {
    ...
    async fn command_id(command: &En1996Command) -> &'static str {
        command.command_id()
    }
    ...
    async fn render(body_key: &str, doc: &ArtifactView<'_, En1996Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> UiNode {
    ...
    async fn export_media(port: &str, doc: &ArtifactView<'_, En1996Snapshot>) -> Result<Media, MediaError> {
    ...
    async fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, En1996Snapshot>) -> Result<Emit<En1996Mutation, NormConfigMutation, Self::DraftMutation>, MediaError> {
...
impl crate::document::NormFamily for En1996Family {
    ...
    async fn evaluate(document: &En1996Snapshot) -> crate::document::CheckReport {
...
//#region ðï¸Manifest
pub async fn create_en1996_app() -> semio_framework_plugin::AppDefinition {
...
pub(crate) mod testkit {
    ...
    pub async fn en1996_manifest_for_testkit() -> semio_framework_plugin::App {
...
mod tests {
    ...
    async fn every_command() -> Vec<En1996Command> {
        vec![
