//! 🧪️ `change-f-vk-mpa` fixture — `raises-the-characteristic-shear-strength-to-0-375-mpa`.
//!
...
async fn raises_the_characteristic_shear_strength_to_0_375_mpa() {
...
/// `f_vk_mpa`.
#[semio_framework_async_macros::async_test]
async fn restoring_0_25_mpa_restores_before() {
    let base = before();
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-f-vk-mpa/raises-the-characteristic-shear-strength-to-0-375-mpa: the produced diff differs from the committed 🔺️diff/🔣️component.json");
}
