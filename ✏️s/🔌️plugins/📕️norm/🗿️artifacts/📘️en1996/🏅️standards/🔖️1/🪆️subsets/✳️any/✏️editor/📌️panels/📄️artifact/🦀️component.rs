//! 📄️ EN 1996 play app panel — the document headline: family, check count, worst utilization, verdict.
...
//#region 🔖️Constants
pub const BODY_DOCUMENT: &str = "norm.en1996.play.document";
...
//#region 🔖️Render
pub async fn render(host: &NormHost<En1996Family>) -> UiNode {
