//! 🎹️ En1996Composer (1 standard) — aggregates its subsets' composer entries value-level. W5a
...
//! history) — a fabricated shape, not a real codec. Only the native `s.en1996` entry remains.
