//! 🧪️ `change-bridge-sigma-c-mpa` fixture — `🌉️raises-bridge-sigma-c-mpa-to-15-75`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1992Diff.bridge_sigma_c_mpa` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-sigma-c-mpa/🌉️raises-bridge-sigma-c-mpa-to-15-75/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-sigma-c-mpa/🌉️raises-bridge-sigma-c-mpa-to-15-75/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-sigma-c-mpa/🌉️raises-bridge-sigma-c-mpa-to-15-75/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-sigma-c-mpa/🌉️raises-bridge-sigma-c-mpa-to-15-75/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-sigma-c-mpa/🌉️raises-bridge-sigma-c-mpa-to-15-75/🎯️outcome/🔣️.json");
...
async fn change_bridge_sigma_c_mpa_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-bridge-sigma-c-mpa/raises-bridge-sigma-c-mpa-to-15-75: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_bridge_sigma_c_mpa_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-bridge-sigma-c-mpa/raises-bridge-sigma-c-mpa-to-15-75: the committed diff must leave the presence-lane selectedCheckIndex absent");
