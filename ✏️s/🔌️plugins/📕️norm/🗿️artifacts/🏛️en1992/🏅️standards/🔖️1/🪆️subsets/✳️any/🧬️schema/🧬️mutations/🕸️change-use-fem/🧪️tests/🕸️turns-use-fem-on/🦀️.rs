...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-use-fem/🕸️turns-use-fem-on/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-use-fem/🕸️turns-use-fem-on/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-use-fem/🕸️turns-use-fem-on/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-use-fem/🕸️turns-use-fem-on/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-use-fem/🕸️turns-use-fem-on/🎯️outcome/🔣️.json");
...
async fn change_use_fem_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-use-fem/turns-use-fem-on: the committed diff must leave the presence-lane selectedCheckIndex absent");
