//! 🔧 `change-concrete-f-ck` — updates f_ck/f_yk on a material grade by id.
...
pub struct ChangeConcreteFCk {
    pub grade_id: String,
    pub new_f_ck: f64,
}

impl protocol::MutationKind<En1992Snapshot, En1992Mutation> for ChangeConcreteFCk {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "change", entity: "grade", kind: "change-concrete-f-ck", record: "ChangedConcreteFCk" };
