...
pub struct ChangeMemberEffectiveDepth {
...
impl protocol::MutationKind<En1992Snapshot, En1992Mutation> for ChangeMemberEffectiveDepth {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change {} of {}", "effective_depth", self.member_id), &format!("{} von {} ändern", "effective_depth", self.member_id))
    }
