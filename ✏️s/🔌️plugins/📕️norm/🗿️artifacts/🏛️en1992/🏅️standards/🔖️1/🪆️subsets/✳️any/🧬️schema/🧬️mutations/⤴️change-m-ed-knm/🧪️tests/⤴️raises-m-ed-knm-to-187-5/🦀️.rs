...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-m-ed-knm-to-187-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-m-ed-knm-to-187-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-m-ed-knm-to-187-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-m-ed-knm-to-187-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-m-ed-knm-to-187-5/🎯️outcome/🔣️.json");
...
async fn change_m_ed_knm_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-m-ed-knm/raises-m-ed-knm-to-187-5: the committed diff must leave the presence-lane selectedCheckIndex absent");
