//! 🧪️ `change-m-ed-knm` fixture — `🌱️raises-m-ed-knm-to-187-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1992Diff.m_ed_knm` and nothing else,
...
fn change_m_ed_knm_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-m-ed-knm/raises-m-ed-knm-to-187-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
