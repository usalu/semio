...
pub struct ChangeActionNEd {
    pub member_id: String,
    pub action_id: String,
    pub new_value: f64,
}

impl protocol::MutationKind<En1992Snapshot, En1992Mutation> for ChangeActionNEd {
    const SEMANTICS: protocol::SemanticDescriptor = protocol::SemanticDescriptor { verb: "change", entity: "action-n-ed", kind: "change-action-n-ed", record: "ChangedChangeActionNEd" };
