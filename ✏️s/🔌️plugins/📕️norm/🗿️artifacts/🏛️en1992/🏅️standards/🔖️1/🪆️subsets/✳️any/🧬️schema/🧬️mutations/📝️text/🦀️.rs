...
use crate::artifact_schema::mutations::{
    ...
    change_hd_over_h::ChangeHdOverH, change_liquid_e_s_mpa::ChangeLiquidESMpa, change_liquid_f_ct_eff_mpa::ChangeLiquidFCtEffMpa, change_liquid_rho_p_eff::ChangeLiquidRhoPEff, change_liquid_s_r_max_mm::ChangeLiquidSRMaxMm,
    change_liquid_sigma_s_mpa::ChangeLiquidSigmaSMpa, change_m_ed_knm::ChangeMEdKnm, change_n_ed_kn::ChangeNEdKn, change_p_kn::ChangePKn, change_provided_axis_distance_mm::ChangeProvidedAxisDistanceMm, change_rho_l::ChangeRhoL,
    change_span_m::ChangeSpanM, change_tightness_class::ChangeTightnessClass, change_udl_kn_m::ChangeUdlKnM, change_use_fem::ChangeUseFem, change_v_ed_kn::ChangeVEdKn,
};
...
//#region 🏷️WireTags
/// 🏷️ Op tags of `En1992Mutation`, derived from the `record <kind> tag=<n>` lines of its `📡️.protocol.semio`.
...
const TAG_CHANGE_F_CK: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-f-ck");
const TAG_CHANGE_B_MM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-b-mm");
const TAG_CHANGE_D_MM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-d-mm");
const TAG_CHANGE_AS_MM2: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-as-mm2");
const TAG_CHANGE_F_YK: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-f-yk");
const TAG_CHANGE_RHO_L: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-rho-l");
const TAG_CHANGE_N_ED_KN: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-n-ed-kn");
const TAG_CHANGE_P_KN: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-p-kn");
const TAG_CHANGE_AC_MM2: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-ac-mm2");
const TAG_CHANGE_USE_FEM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-use-fem");
const TAG_CHANGE_SPAN_M: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-span-m");
const TAG_CHANGE_UDL_KN_M: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-udl-kn-m");
const TAG_CHANGE_FIRE_RATING: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-fire-rating");
const TAG_CHANGE_PROVIDED_AXIS_DISTANCE_MM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-provided-axis-distance-mm");
const TAG_CHANGE_BRIDGE_SIGMA_C_MPA: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-bridge-sigma-c-mpa");
const TAG_CHANGE_BRIDGE_DELTA_SIGMA_S_MPA: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-bridge-delta-sigma-s-mpa");
const TAG_CHANGE_TIGHTNESS_CLASS: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-tightness-class");
const TAG_CHANGE_HD_OVER_H: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-hd-over-h");
const TAG_CHANGE_LIQUID_SIGMA_S_MPA: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-liquid-sigma-s-mpa");
const TAG_CHANGE_LIQUID_RHO_P_EFF: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-liquid-rho-p-eff");
const TAG_CHANGE_LIQUID_F_CT_EFF_MPA: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-liquid-f-ct-eff-mpa");
const TAG_CHANGE_LIQUID_ES_MPA: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-liquid-es-mpa");
const TAG_CHANGE_LIQUID_SR_MAX_MM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-liquid-sr-max-mm");
const TAG_CHANGE_ANCHOR_H_EF_MM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-h-ef-mm");
const TAG_CHANGE_ANCHOR_CRACKED: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-cracked");
const TAG_CHANGE_ANCHOR_F_UK_MPA: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-f-uk-mpa");
const TAG_CHANGE_ANCHOR_F_YK_MPA: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-f-yk-mpa");
const TAG_CHANGE_ANCHOR_AS_MM2: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-as-mm2");
const TAG_CHANGE_ANCHOR_D_MM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-d-mm");
const TAG_CHANGE_ANCHOR_C1_MM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-c1-mm");
const TAG_CHANGE_ANCHOR_N_ED_KN: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-n-ed-kn");
const TAG_CHANGE_ANCHOR_V_ED_KN: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-anchor-v-ed-kn");
//#endregion 🏷️WireTags

impl protocol::OpBinary for En1992Mutation {
    fn encode_op(&self) -> Result<Vec<u8>, protocol::ProtocolError> {
        let tag: u8 = match self {
            En1992Mutation::ChangeAnnex(_) => TAG_CHANGE_ANNEX,
            En1992Mutation::ChangeMEdKnm(_) => TAG_CHANGE_M_ED_KNM,
            En1992Mutation::ChangeVEdKn(_) => TAG_CHANGE_V_ED_KN,
            En1992Mutation::ChangeFCk(_) => TAG_CHANGE_F_CK,
            En1992Mutation::ChangeBMm(_) => TAG_CHANGE_B_MM,
            En1992Mutation::ChangeDMm(_) => TAG_CHANGE_D_MM,
            En1992Mutation::ChangeASMm2(_) => TAG_CHANGE_AS_MM2,
            En1992Mutation::ChangeFYk(_) => TAG_CHANGE_F_YK,
            En1992Mutation::ChangeRhoL(_) => TAG_CHANGE_RHO_L,
            En1992Mutation::ChangeNEdKn(_) => TAG_CHANGE_N_ED_KN,
            En1992Mutation::ChangePKn(_) => TAG_CHANGE_P_KN,
            En1992Mutation::ChangeACMm2(_) => TAG_CHANGE_AC_MM2,
            En1992Mutation::ChangeUseFem(_) => TAG_CHANGE_USE_FEM,
            En1992Mutation::ChangeSpanM(_) => TAG_CHANGE_SPAN_M,
            En1992Mutation::ChangeUdlKnM(_) => TAG_CHANGE_UDL_KN_M,
            En1992Mutation::ChangeFireRating(_) => TAG_CHANGE_FIRE_RATING,
            En1992Mutation::ChangeProvidedAxisDistanceMm(_) => TAG_CHANGE_PROVIDED_AXIS_DISTANCE_MM,
            En1992Mutation::ChangeBridgeSigmaCMpa(_) => TAG_CHANGE_BRIDGE_SIGMA_C_MPA,
            En1992Mutation::ChangeBridgeDeltaSigmaSMpa(_) => TAG_CHANGE_BRIDGE_DELTA_SIGMA_S_MPA,
            En1992Mutation::ChangeTightnessClass(_) => TAG_CHANGE_TIGHTNESS_CLASS,
            En1992Mutation::ChangeHdOverH(_) => TAG_CHANGE_HD_OVER_H,
            En1992Mutation::ChangeLiquidSigmaSMpa(_) => TAG_CHANGE_LIQUID_SIGMA_S_MPA,
            En1992Mutation::ChangeLiquidRhoPEff(_) => TAG_CHANGE_LIQUID_RHO_P_EFF,
            En1992Mutation::ChangeLiquidFCtEffMpa(_) => TAG_CHANGE_LIQUID_F_CT_EFF_MPA,
            En1992Mutation::ChangeLiquidESMpa(_) => TAG_CHANGE_LIQUID_ES_MPA,
            En1992Mutation::ChangeLiquidSRMaxMm(_) => TAG_CHANGE_LIQUID_SR_MAX_MM,
            En1992Mutation::ChangeAnchorHEfMm(_) => TAG_CHANGE_ANCHOR_H_EF_MM,
            En1992Mutation::ChangeAnchorCracked(_) => TAG_CHANGE_ANCHOR_CRACKED,
            En1992Mutation::ChangeAnchorFUkMpa(_) => TAG_CHANGE_ANCHOR_F_UK_MPA,
            En1992Mutation::ChangeAnchorFYkMpa(_) => TAG_CHANGE_ANCHOR_F_YK_MPA,
            En1992Mutation::ChangeAnchorASMm2(_) => TAG_CHANGE_ANCHOR_AS_MM2,
            En1992Mutation::ChangeAnchorDMm(_) => TAG_CHANGE_ANCHOR_D_MM,
            En1992Mutation::ChangeAnchorC1Mm(_) => TAG_CHANGE_ANCHOR_C1_MM,
            En1992Mutation::ChangeAnchorNEdKn(_) => TAG_CHANGE_ANCHOR_N_ED_KN,
            En1992Mutation::ChangeAnchorVEdKn(_) => TAG_CHANGE_ANCHOR_V_ED_KN,
        };
    ...
    fn decode_op(bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        ...
        match tag {
            TAG_CHANGE_ANNEX => Ok(En1992Mutation::ChangeAnnex(ChangeAnnex { new_annex: read_json_bin(&mut reader).map_err(|e| malformed("new_annex", reader.position(), e))? })),
            TAG_CHANGE_M_ED_KNM => Ok(En1992Mutation::ChangeMEdKnm(ChangeMEdKnm { new_m_ed_knm: read_f64_bin(&mut reader).map_err(|e| malformed("new_m_ed_knm", reader.position(), e))? })),
            TAG_CHANGE_V_ED_KN => Ok(En1992Mutation::ChangeVEdKn(ChangeVEdKn { new_v_ed_kn: read_f64_bin(&mut reader).map_err(|e| malformed("new_v_ed_kn", reader.position(), e))? })),
            TAG_CHANGE_F_CK => Ok(En1992Mutation::ChangeFCk(ChangeFCk { new_f_ck: read_f64_bin(&mut reader).map_err(|e| malformed("new_f_ck", reader.position(), e))? })),
            TAG_CHANGE_B_MM => Ok(En1992Mutation::ChangeBMm(ChangeBMm { new_b_mm: read_f64_bin(&mut reader).map_err(|e| malformed("new_b_mm", reader.position(), e))? })),
            TAG_CHANGE_D_MM => Ok(En1992Mutation::ChangeDMm(ChangeDMm { new_d_mm: read_f64_bin(&mut reader).map_err(|e| malformed("new_d_mm", reader.position(), e))? })),
            TAG_CHANGE_AS_MM2 => Ok(En1992Mutation::ChangeASMm2(ChangeASMm2 { new_a_s_mm2: read_f64_bin(&mut reader).map_err(|e| malformed("new_a_s_mm2", reader.position(), e))? })),
            TAG_CHANGE_F_YK => Ok(En1992Mutation::ChangeFYk(ChangeFYk { new_f_yk: read_f64_bin(&mut reader).map_err(|e| malformed("new_f_yk", reader.position(), e))? })),
            TAG_CHANGE_RHO_L => Ok(En1992Mutation::ChangeRhoL(ChangeRhoL { new_rho_l: read_f64_bin(&mut reader).map_err(|e| malformed("new_rho_l", reader.position(), e))? })),
            TAG_CHANGE_N_ED_KN => Ok(En1992Mutation::ChangeNEdKn(ChangeNEdKn { new_n_ed_kn: read_f64_bin(&mut reader).map_err(|e| malformed("new_n_ed_kn", reader.position(), e))? })),
            TAG_CHANGE_P_KN => Ok(En1992Mutation::ChangePKn(ChangePKn { new_p_kn: read_f64_bin(&mut reader).map_err(|e| malformed("new_p_kn", reader.position(), e))? })),
            TAG_CHANGE_AC_MM2 => Ok(En1992Mutation::ChangeACMm2(ChangeACMm2 { new_a_c_mm2: read_f64_bin(&mut reader).map_err(|e| malformed("new_a_c_mm2", reader.position(), e))? })),
            TAG_CHANGE_USE_FEM => Ok(En1992Mutation::ChangeUseFem(ChangeUseFem { new_use_fem: read_bool_bin(&mut reader).map_err(|e| malformed("new_use_fem", reader.position(), e))? })),
            TAG_CHANGE_SPAN_M => Ok(En1992Mutation::ChangeSpanM(ChangeSpanM { new_span_m: read_f64_bin(&mut reader).map_err(|e| malformed("new_span_m", reader.position(), e))? })),
            TAG_CHANGE_UDL_KN_M => Ok(En1992Mutation::ChangeUdlKnM(ChangeUdlKnM { new_udl_kn_m: read_f64_bin(&mut reader).map_err(|e| malformed("new_udl_kn_m", reader.position(), e))? })),
            TAG_CHANGE_FIRE_RATING => Ok(En1992Mutation::ChangeFireRating(ChangeFireRating { new_fire_rating: read_json_bin(&mut reader).map_err(|e| malformed("new_fire_rating", reader.position(), e))? })),
            TAG_CHANGE_PROVIDED_AXIS_DISTANCE_MM => Ok(En1992Mutation::ChangeProvidedAxisDistanceMm(ChangeProvidedAxisDistanceMm { new_provided_axis_distance_mm: read_f64_bin(&mut reader).map_err(|e| malformed("new_provided_axis_distance_mm", reader.position(), e))? })),
            TAG_CHANGE_BRIDGE_SIGMA_C_MPA => Ok(En1992Mutation::ChangeBridgeSigmaCMpa(ChangeBridgeSigmaCMpa { new_bridge_sigma_c_mpa: read_f64_bin(&mut reader).map_err(|e| malformed("new_bridge_sigma_c_mpa", reader.position(), e))? })),
            TAG_CHANGE_BRIDGE_DELTA_SIGMA_S_MPA => Ok(En1992Mutation::ChangeBridgeDeltaSigmaSMpa(ChangeBridgeDeltaSigmaSMpa { new_bridge_delta_sigma_s_mpa: read_f64_bin(&mut reader).map_err(|e| malformed("new_bridge_delta_sigma_s_mpa", reader.position(), e))? })),
            TAG_CHANGE_TIGHTNESS_CLASS => Ok(En1992Mutation::ChangeTightnessClass(ChangeTightnessClass { new_tightness_class: read_json_bin(&mut reader).map_err(|e| malformed("new_tightness_class", reader.position(), e))? })),
            TAG_CHANGE_HD_OVER_H => Ok(En1992Mutation::ChangeHdOverH(ChangeHdOverH { new_hd_over_h: read_f64_bin(&mut reader).map_err(|e| malformed("new_hd_over_h", reader.position(), e))? })),
            TAG_CHANGE_LIQUID_SIGMA_S_MPA => Ok(En1992Mutation::ChangeLiquidSigmaSMpa(ChangeLiquidSigmaSMpa { new_liquid_sigma_s_mpa: read_f64_bin(&mut reader).map_err(|e| malformed("new_liquid_sigma_s_mpa", reader.position(), e))? })),
            TAG_CHANGE_LIQUID_RHO_P_EFF => Ok(En1992Mutation::ChangeLiquidRhoPEff(ChangeLiquidRhoPEff { new_liquid_rho_p_eff: read_f64_bin(&mut reader).map_err(|e| malformed("new_liquid_rho_p_eff", reader.position(), e))? })),
            TAG_CHANGE_LIQUID_F_CT_EFF_MPA => Ok(En1992Mutation::ChangeLiquidFCtEffMpa(ChangeLiquidFCtEffMpa { new_liquid_f_ct_eff_mpa: read_f64_bin(&mut reader).map_err(|e| malformed("new_liquid_f_ct_eff_mpa", reader.position(), e))? })),
            TAG_CHANGE_LIQUID_ES_MPA => Ok(En1992Mutation::ChangeLiquidESMpa(ChangeLiquidESMpa { new_liquid_e_s_mpa: read_f64_bin(&mut reader).map_err(|e| malformed("new_liquid_e_s_mpa", reader.position(), e))? })),
            TAG_CHANGE_LIQUID_SR_MAX_MM => Ok(En1992Mutation::ChangeLiquidSRMaxMm(ChangeLiquidSRMaxMm { new_liquid_s_r_max_mm: read_f64_bin(&mut reader).map_err(|e| malformed("new_liquid_s_r_max_mm", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_H_EF_MM => Ok(En1992Mutation::ChangeAnchorHEfMm(ChangeAnchorHEfMm { new_anchor_h_ef_mm: read_f64_bin(&mut reader).map_err(|e| malformed("new_anchor_h_ef_mm", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_CRACKED => Ok(En1992Mutation::ChangeAnchorCracked(ChangeAnchorCracked { new_anchor_cracked: read_bool_bin(&mut reader).map_err(|e| malformed("new_anchor_cracked", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_F_UK_MPA => Ok(En1992Mutation::ChangeAnchorFUkMpa(ChangeAnchorFUkMpa { new_anchor_f_uk_mpa: read_f64_bin(&mut reader).map_err(|e| malformed("new_anchor_f_uk_mpa", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_F_YK_MPA => Ok(En1992Mutation::ChangeAnchorFYkMpa(ChangeAnchorFYkMpa { new_anchor_f_yk_mpa: read_f64_bin(&mut reader).map_err(|e| malformed("new_anchor_f_yk_mpa", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_AS_MM2 => Ok(En1992Mutation::ChangeAnchorASMm2(ChangeAnchorASMm2 { new_anchor_a_s_mm2: read_f64_bin(&mut reader).map_err(|e| malformed("new_anchor_a_s_mm2", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_D_MM => Ok(En1992Mutation::ChangeAnchorDMm(ChangeAnchorDMm { new_anchor_d_mm: read_f64_bin(&mut reader).map_err(|e| malformed("new_anchor_d_mm", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_C1_MM => Ok(En1992Mutation::ChangeAnchorC1Mm(ChangeAnchorC1Mm { new_anchor_c1_mm: read_f64_bin(&mut reader).map_err(|e| malformed("new_anchor_c1_mm", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_N_ED_KN => Ok(En1992Mutation::ChangeAnchorNEdKn(ChangeAnchorNEdKn { new_anchor_n_ed_kn: read_f64_bin(&mut reader).map_err(|e| malformed("new_anchor_n_ed_kn", reader.position(), e))? })),
            TAG_CHANGE_ANCHOR_V_ED_KN => Ok(En1992Mutation::ChangeAnchorVEdKn(ChangeAnchorVEdKn { new_anchor_v_ed_kn: read_f64_bin(&mut reader).map_err(|e| malformed("new_anchor_v_ed_kn", reader.position(), e))? })),
