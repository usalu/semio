...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-span-m/🌉️raises-span-m-to-7-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-span-m/🌉️raises-span-m-to-7-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-span-m/🌉️raises-span-m-to-7-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-span-m/🌉️raises-span-m-to-7-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-span-m/🌉️raises-span-m-to-7-5/🎯️outcome/🔣️.json");
...
async fn change_span_m_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
async fn change_span_m_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
async fn change_span_m_committed_json_is_canonical() {
...
#[semio_framework_async_macros::async_test]
async fn change_span_m_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
async fn change_span_m_produces_committed_diff() {
    let outcome = <En1992Mutation as protocol::Mutation<En1992Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
async fn change_span_m_committed_diff_applies_to_after() {
    let decoded: En1992Diff = serde_json::from_str(DIFF).expect("change-span-m committed diff decodes");
