...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱️change-liquid-f-ct-eff-mpa/🧱️raises-liquid-f-ct-eff-mpa-to-3-25/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱️change-liquid-f-ct-eff-mpa/🧱️raises-liquid-f-ct-eff-mpa-to-3-25/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱️change-liquid-f-ct-eff-mpa/🧱️raises-liquid-f-ct-eff-mpa-to-3-25/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱️change-liquid-f-ct-eff-mpa/🧱️raises-liquid-f-ct-eff-mpa-to-3-25/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱️change-liquid-f-ct-eff-mpa/🧱️raises-liquid-f-ct-eff-mpa-to-3-25/🎯️outcome/🔣️.json");
...
async fn change_liquid_f_ct_eff_mpa_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
async fn change_liquid_f_ct_eff_mpa_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
async fn change_liquid_f_ct_eff_mpa_committed_json_is_canonical() {
...
#[semio_framework_async_macros::async_test]
async fn change_liquid_f_ct_eff_mpa_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
async fn change_liquid_f_ct_eff_mpa_produces_committed_diff() {
    let outcome = <En1992Mutation as protocol::Mutation<En1992Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
async fn change_liquid_f_ct_eff_mpa_committed_diff_applies_to_after() {
    let decoded: En1992Diff = serde_json::from_str(DIFF).expect("change-liquid-f-ct-eff-mpa committed diff decodes");
