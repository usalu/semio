//! 🧪️ `change-liquid-sr-max-mm` fixture — `🕳️raises-liquid-s-r-max-mm-to-312-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1992Diff.liquid_s_r_max_mm` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-liquid-sr-max-mm/🕳️raises-liquid-s-r-max-mm-to-312-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-liquid-sr-max-mm/🕳️raises-liquid-s-r-max-mm-to-312-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-liquid-sr-max-mm/🕳️raises-liquid-s-r-max-mm-to-312-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-liquid-sr-max-mm/🕳️raises-liquid-s-r-max-mm-to-312-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-liquid-sr-max-mm/🕳️raises-liquid-s-r-max-mm-to-312-5/🎯️outcome/🔣️.json");
...
async fn change_liquid_sr_max_mm_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-liquid-sr-max-mm/raises-liquid-s-r-max-mm-to-312-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_liquid_sr_max_mm_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-liquid-sr-max-mm/raises-liquid-s-r-max-mm-to-312-5: the committed diff must leave the presence-lane selectedCheckIndex absent");
