...
use crate::artifacts::en1992::mutations::change_udl_kn_m::ChangeUdlKnM;
use crate::artifacts::en1992::En1992Snapshot;

//#region 🔖️Diff
pub fn diff(payload: &ChangeUdlKnM, base: &En1992Snapshot) -> protocol::MutationOutcome<En1992Diff> {
