//! 🧪️ `change-tightness-class` fixture — `💧️switches-tightness-class-to-tc2`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1992Diff.tightness_class` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-tightness-class/💧️switches-tightness-class-to-tc2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-tightness-class/💧️switches-tightness-class-to-tc2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-tightness-class/💧️switches-tightness-class-to-tc2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-tightness-class/💧️switches-tightness-class-to-tc2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-tightness-class/💧️switches-tightness-class-to-tc2/🎯️outcome/🔣️.json");
...
async fn change_tightness_class_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-tightness-class/switches-tightness-class-to-tc2: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_tightness_class_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-tightness-class/switches-tightness-class-to-tc2: the committed diff must leave the presence-lane selectedCheckIndex absent");
