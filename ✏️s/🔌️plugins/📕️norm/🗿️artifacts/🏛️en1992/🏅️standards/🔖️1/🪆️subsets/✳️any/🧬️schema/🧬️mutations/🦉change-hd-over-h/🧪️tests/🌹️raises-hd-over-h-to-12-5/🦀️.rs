//! 🧪️ `change-hd-over-h` fixture — `🌹️raises-hd-over-h-to-12-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1992Diff.hd_over_h` and nothing else,
...
fn change_hd_over_h_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-hd-over-h/raises-hd-over-h-to-12-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
