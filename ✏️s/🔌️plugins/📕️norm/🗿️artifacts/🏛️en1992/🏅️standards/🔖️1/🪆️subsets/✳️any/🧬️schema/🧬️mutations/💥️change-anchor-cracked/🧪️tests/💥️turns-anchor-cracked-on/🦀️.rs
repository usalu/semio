//! 🧪️ `change-anchor-cracked` fixture — `💥️turns-anchor-cracked-on`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1992Diff.anchor_cracked` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥️change-anchor-cracked/💥️turns-anchor-cracked-on/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥️change-anchor-cracked/💥️turns-anchor-cracked-on/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥️change-anchor-cracked/💥️turns-anchor-cracked-on/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥️change-anchor-cracked/💥️turns-anchor-cracked-on/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💥️change-anchor-cracked/💥️turns-anchor-cracked-on/🎯️outcome/🔣️.json");
...
async fn change_anchor_cracked_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-anchor-cracked/turns-anchor-cracked-on: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_anchor_cracked_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-anchor-cracked/turns-anchor-cracked-on: the committed diff must leave the presence-lane selectedCheckIndex absent");
