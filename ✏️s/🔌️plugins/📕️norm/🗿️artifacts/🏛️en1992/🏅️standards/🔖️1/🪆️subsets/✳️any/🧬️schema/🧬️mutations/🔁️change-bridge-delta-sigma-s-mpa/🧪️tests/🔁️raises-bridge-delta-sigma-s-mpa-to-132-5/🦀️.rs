//! 🧪️ `change-bridge-delta-sigma-s-mpa` fixture — `🔁️raises-bridge-delta-sigma-s-mpa-to-132-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1992Diff.bridge_delta_sigma_s_mpa` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-bridge-delta-sigma-s-mpa/🔁️raises-bridge-delta-sigma-s-mpa-to-132-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-bridge-delta-sigma-s-mpa/🔁️raises-bridge-delta-sigma-s-mpa-to-132-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-bridge-delta-sigma-s-mpa/🔁️raises-bridge-delta-sigma-s-mpa-to-132-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-bridge-delta-sigma-s-mpa/🔁️raises-bridge-delta-sigma-s-mpa-to-132-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-bridge-delta-sigma-s-mpa/🔁️raises-bridge-delta-sigma-s-mpa-to-132-5/🎯️outcome/🔣️.json");
...
async fn change_bridge_delta_sigma_s_mpa_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-bridge-delta-sigma-s-mpa/raises-bridge-delta-sigma-s-mpa-to-132-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_bridge_delta_sigma_s_mpa_committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-bridge-delta-sigma-s-mpa/raises-bridge-delta-sigma-s-mpa-to-132-5: the committed diff must leave the presence-lane selectedCheckIndex absent"
    );
