...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-anchor-n-ed-kn/🪝️raises-anchor-n-ed-kn-to-22-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-anchor-n-ed-kn/🪝️raises-anchor-n-ed-kn-to-22-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-anchor-n-ed-kn/🪝️raises-anchor-n-ed-kn-to-22-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-anchor-n-ed-kn/🪝️raises-anchor-n-ed-kn-to-22-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-anchor-n-ed-kn/🪝️raises-anchor-n-ed-kn-to-22-5/🎯️outcome/🔣️.json");
...
async fn change_anchor_n_ed_kn_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-anchor-n-ed-kn/raises-anchor-n-ed-kn-to-22-5: the committed diff must leave the presence-lane selectedCheckIndex absent");
