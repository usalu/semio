...
impl En1992Mutation {
    ...
    pub fn from_snapshot(snapshot: &En1992Snapshot) -> Vec<En1992Mutation> {
        ...
        mutations.push(En1992Mutation::ChangeAnnex(change_annex::ChangeAnnex { new_annex: snapshot.annex.clone() }));
...
#[path = "."]
mod fixture_tests {
    #[path = "🐞change-ac-mm2/🧪️tests/💎️raises-a-c-mm2-to-168750-0/🦀️.rs"]
    mod tests_change_a_c_mm2_raises;
    #[path = "🐍change-as-mm2/🧪️tests/🐺️raises-a-s-mm2-to-1608-5/🦀️.rs"]
    mod tests_change_a_s_mm2_raises;
    #[path = "🦋change-anchor-as-mm2/🧪️tests/🟪️raises-anchor-a-s-mm2-to-157-0/🦀️.rs"]
    mod tests_change_anchor_a_s_mm2_raises;
    #[path = "🐌change-anchor-c1-mm/🧪️tests/🦁️raises-anchor-c1-mm-to-137-5/🦀️.rs"]
    ...
    #[path = "🐳change-anchor-f-uk-mpa/🧪️tests/🛰️raises-anchor-f-uk-mpa-to-900-0/🦀️.rs"]
    ...
    #[path = "🦭change-anchor-h-ef-mm/🧪️tests/🐼️raises-anchor-h-ef-mm-to-105-0/🦀️.rs"]
    mod tests_change_anchor_h_ef_mm_raises;
    #[path = "🐊change-anchor-n-ed-kn/🧪️tests/🧿️raises-anchor-n-ed-kn-to-22-5/🦀️.rs"]
    mod tests_change_anchor_n_ed_kn_raises;
    #[path = "🦎change-anchor-v-ed-kn/🧪️tests/🟩️raises-anchor-v-ed-kn-to-11-25/🦀️.rs"]
    mod tests_change_anchor_v_ed_kn_raises;
    #[path = "🦂change-b-mm/🧪️tests/🌾️raises-b-mm-to-375-0/🦀️.rs"]
    mod tests_change_b_mm_raises;
    #[path = "🦟change-bridge-delta-sigma-s-mpa/🧪️tests/🔺️raises-bridge-delta-sigma-s-mpa-to-132-5/🦀️.rs"]
    mod tests_change_bridge_delta_sigma_s_mpa_raises;
    #[path = "🦗change-bridge-sigma-c-mpa/🧪️tests/🌉️raises-bridge-sigma-c-mpa-to-15-75/🦀️.rs"]
    ...
    #[path = "🐜change-f-ck/🧪️tests/🟫️raises-f-ck-to-45-0/🦀️.rs"]
    mod tests_change_f_ck_raises;
    #[path = "🦔change-f-yk/🧪️tests/🌴️raises-f-yk-to-550-0/🦀️.rs"]
    ...
    #[path = "🦉change-hd-over-h/🧪️tests/🌹️raises-hd-over-h-to-12-5/🦀️.rs"]
    mod tests_change_hd_over_h_raises;
    #[path = "🐴change-liquid-es-mpa/🧪️tests/🖱️raises-liquid-e-s-mpa-to-205000-0/🦀️.rs"]
    mod tests_change_liquid_e_s_mpa_raises;
    #[path = "🐎change-liquid-f-ct-eff-mpa/🧪️tests/🖱️raises-liquid-f-ct-eff-mpa-to-3-25/🦀️.rs"]
    mod tests_change_liquid_f_ct_eff_mpa_raises;
    #[path = "🦄change-liquid-rho-p-eff/🧪️tests/🖱️raises-liquid-rho-p-eff-to-0-0078125/🦀️.rs"]
    mod tests_change_liquid_rho_p_eff_raises;
    #[path = "🐐change-liquid-sr-max-mm/🧪️tests/🖱️raises-liquid-s-r-max-mm-to-312-5/🦀️.rs"]
    mod tests_change_liquid_s_r_max_mm_raises;
    #[path = "🐑change-liquid-sigma-s-mpa/🧪️tests/🖱️raises-liquid-sigma-s-mpa-to-235-5/🦀️.rs"]
    mod tests_change_liquid_sigma_s_mpa_raises;
    #[path = "🐮change-m-ed-knm/🧪️tests/🌱️raises-m-ed-knm-to-187-5/🦀️.rs"]
    mod tests_change_m_ed_knm_raises;
    #[path = "🐷change-n-ed-kn/🧪️tests/🐼️raises-n-ed-kn-to-62-5/🦀️.rs"]
    mod tests_change_n_ed_kn_raises;
    #[path = "🐗change-p-kn/🧪️tests/🛟️raises-p-kn-to-45-5/🦀️.rs"]
    mod tests_change_p_kn_raises;
    #[path = "🦌change-provided-axis-distance-mm/🧪️tests/🦁️raises-provided-axis-distance-mm-to-42-5/🦀️.rs"]
    mod tests_change_provided_axis_distance_mm_raises;
    #[path = "🐘change-rho-l/🧪️tests/⚪️raises-rho-l-to-0-015625/🦀️.rs"]
    mod tests_change_rho_l_raises;
    #[path = "🦏change-span-m/🧪️tests/🟨️raises-span-m-to-7-5/🦀️.rs"]
