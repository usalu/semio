//! 📤️ Export En1998Snapshot as .xlsx.

use semio_framework_plugin::{DocumentCodec, IoError, JsonCodec, MediaFormat};

//#region 🔖️Export
pub fn export(snapshot: &crate::artifacts::en1998::En1998Snapshot) -> Result<Vec<u8>, IoError> {
...
pub fn register() {
    ...
    semio_framework_os::register_os_media_export_handler(kind, format, move |doc| {
        let snapshot: crate::artifacts::en1998::En1998Snapshot =
