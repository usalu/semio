...
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.v_rd_kn` and nothing else,
...
fn change_v_rd_kn_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-v-rd-kn/raises-v-rd-kn-to-925-0: produced diff differs from the committed 🔺️diff/🔣️.json");
}
