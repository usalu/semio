...
async fn change_retrofit_limit_state_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_limit_state_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_limit_state_committed_json_is_canonical() {
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_limit_state_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_limit_state_produces_committed_diff() {
    let outcome = <En1998Mutation as protocol::Mutation<En1998Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_limit_state_committed_diff_is_canonical() {
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_limit_state_committed_diff_applies_to_after() {
    let decoded: En1998Diff = serde_json::from_str(DIFF).expect("change-retrofit-limit-state committed diff decodes");
