...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.foundation_p_rd_kpa` and nothing else,
...
async fn change_foundation_p_rd_kpa_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-foundation-p-rd-kpa/raises-foundation-p-rd-kpa-to-625-0: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
