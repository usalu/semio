/** ✏️ EN 1998 editor — subset-level typed twin. Mirrors the editor manifest's mode/
...
export const EN1998_EDITOR_DIALECT = { artifactKind: "s.norm.en1998", standard: "1", subset: "*" } as const;

export const EN1998_EDIT_MODE_ID = "edit" as const;
