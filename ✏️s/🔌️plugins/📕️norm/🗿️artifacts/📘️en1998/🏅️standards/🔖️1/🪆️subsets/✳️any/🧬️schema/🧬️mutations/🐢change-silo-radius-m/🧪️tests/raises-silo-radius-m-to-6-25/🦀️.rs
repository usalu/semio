...
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.silo_radius_m` and nothing else,
...
fn change_silo_radius_m_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-silo-radius-m/raises-silo-radius-m-to-6-25: produced diff differs from the committed 🔺️diff/🔣️.json");
}
