...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.silo_v_ed_kn` and nothing else,
...
fn change_silo_v_ed_kn_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-silo-v-ed-kn/raises-silo-v-ed-kn-to-225-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
