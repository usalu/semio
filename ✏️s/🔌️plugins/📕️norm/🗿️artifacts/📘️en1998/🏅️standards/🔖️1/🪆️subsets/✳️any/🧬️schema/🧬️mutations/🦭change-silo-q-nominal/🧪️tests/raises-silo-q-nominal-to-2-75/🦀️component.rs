//! 🧪️ `change-silo-q-nominal` fixture — `raises-silo-q-nominal-to-2-75`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.silo_q_nominal` and nothing else,
...
async fn change_silo_q_nominal_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-silo-q-nominal/raises-silo-q-nominal-to-2-75: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
