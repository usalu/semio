...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.period_ratio` and nothing else,
...
fn change_period_ratio_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-period-ratio/raises-period-ratio-to-3-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
