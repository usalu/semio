//! 🧪️ `change-seismic-zone` fixture — `raises-seismic-zone-to-4`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.seismic_zone` and nothing else,
...
async fn change_seismic_zone_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-seismic-zone/raises-seismic-zone-to-4: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
