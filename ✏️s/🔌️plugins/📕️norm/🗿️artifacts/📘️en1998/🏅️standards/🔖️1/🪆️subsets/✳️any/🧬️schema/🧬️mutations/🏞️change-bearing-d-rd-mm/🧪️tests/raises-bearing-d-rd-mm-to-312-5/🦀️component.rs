//! 🧪️ `change-bearing-d-rd-mm` fixture — `raises-bearing-d-rd-mm-to-312-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.bearing_d_rd_mm` and nothing else,
...
fn change_bearing_d_rd_mm_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-bearing-d-rd-mm/raises-bearing-d-rd-mm-to-312-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
