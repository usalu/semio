...
fn change_tower_m_ed_knm_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
fn change_tower_m_ed_knm_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
fn change_tower_m_ed_knm_committed_json_is_canonical() {
...
#[semio_framework_async_macros::async_test]
fn change_tower_m_ed_knm_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
fn change_tower_m_ed_knm_produces_committed_diff() {
    let outcome = <En1998Mutation as protocol::Mutation<En1998Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
fn change_tower_m_ed_knm_committed_diff_is_canonical() {
...
#[semio_framework_async_macros::async_test]
fn change_tower_m_ed_knm_committed_diff_applies_to_after() {
    let decoded: En1998Diff = serde_json::from_str(DIFF).expect("change-tower-m-ed-knm committed diff decodes");
