...
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.foundation_area_m2` and nothing else,
...
fn change_foundation_area_m2_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-foundation-area-m2/raises-foundation-area-m2-to-144-0: produced diff differs from the committed 🔺️diff/🔣️.json");
}
