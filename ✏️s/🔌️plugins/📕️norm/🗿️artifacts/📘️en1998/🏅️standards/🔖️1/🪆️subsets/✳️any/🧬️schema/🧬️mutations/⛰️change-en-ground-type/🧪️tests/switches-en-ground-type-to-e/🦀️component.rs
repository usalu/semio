...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.en_ground_type` and nothing else,
...
async fn change_en_ground_type_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-en-ground-type/switches-en-ground-type-to-e: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
