...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.en1998/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &En1998Command, _snapshot: &En1998Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<En1998Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<En1998PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<En1998PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<En1998PlayApp>;
...
impl ArtifactEditor for En1998PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📘️en1998/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
