...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.silo_height_m` and nothing else,
...
fn change_silo_height_m_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-silo-height-m/raises-silo-height-m-to-14-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
