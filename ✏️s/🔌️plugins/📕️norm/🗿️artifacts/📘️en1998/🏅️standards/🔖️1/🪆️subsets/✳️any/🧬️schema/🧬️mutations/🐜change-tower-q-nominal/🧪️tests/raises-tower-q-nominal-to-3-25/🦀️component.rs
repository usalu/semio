...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.tower_q_nominal` and nothing else,
...
fn change_tower_q_nominal_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-tower-q-nominal/raises-tower-q-nominal-to-3-25: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
