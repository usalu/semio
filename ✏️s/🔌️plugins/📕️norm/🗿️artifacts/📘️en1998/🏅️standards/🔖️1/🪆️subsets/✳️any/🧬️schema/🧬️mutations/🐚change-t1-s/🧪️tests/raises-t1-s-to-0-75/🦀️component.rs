...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.t1_s` and nothing else,
...
async fn change_t1_s_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-t1-s/raises-t1-s-to-0-75: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
