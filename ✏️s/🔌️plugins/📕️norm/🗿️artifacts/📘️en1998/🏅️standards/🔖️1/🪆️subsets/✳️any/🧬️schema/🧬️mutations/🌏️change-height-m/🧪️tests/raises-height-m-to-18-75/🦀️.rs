...
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.height_m` and nothing else,
...
fn change_height_m_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-height-m/raises-height-m-to-18-75: produced diff differs from the committed 🔺️diff/🔣️.json");
}
