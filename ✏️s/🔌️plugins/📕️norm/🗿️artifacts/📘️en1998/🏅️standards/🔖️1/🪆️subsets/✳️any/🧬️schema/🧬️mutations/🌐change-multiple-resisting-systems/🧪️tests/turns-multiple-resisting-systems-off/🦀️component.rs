...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.multiple_resisting_systems` and nothing else,
...
async fn change_multiple_resisting_systems_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-multiple-resisting-systems/turns-multiple-resisting-systems-off: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
