...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.tower_mass_t` and nothing else,
...
fn change_tower_mass_t_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-tower-mass-t/raises-tower-mass-t-to-112-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
