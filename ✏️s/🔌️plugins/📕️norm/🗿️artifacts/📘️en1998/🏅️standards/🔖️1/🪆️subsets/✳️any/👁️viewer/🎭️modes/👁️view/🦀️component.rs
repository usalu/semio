//! 👁️ EN 1998 viewer — the `view` mode: a single full-pane Report window, the read-only
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::en1998::create_en1998_viewer`.
