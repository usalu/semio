...
//! leaf's own `../../🔺️diff/🦀️component.rs`, which writes `En1998Diff.retrofit_r_k_kn` and nothing else,
...
async fn change_retrofit_rk_kn_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-retrofit-rk-kn/raises-retrofit-r-k-kn-to-512-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
