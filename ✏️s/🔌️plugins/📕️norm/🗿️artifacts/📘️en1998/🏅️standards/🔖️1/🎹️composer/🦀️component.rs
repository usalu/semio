//! 🎹️ En1998Composer (1 standard) — aggregates its subsets' composer entries value-level. W5a
...
//! history) — a fabricated shape, not a real codec. Only the native `s.en1998` entry remains.
...
pub fn entries() -> &'static [ComposerEntry] {
    ENTRIES.get_or_init(|| vec![
        composer_entry_of::<En1998AnyComposer>(),
    ]).as_slice()
}
