...
//#region 🔖️Constants
pub const BODY_INSPECTION: &str = "norm.vdi3805.play.inspection";
...
//#region 🔖️Render
pub fn render(host: &NormHost<Vdi3805Family>, selected_check_index: Option<u32>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
...
mod tests {
    ...
    fn an_out_of_range_selected_index_falls_back_to_the_first_check() {
        let host = NormHost::<Vdi3805Family>::from_document(crate::artifacts::vdi3805::Vdi3805Snapshot::default());
