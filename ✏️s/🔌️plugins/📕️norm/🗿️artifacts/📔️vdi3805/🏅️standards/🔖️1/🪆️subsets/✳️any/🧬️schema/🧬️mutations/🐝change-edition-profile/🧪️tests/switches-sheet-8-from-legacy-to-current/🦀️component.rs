//! 🧪️ `change-edition-profile` fixture — `switches-sheet-8-from-legacy-to-current`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-edition-profile/switches-sheet-8-from-legacy-to-current: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
