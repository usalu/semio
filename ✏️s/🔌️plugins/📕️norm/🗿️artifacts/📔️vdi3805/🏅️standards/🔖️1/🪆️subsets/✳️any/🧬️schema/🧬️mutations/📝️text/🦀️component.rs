...
//#region 🔖️OpText
async fn print_vdi3805_mutation(mutation: &Vdi3805Mutation) -> String {
    match mutation {
...
async fn parse_vdi3805_mutation(line: &str) -> Result<Vdi3805Mutation, String> {
...
#[cfg(test)]
pub(crate) async fn demo_mutation_cases() -> Vec<Vdi3805Mutation> {
