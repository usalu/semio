...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-geometry-parameters/rescales-geom-valve-50-to-half-and-adds-clearance: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
