...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-curve-points/resamples-curve-kvs-onto-three-points: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
