...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.vdi3805/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &Vdi3805Command, _snapshot: &Vdi3805Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<Vdi3805Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<Vdi3805PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<Vdi3805PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<Vdi3805PlayApp>;
...
impl ArtifactEditor for Vdi3805PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        owner: semio_framework_plugin::EditorApp<Vdi3805PlayApp>,
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📔️vdi3805/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
        controller: "s.norm.vdi3805@1/*#editor",
        document_schema: "semio.norm.vdi3805/v1",
...
pub(crate) mod testkit {
    ...
    pub fn vdi3805_manifest_for_testkit() -> semio_framework_plugin::App {
