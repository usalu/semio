//! 🧪️ `delete-curve` fixture — `removes-the-curve-kvs-flow-curve`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-curve/removes-the-curve-kvs-flow-curve: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
