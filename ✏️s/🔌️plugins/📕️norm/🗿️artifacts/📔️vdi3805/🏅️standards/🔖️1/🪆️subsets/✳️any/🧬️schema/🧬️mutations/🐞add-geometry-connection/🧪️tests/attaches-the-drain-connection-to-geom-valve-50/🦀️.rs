...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "add-geometry-connection/attaches-the-drain-connection-to-geom-valve-50: produced diff differs from the committed 🔺️diff/🔣️.json");
}
