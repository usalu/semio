...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-product/retitles-vlv-50-001-and-resyncs-its-index-tags: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
