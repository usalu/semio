//! 🧪️ `update-manufacturer-file` fixture — `renames-the-header-manufacturer-to-acme`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-manufacturer-file/renames-the-header-manufacturer-to-acme: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
