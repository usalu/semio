...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-product-configuration/reparameterises-vlv-50-001-to-dn-80-and-resyncs-index-dn: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
