...
pub struct Vdi3805Diff {
    ...
    #[state(persistent)] pub manufacturer_file: Option<String>,
    #[state(persistent)] pub catalog: Option<String>,
    #[state(persistent)] pub edition_profile: Option<BTreeMap<String, EditionProfileChoice>>,
    #[state(persistent)] pub correction_as_of: Option<String>,
    #[state(persistent)] pub strict_mode: Option<bool>,
    #[state(persistent)] pub index: Option<String>,
    ...
    #[state(persistent)] pub limits: Option<String>,
