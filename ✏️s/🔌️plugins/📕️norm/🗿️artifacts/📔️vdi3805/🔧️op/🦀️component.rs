...
/// 📦️ VCS envelope/store aliases for the VDI 3805 document, now that `Document`/`Operation` both
...
mod tests {
    ...
    fn set_document_operation_op_text_round_trips_for_vdi3805() {
        store::test_support::assert_op_line_round_trip(&Operation::SetDocument { document: crate::artifacts::vdi3805::reference_fixture() });
    }
}
