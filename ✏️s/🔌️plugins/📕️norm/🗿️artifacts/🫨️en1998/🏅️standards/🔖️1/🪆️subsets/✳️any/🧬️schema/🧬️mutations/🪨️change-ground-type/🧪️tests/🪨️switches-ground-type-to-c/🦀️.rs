//! 🪨️ `change-ground-type` fixture — `🪨️switches-ground-type-to-c`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪨️change-ground-type/🪨️switches-ground-type-to-c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪨️change-ground-type/🪨️switches-ground-type-to-c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪨️change-ground-type/🪨️switches-ground-type-to-c/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪨️change-ground-type/🪨️switches-ground-type-to-c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪨️change-ground-type/🪨️switches-ground-type-to-c/🎯️outcome/🔣️.json");
...
async fn change_ground_type_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-ground-type/switches-ground-type-to-c: the committed diff must leave the presence-lane selectedCheckIndex absent");
