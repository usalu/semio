//! 🧪️ `change-foundation-h-ed-kn` fixture — `➡️raises-foundation-h-ed-kn-to-212-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.foundation_h_ed_kn` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➡️change-foundation-h-ed-kn/➡️raises-foundation-h-ed-kn-to-212-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➡️change-foundation-h-ed-kn/➡️raises-foundation-h-ed-kn-to-212-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➡️change-foundation-h-ed-kn/➡️raises-foundation-h-ed-kn-to-212-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➡️change-foundation-h-ed-kn/➡️raises-foundation-h-ed-kn-to-212-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➡️change-foundation-h-ed-kn/➡️raises-foundation-h-ed-kn-to-212-5/🎯️outcome/🔣️.json");
...
async fn change_foundation_h_ed_kn_committed_json_is_canonical() {
    ...
    assert_eq!(reencoded, original, "change-foundation-h-ed-kn/raises-foundation-h-ed-kn-to-212-5: committed mutation JSON is not the canonical internally-tagged ChangeFoundationHEdKn form carrying mutation and newFoundationHEdKn");
}
...
async fn change_foundation_h_ed_kn_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-foundation-h-ed-kn/raises-foundation-h-ed-kn-to-212-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_foundation_h_ed_kn_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-foundation-h-ed-kn/raises-foundation-h-ed-kn-to-212-5: the committed diff must leave the presence-lane selectedCheckIndex absent");
