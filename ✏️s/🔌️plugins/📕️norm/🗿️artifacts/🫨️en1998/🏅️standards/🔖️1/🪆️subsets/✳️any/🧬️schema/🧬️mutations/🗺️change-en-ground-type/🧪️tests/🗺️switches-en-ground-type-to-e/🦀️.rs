//! 🗺️ `change-en-ground-type` fixture — `🗺️switches-en-ground-type-to-e`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️change-en-ground-type/🗺️switches-en-ground-type-to-e/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️change-en-ground-type/🗺️switches-en-ground-type-to-e/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️change-en-ground-type/🗺️switches-en-ground-type-to-e/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️change-en-ground-type/🗺️switches-en-ground-type-to-e/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️change-en-ground-type/🗺️switches-en-ground-type-to-e/🎯️outcome/🔣️.json");
...
async fn change_en_ground_type_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
async fn change_en_ground_type_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
async fn change_en_ground_type_committed_json_is_canonical() {
    ...
    assert_eq!(reencoded, original, "change-en-ground-type/switches-en-ground-type-to-e: committed mutation JSON is not the canonical internally-tagged ChangeEnGroundType form carrying mutation and newEnGroundType");
}

/// 🎯️ The declared outcome holds: `change-en-ground-type` at e is applied, not rejected, and carries no
/// diagnostic of its own.
#[semio_framework_async_macros::async_test]
async fn change_en_ground_type_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
async fn change_en_ground_type_produces_committed_diff() {
    let outcome = <En1998Mutation as protocol::Mutation<En1998Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
async fn change_en_ground_type_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-en-ground-type/switches-en-ground-type-to-e: the committed diff must leave the presence-lane selectedCheckIndex absent");
...
#[semio_framework_async_macros::async_test]
async fn change_en_ground_type_committed_diff_applies_to_after() {
    let decoded: En1998Diff = serde_json::from_str(DIFF).expect("change-en-ground-type committed diff decodes");
