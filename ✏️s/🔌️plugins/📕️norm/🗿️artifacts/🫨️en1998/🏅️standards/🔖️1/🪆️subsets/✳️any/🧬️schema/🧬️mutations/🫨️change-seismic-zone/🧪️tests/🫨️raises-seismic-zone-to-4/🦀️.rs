...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫨️change-seismic-zone/🫨️raises-seismic-zone-to-4/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫨️change-seismic-zone/🫨️raises-seismic-zone-to-4/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫨️change-seismic-zone/🫨️raises-seismic-zone-to-4/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫨️change-seismic-zone/🫨️raises-seismic-zone-to-4/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫨️change-seismic-zone/🫨️raises-seismic-zone-to-4/🎯️outcome/🔣️.json");
...
async fn change_seismic_zone_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-seismic-zone/raises-seismic-zone-to-4: the committed diff must leave the presence-lane selectedCheckIndex absent");
