//! Named apply/inverse test for `insert-retaining-wall`.
use protocol::{Mutation, MutationDiff};

#[semio_framework_async_macros::async_test]
async fn applies_insert_retaining_wall() {
    ...
    let mutation = crate::mutations::text::demo_mutation_cases()
        ...
        .find(|m| {
            ...
            dbg.contains("insert-retaining-wall") || dbg.contains("insertretainingwall")
        })
