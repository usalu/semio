...
Feature: Apply every typed EN 1998 mutation against an independent Python implementation
  ...
  Scenario Outline: Apply <id> to its committed specification vector
    ...
    Examples:
      | id                                | dir                                | fixture                                        |
      | change-seismic-zone               | 🫨️change-seismic-zone               | raises-seismic-zone-to-4                       |
      | change-ground-type                | 🪨️change-ground-type                | switches-ground-type-to-c                      |
      | change-importance-class           | 🏛️change-importance-class           | switches-importance-class-to-cc3               |
      | change-structural-system          | 🏗️change-structural-system          | switches-structural-system-to-wall-dcm         |
      | change-t1-s                       | 🕐️change-t1-s                       | raises-t1-s-to-0-75                            |
      | change-mass-t                     | ⚖️change-mass-t                     | raises-mass-t-to-812-5                         |
      ...
      | change-multiple-resisting-systems | 🕸️change-multiple-resisting-systems | turns-multiple-resisting-systems-off           |
      ...
      | change-retrofit-limit-state       | 🚦️change-retrofit-limit-state       | switches-retrofit-limit-state-to-near-collapse |
      | change-retrofit-ed-kn             | 📥️change-retrofit-ed-kn             | raises-retrofit-e-d-kn-to-337-5                |
      | change-retrofit-rk-kn             | 💪️change-retrofit-rk-kn             | raises-retrofit-r-k-kn-to-512-5                |
      | change-retrofit-gamma-el          | ✖️change-retrofit-gamma-el          | raises-retrofit-gamma-el-to-1-25               |
      | change-silo-height-m              | 🌾️change-silo-height-m              | raises-silo-height-m-to-14-5                   |
      | change-silo-radius-m              | ⭕️change-silo-radius-m              | raises-silo-radius-m-to-6-25                   |
      | change-silo-n-rd-kn               | 🗜️change-silo-n-rd-kn               | raises-silo-n-rd-kn-to-640-0                   |
      | change-silo-v-ed-kn               | 📉️change-silo-v-ed-kn               | raises-silo-v-ed-kn-to-225-5                   |
      | change-silo-v-rd-kn               | 🚧️change-silo-v-rd-kn               | raises-silo-v-rd-kn-to-412-5                   |
      | change-silo-q-nominal             | 📊️change-silo-q-nominal             | raises-silo-q-nominal-to-2-75                  |
      | change-tank-height-m              | 🛢️change-tank-height-m              | raises-tank-height-m-to-11-5                   |
      | change-tank-radius-m              | 🥁️change-tank-radius-m              | raises-tank-radius-m-to-5-75                   |
      | change-tank-mass-t                | ⚓️change-tank-mass-t                | raises-tank-mass-t-to-425-0                    |
      | change-tank-v-rd-kn               | 🔰️change-tank-v-rd-kn               | raises-tank-v-rd-kn-to-537-5                   |
      | change-tower-m-ed-knm             | ↪️change-tower-m-ed-knm             | raises-tower-m-ed-knm-to-1562-5                |
      | change-tower-m-rd-knm             | 🦾️change-tower-m-rd-knm             | raises-tower-m-rd-knm-to-2812-5                |
      | change-tower-is-chimney           | 🏭️change-tower-is-chimney          | turns-tower-is-chimney-off                     |
      | change-tower-q-nominal            | 💨️change-tower-q-nominal            | raises-tower-q-nominal-to-3-25                 |
      | change-tower-mass-t               | 🗼️change-tower-mass-t               | raises-tower-mass-t-to-112-5                   |
      | change-foundation-area-m2         | 🔲️change-foundation-area-m2         | raises-foundation-area-m2-to-144-0             |
      | change-foundation-p-rd-kpa        | 👇️change-foundation-p-rd-kpa        | raises-foundation-p-rd-kpa-to-625-0            |
      | change-foundation-h-ed-kn         | ➡️change-foundation-h-ed-kn         | raises-foundation-h-ed-kn-to-212-5             |
      | change-foundation-h-rd-kn         | 🧲️change-foundation-h-rd-kn         | raises-foundation-h-rd-kn-to-475-0             |
      | change-k-foundation               | 🌀️change-k-foundation               | raises-k-foundation-to-640000-0                |
      | change-k-soil                     | 🌱️change-k-soil                     | raises-k-soil-to-262500-0                      |
      | change-wall-height-m              | 🧱️change-wall-height-m              | raises-wall-height-m-to-5-5                    |
      | change-wall-phi-deg               | 📐️change-wall-phi-deg               | raises-wall-phi-deg-to-37-5                    |
      | change-wall-soil-gamma-kn-m3      | 🧂️change-wall-soil-gamma-kn-m3      | raises-wall-soil-gamma-kn-m3-to-20-5           |
      | change-wall-r                     | 🔢️change-wall-r                     | raises-wall-r-to-2-25                          |
      | change-wall-h-rd-kn               | 🏋️change-wall-h-rd-kn               | raises-wall-h-rd-kn-to-187-5                   |
