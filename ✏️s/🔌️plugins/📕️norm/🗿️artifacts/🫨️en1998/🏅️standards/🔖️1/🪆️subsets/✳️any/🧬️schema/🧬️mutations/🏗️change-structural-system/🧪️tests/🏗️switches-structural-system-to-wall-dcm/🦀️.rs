//! 🏗️ `change-structural-system` fixture — `🏗️switches-structural-system-to-wall-dcm`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.structural_system` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-structural-system/🏗️switches-structural-system-to-wall-dcm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-structural-system/🏗️switches-structural-system-to-wall-dcm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-structural-system/🏗️switches-structural-system-to-wall-dcm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-structural-system/🏗️switches-structural-system-to-wall-dcm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-structural-system/🏗️switches-structural-system-to-wall-dcm/🎯️outcome/🔣️.json");
...
async fn change_structural_system_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-structural-system/switches-structural-system-to-wall-dcm: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_structural_system_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-structural-system/switches-structural-system-to-wall-dcm: the committed diff must leave the presence-lane selectedCheckIndex absent");
