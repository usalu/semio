...
use crate::mutations::change_retrofit_gamma_el::ChangeRetrofitGammaEl;
...
pub fn inverse(_payload: &ChangeRetrofitGammaEl, base: &En1998Snapshot) -> Vec<En1998Mutation> {
    vec![En1998Mutation::ChangeRetrofitGammaEl(ChangeRetrofitGammaEl { new_retrofit_gamma_el: base.retrofit_gamma_el })]
}
//#endregion 🔖️Inverse
