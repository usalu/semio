...
pub fn handle(_payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, En1998Snapshot>, _cfg: &ConfigView<'_, NoConfig>) -> Result<Emit<En1998Mutation, NoConfigMutation>, Fault> {
    Ok(Emit::default())
}
//#endregion 🔖️Handler
