//! Named apply/inverse test for `change-building-plan-regular`.
use protocol::{Mutation, MutationDiff};

#[semio_framework_async_macros::async_test]
async fn applies_change_building_plan_regular() {
    ...
    let mutation = crate::mutations::text::demo_mutation_cases()
        ...
        .find(|m| {
            ...
            dbg.contains("change-building-plan-regular") || dbg.contains("changebuildingplanregular")
        })
