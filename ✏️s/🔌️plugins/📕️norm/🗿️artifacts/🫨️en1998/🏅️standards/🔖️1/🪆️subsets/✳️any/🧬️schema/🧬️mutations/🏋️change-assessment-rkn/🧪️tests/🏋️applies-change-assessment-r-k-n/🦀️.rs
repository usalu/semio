//! Named apply/inverse test for `change-assessment-rkn`.
use protocol::{Mutation, MutationDiff};

#[semio_framework_async_macros::async_test]
async fn applies_change_assessment_rkn() {
    ...
    let mutation = crate::mutations::text::demo_mutation_cases()
        ...
        .find(|m| {
            ...
            dbg.contains("change-assessment-rkn") || dbg.contains("changeassessmentrkn")
        })
