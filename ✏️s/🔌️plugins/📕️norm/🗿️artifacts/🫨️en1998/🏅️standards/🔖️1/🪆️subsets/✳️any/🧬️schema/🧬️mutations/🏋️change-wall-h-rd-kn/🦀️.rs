...
impl protocol::MutationKind<En1998Snapshot, En1998Mutation> for ChangeWallHRdKn {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change wall horizontal resistance H_Rd [kN] to {}", self.new_wall_h_rd_kn), &format!("Horizontaltragfähigkeit der Wand H_Rd [kN] auf {} ändern", self.new_wall_h_rd_kn))
    }
}
