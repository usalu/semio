//! 🚦️ `change-retrofit-limit-state` fixture — `🚦️switches-retrofit-limit-state-to-near-collapse`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/🎯️outcome/🔣️.json");
...
async fn change_retrofit_limit_state_committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-retrofit-limit-state/switches-retrofit-limit-state-to-near-collapse: the committed diff must leave the presence-lane selectedCheckIndex absent"
    );
