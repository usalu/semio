...
//#region 🔖️Artifact
/// 🧬️ EN 1998 document artifact state.
...
impl En1998Artifact {
    pub fn to_snapshot(&self) -> En1998Snapshot {
        En1998Snapshot {
            ...
            t1_s: self.t1_s,
            mass_t: self.mass_t,
            v_rd_kn: self.v_rd_kn,
            drift_mm: self.drift_mm,
            height_m: self.height_m,
            multiple_resisting_systems: self.multiple_resisting_systems,
            annex: self.annex.clone(),
            en_a_gr: self.en_a_gr,
            en_ground_type: self.en_ground_type.clone(),
            en_spectrum_type: self.en_spectrum_type.clone(),
            period_ratio: self.period_ratio,
            bridge_v_rd_kn: self.bridge_v_rd_kn,
            bearing_d_ed_mm: self.bearing_d_ed_mm,
            bearing_d_rd_mm: self.bearing_d_rd_mm,
            retrofit_knowledge_level: self.retrofit_knowledge_level.clone(),
            retrofit_limit_state: self.retrofit_limit_state.clone(),
            retrofit_e_d_kn: self.retrofit_e_d_kn,
            retrofit_r_k_kn: self.retrofit_r_k_kn,
            retrofit_gamma_el: self.retrofit_gamma_el,
            silo_height_m: self.silo_height_m,
            silo_radius_m: self.silo_radius_m,
            silo_n_rd_kn: self.silo_n_rd_kn,
            silo_v_ed_kn: self.silo_v_ed_kn,
            silo_v_rd_kn: self.silo_v_rd_kn,
            silo_q_nominal: self.silo_q_nominal,
            tank_height_m: self.tank_height_m,
            tank_radius_m: self.tank_radius_m,
            tank_mass_t: self.tank_mass_t,
            tank_v_rd_kn: self.tank_v_rd_kn,
            tower_m_ed_knm: self.tower_m_ed_knm,
            tower_m_rd_knm: self.tower_m_rd_knm,
            tower_is_chimney: self.tower_is_chimney,
            tower_q_nominal: self.tower_q_nominal,
            tower_mass_t: self.tower_mass_t,
            foundation_area_m2: self.foundation_area_m2,
            foundation_p_rd_kpa: self.foundation_p_rd_kpa,
            foundation_h_ed_kn: self.foundation_h_ed_kn,
            foundation_h_rd_kn: self.foundation_h_rd_kn,
            k_foundation: self.k_foundation,
            k_soil: self.k_soil,
            wall_height_m: self.wall_height_m,
            wall_phi_deg: self.wall_phi_deg,
            wall_soil_gamma_kn_m3: self.wall_soil_gamma_kn_m3,
            wall_r: self.wall_r,
            wall_h_rd_kn: self.wall_h_rd_kn,
        }
    }
