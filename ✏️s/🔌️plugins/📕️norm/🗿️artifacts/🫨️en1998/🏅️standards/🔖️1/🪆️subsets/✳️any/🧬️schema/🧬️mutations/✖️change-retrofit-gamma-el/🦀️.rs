...
impl protocol::MutationKind<En1998Snapshot, En1998Mutation> for ChangeRetrofitGammaEl {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change retrofit confidence factor gamma_el to {}", self.new_retrofit_gamma_el), &format!("Konfidenzbeiwert der Ertüchtigung gamma_el auf {} ändern", self.new_retrofit_gamma_el))
    }
}
