//! 🧪️ `change-foundation-area-m2` fixture — `🔲️raises-foundation-area-m2-to-144-0`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔲️change-foundation-area-m2/🔲️raises-foundation-area-m2-to-144-0/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔲️change-foundation-area-m2/🔲️raises-foundation-area-m2-to-144-0/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔲️change-foundation-area-m2/🔲️raises-foundation-area-m2-to-144-0/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔲️change-foundation-area-m2/🔲️raises-foundation-area-m2-to-144-0/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔲️change-foundation-area-m2/🔲️raises-foundation-area-m2-to-144-0/🎯️outcome/🔣️.json");
...
async fn change_foundation_area_m2_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-foundation-area-m2/raises-foundation-area-m2-to-144-0: the committed diff must leave the presence-lane selectedCheckIndex absent");
