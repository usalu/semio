//! ✖️ `change-retrofit-gamma-el` fixture — `✖️raises-retrofit-gamma-el-to-1-25`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.retrofit_gamma_el` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-retrofit-gamma-el/✖️raises-retrofit-gamma-el-to-1-25/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-retrofit-gamma-el/✖️raises-retrofit-gamma-el-to-1-25/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-retrofit-gamma-el/✖️raises-retrofit-gamma-el-to-1-25/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-retrofit-gamma-el/✖️raises-retrofit-gamma-el-to-1-25/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-retrofit-gamma-el/✖️raises-retrofit-gamma-el-to-1-25/🎯️outcome/🔣️.json");
...
async fn change_retrofit_gamma_el_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-retrofit-gamma-el/raises-retrofit-gamma-el-to-1-25: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_retrofit_gamma_el_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-retrofit-gamma-el/raises-retrofit-gamma-el-to-1-25: the committed diff must leave the presence-lane selectedCheckIndex absent");
