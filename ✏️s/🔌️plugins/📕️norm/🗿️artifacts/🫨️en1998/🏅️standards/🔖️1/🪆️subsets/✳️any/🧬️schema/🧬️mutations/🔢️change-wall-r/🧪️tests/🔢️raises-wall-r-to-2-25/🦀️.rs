...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-wall-r/🔢️raises-wall-r-to-2-25/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-wall-r/🔢️raises-wall-r-to-2-25/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-wall-r/🔢️raises-wall-r-to-2-25/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-wall-r/🔢️raises-wall-r-to-2-25/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-wall-r/🔢️raises-wall-r-to-2-25/🎯️outcome/🔣️.json");
...
async fn change_wall_r_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-wall-r/raises-wall-r-to-2-25: the committed diff must leave the presence-lane selectedCheckIndex absent");
