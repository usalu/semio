//! 🕸️ `change-multiple-resisting-systems` fixture — `🕸️turns-multiple-resisting-systems-off`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/🎯️outcome/🔣️.json");
...
async fn change_multiple_resisting_systems_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-multiple-resisting-systems/turns-multiple-resisting-systems-off: the committed diff must leave the presence-lane selectedCheckIndex absent");
