//! 🏛️ `change-importance-class` fixture — `🏛️switches-importance-class-to-cc3`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.importance_class` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️change-importance-class/🏛️switches-importance-class-to-cc3/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️change-importance-class/🏛️switches-importance-class-to-cc3/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️change-importance-class/🏛️switches-importance-class-to-cc3/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️change-importance-class/🏛️switches-importance-class-to-cc3/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️change-importance-class/🏛️switches-importance-class-to-cc3/🎯️outcome/🔣️.json");
...
async fn change_importance_class_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-importance-class/switches-importance-class-to-cc3: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_importance_class_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-importance-class/switches-importance-class-to-cc3: the committed diff must leave the presence-lane selectedCheckIndex absent");
