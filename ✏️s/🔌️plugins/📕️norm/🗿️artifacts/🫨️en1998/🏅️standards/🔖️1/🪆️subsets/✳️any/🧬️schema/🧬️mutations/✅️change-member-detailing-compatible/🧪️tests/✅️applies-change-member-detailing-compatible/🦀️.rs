//! Named apply/inverse test for `change-member-detailing-compatible`.
use protocol::{Mutation, MutationDiff};

#[semio_framework_async_macros::async_test]
async fn applies_change_member_detailing_compatible() {
    ...
    let mutation = crate::mutations::text::demo_mutation_cases()
        ...
        .find(|m| {
            ...
            dbg.contains("change-member-detailing-compatible") || dbg.contains("changememberdetailingcompatible")
        })
