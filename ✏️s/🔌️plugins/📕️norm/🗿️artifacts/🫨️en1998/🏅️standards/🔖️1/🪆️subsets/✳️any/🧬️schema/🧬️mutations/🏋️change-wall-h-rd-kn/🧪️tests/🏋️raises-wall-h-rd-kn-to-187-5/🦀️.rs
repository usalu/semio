...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-wall-h-rd-kn/🏋️raises-wall-h-rd-kn-to-187-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-wall-h-rd-kn/🏋️raises-wall-h-rd-kn-to-187-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-wall-h-rd-kn/🏋️raises-wall-h-rd-kn-to-187-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-wall-h-rd-kn/🏋️raises-wall-h-rd-kn-to-187-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-wall-h-rd-kn/🏋️raises-wall-h-rd-kn-to-187-5/🎯️outcome/🔣️.json");
...
async fn change_wall_h_rd_kn_committed_json_is_canonical() {
    ...
    assert_eq!(reencoded, original, "change-wall-h-rd-kn/raises-wall-h-rd-kn-to-187-5: committed mutation JSON is not the canonical internally-tagged ChangeWallHRdKn form carrying mutation and newWallHRdKn");
}
