//! 🎓️ `change-retrofit-knowledge-level` fixture — `🎓️switches-retrofit-knowledge-level-to-kl3`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/🎯️outcome/🔣️.json");
...
async fn change_retrofit_knowledge_level_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_knowledge_level_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_knowledge_level_committed_json_is_canonical() {
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_knowledge_level_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_knowledge_level_produces_committed_diff() {
    let outcome = <En1998Mutation as protocol::Mutation<En1998Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_knowledge_level_committed_diff_is_canonical() {
    ...
    assert!(
        ...
        "change-retrofit-knowledge-level/switches-retrofit-knowledge-level-to-kl3: the committed diff must leave the presence-lane selectedCheckIndex absent"
    );
...
#[semio_framework_async_macros::async_test]
async fn change_retrofit_knowledge_level_committed_diff_applies_to_after() {
    let decoded: En1998Diff = serde_json::from_str(DIFF).expect("change-retrofit-knowledge-level committed diff decodes");
