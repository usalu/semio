//! Named apply/inverse test for `change-storey-drift-xm`.
use protocol::{Mutation, MutationDiff};

#[semio_framework_async_macros::async_test]
async fn applies_change_storey_drift_xm() {
    ...
    let mutation = crate::mutations::text::demo_mutation_cases()
        ...
        .find(|m| {
            ...
            dbg.contains("change-storey-drift-xm") || dbg.contains("changestoreydriftxm")
        })
