//! ↔️ `change-drift-mm` fixture — `↔️raises-drift-mm-to-33-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.drift_mm` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-drift-mm/↔️raises-drift-mm-to-33-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-drift-mm/↔️raises-drift-mm-to-33-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-drift-mm/↔️raises-drift-mm-to-33-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-drift-mm/↔️raises-drift-mm-to-33-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-drift-mm/↔️raises-drift-mm-to-33-5/🎯️outcome/🔣️.json");
...
async fn change_drift_mm_committed_json_is_canonical() {
    ...
    assert_eq!(reencoded, original, "change-drift-mm/raises-drift-mm-to-33-5: committed mutation JSON is not the canonical internally-tagged ChangeDriftMm form carrying mutation and newDriftMm");
}
...
async fn change_drift_mm_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-drift-mm/raises-drift-mm-to-33-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_drift_mm_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-drift-mm/raises-drift-mm-to-33-5: the committed diff must leave the presence-lane selectedCheckIndex absent");
