...
use crate::mutations::change_foundation_h_rd_kn::ChangeFoundationHRdKn;
...
pub fn diff(payload: &ChangeFoundationHRdKn, base: &En1998Snapshot) -> protocol::MutationOutcome<En1998Diff> {
    ...
    protocol::MutationOutcome::new(En1998Diff { foundation_h_rd_kn: Some(payload.new_foundation_h_rd_kn), ..Default::default() })
}
//#endregion 🔖️Diff
