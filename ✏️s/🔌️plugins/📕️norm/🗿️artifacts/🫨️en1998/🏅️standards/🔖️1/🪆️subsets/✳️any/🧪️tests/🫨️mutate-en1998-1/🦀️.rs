...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str, &'static str) {
    match kind {
        ...
        "change-multiple-resisting-systems" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🕸️change-multiple-resisting-systems/🕸️turns-multiple-resisting-systems-off/🎯️outcome/🔣️.json"),
        ),
        "change-annex" => (
        ...
        "change-retrofit-knowledge-level" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎓️change-retrofit-knowledge-level/🎓️switches-retrofit-knowledge-level-to-kl3/🎯️outcome/🔣️.json"),
        ),
        "change-retrofit-limit-state" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/📸️snapshot/➡️after/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🚦️change-retrofit-limit-state/🚦️switches-retrofit-limit-state-to-near-collapse/🎯️outcome/🔣️.json"),
        ),
        "change-retrofit-ed-kn" => (
