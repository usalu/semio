//! 🧪️ `change-tank-v-rd-kn` fixture — `🔰️raises-tank-v-rd-kn-to-537-5`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔰️change-tank-v-rd-kn/🔰️raises-tank-v-rd-kn-to-537-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔰️change-tank-v-rd-kn/🔰️raises-tank-v-rd-kn-to-537-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔰️change-tank-v-rd-kn/🔰️raises-tank-v-rd-kn-to-537-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔰️change-tank-v-rd-kn/🔰️raises-tank-v-rd-kn-to-537-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔰️change-tank-v-rd-kn/🔰️raises-tank-v-rd-kn-to-537-5/🎯️outcome/🔣️.json");
...
async fn change_tank_v_rd_kn_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-tank-v-rd-kn/raises-tank-v-rd-kn-to-537-5: the committed diff must leave the presence-lane selectedCheckIndex absent");
