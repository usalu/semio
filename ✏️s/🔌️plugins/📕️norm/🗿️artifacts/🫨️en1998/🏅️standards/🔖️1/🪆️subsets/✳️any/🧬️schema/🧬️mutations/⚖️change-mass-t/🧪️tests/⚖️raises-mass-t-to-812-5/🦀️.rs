...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-mass-t/⚖️raises-mass-t-to-812-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-mass-t/⚖️raises-mass-t-to-812-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-mass-t/⚖️raises-mass-t-to-812-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-mass-t/⚖️raises-mass-t-to-812-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚖️change-mass-t/⚖️raises-mass-t-to-812-5/🎯️outcome/🔣️.json");
...
async fn change_mass_t_committed_json_is_canonical() {
    ...
    assert_eq!(reencoded, original, "change-mass-t/raises-mass-t-to-812-5: committed mutation JSON is not the canonical internally-tagged ChangeMassT form carrying mutation and newMassT");
}
...
async fn change_mass_t_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-mass-t/raises-mass-t-to-812-5: the committed diff must leave the presence-lane selectedCheckIndex absent");
