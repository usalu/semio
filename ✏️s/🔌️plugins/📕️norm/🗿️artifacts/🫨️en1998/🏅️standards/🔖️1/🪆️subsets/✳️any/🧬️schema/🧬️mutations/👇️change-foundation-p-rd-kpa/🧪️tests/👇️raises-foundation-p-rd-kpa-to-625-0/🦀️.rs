//! 🧪️ `change-foundation-p-rd-kpa` fixture — `👇️raises-foundation-p-rd-kpa-to-625-0`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👇️change-foundation-p-rd-kpa/👇️raises-foundation-p-rd-kpa-to-625-0/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👇️change-foundation-p-rd-kpa/👇️raises-foundation-p-rd-kpa-to-625-0/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👇️change-foundation-p-rd-kpa/👇️raises-foundation-p-rd-kpa-to-625-0/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👇️change-foundation-p-rd-kpa/👇️raises-foundation-p-rd-kpa-to-625-0/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👇️change-foundation-p-rd-kpa/👇️raises-foundation-p-rd-kpa-to-625-0/🎯️outcome/🔣️.json");
...
async fn change_foundation_p_rd_kpa_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
async fn change_foundation_p_rd_kpa_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
async fn change_foundation_p_rd_kpa_committed_json_is_canonical() {
    ...
    assert_eq!(reencoded, original, "change-foundation-p-rd-kpa/raises-foundation-p-rd-kpa-to-625-0: committed mutation JSON is not the canonical internally-tagged ChangeFoundationPRdKpa form carrying mutation and newFoundationPRdKpa");
}

/// 🎯️ The declared outcome holds: `change-foundation-p-rd-kpa` at 625.0 is applied, not rejected, and carries no
/// diagnostic of its own.
#[semio_framework_async_macros::async_test]
async fn change_foundation_p_rd_kpa_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
async fn change_foundation_p_rd_kpa_produces_committed_diff() {
    let outcome = <En1998Mutation as protocol::Mutation<En1998Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
async fn change_foundation_p_rd_kpa_committed_diff_applies_to_after() {
    let decoded: En1998Diff = serde_json::from_str(DIFF).expect("change-foundation-p-rd-kpa committed diff decodes");
