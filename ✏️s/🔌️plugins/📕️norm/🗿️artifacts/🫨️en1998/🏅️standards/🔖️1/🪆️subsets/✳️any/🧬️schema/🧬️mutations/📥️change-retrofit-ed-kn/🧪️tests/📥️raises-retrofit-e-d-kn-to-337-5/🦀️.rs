...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️change-retrofit-ed-kn/📥️raises-retrofit-e-d-kn-to-337-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️change-retrofit-ed-kn/📥️raises-retrofit-e-d-kn-to-337-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️change-retrofit-ed-kn/📥️raises-retrofit-e-d-kn-to-337-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️change-retrofit-ed-kn/📥️raises-retrofit-e-d-kn-to-337-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📥️change-retrofit-ed-kn/📥️raises-retrofit-e-d-kn-to-337-5/🎯️outcome/🔣️.json");
...
async fn change_retrofit_ed_kn_committed_json_is_canonical() {
    ...
    assert_eq!(reencoded, original, "change-retrofit-ed-kn/raises-retrofit-e-d-kn-to-337-5: committed mutation JSON is not the canonical internally-tagged ChangeRetrofitEDKn form carrying mutation and newRetrofitEDKn");
}
