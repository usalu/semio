...
use crate::editor::en1998::commands::{evaluate, selected_check, set_active_example, set_snapshot};
...
impl ArtifactEditor for En1998PlayApp {
    ...
    fn examples() -> Vec<semio_framework_plugin::ExampleSource> {
        vec![crate::seismic_rc_frame::source()]
    }
    ...
    fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, En1998Snapshot>) -> Result<Emit<En1998Mutation, NoConfigMutation, Self::DraftMutation>, MediaError> {
