//! 🌉️ `change-bridge-v-rd-kn` fixture — `🌉️raises-bridge-v-rd-kn-to-725-0`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.bridge_v_rd_kn` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-v-rd-kn/🌉️raises-bridge-v-rd-kn-to-725-0/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-v-rd-kn/🌉️raises-bridge-v-rd-kn-to-725-0/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-v-rd-kn/🌉️raises-bridge-v-rd-kn-to-725-0/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-v-rd-kn/🌉️raises-bridge-v-rd-kn-to-725-0/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-v-rd-kn/🌉️raises-bridge-v-rd-kn-to-725-0/🎯️outcome/🔣️.json");
...
async fn change_bridge_v_rd_kn_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-bridge-v-rd-kn/raises-bridge-v-rd-kn-to-725-0: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_bridge_v_rd_kn_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-bridge-v-rd-kn/raises-bridge-v-rd-kn-to-725-0: the committed diff must leave the presence-lane selectedCheckIndex absent");
