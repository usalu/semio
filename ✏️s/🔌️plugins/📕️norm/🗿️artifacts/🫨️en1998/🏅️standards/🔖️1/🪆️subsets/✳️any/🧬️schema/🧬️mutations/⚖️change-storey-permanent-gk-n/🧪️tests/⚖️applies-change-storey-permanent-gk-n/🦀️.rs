//! Named apply/inverse test for `change-storey-permanent-gk-n`.
use protocol::{Mutation, MutationDiff};

#[semio_framework_async_macros::async_test]
async fn applies_change_storey_permanent_gk_n() {
    ...
    let mutation = crate::mutations::text::demo_mutation_cases()
        ...
        .find(|m| {
            ...
            dbg.contains("change-storey-permanent-gk-n") || dbg.contains("changestoreypermanentgkn")
        })
