...
fn change_foundation_h_ed_kn_applies_to_committed_after() {
...
#[semio_framework_async_macros::async_test]
fn change_foundation_h_ed_kn_inverse_restores_before() {
    let base = before();
...
#[semio_framework_async_macros::async_test]
fn change_foundation_h_ed_kn_committed_json_is_canonical() {
...
#[semio_framework_async_macros::async_test]
fn change_foundation_h_ed_kn_declared_outcome_holds() {
...
#[semio_framework_async_macros::async_test]
fn change_foundation_h_ed_kn_produces_committed_diff() {
    let outcome = <En1998Mutation as protocol::Mutation<En1998Snapshot>>::diff(&mutation(), &before());
...
#[semio_framework_async_macros::async_test]
fn change_foundation_h_ed_kn_committed_diff_is_canonical() {
...
#[semio_framework_async_macros::async_test]
fn change_foundation_h_ed_kn_committed_diff_applies_to_after() {
    let decoded: En1998Diff = serde_json::from_str(DIFF).expect("change-foundation-h-ed-kn committed diff decodes");
