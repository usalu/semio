//! Named apply/inverse test for `change-system-base-shear-resistance-n`.
use protocol::{Mutation, MutationDiff};

#[semio_framework_async_macros::async_test]
async fn applies_change_system_base_shear_resistance_n() {
    ...
    let mutation = crate::mutations::text::demo_mutation_cases()
        ...
        .find(|m| {
            ...
            dbg.contains("change-system-base-shear-resistance-n") || dbg.contains("changesystembaseshearresistancen")
        })
