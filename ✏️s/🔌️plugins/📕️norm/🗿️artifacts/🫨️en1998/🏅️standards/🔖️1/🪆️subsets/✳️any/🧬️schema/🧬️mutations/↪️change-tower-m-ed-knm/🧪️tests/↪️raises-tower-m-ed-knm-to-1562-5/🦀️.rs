//! 🧪️ `change-tower-m-ed-knm` fixture — `↪️raises-tower-m-ed-knm-to-1562-5`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). Every expectation below was transcribed from this
//! leaf's own `../../🔺️diff/🦀️.rs`, which writes `En1998Diff.tower_m_ed_knm` and nothing else,
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↪️change-tower-m-ed-knm/↪️raises-tower-m-ed-knm-to-1562-5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↪️change-tower-m-ed-knm/↪️raises-tower-m-ed-knm-to-1562-5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↪️change-tower-m-ed-knm/↪️raises-tower-m-ed-knm-to-1562-5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↪️change-tower-m-ed-knm/↪️raises-tower-m-ed-knm-to-1562-5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↪️change-tower-m-ed-knm/↪️raises-tower-m-ed-knm-to-1562-5/🎯️outcome/🔣️.json");
...
async fn change_tower_m_ed_knm_produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-tower-m-ed-knm/raises-tower-m-ed-knm-to-1562-5: produced diff differs from the committed 🔺️diff/🔣️.json");
}
...
async fn change_tower_m_ed_knm_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-tower-m-ed-knm/raises-tower-m-ed-knm-to-1562-5: the committed diff must leave the presence-lane selectedCheckIndex absent");
