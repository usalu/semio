//! Named apply/inverse test for `change-building-masonry-wall-area-ratio`.
use protocol::{Mutation, MutationDiff};

#[semio_framework_async_macros::async_test]
async fn applies_change_building_masonry_wall_area_ratio() {
    ...
    let mutation = crate::mutations::text::demo_mutation_cases()
        ...
        .find(|m| {
            ...
            dbg.contains("change-building-masonry-wall-area-ratio") || dbg.contains("changebuildingmasonrywallarearatio")
        })
