//! 🌈️ `change-en-spectrum-type` fixture — `🌈️switches-en-spectrum-type-to-type2`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-en-spectrum-type/🌈️switches-en-spectrum-type-to-type2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-en-spectrum-type/🌈️switches-en-spectrum-type-to-type2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-en-spectrum-type/🌈️switches-en-spectrum-type-to-type2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-en-spectrum-type/🌈️switches-en-spectrum-type-to-type2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-en-spectrum-type/🌈️switches-en-spectrum-type-to-type2/🎯️outcome/🔣️.json");
...
async fn change_en_spectrum_type_committed_diff_is_canonical() {
    ...
    assert!(serde_json::to_value(&decoded).expect("diff JSON").get("selectedCheckIndex").is_none(), "change-en-spectrum-type/switches-en-spectrum-type-to-type2: the committed diff must leave the presence-lane selectedCheckIndex absent");
