...
use super::ChangeHScMm;
use crate::{En1994Diff, En1994Snapshot};

//#region 🔖️Diff
pub fn diff(payload: &ChangeHScMm, base: &En1994Snapshot) -> protocol::MutationOutcome<En1994Diff> {
    ...
    protocol::MutationOutcome::new(En1994Diff { h_sc_mm: Some(payload.new_h_sc_mm), ..Default::default() })
}
//#endregion 🔖️Diff
