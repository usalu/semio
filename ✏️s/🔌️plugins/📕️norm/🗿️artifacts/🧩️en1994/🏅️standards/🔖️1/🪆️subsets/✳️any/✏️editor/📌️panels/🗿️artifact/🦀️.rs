...
//#region 🔖️Constants
pub const BODY_DOCUMENT: &str = "norm.en1994.play.document";
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1994Family>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
