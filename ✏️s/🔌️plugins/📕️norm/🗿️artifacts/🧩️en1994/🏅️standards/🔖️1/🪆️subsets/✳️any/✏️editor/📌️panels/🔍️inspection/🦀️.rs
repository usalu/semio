//! 🔍️ EN 1994 play app panel — the inspection tab: one computed check in full, chosen by the config's
//! `selected_check_index` (the only view state a norm app carries).

use crate::document::NormHost;
use crate::editor::en1994::En1994Family;
...
//#region 🔖️Constants
pub const BODY_INSPECTION: &str = "norm.en1994.play.inspection";
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1994Family>, selected_check_index: Option<u32>) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
...
mod tests {
    ...
    fn an_out_of_range_selected_index_falls_back_to_the_first_check() {
        let host = NormHost::<En1994Family>::from_document(crate::artifacts::en1994::En1994Snapshot::default());
