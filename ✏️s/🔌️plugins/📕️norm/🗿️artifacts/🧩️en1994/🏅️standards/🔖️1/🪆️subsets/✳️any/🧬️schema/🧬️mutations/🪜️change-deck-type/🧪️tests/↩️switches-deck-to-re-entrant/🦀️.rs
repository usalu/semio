...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪜️change-deck-type/↩️switches-deck-to-re-entrant/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪜️change-deck-type/↩️switches-deck-to-re-entrant/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪜️change-deck-type/↩️switches-deck-to-re-entrant/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪜️change-deck-type/↩️switches-deck-to-re-entrant/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪜️change-deck-type/↩️switches-deck-to-re-entrant/🎯️outcome/🔣️.json");
