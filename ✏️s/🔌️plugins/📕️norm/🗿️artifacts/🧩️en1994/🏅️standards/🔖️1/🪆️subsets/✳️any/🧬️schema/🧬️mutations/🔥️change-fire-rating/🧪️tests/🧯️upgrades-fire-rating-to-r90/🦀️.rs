//! 🧪️ `change-fire-rating` fixture — `🧯️upgrades-fire-rating-to-r90` (EN 1994 composite).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-rating/🧯️upgrades-fire-rating-to-r90/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-rating/🧯️upgrades-fire-rating-to-r90/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-rating/🧯️upgrades-fire-rating-to-r90/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-rating/🧯️upgrades-fire-rating-to-r90/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-rating/🧯️upgrades-fire-rating-to-r90/🎯️outcome/🔣️.json");
