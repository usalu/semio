...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-vl-rd/↔️raises-longitudinal-shear-resistance-to-240-kn/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-vl-rd/↔️raises-longitudinal-shear-resistance-to-240-kn/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-vl-rd/↔️raises-longitudinal-shear-resistance-to-240-kn/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-vl-rd/↔️raises-longitudinal-shear-resistance-to-240-kn/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-vl-rd/↔️raises-longitudinal-shear-resistance-to-240-kn/🎯️outcome/🔣️.json");
