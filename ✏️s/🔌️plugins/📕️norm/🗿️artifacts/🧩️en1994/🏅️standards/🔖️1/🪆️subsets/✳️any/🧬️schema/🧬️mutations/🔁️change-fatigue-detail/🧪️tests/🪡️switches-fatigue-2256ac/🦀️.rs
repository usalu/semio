//! 🧪️ `change-fatigue-detail` fixture — `🪡️switches-fatigue-detail-to-flange-butt-weld` (EN 1994 composite).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-fatigue-detail/switches-fatigue-detail-to-flange-butt-weld: produced diff differs from the committed 🔺️diff/🔣️.json");
}
