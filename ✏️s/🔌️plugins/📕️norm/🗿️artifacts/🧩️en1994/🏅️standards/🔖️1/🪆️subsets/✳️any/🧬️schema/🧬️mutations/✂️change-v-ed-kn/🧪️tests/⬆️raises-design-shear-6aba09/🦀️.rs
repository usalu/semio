//! 🧪️ `change-v-ed-kn` fixture — `⬆️raises-design-shear-to-225-kn` (EN 1994 composite).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-v-ed-kn/raises-design-shear-to-225-kn: produced diff differs from the committed 🔺️diff/🔣️.json");
}
