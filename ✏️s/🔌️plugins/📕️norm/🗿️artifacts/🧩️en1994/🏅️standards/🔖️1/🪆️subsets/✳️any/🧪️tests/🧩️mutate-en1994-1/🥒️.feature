...
Feature: Apply every typed EN 1994 mutation against an independent Python implementation
  ...
  Scenario Outline: Apply <id> to its committed specification vector
    ...
    Examples:
      ...
      | change-m-ed-knm                | 🌀️change-m-ed-knm                 | 🌀️raises-design-moment-to-320-knm                |
      | change-v-ed-kn                 | ✂️change-v-ed-kn                  | ⬆️raises-design-shear-to-225-kn                  |
      | change-m-pla                   | 🦾️change-m-pla                   | 🦾️raises-steel-plastic-moment-to-128-knm         |
      | change-m-pl-rd                 | 🛡️change-m-pl-rd                  | 🛡️raises-plastic-moment-resistance-to-375-knm    |
      | change-eta                     | 🤝️change-eta                     | 🤝️raises-shear-connection-degree-to-0-875        |
      | change-vl-rd                   | ↔️change-vl-rd                    | ↔️raises-longitudinal-shear-resistance-to-240-kn |
      | change-insulation-thickness-mm | 🧯️change-insulation-thickness-mm | 🧣️thickens-fire-insulation-to-40-mm              |
      | change-fire-rating             | 🔥️change-fire-rating             | 🧯️upgrades-fire-rating-to-r90                    |
      | change-deck-type               | 🪜️change-deck-type               | ↩️switches-deck-to-re-entrant                    |
      | change-delta-sigma-mpa         | 📊️change-delta-sigma-mpa         | 📈️raises-steel-stress-range-to-96-mpa            |
      | change-fatigue-detail          | 🔁️change-fatigue-detail          | 🪡️switches-fatigue-detail-to-flange-butt-weld    |
      | change-d-mm                    | ⭕️change-d-mm                     | ⭕️thickens-stud-shank-to-22-mm                   |
      | change-h-sc-mm                 | ↕️change-h-sc-mm                  | 📏️lengthens-stud-to-125-mm                       |
      | change-f-ck-mpa                | 🧱️change-f-ck-mpa                 | 🧱️upgrades-concrete-cylinder-strength-to-40-mpa  |
      | change-fu-mpa                  | 💪️change-fu-mpa                  | 💪️upgrades-stud-ultimate-strength-to-500-mpa     |
      | change-e-cm-mpa                | 🪨️change-e-cm-mpa                | 🪨️raises-concrete-modulus-to-35000-mpa           |
      | change-v-ed-per-stud-kn        | 📌️change-v-ed-per-stud-kn        | 📌️raises-per-stud-shear-to-62-5-kn               |
      | change-span-m                  | 📏️change-span-m                   | 📏️lengthens-span-to-12-m                         |
      | change-fy-mpa                  | 🏋️change-fy-mpa                   | 🏋️upgrades-steel-yield-to-460-mpa                |
      | change-n-cycles-stud           | 🔄️change-n-cycles-stud           | 🔢️raises-stud-cycle-count-to-5000000             |
      | change-delta-tau-stud-mpa      | 🔩️change-delta-tau-stud-mpa      | 🔩️raises-stud-shear-stress-range-to-110-mpa      |
