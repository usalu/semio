...
impl protocol::MutationKind<En1994Snapshot, En1994Mutation> for ChangeVEdPerStudKn {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change shear per stud V_Ed to {}", self.new_v_ed_per_stud_kn), &format!("Schubkraft je Kopfbolzendübel V_Ed auf {} ändern", self.new_v_ed_per_stud_kn))
    }
}
//#endregion 🔖️Payload
