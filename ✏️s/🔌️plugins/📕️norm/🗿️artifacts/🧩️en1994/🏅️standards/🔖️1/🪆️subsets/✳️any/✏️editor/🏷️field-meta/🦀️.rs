...
const TABLE: &[(&str, NormFieldMeta)] = &[
    ...
    ("beams[].actions[].mKNm", mu("Characteristic moment M_k", "Charakteristisches Moment M_k", "N·m")),
    ("beams[].actions[].vKN", mu("Characteristic shear V_k", "Charakteristische Querkraft V_k", "N")),
    ("beams[].actions[].nKN", mu("Characteristic axial N_k", "Charakteristische Normalkraft N_k", "N")),
    ...
    ("columns[].actions[].qAreaPa", mu("Characteristic area load q_k", "Charakteristische Flächenlast q_k", "Pa")),
    ("columns[].actions[].mKNm", mu("Characteristic moment M_k", "Charakteristisches Moment M_k", "N·m")),
    ("columns[].actions[].vKN", mu("Characteristic shear V_k", "Charakteristische Querkraft V_k", "N")),
    ("columns[].actions[].nKN", mu("Characteristic axial N_k", "Charakteristische Normalkraft N_k", "N")),
    ("columns[].actions[].deltaSigmaKPa", mu("Characteristic stress range Δσ_k", "Charakteristische Spannungsschwingbreite Δσ_k", "Pa")),
    ("columns[].actions[].deltaTauKPa", mu("Characteristic stud Δτ_k", "Charakteristische Bolzen-Δτ_k", "Pa")),
    ...
    ("slabs[].actions[].mKNm", mu("Characteristic moment M_k", "Charakteristisches Moment M_k", "N·m")),
    ("slabs[].actions[].vKN", mu("Characteristic shear V_k", "Charakteristische Querkraft V_k", "N")),
    ("slabs[].actions[].nKN", mu("Characteristic axial N_k", "Charakteristische Normalkraft N_k", "N")),
