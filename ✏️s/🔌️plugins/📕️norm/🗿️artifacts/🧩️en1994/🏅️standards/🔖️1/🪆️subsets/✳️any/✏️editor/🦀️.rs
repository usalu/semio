...
use crate::editor::en1994::commands::{apply_remedy, evaluate, insert_item, remove_item, selected_check, set_active_example, set_field, set_snapshot};
...
pub const CONTROLLER_ID: &str = "s.norm.en1994@1/*#editor";
...
semio_framework_plugin::app_commands! {
    ...
    pub enum En1994Command for En1994Snapshot, En1994Mutation, NoConfig, NoConfigMutation {
...
impl ArtifactEditor for En1994PlayApp {
    ...
    fn examples() -> Vec<semio_framework_plugin::ExampleSource> {
        vec![crate::composite_floor_beam::source(), crate::composite_floor_beam_failing::source(), crate::composite_bridge_girder::source()]
    }
    ...
    const DIALECT: Dialect = crate::EN1994_DIALECT;
    ...
    fn register_tool_job_factories(registry: &mut semio_framework_plugin::ArtifactToolFactoryRegistry<'_, semio_framework_plugin::EditorApp<Self>>) -> Result<(), Fault> {
        En1994BoundedCommandJobFactory::register(registry)
    }
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/🧩️en1994/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️.rs",
        controller: "s.norm.en1994@1/*#editor",
        artifact_schema: "semio.norm.en1994/v1",
        factory: "En1994BoundedCommandJobFactory",
        factory_type: En1994BoundedCommandJobFactory,
    ...
    ) -> Result<Emit<En1994Mutation, NoConfigMutation, Self::DraftMutation>, Fault> {
        crate::app_surface::dispatch_norm_command::<Self>(command, doc, cfg, view_state)
    }

    fn render(body_key: &str, doc: &ArtifactView<'_, En1994Snapshot>, cfg: &ConfigView<'_, NoConfig>, view_state: &semio_framework_plugin::ViewModel) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::ComponentTree> {
        let host = NormHost::<En1994Family>::from_artifact(doc.snapshot.clone());
        match body_key {
    ...
    fn import_media(port: &str, media: &Media, doc: &ArtifactView<'_, En1994Snapshot>) -> Result<Emit<En1994Mutation, NoConfigMutation, Self::DraftMutation>, MediaError> {
        let base = doc.snapshot.clone();
        crate::app_surface::import_media(port, media, move |snapshot: En1994Snapshot| En1994Mutation::from_snapshot(&base, &snapshot))
    }
...
crate::norm_owned_tool_job_factory!(En1994BoundedCommandJobFactory, En1994PlayApp);

impl crate::app_surface::NormRetainedEditor for En1994PlayApp {
    type Family = En1994Family;

    type ResultsWindowConfigOwner = results::ResultsWindowConfigOwner;

    fn selected_check_window_mutation(command: &En1994Command) -> Option<crate::results_window_config::NormResultsWindowConfigMutation> {
        match command {
            En1994Command::SetSelectedCheckIndex(payload) => Some(selected_check::window_mutation(payload)),
            _ => None,
        }
    }

    fn dispatch_retained(command: &En1994Command, doc: &ArtifactView<'_, En1994Snapshot>, cfg: &ConfigView<'_, NoConfig>) -> Result<Emit<En1994Mutation, NoConfigMutation, NoDraftMutation>, Fault> {
...
pub fn create_en1994_app() -> semio_framework_plugin::AppDefinition {
    Editor::builder(crate::EN1994_DIALECT)
