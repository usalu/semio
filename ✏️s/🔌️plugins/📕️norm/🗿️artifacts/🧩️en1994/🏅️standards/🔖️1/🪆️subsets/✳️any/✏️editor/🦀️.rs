...
impl ArtifactEditor for En1994PlayApp {
    ...
    fn render(body_key: &str, doc: &ArtifactView<'_, En1994Snapshot>, cfg: &ConfigView<'_, NormConfig>, _view_state: &semio_framework_plugin::ViewModel) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::ComponentTree> {
...
impl crate::app_surface::NormRetainedEditor for En1994PlayApp {
    fn dispatch_retained(command: &En1994Command, doc: &ArtifactView<'_, En1994Snapshot>, cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1994Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
        command.dispatch(doc, cfg)
    }
}
