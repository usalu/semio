//! 🧮️ EN 1994 play app command — recompute the compliance report in place.
//!
...
//#region 🔖️Handler
pub fn handle(_payload: &Evaluate, _doc: &ArtifactView<'_, En1994Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1994Mutation, NormConfigMutation>, Fault> {
    Ok(Emit::default())
}
//#endregion 🔖️Handler
