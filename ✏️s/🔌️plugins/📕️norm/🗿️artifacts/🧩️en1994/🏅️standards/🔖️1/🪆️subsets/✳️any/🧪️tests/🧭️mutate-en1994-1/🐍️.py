...
VECTORS = {
    ...
    "change-m-ed-knm": ("🌀️change-m-ed-knm", "raises-design-moment-to-320-knm"),
    "change-v-ed-kn": ("✂️change-v-ed-kn", "raises-design-shear-to-225-kn"),
    "change-m-pla": ("🦾️change-m-pla", "raises-steel-plastic-moment-to-128-knm"),
    "change-m-pl-rd": ("🛡️change-m-pl-rd", "raises-plastic-moment-resistance-to-375-knm"),
    "change-eta": ("🤝️change-eta", "raises-shear-connection-degree-to-0-875"),
    "change-vl-rd": ("↔️change-vl-rd", "raises-longitudinal-shear-resistance-to-240-kn"),
    ...
    "change-deck-type": ("🪜️change-deck-type", "switches-deck-to-re-entrant"),
    ...
    "change-d-mm": ("⭕️change-d-mm", "thickens-stud-shank-to-22-mm"),
    "change-h-sc-mm": ("↕️change-h-sc-mm", "lengthens-stud-to-125-mm"),
    "change-f-ck-mpa": ("🧱️change-f-ck-mpa", "upgrades-concrete-cylinder-strength-to-40-mpa"),
    "change-fu-mpa": ("💪️change-fu-mpa", "upgrades-stud-ultimate-strength-to-500-mpa"),
    ...
    "change-span-m": ("📏️change-span-m", "lengthens-span-to-12-m"),
    "change-fy-mpa": ("🏋️change-fy-mpa", "upgrades-steel-yield-to-460-mpa"),
...
DSL_ASSET = "asset://📚️examples/🌉️composite-bridge-girder/🖼️assets/🌉️composite-bridge-girder/🗣️.dsl.semio"
