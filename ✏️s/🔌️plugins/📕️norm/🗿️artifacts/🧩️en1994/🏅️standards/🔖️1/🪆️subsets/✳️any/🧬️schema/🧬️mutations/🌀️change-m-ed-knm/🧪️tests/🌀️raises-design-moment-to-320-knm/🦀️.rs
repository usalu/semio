//! 🧪️ `change-m-ed-knm` fixture — `🌀️raises-design-moment-to-320-knm` (EN 1994 composite).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-m-ed-knm/🌀️raises-design-moment-to-320-knm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-m-ed-knm/🌀️raises-design-moment-to-320-knm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-m-ed-knm/🌀️raises-design-moment-to-320-knm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-m-ed-knm/🌀️raises-design-moment-to-320-knm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-m-ed-knm/🌀️raises-design-moment-to-320-knm/🎯️outcome/🔣️.json");
