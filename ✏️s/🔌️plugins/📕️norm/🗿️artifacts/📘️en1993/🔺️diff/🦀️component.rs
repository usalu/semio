//! 🔺️ EN 1993 artifact — the operation diff and its `MutationDiff` law.
//!
...
//! names as its `En1993Mutation::Diff`, with the `MutationDiff` impl (apply = "take the replacement,
...
mod tests {
    ...
    fn set_document_diff_replaces_the_whole_projection() {
        ...
        let mutation = En1993Mutation::SetDocument { document: Document::default() };
