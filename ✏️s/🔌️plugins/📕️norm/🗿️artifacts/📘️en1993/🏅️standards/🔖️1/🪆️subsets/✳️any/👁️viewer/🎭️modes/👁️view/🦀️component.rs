//! 👁️ EN 1993 viewer — the `view` mode: a single full-pane Report window, the read-only
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::en1993::create_en1993_viewer`.
