//! 🧪️ `update-silo-shell-inputs` fixture — `deepens-the-silo-and-thickens-its-shell`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-silo-shell-inputs/deepens-the-silo-and-thickens-its-shell: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
