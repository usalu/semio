//! 🧪️ `update-fire-inputs` fixture — `raises-the-fire-protection-to-r90`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-fire-inputs/raises-the-fire-protection-to-r90: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
