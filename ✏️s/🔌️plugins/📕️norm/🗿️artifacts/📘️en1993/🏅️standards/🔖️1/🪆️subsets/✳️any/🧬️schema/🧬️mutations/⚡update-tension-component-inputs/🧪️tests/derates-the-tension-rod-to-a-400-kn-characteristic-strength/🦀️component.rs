//! 🧪️ `update-tension-component-inputs` fixture — `derates-the-tension-rod-to-a-400-kn-characteristic-strength`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-tension-component-inputs/derates-the-tension-rod-to-a-400-kn-characteristic-strength: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
