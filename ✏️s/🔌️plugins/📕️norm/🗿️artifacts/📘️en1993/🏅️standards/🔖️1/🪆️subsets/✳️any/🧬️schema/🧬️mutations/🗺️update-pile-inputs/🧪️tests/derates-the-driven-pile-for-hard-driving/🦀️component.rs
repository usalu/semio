...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-pile-inputs/derates-the-driven-pile-for-hard-driving: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
