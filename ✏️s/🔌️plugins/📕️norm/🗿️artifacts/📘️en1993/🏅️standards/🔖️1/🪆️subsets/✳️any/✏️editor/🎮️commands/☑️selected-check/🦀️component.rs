...
//#region 🔖️Handler
pub async fn handle(payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, En1993Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1993Mutation, NormConfigMutation>, Fault> {
