...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-plated-inputs/makes-the-plate-panel-more-slender-and-more-stressed: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
