...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.en1993/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &En1993Command, _snapshot: &En1993Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<En1993Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<En1993PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<En1993PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<En1993PlayApp>;
...
impl ArtifactEditor for En1993PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📘️en1993/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
