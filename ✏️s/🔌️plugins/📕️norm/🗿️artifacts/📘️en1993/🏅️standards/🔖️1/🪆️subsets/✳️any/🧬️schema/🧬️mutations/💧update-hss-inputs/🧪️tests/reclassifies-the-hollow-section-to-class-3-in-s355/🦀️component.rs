...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-hss-inputs/reclassifies-the-hollow-section-to-class-3-in-s355: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
