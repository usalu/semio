...
//#region 🔖️Diff
pub async fn diff(payload: &UpdateFireInputs, base: &En1993Snapshot) -> protocol::MutationOutcome<En1993Diff> {
    ...
    if base.fire_thickness_mm == payload.new_fire_thickness_mm
        && base.fire_rating == payload.new_fire_rating
        && base.fire_massivity == payload.new_fire_massivity
        && base.fire_mu_0 == payload.new_fire_mu_0
        && base.fire_design_temperature_c == payload.new_fire_design_temperature_c
    {
