//! 📊️ EN 1993 viewer — the Report window: a read-only table of every computed compliance
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::en1993::create_en1993_viewer`. Read-only variant
...
//#region 🔖️Render
/// 👁️ Pure `En1993Snapshot -> UiNode` read: recomputes the compliance report straight off the document
...
pub async fn render(document: &En1993Snapshot) -> UiNode {
    let report = crate::artifacts::en1993::standards::v1::subsets::any::schema::inferences::evaluate(document);
