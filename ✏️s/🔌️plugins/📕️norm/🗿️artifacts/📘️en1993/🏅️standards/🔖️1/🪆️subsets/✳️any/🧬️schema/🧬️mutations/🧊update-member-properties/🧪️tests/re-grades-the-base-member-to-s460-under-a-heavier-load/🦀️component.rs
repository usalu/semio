...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-member-properties/re-grades-the-base-member-to-s460-under-a-heavier-load: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
