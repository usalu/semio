...
use crate::artifacts::en1993::{EN1993_DIALECT, EN1993_DOCUMENT_SCHEMA};
...
impl ArtifactViewer for En1993Viewer {
    ...
    type Mutation = crate::artifacts::en1993::op::En1993Mutation;
    ...
    async fn initial_snapshot() -> En1993Snapshot {
...
//#region 🔖️Manifest
pub async fn create_en1993_viewer() -> semio_framework_plugin::AppDefinition {
...
mod tests {
    ...
    async fn an_unknown_body_key_falls_back_to_a_text_node() {
        ...
        let json = serde_json::to_string(&<En1993Viewer as ArtifactViewer>::render("nope", &doc, &ConfigView { snapshot: &NoConfig::default() })).expect("json");
