//! 🧪️ `update-tower-inputs` fixture — `raises-the-tower-wind-factor-and-leg-force`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "update-tower-inputs/raises-the-tower-wind-factor-and-leg-force: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
