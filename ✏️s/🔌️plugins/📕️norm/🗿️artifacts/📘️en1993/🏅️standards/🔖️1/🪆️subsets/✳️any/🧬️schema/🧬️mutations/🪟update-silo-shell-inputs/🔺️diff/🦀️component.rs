...
pub fn diff(payload: &UpdateSiloShellInputs, base: &En1993Snapshot) -> protocol::MutationOutcome<En1993Diff> {
    ...
    if base.silo_t_mm == payload.new_silo_t_mm
        && base.silo_r_mm == payload.new_silo_r_mm
        && base.shell_sigma_x_ed_mpa == payload.new_shell_sigma_x_ed_mpa
        && base.silo_k == payload.new_silo_k
        && base.silo_gamma_kn_m3 == payload.new_silo_gamma_kn_m3
        && base.silo_depth_m == payload.new_silo_depth_m
    {
