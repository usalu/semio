...
pub fn definition() -> Result<semio_framework_plugin::ArtifactDefinition, semio_framework_plugin::ArtifactDefinitionError> {
    crate::artifacts::definition::schema_owned_definition(
        "s.en1993",
        crate::artifacts::en1993::schema::en1993_artifact_schema_descriptor().id,
        crate::artifacts::en1993::standards::v1::subsets::any::schema::inferences::en1993_artifact_inference_descriptor().id,
        crate::artifacts::en1993::standards::v1::subsets::any::io::io_registry::entries(),
        pilot_languages(),
        crate::apps::en1993::DOCUMENT_SCHEMA,
        <En1993Snapshot as store::ArtifactDsl>::EXTENSION,
