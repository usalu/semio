...
pub fn register() {}
pub fn deserialize(_from: &crate::artifacts::txt::TxtSnapshot) -> Result<En1997Snapshot, String> {
    Err("txt import not yet implemented".into())
}
pub fn deserialize_bytes(_bytes: &[u8]) -> Result<En1997Snapshot, String> {
    Err("txt import not yet implemented".into())
}
