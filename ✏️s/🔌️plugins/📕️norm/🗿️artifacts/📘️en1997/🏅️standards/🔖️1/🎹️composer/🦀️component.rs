//! 🎹️ En1997Composer (1 standard) — aggregates its subsets' composer entries value-level. W5a
...
//! history) — a fabricated shape, not a real codec. Only the native `s.en1997` entry remains.
