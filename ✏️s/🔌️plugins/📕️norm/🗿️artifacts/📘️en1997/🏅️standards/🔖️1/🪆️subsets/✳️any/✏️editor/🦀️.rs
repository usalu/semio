...
impl ArtifactEditor for En1997PlayApp {
    ...
    const DIALECT: Dialect = crate::artifacts::en1997::EN1997_DIALECT;
...
pub fn create_en1997_app() -> semio_framework_plugin::AppDefinition {
    Editor::builder(crate::artifacts::en1997::EN1997_DIALECT)
...
pub(crate) mod testkit {
    ...
    pub fn en1997_manifest_for_testkit() -> semio_framework_plugin::App {
    ...
    pub fn new_app() -> NormApp {
        sdk_new_app::<EditorApp<En1997PlayApp>>()
    }
    ...
    pub fn app_with_registry() -> NormApp {
        new_app_with_registry::<EditorApp<En1997PlayApp>>(en1997_manifest_for_testkit)
    }
