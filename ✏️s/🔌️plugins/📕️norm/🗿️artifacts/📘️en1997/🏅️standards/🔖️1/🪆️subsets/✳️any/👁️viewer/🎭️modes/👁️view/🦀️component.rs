//! 👁️ EN 1997 viewer — the `view` mode: a single full-pane Report window, the read-only
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::en1997::create_en1997_viewer`.
