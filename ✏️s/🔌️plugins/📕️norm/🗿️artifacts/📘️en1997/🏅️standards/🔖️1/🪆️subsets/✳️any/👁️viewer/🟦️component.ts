/** 👁️ EN 1997 viewer — subset-level typed twin. Read-only counterpart of
...
export const EN1997_VIEWER_DIALECT = { artifactKind: "s.norm.en1997", standard: "1", subset: "*" } as const;

export const EN1997_VIEW_MODE_ID = "view" as const;
