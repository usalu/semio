...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-settlement-limit-mm/relaxes-the-settlement-limit-to-40-mm: the produced diff differs from the committed 🔺️diff/🔣️component.json");
}
