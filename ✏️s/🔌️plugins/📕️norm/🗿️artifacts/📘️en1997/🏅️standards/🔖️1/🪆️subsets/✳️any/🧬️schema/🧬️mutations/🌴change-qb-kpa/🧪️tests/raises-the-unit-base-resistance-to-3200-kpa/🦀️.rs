...
fn raises_the_unit_base_resistance_to_3200_kpa() {
...
/// on `q_b_kpa`.
#[semio_framework_async_macros::async_test]
fn restoring_2500_kpa_restores_before() {
    let base = before();
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-qb-kpa/raises-the-unit-base-resistance-to-3200-kpa: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
