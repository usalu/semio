//! 👁️ EN 1997 viewer — the read-only counterpart of `✏️editor` for this subset (ticket
//! 26/08/16/ARTIFACT-VIEWERS-AND-EDITORS-PER-SUBSET contract §2.2). `En1997Viewer` implements
//! `ArtifactViewer`, never `ArtifactEditor`/`ArtifactApp` — `ViewerApp<En1997Viewer>` (framework SDK) is
//! the sole runtime adapter, so this file can never structurally emit an artifact or draft mutation.
//! MUST NOT import anything from the sibling editor module (`policyViewerPurityBreaches`).

use crate::artifacts::en1997::En1997Snapshot;
use crate::artifacts::en1997::{EN1997_DIALECT, EN1997_DOCUMENT_SCHEMA};
use crate::viewer::en1997::modes::view;
use crate::viewer::en1997::modes::view::windows::report;
...
pub enum En1997ViewCommand {
    #[default]
    Noop,
}

impl protocol::OpBinary for En1997ViewCommand {
    fn encode_op(&self) -> Result<Vec<u8>, protocol::ProtocolError> {
        Ok(Vec::new())
    }
    fn decode_op(_bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        Ok(En1997ViewCommand::Noop)
    }
}
//#endregion 🔖️Command
...
pub struct En1997Viewer;

impl ArtifactViewer for En1997Viewer {
    type Snapshot = En1997Snapshot;
    type Mutation = crate::artifacts::en1997::op::En1997Mutation;
    ...
    type Command = En1997ViewCommand;
    ...
    /// 👁️ Structurally read-only: the sole `En1997ViewCommand::Noop` variant never carries a config
...
//#region 🔖️Manifest
pub fn create_en1997_viewer() -> semio_framework_plugin::AppDefinition {
    Viewer::builder(EN1997_DIALECT)
        .document(["semio", "norm", "en1997"])
...
mod tests {
    ...
    fn create_en1997_viewer_builds_a_definition_for_this_dialect() {
    ...
    fn an_unknown_body_key_falls_back_to_a_text_node() {
        ...
        let json = serde_json::to_string(&<En1997Viewer as ArtifactViewer>::render("nope", &doc, &ConfigView { snapshot: &NoConfig::default() })).expect("json");
