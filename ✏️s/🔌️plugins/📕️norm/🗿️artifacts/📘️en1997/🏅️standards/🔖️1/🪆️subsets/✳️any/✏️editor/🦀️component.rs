...
const NORM_BOUNDED_PAYLOAD_SCHEMA: &str = "semio.norm.en1997/v1.tool-command.v1";
...
fn norm_bounded_extent(command: &En1997Command, _snapshot: &En1997Snapshot, _interaction: &protocol::InteractionState) -> Option<usize> {
...
) -> Result<Emit<En1997Mutation, NormConfigMutation, NoDraftMutation>, Fault> {
...
impl semio_framework::ToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Payload = ArtifactRetainedCommandPayload<EditorApp<En1997PlayApp>>;
    type Job = ArtifactRetainedCommandJob<EditorApp<En1997PlayApp>>;
...
impl semio_framework_plugin::ArtifactOwnedToolJobFactory for BoundedFirstStepCommandJobFactory {
    type Owner = EditorApp<En1997PlayApp>;
...
impl ArtifactEditor for En1997PlayApp {
    ...
    semio_framework_plugin::bounded_first_step_tool_proofs! {
        ...
        owner_file: "✏️s/🔌️plugins/📕️norm/🗿️artifacts/📘️en1997/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🦀️component.rs",
