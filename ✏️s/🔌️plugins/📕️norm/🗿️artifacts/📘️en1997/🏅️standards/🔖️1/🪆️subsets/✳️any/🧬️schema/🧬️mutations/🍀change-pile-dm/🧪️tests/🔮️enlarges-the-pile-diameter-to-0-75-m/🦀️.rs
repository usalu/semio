//! 🧪️ `change-pile-dm` fixture — `🔮️enlarges-the-pile-diameter-to-0-75-m`.
//!
...
fn enlarges_the_pile_diameter_to_0_75_m() {
...
/// back on `pile_d_m`.
#[semio_framework_async_macros::async_test]
fn restoring_0_5_m_restores_before() {
    let base = before();
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-pile-dm/enlarges-the-pile-diameter-to-0-75-m: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
