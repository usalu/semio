...
fn raises_the_design_pile_axial_load_to_1200_kn() {
...
/// on `n_pile_ed_kn`.
#[semio_framework_async_macros::async_test]
fn restoring_800_kn_restores_before() {
    let base = before();
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-n-pile-ed-kn/raises-the-design-pile-axial-load-to-1200-kn: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
