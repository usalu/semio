...
pub fn diff(payload: &ChangeConnectionStrengthClass, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    connections[idx].strength_class = payload.new_value.clone();
