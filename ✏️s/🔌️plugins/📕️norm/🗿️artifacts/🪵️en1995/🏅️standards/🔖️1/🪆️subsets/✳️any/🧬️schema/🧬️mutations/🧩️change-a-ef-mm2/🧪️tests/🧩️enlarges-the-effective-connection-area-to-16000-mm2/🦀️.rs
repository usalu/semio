//! 🧪️ `change-a-ef-mm2` fixture — `🧩️enlarges-the-effective-connection-area-to-16000-mm2`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-a-ef-mm2/🧩️enlarges-the-effective-connection-area-to-16000-mm2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-a-ef-mm2/🧩️enlarges-the-effective-connection-area-to-16000-mm2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-a-ef-mm2/🧩️enlarges-the-effective-connection-area-to-16000-mm2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-a-ef-mm2/🧩️enlarges-the-effective-connection-area-to-16000-mm2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-a-ef-mm2/🧩️enlarges-the-effective-connection-area-to-16000-mm2/🎯️outcome/🔣️.json");
...
async fn enlarges_the_effective_connection_area_to_16000_mm2() {
...
/// back on `a_ef_mm2`.
#[semio_framework_async_macros::async_test]
async fn restoring_12000_mm2_restores_before() {
    let base = before();
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-a-ef-mm2/enlarges-the-effective-connection-area-to-16000-mm2: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
