...
impl ArtifactEditor for En1995PlayApp {
    ...
    fn render(body_key: &str, doc: &ArtifactView<'_, En1995Snapshot>, cfg: &ConfigView<'_, NoConfig>, _view_state: &semio_framework_plugin::ViewModel) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::ComponentTree> {
