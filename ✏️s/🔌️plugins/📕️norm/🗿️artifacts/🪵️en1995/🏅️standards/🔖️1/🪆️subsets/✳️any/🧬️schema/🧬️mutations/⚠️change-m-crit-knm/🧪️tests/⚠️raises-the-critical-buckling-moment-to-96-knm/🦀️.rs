...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚠️change-m-crit-knm/⚠️raises-the-critical-buckling-moment-to-96-knm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚠️change-m-crit-knm/⚠️raises-the-critical-buckling-moment-to-96-knm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚠️change-m-crit-knm/⚠️raises-the-critical-buckling-moment-to-96-knm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚠️change-m-crit-knm/⚠️raises-the-critical-buckling-moment-to-96-knm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚠️change-m-crit-knm/⚠️raises-the-critical-buckling-moment-to-96-knm/🎯️outcome/🔣️.json");
