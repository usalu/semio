...
pub fn diff(payload: &ChangeConnectionActionKind, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    connections[idx].actions[action_idx].kind = payload.new_value.clone();
