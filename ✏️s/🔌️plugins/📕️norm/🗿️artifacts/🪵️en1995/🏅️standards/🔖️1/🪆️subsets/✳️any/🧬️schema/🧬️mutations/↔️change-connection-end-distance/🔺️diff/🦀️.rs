...
pub fn diff(payload: &ChangeConnectionEndDistance, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    connections[idx].end_distance_m = payload.new_value;
