use super::ChangeMemberActionNTK;
use crate::diff::En1995MemberList;
use crate::{En1995Diff, En1995Snapshot};
pub fn diff(payload: &ChangeMemberActionNTK, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    members[idx].actions[action_idx].n_t_k_n = payload.new_value;
