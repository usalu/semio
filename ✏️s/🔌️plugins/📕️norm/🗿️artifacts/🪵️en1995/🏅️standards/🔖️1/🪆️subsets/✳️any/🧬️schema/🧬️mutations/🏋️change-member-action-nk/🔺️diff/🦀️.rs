...
pub fn diff(payload: &ChangeMemberActionNK, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    members[idx].actions[action_idx].n_k_n = payload.new_value;
