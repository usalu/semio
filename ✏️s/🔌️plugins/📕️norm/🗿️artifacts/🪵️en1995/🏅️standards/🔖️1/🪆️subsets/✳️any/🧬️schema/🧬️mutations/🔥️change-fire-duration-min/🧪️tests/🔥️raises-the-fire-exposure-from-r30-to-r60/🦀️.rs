...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-duration-min/🔥️raises-the-fire-exposure-from-r30-to-r60/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-duration-min/🔥️raises-the-fire-exposure-from-r30-to-r60/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-duration-min/🔥️raises-the-fire-exposure-from-r30-to-r60/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-duration-min/🔥️raises-the-fire-exposure-from-r30-to-r60/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-duration-min/🔥️raises-the-fire-exposure-from-r30-to-r60/🎯️outcome/🔣️.json");
