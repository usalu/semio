/** 🪵 EN 1995 artifact TypeScript mirror (same shape as snapshot). */
...
export interface En1995Artifact { annex: AnnexChoice; members: TimberMember[]; connections: TimberConnection[]; }
