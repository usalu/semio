...
pub fn diff(payload: &ChangeMemberActionQLine, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    members[idx].actions[action_idx].q_line_n_per_m = payload.new_value;
