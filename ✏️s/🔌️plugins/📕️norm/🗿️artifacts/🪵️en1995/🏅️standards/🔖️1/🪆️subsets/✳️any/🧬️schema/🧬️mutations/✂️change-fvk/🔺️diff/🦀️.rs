...
use crate::mutations::change_f_v_k::ChangeFVK;
use crate::En1995Snapshot;

//#region 🔖️Diff
pub fn diff(payload: &ChangeFVK, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    protocol::MutationOutcome::new(En1995Diff { f_v_k: Some(payload.new_f_v_k), ..Default::default() })
}
//#endregion 🔖️Diff
