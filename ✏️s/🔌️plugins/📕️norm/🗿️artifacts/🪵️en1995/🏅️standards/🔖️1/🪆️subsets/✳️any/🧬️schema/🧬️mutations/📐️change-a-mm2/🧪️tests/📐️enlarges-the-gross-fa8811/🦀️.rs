//! 🧪️ `change-a-mm2` fixture — `📐️enlarges-the-gross-area-to-72000-mm2`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-a-mm2/enlarges-the-gross-area-to-72000-mm2: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
