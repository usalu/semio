...
fn en1995_mutation_to_dsl(mutation: &En1995Mutation) -> En1995MutationDsl {
    match mutation {
        En1995Mutation::ChangeAnnex(payload) => En1995MutationDsl::ChangeAnnex { new_annex: payload.new_annex },
        En1995Mutation::ChangeMEdKnm(payload) => En1995MutationDsl::ChangeMEdKnm { new_m_ed_knm: payload.new_m_ed_knm },
        En1995Mutation::ChangeNEdKn(payload) => En1995MutationDsl::ChangeNEdKn { new_n_ed_kn: payload.new_n_ed_kn },
        En1995Mutation::ChangeVEdKn(payload) => En1995MutationDsl::ChangeVEdKn { new_v_ed_kn: payload.new_v_ed_kn },
        En1995Mutation::ChangeWMm3(payload) => En1995MutationDsl::ChangeWMm3 { new_w_mm3: payload.new_w_mm3 },
        En1995Mutation::ChangeAMm2(payload) => En1995MutationDsl::ChangeAMm2 { new_a_mm2: payload.new_a_mm2 },
        En1995Mutation::ChangeBMm(payload) => En1995MutationDsl::ChangeBMm { new_b_mm: payload.new_b_mm },
        En1995Mutation::ChangeHMm(payload) => En1995MutationDsl::ChangeHMm { new_h_mm: payload.new_h_mm },
        En1995Mutation::ChangeFMK(payload) => En1995MutationDsl::ChangeFMK { new_f_m_k: payload.new_f_m_k },
        En1995Mutation::ChangeFC0K(payload) => En1995MutationDsl::ChangeFC0K { new_f_c_0_k: payload.new_f_c_0_k },
        ...
        En1995Mutation::ChangeMCritKnm(payload) => En1995MutationDsl::ChangeMCritKnm { new_m_crit_knm: payload.new_m_crit_knm },
        En1995Mutation::ChangeFEdKn(payload) => En1995MutationDsl::ChangeFEdKn { new_f_ed_kn: payload.new_f_ed_kn },
        En1995Mutation::ChangeAEfMm2(payload) => En1995MutationDsl::ChangeAEfMm2 { new_a_ef_mm2: payload.new_a_ef_mm2 },
        En1995Mutation::ChangeFVK(payload) => En1995MutationDsl::ChangeFVK { new_f_v_k: payload.new_f_v_k },
        En1995Mutation::ChangeFireDurationMin(payload) => En1995MutationDsl::ChangeFireDurationMin { new_fire_duration_min: payload.new_fire_duration_min },
        En1995Mutation::ChangeSectionDepthMm(payload) => En1995MutationDsl::ChangeSectionDepthMm { new_section_depth_mm: payload.new_section_depth_mm },
        En1995Mutation::ChangeAVertMS2(payload) => En1995MutationDsl::ChangeAVertMS2 { new_a_vert_m_s2: payload.new_a_vert_m_s2 },
        En1995Mutation::ChangeNCyclesBridge(payload) => En1995MutationDsl::ChangeNCyclesBridge { new_n_cycles_bridge: payload.new_n_cycles_bridge },
    }
}
