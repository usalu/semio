...
pub fn diff(payload: &ChangeMemberActionKind, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    members[idx].actions[action_idx].kind = payload.new_value.clone();
