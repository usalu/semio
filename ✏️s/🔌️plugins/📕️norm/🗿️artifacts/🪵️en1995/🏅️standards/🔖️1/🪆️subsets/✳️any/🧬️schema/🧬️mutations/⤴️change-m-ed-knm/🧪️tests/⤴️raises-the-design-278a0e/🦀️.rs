//! 🧪️ `change-m-ed-knm` fixture — `⤴️raises-the-design-bending-moment-to-32-knm`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-m-ed-knm/raises-the-design-bending-moment-to-32-knm: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
