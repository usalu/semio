...
//#region 🔖️Diff
pub fn diff(payload: &ChangeFEdKn, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    protocol::MutationOutcome::new(En1995Diff { f_ed_kn: Some(payload.new_f_ed_kn), ..Default::default() })
}
//#endregion 🔖️Diff
