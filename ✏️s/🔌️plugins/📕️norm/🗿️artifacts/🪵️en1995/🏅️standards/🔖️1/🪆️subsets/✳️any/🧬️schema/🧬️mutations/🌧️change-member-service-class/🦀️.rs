//! 🌧️ `change-member-service-class` — changes `serviceClass` (Service class) on one addressed member.
...
pub struct ChangeMemberServiceClass { pub member_id: String, pub new_value: u8 }
impl protocol::MutationKind<En1995Snapshot, En1995Mutation> for ChangeMemberServiceClass {
