...
pub fn diff(payload: &ChangeConnectionSteelPlateThickness, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    connections[idx].steel_plate_thickness_m = payload.new_value;
