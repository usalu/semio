...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-32-knm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-32-knm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-32-knm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-32-knm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-32-knm/🎯️outcome/🔣️.json");
