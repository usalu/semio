...
pub fn diff(payload: &ChangeMemberLateralRestraint, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    members[idx].lateral_restraint_spacing_m = payload.new_value;
