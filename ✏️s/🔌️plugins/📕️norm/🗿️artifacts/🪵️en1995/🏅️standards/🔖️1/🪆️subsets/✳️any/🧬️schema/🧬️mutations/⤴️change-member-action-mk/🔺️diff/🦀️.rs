...
pub fn diff(payload: &ChangeMemberActionMK, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    members[idx].actions[action_idx].m_k_nm = payload.new_value;
