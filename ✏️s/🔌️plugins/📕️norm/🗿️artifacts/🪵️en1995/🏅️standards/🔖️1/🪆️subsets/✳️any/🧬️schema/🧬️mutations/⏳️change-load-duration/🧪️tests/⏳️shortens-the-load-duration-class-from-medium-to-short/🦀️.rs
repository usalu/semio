...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-load-duration/⏳️shortens-the-load-duration-class-from-medium-to-short/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-load-duration/⏳️shortens-the-load-duration-class-from-medium-to-short/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-load-duration/⏳️shortens-the-load-duration-class-from-medium-to-short/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-load-duration/⏳️shortens-the-load-duration-class-from-medium-to-short/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏳️change-load-duration/⏳️shortens-the-load-duration-class-from-medium-to-short/🎯️outcome/🔣️.json");
