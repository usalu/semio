//! 📄️ EN 1995 play app panel — the document headline: family, check count, worst utilization, verdict.
...
//#region 🔖️Constants
pub const BODY_ARTIFACT: &str = "norm.en1995.play.artifact";
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1995Family>, locale: semio_framework_plugin::Locale) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
