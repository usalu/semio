...
impl En1995Artifact {
    pub fn to_snapshot(&self) -> En1995Snapshot {
        En1995Snapshot {
            ...
            h_mm: self.h_mm,
            f_m_k: self.f_m_k,
            f_c_0_k: self.f_c_0_k,
            service_class: self.service_class.clone(),
            load_duration: self.load_duration.clone(),
            m_crit_knm: self.m_crit_knm,
            f_ed_kn: self.f_ed_kn,
            a_ef_mm2: self.a_ef_mm2,
            f_v_k: self.f_v_k,
            fire_duration_min: self.fire_duration_min,
            section_depth_mm: self.section_depth_mm,
            a_vert_m_s2: self.a_vert_m_s2,
            n_cycles_bridge: self.n_cycles_bridge,
        }
    }
...
/// `na_de` re-exports `semio_s_artifact_norm_en1990`'s relocated `NaDe`.
