...
pub fn diff(payload: &ChangeConnectionServiceClass, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    connections[idx].service_class = payload.new_value;
