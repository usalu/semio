//! 🧪️ `change-fc0-k` fixture — `🗜️raises-the-parallel-compressive-strength-to-26-5-mpa`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fc0-k/🗜️raises-the-parallel-compressive-strength-to-26-5-mpa/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fc0-k/🗜️raises-the-parallel-compressive-strength-to-26-5-mpa/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fc0-k/🗜️raises-the-parallel-compressive-strength-to-26-5-mpa/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fc0-k/🗜️raises-the-parallel-compressive-strength-to-26-5-mpa/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fc0-k/🗜️raises-the-parallel-compressive-strength-to-26-5-mpa/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-fc0-k/raises-the-parallel-compressive-strength-to-26-5-mpa: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
