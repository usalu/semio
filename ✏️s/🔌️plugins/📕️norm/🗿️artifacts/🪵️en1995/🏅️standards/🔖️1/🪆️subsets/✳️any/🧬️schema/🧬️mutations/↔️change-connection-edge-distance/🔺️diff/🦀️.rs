...
pub fn diff(payload: &ChangeConnectionEdgeDistance, base: &En1995Snapshot) -> protocol::MutationOutcome<En1995Diff> {
    ...
    connections[idx].edge_distance_m = payload.new_value;
