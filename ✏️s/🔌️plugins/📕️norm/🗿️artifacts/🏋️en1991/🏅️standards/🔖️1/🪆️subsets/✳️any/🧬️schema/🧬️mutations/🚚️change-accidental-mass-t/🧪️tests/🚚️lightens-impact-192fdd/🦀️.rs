//! 🧪️ `change-accidental-mass-t` fixture — `🚚️lightens-impact-vehicle-to-12-5-t` (EN 1991 actions).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-accidental-mass-t/lightens-impact-vehicle-to-12-5-t: produced diff differs from the committed 🔺️diff/🔣️.json");
}
