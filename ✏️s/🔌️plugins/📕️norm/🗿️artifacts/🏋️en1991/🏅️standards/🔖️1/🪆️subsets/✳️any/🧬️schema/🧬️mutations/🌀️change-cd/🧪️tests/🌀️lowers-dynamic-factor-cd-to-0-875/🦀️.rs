//! 🧪️ `change-cd` fixture — `🌀️lowers-dynamic-factor-cd-to-0-875` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-cd/🌀️lowers-dynamic-factor-cd-to-0-875/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-cd/🌀️lowers-dynamic-factor-cd-to-0-875/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-cd/🌀️lowers-dynamic-factor-cd-to-0-875/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-cd/🌀️lowers-dynamic-factor-cd-to-0-875/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌀️change-cd/🌀️lowers-dynamic-factor-cd-to-0-875/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-cd/lowers-dynamic-factor-cd-to-0-875: produced diff differs from the committed 🔺️diff/🔣️.json");
}
