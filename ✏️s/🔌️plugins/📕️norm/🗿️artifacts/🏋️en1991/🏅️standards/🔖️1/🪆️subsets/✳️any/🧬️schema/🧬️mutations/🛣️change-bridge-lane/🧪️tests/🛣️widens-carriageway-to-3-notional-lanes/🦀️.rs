//! 🧪️ `change-bridge-lane` fixture — `🛣️widens-carriageway-to-3-notional-lanes` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-lane/🛣️widens-carriageway-to-3-notional-lanes/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-lane/🛣️widens-carriageway-to-3-notional-lanes/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-lane/🛣️widens-carriageway-to-3-notional-lanes/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-lane/🛣️widens-carriageway-to-3-notional-lanes/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛣️change-bridge-lane/🛣️widens-carriageway-to-3-notional-lanes/🎯️outcome/🔣️.json");
