//! 🧪️ `change-construction-activity` fixture — `🚧️switches-construction-activity-to-concreting` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-construction-activity/🚧️switches-construction-activity-to-concreting/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-construction-activity/🚧️switches-construction-activity-to-concreting/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-construction-activity/🚧️switches-construction-activity-to-concreting/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-construction-activity/🚧️switches-construction-activity-to-concreting/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-construction-activity/🚧️switches-construction-activity-to-concreting/🎯️outcome/🔣️.json");
