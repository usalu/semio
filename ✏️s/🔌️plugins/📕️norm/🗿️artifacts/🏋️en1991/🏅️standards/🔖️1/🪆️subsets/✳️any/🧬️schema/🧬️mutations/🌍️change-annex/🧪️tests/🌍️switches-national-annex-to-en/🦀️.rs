//! 🧪️ `change-annex` fixture — `🌍️switches-national-annex-to-en` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️change-annex/🌍️switches-national-annex-to-en/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️change-annex/🌍️switches-national-annex-to-en/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️change-annex/🌍️switches-national-annex-to-en/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️change-annex/🌍️switches-national-annex-to-en/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️change-annex/🌍️switches-national-annex-to-en/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    assert_eq!(produced.self_weight_material, base.self_weight_material, "change-annex/switches-national-annex-to-en: `self_weight_material` is not addressed by this mutation and must survive untouched");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        let decoded: En1991Snapshot = serde_json::from_str(text).expect("change-annex/switches-national-annex-to-en: snapshot decodes");
...
async fn produces_committed_diff() {
    ...
    assert!(outcome.diff().self_weight_material.is_none(), "change-annex/switches-national-annex-to-en: the diff must leave `self_weight_material` unset");
...
async fn committed_diff_is_canonical() {
    let decoded: En1991Diff = serde_json::from_str(DIFF).expect("change-annex/switches-national-annex-to-en: committed diff decodes");
