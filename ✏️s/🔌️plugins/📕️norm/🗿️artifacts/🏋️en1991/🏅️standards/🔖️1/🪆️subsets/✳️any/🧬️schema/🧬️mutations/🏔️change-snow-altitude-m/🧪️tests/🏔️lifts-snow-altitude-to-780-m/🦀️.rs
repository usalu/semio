//! 🧪️ `change-snow-altitude-m` fixture — `🏔️lifts-snow-altitude-to-780-m` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏔️change-snow-altitude-m/🏔️lifts-snow-altitude-to-780-m/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏔️change-snow-altitude-m/🏔️lifts-snow-altitude-to-780-m/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏔️change-snow-altitude-m/🏔️lifts-snow-altitude-to-780-m/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏔️change-snow-altitude-m/🏔️lifts-snow-altitude-to-780-m/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏔️change-snow-altitude-m/🏔️lifts-snow-altitude-to-780-m/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-snow-altitude-m/lifts-snow-altitude-to-780-m: produced diff differs from the committed 🔺️diff/🔣️.json");
}
