...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️change-fire-resistance-min/⏱️extends-fire-resistance-to-120-min/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️change-fire-resistance-min/⏱️extends-fire-resistance-to-120-min/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️change-fire-resistance-min/⏱️extends-fire-resistance-to-120-min/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️change-fire-resistance-min/⏱️extends-fire-resistance-to-120-min/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⏱️change-fire-resistance-min/⏱️extends-fire-resistance-to-120-min/🎯️outcome/🔣️.json");
