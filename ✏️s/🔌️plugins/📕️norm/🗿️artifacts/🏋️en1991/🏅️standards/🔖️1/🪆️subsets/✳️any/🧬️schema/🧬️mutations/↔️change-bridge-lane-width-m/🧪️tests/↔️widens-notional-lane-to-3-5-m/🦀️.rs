//! 🧪️ `change-bridge-lane-width-m` fixture — `↔️widens-notional-lane-to-3-5-m` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bridge-lane-width-m/↔️widens-notional-lane-to-3-5-m/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bridge-lane-width-m/↔️widens-notional-lane-to-3-5-m/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bridge-lane-width-m/↔️widens-notional-lane-to-3-5-m/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bridge-lane-width-m/↔️widens-notional-lane-to-3-5-m/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-bridge-lane-width-m/↔️widens-notional-lane-to-3-5-m/🎯️outcome/🔣️.json");
