...
use crate::editor::en1991::commands::{evaluate, selected_check, set_active_example, set_snapshot};
...
impl ArtifactEditor for En1991PlayApp {
    ...
    fn examples() -> Vec<semio_framework_plugin::ExampleSource> {
        vec![crate::retail_hydrocarbon_fire::source()]
    }
    ...
    fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, En1991Snapshot>) -> Result<Emit<En1991Mutation, NoConfigMutation, Self::DraftMutation>, MediaError> {
