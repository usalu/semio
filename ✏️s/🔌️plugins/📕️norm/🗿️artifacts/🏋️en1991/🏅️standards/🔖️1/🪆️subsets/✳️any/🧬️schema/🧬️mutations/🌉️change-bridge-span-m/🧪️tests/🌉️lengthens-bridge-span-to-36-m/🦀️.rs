//! 🧪️ `change-bridge-span-m` fixture — `🌉️lengthens-bridge-span-to-36-m` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-span-m/🌉️lengthens-bridge-span-to-36-m/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-span-m/🌉️lengthens-bridge-span-to-36-m/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-span-m/🌉️lengthens-bridge-span-to-36-m/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-span-m/🌉️lengthens-bridge-span-to-36-m/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️change-bridge-span-m/🌉️lengthens-bridge-span-to-36-m/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-bridge-span-m/lengthens-bridge-span-to-36-m: produced diff differs from the committed 🔺️diff/🔣️.json");
}
