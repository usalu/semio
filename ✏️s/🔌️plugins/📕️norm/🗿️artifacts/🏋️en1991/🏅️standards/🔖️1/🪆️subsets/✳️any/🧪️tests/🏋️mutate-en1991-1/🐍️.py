...
VECTORS = {
    "change-area-m2": ("📐️change-area-m2", "enlarges-loaded-area-to-360-m2"),
    "change-category": ("🗂️change-category", "reclassifies-imposed-load-to-category-d"),
    ...
    "change-self-weight-thickness-m": ("📏️change-self-weight-thickness-m", "thickens-self-weight-layer-to-0-375-m"),
    "change-assumed-gk-kn-m2": ("⚖️change-assumed-gk-kn-m2", "raises-assumed-gk-to-7-5-kn-m2"),
    "change-fire-curve": ("🔥️change-fire-curve", "switches-fire-curve-to-hydrocarbon"),
    "change-fire-resistance-min": ("⏱️change-fire-resistance-min", "extends-fire-resistance-to-120-min"),
    "change-fire-member-capacity-c": ("🛡️change-fire-member-capacity-c", "raises-fire-member-capacity-to-700-c"),
    "change-snow-zone": ("🗺️change-snow-zone", "moves-site-to-snow-zone-3"),
    ...
    "change-wind-zone": ("🪁️change-wind-zone", "moves-site-to-wind-zone-4"),
    "change-en-vbms": ("🌬️change-en-vbms", "raises-en-basic-wind-speed-to-30-m-s"),
    "change-delta-tk": ("🌡️change-delta-tk", "raises-thermal-delta-tk-to-45-k"),
    "change-construction-activity": ("🚧️change-construction-activity", "switches-construction-activity-to-concreting"),
    ...
    "change-bridge-span-m": ("🌉️change-bridge-span-m", "lengthens-bridge-span-to-36-m"),
    "change-bridge-lane-width-m": ("↔️change-bridge-lane-width-m", "widens-notional-lane-to-3-5-m"),
    "change-bridge-moment-resistance-knm": ("💪️change-bridge-moment-resistance-knm", "raises-bridge-moment-resistance-to-4500-knm"),
    "change-crane-class": ("🏗️change-crane-class", "upgrades-crane-to-class-hc3"),
    "change-hoist-class": ("🏷️change-hoist-class", "upgrades-hoist-to-class-hc4"),
    "change-hoisting-speed-ms": ("🪝️change-hoisting-speed-ms", "speeds-hoisting-to-1-25-m-s"),
    "change-silo-bulk-density-kn-m3": ("🌾️change-silo-bulk-density-kn-m3", "raises-silo-bulk-density-to-10-5-kn-m3"),
    "change-silo-height-m": ("🗼️change-silo-height-m", "raises-silo-to-18-m"),
    "change-silo-hydraulic-radius-m": ("⭕️change-silo-hydraulic-radius-m", "widens-silo-hydraulic-radius-to-2-25-m"),
    "change-silo-mu": ("🧲️change-silo-mu", "raises-silo-wall-friction-mu-to-0-625"),
    "change-silo-k": ("⚙️change-silo-k", "raises-silo-lateral-pressure-ratio-k-to-0-625"),
    "change-cs": ("🔎️change-cs", "raises-size-factor-cs-to-1-125"),
    "change-cd": ("🌀️change-cd", "lowers-dynamic-factor-cd-to-0-875"),
}
