//! 🧪️ `change-hoist-class` fixture — `🏷️upgrades-hoist-to-class-hc4` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-hoist-class/🏷️upgrades-hoist-to-class-hc4/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-hoist-class/🏷️upgrades-hoist-to-class-hc4/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-hoist-class/🏷️upgrades-hoist-to-class-hc4/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-hoist-class/🏷️upgrades-hoist-to-class-hc4/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-hoist-class/🏷️upgrades-hoist-to-class-hc4/🎯️outcome/🔣️.json");
