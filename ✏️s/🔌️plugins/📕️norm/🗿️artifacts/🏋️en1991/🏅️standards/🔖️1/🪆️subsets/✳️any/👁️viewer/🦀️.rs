...
use crate::{EN1991_DIALECT, EN1991_DOCUMENT_SCHEMA};
...
mod tests {
    ...
    async fn create_en1991_viewer_builds_a_definition_for_this_dialect() {
    ...
    async fn an_unknown_body_key_falls_back_to_a_text_node() {
        ...
        let json = semio_framework_plugin::testkit::project_and_retire_fixture_tree(<En1991Viewer as ArtifactViewer>::render("nope", &doc, &ConfigView { snapshot: &NoConfig::default() }).expect("viewer assembly")).expect("json");
