...
Feature: Apply every typed EN 1991 mutation against an independent Python implementation
  ...
  `📚️examples/🔥️retail-hydrocarbon-fire/🖼️assets/🔥️retail-hydrocarbon-fire/🗣️.dsl.semio` — a named
  ...
  Scenario: Re-emit the real committed EN 1991 document from the parsed carrier
    Given the real committed text artifact asset://📚️examples/🔥️retail-hydrocarbon-fire/🖼️assets/🔥️retail-hydrocarbon-fire/🗣️.dsl.semio
