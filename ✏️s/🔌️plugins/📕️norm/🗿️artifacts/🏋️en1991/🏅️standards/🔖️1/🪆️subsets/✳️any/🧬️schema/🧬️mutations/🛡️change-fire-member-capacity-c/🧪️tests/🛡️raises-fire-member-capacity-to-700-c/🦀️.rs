...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-fire-member-capacity-c/🛡️raises-fire-member-capacity-to-700-c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-fire-member-capacity-c/🛡️raises-fire-member-capacity-to-700-c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-fire-member-capacity-c/🛡️raises-fire-member-capacity-to-700-c/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-fire-member-capacity-c/🛡️raises-fire-member-capacity-to-700-c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️change-fire-member-capacity-c/🛡️raises-fire-member-capacity-to-700-c/🎯️outcome/🔣️.json");
