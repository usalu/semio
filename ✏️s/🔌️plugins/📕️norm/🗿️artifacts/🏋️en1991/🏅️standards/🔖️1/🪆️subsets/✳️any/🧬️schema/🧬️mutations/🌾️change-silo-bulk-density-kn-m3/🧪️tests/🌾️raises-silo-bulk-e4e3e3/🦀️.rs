//! 🧪️ `change-silo-bulk-density-kn-m3` fixture — `🌾️raises-silo-bulk-density-to-10-5-kn-m3` (EN 1991 actions).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-silo-bulk-density-kn-m3/raises-silo-bulk-density-to-10-5-kn-m3: produced diff differs from the committed 🔺️diff/🔣️.json");
}
