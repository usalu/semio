...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💪️change-bridge-moment-resistance-knm/💪️raises-bridge-moment-resistance-to-4500-knm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💪️change-bridge-moment-resistance-knm/💪️raises-bridge-moment-resistance-to-4500-knm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💪️change-bridge-moment-resistance-knm/💪️raises-bridge-moment-resistance-to-4500-knm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💪️change-bridge-moment-resistance-knm/💪️raises-bridge-moment-resistance-to-4500-knm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💪️change-bridge-moment-resistance-knm/💪️raises-bridge-moment-resistance-to-4500-knm/🎯️outcome/🔣️.json");
