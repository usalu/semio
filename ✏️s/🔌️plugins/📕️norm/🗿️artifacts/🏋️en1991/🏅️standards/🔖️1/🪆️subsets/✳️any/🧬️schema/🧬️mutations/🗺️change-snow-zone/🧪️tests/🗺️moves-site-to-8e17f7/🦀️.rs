//! 🧪️ `change-snow-zone` fixture — `🗺️moves-site-to-snow-zone-3` (EN 1991 actions).
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-snow-zone/moves-site-to-snow-zone-3: produced diff differs from the committed 🔺️diff/🔣️.json");
}
