//! 🧪️ `change-hoisting-speed-ms` fixture — `🪝️speeds-hoisting-to-1-25-m-s` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-hoisting-speed-ms/🪝️speeds-hoisting-to-1-25-m-s/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-hoisting-speed-ms/🪝️speeds-hoisting-to-1-25-m-s/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-hoisting-speed-ms/🪝️speeds-hoisting-to-1-25-m-s/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-hoisting-speed-ms/🪝️speeds-hoisting-to-1-25-m-s/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️change-hoisting-speed-ms/🪝️speeds-hoisting-to-1-25-m-s/🎯️outcome/🔣️.json");
