//! 🧪️ `change-silo-k` fixture — `⚙️raises-silo-lateral-pressure-ratio-k-to-0-625` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-silo-k/⚙️raises-silo-lateral-pressure-ratio-k-to-0-625/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-silo-k/⚙️raises-silo-lateral-pressure-ratio-k-to-0-625/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-silo-k/⚙️raises-silo-lateral-pressure-ratio-k-to-0-625/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-silo-k/⚙️raises-silo-lateral-pressure-ratio-k-to-0-625/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️change-silo-k/⚙️raises-silo-lateral-pressure-ratio-k-to-0-625/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-silo-k/raises-silo-lateral-pressure-ratio-k-to-0-625: produced diff differs from the committed 🔺️diff/🔣️.json");
}
