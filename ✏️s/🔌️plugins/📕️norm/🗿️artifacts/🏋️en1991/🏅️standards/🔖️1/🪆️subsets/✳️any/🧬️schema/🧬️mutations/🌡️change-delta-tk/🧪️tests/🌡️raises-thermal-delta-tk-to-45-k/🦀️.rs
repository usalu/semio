//! 🧪️ `change-delta-tk` fixture — `🌡️raises-thermal-delta-tk-to-45-k` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-delta-tk/🌡️raises-thermal-delta-tk-to-45-k/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-delta-tk/🌡️raises-thermal-delta-tk-to-45-k/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-delta-tk/🌡️raises-thermal-delta-tk-to-45-k/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-delta-tk/🌡️raises-thermal-delta-tk-to-45-k/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️change-delta-tk/🌡️raises-thermal-delta-tk-to-45-k/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-delta-tk/raises-thermal-delta-tk-to-45-k: produced diff differs from the committed 🔺️diff/🔣️.json");
}
