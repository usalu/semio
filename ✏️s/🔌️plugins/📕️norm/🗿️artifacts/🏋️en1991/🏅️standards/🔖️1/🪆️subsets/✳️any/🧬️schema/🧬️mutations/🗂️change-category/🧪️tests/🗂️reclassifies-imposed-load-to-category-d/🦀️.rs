//! 🧪️ `change-category` fixture — `🗂️reclassifies-imposed-load-to-category-d` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️change-category/🗂️reclassifies-imposed-load-to-category-d/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️change-category/🗂️reclassifies-imposed-load-to-category-d/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️change-category/🗂️reclassifies-imposed-load-to-category-d/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️change-category/🗂️reclassifies-imposed-load-to-category-d/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️change-category/🗂️reclassifies-imposed-load-to-category-d/🎯️outcome/🔣️.json");
