...
//#region 🏷️WireTags
/// 🏷️ Op tags of `En1991Mutation`, derived from the `record <kind> tag=<n>` lines of its `📡️.protocol.semio`.
const WIRE_PROTOCOL: &str = include_str!("../💾️binary/📡️.protocol.semio");
const TAG_CHANGE_AREA_M2: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-area-m2");
...
const TAG_CHANGE_SELF_WEIGHT_MATERIAL: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-self-weight-material");
const TAG_CHANGE_SELF_WEIGHT_THICKNESS_M: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-self-weight-thickness-m");
const TAG_CHANGE_ASSUMED_GK_KN_M2: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-assumed-gk-kn-m2");
const TAG_CHANGE_FIRE_CURVE: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-fire-curve");
const TAG_CHANGE_FIRE_RESISTANCE_MIN: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-fire-resistance-min");
const TAG_CHANGE_FIRE_MEMBER_CAPACITY_C: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-fire-member-capacity-c");
const TAG_CHANGE_SNOW_ZONE: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-snow-zone");
const TAG_CHANGE_SNOW_ALTITUDE_M: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-snow-altitude-m");
const TAG_CHANGE_EN_SK_KN_M2: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-en-sk-kn-m2");
const TAG_CHANGE_WIND_ZONE: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-wind-zone");
const TAG_CHANGE_EN_VBMS: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-en-vbms");
const TAG_CHANGE_DELTA_TK: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-delta-tk");
const TAG_CHANGE_CONSTRUCTION_ACTIVITY: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-construction-activity");
const TAG_CHANGE_ACCIDENTAL_MASS_T: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-accidental-mass-t");
const TAG_CHANGE_ACCIDENTAL_SPEED_KM_H: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-accidental-speed-km-h");
const TAG_CHANGE_BRIDGE_LANE: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-bridge-lane");
const TAG_CHANGE_BRIDGE_SPAN_M: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-bridge-span-m");
const TAG_CHANGE_BRIDGE_LANE_WIDTH_M: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-bridge-lane-width-m");
const TAG_CHANGE_BRIDGE_MOMENT_RESISTANCE_KNM: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-bridge-moment-resistance-knm");
const TAG_CHANGE_CRANE_CLASS: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-crane-class");
const TAG_CHANGE_HOIST_CLASS: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-hoist-class");
const TAG_CHANGE_HOISTING_SPEED_MS: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-hoisting-speed-ms");
const TAG_CHANGE_SILO_BULK_DENSITY_KN_M3: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-silo-bulk-density-kn-m3");
const TAG_CHANGE_SILO_HEIGHT_M: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-silo-height-m");
const TAG_CHANGE_SILO_HYDRAULIC_RADIUS_M: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-silo-hydraulic-radius-m");
const TAG_CHANGE_SILO_MU: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-silo-mu");
const TAG_CHANGE_SILO_K: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-silo-k");
const TAG_CHANGE_CS: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-cs");
const TAG_CHANGE_CD: u8 = dsl::protocol_record::tag_u8(WIRE_PROTOCOL, "change-cd");
//#endregion 🏷️WireTags

impl protocol::OpBinary for En1991Mutation {
    fn encode_op(&self) -> Result<Vec<u8>, protocol::ProtocolError> {
        let tag: u8 = match self {
            En1991Mutation::ChangeAreaM2(_) => TAG_CHANGE_AREA_M2,
            En1991Mutation::ChangeCategory(_) => TAG_CHANGE_CATEGORY,
            En1991Mutation::ChangeAnnex(_) => TAG_CHANGE_ANNEX,
            En1991Mutation::ChangeSelfWeightMaterial(_) => TAG_CHANGE_SELF_WEIGHT_MATERIAL,
            En1991Mutation::ChangeSelfWeightThicknessM(_) => TAG_CHANGE_SELF_WEIGHT_THICKNESS_M,
            En1991Mutation::ChangeAssumedGKKnM2(_) => TAG_CHANGE_ASSUMED_GK_KN_M2,
            En1991Mutation::ChangeFireCurve(_) => TAG_CHANGE_FIRE_CURVE,
            En1991Mutation::ChangeFireResistanceMin(_) => TAG_CHANGE_FIRE_RESISTANCE_MIN,
            En1991Mutation::ChangeFireMemberCapacityC(_) => TAG_CHANGE_FIRE_MEMBER_CAPACITY_C,
            En1991Mutation::ChangeSnowZone(_) => TAG_CHANGE_SNOW_ZONE,
            En1991Mutation::ChangeSnowAltitudeM(_) => TAG_CHANGE_SNOW_ALTITUDE_M,
            En1991Mutation::ChangeEnSKKnM2(_) => TAG_CHANGE_EN_SK_KN_M2,
            En1991Mutation::ChangeWindZone(_) => TAG_CHANGE_WIND_ZONE,
            En1991Mutation::ChangeEnVBMS(_) => TAG_CHANGE_EN_VBMS,
            En1991Mutation::ChangeDeltaTK(_) => TAG_CHANGE_DELTA_TK,
            En1991Mutation::ChangeConstructionActivity(_) => TAG_CHANGE_CONSTRUCTION_ACTIVITY,
            En1991Mutation::ChangeAccidentalMassT(_) => TAG_CHANGE_ACCIDENTAL_MASS_T,
            En1991Mutation::ChangeAccidentalSpeedKmH(_) => TAG_CHANGE_ACCIDENTAL_SPEED_KM_H,
            En1991Mutation::ChangeBridgeLane(_) => TAG_CHANGE_BRIDGE_LANE,
            En1991Mutation::ChangeBridgeSpanM(_) => TAG_CHANGE_BRIDGE_SPAN_M,
            En1991Mutation::ChangeBridgeLaneWidthM(_) => TAG_CHANGE_BRIDGE_LANE_WIDTH_M,
            En1991Mutation::ChangeBridgeMomentResistanceKnm(_) => TAG_CHANGE_BRIDGE_MOMENT_RESISTANCE_KNM,
            En1991Mutation::ChangeCraneClass(_) => TAG_CHANGE_CRANE_CLASS,
            En1991Mutation::ChangeHoistClass(_) => TAG_CHANGE_HOIST_CLASS,
            En1991Mutation::ChangeHoistingSpeedMS(_) => TAG_CHANGE_HOISTING_SPEED_MS,
            En1991Mutation::ChangeSiloBulkDensityKnM3(_) => TAG_CHANGE_SILO_BULK_DENSITY_KN_M3,
            En1991Mutation::ChangeSiloHeightM(_) => TAG_CHANGE_SILO_HEIGHT_M,
            En1991Mutation::ChangeSiloHydraulicRadiusM(_) => TAG_CHANGE_SILO_HYDRAULIC_RADIUS_M,
            En1991Mutation::ChangeSiloMu(_) => TAG_CHANGE_SILO_MU,
            En1991Mutation::ChangeSiloK(_) => TAG_CHANGE_SILO_K,
            En1991Mutation::ChangeCS(_) => TAG_CHANGE_CS,
            En1991Mutation::ChangeCD(_) => TAG_CHANGE_CD,
        };
    ...
    fn decode_op(bytes: &[u8]) -> Result<Self, protocol::ProtocolError> {
        ...
        match tag {
            TAG_CHANGE_AREA_M2 => Ok(En1991Mutation::ChangeAreaM2(ChangeAreaM2 { new_area_m2: reader.read_f64_le().map_err(|e| malformed("new_area_m2", reader.position(), e.to_string()))? })),
            TAG_CHANGE_CATEGORY => Ok(En1991Mutation::ChangeCategory(ChangeCategory { new_category: read_json_bin(&mut reader).map_err(|e| malformed("new_category", reader.position(), e))? })),
            TAG_CHANGE_ANNEX => Ok(En1991Mutation::ChangeAnnex(ChangeAnnex { new_annex: read_json_bin(&mut reader).map_err(|e| malformed("new_annex", reader.position(), e))? })),
            TAG_CHANGE_SELF_WEIGHT_MATERIAL => Ok(En1991Mutation::ChangeSelfWeightMaterial(ChangeSelfWeightMaterial { new_self_weight_material: read_str_bin(&mut reader).map_err(|e| malformed("new_self_weight_material", reader.position(), e))? })),
            TAG_CHANGE_SELF_WEIGHT_THICKNESS_M => Ok(En1991Mutation::ChangeSelfWeightThicknessM(ChangeSelfWeightThicknessM { new_self_weight_thickness_m: reader.read_f64_le().map_err(|e| malformed("new_self_weight_thickness_m", reader.position(), e.to_string()))? })),
            TAG_CHANGE_ASSUMED_GK_KN_M2 => Ok(En1991Mutation::ChangeAssumedGKKnM2(ChangeAssumedGKKnM2 { new_assumed_g_k_kn_m2: reader.read_f64_le().map_err(|e| malformed("new_assumed_g_k_kn_m2", reader.position(), e.to_string()))? })),
            TAG_CHANGE_FIRE_CURVE => Ok(En1991Mutation::ChangeFireCurve(ChangeFireCurve { new_fire_curve: read_json_bin(&mut reader).map_err(|e| malformed("new_fire_curve", reader.position(), e))? })),
            TAG_CHANGE_FIRE_RESISTANCE_MIN => Ok(En1991Mutation::ChangeFireResistanceMin(ChangeFireResistanceMin { new_fire_resistance_min: reader.read_f64_le().map_err(|e| malformed("new_fire_resistance_min", reader.position(), e.to_string()))? })),
            TAG_CHANGE_FIRE_MEMBER_CAPACITY_C => Ok(En1991Mutation::ChangeFireMemberCapacityC(ChangeFireMemberCapacityC { new_fire_member_capacity_c: reader.read_f64_le().map_err(|e| malformed("new_fire_member_capacity_c", reader.position(), e.to_string()))? })),
            TAG_CHANGE_SNOW_ZONE => Ok(En1991Mutation::ChangeSnowZone(ChangeSnowZone { new_snow_zone: reader.read_u8().map_err(|e| malformed("new_snow_zone", reader.position(), e.to_string()))? })),
            TAG_CHANGE_SNOW_ALTITUDE_M => Ok(En1991Mutation::ChangeSnowAltitudeM(ChangeSnowAltitudeM { new_snow_altitude_m: reader.read_f64_le().map_err(|e| malformed("new_snow_altitude_m", reader.position(), e.to_string()))? })),
            TAG_CHANGE_EN_SK_KN_M2 => Ok(En1991Mutation::ChangeEnSKKnM2(ChangeEnSKKnM2 { new_en_s_k_kn_m2: reader.read_f64_le().map_err(|e| malformed("new_en_s_k_kn_m2", reader.position(), e.to_string()))? })),
            TAG_CHANGE_WIND_ZONE => Ok(En1991Mutation::ChangeWindZone(ChangeWindZone { new_wind_zone: reader.read_u8().map_err(|e| malformed("new_wind_zone", reader.position(), e.to_string()))? })),
            TAG_CHANGE_EN_VBMS => Ok(En1991Mutation::ChangeEnVBMS(ChangeEnVBMS { new_en_v_b_m_s: reader.read_f64_le().map_err(|e| malformed("new_en_v_b_m_s", reader.position(), e.to_string()))? })),
            TAG_CHANGE_DELTA_TK => Ok(En1991Mutation::ChangeDeltaTK(ChangeDeltaTK { new_delta_t_k: reader.read_f64_le().map_err(|e| malformed("new_delta_t_k", reader.position(), e.to_string()))? })),
            TAG_CHANGE_CONSTRUCTION_ACTIVITY => Ok(En1991Mutation::ChangeConstructionActivity(ChangeConstructionActivity { new_construction_activity: read_str_bin(&mut reader).map_err(|e| malformed("new_construction_activity", reader.position(), e))? })),
            TAG_CHANGE_ACCIDENTAL_MASS_T => Ok(En1991Mutation::ChangeAccidentalMassT(ChangeAccidentalMassT { new_accidental_mass_t: reader.read_f64_le().map_err(|e| malformed("new_accidental_mass_t", reader.position(), e.to_string()))? })),
            TAG_CHANGE_ACCIDENTAL_SPEED_KM_H => Ok(En1991Mutation::ChangeAccidentalSpeedKmH(ChangeAccidentalSpeedKmH { new_accidental_speed_km_h: reader.read_f64_le().map_err(|e| malformed("new_accidental_speed_km_h", reader.position(), e.to_string()))? })),
            TAG_CHANGE_BRIDGE_LANE => Ok(En1991Mutation::ChangeBridgeLane(ChangeBridgeLane { new_bridge_lane: reader.read_u8().map_err(|e| malformed("new_bridge_lane", reader.position(), e.to_string()))? })),
            TAG_CHANGE_BRIDGE_SPAN_M => Ok(En1991Mutation::ChangeBridgeSpanM(ChangeBridgeSpanM { new_bridge_span_m: reader.read_f64_le().map_err(|e| malformed("new_bridge_span_m", reader.position(), e.to_string()))? })),
            TAG_CHANGE_BRIDGE_LANE_WIDTH_M => Ok(En1991Mutation::ChangeBridgeLaneWidthM(ChangeBridgeLaneWidthM { new_bridge_lane_width_m: reader.read_f64_le().map_err(|e| malformed("new_bridge_lane_width_m", reader.position(), e.to_string()))? })),
            TAG_CHANGE_BRIDGE_MOMENT_RESISTANCE_KNM => Ok(En1991Mutation::ChangeBridgeMomentResistanceKnm(ChangeBridgeMomentResistanceKnm {
            ...
            TAG_CHANGE_CRANE_CLASS => Ok(En1991Mutation::ChangeCraneClass(ChangeCraneClass { new_crane_class: read_str_bin(&mut reader).map_err(|e| malformed("new_crane_class", reader.position(), e))? })),
            TAG_CHANGE_HOIST_CLASS => Ok(En1991Mutation::ChangeHoistClass(ChangeHoistClass { new_hoist_class: read_str_bin(&mut reader).map_err(|e| malformed("new_hoist_class", reader.position(), e))? })),
            TAG_CHANGE_HOISTING_SPEED_MS => Ok(En1991Mutation::ChangeHoistingSpeedMS(ChangeHoistingSpeedMS { new_hoisting_speed_m_s: reader.read_f64_le().map_err(|e| malformed("new_hoisting_speed_m_s", reader.position(), e.to_string()))? })),
            TAG_CHANGE_SILO_BULK_DENSITY_KN_M3 => Ok(En1991Mutation::ChangeSiloBulkDensityKnM3(ChangeSiloBulkDensityKnM3 { new_silo_bulk_density_kn_m3: reader.read_f64_le().map_err(|e| malformed("new_silo_bulk_density_kn_m3", reader.position(), e.to_string()))? })),
            TAG_CHANGE_SILO_HEIGHT_M => Ok(En1991Mutation::ChangeSiloHeightM(ChangeSiloHeightM { new_silo_height_m: reader.read_f64_le().map_err(|e| malformed("new_silo_height_m", reader.position(), e.to_string()))? })),
            TAG_CHANGE_SILO_HYDRAULIC_RADIUS_M => Ok(En1991Mutation::ChangeSiloHydraulicRadiusM(ChangeSiloHydraulicRadiusM { new_silo_hydraulic_radius_m: reader.read_f64_le().map_err(|e| malformed("new_silo_hydraulic_radius_m", reader.position(), e.to_string()))? })),
            TAG_CHANGE_SILO_MU => Ok(En1991Mutation::ChangeSiloMu(ChangeSiloMu { new_silo_mu: reader.read_f64_le().map_err(|e| malformed("new_silo_mu", reader.position(), e.to_string()))? })),
            TAG_CHANGE_SILO_K => Ok(En1991Mutation::ChangeSiloK(ChangeSiloK { new_silo_k: reader.read_f64_le().map_err(|e| malformed("new_silo_k", reader.position(), e.to_string()))? })),
            TAG_CHANGE_CS => Ok(En1991Mutation::ChangeCS(ChangeCS { new_c_s: reader.read_f64_le().map_err(|e| malformed("new_c_s", reader.position(), e.to_string()))? })),
            TAG_CHANGE_CD => Ok(En1991Mutation::ChangeCD(ChangeCD { new_c_d: reader.read_f64_le().map_err(|e| malformed("new_c_d", reader.position(), e.to_string()))? })),
