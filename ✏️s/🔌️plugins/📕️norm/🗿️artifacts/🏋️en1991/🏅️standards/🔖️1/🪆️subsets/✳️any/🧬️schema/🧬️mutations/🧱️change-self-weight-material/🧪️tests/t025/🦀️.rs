//! 🧪️ `change-self-weight-material` fixture — `🧱️switches-self-weight-material-to-structural-steel` (EN 1991 actions).
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-self-weight-material/switches-self-weight-material-to-structural-steel: produced diff differs from the committed 🔺️diff/🔣️.json");
}
