...
//#region 🔖️Handler
pub fn handle(payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, En1991Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1991Mutation, NormConfigMutation>, Fault> {
    crate::app_surface::commit_selected_check_index::<En1991Mutation>(payload.index)
}
//#endregion 🔖️Handler
