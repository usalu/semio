...
pub fn handle(_payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, En1991Snapshot>, _cfg: &ConfigView<'_, NoConfig>) -> Result<Emit<En1991Mutation, NoConfigMutation>, Fault> {
    Ok(Emit::default())
}
//#endregion 🔖️Handler
