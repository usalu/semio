//! 📥️ EN 1991 play app — the inputs window: the raw compliance document, rendered as JSON.
...
//#region 🔖️Render
pub fn render(document: &En1991Snapshot) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
