//! 🧪️ `change-crane-class` fixture — `🏗️upgrades-crane-to-class-hc3` (EN 1991 actions).
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-crane-class/🏗️upgrades-crane-to-class-hc3/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-crane-class/🏗️upgrades-crane-to-class-hc3/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-crane-class/🏗️upgrades-crane-to-class-hc3/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-crane-class/🏗️upgrades-crane-to-class-hc3/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏗️change-crane-class/🏗️upgrades-crane-to-class-hc3/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-crane-class/upgrades-crane-to-class-hc3: produced diff differs from the committed 🔺️diff/🔣️.json");
}
