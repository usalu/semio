//! 🧪️ `change-h-ed-kn` fixture — `↔️raises-the-design-sliding-force-to-26-kn`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-h-ed-kn/↔️raises-the-design-sliding-force-to-26-kn/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-h-ed-kn/↔️raises-the-design-sliding-force-to-26-kn/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-h-ed-kn/↔️raises-the-design-sliding-force-to-26-kn/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-h-ed-kn/↔️raises-the-design-sliding-force-to-26-kn/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️change-h-ed-kn/↔️raises-the-design-sliding-force-to-26-kn/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-h-ed-kn/raises-the-design-sliding-force-to-26-kn: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
