...
pub fn diff(payload: &ChangeQKSnow, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    ...
    walls[payload.wall_index].load_cases[payload.index].q_k_snow_pa = payload.new_q_k_snow_pa;
