...
pub fn diff(payload: &ChangeSlabBearingDepth, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.index].slab_bearing_depth_m = payload.new_slab_bearing_depth_m;
