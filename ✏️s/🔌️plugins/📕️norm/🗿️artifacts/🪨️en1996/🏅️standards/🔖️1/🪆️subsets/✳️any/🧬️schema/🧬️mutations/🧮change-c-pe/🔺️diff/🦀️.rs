...
pub fn diff(payload: &ChangeCPe, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    ...
    walls[payload.wall_index].load_cases[payload.index].c_pe = payload.new_c_pe;
