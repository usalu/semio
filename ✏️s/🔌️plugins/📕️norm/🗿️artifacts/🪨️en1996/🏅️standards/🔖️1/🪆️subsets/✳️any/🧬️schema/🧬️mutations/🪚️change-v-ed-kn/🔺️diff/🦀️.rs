...
//#region 🔖️Diff
pub fn diff(payload: &ChangeVEdKn, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    ...
    protocol::MutationOutcome::new(En1996Diff { v_ed_kn: Some(payload.new_v_ed_kn), ..Default::default() })
}
//#endregion 🔖️Diff
