...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-resistance-min/🔥️raises-the-fire-resistance-requirement-from-r60-to-r90/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-resistance-min/🔥️raises-the-fire-resistance-requirement-from-r60-to-r90/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-resistance-min/🔥️raises-the-fire-resistance-requirement-from-r60-to-r90/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-resistance-min/🔥️raises-the-fire-resistance-requirement-from-r60-to-r90/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔥️change-fire-resistance-min/🔥️raises-the-fire-resistance-requirement-from-r60-to-r90/🎯️outcome/🔣️.json");
...
async fn raises_the_fire_resistance_requirement_from_r60_to_r90() {
...
#[semio_framework_async_macros::async_test]
async fn returning_to_r60_restores_before() {
    let base = before();
