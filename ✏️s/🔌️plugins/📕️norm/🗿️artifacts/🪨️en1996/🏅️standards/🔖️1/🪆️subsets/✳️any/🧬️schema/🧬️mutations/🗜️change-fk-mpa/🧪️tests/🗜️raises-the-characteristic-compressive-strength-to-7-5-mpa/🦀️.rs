...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fk-mpa/🗜️raises-the-characteristic-compressive-strength-to-7-5-mpa/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fk-mpa/🗜️raises-the-characteristic-compressive-strength-to-7-5-mpa/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fk-mpa/🗜️raises-the-characteristic-compressive-strength-to-7-5-mpa/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fk-mpa/🗜️raises-the-characteristic-compressive-strength-to-7-5-mpa/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-fk-mpa/🗜️raises-the-characteristic-compressive-strength-to-7-5-mpa/🎯️outcome/🔣️.json");
...
async fn raises_the_characteristic_compressive_strength_to_7_5_mpa() {
...
/// `f_k_mpa`.
#[semio_framework_async_macros::async_test]
async fn restoring_5_mpa_restores_before() {
    let base = before();
