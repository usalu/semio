...
pub fn diff(payload: &ChangeFm, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.index].mortar_strength_pa = payload.new_mortar_strength_pa;
