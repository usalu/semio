...
pub fn diff(payload: &ChangeOpeningHeight, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.wall_index].openings[payload.index].height_m = payload.new_height_m;
