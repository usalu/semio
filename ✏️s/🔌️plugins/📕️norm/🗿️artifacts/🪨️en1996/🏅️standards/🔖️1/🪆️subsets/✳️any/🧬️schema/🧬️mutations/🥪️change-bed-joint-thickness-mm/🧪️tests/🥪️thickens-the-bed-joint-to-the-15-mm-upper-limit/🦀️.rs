...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥪️change-bed-joint-thickness-mm/🥪️thickens-the-bed-joint-to-the-15-mm-upper-limit/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥪️change-bed-joint-thickness-mm/🥪️thickens-the-bed-joint-to-the-15-mm-upper-limit/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥪️change-bed-joint-thickness-mm/🥪️thickens-the-bed-joint-to-the-15-mm-upper-limit/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥪️change-bed-joint-thickness-mm/🥪️thickens-the-bed-joint-to-the-15-mm-upper-limit/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥪️change-bed-joint-thickness-mm/🥪️thickens-the-bed-joint-to-the-15-mm-upper-limit/🎯️outcome/🔣️.json");
...
async fn thickens_the_bed_joint_to_the_15_mm_upper_limit() {
...
#[semio_framework_async_macros::async_test]
async fn restoring_12_mm_restores_before() {
    let base = before();
