...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️change-v-ed-kn/🪚️raises-the-design-shear-force-to-48-kn/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️change-v-ed-kn/🪚️raises-the-design-shear-force-to-48-kn/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️change-v-ed-kn/🪚️raises-the-design-shear-force-to-48-kn/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️change-v-ed-kn/🪚️raises-the-design-shear-force-to-48-kn/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️change-v-ed-kn/🪚️raises-the-design-shear-force-to-48-kn/🎯️outcome/🔣️.json");
...
async fn raises_the_design_shear_force_to_48_kn() {
...
/// `v_ed_kn`.
#[semio_framework_async_macros::async_test]
async fn restoring_35_kn_restores_before() {
    let base = before();
