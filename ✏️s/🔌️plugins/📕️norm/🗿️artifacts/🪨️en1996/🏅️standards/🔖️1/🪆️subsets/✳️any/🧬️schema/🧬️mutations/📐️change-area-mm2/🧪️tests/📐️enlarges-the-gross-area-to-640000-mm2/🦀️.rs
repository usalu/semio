//! 🧪️ `change-area-mm2` fixture — `📐️enlarges-the-gross-area-to-640000-mm2`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-area-mm2/📐️enlarges-the-gross-area-to-640000-mm2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-area-mm2/📐️enlarges-the-gross-area-to-640000-mm2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-area-mm2/📐️enlarges-the-gross-area-to-640000-mm2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-area-mm2/📐️enlarges-the-gross-area-to-640000-mm2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-area-mm2/📐️enlarges-the-gross-area-to-640000-mm2/🎯️outcome/🔣️.json");
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(
        ...
        None,
        "change-area-mm2/enlarges-the-gross-area-to-640000-mm2: the payload is a finite number, so the `is_finite` fatal guard stays shut, and 640000.0 differs from the committed 500000.0, so the `mutation.no-op` warning guard stays shut too"
    );
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-area-mm2/enlarges-the-gross-area-to-640000-mm2: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
