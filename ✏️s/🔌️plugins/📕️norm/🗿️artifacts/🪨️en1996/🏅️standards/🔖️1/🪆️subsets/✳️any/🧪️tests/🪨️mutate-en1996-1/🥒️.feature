...
Feature: Apply every typed EN 1996 mutation against an independent Python implementation
  ...
  `📚️examples/🧱️loadbearing-wall/🖼️assets/🧱️loadbearing-wall/🗣️.dsl.semio` — a named load-bearing
  ...
  Scenario Outline: Apply <id> to its committed specification vector
    ...
    Examples:
      | id                            | dir                            | fixture                                                   |
      | change-m-ed-knm               | ⤴️change-m-ed-knm               | ⤴️raises-the-design-bending-moment-to-12-5-knm              |
      | change-n-ed-kn                | 🏋️change-n-ed-kn                | 🏋️raises-the-design-axial-force-to-320-kn                   |
      | change-v-ed-kn                | 🪚️change-v-ed-kn                | 🪚️raises-the-design-shear-force-to-48-kn                    |
      | change-h-ed-kn                | ↔️change-h-ed-kn               | ↔️raises-the-design-sliding-force-to-26-kn                  |
      | change-z-mm3                  | 📊️change-z-mm3                 | 📊️raises-the-section-modulus-to-9500000-mm3                 |
      | change-area-mm2               | 📐️change-area-mm2              | 📐️enlarges-the-gross-area-to-640000-mm2                     |
      | change-shear-area-mm2         | 🧩️change-shear-area-mm2         | 🧩️enlarges-the-shear-area-to-384000-mm2                     |
      | change-fk-mpa                 | 🗜️change-fk-mpa                 | 🗜️raises-the-characteristic-compressive-strength-to-7-5-mpa |
      | change-f-vk-mpa               | ✂️change-f-vk-mpa              | ✂️raises-the-characteristic-shear-strength-to-0-375-mpa     |
      | change-annex                  | 🌍️change-annex                  | 🌍️switches-from-the-german-na-to-the-recommended-en-annex   |
      | change-masonry-class          | 🏭️change-masonry-class         | 🏭️downgrades-manufacturing-control-to-class-4               |
      ...
      | change-wall-thickness-mm      | 🧱️change-wall-thickness-mm      | 🧱️thickens-the-wall-to-300-mm                               |
      | change-fire-resistance-min    | 🔥️change-fire-resistance-min    | 🔥️raises-the-fire-resistance-requirement-from-r60-to-r90    |
      | change-unit                   | 🧊️change-unit                  | 🧊️switches-the-masonry-unit-from-clay-to-calcium-silicate   |
      | change-exposure               | 💧️change-exposure               | 💧️moves-the-wall-to-exposure-class-mx3                      |
      | change-mortar                 | 🪣️change-mortar                | 🪣️upgrades-the-general-purpose-mortar-to-m10                |
      | change-bed-joint-thickness-mm | 🥪️change-bed-joint-thickness-mm | 🥪️thickens-the-bed-joint-to-the-15-mm-upper-limit           |
      | change-storeys                | 🏢️change-storeys               | 🏢️adds-a-third-storey-at-the-simplified-method-limit        |
      | change-h-ef-mm                | ↕️change-h-ef-mm                | ↕️lengthens-the-effective-height-to-2750-mm                 |
      | change-t-ef-mm                | 📏️change-t-ef-mm                | 📏️raises-the-effective-thickness-to-300-mm                  |
