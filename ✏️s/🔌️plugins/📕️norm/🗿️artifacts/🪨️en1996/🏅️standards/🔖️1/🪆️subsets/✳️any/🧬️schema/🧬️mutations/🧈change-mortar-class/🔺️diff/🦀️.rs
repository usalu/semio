...
pub fn diff(payload: &ChangeMortarClass, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.index].mortar_class = payload.new_mortar_class;
