...
pub fn diff(payload: &ChangeWallThickness, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.index].thickness_m = payload.new_thickness_m;
