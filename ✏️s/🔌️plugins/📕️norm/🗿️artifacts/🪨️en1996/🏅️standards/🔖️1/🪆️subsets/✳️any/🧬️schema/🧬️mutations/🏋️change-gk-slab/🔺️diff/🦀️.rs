...
pub fn diff(payload: &ChangeGKSlab, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    ...
    walls[payload.wall_index].load_cases[payload.index].g_k_slab_n = payload.new_g_k_slab_n;
