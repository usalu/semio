//! 🧪️ `change-exposure` fixture — `💧️moves-the-wall-to-exposure-class-mx3`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-exposure/💧️moves-the-wall-to-exposure-class-mx3/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-exposure/💧️moves-the-wall-to-exposure-class-mx3/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-exposure/💧️moves-the-wall-to-exposure-class-mx3/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-exposure/💧️moves-the-wall-to-exposure-class-mx3/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-exposure/💧️moves-the-wall-to-exposure-class-mx3/🎯️outcome/🔣️.json");
...
#[semio_framework_async_macros::async_test]
async fn returning_to_exposure_class_mx1_restores_before() {
    let base = before();
