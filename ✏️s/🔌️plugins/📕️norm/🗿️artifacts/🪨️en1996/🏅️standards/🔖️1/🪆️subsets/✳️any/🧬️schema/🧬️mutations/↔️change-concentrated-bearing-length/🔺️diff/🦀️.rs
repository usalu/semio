...
pub fn diff(payload: &ChangeConcentratedBearingLength, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.wall_index].load_cases[payload.load_case_index].concentrated[payload.index].bearing_length_m = payload.new_bearing_length_m;
