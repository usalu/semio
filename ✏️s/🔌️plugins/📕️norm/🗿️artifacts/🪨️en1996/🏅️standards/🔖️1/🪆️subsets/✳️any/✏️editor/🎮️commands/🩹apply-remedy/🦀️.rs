...
pub fn handle(payload: &ApplyRemedy, doc: &ArtifactView<'_, En1996Snapshot>, _cfg: &ConfigView<'_, NoConfig>) -> Result<Emit<En1996Mutation, NoConfigMutation>, Fault> {
    crate::app_surface::dispatch_apply_remedy::<crate::editor::en1996::En1996Family, _>(doc.snapshot, &payload.check_id, payload.remedy_index as usize, |base, target| En1996Mutation::from_snapshot(base, target))
}
//#endregion 🔖️Handler
