...
use crate::editor::en1996::commands::{evaluate, selected_check, set_active_example, set_snapshot};
...
impl ArtifactEditor for En1996PlayApp {
    ...
    fn examples() -> Vec<semio_framework_plugin::ExampleSource> {
        vec![crate::loadbearing_wall::source()]
    }
    ...
    fn render(body_key: &str, doc: &ArtifactView<'_, En1996Snapshot>, cfg: &ConfigView<'_, NoConfig>, view_state: &semio_framework_plugin::ViewModel) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::ComponentTree> {
        let host = NormHost::<En1996Family>::from_artifact(doc.snapshot.clone());
        match body_key {
    ...
    fn import_media(port: &str, media: &Media, _doc: &ArtifactView<'_, En1996Snapshot>) -> Result<Emit<En1996Mutation, NoConfigMutation, Self::DraftMutation>, MediaError> {
