...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏢️change-storeys/🏢️adds-a-third-storey-at-the-simplified-method-limit/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏢️change-storeys/🏢️adds-a-third-storey-at-the-simplified-method-limit/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏢️change-storeys/🏢️adds-a-third-storey-at-the-simplified-method-limit/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏢️change-storeys/🏢️adds-a-third-storey-at-the-simplified-method-limit/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏢️change-storeys/🏢️adds-a-third-storey-at-the-simplified-method-limit/🎯️outcome/🔣️.json");
...
async fn adds_a_third_storey_at_the_simplified_method_limit() {
...
/// `storeys`.
#[semio_framework_async_macros::async_test]
async fn returning_to_two_storeys_restores_before() {
    let base = before();
