//! 🧪️ `change-m-ed-knm` fixture — `⤴️raises-the-design-bending-moment-to-12-5-knm`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-12-5-knm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-12-5-knm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-12-5-knm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-12-5-knm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⤴️change-m-ed-knm/⤴️raises-the-design-bending-moment-to-12-5-knm/🎯️outcome/🔣️.json");
...
async fn raises_the_design_bending_moment_to_12_5_knm() {
...
/// `m_ed_knm`.
#[semio_framework_async_macros::async_test]
async fn restoring_8_knm_restores_before() {
    let base = before();
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-m-ed-knm/raises-the-design-bending-moment-to-12-5-knm: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
