//! 🧪️ `change-masonry-class` fixture — `🏭️downgrades-manufacturing-control-to-class-4`.
//!
...
#[semio_framework_async_macros::async_test]
async fn returning_to_class_3_restores_before() {
    let base = before();
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-masonry-class/downgrades-manufacturing-control-to-class-4: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
