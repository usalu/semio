...
pub fn diff(payload: &ChangeAsHorizontal, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.index].as_horizontal_m2 = payload.new_as_horizontal_m2;
