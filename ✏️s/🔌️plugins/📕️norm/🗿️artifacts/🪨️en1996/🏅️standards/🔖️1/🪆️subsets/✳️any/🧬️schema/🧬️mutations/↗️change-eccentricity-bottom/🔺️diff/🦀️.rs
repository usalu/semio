...
pub fn diff(payload: &ChangeEccentricityBottom, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.index].eccentricity_bottom_m = payload.new_eccentricity_bottom_m;
