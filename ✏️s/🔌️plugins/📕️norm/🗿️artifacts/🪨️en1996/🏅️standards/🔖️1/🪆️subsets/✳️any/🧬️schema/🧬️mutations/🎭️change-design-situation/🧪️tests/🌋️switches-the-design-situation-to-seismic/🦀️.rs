...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎭️change-design-situation/🌋️switches-the-design-situation-to-seismic/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎭️change-design-situation/🌋️switches-the-design-situation-to-seismic/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎭️change-design-situation/🌋️switches-the-design-situation-to-seismic/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎭️change-design-situation/🌋️switches-the-design-situation-to-seismic/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎭️change-design-situation/🌋️switches-the-design-situation-to-seismic/🎯️outcome/🔣️.json");
...
async fn switches_the_design_situation_to_seismic() {
...
#[semio_framework_async_macros::async_test]
async fn returning_to_the_persistent_situation_restores_before() {
    let base = before();
