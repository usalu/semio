...
pub fn diff(payload: &ChangeBedJointThickness, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.index].bed_joint_thickness_m = payload.new_bed_joint_thickness_m;
