//! 📊️ EN 1996 viewer — the Report window: a read-only table of every computed compliance
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::en1996::create_en1996_viewer`. Read-only variant
...
pub fn render(document: &En1996Snapshot) -> semio_framework_plugin::UiAssemblyResult<semio_framework_plugin::BuiltNode> {
    let report = crate::artifacts::en1996::standards::v1::subsets::any::schema::inferences::evaluate(document);
