...
pub fn diff(payload: &ChangeAsVertical, base: &En1996Snapshot) -> protocol::MutationOutcome<En1996Diff> {
    let diff = {
        ...
        walls[payload.index].as_vertical_m2 = payload.new_as_vertical_m2;
