...
// #region 🔖️Session
/// 🧩️ EN 1995's `NormFamily` binding — ties this artifact's `Document` to the `evaluate` above for the
...
/// @emoji ⚙️ UI-independent En1995 artifact engine — owns the projection; every transition is a mutation.
...
impl protocol::ArtifactEngine for En1995Engine {
    ...
    type Diff = crate::artifacts::en1995::diff::Diff;
...
pub fn register_pilot_languages() {
    dsl::register_language(dsl::LanguageSpec {
        ...
        protocol: Some(crate::artifacts::en1994::pack::COMPONENT_PROTOCOL_SEMIO),
        protocol_path: Some(crate::artifacts::en1994::pack::COMPONENT_PROTOCOL_PATH),
