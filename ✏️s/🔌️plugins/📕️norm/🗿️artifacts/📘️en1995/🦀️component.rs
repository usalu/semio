...
pub mod io_registry {
    ...
    use crate::artifacts::en1995::standards::v1::subsets::any::io::io_registry as v1;
...
pub fn definition() -> Result<semio_framework_plugin::ArtifactDefinition, semio_framework_plugin::ArtifactDefinitionError> {
    crate::artifacts::definition::schema_owned_definition(
        "s.en1995",
        crate::artifacts::en1995::schema::en1995_artifact_schema_descriptor().id,
        crate::artifacts::en1995::standards::v1::subsets::any::schema::inferences::en1995_artifact_inference_descriptor().id,
        crate::artifacts::en1995::standards::v1::subsets::any::io::io_registry::entries(),
        pilot_languages(),
        crate::apps::en1995::DOCUMENT_SCHEMA,
        <En1995Snapshot as store::ArtifactDsl>::EXTENSION,
...
pub fn declaration(definition: semio_framework_plugin::ArtifactDefinition) -> Result<semio_framework_plugin::ArtifactDeclaration, semio_framework_plugin::ArtifactDefinitionError> {
    semio_framework_plugin::ArtifactDeclaration::builder(definition)
        ...
        .document_codec::<crate::apps::en1995::En1995PlayApp>()
        .try_build()
}
