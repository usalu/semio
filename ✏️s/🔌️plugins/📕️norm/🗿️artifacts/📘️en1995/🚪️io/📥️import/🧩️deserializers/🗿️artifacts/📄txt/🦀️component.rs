...
pub fn register() {}
pub fn deserialize(_from: &semio_s_plugin_stdio::artifacts::txt::TxtSnapshot) -> Result<En1995Snapshot, String> {
    Err("txt import not yet implemented".into())
}
pub fn deserialize_bytes(_bytes: &[u8]) -> Result<En1995Snapshot, String> {
    Err("txt import not yet implemented".into())
}
