...
/// 💡️ Registers `s.norm.en1995.inference`'s facet leaves into the OS-wide inference catalog —
/// sibling to `register_artifact_schema()` above (separate registry, ticket
/// 26/08/12/INTRODUCE-INFERENCE-SCHEMA-FAMILY-WITH-DEPENDENCY-AWARE-CACHING).
pub fn register_artifact_inferences() {
    ::schema::register_artifact_inference_descriptor(crate::artifacts::en1995::standards::v1::subsets::any::schema::inferences::en1995_artifact_inference_descriptor());
}
//#endregion 🔖️SchemaRegistry

//#region 🔖️IoFacet
pub fn register_io() {
    crate::artifacts::en1995::io_registry::register();
}
//#endregion 🔖️IoFacet
