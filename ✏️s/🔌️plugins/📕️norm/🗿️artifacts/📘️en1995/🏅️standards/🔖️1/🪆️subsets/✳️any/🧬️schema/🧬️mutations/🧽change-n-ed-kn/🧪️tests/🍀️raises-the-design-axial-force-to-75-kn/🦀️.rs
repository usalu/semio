//! 🧪️ `change-n-ed-kn` fixture — `🍀️raises-the-design-axial-force-to-75-kn`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-n-ed-kn/raises-the-design-axial-force-to-75-kn: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
