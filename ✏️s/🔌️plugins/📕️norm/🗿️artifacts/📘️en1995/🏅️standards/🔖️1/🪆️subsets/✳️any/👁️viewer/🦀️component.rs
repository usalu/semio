...
impl ArtifactViewer for En1995Viewer {
    ...
    async fn initial_snapshot() -> En1995Snapshot {
...
//#region 🔖️Manifest
pub async fn create_en1995_viewer() -> semio_framework_plugin::AppDefinition {
...
mod tests {
    ...
    async fn an_unknown_body_key_falls_back_to_a_text_node() {
        ...
        let json = serde_json::to_string(&<En1995Viewer as ArtifactViewer>::render("nope", &doc, &ConfigView { snapshot: &NoConfig::default() })).expect("json");
