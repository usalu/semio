...
//#region 🔖️Handler
pub async fn handle(payload: &SetSelectedCheckIndex, _doc: &ArtifactView<'_, En1995Snapshot>, _cfg: &ConfigView<'_, NormConfig>) -> Result<Emit<En1995Mutation, NormConfigMutation>, Fault> {
