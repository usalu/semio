//! 🧪️ `change-a-vert-ms2` fixture — `🧿️doubles-the-vertical-footfall-acceleration-to-0-5-m-s2`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-a-vert-ms2/doubles-the-vertical-footfall-acceleration-to-0-5-m-s2: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
