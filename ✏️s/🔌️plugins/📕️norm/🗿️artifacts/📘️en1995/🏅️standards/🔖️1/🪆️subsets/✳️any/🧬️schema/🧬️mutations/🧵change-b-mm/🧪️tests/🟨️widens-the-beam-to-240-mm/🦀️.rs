//! 🧪️ `change-b-mm` fixture — `🟨️widens-the-beam-to-240-mm`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-b-mm/widens-the-beam-to-240-mm: the produced diff differs from the committed 🔺️diff/🔣️.json");
}
