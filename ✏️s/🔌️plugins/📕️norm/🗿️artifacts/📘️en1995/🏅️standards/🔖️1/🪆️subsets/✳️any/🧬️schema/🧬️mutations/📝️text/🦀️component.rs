...
async fn en1995_mutation_to_dsl(mutation: &En1995Mutation) -> En1995MutationDsl {
    match mutation {
...
async fn en1995_mutation_from_dsl(mutation: En1995MutationDsl) -> En1995Mutation {
    match mutation {
        En1995MutationDsl::ChangeAnnex { new_annex } => En1995Mutation::ChangeAnnex(set_snapshot::mutation::ChangeAnnex { new_annex }),
        En1995MutationDsl::ChangeMEdKnm { new_m_ed_knm } => En1995Mutation::ChangeMEdKnm(change_m_ed_knm::mutation::ChangeMEdKnm { new_m_ed_knm }),
        En1995MutationDsl::ChangeNEdKn { new_n_ed_kn } => En1995Mutation::ChangeNEdKn(change_n_ed_kn::mutation::ChangeNEdKn { new_n_ed_kn }),
        En1995MutationDsl::ChangeVEdKn { new_v_ed_kn } => En1995Mutation::ChangeVEdKn(change_v_ed_kn::mutation::ChangeVEdKn { new_v_ed_kn }),
        En1995MutationDsl::ChangeWMm3 { new_w_mm3 } => En1995Mutation::ChangeWMm3(change_w_mm3::mutation::ChangeWMm3 { new_w_mm3 }),
        En1995MutationDsl::ChangeAMm2 { new_a_mm2 } => En1995Mutation::ChangeAMm2(change_a_mm2::mutation::ChangeAMm2 { new_a_mm2 }),
        En1995MutationDsl::ChangeBMm { new_b_mm } => En1995Mutation::ChangeBMm(change_b_mm::mutation::ChangeBMm { new_b_mm }),
        En1995MutationDsl::ChangeHMm { new_h_mm } => En1995Mutation::ChangeHMm(change_h_mm::mutation::ChangeHMm { new_h_mm }),
        En1995MutationDsl::ChangeFMK { new_f_m_k } => En1995Mutation::ChangeFMK(change_f_m_k::mutation::ChangeFMK { new_f_m_k }),
        En1995MutationDsl::ChangeFC0K { new_f_c_0_k } => En1995Mutation::ChangeFC0K(change_f_c_0_k::mutation::ChangeFC0K { new_f_c_0_k }),
        En1995MutationDsl::ChangeServiceClass { new_service_class } => En1995Mutation::ChangeServiceClass(change_service_class::mutation::ChangeServiceClass { new_service_class }),
        En1995MutationDsl::ChangeLoadDuration { new_load_duration } => En1995Mutation::ChangeLoadDuration(change_load_duration::mutation::ChangeLoadDuration { new_load_duration }),
        En1995MutationDsl::ChangeMCritKnm { new_m_crit_knm } => En1995Mutation::ChangeMCritKnm(change_m_crit_knm::mutation::ChangeMCritKnm { new_m_crit_knm }),
        En1995MutationDsl::ChangeFEdKn { new_f_ed_kn } => En1995Mutation::ChangeFEdKn(change_f_ed_kn::mutation::ChangeFEdKn { new_f_ed_kn }),
        En1995MutationDsl::ChangeAEfMm2 { new_a_ef_mm2 } => En1995Mutation::ChangeAEfMm2(change_a_ef_mm2::mutation::ChangeAEfMm2 { new_a_ef_mm2 }),
        En1995MutationDsl::ChangeFVK { new_f_v_k } => En1995Mutation::ChangeFVK(change_f_v_k::mutation::ChangeFVK { new_f_v_k }),
        En1995MutationDsl::ChangeFireDurationMin { new_fire_duration_min } => En1995Mutation::ChangeFireDurationMin(change_fire_duration_min::mutation::ChangeFireDurationMin { new_fire_duration_min }),
        En1995MutationDsl::ChangeSectionDepthMm { new_section_depth_mm } => En1995Mutation::ChangeSectionDepthMm(change_section_depth_mm::mutation::ChangeSectionDepthMm { new_section_depth_mm }),
        En1995MutationDsl::ChangeAVertMS2 { new_a_vert_m_s2 } => En1995Mutation::ChangeAVertMS2(change_a_vert_m_s2::mutation::ChangeAVertMS2 { new_a_vert_m_s2 }),
        En1995MutationDsl::ChangeNCyclesBridge { new_n_cycles_bridge } => En1995Mutation::ChangeNCyclesBridge(change_n_cycles_bridge::mutation::ChangeNCyclesBridge { new_n_cycles_bridge }),
    }
}
...
mod tests {
    ...
    async fn every_mutation() -> Vec<En1995Mutation> {
        vec![
            ...
            En1995Mutation::ChangeMEdKnm(change_m_ed_knm::mutation::ChangeMEdKnm { new_m_ed_knm: 25.0 }),
            En1995Mutation::ChangeNEdKn(change_n_ed_kn::mutation::ChangeNEdKn { new_n_ed_kn: 50.0 }),
            En1995Mutation::ChangeVEdKn(change_v_ed_kn::mutation::ChangeVEdKn { new_v_ed_kn: 15.0 }),
            En1995Mutation::ChangeWMm3(change_w_mm3::mutation::ChangeWMm3 { new_w_mm3: 1_000_000.0 }),
            En1995Mutation::ChangeAMm2(change_a_mm2::mutation::ChangeAMm2 { new_a_mm2: 20_000.0 }),
            En1995Mutation::ChangeBMm(change_b_mm::mutation::ChangeBMm { new_b_mm: 200.0 }),
            En1995Mutation::ChangeHMm(change_h_mm::mutation::ChangeHMm { new_h_mm: 300.0 }),
            En1995Mutation::ChangeFMK(change_f_m_k::mutation::ChangeFMK { new_f_m_k: 24.0 }),
            En1995Mutation::ChangeFC0K(change_f_c_0_k::mutation::ChangeFC0K { new_f_c_0_k: 21.0 }),
            En1995Mutation::ChangeServiceClass(change_service_class::mutation::ChangeServiceClass { new_service_class: "sc1".into() }),
            En1995Mutation::ChangeLoadDuration(change_load_duration::mutation::ChangeLoadDuration { new_load_duration: "medium".into() }),
            En1995Mutation::ChangeMCritKnm(change_m_crit_knm::mutation::ChangeMCritKnm { new_m_crit_knm: 80.0 }),
            En1995Mutation::ChangeFEdKn(change_f_ed_kn::mutation::ChangeFEdKn { new_f_ed_kn: 18.0 }),
            En1995Mutation::ChangeAEfMm2(change_a_ef_mm2::mutation::ChangeAEfMm2 { new_a_ef_mm2: 12_000.0 }),
            En1995Mutation::ChangeFVK(change_f_v_k::mutation::ChangeFVK { new_f_v_k: 4.0 }),
            En1995Mutation::ChangeFireDurationMin(change_fire_duration_min::mutation::ChangeFireDurationMin { new_fire_duration_min: 30.0 }),
            En1995Mutation::ChangeSectionDepthMm(change_section_depth_mm::mutation::ChangeSectionDepthMm { new_section_depth_mm: 300.0 }),
            En1995Mutation::ChangeAVertMS2(change_a_vert_m_s2::mutation::ChangeAVertMS2 { new_a_vert_m_s2: 0.3 }),
            En1995Mutation::ChangeNCyclesBridge(change_n_cycles_bridge::mutation::ChangeNCyclesBridge { new_n_cycles_bridge: 500_000.0 }),
        ]
    }
}
//#endregion 🧪️Tests
