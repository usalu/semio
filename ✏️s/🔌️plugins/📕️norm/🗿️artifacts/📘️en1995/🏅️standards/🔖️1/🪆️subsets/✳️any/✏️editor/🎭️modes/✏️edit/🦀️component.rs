//! ✏️ EN 1995 play app — the `edit` mode: the inputs/results authoring layout.
...
//#region 🔖️Definition
/// 🧱️ Stitched into the app manifest by `crate::editor::en1995::create_en1995_app`. Every norm app declares
