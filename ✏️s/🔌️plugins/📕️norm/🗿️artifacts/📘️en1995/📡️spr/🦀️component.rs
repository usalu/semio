...
mod tests {
    ...
    fn op_binary_round_trips_and_agrees_with_text() {
        let mutation = En1995Mutation::SetDocument { document: Document::default() };
    ...
    fn document_text_round_trips_through_store() {
        ...
        store.dispatch(store::DocumentCommand::Apply { mutations: vec![En1995Mutation::SetDocument { document: Document::default() }], description: None }).expect("apply");
