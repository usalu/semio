...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "insert-variable-action/seeds-the-first-variable-action-q-snow-at-12-5-kn: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
