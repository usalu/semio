...
//#region 🔖️OpText
async fn print_en1990_mutation(mutation: &En1990Mutation) -> String {
    match mutation {
...
async fn parse_en1990_mutation(line: &str) -> Result<En1990Mutation, String> {
...
#[cfg(test)]
pub(crate) async fn demo_mutation_cases() -> Vec<En1990Mutation> {
    vec![
