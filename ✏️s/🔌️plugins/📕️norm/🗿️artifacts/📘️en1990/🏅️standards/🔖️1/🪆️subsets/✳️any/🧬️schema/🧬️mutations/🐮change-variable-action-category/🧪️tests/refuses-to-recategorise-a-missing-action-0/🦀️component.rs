...
async fn produces_committed_diff() {
    ...
    assert!(DIFF_ABSENT.is_empty(), "change-variable-action-category/refuses-to-recategorise-a-missing-action-0: 🔺️diff/🚫️component.absent must be a zero-byte marker");
}
