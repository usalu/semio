//! 📊️ EN 1990 play app — the results window: every computed compliance check, one line each.
...
//#region 🔖️Constants
pub const WINDOW_RESULTS: &str = "norm-en1990-results";
pub const BODY_RESULTS: &str = "norm.en1990.play.results";
