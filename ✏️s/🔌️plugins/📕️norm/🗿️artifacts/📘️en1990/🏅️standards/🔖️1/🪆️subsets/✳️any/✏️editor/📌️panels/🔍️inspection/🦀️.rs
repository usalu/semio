//! 🔍️ EN 1990 play app panel — the inspection tab: one computed check in full, chosen by the config's
...
//#region 🔖️Constants
pub const BODY_INSPECTION: &str = "norm.en1990.play.inspection";
...
//#region 🔖️Render
pub fn render(host: &NormHost<En1990Family>, selected_check_index: Option<u32>) -> UiNode {
...
mod tests {
    use super::*;
    use crate::editor::en1990::testkit;
    ...
    fn an_out_of_range_selected_index_falls_back_to_the_first_check() {
        let host = NormHost::<En1990Family>::from_document(crate::artifacts::en1990::En1990Snapshot::default());
