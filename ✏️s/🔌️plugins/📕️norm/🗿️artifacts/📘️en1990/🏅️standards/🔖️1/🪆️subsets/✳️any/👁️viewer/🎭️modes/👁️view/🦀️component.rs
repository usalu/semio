//! 👁️ EN 1990 viewer — the `view` mode: a single full-pane Report window, the read-only
...
//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::en1990::create_en1990_viewer`.
