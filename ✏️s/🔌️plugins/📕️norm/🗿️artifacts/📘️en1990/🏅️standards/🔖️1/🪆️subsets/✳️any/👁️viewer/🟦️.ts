/** 👁️ EN 1990 viewer — subset-level typed twin. Read-only counterpart of
...
export const EN1990_VIEWER_DIALECT = { artifactKind: "s.norm.en1990", standard: "1", subset: "*" } as const;

export const EN1990_VIEW_MODE_ID = "view" as const;
