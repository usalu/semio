...
//! a no-op clone (nothing at that position to change). Reads `base` through the `en1990_qk`
...
//#region 🔖️Diff
pub async fn diff(payload: &ChangeVariableActionCategory, base: &En1990Snapshot) -> protocol::MutationOutcome<En1990Diff> {
