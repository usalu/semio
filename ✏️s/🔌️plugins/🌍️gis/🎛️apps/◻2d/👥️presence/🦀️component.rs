...
impl protocol::MutationDiff<Gis2dPresence> for Gis2dPresence {
    fn apply(&self, _base: &Gis2dPresence) -> Gis2dPresence {
        self.clone()
    }
...
impl store::ArtifactDsl for Gis2dPresence {
...
impl ArtifactPack for Gis2dPresence {
...
impl Mutation<Gis2dPresence> for Gis2dPresenceMutation {
    ...
    fn diff(&self, _base: &Gis2dPresence) -> Gis2dPresence {
        match self {
...
impl protocol::OpBinary for Gis2dPresenceMutation {
