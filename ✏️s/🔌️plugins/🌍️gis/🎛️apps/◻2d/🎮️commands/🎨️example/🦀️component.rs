...
pub mod set_active_example {
    ...
    pub fn handle(payload: &SetActiveExample, _doc: &DocumentView<'_, GisMapDocument>, cfg: &ConfigView<'_, Gis2dConfig>) -> Result<Emit<GisMapOperation, Gis2dConfigOperation>, Fault> {
        ...
        Ok(Emit { document_operations: vec![GisMapOperation::SetDocument { document: next }], config_operations, ..Default::default() })
    }
}
