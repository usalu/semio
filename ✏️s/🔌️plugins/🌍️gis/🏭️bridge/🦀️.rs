//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🌍️gis`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("MapWindowConfigMutation", descriptors::<semio_s_artifact_gis_gismap::editor::gis2d::modes::edit::windows::map::config::MapWindowConfig, semio_s_artifact_gis_gismap::editor::gis2d::modes::edit::windows::map::config::mutations::MapWindowConfigMutation>),
    ("GisMapMutation", descriptors::<semio_s_artifact_gis_gismap::standards::v1::subsets::any::schema::snapshot::GisMapSnapshot, semio_s_artifact_gis_gismap::standards::v1::subsets::any::schema::mutations::GisMapMutation>),
    ("GisMapViewerWindowConfigMutation", descriptors::<semio_s_artifact_gis_gismap::viewer::gismap::modes::view::windows::map::config::GisMapViewerWindowConfig, semio_s_artifact_gis_gismap::viewer::gismap::modes::view::windows::map::config::GisMapViewerWindowConfigMutation>),
    ("GisTerrainWindowConfigMutation", descriptors::<semio_s_artifact_gis_gisterrain::editor::gis3d::modes::view::windows::terrain::config::GisTerrainWindowConfig, semio_s_artifact_gis_gisterrain::editor::gis3d::modes::view::windows::terrain::config::mutations::GisTerrainWindowConfigMutation>),
    ("GisTerrainMutation", descriptors::<semio_s_artifact_gis_gisterrain::standards::v1::subsets::any::schema::snapshot::GisTerrainSnapshot, semio_s_artifact_gis_gisterrain::standards::v1::subsets::any::schema::mutations::GisTerrainMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.gis.gismap", "1", "any", "", "✏️s/🔌️plugins/🌍️gis/🗿️artifacts/🗺️gismap/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.gis.gismap", "1", "any", "✏️editor/🎭️modes/✏️edit/🪟️windows/🗺️map/🎚️config", "✏️s/🔌️plugins/🌍️gis/🗿️artifacts/🗺️gismap/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎭️modes/✏️edit/🪟️windows/🗺️map/🎚️config", ""),
    ("s.gis.gismap", "1", "any", "👁️viewer/🎭️modes/👁️view/🪟️windows/🗺️map/🎚️config", "✏️s/🔌️plugins/🌍️gis/🗿️artifacts/🗺️gismap/🏅️standards/🔖️1/🪆️subsets/✳️any/👁️viewer/🎭️modes/👁️view/🪟️windows/🗺️map/🎚️config", ""),
    ("s.gis.gisterrain", "1", "any", "", "✏️s/🔌️plugins/🌍️gis/🗿️artifacts/🏔️gisterrain/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.gis.gisterrain", "1", "any", "✏️editor/🎭️modes/👁️view/🪟️windows/🏔️terrain/🎚️config", "✏️s/🔌️plugins/🌍️gis/🗿️artifacts/🏔️gisterrain/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎭️modes/👁️view/🪟️windows/🏔️terrain/🎚️config", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-gis-mutation-bridge")),
