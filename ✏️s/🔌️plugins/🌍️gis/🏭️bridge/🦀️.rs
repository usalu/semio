...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_gis_gismap::standards::v1::subsets::any::schema::snapshot::GisMapSnapshot, semio_s_artifact_gis_gismap::standards::v1::subsets::any::schema::mutations::GisMapMutation>,
    descriptors::<semio_s_artifact_gis_gisterrain::standards::v1::subsets::any::schema::snapshot::GisTerrainSnapshot, semio_s_artifact_gis_gisterrain::standards::v1::subsets::any::schema::mutations::GisTerrainMutation>,
];
...
const COORDINATES: &[(&str, &str, &str, &str)] = &[
    ...
    ("s.gis.gisterrain", "1", "any", "✏️s/🔌️plugins/🌍️gis/🗿️artifacts/🏔️gisterrain/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎭️modes/👁️view/🪟️windows/🏔️terrain/🎚️config"),
];
