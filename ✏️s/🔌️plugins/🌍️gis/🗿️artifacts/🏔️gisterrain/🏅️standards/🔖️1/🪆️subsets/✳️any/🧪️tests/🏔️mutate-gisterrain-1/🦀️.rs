...
mod subject {
    ...
    use crate::standards::v1::subsets::any::schema::mutations::gis_terrain_mutation_report_json;
    use crate::standards::v1::subsets::any::schema::snapshot::gis_terrain_identity_report_json;
