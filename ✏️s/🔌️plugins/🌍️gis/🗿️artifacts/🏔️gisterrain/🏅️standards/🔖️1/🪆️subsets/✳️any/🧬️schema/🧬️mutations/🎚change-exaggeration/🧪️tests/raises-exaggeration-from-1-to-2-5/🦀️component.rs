//! 🧪️ `change-exaggeration` fixture — `raises-exaggeration-from-1-to-2-5`.
//!
...
async fn applies_to_committed_after() {
    ...
    assert_ne!(snapshot.mesh, base.mesh, "change-exaggeration/raises-exaggeration-from-1-to-2-5: editing a content-key field must re-mint the derived mesh handle");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-exaggeration/raises-exaggeration-from-1-to-2-5: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
