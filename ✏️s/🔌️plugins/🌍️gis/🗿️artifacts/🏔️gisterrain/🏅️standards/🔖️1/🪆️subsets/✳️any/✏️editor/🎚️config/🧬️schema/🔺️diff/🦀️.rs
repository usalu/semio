...
pub struct Gis3dConfigDiff {
    pub steps: Vec<Gis3dConfigDelta>,
}

impl From<Gis3dConfigDelta> for Gis3dConfigDiff {
    fn from(delta: Gis3dConfigDelta) -> Self {
        if delta == Gis3dConfigDelta::default() {
            Self::default()
        } else {
