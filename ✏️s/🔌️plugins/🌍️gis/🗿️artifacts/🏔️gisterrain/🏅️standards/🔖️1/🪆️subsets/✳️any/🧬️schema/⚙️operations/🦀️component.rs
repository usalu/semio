...
pub const COMPONENT_GRAMMAR_SEMIO: &str = include_str!("../🧬️mutations/📖️component.grammar.semio");
...
/// (`../../🧪️oracle/🔣️.json`) declares and the `mutate-gisterrain-1` exhaustive test case measures
