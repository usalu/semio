...
pub async fn export_stdio_kinds() -> &'static [&'static str] { &["stdio.gltf", "stdio.las", "stdio.obj", "stdio.ply", "stdio.stl", "stdio.txt"] }
...
pub mod io_registry {
    ...
    async fn rebuild_native_snapshot(sources: &[ErasedComposeSource]) -> Result<crate::artifacts::gisterrain::GisTerrainSnapshot, ComposeError> {
