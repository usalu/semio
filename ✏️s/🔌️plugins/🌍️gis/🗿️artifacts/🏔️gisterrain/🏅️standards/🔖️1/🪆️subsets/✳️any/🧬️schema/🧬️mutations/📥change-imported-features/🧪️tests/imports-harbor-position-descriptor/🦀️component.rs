//! 🧪️ `change-imported-features` fixture — `imports-harbor-position-descriptor`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-imported-features/imports-harbor-position-descriptor: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
