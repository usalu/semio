//! 🧪️ `reorder-positions` fixture — `moves-harbor-position-to-end`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-positions/moves-harbor-position-to-end: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
