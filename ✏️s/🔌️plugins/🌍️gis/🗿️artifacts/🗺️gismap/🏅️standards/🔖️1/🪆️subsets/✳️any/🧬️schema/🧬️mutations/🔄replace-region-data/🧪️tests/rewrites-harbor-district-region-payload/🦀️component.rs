//! 🧪️ `replace-region-data` fixture — `rewrites-harbor-district-region-payload`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-region-data/rewrites-harbor-district-region-payload: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
