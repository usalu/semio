...
async fn applies_to_committed_after() {
    ...
    assert_eq!(snapshot.drawing.child_id, base.drawing.child_id, "create-route/adds-tram-route-after-ferry: editing routes must preserve the stable drawing identity");
    assert_eq!(snapshot.value.child_id, base.value.child_id, "create-route/adds-tram-route-after-ferry: editing routes must preserve the stable value identity");
