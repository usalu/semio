...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    assert_eq!(snapshot.drawing.child_id, base.drawing.child_id, "replace-region-data/rewrites-harbor-district-region-payload: editing regions must preserve the stable drawing identity");
    assert_eq!(snapshot.value.child_id, base.value.child_id, "replace-region-data/rewrites-harbor-district-region-payload: editing regions must preserve the stable value identity");
