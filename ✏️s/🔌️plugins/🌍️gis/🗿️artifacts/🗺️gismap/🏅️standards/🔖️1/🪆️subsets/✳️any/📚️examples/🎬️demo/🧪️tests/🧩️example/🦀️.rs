...
async fn inference_default_law() {
    use protocol::Inference;
    assert_eq!(
        crate::standards::v1::subsets::any::schema::inferences::GisMapInference::infer(&crate::GisMapSnapshot::default()),
        crate::standards::v1::subsets::any::schema::inferences::GisMapInference::default(),
    );
}
