...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    assert_eq!(snapshot.drawing.child_id, base.drawing.child_id, "reorder-positions/moves-harbor-position-to-end: editing positions must preserve the stable drawing identity");
    assert_eq!(snapshot.value.child_id, base.value.child_id, "reorder-positions/moves-harbor-position-to-end: editing positions must preserve the stable value identity");
