//! 🎹️ GisMapComposer (1/✳️any) — analyzer + builder glued. Reads native `s.gismap` sources
//! plus any of: stdio.dwg, stdio.dxf, stdio.json, stdio.pdf, stdio.png, stdio.svg, stdio.txt. Writes one `s.gismap` (1/✳️any) snapshot.
...
use crate::artifacts::gismap::standards::v1::subsets::any::analyzer::GisMapAnalyzer;
...
pub struct GisMapComposer;

impl ArtifactComposer for GisMapComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        ...
        Err(ComposeError { message: "GisMapComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
