//! 🧪️ `delete-route` fixture — `removes-tram-route`.
//!
...
async fn applies_to_committed_after() {
    ...
    assert_ne!(snapshot.drawing.child_id, base.drawing.child_id, "delete-route/removes-tram-route: editing routes must re-mint the derived drawing handle");
    assert_ne!(snapshot.value.child_id, base.value.child_id, "delete-route/removes-tram-route: editing routes must re-mint the derived value handle");
