//! 🧪️ `create-route` fixture — `adds-tram-route-after-ferry`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-route/adds-tram-route-after-ferry: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
