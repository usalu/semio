/** 🗺️ GIS 2D editor — Map window: typed twin of `🦀️component.rs`'s `render(document, cfg)`
 ...
 * (`✏️editor/🎚️config/🦀️component.rs`), reused here rather than redeclared per window. */
