...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    assert_eq!(snapshot.drawing.child_id, base.drawing.child_id, "reorder-regions/moves-park-region-between-2-districts: editing regions must preserve the stable drawing identity");
    assert_eq!(snapshot.value.child_id, base.value.child_id, "reorder-regions/moves-park-region-between-2-districts: editing regions must preserve the stable value identity");
