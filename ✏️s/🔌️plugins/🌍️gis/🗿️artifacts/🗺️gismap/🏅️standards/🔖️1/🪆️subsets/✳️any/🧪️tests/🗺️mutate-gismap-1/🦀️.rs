...
#[cfg(feature = "sut")]
const DERIVED_ASSET: &str = "shared://🗺️mutate-gismap-1/🗺️liege-with-derived-regions.dsl.semio";
//#endregion 🔖️Kinds
...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-position" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🆕create-position/💡️adds-lighthouse-position-after-harbor/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🆕create-position/💡️adds-lighthouse-position-after-harbor/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🆕create-position/💡️adds-lighthouse-position-after-harbor/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🆕create-position/💡️adds-lighthouse-position-after-harbor/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🆕create-position/💡️adds-lighthouse-position-after-harbor/🎯️outcome/🔣️.json"),
        },
        "delete-position" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🗑️delete-position/🚫️removes-lighthouse-position/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🗑️delete-position/🚫️removes-lighthouse-position/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🗑️delete-position/🚫️removes-lighthouse-position/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🗑️delete-position/🚫️removes-lighthouse-position/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🗑️delete-position/🚫️removes-lighthouse-position/🎯️outcome/🔣️.json"),
        },
        "replace-position-data" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🔁replace-position-data/⚓️rewrites-harbor-position-payload/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🔁replace-position-data/⚓️rewrites-harbor-position-payload/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🔁replace-position-data/⚓️rewrites-harbor-position-payload/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🔁replace-position-data/⚓️rewrites-harbor-position-payload/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🔁replace-position-data/⚓️rewrites-harbor-position-payload/🎯️outcome/🔣️.json"),
        },
        "reorder-positions" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🔀reorder-positions/⚓️moves-harbor-position-to-end/🎯️outcome/🔣️.json"),
        },
        "create-route" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🛣️create-route/🚋️adds-tram-route-after-ferry/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🛣️create-route/🚋️adds-tram-route-after-ferry/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🛣️create-route/🚋️adds-tram-route-after-ferry/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🛣️create-route/🚋️adds-tram-route-after-ferry/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🛣️create-route/🚋️adds-tram-route-after-ferry/🎯️outcome/🔣️.json"),
        },
        "delete-route" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/✂️delete-route/🚫️removes-tram-route/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/✂️delete-route/🚫️removes-tram-route/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/✂️delete-route/🚫️removes-tram-route/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/✂️delete-route/🚫️removes-tram-route/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/✂️delete-route/🚫️removes-tram-route/🎯️outcome/🔣️.json"),
        },
        "replace-route-data" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/♻️replace-route-data/⛴️rewrites-ferry-route-payload/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/♻️replace-route-data/⛴️rewrites-ferry-route-payload/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/♻️replace-route-data/⛴️rewrites-ferry-route-payload/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/♻️replace-route-data/⛴️rewrites-ferry-route-payload/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/♻️replace-route-data/⛴️rewrites-ferry-route-payload/🎯️outcome/🔣️.json"),
        },
        "reorder-routes" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🧭reorder-routes/🚌️moves-bus-route-to-front/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🧭reorder-routes/🚌️moves-bus-route-to-front/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🧭reorder-routes/🚌️moves-bus-route-to-front/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🧭reorder-routes/🚌️moves-bus-route-to-front/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🧭reorder-routes/🚌️moves-bus-route-to-front/🎯️outcome/🔣️.json"),
        },
        "create-region" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🌐create-region/🏘️adds-old-town-region-after-harbor-district/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🌐create-region/🏘️adds-old-town-region-after-harbor-district/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🌐create-region/🏘️adds-old-town-region-after-harbor-district/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🌐create-region/🏘️adds-old-town-region-after-harbor-district/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🌐create-region/🏘️adds-old-town-region-after-harbor-district/🎯️outcome/🔣️.json"),
        },
        "delete-region" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🧹delete-region/🚫️removes-old-town-region/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🧹delete-region/🚫️removes-old-town-region/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🧹delete-region/🚫️removes-old-town-region/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🧹delete-region/🚫️removes-old-town-region/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🧹delete-region/🚫️removes-old-town-region/🎯️outcome/🔣️.json"),
        },
        "replace-region-data" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🔄replace-region-data/🏘️rewrites-harbor-district-region-payload/🎯️outcome/🔣️.json"),
        },
        "reorder-regions" => Vector {
            before: include_str!("../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧫️fixtures/🧬️mutations/🔃reorder-regions/🌳️moves-park-region-between-2-districts/🎯️outcome/🔣️.json"),
        },
