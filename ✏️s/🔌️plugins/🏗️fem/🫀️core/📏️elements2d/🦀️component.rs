...
use crate::core::formulation::{b_matrix_plane, d_matrix_plane_strain, d_matrix_plane_stress, gauss_quad, gauss_tri, jacobian_2d, shape_quad4, shape_quad8, shape_tri3, shape_tri6};
use crate::core::{Dof, Element, ElementContext, ElementResult, MemberUdl, PlaneStress, PlateMoments};
    ...
    fn recover(&self, ctx: &ElementContext, u_local: &VecD, udl: Option<&MemberUdl>) -> ElementResult {
        ...
        let stations = (0..11)
            .map(|i| {
                ...
                crate::core::BeamStation { x, n: -n1, v: v1 + wy_local * x, m: m1 + v1 * x + wy_local * x * x / 2.0 }
            })
            .collect();
...
/// `PlateDkt` and (via `crate::core::elements2d::d_matrix_plate`) `elements3d::ShellFacet3`'s bending part.
...
mod tests {
    use super::*;
    use crate::core::{solve_linear_static, Model, NodalLoad, Node, Support};
