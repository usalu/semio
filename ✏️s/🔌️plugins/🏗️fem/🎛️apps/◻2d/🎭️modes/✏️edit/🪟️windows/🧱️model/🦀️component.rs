...
//! (`crate::apps::fem2d::modes::edit::windows::results`) — kept here rather than in the artifact's
...
/// (`crate::apps::fem2d::modes::edit::windows::results::render`).
...
pub fn render(doc: &Fem2dSnapshot, camera: &FemCamera) -> UiNode {
    ...
    build_canvas_2d_scene(BODY_KEY, crate::apps::fem2d::FEM2D_APP_ID, Canvas2dScene { camera_x: camera.x, camera_y: camera.y, zoom: camera.zoom, layers_json })
}
//#endregion 🔖️Render
...
mod tests {
    use super::*;
    use crate::apps::fem2d::testkit::{fem2d_app, render as render_body};
