...
impl protocol::MutationDiff<Fem2dPresence> for Fem2dPresence {
    fn apply(&self, base: &Fem2dPresence) -> Fem2dPresence {
        base.clone()
    }
    fn absorb(&mut self, _other: Self) {}
}

impl store::DocumentDsl for Fem2dPresence {
...
impl DocumentPack for Fem2dPresence {
...
impl Mutation<Fem2dPresence> for Fem2dPresenceMutation {
    ...
    fn diff(&self, _base: &Fem2dPresence) -> Fem2dPresence {
        Fem2dPresence::default()
    }
