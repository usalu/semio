//! 📜️ FEM 2D app — textual document grammar surface + laws (constitutional: dsl).
...
/// test fixture.
pub const FEM2D_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/🏗️fem/📚️examples/◻2d/🏗️default.fem2d");
