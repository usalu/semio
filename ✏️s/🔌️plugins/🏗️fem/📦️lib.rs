...
pub mod core {
    ...
    #[path = "🫀️core/🦀️analyses.rs"]
    pub mod analyses;
    #[path = "🫀️core/🦀️elements2d.rs"]
    pub mod elements2d;
    #[path = "🫀️core/🦀️elements3d.rs"]
    pub mod elements3d;
    #[path = "🫀️core/🦀️formulation.rs"]
    pub mod formulation;
    #[path = "🫀️core/🦀️mesh.rs"]
    pub mod mesh;
    #[path = "🫀️core/🦀️sparse.rs"]
    pub mod sparse;
    #[path = "🫀️core/🦀️shared.rs"]
    pub mod shared;
...
pub mod artifacts {
    ...
    pub mod fem2d {
        ...
        pub mod engine {
            ...
            #[path = "🗿️artifacts/◻2d/⚙️engine/🦀️meshing.rs"]
            pub mod meshing;
            #[path = "🗿️artifacts/◻2d/⚙️engine/🦀️modal_buckling.rs"]
            pub mod modal_buckling;
            #[path = "🗿️artifacts/◻2d/⚙️engine/🦀️mesh_preview.rs"]
    ...
    pub mod fem3d {
        ...
        pub mod engine {
            ...
            #[path = "🗿️artifacts/🧊️3d/⚙️engine/🦀️meshing.rs"]
            pub mod meshing;
            #[path = "🗿️artifacts/🧊️3d/⚙️engine/🦀️modal_buckling.rs"]
            pub mod modal_buckling;
            #[path = "🗿️artifacts/🧊️3d/⚙️engine/🦀️mesh_preview.rs"]
            pub mod mesh_preview;
        }
    }
}
