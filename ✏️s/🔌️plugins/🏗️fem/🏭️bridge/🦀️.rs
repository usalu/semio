//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🏗️fem`.
//!
...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_fem_2d::standards::v1::subsets::any::schema::snapshot::Fem2dSnapshot, semio_s_artifact_fem_2d::standards::v1::subsets::any::schema::mutations::Fem2dMutation>,
    descriptors::<semio_s_artifact_fem_3d::standards::v1::subsets::any::schema::snapshot::Fem3dSnapshot, semio_s_artifact_fem_3d::standards::v1::subsets::any::schema::mutations::Fem3dMutation>,
];

/// 🗺️ Manifest coordinate → the owner directory whose leaves it measures.
const COORDINATES: &[(&str, &str, &str, &str)] = &[
    ("s.fem.2d", "1", "any", "✏️s/🔌️plugins/🏗️fem/🗿️artifacts/◻️2d/🏅️standards/🔖️1/🪆️subsets/🌐️any"),
    ("s.fem.3d", "1", "any", "✏️s/🔌️plugins/🏗️fem/🗿️artifacts/🧊️3d/🏅️standards/🔖️1/🪆️subsets/🌐️any"),
];
