...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🏠️appends-an-extruded-roof-slab/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🏠️appends-an-extruded-roof-slab/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🏠️appends-an-extruded-roof-slab/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🏠️appends-an-extruded-roof-slab/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🏠️appends-an-extruded-roof-slab/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem3dDiff::default(), "create-solid/appends-an-extruded-roof-slab: a refused mutation must carry the empty diff");
