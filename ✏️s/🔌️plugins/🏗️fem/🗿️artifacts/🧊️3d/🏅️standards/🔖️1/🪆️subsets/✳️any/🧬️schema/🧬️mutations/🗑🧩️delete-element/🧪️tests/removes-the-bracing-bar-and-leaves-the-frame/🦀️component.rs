...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-element/removes-the-bracing-bar-and-leaves-the-frame: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
