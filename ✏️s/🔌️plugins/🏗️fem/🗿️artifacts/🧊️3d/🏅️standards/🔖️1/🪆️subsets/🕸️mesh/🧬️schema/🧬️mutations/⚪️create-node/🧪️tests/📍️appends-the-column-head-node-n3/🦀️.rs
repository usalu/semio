...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚪️create-node/📍️appends-the-column-head-node-n3/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚪️create-node/📍️appends-the-column-head-node-n3/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚪️create-node/📍️appends-the-column-head-node-n3/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚪️create-node/📍️appends-the-column-head-node-n3/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚪️create-node/📍️appends-the-column-head-node-n3/🎯️outcome/🔣️.json");
