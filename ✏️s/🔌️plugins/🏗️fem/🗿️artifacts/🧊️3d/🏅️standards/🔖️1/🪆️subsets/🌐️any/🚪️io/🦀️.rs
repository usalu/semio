...
pub fn io() -> semio_framework_plugin::app::declarations::IoDeclaration {
    use crate::artifacts::fem3d::io::export::serializers::artifacts as export;
    use crate::artifacts::fem3d::io::import::deserializers::artifacts as import;
    use crate::artifacts::fem3d::standards::v1::subsets::any::io::geometry_import::{ObjIntoFem3d, StlIntoFem3d};
...
mod tests {
    ...
    use crate::artifacts::fem3d::io::export::serializers::artifacts::csv::v_rfc4180::any::csv_text;
    use crate::artifacts::fem3d::io::export::serializers::artifacts::json::v_rfc8259::any::json_text;
    use crate::artifacts::fem3d::io::export::serializers::artifacts::md::v_commonmark::any::md_text;
    use crate::artifacts::fem3d::io::export::serializers::artifacts::obj::v3_0::any::obj_text;
    use crate::artifacts::fem3d::io::export::serializers::artifacts::stl::v_ascii::any::stl_text;
    use crate::artifacts::fem3d::io::export::serializers::artifacts::txt::v_utf_8::any::dsl_text;
    use crate::artifacts::fem3d::io::import::deserializers::artifacts::csv::v_rfc4180::any::from_csv_text;
    use crate::artifacts::fem3d::io::import::deserializers::artifacts::json::v_rfc8259::any::from_json_text;
    use crate::artifacts::fem3d::io::import::deserializers::artifacts::md::v_commonmark::any::from_md_text;
    use crate::artifacts::fem3d::io::import::deserializers::artifacts::txt::v_utf_8::any::from_dsl_text;
    use semio_framework::io::io_mechanism::Deserializer;
    ...
    /// serves to the shell.
    const EXAMPLE: &str = crate::artifacts::fem3d::examples::demo::PRIMARY_TEXT;
