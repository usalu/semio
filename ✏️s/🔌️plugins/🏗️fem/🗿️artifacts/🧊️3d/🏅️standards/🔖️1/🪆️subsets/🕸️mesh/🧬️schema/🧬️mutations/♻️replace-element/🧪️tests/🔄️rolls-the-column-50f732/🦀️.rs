//! 🧪️ `replace-element` fixture — `🔄️rolls-the-column-50f732`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/🔄️rolls-the-column-50f732/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/🔄️rolls-the-column-50f732/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/🔄️rolls-the-column-50f732/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/🔄️rolls-the-column-50f732/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/🔄️rolls-the-column-50f732/🎯️outcome/🔣️.json");
...
fn produces_committed_diff() {
    ...
    assert_eq!(outcome.diff().elements.as_ref().expect("elements delta").patched.len(), 1, "replace-element/rolls-the-column-50f732: exactly one element may be patched");
