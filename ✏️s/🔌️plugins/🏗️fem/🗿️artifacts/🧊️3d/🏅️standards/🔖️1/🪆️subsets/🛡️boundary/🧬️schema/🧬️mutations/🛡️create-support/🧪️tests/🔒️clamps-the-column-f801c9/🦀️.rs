...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🔒️clamps-the-column-f801c9/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🔒️clamps-the-column-f801c9/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🔒️clamps-the-column-f801c9/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🔒️clamps-the-column-f801c9/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🔒️clamps-the-column-f801c9/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem3dDiff::default(), "create-support/clamps-the-column-f801c9: a refused mutation must carry the empty diff");
