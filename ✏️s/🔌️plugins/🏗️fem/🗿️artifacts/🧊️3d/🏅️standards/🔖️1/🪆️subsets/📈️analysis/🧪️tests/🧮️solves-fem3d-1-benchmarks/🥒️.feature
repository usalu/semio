...
Feature: Solve real fem3d structures, and every typed edit to one, against an independent frame solver
  ...
  Scenario Outline: Apply <id> to a frame that stands up, then solve what it became
    ...
    | replace-node                 | {"mutation":"replaceNode","id":"h4","newNode":{"id":"h4","x":0.0,"y":5.0,"z":4.3}}                                                                                       |
    | replace-load                 | {"mutation":"replaceLoad","caseId":"live","loadId":"q_h3","newLoad":{"kind":"nodal","id":"q_h3","nodeId":"h3","dof":"Tz","value":-25000.0}}                              |
    | change-load-case-name        | {"mutation":"changeLoadCaseName","caseId":"wind","newName":"Wind +Y"}                                                                                                    |
    | replace-combination          | {"mutation":"replaceCombination","id":"sls","newCombination":{"id":"sls","name":"SLS frequent","terms":{"dead":1.0,"live":0.7}}}                                         |
