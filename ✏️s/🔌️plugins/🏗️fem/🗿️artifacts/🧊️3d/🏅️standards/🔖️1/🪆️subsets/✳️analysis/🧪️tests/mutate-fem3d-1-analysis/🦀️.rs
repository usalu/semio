...
/// local copy — see `../../../✳️any/🧪️tests/round-trips-the-committed-document/🥒️.feature` for
...
fn vector(kind: &str) -> Vector {
    match kind {
        "update-analysis-settings" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-buckling-mode-count/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-buckling-mode-count/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-buckling-mode-count/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-buckling-mode-count/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-buckling-mode-count/🎯️outcome/🔣️.json"),
        },
