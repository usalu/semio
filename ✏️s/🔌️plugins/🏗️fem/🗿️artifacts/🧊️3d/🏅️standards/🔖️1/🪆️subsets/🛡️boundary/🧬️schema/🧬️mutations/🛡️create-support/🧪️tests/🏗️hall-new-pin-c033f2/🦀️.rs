...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🏗️hall-new-pin-c033f2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🏗️hall-new-pin-c033f2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🏗️hall-new-pin-c033f2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🏗️hall-new-pin-c033f2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🏗️hall-new-pin-c033f2/🎯️outcome/🔣️.json");
