...
REJECT_VECTORS = (
    "same-element-61adb2",
    "dangling-sec-70b168",
    "renames-brace-219be2",
    "dup-node-id-86f2e1",
    "purlin-in-use-99eb01",
    "no-such-section-50d29b",
    "same-section-d1d013",
    "negative-iy-d4e0a8",
    "renames-purlin-dfe160",
    "dup-section-id-a76686",
    "zero-area-475a19",
    "same-solid-8ad12c",
    "zero-height-2b131a",
    "dangling-mat-9c89da",
    "renames-apron-7bfadd",
    "no-such-node-4027a8",
    "rafter-under-udl-e0342d",
    "no-such-element-eb788c",
    "raft-under-load-e4ea39",
    "no-such-solid-f08d23",
...
def uri_in(ctx, needle):
    ...
    for step in ctx.scenario["steps"]:
        for token in step["text"].split():
            if token.startswith(("asset://", "shared://🕸️mutate-fem3d-1-any-mesh/", "shared://")) and needle in token:
                return token
