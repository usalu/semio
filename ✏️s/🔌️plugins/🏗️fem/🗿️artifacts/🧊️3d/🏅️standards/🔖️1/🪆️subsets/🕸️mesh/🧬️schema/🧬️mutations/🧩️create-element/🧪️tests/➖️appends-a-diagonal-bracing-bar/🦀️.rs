//! 🧪️ `create-element` fixture — `➖️appends-a-diagonal-bracing-bar`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-a-diagonal-bracing-bar/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-a-diagonal-bracing-bar/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-a-diagonal-bracing-bar/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-a-diagonal-bracing-bar/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-a-diagonal-bracing-bar/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem3dDiff::default(), "create-element/appends-a-diagonal-bracing-bar: a refused mutation must carry the empty diff");
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-element/appends-a-diagonal-bracing-bar: produced diff differs from the committed 🔺️diff/🔣️.json");
}
