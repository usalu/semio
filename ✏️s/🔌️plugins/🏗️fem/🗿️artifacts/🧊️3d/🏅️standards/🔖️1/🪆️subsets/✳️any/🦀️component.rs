...
//! `io() -> IoDeclaration` function their migration added to `🚪️io/🦀️component.rs`. fem3d's own
...
pub async fn subset() -> SubsetDeclaration {
    SubsetDeclaration {
        ...
        io: io_declaration(),
        viewer: viewer_surface::<viewer::Fem3dViewer>(viewer::create_fem3d_viewer()),
        editor: editor_surface::<editor::Fem3dPlayApp>(editor::create_fem3d_app()),
        examples: examples(),
    }
}
