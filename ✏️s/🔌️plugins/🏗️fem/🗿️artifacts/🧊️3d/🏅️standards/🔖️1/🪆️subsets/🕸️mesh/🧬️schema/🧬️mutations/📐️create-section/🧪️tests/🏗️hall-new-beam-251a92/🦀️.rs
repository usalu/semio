//! 🧪️ `create-section` fixture — `🏗️hall-new-beam-251a92`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-section/🏗️hall-new-beam-251a92/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-section/🏗️hall-new-beam-251a92/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-section/🏗️hall-new-beam-251a92/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️create-section/🏗️hall-new-beam-251a92/🔺️diff/🔣️.json");
...
fn applies_to_committed_after() {
    ...
    assert_eq!(snapshot, expected_after(), "create-section/hall-new-beam-251a92: applied state differs from committed after-snapshot");
    assert_eq!(snapshot.sections.len(), 6, "create-section/hall-new-beam-251a92: the ridge profile is appended behind the spare strut");
    assert_eq!(snapshot.sections[5].area, 0.16, "create-section/hall-new-beam-251a92: the gross area must survive the round trip exactly");
}
...
fn touches_only_its_own_member() {
    ...
    assert_eq!(snapshot.nodes, base.nodes, "create-section/hall-new-beam-251a92: nodes must not move when this verb runs");
    assert_eq!(snapshot.elements, base.elements, "create-section/hall-new-beam-251a92: elements must not move when this verb runs");
    assert_eq!(snapshot.materials, base.materials, "create-section/hall-new-beam-251a92: materials must not move when this verb runs");
    assert_ne!(snapshot.sections, base.sections, "create-section/hall-new-beam-251a92: sections is the one member this verb writes");
    assert_eq!(snapshot.solids, base.solids, "create-section/hall-new-beam-251a92: solids must not move when this verb runs");
    assert_eq!(snapshot.supports, base.supports, "create-section/hall-new-beam-251a92: supports must not move when this verb runs");
    assert_eq!(snapshot.load_cases, base.load_cases, "create-section/hall-new-beam-251a92: load_cases must not move when this verb runs");
    assert_eq!(snapshot.combinations, base.combinations, "create-section/hall-new-beam-251a92: combinations must not move when this verb runs");
    assert_eq!(snapshot.analysis, base.analysis, "create-section/hall-new-beam-251a92: analysis must not move when this verb runs");
}
...
fn inverse_restores_before() {
    ...
    assert_eq!(snapshot, base, "create-section/hall-new-beam-251a92: inverse did not restore the before-snapshot");
}
...
fn semantics_bind_the_declared_kind() {
    ...
    assert_eq!((semantics.verb, semantics.entity, semantics.kind, semantics.record), ("create", "section", "create-section", "CreatedSection"), "create-section/hall-new-beam-251a92: the fixture must be bound to create-section's own descriptor");
}
