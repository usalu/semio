...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🚨️dangling-mat-1ebd78/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🚨️dangling-mat-1ebd78/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🚨️dangling-mat-1ebd78/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️create-solid/🚨️dangling-mat-1ebd78/🎯️outcome/🔣️.json");
...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem3dDiff::default(), "create-solid/dangling-mat-1ebd78: a refused mutation must carry the empty diff");
