...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-node/🚫️removes-the-column-head-056295/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-node/🚫️removes-the-column-head-056295/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-node/🚫️removes-the-column-head-056295/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-node/🚫️removes-the-column-head-056295/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️delete-node/🚫️removes-the-column-head-056295/🎯️outcome/🔣️.json");
