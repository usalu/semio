...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱️create-material/🚨️dup-material-id-1c0787/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱️create-material/🚨️dup-material-id-1c0787/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱️create-material/🚨️dup-material-id-1c0787/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱️create-material/🚨️dup-material-id-1c0787/🎯️outcome/🔣️.json");
...
fn semantics_bind_the_declared_kind() {
    ...
    assert_eq!(
        ...
        "create-material/dup-material-id-1c0787: the fixture must be bound to create-material's own descriptor"
    );
}
