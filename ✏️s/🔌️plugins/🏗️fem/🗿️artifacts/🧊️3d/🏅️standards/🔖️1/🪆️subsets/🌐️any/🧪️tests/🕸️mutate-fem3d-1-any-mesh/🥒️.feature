...
Feature: Apply every typed fem3d mesh mutation twice — once in Rust, once in Python — and require the same answer
  ...
  Scenario Outline: Apply <id> to the real derived steel frame
    ...
    | create-solid    | {"mutation":"createSolid","solid":{"id":"sol_roof","name":"Roof Slab","outline":[[0.0,0.0],[8.0,0.0],[8.0,10.0],[0.0,10.0]],"holes":[],"baseZ":5.6,"height":0.22,"layers":2,"meshSize":0.75,"materialId":"concrete","axis":"z"}}                               |
