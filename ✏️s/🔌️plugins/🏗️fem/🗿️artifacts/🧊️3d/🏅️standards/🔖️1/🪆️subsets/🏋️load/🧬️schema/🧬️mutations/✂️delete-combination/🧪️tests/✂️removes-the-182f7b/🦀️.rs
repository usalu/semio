...
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-combination/✂️removes-the-182f7b/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-combination/✂️removes-the-182f7b/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-combination/✂️removes-the-182f7b/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-combination/✂️removes-the-182f7b/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem3dDiff::default(), "delete-combination/removes-the-182f7b: a refused mutation must carry the empty diff");
