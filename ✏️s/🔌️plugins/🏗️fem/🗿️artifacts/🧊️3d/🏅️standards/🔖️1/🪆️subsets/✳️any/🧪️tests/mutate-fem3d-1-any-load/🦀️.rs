...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-load-case" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-wind-case-pushing-on-the-column-head/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-wind-case-pushing-on-the-column-head/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-wind-case-pushing-on-the-column-head/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-wind-case-pushing-on-the-column-head/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-wind-case-pushing-on-the-column-head/🎯️outcome/🔣️.json"),
        },
        "delete-load-case" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-wind-case-together-with-its-load/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-wind-case-together-with-its-load/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-wind-case-together-with-its-load/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-wind-case-together-with-its-load/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-wind-case-together-with-its-load/🎯️outcome/🔣️.json"),
        },
        "add-load" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/lays-an-area-pressure-over-the-roof-slab/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/lays-an-area-pressure-over-the-roof-slab/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/lays-an-area-pressure-over-the-roof-slab/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/lays-an-area-pressure-over-the-roof-slab/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/lays-an-area-pressure-over-the-roof-slab/🎯️outcome/🔣️.json"),
        },
        "remove-load" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/drops-the-trailing-member-udl-from-the-dead-case/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/drops-the-trailing-member-udl-from-the-dead-case/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/drops-the-trailing-member-udl-from-the-dead-case/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/drops-the-trailing-member-udl-from-the-dead-case/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/drops-the-trailing-member-udl-from-the-dead-case/🎯️outcome/🔣️.json"),
        },
        "change-load-case-self-weight" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-off-for-the-dead-case/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-off-for-the-dead-case/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-off-for-the-dead-case/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-off-for-the-dead-case/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-off-for-the-dead-case/🎯️outcome/🔣️.json"),
        },
        "create-combination" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-a-serviceability-combination-keyed-by-case-id/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-a-serviceability-combination-keyed-by-case-id/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-a-serviceability-combination-keyed-by-case-id/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-a-serviceability-combination-keyed-by-case-id/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-a-serviceability-combination-keyed-by-case-id/🎯️outcome/🔣️.json"),
        },
        "delete-combination" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-serviceability-combination-and-keeps-both-cases/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-serviceability-combination-and-keeps-both-cases/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-serviceability-combination-and-keeps-both-cases/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-serviceability-combination-and-keeps-both-cases/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-serviceability-combination-and-keeps-both-cases/🎯️outcome/🔣️.json"),
        },
