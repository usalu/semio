...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️create-combination/🔗️appends-a-8ede20/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️create-combination/🔗️appends-a-8ede20/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️create-combination/🔗️appends-a-8ede20/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️create-combination/🔗️appends-a-8ede20/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔗️create-combination/🔗️appends-a-8ede20/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem3dDiff::default(), "create-combination/appends-a-8ede20: a refused mutation must carry the empty diff");
