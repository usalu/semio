...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-support" => Vector {
            before: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🐬️clamps-the-column-base-in-all-six-dofs/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🐬️clamps-the-column-base-in-all-six-dofs/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🐬️clamps-the-column-base-in-all-six-dofs/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🐬️clamps-the-column-base-in-all-six-dofs/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🐬️clamps-the-column-base-in-all-six-dofs/🎯️outcome/🔣️.json"),
        },
        "delete-support" => Vector {
            before: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔖️releases-the-pinned-node-n2/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔖️releases-the-pinned-node-n2/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔖️releases-the-pinned-node-n2/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔖️releases-the-pinned-node-n2/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔖️releases-the-pinned-node-n2/🎯️outcome/🔣️.json"),
        },
        "replace-support" => Vector {
            before: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🎨️frees-the-three-rotations-at-the-column-base/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🎨️frees-the-three-rotations-at-the-column-base/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🎨️frees-the-three-rotations-at-the-column-base/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🎨️frees-the-three-rotations-at-the-column-base/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🎨️frees-the-three-rotations-at-the-column-base/🎯️outcome/🔣️.json"),
        },
