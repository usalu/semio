...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🏗️hall-more-modes-ecbb5c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🏗️hall-more-modes-ecbb5c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🏗️hall-more-modes-ecbb5c/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🏗️hall-more-modes-ecbb5c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🏗️hall-more-modes-ecbb5c/🎯️outcome/🔣️.json");
...
fn semantics_bind_the_declared_kind() {
    ...
    assert_eq!(
        ...
        "update-analysis-settings/hall-more-modes-ecbb5c: the fixture must be bound to update-analysis-settings's own descriptor"
    );
}
