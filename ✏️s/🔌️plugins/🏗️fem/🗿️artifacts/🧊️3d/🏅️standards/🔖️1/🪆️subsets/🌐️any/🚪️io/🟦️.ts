/**
 * 🚪️ Typed twin of `🚪️io/🦀️.rs`'s `io() -> IoDeclaration` for `s.fem.fem3d@1/*`.
 *
 ...
 * conversions does fem3d offer, and how lossy is each" without instantiating the WASM component,
...
export const FEM3D_DIALECT: IoDialect = { artifactKind: "s.fem.fem3d", standard: "1", subset: "*" };
 ...
 */
export const FEM3D_IO_ENTRIES: readonly IoEntryTwin[] = [
  { from: FEM3D_DIALECT, into: TXT, fidelity: "exact", implemented: true },
  { from: TXT, into: FEM3D_DIALECT, fidelity: "exact", implemented: true },
  { from: FEM3D_DIALECT, into: JSON_RFC8259, fidelity: "exact", implemented: true },
  { from: JSON_RFC8259, into: FEM3D_DIALECT, fidelity: "exact", implemented: true },
  { from: FEM3D_DIALECT, into: CSV, fidelity: "exact", implemented: true },
  { from: CSV, into: FEM3D_DIALECT, fidelity: "exact", implemented: true },
  { from: FEM3D_DIALECT, into: MD, fidelity: "exact", implemented: true },
  { from: MD, into: FEM3D_DIALECT, fidelity: "exact", implemented: true },
  { from: FEM3D_DIALECT, into: STL, fidelity: "lossy", implemented: true },
  { from: STL, into: FEM3D_DIALECT, fidelity: "lossy", implemented: false },
  { from: FEM3D_DIALECT, into: OBJ, fidelity: "lossy", implemented: true },
  { from: OBJ, into: FEM3D_DIALECT, fidelity: "lossy", implemented: false },
] as const;
...
export const MD_FENCE_INFO = "fem3d";

/** 📄️ The `.semio` text preamble every `fem3d` document opens with — mirrors the Rust `DSL_PREAMBLE`. */
export const DSL_PREAMBLE = "semio fem.fem3d.dsl ";
