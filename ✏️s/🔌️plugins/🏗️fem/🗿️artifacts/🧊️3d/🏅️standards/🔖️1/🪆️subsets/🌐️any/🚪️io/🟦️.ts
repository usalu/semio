...
export const FEM3D_IO_ENTRIES: readonly IoEntryTwin[] = [
  { from: FEM3D_DIALECT, into: TXT, fidelity: "exact" },
  { from: TXT, into: FEM3D_DIALECT, fidelity: "exact" },
  { from: FEM3D_DIALECT, into: JSON_RFC8259, fidelity: "exact" },
  { from: JSON_RFC8259, into: FEM3D_DIALECT, fidelity: "exact" },
  { from: FEM3D_DIALECT, into: CSV, fidelity: "lossy" },
  { from: FEM3D_DIALECT, into: STL, fidelity: "lossy" },
  { from: FEM3D_DIALECT, into: OBJ, fidelity: "lossy" },
] as const;
