...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🏗️hall-cut-gl32c-264bca/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🏗️hall-cut-gl32c-264bca/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🏗️hall-cut-gl32c-264bca/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🏗️hall-cut-gl32c-264bca/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🏗️hall-cut-gl32c-264bca/🎯️outcome/🔣️.json");
...
fn semantics_bind_the_declared_kind() {
    ...
    assert_eq!(
        ...
        "delete-material/hall-cut-gl32c-264bca: the fixture must be bound to delete-material's own descriptor"
    );
}
