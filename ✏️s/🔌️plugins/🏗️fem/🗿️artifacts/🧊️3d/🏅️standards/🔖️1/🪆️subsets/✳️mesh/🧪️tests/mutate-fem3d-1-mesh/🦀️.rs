...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-node" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🌱⚪️create-node/🧪️tests/appends-the-column-head-node-n3/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🌱⚪️create-node/🧪️tests/appends-the-column-head-node-n3/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🌱⚪️create-node/🧪️tests/appends-the-column-head-node-n3/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🌱⚪️create-node/🧪️tests/appends-the-column-head-node-n3/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🌱⚪️create-node/🧪️tests/appends-the-column-head-node-n3/🎯️outcome/🔣️.json"),
        },
        "delete-node" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🗑⚪️delete-node/🧪️tests/removes-the-column-head-node-under-a-live-frame/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🗑⚪️delete-node/🧪️tests/removes-the-column-head-node-under-a-live-frame/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🗑⚪️delete-node/🧪️tests/removes-the-column-head-node-under-a-live-frame/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🗑⚪️delete-node/🧪️tests/removes-the-column-head-node-under-a-live-frame/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🗑⚪️delete-node/🧪️tests/removes-the-column-head-node-under-a-live-frame/🎯️outcome/🔣️.json"),
        },
        "create-element" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🌱🧩️create-element/🧪️tests/appends-a-diagonal-bracing-bar/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🌱🧩️create-element/🧪️tests/appends-a-diagonal-bracing-bar/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🌱🧩️create-element/🧪️tests/appends-a-diagonal-bracing-bar/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🌱🧩️create-element/🧪️tests/appends-a-diagonal-bracing-bar/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🌱🧩️create-element/🧪️tests/appends-a-diagonal-bracing-bar/🎯️outcome/🔣️.json"),
        },
        "delete-element" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🗑🧩️delete-element/🧪️tests/removes-the-bracing-bar-and-leaves-the-frame/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🗑🧩️delete-element/🧪️tests/removes-the-bracing-bar-and-leaves-the-frame/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🗑🧩️delete-element/🧪️tests/removes-the-bracing-bar-and-leaves-the-frame/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🗑🧩️delete-element/🧪️tests/removes-the-bracing-bar-and-leaves-the-frame/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🗑🧩️delete-element/🧪️tests/removes-the-bracing-bar-and-leaves-the-frame/🎯️outcome/🔣️.json"),
        },
        "replace-element" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🔁🧩️replace-element/🧪️tests/rolls-the-column-about-its-own-axis/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🔁🧩️replace-element/🧪️tests/rolls-the-column-about-its-own-axis/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🔁🧩️replace-element/🧪️tests/rolls-the-column-about-its-own-axis/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🔁🧩️replace-element/🧪️tests/rolls-the-column-about-its-own-axis/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🔁🧩️replace-element/🧪️tests/rolls-the-column-about-its-own-axis/🎯️outcome/🔣️.json"),
        },
        "create-section" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🌱create-section/🧪️tests/appends-a-square-hollow-profile/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🌱create-section/🧪️tests/appends-a-square-hollow-profile/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🌱create-section/🧪️tests/appends-a-square-hollow-profile/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🌱create-section/🧪️tests/appends-a-square-hollow-profile/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🌱create-section/🧪️tests/appends-a-square-hollow-profile/🎯️outcome/🔣️.json"),
        },
        "delete-section" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🗑📐️delete-section/🧪️tests/removes-the-spare-square-hollow-profile/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🗑📐️delete-section/🧪️tests/removes-the-spare-square-hollow-profile/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🗑📐️delete-section/🧪️tests/removes-the-spare-square-hollow-profile/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🗑📐️delete-section/🧪️tests/removes-the-spare-square-hollow-profile/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🗑📐️delete-section/🧪️tests/removes-the-spare-square-hollow-profile/🎯️outcome/🔣️.json"),
        },
        "replace-section" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🔁📐️replace-section/🧪️tests/raises-the-torsion-constant-of-hea200/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🔁📐️replace-section/🧪️tests/raises-the-torsion-constant-of-hea200/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🔁📐️replace-section/🧪️tests/raises-the-torsion-constant-of-hea200/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🔁📐️replace-section/🧪️tests/raises-the-torsion-constant-of-hea200/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🔁📐️replace-section/🧪️tests/raises-the-torsion-constant-of-hea200/🎯️outcome/🔣️.json"),
        },
        "create-solid" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🌱🧊️create-solid/🧪️tests/appends-an-extruded-roof-slab/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🌱🧊️create-solid/🧪️tests/appends-an-extruded-roof-slab/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🌱🧊️create-solid/🧪️tests/appends-an-extruded-roof-slab/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🌱🧊️create-solid/🧪️tests/appends-an-extruded-roof-slab/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🌱🧊️create-solid/🧪️tests/appends-an-extruded-roof-slab/🎯️outcome/🔣️.json"),
        },
        "delete-solid" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🗑🧊️delete-solid/🧪️tests/removes-the-roof-slab-and-keeps-its-material/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🗑🧊️delete-solid/🧪️tests/removes-the-roof-slab-and-keeps-its-material/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🗑🧊️delete-solid/🧪️tests/removes-the-roof-slab-and-keeps-its-material/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🗑🧊️delete-solid/🧪️tests/removes-the-roof-slab-and-keeps-its-material/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🗑🧊️delete-solid/🧪️tests/removes-the-roof-slab-and-keeps-its-material/🎯️outcome/🔣️.json"),
        },
        "replace-solid" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🔁replace-solid/🧪️tests/thickens-the-slab-and-adds-a-mesh-layer/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🔁replace-solid/🧪️tests/thickens-the-slab-and-adds-a-mesh-layer/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🔁replace-solid/🧪️tests/thickens-the-slab-and-adds-a-mesh-layer/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🔁replace-solid/🧪️tests/thickens-the-slab-and-adds-a-mesh-layer/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🔁replace-solid/🧪️tests/thickens-the-slab-and-adds-a-mesh-layer/🎯️outcome/🔣️.json"),
        },
