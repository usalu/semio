...
mod wasm_bridge {
    use crate::artifacts::fem3d::mutations::Fem3dStore;
    ...
    impl Fem3dSnapshotVcs {
        ...
        pub async fn create() -> Result<Fem3dSnapshotVcs, JsValue> {
            let store = Fem3dStore::new(create_document_envelope(crate::artifacts::fem3d::FEM_3D_SCHEMA, "fem3d", crate::artifacts::fem3d::schema::empty_fem3d_snapshot(), None)).await.map_err(|e| JsValue::from_str(&e.to_string()))?;
