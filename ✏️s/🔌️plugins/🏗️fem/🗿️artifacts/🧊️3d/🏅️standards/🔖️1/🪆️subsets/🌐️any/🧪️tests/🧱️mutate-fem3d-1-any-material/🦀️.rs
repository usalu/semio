...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-material" => Vector {
            before: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🌱️create-material/🧪️tests/🪙️appends-an-aluminium-alloy/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🌱️create-material/🧪️tests/🪙️appends-an-aluminium-alloy/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🌱️create-material/🧪️tests/🪙️appends-an-aluminium-alloy/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🌱️create-material/🧪️tests/🪙️appends-an-aluminium-alloy/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🌱️create-material/🧪️tests/🪙️appends-an-aluminium-alloy/🎯️outcome/🔣️.json"),
        },
        "delete-material" => Vector {
            before: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-unreferenced-aluminium-alloy/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-unreferenced-aluminium-alloy/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-unreferenced-aluminium-alloy/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-unreferenced-aluminium-alloy/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-unreferenced-aluminium-alloy/🎯️outcome/🔣️.json"),
        },
        "replace-material" => Vector {
            before: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/📉️softens-the-steel-shear-modulus-in-place/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/📉️softens-the-steel-shear-modulus-in-place/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/📉️softens-the-steel-shear-modulus-in-place/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/📉️softens-the-steel-shear-modulus-in-place/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/📉️softens-the-steel-shear-modulus-in-place/🎯️outcome/🔣️.json"),
        },
