//! 🧪️ `create-section` fixture — `appends-a-square-hollow-profile`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-section/appends-a-square-hollow-profile: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
