...
pub fn register() {
    crate::artifacts::fem3d::io_registry::register();
...
/// 💡️ Registers the fem3d artifact 💡️inference schema descriptor into the OS-wide inference
...
pub fn register_artifact_inferences() {
    ::schema::register_artifact_inference_descriptor(
        crate::artifacts::fem3d::standards::v1::subsets::any::schema::inferences::fem3d_artifact_inference_descriptor(),
    );
}
