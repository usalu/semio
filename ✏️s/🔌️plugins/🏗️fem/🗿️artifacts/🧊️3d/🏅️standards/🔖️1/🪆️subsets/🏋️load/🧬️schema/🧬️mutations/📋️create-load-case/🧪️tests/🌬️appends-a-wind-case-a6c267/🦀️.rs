...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::artifacts::fem3d::diff::Fem3dDiff::default(), "create-load-case/appends-a-wind-case-a6c267: a refused mutation must carry the empty diff");
