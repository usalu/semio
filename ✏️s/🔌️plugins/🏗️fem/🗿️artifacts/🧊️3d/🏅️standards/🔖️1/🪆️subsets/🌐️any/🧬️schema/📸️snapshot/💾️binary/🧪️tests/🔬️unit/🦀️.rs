...
fn fem3d_pack_agrees_with_dsl_for_bundled_default_example() {
    let document = crate::standards::v1::subsets::any::schema::snapshot::text::parse_dsl(crate::standards::v1::subsets::any::schema::snapshot::text::FEM3D_EXAMPLE_TEXT).expect("parse default example");
