...
/// local copy.
#[cfg(feature = "sut")]
const DERIVED_ASSET: &str = "shared://🔄️round-trips-the-committed-document/🧊️steel-frame.snapshot.json";
...
mod subject {
    ...
    use crate::standards::v1::subsets::any::schema::snapshot::fem3d_identity_report_json;
