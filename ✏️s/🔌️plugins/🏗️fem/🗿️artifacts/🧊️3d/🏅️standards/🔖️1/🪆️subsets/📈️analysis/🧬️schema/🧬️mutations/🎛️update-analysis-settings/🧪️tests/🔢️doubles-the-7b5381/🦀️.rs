...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🔢️doubles-the-7b5381/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🔢️doubles-the-7b5381/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🔢️doubles-the-7b5381/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🔢️doubles-the-7b5381/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️update-analysis-settings/🔢️doubles-the-7b5381/🎯️outcome/🔣️.json");
...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem3dDiff::default(), "update-analysis-settings/doubles-the-7b5381: a refused mutation must carry the empty diff");
