...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::artifacts::fem3d::diff::Fem3dDiff::default(), "delete-section/removes-the-spare-30ecfb: a refused mutation must carry the empty diff");
