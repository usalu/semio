...
fn declared_outcome_holds() {
    ...
    match status {
        ...
        "rejected" => {
            ...
            assert_eq!(produced.diff(), &crate::artifacts::fem3d::diff::Fem3dDiff::default(), "replace-section/raises-the-torsion-296ef0: a refused mutation must carry the empty diff");
