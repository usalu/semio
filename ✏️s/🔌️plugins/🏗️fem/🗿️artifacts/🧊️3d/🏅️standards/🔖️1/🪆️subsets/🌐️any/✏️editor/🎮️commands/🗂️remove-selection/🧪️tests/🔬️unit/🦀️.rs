...
async fn remove_selection_covers_solids_3d() {
    ...
    dispatch(&mut app, Fem3dCommand::AddSolid(crate::editor::fem3d::commands::add_solid::AddSolid { x: 0.0, y: 0.0, width: 1.0, depth: 1.0, height: 1.0, material_id, base_z: None, layers: None, mesh_size: None, axis: None })).await;
