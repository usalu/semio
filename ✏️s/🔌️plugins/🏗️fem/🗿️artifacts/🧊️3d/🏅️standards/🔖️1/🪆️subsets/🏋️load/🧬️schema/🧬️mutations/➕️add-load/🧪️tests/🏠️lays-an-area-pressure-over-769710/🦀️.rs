//! 🧪️ `add-load` fixture — `🏠️lays-an-area-pressure-over-769710`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/🏠️lays-an-area-pressure-over-769710/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/🏠️lays-an-area-pressure-over-769710/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/🏠️lays-an-area-pressure-over-769710/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/🏠️lays-an-area-pressure-over-769710/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/🏠️lays-an-area-pressure-over-769710/🎯️outcome/🔣️.json");
