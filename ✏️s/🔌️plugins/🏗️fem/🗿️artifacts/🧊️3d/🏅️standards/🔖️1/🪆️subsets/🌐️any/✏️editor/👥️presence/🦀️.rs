//! 👥️ Fem3dPresence — empty shareable live state (selection is command-transient; camera/results live in config).
...
/// and camera / result display already live on `Fem3dConfig` as `local-ui`.
...
pub enum Fem3dPresenceMutation {
    Noop,
}
...
impl Mutation<Fem3dPresence> for Fem3dPresenceMutation {
    ...
    const DESCRIPTORS: &'static [protocol::MutationLeafDescriptor] = &[
        protocol::MutationLeafDescriptor { schema_version: 1, owner: "✏️s/🔌️plugins/🏗️fem/🗿️artifacts/🧊️3d/🏅️standards/🔖️1/🪆️subsets/🌐️any/✏️editor/👥️presence/🚫️presence-noop", semantic_kind: "presence-noop", display_name: "Presence Noop", emoji: "🚫", aggregate_variant: "Noop", payload_schema: "🧬️schema/🔣️.json", text_opcode: None, binary_tag: None, invertibility: protocol::MutationInvertibility::ExplicitMutation, diff_participation: protocol::MutationDiffParticipation::Detect, outcome_classes: &[protocol::MutationOutcomeClass::Applied], composition: protocol::MutationComposition::Atomic, required_language_surfaces: &[protocol::MutationLanguageSurface::Rust, protocol::MutationLanguageSurface::JsonSchema] },
    ];
    ...
    fn inverse(&self, _base: &Fem3dPresence) -> Vec<Self> {
        vec![Fem3dPresenceMutation::Noop]
    }
}

impl protocol::OpText for Fem3dPresenceMutation {
...
impl protocol::OpBinary for Fem3dPresenceMutation {
