...
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️replace-section/🪪️renames-purlin-dfe160/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️replace-section/🪪️renames-purlin-dfe160/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️replace-section/🪪️renames-purlin-dfe160/🎯️outcome/🔣️.json");
