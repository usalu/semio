//! 🗺️ FEM 3D artifact engine — cheap solid mesh preview + nodal-averaged stress (constitutional:
...
mod tests {
    use super::*;
    use crate::artifacts::fem3d::{FemAnalysisSettings, FemDof, FemLoadCase, FemMaterial, FemNode, FemSection, FemSolid, FemSupport};
