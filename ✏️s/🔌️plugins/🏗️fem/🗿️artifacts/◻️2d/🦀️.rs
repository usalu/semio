...
pub use crate::schema::Fem2dArtifact;
...
pub fn artifact() -> semio_framework_plugin::app::declarations::ArtifactDeclaration<crate::FemApps> {
    ...
    ArtifactDeclaration { kind: ArtifactKindId::parse("s.fem.fem2d").expect("canonical fem2d kind"), localization: &[], standards: vec![crate::standards::v1::standard()] }
}
