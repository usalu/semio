...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "replace-region/denies-zero-thick-7d805e: a rejecting replace-region must carry the empty diff, never a half-built delta");
