...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "create-material/rejects-a-duplicate-f3220b: a rejecting create-material must carry the empty diff, never a half-built delta");
