...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "add-load/rejects-a-missing-4271bc: a rejecting add-load must carry the empty diff, never a half-built delta");
