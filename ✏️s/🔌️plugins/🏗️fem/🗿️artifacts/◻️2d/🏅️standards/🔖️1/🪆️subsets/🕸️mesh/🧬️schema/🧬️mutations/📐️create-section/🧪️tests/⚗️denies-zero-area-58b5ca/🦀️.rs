...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "create-section/denies-zero-area-58b5ca: a rejecting create-section must carry the empty diff, never a half-built delta");
