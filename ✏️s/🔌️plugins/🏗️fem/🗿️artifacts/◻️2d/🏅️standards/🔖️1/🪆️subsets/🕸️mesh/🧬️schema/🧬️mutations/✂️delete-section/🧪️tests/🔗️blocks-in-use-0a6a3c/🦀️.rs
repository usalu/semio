...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "delete-section/blocks-in-use-0a6a3c: a rejecting delete-section must carry the empty diff, never a half-built delta");
