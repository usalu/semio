...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "replace-material/rejects-a-missing-b3adee: a rejecting replace-material must carry the empty diff, never a half-built delta");
