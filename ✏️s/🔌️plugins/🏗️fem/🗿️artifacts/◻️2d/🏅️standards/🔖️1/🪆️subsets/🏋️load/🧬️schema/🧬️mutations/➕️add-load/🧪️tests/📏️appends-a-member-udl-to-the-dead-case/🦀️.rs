//! 🧪️ `add-load` fixture — `📏️appends-a-member-udl-to-the-dead-case`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/📏️appends-a-member-udl-to-the-dead-case/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/📏️appends-a-member-udl-to-the-dead-case/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/📏️appends-a-member-udl-to-the-dead-case/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/📏️appends-a-member-udl-to-the-dead-case/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-load/📏️appends-a-member-udl-to-the-dead-case/🎯️outcome/🔣️.json");
