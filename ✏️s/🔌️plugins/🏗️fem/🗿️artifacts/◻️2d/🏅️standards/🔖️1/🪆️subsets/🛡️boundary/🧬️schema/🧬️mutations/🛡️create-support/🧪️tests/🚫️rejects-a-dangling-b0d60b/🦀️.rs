...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "create-support/rejects-a-dangling-b0d60b: a rejecting create-support must carry the empty diff, never a half-built delta");
