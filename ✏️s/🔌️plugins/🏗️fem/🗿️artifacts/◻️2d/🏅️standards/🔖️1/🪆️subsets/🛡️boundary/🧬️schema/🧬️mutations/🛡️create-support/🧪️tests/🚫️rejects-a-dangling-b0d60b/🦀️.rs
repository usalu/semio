...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🚫️rejects-a-dangling-b0d60b/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🚫️rejects-a-dangling-b0d60b/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🚫️rejects-a-dangling-b0d60b/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛡️create-support/🚫️rejects-a-dangling-b0d60b/🎯️outcome/🔣️.json");
...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem2dDiff::default(), "create-support/rejects-a-dangling-b0d60b: a rejecting create-support must carry the empty diff, never a half-built delta");
