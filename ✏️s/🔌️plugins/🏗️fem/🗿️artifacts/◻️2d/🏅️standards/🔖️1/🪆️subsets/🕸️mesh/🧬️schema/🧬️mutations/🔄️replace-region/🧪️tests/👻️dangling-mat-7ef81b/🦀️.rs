...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "replace-region/dangling-mat-7ef81b: a rejecting replace-region must carry the empty diff, never a half-built delta");
