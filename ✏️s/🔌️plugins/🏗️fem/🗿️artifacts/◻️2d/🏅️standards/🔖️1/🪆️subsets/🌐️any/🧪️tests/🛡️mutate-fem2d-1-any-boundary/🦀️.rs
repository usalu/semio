...
//#region 🔖️Kinds
/// 🏷️ This subset's own slice of `KINDS` in `../../../🛡️boundary/🧬️schema/🧬️mutations/🦀️.rs` — duplicated, not
...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-support" => Vector {
            before: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🛞️adds-a-vertical-roller-at-node-n2/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🛞️adds-a-vertical-roller-at-node-n2/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🛞️adds-a-vertical-roller-at-node-n2/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🛞️adds-a-vertical-roller-at-node-n2/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🛡️create-support/🧪️tests/🛞️adds-a-vertical-roller-at-node-n2/🎯️outcome/🔣️.json"),
        },
        "delete-support" => Vector {
            before: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔓️releases-the-roller-at-node-n2/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔓️releases-the-roller-at-node-n2/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔓️releases-the-roller-at-node-n2/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔓️releases-the-roller-at-node-n2/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🗑️delete-support/🧪️tests/🔓️releases-the-roller-at-node-n2/🎯️outcome/🔣️.json"),
        },
        "replace-support" => Vector {
            before: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🔒️upgrades-the-roller-at-n2-to-a-full-fixity/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🔒️upgrades-the-roller-at-n2-to-a-full-fixity/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🔒️upgrades-the-roller-at-n2-to-a-full-fixity/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🔒️upgrades-the-roller-at-n2-to-a-full-fixity/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🛡️boundary/🧬️schema/🧬️mutations/🔁️replace-support/🧪️tests/🔒️upgrades-the-roller-at-n2-to-a-full-fixity/🎯️outcome/🔣️.json"),
        },
