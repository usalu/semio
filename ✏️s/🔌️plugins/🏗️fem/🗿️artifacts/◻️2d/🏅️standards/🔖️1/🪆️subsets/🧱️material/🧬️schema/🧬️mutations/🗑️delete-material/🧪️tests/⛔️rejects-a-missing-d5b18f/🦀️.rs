...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "delete-material/rejects-a-missing-d5b18f: a rejecting delete-material must carry the empty diff, never a half-built delta");
