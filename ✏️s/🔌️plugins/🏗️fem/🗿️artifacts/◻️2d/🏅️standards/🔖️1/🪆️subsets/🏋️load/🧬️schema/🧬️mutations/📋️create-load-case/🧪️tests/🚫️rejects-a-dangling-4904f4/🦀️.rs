...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "create-load-case/rejects-a-dangling-4904f4: a rejecting create-load-case must carry the empty diff, never a half-built delta");
