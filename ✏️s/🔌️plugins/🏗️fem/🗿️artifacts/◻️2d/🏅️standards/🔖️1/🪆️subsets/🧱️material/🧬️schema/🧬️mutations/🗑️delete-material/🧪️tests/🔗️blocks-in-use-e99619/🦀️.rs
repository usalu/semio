//! 🧪️ `delete-material` fixture — `🔗️blocks-in-use-e99619`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🔗️blocks-in-use-e99619/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🔗️blocks-in-use-e99619/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🔗️blocks-in-use-e99619/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-material/🔗️blocks-in-use-e99619/🎯️outcome/🔣️.json");
...
fn rejection_leaves_the_document_untouched() {
    ...
    assert_eq!(snapshot, expected_after(), "delete-material/blocks-in-use-e99619: applied state differs from committed after-snapshot");
    assert_eq!(snapshot, base, "delete-material/blocks-in-use-e99619: a refused mutation must leave the snapshot exactly where it was");
}
...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem2dDiff::default(), "delete-material/blocks-in-use-e99619: a rejecting delete-material must carry the empty diff, never a half-built delta");
...
fn inverse_of_the_refused_mutation() {
    ...
    assert_eq!(undo.material.id, "steel_s355", "the inverse recreates exactly the material the delete was refused for");
}
