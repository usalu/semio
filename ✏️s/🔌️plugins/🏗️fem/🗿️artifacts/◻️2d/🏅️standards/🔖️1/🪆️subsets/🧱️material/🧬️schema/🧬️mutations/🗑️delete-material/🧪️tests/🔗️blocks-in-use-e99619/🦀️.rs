...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "delete-material/blocks-in-use-e99619: a rejecting delete-material must carry the empty diff, never a half-built delta");
