...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "create-region/denies-loose-hole-d9efa1: a rejecting create-region must carry the empty diff, never a half-built delta");
