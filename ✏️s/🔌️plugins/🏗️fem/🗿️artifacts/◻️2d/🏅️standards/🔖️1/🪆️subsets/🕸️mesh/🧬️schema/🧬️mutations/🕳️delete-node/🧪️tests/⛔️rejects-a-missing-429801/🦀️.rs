...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "delete-node/rejects-a-missing-429801: a rejecting delete-node must carry the empty diff, never a half-built delta");
