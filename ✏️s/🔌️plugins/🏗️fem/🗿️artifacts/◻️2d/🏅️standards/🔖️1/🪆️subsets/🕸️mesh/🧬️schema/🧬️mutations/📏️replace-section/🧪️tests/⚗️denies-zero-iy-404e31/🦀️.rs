...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "replace-section/denies-zero-iy-404e31: a rejecting replace-section must carry the empty diff, never a half-built delta");
