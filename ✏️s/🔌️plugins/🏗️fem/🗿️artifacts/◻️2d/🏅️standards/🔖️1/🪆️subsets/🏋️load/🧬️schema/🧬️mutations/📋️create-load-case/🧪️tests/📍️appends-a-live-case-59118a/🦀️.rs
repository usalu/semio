...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/📍️appends-a-live-case-59118a/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/📍️appends-a-live-case-59118a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/📍️appends-a-live-case-59118a/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/📍️appends-a-live-case-59118a/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/📍️appends-a-live-case-59118a/🎯️outcome/🔣️.json");
