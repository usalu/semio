...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "create-material/denies-poisson-329e35: a rejecting create-material must carry the empty diff, never a half-built delta");
