...
subset's typed mutations (`add-load`, `change-load-case-self-weight`, `create-combination`, `create-load-case`, `delete-combination`, `delete-load-case`, `remove-load`), in Python, serving as this case's differential oracle.
...
KINDS = ("add-load", "change-load-case-self-weight", "create-combination", "create-load-case", "delete-combination", "delete-load-case", "remove-load")
"""🏷️ This subset's own kinds, in the catalog's declared order."""

REFUSALS = {"add-load": 2, "change-load-case-self-weight": 1, "create-combination": 1, "create-load-case": 1, "delete-combination": 2, "delete-load-case": 2, "remove-load": 1}
