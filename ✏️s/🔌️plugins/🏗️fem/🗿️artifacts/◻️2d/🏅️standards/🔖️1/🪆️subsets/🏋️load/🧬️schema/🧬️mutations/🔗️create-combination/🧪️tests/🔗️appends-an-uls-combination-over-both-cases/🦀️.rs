//! 🧪️ `create-combination` fixture — `🔗️appends-an-uls-combination-over-both-cases`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-combination/appends-an-uls-combination-over-both-cases: produced diff differs from the committed 🔺️diff/🔣️.json");
}
