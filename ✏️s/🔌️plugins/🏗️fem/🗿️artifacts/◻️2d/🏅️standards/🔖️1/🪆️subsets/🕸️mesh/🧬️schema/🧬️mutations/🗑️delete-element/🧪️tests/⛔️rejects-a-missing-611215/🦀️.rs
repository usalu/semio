...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "delete-element/rejects-a-missing-611215: a rejecting delete-element must carry the empty diff, never a half-built delta");
