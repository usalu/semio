...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "delete-combination/rejects-a-missing-d4bc03: a rejecting delete-combination must carry the empty diff, never a half-built delta");
