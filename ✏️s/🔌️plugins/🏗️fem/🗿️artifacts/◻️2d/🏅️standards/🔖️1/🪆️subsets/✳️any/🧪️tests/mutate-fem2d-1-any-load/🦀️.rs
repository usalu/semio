...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-load-case" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-live-case-carrying-one-nodal-load/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-live-case-carrying-one-nodal-load/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-live-case-carrying-one-nodal-load/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-live-case-carrying-one-nodal-load/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱📋️create-load-case/🧪️tests/appends-a-live-case-carrying-one-nodal-load/🎯️outcome/🔣️.json"),
        },
        "delete-load-case" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-live-case-together-with-its-loads/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-live-case-together-with-its-loads/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-live-case-together-with-its-loads/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-live-case-together-with-its-loads/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑📋️delete-load-case/🧪️tests/removes-the-live-case-together-with-its-loads/🎯️outcome/🔣️.json"),
        },
        "add-load" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/appends-a-member-udl-to-the-dead-case/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/appends-a-member-udl-to-the-dead-case/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/appends-a-member-udl-to-the-dead-case/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/appends-a-member-udl-to-the-dead-case/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➕add-load/🧪️tests/appends-a-member-udl-to-the-dead-case/🎯️outcome/🔣️.json"),
        },
        "remove-load" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/strips-the-trailing-member-udl-from-the-dead-case/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/strips-the-trailing-member-udl-from-the-dead-case/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/strips-the-trailing-member-udl-from-the-dead-case/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/strips-the-trailing-member-udl-from-the-dead-case/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/➖remove-load/🧪️tests/strips-the-trailing-member-udl-from-the-dead-case/🎯️outcome/🔣️.json"),
        },
        "change-load-case-self-weight" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-on-for-the-dead-case/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-on-for-the-dead-case/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-on-for-the-dead-case/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-on-for-the-dead-case/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/⚖change-load-case-self-weight/🧪️tests/switches-self-weight-on-for-the-dead-case/🎯️outcome/🔣️.json"),
        },
        "create-combination" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-an-uls-combination-over-both-cases/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-an-uls-combination-over-both-cases/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-an-uls-combination-over-both-cases/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-an-uls-combination-over-both-cases/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🌱🔗️create-combination/🧪️tests/appends-an-uls-combination-over-both-cases/🎯️outcome/🔣️.json"),
        },
        "delete-combination" => Vector {
            before: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-uls-combination-and-keeps-both-cases/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-uls-combination-and-keeps-both-cases/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-uls-combination-and-keeps-both-cases/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-uls-combination-and-keeps-both-cases/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️load/🧬️schema/🧬️mutations/🗑🔗️delete-combination/🧪️tests/removes-the-uls-combination-and-keeps-both-cases/🎯️outcome/🔣️.json"),
        },
