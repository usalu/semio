...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "replace-support/rejects-a-missing-afbf6d: a rejecting replace-support must carry the empty diff, never a half-built delta");
