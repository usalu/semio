...
fn vector(kind: &str) -> Vector {
    match kind {
        ...
        "delete-material" => Vector {
            before: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-30f7a2/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-30f7a2/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-30f7a2/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-30f7a2/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🗑️delete-material/🧪️tests/🚫️removes-the-30f7a2/🎯️outcome/🔣️.json"),
        },
        "replace-material" => Vector {
            before: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/🏗️restates-steel-7c22bc/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/🏗️restates-steel-7c22bc/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/🏗️restates-steel-7c22bc/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/🏗️restates-steel-7c22bc/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../🧱️material/🧬️schema/🧬️mutations/🔁️replace-material/🧪️tests/🏗️restates-steel-7c22bc/🎯️outcome/🔣️.json"),
        },
