...
#[cfg(feature = "sut")]
const DERIVED_ASSET: &str = "shared://🧱️mutate-fem2d-1-any-material/🏗️timber-portal-frame.snapshot.json";
//#endregion 🔖️Kinds
...
fn vector(kind: &str) -> Vector {
    match kind {
        ...
        "delete-material" => Vector {
            ...
            mutation: include_str!("../../../🧱️material/🧫️fixtures/🧬️mutations/🗑️delete-material/🚫️removes-the-30f7a2/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🧱️material/🧫️fixtures/🧬️mutations/🗑️delete-material/🚫️removes-the-30f7a2/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../🧱️material/🧫️fixtures/🧬️mutations/🗑️delete-material/🚫️removes-the-30f7a2/🔺️diff/🔣️.json"),
...
mod subject {
    ...
    fn uri_in(ctx: &Context, needle: &str) -> Result<String, String> {
        ctx.scenario
            ...
            .find(|token| (token.starts_with("asset://") || token.starts_with("shared://🧱️mutate-fem2d-1-any-material/") || token.starts_with("shared://")) && token.contains(needle))
