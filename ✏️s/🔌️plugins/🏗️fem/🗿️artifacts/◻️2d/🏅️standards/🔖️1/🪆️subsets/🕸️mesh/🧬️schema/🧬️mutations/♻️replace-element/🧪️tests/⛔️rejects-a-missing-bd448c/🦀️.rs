...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "replace-element/rejects-a-missing-bd448c: a rejecting replace-element must carry the empty diff, never a half-built delta");
