...
impl TryFrom<&str> for Fem2dLoopMode {
    ...
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            ...
            "once" => Ok(Self::Once),
            _ => Err("unknown FEM 2D loop mode"),
        }
    }
}
...
impl TryFrom<&str> for Fem2dWaveform {
    type Error = &'static str;
    fn try_from(value: &str) -> Result<Self, Self::Error> {
        match value {
            "ramp" => Ok(Self::Ramp),
            "sine" => Ok(Self::Sine),
            _ => Err("unknown FEM 2D waveform"),
        }
    }
}
...
pub struct Fem2dResultsAnimation {
    pub phase: f64,
    pub playing: bool,
    pub speed: f64,
    pub loop_mode: Fem2dLoopMode,
    pub waveform: Fem2dWaveform,
    pub reverse: bool,
}
...
pub struct Fem2dResultsWindowConfig {
    ...
    #[dsl(block)]
    pub animation: Fem2dResultsAnimation,
}
