...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-material" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🌱🧱️create-material/🧪️tests/appends-concrete-c30/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🌱🧱️create-material/🧪️tests/appends-concrete-c30/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🌱🧱️create-material/🧪️tests/appends-concrete-c30/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🌱🧱️create-material/🧪️tests/appends-concrete-c30/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🌱🧱️create-material/🧪️tests/appends-concrete-c30/🎯️outcome/🔣️.json"),
        },
        "delete-material" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🗑🧱️delete-material/🧪️tests/removes-the-unreferenced-timber-material/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🗑🧱️delete-material/🧪️tests/removes-the-unreferenced-timber-material/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🗑🧱️delete-material/🧪️tests/removes-the-unreferenced-timber-material/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🗑🧱️delete-material/🧪️tests/removes-the-unreferenced-timber-material/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🗑🧱️delete-material/🧪️tests/removes-the-unreferenced-timber-material/🎯️outcome/🔣️.json"),
        },
        "replace-material" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🔁🧱️replace-material/🧪️tests/restates-steel-as-s355-in-its-original-slot/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🔁🧱️replace-material/🧪️tests/restates-steel-as-s355-in-its-original-slot/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🔁🧱️replace-material/🧪️tests/restates-steel-as-s355-in-its-original-slot/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🔁🧱️replace-material/🧪️tests/restates-steel-as-s355-in-its-original-slot/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🔁🧱️replace-material/🧪️tests/restates-steel-as-s355-in-its-original-slot/🎯️outcome/🔣️.json"),
        },
