...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/🚫️rejects-a-dangling-b9e64c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/🚫️rejects-a-dangling-b9e64c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/🚫️rejects-a-dangling-b9e64c/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/🚫️rejects-a-dangling-b9e64c/🎯️outcome/🔣️.json");
...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem2dDiff::default(), "create-element/rejects-a-dangling-b9e64c: a rejecting create-element must carry the empty diff, never a half-built delta");
