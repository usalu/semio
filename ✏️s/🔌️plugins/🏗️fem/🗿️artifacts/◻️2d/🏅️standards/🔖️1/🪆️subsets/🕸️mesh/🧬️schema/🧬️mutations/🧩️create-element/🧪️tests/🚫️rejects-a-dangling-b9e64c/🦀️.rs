...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "create-element/rejects-a-dangling-b9e64c: a rejecting create-element must carry the empty diff, never a half-built delta");
