...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "create-region/denies-two-point-99954a: a rejecting create-region must carry the empty diff, never a half-built delta");
