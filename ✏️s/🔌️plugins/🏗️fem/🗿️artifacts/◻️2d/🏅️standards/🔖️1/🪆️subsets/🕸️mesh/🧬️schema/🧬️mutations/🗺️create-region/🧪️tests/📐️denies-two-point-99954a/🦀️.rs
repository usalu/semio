...
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️create-region/📐️denies-two-point-99954a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️create-region/📐️denies-two-point-99954a/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️create-region/📐️denies-two-point-99954a/🎯️outcome/🔣️.json");
...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem2dDiff::default(), "create-region/denies-two-point-99954a: a rejecting create-region must carry the empty diff, never a half-built delta");
