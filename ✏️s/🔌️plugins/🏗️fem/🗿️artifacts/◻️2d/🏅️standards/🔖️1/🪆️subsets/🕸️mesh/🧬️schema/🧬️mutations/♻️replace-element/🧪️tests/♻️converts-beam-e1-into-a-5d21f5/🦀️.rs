...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/♻️converts-beam-e1-into-a-5d21f5/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/♻️converts-beam-e1-into-a-5d21f5/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/♻️converts-beam-e1-into-a-5d21f5/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/♻️converts-beam-e1-into-a-5d21f5/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️replace-element/♻️converts-beam-e1-into-a-5d21f5/🎯️outcome/🔣️.json");
...
fn applies_to_committed_after() {
    ...
    assert!(matches!(snapshot.elements[0], crate::FemElement::Bar { .. }), "replace-element/converts-beam-e1-into-a-5d21f5: the beam must have become a bar");
    assert_eq!(crate::element_id(&snapshot.elements[0]), "e1", "replace-element/converts-beam-e1-into-a-5d21f5: the identity must survive the variant change");
}
