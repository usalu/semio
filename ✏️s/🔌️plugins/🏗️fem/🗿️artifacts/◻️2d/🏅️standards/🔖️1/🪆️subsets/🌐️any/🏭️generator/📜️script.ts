...
async function main(argv: readonly string[]): Promise<number> {
  ...
  // 🧱️CARRIER MODE — the 26 non-geometric kinds.
  //
  ...
  if (command === "carrier" || command === "carrier-manifests") {
    ...
    for (const [kind, fixture] of Object.entries(CARRIER_FIXTURES)) {
      ...
      entries.push({
        ...
        id: `carrier-${kind}`,
        class: "third-party-generated",
        target: { artifact: "s.fem.fem2d", standard: "1", subset: fixture.subset },
        mutation: kind,
        outcome: "applied",
