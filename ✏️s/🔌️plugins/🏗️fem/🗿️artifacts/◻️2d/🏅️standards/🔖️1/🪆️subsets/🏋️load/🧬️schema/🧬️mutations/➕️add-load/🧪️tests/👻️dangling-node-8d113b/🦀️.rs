...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "add-load/dangling-node-8d113b: a rejecting add-load must carry the empty diff, never a half-built delta");
