...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-bar-e2-between-fc1c09/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-bar-e2-between-fc1c09/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-bar-e2-between-fc1c09/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-bar-e2-between-fc1c09/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️create-element/➖️appends-bar-e2-between-fc1c09/🎯️outcome/🔣️.json");
