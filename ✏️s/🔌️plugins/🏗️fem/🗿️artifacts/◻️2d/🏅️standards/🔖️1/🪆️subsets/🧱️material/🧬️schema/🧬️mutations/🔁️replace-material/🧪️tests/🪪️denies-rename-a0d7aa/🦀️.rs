...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "replace-material/denies-rename-a0d7aa: a rejecting replace-material must carry the empty diff, never a half-built delta");
