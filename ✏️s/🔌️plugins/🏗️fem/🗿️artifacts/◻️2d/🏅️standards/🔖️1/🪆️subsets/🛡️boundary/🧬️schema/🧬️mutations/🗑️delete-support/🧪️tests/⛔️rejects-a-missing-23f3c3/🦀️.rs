...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "delete-support/rejects-a-missing-23f3c3: a rejecting delete-support must carry the empty diff, never a half-built delta");
