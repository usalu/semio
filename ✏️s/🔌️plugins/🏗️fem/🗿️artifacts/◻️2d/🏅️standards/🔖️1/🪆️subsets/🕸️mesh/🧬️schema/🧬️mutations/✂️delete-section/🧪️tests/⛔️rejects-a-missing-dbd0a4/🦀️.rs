...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "delete-section/rejects-a-missing-dbd0a4: a rejecting delete-section must carry the empty diff, never a half-built delta");
