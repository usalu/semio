...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "delete-region/rejects-a-missing-a83a6d: a rejecting delete-region must carry the empty diff, never a half-built delta");
