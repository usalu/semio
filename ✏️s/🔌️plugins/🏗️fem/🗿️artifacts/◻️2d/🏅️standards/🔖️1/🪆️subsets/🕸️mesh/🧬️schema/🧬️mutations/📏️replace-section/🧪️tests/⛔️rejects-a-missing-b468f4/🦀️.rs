...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "replace-section/rejects-a-missing-b468f4: a rejecting replace-section must carry the empty diff, never a half-built delta");
