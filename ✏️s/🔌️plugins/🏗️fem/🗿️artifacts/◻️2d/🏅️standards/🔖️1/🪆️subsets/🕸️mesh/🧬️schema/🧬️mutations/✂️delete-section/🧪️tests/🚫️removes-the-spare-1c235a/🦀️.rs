...
//!
//! The trailing hollow profile nobody references is dropped; beam `e1` keeps pointing at `ipe200`.

use crate::standards::v1::subsets::any::schema::mutations::Fem2dMutation;
use crate::standards::v1::subsets::any::schema::mutations::{apply_fem2d_mutation, inverse_fem2d_mutation};
use crate::Fem2dSnapshot;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-section/🚫️removes-the-spare-1c235a/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-section/🚫️removes-the-spare-1c235a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-section/🚫️removes-the-spare-1c235a/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-section/🚫️removes-the-spare-1c235a/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-section/🚫️removes-the-spare-1c235a/🎯️outcome/🔣️.json");
...
/// ▶️ `delete-section` drops `shs100` and carries `before` to exactly the committed `after`.
#[test]
