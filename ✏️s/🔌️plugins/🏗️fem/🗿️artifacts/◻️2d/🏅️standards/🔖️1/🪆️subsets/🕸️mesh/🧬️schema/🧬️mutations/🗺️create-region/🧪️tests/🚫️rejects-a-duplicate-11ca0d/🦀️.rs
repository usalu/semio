...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "create-region/rejects-a-duplicate-11ca0d: a rejecting create-region must carry the empty diff, never a half-built delta");
