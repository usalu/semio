...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️create-region/🚫️rejects-a-duplicate-11ca0d/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️create-region/🚫️rejects-a-duplicate-11ca0d/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️create-region/🚫️rejects-a-duplicate-11ca0d/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️create-region/🚫️rejects-a-duplicate-11ca0d/🎯️outcome/🔣️.json");
...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::standards::v1::subsets::any::schema::diff::Fem2dDiff::default(), "create-region/rejects-a-duplicate-11ca0d: a rejecting create-region must carry the empty diff, never a half-built delta");
