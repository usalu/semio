...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "replace-region/rejects-a-missing-6e0d70: a rejecting replace-region must carry the empty diff, never a half-built delta");
