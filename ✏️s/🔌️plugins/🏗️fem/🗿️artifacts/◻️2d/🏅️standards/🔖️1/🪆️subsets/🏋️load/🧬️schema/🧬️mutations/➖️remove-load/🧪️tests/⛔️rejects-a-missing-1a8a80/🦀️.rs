...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::artifacts::fem2d::diff::Fem2dDiff::default(), "remove-load/rejects-a-missing-1a8a80: a rejecting remove-load must carry the empty diff, never a half-built delta");
