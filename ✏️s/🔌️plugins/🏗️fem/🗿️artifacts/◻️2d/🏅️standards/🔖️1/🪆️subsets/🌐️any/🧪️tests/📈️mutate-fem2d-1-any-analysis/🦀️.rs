...
#[cfg(feature = "sut")]
const DERIVED_ASSET: &str = "shared://📈️mutate-fem2d-1-any-analysis/🏗️timber-portal-frame.snapshot.json";
//#endregion 🔖️Kinds
...
mod subject {
    ...
    fn uri_in(ctx: &Context, needle: &str) -> Result<String, String> {
        ctx.scenario
            ...
            .find(|token| (token.starts_with("asset://") || token.starts_with("shared://📈️mutate-fem2d-1-any-analysis/") || token.starts_with("shared://")) && token.contains(needle))
