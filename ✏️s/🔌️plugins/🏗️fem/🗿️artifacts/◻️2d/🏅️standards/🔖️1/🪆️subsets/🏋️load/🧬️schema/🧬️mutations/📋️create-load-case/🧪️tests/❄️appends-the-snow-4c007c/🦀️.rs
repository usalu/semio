...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/❄️appends-the-snow-4c007c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/❄️appends-the-snow-4c007c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/❄️appends-the-snow-4c007c/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/❄️appends-the-snow-4c007c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️create-load-case/❄️appends-the-snow-4c007c/🎯️outcome/🔣️.json");
