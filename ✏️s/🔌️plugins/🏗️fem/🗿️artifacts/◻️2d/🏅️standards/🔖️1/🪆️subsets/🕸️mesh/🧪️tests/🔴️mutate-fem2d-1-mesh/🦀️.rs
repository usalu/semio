...
fn vector(kind: &str) -> Vector {
    match kind {
        "create-node" => Vector {
            ...
            diff: include_str!("../../🧬️schema/🧬️mutations/⚪️create-node/🧪️tests/🟫️appends-node-n3/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/⚪️create-node/🧪️tests/🟫️appends-node-n3/🎯️outcome/🔣️.json"),
        },
        "delete-node" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🕳️delete-node/🧪️tests/🚫️removes-node-n3-without-cascading-to-its-support/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🕳️delete-node/🧪️tests/🚫️removes-node-n3-without-cascading-to-its-support/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🕳️delete-node/🧪️tests/🚫️removes-node-n3-without-cascading-to-its-support/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🕳️delete-node/🧪️tests/🚫️removes-node-n3-without-cascading-to-its-support/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🕳️delete-node/🧪️tests/🚫️removes-node-n3-without-cascading-to-its-support/🎯️outcome/🔣️.json"),
        },
        "create-element" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🧩️create-element/🧪️tests/🦊️appends-bar-e2-between-n2-and-n3/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🧩️create-element/🧪️tests/🦊️appends-bar-e2-between-n2-and-n3/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🧩️create-element/🧪️tests/🦊️appends-bar-e2-between-n2-and-n3/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🧩️create-element/🧪️tests/🦊️appends-bar-e2-between-n2-and-n3/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🧩️create-element/🧪️tests/🦊️appends-bar-e2-between-n2-and-n3/🎯️outcome/🔣️.json"),
        },
        "delete-element" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🗑️delete-element/🧪️tests/🚫️removes-bar-e2-and-keeps-its-end-nodes/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🗑️delete-element/🧪️tests/🚫️removes-bar-e2-and-keeps-its-end-nodes/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🗑️delete-element/🧪️tests/🚫️removes-bar-e2-and-keeps-its-end-nodes/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🗑️delete-element/🧪️tests/🚫️removes-bar-e2-and-keeps-its-end-nodes/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🗑️delete-element/🧪️tests/🚫️removes-bar-e2-and-keeps-its-end-nodes/🎯️outcome/🔣️.json"),
        },
        "replace-element" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/♻️replace-element/🧪️tests/🐺️converts-beam-e1-into-a-bar-in-place/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/♻️replace-element/🧪️tests/🐺️converts-beam-e1-into-a-bar-in-place/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/♻️replace-element/🧪️tests/🐺️converts-beam-e1-into-a-bar-in-place/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/♻️replace-element/🧪️tests/🐺️converts-beam-e1-into-a-bar-in-place/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/♻️replace-element/🧪️tests/🐺️converts-beam-e1-into-a-bar-in-place/🎯️outcome/🔣️.json"),
        },
        "create-section" => Vector {
            ...
            diff: include_str!("../../🧬️schema/🧬️mutations/📐️create-section/🧪️tests/🐬️appends-the-ipe300-profile/🔺️diff/🔣️.json"),
        ...
        "delete-section" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/✂️delete-section/🧪️tests/🚫️removes-the-spare-hollow-section/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/✂️delete-section/🧪️tests/🚫️removes-the-spare-hollow-section/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/✂️delete-section/🧪️tests/🚫️removes-the-spare-hollow-section/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/✂️delete-section/🧪️tests/🚫️removes-the-spare-hollow-section/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/✂️delete-section/🧪️tests/🚫️removes-the-spare-hollow-section/🎯️outcome/🔣️.json"),
        },
        "replace-section" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/📏️replace-section/🧪️tests/🌾️stiffens-ipe200-with-a-reinforced-profile/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/📏️replace-section/🧪️tests/🌾️stiffens-ipe200-with-a-reinforced-profile/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/📏️replace-section/🧪️tests/🌾️stiffens-ipe200-with-a-reinforced-profile/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/📏️replace-section/🧪️tests/🌾️stiffens-ipe200-with-a-reinforced-profile/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/📏️replace-section/🧪️tests/🌾️stiffens-ipe200-with-a-reinforced-profile/🎯️outcome/🔣️.json"),
        },
        "create-region" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🗺️create-region/🧪️tests/🌷️appends-a-solid-rectangular-slab/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🗺️create-region/🧪️tests/🌷️appends-a-solid-rectangular-slab/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🗺️create-region/🧪️tests/🌷️appends-a-solid-rectangular-slab/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🗺️create-region/🧪️tests/🌷️appends-a-solid-rectangular-slab/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🗺️create-region/🧪️tests/🌷️appends-a-solid-rectangular-slab/🎯️outcome/🔣️.json"),
        },
        "delete-region" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🚫️delete-region/🧪️tests/🚫️removes-the-slab-and-keeps-its-material/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🚫️delete-region/🧪️tests/🚫️removes-the-slab-and-keeps-its-material/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🚫️delete-region/🧪️tests/🚫️removes-the-slab-and-keeps-its-material/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🚫️delete-region/🧪️tests/🚫️removes-the-slab-and-keeps-its-material/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🚫️delete-region/🧪️tests/🚫️removes-the-slab-and-keeps-its-material/🎯️outcome/🔣️.json"),
        },
        "replace-region" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🔄️replace-region/🧪️tests/📬️punches-a-stair-opening-through-the-slab/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🔄️replace-region/🧪️tests/📬️punches-a-stair-opening-through-the-slab/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🔄️replace-region/🧪️tests/📬️punches-a-stair-opening-through-the-slab/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🔄️replace-region/🧪️tests/📬️punches-a-stair-opening-through-the-slab/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🔄️replace-region/🧪️tests/📬️punches-a-stair-opening-through-the-slab/🎯️outcome/🔣️.json"),
        },
