//! 🏗️ `s.fem.fem2d` analysis mutation case — Rust SUBJECT adapter. Relocated out of the
...
fn vector(kind: &str) -> Vector {
    match kind {
        "update-analysis-settings" => Vector {
            before: include_str!("../../../✳️analysis/🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../✳️analysis/🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/🦠️mutation/🔣️.json"),
            after: include_str!("../../../✳️analysis/🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../../✳️analysis/🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/🔺️diff/🔣️.json"),
            outcome: include_str!("../../../✳️analysis/🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/🎯️outcome/🔣️.json"),
        },
...
fn canonical(text: &str) -> Json {
    parse_json(text).unwrap_or_else(|error| panic!("mutate-fem2d-1-analysis: a committed fixture must be valid JSON: {error}"))
}
//#endregion 🔖️Fixtures
