...
fn the_refusal_is_the_declared_diagnostic() {
    ...
    assert_eq!(produced.diff(), &crate::diff::Fem2dDiff::default(), "update-analysis-settings/denies-zero-modes-babc1d: a rejecting update-analysis-settings must carry the empty diff, never a half-built delta");
