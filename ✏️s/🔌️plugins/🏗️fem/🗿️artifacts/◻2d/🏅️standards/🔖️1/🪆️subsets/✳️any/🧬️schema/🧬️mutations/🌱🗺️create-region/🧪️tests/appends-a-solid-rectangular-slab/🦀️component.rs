//! 🧪️ `create-region` fixture — `appends-a-solid-rectangular-slab`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-region/appends-a-solid-rectangular-slab: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
