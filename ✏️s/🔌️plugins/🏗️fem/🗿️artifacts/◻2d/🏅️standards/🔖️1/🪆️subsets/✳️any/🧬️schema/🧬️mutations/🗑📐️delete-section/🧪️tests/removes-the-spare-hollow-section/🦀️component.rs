//! 🧪️ `delete-section` fixture — `removes-the-spare-hollow-section`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-section/removes-the-spare-hollow-section: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
