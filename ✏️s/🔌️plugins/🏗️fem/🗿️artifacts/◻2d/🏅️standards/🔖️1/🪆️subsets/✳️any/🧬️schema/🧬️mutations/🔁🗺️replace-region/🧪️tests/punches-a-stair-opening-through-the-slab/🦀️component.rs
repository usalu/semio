//! 🧪️ `replace-region` fixture — `punches-a-stair-opening-through-the-slab`.
//!
...
//!
//! An inner loop appears in `holes` and the mesh size halves — nested geometry must survive the whole-value swap.
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-region/punches-a-stair-opening-through-the-slab: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
