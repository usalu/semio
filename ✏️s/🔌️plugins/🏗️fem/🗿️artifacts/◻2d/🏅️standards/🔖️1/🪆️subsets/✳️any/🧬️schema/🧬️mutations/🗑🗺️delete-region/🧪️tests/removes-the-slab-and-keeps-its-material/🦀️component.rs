//! 🧪️ `delete-region` fixture — `removes-the-slab-and-keeps-its-material`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-region/removes-the-slab-and-keeps-its-material: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
