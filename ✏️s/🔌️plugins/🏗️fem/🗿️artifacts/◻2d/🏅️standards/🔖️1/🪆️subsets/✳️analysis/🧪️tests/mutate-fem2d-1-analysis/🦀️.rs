...
fn vector(kind: &str) -> Vector {
    match kind {
        "update-analysis-settings" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/🔺️diff/🔣️.json"),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🎛update-analysis-settings/🧪️tests/doubles-the-modal-count-and-halves-the-deformation-scale/🎯️outcome/🔣️.json"),
        },
