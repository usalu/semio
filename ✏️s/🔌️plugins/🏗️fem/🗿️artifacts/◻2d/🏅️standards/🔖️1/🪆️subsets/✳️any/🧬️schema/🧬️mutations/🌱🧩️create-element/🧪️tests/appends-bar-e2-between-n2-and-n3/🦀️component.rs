//! 🧪️ `create-element` fixture — `appends-bar-e2-between-n2-and-n3`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-element/appends-bar-e2-between-n2-and-n3: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
