//! 🧪️ `replace-material` fixture — `restates-steel-as-s355-in-its-original-slot`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-material/restates-steel-as-s355-in-its-original-slot: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
