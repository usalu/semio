...
//#region 🔖️Entities
/** 📍️ A structural node in plan (x, y in meters). Mirrors Rust `FemNode` (`🗿️artifacts/◻2d/🦀️.rs`). */
 ...
 * (`🗿️artifacts/◻2d/🦀️.rs`), tagged on `kind`. */
 ...
 * Mirrors Rust `FemMaterial` (`🗿️artifacts/◻2d/🦀️.rs`). */
 ...
 * Mirrors Rust `FemLoad` (`🗿️artifacts/◻2d/🦀️.rs`), tagged on `kind`. */
export type FemLoad =
 ...
 * Mirrors Rust `FemLoadCase` (`🗿️artifacts/◻2d/🦀️.rs`). */
 ...
 * `FemCombinationTerm` (`🗿️artifacts/◻2d/🦀️.rs`). */
 ...
 * `FemCombination` (`🗿️artifacts/◻2d/🦀️.rs`). */
 ...
 * Mirrors Rust `FemAnalysisSettings` (`🗿️artifacts/◻2d/🦀️.rs`). */
