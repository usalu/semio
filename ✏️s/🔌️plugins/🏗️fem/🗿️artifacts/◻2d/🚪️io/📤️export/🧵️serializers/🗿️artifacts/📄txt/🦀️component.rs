...
pub fn register() {}
pub fn serialize(_from: &Fem2dSnapshot) -> Result<semio_s_plugin_stdio::artifacts::txt::TxtSnapshot, String> {
    Err("txt export not yet implemented".into())
}
pub fn deserialize_bytes(_bytes: &[u8]) -> Result<Fem2dSnapshot, String> {
