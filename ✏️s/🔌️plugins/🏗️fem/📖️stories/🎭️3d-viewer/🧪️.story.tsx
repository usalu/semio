// #region 🧲️Header
// 💻️ ✏️s/🔌️plugins/🏗️fem/📖️stories/🎭️3d-viewer/🧪️.story.tsx
...
import { buildFem3dSceneNode, fem3dStoryStateFor, fem3dStructuralInstances, fem3dSummaryLines, FEM_STORY_LOCALES, FEM3D_INITIAL_VIEWPORT, FEM3D_SOLID_MESH_OMISSION, FEM3D_STORY_EXAMPLE_ID, FEM3D_CLEARED_EXAMPLE_ID, femStoryOmissions, type FemStoryLocale } from "../🧭️coordination/🧫️fixtures/🧫️scene/🟦️.ts";
...
function Fem3dViewerStoryHost({ initialExampleId, locale }: { readonly initialExampleId: string; readonly locale: FemStoryLocale }): ReactElement {
  ...
  const node = useMemo(() => buildFem3dSceneNode(instances, FEM3D_INITIAL_VIEWPORT, FEM3D_VIEW_BODY_KEY, FEM3D_VIEW_CONTROLLER_ID), [instances]);
  const debug = useMemo(
    () =>
      JSON.stringify({
