//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🗒️note`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("NotePresenceMutation", descriptors::<semio_s_artifact_note_note::editor::note::presence::NotePresence, semio_s_artifact_note_note::editor::note::presence::NotePresenceMutation>),
    ("NoteMutation", descriptors::<semio_s_artifact_note_note::standards::v1::subsets::any::schema::snapshot::NoteSnapshot, semio_s_artifact_note_note::standards::v1::subsets::any::schema::mutations::NoteMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.note.note", "1", "any", "✏️editor/👥️presence", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/👥️presence", ""),
    ("s.note.note", "1", "asset", "", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/🖼️asset", ""),
    ("s.note.note", "1", "block", "", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/🧱️block", ""),
    ("s.note.note", "1", "canvas", "", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/🎨️canvas", ""),
    ("s.note.note", "1", "document", "", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/📜️document", ""),
    ("s.note.note", "1", "ink", "", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/🖋️ink", ""),
    ("s.note.note", "1", "math", "", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/🧮️math", ""),
    ("s.note.note", "1", "table", "", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/📊️table", ""),
    ("s.note.note", "1", "text", "", "✏️s/🔌️plugins/🗒️note/🗿️artifacts/🗒️note/🏅️standards/🔖️1/🪆️subsets/📝️text", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-note-mutation-bridge")),
