...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_note_note::standards::v1::subsets::any::schema::snapshot::NoteSnapshot, semio_s_artifact_note_note::standards::v1::subsets::any::schema::mutations::NoteMutation>,
];
