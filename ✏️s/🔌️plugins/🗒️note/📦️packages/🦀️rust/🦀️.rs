...
// `Result<Emit<NoteMutation, NoConfigMutation>, Fault>`, the exact signature `ArtifactApp::handle`
...
//#region 🗿️Artifacts
mod artifacts {
    pub use semio_s_artifact_note_note as note;
}
//#endregion 🗿️Artifacts

//#region ✏️Editor
mod editor {
    pub use semio_s_artifact_note_note::editor::*;
}
//#endregion ✏️Editor
//#region 👁️Viewer
mod viewer {
    pub use semio_s_artifact_note_note::viewer::*;
}
//#endregion 👁️Viewer
