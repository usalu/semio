...
where
    PA: semio_framework_plugin::PluginApp
        + From<semio_framework_plugin::VcsArtifactApp<semio_framework_plugin::EditorApp<editor::note::NotePlayApp>>>
...
pub mod editor {
    ...
    pub mod note {
        ...
        pub mod window {
            ...
            #[path = "🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🪟️window/🧬️schema/🦀️.rs"]
            pub mod schema;
        }
...
pub fn note_child_restore_projection(snapshot: &crate::NoteSnapshot) -> Result<store::ChildRestoreProjection<'_>, semio_framework_plugin::Fault> {
