...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬅️remove-table-column/⬅️drops-the-trailing-column-b/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬅️remove-table-column/⬅️drops-the-trailing-column-b/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬅️remove-table-column/⬅️drops-the-trailing-column-b/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬅️remove-table-column/⬅️drops-the-trailing-column-b/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬅️remove-table-column/⬅️drops-the-trailing-column-b/🎯️outcome/🔣️.json");
