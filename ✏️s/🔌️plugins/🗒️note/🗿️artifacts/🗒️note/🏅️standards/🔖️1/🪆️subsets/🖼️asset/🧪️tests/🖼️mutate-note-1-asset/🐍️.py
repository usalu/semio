...
mutations (`create-asset`, `replace-asset-payload`, `delete-asset`), in Python, serving as this case's differential oracle. Relocated out of the
...
KINDS = ("create-asset", "replace-asset-payload", "delete-asset")
