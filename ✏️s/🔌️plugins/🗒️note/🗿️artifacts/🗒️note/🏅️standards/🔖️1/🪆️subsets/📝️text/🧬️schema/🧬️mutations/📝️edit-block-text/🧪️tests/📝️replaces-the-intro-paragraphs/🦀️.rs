//! 🧪️ `edit-block-text` fixture — `📝️replaces-the-intro-paragraphs`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📝️edit-block-text/📝️replaces-the-intro-paragraphs/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📝️edit-block-text/📝️replaces-the-intro-paragraphs/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📝️edit-block-text/📝️replaces-the-intro-paragraphs/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📝️edit-block-text/📝️replaces-the-intro-paragraphs/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📝️edit-block-text/📝️replaces-the-intro-paragraphs/🎯️outcome/🔣️.json");
