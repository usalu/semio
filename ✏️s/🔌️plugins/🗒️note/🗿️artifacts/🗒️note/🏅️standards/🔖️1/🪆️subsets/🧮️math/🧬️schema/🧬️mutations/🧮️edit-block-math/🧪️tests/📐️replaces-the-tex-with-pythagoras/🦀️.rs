//! 🧪️ `edit-block-math` fixture — `📐️replaces-the-tex-with-pythagoras`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️edit-block-math/📐️replaces-the-tex-with-pythagoras/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️edit-block-math/📐️replaces-the-tex-with-pythagoras/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️edit-block-math/📐️replaces-the-tex-with-pythagoras/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️edit-block-math/📐️replaces-the-tex-with-pythagoras/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️edit-block-math/📐️replaces-the-tex-with-pythagoras/🎯️outcome/🔣️.json");
