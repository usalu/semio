//! 🧪️ `duplicate-blocks` fixture — `copies-ink-and-table-with-shifting-indices`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "duplicate-blocks/copies-ink-and-table-with-shifting-indices: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
