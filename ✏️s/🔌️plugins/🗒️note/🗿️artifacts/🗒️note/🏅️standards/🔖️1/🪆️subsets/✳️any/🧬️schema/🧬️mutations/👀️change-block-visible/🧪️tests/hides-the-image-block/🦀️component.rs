//! 🧪️ `change-block-visible` fixture — `hides-the-image-block`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-block-visible/hides-the-image-block: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
