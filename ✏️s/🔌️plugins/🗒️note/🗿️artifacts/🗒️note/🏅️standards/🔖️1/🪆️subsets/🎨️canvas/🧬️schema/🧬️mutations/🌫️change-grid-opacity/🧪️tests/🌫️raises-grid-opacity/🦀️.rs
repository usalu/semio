...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-grid-opacity/🌫️raises-grid-opacity/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-grid-opacity/🌫️raises-grid-opacity/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-grid-opacity/🌫️raises-grid-opacity/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-grid-opacity/🌫️raises-grid-opacity/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-grid-opacity/🌫️raises-grid-opacity/🎯️outcome/🔣️.json");
