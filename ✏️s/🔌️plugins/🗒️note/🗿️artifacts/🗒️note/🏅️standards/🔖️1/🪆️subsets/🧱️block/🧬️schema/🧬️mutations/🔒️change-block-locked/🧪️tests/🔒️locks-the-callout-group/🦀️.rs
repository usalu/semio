//! 🧪️ `change-block-locked` fixture — `🔒️locks-the-callout-group`.
//!
...
use crate::schema::{block_locked, block_visible, find_block};
use crate::{NoteDiff, NoteSnapshot};
use protocol::Mutation;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️change-block-locked/🔒️locks-the-callout-group/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️change-block-locked/🔒️locks-the-callout-group/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️change-block-locked/🔒️locks-the-callout-group/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️change-block-locked/🔒️locks-the-callout-group/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️change-block-locked/🔒️locks-the-callout-group/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-block-locked/locks-the-callout-group: produced diff differs from the committed 🔺️diff/🔣️.json");
}
