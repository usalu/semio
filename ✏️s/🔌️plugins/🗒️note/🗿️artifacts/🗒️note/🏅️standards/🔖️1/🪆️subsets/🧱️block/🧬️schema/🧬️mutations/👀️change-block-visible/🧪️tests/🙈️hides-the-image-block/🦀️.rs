...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👀️change-block-visible/🙈️hides-the-image-block/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👀️change-block-visible/🙈️hides-the-image-block/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👀️change-block-visible/🙈️hides-the-image-block/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👀️change-block-visible/🙈️hides-the-image-block/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👀️change-block-visible/🙈️hides-the-image-block/🎯️outcome/🔣️.json");
