...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-snap-grid-spacing/📐️halves-snap-grid-spacing/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-snap-grid-spacing/📐️halves-snap-grid-spacing/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-snap-grid-spacing/📐️halves-snap-grid-spacing/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-snap-grid-spacing/📐️halves-snap-grid-spacing/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-snap-grid-spacing/📐️halves-snap-grid-spacing/🎯️outcome/🔣️.json");
