...
use crate::schema::find_block_location;
use crate::schema::mutations::{apply_note_mutation, inverse_note_mutation, NoteMutation};
use crate::{NoteDiff, NoteSnapshot};
use protocol::Mutation;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️duplicate-blocks/👥️copies-ink-and-table-with-shifting-indices/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️duplicate-blocks/👥️copies-ink-and-table-with-shifting-indices/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️duplicate-blocks/👥️copies-ink-and-table-with-shifting-indices/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️duplicate-blocks/👥️copies-ink-and-table-with-shifting-indices/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👥️duplicate-blocks/👥️copies-ink-and-table-with-shifting-indices/🎯️outcome/🔣️.json");
