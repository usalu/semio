...
//! `dxf-crate-note-ink-reader` in `../../../🔮️oracles/🔣️.json`. Reproduces `NoteIntoDxf::serialize`'s
...
/// `semantic-note-dxf-ink-v1`'s own `"arrays": "set"` declaration in `../../../🔮️oracles/🔣️.json`.
