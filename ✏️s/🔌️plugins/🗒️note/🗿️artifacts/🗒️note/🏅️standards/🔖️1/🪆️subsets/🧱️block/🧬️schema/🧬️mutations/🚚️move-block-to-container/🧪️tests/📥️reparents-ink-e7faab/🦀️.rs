//! 🧪️ `move-block-to-container` fixture — `📥️reparents-ink-into-the-callout-group`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-block-to-container/reparents-ink-into-the-callout-group: produced diff differs from the committed 🔺️diff/🔣️.json");
}
