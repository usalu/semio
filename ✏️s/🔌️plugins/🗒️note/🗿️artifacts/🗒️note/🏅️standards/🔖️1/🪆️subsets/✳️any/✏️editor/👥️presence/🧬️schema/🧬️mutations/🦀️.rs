...
/// crate: production dispatch (`Mutation::diff(..).apply_to`) and the mutation's own inverse over `NotePresence`.
///
/// @see store::os_store::test_support::mutation_report_json
pub fn note_presence_mutation_report_json(base_json: &str, mutation_json: &str, after_json: &str) -> Result<String, String> {
    store::os_store::test_support::mutation_report_json::<NotePresence, NotePresenceMutation>(base_json, mutation_json, after_json)
}
