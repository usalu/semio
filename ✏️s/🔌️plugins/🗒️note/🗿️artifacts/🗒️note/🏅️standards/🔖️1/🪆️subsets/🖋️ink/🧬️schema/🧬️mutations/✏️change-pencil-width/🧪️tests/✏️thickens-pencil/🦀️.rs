...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-pencil-width/✏️thickens-pencil/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-pencil-width/✏️thickens-pencil/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-pencil-width/✏️thickens-pencil/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-pencil-width/✏️thickens-pencil/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-pencil-width/✏️thickens-pencil/🎯️outcome/🔣️.json");
