//! 🧪️ `duplicate-block` fixture — `copies-the-math-block-right-after-its-source`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "duplicate-block/copies-the-math-block-right-after-its-source: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
