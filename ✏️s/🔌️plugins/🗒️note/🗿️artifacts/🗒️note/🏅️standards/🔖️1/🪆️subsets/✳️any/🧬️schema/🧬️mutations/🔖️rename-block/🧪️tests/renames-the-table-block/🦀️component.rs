//! 🧪️ `rename-block` fixture — `renames-the-table-block`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-block/renames-the-table-block: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
