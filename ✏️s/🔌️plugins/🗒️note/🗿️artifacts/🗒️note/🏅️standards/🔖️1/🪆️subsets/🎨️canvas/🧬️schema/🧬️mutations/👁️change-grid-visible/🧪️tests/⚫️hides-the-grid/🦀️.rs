//! 🧪️ `change-grid-visible` fixture — `⚫️hides-the-grid`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-grid-visible/hides-the-grid: produced diff differs from the committed 🔺️diff/🔣️.json");
}
