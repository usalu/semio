...
use crate::schema::{block_name, find_block, find_block_location};
use crate::{NoteDiff, NoteSnapshot};
use protocol::Mutation;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️duplicate-block/📋️copies-the-math-block-right-after-its-source/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️duplicate-block/📋️copies-the-math-block-right-after-its-source/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️duplicate-block/📋️copies-the-math-block-right-after-its-source/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️duplicate-block/📋️copies-the-math-block-right-after-its-source/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📋️duplicate-block/📋️copies-the-math-block-right-after-its-source/🎯️outcome/🔣️.json");
