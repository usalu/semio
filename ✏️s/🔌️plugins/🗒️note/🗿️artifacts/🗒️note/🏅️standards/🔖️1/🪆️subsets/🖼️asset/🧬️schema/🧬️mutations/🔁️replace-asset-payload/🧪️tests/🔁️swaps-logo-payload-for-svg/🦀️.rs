...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-asset-payload/🔁️swaps-logo-payload-for-svg/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-asset-payload/🔁️swaps-logo-payload-for-svg/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-asset-payload/🔁️swaps-logo-payload-for-svg/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-asset-payload/🔁️swaps-logo-payload-for-svg/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-asset-payload/🔁️swaps-logo-payload-for-svg/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-asset-payload/swaps-logo-payload-for-svg: produced diff differs from the committed 🔺️diff/🔣️.json");
}
