//! 🧪️ `change-block-font-size` fixture — `🔤️enlarges-the-intro-font`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️change-block-font-size/🔤️enlarges-the-intro-font/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️change-block-font-size/🔤️enlarges-the-intro-font/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️change-block-font-size/🔤️enlarges-the-intro-font/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️change-block-font-size/🔤️enlarges-the-intro-font/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️change-block-font-size/🔤️enlarges-the-intro-font/🎯️outcome/🔣️.json");
