...
//#region 🔖️Diff
pub fn diff(payload: &EditBlockInkStroke, base: &NoteSnapshot) -> protocol::MutationOutcome<NoteDiff> {
    ...
    if let crate::artifacts::note::NoteBlockNode::Ink { points, x, y, width, height, .. } = &mut updated {
