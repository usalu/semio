//! 🧪️ `change-pencil-width` fixture — `thickens-pencil`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-pencil-width/thickens-pencil: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
