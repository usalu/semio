...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-grid-spacing/📏️widens-grid-spacing/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-grid-spacing/📏️widens-grid-spacing/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-grid-spacing/📏️widens-grid-spacing/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-grid-spacing/📏️widens-grid-spacing/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-grid-spacing/📏️widens-grid-spacing/🎯️outcome/🔣️.json");
