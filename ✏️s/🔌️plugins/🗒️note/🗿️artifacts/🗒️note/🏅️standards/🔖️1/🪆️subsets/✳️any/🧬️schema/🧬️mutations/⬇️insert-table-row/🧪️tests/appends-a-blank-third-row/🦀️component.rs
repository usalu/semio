//! 🧪️ `insert-table-row` fixture — `appends-a-blank-third-row`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "insert-table-row/appends-a-blank-third-row: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
