...
//! `lopdf-note-text-reader`, all declared in `../🔣️oracle.json`). This subset's own domain
...
//!
//! WHAT THE PROJECTIONS DO AND DO NOT WITNESS, per `../🔣️oracle.json`'s `mutationManifests`
...
//!
//! @see `../🔣️oracle.json` — the three oracle registrations and the per-mutation carrier list.
