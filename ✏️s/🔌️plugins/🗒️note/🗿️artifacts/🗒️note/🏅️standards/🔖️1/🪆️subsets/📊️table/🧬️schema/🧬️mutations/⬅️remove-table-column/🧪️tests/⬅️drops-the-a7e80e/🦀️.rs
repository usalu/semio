//! 🧪️ `remove-table-column` fixture — `⬅️drops-the-trailing-column-b`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "remove-table-column/drops-the-trailing-column-b: produced diff differs from the committed 🔺️diff/🔣️.json");
}
