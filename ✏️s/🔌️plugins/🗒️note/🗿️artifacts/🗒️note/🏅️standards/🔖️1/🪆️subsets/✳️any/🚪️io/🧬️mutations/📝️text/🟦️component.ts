 ...
 * sibling `🦀️component.rs` (`parse_op`/`print_op`, callable natively from Rust today). Not wired
 * here: `world actor`'s WIT surface
 * (`🧰️framework/🛍️products/💻️os/🔨️modules/🔌️plugin/🧬️schema/📜️component.wit`) exports only
