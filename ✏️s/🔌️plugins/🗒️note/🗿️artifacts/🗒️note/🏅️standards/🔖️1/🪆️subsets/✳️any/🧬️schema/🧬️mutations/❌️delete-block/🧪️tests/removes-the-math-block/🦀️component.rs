//! 🧪️ `delete-block` fixture — `removes-the-math-block`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-block/removes-the-math-block: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
