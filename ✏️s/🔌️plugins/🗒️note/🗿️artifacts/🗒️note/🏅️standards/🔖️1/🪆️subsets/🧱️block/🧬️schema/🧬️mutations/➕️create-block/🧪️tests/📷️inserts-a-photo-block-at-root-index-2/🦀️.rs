//! 🧪️ `create-block` fixture — `📷️inserts-a-photo-block-at-root-index-2`.
//!
...
use crate::schema::{find_block, find_block_location};
use crate::{NoteDiff, NoteSnapshot};
use protocol::Mutation;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-block/📷️inserts-a-photo-block-at-root-index-2/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-block/📷️inserts-a-photo-block-at-root-index-2/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-block/📷️inserts-a-photo-block-at-root-index-2/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-block/📷️inserts-a-photo-block-at-root-index-2/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-block/📷️inserts-a-photo-block-at-root-index-2/🎯️outcome/🔣️.json");
