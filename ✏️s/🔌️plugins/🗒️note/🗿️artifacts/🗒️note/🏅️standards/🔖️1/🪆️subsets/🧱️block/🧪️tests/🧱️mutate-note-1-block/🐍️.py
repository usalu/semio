...
mutations (`create-block`, `delete-block`, `delete-blocks`, `duplicate-block`, `duplicate-blocks`, `move-block-to-container`, `drag-blocks`, `rename-block`, `change-block-visible`, `change-block-locked`, `move-block`, `resize-block`, `change-block-font-size`), in Python, serving as this case's differential oracle. Relocated out of the
...
KINDS = ("create-block", "delete-block", "delete-blocks", "duplicate-block", "duplicate-blocks", "move-block-to-container", "drag-blocks", "rename-block", "change-block-visible", "change-block-locked", "move-block", "resize-block", "change-block-font-size")
