...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️move-block-to-container/📥️reparents-ink-into-the-callout-group/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️move-block-to-container/📥️reparents-ink-into-the-callout-group/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️move-block-to-container/📥️reparents-ink-into-the-callout-group/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️move-block-to-container/📥️reparents-ink-into-the-callout-group/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️move-block-to-container/📥️reparents-ink-into-the-callout-group/🎯️outcome/🔣️.json");
