//! 🧪️ `resize-block` fixture — `enlarges-the-image-block`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "resize-block/enlarges-the-image-block: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
