...
use crate::schema::{block_name, find_block};
use crate::{NoteBlockNode, NoteDiff, NoteSnapshot};
use protocol::Mutation;

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔖️rename-block/🏷️renames-the-table-block/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔖️rename-block/🏷️renames-the-table-block/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔖️rename-block/🏷️renames-the-table-block/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔖️rename-block/🏷️renames-the-table-block/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔖️rename-block/🏷️renames-the-table-block/🎯️outcome/🔣️.json");
