...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️resize-block/📐️enlarges-the-image-block/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️resize-block/📐️enlarges-the-image-block/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️resize-block/📐️enlarges-the-image-block/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️resize-block/📐️enlarges-the-image-block/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️resize-block/📐️enlarges-the-image-block/🎯️outcome/🔣️.json");
