//! 🧪️ `change-eraser-radius` fixture — `enlarges-eraser`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-eraser-radius/enlarges-eraser: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
