//! 🧪️ `change-grid-opacity` fixture — `raises-grid-opacity`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-grid-opacity/raises-grid-opacity: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
