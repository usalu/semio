//! 🧪️ `delete-blocks` fixture — `🗑️removes-the-ink-and-image-blocks`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-blocks/🗑️removes-the-ink-and-image-blocks/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-blocks/🗑️removes-the-ink-and-image-blocks/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-blocks/🗑️removes-the-ink-and-image-blocks/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-blocks/🗑️removes-the-ink-and-image-blocks/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-blocks/🗑️removes-the-ink-and-image-blocks/🎯️outcome/🔣️.json");
