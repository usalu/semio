//! 🎹️ NoteComposer (1/✳️any) — analyzer + builder glued. Reads native `s.note` sources
//! plus any of: stdio.dwg, stdio.dxf, stdio.json, stdio.pdf, stdio.png, stdio.svg. Writes one `s.note` (1/✳️any) snapshot.
...
use crate::artifacts::note::standards::v1::subsets::any::analyzer::NoteAnalyzer;
...
impl ArtifactComposer for NoteComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        ...
        Err(ComposeError { message: "NoteComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
