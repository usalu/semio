...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️remove-table-row/⬆️drops-the-trailing-blank-row/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️remove-table-row/⬆️drops-the-trailing-blank-row/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️remove-table-row/⬆️drops-the-trailing-blank-row/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️remove-table-row/⬆️drops-the-trailing-blank-row/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️remove-table-row/⬆️drops-the-trailing-blank-row/🎯️outcome/🔣️.json");
