@capability-note-1-math-mutate
@oracle-note-python-independent
@comparison-ordered-json-v1
@mutations-note-1-math
Feature: Apply every typed note document math mutation twice — once in Rust, once in Python — and require the same answer
  ...
  This subset owns `edit-block-math`, which reaches INSIDE a math block's own typed content — its `tex` field — rather than moving the block at all.
