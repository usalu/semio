//! 🧪️ `change-snap-grid-spacing` fixture — `🌷️halves-snap-grid-spacing`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-snap-grid-spacing/halves-snap-grid-spacing: produced diff differs from the committed 🔺️diff/🔣️.json");
}
