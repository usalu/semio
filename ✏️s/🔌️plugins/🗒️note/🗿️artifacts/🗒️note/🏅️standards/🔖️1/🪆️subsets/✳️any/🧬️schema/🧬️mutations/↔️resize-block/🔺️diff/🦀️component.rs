...
pub async fn diff(payload: &ResizeBlock, base: &NoteSnapshot) -> protocol::MutationOutcome<NoteDiff> {
    ...
    match &mut updated {
        crate::artifacts::note::NoteBlockNode::Text { width, height, .. }
        | crate::artifacts::note::NoteBlockNode::Image { width, height, .. }
        | crate::artifacts::note::NoteBlockNode::Table { width, height, .. }
        | crate::artifacts::note::NoteBlockNode::Math { width, height, .. }
        | crate::artifacts::note::NoteBlockNode::Ink { width, height, .. }
        | crate::artifacts::note::NoteBlockNode::Group { width, height, .. } => {
