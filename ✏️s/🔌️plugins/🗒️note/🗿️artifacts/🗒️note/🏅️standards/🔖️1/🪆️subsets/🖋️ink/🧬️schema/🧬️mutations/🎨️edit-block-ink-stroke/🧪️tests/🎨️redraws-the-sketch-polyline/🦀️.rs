...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️edit-block-ink-stroke/🎨️redraws-the-sketch-polyline/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️edit-block-ink-stroke/🎨️redraws-the-sketch-polyline/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️edit-block-ink-stroke/🎨️redraws-the-sketch-polyline/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️edit-block-ink-stroke/🎨️redraws-the-sketch-polyline/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️edit-block-ink-stroke/🎨️redraws-the-sketch-polyline/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "edit-block-ink-stroke/redraws-the-sketch-polyline: produced diff differs from the committed 🔺️diff/🔣️.json");
}
