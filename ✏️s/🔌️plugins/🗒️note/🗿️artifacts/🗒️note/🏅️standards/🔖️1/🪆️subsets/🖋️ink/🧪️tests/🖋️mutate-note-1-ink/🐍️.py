...
mutations (`change-pencil-width`, `change-eraser-radius`, `change-block-ink-width`, `edit-block-ink-stroke`), in Python, serving as this case's differential oracle. Relocated out of the
...
KINDS = ("change-pencil-width", "change-eraser-radius", "change-block-ink-width", "edit-block-ink-stroke")
