//! 🦀️ Note document table mutation case — Rust adapter. Relocated out of the artifact-level
...
const KINDS: &[&str] = &["insert-table-row", "remove-table-row", "insert-table-column", "remove-table-column"];
