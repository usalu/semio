...
mutations (`change-grid-visible`, `change-grid-spacing`, `change-grid-subdivisions`, `change-grid-opacity`, `change-snap-enabled`, `change-snap-grid-spacing`), in Python, serving as this case's differential oracle. Relocated out of the
...
KINDS = ("change-grid-visible", "change-grid-spacing", "change-grid-subdivisions", "change-grid-opacity", "change-snap-enabled", "change-snap-grid-spacing")
