//! 🧪️ `insert-table-column` fixture — `appends-the-lettered-column-c`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "insert-table-column/appends-the-lettered-column-c: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
