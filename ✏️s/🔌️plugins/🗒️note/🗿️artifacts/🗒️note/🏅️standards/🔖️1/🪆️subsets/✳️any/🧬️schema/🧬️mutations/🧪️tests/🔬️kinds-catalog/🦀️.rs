...
fn kinds_match_the_enum_and_the_catalog() {
    ...
    let manifest = concat!(
        include_str!("../../../../🔮️oracles/🔣️.json"),
        include_str!("../../../../../🖋️ink/🔮️oracles/🔣️.json"),
        include_str!("../../../../../📝️text/🔮️oracles/🔣️.json"),
        include_str!("../../../../../🧮️math/🔮️oracles/🔣️.json"),
        include_str!("../../../../../📊️table/🔮️oracles/🔣️.json"),
        include_str!("../../../../../🖼️asset/🔮️oracles/🔣️.json"),
        include_str!("../../../../../🧱️block/🔮️oracles/🔣️.json"),
        include_str!("../../../../../🎨️canvas/🔮️oracles/🔣️.json"),
        include_str!("../../../../../📜️document/🔮️oracles/🔣️.json"),
    );
    for kind in KINDS {
