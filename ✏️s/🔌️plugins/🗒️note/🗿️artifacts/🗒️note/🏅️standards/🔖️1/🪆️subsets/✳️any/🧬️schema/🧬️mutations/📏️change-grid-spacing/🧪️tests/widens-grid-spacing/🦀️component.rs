//! 🧪️ `change-grid-spacing` fixture — `widens-grid-spacing`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-grid-spacing/widens-grid-spacing: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
