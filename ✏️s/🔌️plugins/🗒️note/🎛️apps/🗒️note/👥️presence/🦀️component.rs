...
impl protocol::MutationDiff<NotePresence> for NotePresence {
    fn apply(&self, _base: &NotePresence) -> NotePresence {
        self.clone()
    }
...
impl store::DocumentDsl for NotePresence {
...
impl DocumentPack for NotePresence {
...
impl Mutation<NotePresence> for NotePresenceMutation {
    ...
    fn diff(&self, _base: &NotePresence) -> NotePresence {
        match self {
