    ...
    WindowMeasure::Group {
        ...
        children: vec![
            WindowMeasure::Toggle {
                ...
                text: None,
                on_change: crate::apps::note::note_action("setGridVisible", None),
            },
            WindowMeasure::Slider {
                ...
                disabled: None,
                reveal: None,
                on_change: crate::apps::note::note_action("setGridSpacing", None),
            },
            WindowMeasure::Slider {
                ...
                disabled: None,
                reveal: None,
                on_change: crate::apps::note::note_action("setGridSubdivisions", None),
            },
            WindowMeasure::Slider {
                ...
                disabled: None,
                reveal: None,
                on_change: crate::apps::note::note_action("setGridOpacity", None),
            },
        ],
    }
}
