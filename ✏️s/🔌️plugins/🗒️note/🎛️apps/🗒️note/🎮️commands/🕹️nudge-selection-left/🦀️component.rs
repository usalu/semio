...
pub fn handle(_payload: &NudgeSelectionLeft, doc: &ArtifactView<'_, NoteSnapshot>, cfg: &ConfigView<'_, NoteConfig>) -> Result<Emit<NoteMutation, NoteConfigMutation>, Fault> {
    Ok(nudge(doc.snapshot, cfg.snapshot, -NUDGE_STEP, 0.0))
}
