...
pub fn handle(_payload: &NudgeSelectionDown, doc: &ArtifactView<'_, NoteSnapshot>, cfg: &ConfigView<'_, NoteConfig>) -> Result<Emit<NoteMutation, NoteConfigMutation>, Fault> {
    Ok(nudge(doc.snapshot, cfg.snapshot, 0.0, NUDGE_STEP))
}
