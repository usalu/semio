...
impl RoomAirModel {
    ...
    pub async fn apply(&self, input: &RoomAirInput) -> RoomAirOutput {
        match self {
...
// #region 🔖️FullyMixed
async fn fully_mixed(input: &RoomAirInput) -> RoomAirOutput {
...
async fn vertical_gradient(input: &RoomAirInput, gradient_k_per_m: f64) -> RoomAirOutput {
...
async fn displacement_1node(input: &RoomAirInput, mixing_factor: f64) -> RoomAirOutput {
...
async fn displacement_3node(input: &RoomAirInput, lower_fraction: f64, upper_fraction: f64) -> RoomAirOutput {
...
// #region 🔖️Ufad
async fn ufad(input: &RoomAirInput, diffuser_height_m: f64, throw_m: f64) -> RoomAirOutput {
    let h = input.ceiling_height_m.max(0.1);
...
async fn surface_specific(input: &RoomAirInput) -> RoomAirOutput {
...
mod tests {
    ...
    async fn sample_input() -> RoomAirInput {
