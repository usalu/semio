...
fn valid_model() -> Model {
    Model {
        ...
        materials: vec![Material { id: EntityId(10), name: "Mat".into(), roughness: crate::model::SurfaceRoughness::MediumRough, thickness_m: 0.1, conductivity_w_m_k: 0.04, density_kg_m3: 50.0, specific_heat_j_kg_k: 1000.0, thermal_absorptance: 0.9, solar_absorptance: 0.7, visible_absorptance: 0.7 }],
