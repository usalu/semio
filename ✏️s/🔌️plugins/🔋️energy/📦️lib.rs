...
//! component file with a `#[path]` written in full, relative to THIS file's directory (the plugin
//! root) — do not inline any component file back into this one: the taxonomy validator and the
