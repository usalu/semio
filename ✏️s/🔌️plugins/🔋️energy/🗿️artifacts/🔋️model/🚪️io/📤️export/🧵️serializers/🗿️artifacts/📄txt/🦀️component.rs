...
use crate::artifacts::energyModel::EnergyModelSnapshot;
pub fn register() {}
pub fn serialize(_from: &EnergyModelSnapshot) -> Result<crate::artifacts::txt::TxtSnapshot, String> {
