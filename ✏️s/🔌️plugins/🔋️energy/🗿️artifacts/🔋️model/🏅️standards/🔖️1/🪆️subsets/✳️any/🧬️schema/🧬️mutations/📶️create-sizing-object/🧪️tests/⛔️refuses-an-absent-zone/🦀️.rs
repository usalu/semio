//! 🧪️ `create-sizing-object` fixture — `⛔️refuses-an-absent-zone`: refuses a sizing object on an absent zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/⛔️refuses-an-absent-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/⛔️refuses-an-absent-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/⛔️refuses-an-absent-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/⛔️refuses-an-absent-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/⛔️refuses-an-absent-zone/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-sizing-object", directory: "📶️create-sizing-object/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
