...
fn case() -> Case {
    Case { kind: "change-constant-schedule-value", directory: "🕝️change-constant-schedule-value/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
