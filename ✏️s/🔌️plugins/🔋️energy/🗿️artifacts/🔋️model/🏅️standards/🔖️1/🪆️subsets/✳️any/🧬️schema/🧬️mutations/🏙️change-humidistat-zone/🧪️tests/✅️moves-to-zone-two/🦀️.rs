//! 🧪️ `change-humidistat-zone` fixture — `✅️moves-to-zone-two`: moves the humidistat to the second zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏙️change-humidistat-zone/✅️moves-to-zone-two/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏙️change-humidistat-zone/✅️moves-to-zone-two/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏙️change-humidistat-zone/✅️moves-to-zone-two/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏙️change-humidistat-zone/✅️moves-to-zone-two/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏙️change-humidistat-zone/✅️moves-to-zone-two/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_humidistat_zone(crate::model::EntityId(11), crate::model::EntityId(2)))
}

fn case() -> Case {
    Case { kind: "change-humidistat-zone", directory: "🏙️change-humidistat-zone/✅️moves-to-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
