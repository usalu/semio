...
fn case() -> Case {
    Case { kind: "change-equipment-gain-schedule", directory: "⌛️change-equipment-gain-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
