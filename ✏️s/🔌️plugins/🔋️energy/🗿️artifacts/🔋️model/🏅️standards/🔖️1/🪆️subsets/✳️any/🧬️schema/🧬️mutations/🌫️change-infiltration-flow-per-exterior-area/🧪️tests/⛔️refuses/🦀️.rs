//! 🧪️ `change-infiltration-flow-per-exterior-area` fixture — `⛔️refuses`: refuses flow per exterior area (m³/s·m²) outside a finite non-negative value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_infiltration_flow_per_exterior_area(crate::model::EntityId(50), -0.001))
}

fn case() -> Case {
    Case { kind: "change-infiltration-flow-per-exterior-area", directory: "🌫️change-infiltration-flow-per-exterior-area/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
