...
fn case() -> Case {
    Case { kind: "remove-construction-layer", directory: "➖️remove-construction-layer/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
