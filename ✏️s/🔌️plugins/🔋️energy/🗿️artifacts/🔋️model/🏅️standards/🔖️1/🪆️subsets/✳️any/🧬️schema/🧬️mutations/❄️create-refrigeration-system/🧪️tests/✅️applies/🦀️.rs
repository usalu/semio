//! 🧪️ `create-refrigeration-system` fixture — `✅️applies`: inserts a new refrigeration system.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/❄️create-refrigeration-system/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/❄️create-refrigeration-system/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/❄️create-refrigeration-system/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/❄️create-refrigeration-system/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/❄️create-refrigeration-system/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_refrigeration_system(1, crate::model::EntityId(421), 2, 8000.0, crate::model::ScheduleId(2)))
}

fn case() -> Case {
    Case { kind: "create-refrigeration-system", directory: "❄️create-refrigeration-system/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
