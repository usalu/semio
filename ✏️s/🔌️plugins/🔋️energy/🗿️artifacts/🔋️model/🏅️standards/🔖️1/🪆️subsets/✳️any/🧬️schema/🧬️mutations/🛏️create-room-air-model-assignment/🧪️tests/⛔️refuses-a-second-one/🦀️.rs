//! 🧪️ `create-room-air-model-assignment` fixture — `⛔️refuses-a-second-one`: refuses a second override for one zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/⛔️refuses-a-second-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/⛔️refuses-a-second-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/⛔️refuses-a-second-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/⛔️refuses-a-second-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/⛔️refuses-a-second-one/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-room-air-model-assignment", directory: "🛏️create-room-air-model-assignment/⛔️refuses-a-second-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
