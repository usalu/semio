//! 🧪️ `change-plant-loop-supply-temperature` fixture — `⛔️refuses-a-hot-supply`: refuses an unrepresentable supply temperature.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☕️change-plant-loop-supply-temperature/⛔️refuses-a-hot-supply/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☕️change-plant-loop-supply-temperature/⛔️refuses-a-hot-supply/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☕️change-plant-loop-supply-temperature/⛔️refuses-a-hot-supply/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☕️change-plant-loop-supply-temperature/⛔️refuses-a-hot-supply/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☕️change-plant-loop-supply-temperature/⛔️refuses-a-hot-supply/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_plant_loop_supply_temperature(crate::model::EntityId(18), 1000.0))
}

fn case() -> Case {
    Case { kind: "change-plant-loop-supply-temperature", directory: "☕️change-plant-loop-supply-temperature/⛔️refuses-a-hot-supply", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
