...
fn case() -> Case {
    Case { kind: "create-space", directory: "🪑️create-space/🧪️tests/⛔️refuses-a-missing-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
