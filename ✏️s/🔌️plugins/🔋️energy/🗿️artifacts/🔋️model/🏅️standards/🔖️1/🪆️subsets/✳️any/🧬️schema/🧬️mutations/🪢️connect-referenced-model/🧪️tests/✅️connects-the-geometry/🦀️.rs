...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-referenced-model/✅️connects-the-geometry/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-referenced-model/✅️connects-the-geometry/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-referenced-model/✅️connects-the-geometry/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-referenced-model/✅️connects-the-geometry/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪢️connect-referenced-model/✅️connects-the-geometry/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "connect-referenced-model", directory: "🪢️connect-referenced-model/✅️connects-the-geometry", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
