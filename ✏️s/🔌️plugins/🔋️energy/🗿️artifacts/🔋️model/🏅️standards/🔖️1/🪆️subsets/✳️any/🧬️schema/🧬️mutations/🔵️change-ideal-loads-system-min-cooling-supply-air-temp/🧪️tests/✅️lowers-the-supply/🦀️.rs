//! 🧪️ `change-ideal-loads-system-min-cooling-supply-air-temp` fixture — `✅️lowers-the-supply`: lowers the cooling supply air limit.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/✅️lowers-the-supply/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/✅️lowers-the-supply/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/✅️lowers-the-supply/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/✅️lowers-the-supply/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/✅️lowers-the-supply/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case {
        ...
        directory: "🔵️change-ideal-loads-system-min-cooling-supply-air-temp/✅️lowers-the-supply",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
