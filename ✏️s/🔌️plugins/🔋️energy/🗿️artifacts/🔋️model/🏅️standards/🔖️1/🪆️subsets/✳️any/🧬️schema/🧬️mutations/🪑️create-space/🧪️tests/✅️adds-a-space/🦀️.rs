//! 🧪️ `create-space` fixture — `✅️adds-a-space`: adds a space to the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪑️create-space/✅️adds-a-space/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪑️create-space/✅️adds-a-space/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪑️create-space/✅️adds-a-space/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪑️create-space/✅️adds-a-space/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪑️create-space/✅️adds-a-space/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-space", directory: "🪑️create-space/✅️adds-a-space", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
