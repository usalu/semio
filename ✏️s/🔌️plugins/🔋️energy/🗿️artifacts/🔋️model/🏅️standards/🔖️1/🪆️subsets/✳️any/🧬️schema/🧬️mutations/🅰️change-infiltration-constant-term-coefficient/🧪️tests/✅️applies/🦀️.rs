//! 🧪️ `change-infiltration-constant-term-coefficient` fixture — `✅️applies`: moves infiltration 50.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_infiltration_constant_term_coefficient(crate::model::EntityId(50), 0.606))
}

fn case() -> Case {
    Case { kind: "change-infiltration-constant-term-coefficient", directory: "🅰️change-infiltration-constant-term-coefficient/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
