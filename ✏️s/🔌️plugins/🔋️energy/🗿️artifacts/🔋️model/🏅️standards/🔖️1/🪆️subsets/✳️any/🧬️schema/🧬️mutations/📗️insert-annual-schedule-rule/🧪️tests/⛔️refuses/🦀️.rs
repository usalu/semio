...
fn case() -> Case {
    Case { kind: "insert-annual-schedule-rule", directory: "📗️insert-annual-schedule-rule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
