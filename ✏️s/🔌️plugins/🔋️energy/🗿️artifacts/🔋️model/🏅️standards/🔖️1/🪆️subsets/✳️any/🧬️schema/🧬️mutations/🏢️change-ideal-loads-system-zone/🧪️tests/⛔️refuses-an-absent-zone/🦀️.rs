...
fn case() -> Case {
    Case { kind: "change-ideal-loads-system-zone", directory: "🏢️change-ideal-loads-system-zone/🧪️tests/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
