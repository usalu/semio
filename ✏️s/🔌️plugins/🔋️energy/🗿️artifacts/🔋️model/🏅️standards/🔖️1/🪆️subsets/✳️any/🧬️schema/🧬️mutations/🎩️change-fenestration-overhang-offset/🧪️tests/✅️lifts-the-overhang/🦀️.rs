...
fn case() -> Case {
    Case { kind: "change-fenestration-overhang-offset", directory: "🎩️change-fenestration-overhang-offset/🧪️tests/✅️lifts-the-overhang", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
