...
fn case() -> Case {
    Case { kind: "change-air-loop-return-node", directory: "↘️change-air-loop-return-node/🧪️tests/⛔️refuses-node-zero", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
