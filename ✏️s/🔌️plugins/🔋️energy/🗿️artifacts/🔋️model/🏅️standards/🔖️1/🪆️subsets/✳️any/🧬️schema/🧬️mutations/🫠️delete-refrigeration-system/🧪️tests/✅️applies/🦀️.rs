...
fn case() -> Case {
    Case { kind: "delete-refrigeration-system", directory: "🫠️delete-refrigeration-system/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
