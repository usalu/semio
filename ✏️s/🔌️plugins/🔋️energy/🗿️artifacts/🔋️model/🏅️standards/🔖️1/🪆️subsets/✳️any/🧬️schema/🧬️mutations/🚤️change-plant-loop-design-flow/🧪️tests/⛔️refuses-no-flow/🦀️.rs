//! 🧪️ `change-plant-loop-design-flow` fixture — `⛔️refuses-no-flow`: refuses a zero design flow.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/⛔️refuses-no-flow/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/⛔️refuses-no-flow/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/⛔️refuses-no-flow/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/⛔️refuses-no-flow/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/⛔️refuses-no-flow/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_plant_loop_design_flow(crate::model::EntityId(18), 0.0))
}

fn case() -> Case {
    Case { kind: "change-plant-loop-design-flow", directory: "🚤️change-plant-loop-design-flow/⛔️refuses-no-flow", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
