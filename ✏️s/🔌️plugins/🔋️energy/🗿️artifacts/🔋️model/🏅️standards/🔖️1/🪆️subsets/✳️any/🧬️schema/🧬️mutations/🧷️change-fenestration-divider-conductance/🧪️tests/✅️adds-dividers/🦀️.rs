//! 🧪️ `change-fenestration-divider-conductance` fixture — `✅️adds-dividers`: gives the window divider bars.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/✅️adds-dividers/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/✅️adds-dividers/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/✅️adds-dividers/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/✅️adds-dividers/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/✅️adds-dividers/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_divider_conductance(crate::model::EntityId(5), 0.4))
}

fn case() -> Case {
    Case { kind: "change-fenestration-divider-conductance", directory: "🧷️change-fenestration-divider-conductance/✅️adds-dividers", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
