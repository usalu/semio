//! 🧪️ `add-electrical-load-center-pv` fixture — `⛔️refuses`: refuses a PV system the document does not define.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::add_electrical_load_center_pv(crate::model::EntityId(320), 1, crate::model::EntityId(999)))
}

fn case() -> Case {
    Case { kind: "add-electrical-load-center-pv", directory: "☄️add-electrical-load-center-pv/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
