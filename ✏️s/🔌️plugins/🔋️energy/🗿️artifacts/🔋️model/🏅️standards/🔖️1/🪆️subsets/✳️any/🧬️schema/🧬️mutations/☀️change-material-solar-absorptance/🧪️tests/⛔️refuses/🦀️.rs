//! 🧪️ `change-material-solar-absorptance` fixture — `⛔️refuses`: refuses solar absorptance outside a fraction in [0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-material-solar-absorptance/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-material-solar-absorptance/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-material-solar-absorptance/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-material-solar-absorptance/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☀️change-material-solar-absorptance/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_material_solar_absorptance(crate::model::EntityId(1), -0.1))
}

fn case() -> Case {
    Case { kind: "change-material-solar-absorptance", directory: "☀️change-material-solar-absorptance/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
