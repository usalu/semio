...
fn case() -> Case {
    Case { kind: "change-material-solar-absorptance", directory: "☀️change-material-solar-absorptance/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
