...
fn case() -> Case {
    Case { kind: "change-battery-max-charge", directory: "⏫️change-battery-max-charge/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
