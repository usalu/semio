//! 🧪️ `change-ideal-loads-system-outdoor-air-per-person` fixture — `✅️ventilates-per-head`: draws outdoor air per occupant.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/✅️ventilates-per-head/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/✅️ventilates-per-head/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/✅️ventilates-per-head/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/✅️ventilates-per-head/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/✅️ventilates-per-head/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_ideal_loads_system_outdoor_air_per_person(crate::model::EntityId(12), 0.0025))
}

fn case() -> Case {
    Case {
        kind: "change-ideal-loads-system-outdoor-air-per-person",
        directory: "🧍️change-ideal-loads-system-outdoor-air-per-person/✅️ventilates-per-head",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
