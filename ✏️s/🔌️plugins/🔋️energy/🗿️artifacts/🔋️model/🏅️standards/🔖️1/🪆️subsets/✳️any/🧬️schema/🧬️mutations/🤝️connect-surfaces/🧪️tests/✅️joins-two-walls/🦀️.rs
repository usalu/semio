...
fn case() -> Case {
    Case { kind: "connect-surfaces", directory: "🤝️connect-surfaces/🧪️tests/✅️joins-two-walls", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
