...
fn case() -> Case {
    Case { kind: "delete-space-list", directory: "🗒️delete-space-list/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
