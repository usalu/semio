...
fn case() -> Case {
    Case { kind: "delete-daily-schedule", directory: "🌓️delete-daily-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
