...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeLightingGainRadiantFraction {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Lighting Gain Radiant Fraction of lighting gain {}", self.id.0), &format!("Strahlungsanteil von Beleuchtungswärmegewinn {} ändern", self.id.0))
    }
