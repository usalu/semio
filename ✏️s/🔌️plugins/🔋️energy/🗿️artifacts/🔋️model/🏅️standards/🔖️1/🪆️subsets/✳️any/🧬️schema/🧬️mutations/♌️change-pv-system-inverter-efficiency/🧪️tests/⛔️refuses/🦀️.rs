//! 🧪️ `change-pv-system-inverter-efficiency` fixture — `⛔️refuses`: refuses inverter efficiency outside a fraction in (0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_pv_system_inverter_efficiency(crate::model::EntityId(300), 1.5))
}

fn case() -> Case {
    Case { kind: "change-pv-system-inverter-efficiency", directory: "♌️change-pv-system-inverter-efficiency/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
