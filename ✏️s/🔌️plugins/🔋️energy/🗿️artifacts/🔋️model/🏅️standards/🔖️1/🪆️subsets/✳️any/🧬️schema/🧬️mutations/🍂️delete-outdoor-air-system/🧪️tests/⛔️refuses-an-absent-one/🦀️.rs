...
fn case() -> Case {
    Case { kind: "delete-outdoor-air-system", directory: "🍂️delete-outdoor-air-system/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
