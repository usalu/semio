...
fn case() -> Case {
    Case { kind: "remove-annual-schedule-holiday", directory: "🎊️remove-annual-schedule-holiday/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
