...
fn case() -> Case {
    Case { kind: "connect-surfaces", directory: "🤝️connect-surfaces/🧪️tests/⛔️refuses-a-self-pair", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
