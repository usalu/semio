//! 🧪️ `change-time-series-schedule-timestep` fixture — `⛔️refuses`: refuses a zero-second timestep.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_time_series_schedule_timestep(crate::model::ScheduleId(40), 0))
}

fn case() -> Case {
    Case { kind: "change-time-series-schedule-timestep", directory: "🕙️change-time-series-schedule-timestep/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
