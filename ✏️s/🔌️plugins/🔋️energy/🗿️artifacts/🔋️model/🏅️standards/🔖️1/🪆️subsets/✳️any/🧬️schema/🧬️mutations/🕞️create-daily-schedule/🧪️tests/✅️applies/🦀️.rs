...
fn case() -> Case {
    Case { kind: "create-daily-schedule", directory: "🕞️create-daily-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
