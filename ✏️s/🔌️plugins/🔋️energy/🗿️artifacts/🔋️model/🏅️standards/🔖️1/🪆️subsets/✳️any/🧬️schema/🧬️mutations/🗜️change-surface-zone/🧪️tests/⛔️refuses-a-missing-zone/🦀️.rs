...
fn case() -> Case {
    Case { kind: "change-surface-zone", directory: "🗜️change-surface-zone/🧪️tests/⛔️refuses-a-missing-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
