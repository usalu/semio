...
pub struct EnergyModelCameraPose {
    pub position: [f64; 3],
    pub target: [f64; 3],
    pub zoom: f64,
}

impl Default for EnergyModelCameraPose {
...
#[dsl(id = "energy.model3dwindowconfig", layout = "lines")]
pub struct EnergyModelWindowConfig {
    #[dsl(block)]
