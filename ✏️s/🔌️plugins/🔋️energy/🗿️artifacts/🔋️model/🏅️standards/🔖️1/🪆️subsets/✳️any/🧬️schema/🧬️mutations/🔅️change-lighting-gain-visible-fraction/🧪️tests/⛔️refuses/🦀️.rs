//! 🧪️ `change-lighting-gain-visible-fraction` fixture — `⛔️refuses`: refuses visible fraction outside a fraction in [0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_lighting_gain_visible_fraction(crate::model::EntityId(30), -0.4))
}

fn case() -> Case {
    Case { kind: "change-lighting-gain-visible-fraction", directory: "🔅️change-lighting-gain-visible-fraction/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
