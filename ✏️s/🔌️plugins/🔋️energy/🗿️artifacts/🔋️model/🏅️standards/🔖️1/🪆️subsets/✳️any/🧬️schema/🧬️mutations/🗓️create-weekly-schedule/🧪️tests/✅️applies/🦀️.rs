...
fn case() -> Case {
    Case { kind: "create-weekly-schedule", directory: "🗓️create-weekly-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
