//! 🧪️ `change-battery-round-trip-efficiency` fixture — `⛔️refuses`: refuses round-trip efficiency outside a fraction in (0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_battery_round_trip_efficiency(crate::model::EntityId(310), 1.2))
}

fn case() -> Case {
    Case { kind: "change-battery-round-trip-efficiency", directory: "🥉️change-battery-round-trip-efficiency/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
