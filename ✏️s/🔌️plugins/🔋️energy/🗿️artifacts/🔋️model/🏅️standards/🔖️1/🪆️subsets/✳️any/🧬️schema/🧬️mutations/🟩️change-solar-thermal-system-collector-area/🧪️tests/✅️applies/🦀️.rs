//! 🧪️ `change-solar-thermal-system-collector-area` fixture — `✅️applies`: moves solar thermal system 410.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_solar_thermal_system_collector_area(crate::model::EntityId(410), 6.0))
}

fn case() -> Case {
    Case { kind: "change-solar-thermal-system-collector-area", directory: "🟩️change-solar-thermal-system-collector-area/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
