...
fn case() -> Case {
    Case { kind: "replace-setpoint-manager-kind", directory: "🔃️replace-setpoint-manager-kind/🧪️tests/✅️resets-on-outdoor-air", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
