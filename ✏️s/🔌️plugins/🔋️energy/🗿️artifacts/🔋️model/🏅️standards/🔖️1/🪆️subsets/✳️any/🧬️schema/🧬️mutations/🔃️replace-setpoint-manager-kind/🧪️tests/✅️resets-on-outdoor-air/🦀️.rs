//! 🧪️ `replace-setpoint-manager-kind` fixture — `✅️resets-on-outdoor-air`: swaps the scheduled law for an outdoor air reset.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/✅️resets-on-outdoor-air/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/✅️resets-on-outdoor-air/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/✅️resets-on-outdoor-air/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/✅️resets-on-outdoor-air/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/✅️resets-on-outdoor-air/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::replace_setpoint_manager_kind(crate::model::EntityId(16), "OutdoorAirReset".to_string(), -10.0, 20.0, 16.0, 12.0))
}

fn case() -> Case {
    Case { kind: "replace-setpoint-manager-kind", directory: "🔃️replace-setpoint-manager-kind/✅️resets-on-outdoor-air", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
