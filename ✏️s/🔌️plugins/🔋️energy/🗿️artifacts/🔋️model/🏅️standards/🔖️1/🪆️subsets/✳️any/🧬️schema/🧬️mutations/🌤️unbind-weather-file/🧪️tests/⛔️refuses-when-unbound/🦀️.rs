//! 🧪️ `unbind-weather-file` fixture — `⛔️refuses-when-unbound`: refuses when nothing is bound.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/⛔️refuses-when-unbound/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/⛔️refuses-when-unbound/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/⛔️refuses-when-unbound/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/⛔️refuses-when-unbound/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/⛔️refuses-when-unbound/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "unbind-weather-file", directory: "🌤️unbind-weather-file/⛔️refuses-when-unbound", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
