...
fn case() -> Case {
    Case { kind: "unbind-weather-file", directory: "🌤️unbind-weather-file/🧪️tests/⛔️refuses-when-unbound", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
