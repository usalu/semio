//! 🏛️ ANSI/ASHRAE 140 §5.2 case 920 as a bundled energy-model example.
//!
...
/// @emoji 🪪 Example id.
pub const ID: &str = "bestest-920";

/// @emoji 🏷️ Example label.
pub const LABEL_EN: &str = "BESTEST 920";

/// @emoji 🏛️ The ANSI/ASHRAE 140 §5.2 case id this example carries.
pub const CASE: &str = "920";

/// @emoji 🏗️ This example's model.
pub fn model() -> crate::model::Model {
    crate::bestest::model(CASE).expect("ANSI/ASHRAE 140 §5.2 case 920 is registered")
}
