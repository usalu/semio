//! 🧪️ `change-equipment-gain-radiant-fraction` fixture — `✅️applies`: moves equipment gain 40.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌠️change-equipment-gain-radiant-fraction/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌠️change-equipment-gain-radiant-fraction/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌠️change-equipment-gain-radiant-fraction/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌠️change-equipment-gain-radiant-fraction/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌠️change-equipment-gain-radiant-fraction/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_equipment_gain_radiant_fraction(crate::model::EntityId(40), 0.4))
}

fn case() -> Case {
    Case { kind: "change-equipment-gain-radiant-fraction", directory: "🌠️change-equipment-gain-radiant-fraction/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
