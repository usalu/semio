...
fn case() -> Case {
    Case { kind: "create-air-loop", directory: "🛞️create-air-loop/🧪️tests/✅️adds-a-main-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
