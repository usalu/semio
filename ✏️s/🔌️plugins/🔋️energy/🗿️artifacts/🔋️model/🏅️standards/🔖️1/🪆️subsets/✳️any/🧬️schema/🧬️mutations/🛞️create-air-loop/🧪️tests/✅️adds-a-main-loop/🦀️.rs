//! 🧪️ `create-air-loop` fixture — `✅️adds-a-main-loop`: adds the main air loop serving the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/✅️adds-a-main-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/✅️adds-a-main-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/✅️adds-a-main-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/✅️adds-a-main-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/✅️adds-a-main-loop/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_air_loop(crate::model::EntityId(17), "MAIN AIR LOOP".to_string(), 1, 2, 1.2, vec![crate::model::EntityId(1)]))
}

fn case() -> Case {
    Case { kind: "create-air-loop", directory: "🛞️create-air-loop/✅️adds-a-main-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
