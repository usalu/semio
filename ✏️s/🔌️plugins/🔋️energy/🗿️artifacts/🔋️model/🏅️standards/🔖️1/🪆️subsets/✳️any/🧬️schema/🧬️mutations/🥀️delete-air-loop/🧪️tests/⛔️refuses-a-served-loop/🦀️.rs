//! 🧪️ `delete-air-loop` fixture — `⛔️refuses-a-served-loop`: refuses a loop an outdoor air system still names.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/⛔️refuses-a-served-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/⛔️refuses-a-served-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/⛔️refuses-a-served-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/⛔️refuses-a-served-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/⛔️refuses-a-served-loop/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-air-loop", directory: "🥀️delete-air-loop/⛔️refuses-a-served-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
