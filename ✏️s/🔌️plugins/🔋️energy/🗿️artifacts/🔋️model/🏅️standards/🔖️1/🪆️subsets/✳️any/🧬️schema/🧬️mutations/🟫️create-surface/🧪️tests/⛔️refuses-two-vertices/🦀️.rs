//! 🧪️ `create-surface` fixture — `⛔️refuses-two-vertices`: refuses a polygon with two vertices.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/⛔️refuses-two-vertices/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/⛔️refuses-two-vertices/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/⛔️refuses-two-vertices/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/⛔️refuses-two-vertices/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/⛔️refuses-two-vertices/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-surface", directory: "🟫️create-surface/⛔️refuses-two-vertices", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
