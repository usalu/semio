...
fn case() -> Case {
    Case { kind: "create-surface", directory: "🟫️create-surface/🧪️tests/⛔️refuses-two-vertices", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
