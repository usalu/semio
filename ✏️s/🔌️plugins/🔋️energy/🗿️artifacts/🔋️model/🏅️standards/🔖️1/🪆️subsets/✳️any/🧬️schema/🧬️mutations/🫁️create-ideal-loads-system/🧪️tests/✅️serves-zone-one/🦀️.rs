//! 🧪️ `create-ideal-loads-system` fixture — `✅️serves-zone-one`: serves the first zone with autosized ideal loads.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/✅️serves-zone-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/✅️serves-zone-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/✅️serves-zone-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/✅️serves-zone-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/✅️serves-zone-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_ideal_loads_system(crate::model::EntityId(12), crate::model::EntityId(1), 50.0, 13.0, false, 0.0, false, 0.0, 0.0, 0.0))
}

fn case() -> Case {
    Case { kind: "create-ideal-loads-system", directory: "🫁️create-ideal-loads-system/✅️serves-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
