//! 🧪️ `change-daily-schedule-interpolation` fixture — `⛔️refuses`: refuses a schedule the document does not define.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_daily_schedule_interpolation(crate::model::ScheduleId(99), crate::schedule::ScheduleInterpolation::Discrete))
}

fn case() -> Case {
    Case { kind: "change-daily-schedule-interpolation", directory: "🕕️change-daily-schedule-interpolation/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
