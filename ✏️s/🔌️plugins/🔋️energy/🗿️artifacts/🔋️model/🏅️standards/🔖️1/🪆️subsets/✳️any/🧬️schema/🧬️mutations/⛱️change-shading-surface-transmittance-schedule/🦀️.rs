...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeShadingSurfaceTransmittanceSchedule {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change shading surface {} transmittance schedule", self.id.0), &format!("Transmissionszeitplan von Verschattungsfläche {} ändern", self.id.0))
    }
