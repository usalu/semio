...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeMaterialThermalAbsorptance {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Material Thermal Absorptance of material {}", self.id.0), &format!("Thermischen Absorptionsgrad von Material {} ändern", self.id.0))
    }
