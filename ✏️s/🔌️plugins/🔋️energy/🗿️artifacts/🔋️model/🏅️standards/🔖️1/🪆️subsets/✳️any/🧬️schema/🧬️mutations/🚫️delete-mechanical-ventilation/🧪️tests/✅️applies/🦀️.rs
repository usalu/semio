...
fn case() -> Case {
    Case { kind: "delete-mechanical-ventilation", directory: "🚫️delete-mechanical-ventilation/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
