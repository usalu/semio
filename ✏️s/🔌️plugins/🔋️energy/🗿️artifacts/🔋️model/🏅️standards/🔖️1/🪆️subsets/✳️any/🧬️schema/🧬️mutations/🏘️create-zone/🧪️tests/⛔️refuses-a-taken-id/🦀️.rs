...
fn case() -> Case {
    Case { kind: "create-zone", directory: "🏘️create-zone/🧪️tests/⛔️refuses-a-taken-id", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
