...
fn case() -> Case {
    Case { kind: "remove-plant-loop-equipment", directory: "⚙️remove-plant-loop-equipment/🧪️tests/⛔️refuses-an-unlisted", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
