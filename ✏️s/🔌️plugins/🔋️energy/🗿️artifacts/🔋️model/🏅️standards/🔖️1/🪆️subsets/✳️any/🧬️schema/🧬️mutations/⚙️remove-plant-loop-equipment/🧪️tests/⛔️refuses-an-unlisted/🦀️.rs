//! 🧪️ `remove-plant-loop-equipment` fixture — `⛔️refuses-an-unlisted`: refuses an id the loop does not list.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️remove-plant-loop-equipment/⛔️refuses-an-unlisted/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️remove-plant-loop-equipment/⛔️refuses-an-unlisted/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️remove-plant-loop-equipment/⛔️refuses-an-unlisted/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️remove-plant-loop-equipment/⛔️refuses-an-unlisted/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚙️remove-plant-loop-equipment/⛔️refuses-an-unlisted/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "remove-plant-loop-equipment", directory: "⚙️remove-plant-loop-equipment/⛔️refuses-an-unlisted", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
