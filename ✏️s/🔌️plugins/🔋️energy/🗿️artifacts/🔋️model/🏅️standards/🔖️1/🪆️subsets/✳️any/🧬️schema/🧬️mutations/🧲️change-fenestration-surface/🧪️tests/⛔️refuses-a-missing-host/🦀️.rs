...
fn case() -> Case {
    Case { kind: "change-fenestration-surface", directory: "🧲️change-fenestration-surface/🧪️tests/⛔️refuses-a-missing-host", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
