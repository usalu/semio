//! 🧪️ `change-fenestration-surface` fixture — `⛔️refuses-a-missing-host`: refuses an absent host surface.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/⛔️refuses-a-missing-host/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/⛔️refuses-a-missing-host/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/⛔️refuses-a-missing-host/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/⛔️refuses-a-missing-host/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/⛔️refuses-a-missing-host/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_surface(crate::model::EntityId(5), crate::model::EntityId(9)))
}

fn case() -> Case {
    Case { kind: "change-fenestration-surface", directory: "🧲️change-fenestration-surface/⛔️refuses-a-missing-host", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
