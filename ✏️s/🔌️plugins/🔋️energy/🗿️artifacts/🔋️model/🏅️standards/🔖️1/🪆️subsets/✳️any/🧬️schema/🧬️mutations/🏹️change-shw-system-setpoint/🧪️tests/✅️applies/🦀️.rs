//! 🧪️ `change-shw-system-setpoint` fixture — `✅️applies`: moves service hot water system 400.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_shw_system_setpoint(crate::model::EntityId(400), 60.0))
}

fn case() -> Case {
    Case { kind: "change-shw-system-setpoint", directory: "🏹️change-shw-system-setpoint/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
