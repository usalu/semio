...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeInfiltrationSchedule {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Infiltration Schedule of infiltration {}", self.id.0), &format!("Infiltrationszeitplan von Infiltration {} ändern", self.id.0))
    }
