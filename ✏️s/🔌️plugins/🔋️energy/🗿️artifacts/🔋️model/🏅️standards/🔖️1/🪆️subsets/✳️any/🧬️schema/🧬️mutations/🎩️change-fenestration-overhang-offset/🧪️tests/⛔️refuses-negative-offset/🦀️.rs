//! 🧪️ `change-fenestration-overhang-offset` fixture — `⛔️refuses-negative-offset`: refuses a negative overhang offset.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎩️change-fenestration-overhang-offset/⛔️refuses-negative-offset/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎩️change-fenestration-overhang-offset/⛔️refuses-negative-offset/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎩️change-fenestration-overhang-offset/⛔️refuses-negative-offset/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎩️change-fenestration-overhang-offset/⛔️refuses-negative-offset/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎩️change-fenestration-overhang-offset/⛔️refuses-negative-offset/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_overhang_offset(crate::model::EntityId(5), -0.5))
}

fn case() -> Case {
    Case { kind: "change-fenestration-overhang-offset", directory: "🎩️change-fenestration-overhang-offset/⛔️refuses-negative-offset", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
