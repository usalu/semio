//! 🧪️ `change-lighting-gain-return-air-fraction` fixture — `✅️applies`: moves lighting gain 30.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-lighting-gain-return-air-fraction", directory: "🎐️change-lighting-gain-return-air-fraction/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
