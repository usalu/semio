//! 🧪️ `change-surface-boundary-condition` fixture — `⛔️refuses-half-a-union`: refuses an interzone arm with no partner.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/⛔️refuses-half-a-union/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/⛔️refuses-half-a-union/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/⛔️refuses-half-a-union/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/⛔️refuses-half-a-union/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/⛔️refuses-half-a-union/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-boundary-condition", directory: "🚧️change-surface-boundary-condition/⛔️refuses-half-a-union", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
