...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeRefrigerationSystemDesignLoad {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Refrigeration System Design Load of refrigeration system {}", self.id.0), &format!("Kältensystembemessungslast von Kältensystem {} ändern", self.id.0))
    }
