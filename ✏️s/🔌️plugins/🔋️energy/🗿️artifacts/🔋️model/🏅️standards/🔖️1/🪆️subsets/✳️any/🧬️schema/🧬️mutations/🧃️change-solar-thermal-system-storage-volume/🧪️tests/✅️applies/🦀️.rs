//! 🧪️ `change-solar-thermal-system-storage-volume` fixture — `✅️applies`: moves solar thermal system 410.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_solar_thermal_system_storage_volume(crate::model::EntityId(410), 0.5))
}

fn case() -> Case {
    Case { kind: "change-solar-thermal-system-storage-volume", directory: "🧃️change-solar-thermal-system-storage-volume/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
