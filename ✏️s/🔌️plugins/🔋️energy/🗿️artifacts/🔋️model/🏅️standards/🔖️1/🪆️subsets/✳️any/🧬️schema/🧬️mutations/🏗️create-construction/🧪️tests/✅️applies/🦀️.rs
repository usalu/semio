...
fn case() -> Case {
    Case { kind: "create-construction", directory: "🏗️create-construction/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
