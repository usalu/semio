...
fn case() -> Case {
    Case { kind: "delete-water-system", directory: "🧼️delete-water-system/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
