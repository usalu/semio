//! 🧪️ `rename-zone` fixture — `✅️renames-zone-one`: renames the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏠️rename-zone/✅️renames-zone-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏠️rename-zone/✅️renames-zone-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏠️rename-zone/✅️renames-zone-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏠️rename-zone/✅️renames-zone-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏠️rename-zone/✅️renames-zone-one/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "rename-zone", directory: "🏠️rename-zone/✅️renames-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
