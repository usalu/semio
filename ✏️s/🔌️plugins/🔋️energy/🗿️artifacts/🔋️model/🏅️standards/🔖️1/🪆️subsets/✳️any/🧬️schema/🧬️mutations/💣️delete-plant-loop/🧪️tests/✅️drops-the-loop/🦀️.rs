//! 🧪️ `delete-plant-loop` fixture — `✅️drops-the-loop`: drops the hot water loop.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/✅️drops-the-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/✅️drops-the-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/✅️drops-the-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/✅️drops-the-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/✅️drops-the-loop/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_plant_loop(crate::model::EntityId(18)))
}

fn case() -> Case {
    Case { kind: "delete-plant-loop", directory: "💣️delete-plant-loop/✅️drops-the-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
