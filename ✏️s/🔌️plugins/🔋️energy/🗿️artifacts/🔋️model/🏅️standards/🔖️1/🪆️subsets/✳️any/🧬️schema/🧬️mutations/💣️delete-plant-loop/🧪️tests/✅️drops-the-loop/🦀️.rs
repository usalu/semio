...
fn case() -> Case {
    Case { kind: "delete-plant-loop", directory: "💣️delete-plant-loop/🧪️tests/✅️drops-the-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
