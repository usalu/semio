//! 🧪️ `change-zone-equipment-type` fixture — `⛔️refuses-an-absent-row`: refuses an absent zone equipment.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/⛔️refuses-an-absent-row/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/⛔️refuses-an-absent-row/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/⛔️refuses-an-absent-row/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/⛔️refuses-an-absent-row/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/⛔️refuses-an-absent-row/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-zone-equipment-type", directory: "🔧️change-zone-equipment-type/⛔️refuses-an-absent-row", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
