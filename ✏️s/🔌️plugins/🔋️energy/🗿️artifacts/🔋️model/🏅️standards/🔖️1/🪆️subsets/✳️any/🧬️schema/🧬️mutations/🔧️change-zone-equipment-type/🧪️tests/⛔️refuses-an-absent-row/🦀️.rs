...
fn case() -> Case {
    Case { kind: "change-zone-equipment-type", directory: "🔧️change-zone-equipment-type/🧪️tests/⛔️refuses-an-absent-row", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
