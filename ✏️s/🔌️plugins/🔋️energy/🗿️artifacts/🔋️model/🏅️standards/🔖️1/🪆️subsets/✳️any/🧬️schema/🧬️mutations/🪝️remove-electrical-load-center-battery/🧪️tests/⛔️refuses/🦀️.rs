//! 🧪️ `remove-electrical-load-center-battery` fixture — `⛔️refuses`: refuses a battery the load centre does not carry.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::remove_electrical_load_center_battery(crate::model::EntityId(320), crate::model::EntityId(310)))
}

fn case() -> Case {
    Case { kind: "remove-electrical-load-center-battery", directory: "🪝️remove-electrical-load-center-battery/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
