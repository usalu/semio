...
fn case() -> Case {
    Case { kind: "change-solar-thermal-system-tilt", directory: "🔼️change-solar-thermal-system-tilt/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
