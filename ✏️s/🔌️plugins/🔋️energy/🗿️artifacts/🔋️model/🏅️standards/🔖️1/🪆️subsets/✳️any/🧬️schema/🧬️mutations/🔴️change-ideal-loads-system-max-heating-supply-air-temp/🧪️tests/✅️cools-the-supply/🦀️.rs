...
fn case() -> Case {
    Case { kind: "change-ideal-loads-system-max-heating-supply-air-temp", directory: "🔴️change-ideal-loads-system-max-heating-supply-air-temp/🧪️tests/✅️cools-the-supply", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
