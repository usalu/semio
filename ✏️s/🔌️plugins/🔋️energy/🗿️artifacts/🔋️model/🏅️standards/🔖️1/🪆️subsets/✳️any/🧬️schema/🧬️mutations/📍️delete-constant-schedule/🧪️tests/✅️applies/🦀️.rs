...
fn case() -> Case {
    Case { kind: "delete-constant-schedule", directory: "📍️delete-constant-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
