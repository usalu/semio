...
fn case() -> Case {
    Case { kind: "change-fault-start-schedule", directory: "🕓️change-fault-start-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
