//! 🧪️ `change-refrigeration-system-design-load` fixture — `⛔️refuses`: refuses design load (W) outside a positive finite value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-refrigeration-system-design-load/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-refrigeration-system-design-load/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-refrigeration-system-design-load/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-refrigeration-system-design-load/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏋️change-refrigeration-system-design-load/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_refrigeration_system_design_load(crate::model::EntityId(420), 0.0))
}

fn case() -> Case {
    Case { kind: "change-refrigeration-system-design-load", directory: "🏋️change-refrigeration-system-design-load/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
