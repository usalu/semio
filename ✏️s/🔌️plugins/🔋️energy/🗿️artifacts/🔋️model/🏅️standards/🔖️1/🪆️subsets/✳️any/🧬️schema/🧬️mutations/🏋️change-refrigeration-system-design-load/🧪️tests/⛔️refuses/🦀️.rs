...
fn case() -> Case {
    Case { kind: "change-refrigeration-system-design-load", directory: "🏋️change-refrigeration-system-design-load/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
