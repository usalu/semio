...
fn case() -> Case {
    Case { kind: "change-weekly-schedule-day", directory: "🕗️change-weekly-schedule-day/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
