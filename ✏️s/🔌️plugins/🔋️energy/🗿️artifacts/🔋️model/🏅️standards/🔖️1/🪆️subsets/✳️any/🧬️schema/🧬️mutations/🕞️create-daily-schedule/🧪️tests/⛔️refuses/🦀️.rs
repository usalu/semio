//! 🧪️ `create-daily-schedule` fixture — `⛔️refuses`: refuses a schedule id the document already defines.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕞️create-daily-schedule/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕞️create-daily-schedule/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕞️create-daily-schedule/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕞️create-daily-schedule/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕞️create-daily-schedule/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_daily_schedule(3, crate::model::ScheduleId(10), vec![21.0; 24], crate::schedule::ScheduleInterpolation::Continuous, None, None))
}

fn case() -> Case {
    Case { kind: "create-daily-schedule", directory: "🕞️create-daily-schedule/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
