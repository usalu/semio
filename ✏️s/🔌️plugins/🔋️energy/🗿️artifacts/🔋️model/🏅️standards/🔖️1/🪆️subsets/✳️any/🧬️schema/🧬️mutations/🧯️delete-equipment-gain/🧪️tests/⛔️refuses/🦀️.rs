...
fn case() -> Case {
    Case { kind: "delete-equipment-gain", directory: "🧯️delete-equipment-gain/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
