...
fn case() -> Case {
    Case { kind: "change-surface-construction", directory: "🧰️change-surface-construction/🧪️tests/⛔️refuses-a-missing-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
