//! 🧪️ `change-mechanical-ventilation-design-flow` fixture — `⛔️refuses`: refuses design supply flow (m³/s) outside a finite non-negative value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_mechanical_ventilation_design_flow(crate::model::EntityId(60), -0.05))
}

fn case() -> Case {
    Case { kind: "change-mechanical-ventilation-design-flow", directory: "🚿️change-mechanical-ventilation-design-flow/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
