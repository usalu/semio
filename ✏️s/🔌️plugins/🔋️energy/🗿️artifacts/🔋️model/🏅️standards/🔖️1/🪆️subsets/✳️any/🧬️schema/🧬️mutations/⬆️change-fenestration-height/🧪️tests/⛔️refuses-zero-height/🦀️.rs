...
fn case() -> Case {
    Case { kind: "change-fenestration-height", directory: "⬆️change-fenestration-height/🧪️tests/⛔️refuses-zero-height", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
