//! 🧪️ `change-fenestration-height` fixture — `⛔️refuses-zero-height`: refuses a zero height.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/⛔️refuses-zero-height/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/⛔️refuses-zero-height/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/⛔️refuses-zero-height/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/⛔️refuses-zero-height/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/⛔️refuses-zero-height/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_height(crate::model::EntityId(5), 0.0))
}

fn case() -> Case {
    Case { kind: "change-fenestration-height", directory: "⬆️change-fenestration-height/⛔️refuses-zero-height", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
