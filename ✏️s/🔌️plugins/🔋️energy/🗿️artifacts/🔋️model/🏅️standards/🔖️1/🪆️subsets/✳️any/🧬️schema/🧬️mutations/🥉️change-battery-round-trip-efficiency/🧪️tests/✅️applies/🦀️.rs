//! 🧪️ `change-battery-round-trip-efficiency` fixture — `✅️applies`: moves battery 310.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥉️change-battery-round-trip-efficiency/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_battery_round_trip_efficiency(crate::model::EntityId(310), 0.95))
}

fn case() -> Case {
    Case { kind: "change-battery-round-trip-efficiency", directory: "🥉️change-battery-round-trip-efficiency/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
