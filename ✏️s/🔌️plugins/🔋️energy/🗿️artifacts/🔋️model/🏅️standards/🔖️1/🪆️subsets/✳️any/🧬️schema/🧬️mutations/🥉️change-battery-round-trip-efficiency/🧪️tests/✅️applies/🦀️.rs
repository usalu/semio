...
fn case() -> Case {
    Case { kind: "change-battery-round-trip-efficiency", directory: "🥉️change-battery-round-trip-efficiency/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
