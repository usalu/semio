...
fn case() -> Case {
    Case { kind: "change-air-loop-supply-node", directory: "↗️change-air-loop-supply-node/🧪️tests/⛔️refuses-node-zero", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
