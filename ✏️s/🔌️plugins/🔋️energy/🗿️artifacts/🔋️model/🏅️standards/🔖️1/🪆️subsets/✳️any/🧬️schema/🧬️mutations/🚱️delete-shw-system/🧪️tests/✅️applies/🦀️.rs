...
fn case() -> Case {
    Case { kind: "delete-shw-system", directory: "🚱️delete-shw-system/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
