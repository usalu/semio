...
fn case() -> Case {
    Case { kind: "create-solar-thermal-system", directory: "🌄️create-solar-thermal-system/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
