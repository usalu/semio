//! 🧪️ `rename-thermal-enclosure` fixture — `⛔️refuses`: refuses a name a sibling already holds.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::rename_thermal_enclosure(crate::model::EntityId(220), "SOUTH BLOCK".to_string()))
}

fn case() -> Case {
    Case { kind: "rename-thermal-enclosure", directory: "🖋️rename-thermal-enclosure/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
