...
fn case() -> Case {
    Case { kind: "change-humidistat-humidifying-throttle-range", directory: "🌧️change-humidistat-humidifying-throttle-range/🧪️tests/✅️widens-the-band", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
