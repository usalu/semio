...
fn case() -> Case {
    Case { kind: "change-material-density", directory: "⚖️change-material-density/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
