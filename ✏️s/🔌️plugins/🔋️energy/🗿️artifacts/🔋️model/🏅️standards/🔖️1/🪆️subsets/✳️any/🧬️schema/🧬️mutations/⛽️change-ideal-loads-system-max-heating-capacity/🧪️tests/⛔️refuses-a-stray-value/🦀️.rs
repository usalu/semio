//! 🧪️ `change-ideal-loads-system-max-heating-capacity` fixture — `⛔️refuses-a-stray-value`: refuses an autosized capacity that still carries a value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/⛔️refuses-a-stray-value/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/⛔️refuses-a-stray-value/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/⛔️refuses-a-stray-value/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/⛔️refuses-a-stray-value/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/⛔️refuses-a-stray-value/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_ideal_loads_system_max_heating_capacity(crate::model::EntityId(12), false, 4000.0))
}

fn case() -> Case {
    Case {
        kind: "change-ideal-loads-system-max-heating-capacity",
        directory: "⛽️change-ideal-loads-system-max-heating-capacity/⛔️refuses-a-stray-value",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
