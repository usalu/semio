...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeRefrigerationSystemDefrostSchedule {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Refrigeration System Defrost Schedule of refrigeration system {}", self.id.0), &format!("Abtauzeitplan von Kälteanlage {} ändern", self.id.0))
    }
