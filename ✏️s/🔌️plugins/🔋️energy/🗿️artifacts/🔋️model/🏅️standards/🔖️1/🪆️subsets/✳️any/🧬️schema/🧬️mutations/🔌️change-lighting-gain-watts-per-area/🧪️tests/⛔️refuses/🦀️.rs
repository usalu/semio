...
fn case() -> Case {
    Case { kind: "change-lighting-gain-watts-per-area", directory: "🔌️change-lighting-gain-watts-per-area/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
