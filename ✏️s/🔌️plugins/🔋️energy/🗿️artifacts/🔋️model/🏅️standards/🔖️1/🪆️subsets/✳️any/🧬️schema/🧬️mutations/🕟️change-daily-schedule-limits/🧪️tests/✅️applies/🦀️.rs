//! 🧪️ `change-daily-schedule-limits` fixture — `✅️applies`: clamps the profile to a stated interval.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕟️change-daily-schedule-limits/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕟️change-daily-schedule-limits/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕟️change-daily-schedule-limits/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕟️change-daily-schedule-limits/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕟️change-daily-schedule-limits/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-daily-schedule-limits", directory: "🕟️change-daily-schedule-limits/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
