...
fn case() -> Case {
    Case { kind: "replace-daily-schedule-hourly-values", directory: "🕔️replace-daily-schedule-hourly-values/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
