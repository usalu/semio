//! 🧪️ `change-fenestration-sill-height` fixture — `✅️raises-the-sill`: raises the window sill.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/✅️raises-the-sill/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/✅️raises-the-sill/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/✅️raises-the-sill/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/✅️raises-the-sill/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/✅️raises-the-sill/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_sill_height(crate::model::EntityId(5), 0.9))
}

fn case() -> Case {
    Case { kind: "change-fenestration-sill-height", directory: "⬇️change-fenestration-sill-height/✅️raises-the-sill", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
