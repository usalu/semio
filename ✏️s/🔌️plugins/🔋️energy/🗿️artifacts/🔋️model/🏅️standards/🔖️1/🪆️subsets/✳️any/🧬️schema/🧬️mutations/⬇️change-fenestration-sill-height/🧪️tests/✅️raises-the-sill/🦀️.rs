...
fn case() -> Case {
    Case { kind: "change-fenestration-sill-height", directory: "⬇️change-fenestration-sill-height/🧪️tests/✅️raises-the-sill", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
