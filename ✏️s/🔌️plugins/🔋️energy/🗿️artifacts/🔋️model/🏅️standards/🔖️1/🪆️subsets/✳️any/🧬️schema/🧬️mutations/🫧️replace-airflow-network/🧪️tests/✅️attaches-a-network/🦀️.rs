//! 🧪️ `replace-airflow-network` fixture — `✅️attaches-a-network`: attaches a one-zone airflow network.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/✅️attaches-a-network/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/✅️attaches-a-network/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/✅️attaches-a-network/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/✅️attaches-a-network/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/✅️attaches-a-network/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "replace-airflow-network", directory: "🫧️replace-airflow-network/✅️attaches-a-network", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
