...
fn case() -> Case {
    Case { kind: "replace-airflow-network", directory: "🫧️replace-airflow-network/🧪️tests/✅️attaches-a-network", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
