//! 🧪️ `delete-zone` fixture — `⛔️refuses-a-used-zone`: refuses a zone a space still names.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/⛔️refuses-a-used-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/⛔️refuses-a-used-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/⛔️refuses-a-used-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/⛔️refuses-a-used-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/⛔️refuses-a-used-zone/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-zone", directory: "🏚️delete-zone/⛔️refuses-a-used-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
