...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/⛔️refuses/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-equipment-gain-watts-per-area", directory: "⚡️change-equipment-gain-watts-per-area/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
