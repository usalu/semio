...
fn case() -> Case {
    Case { kind: "rename-surface", directory: "🏳️rename-surface/🧪️tests/✅️renames-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
