//! 🧪️ `rename-surface` fixture — `✅️renames-a-wall`: renames the south wall.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/✅️renames-a-wall/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/✅️renames-a-wall/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/✅️renames-a-wall/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/✅️renames-a-wall/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/✅️renames-a-wall/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "rename-surface", directory: "🏳️rename-surface/✅️renames-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
