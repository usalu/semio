...
fn case() -> Case {
    Case { kind: "rename-shading-surface", directory: "🏕️rename-shading-surface/🧪️tests/✅️renames-an-awning", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
