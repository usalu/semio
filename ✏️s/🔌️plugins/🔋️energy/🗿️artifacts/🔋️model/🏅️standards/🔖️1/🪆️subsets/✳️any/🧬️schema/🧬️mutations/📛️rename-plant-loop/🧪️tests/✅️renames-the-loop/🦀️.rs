//! 🧪️ `rename-plant-loop` fixture — `✅️renames-the-loop`: renames the hot water loop.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/✅️renames-the-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/✅️renames-the-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/✅️renames-the-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/✅️renames-the-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/✅️renames-the-loop/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::rename_plant_loop(crate::model::EntityId(18), "BOILER LOOP".into()))
}

fn case() -> Case {
    Case { kind: "rename-plant-loop", directory: "📛️rename-plant-loop/✅️renames-the-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
