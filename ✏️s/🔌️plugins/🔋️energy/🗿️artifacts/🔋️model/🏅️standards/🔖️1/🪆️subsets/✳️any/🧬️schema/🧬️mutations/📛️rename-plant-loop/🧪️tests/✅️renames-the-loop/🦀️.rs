...
fn case() -> Case {
    Case { kind: "rename-plant-loop", directory: "📛️rename-plant-loop/🧪️tests/✅️renames-the-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
