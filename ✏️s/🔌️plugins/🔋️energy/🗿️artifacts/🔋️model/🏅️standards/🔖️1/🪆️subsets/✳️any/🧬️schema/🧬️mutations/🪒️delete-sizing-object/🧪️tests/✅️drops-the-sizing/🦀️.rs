//! 🧪️ `delete-sizing-object` fixture — `✅️drops-the-sizing`: drops the sizing object.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪒️delete-sizing-object/✅️drops-the-sizing/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪒️delete-sizing-object/✅️drops-the-sizing/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪒️delete-sizing-object/✅️drops-the-sizing/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪒️delete-sizing-object/✅️drops-the-sizing/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪒️delete-sizing-object/✅️drops-the-sizing/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_sizing_object(crate::model::EntityId(15)))
}

fn case() -> Case {
    Case { kind: "delete-sizing-object", directory: "🪒️delete-sizing-object/✅️drops-the-sizing", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
