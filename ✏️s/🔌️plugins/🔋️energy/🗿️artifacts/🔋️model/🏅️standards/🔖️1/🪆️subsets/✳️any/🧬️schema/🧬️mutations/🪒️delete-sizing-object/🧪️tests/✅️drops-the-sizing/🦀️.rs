...
fn case() -> Case {
    Case { kind: "delete-sizing-object", directory: "🪒️delete-sizing-object/🧪️tests/✅️drops-the-sizing", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
