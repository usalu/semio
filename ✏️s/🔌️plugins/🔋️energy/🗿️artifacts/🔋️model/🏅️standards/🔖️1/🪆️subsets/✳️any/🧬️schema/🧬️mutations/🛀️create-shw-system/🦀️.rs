...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for CreateShwSystem {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create Shw System {} at index {}", self.id.0, self.index), &format!("Trinkwarmwasseranlage {} an Index {} erstellen", self.id.0, self.index))
    }
