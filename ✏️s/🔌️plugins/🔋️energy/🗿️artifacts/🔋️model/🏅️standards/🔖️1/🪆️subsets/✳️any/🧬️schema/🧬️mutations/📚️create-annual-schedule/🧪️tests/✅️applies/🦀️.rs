...
fn case() -> Case {
    Case { kind: "create-annual-schedule", directory: "📚️create-annual-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
