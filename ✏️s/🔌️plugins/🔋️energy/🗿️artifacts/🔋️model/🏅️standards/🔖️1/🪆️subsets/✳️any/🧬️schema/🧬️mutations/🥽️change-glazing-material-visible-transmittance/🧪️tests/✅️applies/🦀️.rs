//! 🧪️ `change-glazing-material-visible-transmittance` fixture — `✅️applies`: darkens the pane in the visible band.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_glazing_material_visible_transmittance(crate::model::EntityId(1), 0.74))
}

fn case() -> Case {
    Case { kind: "change-glazing-material-visible-transmittance", directory: "🥽️change-glazing-material-visible-transmittance/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
