...
fn case() -> Case {
    Case { kind: "delete-annual-schedule", directory: "📕️delete-annual-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
