...
fn case() -> Case {
    Case { kind: "add-construction-layer", directory: "➕️add-construction-layer/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
