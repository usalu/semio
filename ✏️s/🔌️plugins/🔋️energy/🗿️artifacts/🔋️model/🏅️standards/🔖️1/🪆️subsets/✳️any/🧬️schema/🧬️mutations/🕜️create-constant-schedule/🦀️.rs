...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for CreateConstantSchedule {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create Constant Schedule {} at index {}", self.id.0, self.index), &format!("Konstantenzeitplan {} an Index {} erstellen", self.id.0, self.index))
    }
