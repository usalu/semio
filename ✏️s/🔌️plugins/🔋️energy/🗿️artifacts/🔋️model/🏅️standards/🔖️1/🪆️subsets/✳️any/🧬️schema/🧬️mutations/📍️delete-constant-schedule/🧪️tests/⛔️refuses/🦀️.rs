...
fn case() -> Case {
    Case { kind: "delete-constant-schedule", directory: "📍️delete-constant-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
