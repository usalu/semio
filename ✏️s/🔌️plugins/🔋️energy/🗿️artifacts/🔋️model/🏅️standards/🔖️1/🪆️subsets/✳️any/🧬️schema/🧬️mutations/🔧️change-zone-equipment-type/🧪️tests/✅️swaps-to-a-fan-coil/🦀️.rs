//! 🧪️ `change-zone-equipment-type` fixture — `✅️swaps-to-a-fan-coil`: swaps the baseboard for a fan coil.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/✅️swaps-to-a-fan-coil/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/✅️swaps-to-a-fan-coil/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/✅️swaps-to-a-fan-coil/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/✅️swaps-to-a-fan-coil/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-zone-equipment-type/✅️swaps-to-a-fan-coil/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_zone_equipment_type(crate::model::EntityId(13), crate::model::ZoneEquipmentType::FanCoil))
}

fn case() -> Case {
    Case { kind: "change-zone-equipment-type", directory: "🔧️change-zone-equipment-type/✅️swaps-to-a-fan-coil", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
