...
fn case() -> Case {
    Case { kind: "change-material-thermal-absorptance", directory: "🔆️change-material-thermal-absorptance/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
