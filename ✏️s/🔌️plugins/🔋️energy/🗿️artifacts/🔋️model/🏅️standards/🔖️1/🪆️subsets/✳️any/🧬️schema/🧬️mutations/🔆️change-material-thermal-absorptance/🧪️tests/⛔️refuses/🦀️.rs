//! 🧪️ `change-material-thermal-absorptance` fixture — `⛔️refuses`: refuses thermal absorptance outside a fraction in [0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔆️change-material-thermal-absorptance/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔆️change-material-thermal-absorptance/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔆️change-material-thermal-absorptance/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔆️change-material-thermal-absorptance/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔆️change-material-thermal-absorptance/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_material_thermal_absorptance(crate::model::EntityId(1), 1.4))
}

fn case() -> Case {
    Case { kind: "change-material-thermal-absorptance", directory: "🔆️change-material-thermal-absorptance/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
