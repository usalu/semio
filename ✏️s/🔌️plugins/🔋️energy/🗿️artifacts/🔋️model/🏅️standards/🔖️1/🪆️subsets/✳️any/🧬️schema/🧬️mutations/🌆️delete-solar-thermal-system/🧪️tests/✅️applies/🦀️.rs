...
fn case() -> Case {
    Case { kind: "delete-solar-thermal-system", directory: "🌆️delete-solar-thermal-system/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
