//! 🧪️ `change-infiltration-constant-term-coefficient` fixture — `⛔️refuses`: refuses the constant term coefficient A outside a finite non-negative value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🅰️change-infiltration-constant-term-coefficient/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_infiltration_constant_term_coefficient(crate::model::EntityId(50), -1.0))
}

fn case() -> Case {
    Case { kind: "change-infiltration-constant-term-coefficient", directory: "🅰️change-infiltration-constant-term-coefficient/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
