...
fn case() -> Case {
    Case { kind: "change-infiltration-constant-term-coefficient", directory: "🅰️change-infiltration-constant-term-coefficient/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
