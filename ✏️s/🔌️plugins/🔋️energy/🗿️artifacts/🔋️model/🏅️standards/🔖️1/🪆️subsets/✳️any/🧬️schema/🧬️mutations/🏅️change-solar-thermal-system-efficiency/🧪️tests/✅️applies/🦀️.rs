//! 🧪️ `change-solar-thermal-system-efficiency` fixture — `✅️applies`: moves solar thermal system 410.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_solar_thermal_system_efficiency(crate::model::EntityId(410), 0.62))
}

fn case() -> Case {
    Case { kind: "change-solar-thermal-system-efficiency", directory: "🏅️change-solar-thermal-system-efficiency/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
