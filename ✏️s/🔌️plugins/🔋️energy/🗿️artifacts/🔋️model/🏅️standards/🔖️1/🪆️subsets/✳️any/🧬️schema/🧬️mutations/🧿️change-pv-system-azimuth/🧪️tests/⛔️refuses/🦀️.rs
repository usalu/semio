//! 🧪️ `change-pv-system-azimuth` fixture — `⛔️refuses`: refuses azimuth outside a compass bearing in [0, 360] degrees.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧿️change-pv-system-azimuth/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧿️change-pv-system-azimuth/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧿️change-pv-system-azimuth/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧿️change-pv-system-azimuth/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧿️change-pv-system-azimuth/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_pv_system_azimuth(crate::model::EntityId(300), 400.0))
}

fn case() -> Case {
    Case { kind: "change-pv-system-azimuth", directory: "🧿️change-pv-system-azimuth/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
