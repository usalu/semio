...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for CreateElectricalLoadCenter {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create Electrical Load Center {} at index {}", self.id.0, self.index), &format!("elektrische Lastmittelpunkt {} an Index {} erstellen", self.id.0, self.index))
    }
