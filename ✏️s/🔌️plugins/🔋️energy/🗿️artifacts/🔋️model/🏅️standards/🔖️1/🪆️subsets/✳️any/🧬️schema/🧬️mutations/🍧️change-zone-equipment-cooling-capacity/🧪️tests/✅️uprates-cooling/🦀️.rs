//! 🧪️ `change-zone-equipment-cooling-capacity` fixture — `✅️uprates-cooling`: uprates the cooling capacity.
//!
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_zone_equipment_cooling_capacity(crate::model::EntityId(13), 1500.0))
}
