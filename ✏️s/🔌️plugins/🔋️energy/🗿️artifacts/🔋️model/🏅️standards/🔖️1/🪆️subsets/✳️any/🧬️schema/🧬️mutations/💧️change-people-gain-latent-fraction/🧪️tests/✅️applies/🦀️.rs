//! 🧪️ `change-people-gain-latent-fraction` fixture — `✅️applies`: moves people gain 20.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-people-gain-latent-fraction/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-people-gain-latent-fraction/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-people-gain-latent-fraction/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-people-gain-latent-fraction/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💧️change-people-gain-latent-fraction/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_people_gain_latent_fraction(crate::model::EntityId(20), 0.3))
}

fn case() -> Case {
    Case { kind: "change-people-gain-latent-fraction", directory: "💧️change-people-gain-latent-fraction/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
