...
fn case() -> Case {
    Case { kind: "remove-electrical-load-center-pv", directory: "🌘️remove-electrical-load-center-pv/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
