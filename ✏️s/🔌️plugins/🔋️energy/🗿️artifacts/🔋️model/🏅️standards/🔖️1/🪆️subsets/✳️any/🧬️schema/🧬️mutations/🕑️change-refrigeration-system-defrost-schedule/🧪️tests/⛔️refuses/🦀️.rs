...
fn case() -> Case {
    Case { kind: "change-refrigeration-system-defrost-schedule", directory: "🕑️change-refrigeration-system-defrost-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
