//! 🧪️ `remove-thermal-enclosure-zone` fixture — `⛔️refuses`: refuses a zone the enclosure does not hold.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::remove_thermal_enclosure_zone(crate::model::EntityId(221), crate::model::EntityId(1)))
}

fn case() -> Case {
    Case { kind: "remove-thermal-enclosure-zone", directory: "🔓️remove-thermal-enclosure-zone/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
