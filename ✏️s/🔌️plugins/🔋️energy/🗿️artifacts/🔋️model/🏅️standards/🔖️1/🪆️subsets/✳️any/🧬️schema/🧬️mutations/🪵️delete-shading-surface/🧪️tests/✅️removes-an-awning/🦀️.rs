//! 🧪️ `delete-shading-surface` fixture — `✅️removes-an-awning`: removes the site awning.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️delete-shading-surface/✅️removes-an-awning/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️delete-shading-surface/✅️removes-an-awning/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️delete-shading-surface/✅️removes-an-awning/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️delete-shading-surface/✅️removes-an-awning/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪵️delete-shading-surface/✅️removes-an-awning/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_shading_surface(crate::model::EntityId(11)))
}

fn case() -> Case {
    Case { kind: "delete-shading-surface", directory: "🪵️delete-shading-surface/✅️removes-an-awning", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
