//! 🧪️ `change-outdoor-air-system-air-loop` fixture — `⛔️refuses-an-absent-loop`: refuses an air loop that does not exist.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/⛔️refuses-an-absent-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/⛔️refuses-an-absent-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/⛔️refuses-an-absent-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/⛔️refuses-an-absent-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/⛔️refuses-an-absent-loop/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_outdoor_air_system_air_loop(crate::model::EntityId(19), crate::model::EntityId(99)))
}

fn case() -> Case {
    Case { kind: "change-outdoor-air-system-air-loop", directory: "⛓️change-outdoor-air-system-air-loop/⛔️refuses-an-absent-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
