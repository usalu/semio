//! 🧪️ `reorder-construction-layers` fixture — `⛔️refuses`: refuses a layer exchange disguised as a reorder.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/⛔️refuses/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "reorder-construction-layers", directory: "🔀️reorder-construction-layers/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
