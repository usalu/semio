...
fn case() -> Case {
    Case { kind: "reorder-construction-layers", directory: "🔀️reorder-construction-layers/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
