...
fn case() -> Case {
    Case { kind: "change-pv-system-area", directory: "🟨️change-pv-system-area/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
