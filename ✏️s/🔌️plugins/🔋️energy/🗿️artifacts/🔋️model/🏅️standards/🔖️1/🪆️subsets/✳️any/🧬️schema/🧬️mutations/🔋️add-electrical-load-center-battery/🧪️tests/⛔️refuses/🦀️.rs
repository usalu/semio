//! 🧪️ `add-electrical-load-center-battery` fixture — `⛔️refuses`: refuses a battery the document does not define.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::add_electrical_load_center_battery(crate::model::EntityId(320), 0, crate::model::EntityId(999)))
}

fn case() -> Case {
    Case { kind: "add-electrical-load-center-battery", directory: "🔋️add-electrical-load-center-battery/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
