...
fn case() -> Case {
    Case { kind: "create-constant-schedule", directory: "🕜️create-constant-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
