//! 🧪️ `change-thermostat-cooling-setpoint-schedule` fixture — `✅️repoints-cooling`: repoints the cooling setpoint at the first schedule.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐧️change-thermostat-cooling-setpoint-schedule/✅️repoints-cooling/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐧️change-thermostat-cooling-setpoint-schedule/✅️repoints-cooling/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐧️change-thermostat-cooling-setpoint-schedule/✅️repoints-cooling/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐧️change-thermostat-cooling-setpoint-schedule/✅️repoints-cooling/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐧️change-thermostat-cooling-setpoint-schedule/✅️repoints-cooling/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_thermostat_cooling_setpoint_schedule(crate::model::EntityId(10), crate::model::ScheduleId(1)))
}

fn case() -> Case {
    Case {
        kind: "change-thermostat-cooling-setpoint-schedule", directory: "🐧️change-thermostat-cooling-setpoint-schedule/✅️repoints-cooling", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
