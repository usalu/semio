//! 🧪️ `change-mechanical-ventilation-fan-total-efficiency` fixture — `✅️applies`: moves mechanical ventilation 60.
//!
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_mechanical_ventilation_fan_total_efficiency(crate::model::EntityId(60), 0.8))
}

fn case() -> Case {
    Case { kind: "change-mechanical-ventilation-fan-total-efficiency", directory: "💠️change-mechanical-ventilation-fan-total-efficiency/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
