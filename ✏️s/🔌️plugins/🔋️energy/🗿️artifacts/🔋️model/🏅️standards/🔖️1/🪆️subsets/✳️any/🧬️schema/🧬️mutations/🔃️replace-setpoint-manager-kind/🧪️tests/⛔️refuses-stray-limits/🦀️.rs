...
fn case() -> Case {
    Case { kind: "replace-setpoint-manager-kind", directory: "🔃️replace-setpoint-manager-kind/🧪️tests/⛔️refuses-stray-limits", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
