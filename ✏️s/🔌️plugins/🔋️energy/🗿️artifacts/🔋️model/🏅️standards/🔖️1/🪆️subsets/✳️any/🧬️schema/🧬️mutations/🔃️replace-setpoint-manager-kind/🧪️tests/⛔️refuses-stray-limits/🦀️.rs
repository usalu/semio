//! 🧪️ `replace-setpoint-manager-kind` fixture — `⛔️refuses-stray-limits`: refuses reset limits on a variant that carries none.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/⛔️refuses-stray-limits/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/⛔️refuses-stray-limits/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/⛔️refuses-stray-limits/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/⛔️refuses-stray-limits/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️replace-setpoint-manager-kind/⛔️refuses-stray-limits/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::replace_setpoint_manager_kind(crate::model::EntityId(16), "WarmestZone".to_string(), -10.0, 20.0, 16.0, 12.0))
}

fn case() -> Case {
    Case { kind: "replace-setpoint-manager-kind", directory: "🔃️replace-setpoint-manager-kind/⛔️refuses-stray-limits", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
