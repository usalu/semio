...
fn case() -> Case {
    Case { kind: "change-mechanical-ventilation-zone", directory: "🧭️change-mechanical-ventilation-zone/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
