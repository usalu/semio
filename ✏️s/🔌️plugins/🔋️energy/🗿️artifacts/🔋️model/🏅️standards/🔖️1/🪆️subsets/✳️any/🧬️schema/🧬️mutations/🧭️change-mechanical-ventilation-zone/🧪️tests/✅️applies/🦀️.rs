//! 🧪️ `change-mechanical-ventilation-zone` fixture — `✅️applies`: moves mechanical ventilation 60.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧭️change-mechanical-ventilation-zone/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧭️change-mechanical-ventilation-zone/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧭️change-mechanical-ventilation-zone/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧭️change-mechanical-ventilation-zone/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧭️change-mechanical-ventilation-zone/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_mechanical_ventilation_zone(crate::model::EntityId(60), crate::model::EntityId(2)))
}

fn case() -> Case {
    Case { kind: "change-mechanical-ventilation-zone", directory: "🧭️change-mechanical-ventilation-zone/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
