//! 🧪️ `change-shw-system-heater-capacity` fixture — `⛔️refuses`: refuses heater capacity (W) outside a positive finite value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_shw_system_heater_capacity(crate::model::EntityId(400), 0.0))
}

fn case() -> Case {
    Case { kind: "change-shw-system-heater-capacity", directory: "🍵️change-shw-system-heater-capacity/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
