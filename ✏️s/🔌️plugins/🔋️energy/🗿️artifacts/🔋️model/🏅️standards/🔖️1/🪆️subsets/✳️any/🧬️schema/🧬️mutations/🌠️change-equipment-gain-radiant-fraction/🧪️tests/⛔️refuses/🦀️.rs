...
fn case() -> Case {
    Case { kind: "change-equipment-gain-radiant-fraction", directory: "🌠️change-equipment-gain-radiant-fraction/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
