...
fn case() -> Case {
    Case { kind: "change-battery-capacity", directory: "🥫️change-battery-capacity/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
