...
fn case() -> Case {
    Case { kind: "rename-air-loop", directory: "📇️rename-air-loop/🧪️tests/✅️renames-the-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
