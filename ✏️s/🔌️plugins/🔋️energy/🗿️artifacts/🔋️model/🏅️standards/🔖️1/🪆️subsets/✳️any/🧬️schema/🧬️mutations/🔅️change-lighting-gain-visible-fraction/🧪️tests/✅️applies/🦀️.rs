//! 🧪️ `change-lighting-gain-visible-fraction` fixture — `✅️applies`: moves lighting gain 30.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-lighting-gain-visible-fraction/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_lighting_gain_visible_fraction(crate::model::EntityId(30), 0.25))
}

fn case() -> Case {
    Case { kind: "change-lighting-gain-visible-fraction", directory: "🔅️change-lighting-gain-visible-fraction/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
