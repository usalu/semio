...
fn case() -> Case {
    Case { kind: "change-lighting-gain-visible-fraction", directory: "🔅️change-lighting-gain-visible-fraction/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
