...
fn case() -> Case {
    Case { kind: "add-plant-loop-equipment", directory: "🔩️add-plant-loop-equipment/🧪️tests/⛔️refuses-the-unset-id", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
