//! 🧪️ `add-plant-loop-equipment` fixture — `⛔️refuses-the-unset-id`: refuses the unset equipment id.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/⛔️refuses-the-unset-id/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/⛔️refuses-the-unset-id/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/⛔️refuses-the-unset-id/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/⛔️refuses-the-unset-id/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/⛔️refuses-the-unset-id/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::add_plant_loop_equipment(crate::model::EntityId(18), crate::model::EntityId(0)))
}

fn case() -> Case {
    Case { kind: "add-plant-loop-equipment", directory: "🔩️add-plant-loop-equipment/⛔️refuses-the-unset-id", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
