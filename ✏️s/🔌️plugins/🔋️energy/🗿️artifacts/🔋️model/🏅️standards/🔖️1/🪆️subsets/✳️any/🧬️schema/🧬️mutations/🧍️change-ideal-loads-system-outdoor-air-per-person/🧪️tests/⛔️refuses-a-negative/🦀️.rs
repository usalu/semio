...
fn case() -> Case {
    Case { kind: "change-ideal-loads-system-outdoor-air-per-person", directory: "🧍️change-ideal-loads-system-outdoor-air-per-person/🧪️tests/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
