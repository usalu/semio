//! 🧪️ `change-ideal-loads-system-outdoor-air-per-person` fixture — `⛔️refuses-a-negative`: refuses a negative ventilation rate.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/⛔️refuses-a-negative/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/⛔️refuses-a-negative/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/⛔️refuses-a-negative/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/⛔️refuses-a-negative/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧍️change-ideal-loads-system-outdoor-air-per-person/⛔️refuses-a-negative/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_ideal_loads_system_outdoor_air_per_person(crate::model::EntityId(12), -1.0))
}

fn case() -> Case {
    Case {
        kind: "change-ideal-loads-system-outdoor-air-per-person",
        directory: "🧍️change-ideal-loads-system-outdoor-air-per-person/⛔️refuses-a-negative",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
