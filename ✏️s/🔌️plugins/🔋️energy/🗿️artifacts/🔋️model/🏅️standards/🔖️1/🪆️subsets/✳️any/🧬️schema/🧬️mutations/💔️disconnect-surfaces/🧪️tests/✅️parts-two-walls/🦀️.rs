...
fn case() -> Case {
    Case { kind: "disconnect-surfaces", directory: "💔️disconnect-surfaces/🧪️tests/✅️parts-two-walls", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
