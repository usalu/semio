//! 🧪️ `disconnect-surfaces` fixture — `✅️parts-two-walls`: parts the two adjacent walls.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/✅️parts-two-walls/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/✅️parts-two-walls/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/✅️parts-two-walls/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/✅️parts-two-walls/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/✅️parts-two-walls/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    model.adjacency_pairs.push(crate::model::AdjacencyPair { surface_a_id: crate::model::EntityId(3), surface_b_id: crate::model::EntityId(6) });
    (snapshot(model), super::disconnect_surfaces(crate::model::EntityId(3), crate::model::EntityId(6)))
}

fn case() -> Case {
    Case { kind: "disconnect-surfaces", directory: "💔️disconnect-surfaces/✅️parts-two-walls", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
