...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeMaterialVisibleAbsorptance {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Material Visible Absorptance of material {}", self.id.0), &format!("sichtbare Materialabsorptionsgrad von Material {} ändern", self.id.0))
    }
