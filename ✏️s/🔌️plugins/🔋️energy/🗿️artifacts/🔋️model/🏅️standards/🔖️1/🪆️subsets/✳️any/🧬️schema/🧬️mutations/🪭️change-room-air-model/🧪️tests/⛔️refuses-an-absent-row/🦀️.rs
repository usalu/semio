//! 🧪️ `change-room-air-model` fixture — `⛔️refuses-an-absent-row`: refuses an absent room air model assignment.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/⛔️refuses-an-absent-row/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/⛔️refuses-an-absent-row/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/⛔️refuses-an-absent-row/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/⛔️refuses-an-absent-row/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/⛔️refuses-an-absent-row/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_room_air_model(crate::model::EntityId(99), crate::model::RoomAirModelType::TwoNodeBuoyancy))
}

fn case() -> Case {
    Case { kind: "change-room-air-model", directory: "🪭️change-room-air-model/⛔️refuses-an-absent-row", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
