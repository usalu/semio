...
fn case() -> Case {
    Case { kind: "change-material-thickness", directory: "📏️change-material-thickness/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
