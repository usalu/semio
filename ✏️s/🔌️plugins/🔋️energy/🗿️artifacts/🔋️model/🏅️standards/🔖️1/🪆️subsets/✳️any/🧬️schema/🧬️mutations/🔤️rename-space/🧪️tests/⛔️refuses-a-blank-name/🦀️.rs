...
fn case() -> Case {
    Case { kind: "rename-space", directory: "🔤️rename-space/🧪️tests/⛔️refuses-a-blank-name", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
