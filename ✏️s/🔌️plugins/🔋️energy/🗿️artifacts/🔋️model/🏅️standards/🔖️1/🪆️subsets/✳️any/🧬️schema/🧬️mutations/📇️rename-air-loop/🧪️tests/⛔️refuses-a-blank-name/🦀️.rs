...
fn case() -> Case {
    Case { kind: "rename-air-loop", directory: "📇️rename-air-loop/🧪️tests/⛔️refuses-a-blank-name", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
