//! 🧪️ `rename-air-loop` fixture — `⛔️refuses-a-blank-name`: refuses a blank name.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📇️rename-air-loop/⛔️refuses-a-blank-name/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📇️rename-air-loop/⛔️refuses-a-blank-name/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📇️rename-air-loop/⛔️refuses-a-blank-name/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📇️rename-air-loop/⛔️refuses-a-blank-name/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📇️rename-air-loop/⛔️refuses-a-blank-name/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::rename_air_loop(crate::model::EntityId(17), "   ".into()))
}

fn case() -> Case {
    Case { kind: "rename-air-loop", directory: "📇️rename-air-loop/⛔️refuses-a-blank-name", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
