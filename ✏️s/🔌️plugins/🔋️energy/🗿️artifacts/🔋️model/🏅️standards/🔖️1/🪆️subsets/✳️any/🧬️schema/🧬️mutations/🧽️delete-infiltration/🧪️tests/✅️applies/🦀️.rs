...
fn case() -> Case {
    Case { kind: "delete-infiltration", directory: "🧽️delete-infiltration/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
