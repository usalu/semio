...
fn case() -> Case {
    Case { kind: "change-people-gain-people-per-area", directory: "👥️change-people-gain-people-per-area/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
