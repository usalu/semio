...
fn case() -> Case {
    Case { kind: "add-thermal-enclosure-zone", directory: "🔒️add-thermal-enclosure-zone/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
