//! 🧪️ `add-thermal-enclosure-zone` fixture — `✅️applies`: moves thermal enclosure 220's membership.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::add_thermal_enclosure_zone(crate::model::EntityId(220), 1, crate::model::EntityId(2)))
}

fn case() -> Case {
    Case { kind: "add-thermal-enclosure-zone", directory: "🔒️add-thermal-enclosure-zone/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
