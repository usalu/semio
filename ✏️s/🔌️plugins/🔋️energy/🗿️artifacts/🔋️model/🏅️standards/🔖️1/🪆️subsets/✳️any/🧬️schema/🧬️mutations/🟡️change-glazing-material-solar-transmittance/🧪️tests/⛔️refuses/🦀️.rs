//! 🧪️ `change-glazing-material-solar-transmittance` fixture — `⛔️refuses`: refuses a transmittance above one.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_glazing_material_solar_transmittance(crate::model::EntityId(1), 1.4))
}

fn case() -> Case {
    Case { kind: "change-glazing-material-solar-transmittance", directory: "🟡️change-glazing-material-solar-transmittance/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
