...
fn case() -> Case {
    Case { kind: "update-site", directory: "🌍️update-site/🧪️tests/✅️relocates-to-denver", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
