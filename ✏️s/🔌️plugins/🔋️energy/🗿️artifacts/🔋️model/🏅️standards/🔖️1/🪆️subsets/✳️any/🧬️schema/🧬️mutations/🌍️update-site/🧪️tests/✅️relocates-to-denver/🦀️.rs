//! 🧪️ `update-site` fixture — `✅️relocates-to-denver`: relocates the model to Denver.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/✅️relocates-to-denver/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/✅️relocates-to-denver/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/✅️relocates-to-denver/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/✅️relocates-to-denver/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/✅️relocates-to-denver/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "update-site", directory: "🌍️update-site/✅️relocates-to-denver", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
