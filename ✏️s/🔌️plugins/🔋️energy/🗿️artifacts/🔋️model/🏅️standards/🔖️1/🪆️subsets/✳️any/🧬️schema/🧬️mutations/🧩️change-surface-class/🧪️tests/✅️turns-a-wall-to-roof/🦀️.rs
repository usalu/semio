...
fn case() -> Case {
    Case { kind: "change-surface-class", directory: "🧩️change-surface-class/🧪️tests/✅️turns-a-wall-to-roof", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
