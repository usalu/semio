//! 🧪️ `change-surface-class` fixture — `✅️turns-a-wall-to-roof`: reclassifies the wall as a roof.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/✅️turns-a-wall-to-roof/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/✅️turns-a-wall-to-roof/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/✅️turns-a-wall-to-roof/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/✅️turns-a-wall-to-roof/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/✅️turns-a-wall-to-roof/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-class", directory: "🧩️change-surface-class/✅️turns-a-wall-to-roof", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
