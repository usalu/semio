...
fn case() -> Case {
    Case { kind: "create-refrigeration-system", directory: "❄️create-refrigeration-system/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
