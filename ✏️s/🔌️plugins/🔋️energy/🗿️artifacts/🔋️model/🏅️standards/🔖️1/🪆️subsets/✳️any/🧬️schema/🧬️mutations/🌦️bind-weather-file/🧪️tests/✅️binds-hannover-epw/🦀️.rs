//! 🧪️ `bind-weather-file` fixture — `✅️binds-hannover-epw`: binds the bundled Hannover weather file.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/✅️binds-hannover-epw/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/✅️binds-hannover-epw/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/✅️binds-hannover-epw/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/✅️binds-hannover-epw/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/✅️binds-hannover-epw/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "bind-weather-file", directory: "🌦️bind-weather-file/✅️binds-hannover-epw", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
