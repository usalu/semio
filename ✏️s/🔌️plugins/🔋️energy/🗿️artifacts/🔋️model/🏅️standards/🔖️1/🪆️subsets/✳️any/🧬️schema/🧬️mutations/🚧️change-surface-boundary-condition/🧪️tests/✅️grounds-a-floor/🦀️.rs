//! 🧪️ `change-surface-boundary-condition` fixture — `✅️grounds-a-floor`: puts the surface on the ground.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/✅️grounds-a-floor/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/✅️grounds-a-floor/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/✅️grounds-a-floor/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/✅️grounds-a-floor/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚧️change-surface-boundary-condition/✅️grounds-a-floor/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-boundary-condition", directory: "🚧️change-surface-boundary-condition/✅️grounds-a-floor", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
