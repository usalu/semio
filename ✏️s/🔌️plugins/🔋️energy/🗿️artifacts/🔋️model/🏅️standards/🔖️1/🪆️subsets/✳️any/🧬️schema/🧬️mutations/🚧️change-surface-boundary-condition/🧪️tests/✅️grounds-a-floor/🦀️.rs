...
fn case() -> Case {
    Case { kind: "change-surface-boundary-condition", directory: "🚧️change-surface-boundary-condition/🧪️tests/✅️grounds-a-floor", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
