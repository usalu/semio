...
fn case() -> Case {
    Case { kind: "change-infiltration-schedule", directory: "⏳️change-infiltration-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
