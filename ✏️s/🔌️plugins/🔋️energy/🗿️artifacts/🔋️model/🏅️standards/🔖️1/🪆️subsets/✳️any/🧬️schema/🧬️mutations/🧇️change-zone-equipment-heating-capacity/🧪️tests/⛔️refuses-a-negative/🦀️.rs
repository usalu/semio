//! 🧪️ `change-zone-equipment-heating-capacity` fixture — `⛔️refuses-a-negative`: refuses a negative capacity.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/⛔️refuses-a-negative/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/⛔️refuses-a-negative/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/⛔️refuses-a-negative/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/⛔️refuses-a-negative/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/⛔️refuses-a-negative/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_zone_equipment_heating_capacity(crate::model::EntityId(13), -1.0))
}

fn case() -> Case {
    Case { kind: "change-zone-equipment-heating-capacity", directory: "🧇️change-zone-equipment-heating-capacity/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
