//! 🧪️ `change-outdoor-air-system-economizer-enabled` fixture — `✅️frees-the-cooling`: lets the economizer open.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/✅️frees-the-cooling/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/✅️frees-the-cooling/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/✅️frees-the-cooling/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/✅️frees-the-cooling/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/✅️frees-the-cooling/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_outdoor_air_system_economizer_enabled(crate::model::EntityId(19), true))
}

fn case() -> Case {
    Case {
        kind: "change-outdoor-air-system-economizer-enabled", directory: "💰️change-outdoor-air-system-economizer-enabled/✅️frees-the-cooling", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
