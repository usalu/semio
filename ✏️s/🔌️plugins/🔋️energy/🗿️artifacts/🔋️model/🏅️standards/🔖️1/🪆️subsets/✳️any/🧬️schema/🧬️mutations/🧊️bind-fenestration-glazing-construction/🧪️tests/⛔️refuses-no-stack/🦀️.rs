//! 🧪️ `bind-fenestration-glazing-construction` fixture — `⛔️refuses-no-stack`: refuses an absent construction.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/⛔️refuses-no-stack/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/⛔️refuses-no-stack/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/⛔️refuses-no-stack/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/⛔️refuses-no-stack/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/⛔️refuses-no-stack/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::bind_fenestration_glazing_construction(crate::model::EntityId(5), crate::model::EntityId(9)))
}

fn case() -> Case {
    Case { kind: "bind-fenestration-glazing-construction", directory: "🧊️bind-fenestration-glazing-construction/⛔️refuses-no-stack", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
