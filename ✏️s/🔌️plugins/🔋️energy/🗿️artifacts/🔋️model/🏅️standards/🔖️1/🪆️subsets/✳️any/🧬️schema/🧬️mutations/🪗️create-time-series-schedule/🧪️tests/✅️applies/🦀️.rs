...
fn case() -> Case {
    Case { kind: "create-time-series-schedule", directory: "🪗️create-time-series-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
