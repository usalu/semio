//! 🧪️ `remove-thermal-enclosure-zone` fixture — `✅️applies`: moves thermal enclosure 220's membership.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔓️remove-thermal-enclosure-zone/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::remove_thermal_enclosure_zone(crate::model::EntityId(220), crate::model::EntityId(1)))
}

fn case() -> Case {
    Case { kind: "remove-thermal-enclosure-zone", directory: "🔓️remove-thermal-enclosure-zone/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
