...
fn case() -> Case {
    Case { kind: "rename-space-list", directory: "🪶️rename-space-list/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
