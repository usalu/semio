...
fn case() -> Case {
    Case { kind: "create-constant-schedule", directory: "🕜️create-constant-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
