//! 🧪️ `disconnect-referenced-model` fixture — `⛔️refuses-when-absent`: refuses when nothing is connected.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-referenced-model/⛔️refuses-when-absent/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-referenced-model/⛔️refuses-when-absent/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-referenced-model/⛔️refuses-when-absent/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-referenced-model/⛔️refuses-when-absent/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-referenced-model/⛔️refuses-when-absent/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "disconnect-referenced-model", directory: "✂️disconnect-referenced-model/⛔️refuses-when-absent", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
