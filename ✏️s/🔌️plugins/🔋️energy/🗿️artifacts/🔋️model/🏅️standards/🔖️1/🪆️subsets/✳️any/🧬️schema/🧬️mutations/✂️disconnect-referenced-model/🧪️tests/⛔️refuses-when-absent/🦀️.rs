...
fn case() -> Case {
    Case { kind: "disconnect-referenced-model", directory: "✂️disconnect-referenced-model/🧪️tests/⛔️refuses-when-absent", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
