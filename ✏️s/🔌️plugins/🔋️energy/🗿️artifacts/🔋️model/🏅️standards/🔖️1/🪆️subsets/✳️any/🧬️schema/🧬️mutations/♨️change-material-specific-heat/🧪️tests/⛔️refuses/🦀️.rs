...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/⛔️refuses/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-material-specific-heat", directory: "♨️change-material-specific-heat/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
