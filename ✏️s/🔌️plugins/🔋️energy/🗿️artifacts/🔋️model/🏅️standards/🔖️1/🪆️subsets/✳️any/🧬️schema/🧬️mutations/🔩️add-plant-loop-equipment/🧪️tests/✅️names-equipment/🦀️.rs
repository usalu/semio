...
fn case() -> Case {
    Case { kind: "add-plant-loop-equipment", directory: "🔩️add-plant-loop-equipment/🧪️tests/✅️names-equipment", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
