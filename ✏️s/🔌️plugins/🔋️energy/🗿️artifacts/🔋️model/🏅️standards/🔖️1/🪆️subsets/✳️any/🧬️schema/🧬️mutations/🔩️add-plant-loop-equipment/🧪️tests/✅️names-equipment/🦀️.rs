//! 🧪️ `add-plant-loop-equipment` fixture — `✅️names-equipment`: puts one plant equipment id on the loop.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/✅️names-equipment/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/✅️names-equipment/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/✅️names-equipment/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/✅️names-equipment/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔩️add-plant-loop-equipment/✅️names-equipment/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "add-plant-loop-equipment", directory: "🔩️add-plant-loop-equipment/✅️names-equipment", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
