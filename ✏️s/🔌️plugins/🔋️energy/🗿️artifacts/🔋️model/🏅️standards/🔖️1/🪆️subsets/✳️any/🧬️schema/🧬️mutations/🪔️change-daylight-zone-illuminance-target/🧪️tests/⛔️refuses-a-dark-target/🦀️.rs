//! 🧪️ `change-daylight-zone-illuminance-target` fixture — `⛔️refuses-a-dark-target`: refuses a zero illuminance target.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/⛔️refuses-a-dark-target/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/⛔️refuses-a-dark-target/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/⛔️refuses-a-dark-target/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/⛔️refuses-a-dark-target/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/⛔️refuses-a-dark-target/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_daylight_zone_illuminance_target(crate::model::EntityId(14), 0.0))
}

fn case() -> Case {
    Case {
        kind: "change-daylight-zone-illuminance-target", directory: "🪔️change-daylight-zone-illuminance-target/⛔️refuses-a-dark-target", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
