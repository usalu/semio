//! 🧪️ `change-air-loop-supply-node` fixture — `✅️repoints-supply`: repoints the supply node.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↗️change-air-loop-supply-node/✅️repoints-supply/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↗️change-air-loop-supply-node/✅️repoints-supply/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↗️change-air-loop-supply-node/✅️repoints-supply/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↗️change-air-loop-supply-node/✅️repoints-supply/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↗️change-air-loop-supply-node/✅️repoints-supply/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_air_loop_supply_node(crate::model::EntityId(17), 5))
}

fn case() -> Case {
    Case { kind: "change-air-loop-supply-node", directory: "↗️change-air-loop-supply-node/✅️repoints-supply", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
