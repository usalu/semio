...
fn case() -> Case {
    Case { kind: "change-air-loop-supply-node", directory: "↗️change-air-loop-supply-node/🧪️tests/✅️repoints-supply", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
