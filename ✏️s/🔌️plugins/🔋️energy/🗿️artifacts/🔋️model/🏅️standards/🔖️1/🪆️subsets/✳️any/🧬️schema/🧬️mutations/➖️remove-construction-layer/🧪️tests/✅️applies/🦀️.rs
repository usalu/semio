...
fn case() -> Case {
    Case { kind: "remove-construction-layer", directory: "➖️remove-construction-layer/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
