//! 🧪️ `remove-air-loop-terminal-zone` fixture — `✅️stops-serving-one`: takes the first zone off the loop.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/✅️stops-serving-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/✅️stops-serving-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/✅️stops-serving-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/✅️stops-serving-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/✅️stops-serving-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::remove_air_loop_terminal_zone(crate::model::EntityId(17), crate::model::EntityId(1)))
}

fn case() -> Case {
    Case { kind: "remove-air-loop-terminal-zone", directory: "🪹️remove-air-loop-terminal-zone/✅️stops-serving-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
