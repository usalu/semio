//! 🧪️ `change-infiltration-flow-per-exterior-area` fixture — `✅️applies`: moves infiltration 50.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-infiltration-flow-per-exterior-area/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_infiltration_flow_per_exterior_area(crate::model::EntityId(50), 0.0003))
}

fn case() -> Case {
    Case { kind: "change-infiltration-flow-per-exterior-area", directory: "🌫️change-infiltration-flow-per-exterior-area/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
