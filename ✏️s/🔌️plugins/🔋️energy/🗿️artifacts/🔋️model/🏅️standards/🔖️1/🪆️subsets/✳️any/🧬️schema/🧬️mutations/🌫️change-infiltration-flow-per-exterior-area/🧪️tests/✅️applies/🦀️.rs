...
fn case() -> Case {
    Case { kind: "change-infiltration-flow-per-exterior-area", directory: "🌫️change-infiltration-flow-per-exterior-area/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
