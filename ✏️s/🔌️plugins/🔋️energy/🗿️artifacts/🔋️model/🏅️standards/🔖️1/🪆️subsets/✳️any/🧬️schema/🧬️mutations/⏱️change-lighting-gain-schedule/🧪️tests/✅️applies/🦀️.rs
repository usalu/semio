...
fn case() -> Case {
    Case { kind: "change-lighting-gain-schedule", directory: "⏱️change-lighting-gain-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
