...
fn case() -> Case {
    Case { kind: "clear-fenestration-glazing-construction", directory: "🫗️clear-fenestration-glazing-construction/🧪️tests/⛔️refuses-empty", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
