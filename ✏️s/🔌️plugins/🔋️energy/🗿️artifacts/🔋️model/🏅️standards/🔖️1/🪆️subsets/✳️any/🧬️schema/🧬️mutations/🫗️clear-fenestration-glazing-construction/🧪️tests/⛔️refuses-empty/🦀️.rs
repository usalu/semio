//! 🧪️ `clear-fenestration-glazing-construction` fixture — `⛔️refuses-empty`: refuses a slot that is already empty.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫗️clear-fenestration-glazing-construction/⛔️refuses-empty/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫗️clear-fenestration-glazing-construction/⛔️refuses-empty/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫗️clear-fenestration-glazing-construction/⛔️refuses-empty/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫗️clear-fenestration-glazing-construction/⛔️refuses-empty/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫗️clear-fenestration-glazing-construction/⛔️refuses-empty/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "clear-fenestration-glazing-construction", directory: "🫗️clear-fenestration-glazing-construction/⛔️refuses-empty", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
