//! 🧪️ `change-glazing-material-thickness` fixture — `⛔️refuses`: refuses a zero thickness.
//!
...
//! (`SEMIO_ENERGY_WRITE_FIXTURES=1 cargo test -p semio-s-artifact-energy-model`), and the ten law
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔷️change-glazing-material-thickness/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔷️change-glazing-material-thickness/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔷️change-glazing-material-thickness/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔷️change-glazing-material-thickness/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔷️change-glazing-material-thickness/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_glazing_material_thickness(crate::model::EntityId(1), 0.0))
}

fn case() -> Case {
    Case { kind: "change-glazing-material-thickness", directory: "🔷️change-glazing-material-thickness/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
