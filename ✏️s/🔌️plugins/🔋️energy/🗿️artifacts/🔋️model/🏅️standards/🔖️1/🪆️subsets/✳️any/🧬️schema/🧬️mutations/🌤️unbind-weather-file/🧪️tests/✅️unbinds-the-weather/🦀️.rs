...
fn case() -> Case {
    Case { kind: "unbind-weather-file", directory: "🌤️unbind-weather-file/🧪️tests/✅️unbinds-the-weather", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
