//! 🧪️ `unbind-weather-file` fixture — `✅️unbinds-the-weather`: unbinds a bound weather file.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/✅️unbinds-the-weather/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/✅️unbinds-the-weather/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/✅️unbinds-the-weather/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/✅️unbinds-the-weather/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌤️unbind-weather-file/✅️unbinds-the-weather/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "unbind-weather-file", directory: "🌤️unbind-weather-file/✅️unbinds-the-weather", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
