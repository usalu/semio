...
fn case() -> Case {
    Case { kind: "change-fault-target-equipment", directory: "🎣️change-fault-target-equipment/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
