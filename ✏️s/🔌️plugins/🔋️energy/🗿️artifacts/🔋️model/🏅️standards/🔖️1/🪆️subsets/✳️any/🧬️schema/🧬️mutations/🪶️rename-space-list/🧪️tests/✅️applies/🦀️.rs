...
fn case() -> Case {
    Case { kind: "rename-space-list", directory: "🪶️rename-space-list/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
