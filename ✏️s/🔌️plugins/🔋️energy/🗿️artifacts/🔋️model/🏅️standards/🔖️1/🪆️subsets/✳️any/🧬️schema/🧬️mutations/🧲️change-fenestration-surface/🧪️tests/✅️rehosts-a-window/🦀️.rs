//! 🧪️ `change-fenestration-surface` fixture — `✅️rehosts-a-window`: rehosts the window on the north wall.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/✅️rehosts-a-window/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/✅️rehosts-a-window/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/✅️rehosts-a-window/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/✅️rehosts-a-window/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧲️change-fenestration-surface/✅️rehosts-a-window/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-fenestration-surface", directory: "🧲️change-fenestration-surface/✅️rehosts-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
