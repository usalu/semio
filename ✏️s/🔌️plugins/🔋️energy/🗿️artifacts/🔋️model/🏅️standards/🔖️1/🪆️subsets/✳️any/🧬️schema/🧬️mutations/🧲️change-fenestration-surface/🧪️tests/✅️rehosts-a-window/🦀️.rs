...
fn case() -> Case {
    Case { kind: "change-fenestration-surface", directory: "🧲️change-fenestration-surface/🧪️tests/✅️rehosts-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
