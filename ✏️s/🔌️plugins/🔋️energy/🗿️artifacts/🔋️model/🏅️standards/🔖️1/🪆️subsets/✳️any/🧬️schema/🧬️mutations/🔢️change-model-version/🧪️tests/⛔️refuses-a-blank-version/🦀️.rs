//! 🧪️ `change-model-version` fixture — `⛔️refuses-a-blank-version`: refuses a blank version.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/⛔️refuses-a-blank-version/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/⛔️refuses-a-blank-version/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/⛔️refuses-a-blank-version/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/⛔️refuses-a-blank-version/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/⛔️refuses-a-blank-version/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-model-version", directory: "🔢️change-model-version/⛔️refuses-a-blank-version", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
