...
fn case() -> Case {
    Case { kind: "create-shading-surface", directory: "🌳️create-shading-surface/🧪️tests/⛔️refuses-a-line", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
