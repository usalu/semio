//! 🧪️ `change-surface-construction` fixture — `✅️swaps-the-wall-stack`: swaps the wall to the heavyweight stack.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧰️change-surface-construction/✅️swaps-the-wall-stack/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧰️change-surface-construction/✅️swaps-the-wall-stack/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧰️change-surface-construction/✅️swaps-the-wall-stack/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧰️change-surface-construction/✅️swaps-the-wall-stack/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧰️change-surface-construction/✅️swaps-the-wall-stack/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-construction", directory: "🧰️change-surface-construction/✅️swaps-the-wall-stack", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
