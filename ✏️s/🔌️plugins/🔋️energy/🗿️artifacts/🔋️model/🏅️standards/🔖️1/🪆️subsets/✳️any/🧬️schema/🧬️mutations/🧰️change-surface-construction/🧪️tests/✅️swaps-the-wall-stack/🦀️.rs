...
fn case() -> Case {
    Case { kind: "change-surface-construction", directory: "🧰️change-surface-construction/🧪️tests/✅️swaps-the-wall-stack", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
