...
fn case() -> Case {
    Case { kind: "change-lighting-gain-radiant-fraction", directory: "🌟️change-lighting-gain-radiant-fraction/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
