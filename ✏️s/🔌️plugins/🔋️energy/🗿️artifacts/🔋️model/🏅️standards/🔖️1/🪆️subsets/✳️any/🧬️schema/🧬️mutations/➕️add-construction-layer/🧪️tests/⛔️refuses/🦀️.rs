...
fn case() -> Case {
    Case { kind: "add-construction-layer", directory: "➕️add-construction-layer/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
