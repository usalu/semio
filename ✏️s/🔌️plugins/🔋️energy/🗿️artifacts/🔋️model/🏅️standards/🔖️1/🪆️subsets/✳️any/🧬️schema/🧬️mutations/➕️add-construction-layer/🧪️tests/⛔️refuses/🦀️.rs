//! 🧪️ `add-construction-layer` fixture — `⛔️refuses`: refuses an undefined material.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-construction-layer/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-construction-layer/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-construction-layer/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-construction-layer/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️add-construction-layer/⛔️refuses/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "add-construction-layer", directory: "➕️add-construction-layer/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
