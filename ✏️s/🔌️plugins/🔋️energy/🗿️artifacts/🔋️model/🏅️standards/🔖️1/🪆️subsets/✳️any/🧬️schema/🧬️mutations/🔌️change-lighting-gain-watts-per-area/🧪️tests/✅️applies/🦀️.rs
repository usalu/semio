//! 🧪️ `change-lighting-gain-watts-per-area` fixture — `✅️applies`: moves lighting gain 30.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️change-lighting-gain-watts-per-area/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️change-lighting-gain-watts-per-area/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️change-lighting-gain-watts-per-area/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️change-lighting-gain-watts-per-area/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️change-lighting-gain-watts-per-area/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_lighting_gain_watts_per_area(crate::model::EntityId(30), 12.5))
}

fn case() -> Case {
    Case { kind: "change-lighting-gain-watts-per-area", directory: "🔌️change-lighting-gain-watts-per-area/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
