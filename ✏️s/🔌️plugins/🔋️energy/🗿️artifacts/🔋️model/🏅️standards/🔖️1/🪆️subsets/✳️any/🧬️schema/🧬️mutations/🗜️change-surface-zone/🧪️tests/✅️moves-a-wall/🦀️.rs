//! 🧪️ `change-surface-zone` fixture — `✅️moves-a-wall`: moves the wall to the second zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-surface-zone/✅️moves-a-wall/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-surface-zone/✅️moves-a-wall/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-surface-zone/✅️moves-a-wall/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-surface-zone/✅️moves-a-wall/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗜️change-surface-zone/✅️moves-a-wall/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-zone", directory: "🗜️change-surface-zone/✅️moves-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
