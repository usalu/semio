...
fn case() -> Case {
    Case { kind: "change-surface-zone", directory: "🗜️change-surface-zone/🧪️tests/✅️moves-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
