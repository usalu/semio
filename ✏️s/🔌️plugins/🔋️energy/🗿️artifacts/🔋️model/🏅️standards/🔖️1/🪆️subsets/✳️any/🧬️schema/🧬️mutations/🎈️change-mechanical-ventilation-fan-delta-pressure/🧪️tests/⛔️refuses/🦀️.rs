//! 🧪️ `change-mechanical-ventilation-fan-delta-pressure` fixture — `⛔️refuses`: refuses fan pressure rise (Pa) outside a finite non-negative value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎈️change-mechanical-ventilation-fan-delta-pressure/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎈️change-mechanical-ventilation-fan-delta-pressure/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎈️change-mechanical-ventilation-fan-delta-pressure/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎈️change-mechanical-ventilation-fan-delta-pressure/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎈️change-mechanical-ventilation-fan-delta-pressure/⛔️refuses/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case {
        kind: "change-mechanical-ventilation-fan-delta-pressure", directory: "🎈️change-mechanical-ventilation-fan-delta-pressure/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
