//! 🧪️ `change-weekly-schedule-day` fixture — `✅️applies`: re-points Tuesday at another profile.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕗️change-weekly-schedule-day/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕗️change-weekly-schedule-day/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕗️change-weekly-schedule-day/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕗️change-weekly-schedule-day/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕗️change-weekly-schedule-day/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-weekly-schedule-day", directory: "🕗️change-weekly-schedule-day/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
