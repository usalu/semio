//! 🧪️ `change-air-loop-return-node` fixture — `✅️repoints-return`: repoints the return node.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↘️change-air-loop-return-node/✅️repoints-return/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↘️change-air-loop-return-node/✅️repoints-return/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↘️change-air-loop-return-node/✅️repoints-return/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↘️change-air-loop-return-node/✅️repoints-return/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↘️change-air-loop-return-node/✅️repoints-return/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_air_loop_return_node(crate::model::EntityId(17), 6))
}

fn case() -> Case {
    Case { kind: "change-air-loop-return-node", directory: "↘️change-air-loop-return-node/✅️repoints-return", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
