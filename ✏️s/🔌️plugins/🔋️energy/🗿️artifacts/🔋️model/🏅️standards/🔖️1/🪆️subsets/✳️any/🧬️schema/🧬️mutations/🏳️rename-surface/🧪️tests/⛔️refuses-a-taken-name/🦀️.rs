//! 🧪️ `rename-surface` fixture — `⛔️refuses-a-taken-name`: refuses a name another surface holds.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/⛔️refuses-a-taken-name/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/⛔️refuses-a-taken-name/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/⛔️refuses-a-taken-name/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/⛔️refuses-a-taken-name/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏳️rename-surface/⛔️refuses-a-taken-name/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "rename-surface", directory: "🏳️rename-surface/⛔️refuses-a-taken-name", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
