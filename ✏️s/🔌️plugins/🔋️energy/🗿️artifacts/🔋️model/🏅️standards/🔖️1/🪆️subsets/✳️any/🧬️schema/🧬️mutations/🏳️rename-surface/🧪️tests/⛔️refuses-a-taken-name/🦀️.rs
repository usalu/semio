...
fn case() -> Case {
    Case { kind: "rename-surface", directory: "🏳️rename-surface/🧪️tests/⛔️refuses-a-taken-name", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
