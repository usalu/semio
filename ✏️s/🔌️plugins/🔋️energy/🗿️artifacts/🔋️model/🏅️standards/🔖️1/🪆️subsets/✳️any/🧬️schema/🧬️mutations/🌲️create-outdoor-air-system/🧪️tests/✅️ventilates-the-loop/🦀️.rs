//! 🧪️ `create-outdoor-air-system` fixture — `✅️ventilates-the-loop`: puts an outdoor air system on the main loop.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/✅️ventilates-the-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/✅️ventilates-the-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/✅️ventilates-the-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/✅️ventilates-the-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/✅️ventilates-the-loop/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_outdoor_air_system(crate::model::EntityId(19), crate::model::EntityId(17), 0.2, false))
}

fn case() -> Case {
    Case { kind: "create-outdoor-air-system", directory: "🌲️create-outdoor-air-system/✅️ventilates-the-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
