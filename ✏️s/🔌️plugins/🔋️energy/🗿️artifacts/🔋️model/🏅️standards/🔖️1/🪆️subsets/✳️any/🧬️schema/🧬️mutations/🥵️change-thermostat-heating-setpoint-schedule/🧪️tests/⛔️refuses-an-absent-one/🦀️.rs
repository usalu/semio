...
fn case() -> Case {
    Case {
        kind: "change-thermostat-heating-setpoint-schedule", directory: "🥵️change-thermostat-heating-setpoint-schedule/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
