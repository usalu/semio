//! 🧪️ `change-fenestration-fin-depth` fixture — `⛔️refuses-negative-fin`: refuses a negative fin depth.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/⛔️refuses-negative-fin/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/⛔️refuses-negative-fin/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/⛔️refuses-negative-fin/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/⛔️refuses-negative-fin/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/⛔️refuses-negative-fin/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-fenestration-fin-depth", directory: "🐬️change-fenestration-fin-depth/⛔️refuses-negative-fin", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
