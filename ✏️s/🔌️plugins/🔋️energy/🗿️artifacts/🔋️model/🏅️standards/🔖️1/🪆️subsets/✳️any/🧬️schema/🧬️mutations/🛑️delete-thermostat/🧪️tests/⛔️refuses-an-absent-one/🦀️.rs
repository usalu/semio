...
fn case() -> Case {
    Case { kind: "delete-thermostat", directory: "🛑️delete-thermostat/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
