//! 🧪️ `create-lighting-gain` fixture — `⛔️refuses`: refuses an id the model already carries.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💡️create-lighting-gain/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💡️create-lighting-gain/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💡️create-lighting-gain/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💡️create-lighting-gain/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💡️create-lighting-gain/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_lighting_gain(1, crate::model::EntityId(30), crate::model::EntityId(2), crate::model::ScheduleId(1), 8.0, 0.6, 0.2, 0.0))
}

fn case() -> Case {
    Case { kind: "create-lighting-gain", directory: "💡️create-lighting-gain/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
