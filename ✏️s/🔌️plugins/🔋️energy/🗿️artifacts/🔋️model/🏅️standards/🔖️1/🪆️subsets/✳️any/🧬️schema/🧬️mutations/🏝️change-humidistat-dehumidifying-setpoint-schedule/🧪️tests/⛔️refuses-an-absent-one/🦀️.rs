...
fn case() -> Case {
    Case { kind: "change-humidistat-dehumidifying-setpoint-schedule", directory: "🏝️change-humidistat-dehumidifying-setpoint-schedule/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
