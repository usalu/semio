...
fn case() -> Case {
    Case { kind: "rename-zone", directory: "🏠️rename-zone/🧪️tests/⛔️refuses-a-missing-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
