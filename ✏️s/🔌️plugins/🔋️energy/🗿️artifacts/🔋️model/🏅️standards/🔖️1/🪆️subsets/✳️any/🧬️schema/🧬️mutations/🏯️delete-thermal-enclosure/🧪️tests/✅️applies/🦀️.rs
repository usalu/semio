...
fn case() -> Case {
    Case { kind: "delete-thermal-enclosure", directory: "🏯️delete-thermal-enclosure/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
