//! 🧪️ `change-people-gain-radiant-fraction` fixture — `✅️applies`: moves people gain 20.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📡️change-people-gain-radiant-fraction/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📡️change-people-gain-radiant-fraction/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📡️change-people-gain-radiant-fraction/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📡️change-people-gain-radiant-fraction/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📡️change-people-gain-radiant-fraction/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_people_gain_radiant_fraction(crate::model::EntityId(20), 0.5))
}

fn case() -> Case {
    Case { kind: "change-people-gain-radiant-fraction", directory: "📡️change-people-gain-radiant-fraction/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
