...
fn case() -> Case {
    Case { kind: "change-people-gain-radiant-fraction", directory: "📡️change-people-gain-radiant-fraction/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
