//! 🧪️ `change-surface-class` fixture — `⛔️refuses-a-missing-one`: refuses an absent surface.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/⛔️refuses-a-missing-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/⛔️refuses-a-missing-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/⛔️refuses-a-missing-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/⛔️refuses-a-missing-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧩️change-surface-class/⛔️refuses-a-missing-one/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-class", directory: "🧩️change-surface-class/⛔️refuses-a-missing-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
