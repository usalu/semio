...
fn case() -> Case {
    Case { kind: "change-surface-class", directory: "🧩️change-surface-class/🧪️tests/⛔️refuses-a-missing-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
