...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeInfiltrationMethod {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Infiltration Method of infiltration {}", self.id.0), &format!("Infiltrationsmethode von Infiltration {} ändern", self.id.0))
    }
