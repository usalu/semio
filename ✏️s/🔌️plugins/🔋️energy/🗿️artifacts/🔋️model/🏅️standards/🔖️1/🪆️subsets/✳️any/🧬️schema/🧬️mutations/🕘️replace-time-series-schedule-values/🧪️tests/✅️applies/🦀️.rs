...
fn case() -> Case {
    Case { kind: "replace-time-series-schedule-values", directory: "🕘️replace-time-series-schedule-values/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
