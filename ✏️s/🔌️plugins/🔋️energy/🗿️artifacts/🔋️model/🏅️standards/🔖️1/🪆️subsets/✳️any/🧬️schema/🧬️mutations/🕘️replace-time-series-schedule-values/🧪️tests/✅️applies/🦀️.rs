//! 🧪️ `replace-time-series-schedule-values` fixture — `✅️applies`: moves time series schedule 40.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕘️replace-time-series-schedule-values/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕘️replace-time-series-schedule-values/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕘️replace-time-series-schedule-values/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕘️replace-time-series-schedule-values/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕘️replace-time-series-schedule-values/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::replace_time_series_schedule_values(crate::model::ScheduleId(40), vec![1.0, 0.8, 0.6, 0.4]))
}

fn case() -> Case {
    Case { kind: "replace-time-series-schedule-values", directory: "🕘️replace-time-series-schedule-values/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
