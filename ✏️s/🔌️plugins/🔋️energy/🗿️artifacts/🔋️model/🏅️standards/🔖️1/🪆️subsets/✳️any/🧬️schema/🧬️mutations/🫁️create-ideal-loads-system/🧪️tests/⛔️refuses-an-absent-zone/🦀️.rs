//! 🧪️ `create-ideal-loads-system` fixture — `⛔️refuses-an-absent-zone`: refuses an ideal loads system on an absent zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/⛔️refuses-an-absent-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/⛔️refuses-an-absent-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/⛔️refuses-an-absent-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/⛔️refuses-an-absent-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫁️create-ideal-loads-system/⛔️refuses-an-absent-zone/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_ideal_loads_system(crate::model::EntityId(12), crate::model::EntityId(99), 50.0, 13.0, false, 0.0, false, 0.0, 0.0, 0.0))
}

fn case() -> Case {
    Case { kind: "create-ideal-loads-system", directory: "🫁️create-ideal-loads-system/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
