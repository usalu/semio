...
fn case() -> Case {
    Case { kind: "create-ideal-loads-system", directory: "🫁️create-ideal-loads-system/🧪️tests/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
