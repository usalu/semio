//! 🧪️ `remove-annual-schedule-rule` fixture — `✅️applies`: drops the first-half-year rule.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📙️remove-annual-schedule-rule/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📙️remove-annual-schedule-rule/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📙️remove-annual-schedule-rule/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📙️remove-annual-schedule-rule/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📙️remove-annual-schedule-rule/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "remove-annual-schedule-rule", directory: "📙️remove-annual-schedule-rule/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
