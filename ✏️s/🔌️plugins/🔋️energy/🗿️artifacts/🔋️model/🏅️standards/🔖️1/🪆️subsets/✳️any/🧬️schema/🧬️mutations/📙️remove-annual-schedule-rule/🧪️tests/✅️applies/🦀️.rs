...
fn case() -> Case {
    Case { kind: "remove-annual-schedule-rule", directory: "📙️remove-annual-schedule-rule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
