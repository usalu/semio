...
fn case() -> Case {
    Case { kind: "delete-people-gain", directory: "🚷️delete-people-gain/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
