//! 🧪️ `change-fenestration-vlt` fixture — `✅️dims-the-daylight`: moves to the EnergyPlus simple-glazing VT.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/✅️dims-the-daylight/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/✅️dims-the-daylight/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/✅️dims-the-daylight/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/✅️dims-the-daylight/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/✅️dims-the-daylight/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_vlt(crate::model::EntityId(5), 0.84))
}

fn case() -> Case {
    Case { kind: "change-fenestration-vlt", directory: "🌈️change-fenestration-vlt/✅️dims-the-daylight", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
