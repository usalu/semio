...
fn case() -> Case {
    Case { kind: "change-fenestration-vlt", directory: "🌈️change-fenestration-vlt/🧪️tests/✅️dims-the-daylight", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
