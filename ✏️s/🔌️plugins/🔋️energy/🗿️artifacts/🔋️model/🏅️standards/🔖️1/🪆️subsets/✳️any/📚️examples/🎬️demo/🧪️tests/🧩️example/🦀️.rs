...
async fn inference_default_law() {
    use protocol::Inference;
    assert_eq!(crate::standards::v1::subsets::any::schema::inferences::EnergyModelInference::infer(&crate::EnergyModelSnapshot::default()), crate::standards::v1::subsets::any::schema::inferences::EnergyModelInference::default(),);
}
