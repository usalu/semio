//! 🧪️ `change-outdoor-air-system-air-loop` fixture — `✅️moves-to-the-spare`: moves the system to the spare loop.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/✅️moves-to-the-spare/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/✅️moves-to-the-spare/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/✅️moves-to-the-spare/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/✅️moves-to-the-spare/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛓️change-outdoor-air-system-air-loop/✅️moves-to-the-spare/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_outdoor_air_system_air_loop(crate::model::EntityId(19), crate::model::EntityId(20)))
}

fn case() -> Case {
    Case { kind: "change-outdoor-air-system-air-loop", directory: "⛓️change-outdoor-air-system-air-loop/✅️moves-to-the-spare", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
