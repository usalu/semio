...
fn case() -> Case {
    Case { kind: "change-outdoor-air-system-air-loop", directory: "⛓️change-outdoor-air-system-air-loop/🧪️tests/✅️moves-to-the-spare", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
