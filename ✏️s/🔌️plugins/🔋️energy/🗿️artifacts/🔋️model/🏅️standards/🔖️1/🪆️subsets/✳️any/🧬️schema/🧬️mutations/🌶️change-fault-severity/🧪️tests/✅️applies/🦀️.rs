...
fn case() -> Case {
    Case { kind: "change-fault-severity", directory: "🌶️change-fault-severity/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
