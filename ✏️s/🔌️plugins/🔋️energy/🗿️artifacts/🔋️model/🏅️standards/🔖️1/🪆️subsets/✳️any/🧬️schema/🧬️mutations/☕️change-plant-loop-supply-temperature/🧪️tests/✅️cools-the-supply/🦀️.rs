...
fn case() -> Case {
    Case { kind: "change-plant-loop-supply-temperature", directory: "☕️change-plant-loop-supply-temperature/🧪️tests/✅️cools-the-supply", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
