...
fn case() -> Case {
    Case { kind: "change-ideal-loads-system-max-cooling-capacity", directory: "🟧️change-ideal-loads-system-max-cooling-capacity/🧪️tests/✅️caps-the-cooling", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
