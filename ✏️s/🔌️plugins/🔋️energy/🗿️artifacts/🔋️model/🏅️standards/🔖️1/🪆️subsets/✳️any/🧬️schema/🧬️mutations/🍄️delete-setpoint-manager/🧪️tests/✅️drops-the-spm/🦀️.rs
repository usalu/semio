//! 🧪️ `delete-setpoint-manager` fixture — `✅️drops-the-spm`: drops the supply setpoint manager.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍄️delete-setpoint-manager/✅️drops-the-spm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍄️delete-setpoint-manager/✅️drops-the-spm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍄️delete-setpoint-manager/✅️drops-the-spm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍄️delete-setpoint-manager/✅️drops-the-spm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍄️delete-setpoint-manager/✅️drops-the-spm/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_setpoint_manager(crate::model::EntityId(16)))
}

fn case() -> Case {
    Case { kind: "delete-setpoint-manager", directory: "🍄️delete-setpoint-manager/✅️drops-the-spm", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
