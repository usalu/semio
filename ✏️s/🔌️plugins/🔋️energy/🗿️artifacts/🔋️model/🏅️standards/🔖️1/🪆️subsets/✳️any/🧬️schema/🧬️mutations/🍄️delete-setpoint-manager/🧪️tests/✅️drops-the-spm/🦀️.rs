...
fn case() -> Case {
    Case { kind: "delete-setpoint-manager", directory: "🍄️delete-setpoint-manager/🧪️tests/✅️drops-the-spm", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
