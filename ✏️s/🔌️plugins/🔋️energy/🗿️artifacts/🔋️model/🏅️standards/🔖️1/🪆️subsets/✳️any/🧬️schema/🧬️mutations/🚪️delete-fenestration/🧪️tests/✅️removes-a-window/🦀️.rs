...
fn case() -> Case {
    Case { kind: "delete-fenestration", directory: "🚪️delete-fenestration/🧪️tests/✅️removes-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
