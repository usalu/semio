//! 🧪️ `delete-fenestration` fixture — `✅️removes-a-window`: removes the south window.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/✅️removes-a-window/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/✅️removes-a-window/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/✅️removes-a-window/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/✅️removes-a-window/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/✅️removes-a-window/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_fenestration(crate::model::EntityId(5)))
}

fn case() -> Case {
    Case { kind: "delete-fenestration", directory: "🚪️delete-fenestration/✅️removes-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
