...
fn case() -> Case {
    Case { kind: "change-fenestration-fin-offset", directory: "🐋️change-fenestration-fin-offset/🧪️tests/✅️spreads-the-fins", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
