...
fn case() -> Case {
    Case { kind: "delete-surface", directory: "🪚️delete-surface/🧪️tests/✅️cascades-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
