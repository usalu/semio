//! 🧪️ `replace-daily-schedule-hourly-values` fixture — `✅️applies`: moves daily schedule 10.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕔️replace-daily-schedule-hourly-values/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕔️replace-daily-schedule-hourly-values/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕔️replace-daily-schedule-hourly-values/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕔️replace-daily-schedule-hourly-values/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕔️replace-daily-schedule-hourly-values/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::replace_daily_schedule_hourly_values(crate::model::ScheduleId(10), vec![22.0; 24]))
}

fn case() -> Case {
    Case { kind: "replace-daily-schedule-hourly-values", directory: "🕔️replace-daily-schedule-hourly-values/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
