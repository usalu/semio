//! 🧪️ `create-zone-equipment` fixture — `⛔️refuses-rank-zero`: refuses an equipment rank of zero.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/⛔️refuses-rank-zero/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/⛔️refuses-rank-zero/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/⛔️refuses-rank-zero/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/⛔️refuses-rank-zero/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/⛔️refuses-rank-zero/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-zone-equipment", directory: "🛠️create-zone-equipment/⛔️refuses-rank-zero", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
