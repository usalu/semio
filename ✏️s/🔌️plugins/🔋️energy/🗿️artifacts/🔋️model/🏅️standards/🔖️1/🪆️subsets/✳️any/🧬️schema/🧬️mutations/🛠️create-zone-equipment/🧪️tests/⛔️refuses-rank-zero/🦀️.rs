...
fn case() -> Case {
    Case { kind: "create-zone-equipment", directory: "🛠️create-zone-equipment/🧪️tests/⛔️refuses-rank-zero", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
