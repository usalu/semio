//! 🧪️ `change-zone-equipment-heating-capacity` fixture — `✅️uprates-heating`: uprates the heating capacity.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/✅️uprates-heating/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/✅️uprates-heating/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/✅️uprates-heating/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/✅️uprates-heating/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧇️change-zone-equipment-heating-capacity/✅️uprates-heating/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_zone_equipment_heating_capacity(crate::model::EntityId(13), 3000.0))
}

fn case() -> Case {
    Case { kind: "change-zone-equipment-heating-capacity", directory: "🧇️change-zone-equipment-heating-capacity/✅️uprates-heating", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
