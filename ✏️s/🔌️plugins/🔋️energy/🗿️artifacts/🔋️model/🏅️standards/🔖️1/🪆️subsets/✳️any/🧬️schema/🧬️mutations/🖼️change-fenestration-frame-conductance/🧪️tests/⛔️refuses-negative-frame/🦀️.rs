//! 🧪️ `change-fenestration-frame-conductance` fixture — `⛔️refuses-negative-frame`: refuses a negative frame conductance.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/⛔️refuses-negative-frame/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/⛔️refuses-negative-frame/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/⛔️refuses-negative-frame/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/⛔️refuses-negative-frame/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/⛔️refuses-negative-frame/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_frame_conductance(crate::model::EntityId(5), -1.0))
}

fn case() -> Case {
    Case { kind: "change-fenestration-frame-conductance", directory: "🖼️change-fenestration-frame-conductance/⛔️refuses-negative-frame", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
