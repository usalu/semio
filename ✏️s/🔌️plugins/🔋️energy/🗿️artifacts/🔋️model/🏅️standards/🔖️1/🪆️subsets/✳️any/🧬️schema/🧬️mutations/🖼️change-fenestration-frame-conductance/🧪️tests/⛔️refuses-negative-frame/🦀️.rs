...
fn case() -> Case {
    Case { kind: "change-fenestration-frame-conductance", directory: "🖼️change-fenestration-frame-conductance/🧪️tests/⛔️refuses-negative-frame", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
