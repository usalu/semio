...
fn case() -> Case {
    Case { kind: "delete-shading-surface", directory: "🪵️delete-shading-surface/🧪️tests/⛔️refuses-a-missing-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
