//! 🧪️ `insert-annual-schedule-rule` fixture — `✅️applies`: adds a second-half-year rule.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📗️insert-annual-schedule-rule/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📗️insert-annual-schedule-rule/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📗️insert-annual-schedule-rule/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📗️insert-annual-schedule-rule/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📗️insert-annual-schedule-rule/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "insert-annual-schedule-rule", directory: "📗️insert-annual-schedule-rule/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
