//! 🧪️ `change-thermostat-heating-throttle-range` fixture — `✅️widens-heating-band`: widens the heating throttle band.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-thermostat-heating-throttle-range/✅️widens-heating-band/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-thermostat-heating-throttle-range/✅️widens-heating-band/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-thermostat-heating-throttle-range/✅️widens-heating-band/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-thermostat-heating-throttle-range/✅️widens-heating-band/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-thermostat-heating-throttle-range/✅️widens-heating-band/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_thermostat_heating_throttle_range(crate::model::EntityId(10), 2.0))
}

fn case() -> Case {
    Case {
        kind: "change-thermostat-heating-throttle-range", directory: "🎚️change-thermostat-heating-throttle-range/✅️widens-heating-band", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
