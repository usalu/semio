...
fn case() -> Case {
    Case { kind: "change-thermostat-heating-throttle-range", directory: "🎚️change-thermostat-heating-throttle-range/🧪️tests/✅️widens-heating-band", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
