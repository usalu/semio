...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeSurfaceZone {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Move surface {} to zone {}", self.id.0, self.new_zone_id.0), &format!("Oberfläche {} nach Zone {} verschieben", self.id.0, self.new_zone_id.0))
    }
