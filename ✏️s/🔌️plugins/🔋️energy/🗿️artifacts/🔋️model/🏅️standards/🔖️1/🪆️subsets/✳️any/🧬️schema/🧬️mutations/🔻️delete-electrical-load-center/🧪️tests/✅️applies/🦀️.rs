...
fn case() -> Case {
    Case { kind: "delete-electrical-load-center", directory: "🔻️delete-electrical-load-center/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
