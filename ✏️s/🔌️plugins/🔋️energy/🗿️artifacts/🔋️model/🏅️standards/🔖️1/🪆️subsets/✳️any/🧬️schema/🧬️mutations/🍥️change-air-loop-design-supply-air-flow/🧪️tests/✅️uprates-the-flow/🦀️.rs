...
fn case() -> Case {
    Case { kind: "change-air-loop-design-supply-air-flow", directory: "🍥️change-air-loop-design-supply-air-flow/🧪️tests/✅️uprates-the-flow", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
