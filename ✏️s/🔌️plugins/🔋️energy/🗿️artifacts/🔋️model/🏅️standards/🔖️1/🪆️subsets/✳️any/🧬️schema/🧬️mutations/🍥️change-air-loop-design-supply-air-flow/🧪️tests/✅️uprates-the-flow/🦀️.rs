//! 🧪️ `change-air-loop-design-supply-air-flow` fixture — `✅️uprates-the-flow`: uprates the design supply air flow.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍥️change-air-loop-design-supply-air-flow/✅️uprates-the-flow/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍥️change-air-loop-design-supply-air-flow/✅️uprates-the-flow/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍥️change-air-loop-design-supply-air-flow/✅️uprates-the-flow/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍥️change-air-loop-design-supply-air-flow/✅️uprates-the-flow/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍥️change-air-loop-design-supply-air-flow/✅️uprates-the-flow/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_air_loop_design_supply_air_flow(crate::model::EntityId(17), 1.6))
}

fn case() -> Case {
    Case { kind: "change-air-loop-design-supply-air-flow", directory: "🍥️change-air-loop-design-supply-air-flow/✅️uprates-the-flow", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
