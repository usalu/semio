...
fn case() -> Case {
    Case { kind: "create-shw-system", directory: "🛀️create-shw-system/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
