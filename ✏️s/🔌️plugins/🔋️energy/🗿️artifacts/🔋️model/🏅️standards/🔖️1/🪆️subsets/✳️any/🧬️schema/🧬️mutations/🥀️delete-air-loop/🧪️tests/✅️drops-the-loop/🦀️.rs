//! 🧪️ `delete-air-loop` fixture — `✅️drops-the-loop`: drops the main air loop.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/✅️drops-the-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/✅️drops-the-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/✅️drops-the-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/✅️drops-the-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥀️delete-air-loop/✅️drops-the-loop/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_air_loop(crate::model::EntityId(17)))
}

fn case() -> Case {
    Case { kind: "delete-air-loop", directory: "🥀️delete-air-loop/✅️drops-the-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
