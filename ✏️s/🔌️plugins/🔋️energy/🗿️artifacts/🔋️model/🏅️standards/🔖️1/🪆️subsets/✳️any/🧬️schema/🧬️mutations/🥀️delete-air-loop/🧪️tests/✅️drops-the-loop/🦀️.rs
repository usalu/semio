...
fn case() -> Case {
    Case { kind: "delete-air-loop", directory: "🥀️delete-air-loop/🧪️tests/✅️drops-the-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
