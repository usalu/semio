...
fn case() -> Case {
    Case { kind: "change-infiltration-discharge-coefficient", directory: "🚰️change-infiltration-discharge-coefficient/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
