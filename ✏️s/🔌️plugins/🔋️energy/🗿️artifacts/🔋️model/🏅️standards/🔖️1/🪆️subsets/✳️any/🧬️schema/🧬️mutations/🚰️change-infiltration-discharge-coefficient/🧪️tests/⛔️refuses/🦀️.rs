//! 🧪️ `change-infiltration-discharge-coefficient` fixture — `⛔️refuses`: refuses the orifice discharge coefficient outside a positive finite value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚰️change-infiltration-discharge-coefficient/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚰️change-infiltration-discharge-coefficient/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚰️change-infiltration-discharge-coefficient/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚰️change-infiltration-discharge-coefficient/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚰️change-infiltration-discharge-coefficient/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_infiltration_discharge_coefficient(crate::model::EntityId(50), 0.0))
}

fn case() -> Case {
    Case { kind: "change-infiltration-discharge-coefficient", directory: "🚰️change-infiltration-discharge-coefficient/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
