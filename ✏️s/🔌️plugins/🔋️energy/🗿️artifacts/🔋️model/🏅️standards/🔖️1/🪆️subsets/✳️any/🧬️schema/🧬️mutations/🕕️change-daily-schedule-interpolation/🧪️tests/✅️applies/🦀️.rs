//! 🧪️ `change-daily-schedule-interpolation` fixture — `✅️applies`: moves daily schedule 10.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕕️change-daily-schedule-interpolation/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_daily_schedule_interpolation(crate::model::ScheduleId(10), crate::schedule::ScheduleInterpolation::Discrete))
}

fn case() -> Case {
    Case { kind: "change-daily-schedule-interpolation", directory: "🕕️change-daily-schedule-interpolation/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
