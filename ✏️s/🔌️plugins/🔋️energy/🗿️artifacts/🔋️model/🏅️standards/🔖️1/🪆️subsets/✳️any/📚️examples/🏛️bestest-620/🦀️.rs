//! 🏛️ ANSI/ASHRAE 140 §5.2 case 620 as a bundled energy-model example.
//!
...
/// @emoji 🪪 Example id.
pub const ID: &str = "bestest-620";

/// @emoji 🏷️ Example label.
pub const LABEL_EN: &str = "BESTEST 620";

/// @emoji 🏛️ The ANSI/ASHRAE 140 §5.2 case id this example carries.
pub const CASE: &str = "620";

/// @emoji 🏗️ This example's model.
pub fn model() -> crate::model::Model {
    crate::bestest::model(CASE).expect("ANSI/ASHRAE 140 §5.2 case 620 is registered")
}
