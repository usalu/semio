...
fn case() -> Case {
    Case { kind: "remove-electrical-load-center-battery", directory: "🪝️remove-electrical-load-center-battery/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
