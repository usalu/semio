//! 🧪️ `remove-electrical-load-center-battery` fixture — `✅️applies`: moves electrical load center 321's membership.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪝️remove-electrical-load-center-battery/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::remove_electrical_load_center_battery(crate::model::EntityId(321), crate::model::EntityId(310)))
}

fn case() -> Case {
    Case { kind: "remove-electrical-load-center-battery", directory: "🪝️remove-electrical-load-center-battery/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
