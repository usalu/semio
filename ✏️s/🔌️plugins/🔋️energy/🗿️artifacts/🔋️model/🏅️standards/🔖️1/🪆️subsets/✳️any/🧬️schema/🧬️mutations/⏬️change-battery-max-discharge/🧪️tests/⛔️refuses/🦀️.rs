...
fn case() -> Case {
    Case { kind: "change-battery-max-discharge", directory: "⏬️change-battery-max-discharge/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
