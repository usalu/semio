//! 🏛️ ANSI/ASHRAE 140 §5.2 case 600FF as a bundled energy-model example.
//!
...
/// @emoji 🪪 Example id.
pub const ID: &str = "bestest-600ff";

/// @emoji 🏷️ Example label.
pub const LABEL_EN: &str = "BESTEST 600FF";

/// @emoji 🏛️ The ANSI/ASHRAE 140 §5.2 case id this example carries.
pub const CASE: &str = "600FF";

/// @emoji 🏗️ This example's model.
pub fn model() -> crate::model::Model {
    crate::bestest::model(CASE).expect("ANSI/ASHRAE 140 §5.2 case 600FF is registered")
}
