...
fn case() -> Case {
    Case { kind: "remove-space-list-member", directory: "🪤️remove-space-list-member/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
