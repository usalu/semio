//! 🧪️ `create-infiltration` fixture — `⛔️refuses`: refuses an id the model already carries.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💨️create-infiltration/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💨️create-infiltration/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💨️create-infiltration/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💨️create-infiltration/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💨️create-infiltration/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_infiltration(1, crate::model::EntityId(50), crate::model::EntityId(2), crate::model::ScheduleId(1), crate::air_exchange::InfiltrationMethod::ScheduledAch, 0.5, 0.0, 0.0, 1.0, 2.7, 1.0, 0.0, 0.0, 0.0))
}

fn case() -> Case {
    Case { kind: "create-infiltration", directory: "💨️create-infiltration/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
