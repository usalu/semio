...
fn case() -> Case {
    Case { kind: "create-infiltration", directory: "💨️create-infiltration/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
