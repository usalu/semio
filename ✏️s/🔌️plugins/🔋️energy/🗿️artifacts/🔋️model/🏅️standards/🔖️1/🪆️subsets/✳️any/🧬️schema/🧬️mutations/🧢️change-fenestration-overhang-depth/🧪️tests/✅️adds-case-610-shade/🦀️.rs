//! 🧪️ `change-fenestration-overhang-depth` fixture — `✅️adds-case-610-shade`: adds case 610's one-metre overhang.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/✅️adds-case-610-shade/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/✅️adds-case-610-shade/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/✅️adds-case-610-shade/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/✅️adds-case-610-shade/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/✅️adds-case-610-shade/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_overhang_depth(crate::model::EntityId(5), 1.0))
}

fn case() -> Case {
    Case { kind: "change-fenestration-overhang-depth", directory: "🧢️change-fenestration-overhang-depth/✅️adds-case-610-shade", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
