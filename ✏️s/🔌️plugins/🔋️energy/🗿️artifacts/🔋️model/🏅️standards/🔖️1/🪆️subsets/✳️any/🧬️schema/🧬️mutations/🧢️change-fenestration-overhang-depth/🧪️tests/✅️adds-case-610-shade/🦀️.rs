...
fn case() -> Case {
    Case { kind: "change-fenestration-overhang-depth", directory: "🧢️change-fenestration-overhang-depth/🧪️tests/✅️adds-case-610-shade", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
