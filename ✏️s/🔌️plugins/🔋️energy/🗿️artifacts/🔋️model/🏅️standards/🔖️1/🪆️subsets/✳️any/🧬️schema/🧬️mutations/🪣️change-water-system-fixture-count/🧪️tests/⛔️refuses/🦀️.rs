...
fn case() -> Case {
    Case { kind: "change-water-system-fixture-count", directory: "🪣️change-water-system-fixture-count/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
