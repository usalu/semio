...
fn case() -> Case {
    Case { kind: "create-construction", directory: "🏗️create-construction/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
