//! 🧪️ `change-annual-schedule-holiday-daily-schedule` fixture — `⛔️refuses`: refuses a holiday profile the document does not define.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_annual_schedule_holiday_daily_schedule(crate::model::ScheduleId(30), Some(crate::model::ScheduleId(99))))
}

fn case() -> Case {
    Case { kind: "change-annual-schedule-holiday-daily-schedule", directory: "🎄️change-annual-schedule-holiday-daily-schedule/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
