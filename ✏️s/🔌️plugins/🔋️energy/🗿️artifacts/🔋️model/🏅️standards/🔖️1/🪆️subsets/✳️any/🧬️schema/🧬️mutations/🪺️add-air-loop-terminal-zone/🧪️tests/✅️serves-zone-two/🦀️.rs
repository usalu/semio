...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/✅️serves-zone-two/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/✅️serves-zone-two/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/✅️serves-zone-two/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/✅️serves-zone-two/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/✅️serves-zone-two/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "add-air-loop-terminal-zone", directory: "🪺️add-air-loop-terminal-zone/✅️serves-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
