...
fn case() -> Case {
    Case { kind: "remove-plant-loop-equipment", directory: "⚙️remove-plant-loop-equipment/🧪️tests/✅️drops-equipment", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
