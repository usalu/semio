...
fn case() -> Case {
    Case { kind: "change-sizing-object-zone", directory: "🏨️change-sizing-object-zone/🧪️tests/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
