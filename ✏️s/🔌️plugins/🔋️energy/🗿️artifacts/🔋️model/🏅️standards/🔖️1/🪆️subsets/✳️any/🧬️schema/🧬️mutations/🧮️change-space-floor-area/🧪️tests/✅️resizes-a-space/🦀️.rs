//! 🧪️ `change-space-floor-area` fixture — `✅️resizes-a-space`: resizes the first space.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-space-floor-area/✅️resizes-a-space/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-space-floor-area/✅️resizes-a-space/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-space-floor-area/✅️resizes-a-space/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-space-floor-area/✅️resizes-a-space/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧮️change-space-floor-area/✅️resizes-a-space/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-space-floor-area", directory: "🧮️change-space-floor-area/✅️resizes-a-space", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
