...
fn case() -> Case {
    Case { kind: "rename-plant-loop", directory: "📛️rename-plant-loop/🧪️tests/⛔️refuses-a-blank-name", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
