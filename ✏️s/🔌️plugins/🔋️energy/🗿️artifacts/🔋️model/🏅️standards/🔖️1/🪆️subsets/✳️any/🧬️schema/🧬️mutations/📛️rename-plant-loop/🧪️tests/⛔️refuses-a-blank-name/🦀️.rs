//! 🧪️ `rename-plant-loop` fixture — `⛔️refuses-a-blank-name`: refuses a blank name.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/⛔️refuses-a-blank-name/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/⛔️refuses-a-blank-name/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/⛔️refuses-a-blank-name/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/⛔️refuses-a-blank-name/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📛️rename-plant-loop/⛔️refuses-a-blank-name/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::rename_plant_loop(crate::model::EntityId(18), "   ".into()))
}

fn case() -> Case {
    Case { kind: "rename-plant-loop", directory: "📛️rename-plant-loop/⛔️refuses-a-blank-name", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
