...
fn case() -> Case {
    Case { kind: "create-thermostat", directory: "🩺️create-thermostat/🧪️tests/✅️controls-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
