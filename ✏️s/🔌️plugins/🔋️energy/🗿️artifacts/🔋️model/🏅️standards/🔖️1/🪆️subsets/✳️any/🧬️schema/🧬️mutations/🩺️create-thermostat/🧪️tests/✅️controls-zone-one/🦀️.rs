//! 🧪️ `create-thermostat` fixture — `✅️controls-zone-one`: puts a thermostat on the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩺️create-thermostat/✅️controls-zone-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩺️create-thermostat/✅️controls-zone-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩺️create-thermostat/✅️controls-zone-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩺️create-thermostat/✅️controls-zone-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩺️create-thermostat/✅️controls-zone-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_thermostat(crate::model::EntityId(10), crate::model::EntityId(1), crate::model::ScheduleId(1), crate::model::ScheduleId(2), 1.0, 1.0))
}

fn case() -> Case {
    Case { kind: "create-thermostat", directory: "🩺️create-thermostat/✅️controls-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
