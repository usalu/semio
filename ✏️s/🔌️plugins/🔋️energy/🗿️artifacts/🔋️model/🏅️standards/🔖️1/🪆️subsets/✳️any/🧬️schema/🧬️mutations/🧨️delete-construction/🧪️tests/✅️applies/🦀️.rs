...
fn case() -> Case {
    Case { kind: "delete-construction", directory: "🧨️delete-construction/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
