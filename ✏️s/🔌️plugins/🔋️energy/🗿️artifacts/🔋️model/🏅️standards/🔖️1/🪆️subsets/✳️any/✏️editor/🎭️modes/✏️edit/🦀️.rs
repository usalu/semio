...
pub fn layout() -> WindowLayout {
    WindowLayout {
        root: WindowLayoutRoot::Axis(WindowLayoutAxisNode {
            kind: "row".into(),
            size: None,
            children: vec![model_window_stack(structure::WINDOW_KIND_ID, "Structure"), model_window_stack(zones::WINDOW_KIND_ID, "Zones"), model_window_stack(simulation::WINDOW_KIND_ID, "Energy simulation")],
        }),
    }
}
