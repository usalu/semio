...
fn case() -> Case {
    Case { kind: "change-solar-thermal-system-efficiency", directory: "🏅️change-solar-thermal-system-efficiency/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
