//! 🧪️ `change-solar-thermal-system-efficiency` fixture — `⛔️refuses`: refuses collector efficiency outside a fraction in (0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏅️change-solar-thermal-system-efficiency/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_solar_thermal_system_efficiency(crate::model::EntityId(410), 1.4))
}

fn case() -> Case {
    Case { kind: "change-solar-thermal-system-efficiency", directory: "🏅️change-solar-thermal-system-efficiency/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
