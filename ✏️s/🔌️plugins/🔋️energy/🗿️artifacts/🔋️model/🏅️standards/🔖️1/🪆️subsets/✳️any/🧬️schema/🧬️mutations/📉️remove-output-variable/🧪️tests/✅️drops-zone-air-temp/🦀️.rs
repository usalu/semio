...
fn case() -> Case {
    Case { kind: "remove-output-variable", directory: "📉️remove-output-variable/🧪️tests/✅️drops-zone-air-temp", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
