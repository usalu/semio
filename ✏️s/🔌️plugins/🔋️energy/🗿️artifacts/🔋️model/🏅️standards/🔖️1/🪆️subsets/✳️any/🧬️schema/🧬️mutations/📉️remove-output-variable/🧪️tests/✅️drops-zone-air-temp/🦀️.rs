//! 🧪️ `remove-output-variable` fixture — `✅️drops-zone-air-temp`: drops the zone mean air temperature report.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📉️remove-output-variable/✅️drops-zone-air-temp/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📉️remove-output-variable/✅️drops-zone-air-temp/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📉️remove-output-variable/✅️drops-zone-air-temp/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📉️remove-output-variable/✅️drops-zone-air-temp/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📉️remove-output-variable/✅️drops-zone-air-temp/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "remove-output-variable", directory: "📉️remove-output-variable/✅️drops-zone-air-temp", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
