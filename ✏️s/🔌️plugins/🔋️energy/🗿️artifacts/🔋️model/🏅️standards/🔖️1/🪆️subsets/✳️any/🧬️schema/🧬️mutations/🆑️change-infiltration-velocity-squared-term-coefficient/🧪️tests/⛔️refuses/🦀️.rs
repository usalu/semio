...
fn case() -> Case {
    Case { kind: "change-infiltration-velocity-squared-term-coefficient", directory: "🆑️change-infiltration-velocity-squared-term-coefficient/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
