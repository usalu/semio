//! 🧪️ `change-solar-thermal-system-azimuth` fixture — `✅️applies`: moves solar thermal system 410.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛵️change-solar-thermal-system-azimuth/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛵️change-solar-thermal-system-azimuth/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛵️change-solar-thermal-system-azimuth/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛵️change-solar-thermal-system-azimuth/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛵️change-solar-thermal-system-azimuth/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_solar_thermal_system_azimuth(crate::model::EntityId(410), 200.0))
}

fn case() -> Case {
    Case { kind: "change-solar-thermal-system-azimuth", directory: "⛵️change-solar-thermal-system-azimuth/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
