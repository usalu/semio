...
fn case() -> Case {
    Case { kind: "change-solar-thermal-system-azimuth", directory: "⛵️change-solar-thermal-system-azimuth/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
