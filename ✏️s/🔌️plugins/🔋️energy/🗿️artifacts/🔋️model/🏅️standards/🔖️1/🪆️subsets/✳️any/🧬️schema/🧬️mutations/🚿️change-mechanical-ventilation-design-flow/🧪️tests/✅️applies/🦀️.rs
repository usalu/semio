...
fn case() -> Case {
    Case { kind: "change-mechanical-ventilation-design-flow", directory: "🚿️change-mechanical-ventilation-design-flow/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
