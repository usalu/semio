//! 🧪️ `change-mechanical-ventilation-design-flow` fixture — `✅️applies`: moves mechanical ventilation 60.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚿️change-mechanical-ventilation-design-flow/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_mechanical_ventilation_design_flow(crate::model::EntityId(60), 0.12))
}

fn case() -> Case {
    Case { kind: "change-mechanical-ventilation-design-flow", directory: "🚿️change-mechanical-ventilation-design-flow/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
