//! 🧪️ `change-fenestration-vlt` fixture — `⛔️refuses-negative-vlt`: refuses a negative transmittance.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/⛔️refuses-negative-vlt/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/⛔️refuses-negative-vlt/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/⛔️refuses-negative-vlt/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/⛔️refuses-negative-vlt/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌈️change-fenestration-vlt/⛔️refuses-negative-vlt/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_vlt(crate::model::EntityId(5), -0.1))
}

fn case() -> Case {
    Case { kind: "change-fenestration-vlt", directory: "🌈️change-fenestration-vlt/⛔️refuses-negative-vlt", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
