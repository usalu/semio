//! 🧪️ `change-solar-thermal-system-tilt` fixture — `✅️applies`: moves solar thermal system 410.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔼️change-solar-thermal-system-tilt/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔼️change-solar-thermal-system-tilt/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔼️change-solar-thermal-system-tilt/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔼️change-solar-thermal-system-tilt/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔼️change-solar-thermal-system-tilt/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_solar_thermal_system_tilt(crate::model::EntityId(410), 35.0))
}

fn case() -> Case {
    Case { kind: "change-solar-thermal-system-tilt", directory: "🔼️change-solar-thermal-system-tilt/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
