...
fn case() -> Case {
    Case { kind: "change-fenestration-u-value", directory: "🌐️change-fenestration-u-value/🧪️tests/✅️swaps-the-glazing", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
