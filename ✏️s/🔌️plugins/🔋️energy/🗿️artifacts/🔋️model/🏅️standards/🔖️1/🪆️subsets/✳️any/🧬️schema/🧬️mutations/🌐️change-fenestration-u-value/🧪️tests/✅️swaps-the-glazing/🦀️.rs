//! 🧪️ `change-fenestration-u-value` fixture — `✅️swaps-the-glazing`: moves to the EnergyPlus simple-glazing U-value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/✅️swaps-the-glazing/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/✅️swaps-the-glazing/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/✅️swaps-the-glazing/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/✅️swaps-the-glazing/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/✅️swaps-the-glazing/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_u_value(crate::model::EntityId(5), 2.74))
}

fn case() -> Case {
    Case { kind: "change-fenestration-u-value", directory: "🌐️change-fenestration-u-value/✅️swaps-the-glazing", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
