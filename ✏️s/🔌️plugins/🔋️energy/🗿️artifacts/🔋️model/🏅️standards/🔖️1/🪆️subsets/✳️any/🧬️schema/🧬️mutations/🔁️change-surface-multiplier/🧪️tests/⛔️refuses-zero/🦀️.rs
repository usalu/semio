...
fn case() -> Case {
    Case { kind: "change-surface-multiplier", directory: "🔁️change-surface-multiplier/🧪️tests/⛔️refuses-zero", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
