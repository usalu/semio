//! 🧪️ `change-surface-multiplier` fixture — `⛔️refuses-zero`: refuses zero instances.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/⛔️refuses-zero/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/⛔️refuses-zero/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/⛔️refuses-zero/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/⛔️refuses-zero/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/⛔️refuses-zero/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-multiplier", directory: "🔁️change-surface-multiplier/⛔️refuses-zero", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
