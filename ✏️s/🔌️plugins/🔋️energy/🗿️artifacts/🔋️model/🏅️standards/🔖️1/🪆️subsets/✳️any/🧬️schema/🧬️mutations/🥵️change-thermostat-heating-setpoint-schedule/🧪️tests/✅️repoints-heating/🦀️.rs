//! 🧪️ `change-thermostat-heating-setpoint-schedule` fixture — `✅️repoints-heating`: repoints the heating setpoint at the second schedule.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥵️change-thermostat-heating-setpoint-schedule/✅️repoints-heating/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥵️change-thermostat-heating-setpoint-schedule/✅️repoints-heating/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥵️change-thermostat-heating-setpoint-schedule/✅️repoints-heating/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥵️change-thermostat-heating-setpoint-schedule/✅️repoints-heating/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥵️change-thermostat-heating-setpoint-schedule/✅️repoints-heating/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_thermostat_heating_setpoint_schedule(crate::model::EntityId(10), crate::model::ScheduleId(2)))
}

fn case() -> Case {
    Case {
        kind: "change-thermostat-heating-setpoint-schedule", directory: "🥵️change-thermostat-heating-setpoint-schedule/✅️repoints-heating", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
