...
fn case() -> Case {
    Case {
        kind: "change-thermostat-heating-setpoint-schedule", directory: "🥵️change-thermostat-heating-setpoint-schedule/🧪️tests/✅️repoints-heating", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
