...
fn case() -> Case {
    Case { kind: "create-setpoint-manager", directory: "📌️create-setpoint-manager/🧪️tests/✅️adds-a-scheduled-spm", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
