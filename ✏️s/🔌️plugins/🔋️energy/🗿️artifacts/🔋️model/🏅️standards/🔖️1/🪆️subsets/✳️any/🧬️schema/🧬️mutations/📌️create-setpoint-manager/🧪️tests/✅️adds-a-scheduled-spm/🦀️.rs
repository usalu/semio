//! 🧪️ `create-setpoint-manager` fixture — `✅️adds-a-scheduled-spm`: adds a scheduled supply setpoint manager.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/✅️adds-a-scheduled-spm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/✅️adds-a-scheduled-spm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/✅️adds-a-scheduled-spm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/✅️adds-a-scheduled-spm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/✅️adds-a-scheduled-spm/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-setpoint-manager", directory: "📌️create-setpoint-manager/✅️adds-a-scheduled-spm", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
