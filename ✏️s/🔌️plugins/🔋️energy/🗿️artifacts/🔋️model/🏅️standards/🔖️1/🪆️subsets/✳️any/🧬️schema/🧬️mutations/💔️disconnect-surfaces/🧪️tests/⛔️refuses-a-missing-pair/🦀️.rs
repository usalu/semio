...
fn case() -> Case {
    Case { kind: "disconnect-surfaces", directory: "💔️disconnect-surfaces/🧪️tests/⛔️refuses-a-missing-pair", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
