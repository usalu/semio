//! 🧪️ `disconnect-surfaces` fixture — `⛔️refuses-a-missing-pair`: refuses two surfaces that are not adjacent.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/⛔️refuses-a-missing-pair/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/⛔️refuses-a-missing-pair/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/⛔️refuses-a-missing-pair/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/⛔️refuses-a-missing-pair/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💔️disconnect-surfaces/⛔️refuses-a-missing-pair/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "disconnect-surfaces", directory: "💔️disconnect-surfaces/⛔️refuses-a-missing-pair", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
