//! 🧪️ `change-shading-surface-transmittance-schedule` fixture — `✅️lets-light-in`: gives the awning a transmittance schedule.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛱️change-shading-surface-transmittance-schedule/✅️lets-light-in/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛱️change-shading-surface-transmittance-schedule/✅️lets-light-in/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛱️change-shading-surface-transmittance-schedule/✅️lets-light-in/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛱️change-shading-surface-transmittance-schedule/✅️lets-light-in/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛱️change-shading-surface-transmittance-schedule/✅️lets-light-in/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case {
        kind: "change-shading-surface-transmittance-schedule", directory: "⛱️change-shading-surface-transmittance-schedule/✅️lets-light-in", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
