//! 🧪️ `create-outdoor-air-system` fixture — `⛔️refuses-an-absent-loop`: refuses an air loop that does not exist.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/⛔️refuses-an-absent-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/⛔️refuses-an-absent-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/⛔️refuses-an-absent-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/⛔️refuses-an-absent-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌲️create-outdoor-air-system/⛔️refuses-an-absent-loop/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-outdoor-air-system", directory: "🌲️create-outdoor-air-system/⛔️refuses-an-absent-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
