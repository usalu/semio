...
fn case() -> Case {
    Case { kind: "create-outdoor-air-system", directory: "🌲️create-outdoor-air-system/🧪️tests/⛔️refuses-an-absent-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
