...
fn case() -> Case {
    Case { kind: "change-shw-system-schedule", directory: "🕐️change-shw-system-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
