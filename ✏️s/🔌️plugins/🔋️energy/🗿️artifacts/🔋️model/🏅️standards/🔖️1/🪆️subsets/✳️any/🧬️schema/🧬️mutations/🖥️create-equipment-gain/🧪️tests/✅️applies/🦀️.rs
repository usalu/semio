...
fn case() -> Case {
    Case { kind: "create-equipment-gain", directory: "🖥️create-equipment-gain/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
