//! 🧪️ `create-equipment-gain` fixture — `✅️applies`: inserts a new equipment gain.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖥️create-equipment-gain/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖥️create-equipment-gain/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖥️create-equipment-gain/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖥️create-equipment-gain/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖥️create-equipment-gain/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_equipment_gain(1, crate::model::EntityId(41), crate::model::EntityId(2), crate::model::ScheduleId(1), 2.5, 0.5, 0.0))
}

fn case() -> Case {
    Case { kind: "create-equipment-gain", directory: "🖥️create-equipment-gain/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
