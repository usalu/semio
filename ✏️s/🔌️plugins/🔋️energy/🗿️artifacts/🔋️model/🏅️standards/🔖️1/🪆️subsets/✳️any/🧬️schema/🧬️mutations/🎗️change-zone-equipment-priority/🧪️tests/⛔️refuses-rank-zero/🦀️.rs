...
fn case() -> Case {
    Case { kind: "change-zone-equipment-priority", directory: "🎗️change-zone-equipment-priority/🧪️tests/⛔️refuses-rank-zero", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
