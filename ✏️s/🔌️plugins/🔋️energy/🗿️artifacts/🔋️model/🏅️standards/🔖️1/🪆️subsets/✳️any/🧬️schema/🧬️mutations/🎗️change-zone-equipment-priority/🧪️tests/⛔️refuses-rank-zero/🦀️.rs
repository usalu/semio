//! 🧪️ `change-zone-equipment-priority` fixture — `⛔️refuses-rank-zero`: refuses a rank of zero.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/⛔️refuses-rank-zero/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/⛔️refuses-rank-zero/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/⛔️refuses-rank-zero/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/⛔️refuses-rank-zero/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/⛔️refuses-rank-zero/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_zone_equipment_priority(crate::model::EntityId(13), 0))
}

fn case() -> Case {
    Case { kind: "change-zone-equipment-priority", directory: "🎗️change-zone-equipment-priority/⛔️refuses-rank-zero", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
