...
fn case() -> Case {
    Case { kind: "change-daylight-zone-illuminance-target", directory: "🪔️change-daylight-zone-illuminance-target/🧪️tests/✅️dims-the-target", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
