//! 🧪️ `change-daylight-zone-illuminance-target` fixture — `✅️dims-the-target`: lowers the illuminance target.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/✅️dims-the-target/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/✅️dims-the-target/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/✅️dims-the-target/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/✅️dims-the-target/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪔️change-daylight-zone-illuminance-target/✅️dims-the-target/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_daylight_zone_illuminance_target(crate::model::EntityId(14), 300.0))
}

fn case() -> Case {
    Case { kind: "change-daylight-zone-illuminance-target", directory: "🪔️change-daylight-zone-illuminance-target/✅️dims-the-target", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
