...
fn case() -> Case {
    Case { kind: "change-plant-loop-design-flow", directory: "🚤️change-plant-loop-design-flow/🧪️tests/✅️uprates-the-flow", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
