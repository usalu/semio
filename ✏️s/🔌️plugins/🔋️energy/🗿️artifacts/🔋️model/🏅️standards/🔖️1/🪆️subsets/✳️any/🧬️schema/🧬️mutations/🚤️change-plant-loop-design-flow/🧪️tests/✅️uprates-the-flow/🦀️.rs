//! 🧪️ `change-plant-loop-design-flow` fixture — `✅️uprates-the-flow`: uprates the design mass flow.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/✅️uprates-the-flow/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/✅️uprates-the-flow/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/✅️uprates-the-flow/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/✅️uprates-the-flow/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚤️change-plant-loop-design-flow/✅️uprates-the-flow/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_plant_loop_design_flow(crate::model::EntityId(18), 3.0))
}

fn case() -> Case {
    Case { kind: "change-plant-loop-design-flow", directory: "🚤️change-plant-loop-design-flow/✅️uprates-the-flow", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
