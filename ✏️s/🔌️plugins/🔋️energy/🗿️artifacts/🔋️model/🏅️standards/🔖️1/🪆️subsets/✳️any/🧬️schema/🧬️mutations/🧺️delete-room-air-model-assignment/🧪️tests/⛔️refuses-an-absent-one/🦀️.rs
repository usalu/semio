//! 🧪️ `delete-room-air-model-assignment` fixture — `⛔️refuses-an-absent-one`: refuses a zone with no override.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/⛔️refuses-an-absent-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/⛔️refuses-an-absent-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/⛔️refuses-an-absent-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/⛔️refuses-an-absent-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/⛔️refuses-an-absent-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_room_air_model_assignment(crate::model::EntityId(99)))
}

fn case() -> Case {
    Case { kind: "delete-room-air-model-assignment", directory: "🧺️delete-room-air-model-assignment/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
