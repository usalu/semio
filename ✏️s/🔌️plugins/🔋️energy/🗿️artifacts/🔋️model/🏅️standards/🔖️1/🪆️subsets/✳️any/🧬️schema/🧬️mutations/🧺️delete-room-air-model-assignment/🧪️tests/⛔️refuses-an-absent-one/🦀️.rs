...
fn case() -> Case {
    Case { kind: "delete-room-air-model-assignment", directory: "🧺️delete-room-air-model-assignment/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
