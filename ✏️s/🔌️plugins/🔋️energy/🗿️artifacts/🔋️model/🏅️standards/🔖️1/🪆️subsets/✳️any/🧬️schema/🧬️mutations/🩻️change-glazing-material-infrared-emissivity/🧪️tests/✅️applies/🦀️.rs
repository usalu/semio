//! 🧪️ `change-glazing-material-infrared-emissivity` fixture — `✅️applies`: coats the inner face low-e.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_glazing_material_infrared_emissivity(crate::model::EntityId(1), 0.84, 0.04))
}

fn case() -> Case {
    Case { kind: "change-glazing-material-infrared-emissivity", directory: "🩻️change-glazing-material-infrared-emissivity/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
