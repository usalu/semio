...
fn case() -> Case {
    Case { kind: "change-infiltration-stack-height", directory: "🏭️change-infiltration-stack-height/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
