//! 🧪️ `change-pv-system-area` fixture — `⛔️refuses`: refuses aperture area (m²) outside a positive finite value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟨️change-pv-system-area/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟨️change-pv-system-area/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟨️change-pv-system-area/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟨️change-pv-system-area/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟨️change-pv-system-area/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_pv_system_area(crate::model::EntityId(300), -1.0))
}

fn case() -> Case {
    Case { kind: "change-pv-system-area", directory: "🟨️change-pv-system-area/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
