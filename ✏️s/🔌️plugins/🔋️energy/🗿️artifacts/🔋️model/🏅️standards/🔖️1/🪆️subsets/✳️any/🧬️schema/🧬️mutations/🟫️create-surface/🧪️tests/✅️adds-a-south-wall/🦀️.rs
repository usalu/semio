...
fn case() -> Case {
    Case { kind: "create-surface", directory: "🟫️create-surface/🧪️tests/✅️adds-a-south-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
