//! 🧪️ `create-surface` fixture — `✅️adds-a-south-wall`: adds the south exterior wall.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/✅️adds-a-south-wall/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/✅️adds-a-south-wall/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/✅️adds-a-south-wall/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/✅️adds-a-south-wall/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟫️create-surface/✅️adds-a-south-wall/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-surface", directory: "🟫️create-surface/✅️adds-a-south-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
