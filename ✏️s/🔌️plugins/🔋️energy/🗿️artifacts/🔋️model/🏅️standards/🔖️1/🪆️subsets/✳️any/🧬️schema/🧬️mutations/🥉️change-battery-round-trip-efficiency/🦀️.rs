...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeBatteryRoundTripEfficiency {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Battery Round Trip Efficiency of battery {}", self.id.0), &format!("runde Batterienwegwirkungsgrad von Batterie {} ändern", self.id.0))
    }
