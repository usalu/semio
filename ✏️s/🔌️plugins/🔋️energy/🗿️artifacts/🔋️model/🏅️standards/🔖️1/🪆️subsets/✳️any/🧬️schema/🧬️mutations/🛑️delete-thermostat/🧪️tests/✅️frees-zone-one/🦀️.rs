//! 🧪️ `delete-thermostat` fixture — `✅️frees-zone-one`: drops the thermostat off the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛑️delete-thermostat/✅️frees-zone-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛑️delete-thermostat/✅️frees-zone-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛑️delete-thermostat/✅️frees-zone-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛑️delete-thermostat/✅️frees-zone-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛑️delete-thermostat/✅️frees-zone-one/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-thermostat", directory: "🛑️delete-thermostat/✅️frees-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
