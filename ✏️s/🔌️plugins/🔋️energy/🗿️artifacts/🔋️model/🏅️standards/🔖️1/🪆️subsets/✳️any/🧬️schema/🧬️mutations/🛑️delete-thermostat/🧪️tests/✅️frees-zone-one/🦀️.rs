...
fn case() -> Case {
    Case { kind: "delete-thermostat", directory: "🛑️delete-thermostat/🧪️tests/✅️frees-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
