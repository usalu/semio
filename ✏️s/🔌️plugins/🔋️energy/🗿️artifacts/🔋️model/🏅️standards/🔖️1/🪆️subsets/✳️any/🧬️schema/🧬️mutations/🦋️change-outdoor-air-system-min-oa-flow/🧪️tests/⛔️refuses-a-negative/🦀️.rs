//! 🧪️ `change-outdoor-air-system-min-oa-flow` fixture — `⛔️refuses-a-negative`: refuses a negative outdoor air flow.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/⛔️refuses-a-negative/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/⛔️refuses-a-negative/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/⛔️refuses-a-negative/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/⛔️refuses-a-negative/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/⛔️refuses-a-negative/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_outdoor_air_system_min_oa_flow(crate::model::EntityId(19), -1.0))
}

fn case() -> Case {
    Case { kind: "change-outdoor-air-system-min-oa-flow", directory: "🦋️change-outdoor-air-system-min-oa-flow/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
