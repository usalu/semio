...
fn case() -> Case {
    Case { kind: "change-outdoor-air-system-min-oa-flow", directory: "🦋️change-outdoor-air-system-min-oa-flow/🧪️tests/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
