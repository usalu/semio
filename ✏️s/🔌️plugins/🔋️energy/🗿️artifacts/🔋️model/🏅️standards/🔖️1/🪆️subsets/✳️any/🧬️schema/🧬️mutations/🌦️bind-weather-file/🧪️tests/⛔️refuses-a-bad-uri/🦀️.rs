...
fn case() -> Case {
    Case { kind: "bind-weather-file", directory: "🌦️bind-weather-file/🧪️tests/⛔️refuses-a-bad-uri", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
