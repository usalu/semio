//! 🧪️ `bind-weather-file` fixture — `⛔️refuses-a-bad-uri`: refuses a malformed artifact URI.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/⛔️refuses-a-bad-uri/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/⛔️refuses-a-bad-uri/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/⛔️refuses-a-bad-uri/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/⛔️refuses-a-bad-uri/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌦️bind-weather-file/⛔️refuses-a-bad-uri/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "bind-weather-file", directory: "🌦️bind-weather-file/⛔️refuses-a-bad-uri", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
