//! 🧪️ `change-pv-system-inverter-efficiency` fixture — `✅️applies`: moves pv system 300.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♌️change-pv-system-inverter-efficiency/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_pv_system_inverter_efficiency(crate::model::EntityId(300), 0.98))
}

fn case() -> Case {
    Case { kind: "change-pv-system-inverter-efficiency", directory: "♌️change-pv-system-inverter-efficiency/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
