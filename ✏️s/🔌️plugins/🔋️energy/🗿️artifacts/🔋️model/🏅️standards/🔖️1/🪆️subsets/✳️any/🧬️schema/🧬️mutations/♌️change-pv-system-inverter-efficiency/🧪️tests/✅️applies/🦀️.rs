...
fn case() -> Case {
    Case { kind: "change-pv-system-inverter-efficiency", directory: "♌️change-pv-system-inverter-efficiency/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
