...
fn case() -> Case {
    Case { kind: "change-equipment-gain-zone", directory: "🖨️change-equipment-gain-zone/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
