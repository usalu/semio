//! 🧪️ `add-annual-schedule-holiday` fixture — `✅️applies`: marks new year's day a holiday.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎉️add-annual-schedule-holiday/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎉️add-annual-schedule-holiday/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎉️add-annual-schedule-holiday/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎉️add-annual-schedule-holiday/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎉️add-annual-schedule-holiday/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "add-annual-schedule-holiday", directory: "🎉️add-annual-schedule-holiday/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
