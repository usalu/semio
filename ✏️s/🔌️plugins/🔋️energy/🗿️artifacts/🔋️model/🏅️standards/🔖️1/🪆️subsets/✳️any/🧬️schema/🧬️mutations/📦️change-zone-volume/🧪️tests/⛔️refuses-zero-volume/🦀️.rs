//! 🧪️ `change-zone-volume` fixture — `⛔️refuses-zero-volume`: refuses a zero volume.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/⛔️refuses-zero-volume/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/⛔️refuses-zero-volume/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/⛔️refuses-zero-volume/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/⛔️refuses-zero-volume/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/⛔️refuses-zero-volume/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-zone-volume", directory: "📦️change-zone-volume/⛔️refuses-zero-volume", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
