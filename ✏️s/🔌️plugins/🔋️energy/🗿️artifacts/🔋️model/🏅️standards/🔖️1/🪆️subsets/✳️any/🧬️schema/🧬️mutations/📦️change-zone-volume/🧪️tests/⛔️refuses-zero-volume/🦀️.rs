...
fn case() -> Case {
    Case { kind: "change-zone-volume", directory: "📦️change-zone-volume/🧪️tests/⛔️refuses-zero-volume", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
