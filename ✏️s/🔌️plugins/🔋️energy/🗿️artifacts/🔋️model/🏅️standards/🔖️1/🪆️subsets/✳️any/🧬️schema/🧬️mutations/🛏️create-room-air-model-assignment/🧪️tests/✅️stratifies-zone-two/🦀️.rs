...
fn case() -> Case {
    Case { kind: "create-room-air-model-assignment", directory: "🛏️create-room-air-model-assignment/🧪️tests/✅️stratifies-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
