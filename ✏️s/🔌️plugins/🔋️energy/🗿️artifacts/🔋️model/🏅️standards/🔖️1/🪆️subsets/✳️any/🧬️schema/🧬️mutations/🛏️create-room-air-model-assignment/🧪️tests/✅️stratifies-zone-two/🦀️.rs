//! 🧪️ `create-room-air-model-assignment` fixture — `✅️stratifies-zone-two`: gives the second zone a two-node room air model.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/✅️stratifies-zone-two/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/✅️stratifies-zone-two/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/✅️stratifies-zone-two/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/✅️stratifies-zone-two/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛏️create-room-air-model-assignment/✅️stratifies-zone-two/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-room-air-model-assignment", directory: "🛏️create-room-air-model-assignment/✅️stratifies-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
