//! 🧪️ `delete-daylight-zone` fixture — `✅️darkens-the-zone`: removes the daylighting control.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌗️delete-daylight-zone/✅️darkens-the-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌗️delete-daylight-zone/✅️darkens-the-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌗️delete-daylight-zone/✅️darkens-the-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌗️delete-daylight-zone/✅️darkens-the-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌗️delete-daylight-zone/✅️darkens-the-zone/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_daylight_zone(crate::model::EntityId(14)))
}

fn case() -> Case {
    Case { kind: "delete-daylight-zone", directory: "🌗️delete-daylight-zone/✅️darkens-the-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
