...
fn case() -> Case {
    Case { kind: "delete-daylight-zone", directory: "🌗️delete-daylight-zone/🧪️tests/✅️darkens-the-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
