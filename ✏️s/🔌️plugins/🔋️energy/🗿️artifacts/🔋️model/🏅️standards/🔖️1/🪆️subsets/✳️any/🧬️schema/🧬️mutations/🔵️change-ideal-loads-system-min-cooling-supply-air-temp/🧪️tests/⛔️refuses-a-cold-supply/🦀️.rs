//! 🧪️ `change-ideal-loads-system-min-cooling-supply-air-temp` fixture — `⛔️refuses-a-cold-supply`: refuses an unrepresentable supply temperature.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/⛔️refuses-a-cold-supply/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/⛔️refuses-a-cold-supply/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/⛔️refuses-a-cold-supply/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/⛔️refuses-a-cold-supply/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔵️change-ideal-loads-system-min-cooling-supply-air-temp/⛔️refuses-a-cold-supply/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_ideal_loads_system_min_cooling_supply_air_temp(crate::model::EntityId(12), -500.0))
}

fn case() -> Case {
    Case {
        kind: "change-ideal-loads-system-min-cooling-supply-air-temp",
        directory: "🔵️change-ideal-loads-system-min-cooling-supply-air-temp/⛔️refuses-a-cold-supply",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
