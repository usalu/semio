...
fn case() -> Case {
    Case { kind: "change-ideal-loads-system-min-cooling-supply-air-temp", directory: "🔵️change-ideal-loads-system-min-cooling-supply-air-temp/🧪️tests/⛔️refuses-a-cold-supply", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
