...
fn case() -> Case {
    Case { kind: "delete-mechanical-ventilation", directory: "🚫️delete-mechanical-ventilation/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
