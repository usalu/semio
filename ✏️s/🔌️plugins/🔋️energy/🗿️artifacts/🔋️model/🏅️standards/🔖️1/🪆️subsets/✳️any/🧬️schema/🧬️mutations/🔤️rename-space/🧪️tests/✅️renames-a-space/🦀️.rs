//! 🧪️ `rename-space` fixture — `✅️renames-a-space`: renames the first space.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️rename-space/✅️renames-a-space/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️rename-space/✅️renames-a-space/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️rename-space/✅️renames-a-space/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️rename-space/✅️renames-a-space/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔤️rename-space/✅️renames-a-space/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "rename-space", directory: "🔤️rename-space/✅️renames-a-space", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
