...
fn case() -> Case {
    Case { kind: "create-electrical-load-center", directory: "🏦️create-electrical-load-center/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
