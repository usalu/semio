//! 🧪️ `create-electrical-load-center` fixture — `✅️applies`: inserts a new electrical load center.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏦️create-electrical-load-center/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏦️create-electrical-load-center/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏦️create-electrical-load-center/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏦️create-electrical-load-center/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏦️create-electrical-load-center/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_electrical_load_center(2, crate::model::EntityId(322), "ROOF PANEL".into(), Vec::new(), vec![crate::model::EntityId(301)], Vec::new()))
}

fn case() -> Case {
    Case { kind: "create-electrical-load-center", directory: "🏦️create-electrical-load-center/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
