//! 🧪️ `change-refrigeration-system-defrost-schedule` fixture — `✅️applies`: moves refrigeration system 420.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕑️change-refrigeration-system-defrost-schedule/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕑️change-refrigeration-system-defrost-schedule/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕑️change-refrigeration-system-defrost-schedule/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕑️change-refrigeration-system-defrost-schedule/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕑️change-refrigeration-system-defrost-schedule/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_refrigeration_system_defrost_schedule(crate::model::EntityId(420), crate::model::ScheduleId(2)))
}

fn case() -> Case {
    Case { kind: "change-refrigeration-system-defrost-schedule", directory: "🕑️change-refrigeration-system-defrost-schedule/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
