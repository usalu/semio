...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeInfiltrationVelocityTermCoefficient {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Infiltration Velocity Term Coefficient of infiltration {}", self.id.0), &format!("Infiltrationsgeschwindigkeitstermkoeffizient von Infiltration {} ändern", self.id.0))
    }
