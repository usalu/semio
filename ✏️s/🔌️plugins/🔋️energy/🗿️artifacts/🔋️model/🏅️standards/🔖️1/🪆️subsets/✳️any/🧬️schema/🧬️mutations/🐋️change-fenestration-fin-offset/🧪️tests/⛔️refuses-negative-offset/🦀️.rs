...
fn case() -> Case {
    Case { kind: "change-fenestration-fin-offset", directory: "🐋️change-fenestration-fin-offset/🧪️tests/⛔️refuses-negative-offset", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
