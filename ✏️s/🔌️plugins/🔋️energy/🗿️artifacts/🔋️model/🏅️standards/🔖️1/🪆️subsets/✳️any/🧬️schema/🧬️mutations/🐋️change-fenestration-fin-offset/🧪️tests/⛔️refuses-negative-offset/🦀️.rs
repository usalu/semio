//! 🧪️ `change-fenestration-fin-offset` fixture — `⛔️refuses-negative-offset`: refuses a negative fin offset.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐋️change-fenestration-fin-offset/⛔️refuses-negative-offset/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐋️change-fenestration-fin-offset/⛔️refuses-negative-offset/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐋️change-fenestration-fin-offset/⛔️refuses-negative-offset/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐋️change-fenestration-fin-offset/⛔️refuses-negative-offset/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐋️change-fenestration-fin-offset/⛔️refuses-negative-offset/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_fin_offset(crate::model::EntityId(5), -0.2))
}

fn case() -> Case {
    Case { kind: "change-fenestration-fin-offset", directory: "🐋️change-fenestration-fin-offset/⛔️refuses-negative-offset", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
