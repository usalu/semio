...
fn case() -> Case {
    Case { kind: "create-humidistat", directory: "🌂️create-humidistat/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
