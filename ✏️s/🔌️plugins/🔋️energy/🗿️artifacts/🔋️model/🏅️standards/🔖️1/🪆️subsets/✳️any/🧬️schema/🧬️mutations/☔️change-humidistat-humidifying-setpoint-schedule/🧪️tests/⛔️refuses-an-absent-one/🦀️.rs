//! 🧪️ `change-humidistat-humidifying-setpoint-schedule` fixture — `⛔️refuses-an-absent-one`: refuses a schedule the model does not define.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☔️change-humidistat-humidifying-setpoint-schedule/⛔️refuses-an-absent-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☔️change-humidistat-humidifying-setpoint-schedule/⛔️refuses-an-absent-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☔️change-humidistat-humidifying-setpoint-schedule/⛔️refuses-an-absent-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☔️change-humidistat-humidifying-setpoint-schedule/⛔️refuses-an-absent-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☔️change-humidistat-humidifying-setpoint-schedule/⛔️refuses-an-absent-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_humidistat_humidifying_setpoint_schedule(crate::model::EntityId(11), crate::model::ScheduleId(99)))
}

fn case() -> Case {
    Case {
        kind: "change-humidistat-humidifying-setpoint-schedule",
        directory: "☔️change-humidistat-humidifying-setpoint-schedule/⛔️refuses-an-absent-one",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
