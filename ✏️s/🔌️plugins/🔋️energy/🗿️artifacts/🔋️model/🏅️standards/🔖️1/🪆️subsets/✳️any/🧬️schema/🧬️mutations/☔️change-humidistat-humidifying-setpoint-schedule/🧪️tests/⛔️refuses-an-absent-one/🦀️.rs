...
fn case() -> Case {
    Case { kind: "change-humidistat-humidifying-setpoint-schedule", directory: "☔️change-humidistat-humidifying-setpoint-schedule/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
