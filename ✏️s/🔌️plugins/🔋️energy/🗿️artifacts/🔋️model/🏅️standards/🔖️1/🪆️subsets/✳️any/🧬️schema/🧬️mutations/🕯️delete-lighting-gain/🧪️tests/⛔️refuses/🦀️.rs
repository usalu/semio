...
fn case() -> Case {
    Case { kind: "delete-lighting-gain", directory: "🕯️delete-lighting-gain/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
