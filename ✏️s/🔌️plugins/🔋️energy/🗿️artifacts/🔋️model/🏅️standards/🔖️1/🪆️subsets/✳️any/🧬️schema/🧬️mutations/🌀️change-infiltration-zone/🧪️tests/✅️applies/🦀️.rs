...
fn case() -> Case {
    Case { kind: "change-infiltration-zone", directory: "🌀️change-infiltration-zone/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
