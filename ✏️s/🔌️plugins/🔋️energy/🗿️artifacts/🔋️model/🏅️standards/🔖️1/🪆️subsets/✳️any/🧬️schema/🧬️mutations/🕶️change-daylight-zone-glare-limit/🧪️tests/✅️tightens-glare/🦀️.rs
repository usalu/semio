//! 🧪️ `change-daylight-zone-glare-limit` fixture — `✅️tightens-glare`: tightens the glare limit.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/✅️tightens-glare/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/✅️tightens-glare/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/✅️tightens-glare/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/✅️tightens-glare/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/✅️tightens-glare/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_daylight_zone_glare_limit(crate::model::EntityId(14), 20.0))
}

fn case() -> Case {
    Case { kind: "change-daylight-zone-glare-limit", directory: "🕶️change-daylight-zone-glare-limit/✅️tightens-glare", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
