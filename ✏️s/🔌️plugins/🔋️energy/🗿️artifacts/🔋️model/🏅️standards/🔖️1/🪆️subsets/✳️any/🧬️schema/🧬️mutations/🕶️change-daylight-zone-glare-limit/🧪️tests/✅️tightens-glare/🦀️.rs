...
fn case() -> Case {
    Case { kind: "change-daylight-zone-glare-limit", directory: "🕶️change-daylight-zone-glare-limit/🧪️tests/✅️tightens-glare", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
