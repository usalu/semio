...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeThermostatZone {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change thermostat {} zone to {}", self.id.0, self.new_zone_id.0), &format!("Zone von Thermostat {} auf {} ändern", self.id.0, self.new_zone_id.0))
    }
