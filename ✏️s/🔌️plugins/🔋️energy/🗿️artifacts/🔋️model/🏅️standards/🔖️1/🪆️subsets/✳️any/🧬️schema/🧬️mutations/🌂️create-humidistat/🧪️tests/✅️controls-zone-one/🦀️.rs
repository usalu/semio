...
fn case() -> Case {
    Case { kind: "create-humidistat", directory: "🌂️create-humidistat/🧪️tests/✅️controls-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
