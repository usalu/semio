//! 🧪️ `create-humidistat` fixture — `✅️controls-zone-one`: puts a humidistat on the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌂️create-humidistat/✅️controls-zone-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌂️create-humidistat/✅️controls-zone-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌂️create-humidistat/✅️controls-zone-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌂️create-humidistat/✅️controls-zone-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌂️create-humidistat/✅️controls-zone-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_humidistat(crate::model::EntityId(11), crate::model::EntityId(1), crate::model::ScheduleId(1), crate::model::ScheduleId(2), 5.0, 5.0))
}

fn case() -> Case {
    Case { kind: "create-humidistat", directory: "🌂️create-humidistat/✅️controls-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
