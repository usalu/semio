//! 🧪️ `change-fenestration-fin-depth` fixture — `✅️adds-case-630-fins`: adds case 630's one-metre fins.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/✅️adds-case-630-fins/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/✅️adds-case-630-fins/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/✅️adds-case-630-fins/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/✅️adds-case-630-fins/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🐬️change-fenestration-fin-depth/✅️adds-case-630-fins/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_fin_depth(crate::model::EntityId(5), 1.0))
}

fn case() -> Case {
    Case { kind: "change-fenestration-fin-depth", directory: "🐬️change-fenestration-fin-depth/✅️adds-case-630-fins", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
