...
fn case() -> Case {
    Case { kind: "change-fenestration-fin-depth", directory: "🐬️change-fenestration-fin-depth/🧪️tests/✅️adds-case-630-fins", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
