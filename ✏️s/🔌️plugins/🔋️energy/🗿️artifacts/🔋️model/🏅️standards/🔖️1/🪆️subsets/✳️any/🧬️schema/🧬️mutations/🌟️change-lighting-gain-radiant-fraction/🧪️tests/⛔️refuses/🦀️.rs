//! 🧪️ `change-lighting-gain-radiant-fraction` fixture — `⛔️refuses`: refuses radiant fraction outside a fraction in [0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌟️change-lighting-gain-radiant-fraction/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌟️change-lighting-gain-radiant-fraction/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌟️change-lighting-gain-radiant-fraction/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌟️change-lighting-gain-radiant-fraction/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌟️change-lighting-gain-radiant-fraction/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_lighting_gain_radiant_fraction(crate::model::EntityId(30), 1.3))
}

fn case() -> Case {
    Case { kind: "change-lighting-gain-radiant-fraction", directory: "🌟️change-lighting-gain-radiant-fraction/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
