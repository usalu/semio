//! 🧪️ `change-equipment-gain-schedule` fixture — `⛔️refuses`: refuses an undefined schedule.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⌛️change-equipment-gain-schedule/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⌛️change-equipment-gain-schedule/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⌛️change-equipment-gain-schedule/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⌛️change-equipment-gain-schedule/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⌛️change-equipment-gain-schedule/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_equipment_gain_schedule(crate::model::EntityId(40), crate::model::ScheduleId(999)))
}

fn case() -> Case {
    Case { kind: "change-equipment-gain-schedule", directory: "⌛️change-equipment-gain-schedule/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
