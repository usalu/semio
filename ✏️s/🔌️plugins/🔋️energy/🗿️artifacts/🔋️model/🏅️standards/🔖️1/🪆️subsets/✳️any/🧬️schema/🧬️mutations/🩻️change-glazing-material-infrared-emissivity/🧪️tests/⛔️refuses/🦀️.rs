//! 🧪️ `change-glazing-material-infrared-emissivity` fixture — `⛔️refuses`: refuses an emissivity above one.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🩻️change-glazing-material-infrared-emissivity/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_glazing_material_infrared_emissivity(crate::model::EntityId(1), 0.84, 1.2))
}

fn case() -> Case {
    Case { kind: "change-glazing-material-infrared-emissivity", directory: "🩻️change-glazing-material-infrared-emissivity/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
