//! 🧪️ `delete-space` fixture — `✅️deletes-a-free-space`: deletes a space no list names.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/✅️deletes-a-free-space/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/✅️deletes-a-free-space/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/✅️deletes-a-free-space/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/✅️deletes-a-free-space/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/✅️deletes-a-free-space/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-space", directory: "🧹️delete-space/✅️deletes-a-free-space", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
