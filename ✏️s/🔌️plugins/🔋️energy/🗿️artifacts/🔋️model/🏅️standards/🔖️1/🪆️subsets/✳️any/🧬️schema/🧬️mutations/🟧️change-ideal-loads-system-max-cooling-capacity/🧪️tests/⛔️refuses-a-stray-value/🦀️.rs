...
fn case() -> Case {
    Case { kind: "change-ideal-loads-system-max-cooling-capacity", directory: "🟧️change-ideal-loads-system-max-cooling-capacity/🧪️tests/⛔️refuses-a-stray-value", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
