//! 🧪️ `create-people-gain` fixture — `⛔️refuses`: refuses an id the model already carries.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_people_gain(1, crate::model::EntityId(20), crate::model::EntityId(2), crate::model::ScheduleId(1), crate::model::ScheduleId(2), 0.1, 0.6, 0.4, 0.3))
}

fn case() -> Case {
    Case { kind: "create-people-gain", directory: "👤️create-people-gain/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
