...
fn case() -> Case {
    Case { kind: "change-daily-schedule-limits", directory: "🕟️change-daily-schedule-limits/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
