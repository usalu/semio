...
fn case() -> Case {
    Case { kind: "change-equipment-gain-latent-fraction", directory: "💦️change-equipment-gain-latent-fraction/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
