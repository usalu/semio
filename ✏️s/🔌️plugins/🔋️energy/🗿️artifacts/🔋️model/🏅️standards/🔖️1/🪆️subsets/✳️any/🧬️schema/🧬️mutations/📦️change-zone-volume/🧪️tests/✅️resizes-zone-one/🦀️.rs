...
fn case() -> Case {
    Case { kind: "change-zone-volume", directory: "📦️change-zone-volume/🧪️tests/✅️resizes-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
