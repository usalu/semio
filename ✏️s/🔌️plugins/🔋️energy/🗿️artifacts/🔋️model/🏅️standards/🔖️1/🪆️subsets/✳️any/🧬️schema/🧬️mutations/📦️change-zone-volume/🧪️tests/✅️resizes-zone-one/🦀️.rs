//! 🧪️ `change-zone-volume` fixture — `✅️resizes-zone-one`: resizes the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/✅️resizes-zone-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/✅️resizes-zone-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/✅️resizes-zone-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/✅️resizes-zone-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📦️change-zone-volume/✅️resizes-zone-one/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-zone-volume", directory: "📦️change-zone-volume/✅️resizes-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
