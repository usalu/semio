...
fn case() -> Case {
    Case { kind: "rename-fenestration", directory: "🏁️rename-fenestration/🧪️tests/✅️renames-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
