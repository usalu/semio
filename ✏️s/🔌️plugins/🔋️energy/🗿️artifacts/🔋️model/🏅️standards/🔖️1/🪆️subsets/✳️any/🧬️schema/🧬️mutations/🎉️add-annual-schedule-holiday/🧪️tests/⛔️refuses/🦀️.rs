...
fn case() -> Case {
    Case { kind: "add-annual-schedule-holiday", directory: "🎉️add-annual-schedule-holiday/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
