...
fn case() -> Case {
    Case { kind: "delete-humidistat", directory: "🏜️delete-humidistat/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
