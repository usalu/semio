...
fn case() -> Case {
    Case {
        kind: "change-thermostat-cooling-throttle-range", directory: "🎛️change-thermostat-cooling-throttle-range/🧪️tests/✅️widens-cooling-band", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
