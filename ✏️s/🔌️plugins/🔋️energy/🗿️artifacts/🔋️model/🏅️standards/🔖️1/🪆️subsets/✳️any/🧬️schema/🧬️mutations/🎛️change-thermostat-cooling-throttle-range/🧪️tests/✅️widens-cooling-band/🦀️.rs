//! 🧪️ `change-thermostat-cooling-throttle-range` fixture — `✅️widens-cooling-band`: widens the cooling throttle band.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-thermostat-cooling-throttle-range/✅️widens-cooling-band/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-thermostat-cooling-throttle-range/✅️widens-cooling-band/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-thermostat-cooling-throttle-range/✅️widens-cooling-band/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-thermostat-cooling-throttle-range/✅️widens-cooling-band/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-thermostat-cooling-throttle-range/✅️widens-cooling-band/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_thermostat_cooling_throttle_range(crate::model::EntityId(10), 2.0))
}

fn case() -> Case {
    Case {
        kind: "change-thermostat-cooling-throttle-range", directory: "🎛️change-thermostat-cooling-throttle-range/✅️widens-cooling-band", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
