...
fn case() -> Case {
    Case { kind: "change-infiltration-method", directory: "🔬️change-infiltration-method/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
