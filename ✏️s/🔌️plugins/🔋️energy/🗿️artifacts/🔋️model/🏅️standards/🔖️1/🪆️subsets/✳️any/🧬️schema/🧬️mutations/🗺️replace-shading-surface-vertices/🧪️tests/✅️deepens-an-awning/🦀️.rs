//! 🧪️ `replace-shading-surface-vertices` fixture — `✅️deepens-an-awning`: deepens the site awning.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️replace-shading-surface-vertices/✅️deepens-an-awning/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️replace-shading-surface-vertices/✅️deepens-an-awning/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️replace-shading-surface-vertices/✅️deepens-an-awning/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️replace-shading-surface-vertices/✅️deepens-an-awning/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗺️replace-shading-surface-vertices/✅️deepens-an-awning/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::replace_shading_surface_vertices(crate::model::EntityId(11), vec![[0.0, -3.0, 3.0], [8.0, -3.0, 3.0], [8.0, 0.0, 3.0], [0.0, 0.0, 3.0]]))
}

fn case() -> Case {
    Case { kind: "replace-shading-surface-vertices", directory: "🗺️replace-shading-surface-vertices/✅️deepens-an-awning", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
