...
fn case() -> Case {
    Case { kind: "replace-shading-surface-vertices", directory: "🗺️replace-shading-surface-vertices/🧪️tests/✅️deepens-an-awning", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
