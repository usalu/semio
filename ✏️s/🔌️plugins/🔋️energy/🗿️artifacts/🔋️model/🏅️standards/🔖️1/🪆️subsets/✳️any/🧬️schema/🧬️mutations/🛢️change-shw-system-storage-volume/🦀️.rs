...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeShwSystemStorageVolume {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Shw System Storage Volume of service hot water system {}", self.id.0), &format!("Speichervolumen von Trinkwarmwasseranlage {} ändern", self.id.0))
    }
