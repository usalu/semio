...
fn case() -> Case {
    Case { kind: "change-zone-equipment-zone", directory: "🏬️change-zone-equipment-zone/🧪️tests/✅️moves-to-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
