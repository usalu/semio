//! 🧪️ `create-people-gain` fixture — `✅️applies`: inserts a new people gain.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👤️create-people-gain/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_people_gain(1, crate::model::EntityId(21), crate::model::EntityId(2), crate::model::ScheduleId(1), crate::model::ScheduleId(2), 0.1, 0.6, 0.4, 0.3))
}

fn case() -> Case {
    Case { kind: "create-people-gain", directory: "👤️create-people-gain/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
