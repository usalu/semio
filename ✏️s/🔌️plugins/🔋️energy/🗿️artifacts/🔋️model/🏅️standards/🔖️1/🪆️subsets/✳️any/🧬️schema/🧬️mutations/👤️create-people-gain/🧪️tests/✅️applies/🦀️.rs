...
fn case() -> Case {
    Case { kind: "create-people-gain", directory: "👤️create-people-gain/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
