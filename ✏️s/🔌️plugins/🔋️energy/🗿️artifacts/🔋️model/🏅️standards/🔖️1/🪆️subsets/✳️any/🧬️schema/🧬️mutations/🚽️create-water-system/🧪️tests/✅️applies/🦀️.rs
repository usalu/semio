...
fn case() -> Case {
    Case { kind: "create-water-system", directory: "🚽️create-water-system/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
