//! 🧪️ `change-fenestration-frame-conductance` fixture — `✅️adds-a-frame`: gives the window a conducting frame.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/✅️adds-a-frame/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/✅️adds-a-frame/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/✅️adds-a-frame/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/✅️adds-a-frame/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-fenestration-frame-conductance/✅️adds-a-frame/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_frame_conductance(crate::model::EntityId(5), 1.2))
}

fn case() -> Case {
    Case { kind: "change-fenestration-frame-conductance", directory: "🖼️change-fenestration-frame-conductance/✅️adds-a-frame", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
