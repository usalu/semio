//! 🧪️ `change-equipment-gain-latent-fraction` fixture — `⛔️refuses`: refuses latent fraction outside a fraction in [0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💦️change-equipment-gain-latent-fraction/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💦️change-equipment-gain-latent-fraction/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💦️change-equipment-gain-latent-fraction/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💦️change-equipment-gain-latent-fraction/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💦️change-equipment-gain-latent-fraction/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_equipment_gain_latent_fraction(crate::model::EntityId(40), -0.5))
}

fn case() -> Case {
    Case { kind: "change-equipment-gain-latent-fraction", directory: "💦️change-equipment-gain-latent-fraction/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
