//! 🧪️ `change-model-version` fixture — `✅️bumps-the-version`: bumps the version to 2.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/✅️bumps-the-version/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/✅️bumps-the-version/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/✅️bumps-the-version/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/✅️bumps-the-version/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️change-model-version/✅️bumps-the-version/🎯️outcome/🔣️.json");

#[allow(unused_variables, unused_mut)]
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    let model = crate::model::Model { name: "BESTEST 600".into(), version: "1".into(), ..crate::model::Model::default() };
    (snapshot(model), super::change_model_version("2".into()))
}

fn case() -> Case {
    Case { kind: "change-model-version", directory: "🔢️change-model-version/✅️bumps-the-version", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
