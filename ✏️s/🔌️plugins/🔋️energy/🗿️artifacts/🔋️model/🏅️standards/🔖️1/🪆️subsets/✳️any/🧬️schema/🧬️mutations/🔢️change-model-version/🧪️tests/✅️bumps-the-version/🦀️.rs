...
fn case() -> Case {
    Case { kind: "change-model-version", directory: "🔢️change-model-version/🧪️tests/✅️bumps-the-version", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
