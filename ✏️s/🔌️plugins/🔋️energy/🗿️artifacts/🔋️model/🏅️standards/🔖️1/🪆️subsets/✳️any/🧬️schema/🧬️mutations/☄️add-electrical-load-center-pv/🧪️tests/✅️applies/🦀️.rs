//! 🧪️ `add-electrical-load-center-pv` fixture — `✅️applies`: moves electrical load center 320's membership.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/☄️add-electrical-load-center-pv/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::add_electrical_load_center_pv(crate::model::EntityId(320), 1, crate::model::EntityId(301)))
}

fn case() -> Case {
    Case { kind: "add-electrical-load-center-pv", directory: "☄️add-electrical-load-center-pv/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
