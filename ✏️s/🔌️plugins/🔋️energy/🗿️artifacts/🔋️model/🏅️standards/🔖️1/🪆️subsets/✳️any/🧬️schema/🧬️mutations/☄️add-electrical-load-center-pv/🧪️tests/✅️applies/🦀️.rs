...
fn case() -> Case {
    Case { kind: "add-electrical-load-center-pv", directory: "☄️add-electrical-load-center-pv/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
