...
fn case() -> Case {
    Case { kind: "rename-model", directory: "🏷️rename-model/🧪️tests/⛔️refuses-a-blank-name", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
