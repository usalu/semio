...
fn case() -> Case {
    Case { kind: "reorder-annual-schedule-rules", directory: "🗂️reorder-annual-schedule-rules/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
