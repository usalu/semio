//! 🧪️ `reorder-annual-schedule-rules` fixture — `✅️applies`: gives the summer rule precedence.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️reorder-annual-schedule-rules/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️reorder-annual-schedule-rules/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️reorder-annual-schedule-rules/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️reorder-annual-schedule-rules/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗂️reorder-annual-schedule-rules/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "reorder-annual-schedule-rules", directory: "🗂️reorder-annual-schedule-rules/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
