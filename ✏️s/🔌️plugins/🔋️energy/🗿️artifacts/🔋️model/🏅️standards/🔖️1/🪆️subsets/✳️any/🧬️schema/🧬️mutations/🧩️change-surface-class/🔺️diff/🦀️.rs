//! 🔺️ Sparse diff builder for `ChangeSurfaceClass` — the artifact's delta is built straight from the
...
//#region 🔖️Diff
pub fn diff(payload: &super::ChangeSurfaceClass, base: &EnergyModelSnapshot) -> protocol::MutationOutcome<EnergyModelDiff> {
