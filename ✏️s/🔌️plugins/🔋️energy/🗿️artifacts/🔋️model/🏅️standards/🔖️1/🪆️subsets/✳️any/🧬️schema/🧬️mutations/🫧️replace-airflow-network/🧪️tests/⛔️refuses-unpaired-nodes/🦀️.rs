//! 🧪️ `replace-airflow-network` fixture — `⛔️refuses-unpaired-nodes`: refuses unpaired zone and node ids.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/⛔️refuses-unpaired-nodes/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/⛔️refuses-unpaired-nodes/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/⛔️refuses-unpaired-nodes/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/⛔️refuses-unpaired-nodes/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫧️replace-airflow-network/⛔️refuses-unpaired-nodes/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "replace-airflow-network", directory: "🫧️replace-airflow-network/⛔️refuses-unpaired-nodes", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
