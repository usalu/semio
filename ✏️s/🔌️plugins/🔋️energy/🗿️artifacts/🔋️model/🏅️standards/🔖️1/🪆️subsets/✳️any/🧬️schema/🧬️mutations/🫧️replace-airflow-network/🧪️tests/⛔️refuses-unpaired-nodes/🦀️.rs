...
fn case() -> Case {
    Case { kind: "replace-airflow-network", directory: "🫧️replace-airflow-network/🧪️tests/⛔️refuses-unpaired-nodes", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
