//! 🧪️ `change-surface-sun-exposed` fixture — `✅️shades-a-wall`: takes the wall out of the sun.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌅️change-surface-sun-exposed/✅️shades-a-wall/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌅️change-surface-sun-exposed/✅️shades-a-wall/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌅️change-surface-sun-exposed/✅️shades-a-wall/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌅️change-surface-sun-exposed/✅️shades-a-wall/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌅️change-surface-sun-exposed/✅️shades-a-wall/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-sun-exposed", directory: "🌅️change-surface-sun-exposed/✅️shades-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
