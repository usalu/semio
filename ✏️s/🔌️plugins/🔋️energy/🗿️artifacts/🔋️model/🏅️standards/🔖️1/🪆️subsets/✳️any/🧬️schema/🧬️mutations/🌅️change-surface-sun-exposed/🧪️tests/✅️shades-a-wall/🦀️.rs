...
fn case() -> Case {
    Case { kind: "change-surface-sun-exposed", directory: "🌅️change-surface-sun-exposed/🧪️tests/✅️shades-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
