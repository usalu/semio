//! 🧪️ `add-output-variable` fixture — `⛔️refuses-a-duplicate`: refuses a duplicate registration.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️add-output-variable/⛔️refuses-a-duplicate/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️add-output-variable/⛔️refuses-a-duplicate/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️add-output-variable/⛔️refuses-a-duplicate/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️add-output-variable/⛔️refuses-a-duplicate/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📊️add-output-variable/⛔️refuses-a-duplicate/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "add-output-variable", directory: "📊️add-output-variable/⛔️refuses-a-duplicate", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
