...
fn case() -> Case {
    Case { kind: "add-output-variable", directory: "📊️add-output-variable/🧪️tests/⛔️refuses-a-duplicate", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
