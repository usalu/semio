//! 🧪️ `change-refrigeration-system-case-count` fixture — `⛔️refuses`: refuses a zero display case count.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_refrigeration_system_case_count(crate::model::EntityId(420), 0))
}

fn case() -> Case {
    Case { kind: "change-refrigeration-system-case-count", directory: "🗄️change-refrigeration-system-case-count/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
