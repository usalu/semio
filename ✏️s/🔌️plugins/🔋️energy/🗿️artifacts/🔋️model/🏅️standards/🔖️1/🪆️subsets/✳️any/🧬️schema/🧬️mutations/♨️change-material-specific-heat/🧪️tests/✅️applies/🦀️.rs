//! 🧪️ `change-material-specific-heat` fixture — `✅️applies`: moves material 1.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♨️change-material-specific-heat/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_material_specific_heat(crate::model::EntityId(1), 1000.0))
}

fn case() -> Case {
    Case { kind: "change-material-specific-heat", directory: "♨️change-material-specific-heat/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
