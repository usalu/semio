...
fn case() -> Case {
    Case { kind: "change-material-specific-heat", directory: "♨️change-material-specific-heat/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
