...
fn case() -> Case {
    Case { kind: "change-zone-conditioned", directory: "🌬️change-zone-conditioned/🧪️tests/✅️frees-the-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
