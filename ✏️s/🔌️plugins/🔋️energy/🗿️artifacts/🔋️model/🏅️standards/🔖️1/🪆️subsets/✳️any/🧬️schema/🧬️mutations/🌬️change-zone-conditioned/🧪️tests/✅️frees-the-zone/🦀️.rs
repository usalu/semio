//! 🧪️ `change-zone-conditioned` fixture — `✅️frees-the-zone`: turns the zone free-floating.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/✅️frees-the-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/✅️frees-the-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/✅️frees-the-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/✅️frees-the-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/✅️frees-the-zone/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-zone-conditioned", directory: "🌬️change-zone-conditioned/✅️frees-the-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
