//! 🧪️ `change-room-air-model` fixture — `✅️stratifies-the-air`: swaps the well-mixed model for a two-node one.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/✅️stratifies-the-air/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/✅️stratifies-the-air/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/✅️stratifies-the-air/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/✅️stratifies-the-air/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪭️change-room-air-model/✅️stratifies-the-air/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_room_air_model(crate::model::EntityId(1), crate::model::RoomAirModelType::TwoNodeBuoyancy))
}

fn case() -> Case {
    Case { kind: "change-room-air-model", directory: "🪭️change-room-air-model/✅️stratifies-the-air", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
