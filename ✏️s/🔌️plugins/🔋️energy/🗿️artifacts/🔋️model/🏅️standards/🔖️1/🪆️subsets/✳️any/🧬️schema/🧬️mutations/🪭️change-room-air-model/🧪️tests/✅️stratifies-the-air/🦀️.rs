...
fn case() -> Case {
    Case { kind: "change-room-air-model", directory: "🪭️change-room-air-model/🧪️tests/✅️stratifies-the-air", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
