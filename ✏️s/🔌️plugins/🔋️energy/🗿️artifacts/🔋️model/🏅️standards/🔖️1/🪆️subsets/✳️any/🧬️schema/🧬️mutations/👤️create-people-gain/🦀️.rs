...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for CreatePeopleGain {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create People Gain {} at index {}", self.id.0, self.index), &format!("Personenwärmegewinn {} an Index {} erstellen", self.id.0, self.index))
    }
