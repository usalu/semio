...
fn case() -> Case {
    Case {
        kind: "change-thermostat-cooling-setpoint-schedule", directory: "🐧️change-thermostat-cooling-setpoint-schedule/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
