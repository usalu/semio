//! 🧪️ `change-shw-system-storage-volume` fixture — `✅️applies`: moves service hot water system 400.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛢️change-shw-system-storage-volume/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛢️change-shw-system-storage-volume/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛢️change-shw-system-storage-volume/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛢️change-shw-system-storage-volume/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛢️change-shw-system-storage-volume/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_shw_system_storage_volume(crate::model::EntityId(400), 0.2))
}

fn case() -> Case {
    Case { kind: "change-shw-system-storage-volume", directory: "🛢️change-shw-system-storage-volume/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
