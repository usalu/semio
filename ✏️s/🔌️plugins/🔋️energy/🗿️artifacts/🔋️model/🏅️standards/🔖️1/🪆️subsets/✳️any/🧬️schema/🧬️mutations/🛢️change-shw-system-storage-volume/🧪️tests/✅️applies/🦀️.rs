...
fn case() -> Case {
    Case { kind: "change-shw-system-storage-volume", directory: "🛢️change-shw-system-storage-volume/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
