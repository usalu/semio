...
fn case() -> Case {
    Case { kind: "delete-space", directory: "🧹️delete-space/🧪️tests/⛔️refuses-a-missing-space", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
