//! 🧪️ `delete-space` fixture — `⛔️refuses-a-missing-space`: refuses an absent space.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/⛔️refuses-a-missing-space/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/⛔️refuses-a-missing-space/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/⛔️refuses-a-missing-space/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/⛔️refuses-a-missing-space/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-space/⛔️refuses-a-missing-space/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-space", directory: "🧹️delete-space/⛔️refuses-a-missing-space", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
