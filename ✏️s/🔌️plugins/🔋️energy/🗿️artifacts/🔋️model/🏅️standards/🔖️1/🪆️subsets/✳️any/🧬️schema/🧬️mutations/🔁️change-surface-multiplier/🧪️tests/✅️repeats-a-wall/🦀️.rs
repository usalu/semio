//! 🧪️ `change-surface-multiplier` fixture — `✅️repeats-a-wall`: repeats the wall four times.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/✅️repeats-a-wall/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/✅️repeats-a-wall/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/✅️repeats-a-wall/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/✅️repeats-a-wall/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️change-surface-multiplier/✅️repeats-a-wall/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-multiplier", directory: "🔁️change-surface-multiplier/✅️repeats-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
