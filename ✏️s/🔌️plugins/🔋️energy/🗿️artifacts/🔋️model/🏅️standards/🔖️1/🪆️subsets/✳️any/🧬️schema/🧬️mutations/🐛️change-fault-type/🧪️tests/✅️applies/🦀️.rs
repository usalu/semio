...
fn case() -> Case {
    Case { kind: "change-fault-type", directory: "🐛️change-fault-type/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
