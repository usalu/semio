...
fn case() -> Case {
    Case { kind: "update-site", directory: "🌍️update-site/🧪️tests/⛔️refuses-a-bad-latitude", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
