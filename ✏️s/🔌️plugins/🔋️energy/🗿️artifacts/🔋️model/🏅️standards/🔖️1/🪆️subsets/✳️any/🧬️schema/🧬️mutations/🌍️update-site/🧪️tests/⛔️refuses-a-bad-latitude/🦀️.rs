//! 🧪️ `update-site` fixture — `⛔️refuses-a-bad-latitude`: refuses an impossible latitude.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/⛔️refuses-a-bad-latitude/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/⛔️refuses-a-bad-latitude/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/⛔️refuses-a-bad-latitude/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/⛔️refuses-a-bad-latitude/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌍️update-site/⛔️refuses-a-bad-latitude/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "update-site", directory: "🌍️update-site/⛔️refuses-a-bad-latitude", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
