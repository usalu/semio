...
fn case() -> Case {
    Case { kind: "change-fault-start-schedule", directory: "🕓️change-fault-start-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
