...
fn case() -> Case {
    Case { kind: "create-lighting-gain", directory: "💡️create-lighting-gain/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
