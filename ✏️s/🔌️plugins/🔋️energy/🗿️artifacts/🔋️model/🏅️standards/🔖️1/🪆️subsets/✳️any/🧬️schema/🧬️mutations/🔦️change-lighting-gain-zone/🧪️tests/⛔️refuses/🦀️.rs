...
fn case() -> Case {
    Case { kind: "change-lighting-gain-zone", directory: "🔦️change-lighting-gain-zone/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
