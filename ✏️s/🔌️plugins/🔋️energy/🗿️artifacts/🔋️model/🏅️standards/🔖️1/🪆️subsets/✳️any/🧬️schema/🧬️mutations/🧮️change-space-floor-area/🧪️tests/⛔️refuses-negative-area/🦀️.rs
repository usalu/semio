...
fn case() -> Case {
    Case { kind: "change-space-floor-area", directory: "🧮️change-space-floor-area/🧪️tests/⛔️refuses-negative-area", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
