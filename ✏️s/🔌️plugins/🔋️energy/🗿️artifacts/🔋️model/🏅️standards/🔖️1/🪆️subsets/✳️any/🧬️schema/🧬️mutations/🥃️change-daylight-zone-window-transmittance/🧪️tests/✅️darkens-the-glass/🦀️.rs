//! 🧪️ `change-daylight-zone-window-transmittance` fixture — `✅️darkens-the-glass`: darkens the glazing the control sees.
//!
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_daylight_zone_window_transmittance(crate::model::EntityId(14), 0.5))
}
