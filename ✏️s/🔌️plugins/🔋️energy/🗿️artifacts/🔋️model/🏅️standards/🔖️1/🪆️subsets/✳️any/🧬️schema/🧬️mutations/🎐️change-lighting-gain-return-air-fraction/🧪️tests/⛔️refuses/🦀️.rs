//! 🧪️ `change-lighting-gain-return-air-fraction` fixture — `⛔️refuses`: refuses return-air fraction outside a fraction in [0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎐️change-lighting-gain-return-air-fraction/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_lighting_gain_return_air_fraction(crate::model::EntityId(30), 1.8))
}

fn case() -> Case {
    Case { kind: "change-lighting-gain-return-air-fraction", directory: "🎐️change-lighting-gain-return-air-fraction/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
