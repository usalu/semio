...
fn case() -> Case {
    Case { kind: "change-lighting-gain-return-air-fraction", directory: "🎐️change-lighting-gain-return-air-fraction/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
