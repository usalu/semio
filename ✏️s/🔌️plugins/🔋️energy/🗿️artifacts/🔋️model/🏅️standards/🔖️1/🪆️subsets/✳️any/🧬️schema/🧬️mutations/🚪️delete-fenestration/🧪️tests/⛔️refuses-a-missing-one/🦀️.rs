//! 🧪️ `delete-fenestration` fixture — `⛔️refuses-a-missing-one`: refuses an absent fenestration.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/⛔️refuses-a-missing-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/⛔️refuses-a-missing-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/⛔️refuses-a-missing-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/⛔️refuses-a-missing-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚪️delete-fenestration/⛔️refuses-a-missing-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_fenestration(crate::model::EntityId(9)))
}

fn case() -> Case {
    Case { kind: "delete-fenestration", directory: "🚪️delete-fenestration/⛔️refuses-a-missing-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
