...
fn case() -> Case {
    Case { kind: "delete-fenestration", directory: "🚪️delete-fenestration/🧪️tests/⛔️refuses-a-missing-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
