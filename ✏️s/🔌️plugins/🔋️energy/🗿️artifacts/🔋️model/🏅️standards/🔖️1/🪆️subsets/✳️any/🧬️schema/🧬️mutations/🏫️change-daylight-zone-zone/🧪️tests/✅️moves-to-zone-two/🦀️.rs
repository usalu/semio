...
fn case() -> Case {
    Case { kind: "change-daylight-zone-zone", directory: "🏫️change-daylight-zone-zone/🧪️tests/✅️moves-to-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
