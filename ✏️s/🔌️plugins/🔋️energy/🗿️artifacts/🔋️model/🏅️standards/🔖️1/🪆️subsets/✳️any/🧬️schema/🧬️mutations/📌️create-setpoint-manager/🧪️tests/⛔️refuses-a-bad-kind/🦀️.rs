...
fn case() -> Case {
    Case { kind: "create-setpoint-manager", directory: "📌️create-setpoint-manager/🧪️tests/⛔️refuses-a-bad-kind", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
