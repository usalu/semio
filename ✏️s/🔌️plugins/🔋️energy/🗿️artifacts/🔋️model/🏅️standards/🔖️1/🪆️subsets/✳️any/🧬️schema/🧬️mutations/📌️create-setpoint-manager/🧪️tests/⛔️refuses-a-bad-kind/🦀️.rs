//! 🧪️ `create-setpoint-manager` fixture — `⛔️refuses-a-bad-kind`: refuses a setpoint manager kind that does not exist.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/⛔️refuses-a-bad-kind/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/⛔️refuses-a-bad-kind/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/⛔️refuses-a-bad-kind/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/⛔️refuses-a-bad-kind/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️create-setpoint-manager/⛔️refuses-a-bad-kind/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_setpoint_manager(crate::model::EntityId(16), "SUPPLY SPM".to_string(), "Sunny".to_string(), 0.0, 0.0, 0.0, 0.0, false, crate::model::ScheduleId(0)))
}

fn case() -> Case {
    Case { kind: "create-setpoint-manager", directory: "📌️create-setpoint-manager/⛔️refuses-a-bad-kind", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
