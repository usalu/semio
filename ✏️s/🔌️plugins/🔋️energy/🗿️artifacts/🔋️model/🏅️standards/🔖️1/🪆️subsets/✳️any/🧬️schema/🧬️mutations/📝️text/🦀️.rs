//! 📝️ Energy-model mutation text framing and direct-owner registry.
...
pub const TEXT_OPCODE_REGISTRY: &[(&str, &str)] = &[("ReplaceModel", super::replace_model::text::TEXT_OPCODE)];
