...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for CreateTimeSeriesSchedule {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create Time Series Schedule {} at index {}", self.id.0, self.index), &format!("Zeitreihenzeitplan {} an Index {} erstellen", self.id.0, self.index))
    }
