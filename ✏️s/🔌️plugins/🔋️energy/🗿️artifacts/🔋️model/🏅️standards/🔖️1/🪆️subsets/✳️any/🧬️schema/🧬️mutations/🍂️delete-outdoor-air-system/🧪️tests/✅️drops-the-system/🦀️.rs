//! 🧪️ `delete-outdoor-air-system` fixture — `✅️drops-the-system`: drops the outdoor air system.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍂️delete-outdoor-air-system/✅️drops-the-system/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍂️delete-outdoor-air-system/✅️drops-the-system/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍂️delete-outdoor-air-system/✅️drops-the-system/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍂️delete-outdoor-air-system/✅️drops-the-system/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍂️delete-outdoor-air-system/✅️drops-the-system/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_outdoor_air_system(crate::model::EntityId(19)))
}

fn case() -> Case {
    Case { kind: "delete-outdoor-air-system", directory: "🍂️delete-outdoor-air-system/✅️drops-the-system", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
