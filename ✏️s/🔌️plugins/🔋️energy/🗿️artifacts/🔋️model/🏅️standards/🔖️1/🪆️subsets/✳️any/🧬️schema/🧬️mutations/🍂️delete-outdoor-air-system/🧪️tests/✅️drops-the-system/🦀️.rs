...
fn case() -> Case {
    Case { kind: "delete-outdoor-air-system", directory: "🍂️delete-outdoor-air-system/🧪️tests/✅️drops-the-system", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
