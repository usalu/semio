...
fn case() -> Case {
    Case { kind: "change-plant-loop-return-temperature", directory: "🫖️change-plant-loop-return-temperature/🧪️tests/✅️cools-the-return", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
