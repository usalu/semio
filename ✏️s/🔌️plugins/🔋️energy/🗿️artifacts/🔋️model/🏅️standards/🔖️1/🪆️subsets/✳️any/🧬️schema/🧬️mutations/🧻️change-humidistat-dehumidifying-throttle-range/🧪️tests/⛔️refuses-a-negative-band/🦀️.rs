...
fn case() -> Case {
    Case { kind: "change-humidistat-dehumidifying-throttle-range", directory: "🧻️change-humidistat-dehumidifying-throttle-range/🧪️tests/⛔️refuses-a-negative-band", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
