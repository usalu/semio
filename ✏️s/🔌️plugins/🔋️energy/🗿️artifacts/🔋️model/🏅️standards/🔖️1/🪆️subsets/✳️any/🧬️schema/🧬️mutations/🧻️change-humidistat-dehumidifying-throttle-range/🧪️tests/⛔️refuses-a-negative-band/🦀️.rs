//! 🧪️ `change-humidistat-dehumidifying-throttle-range` fixture — `⛔️refuses-a-negative-band`: refuses a negative band.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/⛔️refuses-a-negative-band/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/⛔️refuses-a-negative-band/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/⛔️refuses-a-negative-band/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/⛔️refuses-a-negative-band/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/⛔️refuses-a-negative-band/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_humidistat_dehumidifying_throttle_range(crate::model::EntityId(11), -2.0))
}

fn case() -> Case {
    Case {
        kind: "change-humidistat-dehumidifying-throttle-range",
        directory: "🧻️change-humidistat-dehumidifying-throttle-range/⛔️refuses-a-negative-band",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
