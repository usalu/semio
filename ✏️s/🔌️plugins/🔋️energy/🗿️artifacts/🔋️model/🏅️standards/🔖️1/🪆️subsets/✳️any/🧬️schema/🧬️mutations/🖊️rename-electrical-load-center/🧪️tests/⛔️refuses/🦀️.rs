...
fn case() -> Case {
    Case { kind: "rename-electrical-load-center", directory: "🖊️rename-electrical-load-center/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
