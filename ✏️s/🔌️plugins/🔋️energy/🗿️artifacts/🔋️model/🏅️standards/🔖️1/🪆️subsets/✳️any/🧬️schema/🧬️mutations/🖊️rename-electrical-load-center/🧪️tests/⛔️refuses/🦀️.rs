//! 🧪️ `rename-electrical-load-center` fixture — `⛔️refuses`: refuses a name a sibling already holds.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::rename_electrical_load_center(crate::model::EntityId(320), "SUB PANEL".to_string()))
}

fn case() -> Case {
    Case { kind: "rename-electrical-load-center", directory: "🖊️rename-electrical-load-center/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
