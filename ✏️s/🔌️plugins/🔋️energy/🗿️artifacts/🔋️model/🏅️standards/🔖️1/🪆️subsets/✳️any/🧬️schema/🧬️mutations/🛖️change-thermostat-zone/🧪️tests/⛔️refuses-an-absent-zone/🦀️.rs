...
fn case() -> Case {
    Case { kind: "change-thermostat-zone", directory: "🛖️change-thermostat-zone/🧪️tests/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
