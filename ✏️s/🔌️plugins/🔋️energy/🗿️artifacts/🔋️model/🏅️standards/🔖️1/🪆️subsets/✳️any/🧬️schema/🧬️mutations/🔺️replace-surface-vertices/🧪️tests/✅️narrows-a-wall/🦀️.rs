...
fn case() -> Case {
    Case { kind: "replace-surface-vertices", directory: "🔺️replace-surface-vertices/🧪️tests/✅️narrows-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
