//! 🧪️ `replace-surface-vertices` fixture — `✅️narrows-a-wall`: narrows the wall to six metres.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔺️replace-surface-vertices/✅️narrows-a-wall/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔺️replace-surface-vertices/✅️narrows-a-wall/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔺️replace-surface-vertices/✅️narrows-a-wall/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔺️replace-surface-vertices/✅️narrows-a-wall/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔺️replace-surface-vertices/✅️narrows-a-wall/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "replace-surface-vertices", directory: "🔺️replace-surface-vertices/✅️narrows-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
