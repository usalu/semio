...
fn case() -> Case {
    Case { kind: "create-plant-loop", directory: "⚗️create-plant-loop/🧪️tests/✅️adds-a-hot-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
