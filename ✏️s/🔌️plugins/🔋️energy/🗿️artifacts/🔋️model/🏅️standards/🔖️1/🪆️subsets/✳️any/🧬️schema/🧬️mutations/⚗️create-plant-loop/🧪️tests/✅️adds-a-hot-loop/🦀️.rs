//! 🧪️ `create-plant-loop` fixture — `✅️adds-a-hot-loop`: adds a hot water plant loop.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚗️create-plant-loop/✅️adds-a-hot-loop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚗️create-plant-loop/✅️adds-a-hot-loop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚗️create-plant-loop/✅️adds-a-hot-loop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚗️create-plant-loop/✅️adds-a-hot-loop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚗️create-plant-loop/✅️adds-a-hot-loop/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_plant_loop(crate::model::EntityId(18), "HOT WATER LOOP".to_string(), crate::model::PlantLoopType::Heating, 80.0, 60.0, 2.0, Vec::new()))
}

fn case() -> Case {
    Case { kind: "create-plant-loop", directory: "⚗️create-plant-loop/✅️adds-a-hot-loop", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
