//! 🧪️ `update-run-period` fixture — `✅️shortens-to-january`: shortens the run period to January.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/✅️shortens-to-january/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/✅️shortens-to-january/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/✅️shortens-to-january/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/✅️shortens-to-january/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/✅️shortens-to-january/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "update-run-period", directory: "📅️update-run-period/✅️shortens-to-january", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
