...
fn case() -> Case {
    Case { kind: "update-run-period", directory: "📅️update-run-period/🧪️tests/✅️shortens-to-january", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
