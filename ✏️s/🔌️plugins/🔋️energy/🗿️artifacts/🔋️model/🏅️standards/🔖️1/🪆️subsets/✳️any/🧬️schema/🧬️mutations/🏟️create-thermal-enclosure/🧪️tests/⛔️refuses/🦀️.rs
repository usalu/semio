...
fn case() -> Case {
    Case { kind: "create-thermal-enclosure", directory: "🏟️create-thermal-enclosure/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
