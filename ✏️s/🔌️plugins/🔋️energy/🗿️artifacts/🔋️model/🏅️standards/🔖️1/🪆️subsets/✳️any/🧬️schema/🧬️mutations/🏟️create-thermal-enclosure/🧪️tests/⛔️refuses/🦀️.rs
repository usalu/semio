//! 🧪️ `create-thermal-enclosure` fixture — `⛔️refuses`: refuses an id the model already carries.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_thermal_enclosure(2, crate::model::EntityId(220), "ROOF BLOCK".into(), Vec::new()))
}

fn case() -> Case {
    Case { kind: "create-thermal-enclosure", directory: "🏟️create-thermal-enclosure/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
