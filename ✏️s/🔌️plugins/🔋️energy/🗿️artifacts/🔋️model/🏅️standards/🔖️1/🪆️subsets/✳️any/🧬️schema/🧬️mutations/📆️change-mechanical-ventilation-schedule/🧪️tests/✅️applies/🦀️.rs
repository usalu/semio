//! 🧪️ `change-mechanical-ventilation-schedule` fixture — `✅️applies`: moves mechanical ventilation 60.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📆️change-mechanical-ventilation-schedule/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📆️change-mechanical-ventilation-schedule/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📆️change-mechanical-ventilation-schedule/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📆️change-mechanical-ventilation-schedule/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📆️change-mechanical-ventilation-schedule/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_mechanical_ventilation_schedule(crate::model::EntityId(60), crate::model::ScheduleId(3)))
}

fn case() -> Case {
    Case { kind: "change-mechanical-ventilation-schedule", directory: "📆️change-mechanical-ventilation-schedule/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
