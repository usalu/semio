...
fn case() -> Case {
    Case { kind: "change-fenestration-area", directory: "🟥️change-fenestration-area/🧪️tests/⛔️refuses-zero-area", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
