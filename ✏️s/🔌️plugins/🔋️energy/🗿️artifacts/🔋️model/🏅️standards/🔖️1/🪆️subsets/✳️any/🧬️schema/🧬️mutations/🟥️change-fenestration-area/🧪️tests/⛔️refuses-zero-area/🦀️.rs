//! 🧪️ `change-fenestration-area` fixture — `⛔️refuses-zero-area`: refuses a zero area.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/⛔️refuses-zero-area/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/⛔️refuses-zero-area/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/⛔️refuses-zero-area/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/⛔️refuses-zero-area/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/⛔️refuses-zero-area/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_area(crate::model::EntityId(5), 0.0))
}

fn case() -> Case {
    Case { kind: "change-fenestration-area", directory: "🟥️change-fenestration-area/⛔️refuses-zero-area", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
