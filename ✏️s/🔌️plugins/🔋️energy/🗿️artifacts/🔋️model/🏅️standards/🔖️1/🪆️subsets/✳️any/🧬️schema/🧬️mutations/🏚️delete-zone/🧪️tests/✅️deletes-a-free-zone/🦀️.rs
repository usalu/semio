//! 🧪️ `delete-zone` fixture — `✅️deletes-a-free-zone`: deletes a zone nothing references.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/✅️deletes-a-free-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/✅️deletes-a-free-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/✅️deletes-a-free-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/✅️deletes-a-free-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏚️delete-zone/✅️deletes-a-free-zone/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-zone", directory: "🏚️delete-zone/✅️deletes-a-free-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
