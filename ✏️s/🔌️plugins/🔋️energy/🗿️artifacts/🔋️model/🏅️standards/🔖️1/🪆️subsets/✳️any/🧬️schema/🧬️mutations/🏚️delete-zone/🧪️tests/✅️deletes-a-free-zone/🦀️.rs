...
fn case() -> Case {
    Case { kind: "delete-zone", directory: "🏚️delete-zone/🧪️tests/✅️deletes-a-free-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
