//! 🧪️ `change-fenestration-height` fixture — `✅️raises-the-head`: raises the window head.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/✅️raises-the-head/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/✅️raises-the-head/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/✅️raises-the-head/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/✅️raises-the-head/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬆️change-fenestration-height/✅️raises-the-head/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_height(crate::model::EntityId(5), 2.4))
}

fn case() -> Case {
    Case { kind: "change-fenestration-height", directory: "⬆️change-fenestration-height/✅️raises-the-head", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
