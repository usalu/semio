...
fn case() -> Case {
    Case { kind: "change-fenestration-height", directory: "⬆️change-fenestration-height/🧪️tests/✅️raises-the-head", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
