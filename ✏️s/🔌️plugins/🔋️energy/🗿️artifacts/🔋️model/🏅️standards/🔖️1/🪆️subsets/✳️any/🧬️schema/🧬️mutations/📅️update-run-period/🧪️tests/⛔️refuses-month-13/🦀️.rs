//! 🧪️ `update-run-period` fixture — `⛔️refuses-month-13`: refuses a thirteenth month.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/⛔️refuses-month-13/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/⛔️refuses-month-13/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/⛔️refuses-month-13/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/⛔️refuses-month-13/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📅️update-run-period/⛔️refuses-month-13/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "update-run-period", directory: "📅️update-run-period/⛔️refuses-month-13", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
