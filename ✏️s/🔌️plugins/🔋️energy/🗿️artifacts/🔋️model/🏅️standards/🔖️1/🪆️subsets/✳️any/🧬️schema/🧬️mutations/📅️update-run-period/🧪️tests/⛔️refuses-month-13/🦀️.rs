...
fn case() -> Case {
    Case { kind: "update-run-period", directory: "📅️update-run-period/🧪️tests/⛔️refuses-month-13", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
