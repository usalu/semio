//! 🧪️ `change-fenestration-u-value` fixture — `⛔️refuses-zero-u`: refuses a zero U-value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/⛔️refuses-zero-u/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/⛔️refuses-zero-u/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/⛔️refuses-zero-u/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/⛔️refuses-zero-u/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌐️change-fenestration-u-value/⛔️refuses-zero-u/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_u_value(crate::model::EntityId(5), 0.0))
}

fn case() -> Case {
    Case { kind: "change-fenestration-u-value", directory: "🌐️change-fenestration-u-value/⛔️refuses-zero-u", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
