//! 🧪️ `change-sizing-object-design-day-type` fixture — `✅️reads-a-hot-day`: reads the cooling design day instead.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌥️change-sizing-object-design-day-type/✅️reads-a-hot-day/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌥️change-sizing-object-design-day-type/✅️reads-a-hot-day/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌥️change-sizing-object-design-day-type/✅️reads-a-hot-day/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌥️change-sizing-object-design-day-type/✅️reads-a-hot-day/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌥️change-sizing-object-design-day-type/✅️reads-a-hot-day/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_sizing_object_design_day_type(crate::model::EntityId(15), crate::model::DesignDayType::Cooling))
}

fn case() -> Case {
    Case { kind: "change-sizing-object-design-day-type", directory: "🌥️change-sizing-object-design-day-type/✅️reads-a-hot-day", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
