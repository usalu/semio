...
fn case() -> Case {
    Case { kind: "change-sizing-object-design-day-type", directory: "🌥️change-sizing-object-design-day-type/🧪️tests/✅️reads-a-hot-day", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
