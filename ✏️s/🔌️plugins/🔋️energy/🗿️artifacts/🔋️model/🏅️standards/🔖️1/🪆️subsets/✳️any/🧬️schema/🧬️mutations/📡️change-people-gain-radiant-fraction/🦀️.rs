...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangePeopleGainRadiantFraction {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change People Gain Radiant Fraction of people gain {}", self.id.0), &format!("strahlende Personengewinnanteil von Personengewinn {} ändern", self.id.0))
    }
