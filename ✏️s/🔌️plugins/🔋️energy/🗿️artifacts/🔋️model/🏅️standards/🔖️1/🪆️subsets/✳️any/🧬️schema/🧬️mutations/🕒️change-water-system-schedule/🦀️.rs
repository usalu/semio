...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeWaterSystemSchedule {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Water System Schedule of water system {}", self.id.0), &format!("Wassersystemzeitplan von Wassersystem {} ändern", self.id.0))
    }
