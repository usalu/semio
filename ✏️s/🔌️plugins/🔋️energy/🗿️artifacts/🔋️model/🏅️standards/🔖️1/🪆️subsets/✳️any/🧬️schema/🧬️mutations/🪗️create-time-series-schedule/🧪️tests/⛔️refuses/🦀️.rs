...
fn case() -> Case {
    Case { kind: "create-time-series-schedule", directory: "🪗️create-time-series-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
