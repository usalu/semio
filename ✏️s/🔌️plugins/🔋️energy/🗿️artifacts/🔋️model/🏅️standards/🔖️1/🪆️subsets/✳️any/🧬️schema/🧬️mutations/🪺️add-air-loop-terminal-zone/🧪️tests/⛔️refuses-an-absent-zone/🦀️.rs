//! 🧪️ `add-air-loop-terminal-zone` fixture — `⛔️refuses-an-absent-zone`: refuses a zone that does not exist.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/⛔️refuses-an-absent-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/⛔️refuses-an-absent-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/⛔️refuses-an-absent-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/⛔️refuses-an-absent-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪺️add-air-loop-terminal-zone/⛔️refuses-an-absent-zone/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::add_air_loop_terminal_zone(crate::model::EntityId(17), crate::model::EntityId(99)))
}

fn case() -> Case {
    Case { kind: "add-air-loop-terminal-zone", directory: "🪺️add-air-loop-terminal-zone/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
