...
fn case() -> Case {
    Case { kind: "add-air-loop-terminal-zone", directory: "🪺️add-air-loop-terminal-zone/🧪️tests/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
