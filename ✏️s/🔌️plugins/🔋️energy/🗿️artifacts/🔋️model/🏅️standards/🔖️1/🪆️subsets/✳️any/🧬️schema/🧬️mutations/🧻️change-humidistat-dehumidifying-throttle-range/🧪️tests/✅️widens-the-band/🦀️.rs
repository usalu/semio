//! 🧪️ `change-humidistat-dehumidifying-throttle-range` fixture — `✅️widens-the-band`: widens the dehumidifying band.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/✅️widens-the-band/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/✅️widens-the-band/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/✅️widens-the-band/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/✅️widens-the-band/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧻️change-humidistat-dehumidifying-throttle-range/✅️widens-the-band/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case {
        kind: "change-humidistat-dehumidifying-throttle-range", directory: "🧻️change-humidistat-dehumidifying-throttle-range/✅️widens-the-band", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
