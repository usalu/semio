...
fn case() -> Case {
    Case { kind: "change-material-conductivity", directory: "🔥️change-material-conductivity/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
