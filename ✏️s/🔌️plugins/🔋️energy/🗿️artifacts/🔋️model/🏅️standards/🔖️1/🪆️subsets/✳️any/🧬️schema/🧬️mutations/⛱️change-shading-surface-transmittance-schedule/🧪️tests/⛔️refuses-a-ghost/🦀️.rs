...
fn case() -> Case {
    Case { kind: "change-shading-surface-transmittance-schedule", directory: "⛱️change-shading-surface-transmittance-schedule/🧪️tests/⛔️refuses-a-ghost", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
