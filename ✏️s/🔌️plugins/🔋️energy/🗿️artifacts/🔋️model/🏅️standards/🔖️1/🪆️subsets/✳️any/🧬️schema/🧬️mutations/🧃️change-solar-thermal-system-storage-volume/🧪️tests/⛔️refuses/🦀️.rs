//! 🧪️ `change-solar-thermal-system-storage-volume` fixture — `⛔️refuses`: refuses buffer volume (m³) outside a positive finite value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧃️change-solar-thermal-system-storage-volume/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_solar_thermal_system_storage_volume(crate::model::EntityId(410), -2.0))
}

fn case() -> Case {
    Case { kind: "change-solar-thermal-system-storage-volume", directory: "🧃️change-solar-thermal-system-storage-volume/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
