...
fn case() -> Case {
    Case { kind: "change-solar-thermal-system-storage-volume", directory: "🧃️change-solar-thermal-system-storage-volume/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
