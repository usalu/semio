//! 🧪️ `change-fenestration-sill-height` fixture — `⛔️refuses-negative-sill`: refuses a negative sill height.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/⛔️refuses-negative-sill/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/⛔️refuses-negative-sill/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/⛔️refuses-negative-sill/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/⛔️refuses-negative-sill/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⬇️change-fenestration-sill-height/⛔️refuses-negative-sill/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_sill_height(crate::model::EntityId(5), -0.2))
}

fn case() -> Case {
    Case { kind: "change-fenestration-sill-height", directory: "⬇️change-fenestration-sill-height/⛔️refuses-negative-sill", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
