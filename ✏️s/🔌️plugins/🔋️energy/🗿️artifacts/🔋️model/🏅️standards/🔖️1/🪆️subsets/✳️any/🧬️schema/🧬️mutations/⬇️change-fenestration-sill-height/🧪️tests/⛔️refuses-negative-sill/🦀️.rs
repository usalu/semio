...
fn case() -> Case {
    Case { kind: "change-fenestration-sill-height", directory: "⬇️change-fenestration-sill-height/🧪️tests/⛔️refuses-negative-sill", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
