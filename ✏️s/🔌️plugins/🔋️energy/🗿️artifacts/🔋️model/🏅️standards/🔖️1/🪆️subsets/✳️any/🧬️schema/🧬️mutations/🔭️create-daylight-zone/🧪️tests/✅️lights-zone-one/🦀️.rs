//! 🧪️ `create-daylight-zone` fixture — `✅️lights-zone-one`: daylights the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/✅️lights-zone-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/✅️lights-zone-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/✅️lights-zone-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/✅️lights-zone-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/✅️lights-zone-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_daylight_zone(crate::model::EntityId(14), crate::model::EntityId(1), 500.0, 22.0, 0.6))
}

fn case() -> Case {
    Case { kind: "create-daylight-zone", directory: "🔭️create-daylight-zone/✅️lights-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
