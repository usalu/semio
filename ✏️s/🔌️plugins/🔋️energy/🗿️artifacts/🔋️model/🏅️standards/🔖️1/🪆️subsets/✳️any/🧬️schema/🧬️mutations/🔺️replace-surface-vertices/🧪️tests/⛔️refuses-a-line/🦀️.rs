...
fn case() -> Case {
    Case { kind: "replace-surface-vertices", directory: "🔺️replace-surface-vertices/🧪️tests/⛔️refuses-a-line", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
