...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeInfiltrationDischargeCoefficient {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Infiltration Discharge Coefficient of infiltration {}", self.id.0), &format!("Infiltrationsabgabenkoeffizient von Infiltration {} ändern", self.id.0))
    }
