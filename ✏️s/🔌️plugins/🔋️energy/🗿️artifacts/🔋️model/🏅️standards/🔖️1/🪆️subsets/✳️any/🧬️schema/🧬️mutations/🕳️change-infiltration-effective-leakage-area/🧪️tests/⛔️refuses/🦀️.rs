//! 🧪️ `change-infiltration-effective-leakage-area` fixture — `⛔️refuses`: refuses effective leakage area (m²) outside a finite non-negative value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_infiltration_effective_leakage_area(crate::model::EntityId(50), -0.01))
}

fn case() -> Case {
    Case { kind: "change-infiltration-effective-leakage-area", directory: "🕳️change-infiltration-effective-leakage-area/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
