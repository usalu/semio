...
fn case() -> Case {
    Case { kind: "change-infiltration-effective-leakage-area", directory: "🕳️change-infiltration-effective-leakage-area/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
