...
fn case() -> Case {
    Case { kind: "create-shading-surface", directory: "🌳️create-shading-surface/🧪️tests/✅️adds-an-awning", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
