//! 🧪️ `create-shading-surface` fixture — `✅️adds-an-awning`: adds a site awning.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌳️create-shading-surface/✅️adds-an-awning/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌳️create-shading-surface/✅️adds-an-awning/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌳️create-shading-surface/✅️adds-an-awning/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌳️create-shading-surface/✅️adds-an-awning/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌳️create-shading-surface/✅️adds-an-awning/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-shading-surface", directory: "🌳️create-shading-surface/✅️adds-an-awning", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
