...
fn case() -> Case {
    Case { kind: "change-shw-system-setpoint", directory: "🏹️change-shw-system-setpoint/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
