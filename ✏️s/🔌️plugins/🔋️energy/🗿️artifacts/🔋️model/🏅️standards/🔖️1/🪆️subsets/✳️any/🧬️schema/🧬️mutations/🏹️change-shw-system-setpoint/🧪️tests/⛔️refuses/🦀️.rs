//! 🧪️ `change-shw-system-setpoint` fixture — `⛔️refuses`: refuses tank setpoint (°C) outside a liquid-water temperature in [0, 100] °C.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏹️change-shw-system-setpoint/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_shw_system_setpoint(crate::model::EntityId(400), 250.0))
}

fn case() -> Case {
    Case { kind: "change-shw-system-setpoint", directory: "🏹️change-shw-system-setpoint/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
