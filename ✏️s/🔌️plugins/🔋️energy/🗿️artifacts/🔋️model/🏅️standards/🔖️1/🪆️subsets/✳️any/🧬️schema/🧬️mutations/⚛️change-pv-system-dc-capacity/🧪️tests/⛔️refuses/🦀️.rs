//! 🧪️ `change-pv-system-dc-capacity` fixture — `⛔️refuses`: refuses DC capacity (W) outside a positive finite value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_pv_system_dc_capacity(crate::model::EntityId(300), 0.0))
}

fn case() -> Case {
    Case { kind: "change-pv-system-dc-capacity", directory: "⚛️change-pv-system-dc-capacity/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
