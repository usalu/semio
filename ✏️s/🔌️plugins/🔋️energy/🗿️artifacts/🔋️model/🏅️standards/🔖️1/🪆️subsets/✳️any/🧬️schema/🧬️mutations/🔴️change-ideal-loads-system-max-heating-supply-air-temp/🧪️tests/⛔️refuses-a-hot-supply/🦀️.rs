//! 🧪️ `change-ideal-loads-system-max-heating-supply-air-temp` fixture — `⛔️refuses-a-hot-supply`: refuses an unrepresentable supply temperature.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔴️change-ideal-loads-system-max-heating-supply-air-temp/⛔️refuses-a-hot-supply/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔴️change-ideal-loads-system-max-heating-supply-air-temp/⛔️refuses-a-hot-supply/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔴️change-ideal-loads-system-max-heating-supply-air-temp/⛔️refuses-a-hot-supply/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔴️change-ideal-loads-system-max-heating-supply-air-temp/⛔️refuses-a-hot-supply/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔴️change-ideal-loads-system-max-heating-supply-air-temp/⛔️refuses-a-hot-supply/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_ideal_loads_system_max_heating_supply_air_temp(crate::model::EntityId(12), 1000.0))
}

fn case() -> Case {
    Case {
        kind: "change-ideal-loads-system-max-heating-supply-air-temp",
        directory: "🔴️change-ideal-loads-system-max-heating-supply-air-temp/⛔️refuses-a-hot-supply",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
