...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for CreateDailySchedule {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Create Daily Schedule {} at index {}", self.id.0, self.index), &format!("Tageszeitplan {} an Index {} erstellen", self.id.0, self.index))
    }
