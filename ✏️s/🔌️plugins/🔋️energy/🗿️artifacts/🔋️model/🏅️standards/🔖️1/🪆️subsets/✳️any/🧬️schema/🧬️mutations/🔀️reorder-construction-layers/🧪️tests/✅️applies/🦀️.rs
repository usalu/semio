//! 🧪️ `reorder-construction-layers` fixture — `✅️applies`: turns the wall inside out.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀️reorder-construction-layers/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "reorder-construction-layers", directory: "🔀️reorder-construction-layers/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
