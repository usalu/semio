...
fn case() -> Case {
    Case { kind: "change-people-gain-latent-fraction", directory: "💧️change-people-gain-latent-fraction/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
