...
fn case() -> Case {
    Case { kind: "create-mechanical-ventilation", directory: "🌪️create-mechanical-ventilation/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
