//! 🧪️ `create-mechanical-ventilation` fixture — `✅️applies`: inserts a new mechanical ventilation.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌪️create-mechanical-ventilation/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌪️create-mechanical-ventilation/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌪️create-mechanical-ventilation/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌪️create-mechanical-ventilation/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌪️create-mechanical-ventilation/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_mechanical_ventilation(1, crate::model::EntityId(61), crate::model::EntityId(2), crate::model::ScheduleId(1), 0.08, 0.65, 250.0))
}

fn case() -> Case {
    Case { kind: "create-mechanical-ventilation", directory: "🌪️create-mechanical-ventilation/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
