...
fn case() -> Case {
    Case {
        kind: "change-outdoor-air-system-economizer-enabled", directory: "💰️change-outdoor-air-system-economizer-enabled/🧪️tests/⛔️refuses-an-absent-row", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
