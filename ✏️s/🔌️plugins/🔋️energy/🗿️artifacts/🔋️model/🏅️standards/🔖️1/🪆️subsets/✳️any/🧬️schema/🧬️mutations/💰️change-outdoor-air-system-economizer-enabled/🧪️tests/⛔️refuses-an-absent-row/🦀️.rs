//! 🧪️ `change-outdoor-air-system-economizer-enabled` fixture — `⛔️refuses-an-absent-row`: refuses an absent outdoor air system.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/⛔️refuses-an-absent-row/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/⛔️refuses-an-absent-row/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/⛔️refuses-an-absent-row/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/⛔️refuses-an-absent-row/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💰️change-outdoor-air-system-economizer-enabled/⛔️refuses-an-absent-row/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_outdoor_air_system_economizer_enabled(crate::model::EntityId(99), true))
}

fn case() -> Case {
    Case {
        kind: "change-outdoor-air-system-economizer-enabled", directory: "💰️change-outdoor-air-system-economizer-enabled/⛔️refuses-an-absent-row", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
