...
fn case() -> Case {
    Case { kind: "add-space-list-member", directory: "➡️add-space-list-member/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
