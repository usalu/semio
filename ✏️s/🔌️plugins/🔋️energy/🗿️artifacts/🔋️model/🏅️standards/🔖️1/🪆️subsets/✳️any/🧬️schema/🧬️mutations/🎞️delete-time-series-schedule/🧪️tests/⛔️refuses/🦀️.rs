...
fn case() -> Case {
    Case { kind: "delete-time-series-schedule", directory: "🎞️delete-time-series-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
