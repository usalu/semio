//! 🧪️ `delete-time-series-schedule` fixture — `⛔️refuses`: refuses while the document still resolves it.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️delete-time-series-schedule/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️delete-time-series-schedule/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️delete-time-series-schedule/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️delete-time-series-schedule/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️delete-time-series-schedule/⛔️refuses/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-time-series-schedule", directory: "🎞️delete-time-series-schedule/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
