...
fn case() -> Case {
    Case { kind: "change-material-thermal-absorptance", directory: "🔆️change-material-thermal-absorptance/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
