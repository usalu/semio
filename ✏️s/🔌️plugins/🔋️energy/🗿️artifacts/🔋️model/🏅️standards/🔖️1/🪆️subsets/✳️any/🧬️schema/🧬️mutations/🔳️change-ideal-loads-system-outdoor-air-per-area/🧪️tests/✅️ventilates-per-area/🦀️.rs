...
fn case() -> Case {
    Case { kind: "change-ideal-loads-system-outdoor-air-per-area", directory: "🔳️change-ideal-loads-system-outdoor-air-per-area/🧪️tests/✅️ventilates-per-area", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
