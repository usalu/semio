//! 🧪️ `change-ideal-loads-system-outdoor-air-per-area` fixture — `✅️ventilates-per-area`: draws outdoor air per floor area.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔳️change-ideal-loads-system-outdoor-air-per-area/✅️ventilates-per-area/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔳️change-ideal-loads-system-outdoor-air-per-area/✅️ventilates-per-area/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔳️change-ideal-loads-system-outdoor-air-per-area/✅️ventilates-per-area/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔳️change-ideal-loads-system-outdoor-air-per-area/✅️ventilates-per-area/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔳️change-ideal-loads-system-outdoor-air-per-area/✅️ventilates-per-area/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_ideal_loads_system_outdoor_air_per_area(crate::model::EntityId(12), 0.0003))
}

fn case() -> Case {
    Case {
        kind: "change-ideal-loads-system-outdoor-air-per-area", directory: "🔳️change-ideal-loads-system-outdoor-air-per-area/✅️ventilates-per-area", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
