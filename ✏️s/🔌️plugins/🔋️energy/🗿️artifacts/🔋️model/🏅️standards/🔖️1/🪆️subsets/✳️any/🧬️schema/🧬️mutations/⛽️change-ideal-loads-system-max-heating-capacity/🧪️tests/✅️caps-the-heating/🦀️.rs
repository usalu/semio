//! 🧪️ `change-ideal-loads-system-max-heating-capacity` fixture — `✅️caps-the-heating`: caps the heating capacity at four kilowatts.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/✅️caps-the-heating/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/✅️caps-the-heating/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/✅️caps-the-heating/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/✅️caps-the-heating/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⛽️change-ideal-loads-system-max-heating-capacity/✅️caps-the-heating/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_ideal_loads_system_max_heating_capacity(crate::model::EntityId(12), true, 4000.0))
}

fn case() -> Case {
    Case {
        kind: "change-ideal-loads-system-max-heating-capacity", directory: "⛽️change-ideal-loads-system-max-heating-capacity/✅️caps-the-heating", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
