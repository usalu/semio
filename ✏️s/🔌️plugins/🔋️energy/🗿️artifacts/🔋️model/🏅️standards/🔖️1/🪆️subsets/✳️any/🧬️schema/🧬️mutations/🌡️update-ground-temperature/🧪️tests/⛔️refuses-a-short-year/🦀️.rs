...
fn case() -> Case {
    Case { kind: "update-ground-temperature", directory: "🌡️update-ground-temperature/🧪️tests/⛔️refuses-a-short-year", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
