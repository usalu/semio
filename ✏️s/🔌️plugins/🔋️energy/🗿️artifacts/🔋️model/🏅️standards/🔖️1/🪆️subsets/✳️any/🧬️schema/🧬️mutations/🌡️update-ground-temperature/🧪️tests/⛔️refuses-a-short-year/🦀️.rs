//! 🧪️ `update-ground-temperature` fixture — `⛔️refuses-a-short-year`: refuses a ten-month year.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/⛔️refuses-a-short-year/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/⛔️refuses-a-short-year/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/⛔️refuses-a-short-year/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/⛔️refuses-a-short-year/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/⛔️refuses-a-short-year/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "update-ground-temperature", directory: "🌡️update-ground-temperature/⛔️refuses-a-short-year", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
