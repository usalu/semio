//! 🧪️ `change-plant-loop-type` fixture — `✅️turns-it-chilled`: turns the hot water loop into a chilled one.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️change-plant-loop-type/✅️turns-it-chilled/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️change-plant-loop-type/✅️turns-it-chilled/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️change-plant-loop-type/✅️turns-it-chilled/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️change-plant-loop-type/✅️turns-it-chilled/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/♻️change-plant-loop-type/✅️turns-it-chilled/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_plant_loop_type(crate::model::EntityId(18), crate::model::PlantLoopType::Cooling))
}

fn case() -> Case {
    Case { kind: "change-plant-loop-type", directory: "♻️change-plant-loop-type/✅️turns-it-chilled", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
