...
fn case() -> Case {
    Case { kind: "change-plant-loop-type", directory: "♻️change-plant-loop-type/🧪️tests/✅️turns-it-chilled", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
