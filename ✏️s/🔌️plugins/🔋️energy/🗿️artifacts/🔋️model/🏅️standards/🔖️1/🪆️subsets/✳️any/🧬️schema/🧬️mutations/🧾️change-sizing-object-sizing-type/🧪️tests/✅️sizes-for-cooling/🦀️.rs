//! 🧪️ `change-sizing-object-sizing-type` fixture — `✅️sizes-for-cooling`: sizes for the cooling load instead.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/✅️sizes-for-cooling/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/✅️sizes-for-cooling/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/✅️sizes-for-cooling/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/✅️sizes-for-cooling/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/✅️sizes-for-cooling/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_sizing_object_sizing_type(crate::model::EntityId(15), crate::model::SizingType::Cooling))
}

fn case() -> Case {
    Case { kind: "change-sizing-object-sizing-type", directory: "🧾️change-sizing-object-sizing-type/✅️sizes-for-cooling", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
