//! 🧪️ `change-zone-equipment-zone` fixture — `⛔️refuses-an-absent-zone`: refuses a zone that does not exist.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏬️change-zone-equipment-zone/⛔️refuses-an-absent-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏬️change-zone-equipment-zone/⛔️refuses-an-absent-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏬️change-zone-equipment-zone/⛔️refuses-an-absent-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏬️change-zone-equipment-zone/⛔️refuses-an-absent-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏬️change-zone-equipment-zone/⛔️refuses-an-absent-zone/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_zone_equipment_zone(crate::model::EntityId(13), crate::model::EntityId(99)))
}

fn case() -> Case {
    Case { kind: "change-zone-equipment-zone", directory: "🏬️change-zone-equipment-zone/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
