...
fn case() -> Case {
    Case { kind: "change-zone-equipment-zone", directory: "🏬️change-zone-equipment-zone/🧪️tests/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
