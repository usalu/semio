...
fn case() -> Case {
    Case { kind: "change-sizing-object-design-day-type", directory: "🌥️change-sizing-object-design-day-type/🧪️tests/⛔️refuses-an-absent-row", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
