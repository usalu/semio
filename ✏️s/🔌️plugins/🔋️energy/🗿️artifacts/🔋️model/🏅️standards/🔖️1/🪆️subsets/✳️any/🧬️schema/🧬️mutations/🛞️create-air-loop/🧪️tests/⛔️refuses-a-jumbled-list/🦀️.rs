...
fn case() -> Case {
    Case { kind: "create-air-loop", directory: "🛞️create-air-loop/🧪️tests/⛔️refuses-a-jumbled-list", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
