//! 🧪️ `create-air-loop` fixture — `⛔️refuses-a-jumbled-list`: refuses a terminal zone list that is not ascending.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/⛔️refuses-a-jumbled-list/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/⛔️refuses-a-jumbled-list/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/⛔️refuses-a-jumbled-list/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/⛔️refuses-a-jumbled-list/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛞️create-air-loop/⛔️refuses-a-jumbled-list/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-air-loop", directory: "🛞️create-air-loop/⛔️refuses-a-jumbled-list", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
