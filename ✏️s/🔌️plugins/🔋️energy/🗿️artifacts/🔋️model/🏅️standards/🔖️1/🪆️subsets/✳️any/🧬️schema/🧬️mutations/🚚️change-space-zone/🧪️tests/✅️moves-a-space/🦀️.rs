//! 🧪️ `change-space-zone` fixture — `✅️moves-a-space`: moves the space to the second zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️change-space-zone/✅️moves-a-space/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️change-space-zone/✅️moves-a-space/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️change-space-zone/✅️moves-a-space/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️change-space-zone/✅️moves-a-space/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚚️change-space-zone/✅️moves-a-space/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-space-zone", directory: "🚚️change-space-zone/✅️moves-a-space", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
