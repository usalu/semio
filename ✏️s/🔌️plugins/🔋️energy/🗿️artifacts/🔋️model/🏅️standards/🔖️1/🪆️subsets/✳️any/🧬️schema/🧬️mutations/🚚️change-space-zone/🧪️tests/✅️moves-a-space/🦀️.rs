...
fn case() -> Case {
    Case { kind: "change-space-zone", directory: "🚚️change-space-zone/🧪️tests/✅️moves-a-space", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
