...
fn case() -> Case {
    Case { kind: "change-people-gain-schedule", directory: "⏰️change-people-gain-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
