...
fn case() -> Case {
    Case { kind: "create-daylight-zone", directory: "🔭️create-daylight-zone/🧪️tests/⛔️refuses-a-bad-tau", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
