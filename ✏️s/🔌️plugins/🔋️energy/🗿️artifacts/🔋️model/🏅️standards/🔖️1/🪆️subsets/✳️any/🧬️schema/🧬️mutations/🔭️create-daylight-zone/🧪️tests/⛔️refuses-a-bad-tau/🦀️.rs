//! 🧪️ `create-daylight-zone` fixture — `⛔️refuses-a-bad-tau`: refuses a transmittance above one.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/⛔️refuses-a-bad-tau/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/⛔️refuses-a-bad-tau/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/⛔️refuses-a-bad-tau/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/⛔️refuses-a-bad-tau/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔭️create-daylight-zone/⛔️refuses-a-bad-tau/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-daylight-zone", directory: "🔭️create-daylight-zone/⛔️refuses-a-bad-tau", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
