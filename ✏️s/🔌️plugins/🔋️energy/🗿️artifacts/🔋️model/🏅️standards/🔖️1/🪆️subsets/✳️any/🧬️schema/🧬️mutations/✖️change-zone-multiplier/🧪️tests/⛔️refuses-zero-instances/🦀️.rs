//! 🧪️ `change-zone-multiplier` fixture — `⛔️refuses-zero-instances`: refuses zero instances.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/⛔️refuses-zero-instances/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/⛔️refuses-zero-instances/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/⛔️refuses-zero-instances/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/⛔️refuses-zero-instances/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/⛔️refuses-zero-instances/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-zone-multiplier", directory: "✖️change-zone-multiplier/⛔️refuses-zero-instances", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
