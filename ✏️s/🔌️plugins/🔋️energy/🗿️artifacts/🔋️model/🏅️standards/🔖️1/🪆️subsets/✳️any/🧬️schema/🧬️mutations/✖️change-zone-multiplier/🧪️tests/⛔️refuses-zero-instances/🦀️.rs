...
fn case() -> Case {
    Case { kind: "change-zone-multiplier", directory: "✖️change-zone-multiplier/🧪️tests/⛔️refuses-zero-instances", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
