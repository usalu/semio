//! 🧪️ `delete-ideal-loads-system` fixture — `✅️drops-the-system`: drops the ideal loads system.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫥️delete-ideal-loads-system/✅️drops-the-system/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫥️delete-ideal-loads-system/✅️drops-the-system/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫥️delete-ideal-loads-system/✅️drops-the-system/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫥️delete-ideal-loads-system/✅️drops-the-system/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🫥️delete-ideal-loads-system/✅️drops-the-system/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_ideal_loads_system(crate::model::EntityId(12)))
}

fn case() -> Case {
    Case { kind: "delete-ideal-loads-system", directory: "🫥️delete-ideal-loads-system/✅️drops-the-system", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
