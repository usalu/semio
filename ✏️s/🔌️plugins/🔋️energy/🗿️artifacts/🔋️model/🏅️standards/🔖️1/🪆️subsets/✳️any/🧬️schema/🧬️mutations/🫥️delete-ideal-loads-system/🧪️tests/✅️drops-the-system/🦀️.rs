...
fn case() -> Case {
    Case { kind: "delete-ideal-loads-system", directory: "🫥️delete-ideal-loads-system/🧪️tests/✅️drops-the-system", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
