...
fn case() -> Case {
    Case { kind: "change-time-series-schedule-timestep", directory: "🕙️change-time-series-schedule-timestep/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
