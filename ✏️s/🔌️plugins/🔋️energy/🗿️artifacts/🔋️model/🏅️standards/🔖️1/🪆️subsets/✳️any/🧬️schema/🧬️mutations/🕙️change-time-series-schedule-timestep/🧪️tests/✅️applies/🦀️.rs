//! 🧪️ `change-time-series-schedule-timestep` fixture — `✅️applies`: moves time series schedule 40.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕙️change-time-series-schedule-timestep/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_time_series_schedule_timestep(crate::model::ScheduleId(40), 900))
}

fn case() -> Case {
    Case { kind: "change-time-series-schedule-timestep", directory: "🕙️change-time-series-schedule-timestep/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
