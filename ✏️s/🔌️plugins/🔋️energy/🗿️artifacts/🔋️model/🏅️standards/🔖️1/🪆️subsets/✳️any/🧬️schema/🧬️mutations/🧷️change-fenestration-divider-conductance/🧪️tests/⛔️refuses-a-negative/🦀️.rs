//! 🧪️ `change-fenestration-divider-conductance` fixture — `⛔️refuses-a-negative`: refuses a negative divider conductance.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/⛔️refuses-a-negative/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/⛔️refuses-a-negative/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/⛔️refuses-a-negative/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/⛔️refuses-a-negative/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷️change-fenestration-divider-conductance/⛔️refuses-a-negative/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_divider_conductance(crate::model::EntityId(5), -1.0))
}

fn case() -> Case {
    Case { kind: "change-fenestration-divider-conductance", directory: "🧷️change-fenestration-divider-conductance/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
