...
fn case() -> Case {
    Case { kind: "change-fenestration-divider-conductance", directory: "🧷️change-fenestration-divider-conductance/🧪️tests/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
