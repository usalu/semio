//! 🧪️ `change-zone-floor-area-participation` fixture — `✅️excludes-the-zone`: excludes the zone from the total.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-zone-floor-area-participation/✅️excludes-the-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-zone-floor-area-participation/✅️excludes-the-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-zone-floor-area-participation/✅️excludes-the-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-zone-floor-area-participation/✅️excludes-the-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📐️change-zone-floor-area-participation/✅️excludes-the-zone/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-zone-floor-area-participation", directory: "📐️change-zone-floor-area-participation/✅️excludes-the-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
