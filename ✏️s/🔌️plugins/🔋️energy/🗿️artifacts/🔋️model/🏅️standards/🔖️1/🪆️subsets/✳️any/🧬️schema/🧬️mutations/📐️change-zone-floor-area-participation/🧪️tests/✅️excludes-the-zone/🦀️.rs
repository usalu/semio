...
fn case() -> Case {
    Case { kind: "change-zone-floor-area-participation", directory: "📐️change-zone-floor-area-participation/🧪️tests/✅️excludes-the-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
