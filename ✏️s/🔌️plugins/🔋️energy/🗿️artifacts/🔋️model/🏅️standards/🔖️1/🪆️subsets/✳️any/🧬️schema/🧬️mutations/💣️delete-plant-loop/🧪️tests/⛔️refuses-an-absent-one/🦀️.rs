...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/⛔️refuses-an-absent-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/⛔️refuses-an-absent-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/⛔️refuses-an-absent-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/⛔️refuses-an-absent-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/💣️delete-plant-loop/⛔️refuses-an-absent-one/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-plant-loop", directory: "💣️delete-plant-loop/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
