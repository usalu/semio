...
fn case() -> Case {
    Case { kind: "change-people-gain-zone", directory: "🚶️change-people-gain-zone/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
