//! 🧪️ `delete-zone-equipment` fixture — `⛔️refuses-an-absent-one`: refuses absent zone equipment.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/⛔️refuses-an-absent-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/⛔️refuses-an-absent-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/⛔️refuses-an-absent-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/⛔️refuses-an-absent-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/⛔️refuses-an-absent-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_zone_equipment(crate::model::EntityId(99)))
}

fn case() -> Case {
    Case { kind: "delete-zone-equipment", directory: "🗑️delete-zone-equipment/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
