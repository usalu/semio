...
fn case() -> Case {
    Case { kind: "change-surface-sun-exposed", directory: "🌅️change-surface-sun-exposed/🧪️tests/⛔️refuses-a-missing-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
