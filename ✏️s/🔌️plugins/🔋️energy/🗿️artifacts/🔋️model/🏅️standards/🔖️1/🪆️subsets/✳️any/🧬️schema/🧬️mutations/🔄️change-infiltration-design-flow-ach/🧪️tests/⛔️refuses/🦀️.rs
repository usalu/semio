//! 🧪️ `change-infiltration-design-flow-ach` fixture — `⛔️refuses`: refuses design flow (air changes per hour) outside a finite non-negative value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️change-infiltration-design-flow-ach/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️change-infiltration-design-flow-ach/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️change-infiltration-design-flow-ach/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️change-infiltration-design-flow-ach/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️change-infiltration-design-flow-ach/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_infiltration_design_flow_ach(crate::model::EntityId(50), -0.5))
}

fn case() -> Case {
    Case { kind: "change-infiltration-design-flow-ach", directory: "🔄️change-infiltration-design-flow-ach/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
