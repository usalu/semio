...
fn case() -> Case {
    Case { kind: "change-infiltration-design-flow-ach", directory: "🔄️change-infiltration-design-flow-ach/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
