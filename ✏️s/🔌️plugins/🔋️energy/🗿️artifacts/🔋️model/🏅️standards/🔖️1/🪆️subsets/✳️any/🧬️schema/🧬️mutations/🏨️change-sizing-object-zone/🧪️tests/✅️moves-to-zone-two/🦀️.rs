...
fn case() -> Case {
    Case { kind: "change-sizing-object-zone", directory: "🏨️change-sizing-object-zone/🧪️tests/✅️moves-to-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
