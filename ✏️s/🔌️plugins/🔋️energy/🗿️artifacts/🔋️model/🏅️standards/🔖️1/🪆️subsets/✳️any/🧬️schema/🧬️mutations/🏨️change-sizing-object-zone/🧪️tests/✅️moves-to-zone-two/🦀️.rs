//! 🧪️ `change-sizing-object-zone` fixture — `✅️moves-to-zone-two`: sizes the second zone instead.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏨️change-sizing-object-zone/✅️moves-to-zone-two/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏨️change-sizing-object-zone/✅️moves-to-zone-two/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏨️change-sizing-object-zone/✅️moves-to-zone-two/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏨️change-sizing-object-zone/✅️moves-to-zone-two/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏨️change-sizing-object-zone/✅️moves-to-zone-two/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_sizing_object_zone(crate::model::EntityId(15), crate::model::EntityId(2)))
}

fn case() -> Case {
    Case { kind: "change-sizing-object-zone", directory: "🏨️change-sizing-object-zone/✅️moves-to-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
