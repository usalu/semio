...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeSolarThermalSystemCollectorArea {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Solar Thermal System Collector Area of solar thermal system {}", self.id.0), &format!("Solarwärmensystemkollektorfläche von Solarwärmensystem {} ändern", self.id.0))
    }
