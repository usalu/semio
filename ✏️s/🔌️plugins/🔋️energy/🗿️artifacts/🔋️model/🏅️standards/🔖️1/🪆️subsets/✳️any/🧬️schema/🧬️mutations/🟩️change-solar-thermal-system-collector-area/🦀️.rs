...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeSolarThermalSystemCollectorArea {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Solar Thermal System Collector Area of solar thermal system {}", self.id.0), &format!("Kollektorfläche von Solarthermieanlage {} ändern", self.id.0))
    }
