...
fn case() -> Case {
    Case { kind: "create-zone-equipment", directory: "🛠️create-zone-equipment/🧪️tests/✅️adds-a-baseboard", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
