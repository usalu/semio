//! 🧪️ `create-zone-equipment` fixture — `✅️adds-a-baseboard`: adds a baseboard to the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/✅️adds-a-baseboard/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/✅️adds-a-baseboard/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/✅️adds-a-baseboard/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/✅️adds-a-baseboard/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛠️create-zone-equipment/✅️adds-a-baseboard/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_zone_equipment(crate::model::EntityId(13), crate::model::EntityId(1), crate::model::ZoneEquipmentType::Baseboard, 1, 2000.0, 0.0))
}

fn case() -> Case {
    Case { kind: "create-zone-equipment", directory: "🛠️create-zone-equipment/✅️adds-a-baseboard", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
