...
fn case() -> Case {
    Case { kind: "remove-air-loop-terminal-zone", directory: "🪹️remove-air-loop-terminal-zone/🧪️tests/⛔️refuses-an-unserved", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
