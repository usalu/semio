//! 🧪️ `remove-air-loop-terminal-zone` fixture — `⛔️refuses-an-unserved`: refuses a zone the loop does not serve.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/⛔️refuses-an-unserved/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/⛔️refuses-an-unserved/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/⛔️refuses-an-unserved/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/⛔️refuses-an-unserved/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪹️remove-air-loop-terminal-zone/⛔️refuses-an-unserved/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::remove_air_loop_terminal_zone(crate::model::EntityId(17), crate::model::EntityId(2)))
}

fn case() -> Case {
    Case { kind: "remove-air-loop-terminal-zone", directory: "🪹️remove-air-loop-terminal-zone/⛔️refuses-an-unserved", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
