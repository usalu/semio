...
fn case() -> Case {
    Case { kind: "delete-room-air-model-assignment", directory: "🧺️delete-room-air-model-assignment/🧪️tests/✅️falls-back", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
