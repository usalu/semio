//! 🧪️ `delete-room-air-model-assignment` fixture — `✅️falls-back`: drops the override off the first zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/✅️falls-back/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/✅️falls-back/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/✅️falls-back/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/✅️falls-back/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧺️delete-room-air-model-assignment/✅️falls-back/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_room_air_model_assignment(crate::model::EntityId(1)))
}

fn case() -> Case {
    Case { kind: "delete-room-air-model-assignment", directory: "🧺️delete-room-air-model-assignment/✅️falls-back", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
