//! 🧪️ `change-glazing-material-solar-transmittance` fixture — `✅️applies`: darkens the pane.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟡️change-glazing-material-solar-transmittance/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_glazing_material_solar_transmittance(crate::model::EntityId(1), 0.61))
}

fn case() -> Case {
    Case { kind: "change-glazing-material-solar-transmittance", directory: "🟡️change-glazing-material-solar-transmittance/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
