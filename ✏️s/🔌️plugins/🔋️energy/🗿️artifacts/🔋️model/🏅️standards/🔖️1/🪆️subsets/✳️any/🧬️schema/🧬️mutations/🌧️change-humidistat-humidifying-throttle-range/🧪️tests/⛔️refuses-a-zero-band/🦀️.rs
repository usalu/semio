//! 🧪️ `change-humidistat-humidifying-throttle-range` fixture — `⛔️refuses-a-zero-band`: refuses a zero-wide band.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌧️change-humidistat-humidifying-throttle-range/⛔️refuses-a-zero-band/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌧️change-humidistat-humidifying-throttle-range/⛔️refuses-a-zero-band/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌧️change-humidistat-humidifying-throttle-range/⛔️refuses-a-zero-band/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌧️change-humidistat-humidifying-throttle-range/⛔️refuses-a-zero-band/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌧️change-humidistat-humidifying-throttle-range/⛔️refuses-a-zero-band/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_humidistat_humidifying_throttle_range(crate::model::EntityId(11), 0.0))
}

fn case() -> Case {
    Case {
        kind: "change-humidistat-humidifying-throttle-range", directory: "🌧️change-humidistat-humidifying-throttle-range/⛔️refuses-a-zero-band", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario
    }
}
