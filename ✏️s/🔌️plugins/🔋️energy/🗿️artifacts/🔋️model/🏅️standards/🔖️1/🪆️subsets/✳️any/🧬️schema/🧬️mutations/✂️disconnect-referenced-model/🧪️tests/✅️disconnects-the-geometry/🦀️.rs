...
fn case() -> Case {
    Case { kind: "disconnect-referenced-model", directory: "✂️disconnect-referenced-model/🧪️tests/✅️disconnects-the-geometry", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
