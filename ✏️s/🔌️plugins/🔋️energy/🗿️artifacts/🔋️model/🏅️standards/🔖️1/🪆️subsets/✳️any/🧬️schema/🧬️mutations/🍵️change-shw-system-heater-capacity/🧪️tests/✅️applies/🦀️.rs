//! 🧪️ `change-shw-system-heater-capacity` fixture — `✅️applies`: moves service hot water system 400.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍵️change-shw-system-heater-capacity/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_shw_system_heater_capacity(crate::model::EntityId(400), 6000.0))
}

fn case() -> Case {
    Case { kind: "change-shw-system-heater-capacity", directory: "🍵️change-shw-system-heater-capacity/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
