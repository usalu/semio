...
fn case() -> Case {
    Case { kind: "change-shw-system-heater-capacity", directory: "🍵️change-shw-system-heater-capacity/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
