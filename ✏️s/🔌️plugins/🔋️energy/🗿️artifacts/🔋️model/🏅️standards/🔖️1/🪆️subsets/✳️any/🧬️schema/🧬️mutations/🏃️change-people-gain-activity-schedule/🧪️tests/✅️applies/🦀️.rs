//! 🧪️ `change-people-gain-activity-schedule` fixture — `✅️applies`: moves people gain 20.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏃️change-people-gain-activity-schedule/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏃️change-people-gain-activity-schedule/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏃️change-people-gain-activity-schedule/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏃️change-people-gain-activity-schedule/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏃️change-people-gain-activity-schedule/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_people_gain_activity_schedule(crate::model::EntityId(20), crate::model::ScheduleId(3)))
}

fn case() -> Case {
    Case { kind: "change-people-gain-activity-schedule", directory: "🏃️change-people-gain-activity-schedule/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
