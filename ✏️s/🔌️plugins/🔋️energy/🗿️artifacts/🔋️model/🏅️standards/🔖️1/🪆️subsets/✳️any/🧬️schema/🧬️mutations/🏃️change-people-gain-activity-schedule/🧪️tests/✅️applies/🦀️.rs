...
fn case() -> Case {
    Case { kind: "change-people-gain-activity-schedule", directory: "🏃️change-people-gain-activity-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
