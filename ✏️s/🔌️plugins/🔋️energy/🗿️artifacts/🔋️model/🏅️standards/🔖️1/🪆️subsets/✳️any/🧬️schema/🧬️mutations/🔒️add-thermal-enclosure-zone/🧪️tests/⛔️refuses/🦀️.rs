//! 🧪️ `add-thermal-enclosure-zone` fixture — `⛔️refuses`: refuses a zone the document does not define.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒️add-thermal-enclosure-zone/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::add_thermal_enclosure_zone(crate::model::EntityId(220), 1, crate::model::EntityId(999)))
}

fn case() -> Case {
    Case { kind: "add-thermal-enclosure-zone", directory: "🔒️add-thermal-enclosure-zone/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
