...
fn case() -> Case {
    Case { kind: "rename-setpoint-manager", directory: "🖇️rename-setpoint-manager/🧪️tests/✅️renames-the-spm", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
