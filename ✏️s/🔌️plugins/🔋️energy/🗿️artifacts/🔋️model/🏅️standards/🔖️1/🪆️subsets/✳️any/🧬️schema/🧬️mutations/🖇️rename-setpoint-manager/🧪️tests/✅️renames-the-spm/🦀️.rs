//! 🧪️ `rename-setpoint-manager` fixture — `✅️renames-the-spm`: renames the supply setpoint manager.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️rename-setpoint-manager/✅️renames-the-spm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️rename-setpoint-manager/✅️renames-the-spm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️rename-setpoint-manager/✅️renames-the-spm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️rename-setpoint-manager/✅️renames-the-spm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️rename-setpoint-manager/✅️renames-the-spm/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::rename_setpoint_manager(crate::model::EntityId(16), "RESET SPM".into()))
}

fn case() -> Case {
    Case { kind: "rename-setpoint-manager", directory: "🖇️rename-setpoint-manager/✅️renames-the-spm", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
