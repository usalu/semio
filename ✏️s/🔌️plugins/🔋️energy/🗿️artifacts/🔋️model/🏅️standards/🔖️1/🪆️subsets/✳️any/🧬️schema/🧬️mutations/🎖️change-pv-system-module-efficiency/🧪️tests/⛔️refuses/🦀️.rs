//! 🧪️ `change-pv-system-module-efficiency` fixture — `⛔️refuses`: refuses module efficiency outside a fraction in (0, 1].
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎖️change-pv-system-module-efficiency/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎖️change-pv-system-module-efficiency/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎖️change-pv-system-module-efficiency/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎖️change-pv-system-module-efficiency/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎖️change-pv-system-module-efficiency/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_pv_system_module_efficiency(crate::model::EntityId(300), 0.0))
}

fn case() -> Case {
    Case { kind: "change-pv-system-module-efficiency", directory: "🎖️change-pv-system-module-efficiency/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
