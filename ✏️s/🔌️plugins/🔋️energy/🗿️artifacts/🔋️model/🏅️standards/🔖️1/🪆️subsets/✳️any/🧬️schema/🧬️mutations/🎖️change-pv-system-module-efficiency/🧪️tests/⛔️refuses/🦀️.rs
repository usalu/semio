...
fn case() -> Case {
    Case { kind: "change-pv-system-module-efficiency", directory: "🎖️change-pv-system-module-efficiency/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
