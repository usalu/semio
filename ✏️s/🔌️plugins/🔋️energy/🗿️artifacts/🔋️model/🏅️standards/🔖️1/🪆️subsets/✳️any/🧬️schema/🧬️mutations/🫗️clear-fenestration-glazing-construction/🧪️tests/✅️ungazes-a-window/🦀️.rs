...
fn case() -> Case {
    Case { kind: "clear-fenestration-glazing-construction", directory: "🫗️clear-fenestration-glazing-construction/🧪️tests/✅️ungazes-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
