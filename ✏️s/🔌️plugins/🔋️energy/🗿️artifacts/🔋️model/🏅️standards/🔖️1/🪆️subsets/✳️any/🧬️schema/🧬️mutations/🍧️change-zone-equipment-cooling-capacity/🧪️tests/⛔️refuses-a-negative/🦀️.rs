...
fn case() -> Case {
    Case { kind: "change-zone-equipment-cooling-capacity", directory: "🍧️change-zone-equipment-cooling-capacity/🧪️tests/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
