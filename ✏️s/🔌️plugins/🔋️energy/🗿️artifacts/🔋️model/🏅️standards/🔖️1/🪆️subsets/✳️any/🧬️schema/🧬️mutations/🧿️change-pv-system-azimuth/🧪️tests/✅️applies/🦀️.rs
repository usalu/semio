...
fn case() -> Case {
    Case { kind: "change-pv-system-azimuth", directory: "🧿️change-pv-system-azimuth/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
