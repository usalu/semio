...
fn case() -> Case {
    Case { kind: "delete-daylight-zone", directory: "🌗️delete-daylight-zone/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
