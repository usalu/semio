//! 🧪️ `change-humidistat-dehumidifying-setpoint-schedule` fixture — `✅️repoints-drying`: repoints the dehumidifying setpoint.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏝️change-humidistat-dehumidifying-setpoint-schedule/✅️repoints-drying/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏝️change-humidistat-dehumidifying-setpoint-schedule/✅️repoints-drying/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏝️change-humidistat-dehumidifying-setpoint-schedule/✅️repoints-drying/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏝️change-humidistat-dehumidifying-setpoint-schedule/✅️repoints-drying/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏝️change-humidistat-dehumidifying-setpoint-schedule/✅️repoints-drying/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_humidistat_dehumidifying_setpoint_schedule(crate::model::EntityId(11), crate::model::ScheduleId(1)))
}

fn case() -> Case {
    Case {
        kind: "change-humidistat-dehumidifying-setpoint-schedule",
        directory: "🏝️change-humidistat-dehumidifying-setpoint-schedule/✅️repoints-drying",
        before: BEFORE,
        after: AFTER,
        mutation: MUTATION,
        diff: DIFF,
