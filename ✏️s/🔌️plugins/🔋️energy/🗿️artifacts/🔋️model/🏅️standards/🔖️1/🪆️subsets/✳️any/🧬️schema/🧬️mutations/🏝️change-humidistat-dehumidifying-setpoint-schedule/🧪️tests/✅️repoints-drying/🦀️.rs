...
fn case() -> Case {
    Case { kind: "change-humidistat-dehumidifying-setpoint-schedule", directory: "🏝️change-humidistat-dehumidifying-setpoint-schedule/🧪️tests/✅️repoints-drying", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
