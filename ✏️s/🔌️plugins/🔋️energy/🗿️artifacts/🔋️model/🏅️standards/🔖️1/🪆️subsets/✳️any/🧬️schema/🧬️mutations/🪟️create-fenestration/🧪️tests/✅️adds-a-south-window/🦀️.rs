//! 🧪️ `create-fenestration` fixture — `✅️adds-a-south-window`: adds the south window.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/✅️adds-a-south-window/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/✅️adds-a-south-window/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/✅️adds-a-south-window/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/✅️adds-a-south-window/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/✅️adds-a-south-window/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-fenestration", directory: "🪟️create-fenestration/✅️adds-a-south-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
