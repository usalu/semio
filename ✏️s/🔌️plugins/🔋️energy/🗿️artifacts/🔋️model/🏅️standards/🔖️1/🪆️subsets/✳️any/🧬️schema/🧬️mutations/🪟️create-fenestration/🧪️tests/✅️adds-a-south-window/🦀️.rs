...
fn case() -> Case {
    Case { kind: "create-fenestration", directory: "🪟️create-fenestration/🧪️tests/✅️adds-a-south-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
