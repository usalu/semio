//! 🧪️ `add-electrical-load-center-battery` fixture — `✅️applies`: moves electrical load center 320's membership.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔋️add-electrical-load-center-battery/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::add_electrical_load_center_battery(crate::model::EntityId(320), 0, crate::model::EntityId(310)))
}

fn case() -> Case {
    Case { kind: "add-electrical-load-center-battery", directory: "🔋️add-electrical-load-center-battery/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
