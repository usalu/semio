...
fn case() -> Case {
    Case { kind: "add-electrical-load-center-battery", directory: "🔋️add-electrical-load-center-battery/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
