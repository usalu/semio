...
fn case() -> Case {
    Case { kind: "delete-surface", directory: "🪚️delete-surface/🧪️tests/⛔️refuses-a-partner", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
