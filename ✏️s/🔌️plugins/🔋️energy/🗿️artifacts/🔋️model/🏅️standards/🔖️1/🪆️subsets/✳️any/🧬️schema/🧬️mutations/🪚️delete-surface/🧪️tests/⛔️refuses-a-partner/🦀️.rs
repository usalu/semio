//! 🧪️ `delete-surface` fixture — `⛔️refuses-a-partner`: refuses a surface another names as its interzone partner.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️delete-surface/⛔️refuses-a-partner/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️delete-surface/⛔️refuses-a-partner/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️delete-surface/⛔️refuses-a-partner/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️delete-surface/⛔️refuses-a-partner/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪚️delete-surface/⛔️refuses-a-partner/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "delete-surface", directory: "🪚️delete-surface/⛔️refuses-a-partner", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
