...
fn case() -> Case {
    Case { kind: "change-fenestration-shgc", directory: "🌇️change-fenestration-shgc/🧪️tests/✅️dims-the-solar-gain", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
