//! 🧪️ `change-fenestration-shgc` fixture — `✅️dims-the-solar-gain`: moves to the EnergyPlus simple-glazing SHGC.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/✅️dims-the-solar-gain/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/✅️dims-the-solar-gain/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/✅️dims-the-solar-gain/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/✅️dims-the-solar-gain/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/✅️dims-the-solar-gain/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_shgc(crate::model::EntityId(5), 0.76))
}

fn case() -> Case {
    Case { kind: "change-fenestration-shgc", directory: "🌇️change-fenestration-shgc/✅️dims-the-solar-gain", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
