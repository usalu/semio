...
fn case() -> Case {
    Case { kind: "create-space-list", directory: "📋️create-space-list/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
