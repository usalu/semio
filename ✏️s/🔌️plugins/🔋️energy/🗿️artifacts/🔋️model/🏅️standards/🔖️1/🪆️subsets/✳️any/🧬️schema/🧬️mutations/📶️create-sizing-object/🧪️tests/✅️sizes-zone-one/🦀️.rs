...
fn case() -> Case {
    Case { kind: "create-sizing-object", directory: "📶️create-sizing-object/🧪️tests/✅️sizes-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
