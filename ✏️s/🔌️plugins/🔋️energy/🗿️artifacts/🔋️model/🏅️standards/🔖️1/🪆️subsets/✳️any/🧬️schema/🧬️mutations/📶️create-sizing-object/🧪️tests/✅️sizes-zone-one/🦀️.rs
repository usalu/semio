//! 🧪️ `create-sizing-object` fixture — `✅️sizes-zone-one`: autosizes the first zone for heating.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/✅️sizes-zone-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/✅️sizes-zone-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/✅️sizes-zone-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/✅️sizes-zone-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📶️create-sizing-object/✅️sizes-zone-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_sizing_object(crate::model::EntityId(15), crate::model::EntityId(1), crate::model::SizingType::Heating, crate::model::DesignDayType::Heating))
}

fn case() -> Case {
    Case { kind: "create-sizing-object", directory: "📶️create-sizing-object/✅️sizes-zone-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
