...
fn case() -> Case {
    Case { kind: "change-annual-schedule-holiday-daily-schedule", directory: "🎄️change-annual-schedule-holiday-daily-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
