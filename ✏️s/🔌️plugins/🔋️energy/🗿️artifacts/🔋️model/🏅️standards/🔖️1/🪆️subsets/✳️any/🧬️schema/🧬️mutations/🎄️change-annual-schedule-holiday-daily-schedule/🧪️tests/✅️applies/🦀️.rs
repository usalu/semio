//! 🧪️ `change-annual-schedule-holiday-daily-schedule` fixture — `✅️applies`: moves annual schedule 30.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎄️change-annual-schedule-holiday-daily-schedule/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_annual_schedule_holiday_daily_schedule(crate::model::ScheduleId(30), Some(crate::model::ScheduleId(11))))
}

fn case() -> Case {
    Case { kind: "change-annual-schedule-holiday-daily-schedule", directory: "🎄️change-annual-schedule-holiday-daily-schedule/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
