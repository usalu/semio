//! 🧪️ `change-fenestration-area` fixture — `✅️doubles-the-glazing`: doubles the glazed area.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/✅️doubles-the-glazing/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/✅️doubles-the-glazing/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/✅️doubles-the-glazing/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/✅️doubles-the-glazing/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟥️change-fenestration-area/✅️doubles-the-glazing/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_area(crate::model::EntityId(5), 12.0))
}

fn case() -> Case {
    Case { kind: "change-fenestration-area", directory: "🟥️change-fenestration-area/✅️doubles-the-glazing", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
