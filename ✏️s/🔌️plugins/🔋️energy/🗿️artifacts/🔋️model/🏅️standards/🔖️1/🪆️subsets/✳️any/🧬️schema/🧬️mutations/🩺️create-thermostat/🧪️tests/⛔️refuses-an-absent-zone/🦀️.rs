...
fn case() -> Case {
    Case { kind: "create-thermostat", directory: "🩺️create-thermostat/🧪️tests/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
