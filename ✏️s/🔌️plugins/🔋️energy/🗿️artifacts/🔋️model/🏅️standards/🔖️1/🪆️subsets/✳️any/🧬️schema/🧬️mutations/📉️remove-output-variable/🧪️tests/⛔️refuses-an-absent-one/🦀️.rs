...
use crate::artifacts::model::mutations::fixtures::{self, snapshot, Case};
...
fn case() -> Case {
    Case { kind: "remove-output-variable", directory: "📉️remove-output-variable/🧪️tests/⛔️refuses-an-absent-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
