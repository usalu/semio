//! 🧪️ `change-zone-equipment-priority` fixture — `✅️demotes-it`: demotes the equipment to second rank.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/✅️demotes-it/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/✅️demotes-it/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/✅️demotes-it/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/✅️demotes-it/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎗️change-zone-equipment-priority/✅️demotes-it/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_zone_equipment_priority(crate::model::EntityId(13), 2))
}

fn case() -> Case {
    Case { kind: "change-zone-equipment-priority", directory: "🎗️change-zone-equipment-priority/✅️demotes-it", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
