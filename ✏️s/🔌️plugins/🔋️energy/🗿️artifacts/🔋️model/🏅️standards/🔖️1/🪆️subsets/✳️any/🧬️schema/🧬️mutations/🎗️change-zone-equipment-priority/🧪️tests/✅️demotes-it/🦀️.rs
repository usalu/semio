...
fn case() -> Case {
    Case { kind: "change-zone-equipment-priority", directory: "🎗️change-zone-equipment-priority/🧪️tests/✅️demotes-it", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
