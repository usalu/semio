...
fn case() -> Case {
    Case { kind: "change-water-system-peak-flow", directory: "🚾️change-water-system-peak-flow/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
