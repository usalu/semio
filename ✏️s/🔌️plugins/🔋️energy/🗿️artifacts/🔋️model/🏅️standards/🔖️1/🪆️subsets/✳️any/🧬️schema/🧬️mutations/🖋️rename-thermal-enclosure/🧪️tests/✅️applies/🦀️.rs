...
fn case() -> Case {
    Case { kind: "rename-thermal-enclosure", directory: "🖋️rename-thermal-enclosure/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
