//! 🧪️ `rename-thermal-enclosure` fixture — `✅️applies`: moves thermal enclosure 220.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖋️rename-thermal-enclosure/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::rename_thermal_enclosure(crate::model::EntityId(220), "NORTH ENCLOSURE".to_string()))
}

fn case() -> Case {
    Case { kind: "rename-thermal-enclosure", directory: "🖋️rename-thermal-enclosure/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
