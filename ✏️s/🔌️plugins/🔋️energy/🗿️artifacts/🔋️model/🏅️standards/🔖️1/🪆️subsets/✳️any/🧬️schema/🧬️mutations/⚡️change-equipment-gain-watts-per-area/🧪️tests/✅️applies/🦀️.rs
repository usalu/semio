...
fn case() -> Case {
    Case { kind: "change-equipment-gain-watts-per-area", directory: "⚡️change-equipment-gain-watts-per-area/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
