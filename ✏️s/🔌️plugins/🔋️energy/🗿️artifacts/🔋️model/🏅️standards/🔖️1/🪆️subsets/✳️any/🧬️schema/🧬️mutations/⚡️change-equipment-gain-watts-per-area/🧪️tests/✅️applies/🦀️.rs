//! 🧪️ `change-equipment-gain-watts-per-area` fixture — `✅️applies`: moves equipment gain 40.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡️change-equipment-gain-watts-per-area/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_equipment_gain_watts_per_area(crate::model::EntityId(40), 5.0))
}

fn case() -> Case {
    Case { kind: "change-equipment-gain-watts-per-area", directory: "⚡️change-equipment-gain-watts-per-area/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
