...
fn case() -> Case {
    Case { kind: "change-humidistat-zone", directory: "🏙️change-humidistat-zone/🧪️tests/⛔️refuses-an-absent-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
