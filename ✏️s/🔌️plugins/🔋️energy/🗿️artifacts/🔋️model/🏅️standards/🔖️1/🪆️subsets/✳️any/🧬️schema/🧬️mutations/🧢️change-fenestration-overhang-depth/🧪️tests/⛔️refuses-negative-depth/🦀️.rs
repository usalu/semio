...
fn case() -> Case {
    Case { kind: "change-fenestration-overhang-depth", directory: "🧢️change-fenestration-overhang-depth/🧪️tests/⛔️refuses-negative-depth", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
