//! 🧪️ `change-fenestration-overhang-depth` fixture — `⛔️refuses-negative-depth`: refuses a negative overhang depth.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/⛔️refuses-negative-depth/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/⛔️refuses-negative-depth/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/⛔️refuses-negative-depth/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/⛔️refuses-negative-depth/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧢️change-fenestration-overhang-depth/⛔️refuses-negative-depth/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-fenestration-overhang-depth", directory: "🧢️change-fenestration-overhang-depth/⛔️refuses-negative-depth", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
