...
fn case() -> Case {
    Case { kind: "change-ideal-loads-system-zone", directory: "🏢️change-ideal-loads-system-zone/🧪️tests/✅️moves-to-zone-two", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
