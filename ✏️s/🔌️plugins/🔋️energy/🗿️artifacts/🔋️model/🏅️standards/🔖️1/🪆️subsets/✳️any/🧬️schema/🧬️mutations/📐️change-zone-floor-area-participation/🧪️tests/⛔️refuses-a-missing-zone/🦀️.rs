...
fn case() -> Case {
    Case { kind: "change-zone-floor-area-participation", directory: "📐️change-zone-floor-area-participation/🧪️tests/⛔️refuses-a-missing-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
