...
fn case() -> Case {
    Case { kind: "add-output-variable", directory: "📊️add-output-variable/🧪️tests/✅️adds-zone-air-temp", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
