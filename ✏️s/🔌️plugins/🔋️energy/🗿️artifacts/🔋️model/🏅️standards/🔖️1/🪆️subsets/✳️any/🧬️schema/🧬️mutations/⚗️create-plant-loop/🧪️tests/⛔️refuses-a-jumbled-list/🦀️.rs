...
fn case() -> Case {
    Case { kind: "create-plant-loop", directory: "⚗️create-plant-loop/🧪️tests/⛔️refuses-a-jumbled-list", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
