...
fn case() -> Case {
    Case { kind: "change-surface-wind-exposed", directory: "🍃️change-surface-wind-exposed/🧪️tests/✅️shelters-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
