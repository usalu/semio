//! 🧪️ `change-surface-wind-exposed` fixture — `✅️shelters-a-wall`: shelters the wall from wind.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍃️change-surface-wind-exposed/✅️shelters-a-wall/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍃️change-surface-wind-exposed/✅️shelters-a-wall/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍃️change-surface-wind-exposed/✅️shelters-a-wall/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍃️change-surface-wind-exposed/✅️shelters-a-wall/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🍃️change-surface-wind-exposed/✅️shelters-a-wall/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-surface-wind-exposed", directory: "🍃️change-surface-wind-exposed/✅️shelters-a-wall", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
