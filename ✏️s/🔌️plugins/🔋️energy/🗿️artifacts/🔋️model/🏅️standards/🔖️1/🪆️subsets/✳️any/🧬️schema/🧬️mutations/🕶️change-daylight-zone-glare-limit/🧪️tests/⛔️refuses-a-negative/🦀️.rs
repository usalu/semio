...
fn case() -> Case {
    Case { kind: "change-daylight-zone-glare-limit", directory: "🕶️change-daylight-zone-glare-limit/🧪️tests/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
