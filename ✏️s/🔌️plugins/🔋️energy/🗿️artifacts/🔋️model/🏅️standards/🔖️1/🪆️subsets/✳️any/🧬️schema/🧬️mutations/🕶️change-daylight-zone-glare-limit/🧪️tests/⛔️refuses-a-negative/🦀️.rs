//! 🧪️ `change-daylight-zone-glare-limit` fixture — `⛔️refuses-a-negative`: refuses a negative glare limit.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/⛔️refuses-a-negative/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/⛔️refuses-a-negative/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/⛔️refuses-a-negative/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/⛔️refuses-a-negative/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕶️change-daylight-zone-glare-limit/⛔️refuses-a-negative/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_daylight_zone_glare_limit(crate::model::EntityId(14), -5.0))
}

fn case() -> Case {
    Case { kind: "change-daylight-zone-glare-limit", directory: "🕶️change-daylight-zone-glare-limit/⛔️refuses-a-negative", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
