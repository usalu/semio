//! 🧪️ `change-glazing-material-conductivity` fixture — `✅️applies`: raises the pane conductivity.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟠️change-glazing-material-conductivity/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟠️change-glazing-material-conductivity/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟠️change-glazing-material-conductivity/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟠️change-glazing-material-conductivity/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟠️change-glazing-material-conductivity/✅️applies/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-glazing-material-conductivity", directory: "🟠️change-glazing-material-conductivity/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
