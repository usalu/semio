...
fn case() -> Case {
    Case { kind: "update-ground-temperature", directory: "🌡️update-ground-temperature/🧪️tests/✅️sets-denver-ground", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
