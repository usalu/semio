//! 🧪️ `update-ground-temperature` fixture — `✅️sets-denver-ground`: sets Denver monthly ground temperatures.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/✅️sets-denver-ground/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/✅️sets-denver-ground/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/✅️sets-denver-ground/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/✅️sets-denver-ground/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌡️update-ground-temperature/✅️sets-denver-ground/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "update-ground-temperature", directory: "🌡️update-ground-temperature/✅️sets-denver-ground", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
