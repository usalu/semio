//! 🧪️ `remove-electrical-load-center-pv` fixture — `⛔️refuses`: refuses a PV system the load centre does not carry.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌘️remove-electrical-load-center-pv/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌘️remove-electrical-load-center-pv/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌘️remove-electrical-load-center-pv/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌘️remove-electrical-load-center-pv/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌘️remove-electrical-load-center-pv/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::remove_electrical_load_center_pv(crate::model::EntityId(321), crate::model::EntityId(300)))
}

fn case() -> Case {
    Case { kind: "remove-electrical-load-center-pv", directory: "🌘️remove-electrical-load-center-pv/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
