...
fn case() -> Case {
    Case { kind: "remove-electrical-load-center-pv", directory: "🌘️remove-electrical-load-center-pv/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
