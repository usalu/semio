...
fn case() -> Case {
    Case { kind: "change-material-visible-absorptance", directory: "👁️change-material-visible-absorptance/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
