//! 🧪️ `change-zone-conditioned` fixture — `⛔️refuses-a-missing-zone`: refuses an absent zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/⛔️refuses-a-missing-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/⛔️refuses-a-missing-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/⛔️refuses-a-missing-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/⛔️refuses-a-missing-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌬️change-zone-conditioned/⛔️refuses-a-missing-zone/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-zone-conditioned", directory: "🌬️change-zone-conditioned/⛔️refuses-a-missing-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
