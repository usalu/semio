...
fn case() -> Case {
    Case { kind: "change-zone-conditioned", directory: "🌬️change-zone-conditioned/🧪️tests/⛔️refuses-a-missing-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
