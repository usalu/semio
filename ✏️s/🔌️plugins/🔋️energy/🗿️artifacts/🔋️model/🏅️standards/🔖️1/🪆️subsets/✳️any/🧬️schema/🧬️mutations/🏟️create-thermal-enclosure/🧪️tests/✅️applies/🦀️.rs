//! 🧪️ `create-thermal-enclosure` fixture — `✅️applies`: inserts a new thermal enclosure.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏟️create-thermal-enclosure/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::create_thermal_enclosure(2, crate::model::EntityId(222), "ROOF BLOCK".into(), vec![crate::model::EntityId(2)]))
}

fn case() -> Case {
    Case { kind: "create-thermal-enclosure", directory: "🏟️create-thermal-enclosure/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
