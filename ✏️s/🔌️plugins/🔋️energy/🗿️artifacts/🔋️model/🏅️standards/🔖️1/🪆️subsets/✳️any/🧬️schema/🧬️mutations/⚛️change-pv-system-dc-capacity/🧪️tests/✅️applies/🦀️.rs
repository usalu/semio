//! 🧪️ `change-pv-system-dc-capacity` fixture — `✅️applies`: moves pv system 300.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚛️change-pv-system-dc-capacity/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_pv_system_dc_capacity(crate::model::EntityId(300), 7000.0))
}

fn case() -> Case {
    Case { kind: "change-pv-system-dc-capacity", directory: "⚛️change-pv-system-dc-capacity/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
