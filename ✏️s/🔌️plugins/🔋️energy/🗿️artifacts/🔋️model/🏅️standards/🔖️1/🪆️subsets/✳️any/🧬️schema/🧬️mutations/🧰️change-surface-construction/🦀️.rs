...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeSurfaceConstruction {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change surface {} construction to {}", self.id.0, self.new_construction_id.0), &format!("Oberfläche {} Konstruktion auf {} ändern", self.id.0, self.new_construction_id.0))
    }
