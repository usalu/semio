...
fn case() -> Case {
    Case { kind: "change-infiltration-temperature-term-coefficient", directory: "🅱️change-infiltration-temperature-term-coefficient/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
