...
fn case() -> Case {
    Case { kind: "change-refrigeration-system-case-count", directory: "🗄️change-refrigeration-system-case-count/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
