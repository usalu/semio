//! 🧪️ `change-refrigeration-system-case-count` fixture — `✅️applies`: moves refrigeration system 420.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗄️change-refrigeration-system-case-count/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_refrigeration_system_case_count(crate::model::EntityId(420), 6))
}

fn case() -> Case {
    Case { kind: "change-refrigeration-system-case-count", directory: "🗄️change-refrigeration-system-case-count/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
