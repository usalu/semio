//! 🧪️ `bind-fenestration-glazing-construction` fixture — `✅️glazes-a-window`: gives the window a real layer stack.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/✅️glazes-a-window/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/✅️glazes-a-window/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/✅️glazes-a-window/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/✅️glazes-a-window/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧊️bind-fenestration-glazing-construction/✅️glazes-a-window/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "bind-fenestration-glazing-construction", directory: "🧊️bind-fenestration-glazing-construction/✅️glazes-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
