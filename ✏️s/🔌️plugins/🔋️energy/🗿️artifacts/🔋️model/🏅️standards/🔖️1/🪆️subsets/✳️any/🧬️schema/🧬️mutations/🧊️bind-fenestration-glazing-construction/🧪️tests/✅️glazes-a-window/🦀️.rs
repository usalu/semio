...
fn case() -> Case {
    Case { kind: "bind-fenestration-glazing-construction", directory: "🧊️bind-fenestration-glazing-construction/🧪️tests/✅️glazes-a-window", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
