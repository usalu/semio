...
fn case() -> Case {
    Case { kind: "create-fenestration", directory: "🪟️create-fenestration/🧪️tests/⛔️refuses-a-missing-host", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
