//! 🧪️ `create-fenestration` fixture — `⛔️refuses-a-missing-host`: refuses an absent host surface.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/⛔️refuses-a-missing-host/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/⛔️refuses-a-missing-host/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/⛔️refuses-a-missing-host/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/⛔️refuses-a-missing-host/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🪟️create-fenestration/⛔️refuses-a-missing-host/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-fenestration", directory: "🪟️create-fenestration/⛔️refuses-a-missing-host", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
