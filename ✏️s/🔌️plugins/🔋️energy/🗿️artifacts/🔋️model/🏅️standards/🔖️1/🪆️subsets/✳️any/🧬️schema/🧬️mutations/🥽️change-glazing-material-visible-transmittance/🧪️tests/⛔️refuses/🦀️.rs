//! 🧪️ `change-glazing-material-visible-transmittance` fixture — `⛔️refuses`: refuses a negative transmittance.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🥽️change-glazing-material-visible-transmittance/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_glazing_material_visible_transmittance(crate::model::EntityId(1), -0.1))
}

fn case() -> Case {
    Case { kind: "change-glazing-material-visible-transmittance", directory: "🥽️change-glazing-material-visible-transmittance/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
