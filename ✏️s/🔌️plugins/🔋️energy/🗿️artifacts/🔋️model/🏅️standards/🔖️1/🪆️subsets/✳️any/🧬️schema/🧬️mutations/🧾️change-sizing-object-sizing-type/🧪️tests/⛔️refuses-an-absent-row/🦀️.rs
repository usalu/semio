//! 🧪️ `change-sizing-object-sizing-type` fixture — `⛔️refuses-an-absent-row`: refuses an absent sizing object.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/⛔️refuses-an-absent-row/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/⛔️refuses-an-absent-row/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/⛔️refuses-an-absent-row/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/⛔️refuses-an-absent-row/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾️change-sizing-object-sizing-type/⛔️refuses-an-absent-row/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_sizing_object_sizing_type(crate::model::EntityId(99), crate::model::SizingType::Cooling))
}

fn case() -> Case {
    Case { kind: "change-sizing-object-sizing-type", directory: "🧾️change-sizing-object-sizing-type/⛔️refuses-an-absent-row", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
