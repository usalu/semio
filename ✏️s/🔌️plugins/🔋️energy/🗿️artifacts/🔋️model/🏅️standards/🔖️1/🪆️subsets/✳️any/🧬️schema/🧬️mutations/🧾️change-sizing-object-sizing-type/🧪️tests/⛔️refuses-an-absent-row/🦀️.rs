...
fn case() -> Case {
    Case { kind: "change-sizing-object-sizing-type", directory: "🧾️change-sizing-object-sizing-type/🧪️tests/⛔️refuses-an-absent-row", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
