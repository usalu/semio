//! 🧪️ `change-outdoor-air-system-min-oa-flow` fixture — `✅️raises-the-minimum`: raises the minimum outdoor air flow.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/✅️raises-the-minimum/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/✅️raises-the-minimum/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/✅️raises-the-minimum/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/✅️raises-the-minimum/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🦋️change-outdoor-air-system-min-oa-flow/✅️raises-the-minimum/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_outdoor_air_system_min_oa_flow(crate::model::EntityId(19), 0.35))
}

fn case() -> Case {
    Case { kind: "change-outdoor-air-system-min-oa-flow", directory: "🦋️change-outdoor-air-system-min-oa-flow/✅️raises-the-minimum", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
