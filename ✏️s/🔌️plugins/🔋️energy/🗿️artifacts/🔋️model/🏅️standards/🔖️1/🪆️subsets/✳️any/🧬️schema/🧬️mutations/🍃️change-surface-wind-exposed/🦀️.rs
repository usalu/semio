...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeSurfaceWindExposed {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change surface {} wind exposure to {}", self.id.0, self.new_wind_exposed), &format!("Oberfläche {} Windexposition auf {} ändern", self.id.0, self.new_wind_exposed))
    }
