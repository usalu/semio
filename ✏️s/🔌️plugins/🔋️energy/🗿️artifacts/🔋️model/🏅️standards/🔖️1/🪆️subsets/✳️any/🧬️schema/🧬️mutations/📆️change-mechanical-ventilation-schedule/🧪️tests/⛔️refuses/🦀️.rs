...
fn case() -> Case {
    Case { kind: "change-mechanical-ventilation-schedule", directory: "📆️change-mechanical-ventilation-schedule/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
