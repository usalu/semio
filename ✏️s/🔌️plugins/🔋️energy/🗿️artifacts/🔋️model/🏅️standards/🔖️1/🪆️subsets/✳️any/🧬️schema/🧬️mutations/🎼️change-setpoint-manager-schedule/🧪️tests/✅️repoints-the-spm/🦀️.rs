//! 🧪️ `change-setpoint-manager-schedule` fixture — `✅️repoints-the-spm`: repoints the manager at the second schedule.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎼️change-setpoint-manager-schedule/✅️repoints-the-spm/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎼️change-setpoint-manager-schedule/✅️repoints-the-spm/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎼️change-setpoint-manager-schedule/✅️repoints-the-spm/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎼️change-setpoint-manager-schedule/✅️repoints-the-spm/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎼️change-setpoint-manager-schedule/✅️repoints-the-spm/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_setpoint_manager_schedule(crate::model::EntityId(16), true, crate::model::ScheduleId(2)))
}

fn case() -> Case {
    Case { kind: "change-setpoint-manager-schedule", directory: "🎼️change-setpoint-manager-schedule/✅️repoints-the-spm", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
