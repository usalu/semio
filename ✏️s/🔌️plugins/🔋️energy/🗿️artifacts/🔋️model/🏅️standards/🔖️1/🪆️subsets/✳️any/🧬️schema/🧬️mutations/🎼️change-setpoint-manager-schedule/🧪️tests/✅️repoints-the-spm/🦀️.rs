...
fn case() -> Case {
    Case { kind: "change-setpoint-manager-schedule", directory: "🎼️change-setpoint-manager-schedule/🧪️tests/✅️repoints-the-spm", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
