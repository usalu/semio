...
fn case() -> Case {
    Case { kind: "connect-referenced-model", directory: "🪢️connect-referenced-model/🧪️tests/⛔️refuses-a-bad-uri", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
