...
fn case() -> Case {
    Case { kind: "rename-model", directory: "🏷️rename-model/🧪️tests/✅️renames-the-model", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
