//! 🧪️ `rename-model` fixture — `✅️renames-the-model`: renames the demo model.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-model/✅️renames-the-model/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-model/✅️renames-the-model/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-model/✅️renames-the-model/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-model/✅️renames-the-model/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-model/✅️renames-the-model/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "rename-model", directory: "🏷️rename-model/✅️renames-the-model", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
