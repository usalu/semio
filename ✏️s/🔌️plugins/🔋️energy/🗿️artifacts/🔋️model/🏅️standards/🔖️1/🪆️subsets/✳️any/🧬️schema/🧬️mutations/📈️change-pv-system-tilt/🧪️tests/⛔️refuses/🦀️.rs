...
fn case() -> Case {
    Case { kind: "change-pv-system-tilt", directory: "📈️change-pv-system-tilt/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
