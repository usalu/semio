...
fn case() -> Case {
    Case { kind: "delete-lighting-gain", directory: "🕯️delete-lighting-gain/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
