//! 🧪️ `change-infiltration-effective-leakage-area` fixture — `✅️applies`: moves infiltration 50.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🕳️change-infiltration-effective-leakage-area/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_infiltration_effective_leakage_area(crate::model::EntityId(50), 0.05))
}

fn case() -> Case {
    Case { kind: "change-infiltration-effective-leakage-area", directory: "🕳️change-infiltration-effective-leakage-area/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
