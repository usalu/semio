...
fn case() -> Case {
    Case { kind: "change-water-system-schedule", directory: "🕒️change-water-system-schedule/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
