//! 🧪️ `change-zone-multiplier` fixture — `✅️stacks-four-storeys`: stacks four identical storeys.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/✅️stacks-four-storeys/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/✅️stacks-four-storeys/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/✅️stacks-four-storeys/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/✅️stacks-four-storeys/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✖️change-zone-multiplier/✅️stacks-four-storeys/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "change-zone-multiplier", directory: "✖️change-zone-multiplier/✅️stacks-four-storeys", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
