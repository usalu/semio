...
fn case() -> Case {
    Case { kind: "change-zone-multiplier", directory: "✖️change-zone-multiplier/🧪️tests/✅️stacks-four-storeys", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
