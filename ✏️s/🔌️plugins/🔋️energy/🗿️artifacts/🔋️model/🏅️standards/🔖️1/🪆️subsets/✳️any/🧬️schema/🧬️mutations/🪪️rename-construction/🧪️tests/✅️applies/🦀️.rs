...
fn case() -> Case {
    Case { kind: "rename-construction", directory: "🪪️rename-construction/🧪️tests/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
