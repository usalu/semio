//! 🧪️ `delete-zone-equipment` fixture — `✅️drops-the-baseboard`: removes the baseboard.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/✅️drops-the-baseboard/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/✅️drops-the-baseboard/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/✅️drops-the-baseboard/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/✅️drops-the-baseboard/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-zone-equipment/✅️drops-the-baseboard/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::delete_zone_equipment(crate::model::EntityId(13)))
}

fn case() -> Case {
    Case { kind: "delete-zone-equipment", directory: "🗑️delete-zone-equipment/✅️drops-the-baseboard", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
