...
fn case() -> Case {
    Case { kind: "delete-zone-equipment", directory: "🗑️delete-zone-equipment/🧪️tests/✅️drops-the-baseboard", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
