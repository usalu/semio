...
impl protocol::MutationKind<EnergyModelSnapshot, EnergyModelMutation> for ChangeEquipmentGainLatentFraction {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change Equipment Gain Latent Fraction of equipment gain {}", self.id.0), &format!("Anlagengewinnlatentanteil von Anlagengewinn {} ändern", self.id.0))
    }
