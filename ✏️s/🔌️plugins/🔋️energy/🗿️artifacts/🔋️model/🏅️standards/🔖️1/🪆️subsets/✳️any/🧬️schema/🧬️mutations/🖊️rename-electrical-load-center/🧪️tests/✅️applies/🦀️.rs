//! 🧪️ `rename-electrical-load-center` fixture — `✅️applies`: moves electrical load center 320.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/✅️applies/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/✅️applies/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/✅️applies/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/✅️applies/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️rename-electrical-load-center/✅️applies/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::rename_electrical_load_center(crate::model::EntityId(320), "MAIN DISTRIBUTION".to_string()))
}

fn case() -> Case {
    Case { kind: "rename-electrical-load-center", directory: "🖊️rename-electrical-load-center/✅️applies", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
