//! 🧪️ `create-zone` fixture — `✅️adds-a-second-zone`: adds a second conditioned zone.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏘️create-zone/✅️adds-a-second-zone/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏘️create-zone/✅️adds-a-second-zone/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏘️create-zone/✅️adds-a-second-zone/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏘️create-zone/✅️adds-a-second-zone/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏘️create-zone/✅️adds-a-second-zone/🎯️outcome/🔣️.json");
...
fn case() -> Case {
    Case { kind: "create-zone", directory: "🏘️create-zone/✅️adds-a-second-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
