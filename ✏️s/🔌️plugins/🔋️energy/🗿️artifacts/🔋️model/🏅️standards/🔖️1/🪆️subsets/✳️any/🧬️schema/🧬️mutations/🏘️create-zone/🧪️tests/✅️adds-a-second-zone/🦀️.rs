...
fn case() -> Case {
    Case { kind: "create-zone", directory: "🏘️create-zone/🧪️tests/✅️adds-a-second-zone", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
