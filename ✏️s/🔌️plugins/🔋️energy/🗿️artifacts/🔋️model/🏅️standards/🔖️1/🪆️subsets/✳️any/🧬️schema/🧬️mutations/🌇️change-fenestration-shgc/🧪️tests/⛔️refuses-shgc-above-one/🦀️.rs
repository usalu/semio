//! 🧪️ `change-fenestration-shgc` fixture — `⛔️refuses-shgc-above-one`: refuses an SHGC above one.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/⛔️refuses-shgc-above-one/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/⛔️refuses-shgc-above-one/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/⛔️refuses-shgc-above-one/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/⛔️refuses-shgc-above-one/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌇️change-fenestration-shgc/⛔️refuses-shgc-above-one/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_fenestration_shgc(crate::model::EntityId(5), 1.4))
}

fn case() -> Case {
    Case { kind: "change-fenestration-shgc", directory: "🌇️change-fenestration-shgc/⛔️refuses-shgc-above-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
