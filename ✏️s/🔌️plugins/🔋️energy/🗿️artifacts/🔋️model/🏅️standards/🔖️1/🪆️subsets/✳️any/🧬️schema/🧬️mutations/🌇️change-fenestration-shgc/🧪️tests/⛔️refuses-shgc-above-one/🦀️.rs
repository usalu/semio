...
fn case() -> Case {
    Case { kind: "change-fenestration-shgc", directory: "🌇️change-fenestration-shgc/🧪️tests/⛔️refuses-shgc-above-one", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
