...
fn case() -> Case {
    Case { kind: "change-solar-thermal-system-collector-area", directory: "🟩️change-solar-thermal-system-collector-area/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
