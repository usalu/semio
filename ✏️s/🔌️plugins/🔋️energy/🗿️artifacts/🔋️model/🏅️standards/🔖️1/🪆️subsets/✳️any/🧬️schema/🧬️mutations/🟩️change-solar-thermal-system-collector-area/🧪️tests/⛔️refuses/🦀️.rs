//! 🧪️ `change-solar-thermal-system-collector-area` fixture — `⛔️refuses`: refuses collector area (m²) outside a positive finite value.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/⛔️refuses/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/⛔️refuses/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/⛔️refuses/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/⛔️refuses/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🟩️change-solar-thermal-system-collector-area/⛔️refuses/🎯️outcome/🔣️.json");
...
fn scenario() -> (EnergyModelSnapshot, EnergyModelMutation) {
    ...
    (snapshot(model), super::change_solar_thermal_system_collector_area(crate::model::EntityId(410), 0.0))
}

fn case() -> Case {
    Case { kind: "change-solar-thermal-system-collector-area", directory: "🟩️change-solar-thermal-system-collector-area/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
