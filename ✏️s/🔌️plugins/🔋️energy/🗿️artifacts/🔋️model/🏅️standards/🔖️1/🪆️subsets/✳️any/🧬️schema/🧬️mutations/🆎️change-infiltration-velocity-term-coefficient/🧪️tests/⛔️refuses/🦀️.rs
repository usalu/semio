...
fn case() -> Case {
    Case { kind: "change-infiltration-velocity-term-coefficient", directory: "🆎️change-infiltration-velocity-term-coefficient/🧪️tests/⛔️refuses", before: BEFORE, after: AFTER, mutation: MUTATION, diff: DIFF, outcome: OUTCOME, scenario }
}
