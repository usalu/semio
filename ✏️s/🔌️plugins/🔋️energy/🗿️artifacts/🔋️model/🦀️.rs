...
extern crate self as semio_s_artifact_energy_model;

pub use crate::schema::mutations::EnergyModelMutation;
pub use crate::schema::snapshot::EnergyModelSnapshot;
...
pub fn declaration() -> Result<semio_framework_plugin::ArtifactDeclaration, semio_framework_plugin::ArtifactDefinitionError> {
    semio_framework_plugin::ArtifactDeclaration::builder(definition()?)
        .schema(crate::standards::v1::subsets::any::schema::energy_model_artifact_schema_descriptor())
        .inferences([crate::standards::v1::subsets::any::schema::inferences::energy_model_artifact_inference_descriptor()])
