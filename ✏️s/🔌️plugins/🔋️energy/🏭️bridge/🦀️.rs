...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_energy_model::standards::v1::subsets::any::schema::snapshot::EnergyModelSnapshot, semio_s_artifact_energy_model::standards::v1::subsets::any::schema::mutations::EnergyModelMutation>,
];
