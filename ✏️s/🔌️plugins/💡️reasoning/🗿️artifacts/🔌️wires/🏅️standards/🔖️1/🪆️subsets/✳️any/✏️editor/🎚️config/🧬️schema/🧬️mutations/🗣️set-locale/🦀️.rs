//! 🧬️ Set Locale in the wires.config channel.
...
impl protocol::MutationKind<WiresConfig, WiresConfigMutation> for SetLocale {
    ...
    fn inverse(&self, base: &WiresConfig) -> Vec<WiresConfigMutation> { vec![WiresConfigMutation::SetLocale(Self { value: base.locale.clone() })] }
