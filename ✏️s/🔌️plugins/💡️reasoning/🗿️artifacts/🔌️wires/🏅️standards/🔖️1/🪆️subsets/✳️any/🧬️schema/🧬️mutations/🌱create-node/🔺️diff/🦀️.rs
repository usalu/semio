...
use crate::diff::{board_after_add_node, diff_board_fixture, WiresDiff};
use crate::schema::entity_id;
use crate::standards::v1::subsets::any::schema::inferences::find_board_node;
use crate::WiresSnapshot;

//#region 🔖️Diff
pub fn diff(payload: &super::CreateNode, base: &WiresSnapshot) -> protocol::MutationOutcome<WiresDiff> {
