...
fn vector(kind: &str) -> Result<Vector, String> {
    Ok(match kind {
        "set-camera" => Vector {
            before: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/✅️set-camera-applied/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/✅️set-camera-applied/🦠️mutation/🔣️.json"),
            after: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/✅️set-camera-applied/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/✅️set-camera-applied/🔺️diff/🔣️.json"),
            outcome: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/✅️set-camera-applied/🎯️outcome/🔣️.json"),
            observable: true,
        },
...
fn kept(kind: &str) -> Result<Vector, String> {
    Ok(match kind {
        "set-camera" => Vector {
            before: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/🟰️set-camera-no-op/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/🟰️set-camera-no-op/🦠️mutation/🔣️.json"),
            after: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/🟰️set-camera-no-op/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/🟰️set-camera-no-op/🔺️diff/🔣️.json"),
            outcome: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️canvas/🎚️config/🧫️fixtures/🎥️set-camera/🟰️set-camera-no-op/🎯️outcome/🔣️.json"),
            observable: false,
        },
