...
Feature: Apply every typed wires mutation to its committed vector, to a real-effect payload, and against an independent Python implementation
  ...
  Scenario Outline: Apply <id> to its committed vector and then for real
    ...
    Examples:
      ...
      | create-node       | 🌱create-node      | 🧪️rejects-a-node-id-the-board-already-holds                   | create-node      | mutation.duplicate-id   | Fatal   | {"mutation": "createNode", "node": {"id": "node-gamma", "nodeKind": "topic", "shape": "rectangle", "x": 80.0, "y": 40.0, "radius": 24.0, "text": "Gamma", "handles": []}}                                            |
      | delete-node       | 🗑️delete-node      | 🧪️rejects-deleting-a-node-the-board-never-held                | delete-node      | mutation.target-missing | Error   | {"mutation": "deleteNode", "nodeId": "node-anchor"}                                                                                                                                                                 |
      | move-node         | 🧭move-node        | 🧪️reports-a-no-op-when-a-y-less-node-is-moved-to-y-zero       | move-node        | mutation.no-op          | Warning | {"mutation": "moveNode", "nodeId": "node-drifter", "newX": 48.0, "newY": 36.0}                                                                                                                                       |
      | resize-node       | 📐resize-node      | 🧪️reports-a-no-op-when-the-radius-already-matches             | resize-node      | mutation.no-op          | Warning | {"mutation": "resizeNode", "nodeId": "node-nucleus", "newRadius": 40.0}                                                                                                                                              |
      | change-node-kind  | 🏷️change-node-kind | 🧪️reports-a-no-op-when-the-kind-already-reads-topic           | change-node-kind | mutation.no-op          | Warning | {"mutation": "changeNodeKind", "nodeId": "node-metabolism", "newNodeKind": "identity"}                                                                                                                               |
      | change-node-shape | 🔷change-node-shape| 🧪️reports-a-no-op-when-the-shape-already-reads-circle         | change-node-shape| mutation.no-op          | Warning | {"mutation": "changeNodeShape", "nodeId": "node-orbit", "newShape": "rectangle"}                                                                                                                                     |
      | edit-node-text    | ✏️edit-node-text   | 🧪️reports-a-no-op-when-the-label-is-retyped-verbatim          | edit-node-text   | mutation.no-op          | Warning | {"mutation": "editNodeText", "nodeId": "node-thesis", "newText": "Antithesis"}                                                                                                                                       |
      | set-node-root     | 🚩set-node-root    | 🧪️reports-a-no-op-when-an-unflagged-node-is-set-to-not-root   | set-node-root    | mutation.no-op          | Warning | {"mutation": "setNodeRoot", "nodeId": "node-leaf", "newRoot": true}                                                                                                                                                  |
      | connect-nodes     | 🤝️connect-nodes    | 🧪️rejects-an-edge-whose-source-node-is-absent                 | disconnect-nodes | mutation.target-missing | Error   | {"mutation": "connectNodes", "edge": {"id": "edge-mentions", "edgeKind": "wires.owns", "source": "node-source", "target": "node-sink"}, "relationship": {"relationshipId": 2.0, "kind": "owns", "sourceIdentityId": 1.0, "targetIdentityId": 2.0, "edgeId": "edge-mentions"}} |
      | disconnect-nodes  | ✂️disconnect-nodes | 🧪️rejects-cutting-an-edge-the-board-never-carried             | disconnect-nodes | mutation.target-missing | Error   | {"mutation": "disconnectNodes", "edgeId": "edge-owns"}                                                                                                                                                               |
