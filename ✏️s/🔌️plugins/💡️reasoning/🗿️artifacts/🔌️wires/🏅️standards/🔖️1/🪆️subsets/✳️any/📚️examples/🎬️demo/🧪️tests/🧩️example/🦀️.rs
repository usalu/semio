...
async fn inference_default_law() {
    use protocol::Inference;
    assert_eq!(
        crate::standards::v1::subsets::any::schema::inferences::WiresInference::infer(&crate::empty_wires_snapshot()),
        crate::standards::v1::subsets::any::schema::inferences::WiresInference::default(),
    );
}
