...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "edit-node-text/reports-a-no-op-when-the-label-is-retyped-verbatim: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
