//! 🧪️ `delete-node` fixture — `🚫️rejects-deleting-a-node-the-board-never-held`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🧪️rejects-deleting-a-node-the-board-never-held/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🧪️rejects-deleting-a-node-the-board-never-held/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🧪️rejects-deleting-a-node-the-board-never-held/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🧪️rejects-deleting-a-node-the-board-never-held/🎯️outcome/🔣️.json");
