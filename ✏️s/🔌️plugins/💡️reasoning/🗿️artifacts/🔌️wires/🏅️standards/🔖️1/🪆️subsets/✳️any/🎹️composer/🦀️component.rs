//! 🎹️ WiresComposer (1/✳️any) — analyzer + builder glued. Reads native `s.wires` sources
//! plus any of: stdio.csv, stdio.json, stdio.md, stdio.png, stdio.svg, stdio.txt. Writes one `s.wires` (1/✳️any) snapshot.
...
use crate::artifacts::wires::standards::v1::subsets::any::analyzer::WiresAnalyzer;
...
pub struct WiresComposer;

impl ArtifactComposer for WiresComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        ...
        Err(ComposeError { message: "WiresComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
