...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🤝️connect-nodes/🧪️rejects-an-edge-whose-source-node-is-absent/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🤝️connect-nodes/🧪️rejects-an-edge-whose-source-node-is-absent/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🤝️connect-nodes/🧪️rejects-an-edge-whose-source-node-is-absent/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🤝️connect-nodes/🧪️rejects-an-edge-whose-source-node-is-absent/🎯️outcome/🔣️.json");
