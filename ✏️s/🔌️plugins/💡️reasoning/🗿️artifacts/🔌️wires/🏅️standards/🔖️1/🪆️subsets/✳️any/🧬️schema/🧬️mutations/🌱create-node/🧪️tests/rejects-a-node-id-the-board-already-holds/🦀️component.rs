//! 🧪️ `create-node` fixture — `rejects-a-node-id-the-board-already-holds`.
//!
...
/// cache from that snapshot's own persisted `wiresFixture.board` mirror — the occupant whose id
