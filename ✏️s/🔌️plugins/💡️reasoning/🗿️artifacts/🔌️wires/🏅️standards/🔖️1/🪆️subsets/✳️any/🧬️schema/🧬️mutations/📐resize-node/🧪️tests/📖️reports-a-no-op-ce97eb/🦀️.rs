//! 🧪️ `resize-node` fixture — `📖️reports-a-no-op-when-the-radius-already-matches`.
//!
...
/// child owner. Nothing is invented: the seed is the committed snapshot's OWN persisted
