//! 📜️ DAG app — textual document grammar surface + laws (constitutional: dsl).
//!
...
/// tests parse via `include_str!("../../../../../../../../../🧰️framework/🛍️products/💻️os/🔨️modules/♾️infinite/🎲️board/🔌️ports/➡️directed/🕸️dag/⚡️implementations/🦀️rust/📚️examples/🕸️demo.dag")`.
pub const DAG_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../🧰️framework/🛍️products/💻️os/🔨️modules/♾️infinite/🎲️board/🔌️ports/➡️directed/🕸️dag/⚡️implementations/🦀️rust/📚️examples/🕸️demo.dag");
