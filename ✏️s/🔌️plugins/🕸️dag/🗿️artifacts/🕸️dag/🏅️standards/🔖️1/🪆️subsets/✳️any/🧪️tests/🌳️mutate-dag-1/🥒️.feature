...
Feature: Apply every typed DAG mutation to the real committed pipeline, to its rejection vectors, and against an independent Python implementation
  ...
  Scenario Outline: Apply <id> to its committed rejection vector and to the real pipeline
    ...
    Examples:
      ...
      | create-node               | 🌱create-node                | 🧪️rejects-a-duplicate-node-id                               | mutation.duplicate-id   | {"mutation": "createNode", "node": {"id": "gain", "name": "Gain", "abbreviation": "Gain", "icon": "", "x": -260.0, "y": 180.0, "width": 104.0, "height": 14.0, "properties": {}, "kind": "computation", "inputs": [], "outputs": [], "variadicInputs": false, "variadicOutputs": false}} |
      | delete-node               | 🗑️delete-node               | 🧪️rejects-deleting-a-missing-node                           | mutation.target-missing | {"mutation": "deleteNode", "id": "mode"}                                                                                                                                                          |
      | rename-node               | 🏷️rename-node               | 🧪️rejects-renaming-a-missing-node                           | mutation.target-missing | {"mutation": "renameNode", "id": "scale", "newId": "gain"}                                                                                                                                        |
      | change-node-name          | 🔤change-node-name           | 🧪️rejects-renaming-the-label-of-a-missing-node              | mutation.target-missing | {"mutation": "changeNodeName", "id": "combine", "newName": "Merge"}                                                                                                                               |
      | move-node                 | ↔️move-node                 | 🧪️rejects-moving-a-missing-node                             | mutation.target-missing | {"mutation": "moveNode", "id": "screen", "x": 520.0, "y": 40.0}                                                                                                                                   |
      | resize-node               | 📐resize-node                | 🧪️rejects-resizing-a-missing-node                           | mutation.target-missing | {"mutation": "resizeNode", "id": "screen", "width": 240.0, "height": 160.0}                                                                                                                       |
      | change-node-icon          | 🖼️change-node-icon          | 🧪️rejects-reiconing-a-missing-node                          | mutation.target-missing | {"mutation": "changeNodeIcon", "id": "slider", "newIcon": "emoji:spark"}                                                                                                                          |
      | change-node-abbreviation  | 🔡change-node-abbreviation   | 🧪️rejects-reabbreviating-a-missing-node                     | mutation.target-missing | {"mutation": "changeNodeAbbreviation", "id": "slider", "newAbbreviation": "Amt"}                                                                                                                   |
      | change-node-operator-kind | 🧮change-node-operator-kind  | 🧪️rejects-rebinding-the-operator-of-a-missing-node          | mutation.target-missing | {"mutation": "changeNodeOperatorKind", "id": "combine", "newOperatorKind": "sum"}                                                                                                                  |
      | replace-node-kind         | 🔁replace-node-kind          | 🧪️rejects-rekinding-a-missing-node                          | mutation.target-missing | {"mutation": "replaceNodeKind", "id": "scale", "newKind": {"kind": "computation", "inputs": [], "outputs": [], "variadicInputs": true, "variadicOutputs": false}}                                  |
      | replace-node-properties   | 🗃️replace-node-properties   | 🧪️rejects-repropertying-a-missing-node                      | mutation.target-missing | {"mutation": "replaceNodeProperties", "id": "scale", "newProperties": {"units": "mm"}}                                                                                                             |
      | reorder-nodes             | 🔀reorder-nodes              | 🧪️rejects-a-duplicate-id-in-the-order                       | mutation.invariant      | {"mutation": "reorderNodes", "order": ["screen", "combine", "scale", "mode", "slider"]}                                                                                                            |
      | connect-nodes             | 🤝️connect-nodes              | 🧪️rejects-a-missing-source-node                             | mutation.target-missing | {"mutation": "connectNodes", "id": "e5", "source": "slider@out", "target": "combine@a", "routeStyle": "bezier", "properties": {}}                                                                   |
      | disconnect-nodes          | ✂️disconnect-nodes          | 🧪️rejects-disconnecting-a-missing-edge                      | mutation.target-missing | {"mutation": "disconnectNodes", "id": "e3"}                                                                                                                                                       |
