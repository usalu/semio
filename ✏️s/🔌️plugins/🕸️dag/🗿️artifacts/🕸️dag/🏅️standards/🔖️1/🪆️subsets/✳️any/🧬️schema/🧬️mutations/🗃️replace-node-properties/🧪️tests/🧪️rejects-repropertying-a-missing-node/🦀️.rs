//! 🧪️ `replace-node-properties` fixture — `🚫️rejects-repropertying-a-missing-node`.
//!
...
use crate::mutations::{apply_dag_mutation, inverse_dag_mutation, replace_node_properties, DagMutation};
use crate::{DagDiff, DagSnapshot};

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️replace-node-properties/🧪️rejects-repropertying-a-missing-node/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️replace-node-properties/🧪️rejects-repropertying-a-missing-node/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️replace-node-properties/🧪️rejects-repropertying-a-missing-node/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗃️replace-node-properties/🧪️rejects-repropertying-a-missing-node/🎯️outcome/🔣️.json");
