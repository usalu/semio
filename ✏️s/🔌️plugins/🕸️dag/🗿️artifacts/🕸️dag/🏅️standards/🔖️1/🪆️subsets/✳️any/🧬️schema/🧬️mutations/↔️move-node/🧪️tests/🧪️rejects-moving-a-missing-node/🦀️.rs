...
use crate::mutations::{apply_dag_mutation, inverse_dag_mutation, move_node, DagMutation};
use crate::{DagDiff, DagSnapshot};

const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-node/🧪️rejects-moving-a-missing-node/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-node/🧪️rejects-moving-a-missing-node/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-node/🧪️rejects-moving-a-missing-node/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-node/🧪️rejects-moving-a-missing-node/🎯️outcome/🔣️.json");
