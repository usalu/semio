...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-nodes/🧪️rejects-disconnecting-a-missing-edge/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-nodes/🧪️rejects-disconnecting-a-missing-edge/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-nodes/🧪️rejects-disconnecting-a-missing-edge/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-nodes/🧪️rejects-disconnecting-a-missing-edge/🎯️outcome/🔣️.json");
