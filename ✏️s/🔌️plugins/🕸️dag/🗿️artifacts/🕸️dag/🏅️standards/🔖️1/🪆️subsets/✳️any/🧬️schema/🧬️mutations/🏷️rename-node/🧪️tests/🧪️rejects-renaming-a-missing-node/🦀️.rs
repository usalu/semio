//! 🧪️ `rename-node` fixture — `🚫️rejects-renaming-a-missing-node`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-node/🧪️rejects-renaming-a-missing-node/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-node/🧪️rejects-renaming-a-missing-node/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-node/🧪️rejects-renaming-a-missing-node/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-node/🧪️rejects-renaming-a-missing-node/🎯️outcome/🔣️.json");
