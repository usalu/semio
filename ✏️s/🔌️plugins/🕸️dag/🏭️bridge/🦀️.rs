//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🕸️dag`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("DagConfigMutation", descriptors::<semio_s_artifact_dag_dag::editor::dag::config::DagConfig, semio_s_artifact_dag_dag::editor::dag::config::mutations::DagConfigMutation>),
    ("DagPresenceMutation", descriptors::<semio_s_artifact_dag_dag::editor::dag::presence::DagPresence, semio_s_artifact_dag_dag::editor::dag::presence::mutations::DagPresenceMutation>),
    ("DagMutation", descriptors::<semio_s_artifact_dag_dag::standards::v1::subsets::any::schema::snapshot::DagSnapshot, semio_s_artifact_dag_dag::standards::v1::subsets::any::schema::mutations::DagMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.dag.dag", "1", "any", "", "✏️s/🔌️plugins/🕸️dag/🗿️artifacts/🕸️dag/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.dag.dag", "1", "any", "✏️editor/🎚️config", "✏️s/🔌️plugins/🕸️dag/🗿️artifacts/🕸️dag/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎚️config", ""),
    ("s.dag.dag", "1", "any", "✏️editor/👥️presence", "✏️s/🔌️plugins/🕸️dag/🗿️artifacts/🕸️dag/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/👥️presence", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-dag-mutation-bridge")),
