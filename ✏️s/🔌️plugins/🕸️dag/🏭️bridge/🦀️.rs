...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_dag_dag::standards::v1::subsets::any::schema::snapshot::DagSnapshot, semio_s_artifact_dag_dag::standards::v1::subsets::any::schema::mutations::DagMutation>,
];
