//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🏭️process`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("Process3dMutation", descriptors::<semio_s_artifact_process_process3d::standards::v1::subsets::any::schema::snapshot::Process3dSnapshot, semio_s_artifact_process_process3d::standards::v1::subsets::any::schema::mutations::Process3dMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.process.process3d", "1", "any", "", "✏️s/🔌️plugins/🏭️process/🗿️artifacts/🧊️process3d/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-process-mutation-bridge")),
