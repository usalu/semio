...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_process_process3d::standards::v1::subsets::any::schema::snapshot::Process3dSnapshot, semio_s_artifact_process_process3d::standards::v1::subsets::any::schema::mutations::Process3dMutation>,
];
