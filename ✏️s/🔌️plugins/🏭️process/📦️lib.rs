...
pub mod artifacts {
    ...
    pub mod process3d {
        ...
        pub mod engine {
            ...
            #[path = "🗿️artifacts/🧊️process3d/⚙️engine/🦀️catalog_wood.rs"]
            pub mod catalog_wood;
            #[path = "🗿️artifacts/🧊️process3d/⚙️engine/🦀️catalog_concrete.rs"]
            pub mod catalog_concrete;
            #[path = "🗿️artifacts/🧊️process3d/⚙️engine/🦀️catalog_metal.rs"]
            pub mod catalog_metal;
            #[path = "🗿️artifacts/🧊️process3d/⚙️engine/🦀️catalog_robotic.rs"]
