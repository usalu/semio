...
pub mod set_snapshot {
    ...
    pub fn handle(payload: &SetSnapshot, _doc: &ArtifactView<'_, Process3dSnapshot>, _cfg: &ConfigView<'_, Process3dConfig>) -> Result<Emit<Process3dMutation, Process3dConfigMutation>, Fault> {
        Ok(Emit {
            artifact_mutations: vec![Process3dMutation::SetSnapshot { snapshot: payload.snapshot.clone() }],
