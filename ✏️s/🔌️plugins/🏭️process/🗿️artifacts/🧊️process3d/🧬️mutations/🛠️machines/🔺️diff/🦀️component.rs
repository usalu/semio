//! 🔺️ Diff fragment yielded by `Machines`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `Machines` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct MachinesDiff {
...
impl MutationDiff<Process3dDocument> for MachinesDiff {
