...
async fn regenerate_step_mutation_vectors() {
    ...
    let bore_hole = ProcessStep {
        id: "step-2".into(),
        label: "Bore Hole".into(),
        enabled: true,
        origin: Some(StepOrigin { machine_id: "saw".into(), capability_id: "drill".into() }),
        measure: ProcessMeasure::Drill { radius: 0.008, depth: 0.02, pose: Pose::default() },
    };
