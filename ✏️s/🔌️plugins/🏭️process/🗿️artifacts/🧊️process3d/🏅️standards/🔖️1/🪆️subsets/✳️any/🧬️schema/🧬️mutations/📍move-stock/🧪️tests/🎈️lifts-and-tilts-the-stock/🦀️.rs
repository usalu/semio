//! 🧪️ `move-stock` fixture — `🎈️lifts-and-tilts-the-stock`.
//!
...
async fn produces_committed_diff() {
    ...
    assert!(semio_framework_os_kernel::json::value_eq_ignoring_object_order(&produced, &committed), "move-stock/lifts-and-tilts-the-stock: produced diff differs from the committed 🔺️diff/🔣️.json");
}
