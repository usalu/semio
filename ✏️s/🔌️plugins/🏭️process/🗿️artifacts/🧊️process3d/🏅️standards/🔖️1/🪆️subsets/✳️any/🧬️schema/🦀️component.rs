...
pub fn metal_catalog() -> Box<dyn MachineCatalog> {
...
pub fn wood_catalog() -> Box<dyn MachineCatalog> {
    Box::new(WoodCatalog)
}
...
pub fn robotic_catalog() -> Box<dyn MachineCatalog> {
...
pub fn concrete_catalog() -> Box<dyn MachineCatalog> {
