...
//!
//! Whole-document snapshot replacement (`SetSnapshot`) is BANNED by
...
impl protocol::MutationKind<Process3dSnapshot, Process3dMutation> for ReplaceStepMeasure {
    ...
    fn diff(&self, base: &Process3dSnapshot) -> Process3dDiff {
        crate::artifacts::process3d::mutations::set_snapshot::diff::diff(self, base)
    }

    fn inverse(&self, base: &Process3dSnapshot) -> Vec<Process3dMutation> {
        crate::artifacts::process3d::mutations::set_snapshot::inverse::inverse(self, base)
    }
