//! 🧪️ `change-cursor` fixture — `🟠️pins-the-replay-cursor-to-two-steps`.
//!
...
async fn produces_committed_diff() {
    ...
    assert!(semio_framework_os_kernel::json::value_eq_ignoring_object_order(&produced, &committed), "change-cursor/pins-the-replay-cursor-to-two-steps: produced diff differs from the committed 🔺️diff/🔣️.json");
}
