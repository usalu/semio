...
pub mod set_sun_azimuth {
    ...
    pub fn handle(payload: &SetSunAzimuth, _doc: &ArtifactView<'_, Process3dSnapshot>, cfg: &ConfigView<'_, Process3dConfig>, _ctx: &mut crate::editor::process3d::Process3dDispatchCtx) -> Result<Emit<Process3dMutation, Process3dConfigMutation>, Fault> {
        let config = cfg.snapshot;
...
pub mod set_sun_elevation {
    ...
    pub fn handle(payload: &SetSunElevation, _doc: &ArtifactView<'_, Process3dSnapshot>, cfg: &ConfigView<'_, Process3dConfig>, _ctx: &mut crate::editor::process3d::Process3dDispatchCtx) -> Result<Emit<Process3dMutation, Process3dConfigMutation>, Fault> {
        let config = cfg.snapshot;
...
pub mod set_sun_intensity {
    ...
    pub fn handle(payload: &SetSunIntensity, _doc: &ArtifactView<'_, Process3dSnapshot>, cfg: &ConfigView<'_, Process3dConfig>, _ctx: &mut crate::editor::process3d::Process3dDispatchCtx) -> Result<Emit<Process3dMutation, Process3dConfigMutation>, Fault> {
        let config = cfg.snapshot;
