...
async fn produces_committed_diff() {
    ...
    assert!(semio_framework_os_kernel::json::value_eq_ignoring_object_order(&produced, &committed), "change-step-origin/accepts-a-machine-provenance-and-changes-nothing: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
