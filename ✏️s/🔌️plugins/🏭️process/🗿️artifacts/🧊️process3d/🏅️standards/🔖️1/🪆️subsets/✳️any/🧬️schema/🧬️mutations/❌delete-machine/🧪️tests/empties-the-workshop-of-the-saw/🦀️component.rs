...
async fn produces_committed_diff() {
    ...
    assert!(semio_framework_os_kernel::json::value_eq_ignoring_object_order(&produced, &committed), "delete-machine/empties-the-workshop-of-the-saw: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
