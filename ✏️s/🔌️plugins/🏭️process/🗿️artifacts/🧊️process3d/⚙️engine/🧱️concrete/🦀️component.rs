//! 🧱️ Process3d engine — built-in concrete-shop machine catalog (saws, core drilling, anchors, grinding).
//!
//! Folded in from the old, standalone `semio-s-plugin-process-concrete` crate — see
//! `🦀️catalog_wood.rs`'s doc comment for why these built-in catalogs are engine topic files rather than
//! satellite crates in this merged layout.
