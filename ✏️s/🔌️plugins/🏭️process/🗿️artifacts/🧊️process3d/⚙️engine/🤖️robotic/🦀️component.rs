//! 🤖️ Process3d engine — built-in robotic/CNC machine catalog (multi-axis mills, gantry CNC, waterjet,
//! laser, assembler).
//!
//! Folded in from the old, standalone `semio-s-plugin-process-robotic` crate — see `🦀️catalog_wood.rs`'s
