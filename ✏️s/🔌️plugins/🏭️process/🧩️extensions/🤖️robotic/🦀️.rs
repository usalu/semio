...
fn bundle() -> ExtensionBundle {
    ...
    let bundle = ExtensionBundle::new(EXTENSION_ID, "Process Robotic Machines", env!("CARGO_PKG_VERSION")).extends("process").depends_on("process", semio_framework::tree_pin!());
