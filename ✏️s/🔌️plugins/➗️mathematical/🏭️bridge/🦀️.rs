...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_mathematical_equation::standards::v1::subsets::any::schema::snapshot::EquationSnapshot, semio_s_artifact_mathematical_equation::standards::v1::subsets::any::schema::mutations::EquationMutation>,
];
