//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/➗️mathematical`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("EquationGraphWindowConfigMutation", descriptors::<semio_s_artifact_mathematical_equation::editor::equation::modes::edit::windows::graph::config::EquationGraphWindowConfig, semio_s_artifact_mathematical_equation::editor::equation::modes::edit::windows::graph::config::EquationGraphWindowConfigMutation>),
    ("EquationMutation", descriptors::<semio_s_artifact_mathematical_equation::standards::v1::subsets::any::schema::snapshot::EquationSnapshot, semio_s_artifact_mathematical_equation::standards::v1::subsets::any::schema::mutations::EquationMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.mathematical.equation", "1", "any", "✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️graph/🎚️config", "✏️s/🔌️plugins/➗️mathematical/🗿️artifacts/➗️equation/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎭️modes/✏️edit/🪟️windows/🕸️graph/🎚️config", ""),
    ("s.mathematical.equation", "1", "equation", "", "✏️s/🔌️plugins/➗️mathematical/🗿️artifacts/➗️equation/🏅️standards/🔖️1/🪆️subsets/➗️equation", ""),
    ("s.mathematical.equation", "1", "geometry", "", "✏️s/🔌️plugins/➗️mathematical/🗿️artifacts/➗️equation/🏅️standards/🔖️1/🪆️subsets/📐️geometry", ""),
    ("s.mathematical.equation", "1", "graph", "", "✏️s/🔌️plugins/➗️mathematical/🗿️artifacts/➗️equation/🏅️standards/🔖️1/🪆️subsets/🕸️graph", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-mathematical-mutation-bridge")),
