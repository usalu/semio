/** 👁️ Equation viewer — subset-level typed twin. Read-only counterpart of
...
export const EQUATION_VIEWER_DIALECT = { artifactKind: "s.mathematical.equation", standard: "1", subset: "*" } as const;
