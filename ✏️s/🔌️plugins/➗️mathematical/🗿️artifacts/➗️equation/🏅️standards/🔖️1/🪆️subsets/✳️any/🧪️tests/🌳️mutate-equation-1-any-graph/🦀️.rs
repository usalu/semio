...
fn vector(kind: &str) -> Vector {
    match kind {
        "change-graph-directed" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔀️change-graph-directed/🧪️tests/🌳️keeps-an-already-directed-graph-directed/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔀️change-graph-directed/🧪️tests/🌳️keeps-an-already-directed-graph-directed/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔀️change-graph-directed/🧪️tests/🌳️keeps-an-already-directed-graph-directed/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔀️change-graph-directed/🧪️tests/🌳️keeps-an-already-directed-graph-directed/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔀️change-graph-directed/🧪️tests/🌳️keeps-an-already-directed-graph-directed/🎯️outcome/🔣️.json"),
        },
        "update-graph-algorithm" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🧮️update-graph-algorithm/🧪️tests/🟢️restates-the-unset-algorithm-and-its-absent-seed/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🧮️update-graph-algorithm/🧪️tests/🟢️restates-the-unset-algorithm-and-its-absent-seed/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🧮️update-graph-algorithm/🧪️tests/🟢️restates-the-unset-algorithm-and-its-absent-seed/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🧮️update-graph-algorithm/🧪️tests/🟢️restates-the-unset-algorithm-and-its-absent-seed/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🧮️update-graph-algorithm/🧪️tests/🟢️restates-the-unset-algorithm-and-its-absent-seed/🎯️outcome/🔣️.json"),
        },
        "replace-graph" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔁️replace-graph/🧪️tests/🌳️replays-the-identical-empty-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔁️replace-graph/🧪️tests/🌳️replays-the-identical-empty-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔁️replace-graph/🧪️tests/🌳️replays-the-identical-empty-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔁️replace-graph/🧪️tests/🌳️replays-the-identical-empty-graph/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔁️replace-graph/🧪️tests/🌳️replays-the-identical-empty-graph/🎯️outcome/🔣️.json"),
        },
        "create-node" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🟢️create-node/🧪️tests/🚫️rejects-a-duplicate-node-id/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🟢️create-node/🧪️tests/🚫️rejects-a-duplicate-node-id/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🟢️create-node/🧪️tests/🚫️rejects-a-duplicate-node-id/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🟢️create-node/🧪️tests/🚫️rejects-a-duplicate-node-id/🎯️outcome/🔣️.json"),
        },
        "delete-node" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/❌️delete-node/🧪️tests/🚫️rejects-deleting-a-node-that-is-not-in-the-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/❌️delete-node/🧪️tests/🚫️rejects-deleting-a-node-that-is-not-in-the-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/❌️delete-node/🧪️tests/🚫️rejects-deleting-a-node-that-is-not-in-the-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/❌️delete-node/🧪️tests/🚫️rejects-deleting-a-node-that-is-not-in-the-graph/🎯️outcome/🔣️.json"),
        },
        "delete-nodes" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🗑️delete-nodes/🧪️tests/🚫️rejects-a-bulk-delete-where-every-id-is-absent/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🗑️delete-nodes/🧪️tests/🚫️rejects-a-bulk-delete-where-every-id-is-absent/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🗑️delete-nodes/🧪️tests/🚫️rejects-a-bulk-delete-where-every-id-is-absent/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🗑️delete-nodes/🧪️tests/🚫️rejects-a-bulk-delete-where-every-id-is-absent/🎯️outcome/🔣️.json"),
        },
        "change-node-label" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🏷️change-node-label/🧪️tests/🚫️rejects-relabelling-a-node-that-is-not-in-the-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🏷️change-node-label/🧪️tests/🚫️rejects-relabelling-a-node-that-is-not-in-the-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🏷️change-node-label/🧪️tests/🚫️rejects-relabelling-a-node-that-is-not-in-the-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🏷️change-node-label/🧪️tests/🚫️rejects-relabelling-a-node-that-is-not-in-the-graph/🎯️outcome/🔣️.json"),
        },
        "move-node" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🕹️move-node/🧪️tests/🚫️rejects-moving-a-node-that-is-not-in-the-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🕹️move-node/🧪️tests/🚫️rejects-moving-a-node-that-is-not-in-the-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🕹️move-node/🧪️tests/🚫️rejects-moving-a-node-that-is-not-in-the-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🕹️move-node/🧪️tests/🚫️rejects-moving-a-node-that-is-not-in-the-graph/🎯️outcome/🔣️.json"),
        },
        "connect-nodes" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔗️connect-nodes/🧪️tests/🚫️rejects-an-edge-between-two-absent-endpoints/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔗️connect-nodes/🧪️tests/🚫️rejects-an-edge-between-two-absent-endpoints/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔗️connect-nodes/🧪️tests/🚫️rejects-an-edge-between-two-absent-endpoints/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/🔗️connect-nodes/🧪️tests/🚫️rejects-an-edge-between-two-absent-endpoints/🎯️outcome/🔣️.json"),
        },
        "disconnect-nodes" => Vector {
            before: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/✂️disconnect-nodes/🧪️tests/🚫️rejects-severing-an-edge-that-is-not-in-the-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/✂️disconnect-nodes/🧪️tests/🚫️rejects-severing-an-edge-that-is-not-in-the-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/✂️disconnect-nodes/🧪️tests/🚫️rejects-severing-an-edge-that-is-not-in-the-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧬️schema/🧬️mutations/✂️disconnect-nodes/🧪️tests/🚫️rejects-severing-an-edge-that-is-not-in-the-graph/🎯️outcome/🔣️.json"),
        },
