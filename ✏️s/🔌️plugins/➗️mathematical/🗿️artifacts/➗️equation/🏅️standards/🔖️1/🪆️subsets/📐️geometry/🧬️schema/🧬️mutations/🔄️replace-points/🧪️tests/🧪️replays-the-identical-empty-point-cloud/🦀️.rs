...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/🎯️outcome/🔣️.json");
