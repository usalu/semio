//! ➗️ `s.mathematical.equation` equation mutation case — Rust adapter. Relocated out of the
...
fn vector(kind: &str) -> Vector {
    match kind {
        "change-coefficient" => Vector {
            before: include_str!("../../🧬️schema/🧬️mutations/🎚️change-coefficient/🧪️tests/➗️raises-the-leading-coefficient-to-three-halves/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../🧬️schema/🧬️mutations/🎚️change-coefficient/🧪️tests/➗️raises-the-leading-coefficient-to-three-halves/🦠️mutation/🔣️.json"),
            after: include_str!("../../🧬️schema/🧬️mutations/🎚️change-coefficient/🧪️tests/➗️raises-the-leading-coefficient-to-three-halves/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../🧬️schema/🧬️mutations/🎚️change-coefficient/🧪️tests/➗️raises-the-leading-coefficient-to-three-halves/🔺️diff/🔣️.json")),
            outcome: include_str!("../../🧬️schema/🧬️mutations/🎚️change-coefficient/🧪️tests/➗️raises-the-leading-coefficient-to-three-halves/🎯️outcome/🔣️.json"),
        },
...
fn canonical(text: &str) -> Json {
    parse_json(text).unwrap_or_else(|error| panic!("mutate-equation-1-equation: a committed fixture must be valid JSON: {error}"))
}
//#endregion 🔖️Fixtures
