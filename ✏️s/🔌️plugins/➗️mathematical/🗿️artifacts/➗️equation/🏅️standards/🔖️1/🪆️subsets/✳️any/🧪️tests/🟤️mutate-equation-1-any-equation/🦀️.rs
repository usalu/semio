...
//! Duplicated verbatim (only relative paths adjusted) from `../../../➗️equation/🧪️tests/🦋️mutate-equation-1-equation/` by shard F4 (this ticket) to close `unregistered-mutation-vocabulary` at the `✳️any/🧬️schema/🧬️mutations` + `✳️any/🚪️io/🧬️mutations` owner — same mechanism E3 already proved on `sequence`: reuse the already-manifested `equation-1-equation-mutate` capability, no new v2 manifest entry or runtime-inventory coordinate.
...
//#region 🔖️Kinds
/// 🏷️ This subset's own slice of `KINDS` in `../../../➗️equation/🧬️schema/🧬️mutations/🦀️.rs` — duplicated, not
