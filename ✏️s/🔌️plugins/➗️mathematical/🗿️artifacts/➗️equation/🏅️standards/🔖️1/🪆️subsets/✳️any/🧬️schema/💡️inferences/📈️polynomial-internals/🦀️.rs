...
//!
//! 🚚 Migrated verbatim from `🧰️framework/🔨️modules/🧮️math/📈️polynomial/🦀️.rs` (ticket
//! 26/08/12/DISSOLVE-KERNELS-AND-MODULES-INTO-EVENT-SOURCED-ARTIFACTS, wave M3a) — see
//! `🌿️cas-internals/🦀️.rs`'s doc header (its sibling in this move) for the full rationale.
//! `crate::polynomial` self-references are preserved unedited via a crate-root `pub use … as
//! polynomial;` alias in `🦀️.rs`; `crate::number` became `number::` (wave MATHEND). Unlike
...
pub mod univariate {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️univariate-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod multivariate {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️multivariate-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
...
pub mod finite {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️finite-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Finite
...
pub mod factor {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️factor-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Factor
...
pub mod roots {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️roots-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
// #endregion 🔖️Roots
...
pub mod algebraic {
    ...
    // #region 🔖️Tests
    #[cfg(test)]
    include!("🧪️tests/🔬️algebraic-unit/🦀️.rs");
    // #endregion 🔖️Tests
}
