...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/🎯️outcome/🔣️.json");
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(outcome.get("status").and_then(pack::JsonValue::as_str), Some("no-op"), "replace-graph/replays-the-identical-empty-graph declares a no-op outcome");
