...
fn vector(kind: &str) -> Vector {
    match kind {
        "change-graph-directed" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧭️change-graph-directed/🧪️keeps-an-already-directed-graph-directed/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧭️change-graph-directed/🧪️keeps-an-already-directed-graph-directed/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧭️change-graph-directed/🧪️keeps-an-already-directed-graph-directed/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧭️change-graph-directed/🧪️keeps-an-already-directed-graph-directed/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧭️change-graph-directed/🧪️keeps-an-already-directed-graph-directed/🎯️outcome/🔣️.json"),
        },
        "update-graph-algorithm" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧮️update-graph-algorithm/🧪️restates-the-unset-algorithm-and-its-absent-seed/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧮️update-graph-algorithm/🧪️restates-the-unset-algorithm-and-its-absent-seed/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧮️update-graph-algorithm/🧪️restates-the-unset-algorithm-and-its-absent-seed/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧮️update-graph-algorithm/🧪️restates-the-unset-algorithm-and-its-absent-seed/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🧮️update-graph-algorithm/🧪️restates-the-unset-algorithm-and-its-absent-seed/🎯️outcome/🔣️.json"),
        },
        "replace-graph" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔁️replace-graph/🧪️replays-the-identical-empty-graph/🎯️outcome/🔣️.json"),
        },
        "create-node" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/➕️create-node/🧪️rejects-a-duplicate-node-id/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/➕️create-node/🧪️rejects-a-duplicate-node-id/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/➕️create-node/🧪️rejects-a-duplicate-node-id/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/➕️create-node/🧪️rejects-a-duplicate-node-id/🎯️outcome/🔣️.json"),
        },
        "delete-node" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/❌️delete-node/🧪️rejects-deleting-a-node-that-is-not-in-the-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/❌️delete-node/🧪️rejects-deleting-a-node-that-is-not-in-the-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/❌️delete-node/🧪️rejects-deleting-a-node-that-is-not-in-the-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/❌️delete-node/🧪️rejects-deleting-a-node-that-is-not-in-the-graph/🎯️outcome/🔣️.json"),
        },
        "delete-nodes" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🗑️delete-nodes/🧪️rejects-a-bulk-delete-where-every-id-is-absent/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🗑️delete-nodes/🧪️rejects-a-bulk-delete-where-every-id-is-absent/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🗑️delete-nodes/🧪️rejects-a-bulk-delete-where-every-id-is-absent/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🗑️delete-nodes/🧪️rejects-a-bulk-delete-where-every-id-is-absent/🎯️outcome/🔣️.json"),
        },
        "change-node-label" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🏷️change-node-label/🧪️rejects-relabelling-a-node-that-is-not-in-the-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🏷️change-node-label/🧪️rejects-relabelling-a-node-that-is-not-in-the-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🏷️change-node-label/🧪️rejects-relabelling-a-node-that-is-not-in-the-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🏷️change-node-label/🧪️rejects-relabelling-a-node-that-is-not-in-the-graph/🎯️outcome/🔣️.json"),
        },
        "move-node" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🕹️move-node/🧪️rejects-moving-a-node-that-is-not-in-the-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🕹️move-node/🧪️rejects-moving-a-node-that-is-not-in-the-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🕹️move-node/🧪️rejects-moving-a-node-that-is-not-in-the-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🕹️move-node/🧪️rejects-moving-a-node-that-is-not-in-the-graph/🎯️outcome/🔣️.json"),
        },
        "connect-nodes" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔗️connect-nodes/🧪️rejects-an-edge-between-two-absent-endpoints/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔗️connect-nodes/🧪️rejects-an-edge-between-two-absent-endpoints/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔗️connect-nodes/🧪️rejects-an-edge-between-two-absent-endpoints/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/🔗️connect-nodes/🧪️rejects-an-edge-between-two-absent-endpoints/🎯️outcome/🔣️.json"),
        },
        "disconnect-nodes" => Vector {
            before: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/✂️disconnect-nodes/🧪️rejects-severing-an-edge-that-is-not-in-the-graph/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/✂️disconnect-nodes/🧪️rejects-severing-an-edge-that-is-not-in-the-graph/🦠️mutation/🔣️.json"),
            after: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/✂️disconnect-nodes/🧪️rejects-severing-an-edge-that-is-not-in-the-graph/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../🕸️graph/🧫️fixtures/🧬️mutations/✂️disconnect-nodes/🧪️rejects-severing-an-edge-that-is-not-in-the-graph/🎯️outcome/🔣️.json"),
        },
