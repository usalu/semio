...
fn vector(kind: &str) -> Vector {
    match kind {
        "replace-points" => Vector {
            before: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🔄️replace-points/🧪️tests/🔄️replays-the-95870f/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🔄️replace-points/🧪️tests/🔄️replays-the-95870f/🦠️mutation/🔣️.json"),
            after: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🔄️replace-points/🧪️tests/🔄️replays-the-95870f/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🔄️replace-points/🧪️tests/🔄️replays-the-95870f/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🔄️replace-points/🧪️tests/🔄️replays-the-95870f/🎯️outcome/🔣️.json"),
        },
        "insert-point" => Vector {
            before: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➕️insert-point/🧪️tests/📍️seeds-the-empty-b1911b/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➕️insert-point/🧪️tests/📍️seeds-the-empty-b1911b/🦠️mutation/🔣️.json"),
            after: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➕️insert-point/🧪️tests/📍️seeds-the-empty-b1911b/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➕️insert-point/🧪️tests/📍️seeds-the-empty-b1911b/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➕️insert-point/🧪️tests/📍️seeds-the-empty-b1911b/🎯️outcome/🔣️.json"),
        },
        "remove-point" => Vector {
            before: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➖️remove-point/🧪️tests/🚫️rejects-removing-6265f6/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➖️remove-point/🧪️tests/🚫️rejects-removing-6265f6/🦠️mutation/🔣️.json"),
            after: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➖️remove-point/🧪️tests/🚫️rejects-removing-6265f6/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/➖️remove-point/🧪️tests/🚫️rejects-removing-6265f6/🎯️outcome/🔣️.json"),
        },
        "move-point" => Vector {
            before: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🎯️move-point/🧪️tests/🚫️rejects-moving-a-3f5e64/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🎯️move-point/🧪️tests/🚫️rejects-moving-a-3f5e64/🦠️mutation/🔣️.json"),
            after: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🎯️move-point/🧪️tests/🚫️rejects-moving-a-3f5e64/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../📐️geometry/🧬️schema/🧬️mutations/🎯️move-point/🧪️tests/🚫️rejects-moving-a-3f5e64/🎯️outcome/🔣️.json"),
        },
