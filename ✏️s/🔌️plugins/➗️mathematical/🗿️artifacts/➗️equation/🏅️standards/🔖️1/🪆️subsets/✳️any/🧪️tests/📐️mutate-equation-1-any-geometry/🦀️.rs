...
fn vector(kind: &str) -> Vector {
    match kind {
        "replace-points" => Vector {
            before: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/🦠️mutation/🔣️.json"),
            after: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🔄️replace-points/🧪️replays-the-identical-empty-point-cloud/🎯️outcome/🔣️.json"),
        },
        "insert-point" => Vector {
            before: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➕️insert-point/🧪️seeds-the-empty-cloud-with-its-first-point/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➕️insert-point/🧪️seeds-the-empty-cloud-with-its-first-point/🦠️mutation/🔣️.json"),
            after: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➕️insert-point/🧪️seeds-the-empty-cloud-with-its-first-point/📸️snapshot/➡️after/🔣️.json"),
            diff: Some(include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➕️insert-point/🧪️seeds-the-empty-cloud-with-its-first-point/🔺️diff/🔣️.json")),
            outcome: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➕️insert-point/🧪️seeds-the-empty-cloud-with-its-first-point/🎯️outcome/🔣️.json"),
        },
        "remove-point" => Vector {
            before: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➖️remove-point/🧪️rejects-removing-a-point-from-an-empty-cloud/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➖️remove-point/🧪️rejects-removing-a-point-from-an-empty-cloud/🦠️mutation/🔣️.json"),
            after: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➖️remove-point/🧪️rejects-removing-a-point-from-an-empty-cloud/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/➖️remove-point/🧪️rejects-removing-a-point-from-an-empty-cloud/🎯️outcome/🔣️.json"),
        },
        "move-point" => Vector {
            before: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🎯️move-point/🧪️rejects-moving-a-point-that-is-not-in-the-cloud/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🎯️move-point/🧪️rejects-moving-a-point-that-is-not-in-the-cloud/🦠️mutation/🔣️.json"),
            after: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🎯️move-point/🧪️rejects-moving-a-point-that-is-not-in-the-cloud/📸️snapshot/➡️after/🔣️.json"),
            diff: None,
            outcome: include_str!("../../../📐️geometry/🧫️fixtures/🧬️mutations/🎯️move-point/🧪️rejects-moving-a-point-that-is-not-in-the-cloud/🎯️outcome/🔣️.json"),
        },
