@capability-mathematical-1-graph-mutate
@no-oracle-mathematical-mutation-semantics
@comparison-ordered-json-v1
@mutations-mathematical-1-graph
Feature: Apply every typed s.mathematical.mathematical graph mutation to its committed specification vector
