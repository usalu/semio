...
pub fn layout() -> WindowLayout {
    WindowLayout {
        root: WindowLayoutRoot::Stack(WindowLayoutStackNode {
            ...
            children: vec![WindowLayoutWindowNode { kind: "window".into(), window_kind_id: geometry::WINDOW_KIND_ID.into(), title: Some("Geometry".into()), instance_id: None, template_id: None }],
        }),
    }
}
