@capability-mathematical-1-equation-mutate
@no-oracle-mathematical-mutation-semantics
@comparison-ordered-json-v1
@mutations-mathematical-1-equation
Feature: Apply the s.mathematical.mathematical equation mutation to its committed specification vector
