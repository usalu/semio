...
/// 📦️ Foreign-carrier projection of the complete authored mathematical document. Child handles
/// are persistence references, not mathematical content, so exports use this projection instead.
#[derive(Clone, Debug, PartialEq, ToValueDerive, FromValueDerive)]
#[value(rename_all = "camelCase")]
pub struct MathematicalFixture {
