/** ➗️ MathematicalMutation — closed semantic mutation vocabulary for the mathematical document,
 *  mirrors `🧬️mutations/🦀️component.rs`'s `MathematicalMutation` enum and its 15 per-verb leaf
 ...
 *  }`, proven by every committed `🧪️tests/*​/🦠️mutation/🔣️component.json` fixture (e.g.
 ...
 *  confirmed field-by-field against the committed fixtures. `MathematicalGraph`/`MathematicalPoint`
...
import type { MathematicalGraph, MathematicalPoint } from "../🟦️component.ts";
...
export type MathematicalMutation =
