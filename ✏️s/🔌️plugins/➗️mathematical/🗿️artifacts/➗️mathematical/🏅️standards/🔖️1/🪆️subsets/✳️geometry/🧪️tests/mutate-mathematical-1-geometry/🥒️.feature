@capability-mathematical-1-geometry-mutate
@no-oracle-mathematical-mutation-semantics
@comparison-ordered-json-v1
@mutations-mathematical-1-geometry
Feature: Apply every typed s.mathematical.mathematical geometry mutation to its committed specification vector
