//! 🔬️ Third-party carrier reader for `s.mathematical.mathematical@1/✳️any`.
//!
...
//! (`…➗️mathematical/…/📊️csv/🔖️rfc4180/✳️any/🦀️.rs:22-33`) — so this reader only ever answers
...
//!   semio-mathematical-oracle-probe csv-rows    --input a.csv
//!   semio-mathematical-oracle-probe csv-compare --input expected.csv --input actual.csv
//!   semio-mathematical-oracle-probe gate-inputs --out <dir>
//!   semio-mathematical-oracle-probe fixtures    --out <dir>
//!
...
/// `csv` crate — this is what a correct `MathematicalIntoCsv` export SHOULD contain before and after
