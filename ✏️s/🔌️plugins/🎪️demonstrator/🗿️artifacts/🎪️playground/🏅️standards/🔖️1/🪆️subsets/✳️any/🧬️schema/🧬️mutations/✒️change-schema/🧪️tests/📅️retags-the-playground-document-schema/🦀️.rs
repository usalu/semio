...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✒️change-schema/📅️retags-the-playground-document-schema/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✒️change-schema/📅️retags-the-playground-document-schema/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✒️change-schema/📅️retags-the-playground-document-schema/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✒️change-schema/📅️retags-the-playground-document-schema/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✒️change-schema/📅️retags-the-playground-document-schema/🎯️outcome/🔣️.json");
