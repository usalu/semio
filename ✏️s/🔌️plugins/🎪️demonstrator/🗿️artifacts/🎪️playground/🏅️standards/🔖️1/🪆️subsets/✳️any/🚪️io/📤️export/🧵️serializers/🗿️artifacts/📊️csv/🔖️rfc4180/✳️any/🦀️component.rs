...
pub async fn serialize(snapshot: &PlaygroundSnapshot) -> Result<CsvSnapshot, store::TextError> {
...
pub async fn serialize_bytes(snapshot: &PlaygroundSnapshot) -> Result<Vec<u8>, store::TextError> {
