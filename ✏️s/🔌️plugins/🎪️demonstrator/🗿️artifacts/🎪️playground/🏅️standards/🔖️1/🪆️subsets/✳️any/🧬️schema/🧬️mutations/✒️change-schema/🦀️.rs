...
mod tests {
    ...
    fn committed_json_bridge_round_trips() {
        let before = include_str!("🧪️tests/📅️retags-the-4f474c/📸️snapshot/⬅️before/🔣️.json");
        let operation = include_str!("🧪️tests/📅️retags-the-4f474c/🦠️mutation/🔣️.json");
        let after = include_str!("🧪️tests/📅️retags-the-4f474c/📸️snapshot/➡️after/🔣️.json");
