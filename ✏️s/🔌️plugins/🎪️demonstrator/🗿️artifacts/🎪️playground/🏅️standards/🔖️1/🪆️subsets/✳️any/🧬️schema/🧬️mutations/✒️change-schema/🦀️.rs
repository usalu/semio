...
mod tests {
    ...
    fn committed_json_bridge_round_trips() {
        let before = include_str!("🧪️tests/📅️retags-the-playground-document-schema/📸️snapshot/⬅️before/🔣️.json");
        let operation = include_str!("🧪️tests/📅️retags-the-playground-document-schema/🦠️mutation/🔣️.json");
        let after = include_str!("🧪️tests/📅️retags-the-playground-document-schema/📸️snapshot/➡️after/🔣️.json");
