//! 📥️ Import .xlsx into PlaygroundSnapshot.

use semio_framework_plugin::{DocumentCodec, IoError, JsonCodec, MediaFormat};

//#region 🔖️Import
pub fn import(bytes: &[u8]) -> Result<crate::artifacts::playground::PlaygroundSnapshot, IoError> {
