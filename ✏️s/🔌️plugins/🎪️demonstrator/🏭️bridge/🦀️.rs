...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_demonstrator_playground::standards::v1::subsets::any::schema::snapshot::PlaygroundSnapshot, semio_s_artifact_demonstrator_playground::standards::v1::subsets::any::schema::mutations::PlaygroundMutation>,
];
