//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🎪️demonstrator`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("PlaygroundMutation", descriptors::<semio_s_artifact_demonstrator_playground::standards::v1::subsets::any::schema::snapshot::PlaygroundSnapshot, semio_s_artifact_demonstrator_playground::standards::v1::subsets::any::schema::mutations::PlaygroundMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.demonstrator.playground", "1", "any", "", "✏️s/🔌️plugins/🎪️demonstrator/🗿️artifacts/🎪️playground/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-demonstrator-mutation-bridge")),
