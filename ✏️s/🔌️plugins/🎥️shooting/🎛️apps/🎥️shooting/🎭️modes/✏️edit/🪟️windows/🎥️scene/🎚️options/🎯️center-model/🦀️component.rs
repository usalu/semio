...
pub fn measure(labels: &ShootingLabels) -> WindowMeasure {
    WindowMeasure::Toggle { id: "shooting.measure.center-model".into(), icon_id: "focus".into(), label: Some(labels.measure_center_model.into()), pressed: true, text: None, on_change: crate::apps::shooting::shooting_action("setCenterModel", None) }
}
//#endregion 🔖️Measure
...
mod tests {
    ...
    #[test]
    fn center_model_toggle_starts_pressed() {
