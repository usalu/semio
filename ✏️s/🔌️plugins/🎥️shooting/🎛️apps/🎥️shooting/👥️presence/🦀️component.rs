...
impl protocol::MutationDiff<ShootingPresence> for ShootingPresence {
    fn apply(&self, _base: &ShootingPresence) -> ShootingPresence {
        self.clone()
    }
...
impl store::DocumentDsl for ShootingPresence {
...
impl DocumentPack for ShootingPresence {
...
impl Mutation<ShootingPresence> for ShootingPresenceMutation {
    ...
    fn diff(&self, _base: &ShootingPresence) -> ShootingPresence {
        match self {
