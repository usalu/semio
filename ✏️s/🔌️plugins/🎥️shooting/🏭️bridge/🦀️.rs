//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🎥️shooting`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("ShootingConfigMutation", descriptors::<semio_s_artifact_shooting_shooting::editor::shooting::config::ShootingConfig, semio_s_artifact_shooting_shooting::editor::shooting::config::ShootingConfigMutation>),
    ("ShootingPresenceMutation", descriptors::<semio_s_artifact_shooting_shooting::editor::shooting::presence::ShootingPresence, semio_s_artifact_shooting_shooting::editor::shooting::presence::ShootingPresenceMutation>),
    ("ShootingMutation", descriptors::<semio_s_artifact_shooting_shooting::standards::v1::subsets::any::schema::snapshot::ShootingSnapshot, semio_s_artifact_shooting_shooting::standards::v1::subsets::any::schema::mutations::ShootingMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.shooting.shooting", "1", "any", "", "✏️s/🔌️plugins/🎥️shooting/🗿️artifacts/🎥️shooting/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.shooting.shooting", "1", "any", "✏️editor/🎚️config", "✏️s/🔌️plugins/🎥️shooting/🗿️artifacts/🎥️shooting/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎚️config", ""),
    ("s.shooting.shooting", "1", "any", "✏️editor/👥️presence", "✏️s/🔌️plugins/🎥️shooting/🗿️artifacts/🎥️shooting/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/👥️presence", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-shooting-mutation-bridge")),
