...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-scene-ambient-intensity/dims-scene-ambient-to-quarter: produced diff differs from the committed 🔺️diff/🔣️component.json");
