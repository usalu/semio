//! 🧪️ `change-shot-shape` fixture — `rounds-shot-wide-to-ellipse`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-shot-shape/rounds-shot-wide-to-ellipse: produced diff differs from the committed 🔺️diff/🔣️component.json");
