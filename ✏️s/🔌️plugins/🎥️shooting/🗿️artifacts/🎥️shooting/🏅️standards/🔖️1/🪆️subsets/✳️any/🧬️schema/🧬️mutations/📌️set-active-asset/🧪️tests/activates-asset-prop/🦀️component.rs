//! 🧪️ `set-active-asset` fixture — `activates-asset-prop`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-active-asset/activates-asset-prop: produced diff differs from the committed 🔺️diff/🔣️component.json");
