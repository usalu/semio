//! 🧪️ `drag-assets` fixture — `offsets-both-assets-and-skips-a-ghost`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "drag-assets/offsets-both-assets-and-skips-a-ghost: produced diff differs from the committed 🔺️diff/🔣️component.json");
