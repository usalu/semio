//! 🧪️ `change-shot-width` fixture — `widens-shot-close-to-1024`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-shot-width/widens-shot-close-to-1024: produced diff differs from the committed 🔺️diff/🔣️component.json");
