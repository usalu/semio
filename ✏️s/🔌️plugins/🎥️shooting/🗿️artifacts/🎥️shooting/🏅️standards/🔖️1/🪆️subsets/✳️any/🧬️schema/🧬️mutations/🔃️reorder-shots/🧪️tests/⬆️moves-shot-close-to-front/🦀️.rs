//! 🧪️ `reorder-shots` fixture — `⬆️moves-shot-close-to-front`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️reorder-shots/⬆️moves-shot-close-to-front/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️reorder-shots/⬆️moves-shot-close-to-front/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️reorder-shots/⬆️moves-shot-close-to-front/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️reorder-shots/⬆️moves-shot-close-to-front/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔃️reorder-shots/⬆️moves-shot-close-to-front/🎯️outcome/🔣️.json");
