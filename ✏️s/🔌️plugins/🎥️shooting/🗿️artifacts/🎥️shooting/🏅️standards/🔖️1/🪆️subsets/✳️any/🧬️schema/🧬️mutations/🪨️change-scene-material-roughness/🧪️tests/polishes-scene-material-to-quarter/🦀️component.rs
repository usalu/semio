...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-scene-material-roughness/polishes-scene-material-to-quarter: produced diff differs from the committed 🔺️diff/🔣️component.json");
