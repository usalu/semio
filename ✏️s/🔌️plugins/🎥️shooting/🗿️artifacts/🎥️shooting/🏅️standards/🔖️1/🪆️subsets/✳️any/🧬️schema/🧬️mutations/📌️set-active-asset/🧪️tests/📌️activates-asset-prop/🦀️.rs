...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️set-active-asset/📌️activates-asset-prop/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️set-active-asset/📌️activates-asset-prop/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️set-active-asset/📌️activates-asset-prop/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️set-active-asset/📌️activates-asset-prop/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📌️set-active-asset/📌️activates-asset-prop/🎯️outcome/🔣️.json");
