...
Feature: Apply every typed SHOOTING mutation to the vocabulary's own committed render scene and against an independent Python implementation
  ...
  `asset://🧬️schema/🧬️mutations/✏️rename-asset/🧪️tests/renames-asset-hero-to-lead/📸️snapshot/⬅️before/🔣️.json`.
  ...
  Scenario Outline: Apply <id> to the committed render scene and observe it move
    Given the committed before-snapshot every leaf fixture of this vocabulary shares asset://🧬️schema/🧬️mutations/✏️rename-asset/🧪️tests/renames-asset-hero-to-lead/📸️snapshot/⬅️before/🔣️.json
    ...
    Examples:
      ...
      | create-asset                    | {"mutation":"createAsset","asset":{"id":"asset-detail","name":"Detail","url":"/mesh/detail.glb","format":"glb","origin":[0.0,4.0,0.0],"orientation":null,"scale":null},"index":0} | 🌱️create-asset                    | appends-asset-detail                  |
      | delete-asset                    | {"mutation":"deleteAsset","id":"asset-prop"}                                                                                                                                      | 🗑️delete-asset                    | removes-trailing-asset-prop           |
      | rename-asset                    | {"mutation":"renameAsset","id":"asset-hero","new_name":"Lead"}                                                                                                                    | ✏️rename-asset                    | renames-asset-hero-to-lead            |
      | change-asset-url                | {"mutation":"changeAssetUrl","id":"asset-prop","new_url":"/mesh/prop-v2.glb"}                                                                                                     | 🔗️change-asset-url                | points-asset-prop-at-v2-mesh          |
      | reorder-assets                  | {"mutation":"reorderAssets","id":"asset-hero","to_index":1}                                                                                                                       | 🔀️reorder-assets                  | moves-asset-hero-behind-asset-prop    |
      | drag-assets                     | {"mutation":"dragAssets","asset_ids":["asset-hero","asset-prop","asset-ghost"],"dx":4.0,"dy":-1.0,"dz":0.5}                                                                       | ↔️drag-assets                     | offsets-both-assets-and-skips-a-ghost |
      | rotate-assets                   | {"mutation":"rotateAssets","asset_ids":["asset-hero"],"ax":0.0,"ay":0.0,"az":1.0,"angle":1.5}                                                                                     | 🔄️rotate-assets                   | spins-asset-hero-about-z              |
      | scale-assets                    | {"mutation":"scaleAssets","asset_ids":["asset-hero"],"sx":2.0,"sy":2.0,"sz":2.0}                                                                                                  | ↕️scale-assets                    | doubles-asset-hero-scale              |
      | create-shot                     | {"mutation":"createShot","shot":{"id":"shot-macro","label":"Macro","width":128,"height":128,"format":"png","shape":"rectangle"},"index":null}                                     | 📸️create-shot                     | appends-shot-macro                    |
      | delete-shot                     | {"mutation":"deleteShot","id":"shot-close"}                                                                                                                                       | 🚮️delete-shot                     | removes-trailing-shot-close           |
      | rename-shot                     | {"mutation":"renameShot","id":"shot-close","new_label":"Detail"}                                                                                                                  | 🏷️rename-shot                     | relabels-shot-close-to-detail         |
      | change-shot-width               | {"mutation":"changeShotWidth","id":"shot-close","new_width":1024}                                                                                                                 | 📏️change-shot-width               | widens-shot-close-to-1024             |
      | change-shot-height              | {"mutation":"changeShotHeight","id":"shot-close","new_height":768}                                                                                                                | 📐️change-shot-height              | heightens-shot-close-to-768           |
      | change-shot-format              | {"mutation":"changeShotFormat","id":"shot-wide","new_format":"svg"}                                                                                                               | 🖼️change-shot-format              | switches-shot-wide-to-svg             |
      | change-shot-shape               | {"mutation":"changeShotShape","id":"shot-wide","new_shape":"ellipse"}                                                                                                             | ✂️change-shot-shape               | rounds-shot-wide-to-ellipse           |
      | reorder-shots                   | {"mutation":"reorderShots","id":"shot-close","to_index":0}                                                                                                                        | 🔃️reorder-shots                   | moves-shot-close-to-front             |
      | replace-shot-camera             | {"mutation":"replaceShotCamera","shot_id":"shot-wide","new_camera":{"position":[3.0,-3.0,2.0],"target":[0.0,0.0,0.5],"zoom":1.5,"fov":40.0}}                                      | 📷️replace-shot-camera             | rewrites-cam-wide-through-shot-wide   |
      | create-saved-camera             | {"mutation":"createSavedCamera","saved_camera":{"id":"cam-top","label":"Top","camera":{"position":[0.0,0.0,20.0],"target":[0.0,0.0,0.0],"zoom":1.0,"fov":50.0}},"index":null}     | 🎥️create-saved-camera             | appends-saved-camera-top              |
      | delete-saved-camera             | {"mutation":"deleteSavedCamera","id":"cam-close"}                                                                                                                                 | 🧹️delete-saved-camera             | removes-trailing-cam-close            |
      | rename-saved-camera             | {"mutation":"renameSavedCamera","id":"cam-close","new_label":"Tight"}                                                                                                             | 🪪️rename-saved-camera             | relabels-cam-close-to-tight           |
      | replace-saved-camera-view       | {"mutation":"replaceSavedCameraView","id":"cam-close","new_camera":{"position":[1.0,-1.0,0.75],"target":[0.0,0.0,1.0],"zoom":4.0,"fov":20.0}}                                     | 🎞️replace-saved-camera-view       | repositions-cam-close-view            |
      | reorder-saved-cameras           | {"mutation":"reorderSavedCameras","id":"cam-close","to_index":0}                                                                                                                  | 🔁️reorder-saved-cameras           | moves-cam-close-to-front              |
      | set-active-shot                 | {"mutation":"setActiveShot","shot_id":"shot-close"}                                                                                                                               | 🎯️set-active-shot                 | activates-shot-close                  |
      | set-active-asset                | {"mutation":"setActiveAsset","asset_id":"asset-prop"}                                                                                                                             | 📌️set-active-asset                | activates-asset-prop                  |
      | change-scene-sun-enabled        | {"mutation":"changeSceneSunEnabled","new_enabled":false}                                                                                                                          | ☀️change-scene-sun-enabled        | switches-scene-sun-off                |
      | change-scene-sun-azimuth        | {"mutation":"changeSceneSunAzimuth","new_azimuth":315.0}                                                                                                                          | 🧭️change-scene-sun-azimuth        | turns-scene-sun-to-315-degrees        |
      | change-scene-sun-elevation      | {"mutation":"changeSceneSunElevation","new_elevation":60.0}                                                                                                                       | 🌅️change-scene-sun-elevation      | raises-scene-sun-to-60-degrees        |
      | change-scene-sun-intensity      | {"mutation":"changeSceneSunIntensity","new_intensity":1.2}                                                                                                                        | 💡️change-scene-sun-intensity      | dims-scene-sun-to-half                |
      | change-scene-ambient-intensity  | {"mutation":"changeSceneAmbientIntensity","new_intensity":0.25}                                                                                                                   | 🔅️change-scene-ambient-intensity  | dims-scene-ambient-to-quarter         |
      | change-scene-shadow-enabled     | {"mutation":"changeSceneShadowEnabled","new_enabled":false}                                                                                                                       | 🌑️change-scene-shadow-enabled     | switches-scene-shadows-off            |
      | change-scene-material-roughness | {"mutation":"changeSceneMaterialRoughness","new_roughness":0.25}                                                                                                                  | 🪨️change-scene-material-roughness | polishes-scene-material-to-quarter    |
