//! 🧪️ `rename-shot` fixture — `🔤️relabels-shot-close-to-detail`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-shot/🔤️relabels-shot-close-to-detail/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-shot/🔤️relabels-shot-close-to-detail/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-shot/🔤️relabels-shot-close-to-detail/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-shot/🔤️relabels-shot-close-to-detail/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-shot/🔤️relabels-shot-close-to-detail/🎯️outcome/🔣️.json");
