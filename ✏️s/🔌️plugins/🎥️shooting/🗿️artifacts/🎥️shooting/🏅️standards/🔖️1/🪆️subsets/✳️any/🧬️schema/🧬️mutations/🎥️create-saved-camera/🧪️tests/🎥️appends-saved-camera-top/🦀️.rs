...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎥️create-saved-camera/🎥️appends-saved-camera-top/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎥️create-saved-camera/🎥️appends-saved-camera-top/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎥️create-saved-camera/🎥️appends-saved-camera-top/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎥️create-saved-camera/🎥️appends-saved-camera-top/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎥️create-saved-camera/🎥️appends-saved-camera-top/🎯️outcome/🔣️.json");
