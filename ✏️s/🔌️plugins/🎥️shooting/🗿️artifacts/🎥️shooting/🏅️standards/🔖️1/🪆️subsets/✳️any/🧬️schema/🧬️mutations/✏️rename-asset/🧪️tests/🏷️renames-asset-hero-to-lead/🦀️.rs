//! 🧪️ `rename-asset` fixture — `🏷️renames-asset-hero-to-lead`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-asset/🏷️renames-asset-hero-to-lead/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-asset/🏷️renames-asset-hero-to-lead/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-asset/🏷️renames-asset-hero-to-lead/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-asset/🏷️renames-asset-hero-to-lead/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-asset/🏷️renames-asset-hero-to-lead/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-asset/renames-asset-hero-to-lead: produced diff differs from the committed 🔺️diff/🔣️.json");
