...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️change-shot-shape/⭕️rounds-shot-wide-to-ellipse/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️change-shot-shape/⭕️rounds-shot-wide-to-ellipse/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️change-shot-shape/⭕️rounds-shot-wide-to-ellipse/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️change-shot-shape/⭕️rounds-shot-wide-to-ellipse/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️change-shot-shape/⭕️rounds-shot-wide-to-ellipse/🎯️outcome/🔣️.json");
