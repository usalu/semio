/** 🎥️ Shooting editor — Scene window: typed twin of `🦀️component.rs`'s view-model. Mirrors the
 ...
 * (both absent entirely from the viewer's read-only twin, see `👁️viewer/…/🟦️component.ts`). */
