...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-shot-width/↔️widens-shot-close-to-1024/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-shot-width/↔️widens-shot-close-to-1024/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-shot-width/↔️widens-shot-close-to-1024/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-shot-width/↔️widens-shot-close-to-1024/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏️change-shot-width/↔️widens-shot-close-to-1024/🎯️outcome/🔣️.json");
