...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️drag-assets/🚚️offsets-both-assets-and-skips-a-ghost/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️drag-assets/🚚️offsets-both-assets-and-skips-a-ghost/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️drag-assets/🚚️offsets-both-assets-and-skips-a-ghost/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️drag-assets/🚚️offsets-both-assets-and-skips-a-ghost/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️drag-assets/🚚️offsets-both-assets-and-skips-a-ghost/🎯️outcome/🔣️.json");
