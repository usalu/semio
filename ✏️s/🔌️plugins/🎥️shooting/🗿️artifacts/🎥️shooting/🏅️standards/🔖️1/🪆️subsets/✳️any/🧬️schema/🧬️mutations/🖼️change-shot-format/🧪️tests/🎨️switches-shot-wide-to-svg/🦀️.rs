//! 🧪️ `change-shot-format` fixture — `🎨️switches-shot-wide-to-svg`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-shot-format/🎨️switches-shot-wide-to-svg/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-shot-format/🎨️switches-shot-wide-to-svg/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-shot-format/🎨️switches-shot-wide-to-svg/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-shot-format/🎨️switches-shot-wide-to-svg/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖼️change-shot-format/🎨️switches-shot-wide-to-svg/🎯️outcome/🔣️.json");
