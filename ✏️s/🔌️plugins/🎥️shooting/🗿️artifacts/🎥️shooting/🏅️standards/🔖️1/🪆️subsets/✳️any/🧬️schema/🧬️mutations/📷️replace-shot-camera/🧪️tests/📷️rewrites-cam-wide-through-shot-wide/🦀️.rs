...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📷️replace-shot-camera/📷️rewrites-cam-wide-through-shot-wide/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📷️replace-shot-camera/📷️rewrites-cam-wide-through-shot-wide/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📷️replace-shot-camera/📷️rewrites-cam-wide-through-shot-wide/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📷️replace-shot-camera/📷️rewrites-cam-wide-through-shot-wide/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📷️replace-shot-camera/📷️rewrites-cam-wide-through-shot-wide/🎯️outcome/🔣️.json");
