...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️replace-saved-camera-view/📍️repositions-cam-close-view/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️replace-saved-camera-view/📍️repositions-cam-close-view/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️replace-saved-camera-view/📍️repositions-cam-close-view/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️replace-saved-camera-view/📍️repositions-cam-close-view/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎞️replace-saved-camera-view/📍️repositions-cam-close-view/🎯️outcome/🔣️.json");
