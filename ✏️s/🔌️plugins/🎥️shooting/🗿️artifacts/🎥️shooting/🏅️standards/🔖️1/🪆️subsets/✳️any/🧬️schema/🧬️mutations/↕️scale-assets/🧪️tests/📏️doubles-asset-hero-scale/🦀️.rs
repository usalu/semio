...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️scale-assets/📏️doubles-asset-hero-scale/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️scale-assets/📏️doubles-asset-hero-scale/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️scale-assets/📏️doubles-asset-hero-scale/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️scale-assets/📏️doubles-asset-hero-scale/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↕️scale-assets/📏️doubles-asset-hero-scale/🎯️outcome/🔣️.json");
