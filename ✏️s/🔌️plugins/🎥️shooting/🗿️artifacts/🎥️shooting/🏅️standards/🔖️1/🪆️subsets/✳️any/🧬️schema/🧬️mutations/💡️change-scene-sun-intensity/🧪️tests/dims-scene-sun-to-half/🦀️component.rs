//! 🧪️ `change-scene-sun-intensity` fixture — `dims-scene-sun-to-half`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-scene-sun-intensity/dims-scene-sun-to-half: produced diff differs from the committed 🔺️diff/🔣️component.json");
