//! 🧪️ `delete-shot` fixture — `🚫️removes-trailing-shot-close`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-shot/🚫️removes-trailing-shot-close/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-shot/🚫️removes-trailing-shot-close/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-shot/🚫️removes-trailing-shot-close/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-shot/🚫️removes-trailing-shot-close/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚮️delete-shot/🚫️removes-trailing-shot-close/🎯️outcome/🔣️.json");
