//! 🧪️ `reorder-saved-cameras` fixture — `moves-cam-close-to-front`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-saved-cameras/moves-cam-close-to-front: produced diff differs from the committed 🔺️diff/🔣️component.json");
