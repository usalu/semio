//! 🧪️ `set-active-shot` fixture — `🎯️activates-shot-close`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "set-active-shot/activates-shot-close: produced diff differs from the committed 🔺️diff/🔣️.json");
