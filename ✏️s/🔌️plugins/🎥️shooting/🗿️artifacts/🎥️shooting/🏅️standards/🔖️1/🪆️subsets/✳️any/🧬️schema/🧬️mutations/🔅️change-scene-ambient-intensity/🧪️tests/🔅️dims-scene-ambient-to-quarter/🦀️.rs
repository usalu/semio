//! 🧪️ `change-scene-ambient-intensity` fixture — `🔅️dims-scene-ambient-to-quarter`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-scene-ambient-intensity/🔅️dims-scene-ambient-to-quarter/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-scene-ambient-intensity/🔅️dims-scene-ambient-to-quarter/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-scene-ambient-intensity/🔅️dims-scene-ambient-to-quarter/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-scene-ambient-intensity/🔅️dims-scene-ambient-to-quarter/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔅️change-scene-ambient-intensity/🔅️dims-scene-ambient-to-quarter/🎯️outcome/🔣️.json");
