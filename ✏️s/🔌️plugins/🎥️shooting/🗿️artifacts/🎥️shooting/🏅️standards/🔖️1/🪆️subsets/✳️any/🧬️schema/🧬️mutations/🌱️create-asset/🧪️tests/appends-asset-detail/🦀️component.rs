//! 🧪️ `create-asset` fixture — `appends-asset-detail`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "create-asset/appends-asset-detail: produced diff differs from the committed 🔺️diff/🔣️component.json");
