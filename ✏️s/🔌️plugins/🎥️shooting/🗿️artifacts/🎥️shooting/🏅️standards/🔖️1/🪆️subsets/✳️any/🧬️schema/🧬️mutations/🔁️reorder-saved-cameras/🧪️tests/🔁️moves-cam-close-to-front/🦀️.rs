...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️reorder-saved-cameras/🔁️moves-cam-close-to-front/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️reorder-saved-cameras/🔁️moves-cam-close-to-front/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️reorder-saved-cameras/🔁️moves-cam-close-to-front/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️reorder-saved-cameras/🔁️moves-cam-close-to-front/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️reorder-saved-cameras/🔁️moves-cam-close-to-front/🎯️outcome/🔣️.json");
