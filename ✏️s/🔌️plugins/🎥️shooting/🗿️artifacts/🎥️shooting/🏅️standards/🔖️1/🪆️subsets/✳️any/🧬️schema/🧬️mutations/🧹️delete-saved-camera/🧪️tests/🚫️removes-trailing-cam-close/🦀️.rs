...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-saved-camera/🚫️removes-trailing-cam-close/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-saved-camera/🚫️removes-trailing-cam-close/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-saved-camera/🚫️removes-trailing-cam-close/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-saved-camera/🚫️removes-trailing-cam-close/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️delete-saved-camera/🚫️removes-trailing-cam-close/🎯️outcome/🔣️.json");
