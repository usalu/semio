//! 🎹️ ShootingComposer (1/✳️any) — analyzer + builder glued. Reads native `s.shooting` sources
//! plus any of: stdio.bmp, stdio.dwg, stdio.gif, stdio.jpg, stdio.json, stdio.pdf, stdio.png, stdio.svg, stdio.tiff, stdio.txt. Writes one `s.shooting` (1/✳️any) snapshot.
...
use crate::artifacts::shooting::standards::v1::subsets::any::analyzer::ShootingAnalyzer;
...
pub struct ShootingComposer;

impl ArtifactComposer for ShootingComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        ...
        Err(ComposeError { message: "ShootingComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
