...
VECTORS = {
    ...
    "rename-asset": ("✏️rename-asset", "🏷️renames-asset-hero-to-lead", "renameAsset"),
    "change-asset-url": ("🌐️change-asset-url", "🌐️points-asset-prop-at-v2-mesh", "changeAssetUrl"),
    "reorder-assets": ("🔀️reorder-assets", "🔀️moves-asset-hero-behind-asset-prop", "reorderAssets"),
    "drag-assets": ("↔️drag-assets", "🚚️offsets-both-assets-and-skips-a-ghost", "dragAssets"),
    "rotate-assets": ("🔄️rotate-assets", "🔄️spins-asset-hero-about-z", "rotateAssets"),
    "scale-assets": ("↕️scale-assets", "📏️doubles-asset-hero-scale", "scaleAssets"),
    "create-shot": ("📸️create-shot", "📸️appends-shot-macro", "createShot"),
    "delete-shot": ("🚮️delete-shot", "🚫️removes-trailing-shot-close", "deleteShot"),
    "rename-shot": ("🏷️rename-shot", "🔤️relabels-shot-close-to-detail", "renameShot"),
    "change-shot-width": ("📏️change-shot-width", "↔️widens-shot-close-to-1024", "changeShotWidth"),
    "change-shot-height": ("📐️change-shot-height", "↕️heightens-shot-close-to-768", "changeShotHeight"),
    "change-shot-format": ("🖼️change-shot-format", "🎨️switches-shot-wide-to-svg", "changeShotFormat"),
    "change-shot-shape": ("✂️change-shot-shape", "⭕️rounds-shot-wide-to-ellipse", "changeShotShape"),
    "reorder-shots": ("🔃️reorder-shots", "⬆️moves-shot-close-to-front", "reorderShots"),
    "replace-shot-camera": ("📷️replace-shot-camera", "📷️rewrites-cam-wide-through-shot-wide", "replaceShotCamera"),
    "create-saved-camera": ("🎥️create-saved-camera", "🎥️appends-saved-camera-top", "createSavedCamera"),
    "delete-saved-camera": ("🧹️delete-saved-camera", "🚫️removes-trailing-cam-close", "deleteSavedCamera"),
    "rename-saved-camera": ("🪪️rename-saved-camera", "🔤️relabels-cam-close-to-tight", "renameSavedCamera"),
    "replace-saved-camera-view": ("🎞️replace-saved-camera-view", "📍️repositions-cam-close-view", "replaceSavedCameraView"),
    "reorder-saved-cameras": ("🔁️reorder-saved-cameras", "🔁️moves-cam-close-to-front", "reorderSavedCameras"),
    "set-active-shot": ("🎯️set-active-shot", "🎯️activates-shot-close", "setActiveShot"),
    "set-active-asset": ("📌️set-active-asset", "📌️activates-asset-prop", "setActiveAsset"),
    "change-scene-sun-enabled": ("☀️change-scene-sun-enabled", "☀️switches-scene-sun-off", "changeSceneSunEnabled"),
    "change-scene-sun-azimuth": ("🧭️change-scene-sun-azimuth", "🧭️turns-scene-sun-to-315-degrees", "changeSceneSunAzimuth"),
    "change-scene-sun-elevation": ("🌅️change-scene-sun-elevation", "🌅️raises-scene-sun-to-60-degrees", "changeSceneSunElevation"),
