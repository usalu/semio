//! 🧪️ `change-scene-shadow-enabled` fixture — `🌑️switches-scene-shadows-off`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌑️change-scene-shadow-enabled/🌑️switches-scene-shadows-off/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌑️change-scene-shadow-enabled/🌑️switches-scene-shadows-off/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌑️change-scene-shadow-enabled/🌑️switches-scene-shadows-off/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌑️change-scene-shadow-enabled/🌑️switches-scene-shadows-off/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌑️change-scene-shadow-enabled/🌑️switches-scene-shadows-off/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-scene-shadow-enabled/switches-scene-shadows-off: produced diff differs from the committed 🔺️diff/🔣️.json");
