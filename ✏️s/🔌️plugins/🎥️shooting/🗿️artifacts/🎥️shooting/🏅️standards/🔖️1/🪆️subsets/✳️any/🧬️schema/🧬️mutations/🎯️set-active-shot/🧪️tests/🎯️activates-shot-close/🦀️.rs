...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯️set-active-shot/🎯️activates-shot-close/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯️set-active-shot/🎯️activates-shot-close/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯️set-active-shot/🎯️activates-shot-close/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯️set-active-shot/🎯️activates-shot-close/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯️set-active-shot/🎯️activates-shot-close/🎯️outcome/🔣️.json");
