//! 🧪️ `rename-saved-camera` fixture — `relabels-cam-close-to-tight`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-saved-camera/relabels-cam-close-to-tight: produced diff differs from the committed 🔺️diff/🔣️component.json");
