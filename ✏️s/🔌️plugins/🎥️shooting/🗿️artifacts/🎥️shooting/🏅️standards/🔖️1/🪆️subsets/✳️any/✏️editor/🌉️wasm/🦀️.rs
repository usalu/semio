...
mod tests {
    ...
    async fn shooting_store_type_alias_constructs_from_an_empty_envelope() {
        let store = ShootingStore::new(store::create_document_envelope(crate::artifacts::shooting::SHOOTING_DOCUMENT_SCHEMA, "shooting", crate::artifacts::shooting::empty_shooting_snapshot(), None)).await.expect("valid artifact store fixture");
