//! 🧪️ `delete-saved-camera` fixture — `removes-trailing-cam-close`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-saved-camera/removes-trailing-cam-close: produced diff differs from the committed 🔺️diff/🔣️component.json");
