//! 🔺️ Diff fragment yielded by `ObjectsAdd`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `ObjectsAdd` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct ObjectsAddDiff {
...
impl MutationDiff<LowpolyProjection> for ObjectsAddDiff {
