//! 🔺️ Diff fragment yielded by `SetProjection`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `SetProjection` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct SetProjectionDiff {
    pub mutation: Option<LowpolyMutation>,
}

impl SetProjectionDiff {
...
impl MutationDiff<LowpolyProjection> for SetProjectionDiff {
