//! 🧪️ `delete-object` fixture — `🚫️removes-obj-fin-without-touching-the-order`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "delete-object/removes-obj-fin-without-touching-the-order: produced diff differs from the committed 🔺️diff/🔣️.json");
}
