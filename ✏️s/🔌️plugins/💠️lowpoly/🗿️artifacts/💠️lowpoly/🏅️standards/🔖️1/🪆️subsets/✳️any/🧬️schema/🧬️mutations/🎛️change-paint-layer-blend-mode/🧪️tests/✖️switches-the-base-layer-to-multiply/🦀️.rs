...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-paint-layer-blend-mode/✖️switches-the-base-layer-to-multiply/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-paint-layer-blend-mode/✖️switches-the-base-layer-to-multiply/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-paint-layer-blend-mode/✖️switches-the-base-layer-to-multiply/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-paint-layer-blend-mode/✖️switches-the-base-layer-to-multiply/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎛️change-paint-layer-blend-mode/✖️switches-the-base-layer-to-multiply/🎯️outcome/🔣️.json");
