...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-paint-layer-blend-mode/switches-the-base-layer-to-multiply: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
