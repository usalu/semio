/** 👁️ Lowpoly viewer — subset-level typed twin. Read-only counterpart of `✏️editor/🟦️component.ts`:
...
export const LOWPOLY_VIEWER_DIALECT = { artifactKind: "s.lowpoly.lowpoly", standard: "1", subset: "*" } as const;
