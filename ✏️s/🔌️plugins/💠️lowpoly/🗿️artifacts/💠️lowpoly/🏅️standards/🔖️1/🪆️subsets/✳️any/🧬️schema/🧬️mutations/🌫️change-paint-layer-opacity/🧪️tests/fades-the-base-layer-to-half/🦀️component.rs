//! 🧪️ `change-paint-layer-opacity` fixture — `fades-the-base-layer-to-half`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-paint-layer-opacity/fades-the-base-layer-to-half: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
