/** 🌐️ Lowpoly editor — Model window: typed twin of `🦀️component.rs`'s `render()` boundary. The live
 ...
 * both (see the surface root `🦀️component.rs`'s shared-options doc comment). */
