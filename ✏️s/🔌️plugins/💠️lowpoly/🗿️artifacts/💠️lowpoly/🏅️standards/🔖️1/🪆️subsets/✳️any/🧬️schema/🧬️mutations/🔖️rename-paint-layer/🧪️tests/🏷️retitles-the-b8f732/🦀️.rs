//! 🧪️ `rename-paint-layer` fixture — `🏷️retitles-the-base-layer-to-undercoat`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-paint-layer/retitles-the-base-layer-to-undercoat: produced diff differs from the committed 🔺️diff/🔣️.json");
}
