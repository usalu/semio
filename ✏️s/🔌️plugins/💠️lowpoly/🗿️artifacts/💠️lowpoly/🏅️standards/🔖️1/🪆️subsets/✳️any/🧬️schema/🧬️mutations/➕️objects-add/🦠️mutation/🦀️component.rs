//! 🪦️ Orphaned by 26/08/12/SEMANTIC-MUTATIONS-OVERHAUL — `LowpolyMutation::ObjectsAdd` was replaced
//! by `create-object` (see `📓️taxonomy.md`/`📓️derivation-rules.md`). This file stays present only
