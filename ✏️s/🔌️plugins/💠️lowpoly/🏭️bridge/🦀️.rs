...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_lowpoly_lowpoly::standards::v1::subsets::any::schema::snapshot::LowpolySnapshot, semio_s_artifact_lowpoly_lowpoly::standards::v1::subsets::any::schema::mutations::LowpolyMutation>,
];
