//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/💠️lowpoly`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("LowpolyMutation", descriptors::<semio_s_artifact_lowpoly_lowpoly::standards::v1::subsets::any::schema::snapshot::LowpolySnapshot, semio_s_artifact_lowpoly_lowpoly::standards::v1::subsets::any::schema::mutations::LowpolyMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.lowpoly.lowpoly", "1", "any", "", "✏️s/🔌️plugins/💠️lowpoly/🗿️artifacts/💠️lowpoly/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-lowpoly-mutation-bridge")),
