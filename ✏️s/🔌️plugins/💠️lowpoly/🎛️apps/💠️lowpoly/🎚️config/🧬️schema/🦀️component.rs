...
pub struct LowpolyConfig {
    ...
    #[state(config)] pub selection_ids: Vec<u32>,
    #[state(config)] pub selection_targets_mesh: bool,
    #[state(config)] pub selection_targets_vertex: bool,
    #[state(config)] pub selection_targets_edge: bool,
    #[state(config)] pub selection_targets_face: bool,
    #[state(config)] pub selection_keys: Vec<String>,
    ...
    #[state(config)] pub hovered_target_object_id: Option<String>,
    #[state(config)] pub hovered_target_mode: Option<String>,
    #[state(config)] pub hovered_target_id: Option<u32>,
