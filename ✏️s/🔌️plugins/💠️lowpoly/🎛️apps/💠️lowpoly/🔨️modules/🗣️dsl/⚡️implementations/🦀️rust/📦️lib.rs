//! 📜️ Lowpoly app — textual document grammar surface + laws (constitutional: dsl).
...
/// placeholder.
pub const LOWPOLY_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/💠️lowpoly/📚️examples/💠️concrete-forest-left.lowpoly");
