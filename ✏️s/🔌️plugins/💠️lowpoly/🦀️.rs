...
pub fn plugin() -> Result<Plugin<LowpolyApps>, PluginAssemblyError> {
    Plugin::<LowpolyApps>::builder("lowpoly")
        ...
        .editor_with_examples::<crate::editor::lowpoly::LowpolyPlayApp>(crate::editor::lowpoly::create_lowpoly_app(), vec![semio_s_artifact_lowpoly_lowpoly::examples::hexagonal_cut_concrete_forest_left::source()])
