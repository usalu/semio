//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🔱️trinity`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ...
    ("TrinityGraphMutation", descriptors::<semio_s_artifact_trinity_jack::standards::v1::subsets::any::schema::snapshot::JackSnapshot, semio_s_artifact_trinity_jack::standards::v1::subsets::any::schema::mutations::TrinityGraphMutation>),
    ("RewritingWindowConfigMutation", descriptors::<semio_s_artifact_trinity_rewriting::editor::rewriting::window_config::RewritingWindowConfig, semio_s_artifact_trinity_rewriting::editor::rewriting::window_config::RewritingWindowConfigMutation>),
    ("RewriteRuleMutation", descriptors::<semio_s_artifact_trinity_rewriting::standards::v1::subsets::any::schema::snapshot::RewritingSnapshot, semio_s_artifact_trinity_rewriting::standards::v1::subsets::any::schema::mutations::RewriteRuleMutation>),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-trinity-mutation-bridge")),
