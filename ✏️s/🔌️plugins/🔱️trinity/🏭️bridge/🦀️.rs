...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_trinity_jack::standards::v1::subsets::any::schema::snapshot::JackSnapshot, semio_s_artifact_trinity_jack::standards::v1::subsets::any::schema::mutations::TrinityGraphMutation>,
    descriptors::<semio_s_artifact_trinity_rewriting::standards::v1::subsets::any::schema::snapshot::RewritingSnapshot, semio_s_artifact_trinity_rewriting::standards::v1::subsets::any::schema::mutations::RewriteRuleMutation>,
];
