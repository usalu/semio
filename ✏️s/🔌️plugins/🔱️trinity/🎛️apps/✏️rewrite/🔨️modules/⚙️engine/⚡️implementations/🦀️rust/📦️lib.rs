//! ♻️ Trinity Rewrite app — headless compute: parametric graph rewriting + LOD/board-host with
//! optional WASM canvas host (constitutional: engine).
...
/// 🩹️ unified syntax law: string literals PRINT double-quoted (never single-quoted) — matches
...
mod wasm_session {
    ...
    impl TrinitySession {
        #[wasm_bindgen(constructor)]
        pub fn new() -> Self {
            let dsl = include_str!("../../../../../../../../../✏️s/🔌️plugins/🔱️trinity/📚️examples/🔱️nakagin-capsule-tower.trinity");
...
mod tests {
    ...
    //#endregion 🔖️ForceLayoutTests
    //#region 🔖️TrinityHostTests
    #[test]
