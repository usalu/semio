...
mod tests {
    ...
    fn dsl_round_trip_nakagin_fixture() {
        let fixture = GraphFixture::parse_dsl(include_str!("../../../../../../../✏️s/🔌️plugins/🔱️trinity/📚️examples/🔱️nakagin-capsule-tower.trinity")).expect("nakagin fixture parses");
    ...
    fn dsl_round_trip_branch_chain_fixture() {
        let fixture = GraphFixture::parse_dsl(include_str!("../../../../../../../✏️s/🔌️plugins/🔱️trinity/📚️examples/🔱️branch-chain.trinity")).expect("branch-chain fixture parses");
        assert_dsl_round_trip(&fixture);
        assert_dsl_pack_equivalence(&fixture);
    }
