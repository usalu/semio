//! 🃏️ Cypher-inspired query language for trinity graphs — cross-artifact kernel shared by the
...
use crate::artifacts::jack::op::{apply_trinity_graph_operations, TrinityGraphOperation};
