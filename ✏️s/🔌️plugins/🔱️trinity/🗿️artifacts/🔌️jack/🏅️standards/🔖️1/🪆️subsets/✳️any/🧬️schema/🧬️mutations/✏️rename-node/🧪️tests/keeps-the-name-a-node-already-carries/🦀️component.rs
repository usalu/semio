//! 🧪️ `rename-node` fixture — `keeps-the-name-a-node-already-carries`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-node/keeps-the-name-a-node-already-carries: produced diff differs from the committed 🔺️diff/🔣️component.json");
