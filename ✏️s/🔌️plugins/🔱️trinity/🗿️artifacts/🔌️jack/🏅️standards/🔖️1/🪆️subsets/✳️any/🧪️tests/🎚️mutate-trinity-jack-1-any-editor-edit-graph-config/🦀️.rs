//! 🎚️ `s.trinity.jack` ✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️graph/🎚️config state-lane mutation case — Rust adapter.
//!
//! Recorded no-oracle decision `trinity-jack-1-any-editor-edit-graph-config-state-lane-semantics`: the runner dispatches no oracle role, so every law is asserted inside
//! the subject handlers through `semio_s_plugin_stdio_test_oracle::law::vector` over the report of this crate's
//! production bridge `jack_graph_window_config_mutation_report_json`. The oracle handlers answer with the committed after- and before-snapshots read
...
//#region 🔖️Vectors
/// 🧫️ The committed applied vector of one kind, read literally from `✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️graph/🎚️config/🧫️fixtures`.
fn vector(kind: &str) -> Result<Vector, String> {
    Ok(match kind {
        ...
        "set-lod-mode" => Vector {
            before: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️graph/🎚️config/🧫️fixtures/🔍️set-lod-mode/✅️set-lod-mode-applied/📸️snapshot/⬅️before/🔣️.json"),
            mutation: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️graph/🎚️config/🧫️fixtures/🔍️set-lod-mode/✅️set-lod-mode-applied/🦠️mutation/🔣️.json"),
            after: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️graph/🎚️config/🧫️fixtures/🔍️set-lod-mode/✅️set-lod-mode-applied/📸️snapshot/➡️after/🔣️.json"),
            diff: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️graph/🎚️config/🧫️fixtures/🔍️set-lod-mode/✅️set-lod-mode-applied/🔺️diff/🔣️.json"),
            outcome: include_str!("../../✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️graph/🎚️config/🧫️fixtures/🔍️set-lod-mode/✅️set-lod-mode-applied/🎯️outcome/🔣️.json"),
            observable: true,
        },
