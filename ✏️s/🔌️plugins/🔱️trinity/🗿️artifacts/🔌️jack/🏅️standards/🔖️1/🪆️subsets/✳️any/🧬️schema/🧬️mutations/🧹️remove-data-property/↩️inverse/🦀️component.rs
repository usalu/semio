...
//#region 🔖️Inverse
async fn base_property_value(base: &JackSnapshot, entity: &EntityRef, key: &str) -> Option<crate::artifacts::jack::PropertyValue> {
    match entity {
...
pub async fn inverse(payload: &super::mutation::RemoveDataProperty, base: &JackSnapshot) -> Vec<TrinityGraphMutation> {
