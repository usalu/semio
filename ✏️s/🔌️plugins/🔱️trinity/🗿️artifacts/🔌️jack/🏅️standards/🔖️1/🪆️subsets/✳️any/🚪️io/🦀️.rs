...
pub mod derived_composition {
    use crate::standards::v1::subsets::any::schema::JackAnalyzer;
...
pub mod io_registry {
    use crate::standards::v1::subsets::any::schema::JackBuilder as JackAnyBuilder;
    use crate::standards::v1::subsets::any::schema::JackComposer as JackAnyComposer;
    ...
    const JACK_DIALECT: Dialect = Dialect { artifact_kind: "s.trinity.jack", standard: StandardId("1"), subset: SubsetId("*") };
    const JACK_JSON_BRIDGE_DIALECT: Dialect = Dialect { artifact_kind: "s.stdio.json", standard: StandardId("rfc8259"), subset: SubsetId("*") };

    fn rebuild_native_snapshot(sources: &[ErasedComposeSource]) -> Result<crate::JackSnapshot, ComposeError> {
