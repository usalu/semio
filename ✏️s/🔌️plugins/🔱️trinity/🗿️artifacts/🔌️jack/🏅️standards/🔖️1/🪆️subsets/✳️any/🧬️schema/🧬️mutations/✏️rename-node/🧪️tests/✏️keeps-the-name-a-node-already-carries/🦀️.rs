...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-node/✏️keeps-the-name-a-node-already-carries/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-node/✏️keeps-the-name-a-node-already-carries/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-node/✏️keeps-the-name-a-node-already-carries/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-node/✏️keeps-the-name-a-node-already-carries/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-node/✏️keeps-the-name-a-node-already-carries/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(typed, JackDiff::default(), "rename-node's no-op delta is the artifact's Default diff, every one of its seven document slots left None");
}
