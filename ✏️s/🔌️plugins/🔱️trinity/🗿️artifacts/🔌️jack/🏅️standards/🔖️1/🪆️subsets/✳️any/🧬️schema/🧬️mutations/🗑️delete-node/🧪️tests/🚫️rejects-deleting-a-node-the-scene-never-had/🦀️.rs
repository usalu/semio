//! 🧪️ `delete-node` fixture — `🚫️rejects-deleting-a-node-the-scene-never-had`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️rejects-deleting-a-node-the-scene-never-had/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️rejects-deleting-a-node-the-scene-never-had/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️rejects-deleting-a-node-the-scene-never-had/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-node/🚫️rejects-deleting-a-node-the-scene-never-had/🎯️outcome/🔣️.json");
