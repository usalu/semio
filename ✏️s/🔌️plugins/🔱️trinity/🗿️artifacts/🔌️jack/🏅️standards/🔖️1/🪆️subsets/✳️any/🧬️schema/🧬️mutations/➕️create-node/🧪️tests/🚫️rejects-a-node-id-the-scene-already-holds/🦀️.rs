//! 🧪️ `create-node` fixture — `🚫️rejects-a-node-id-the-scene-already-holds`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-node/🚫️rejects-a-node-id-the-scene-already-holds/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-node/🚫️rejects-a-node-id-the-scene-already-holds/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-node/🚫️rejects-a-node-id-the-scene-already-holds/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-node/🚫️rejects-a-node-id-the-scene-already-holds/🎯️outcome/🔣️.json");
