//! 🧪️ `create-edge` fixture — `🚫️rejects-an-edge-whose-endpoints-are-absent`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🚫️rejects-an-edge-whose-endpoints-are-absent/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🚫️rejects-an-edge-whose-endpoints-are-absent/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🚫️rejects-an-edge-whose-endpoints-are-absent/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌉️create-edge/🚫️rejects-an-edge-whose-endpoints-are-absent/🎯️outcome/🔣️.json");
