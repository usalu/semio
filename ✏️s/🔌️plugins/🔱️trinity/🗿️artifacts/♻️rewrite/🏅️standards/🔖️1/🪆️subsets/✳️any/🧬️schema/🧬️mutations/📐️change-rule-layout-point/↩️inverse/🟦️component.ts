...
import type { ChangeRuleLayoutPoint, LayoutPoint } from "../🦠️mutation/🟦️component.ts";
import type { RemoveRuleLayoutPoint } from "../../🗑️remove-rule-layout-point/🦠️mutation/🟦️component.ts";
