...
use crate::artifacts::rewrite::mutations::{change_rule_layout_point, remove_rule_layout_point, RewriteRuleMutation};
use crate::artifacts::rewrite::RewriteSnapshot;

//#region 🔖️Inverse
pub async fn inverse(payload: &super::mutation::ChangeRuleLayoutPoint, base: &RewriteSnapshot) -> Vec<RewriteRuleMutation> {
