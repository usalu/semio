//! 🎹️ RewriteComposer (1/✳️any) — analyzer + builder glued. Reads native `s.rewrite` sources
//! plus any of: stdio.docx, stdio.json, stdio.md, stdio.pdf, stdio.txt. Writes one `s.rewrite` (1/✳️any) snapshot.
...
use crate::artifacts::rewrite::standards::v1::subsets::any::analyzer::RewriteAnalyzer;
...
pub struct RewriteComposer;

impl ArtifactComposer for RewriteComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        ...
        Err(ComposeError { message: "RewriteComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
