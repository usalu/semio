//! ♻️ Trinity Rewrite editor — the `edit` mode: the two-row layout (LHS/RHS/Jack over Parameters/
        ...
        root: WindowLayoutRoot::Axis(WindowLayoutAxisNode {
            ...
            children: vec![
                ...
                WindowLayoutChild::Axis(WindowLayoutAxisNode {
                    ...
                    size: Some(0.5),
                    children: vec![
                        window_stack(TRINITY_REWRITE_PLAY_WINDOW_PARAMETERS, "Parameters", Some(0.34)),
                        window_stack(TRINITY_REWRITE_PLAY_WINDOW_BEFORE, "Before", Some(0.33)),
                        window_stack(TRINITY_REWRITE_PLAY_WINDOW_AFTER, "After", Some(0.33)),
                    ],
                }),
            ],
        }),
