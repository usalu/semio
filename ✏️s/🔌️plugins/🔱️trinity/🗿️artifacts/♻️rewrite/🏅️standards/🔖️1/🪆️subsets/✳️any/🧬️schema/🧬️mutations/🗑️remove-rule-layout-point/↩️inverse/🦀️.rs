...
use crate::artifacts::rewrite::mutations::{change_rule_layout_point, RewriteRuleMutation};
use crate::artifacts::rewrite::RewriteSnapshot;

//#region 🔖️Inverse
pub fn inverse(payload: &super::RemoveRuleLayoutPoint, base: &RewriteSnapshot) -> Vec<RewriteRuleMutation> {
