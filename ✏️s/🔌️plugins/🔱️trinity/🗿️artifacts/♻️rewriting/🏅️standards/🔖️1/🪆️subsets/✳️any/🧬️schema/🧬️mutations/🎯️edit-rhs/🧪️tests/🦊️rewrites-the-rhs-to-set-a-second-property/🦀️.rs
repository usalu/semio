//! 🧪️ `edit-rhs` fixture — `🦊️rewrites-the-rhs-to-set-a-second-property`.
//!
...
//!
//! 🎯️ `edit-rhs` is a whole-body replacement of the authored RHS rewriting program, addressed by
