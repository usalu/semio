//! 🧪️ `remove-parameter-binding` fixture — `✂️drops-the-repeat-binding`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️remove-parameter-binding/✂️drops-the-repeat-binding/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️remove-parameter-binding/✂️drops-the-repeat-binding/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️remove-parameter-binding/✂️drops-the-repeat-binding/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️remove-parameter-binding/✂️drops-the-repeat-binding/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹️remove-parameter-binding/✂️drops-the-repeat-binding/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert!(!bindings.entries().contains_key("caption"), "the surviving binding must not appear in the delta at all");
