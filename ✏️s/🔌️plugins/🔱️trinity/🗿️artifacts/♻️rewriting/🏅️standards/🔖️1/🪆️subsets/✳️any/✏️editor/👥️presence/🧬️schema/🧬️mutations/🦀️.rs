//! 🧬️ Trinity rewriting presence mutation collection.

use super::RewritingPresence;
...
#[mutations(snapshot = RewritingPresence, diff = RewritingPresence, schema = "trinity.rewriting.presence")]
