//! 🧪️ `change-parameter-binding` fixture — `🏷️retitles-the-caption-binding`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-parameter-binding/🏷️retitles-the-caption-binding/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-parameter-binding/🏷️retitles-the-caption-binding/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-parameter-binding/🏷️retitles-the-caption-binding/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-parameter-binding/🏷️retitles-the-caption-binding/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔧️change-parameter-binding/🏷️retitles-the-caption-binding/🎯️outcome/🔣️.json");
