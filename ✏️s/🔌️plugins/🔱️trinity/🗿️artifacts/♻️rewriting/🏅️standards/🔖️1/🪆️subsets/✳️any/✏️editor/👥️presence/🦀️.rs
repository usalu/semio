...
pub enum RewritingPresenceMutation {
    #[dsl(key = "snapshot")]
    Snapshot {
        #[dsl(block)]
        presence: RewritingPresence,
    },
}

impl Mutation<RewritingPresence> for RewritingPresenceMutation {
    type Diff = RewritingPresence;
    ...
    fn inverse(&self, base: &RewritingPresence) -> Vec<Self> {
        vec![Self::Snapshot { presence: base.clone() }]
    }
}

impl protocol::OpText for RewritingPresenceMutation {
...
impl protocol::OpBinary for RewritingPresenceMutation {
