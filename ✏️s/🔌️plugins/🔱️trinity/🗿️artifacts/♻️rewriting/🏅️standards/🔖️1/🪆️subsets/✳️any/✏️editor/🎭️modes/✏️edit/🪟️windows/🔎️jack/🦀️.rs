...
//! highlighting used to read `NoConfig.active_hover_var`/`active_select_var`, both deleted —
...
pub(crate) fn render(state: &RewritingSnapshot, _cfg: &NoConfig) -> UiAssemblyResult<BuiltNode> {
