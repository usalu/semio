//! ♻️ Trinity Rewriting viewer — the `view` mode: a single full-pane Rule window, the read-only
...
pub const TRINITY_REWRITING_VIEW_MODE_VIEW: &str = "view";

//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::rewriting::create_trinity_rewriting_viewer`.
pub fn definition() -> ModeDefinition {
    ModeDefinition { id: TRINITY_REWRITING_VIEW_MODE_VIEW.into(), label: LocalizedLabel::native("View", "Ansicht"), icon_id: "eye".into(), tools: Vec::new(), layout_id: None, commands: Vec::new() }
}
