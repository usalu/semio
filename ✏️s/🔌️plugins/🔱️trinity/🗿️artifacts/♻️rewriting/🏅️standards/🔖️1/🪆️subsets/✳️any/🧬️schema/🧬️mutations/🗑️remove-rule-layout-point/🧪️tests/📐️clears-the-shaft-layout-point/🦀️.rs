...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-rule-layout-point/📐️clears-the-shaft-layout-point/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-rule-layout-point/📐️clears-the-shaft-layout-point/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-rule-layout-point/📐️clears-the-shaft-layout-point/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-rule-layout-point/📐️clears-the-shaft-layout-point/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-rule-layout-point/📐️clears-the-shaft-layout-point/🎯️outcome/🔣️.json");
