...
use semio_framework_plugin::{
    tree_item_with_action, HistoryView, Label, LocalizedLabel, PanelGroup, PanelTabDefinition, PanelTabKind, PanelTreeBuilder, UiNode, UiTreeItemNode, FRAMEWORK_PANEL_TAB_DOCUMENT_ID, FRAMEWORK_PANEL_TAB_DOCUMENT_LABEL,
};
use serde_json::json;
...
/// the `DocumentApp`-visible `HistoryView` contract — a real gap, noted for whoever revisits this).
