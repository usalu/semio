...
mod tests {
    ...
    fn command_envelope_round_trip_holds_for_an_applied_operation() {
        ...
        use vcs::VCS_DEMO_SCHEMA;
        use vcs_op::VcsDemoOperation;

        let mut store: DocumentStore<VcsDemoProjection, VcsDemoOperation> = DocumentStore::new(create_document_envelope(VCS_DEMO_SCHEMA, "vcs-demo", vcs_engine::empty_vcs_demo_projection(), None));
