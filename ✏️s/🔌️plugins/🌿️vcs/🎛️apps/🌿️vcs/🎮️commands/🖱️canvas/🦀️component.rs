...
pub mod no_operation {
    ...
    pub fn handle(_payload: &NoOperation, _doc: &DocumentView<'_, VcsDemoProjection>, _cfg: &ConfigView<'_, VcsDemoConfig>) -> Result<Emit<VcsDemoOperation, VcsDemoConfigOperation>, Fault> {
        Ok(Emit::default())
    }
}
...
pub mod canvas_pointer_down {
    ...
    pub fn handle(_payload: &CanvasPointerDown, _doc: &DocumentView<'_, VcsDemoProjection>, _cfg: &ConfigView<'_, VcsDemoConfig>) -> Result<Emit<VcsDemoOperation, VcsDemoConfigOperation>, Fault> {
        Ok(Emit::default())
    }
}
...
pub mod canvas_pointer_move {
    ...
    pub fn handle(_payload: &CanvasPointerMove, _doc: &DocumentView<'_, VcsDemoProjection>, _cfg: &ConfigView<'_, VcsDemoConfig>) -> Result<Emit<VcsDemoOperation, VcsDemoConfigOperation>, Fault> {
        Ok(Emit::default())
    }
}
...
pub mod canvas_pointer_up {
    ...
    pub fn handle(_payload: &CanvasPointerUp, _doc: &DocumentView<'_, VcsDemoProjection>, _cfg: &ConfigView<'_, VcsDemoConfig>) -> Result<Emit<VcsDemoOperation, VcsDemoConfigOperation>, Fault> {
        Ok(Emit::default())
    }
}
...
pub mod canvas_wheel {
    ...
    pub fn handle(_payload: &CanvasWheel, _doc: &DocumentView<'_, VcsDemoProjection>, _cfg: &ConfigView<'_, VcsDemoConfig>) -> Result<Emit<VcsDemoOperation, VcsDemoConfigOperation>, Fault> {
        Ok(Emit::default())
    }
}
...
mod tests {
    ...
    fn vcs_demo_command_op_text_round_trips() {
        store::test_support::assert_op_line_round_trip(&VcsCommand::NoOperation(no_operation::NoOperation {}));
