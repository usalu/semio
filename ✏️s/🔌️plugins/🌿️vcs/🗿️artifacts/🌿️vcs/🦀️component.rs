...
impl store::DocumentDsl for VcsDemoProjection {
    const EXTENSION: &'static str = "vcsdemo";
    fn envelope_id() -> &'static str { "vcsdemo" }
...
impl store::DocumentPack for VcsDemoProjection {
