...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-vcs/🧪️retitles-the-document/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-vcs/🧪️retitles-the-document/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-vcs/🧪️retitles-the-document/🎯️outcome/🔣️.json");
