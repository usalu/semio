//! 🧪️ `change-counter` fixture — `sets-counter-to-seven`.
//!
...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-counter/sets-counter-to-seven: produced diff differs from the committed 🔺️diff/🔣️component.json");
