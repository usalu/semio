...
VECTORS = {
    "rename-vcs": (f"{_ROOT}/✏️rename-vcs/🧪️tests/retitles-the-document", "renameVcs"),
    "change-counter": (f"{_ROOT}/🔢change-counter/🧪️tests/sets-counter-to-seven", "changeCounter"),
    "change-notes": (f"{_ROOT}/📝change-notes/🧪️tests/rewrites-the-notes", "changeNotes"),
    "change-status": (f"{_ROOT}/🚦change-status/🧪️tests/draft-to-review", "changeStatus"),
    "add-tag": (f"{_ROOT}/🏷️add-tag/🧪️tests/appends-urgent-tag", "addTag"),
    "remove-tag": (f"{_ROOT}/🗑️remove-tag/🧪️tests/detaches-the-review-tag", "removeTag"),
}
