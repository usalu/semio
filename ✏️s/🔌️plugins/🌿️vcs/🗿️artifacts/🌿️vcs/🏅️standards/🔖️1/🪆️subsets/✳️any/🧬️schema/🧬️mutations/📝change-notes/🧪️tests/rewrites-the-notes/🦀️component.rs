//! 🧪️ `change-notes` fixture — `rewrites-the-notes`.
//!
...
#[semio_framework_async_macros::async_test]
async fn notes_are_replaced_wholesale() {
    let base = before();
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-notes/rewrites-the-notes: produced diff differs from the committed 🔺️diff/🔣️component.json");
