//! 🧪️ `add-tag` fixture — `appends-urgent-tag`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "add-tag/appends-urgent-tag: produced diff differs from the committed 🔺️diff/🔣️component.json");
