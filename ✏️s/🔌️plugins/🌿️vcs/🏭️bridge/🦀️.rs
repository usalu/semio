//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🌿️vcs`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("VcsDemoMutation", descriptors::<semio_s_artifact_vcs_vcs::standards::v1::subsets::any::schema::snapshot::VcsSnapshot, semio_s_artifact_vcs_vcs::standards::v1::subsets::any::schema::mutations::VcsDemoMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.vcs.vcs", "1", "any", "", "✏️s/🔌️plugins/🌿️vcs/🗿️artifacts/🌿️vcs/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-vcs-mutation-bridge")),
