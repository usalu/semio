...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_vcs_vcs::standards::v1::subsets::any::schema::snapshot::VcsSnapshot, semio_s_artifact_vcs_vcs::standards::v1::subsets::any::schema::mutations::VcsDemoMutation>,
];
