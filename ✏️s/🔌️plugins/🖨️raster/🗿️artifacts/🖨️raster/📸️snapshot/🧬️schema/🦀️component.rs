...
use crate::artifacts::raster::{RasterImageAsset, RasterLayerNode, RASTER_DOCUMENT_SCHEMA};
...
#[dsl(id = "raster.raster", layout = "lines")]
...
impl store::DocumentDsl for RasterSnapshot {
    const EXTENSION: &'static str = "raster";
    fn envelope_id() -> &'static str { "raster.raster" }
...
impl store::DocumentPack for RasterSnapshot {
