...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-layer-blend-mode/💡️switches-the-a17d90/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-layer-blend-mode/💡️switches-the-a17d90/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-layer-blend-mode/💡️switches-the-a17d90/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-layer-blend-mode/💡️switches-the-a17d90/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-layer-blend-mode/💡️switches-the-a17d90/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        ...
        assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "change-layer-blend-mode/switches-the-glow-layer-to-screen: committed {side} JSON is not canonical");
    }
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "change-layer-blend-mode/switches-the-glow-layer-to-screen: committed mutation JSON is not canonical");
}
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(outcome.get("status").and_then(dsl::json::Value::as_str), Some("applied"), "change-layer-blend-mode/switches-the-glow-layer-to-screen declares an applied outcome");
...
async fn produces_committed_diff() {
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&encoded, &committed), "change-layer-blend-mode/switches-the-glow-layer-to-screen: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "change-layer-blend-mode/switches-the-glow-layer-to-screen: committed diff JSON is not canonical");
}
