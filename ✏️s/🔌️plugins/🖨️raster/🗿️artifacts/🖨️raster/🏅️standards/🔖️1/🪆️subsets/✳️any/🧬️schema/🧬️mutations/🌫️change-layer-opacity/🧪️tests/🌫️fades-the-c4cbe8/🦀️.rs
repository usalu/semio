//! 🧪️ `change-layer-opacity` fixture — `🌫️fades-the-highlight-layer-to-a-quarter`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-layer-opacity/🌫️fades-the-c4cbe8/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-layer-opacity/🌫️fades-the-c4cbe8/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-layer-opacity/🌫️fades-the-c4cbe8/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-layer-opacity/🌫️fades-the-c4cbe8/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️change-layer-opacity/🌫️fades-the-c4cbe8/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        ...
        assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "change-layer-opacity/fades-the-highlight-layer-to-a-quarter: committed {side} JSON is not canonical");
    }
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "change-layer-opacity/fades-the-highlight-layer-to-a-quarter: committed mutation JSON is not canonical");
}
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(outcome.get("status").and_then(dsl::json::Value::as_str), Some("applied"), "change-layer-opacity/fades-the-highlight-layer-to-a-quarter declares an applied outcome");
...
async fn produces_committed_diff() {
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&encoded, &committed), "change-layer-opacity/fades-the-highlight-layer-to-a-quarter: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "change-layer-opacity/fades-the-highlight-layer-to-a-quarter: committed diff JSON is not canonical");
}
