//! 🧽️ Composite-window option — the `paintEraser` utility's size/opacity sliders. Command handlers live
//! in `🎮️commands/🖌️brush::{set_brush_size,set_brush_opacity}` (eraser reuses the same brush-size/opacity
...
pub fn measure(config: &RasterConfig) -> WindowMeasure {
    WindowMeasure::Group {
        ...
        active_utility_id: Some("paintEraser".into()),
        value: None,
        min: None,
        max: None,
        step: None,
        ...
        children: vec![
            WindowMeasure::Slider {
                id: "raster-paintEraser-size".into(),
