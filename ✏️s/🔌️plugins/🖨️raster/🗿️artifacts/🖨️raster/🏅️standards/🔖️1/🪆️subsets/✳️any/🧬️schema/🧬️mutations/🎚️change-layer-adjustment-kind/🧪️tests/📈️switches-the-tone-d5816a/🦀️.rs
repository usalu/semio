//! 🧪️ `change-layer-adjustment-kind` fixture — `📈️switches-the-tone-layer-from-levels-to-curves`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-layer-adjustment-kind/📈️switches-the-tone-d5816a/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-layer-adjustment-kind/📈️switches-the-tone-d5816a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-layer-adjustment-kind/📈️switches-the-tone-d5816a/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-layer-adjustment-kind/📈️switches-the-tone-d5816a/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎚️change-layer-adjustment-kind/📈️switches-the-tone-d5816a/🎯️outcome/🔣️.json");
