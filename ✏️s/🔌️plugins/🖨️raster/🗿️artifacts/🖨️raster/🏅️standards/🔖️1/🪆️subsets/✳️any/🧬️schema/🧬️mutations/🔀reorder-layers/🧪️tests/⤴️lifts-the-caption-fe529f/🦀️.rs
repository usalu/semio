//! 🧪️ `reorder-layers` fixture — `⤴️lifts-the-caption-layer-out-of-the-frame-group`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-layers/⤴️lifts-the-caption-fe529f/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-layers/⤴️lifts-the-caption-fe529f/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-layers/⤴️lifts-the-caption-fe529f/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-layers/⤴️lifts-the-caption-fe529f/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-layers/⤴️lifts-the-caption-fe529f/🎯️outcome/🔣️.json");
...
async fn committed_json_is_canonical() {
    for (side, text) in [("before", BEFORE), ("after", AFTER)] {
        ...
        assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "reorder-layers/lifts-the-caption-layer-out-of-the-frame-group: committed {side} JSON is not canonical");
    }
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "reorder-layers/lifts-the-caption-layer-out-of-the-frame-group: committed mutation JSON is not canonical");
}
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(outcome.get("status").and_then(dsl::json::Value::as_str), Some("applied"), "reorder-layers/lifts-the-caption-layer-out-of-the-frame-group declares an applied outcome");
...
async fn produces_committed_diff() {
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&encoded, &committed), "reorder-layers/lifts-the-caption-layer-out-of-the-frame-group: produced diff differs from the committed 🔺️diff/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "reorder-layers/lifts-the-caption-layer-out-of-the-frame-group: committed diff JSON is not canonical");
}
