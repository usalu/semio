//! 🧪️ `add-layer-asset` fixture — `🖼️declines-to-reattach-an-asset-already-on-the-document`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️add-layer-asset/🖼️declines-to-4af870/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️add-layer-asset/🖼️declines-to-4af870/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️add-layer-asset/🖼️declines-to-4af870/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️add-layer-asset/🖼️declines-to-4af870/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖇️add-layer-asset/🖼️declines-to-4af870/🎯️outcome/🔣️.json");
...
async fn committed_diff_is_canonical() {
    ...
    assert!(dsl::json::value_eq_ignoring_object_order(&reencoded, &original), "add-layer-asset/declines-to-reattach-an-asset-already-on-the-document: committed diff JSON is not canonical");
}
