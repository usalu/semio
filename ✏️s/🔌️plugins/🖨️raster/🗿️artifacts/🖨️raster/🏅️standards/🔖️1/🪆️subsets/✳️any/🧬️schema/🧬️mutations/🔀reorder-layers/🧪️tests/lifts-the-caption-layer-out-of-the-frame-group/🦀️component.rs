...
async fn produces_committed_diff() {
    ...
    assert_eq!(encoded, committed, "reorder-layers/lifts-the-caption-layer-out-of-the-frame-group: produced diff differs from the committed 🔺️diff/🔣️component.json");
