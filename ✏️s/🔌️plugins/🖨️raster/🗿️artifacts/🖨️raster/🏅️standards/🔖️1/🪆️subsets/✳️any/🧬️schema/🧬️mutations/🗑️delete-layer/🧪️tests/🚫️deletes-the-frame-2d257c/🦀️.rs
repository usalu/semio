//! 🧪️ `delete-layer` fixture — `🚫️deletes-the-frame-group-and-its-nested-children`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️deletes-the-frame-2d257c/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️deletes-the-frame-2d257c/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️deletes-the-frame-2d257c/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️deletes-the-frame-2d257c/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-layer/🚫️deletes-the-frame-2d257c/🎯️outcome/🔣️.json");
