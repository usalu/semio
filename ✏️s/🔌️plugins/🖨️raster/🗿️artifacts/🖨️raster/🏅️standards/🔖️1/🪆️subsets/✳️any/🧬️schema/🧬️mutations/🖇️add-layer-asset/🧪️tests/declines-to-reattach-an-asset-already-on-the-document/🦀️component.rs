...
async fn produces_committed_diff() {
    ...
    assert_eq!(encoded, committed, "add-layer-asset/declines-to-reattach-an-asset-already-on-the-document: produced diff differs from the committed 🔺️diff/🔣️component.json");
