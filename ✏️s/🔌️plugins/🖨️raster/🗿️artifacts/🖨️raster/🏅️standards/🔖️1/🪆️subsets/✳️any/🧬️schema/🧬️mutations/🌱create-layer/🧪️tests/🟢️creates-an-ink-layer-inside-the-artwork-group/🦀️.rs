//! 🧪️ `create-layer` fixture — `🟢️creates-an-ink-layer-inside-the-artwork-group`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(encoded, committed, "create-layer/creates-an-ink-layer-inside-the-artwork-group: produced diff differs from the committed 🔺️diff/🔣️.json");
