...
async fn produces_committed_diff() {
    ...
    assert_eq!(encoded, committed, "delete-layer/deletes-the-frame-group-and-its-nested-children: produced diff differs from the committed 🔺️diff/🔣️component.json");
