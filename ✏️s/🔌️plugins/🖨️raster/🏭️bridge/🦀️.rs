...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_raster_raster::standards::v1::subsets::any::schema::snapshot::RasterSnapshot, semio_s_artifact_raster_raster::standards::v1::subsets::any::schema::mutations::RasterMutation>,
];
