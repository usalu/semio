//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🎞️animate`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("PresentationConfigMutation", descriptors::<semio_s_artifact_animate_presentation::editor::animate::config::PresentationConfig, semio_s_artifact_animate_presentation::editor::animate::config::PresentationConfigMutation>),
    ("PresentationPresenceMutation", descriptors::<semio_s_artifact_animate_presentation::editor::animate::presence::PresentationPresence, semio_s_artifact_animate_presentation::editor::animate::presence::PresentationPresenceMutation>),
    ("PresentationMutation", descriptors::<semio_s_artifact_animate_presentation::standards::v1::subsets::any::schema::snapshot::PresentationSnapshot, semio_s_artifact_animate_presentation::standards::v1::subsets::any::schema::mutations::PresentationMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.animate.presentation", "1", "any", "", "✏️s/🔌️plugins/🎞️animate/🗿️artifacts/🎬️presentation/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.animate.presentation", "1", "any", "✏️editor/🎚️config", "✏️s/🔌️plugins/🎞️animate/🗿️artifacts/🎬️presentation/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎚️config", ""),
    ("s.animate.presentation", "1", "any", "✏️editor/👥️presence", "✏️s/🔌️plugins/🎞️animate/🗿️artifacts/🎬️presentation/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/👥️presence", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-animate-mutation-bridge")),
