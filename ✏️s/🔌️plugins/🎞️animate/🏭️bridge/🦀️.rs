...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_animate_presentation::standards::v1::subsets::any::schema::snapshot::PresentationSnapshot, semio_s_artifact_animate_presentation::standards::v1::subsets::any::schema::mutations::PresentationMutation>,
];
