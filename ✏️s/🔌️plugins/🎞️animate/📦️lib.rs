...
pub mod artifacts {
    ...
    pub mod present {
        ...
        pub mod engine {
            ...
            #[path = "🗿️artifacts/🎬️present/⚙️engine/🦀️animate_core.rs"]
            pub mod animate_core;
            #[path = "🗿️artifacts/🎬️present/⚙️engine/🦀️animate_video.rs"]
...
pub mod apps {
    ...
    pub mod present {
        ...
        #[path = "🎛️apps/🎬️present/🦀️config.rs"]
        pub mod config;
        #[path = "🎛️apps/🎬️present/🦀️terminology.rs"]
        pub mod terminology;
        #[path = "🎛️apps/🎬️present/🦀️wasm.rs"]
        pub mod wasm;
