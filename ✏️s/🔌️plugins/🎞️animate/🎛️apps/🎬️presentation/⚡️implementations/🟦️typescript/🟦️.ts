// #region 🧲️Header
/** @emoji 🎞️ `@semio-tech/animate-presentation-core` — render-independent declarative presentation model. */
// #endregion 🧲️Header
...
export const animatePlayAppDefinition = {
	...
	modes: [{ id: "presentation", label: "Presentation" }],
	defaultModeId: "presentation",
	devHost: {
