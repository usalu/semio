...
//#region 🧪️Recovery
describe("animate presentation core recovery", () => {
	it("assembles, collects, and resolves a slide glob hierarchy", () => {
		const presentation = loadPresentationFromSlideGlob(
			...
			{
				"../../⚡️implementations/🟦️typescript/🎞️slide/Chapter/Sequence/Thought/Second.ts": {
					default: {
						order: 2,
						arrangement: {
							id: "second",
				...
				"../../⚡️implementations/🟦️typescript/🎞️slide/Chapter/Sequence/Thought/First.ts": {
					default: {
						order: 1,
