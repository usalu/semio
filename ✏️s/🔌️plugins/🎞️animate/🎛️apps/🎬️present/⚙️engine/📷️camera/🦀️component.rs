//! 🎞️ Animate app engine facet: 📷️camera (ticket 26/08/12/ENGINELESS-ARTIFACTS-AND-APP-STATE-MACHINES:
//! relocated verbatim from the deleted artifact-tree `⚙️engine/📷️camera`).
