//! 📜️ Animate present app — textual document grammar surface + laws (constitutional: dsl).
...
pub const PRESENT_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/🎞️animate/📚️examples/🎞️default.present");
