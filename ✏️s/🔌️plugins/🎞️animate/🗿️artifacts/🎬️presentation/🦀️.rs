...
pub use crate::artifacts::presentation::schema::mutations::PresentationMutation;

pub use crate::artifacts::presentation::schema::diff::PresentationDiff;

pub const PRESENTATION_DOCUMENT_SCHEMA: &str = "animate.presentation";
pub use crate::artifacts::presentation::snapshot::schema::{default_snapshot, PresentationSnapshot};
        ...
        + From<semio_framework_plugin::VcsArtifactApp<semio_framework_plugin::ViewerApp<crate::viewer::animate::AnimatePresentationViewer>>>,
{
    ...
    ArtifactDeclaration { kind: ArtifactKindId::parse("s.animate.presentation").expect("canonical animate.presentation kind"), localization: &[], standards: vec![crate::artifacts::presentation::standards::v1::standard::<PA>()] }
}
