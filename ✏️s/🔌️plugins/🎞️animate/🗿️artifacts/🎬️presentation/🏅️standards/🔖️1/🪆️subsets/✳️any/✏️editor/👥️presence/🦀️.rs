...
//#region 🔖️Presence
/// 👥️ Shareable live subset of animate presentation view state. Tile selection/hover broadcast through
...
#[dsl(extension = "presentation.presence")]
#[dsl(id = "presentation.presence")]
#[dsl(layout = "lines")]
...
impl store::ArtifactDsl for PresentationPresence {
...
impl ArtifactPack for PresentationPresence {
