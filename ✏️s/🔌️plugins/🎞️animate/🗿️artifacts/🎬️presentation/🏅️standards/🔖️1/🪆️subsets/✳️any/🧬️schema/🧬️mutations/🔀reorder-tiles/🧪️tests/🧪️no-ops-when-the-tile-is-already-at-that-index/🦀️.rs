...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-tiles/🧪️no-ops-when-the-tile-is-already-at-that-index/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-tiles/🧪️no-ops-when-the-tile-is-already-at-that-index/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-tiles/🧪️no-ops-when-the-tile-is-already-at-that-index/🎯️outcome/🔣️.json");
