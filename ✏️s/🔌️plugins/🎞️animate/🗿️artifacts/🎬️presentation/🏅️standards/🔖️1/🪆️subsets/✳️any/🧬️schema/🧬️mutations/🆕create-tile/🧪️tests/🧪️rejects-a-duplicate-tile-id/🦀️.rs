...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆕create-tile/🧪️rejects-a-duplicate-tile-id/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆕create-tile/🧪️rejects-a-duplicate-tile-id/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🆕create-tile/🧪️rejects-a-duplicate-tile-id/🎯️outcome/🔣️.json");
