/** 🎬️ PresentationMutation — closed semantic mutation vocabulary for the presentation-deck document, mirrors
 *  `🧬️mutations/🦀️.rs`'s `PresentationMutation` enum and its 9 per-verb leaf structs. The enum
