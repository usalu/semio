...
pub mod geometry {
    ...
    pub fn surrounding_rectangle<S: Sobject>(mobject: &S, buff: f64, fill: Color, stroke: Option<Color>, stroke_width: f64) -> VSobject {
    ...
    #[cfg(test)]
    include!("🧪️tests/🔬️geometry-unit/🦀️.rs");
}
...
pub mod three_d {
    ...
    #[cfg(test)]
    include!("🧪️tests/🔬️three-d-unit/🦀️.rs");
}
...
pub mod axes {
    ...
    #[cfg(test)]
    include!("🧪️tests/🔬️axes-unit/🦀️.rs");
}
