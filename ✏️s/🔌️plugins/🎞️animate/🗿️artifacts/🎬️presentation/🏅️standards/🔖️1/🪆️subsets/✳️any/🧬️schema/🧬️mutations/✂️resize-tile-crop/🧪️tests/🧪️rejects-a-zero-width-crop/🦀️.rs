...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️resize-tile-crop/🧪️rejects-a-zero-width-crop/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️resize-tile-crop/🧪️rejects-a-zero-width-crop/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️resize-tile-crop/🧪️rejects-a-zero-width-crop/🎯️outcome/🔣️.json");
