//! 🧪️ `delete-tiles` fixture — `🚫️rejects-when-every-addressed-tile-is-missing`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹delete-tiles/🧪️rejects-when-every-addressed-tile-is-missing/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹delete-tiles/🧪️rejects-when-every-addressed-tile-is-missing/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹delete-tiles/🧪️rejects-when-every-addressed-tile-is-missing/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹delete-tiles/🧪️rejects-when-every-addressed-tile-is-missing/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧹delete-tiles/🧪️rejects-when-every-addressed-tile-is-missing/🎯️outcome/🔣️.json");
