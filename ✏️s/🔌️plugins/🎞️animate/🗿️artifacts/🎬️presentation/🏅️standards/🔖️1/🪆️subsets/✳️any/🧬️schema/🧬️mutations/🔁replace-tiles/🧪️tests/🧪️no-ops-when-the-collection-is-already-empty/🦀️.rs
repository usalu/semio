...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁replace-tiles/🧪️no-ops-when-the-collection-is-already-empty/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁replace-tiles/🧪️no-ops-when-the-collection-is-already-empty/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁replace-tiles/🧪️no-ops-when-the-collection-is-already-empty/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁replace-tiles/🧪️no-ops-when-the-collection-is-already-empty/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁replace-tiles/🧪️no-ops-when-the-collection-is-already-empty/🎯️outcome/🔣️.json");
