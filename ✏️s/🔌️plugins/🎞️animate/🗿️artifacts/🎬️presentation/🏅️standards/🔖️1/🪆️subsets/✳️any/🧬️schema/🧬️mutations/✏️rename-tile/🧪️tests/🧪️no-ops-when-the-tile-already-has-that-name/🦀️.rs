...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-tile/🧪️no-ops-when-the-tile-already-has-that-name/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-tile/🧪️no-ops-when-the-tile-already-has-that-name/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-tile/🧪️no-ops-when-the-tile-already-has-that-name/🎯️outcome/🔣️.json");
