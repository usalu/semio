...
if (import.meta.vitest) {
  const { registerTests1 } = await import("./🧪️tests/🧪️owned-markdown-html-compiler/🟦️.ts");
  await registerTests1(import.meta.vitest, { compileOwnedMarkdownToHtml }, { directory: import.meta.dir, url: import.meta.url });
}
// #endregion 🧪️Tests
