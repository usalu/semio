...
pub fn render(deck: &PresentationSnapshot, labels: &AnimatePresentationLabels) -> BuiltNode {
    ...
    let templates = section(Label::from(labels.catalogue_tile_templates.as_str()))
        ...
        .children(vec![
            ...
            catalogue_button("animate.presentation.play.catalogue.seed-2x2", labels.catalogue_seed_2x2.as_str(), "seedGrid", Some(json!({ "rows": 2, "columns": 2 }))),
            catalogue_button("animate.presentation.play.catalogue.seed-3x5", labels.catalogue_seed_3x5.as_str(), "seedGrid", Some(json!({ "rows": 3, "columns": 5 }))),
    ...
    let figure = section(Label::from(labels.catalogue_figure_templates.as_str()))
        ...
        .children(vec![
            catalogue_button(
                ...
                "setSource",
                Some(dsl::ToValue::to_value(&crate::artifacts::presentation::presentation_working_scene(&crate::artifacts::presentation::default_presentation_snapshot()).0).into()),
            ),
