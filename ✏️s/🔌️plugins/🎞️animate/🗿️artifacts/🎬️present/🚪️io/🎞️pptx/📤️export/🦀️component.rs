//! 📤️ Export PresentSnapshot as .pptx.

use semio_framework_plugin::{DocumentCodec, IoError, JsonCodec, MediaFormat};

//#region 🔖️Export
pub fn export(snapshot: &crate::artifacts::present::PresentSnapshot) -> Result<Vec<u8>, IoError> {
...
pub fn register() {
    let kind = "2d.present";
    let format = MediaFormat::Pptx;
    semio_framework_os::register_os_media_export_handler(kind, format, move |doc| {
        let snapshot: crate::artifacts::present::PresentSnapshot =
