//! 🎞️ Animate engine facet: 📐️geometry
...
pub mod geometry {
    ...
    use crate::artifacts::present::engine::animate::sobject::{Group, Sobject, VSobject};
...
pub mod three_d {
    ...
    use crate::artifacts::present::engine::animate::color::Color;
    use crate::artifacts::present::engine::animate::geometry::{circle, line, polygon, rectangle};
    use crate::artifacts::present::engine::animate::sobject::{Bounds, Group, Sobject, Style, VSobject};
...
pub mod axes {
    ...
    use crate::artifacts::present::engine::animate::color::Color;
    use crate::artifacts::present::engine::animate::geometry::{arrow, dot, line};
    use crate::artifacts::present::engine::animate::sobject::{Group, Sobject, VSobject};
    use crate::artifacts::present::engine::animate::text::Text;
