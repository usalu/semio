...
pub mod updater {
        ...
        F: Fn() -> Box<dyn Sobject> + Send + Sync + 'static,
    {
        ...
        add_updater(
            ...
            Updater::new(name, move |obj, _dt| {
                let fresh = factory();
                if let Some(v) = obj.as_any_mut().downcast_mut::<crate::artifacts::present::engine::animate::sobject::VSobject>() {
                    if let Some(fv) = fresh.as_any().downcast_ref::<crate::artifacts::present::engine::animate::sobject::VSobject>() {
    ...
    mod tests {
        ...
        fn run_updaters_recurses_into_group_children() {
            ...
            let mut group = crate::artifacts::present::engine::animate::sobject::Group::new(vec![Box::new(child)]);
