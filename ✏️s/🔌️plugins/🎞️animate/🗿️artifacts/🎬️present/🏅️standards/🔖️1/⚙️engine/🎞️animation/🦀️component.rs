//! 🎞️ Animate engine facet: 🎞️animation
...
pub mod animation {
    ...
    use crate::artifacts::present::engine::animate::rate::{map_child_alpha, RateFunc};
    ...
    impl Create {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::linear, started: false, snapshot_ratio: 1.0 }
        }
    ...
    impl FadeIn {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, target_opacity: 1.0, start_opacity: 0.0, primed: false }
        }
    }
    ...
    impl FadeOut {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, start_opacity: 1.0, primed: false }
        }
    }
    ...
    impl Transform {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, primed: false }
        }
    }
    ...
    impl Rotate {
        pub fn new(target_id: u64, angle: f64, run_time: f64) -> Self {
            Self { target_id, angle, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, start_transform: None }
        }
    }
    ...
    impl MoveAlongPath {
        pub fn new(target_id: u64, path: CubicBez, run_time: f64) -> Self {
            Self { target_id, path, run_time, rate: crate::artifacts::present::engine::animate::rate::linear }
        }
    ...
    impl AnimationGroup {
        pub fn new(animations: Vec<Box<dyn Animation>>) -> Self {
            ...
            Self { animations, run_time: None, rate: crate::artifacts::present::engine::animate::rate::linear, begun: vec![false; n] }
        }
    ...
    impl Succession {
        pub fn new(animations: Vec<Box<dyn Animation>>) -> Self {
            ...
            let n = animations.len();
            Self { animations, rate: crate::artifacts::present::engine::animate::rate::linear, active_index: None, begun: vec![false; n], durations, total }
        }
        ...
        F: Fn(usize) -> Box<dyn Animation> + Send,
    {
        ...
        fn rate_func(&self) -> RateFunc {
            crate::artifacts::present::engine::animate::rate::linear
        }
        fn begin(&mut self) {}
        fn finish(&mut self) {
    ...
    impl<'a> AnimateBuilder<'a> {
        pub fn new(target: &'a mut dyn Sobject, run_time: f64) -> Self {
            Self { target, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth }
        }
    ...
    impl Shift {
        pub fn new(target_id: u64, delta: Vec2, run_time: f64) -> Self {
            Self { target_id, delta, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, start_transform: None }
        }
    }
    ...
    impl ApplyMethod {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, scale_factor: 1.2, start_transform: None }
        }
    }
    ...
    impl FocusOn {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::there_and_back, start_transform: None }
        }
    }
    ...
    impl Blink {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::there_and_back, start_opacity: 1.0, primed: false }
        }
    }
    ...
    impl TracedPath {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::linear, primed: false }
        }
    }
    ...
    mod tests {
        use super::*;
        use crate::artifacts::present::engine::animate::animation::AnimateExt;
...
pub mod animations_catalog {
    ...
    use crate::artifacts::present::engine::animate::animation::{eased_alpha_for, with_vsobject, Animation};
    use crate::artifacts::present::engine::animate::rate::RateFunc;
    ...
    impl DrawBorderThenFill {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, primed: false, fill_opacity: 1.0 }
        }
    }
    ...
    impl TransformFromCopy {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, primed: false, start_transform: None }
        }
    }
    ...
    impl GrowFromPoint {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, grow_point: Point::ZERO, start_transform: None }
        }
    }
    ...
    impl ShrinkToCenter {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, start_transform: None, start_opacity: 1.0, primed: false }
        }
    }
    ...
    impl SpinInFromNothing {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, angle: std::f64::consts::TAU, start_transform: None }
        }
    }
    ...
    impl ChangeDecimalToValue {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, value: 0.0, start_opacity: 1.0, primed: false }
        }
    }
    ...
    impl ApplyWave {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, amplitude: 0.2, start_transform: None }
        }
    }
    ...
    impl Wiggle {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::there_and_back, angle: 0.1, start_transform: None }
        }
    }
    ...
    impl CyclicReplace {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { cycle_ids: vec![target_id], run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, start_centers: Vec::new() }
        }
    }
    ...
    impl Swap {
        pub fn new(target_id: u64, swap_id: u64, run_time: f64) -> Self {
            Self { target_id, swap_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, a_center: None, b_center: None }
        }
    }
    ...
    impl Homotopy {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, start_transform: None }
        }
    }
    ...
    impl SpiralIn {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::smooth, angle: std::f64::consts::TAU * 2.0, origin: Point::ZERO, start_transform: None }
        }
    }
    ...
    impl Rotating {
        pub fn new(target_id: u64, run_time: f64) -> Self {
            Self { target_id, run_time, rate: crate::artifacts::present::engine::animate::rate::linear, angle: std::f64::consts::TAU, start_transform: None }
        }
    }
    ...
    mod tests {
        ...
        use crate::artifacts::present::engine::animate::geometry::circle;
        use crate::artifacts::present::engine::animate::sobject::VSobject;
