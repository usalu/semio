...
where
    PA: semio_framework_plugin::PluginApp
        + From<semio_framework_plugin::VcsArtifactApp<semio_framework_plugin::EditorApp<editor::AnimatePresentPlayApp>>>
        + From<semio_framework_plugin::VcsArtifactApp<semio_framework_plugin::ViewerApp<viewer::AnimatePresentViewer>>>,
{
    SubsetDeclaration {
        ...
        io: io::io(),
        viewer: viewer_surface::<viewer::AnimatePresentViewer, PA>(viewer::create_animate_present_viewer()),
        editor: editor_surface::<editor::AnimatePresentPlayApp, PA>(editor::create_animate_present_app()),
        examples: examples(),
    }
}
