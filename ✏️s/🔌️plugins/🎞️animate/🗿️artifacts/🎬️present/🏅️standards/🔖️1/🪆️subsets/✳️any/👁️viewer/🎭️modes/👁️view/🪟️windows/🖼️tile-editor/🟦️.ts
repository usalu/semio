 ...
 * inputs (a bare `PresentSnapshot`, no runtime/config/utility state: a viewer has none of those). */
export interface AnimateViewTileEditorViewModel {
  windowKindId: "animate-view-tile-editor";
  bodyKey: "animate.view.tile-editor";
  surfaceId: "animate.present.view";
...
export const ANIMATE_VIEW_TILE_EDITOR_SURFACE_ID = "animate.present.view" as const;
