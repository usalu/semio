...
export const ANIMATE_VIEWER_DIALECT = { artifactKind: "s.animate.present", standard: "1", subset: "*" } as const;

export const ANIMATE_VIEW_MODE_ID = "view" as const;

export * from "./🎭️modes/👁️view/🪟️windows/🖼️tile-editor/🟦️component";
