//! 🎞️ Animate engine facet: 🎛️config
...
pub mod graph {
    ...
    use crate::artifacts::present::engine::animate::geometry::{arrow, circle, line};
    use crate::artifacts::present::engine::animate::sobject::{Group, Sobject};
