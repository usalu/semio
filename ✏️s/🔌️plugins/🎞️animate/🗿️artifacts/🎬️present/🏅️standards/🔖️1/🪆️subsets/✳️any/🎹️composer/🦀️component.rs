//! 🎹️ PresentComposer (1/✳️any) — analyzer + builder glued. Reads native `s.present` sources
//! plus any of: stdio.json, stdio.md, stdio.pdf, stdio.png, stdio.pptx, stdio.svg, stdio.txt. Writes one `s.present` (1/✳️any) snapshot.
...
use crate::artifacts::present::standards::v1::subsets::any::analyzer::PresentAnalyzer;
...
pub struct PresentComposer;

impl ArtifactComposer for PresentComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        ...
        Err(ComposeError { message: "PresentComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
