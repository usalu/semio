...
fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-source/no-ops-when-the-source-is-already-identical: produced diff differs from the committed 🔺️diff/🔣️component.json");
