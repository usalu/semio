...
pub mod scene {
    ...
    use crate::artifacts::present::engine::animate::animation::{apply_parent_opacity_tree, compile_animations, interpolate_at, Animation, Wait};
    use crate::artifacts::present::engine::animate::camera::{Camera, MovingCamera, ThreeDCamera, ZoomedCamera};
    use crate::artifacts::present::engine::animate::config::AnimateConfig;
    use crate::artifacts::present::engine::animate::section::SectionList;
    use crate::artifacts::present::engine::animate::sobject::Sobject;
    use crate::artifacts::present::engine::animate::updater::run_updaters;
    ...
    mod tests {
        use super::*;
        use crate::artifacts::present::engine::animate::sobject::VSobject;
...
pub mod sobject {
    ...
    use crate::artifacts::present::engine::animate::updater::Updater;
