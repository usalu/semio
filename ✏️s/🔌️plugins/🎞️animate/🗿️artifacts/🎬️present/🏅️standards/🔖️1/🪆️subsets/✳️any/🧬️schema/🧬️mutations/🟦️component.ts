 ...
 *  `🧬️mutations/🦀️component.rs`'s `PresentMutation` enum and its 9 per-verb leaf structs. The enum
 ...
 *  every committed `🧪️tests/*​/🦠️mutation/🔣️component.json` fixture (e.g. `{"RenameTile":
...
import type { FigureTileDraft, FigureTileFrame, FigureTileSource } from "../🟦️component.ts";
