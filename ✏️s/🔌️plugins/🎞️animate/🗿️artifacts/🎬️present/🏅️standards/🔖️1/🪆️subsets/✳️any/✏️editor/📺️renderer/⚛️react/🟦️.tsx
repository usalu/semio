...
export type { MorphFromSlot, PresentationLanguageKind, PresentationSlideBookmark, PresentationSlideBookmarkParamKeys, PresentationSlideRef, RenderSlide, Slide, TextMorphRoot } from "@semio-tech/animate-present-core";
...
const pdfWorkerReady = ephemeralBox<Promise<void> | null>("s.plugins.animate.apps.present.renderer.react.component.tsx.pdfWorkerReady", null);
...
const pdfCanvasPort = ephemeralBox<PdfCanvasPort>("s.plugins.animate.apps.present.renderer.react.component.tsx.pdfCanvasPort", defaultPdfCanvasPort);
