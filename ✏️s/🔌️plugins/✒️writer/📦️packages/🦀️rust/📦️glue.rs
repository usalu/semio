...
pub mod artifacts {
    ...
    pub mod writer {
                        ...
                        pub mod schema {
                            ...
                            pub mod mutations {
                                ...
                                pub mod rename_writer {
                                    #[path = "../../🗿️artifacts/✒️writer/🏅️standards/🔖️1/🪆️subsets/✳️any/🧬️schema/🧬️mutations/🏷️rename-writer/🦠️mutation/🦀️component.rs"]
                                    pub mod mutation;
                                ...
                                #[path = "."]
                                pub mod change_uri {
                                    #[path = "../../🗿️artifacts/✒️writer/🏅️standards/🔖️1/🪆️subsets/✳️any/🧬️schema/🧬️mutations/🔗change-uri/🦠️mutation/🦀️component.rs"]
                                    pub mod mutation;
                                ...
                                pub mod change_language {
                                    #[path = "../../🗿️artifacts/✒️writer/🏅️standards/🔖️1/🪆️subsets/✳️any/🧬️schema/🧬️mutations/🌐change-language/🦠️mutation/🦀️component.rs"]
                                    pub mod mutation;
                                ...
                                #[path = "."]
                                pub mod edit_text {
                                    #[path = "../../🗿️artifacts/✒️writer/🏅️standards/🔖️1/🪆️subsets/✳️any/🧬️schema/🧬️mutations/✏️edit-text/🦠️mutation/🦀️component.rs"]
                                    pub mod mutation;
        ...
        pub mod op { pub use crate::artifacts::writer::standards::v1::subsets::any::io::mutations::text::*; pub use crate::artifacts::writer::standards::v1::subsets::any::schema::mutations::WriterMutation; }
        pub mod dsl { pub use crate::artifacts::writer::standards::v1::subsets::any::io::snapshot::text::*; }
        pub mod spr { pub use crate::artifacts::writer::standards::v1::subsets::any::io::mutations::binary::*; }
        pub mod pack { pub use crate::artifacts::writer::standards::v1::subsets::any::io::snapshot::binary::*; }
        pub mod diff { pub use crate::artifacts::writer::standards::v1::subsets::any::schema::diff::*; pub mod schema { pub use crate::artifacts::writer::standards::v1::subsets::any::schema::diff::*; } pub mod text { pub use crate::artifacts::writer::standards::v1::subsets::any::io::diff::text::*; } }
