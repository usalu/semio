//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/✒️writer`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("WriterMainWindowConfigMutation", descriptors::<semio_s_artifact_writer_writer::editor::writer::modes::edit::windows::main::config::WriterMainWindowConfig, semio_s_artifact_writer_writer::editor::writer::modes::edit::windows::main::config::WriterMainWindowConfigMutation>),
    ("WriterMainWindowTransientMutation", descriptors::<semio_s_artifact_writer_writer::editor::writer::modes::edit::windows::main::transient::WriterMainWindowTransient, semio_s_artifact_writer_writer::editor::writer::modes::edit::windows::main::transient::WriterMainWindowTransientMutation>),
    ("WriterMutation", descriptors::<semio_s_artifact_writer_writer::standards::v1::subsets::any::schema::snapshot::WriterSnapshot, semio_s_artifact_writer_writer::standards::v1::subsets::any::schema::mutations::WriterMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.writer.writer", "1", "any", "", "✏️s/🔌️plugins/✒️writer/🗿️artifacts/✒️writer/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.writer.writer", "1", "any", "✏️editor/🎭️modes/✏️edit/🪟️windows/✒️main/🎚️config", "✏️s/🔌️plugins/✒️writer/🗿️artifacts/✒️writer/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎭️modes/✏️edit/🪟️windows/✒️main/🎚️config", ""),
    ("s.writer.writer", "1", "any", "✏️editor/🎭️modes/✏️edit/🪟️windows/✒️main/🫧️transient", "✏️s/🔌️plugins/✒️writer/🗿️artifacts/✒️writer/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎭️modes/✏️edit/🪟️windows/✒️main/🫧️transient", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-writer-mutation-bridge")),
