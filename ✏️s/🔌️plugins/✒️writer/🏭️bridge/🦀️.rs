...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_writer_writer::standards::v1::subsets::any::schema::snapshot::WriterSnapshot, semio_s_artifact_writer_writer::standards::v1::subsets::any::schema::mutations::WriterMutation>,
];
