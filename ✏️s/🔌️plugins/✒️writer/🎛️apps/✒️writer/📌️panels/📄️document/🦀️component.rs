...
//#region 🔖️Constants
pub const WRITER_PLAY_BODY_DOCUMENT: &str = "writer.play.document";
...
pub fn definition() -> PanelTabDefinition {
    PanelTabDefinition {
        ...
        body_key: None,
        children: vec![
            PanelTabDefinition { kind: PanelTabKind::App(WRITER_PANEL_TAB_DOCUMENT_CONTENT_ID.into()), label: LocalizedLabel::native("Content", "Inhalt"), group: PanelGroup::Workbench, body_key: Some(WRITER_PLAY_BODY_DOCUMENT.into()), children: Vec::new() },
            PanelTabDefinition { kind: PanelTabKind::App(WRITER_PANEL_TAB_DOCUMENT_OUTLINE_ID.into()), label: LocalizedLabel::native("Outline", "Gliederung"), group: PanelGroup::Workbench, body_key: Some(WRITER_PLAY_BODY_DOCUMENT.into()), children: Vec::new() },
        ],
    }
}
