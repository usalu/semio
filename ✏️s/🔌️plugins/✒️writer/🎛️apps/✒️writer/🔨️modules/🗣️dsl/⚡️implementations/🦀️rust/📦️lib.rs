...
pub const JACK_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/✒️writer/📚️examples/✒️jack.writer");
/// 📄️ The `dag.jack` example document, handcrafted in the `.writer` DSL — see {@link JACK_EXAMPLE_TEXT}.
pub const DAG_JACK_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/✒️writer/📚️examples/✒️dag.jack.writer");
