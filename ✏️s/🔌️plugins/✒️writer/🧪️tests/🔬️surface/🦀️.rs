...
async fn writer_viewer_never_mutates() {
    semio_framework_plugin::artifact_app_laws::assert_viewer_never_mutates::<crate::viewer::writer::WriterViewer>().await;
}

#[semio_framework_async_macros::async_test]
async fn writer_editor_and_viewer_share_dialect() {
    semio_framework_plugin::artifact_app_laws::assert_editor_and_viewer_share_dialect::<crate::editor::writer::WriterPlayApp, crate::viewer::writer::WriterViewer>().await;
}
