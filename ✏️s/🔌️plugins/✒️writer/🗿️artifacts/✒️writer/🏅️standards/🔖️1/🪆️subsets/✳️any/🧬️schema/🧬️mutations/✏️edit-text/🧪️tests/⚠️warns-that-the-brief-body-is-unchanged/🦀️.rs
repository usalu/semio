//! 🧪️ `edit-text` fixture — `⚠️warns-that-the-brief-body-is-unchanged`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-text/⚠️warns-that-the-brief-body-is-unchanged/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-text/⚠️warns-that-the-brief-body-is-unchanged/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️edit-text/⚠️warns-that-the-brief-body-is-unchanged/🦠️mutation/🔣️.json");
