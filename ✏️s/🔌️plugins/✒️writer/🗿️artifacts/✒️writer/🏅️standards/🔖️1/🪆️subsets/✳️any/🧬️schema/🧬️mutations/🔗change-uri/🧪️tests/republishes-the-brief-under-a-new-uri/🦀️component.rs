//! 🧪️ `change-uri` fixture — `republishes-the-brief-under-a-new-uri`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-uri/republishes-the-brief-under-a-new-uri: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
