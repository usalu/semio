//! 🧪️ `rename-writer` fixture — `renames-the-document-to-mission-brief`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "rename-writer/renames-the-document-to-mission-brief: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
