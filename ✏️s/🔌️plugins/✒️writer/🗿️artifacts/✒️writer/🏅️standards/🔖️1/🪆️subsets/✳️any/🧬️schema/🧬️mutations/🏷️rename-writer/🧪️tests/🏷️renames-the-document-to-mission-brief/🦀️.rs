...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-writer/🏷️renames-the-document-to-mission-brief/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-writer/🏷️renames-the-document-to-mission-brief/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-writer/🏷️renames-the-document-to-mission-brief/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-writer/🏷️renames-the-document-to-mission-brief/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️rename-writer/🏷️renames-the-document-to-mission-brief/🎯️outcome/🔣️.json");
...
fn mutation() -> WriterMutation {
    dsl::os_pack::json::from_json_str(MUTATION).expect("rename-writer mutation decodes")
}
...
async fn committed_json_is_canonical() {
    ...
    let reencoded = serde_json::from_str::<serde_json::Value>(&dsl::os_pack::json::to_json_string(&(mutation()))).expect("renameWriter payload encodes");
...
async fn produces_committed_diff() {
    ...
    let produced = serde_json::from_str::<serde_json::Value>(&dsl::os_pack::json::to_json_string(outcome.diff())).expect("produced rename-writer diff encodes");
...
async fn committed_diff_is_canonical() {
    let decoded: WriterDiff = dsl::os_pack::json::from_json_str(DIFF).expect("committed rename-writer diff decodes");
