//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🧱️block`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("Block2dMutation", descriptors::<semio_s_artifact_block_2d::standards::v1::subsets::any::schema::snapshot::Block2dSnapshot, semio_s_artifact_block_2d::standards::v1::subsets::any::schema::mutations::Block2dMutation>),
    ("Block3dWorldWindowTransientMutation", descriptors::<semio_s_artifact_block_3d::editor::block3d::modes::edit::windows::world::transient::Block3dWorldWindowTransient, semio_s_artifact_block_3d::editor::block3d::modes::edit::windows::world::transient::Block3dWorldWindowTransientMutation>),
    ("Block3dMutation", descriptors::<semio_s_artifact_block_3d::standards::v1::subsets::any::schema::snapshot::Block3dSnapshot, semio_s_artifact_block_3d::standards::v1::subsets::any::schema::mutations::Block3dMutation>),
    ("Block5dMutation", descriptors::<semio_s_artifact_block_5d::standards::v1::subsets::any::schema::snapshot::Block5dSnapshot, semio_s_artifact_block_5d::standards::v1::subsets::any::schema::mutations::Block5dMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.block.2d", "1", "any", "", "✏️s/🔌️plugins/🧱️block/🗿️artifacts/◻️2d/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.block.3d", "1", "any", "", "✏️s/🔌️plugins/🧱️block/🗿️artifacts/🧊️3d/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.block.3d", "1", "any", "✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️world/🫧️transient", "✏️s/🔌️plugins/🧱️block/🗿️artifacts/🧊️3d/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎭️modes/✏️edit/🪟️windows/🌐️world/🫧️transient", ""),
    ("s.block.5d", "1", "any", "", "✏️s/🔌️plugins/🧱️block/🗿️artifacts/🖐️5d/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-block-mutation-bridge")),
