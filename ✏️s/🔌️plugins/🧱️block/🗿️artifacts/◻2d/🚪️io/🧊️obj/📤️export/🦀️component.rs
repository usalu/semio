//! 📤️ Export Block2dSnapshot as .obj.

use semio_framework_plugin::{DocumentCodec, IoError, JsonCodec, MediaFormat};

//#region 🔖️Export
pub fn export(snapshot: &crate::artifacts::block2d::Block2dSnapshot) -> Result<Vec<u8>, IoError> {
...
pub fn register() {
    let kind = "2d.block";
    let format = MediaFormat::Obj;
    semio_framework_os::register_os_media_export_handler(kind, format, move |doc| {
        let snapshot: crate::artifacts::block2d::Block2dSnapshot =
