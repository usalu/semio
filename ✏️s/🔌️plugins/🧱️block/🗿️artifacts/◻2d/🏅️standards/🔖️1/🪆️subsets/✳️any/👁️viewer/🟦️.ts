/** 👁️ Block 2D viewer — subset-level typed twin. Read-only counterpart of `✏️editor/🟦️.ts`:
...
export const BLOCK2D_VIEWER_DIALECT = { artifactKind: "s.block.block2d", standard: "1", subset: "*" } as const;
