//! 🎹️ Block2dComposer (1/✳️any) — analyzer + builder glued. Reads native `s.block2d` sources
//! plus any of: stdio.glb, stdio.json, stdio.obj, stdio.png, stdio.stl, stdio.txt, stdio.zip. Writes one `s.block2d` (1/✳️any) snapshot.
...
use crate::artifacts::block2d::standards::v1::subsets::any::analyzer::Block2dAnalyzer;
...
pub struct Block2dComposer;

impl ArtifactComposer for Block2dComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        for source in sources {
            ...
            if source.dialect == DEP_GLB {
                ...
                if let Ok(snapshot) = crate::artifacts::block2d::io::import::deserializers::artifacts::glb::v2_0::any::deserialize_bytes(&bytes) {
        ...
        Err(ComposeError { message: "Block2dComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
