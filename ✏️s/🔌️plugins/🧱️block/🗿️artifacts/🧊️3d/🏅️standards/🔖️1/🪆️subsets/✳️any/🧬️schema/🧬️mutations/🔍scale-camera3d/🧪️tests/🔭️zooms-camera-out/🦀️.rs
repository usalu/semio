//! 🧪️ `scale-camera3d` fixture — `🔭️zooms-camera-out`: the 3D camera zoom falls to 0.5
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "scale-camera3d/zooms-camera-out: produced diff differs from the committed 🔺️diff/🔣️.json");
}
