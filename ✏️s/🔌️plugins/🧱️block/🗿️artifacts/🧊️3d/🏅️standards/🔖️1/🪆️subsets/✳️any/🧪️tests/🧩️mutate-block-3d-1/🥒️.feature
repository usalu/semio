...
Feature: Apply every typed block3d object-kind mutation twice — once in Rust, once in Python — and require the same answer
  ...
  Scenario Outline: The committed <id> vector declares its own kind and moves the document
    ...
    Examples:
      ...
      | rename-vortex-kind                    | 🖋️rename-vortex-kind/🧪️tests/renames-door-to-portal                           |
      ...
      | delete-vortex                         | 🕳️delete-vortex/🧪️tests/removes-front-vortex                                  |
      ...
      | remove-compatibility-rule             | ✂️remove-compatibility-rule/🧪️tests/revokes-door-to-door                      |
