...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷change-vortex-vortex-kind/🧪️rekinds-front-vortex-as-hatch/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷change-vortex-vortex-kind/🧪️rekinds-front-vortex-as-hatch/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷change-vortex-vortex-kind/🧪️rekinds-front-vortex-as-hatch/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷change-vortex-vortex-kind/🧪️rekinds-front-vortex-as-hatch/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧷change-vortex-vortex-kind/🧪️rekinds-front-vortex-as-hatch/🎯️outcome/🔣️.json");
