/** 🌐️ Block 3D editor — world window: typed twin of `🦀️component.rs`'s view-model. Mirrors the
 ...
 * entirely from the viewer's read-only twin (see `👁️viewer/…/🌐️world/🟦️component.ts`). */
