...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍scale-camera3d/🧪️zooms-camera-out/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍scale-camera3d/🧪️zooms-camera-out/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍scale-camera3d/🧪️zooms-camera-out/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍scale-camera3d/🧪️zooms-camera-out/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍scale-camera3d/🧪️zooms-camera-out/🎯️outcome/🔣️.json");
