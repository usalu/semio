//! 🧪️ `move-camera3d` fixture — `orbits-camera`: the 3D camera moves to (5, 5, 5) looking at (0, 1, 0)
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-camera3d/orbits-camera: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
