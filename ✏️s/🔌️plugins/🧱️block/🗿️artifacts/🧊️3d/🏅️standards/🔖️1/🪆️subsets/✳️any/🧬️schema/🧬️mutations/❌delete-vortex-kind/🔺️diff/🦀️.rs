...
use crate::diff::{Block3dDiff, Block3dVortexKindsDelta};

//#region 🔖️Diff
pub fn diff(payload: &super::DeleteVortexKind, base: &Block3dSnapshot) -> protocol::MutationOutcome<Block3dDiff> {
