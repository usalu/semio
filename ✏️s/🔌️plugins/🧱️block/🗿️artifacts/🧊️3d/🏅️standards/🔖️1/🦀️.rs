...
pub fn standard<PA: crate::ArtifactApps>() -> StandardDeclaration<PA> {
    StandardDeclaration { id: StandardId("1"), media: MediaDeclaration { mimes: &["application/vnd.semio.block3d+json"], extensions: &["block3d"] }, subsets: vec![subsets::any::subset::<PA>()] }
}
