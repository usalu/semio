//! 📤️ Export Block3dSnapshot as .stl.

use semio_framework_plugin::{DocumentCodec, IoError, JsonCodec, MediaFormat};

//#region 🔖️Export
pub fn export(snapshot: &crate::artifacts::block3d::Block3dSnapshot) -> Result<Vec<u8>, IoError> {
...
pub fn register() {
    ...
    semio_framework_os::register_os_media_export_handler(kind, format, move |doc| {
        let snapshot: crate::artifacts::block3d::Block3dSnapshot =
