//! 🔺️ Diff for `ChangeGripKindDefaultRopeKind`.
...
//#region 🔖️Diff
pub async fn diff(payload: &super::ChangeGripKindDefaultRopeKind, base: &Block5dSnapshot) -> protocol::MutationOutcome<Block5dDiff> {
