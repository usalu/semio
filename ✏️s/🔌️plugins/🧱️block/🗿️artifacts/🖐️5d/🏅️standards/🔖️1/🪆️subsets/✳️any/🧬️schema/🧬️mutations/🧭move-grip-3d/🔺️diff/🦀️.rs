...
use crate::standards::v1::subsets::any::schema::diff::{Block5dDiff, Block5dGripsDelta, Block5dGripsPatch, Block5dGripsPatchEntry};
...
pub fn diff(payload: &super::MoveGrip3d, base: &Block5dSnapshot) -> protocol::MutationOutcome<Block5dDiff> {
    ...
    let replacement = Block5dGripTemplate { position: payload.new_position, direction: payload.new_direction, ..existing.clone() };
