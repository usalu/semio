//! 🔺️ Sparse diff builder for `MoveGrip3d` — real handcrafted delta, never apply-then-capture.
...
//#region 🔖️Diff
pub fn diff(payload: &super::mutation::MoveGrip3d, base: &Block5dSnapshot) -> Block5dDiff {
