//! 🔺️ Sparse diff builder for `ChangeGripKindLabel` — real handcrafted delta, never apply-then-capture.
...
//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::ChangeGripKindLabel, base: &Block5dSnapshot) -> protocol::MutationOutcome<Block5dDiff> {
