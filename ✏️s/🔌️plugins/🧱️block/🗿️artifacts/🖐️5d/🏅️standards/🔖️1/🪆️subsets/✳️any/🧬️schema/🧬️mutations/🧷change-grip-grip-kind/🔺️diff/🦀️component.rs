//! 🔺️ Sparse diff builder for `ChangeGripGripKind` — real handcrafted delta, never apply-then-capture.
...
//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::ChangeGripGripKind, base: &Block5dSnapshot) -> protocol::MutationOutcome<Block5dDiff> {
