//! 🧪️ `change-part-kind-description` fixture — `💬️rewrites-part-kind-description`: the part kind's own `description` is rewritten
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📃️change-part-kind-description/🧪️rewrites-part-kind-description/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📃️change-part-kind-description/🧪️rewrites-part-kind-description/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📃️change-part-kind-description/🧪️rewrites-part-kind-description/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📃️change-part-kind-description/🧪️rewrites-part-kind-description/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📃️change-part-kind-description/🧪️rewrites-part-kind-description/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-part-kind-description/rewrites-part-kind-description: produced diff differs from the committed 🔺️diff/🔣️.json");
}
