...
Feature: Apply every typed block5d part-kind mutation twice — once in Rust, once in Python — and require the same answer
  ...
  Scenario Outline: The committed <id> vector declares its own kind and moves the document
    ...
    Examples:
      ...
      | update-part-2d                      | 🖌️update-part-2d/🧪️tests/circle-to-rectangle                               |
      | update-part-3d                      | 🧊update-part-3d/🧪️tests/reorients-and-rescales-part                        |
      | create-representation              | 🧱create-representation/🧪️tests/appends-frame-representation                |
      | delete-representation              | 🗑️delete-representation/🧪️tests/removes-shell-representation                |
      | rename-representation              | ✒️rename-representation/🧪️tests/renames-shell-to-hull                       |
      | change-representation-mesh-url     | 🌐change-representation-mesh-url/🧪️tests/repoints-shell-mesh-url            |
      | change-representation-lod          | 🏔️change-representation-lod/🧪️tests/promotes-shell-to-lod2                  |
      ...
      | rename-grip-kind                   | 🖋️rename-grip-kind/🧪️tests/renames-plug-to-coupler                          |
      ...
      | delete-grip                        | 🕳️delete-grip/🧪️tests/removes-north-grip                                    |
      | move-grip-2d                        | 📍move-grip-2d/🧪️tests/swings-north-grip-along-the-rim                      |
      | move-grip-3d                        | 🧭move-grip-3d/🧪️tests/repositions-north-grip-in-world                      |
      | resize-grip-3d                      | 📏resize-grip-3d/🧪️tests/widens-north-grip-radius                           |
      ...
      | remove-compatibility-rule          | ✂️remove-compatibility-rule/🧪️tests/revokes-plug-to-plug                    |
