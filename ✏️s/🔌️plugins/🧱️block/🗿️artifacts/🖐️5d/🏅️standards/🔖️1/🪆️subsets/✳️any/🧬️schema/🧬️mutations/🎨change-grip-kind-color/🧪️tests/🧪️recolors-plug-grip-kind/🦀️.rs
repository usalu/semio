//! 🧪️ `change-grip-kind-color` fixture — `⚫️recolors-plug-grip-kind`: the `gk-plug` grip kind's `color` becomes `#101010`
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-grip-kind-color/🧪️recolors-plug-grip-kind/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-grip-kind-color/🧪️recolors-plug-grip-kind/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-grip-kind-color/🧪️recolors-plug-grip-kind/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-grip-kind-color/🧪️recolors-plug-grip-kind/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-grip-kind-color/🧪️recolors-plug-grip-kind/🎯️outcome/🔣️.json");
