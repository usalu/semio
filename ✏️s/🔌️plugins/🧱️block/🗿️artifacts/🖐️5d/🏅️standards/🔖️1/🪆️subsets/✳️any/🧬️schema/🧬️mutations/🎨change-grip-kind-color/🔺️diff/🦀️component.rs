//! 🔺️ Sparse diff builder for `ChangeGripKindColor` — real handcrafted delta, never apply-then-capture.
...
//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::ChangeGripKindColor, base: &Block5dSnapshot) -> protocol::MutationOutcome<Block5dDiff> {
