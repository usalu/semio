...
async fn applies_to_committed_after() {
    ...
    apply_block5d_mutation(&mut snapshot, &mutation()).expect("change-representation-description applies to its committed before-snapshot");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "change-representation-description/rewrites-shell-description: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
