/** 👁️ Block 5D viewer — subset-level typed twin. Read-only counterpart of `✏️editor/🟦️component.ts`:
...
export const BLOCK5D_VIEWER_DIALECT = { artifactKind: "s.block.block5d", standard: "1", subset: "*" } as const;
