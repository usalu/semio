...
//#region 🔖️Diff
pub async fn diff(payload: &super::ChangeGripKindLabel, base: &Block5dSnapshot) -> protocol::MutationOutcome<Block5dDiff> {
    ...
    let replacement = Block5dGripKind { label: payload.new_label.clone(), ..existing.clone() };
