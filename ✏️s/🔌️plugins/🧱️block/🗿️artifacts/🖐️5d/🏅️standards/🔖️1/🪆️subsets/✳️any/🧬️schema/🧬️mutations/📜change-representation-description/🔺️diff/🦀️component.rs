//! 🔺️ Sparse diff builder for `ChangeRepresentationDescription` — real handcrafted delta, never apply-then-capture.
...
//#region 🔖️Diff
pub async fn diff(payload: &super::mutation::ChangeRepresentationDescription, base: &Block5dSnapshot) -> protocol::MutationOutcome<Block5dDiff> {
