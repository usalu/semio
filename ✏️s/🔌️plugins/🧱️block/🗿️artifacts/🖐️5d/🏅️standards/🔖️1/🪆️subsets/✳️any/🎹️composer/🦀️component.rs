//! 🎹️ Block5dComposer (1/✳️any) — analyzer + builder glued. Reads native `s.block5d` sources
//! plus any of: stdio.glb, stdio.json, stdio.obj, stdio.png, stdio.stl, stdio.txt, stdio.zip. Writes one `s.block5d` (1/✳️any) snapshot.
...
use crate::artifacts::block5d::standards::v1::subsets::any::analyzer::Block5dAnalyzer;
...
pub struct Block5dComposer;

impl ArtifactComposer for Block5dComposer {
    ...
    fn compose(sources: &[ComposeSource]) -> Result<Composition<Self::Snapshot>, ComposeError> {
        for source in sources {
            ...
            if source.dialect == DEP_GLB {
                ...
                if let Ok(snapshot) = crate::artifacts::block5d::io::import::deserializers::artifacts::glb::v2_0::any::deserialize_bytes(&bytes) {
        ...
        Err(ComposeError { message: "Block5dComposer: no source in a known read dialect".into(), diagnostics: Vec::new() })
    }
}
