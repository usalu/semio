...
pub fn standard<PA: crate::ArtifactApps>() -> StandardDeclaration<PA> {
    StandardDeclaration { id: StandardId("1"), media: MediaDeclaration { mimes: &["application/vnd.semio.block5d+json"], extensions: &["block5d"] }, subsets: vec![subsets::any::subset::<PA>()] }
}
