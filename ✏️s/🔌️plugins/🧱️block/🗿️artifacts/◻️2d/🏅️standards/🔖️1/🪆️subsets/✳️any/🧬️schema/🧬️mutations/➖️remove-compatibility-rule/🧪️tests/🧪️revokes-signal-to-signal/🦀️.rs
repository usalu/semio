...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-compatibility-rule/🧪️revokes-signal-to-signal/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-compatibility-rule/🧪️revokes-signal-to-signal/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-compatibility-rule/🧪️revokes-signal-to-signal/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-compatibility-rule/🧪️revokes-signal-to-signal/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖️remove-compatibility-rule/🧪️revokes-signal-to-signal/🎯️outcome/🔣️.json");
