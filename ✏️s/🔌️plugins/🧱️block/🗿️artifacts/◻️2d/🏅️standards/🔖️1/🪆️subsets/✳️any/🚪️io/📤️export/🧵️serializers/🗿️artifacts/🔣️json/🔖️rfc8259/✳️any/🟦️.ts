/** 🚪️ block2d → json — TypeScript mirror of the sibling `🦀️.rs` leaf's `json_text`.
 *
...
// #region 🎯️Entrypoint
/** 🧵️ `s.block.block2d@1/*` → `s.stdio.json@rfc8259/*` — the exact bytes the Rust `Block2dIntoJson` writes. */
export function block2dToJsonText(snapshot: Block2dSnapshot): string {
  return writeBlockJsonRecord(snapshot as unknown as Record<string, unknown>, BLOCK2D_SNAPSHOT_FIELDS);
}
