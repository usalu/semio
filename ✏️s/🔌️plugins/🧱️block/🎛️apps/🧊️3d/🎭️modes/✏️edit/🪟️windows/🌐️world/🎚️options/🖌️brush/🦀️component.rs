...
use crate::apps::block3d::config::Block3dConfig;
    ...
    WindowMeasure::Group {
        ...
        children: vec![
            ...
            WindowMeasure::Slider {
                ...
                disabled: None,
                reveal: None,
                on_change: crate::apps::block3d::block3d_action("setBrushRadius", None),
            },
            WindowMeasure::Toggle {
                ...
                text: None,
                on_change: crate::apps::block3d::block3d_action("setBrushFlip", Some(serde_json::json!({ "flip": !config.brush_flip }))),
            },
        ],
    }
}
