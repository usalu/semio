...
pub mod set_brush_vortex_kind {
    ...
    pub fn handle(payload: &SetBrushVortexKind, _doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dOperation, Block3dConfigOperation>, Fault> {
        Ok(Emit::config(vec![Block3dConfigOperation::SetBrushVortexKind { vortex_kind_id: payload.vortex_kind_id.clone() }]))
    }
}
...
pub mod set_brush_radius {
    ...
    pub fn handle(payload: &SetBrushRadius, _doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dOperation, Block3dConfigOperation>, Fault> {
        Ok(Emit::config(vec![Block3dConfigOperation::SetBrushRadius { radius: payload.radius }]))
    }
}
...
pub mod set_brush_flip {
    ...
    pub fn handle(payload: &SetBrushFlip, _doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dOperation, Block3dConfigOperation>, Fault> {
        Ok(Emit::config(vec![Block3dConfigOperation::SetBrushFlip { flip: payload.flip }]))
    }
}

pub mod hover_surface {
    use crate::apps::block3d::config::{Block3dBrushPreview, Block3dConfig, Block3dConfigOperation};
    use crate::artifacts::block3d::op::Block3dOperation;
    use crate::artifacts::block3d::Block3dDefinition;
    use semio_framework_plugin::{ConfigView, DocumentView, Emit, Fault};
    use serde::{Deserialize, Serialize};
    ...
    pub fn handle(payload: &HoverSurface, _doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dOperation, Block3dConfigOperation>, Fault> {
        Ok(Emit::config(vec![Block3dConfigOperation::SetBrushPreview { preview: Some(Block3dBrushPreview { position: payload.position, direction: payload.normal }) }]))
    }
}
...
pub mod leave_surface {
    ...
    pub fn handle(_payload: &LeaveSurface, _doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dOperation, Block3dConfigOperation>, Fault> {
        Ok(Emit::config(vec![Block3dConfigOperation::SetBrushPreview { preview: None }]))
    }
}

pub mod place_vortex {
    use crate::apps::block3d::config::{block3d_window_view, Block3dConfig, Block3dConfigOperation};
    ...
    pub fn handle(payload: &PlaceVortex, doc: &DocumentView<'_, Block3dDefinition>, cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dOperation, Block3dConfigOperation>, Fault> {
