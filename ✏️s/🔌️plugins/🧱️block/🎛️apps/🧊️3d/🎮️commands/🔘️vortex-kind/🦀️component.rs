...
pub mod add_vortex_kind {
    ...
    pub fn handle(_payload: &AddVortexKind, doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dMutation, Block3dConfigMutation>, Fault> {
        ...
        Ok(Emit::mutations(vec![Block3dMutation::SetVortexKind { index: doc.projection.vortex_kinds.len(), vortex_kind }]))
    }
}
...
pub mod remove_vortex_kind {
    ...
    pub fn handle(payload: &RemoveVortexKind, _doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dMutation, Block3dConfigMutation>, Fault> {
