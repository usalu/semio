...
pub mod add_vortex {
    ...
    pub fn handle(_payload: &AddVortex, doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dMutation, Block3dConfigMutation>, Fault> {
        ...
        Ok(Emit::mutations(vec![Block3dMutation::SetVortex { index: doc.projection.vortices.len(), vortex }]))
    }
}
...
pub mod remove_vortex {
    ...
    pub fn handle(payload: &RemoveVortex, _doc: &DocumentView<'_, Block3dDefinition>, _cfg: &ConfigView<'_, Block3dConfig>) -> Result<Emit<Block3dMutation, Block3dConfigMutation>, Fault> {
