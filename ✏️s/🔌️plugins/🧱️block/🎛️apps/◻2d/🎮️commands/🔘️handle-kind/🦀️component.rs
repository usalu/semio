...
pub mod add_handle_kind {
    ...
    pub fn handle(_payload: &AddHandleKind, doc: &DocumentView<'_, Block2dDefinition>, _cfg: &ConfigView<'_, Block2dConfig>) -> Result<Emit<Block2dMutation, Block2dConfigMutation>, Fault> {
        ...
        Ok(Emit::mutations(vec![Block2dMutation::SetHandleKind { index: doc.projection.handle_kinds.len(), handle_kind }]))
    }
}
...
pub mod remove_handle_kind {
    ...
    pub fn handle(payload: &RemoveHandleKind, _doc: &DocumentView<'_, Block2dDefinition>, _cfg: &ConfigView<'_, Block2dConfig>) -> Result<Emit<Block2dMutation, Block2dConfigMutation>, Fault> {
