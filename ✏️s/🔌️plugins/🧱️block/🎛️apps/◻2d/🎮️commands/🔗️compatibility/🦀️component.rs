...
pub mod add_compatibility_rule {
    ...
    pub fn handle(payload: &AddCompatibilityRule, doc: &DocumentView<'_, Block2dDefinition>, _cfg: &ConfigView<'_, Block2dConfig>) -> Result<Emit<Block2dMutation, Block2dConfigMutation>, Fault> {
        ...
        Ok(Emit::mutations(vec![Block2dMutation::SetCompatibilityRule { index: doc.projection.compatibility.len(), rule }]))
    }
}
...
pub mod remove_compatibility_rule {
    ...
    pub fn handle(payload: &RemoveCompatibilityRule, _doc: &DocumentView<'_, Block2dDefinition>, _cfg: &ConfigView<'_, Block2dConfig>) -> Result<Emit<Block2dMutation, Block2dConfigMutation>, Fault> {
