//! 📜️ Block 5D app — textual document grammar surface + laws (constitutional: dsl).
...
pub const BLOCK5D_CONCRETE_FOREST_LEFT_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/🧱️block/🎛️apps/🖐️5d/⚡️implementations/🦀️rust/📚️examples/🧱️hexagonal-cut-concrete-forest-left.block5d");
/// 📄️ The `nakagin-capsule` example fixture, handcrafted in the `.block5d` DSL.
pub const BLOCK5D_NAKAGIN_CAPSULE_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/🧱️block/🎛️apps/🖐️5d/⚡️implementations/🦀️rust/📚️examples/🧱️nakagin-capsule.block5d");
