//! 🗂️ 🗂️ Block 5D play app command command — `set-selection`.
...
pub fn handle(payload: &SetSelection, _doc: &ArtifactView<'_, Block5dSnapshot>, _cfg: &ConfigView<'_, Block5dConfig>) -> Result<Emit<Block5dMutation, Block5dConfigMutation>, Fault> {
