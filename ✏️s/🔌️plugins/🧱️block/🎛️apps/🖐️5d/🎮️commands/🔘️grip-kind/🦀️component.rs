...
pub mod add_grip_kind {
    ...
    pub fn handle(_payload: &AddGripKind, doc: &DocumentView<'_, Block5dSnapshot>, _cfg: &ConfigView<'_, Block5dConfig>) -> Result<Emit<Block5dMutation, Block5dConfigMutation>, Fault> {
...
pub mod remove_grip_kind {
    ...
    pub fn handle(payload: &RemoveGripKind, _doc: &DocumentView<'_, Block5dSnapshot>, _cfg: &ConfigView<'_, Block5dConfig>) -> Result<Emit<Block5dMutation, Block5dConfigMutation>, Fault> {
