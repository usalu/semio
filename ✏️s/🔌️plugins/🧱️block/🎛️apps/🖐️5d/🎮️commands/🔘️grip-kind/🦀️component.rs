...
pub mod add_grip_kind {
    ...
    pub fn handle(_payload: &AddGripKind, doc: &DocumentView<'_, Block5dDefinition>, _cfg: &ConfigView<'_, Block5dConfig>) -> Result<Emit<Block5dMutation, Block5dConfigMutation>, Fault> {
        ...
        Ok(Emit::mutations(vec![Block5dMutation::SetGripKind { index: doc.projection.grip_kinds.len(), grip_kind }]))
    }
}
...
pub mod remove_grip_kind {
    ...
    pub fn handle(payload: &RemoveGripKind, _doc: &DocumentView<'_, Block5dDefinition>, _cfg: &ConfigView<'_, Block5dConfig>) -> Result<Emit<Block5dMutation, Block5dConfigMutation>, Fault> {
