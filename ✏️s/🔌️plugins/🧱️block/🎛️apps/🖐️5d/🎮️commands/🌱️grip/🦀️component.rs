...
pub mod add_grip {
    ...
    pub fn handle(_payload: &AddGrip, doc: &DocumentView<'_, Block5dDefinition>, _cfg: &ConfigView<'_, Block5dConfig>) -> Result<Emit<Block5dOperation, Block5dConfigOperation>, Fault> {
...
pub mod remove_grip {
    ...
    pub fn handle(payload: &RemoveGrip, _doc: &DocumentView<'_, Block5dDefinition>, _cfg: &ConfigView<'_, Block5dConfig>) -> Result<Emit<Block5dOperation, Block5dConfigOperation>, Fault> {
        Ok(Emit::operations(vec![Block5dOperation::RemoveGrip { id: payload.id.clone() }]))
    }
}
