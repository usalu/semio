#!/usr/bin/env bun
/** 🖼️ `@semio-tech/remodel-images` — Image containers and classical image processing: grayscale pyramids, gradients, filtering, patch correlation and PNG codec behind an interface. */
