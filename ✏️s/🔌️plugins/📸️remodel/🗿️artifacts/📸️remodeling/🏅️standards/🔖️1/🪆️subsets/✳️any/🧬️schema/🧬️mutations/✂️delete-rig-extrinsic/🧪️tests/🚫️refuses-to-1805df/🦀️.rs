//! 🧪️ `delete-rig-extrinsic` fixture — `🚫️refuses-to-1805df`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). `delete-rig-extrinsic-missing` is this vector's scenario id in
...
//!
//! 🏞️ a calibrated camera with no rig entry is still a missing target for this verb
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-rig-extrinsic/🚫️refuses-to-1805df/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-rig-extrinsic/🚫️refuses-to-1805df/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-rig-extrinsic/🚫️refuses-to-1805df/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-rig-extrinsic/🚫️refuses-to-1805df/🎯️outcome/🔣️.json");
...
async fn refusal_leaves_the_document_untouched() {
    ...
    assert_eq!(applied, expected_after(), "delete-rig-extrinsic/refuses-to-1805df: applied state differs from committed after-snapshot");
    assert_eq!(applied, base, "delete-rig-extrinsic/refuses-to-1805df: a refused mutation must not move the document");
}
...
async fn no_diff_is_committed() {
    assert!(include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️delete-rig-extrinsic/🚫️refuses-to-1805df/🔺️diff/🚫️.absent").is_empty(), "delete-rig-extrinsic/refuses-to-1805df: the absent-diff marker must stay empty");
}
