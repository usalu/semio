//! 👁️ Remodeling viewer — the `view` mode: a single full-pane Model window, the read-only counterpart
...
pub const REMODELING_VIEW_MODE_VIEW: &str = "view";

//#region 🔖️Definition
/// 🧱️ Stitched into the viewer manifest by `crate::viewer::remodeling::create_remodeling_viewer`.
pub async fn definition() -> ModeDefinition {
    ModeDefinition { id: REMODELING_VIEW_MODE_VIEW.into(), label: LocalizedLabel::native("View", "Ansicht"), icon_id: "eye".into(), tools: Vec::new(), layout_id: None, commands: Vec::new() }
}
