...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-camera-calibration/🚫️refuses-to-73655a/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-camera-calibration/🚫️refuses-to-73655a/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-camera-calibration/🚫️refuses-to-73655a/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-camera-calibration/🚫️refuses-to-73655a/🎯️outcome/🔣️.json");
...
async fn no_diff_is_committed() {
    assert!(include_str!("../../../../../🧫️fixtures/🧬️mutations/🚫delete-camera-calibration/🚫️refuses-to-73655a/🔺️diff/🚫️.absent").is_empty(), "delete-camera-calibration/refuses-to-73655a: the absent-diff marker must stay empty");
}
