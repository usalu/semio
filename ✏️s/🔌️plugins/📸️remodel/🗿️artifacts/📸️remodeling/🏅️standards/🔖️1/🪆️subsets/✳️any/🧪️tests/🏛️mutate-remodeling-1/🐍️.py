...
VECTORS = {
    "create-stream": ("🌱create-stream", "adds-stream-c-bound-to-cam-b", "createStream"),
    "delete-stream": ("🪓delete-stream", "removes-stream-b-and-cascades-its-gcp-observation", "deleteStream"),
    "change-stream-sync": ("⏱️change-stream-sync", "shifts-stream-a-sync-offset-to-minus-seven-and-a-half", "changeStreamSync"),
    "add-stream-frame": ("➕add-stream-frame", "appends-a-third-frame-to-stream-a", "addStreamFrame"),
    "remove-stream-frame": ("➖remove-stream-frame", "removes-the-last-frame-of-stream-a", "removeStreamFrame"),
    "replace-stream-source": ("🔁replace-stream-source", "clears-the-video-source-of-stream-a", "replaceStreamSource"),
    "create-asset": ("🧷create-asset", "stores-a-new-jpeg-frame-asset", "createAsset"),
    "delete-asset": ("🗞️delete-asset", "removes-asset-a-and-reports-its-stale-references", "deleteAsset"),
    "create-camera-calibration": ("🔭create-camera-calibration", "adds-the-cam-c-fisheye-calibration", "createCameraCalibration"),
    "update-camera-calibration": ("🛠️update-camera-calibration", "refines-the-cam-a-focal-length-and-rms", "updateCameraCalibration"),
    "delete-camera-calibration": ("🚫delete-camera-calibration", "removes-the-cam-b-calibration", "deleteCameraCalibration"),
    "create-rig-extrinsic": ("⛓️create-rig-extrinsic", "adds-a-rig-extrinsic-for-cam-b", "createRigExtrinsic"),
    "delete-rig-extrinsic": ("✂️delete-rig-extrinsic", "drops-the-cam-a-rig-extrinsic", "deleteRigExtrinsic"),
    "update-rig-extrinsic": ("🔩update-rig-extrinsic", "retunes-the-cam-a-rig-translation", "updateRigExtrinsic"),
    "create-gcp": ("🧿create-gcp", "adds-gcp-tower-with-one-observation", "createGcp"),
    "delete-gcp": ("🚮delete-gcp", "removes-gcp-corner-and-cascades-its-observation", "deleteGcp"),
    "add-gcp-observation": ("🔎add-gcp-observation", "adds-the-first-observation-to-gcp-ridge", "addGcpObservation"),
    "remove-gcp-observation": ("🚷remove-gcp-observation", "removes-the-only-observation-of-gcp-corner", "removeGcpObservation"),
    "update-ingest-params": ("🥣update-ingest-params", "tightens-the-ingest-sharpness-gate", "updateIngestParams"),
    "update-feature-params": ("🌠update-feature-params", "switches-the-detector-to-akaze", "updateFeatureParams"),
    "update-match-params": ("🪢update-match-params", "switches-the-matcher-to-a-kd-tree", "updateMatchParams"),
    "update-sfm-params": ("🧮update-sfm-params", "switches-the-robust-loss-to-cauchy", "updateSfmParams"),
    "update-dense-params": ("🌁update-dense-params", "raises-the-dense-resolution-and-confidence-gate", "updateDenseParams"),
    "update-mesh-params": ("🕸️update-mesh-params", "doubles-the-texture-size-and-drops-the-watertight-guarantee", "updateMeshParams"),
    "update-motion-params": ("🏎️update-motion-params", "enables-motion-tracking", "updateMotionParams"),
    "update-geo-params": ("🌐update-geo-params", "enables-georeferencing-with-an-origin", "updateGeoParams"),
    "replace-job": ("🏗️replace-job", "advances-the-job-to-texturing", "replaceJob"),
    "replace-sparse": ("⭐replace-sparse", "swaps-in-an-uncolored-four-point-sparse-cloud", "replaceSparse"),
    "replace-dense": ("☁️replace-dense", "swaps-in-a-two-point-classified-dense-cloud", "replaceDense"),
    "replace-mesh-result": ("🧱replace-mesh-result", "swaps-in-an-imported-untextured-mesh", "replaceMeshResult"),
    "replace-trajectory": ("🛣️replace-trajectory", "clears-the-camera-trajectory", "replaceTrajectory"),
    "replace-tracks": ("🚂replace-tracks", "replaces-the-moving-track-with-two-static-tracks", "replaceTracks"),
    "replace-geo-products": ("🗾replace-geo-products", "adds-the-dtm-and-ortho-rasters", "replaceGeoProducts"),
    "replace-qc": ("🧾replace-qc", "records-a-qc-report-carrying-a-watertight-summary", "replaceQc"),
}
