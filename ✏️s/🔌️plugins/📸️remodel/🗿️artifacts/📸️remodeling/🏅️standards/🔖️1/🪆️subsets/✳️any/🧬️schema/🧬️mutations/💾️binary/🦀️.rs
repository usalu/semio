...
mod tests {
    ...
    async fn store_roundtrips_through_document_text() {
        ...
        store.dispatch(store::ArtifactCommand::Apply { mutations: vec![crate::artifacts::remodeling::mutations::update_feature_params(feature_params)], description: None }).expect("apply");
