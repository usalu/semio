...
use crate::artifacts::remodeling::schema::mutations::text::RemodelingMutation;
...
mod tests {
    ...
    async fn op_binary_round_trips_and_agrees_with_text() {
        ...
        let operation = crate::artifacts::remodeling::mutations::update_feature_params(scene.params.feature);
    ...
    async fn store_roundtrips_through_document_text() {
        ...
        store.dispatch(store::ArtifactCommand::Apply { mutations: vec![crate::artifacts::remodeling::mutations::update_feature_params(feature_params)], description: None }).await.expect("apply");
