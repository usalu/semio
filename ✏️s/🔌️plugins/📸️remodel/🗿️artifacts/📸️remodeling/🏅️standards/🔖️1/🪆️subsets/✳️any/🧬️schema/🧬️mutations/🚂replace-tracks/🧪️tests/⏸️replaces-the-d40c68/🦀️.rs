...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚂replace-tracks/⏸️replaces-the-d40c68/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚂replace-tracks/⏸️replaces-the-d40c68/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚂replace-tracks/⏸️replaces-the-d40c68/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚂replace-tracks/⏸️replaces-the-d40c68/🎯️outcome/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🚂replace-tracks/⏸️replaces-the-d40c68/🔺️diff/🔣️.json");
