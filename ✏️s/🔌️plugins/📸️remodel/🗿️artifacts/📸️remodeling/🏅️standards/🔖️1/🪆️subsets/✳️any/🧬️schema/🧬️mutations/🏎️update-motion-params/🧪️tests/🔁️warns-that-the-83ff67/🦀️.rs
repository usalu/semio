//! 🧪️ `update-motion-params` fixture — `🔁️warns-that-the-83ff67`.
//!
//! Source of truth is the committed JSON quintet beside this file (contract D1, ticket
//! `26/08/20/COMPOSE-TO-PUZZLE5D-MIGRATION`). `update-motion-params-noop` is this vector's scenario id in
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏎️update-motion-params/🔁️warns-that-the-83ff67/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏎️update-motion-params/🔁️warns-that-the-83ff67/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏎️update-motion-params/🔁️warns-that-the-83ff67/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏎️update-motion-params/🔁️warns-that-the-83ff67/🎯️outcome/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏎️update-motion-params/🔁️warns-that-the-83ff67/🔺️diff/🔣️.json");
...
async fn no_op_leaves_the_document_untouched() {
    ...
    assert_eq!(applied, expected_after(), "update-motion-params/warns-that-the-83ff67: applied state differs from committed after-snapshot");
    assert_eq!(applied, base, "update-motion-params/warns-that-the-83ff67: a no-op must not move the document");
}
...
async fn declared_warning_holds() {
    ...
    assert_eq!(declared.get("status").and_then(|status| status.as_str()), Some("applied"), "update-motion-params/warns-that-the-83ff67 declares an applied outcome");
