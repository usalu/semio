...
//! through the 512/512 production resolver. Unavailable content infers a clean zero `RemodelingBounds`,
...
pub struct RemodelingBoundingBox {
    pub min: [f64; 3],
    pub max: [f64; 3],
}
...
#[value(rename_all = "camelCase")]
#[serde(rename_all = "camelCase")]
pub struct RemodelingBounds {
    pub bounding_box: RemodelingBoundingBox,
