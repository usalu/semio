...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱replace-mesh-result/🔁️warns-that-the-b39bab/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱replace-mesh-result/🔁️warns-that-the-b39bab/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱replace-mesh-result/🔁️warns-that-the-b39bab/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱replace-mesh-result/🔁️warns-that-the-b39bab/🎯️outcome/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱replace-mesh-result/🔁️warns-that-the-b39bab/🔺️diff/🔣️.json");
...
async fn declared_warning_holds() {
    ...
    assert_eq!(declared.get("status").and_then(|status| status.as_str()), Some("no-op"), "replace-mesh-result/warns-that-the-b39bab declares a no-op outcome");
