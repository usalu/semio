...
async fn produces_committed_diff() {
    ...
    assert_eq!(encoded, committed, "delete-stream/removes-stream-b-and-cascades-its-gcp-observation: produced diff differs from the committed 🔺️diff/🔣️component.json");
