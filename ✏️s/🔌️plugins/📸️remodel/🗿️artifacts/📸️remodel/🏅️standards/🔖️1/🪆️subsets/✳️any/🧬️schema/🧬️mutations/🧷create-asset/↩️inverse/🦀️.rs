...
//#region 🔖️Inverse
pub fn inverse(payload: &super::CreateAsset, base: &RemodelSnapshot) -> Vec<RemodelMutation> {
    match base.assets.get(&payload.key) {
        ...
        None => vec![crate::artifacts::remodel::mutations::delete_asset::delete_asset(payload.key.clone())],
    }
}
//#endregion 🔖️Inverse
