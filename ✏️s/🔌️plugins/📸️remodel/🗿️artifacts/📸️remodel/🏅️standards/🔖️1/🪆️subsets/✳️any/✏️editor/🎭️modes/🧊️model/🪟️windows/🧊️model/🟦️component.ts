/** 🧊️ Remodel editor — Model window: typed twin of `🦀️component.rs`'s view-model. Mirrors the
 ...
 * shapes). The viewer's read-only twin (`👁️viewer/…/🧊️model/🟦️component.ts`) mirrors this same
