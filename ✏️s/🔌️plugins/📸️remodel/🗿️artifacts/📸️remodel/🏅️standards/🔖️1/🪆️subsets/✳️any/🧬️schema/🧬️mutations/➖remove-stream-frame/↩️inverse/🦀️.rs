...
//#region 🔖️Inverse
pub fn inverse(payload: &super::RemoveStreamFrame, base: &RemodelSnapshot) -> Vec<RemodelMutation> {
    ...
    vec![crate::artifacts::remodel::mutations::add_stream_frame::add_stream_frame(payload.id.clone(), frame.clone(), stream.kind)]
}
//#endregion 🔖️Inverse
