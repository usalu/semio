...
//#region 🔖️Diff
pub fn diff(payload: &super::UpdateGeoParams, base: &RemodelSnapshot) -> protocol::MutationOutcome<RemodelDiff> {
    ...
    protocol::MutationOutcome::new(RemodelDiff { params: Some(params_state), ..Default::default() })
}
//#endregion 🔖️Diff
