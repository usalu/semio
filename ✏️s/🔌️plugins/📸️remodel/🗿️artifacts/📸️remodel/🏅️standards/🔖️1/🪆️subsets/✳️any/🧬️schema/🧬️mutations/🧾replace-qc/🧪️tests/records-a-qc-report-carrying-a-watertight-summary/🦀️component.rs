...
async fn produces_committed_diff() {
    ...
    assert_eq!(encoded, committed, "replace-qc/records-a-qc-report-carrying-a-watertight-summary: produced diff differs from the committed 🔺️diff/🔣️component.json");
