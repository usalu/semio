...
async fn produces_committed_diff() {
    ...
    assert_eq!(encoded, committed, "update-mesh-params/doubles-the-texture-size-and-drops-the-watertight-guarantee: produced diff differs from the committed 🔺️diff/🔣️component.json");
