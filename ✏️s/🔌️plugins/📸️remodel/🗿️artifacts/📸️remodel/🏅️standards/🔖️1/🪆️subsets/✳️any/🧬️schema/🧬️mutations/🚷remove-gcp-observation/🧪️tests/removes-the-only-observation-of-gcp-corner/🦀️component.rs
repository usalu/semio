...
async fn produces_committed_diff() {
    ...
    assert_eq!(encoded, committed, "remove-gcp-observation/removes-the-only-observation-of-gcp-corner: produced diff differs from the committed 🔺️diff/🔣️component.json");
