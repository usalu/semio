...
//#region 🔖️Inverse
pub fn inverse(payload: &super::RemoveGcpObservation, base: &RemodelSnapshot) -> Vec<RemodelMutation> {
    ...
    vec![crate::artifacts::remodel::mutations::add_gcp_observation::add_gcp_observation(payload.id.clone(), observation.clone())]
}
//#endregion 🔖️Inverse
