...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_remodel_remodeling::standards::v1::subsets::any::schema::snapshot::RemodelingSnapshot, semio_s_artifact_remodel_remodeling::standards::v1::subsets::any::schema::mutations::RemodelingMutation>,
];
