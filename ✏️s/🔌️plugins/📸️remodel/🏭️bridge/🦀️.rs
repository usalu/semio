//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/📸️remodel`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("RemodelingMutation", descriptors::<semio_s_artifact_remodel_remodeling::standards::v1::subsets::any::schema::snapshot::RemodelingSnapshot, semio_s_artifact_remodel_remodeling::standards::v1::subsets::any::schema::mutations::RemodelingMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.remodel.remodeling", "1", "any", "", "✏️s/🔌️plugins/📸️remodel/🗿️artifacts/📸️remodeling/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-remodel-mutation-bridge")),
