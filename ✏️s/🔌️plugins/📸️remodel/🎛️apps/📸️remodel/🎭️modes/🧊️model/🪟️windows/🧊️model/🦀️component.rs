...
//#region 🔖️Constants
pub const REMODEL_PLAY_WINDOW_MAIN: &str = "remodel-main";
pub const REMODEL_PLAY_BODY_MAIN: &str = "remodel.play.main";
...
pub fn render(scene: &RemodelSnapshot, config: &RemodelConfig) -> UiNode {
    ...
    build_world_3d_scene(REMODEL_PLAY_SURFACE_MAIN, crate::apps::remodel::REMODEL_PLAY_APP_ID, world_scene)
}
//#endregion 🔖️Scene
