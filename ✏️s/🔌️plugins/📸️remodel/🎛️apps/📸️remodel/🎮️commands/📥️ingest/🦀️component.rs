...
fn batch_stream_id(scene: &RemodelScene, index: u32) -> String {
    if index == 0 {
...
pub mod import_frame_payload {
    ...
    /// video-bytes decoder.
    pub fn handle(payload: &ImportFramePayload, doc: &DocumentView<'_, RemodelScene>, cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelOperation, RemodelConfigOperation>, Fault> {
...
pub mod import_video_frame_payload {
    ...
    pub fn handle(payload: &ImportVideoFramePayload, doc: &DocumentView<'_, RemodelScene>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelOperation, RemodelConfigOperation>, Fault> {
...
pub mod import_video_done {
    ...
    pub fn handle(payload: &ImportVideoDone, doc: &DocumentView<'_, RemodelScene>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelOperation, RemodelConfigOperation>, Fault> {
        let scene = doc.projection;
...
pub mod import_video_bytes_payload {
    ...
    pub fn handle(payload: &ImportVideoBytesPayload, doc: &DocumentView<'_, RemodelScene>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelOperation, RemodelConfigOperation>, Fault> {
        let Some((_mime, bytes)) = payload_from_data_url(&payload.payload) else { return Ok(Emit::default()) };
...
pub mod add_stream {
    ...
    pub fn handle(payload: &AddStream, doc: &DocumentView<'_, RemodelScene>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelOperation, RemodelConfigOperation>, Fault> {
        let scene = doc.projection;
...
pub mod remove_stream {
    ...
    pub fn handle(payload: &RemoveStream, doc: &DocumentView<'_, RemodelScene>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelOperation, RemodelConfigOperation>, Fault> {
...
pub mod set_stream_sync {
    ...
    pub fn handle(payload: &SetStreamSync, doc: &DocumentView<'_, RemodelScene>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelOperation, RemodelConfigOperation>, Fault> {
