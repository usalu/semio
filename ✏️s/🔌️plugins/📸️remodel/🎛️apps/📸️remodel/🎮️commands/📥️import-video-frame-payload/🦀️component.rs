...
mod tests {
    ...
    fn import_video_bytes_payload_extracts_frames_in_process() {
        ...
        dispatch(&mut app, RemodelCommand::SetIngestParams(crate::apps::remodel::commands::set_ingest_params::SetIngestParams { frame_sample_stride: 1, max_frames: 200, downscale_long_edge_px: 1600, min_sharpness: 0.3 }));
