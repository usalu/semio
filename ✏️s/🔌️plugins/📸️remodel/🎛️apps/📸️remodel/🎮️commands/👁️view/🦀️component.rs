...
pub mod set_selection {
    ...
    pub fn handle(payload: &SetSelection, _doc: &DocumentView<'_, RemodelProjection>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelMutation, RemodelConfigMutation>, Fault> {
...
pub mod set_camera {
    ...
    pub fn handle(payload: &SetCamera, _doc: &DocumentView<'_, RemodelProjection>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelMutation, RemodelConfigMutation>, Fault> {
...
pub mod set_layer_visibility {
    ...
    pub fn handle(payload: &SetLayerVisibility, _doc: &DocumentView<'_, RemodelProjection>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelMutation, RemodelConfigMutation>, Fault> {
...
pub mod set_frame_cursor {
    ...
    pub fn handle(payload: &SetFrameCursor, _doc: &DocumentView<'_, RemodelProjection>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelMutation, RemodelConfigMutation>, Fault> {
...
pub mod set_report_table {
    ...
    pub fn handle(payload: &SetReportTable, _doc: &DocumentView<'_, RemodelProjection>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelMutation, RemodelConfigMutation>, Fault> {
...
pub mod set_active_utility {
    ...
    pub fn handle(payload: &SetActiveUtility, _doc: &DocumentView<'_, RemodelProjection>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelMutation, RemodelConfigMutation>, Fault> {
...
pub mod set_locale {
    ...
    pub fn handle(payload: &SetLocale, _doc: &DocumentView<'_, RemodelProjection>, _cfg: &ConfigView<'_, RemodelConfig>) -> Result<Emit<RemodelMutation, RemodelConfigMutation>, Fault> {
