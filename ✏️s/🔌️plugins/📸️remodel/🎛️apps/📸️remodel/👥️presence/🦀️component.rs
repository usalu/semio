...
impl protocol::MutationDiff<RemodelPresence> for RemodelPresence {
    fn apply(&self, _base: &RemodelPresence) -> RemodelPresence {
        self.clone()
    }
...
impl store::DocumentDsl for RemodelPresence {
...
impl DocumentPack for RemodelPresence {
...
impl Mutation<RemodelPresence> for RemodelPresenceMutation {
    ...
    fn diff(&self, _base: &RemodelPresence) -> RemodelPresence {
        match self {
