// #region 🧲️Header
// 💻️ ✏️s/🔌️plugins/📸️remodel/📖️stories/🎭️panels/🧪️.story.tsx
...
import { InterpretedUiNode, UiDocumentStore, builtNodeToSnapshot } from "../../../../../🧰️framework/🛍️products/💻️os/🔨️modules/📺️renderer/🧑‍🎨engine/🎯️targets/⚛️react/📦️packages/🟦️typescript/🟦️.tsx";
...
import { REMODEL_DEFAULT_CONFIG, REMODEL_EMPTY_SCENE, REMODEL_POPULATED_SCENE, remodelLabelsFor, type RemodelScene } from "../🧭️coordination/🧫️fixtures/🧫️model/🟦️.ts";
import { REMODEL_EDITOR_CONTROLLER_ID, REMODEL_PANELS, reduceRemodelStoryAction, remodelPanelDocument, type RemodelPanelId } from "../🧭️coordination/🧫️fixtures/🧫️scene/🟦️.ts";
