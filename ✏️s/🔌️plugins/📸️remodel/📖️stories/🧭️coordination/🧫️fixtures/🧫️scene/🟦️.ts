// #region 🧲️Header
// 💻️ ✏️s/🔌️plugins/📸️remodel/📖️stories/🧭️coordination/🧫️fixtures/🧫️scene/🟦️.ts
...
import type { ActionDescriptor, Canvas2dScene, TableScene, UiComponentSceneNode, World3dScene } from "../../../../../../../🧰️framework/🛍️products/💻️os/🔨️modules/📺️renderer/🧑‍🎨engine/🎯️targets/⚛️react/📦️packages/🟦️typescript/🟦️.tsx";
import type { AccessibilitySpec, BuiltNode, LayoutSpec, StyleSpec } from "../../../../../../../🧰️framework/🔨️modules/🛂️manifest/🤖️generated/📜️ui-contract";

import { remodelLabelsFor, type RemodelConfig, type RemodelLabels, type RemodelScene } from "../🧫️model/🟦️.ts";
