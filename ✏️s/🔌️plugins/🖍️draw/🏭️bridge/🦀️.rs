...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_draw_drawing::standards::v1::subsets::any::schema::snapshot::DrawingSnapshot, semio_s_artifact_draw_drawing::standards::v1::subsets::any::schema::mutations::DrawingMutation>,
];
