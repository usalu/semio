//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🖍️draw`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("DrawingMutation", descriptors::<semio_s_artifact_draw_drawing::standards::v1::subsets::any::schema::snapshot::DrawingSnapshot, semio_s_artifact_draw_drawing::standards::v1::subsets::any::schema::mutations::DrawingMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.draw.drawing", "1", "metadata", "", "✏️s/🔌️plugins/🖍️draw/🗿️artifacts/🖍️drawing/🏅️standards/🔖️1/🪆️subsets/🏷️metadata", ""),
    ("s.draw.drawing", "1", "structure", "", "✏️s/🔌️plugins/🖍️draw/🗿️artifacts/🖍️drawing/🏅️standards/🔖️1/🪆️subsets/🧱️structure", ""),
    ("s.draw.drawing", "1", "style", "", "✏️s/🔌️plugins/🖍️draw/🗿️artifacts/🖍️drawing/🏅️standards/🔖️1/🪆️subsets/🎨️style", ""),
    ("s.draw.drawing", "1", "transform", "", "✏️s/🔌️plugins/🖍️draw/🗿️artifacts/🖍️drawing/🏅️standards/🔖️1/🪆️subsets/🔀️transform", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-draw-mutation-bridge")),
