//! 📜️ Draw app — textual document grammar surface + laws (constitutional: dsl).

use draw::DrawDocument;

/// 🗄️ The Semio emblem example fixture, handcrafted in `draw`'s DSL (`store::DocumentDsl`).
pub const SEMIO_DRAW_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/🖍️draw/📚️examples/🖍️semio.draw");
