...
mod tests {
    ...
    /// `command_envelope_round_trip_holds_for_an_applied_operation`), reusing the store-building flow
    /// from `document_text_round_trips_a_store_with_an_applied_operation` above.
    #[test]
