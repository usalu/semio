//! 🔺️ Diff fragment yielded by `SetLayerOpacity`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `SetLayerOpacity` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct SetLayerOpacityDiff {
    pub mutation: Option<DrawMutation>,
}

impl SetLayerOpacityDiff {
    pub fn from_mutation(mutation: DrawMutation) -> Self {
        Self { mutation: Some(mutation) }
    }
}

impl MutationDiff<DrawDocument> for SetLayerOpacityDiff {
