//! 🔺️ Diff fragment yielded by `AddLayer`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `AddLayer` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct AddLayerDiff {
...
impl MutationDiff<DrawDocument> for AddLayerDiff {
