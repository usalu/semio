//! 🧪️ `update-layer-trace-params` fixture — `🔍️sharpens-the-trace`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍️update-layer-trace-params/🔍️sharpens-the-trace/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍️update-layer-trace-params/🔍️sharpens-the-trace/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍️update-layer-trace-params/🔍️sharpens-the-trace/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍️update-layer-trace-params/🔍️sharpens-the-trace/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔍️update-layer-trace-params/🔍️sharpens-the-trace/🎯️outcome/🔣️.json");
...
async fn applies_to_committed_after() {
    ...
    apply_drawing_mutation(&mut snapshot, &mutation()).expect("update-layer-trace-params applies to its committed before-snapshot");
...
async fn both_trace_params_move_together_without_retargeting_the_source() {
    ...
    apply_drawing_mutation(&mut snapshot, &mutation()).expect("update-layer-trace-params applies");
    let DrawingLayerNode::Trace(before_trace) = find_drawing_layer(&base, "trace-a").expect("before carries trace-a") else {
        panic!("sharpens-the-trace's before-snapshot must carry a trace layer");
    };
    let DrawingLayerNode::Trace(after_trace) = find_drawing_layer(&snapshot, "trace-a").expect("trace-a survives the params update") else {
