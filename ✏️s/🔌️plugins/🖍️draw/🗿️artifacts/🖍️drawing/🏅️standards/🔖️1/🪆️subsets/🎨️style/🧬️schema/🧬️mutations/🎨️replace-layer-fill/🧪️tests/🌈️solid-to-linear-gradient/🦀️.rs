...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️replace-layer-fill/🌈️solid-to-linear-gradient/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️replace-layer-fill/🌈️solid-to-linear-gradient/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️replace-layer-fill/🌈️solid-to-linear-gradient/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️replace-layer-fill/🌈️solid-to-linear-gradient/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨️replace-layer-fill/🌈️solid-to-linear-gradient/🎯️outcome/🔣️.json");
