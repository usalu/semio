...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀set-layer-boolean-operation/➖️union-to-subtract/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀set-layer-boolean-operation/➖️union-to-subtract/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀set-layer-boolean-operation/➖️union-to-subtract/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀set-layer-boolean-operation/➖️union-to-subtract/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀set-layer-boolean-operation/➖️union-to-subtract/🎯️outcome/🔣️.json");
