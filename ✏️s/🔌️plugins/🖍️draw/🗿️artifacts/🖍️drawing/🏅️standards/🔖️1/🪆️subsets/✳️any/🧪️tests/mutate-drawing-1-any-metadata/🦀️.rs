...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        "rename-layer" => (
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/✏️rename-layer/🧪️tests/renames-shape-a-without-touching-its-id/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/✏️rename-layer/🧪️tests/renames-shape-a-without-touching-its-id/🦠️mutation/🔣️.json"),
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/✏️rename-layer/🧪️tests/renames-shape-a-without-touching-its-id/📸️snapshot/➡️after/🔣️.json"),
        ),
        "set-layer-locked" => (
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/🔒️set-layer-locked/🧪️tests/locks-shape-a/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/🔒️set-layer-locked/🧪️tests/locks-shape-a/🦠️mutation/🔣️.json"),
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/🔒️set-layer-locked/🧪️tests/locks-shape-a/📸️snapshot/➡️after/🔣️.json"),
        ),
        "set-layer-visible" => (
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/👁️set-layer-visible/🧪️tests/hides-shape-a/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/👁️set-layer-visible/🧪️tests/hides-shape-a/🦠️mutation/🔣️.json"),
            include_str!("../../../✳️metadata/🧬️schema/🧬️mutations/👁️set-layer-visible/🧪️tests/hides-shape-a/📸️snapshot/➡️after/🔣️.json"),
        ),
