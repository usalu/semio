...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        "create-layer" => (
            include_str!("../../../🧱️structure/🧬️schema/🧬️mutations/🌱create-layer/🧪️tests/🍋️appends-shape-b-at-the-root/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../🧱️structure/🧬️schema/🧬️mutations/🌱create-layer/🧪️tests/🍋️appends-shape-b-at-the-root/🦠️mutation/🔣️.json"),
            include_str!("../../../🧱️structure/🧬️schema/🧬️mutations/🌱create-layer/🧪️tests/🍋️appends-shape-b-at-the-root/📸️snapshot/➡️after/🔣️.json"),
        ),
        "delete-layer" => (
