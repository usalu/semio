...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️replace-layer-stroke/🖊️adds-a-dashed-stroke/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️replace-layer-stroke/🖊️adds-a-dashed-stroke/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️replace-layer-stroke/🖊️adds-a-dashed-stroke/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️replace-layer-stroke/🖊️adds-a-dashed-stroke/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️replace-layer-stroke/🖊️adds-a-dashed-stroke/🎯️outcome/🔣️.json");
