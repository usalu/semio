...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        "create-layer" => (
            include_str!("../../🧬️schema/🧬️mutations/➕️create-layer/🧪️tests/➕️appends-shape-b-0b0435/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/➕️create-layer/🧪️tests/➕️appends-shape-b-0b0435/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/➕️create-layer/🧪️tests/➕️appends-shape-b-0b0435/📸️snapshot/➡️after/🔣️.json"),
        ),
        "delete-layer" => (
            include_str!("../../🧬️schema/🧬️mutations/🗑️delete-layer/🧪️tests/🚫️removes-group-a-41e1e0/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🗑️delete-layer/🧪️tests/🚫️removes-group-a-41e1e0/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🗑️delete-layer/🧪️tests/🚫️removes-group-a-41e1e0/📸️snapshot/➡️after/🔣️.json"),
        ),
        "duplicate-layer" => (
            include_str!("../../🧬️schema/🧬️mutations/📋️duplicate-layer/🧪️tests/🚫️rejects-a-c88127/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/📋️duplicate-layer/🧪️tests/🚫️rejects-a-c88127/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/📋️duplicate-layer/🧪️tests/🚫️rejects-a-c88127/📸️snapshot/➡️after/🔣️.json"),
        ),
        "reorder-layer" => (
            include_str!("../../🧬️schema/🧬️mutations/🔃reorder-layer/🧪️tests/⬆️moves-shape-a-d7c515/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔃reorder-layer/🧪️tests/⬆️moves-shape-a-d7c515/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔃reorder-layer/🧪️tests/⬆️moves-shape-a-d7c515/📸️snapshot/➡️after/🔣️.json"),
        ),
