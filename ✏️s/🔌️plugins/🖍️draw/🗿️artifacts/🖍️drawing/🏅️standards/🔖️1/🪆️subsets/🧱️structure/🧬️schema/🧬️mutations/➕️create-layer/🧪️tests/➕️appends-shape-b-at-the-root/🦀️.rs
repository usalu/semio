//! 🧪️ `create-layer` fixture — `➕️appends-shape-b-at-the-root`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-layer/➕️appends-shape-b-at-the-root/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-layer/➕️appends-shape-b-at-the-root/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-layer/➕️appends-shape-b-at-the-root/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-layer/➕️appends-shape-b-at-the-root/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕️create-layer/➕️appends-shape-b-at-the-root/🎯️outcome/🔣️.json");
