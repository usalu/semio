...
use crate::artifacts::drawing::diff::{diff_set_layer_opacity, DrawingDiff};
use crate::artifacts::drawing::schema::{find_drawing_layer, layer_base};
use crate::artifacts::drawing::DrawingSnapshot;

//#region 🔖️Diff
pub fn diff(payload: &super::mutation::SetLayerOpacity, base: &DrawingSnapshot) -> protocol::MutationOutcome<DrawingDiff> {
