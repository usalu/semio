...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        "set-layer-boolean-operation" => (
            include_str!("../../🧬️schema/🧬️mutations/🔀set-layer-boolean-operation/🧪️tests/➖️union-to-subtract-845e1f/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔀set-layer-boolean-operation/🧪️tests/➖️union-to-subtract-845e1f/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔀set-layer-boolean-operation/🧪️tests/➖️union-to-subtract-845e1f/📸️snapshot/➡️after/🔣️.json"),
        ),
        "update-layer-trace-params" => (
            include_str!("../../🧬️schema/🧬️mutations/🔍️update-layer-trace-params/🧪️tests/🔍️sharpens-the-117131/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔍️update-layer-trace-params/🧪️tests/🔍️sharpens-the-117131/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔍️update-layer-trace-params/🧪️tests/🔍️sharpens-the-117131/📸️snapshot/➡️after/🔣️.json"),
        ),
        "update-layer-transform" => (
            include_str!("../../🧬️schema/🧬️mutations/🔄️update-layer-transform/🧪️tests/📐️translates-and-f4316d/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔄️update-layer-transform/🧪️tests/📐️translates-and-f4316d/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔄️update-layer-transform/🧪️tests/📐️translates-and-f4316d/📸️snapshot/➡️after/🔣️.json"),
        ),
