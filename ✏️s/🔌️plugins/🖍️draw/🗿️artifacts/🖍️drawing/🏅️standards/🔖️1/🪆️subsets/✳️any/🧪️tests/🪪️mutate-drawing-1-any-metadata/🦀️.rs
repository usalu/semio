...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        ...
        "set-layer-locked" => (
            include_str!("../../../🏷️metadata/🧫️fixtures/🧬️mutations/🔒️set-layer-locked/🔒️locks-shape-a/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../🏷️metadata/🧫️fixtures/🧬️mutations/🔒️set-layer-locked/🔒️locks-shape-a/🦠️mutation/🔣️.json"),
            include_str!("../../../🏷️metadata/🧫️fixtures/🧬️mutations/🔒️set-layer-locked/🔒️locks-shape-a/📸️snapshot/➡️after/🔣️.json"),
        ),
        "set-layer-visible" => (
            include_str!("../../../🏷️metadata/🧫️fixtures/🧬️mutations/👁️set-layer-visible/🙈️hides-shape-a/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../🏷️metadata/🧫️fixtures/🧬️mutations/👁️set-layer-visible/🙈️hides-shape-a/🦠️mutation/🔣️.json"),
            include_str!("../../../🏷️metadata/🧫️fixtures/🧬️mutations/👁️set-layer-visible/🙈️hides-shape-a/📸️snapshot/➡️after/🔣️.json"),
        ),
