...
use semio_s_plugin_stdio::artifacts::json::standards::v_rfc8259::subsets::base::schema::snapshot::parse_json_text;
...
impl Deserializer<DrawingSnapshot> for JsonIntoDraw {
    ...
    fn deserialize(payload: &IoPayload) -> IoResult<DrawingSnapshot> {
