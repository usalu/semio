...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        ...
        "update-layer-trace-params" => (
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔧update-layer-trace-params/🧪️tests/🟢️sharpens-the-trace/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔧update-layer-trace-params/🧪️tests/🟢️sharpens-the-trace/🦠️mutation/🔣️.json"),
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔧update-layer-trace-params/🧪️tests/🟢️sharpens-the-trace/📸️snapshot/➡️after/🔣️.json"),
        ),
