//! 🖍️ Drawing-document transform mutation case — Rust adapter. Relocated out of the artifact-level
//! Duplicated verbatim (only relative paths adjusted) from `../../../🔀️transform/🧪️tests/🔀️mutate-drawing-1-transform/🦀️.rs` by shard F4 (this ticket) to close `unregistered-mutation-vocabulary` at the `✳️any/🧬️schema/🧬️mutations` + `✳️any/🚪️io/🧬️mutations` owner — same mechanism E3 already proved on `sequence`: reuse the already-manifested capability, no new v2 manifest entry.
...
//#region 🔖️Kinds
/// 🏷️ This subset's own slice of `KINDS` in `../../../🔀️transform/🧬️schema/🧬️mutations/🦀️.rs` — duplicated,
...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        "set-layer-boolean-operation" => (
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔀set-layer-boolean-operation/🧪️tests/➖️union-to-subtract/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔀set-layer-boolean-operation/🧪️tests/➖️union-to-subtract/🦠️mutation/🔣️.json"),
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔀set-layer-boolean-operation/🧪️tests/➖️union-to-subtract/📸️snapshot/➡️after/🔣️.json"),
        ),
        "update-layer-trace-params" => (
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔍️update-layer-trace-params/🧪️tests/🔍️sharpens-the-trace/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔍️update-layer-trace-params/🧪️tests/🔍️sharpens-the-trace/🦠️mutation/🔣️.json"),
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔍️update-layer-trace-params/🧪️tests/🔍️sharpens-the-trace/📸️snapshot/➡️after/🔣️.json"),
        ),
        "update-layer-transform" => (
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔄️update-layer-transform/🧪️tests/📐️translates-and-scales-shape-a/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔄️update-layer-transform/🧪️tests/📐️translates-and-scales-shape-a/🦠️mutation/🔣️.json"),
            include_str!("../../../🔀️transform/🧬️schema/🧬️mutations/🔄️update-layer-transform/🧪️tests/📐️translates-and-scales-shape-a/📸️snapshot/➡️after/🔣️.json"),
        ),
...
fn canonical(text: &str) -> Json {
    parse_json(text).unwrap_or_else(|error| panic!("mutate-drawing-1-transform: a committed fixture must be valid JSON: {error}"))
}
