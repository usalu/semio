//! 🧪️ `rename-layer` fixture — `✏️renames-shape-a-without-touching-its-id`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-layer/✏️renames-shape-a-without-touching-its-id/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-layer/✏️renames-shape-a-without-touching-its-id/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-layer/✏️renames-shape-a-without-touching-its-id/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-layer/✏️renames-shape-a-without-touching-its-id/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-layer/✏️renames-shape-a-without-touching-its-id/🎯️outcome/🔣️.json");
