...
//#region 🔖️Kinds
/// 🏷️ This subset's own slice of `KINDS` in `../../../✳️style/🧬️schema/🧬️mutations/🦀️.rs` — duplicated,
/// not imported, because the oracle-only build must not link the subject crate.
const KINDS: &[&str] = &["replace-layer-fill", "replace-layer-stroke", "set-layer-blend-mode", "set-layer-opacity"];
...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        "replace-layer-fill" => (
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🔁replace-layer-fill/🧪️tests/solid-to-linear-gradient/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🔁replace-layer-fill/🧪️tests/solid-to-linear-gradient/🦠️mutation/🔣️.json"),
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🔁replace-layer-fill/🧪️tests/solid-to-linear-gradient/📸️snapshot/➡️after/🔣️.json"),
        ),
        "replace-layer-stroke" => (
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/♻️replace-layer-stroke/🧪️tests/adds-a-dashed-stroke/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/♻️replace-layer-stroke/🧪️tests/adds-a-dashed-stroke/🦠️mutation/🔣️.json"),
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/♻️replace-layer-stroke/🧪️tests/adds-a-dashed-stroke/📸️snapshot/➡️after/🔣️.json"),
        ),
        "set-layer-blend-mode" => (
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🖌️set-layer-blend-mode/🧪️tests/normal-to-multiply/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🖌️set-layer-blend-mode/🧪️tests/normal-to-multiply/🦠️mutation/🔣️.json"),
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🖌️set-layer-blend-mode/🧪️tests/normal-to-multiply/📸️snapshot/➡️after/🔣️.json"),
        ),
        "set-layer-opacity" => (
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🌫️set-layer-opacity/🧪️tests/dims-shape-a-to-half/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🌫️set-layer-opacity/🧪️tests/dims-shape-a-to-half/🦠️mutation/🔣️.json"),
            include_str!("../../../✳️style/🧬️schema/🧬️mutations/🌫️set-layer-opacity/🧪️tests/dims-shape-a-to-half/📸️snapshot/➡️after/🔣️.json"),
        ),
...
fn canonical(text: &str) -> Json {
    parse_json(text).unwrap_or_else(|error| panic!("mutate-drawing-1-style: a committed fixture must be valid JSON: {error}"))
}
