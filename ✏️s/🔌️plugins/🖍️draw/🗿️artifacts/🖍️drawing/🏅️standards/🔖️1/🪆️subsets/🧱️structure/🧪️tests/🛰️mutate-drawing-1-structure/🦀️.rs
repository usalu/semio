...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        "create-layer" => (
            include_str!("../../🧬️schema/🧬️mutations/🌱create-layer/🧪️tests/🍋️appends-shape-b-at-the-root/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🌱create-layer/🧪️tests/🍋️appends-shape-b-at-the-root/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🌱create-layer/🧪️tests/🍋️appends-shape-b-at-the-root/📸️snapshot/➡️after/🔣️.json"),
        ),
        "delete-layer" => (
            include_str!("../../🧬️schema/🧬️mutations/🗑️delete-layer/🧪️tests/🚫️removes-group-a-with-its-child/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🗑️delete-layer/🧪️tests/🚫️removes-group-a-with-its-child/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🗑️delete-layer/🧪️tests/🚫️removes-group-a-with-its-child/📸️snapshot/➡️after/🔣️.json"),
        ),
        "duplicate-layer" => (
            include_str!("../../🧬️schema/🧬️mutations/🧬️duplicate-layer/🧪️tests/🚫️rejects-a-missing-source-layer/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🧬️duplicate-layer/🧪️tests/🚫️rejects-a-missing-source-layer/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🧬️duplicate-layer/🧪️tests/🚫️rejects-a-missing-source-layer/📸️snapshot/➡️after/🔣️.json"),
        ),
        "reorder-layer" => (
            include_str!("../../🧬️schema/🧬️mutations/🔃reorder-layer/🧪️tests/🍎️moves-shape-a-above-shape-b/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔃reorder-layer/🧪️tests/🍎️moves-shape-a-above-shape-b/🦠️mutation/🔣️.json"),
            include_str!("../../🧬️schema/🧬️mutations/🔃reorder-layer/🧪️tests/🍎️moves-shape-a-above-shape-b/📸️snapshot/➡️after/🔣️.json"),
        ),
