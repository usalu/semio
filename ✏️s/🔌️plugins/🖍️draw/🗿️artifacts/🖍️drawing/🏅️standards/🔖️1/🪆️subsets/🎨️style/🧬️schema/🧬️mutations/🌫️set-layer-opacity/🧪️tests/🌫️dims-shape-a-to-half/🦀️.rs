...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️set-layer-opacity/🌫️dims-shape-a-to-half/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️set-layer-opacity/🌫️dims-shape-a-to-half/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️set-layer-opacity/🌫️dims-shape-a-to-half/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️set-layer-opacity/🌫️dims-shape-a-to-half/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌫️set-layer-opacity/🌫️dims-shape-a-to-half/🎯️outcome/🔣️.json");
