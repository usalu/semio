...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌓️set-layer-blend-mode/✖️normal-to-multiply/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌓️set-layer-blend-mode/✖️normal-to-multiply/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌓️set-layer-blend-mode/✖️normal-to-multiply/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌓️set-layer-blend-mode/✖️normal-to-multiply/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌓️set-layer-blend-mode/✖️normal-to-multiply/🎯️outcome/🔣️.json");
