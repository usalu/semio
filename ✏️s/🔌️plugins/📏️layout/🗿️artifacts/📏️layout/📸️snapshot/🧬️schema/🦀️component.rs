...
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, ArtifactSchema, dsl::DslDocument)]
...
impl store::DocumentDsl for LayoutSnapshot {
...
impl store::DocumentPack for LayoutSnapshot {
