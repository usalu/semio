...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️update-page-columns/🏛️splits-page-1-into-three-columns/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️update-page-columns/🏛️splits-page-1-into-three-columns/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️update-page-columns/🏛️splits-page-1-into-three-columns/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️update-page-columns/🏛️splits-page-1-into-three-columns/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️update-page-columns/🏛️splits-page-1-into-three-columns/🎯️outcome/🔣️.json");

fn before() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(BEFORE).expect("update-page-columns/splits-page-1-into-three-columns: before snapshot decodes")
}
fn expected_after() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(AFTER).expect("update-page-columns/splits-page-1-into-three-columns: after snapshot decodes")
}
