...
VECTORS = {
    ...
    "change-print-target": (f"{_ROOT}/🖨️change-print-target/🖨️sets-a-cmyk-print-target", "ChangePrintTarget"),
    "change-data-fields": (f"{_ROOT}/🧾change-data-fields/🧾️attaches-a-data-fields-payload", "ChangeDataFields"),
    ...
    "update-page-margins": (f"{_ROOT}/📐update-page-margins/📐️sets-asymmetric-margins-on-page-1", "UpdatePageMargins"),
    "update-page-columns": (f"{_ROOT}/🏛️update-page-columns/🏛️splits-page-1-into-three-columns", "UpdatePageColumns"),
    ...
    "change-link-path": (f"{_ROOT}/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file", "ChangeLinkPath"),
    "create-frame": (f"{_ROOT}/➕create-frame/🔲️inserts-a-rect-frame-at-index-1", "CreateFrame"),
    "delete-frame": (f"{_ROOT}/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership", "DeleteFrame"),
    ...
    "change-frame-fill": (f"{_ROOT}/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill", "ChangeFrameFill"),
