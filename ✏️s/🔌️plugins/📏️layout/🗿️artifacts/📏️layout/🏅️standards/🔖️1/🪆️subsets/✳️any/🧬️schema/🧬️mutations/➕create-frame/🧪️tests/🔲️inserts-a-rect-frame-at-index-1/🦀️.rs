...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕create-frame/🔲️inserts-a-rect-frame-at-index-1/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕create-frame/🔲️inserts-a-rect-frame-at-index-1/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕create-frame/🔲️inserts-a-rect-frame-at-index-1/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕create-frame/🔲️inserts-a-rect-frame-at-index-1/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➕create-frame/🔲️inserts-a-rect-frame-at-index-1/🎯️outcome/🔣️.json");

fn before() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(BEFORE).expect("create-frame/inserts-a-rect-frame-at-index-1: before snapshot decodes")
}
fn expected_after() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(AFTER).expect("create-frame/inserts-a-rect-frame-at-index-1: after snapshot decodes")
}
