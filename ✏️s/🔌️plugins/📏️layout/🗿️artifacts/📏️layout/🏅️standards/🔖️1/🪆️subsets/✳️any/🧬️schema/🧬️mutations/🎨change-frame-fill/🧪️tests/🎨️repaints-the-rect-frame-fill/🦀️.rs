...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill/🎯️outcome/🔣️.json");

fn before() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(BEFORE).expect("change-frame-fill/repaints-the-rect-frame-fill: before snapshot decodes")
}
fn expected_after() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(AFTER).expect("change-frame-fill/repaints-the-rect-frame-fill: after snapshot decodes")
}
...
async fn repaints_the_rect_fill_without_touching_the_stroke() {
    ...
    let crate::Frame::Rect { fill, stroke, bounds, .. } = frame else { panic!("change-frame-fill targets the rect frame") };
