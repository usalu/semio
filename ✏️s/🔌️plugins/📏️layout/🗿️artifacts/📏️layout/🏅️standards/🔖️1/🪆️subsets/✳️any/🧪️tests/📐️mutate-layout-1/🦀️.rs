...
//!
//! The shape this case has to hold on to is TWO nesting depths: `frames` live inside a page, so a
//! frame divergence surfaces as `$.pages[0].frames[1]…` and a page divergence as `$.pages[1]…`.
//! Reporting the first divergence by JSON path through `law::divergence` is what keeps those two
...
//! bytes to the production bridges `apply_layout_mutation_json`, `undo_layout_mutation_json` and
//! `round_trip_layout_dsl` that this subset's `🧬️schema/🧬️mutations/🦀️.rs` exports for it.
...
fn fixture_text(kind: &str) -> (&'static str, &'static str, &'static str) {
    match kind {
        "rename-layout" => (
            include_str!("../../🧫️fixtures/🧬️mutations/✏️rename-layout/🏷️renames-the-document/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✏️rename-layout/🏷️renames-the-document/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✏️rename-layout/🏷️renames-the-document/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-print-target" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🖨️change-print-target/🖨️sets-a-cmyk-print-target/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🖨️change-print-target/🖨️sets-a-cmyk-print-target/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🖨️change-print-target/🖨️sets-a-cmyk-print-target/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-data-fields" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🧾change-data-fields/🧾️attaches-a-data-fields-payload/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧾change-data-fields/🧾️attaches-a-data-fields-payload/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🧾change-data-fields/🧾️attaches-a-data-fields-payload/📸️snapshot/➡️after/🔣️.json"),
        ),
        "create-page" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🌱create-page/➕️appends-page-3/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🌱create-page/➕️appends-page-3/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🌱create-page/➕️appends-page-3/📸️snapshot/➡️after/🔣️.json"),
        ),
        "delete-page" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🗑️delete-page/🚫️removes-page-2/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🗑️delete-page/🚫️removes-page-2/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🗑️delete-page/🚫️removes-page-2/📸️snapshot/➡️after/🔣️.json"),
        ),
        "rename-page" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🏷️rename-page/🏷️renames-page-1/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🏷️rename-page/🏷️renames-page-1/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🏷️rename-page/🏷️renames-page-1/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-page-width" => (
            include_str!("../../🧫️fixtures/🧬️mutations/↔️change-page-width/↔️widens-page-1/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/↔️change-page-width/↔️widens-page-1/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/↔️change-page-width/↔️widens-page-1/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-page-height" => (
            include_str!("../../🧫️fixtures/🧬️mutations/↕️change-page-height/↕️lengthens-page-1/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/↕️change-page-height/↕️lengthens-page-1/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/↕️change-page-height/↕️lengthens-page-1/📸️snapshot/➡️after/🔣️.json"),
        ),
        "update-page-margins" => (
            include_str!("../../🧫️fixtures/🧬️mutations/📐update-page-margins/📐️sets-asymmetric-margins-on-page-1/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📐update-page-margins/📐️sets-asymmetric-margins-on-page-1/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📐update-page-margins/📐️sets-asymmetric-margins-on-page-1/📸️snapshot/➡️after/🔣️.json"),
        ),
        "update-page-columns" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🏛️update-page-columns/🏛️splits-page-1-into-three-columns/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🏛️update-page-columns/🏛️splits-page-1-into-three-columns/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🏛️update-page-columns/🏛️splits-page-1-into-three-columns/📸️snapshot/➡️after/🔣️.json"),
        ),
        "reorder-pages" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🔀reorder-pages/🔀️moves-page-1-behind-page-2/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔀reorder-pages/🔀️moves-page-1-behind-page-2/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔀reorder-pages/🔀️moves-page-1-behind-page-2/📸️snapshot/➡️after/🔣️.json"),
        ),
        "create-story" => (
            include_str!("../../🧫️fixtures/🧬️mutations/📖create-story/📖️appends-story-3/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📖create-story/📖️appends-story-3/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📖create-story/📖️appends-story-3/📸️snapshot/➡️after/🔣️.json"),
        ),
        "delete-story" => (
            include_str!("../../🧫️fixtures/🧬️mutations/📕delete-story/🚫️removes-story-2/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📕delete-story/🚫️removes-story-2/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📕delete-story/🚫️removes-story-2/📸️snapshot/➡️after/🔣️.json"),
        ),
        "edit-story" => (
            include_str!("../../🧫️fixtures/🧬️mutations/✍️edit-story/📝️rewrites-story-1-body/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✍️edit-story/📝️rewrites-story-1-body/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✍️edit-story/📝️rewrites-story-1-body/📸️snapshot/➡️after/🔣️.json"),
        ),
        "create-link" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🖇️create-link/🔗️appends-link-3/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🖇️create-link/🔗️appends-link-3/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🖇️create-link/🔗️appends-link-3/📸️snapshot/➡️after/🔣️.json"),
        ),
        "delete-link" => (
            include_str!("../../🧫️fixtures/🧬️mutations/✂️delete-link/🔗️removes-link-2/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✂️delete-link/🔗️removes-link-2/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/✂️delete-link/🔗️removes-link-2/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-link-path" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file/📸️snapshot/➡️after/🔣️.json"),
        ),
        "create-frame" => (
            include_str!("../../🧫️fixtures/🧬️mutations/➕create-frame/🔲️inserts-a-rect-frame-at-index-1/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/➕create-frame/🔲️inserts-a-rect-frame-at-index-1/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/➕create-frame/🔲️inserts-a-rect-frame-at-index-1/📸️snapshot/➡️after/🔣️.json"),
        ),
        "delete-frame" => (
            include_str!("../../🧫️fixtures/🧬️mutations/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership/📸️snapshot/➡️after/🔣️.json"),
        ),
        "move-frame" => (
        ...
        "resize-frame" => (
            ...
            include_str!("../../🧫️fixtures/🧬️mutations/📏resize-frame/📐️resizes-the-rect-frame/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/📏resize-frame/📐️resizes-the-rect-frame/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-frame-fill" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🎨change-frame-fill/🎨️repaints-the-rect-frame-fill/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-frame-stroke" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🖊️change-frame-stroke/🖊️adds-a-stroke-to-the-rect-frame/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🖊️change-frame-stroke/🖊️adds-a-stroke-to-the-rect-frame/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🖊️change-frame-stroke/🖊️adds-a-stroke-to-the-rect-frame/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-frame-wrap-mode" => (
            include_str!("../../🧫️fixtures/🧬️mutations/🔤change-frame-wrap-mode/🔤️switches-the-text-frame-to-column-wrap/📸️snapshot/⬅️before/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔤change-frame-wrap-mode/🔤️switches-the-text-frame-to-column-wrap/🦠️mutation/🔣️.json"),
            include_str!("../../🧫️fixtures/🧬️mutations/🔤change-frame-wrap-mode/🔤️switches-the-text-frame-to-column-wrap/📸️snapshot/➡️after/🔣️.json"),
        ),
        "change-frame-columns" => (
...
fn canonical(text: &str) -> Json {
    parse_json(text).unwrap_or_else(|error| panic!("mutate-layout-1: a committed fixture must be valid JSON: {error}"))
}
...
mod subject {
    ...
    pub fn mutate(kind: &'static str) -> impl Fn(&Context) -> Result<Outcome, String> {
        move |_ctx: &Context| {
            ...
            let (document, codes) = answer(&apply_layout_mutation_json(before, mutation)?)?;
    ...
    pub fn inverse(kind: &'static str) -> impl Fn(&Context) -> Result<Outcome, String> {
        move |_ctx: &Context| {
            ...
            let (document, _codes) = answer(&undo_layout_mutation_json(before, mutation)?)?;
    ...
    pub fn round_trip(ctx: &Context) -> Result<Outcome, String> {
        ...
        let value = parse_json(&round_trip_layout_dsl(&text)?)?;
