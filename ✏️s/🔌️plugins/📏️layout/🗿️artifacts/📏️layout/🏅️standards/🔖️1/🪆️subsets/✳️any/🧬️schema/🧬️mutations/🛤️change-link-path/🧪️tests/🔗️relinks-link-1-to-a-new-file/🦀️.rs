...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🛤️change-link-path/🔗️relinks-link-1-to-a-new-file/🎯️outcome/🔣️.json");

fn before() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(BEFORE).expect("change-link-path/relinks-link-1-to-a-new-file: before snapshot decodes")
}
fn expected_after() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(AFTER).expect("change-link-path/relinks-link-1-to-a-new-file: after snapshot decodes")
}
