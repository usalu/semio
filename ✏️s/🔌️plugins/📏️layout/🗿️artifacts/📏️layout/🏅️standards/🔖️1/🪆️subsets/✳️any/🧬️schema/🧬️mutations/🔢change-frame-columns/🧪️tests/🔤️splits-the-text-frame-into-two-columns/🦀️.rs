...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢change-frame-columns/🔤️splits-the-text-frame-into-two-columns/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢change-frame-columns/🔤️splits-the-text-frame-into-two-columns/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢change-frame-columns/🔤️splits-the-text-frame-into-two-columns/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢change-frame-columns/🔤️splits-the-text-frame-into-two-columns/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢change-frame-columns/🔤️splits-the-text-frame-into-two-columns/🎯️outcome/🔣️.json");
