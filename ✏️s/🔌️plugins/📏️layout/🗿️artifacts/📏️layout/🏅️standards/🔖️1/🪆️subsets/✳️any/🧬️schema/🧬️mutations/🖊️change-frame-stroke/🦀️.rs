...
impl MutationKind<LayoutSnapshot, LayoutMutation> for ChangeFrameStroke {
    ...
    fn label(&self) -> protocol::LocalizedLabel {
        protocol::LocalizedLabel::native(&format!("Change frame \"{}\" stroke", self.frame_id), &format!("Kontur von Rahmen \"{}\" ändern", self.frame_id))
    }
...
//#region 🖊️ChangeFrameStroke
pub fn diff_change_frame_stroke(payload: &ChangeFrameStroke, base: &LayoutSnapshot) -> protocol::MutationOutcome<LayoutDiff> {
