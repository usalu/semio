...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-frame/🚫️removes-the-text-frame-and-its-layer-membership/🎯️outcome/🔣️.json");

fn before() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(BEFORE).expect("delete-frame/removes-the-text-frame-and-its-layer-membership: before snapshot decodes")
}
fn expected_after() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(AFTER).expect("delete-frame/removes-the-text-frame-and-its-layer-membership: after snapshot decodes")
}
