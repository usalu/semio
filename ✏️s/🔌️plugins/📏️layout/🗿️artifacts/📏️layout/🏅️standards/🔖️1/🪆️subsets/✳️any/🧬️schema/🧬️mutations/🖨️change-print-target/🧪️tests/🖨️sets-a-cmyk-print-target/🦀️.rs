...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖨️change-print-target/🖨️sets-a-cmyk-print-target/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖨️change-print-target/🖨️sets-a-cmyk-print-target/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖨️change-print-target/🖨️sets-a-cmyk-print-target/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖨️change-print-target/🖨️sets-a-cmyk-print-target/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖨️change-print-target/🖨️sets-a-cmyk-print-target/🎯️outcome/🔣️.json");

fn before() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(BEFORE).expect("change-print-target/sets-a-cmyk-print-target: before snapshot decodes")
}
fn expected_after() -> LayoutSnapshot {
    dsl::os_pack::from_json_str(AFTER).expect("change-print-target/sets-a-cmyk-print-target: after snapshot decodes")
}
