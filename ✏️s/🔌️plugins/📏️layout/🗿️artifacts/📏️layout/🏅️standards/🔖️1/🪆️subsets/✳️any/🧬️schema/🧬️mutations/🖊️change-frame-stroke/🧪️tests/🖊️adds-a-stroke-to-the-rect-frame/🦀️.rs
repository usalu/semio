...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️change-frame-stroke/🖊️adds-a-stroke-to-the-rect-frame/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️change-frame-stroke/🖊️adds-a-stroke-to-the-rect-frame/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️change-frame-stroke/🖊️adds-a-stroke-to-the-rect-frame/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️change-frame-stroke/🖊️adds-a-stroke-to-the-rect-frame/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🖊️change-frame-stroke/🖊️adds-a-stroke-to-the-rect-frame/🎯️outcome/🔣️.json");
