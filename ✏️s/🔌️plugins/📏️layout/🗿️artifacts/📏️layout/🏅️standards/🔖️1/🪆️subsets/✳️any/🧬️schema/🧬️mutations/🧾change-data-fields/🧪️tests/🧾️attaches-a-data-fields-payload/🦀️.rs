//! 🧪️ `change-data-fields` fixture — `🧾️attaches-a-data-fields-payload`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾change-data-fields/🧾️attaches-a-data-fields-payload/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾change-data-fields/🧾️attaches-a-data-fields-payload/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾change-data-fields/🧾️attaches-a-data-fields-payload/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾change-data-fields/🧾️attaches-a-data-fields-payload/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧾change-data-fields/🧾️attaches-a-data-fields-payload/🎯️outcome/🔣️.json");
