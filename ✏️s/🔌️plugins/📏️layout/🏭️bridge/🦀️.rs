...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_layout_layout::standards::v1::subsets::any::schema::snapshot::LayoutSnapshot, semio_s_artifact_layout_layout::standards::v1::subsets::any::schema::mutations::LayoutMutation>,
];
