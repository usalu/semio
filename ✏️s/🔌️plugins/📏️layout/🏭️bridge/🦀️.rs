//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/📏️layout`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("LayoutMutation", descriptors::<semio_s_artifact_layout_layout::standards::v1::subsets::any::schema::snapshot::LayoutSnapshot, semio_s_artifact_layout_layout::standards::v1::subsets::any::schema::mutations::LayoutMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.layout.layout", "1", "any", "", "✏️s/🔌️plugins/📏️layout/🗿️artifacts/📏️layout/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-layout-mutation-bridge")),
