//! 🧪️ `delete-step` fixture — `🚫️rejects-deleting-a-step-the-scene-does-not-hold`.
//!
...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-step/🧪️rejects-deleting-a-step-the-scene-does-not-hold/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-step/🧪️rejects-deleting-a-step-the-scene-does-not-hold/🎯️outcome/🔣️.json");
