...
pub fn layout() -> WindowLayout {
    WindowLayout {
        root: WindowLayoutRoot::Stack(WindowLayoutStackNode {
            ...
            children: vec![WindowLayoutWindowNode { kind: "window".into(), window_kind_id: try_wizard::WINDOW_KIND_ID.into(), title: Some("Try".into()), instance_id: None, template_id: None }],
        }),
    }
}
