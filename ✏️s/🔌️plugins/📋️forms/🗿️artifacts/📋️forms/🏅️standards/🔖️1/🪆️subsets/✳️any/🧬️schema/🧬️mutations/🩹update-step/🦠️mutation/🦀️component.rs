...
impl MutationKind<FormsSnapshot, FormMutation> for RenameStep {
    ...
    fn diff(&self, base: &FormsSnapshot) -> FormsDiff {
        super::diff::diff_rename_step(self, base)
    }
    fn inverse(&self, base: &FormsSnapshot) -> Vec<FormMutation> {
        super::inverse::inverse_rename_step(self, base)
    }
...
impl MutationKind<FormsSnapshot, FormMutation> for ChangeStepDescription {
    ...
    fn diff(&self, base: &FormsSnapshot) -> FormsDiff {
        super::diff::diff_change_step_description(self, base)
    }
    fn inverse(&self, base: &FormsSnapshot) -> Vec<FormMutation> {
        super::inverse::inverse_change_step_description(self, base)
    }
    fn label(&self) -> String {
