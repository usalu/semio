//! 🧪️ `replace-block` fixture — `🧩️no-ops-when-the-replacement-block-is-identical`.
//!
...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁replace-block/🧪️no-ops-when-the-replacement-block-is-identical/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁replace-block/🧪️no-ops-when-the-replacement-block-is-identical/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁replace-block/🧪️no-ops-when-the-replacement-block-is-identical/🎯️outcome/🔣️.json");
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(outcome.get("status").and_then(serde_json::Value::as_str), Some("no-op"), "replace-block/no-ops-when-the-replacement-block-is-identical declares a no-op outcome");
