...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-step/🧪️no-ops-when-the-step-already-sits-at-that-index/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-step/🧪️no-ops-when-the-step-already-sits-at-that-index/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀reorder-step/🧪️no-ops-when-the-step-already-sits-at-that-index/🎯️outcome/🔣️.json");
...
/// 🎯️ The declared outcome holds: `no-op`, with one untargeted Warning `mutation.no-op` — the
/// same verb answers an unknown id with an Error-level `mutation.target-missing` instead.
#[semio_framework_async_macros::async_test]
async fn declared_outcome_holds() {
    let outcome: serde_json::Value = serde_json::from_str(OUTCOME).expect("outcome decodes");
    assert_eq!(outcome.get("status").and_then(serde_json::Value::as_str), Some("no-op"), "reorder-step/no-ops-when-the-step-already-sits-at-that-index declares a no-op outcome");
