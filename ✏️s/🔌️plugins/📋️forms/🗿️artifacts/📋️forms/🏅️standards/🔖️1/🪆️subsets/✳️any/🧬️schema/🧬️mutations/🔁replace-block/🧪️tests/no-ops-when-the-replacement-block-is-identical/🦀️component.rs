...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-block/no-ops-when-the-replacement-block-is-identical: produced diff differs from the committed 🔺️diff/🔣️component.json");
