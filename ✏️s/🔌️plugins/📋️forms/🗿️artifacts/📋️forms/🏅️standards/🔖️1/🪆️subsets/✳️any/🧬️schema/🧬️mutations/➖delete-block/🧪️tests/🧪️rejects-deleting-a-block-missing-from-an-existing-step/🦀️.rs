//! 🧪️ `delete-block` fixture — `🧩️rejects-deleting-a-block-missing-from-an-existing-step`.
//!
...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-block/🧪️rejects-deleting-a-block-missing-from-an-existing-step/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖delete-block/🧪️rejects-deleting-a-block-missing-from-an-existing-step/🎯️outcome/🔣️.json");
