//! 🧪️ `rename-step` fixture — `📖️no-ops-when-the-step-already-carries-that-title`.
//!
...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-step/🧪️no-ops-when-the-step-already-carries-that-title/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-step/🧪️no-ops-when-the-step-already-carries-that-title/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️rename-step/🧪️no-ops-when-the-step-already-carries-that-title/🎯️outcome/🔣️.json");
