...
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-step/🧪️rejects-a-duplicate-step-id/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🌱create-step/🧪️rejects-a-duplicate-step-id/🎯️outcome/🔣️.json");
