//! 🧪️ `change-form-title` fixture — `⚓️titles-an-untitled-survey`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-form-title/🧪️titles-an-untitled-survey/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-form-title/🧪️titles-an-untitled-survey/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-form-title/🧪️titles-an-untitled-survey/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-form-title/🧪️titles-an-untitled-survey/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏷️change-form-title/🧪️titles-an-untitled-survey/🎯️outcome/🔣️.json");
