import { testDocumentContractOracle } from "../../../../../../../../../../../../🧰️framework/🔨️modules/🧬️schema/🧪️testkit/🪪️document-contract/🟦️.ts";
...
export function testFormsDocumentContractOracle(): void {
  ...
  testDocumentContractOracle({
    ...
    mutations: join(import.meta.dir, "../../🧬️mutations"),
