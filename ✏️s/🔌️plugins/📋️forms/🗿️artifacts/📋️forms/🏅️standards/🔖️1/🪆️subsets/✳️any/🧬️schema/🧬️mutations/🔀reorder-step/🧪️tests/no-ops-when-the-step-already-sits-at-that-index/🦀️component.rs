...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-step/no-ops-when-the-step-already-sits-at-that-index: produced diff differs from the committed 🔺️diff/🔣️component.json");
