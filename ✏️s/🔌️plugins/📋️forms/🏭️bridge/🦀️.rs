...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_forms_forms::standards::v1::subsets::any::schema::snapshot::FormsSnapshot, semio_s_artifact_forms_forms::standards::v1::subsets::any::schema::mutations::FormMutation>,
];
