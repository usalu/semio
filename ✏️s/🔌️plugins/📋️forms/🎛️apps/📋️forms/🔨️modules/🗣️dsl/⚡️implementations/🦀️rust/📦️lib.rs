...
pub const BUILDING_COMPONENT_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/📋️forms/📚️examples/📋️building-component.forms");

/// 📄️ The `default` (Contact) fixture — a minimal single-step form, in the `.forms` DSL.
pub const DEFAULT_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/📋️forms/📚️examples/📋️default.forms");
...
pub const ONBOARDING_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/📋️forms/📚️examples/📋️onboarding.forms");
