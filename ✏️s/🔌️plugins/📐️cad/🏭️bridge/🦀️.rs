...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_cad_cad::standards::v1::subsets::any::schema::snapshot::CadSnapshot, semio_s_artifact_cad_cad::standards::v1::subsets::any::schema::mutations::CadMutation>,
];
