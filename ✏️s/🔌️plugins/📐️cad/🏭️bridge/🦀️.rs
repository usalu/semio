//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/📐️cad`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("CadMutation", descriptors::<semio_s_artifact_cad_cad::standards::v1::subsets::any::schema::snapshot::CadSnapshot, semio_s_artifact_cad_cad::standards::v1::subsets::any::schema::mutations::CadMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.cad.cad", "1", "any", "", "✏️s/🔌️plugins/📐️cad/🗿️artifacts/📐️cad/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-cad-mutation-bridge")),
