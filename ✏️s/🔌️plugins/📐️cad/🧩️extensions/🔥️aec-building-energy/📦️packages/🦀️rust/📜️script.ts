#!/usr/bin/env bun
/** 🔥️ `@semio-tech/cad-extension-aec-building-energy-rust` router: `bun ./📜️script.ts test`. */
...
class TestScript extends BundleScript {
  run(_segments: string[]): void {
    runCargoTestBudgeted(["semio-s-plugin-cad-aec-building-energy"], this.repoRoot);
  }
}
