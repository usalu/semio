...
const { bboxSizesFromPositions, cloneModelGeometryShell, collectSolidRefsForObjects, collectVertexPositionsForObjects, qualifiedTransformationId, registerImportProfile, registerStatComputer, registerTransformationApplier, solidRef, transformationObjectId } = core;
type Model = core.Model;
type StatComputeContext = core.StatComputeContext;
type TransformationSpec = core.TransformationSpec;
