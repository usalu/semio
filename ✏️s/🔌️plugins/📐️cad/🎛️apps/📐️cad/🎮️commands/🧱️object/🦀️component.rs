...
pub mod add_object {
    ...
    pub fn handle(payload: &AddObject, doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
...
pub mod patch_object {
    ...
    pub fn handle(payload: &PatchObject, doc: &DocumentView<'_, CadScene>, _cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
...
pub mod patch_selection {
    ...
    pub fn handle(payload: &PatchSelection, doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
...
pub mod delete_object {
    ...
    pub fn handle(payload: &DeleteObject, doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let document = doc.projection;
        let mut runtime = runtime_of(cfg);
...
pub mod duplicate_object {
    ...
    pub fn handle(payload: &DuplicateObject, doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let document = doc.projection;
        let mut runtime = runtime_of(cfg);
