...
pub mod engagement_submit {
    ...
    pub fn handle(payload: &EngagementSubmit, doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
...
pub mod engagement_input {
    ...
    pub fn handle(payload: &EngagementInput, _doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let mut runtime = runtime_of(cfg);
...
pub mod engagement_possible_select {
    ...
    pub fn handle(payload: &EngagementPossibleSelect, _doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let mut runtime = runtime_of(cfg);
        let pane_id = payload.pane.as_deref().map_or(CadPaneId::Shape, cad_pane_id_from_suffix);
...
pub mod engagement_repeat_last {
    ...
    pub fn handle(payload: &EngagementRepeatLast, _doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let mut runtime = runtime_of(cfg);
        let pane_id = payload.pane.as_deref().map_or(CadPaneId::Shape, cad_pane_id_from_suffix);
...
pub mod engagement_abort {
    ...
    pub fn handle(_payload: &EngagementAbort, _doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let mut runtime = runtime_of(cfg);
...
pub mod world_pointer_down {
    ...
    pub fn handle(payload: &WorldPointerDown, doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
...
pub mod world_pointer_move {
    ...
    pub fn handle(payload: &WorldPointerMove, _doc: &DocumentView<'_, CadScene>, cfg: &ConfigView<'_, CadConfig>, ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        ...
        if let Some(session) = runtime.engagement_session.as_mut() {
            ...
            *seq = seq.wrapping_add(1);
            drop(seq);
            Ok(Emit::amend_config(vec![snapshot_of(&runtime, cfg.projection)], "engagement.pointer-move"))
        } else {
            Ok(Emit::default())
        }
    }
