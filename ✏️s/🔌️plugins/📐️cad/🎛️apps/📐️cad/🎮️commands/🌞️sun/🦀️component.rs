...
pub mod toggle_sun {
    ...
    pub fn handle(_payload: &ToggleSun, _doc: &DocumentView<'_, CadProjection>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
...
pub mod set_sun_azimuth {
    ...
    pub fn handle(payload: &SetSunAzimuth, _doc: &DocumentView<'_, CadProjection>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let mut runtime = runtime_of(cfg);
...
pub mod set_sun_elevation {
    ...
    pub fn handle(payload: &SetSunElevation, _doc: &DocumentView<'_, CadProjection>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let mut runtime = runtime_of(cfg);
        let args_value = json!({ "value": payload.value });
...
pub mod set_sun_intensity {
    ...
    pub fn handle(payload: &SetSunIntensity, _doc: &DocumentView<'_, CadProjection>, cfg: &ConfigView<'_, CadConfig>, _ctx: &mut CadDispatchCtx<'_>) -> Result<Emit<CadOperation, CadConfigOperation>, Fault> {
        let mut runtime = runtime_of(cfg);
        let args_value = json!({ "value": payload.value });
