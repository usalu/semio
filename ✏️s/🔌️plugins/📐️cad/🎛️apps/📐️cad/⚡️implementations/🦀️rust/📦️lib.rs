...
mod tests {
    ...
    fn interaction_spec_parses_box_asset() {
        let raw = include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/📐️spatial.shape/🎬️interactions/🔣️box.json");
    ...
    fn interaction_spec_parses_sphere_asset_with_command_finish() {
        let raw = include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/📐️spatial.shape/🎬️interactions/🔣️sphere.json");
    ...
    fn interaction_spec_parses_all_energy_and_structure_classic_assets() {
        let sources = [
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🔥️aec.building.energy/🎬️interactions/🔣️constructBasePlate.json"),
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🔥️aec.building.energy/🎬️interactions/🔣️constructExternalWall.json"),
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🔥️aec.building.energy/🎬️interactions/🔣️constructHull.json"),
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🔥️aec.building.energy/🎬️interactions/🔣️constructRoof.json"),
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🔥️aec.building.energy/🎬️interactions/🔣️constructWindows.json"),
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🏛️aec.building.structure.classic/🎬️interactions/🔣️constructOneWayReinforcedConcreteSlab.json"),
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🏛️aec.building.structure.classic/🎬️interactions/🔣️constructReinforcedConcreteColumn.json"),
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🏛️aec.building.structure.classic/🎬️interactions/🔣️constructReinforcedConcreteExternalWall.json"),
            include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🏛️aec.building.structure.classic/🎬️interactions/🔣️constructReinforcedConcreteInternalWall.json"),
        ];
        for raw in sources {
    ...
    fn every_interaction_asset_on_disk_parses_as_interaction_spec() {
        ...
        fn walk(dir: &std::path::Path, out: &mut Vec<std::path::PathBuf>) {
            ...
            for entry in entries.flatten() {
                ...
                if path.is_dir() {
                    walk(&path, out);
                } else if path.file_name().and_then(|n| n.to_str()).map(|n| n.ends_with(".json")).unwrap_or(false) && path.parent().and_then(|p| p.file_name()).and_then(|n| n.to_str()) == Some("🎬️interactions") {
                    out.push(path);
                }
            }
        }
    ...
    fn interaction_spec_guard_evaluates_against_context() {
        let raw = include_str!("../../../../../../../✏️s/🔌️plugins/📐️cad/🖼️assets/🏗️modelDefinitions/🔥️aec.building.energy/🎬️interactions/🔣️constructExternalWall.json");
