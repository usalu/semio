/** 👁️ CAD viewer — subset-level typed twin. Read-only counterpart of `✏️editor/🟦️.ts`:
...
export const CAD_VIEWER_DIALECT = { artifactKind: "s.cad.cad", standard: "1", subset: "*" } as const;
