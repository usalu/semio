...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯change-active-model-definition/🏗️switches-the-active-pane-to-the-building-model/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯change-active-model-definition/🏗️switches-the-active-pane-to-the-building-model/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯change-active-model-definition/🏗️switches-the-active-pane-to-the-building-model/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯change-active-model-definition/🏗️switches-the-active-pane-to-the-building-model/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🎯change-active-model-definition/🏗️switches-the-active-pane-to-the-building-model/🎯️outcome/🔣️.json");

fn before() -> CadSnapshot {
    dsl::json::from_json_str(BEFORE).expect("change-active-model-definition/switches-the-active-pane-to-the-building-model: before snapshot decodes")
}
fn expected_after() -> CadSnapshot {
    dsl::json::from_json_str(AFTER).expect("change-active-model-definition/switches-the-active-pane-to-the-building-model: after snapshot decodes")
}
fn mutation() -> CadMutation {
    dsl::json::from_json_str(MUTATION).expect("change-active-model-definition/switches-the-active-pane-to-the-building-model: mutation decodes")
}
