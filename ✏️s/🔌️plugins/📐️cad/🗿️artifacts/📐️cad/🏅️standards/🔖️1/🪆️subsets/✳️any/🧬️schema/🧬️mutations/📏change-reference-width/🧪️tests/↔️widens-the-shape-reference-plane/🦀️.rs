...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏change-reference-width/↔️widens-the-shape-reference-plane/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏change-reference-width/↔️widens-the-shape-reference-plane/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏change-reference-width/↔️widens-the-shape-reference-plane/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏change-reference-width/↔️widens-the-shape-reference-plane/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📏change-reference-width/↔️widens-the-shape-reference-plane/🎯️outcome/🔣️.json");
