...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-structure-classic-model/🏛️rehandles-the-occupied-structure-classic-slot/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-structure-classic-model/🏛️rehandles-the-occupied-structure-classic-slot/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-structure-classic-model/🏛️rehandles-the-occupied-structure-classic-slot/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-structure-classic-model/🏛️rehandles-the-occupied-structure-classic-slot/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🏛️create-structure-classic-model/🏛️rehandles-the-occupied-structure-classic-slot/🎯️outcome/🔣️.json");

fn before() -> CadSnapshot {
    dsl::json::from_json_str(BEFORE).expect("create-structure-classic-model/rehandles-the-occupied-structure-classic-slot: before snapshot decodes")
}
fn expected_after() -> CadSnapshot {
    dsl::json::from_json_str(AFTER).expect("create-structure-classic-model/rehandles-the-occupied-structure-classic-slot: after snapshot decodes")
}
fn mutation() -> CadMutation {
    dsl::json::from_json_str(MUTATION).expect("create-structure-classic-model/rehandles-the-occupied-structure-classic-slot: mutation decodes")
}
