...
pub const SURFACE_ID: &str = "cad.play.scene3d/building";
pub const PANE: CadPaneId = CadPaneId::Building;
...
pub fn window_measures(runtime: &CadPlayRuntime, is_de: bool) -> Vec<WindowMeasure> {
    vec![options::projection::measure(runtime, PANE), options::sun::measure(runtime, is_de), options::dislocate::measure(runtime.dislocate_options(WINDOW_KIND_ID), is_de)]
}
