//! 🧪️ `change-reference-locked` fixture — `🔓️unlocks-the-shape-reference`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-reference-locked/🔓️unlocks-the-shape-reference/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-reference-locked/🔓️unlocks-the-shape-reference/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-reference-locked/🔓️unlocks-the-shape-reference/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-reference-locked/🔓️unlocks-the-shape-reference/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔒change-reference-locked/🔓️unlocks-the-shape-reference/🎯️outcome/🔣️.json");

fn before() -> CadSnapshot {
    dsl::json::from_json_str(BEFORE).expect("change-reference-locked/unlocks-the-shape-reference: before snapshot decodes")
}
fn expected_after() -> CadSnapshot {
    dsl::json::from_json_str(AFTER).expect("change-reference-locked/unlocks-the-shape-reference: after snapshot decodes")
}
fn mutation() -> CadMutation {
    dsl::json::from_json_str(MUTATION).expect("change-reference-locked/unlocks-the-shape-reference: mutation decodes")
}
