...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📎replace-references/🔄️swaps-the-shape-reference-list/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📎replace-references/🔄️swaps-the-shape-reference-list/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📎replace-references/🔄️swaps-the-shape-reference-list/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📎replace-references/🔄️swaps-the-shape-reference-list/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/📎replace-references/🔄️swaps-the-shape-reference-list/🎯️outcome/🔣️.json");
