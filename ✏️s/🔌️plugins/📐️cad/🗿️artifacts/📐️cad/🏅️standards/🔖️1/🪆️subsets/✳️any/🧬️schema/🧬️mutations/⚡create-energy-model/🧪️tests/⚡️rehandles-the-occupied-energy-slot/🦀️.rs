//! 🧪️ `create-energy-model` fixture — `⚡️rehandles-the-occupied-energy-slot`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡create-energy-model/⚡️rehandles-the-occupied-energy-slot/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡create-energy-model/⚡️rehandles-the-occupied-energy-slot/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡create-energy-model/⚡️rehandles-the-occupied-energy-slot/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡create-energy-model/⚡️rehandles-the-occupied-energy-slot/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/⚡create-energy-model/⚡️rehandles-the-occupied-energy-slot/🎯️outcome/🔣️.json");

fn before() -> CadSnapshot {
    dsl::json::from_json_str(BEFORE).expect("create-energy-model/rehandles-the-occupied-energy-slot: before snapshot decodes")
}
fn expected_after() -> CadSnapshot {
    dsl::json::from_json_str(AFTER).expect("create-energy-model/rehandles-the-occupied-energy-slot: after snapshot decodes")
}
fn mutation() -> CadMutation {
    dsl::json::from_json_str(MUTATION).expect("create-energy-model/rehandles-the-occupied-energy-slot: mutation decodes")
}
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(handle.child_id, "cad-energy-2", "the slot diff carries the payload child id");
