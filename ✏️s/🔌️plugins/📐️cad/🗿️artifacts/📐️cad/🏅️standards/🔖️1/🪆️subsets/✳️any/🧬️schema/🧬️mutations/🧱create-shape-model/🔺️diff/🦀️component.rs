...
pub fn diff(payload: &CreateShapeModel, _base: &CadSnapshot) -> CadDiff {
    CadDiff { shape_model: Some(Some(store::ArtifactChild::new(payload.child_id.clone(), parse_target(&payload.target)))), ..Default::default() }
}
//#endregion 🔖️Diff
