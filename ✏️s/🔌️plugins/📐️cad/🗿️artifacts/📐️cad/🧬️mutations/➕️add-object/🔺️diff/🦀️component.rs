//! 🔺️ Diff fragment yielded by `AddObject`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `AddObject` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct AddObjectDiff {
...
impl MutationDiff<CadProjection> for AddObjectDiff {
