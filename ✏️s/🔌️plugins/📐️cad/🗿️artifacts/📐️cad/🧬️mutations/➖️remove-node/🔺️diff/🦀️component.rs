//! 🔺️ Diff fragment yielded by `RemoveNode`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `RemoveNode` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct RemoveNodeDiff {
...
impl MutationDiff<CadProjection> for RemoveNodeDiff {
