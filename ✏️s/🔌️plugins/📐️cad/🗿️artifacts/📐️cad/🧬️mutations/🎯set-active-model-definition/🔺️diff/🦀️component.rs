//! 🔺️ Diff fragment yielded by `SetActiveModelDefinition`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `SetActiveModelDefinition` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct SetActiveModelDefinitionDiff {
    pub mutation: Option<CadMutation>,
}

impl SetActiveModelDefinitionDiff {
    pub fn from_mutation(mutation: CadMutation) -> Self {
        Self { mutation: Some(mutation) }
    }
}

impl MutationDiff<CadProjection> for SetActiveModelDefinitionDiff {
