//! 🔺️ Diff fragment yielded by `SetScene`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `SetScene` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct SetSceneDiff {
...
impl MutationDiff<CadProjection> for SetSceneDiff {
