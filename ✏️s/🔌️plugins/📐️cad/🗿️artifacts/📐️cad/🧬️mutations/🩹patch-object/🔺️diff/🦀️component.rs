//! 🔺️ Diff fragment yielded by `PatchObject`.
...
//#region 🔖️Diff
/// @emoji 🔺️ Diff produced by one `PatchObject` mutation.
#[derive(Clone, Debug, Default, PartialEq, Serialize, Deserialize)]
pub struct PatchObjectDiff {
    pub mutation: Option<CadMutation>,
}

impl PatchObjectDiff {
    pub fn from_mutation(mutation: CadMutation) -> Self {
        Self { mutation: Some(mutation) }
    }
}

impl MutationDiff<CadProjection> for PatchObjectDiff {
