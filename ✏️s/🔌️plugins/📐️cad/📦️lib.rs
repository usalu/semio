...
pub mod artifacts {
    ...
    pub mod cad {
        ...
        #[path = "🗿️artifacts/📐️cad/🦀️interaction_spec.rs"]
        ...
        pub mod engine {
            ...
            #[path = "🗿️artifacts/📐️cad/⚙️engine/🦀️geometry_import.rs"]
            pub mod geometry_import;
            #[path = "🗿️artifacts/📐️cad/⚙️engine/🦀️transformation.rs"]
            pub mod transformation;
            #[path = "🗿️artifacts/📐️cad/⚙️engine/🦀️interaction.rs"]
            pub mod interaction;
            #[path = "🗿️artifacts/📐️cad/⚙️engine/🦀️construct.rs"]
            pub mod construct;
        }
    }
}
...
pub mod apps {
    ...
    pub mod cad {
        ...
        #[path = "🎛️apps/📐️cad/🦀️config.rs"]
        pub mod config;
        #[path = "🎛️apps/📐️cad/🦀️terminology.rs"]
        pub mod terminology;
        #[path = "🎛️apps/📐️cad/🦀️wasm.rs"]
        pub mod wasm;
