...
import { Model, ObjectRef, TypologyPrimitiveKind, TypologyRef, TypologySpec, listModelDefinitionTypologies, listTypologiesForModelDefinition, loadTypology, typologyForInteraction } from "../📐️geometry/🟦️component.ts";
