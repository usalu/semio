...
class GenerateScript extends BundleScript {
  async run(extra: string[]): Promise<void> {
    ...
    const { buildSpatialStatelyMachineCatalogView } = await import("../../../../../../../🧰️framework/🔨️modules/🧮️math/🕸️graph/🗣️dsl/🫀️core/⚡️implementations/🟦️typescript/🟦️typescript/📦️index.ts");
    bootstrapCadModules();
