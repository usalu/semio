//! 🧪️ `reorder-synapses` fixture — `keeps-the-leading-synapse-at-index-zero`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-synapses/keeps-the-leading-synapse-at-index-zero: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
