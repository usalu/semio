//! 🧪️ `duplicate-widget` fixture — `🚫️rejects-duplicating-onto-a-taken-id`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👯️duplicate-widget/🚫️rejects-duplicating-onto-a-taken-id/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👯️duplicate-widget/🚫️rejects-duplicating-onto-a-taken-id/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👯️duplicate-widget/🚫️rejects-duplicating-onto-a-taken-id/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/👯️duplicate-widget/🚫️rejects-duplicating-onto-a-taken-id/🎯️outcome/🔣️.json");
...
/// `DuplicateWidget` uses the same camelCase payload keys as every leaf verb.
#[semio_framework_async_macros::async_test]
