...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️update-synapse-endpoints/🟰️re-declares-the-same-endpoints/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️update-synapse-endpoints/🟰️re-declares-the-same-endpoints/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️update-synapse-endpoints/🟰️re-declares-the-same-endpoints/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️update-synapse-endpoints/🟰️re-declares-the-same-endpoints/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄️update-synapse-endpoints/🟰️re-declares-the-same-endpoints/🎯️outcome/🔣️.json");
