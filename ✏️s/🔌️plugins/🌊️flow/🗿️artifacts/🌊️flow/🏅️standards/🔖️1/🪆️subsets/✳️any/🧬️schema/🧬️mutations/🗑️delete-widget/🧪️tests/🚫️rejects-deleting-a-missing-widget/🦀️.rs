//! 🧪️ `delete-widget` fixture — `🚫️rejects-deleting-a-missing-widget`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-widget/🚫️rejects-deleting-a-missing-widget/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-widget/🚫️rejects-deleting-a-missing-widget/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-widget/🚫️rejects-deleting-a-missing-widget/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️delete-widget/🚫️rejects-deleting-a-missing-widget/🎯️outcome/🔣️.json");
