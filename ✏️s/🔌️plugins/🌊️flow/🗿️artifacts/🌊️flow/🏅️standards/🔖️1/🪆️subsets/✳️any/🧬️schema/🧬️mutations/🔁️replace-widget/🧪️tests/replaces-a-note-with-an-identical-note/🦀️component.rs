//! 🧪️ `replace-widget` fixture — `replaces-a-note-with-an-identical-note`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-widget/replaces-a-note-with-an-identical-note: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
