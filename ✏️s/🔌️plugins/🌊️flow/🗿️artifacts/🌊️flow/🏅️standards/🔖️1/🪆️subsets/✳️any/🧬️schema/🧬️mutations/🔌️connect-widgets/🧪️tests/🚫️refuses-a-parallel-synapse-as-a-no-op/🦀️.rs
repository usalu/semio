...
//!
//! ✅️ This is an NO-OP case with an EMPTY diff. `connect-widgets`' own `🔺️diff` leaf guards
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️connect-widgets/🚫️refuses-a-parallel-synapse-as-a-no-op/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️connect-widgets/🚫️refuses-a-parallel-synapse-as-a-no-op/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️connect-widgets/🚫️refuses-a-parallel-synapse-as-a-no-op/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️connect-widgets/🚫️refuses-a-parallel-synapse-as-a-no-op/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔌️connect-widgets/🚫️refuses-a-parallel-synapse-as-a-no-op/🎯️outcome/🔣️.json");
...
/// 🎯️ The declared outcome is `no-op` WITH a `warn`-level `mutation.no-op` — a refused parallel
...
async fn declared_outcome_holds() {
    ...
    assert_eq!(outcome.get("status").and_then(serde_json::Value::as_str), Some("no-op"), "connect-widgets/refuses-a-parallel-synapse-as-a-no-op declares a no-op outcome");
    let mut snapshot = before();
    apply_flow_mutation(&mut snapshot, &mutation()).expect("connect-widgets/refuses-a-parallel-synapse-as-a-no-op: declared no-op but the mutation was rejected");
