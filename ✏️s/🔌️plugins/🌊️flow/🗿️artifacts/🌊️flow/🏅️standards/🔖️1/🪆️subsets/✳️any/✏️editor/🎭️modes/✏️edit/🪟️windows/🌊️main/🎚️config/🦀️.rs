...
impl store::ArtifactDsl for FlowMainWindowConfig {
    const EXTENSION: &'static str = "flowmainwindowcfg";
    fn envelope_id() -> &'static str { "s.flow.flow.mainwindowconfig" }
    ...
    fn print_dsl(&self) -> String {
        ...
        let body = serde_json::to_string_pretty(&value).expect("Flow main window config JSON");
