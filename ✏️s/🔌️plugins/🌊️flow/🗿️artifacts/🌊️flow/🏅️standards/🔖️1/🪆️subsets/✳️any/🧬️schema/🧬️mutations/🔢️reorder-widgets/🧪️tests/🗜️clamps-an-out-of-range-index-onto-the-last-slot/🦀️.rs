//! 🧪️ `reorder-widgets` fixture — `🗜️clamps-an-out-of-range-index-onto-the-last-slot`.
//!
...
//! composed `s.stdio.semio.flow` CHILD by a domain-separated SHA-256 digest of the child content.
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️reorder-widgets/🗜️clamps-an-out-of-range-index-onto-the-last-slot/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️reorder-widgets/🗜️clamps-an-out-of-range-index-onto-the-last-slot/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️reorder-widgets/🗜️clamps-an-out-of-range-index-onto-the-last-slot/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️reorder-widgets/🗜️clamps-an-out-of-range-index-onto-the-last-slot/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔢️reorder-widgets/🗜️clamps-an-out-of-range-index-onto-the-last-slot/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "reorder-widgets/clamps-an-out-of-range-index-onto-the-last-slot: produced diff differs from the committed 🔺️diff/🔣️.json");
}
