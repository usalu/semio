...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-widget/🟰️replaces-a-note-with-an-identical-note/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-widget/🟰️replaces-a-note-with-an-identical-note/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-widget/🟰️replaces-a-note-with-an-identical-note/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-widget/🟰️replaces-a-note-with-an-identical-note/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔁️replace-widget/🟰️replaces-a-note-with-an-identical-note/🎯️outcome/🔣️.json");
