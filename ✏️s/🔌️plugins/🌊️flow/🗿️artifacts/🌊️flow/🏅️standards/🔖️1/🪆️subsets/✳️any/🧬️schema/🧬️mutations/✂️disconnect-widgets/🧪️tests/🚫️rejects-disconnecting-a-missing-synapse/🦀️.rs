...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-widgets/🚫️rejects-disconnecting-a-missing-synapse/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-widgets/🚫️rejects-disconnecting-a-missing-synapse/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-widgets/🚫️rejects-disconnecting-a-missing-synapse/🦠️mutation/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✂️disconnect-widgets/🚫️rejects-disconnecting-a-missing-synapse/🎯️outcome/🔣️.json");
