//! 🧬️ 🧬️ Generate-mode commands command — `select-generation`.
...
pub async fn handle(payload: &SelectGeneration, doc: &ArtifactView<'_, FlowSnapshot>, cfg: &ConfigView<'_, FlowConfig>, session: &mut FlowEvalSession) -> Result<Emit<FlowMutation, FlowConfigMutation>, Fault> {
