...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-widgets/re-applies-the-current-layout-to-both-widgets: produced diff differs from the committed 🔺️diff/🔣️component.json");
}
