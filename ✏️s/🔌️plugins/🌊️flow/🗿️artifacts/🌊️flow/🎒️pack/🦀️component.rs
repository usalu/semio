...
//!
//! `store::DocumentPack for FlowFixture` is implemented directly in the flow kernel crate (`flow`);
...
mod tests {
    ...
    fn pack_round_trips_and_agrees_with_dsl() {
        let fixture = dsl::parse_dsl(dsl::FLOW_EXAMPLE_TEXT).expect("parse default fixture");
