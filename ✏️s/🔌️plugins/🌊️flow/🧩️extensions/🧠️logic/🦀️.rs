...
pub fn extension_manifest_json() -> String {
    ...
    build_manifest_json("logic", "Logic", env!("CARGO_PKG_VERSION"), &neural_engine::ColdOwner::new(module_registry()), vec!["onStartup".into()], vec![], vec![FlowExtensionCommand { id: "logic.showHelp".into(), title: "Logic: Show Help".into() }], vec![])
}
...
mod extension_guest {
    ...
    fn bundle() -> ExtensionBundle {
        ...
        let bundle = ExtensionBundle::new("flow-extension-logic", EXTENSION_LABEL, env!("CARGO_PKG_VERSION")).extends("flow").depends_on("flow", semio_framework::tree_pin!());
