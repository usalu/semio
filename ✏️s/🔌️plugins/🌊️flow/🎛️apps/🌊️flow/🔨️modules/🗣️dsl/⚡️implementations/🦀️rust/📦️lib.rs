//! 📜️ Flow app — textual document grammar surface + laws (constitutional: dsl).
//!
...
/// tests parse via `include_str!("../../../../../../../../../🧰️framework/🛍️products/💻️os/🔨️modules/🌊️flow/📚️examples/🌊️default.flow")`.
pub const FLOW_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../🧰️framework/🛍️products/💻️os/🔨️modules/🌊️flow/📚️examples/🌊️default.flow");
