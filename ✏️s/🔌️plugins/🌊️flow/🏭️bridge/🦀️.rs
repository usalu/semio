...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_flow_flow::standards::v1::subsets::any::schema::snapshot::FlowSnapshot, semio_s_artifact_flow_flow::standards::v1::subsets::any::schema::mutations::FlowMutation>,
];
