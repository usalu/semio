//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/🌊️flow`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("FlowMutation", descriptors::<semio_s_artifact_flow_flow::standards::v1::subsets::any::schema::snapshot::FlowSnapshot, semio_s_artifact_flow_flow::standards::v1::subsets::any::schema::mutations::FlowMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.flow.flow", "1", "any", "", "✏️s/🔌️plugins/🌊️flow/🗿️artifacts/🌊️flow/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-flow-mutation-bridge")),
