...
pub const FACADE_GENERATOR_EXAMPLE_TEXT: &str = include_str!("../../../../../../../../../✏️s/🔌️plugins/📖️playbook/📚️examples/📖️facade-generator.playbook");
...
mod tests {
    ...
    /// `📚️examples/📖️facade-generator.playbook` exactly; used to pin the fixture's canonical
