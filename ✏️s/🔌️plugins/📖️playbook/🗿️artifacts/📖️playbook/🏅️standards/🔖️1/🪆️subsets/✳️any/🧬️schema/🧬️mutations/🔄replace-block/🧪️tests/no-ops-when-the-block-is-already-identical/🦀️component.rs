//! 🧪️ `replace-block` fixture — `no-ops-when-the-block-is-already-identical`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "replace-block/no-ops-when-the-block-is-already-identical: produced diff differs from the committed 🔺️diff/🔣️component.json");
