//! 🧪️ `move-step` fixture — `🚪️no-ops-when-the-step-is-already-at-that-index`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-step/🧪️no-ops-when-the-step-is-already-at-that-index/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-step/🧪️no-ops-when-the-step-is-already-at-that-index/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-step/🧪️no-ops-when-the-step-is-already-at-that-index/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-step/🧪️no-ops-when-the-step-is-already-at-that-index/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/↔️move-step/🧪️no-ops-when-the-step-is-already-at-that-index/🎯️outcome/🔣️.json");
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "move-step/no-ops-when-the-step-is-already-at-that-index: produced diff differs from the committed 🔺️diff/🔣️.json");
...
/// 🎯️ The declared outcome holds: `no-op`, with one untargeted Warning `mutation.no-op`. A move
/// onto the current slot is a warning, never the Error a missing step would raise.
#[semio_framework_async_macros::async_test]
async fn declared_outcome_holds() {
    let outcome: serde_json::Value = serde_json::from_str(OUTCOME).expect("outcome decodes");
    assert_eq!(outcome.get("status").and_then(serde_json::Value::as_str), Some("no-op"), "move-step/no-ops-when-the-step-is-already-at-that-index declares a no-op outcome");
