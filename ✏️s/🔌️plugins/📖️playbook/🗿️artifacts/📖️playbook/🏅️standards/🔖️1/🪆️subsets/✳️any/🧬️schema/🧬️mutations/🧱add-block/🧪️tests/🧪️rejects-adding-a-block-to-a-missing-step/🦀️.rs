...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱add-block/🧪️rejects-adding-a-block-to-a-missing-step/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱add-block/🧪️rejects-adding-a-block-to-a-missing-step/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱add-block/🧪️rejects-adding-a-block-to-a-missing-step/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱add-block/🧪️rejects-adding-a-block-to-a-missing-step/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🧱add-block/🧪️rejects-adding-a-block-to-a-missing-step/🎯️outcome/🔣️.json");
