//! 🧪️ `change-title` fixture — `🔀️changes-the-playbook-title`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-title/🧪️changes-the-playbook-title/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-title/🧪️changes-the-playbook-title/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-title/🧪️changes-the-playbook-title/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-title/🧪️changes-the-playbook-title/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/✏️change-title/🧪️changes-the-playbook-title/🎯️outcome/🔣️.json");
