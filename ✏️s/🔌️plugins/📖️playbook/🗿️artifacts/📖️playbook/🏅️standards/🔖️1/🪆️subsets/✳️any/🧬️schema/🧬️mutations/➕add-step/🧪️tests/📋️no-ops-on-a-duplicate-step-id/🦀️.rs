//! 🧪️ `add-step` fixture — `📋️no-ops-on-a-duplicate-step-id`.
//!
...
async fn produces_committed_diff() {
    ...
    assert_eq!(produced, committed, "add-step/no-ops-on-a-duplicate-step-id: produced diff differs from the committed 🔺️diff/🔣️.json");
