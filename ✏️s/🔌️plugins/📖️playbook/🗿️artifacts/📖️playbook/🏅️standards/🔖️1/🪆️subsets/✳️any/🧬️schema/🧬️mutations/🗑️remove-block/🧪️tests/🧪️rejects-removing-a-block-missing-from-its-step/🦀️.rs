...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-block/🧪️rejects-removing-a-block-missing-from-its-step/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-block/🧪️rejects-removing-a-block-missing-from-its-step/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-block/🧪️rejects-removing-a-block-missing-from-its-step/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-block/🧪️rejects-removing-a-block-missing-from-its-step/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🗑️remove-block/🧪️rejects-removing-a-block-missing-from-its-step/🎯️outcome/🔣️.json");
