//! 🧪️ `remove-step` fixture — `🚫️rejects-removing-a-missing-step`.
//!
...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-step/🧪️rejects-removing-a-missing-step/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-step/🧪️rejects-removing-a-missing-step/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-step/🧪️rejects-removing-a-missing-step/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-step/🧪️rejects-removing-a-missing-step/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/➖remove-step/🧪️rejects-removing-a-missing-step/🎯️outcome/🔣️.json");
