...
pub use crate::artifacts::playbook::mutations::{add_block_operation, add_step_operation, apply_playbook_mutation, move_block_operation, move_step_operation, remove_block_operation, remove_step_operation, update_playbook_title_operation, inverse_playbook_mutation, PlaybookMutation};
...
mod tests {
    ...
    fn apply_playbook_edit_op_roundtrip() {
        ...
        let next = apply_playbook_mutation(&spec, &PlaybookMutation::AddStep { step, index: None });
