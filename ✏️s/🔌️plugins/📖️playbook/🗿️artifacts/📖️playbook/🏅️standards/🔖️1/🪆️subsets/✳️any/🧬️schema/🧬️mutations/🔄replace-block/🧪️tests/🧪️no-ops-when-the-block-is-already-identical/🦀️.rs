...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-block/🧪️no-ops-when-the-block-is-already-identical/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-block/🧪️no-ops-when-the-block-is-already-identical/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-block/🧪️no-ops-when-the-block-is-already-identical/🦠️mutation/🔣️.json");
const DIFF: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-block/🧪️no-ops-when-the-block-is-already-identical/🔺️diff/🔣️.json");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔄replace-block/🧪️no-ops-when-the-block-is-already-identical/🎯️outcome/🔣️.json");
