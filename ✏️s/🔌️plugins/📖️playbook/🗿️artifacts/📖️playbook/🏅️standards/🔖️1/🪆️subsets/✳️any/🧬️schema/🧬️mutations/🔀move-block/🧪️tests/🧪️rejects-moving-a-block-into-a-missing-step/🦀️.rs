...
const BEFORE: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀move-block/🧪️rejects-moving-a-block-into-a-missing-step/📸️snapshot/⬅️before/🔣️.json");
const AFTER: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀move-block/🧪️rejects-moving-a-block-into-a-missing-step/📸️snapshot/➡️after/🔣️.json");
const MUTATION: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀move-block/🧪️rejects-moving-a-block-into-a-missing-step/🦠️mutation/🔣️.json");
const DIFF_ABSENT: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀move-block/🧪️rejects-moving-a-block-into-a-missing-step/🔺️diff/🚫️.absent");
const OUTCOME: &str = include_str!("../../../../../🧫️fixtures/🧬️mutations/🔀move-block/🧪️rejects-moving-a-block-into-a-missing-step/🎯️outcome/🔣️.json");
