...
//!
//! `store::DocumentDsl for PlaybookSpec` is implemented directly in the shared `playbook` kernel crate;
...
pub const FACADE_GENERATOR_EXAMPLE_TEXT: &str = include_str!("../../../📚️examples/📖️facade-generator.playbook");
...
mod tests {
    ...
    /// `📚️examples/📖️facade-generator.playbook` exactly; used to pin the fixture's canonical DSL
    /// formatting against a hand-built struct literal.
    pub(crate) fn sample_facade_generator_spec() -> PlaybookSpec {
        use crate::artifacts::playbook::{PlaybookBlock, PlaybookBlockOption, PlaybookExpr, PlaybookStep, PlaybookVectorField, PLAYBOOK_DOCUMENT_SCHEMA};
        use dsl::DslValue;
