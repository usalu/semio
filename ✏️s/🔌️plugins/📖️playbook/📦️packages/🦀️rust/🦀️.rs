...
//#region 🗿️Artifacts
mod artifacts {
    pub use semio_s_artifact_playbook_playbook as playbook;
}
//#endregion 🗿️Artifacts

//#region ✏️Editor
mod editor {
    pub use semio_s_artifact_playbook_playbook::editor::*;
}
//#endregion ✏️Editor

//#region 👁️Viewer
mod viewer {
    pub use semio_s_artifact_playbook_playbook::viewer::*;
}
//#endregion 👁️Viewer
