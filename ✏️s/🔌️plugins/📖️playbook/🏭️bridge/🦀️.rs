//! 🏭️ Production mutation bridge for `✏️s/🔌️plugins/📖️playbook`.
//!
...
const AGGREGATES: &[(&str, fn() -> &'static [MutationLeafDescriptor])] = &[
    ("PlaybookConfigMutation", descriptors::<semio_s_artifact_playbook_playbook::editor::playbook::config::PlaybookConfig, semio_s_artifact_playbook_playbook::editor::playbook::config::PlaybookConfigMutation>),
    ("PlaybookMutation", descriptors::<semio_s_artifact_playbook_playbook::standards::v1::subsets::any::schema::snapshot::PlaybookSnapshot, semio_s_artifact_playbook_playbook::standards::v1::subsets::any::schema::mutations::PlaybookMutation>),
];
...
const COORDINATES: &[(&str, &str, &str, &str, &str, &str)] = &[
    ("s.playbook.playbook", "1", "any", "", "✏️s/🔌️plugins/📖️playbook/🗿️artifacts/📖️playbook/🏅️standards/🔖️1/🪆️subsets/✳️any", ""),
    ("s.playbook.playbook", "1", "any", "✏️editor/🎚️config", "✏️s/🔌️plugins/📖️playbook/🗿️artifacts/📖️playbook/🏅️standards/🔖️1/🪆️subsets/✳️any/✏️editor/🎚️config", ""),
];
...
fn main() {
    ...
    fields.extend([
        ...
        ("producedBy".to_string(), pack::JsonValue::from("semio-playbook-mutation-bridge")),
