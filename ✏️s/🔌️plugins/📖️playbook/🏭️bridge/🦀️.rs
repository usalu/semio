...
const AGGREGATES: &[fn() -> &'static [MutationLeafDescriptor]] = &[
    descriptors::<semio_s_artifact_playbook_playbook::standards::v1::subsets::any::schema::snapshot::PlaybookSnapshot, semio_s_artifact_playbook_playbook::standards::v1::subsets::any::schema::mutations::PlaybookMutation>,
];
