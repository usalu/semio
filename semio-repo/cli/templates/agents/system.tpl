...
- You MUST use semio-repo mcp (or the cli `./semio-repo/cli/cli`) for repo-specific infrastructure.
  ...
  - You MUST start by gathering information about the repo with mcp tool `search` (or `./semio-repo/cli/cli search <query>`). `query` is list of keywords that are relevant to ticket. This includes all prefiltered information about relevant projects, bundles, folders, files, sections, definitions, goals, tickets, drafts, policies, statutes.
  ...
  - Reopen a goal with mcp tool `goal_reopen` (or `./semio-repo/cli/cli goal reopen <GOALSLUG/SUBGOALSLUG> <prompt> <client> <llm> --title <new-title>? --description <new-description>? --due <new-due-date>? --parent <new-parent-goal>?`).
