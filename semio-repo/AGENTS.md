...
technologies:
  ...
  uri:
    ...
    examples: ["semiorepo://technologies/26/02/15/14/33/38"]
technology:
  parent: technologies
  kinds:
    - name: infrastructure
  ...
  uri:
    ...
    examples:
      - semiorepo://technology/semio-repo
      - semiorepo://technology/semio
bundles:
  parent: technology
  emoji: 📦
  code: bnd
...
semio-repo/cli/cli changes {{entity-id-to-filter-changes}} # shows only the portion of the current revision to the checkpoint for the given entity. e.g. technology only show the part of the revision in regards to the technology such as only bundles inside the technology, only
```
...
semio-repo/cli/cli revision {{entity-id-to-filter-revision}} # shows only the portion of the current revision to the checkpoint for the given entity. e.g. technology only show the part of the revision in regards to the technology such as only bundles inside the technology, only
```
