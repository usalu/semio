...
export type Policy = Node & {
  ...
  violationKinds: Array<ViolationKind>;
};
...
export type Query = {
  ...
  ticket?: Maybe<Ticket>;
  tickets: Array<Ticket>;
  violationKind?: Maybe<ViolationKind>;
  violationKinds: Array<ViolationKind>;
  violations: Array<Violation>;
};
...
export type QueryViolationKindArgs = {
  id: Scalars['String']['input'];
};
...
export type RepoViolationsArgs = {
  scope?: InputMaybe<Scalars['String']['input']>;
};
...
export type ViolationKind = Node & {
  __typename?: 'ViolationKind';
  autofixable: Scalars['Boolean']['output'];
  id: Scalars['ID']['output'];
  policy: Policy;
  priority: ViolationPriority;
...
export type ViolationKindViolationsArgs = {
  scope?: InputMaybe<Scalars['String']['input']>;
};

export enum ViolationPriority {
  High = 'HIGH',
  Low = 'LOW',
  Medium = 'MEDIUM'
}
...
export type AnalyzeQuery = { __typename?: 'Query', analyze: { __typename?: 'AnalyzeResult', violations: Array<{ __typename?: 'Violation', id: string, summary: string, priority: ViolationPriority, autofixable: boolean, scope: string, line?: number | null, column?: number | null, excerpt?: string | null, kind: { __typename?: 'ViolationKind', id: string, reason: string, solution: string, policy: { __typename?: 'Policy', id: string, name: string } }, autofix?: { __typename?: 'Autofix', description: string } | null }>, metrics: { __typename?: 'AnalyzeMetrics', total: number, autofixable: number, byPriority: { __typename?: 'PriorityCount', high: number, medium: number, low: number } } } };
...
export type FixMutation = { __typename?: 'Mutation', fix: { __typename?: 'FixResult', fixed: number, remaining: number, violations: Array<{ __typename?: 'Violation', id: string, summary: string, priority: ViolationPriority, scope: string }> } };

export type CodebaseQueryVariables = Exact<{ [key: string]: never; }>;


export type CodebaseQuery = { __typename?: 'Query', repo: { __typename?: 'Repo', id: string, name: string, path: string, bundles: Array<{ __typename?: 'Bundle', id: string, name: string, root: string, sourceRoot?: string | null, projectType?: string | null, tags: Array<string>, uri: string, metrics: { __typename?: 'BundleMetrics', folders: number, files: number, sections: number, definitions: number, lines: number, violations: number } }>, folders: Array<{ __typename?: 'Folder', id: string, path: string, uri: string, metrics: { __typename?: 'FolderMetrics', files: number, lines: number, violations: number } }>, files: Array<{ __typename?: 'File', id: string, path: string, uri: string, metrics: { __typename?: 'FileMetrics', sections: number, definitions: number, lines: number }, sections: Array<{ __typename?: 'Section', id: string, name: string, path: string, range: { __typename?: 'Range', start: { __typename?: 'Position', line: number }, end: { __typename?: 'Position', line: number } }, metrics: { __typename?: 'SectionMetrics', definitions: number, lines: number, violations: number } }>, definitions: Array<{ __typename?: 'Definition', id: string, name: string, kind: DefinitionKind, range: { __typename?: 'Range', start: { __typename?: 'Position', line: number }, end: { __typename?: 'Position', line: number } }, metrics: { __typename?: 'DefinitionMetrics', definitions: number, lines: number, violations: number } }> }>, contributors: Array<{ __typename?: 'Contributor', id: string, github: string, name?: string | null, emails: Array<string>, links: Array<{ __typename?: 'ContributorLink', name: string, url: string }>, metrics: { __typename?: 'ContributorMetrics', commits: number, tickets: number, bundles: number, folders: number, files: number, sections: number, definitions: number, lines: number } }>, tickets: Array<{ __typename?: 'Ticket', id: string, year: number, month: number, day: number, slug: string, path: string, uri: string, prompt: string, summary?: string | null, status: TicketStatus, commit?: string | null, author?: { __typename?: 'Contributor', github: string, name?: string | null } | null, checkpoints: Array<{ __typename?: 'TicketCheckpoint', commit?: string | null }>, metrics: { __typename?: 'TicketMetrics', checkpoints: number, files: number, lines: { __typename?: 'LineMetrics', added: number, removed: number } } }>, policies: Array<{ __typename?: 'Policy', id: string, name: string, description?: string | null, scopes: Array<string>, violationKinds: Array<{ __typename?: 'ViolationKind', id: string, priority: ViolationPriority, autofixable: boolean, reason: string, solution: string }> }> } };
