...
// Specs: Host `GraphWasmCanvas` (`framework/os/kernel/infinite/canvas/react-renderer/index.tsx`) against a pure-JS mock `GraphWasmSession` — no real WASM session, no puzzle-2d program.
...
import { GraphWasmCanvas } from "../../../framework/os/kernel/infinite/canvas/react-renderer/index.tsx";
import type { CanvasInputModifiers, GraphWasmSession } from "../../../framework/os/kernel/infinite/canvas/react-renderer/index.tsx";
