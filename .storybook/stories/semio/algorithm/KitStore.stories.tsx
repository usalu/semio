...
import { AlgorithmApp, NAKAGIN_CAPSULE_TOWER_DESIGN_ID, WindowKind, designFromKit, kitSurface, type AlgorithmContextValue, type AlgorithmWindowDef } from "@semio/algorithm";

import { CommandForm } from "../../../semio/algorithm/kit-store/CommandForm";
import { ALL_CHANGE_KIT_ROOT_KEYS, CHANGE_TYPE_COMMAND_KEYS, KIT_STORE_COVERAGE_ROWS } from "../../../semio/algorithm/kit-store/commandSchema";
import { DiffViewer } from "../../../semio/algorithm/kit-store/DiffViewer";
import { applyEntityPlaceholders, EntityPicker } from "../../../semio/algorithm/kit-store/EntityPicker";
import { EventsFeed } from "../../../semio/algorithm/kit-store/EventsFeed";
import { HistoryControls, KitTreeGraph } from "../../../semio/algorithm/kit-store/HistoryControls";
import { SnapshotViewer } from "../../../semio/algorithm/kit-store/SnapshotViewer";
import { useKitStore } from "../../../semio/algorithm/kit-store/useKitStore";
