...
import { AlgorithmApp, NAKAGIN_CAPSULE_TOWER_DESIGN_ID, WindowKind, designFromKit, useFlatDesignPreview, type AlgorithmContextValue, type AlgorithmWindowDef } from "@semio/algorithms";
