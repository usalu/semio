// #region Header
// compose/algorithm/.storybook/story/Move.stories.tsx
// Specs: Pure UI proxy to flatDesign + movePieces via shared story hooks.
// Summary: IPO move board — vector input, WASM flat input, movePieces diff + ComposeScene output.
...
import { DragPieces, MoveStoryDesign, MoveVector } from "@compose/fixture";
