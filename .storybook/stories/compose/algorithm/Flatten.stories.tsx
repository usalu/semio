...
import { AlgorithmApp, NAKAGIN_CAPSULE_TOWER_DESIGN_ID, WindowKind, designFromKit, useFlattenPreview, type AlgorithmContextValue, type AlgorithmWindowDef } from "@compose/algorithm";
