...
// 🥼︎ .storybook/stories/ui/DragAndDrop.stories.tsx
...
// 🫳 `DraggableAvatar` already has dedicated coverage in `Avatar.stories.tsx` (DraggableAvatarDefault) — this file
...
/** @emoji 🧺 Pointer-driven reorder demo pairing {@link DragHandle} with {@link DraggableAvatar} rows — no dnd-kit wiring required for the story, just local list state. */
