...
// 🥼︎ .storybook/stories/ui/ShellSearchDialog.stories.tsx
...
const ALL_RESULTS: ShellCommandResult[] = [
  { id: "cmd.new-design", label: "New Design", icon: "file-code", hotkey: "⌘N" },
  { id: "cmd.open-kit", label: "Open Kit…", icon: "folder-open", hotkey: "⌘O" },
