// #region 🧲️Header
// 💻️ .storybook/stories/framework/os/plugins.stories.tsx
...
// #region 🔖️PluginMatrix
// 🧩️ One literal export per `PLUGIN_BUILD_TARGETS` row — CSF3's Vite indexer needs a statically
...
export const Space: Story = { args: { plugin: "space" } satisfies OsBootHostProps };
