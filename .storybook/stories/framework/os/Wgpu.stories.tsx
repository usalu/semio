...
// Specs: Boot the real `@semio-tech/framework-renderer-wgpu` raw-wgpu host for a registry plugin — the "no React DOM, canvas-only" renderer story.
...
/** @emoji 🖥️ Studio host plugin through the wgpu renderer instead of the React renderer. */
export const Studio: Story = {
  args: { plugin: "s" } satisfies WgpuBootHostProps,
};

/** @emoji 🧩 Puzzle plugin through the wgpu renderer. */
