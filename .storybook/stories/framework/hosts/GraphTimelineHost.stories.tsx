// #region 🧲️Header
// 💻️ .storybook/stories/framework/hosts/GraphTimelineHost.stories.tsx
...
/** 🌳️ Two forked branches off a shared root — matches the swimlane/fork-elbow shape `HistoryTable`'s own test exercises (`framework/ui/js/react/index.tsx`, "renders swimlane guides and fork elbows"). */
...
/** 📏️ A single lane, no forks or labels/authors — exercises the "checkpoint chip + unknown avatar" fallback row rendering. */
...
const meta = {
  title: "🛠️framework🔌️hosts/GraphTimelineHost",
...
/** 🌳️ Two forked branches — clicking a row dispatches `checkoutCheckpoint`, visible in the debug readout. */
export const Branching: Story = {
  args: { columns: BRANCHING_COLUMNS, controllerId: "vcs-play", surfaceId: "vcs.play.timeline" },
};

/** 📏️ Single lane, no labels/authors — the fallback checkpoint-chip/unknown-avatar row rendering. */
