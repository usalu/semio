...
// Specs: Single level decorator for monorepo Storybook: globals.level (elements) and args.level (semio stories).
...
// #region 🧩LevelWrapper
/** Border + min width used when a story sets `level` via args (semio UI / algorithms). */
